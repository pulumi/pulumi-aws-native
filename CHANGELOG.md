...
- [De-duplicate types for simple arrays of tags](https://github.com/pulumi/pulumi-aws-native/pull/1348)
  - Resources affected:
    ...
    - apigateway:VpcLink
    - appconfig:ApplicationT
    - appconfig:ConfigurationProfileT
    ...
    - comprehend:Flywheel
    - configuration:AggregationAuthorization
    - configuration:ConfigurationAggregator
    - configuration:StoredQuery
    - connect:ContactFlow
    ...
    - events:EventBus
    - eventschemas:DiscovererTagsEn
    - eventschemas:RegistryTagsEn
    - eventschemas:SchemaTagsEn
    ...
    - guardduty:DetectorTagI
    - guardduty:FilterTagI
    - guardduty:IpSetTagI
    - guardduty:ThreatIntelSetTagI
    ...
    - sso:PermissionSet
    - stepfunctions:ActivityTagsEn
    - stepfunctions:StateMachineTagsEn
    - synthetics:Canary
    - synthetics:Group
