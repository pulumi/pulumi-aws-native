...
//    }
//    func (m *mockCloudFormationClient) CancelResourceRequest(input *cloudformation.CancelResourceRequestInput) (*cloudformation.CancelResourceRequestOutput, error) {
...
type CloudFormationAPI interface {
	CancelResourceRequest(*cloudformation.CancelResourceRequestInput) (*cloudformation.CancelResourceRequestOutput, error)
	CancelResourceRequestWithContext(aws.Context, *cloudformation.CancelResourceRequestInput, ...request.Option) (*cloudformation.CancelResourceRequestOutput, error)
	CancelResourceRequestRequest(*cloudformation.CancelResourceRequestInput) (*request.Request, *cloudformation.CancelResourceRequestOutput)
	...
	CreateResource(*cloudformation.CreateResourceInput) (*cloudformation.CreateResourceOutput, error)
	CreateResourceWithContext(aws.Context, *cloudformation.CreateResourceInput, ...request.Option) (*cloudformation.CreateResourceOutput, error)
	CreateResourceRequest(*cloudformation.CreateResourceInput) (*request.Request, *cloudformation.CreateResourceOutput)
	...
	DeleteResource(*cloudformation.DeleteResourceInput) (*cloudformation.DeleteResourceOutput, error)
	DeleteResourceWithContext(aws.Context, *cloudformation.DeleteResourceInput, ...request.Option) (*cloudformation.DeleteResourceOutput, error)
	DeleteResourceRequest(*cloudformation.DeleteResourceInput) (*request.Request, *cloudformation.DeleteResourceOutput)
	...
	GetResource(*cloudformation.GetResourceInput) (*cloudformation.GetResourceOutput, error)
	GetResourceWithContext(aws.Context, *cloudformation.GetResourceInput, ...request.Option) (*cloudformation.GetResourceOutput, error)
	GetResourceRequest(*cloudformation.GetResourceInput) (*request.Request, *cloudformation.GetResourceOutput)

	GetResourceRequestStatus(*cloudformation.GetResourceRequestStatusInput) (*cloudformation.GetResourceRequestStatusOutput, error)
	GetResourceRequestStatusWithContext(aws.Context, *cloudformation.GetResourceRequestStatusInput, ...request.Option) (*cloudformation.GetResourceRequestStatusOutput, error)
	GetResourceRequestStatusRequest(*cloudformation.GetResourceRequestStatusInput) (*request.Request, *cloudformation.GetResourceRequestStatusOutput)
	...
	ListResourceRequests(*cloudformation.ListResourceRequestsInput) (*cloudformation.ListResourceRequestsOutput, error)
	ListResourceRequestsWithContext(aws.Context, *cloudformation.ListResourceRequestsInput, ...request.Option) (*cloudformation.ListResourceRequestsOutput, error)
	ListResourceRequestsRequest(*cloudformation.ListResourceRequestsInput) (*request.Request, *cloudformation.ListResourceRequestsOutput)

	ListResources(*cloudformation.ListResourcesInput) (*cloudformation.ListResourcesOutput, error)
	ListResourcesWithContext(aws.Context, *cloudformation.ListResourcesInput, ...request.Option) (*cloudformation.ListResourcesOutput, error)
	ListResourcesRequest(*cloudformation.ListResourcesInput) (*request.Request, *cloudformation.ListResourcesOutput)

	ListResourcesPages(*cloudformation.ListResourcesInput, func(*cloudformation.ListResourcesOutput, bool) bool) error
	ListResourcesPagesWithContext(aws.Context, *cloudformation.ListResourcesInput, func(*cloudformation.ListResourcesOutput, bool) bool, ...request.Option) error
	...
	UpdateResource(*cloudformation.UpdateResourceInput) (*cloudformation.UpdateResourceOutput, error)
	UpdateResourceWithContext(aws.Context, *cloudformation.UpdateResourceInput, ...request.Option) (*cloudformation.UpdateResourceOutput, error)
	UpdateResourceRequest(*cloudformation.UpdateResourceInput) (*request.Request, *cloudformation.UpdateResourceOutput)
