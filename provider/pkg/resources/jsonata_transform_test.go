...
func TestSuppressPropertyTransformDiffs(t *testing.T) {
	t.Run("suppresses lowercase equivalent diff", func(t *testing.T) {
		...
		result := suppressPropertyTransformDiffs("aws-native:rds:DBCluster", spec, diff, originalInputs)
	...
	t.Run("handles nested object diff", func(t *testing.T) {
		...
		result := suppressPropertyTransformDiffs("aws-native:efs:FileSystem", spec, diff, originalInputs)
...
func TestPropertyValueConversion(t *testing.T) {
	t.Run("converts basic types", func(t *testing.T) {
		assert.Equal(t, true, propertyValueToInterface(resource.NewBoolProperty(true)))
		assert.Equal(t, float64(42), propertyValueToInterface(resource.NewNumberProperty(42)))
		assert.Equal(t, "hello", propertyValueToInterface(resource.NewStringProperty("hello")))
		assert.Nil(t, propertyValueToInterface(resource.NewNullProperty()))
	})
	...
	t.Run("converts arrays", func(t *testing.T) {
		...
		result := propertyValueToInterface(arr)
	...
	t.Run("converts objects", func(t *testing.T) {
		...
		result := propertyValueToInterface(obj)
	...
	t.Run("converts nested structures", func(t *testing.T) {
		...
		result := propertyValueToInterface(nested)
	...
	t.Run("handles secret values", func(t *testing.T) {
		...
		result := propertyValueToInterface(secret)
