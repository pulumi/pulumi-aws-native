...
func (ctx *context) gatherPropertyType(resourceScope string, spec schema.PropertyTypeSpec) pschema.ObjectTypeSpec {
...
func (ctx *context) gatherAttributesType(resourceScope string, attributes map[string]schema.AttributeSpec) pschema.ObjectTypeSpec {
	properties, required := map[string]pschema.PropertySpec{}, []string{}
...
var creationPolicyTypes = map[string]pschema.ObjectTypeSpec{
	"CreationPolicy": {
...
var updatePolicyTypes = map[string]pschema.ObjectTypeSpec{
