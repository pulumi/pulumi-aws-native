...
public final class AlarmModelSqsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlarmModelSqsArgs Empty = new AlarmModelSqsArgs();
    ...
    private AlarmModelSqsArgs() {}

    private AlarmModelSqsArgs(AlarmModelSqsArgs $) {
    ...
    public static Builder builder(AlarmModelSqsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlarmModelSqsArgs();
        }

        public Builder(AlarmModelSqsArgs defaults) {
            $ = new AlarmModelSqsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AlarmModelSqsArgs build() {
