...
@CustomType
public final class RoleAliasTag {
    /**
    ...
    public static Builder builder(RoleAliasTag defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(RoleAliasTag defaults) {
        ...
        public RoleAliasTag build() {
            final var o = new RoleAliasTag();
            o.key = key;
            o.value = value;
            return o;
        }
