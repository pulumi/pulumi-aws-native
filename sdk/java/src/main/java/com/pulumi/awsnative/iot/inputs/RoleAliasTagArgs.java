 ...
 * 
 */
public final class RoleAliasTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleAliasTagArgs Empty = new RoleAliasTagArgs();
    ...
    private RoleAliasTagArgs() {}

    private RoleAliasTagArgs(RoleAliasTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(RoleAliasTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleAliasTagArgs();
        }

        public Builder(RoleAliasTagArgs defaults) {
            $ = new RoleAliasTagArgs(Objects.requireNonNull(defaults));
        }
