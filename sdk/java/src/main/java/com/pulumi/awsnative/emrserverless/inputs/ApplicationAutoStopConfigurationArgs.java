...
public final class ApplicationAutoStopConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param enabled If set to true, the Application will automatically stop after being idle. Defaults to true.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param idleTimeoutMinutes The amount of time [in minutes] to wait before auto stopping the Application when idle. Defaults to 15 minutes.
         * 
         * @return builder
         * 
         */
