...
@CustomType
public final class ApplicationCSVMappingParameters {
    /**
    ...
    public static Builder builder(ApplicationCSVMappingParameters defaults) {
    ...
    public static final class Builder {
        ...
        private String recordRowDelimiter;
        public Builder() {}
        public Builder(ApplicationCSVMappingParameters defaults) {
        ...
        public ApplicationCSVMappingParameters build() {
            final var o = new ApplicationCSVMappingParameters();
