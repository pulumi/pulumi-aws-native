 ...
 * 
 */
public final class AnalyzerTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnalyzerTagArgs Empty = new AnalyzerTagArgs();
    ...
    private AnalyzerTagArgs() {}

    private AnalyzerTagArgs(AnalyzerTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(AnalyzerTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AnalyzerTagArgs defaults) {
            $ = new AnalyzerTagArgs(Objects.requireNonNull(defaults));
        }
