...
public final class ScheduledActionResizeClusterMessageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ScheduledActionResizeClusterMessageArgs(ScheduledActionResizeClusterMessageArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScheduledActionResizeClusterMessageArgs();
        }

        public Builder(ScheduledActionResizeClusterMessageArgs defaults) {
            $ = new ScheduledActionResizeClusterMessageArgs(Objects.requireNonNull(defaults));
        }
