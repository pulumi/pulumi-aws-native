...
@CustomType
public final class DomainRSessionAppSettings {
    /**
    ...
    public static Builder builder(DomainRSessionAppSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable DomainResourceSpec defaultResourceSpec;
        public Builder() {}
        public Builder(DomainRSessionAppSettings defaults) {
        ...
        public DomainRSessionAppSettings build() {
            final var o = new DomainRSessionAppSettings();
