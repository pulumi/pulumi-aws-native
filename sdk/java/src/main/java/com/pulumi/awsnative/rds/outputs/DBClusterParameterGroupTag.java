...
@CustomType
public final class DBClusterParameterGroupTag {
    /**
    ...
    public static Builder builder(DBClusterParameterGroupTag defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DBClusterParameterGroupTag defaults) {
        ...
        public DBClusterParameterGroupTag build() {
            final var o = new DBClusterParameterGroupTag();
            o.key = key;
            o.value = value;
            return o;
        }
