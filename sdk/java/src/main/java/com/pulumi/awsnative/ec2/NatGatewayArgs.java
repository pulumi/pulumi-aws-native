...
import com.pulumi.awsnative.ec2.inputs.NatGatewayTagArgs;
...
public final class NatGatewayArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="tags")
    private @Nullable Output<List<NatGatewayTagArgs>> tags;

    public Optional<Output<List<NatGatewayTagArgs>>> tags() {
    ...
    public static final class Builder {
        ...
        public Builder tags(@Nullable Output<List<NatGatewayTagArgs>> tags) {
            $.tags = tags;
            return this;
        }

        public Builder tags(List<NatGatewayTagArgs> tags) {
            return tags(Output.of(tags));
        }

        public Builder tags(NatGatewayTagArgs... tags) {
