 ...
 * 
 */
public final class KeyPairTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final KeyPairTagArgs Empty = new KeyPairTagArgs();
    ...
    private KeyPairTagArgs() {}

    private KeyPairTagArgs(KeyPairTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(KeyPairTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KeyPairTagArgs defaults) {
            $ = new KeyPairTagArgs(Objects.requireNonNull(defaults));
        }
