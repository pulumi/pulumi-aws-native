...
import com.pulumi.awsnative.sagemaker.inputs.DomainRSessionAppSettingsArgs;
...
public final class DomainUserSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DomainRSessionAppSettingsArgs> rSessionAppSettings;

    public Optional<Output<DomainRSessionAppSettingsArgs>> rSessionAppSettings() {
    ...
    public static final class Builder {
        ...
        public Builder rSessionAppSettings(@Nullable Output<DomainRSessionAppSettingsArgs> rSessionAppSettings) {
            $.rSessionAppSettings = rSessionAppSettings;
            return this;
        }

        public Builder rSessionAppSettings(DomainRSessionAppSettingsArgs rSessionAppSettings) {
