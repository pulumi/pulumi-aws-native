...
@CustomType
public final class RuleGroupHeaderMatchPattern {
    /**
    ...
    public static Builder builder(RuleGroupHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(RuleGroupHeaderMatchPattern defaults) {
        ...
        public RuleGroupHeaderMatchPattern build() {
            final var o = new RuleGroupHeaderMatchPattern();
            o.all = all;
