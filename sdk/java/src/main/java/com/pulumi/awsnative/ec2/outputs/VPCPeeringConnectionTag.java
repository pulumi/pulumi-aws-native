...
@CustomType
public final class VPCPeeringConnectionTag {
    /**
    ...
    private VPCPeeringConnectionTag() {}
    /**
     * @return The key name of the tag. You can specify a value that is 1 to 128 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
     * 
     */
    ...
    public static Builder builder(VPCPeeringConnectionTag defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(VPCPeeringConnectionTag defaults) {
        ...
        public VPCPeeringConnectionTag build() {
            final var o = new VPCPeeringConnectionTag();
            o.key = key;
            o.value = value;
            return o;
        }
