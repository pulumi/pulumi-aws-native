...
import com.pulumi.awsnative.msk.inputs.ClusterPrometheusArgs;
...
public final class ClusterOpenMonitoringArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<ClusterPrometheusArgs> prometheus;

    public Output<ClusterPrometheusArgs> prometheus() {
    ...
    public static final class Builder {
        ...
        public Builder prometheus(Output<ClusterPrometheusArgs> prometheus) {
            $.prometheus = prometheus;
            return this;
        }

        public Builder prometheus(ClusterPrometheusArgs prometheus) {
