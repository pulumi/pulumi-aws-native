...
public final class WebACLFieldToMatchSingleQueryArgumentPropertiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebACLFieldToMatchSingleQueryArgumentPropertiesArgs(WebACLFieldToMatchSingleQueryArgumentPropertiesArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebACLFieldToMatchSingleQueryArgumentPropertiesArgs();
        }

        public Builder(WebACLFieldToMatchSingleQueryArgumentPropertiesArgs defaults) {
            $ = new WebACLFieldToMatchSingleQueryArgumentPropertiesArgs(Objects.requireNonNull(defaults));
        }
