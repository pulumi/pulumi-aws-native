 ...
 * 
 */
public final class DBSubnetGroupTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final DBSubnetGroupTagArgs Empty = new DBSubnetGroupTagArgs();
    ...
    private DBSubnetGroupTagArgs() {}

    private DBSubnetGroupTagArgs(DBSubnetGroupTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(DBSubnetGroupTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DBSubnetGroupTagArgs();
        }

        public Builder(DBSubnetGroupTagArgs defaults) {
            $ = new DBSubnetGroupTagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DBSubnetGroupTagArgs build() {
