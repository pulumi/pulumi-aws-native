...
public final class UsagePlanTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UsagePlanTagArgs(UsagePlanTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UsagePlanTagArgs();
        }

        public Builder(UsagePlanTagArgs defaults) {
            $ = new UsagePlanTagArgs(Objects.requireNonNull(defaults));
        }
