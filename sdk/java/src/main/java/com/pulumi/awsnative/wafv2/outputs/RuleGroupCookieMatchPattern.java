...
@CustomType
public final class RuleGroupCookieMatchPattern {
    /**
    ...
    private RuleGroupCookieMatchPattern() {}
    /**
     * @return Inspect all parts of the web request cookies.
     * 
     */
    ...
    public static Builder builder(RuleGroupCookieMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedCookies;
        public Builder() {}
        public Builder(RuleGroupCookieMatchPattern defaults) {
        ...
        public RuleGroupCookieMatchPattern build() {
            final var o = new RuleGroupCookieMatchPattern();
            o.all = all;
