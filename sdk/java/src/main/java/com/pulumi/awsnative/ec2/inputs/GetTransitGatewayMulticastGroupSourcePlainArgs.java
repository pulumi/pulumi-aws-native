...
public final class GetTransitGatewayMulticastGroupSourcePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTransitGatewayMulticastGroupSourcePlainArgs Empty = new GetTransitGatewayMulticastGroupSourcePlainArgs();
    ...
    private GetTransitGatewayMulticastGroupSourcePlainArgs() {}

    private GetTransitGatewayMulticastGroupSourcePlainArgs(GetTransitGatewayMulticastGroupSourcePlainArgs $) {
    ...
    public static Builder builder(GetTransitGatewayMulticastGroupSourcePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransitGatewayMulticastGroupSourcePlainArgs();
        }

        public Builder(GetTransitGatewayMulticastGroupSourcePlainArgs defaults) {
            $ = new GetTransitGatewayMulticastGroupSourcePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTransitGatewayMulticastGroupSourcePlainArgs build() {
