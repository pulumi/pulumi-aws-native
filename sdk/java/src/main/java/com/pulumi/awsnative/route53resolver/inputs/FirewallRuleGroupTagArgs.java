 ...
 * 
 */
public final class FirewallRuleGroupTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirewallRuleGroupTagArgs Empty = new FirewallRuleGroupTagArgs();
    ...
    private FirewallRuleGroupTagArgs() {}

    private FirewallRuleGroupTagArgs(FirewallRuleGroupTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(FirewallRuleGroupTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallRuleGroupTagArgs();
        }

        public Builder(FirewallRuleGroupTagArgs defaults) {
            $ = new FirewallRuleGroupTagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FirewallRuleGroupTagArgs build() {
