...
public final class CertificateAuthorityKeyUsageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CertificateAuthorityKeyUsageArgs(CertificateAuthorityKeyUsageArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateAuthorityKeyUsageArgs();
        }

        public Builder(CertificateAuthorityKeyUsageArgs defaults) {
            $ = new CertificateAuthorityKeyUsageArgs(Objects.requireNonNull(defaults));
        }
