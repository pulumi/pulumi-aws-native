...
@CustomType
public final class ApplicationRecordColumn {
    /**
    ...
    public static Builder builder(ApplicationRecordColumn defaults) {
    ...
    public static final class Builder {
        ...
        private String sqlType;
        public Builder() {}
        public Builder(ApplicationRecordColumn defaults) {
        ...
        public ApplicationRecordColumn build() {
            final var o = new ApplicationRecordColumn();
            o.mapping = mapping;
            o.name = name;
            o.sqlType = sqlType;
            return o;
