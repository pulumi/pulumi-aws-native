 ...
 * 
 */
public final class BotS3BucketLogDestinationArgs extends com.pulumi.resources.ResourceArgs {

    public static final BotS3BucketLogDestinationArgs Empty = new BotS3BucketLogDestinationArgs();
    ...
    private BotS3BucketLogDestinationArgs() {}

    private BotS3BucketLogDestinationArgs(BotS3BucketLogDestinationArgs $) {
    ...
    public static Builder builder(BotS3BucketLogDestinationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BotS3BucketLogDestinationArgs();
        }

        public Builder(BotS3BucketLogDestinationArgs defaults) {
            $ = new BotS3BucketLogDestinationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BotS3BucketLogDestinationArgs build() {
