 ...
 * 
 */
public final class IPAMTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final IPAMTagArgs Empty = new IPAMTagArgs();
    ...
    private IPAMTagArgs(IPAMTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(IPAMTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IPAMTagArgs defaults) {
            $ = new IPAMTagArgs(Objects.requireNonNull(defaults));
        }
