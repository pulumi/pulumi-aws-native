 ...
 * 
 */
public final class RuleGroupCookieMatchPatternArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupCookieMatchPatternArgs Empty = new RuleGroupCookieMatchPatternArgs();
    ...
    private RuleGroupCookieMatchPatternArgs() {}

    private RuleGroupCookieMatchPatternArgs(RuleGroupCookieMatchPatternArgs $) {
        this.all = $.all;
    ...
    public static Builder builder(RuleGroupCookieMatchPatternArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupCookieMatchPatternArgs();
        }

        public Builder(RuleGroupCookieMatchPatternArgs defaults) {
            $ = new RuleGroupCookieMatchPatternArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuleGroupCookieMatchPatternArgs build() {
            return $;
        }
    }
