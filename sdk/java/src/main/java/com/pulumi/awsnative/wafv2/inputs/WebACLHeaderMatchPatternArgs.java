 ...
 * 
 */
public final class WebACLHeaderMatchPatternArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebACLHeaderMatchPatternArgs Empty = new WebACLHeaderMatchPatternArgs();
    ...
    private WebACLHeaderMatchPatternArgs() {}

    private WebACLHeaderMatchPatternArgs(WebACLHeaderMatchPatternArgs $) {
        this.all = $.all;
    ...
    public static Builder builder(WebACLHeaderMatchPatternArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebACLHeaderMatchPatternArgs();
        }

        public Builder(WebACLHeaderMatchPatternArgs defaults) {
            $ = new WebACLHeaderMatchPatternArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebACLHeaderMatchPatternArgs build() {
            return $;
        }
    }
