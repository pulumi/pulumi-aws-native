 ...
 * 
 */
public final class ModelPackageTagArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelPackageTagArgs Empty = new ModelPackageTagArgs();
    ...
    private ModelPackageTagArgs() {}

    private ModelPackageTagArgs(ModelPackageTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(ModelPackageTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelPackageTagArgs();
        }

        public Builder(ModelPackageTagArgs defaults) {
            $ = new ModelPackageTagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ModelPackageTagArgs build() {
