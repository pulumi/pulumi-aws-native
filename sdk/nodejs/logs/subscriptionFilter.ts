...
export class SubscriptionFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionFilter {
        return new SubscriptionFilter(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Logs.SubscriptionFilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Logs.SubscriptionFilterProperties>;
    ...
    constructor(name: string, argsOrState?: SubscriptionFilterArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SubscriptionFilterArgs | undefined;
...
export interface SubscriptionFilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Logs.SubscriptionFilterProperties>;
    /**
