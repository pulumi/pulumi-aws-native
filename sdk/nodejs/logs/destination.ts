...
export class Destination extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Logs:Destination';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Logs.DestinationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Logs.DestinationProperties>;
    ...
    constructor(name: string, argsOrState?: DestinationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DestinationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Logs.DestinationProperties>;
    /**
