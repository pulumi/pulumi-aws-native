...
export class MetricFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MetricFilter {
        return new MetricFilter(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Logs.MetricFilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Logs.MetricFilterProperties>;
    ...
    constructor(name: string, argsOrState?: MetricFilterArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as MetricFilterArgs | undefined;
...
export interface MetricFilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Logs.MetricFilterProperties>;
    /**
