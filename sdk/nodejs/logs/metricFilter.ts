...
export class MetricFilter extends pulumi.CustomResource {
     ...
     */
    public readonly emitSystemFieldDimensions!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public readonly fieldSelectionCriteria!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: MetricFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["emitSystemFieldDimensions"] = args ? args.emitSystemFieldDimensions : undefined;
            resourceInputs["fieldSelectionCriteria"] = args ? args.fieldSelectionCriteria : undefined;
