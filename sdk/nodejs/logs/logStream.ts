...
export class LogStream extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogStream {
        return new LogStream(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Logs.LogStreamAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Logs.LogStreamProperties>;
    ...
    constructor(name: string, argsOrState?: LogStreamArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LogStreamArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Logs.LogStreamProperties>;
    /**
