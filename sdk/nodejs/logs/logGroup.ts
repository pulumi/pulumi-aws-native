...
export class LogGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogGroup {
        return new LogGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Logs.LogGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Logs.LogGroupProperties>;
    ...
    constructor(name: string, argsOrState?: LogGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LogGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Logs.LogGroupProperties>;
    /**
