...
export class Broker extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Broker {
        return new Broker(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AmazonMQ.BrokerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AmazonMQ.BrokerProperties>;
    ...
    constructor(name: string, argsOrState?: BrokerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BrokerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AmazonMQ.BrokerProperties>;
    /**
