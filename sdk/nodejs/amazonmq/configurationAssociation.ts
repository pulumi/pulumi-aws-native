...
export class ConfigurationAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationAssociation {
        return new ConfigurationAssociation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AmazonMQ:ConfigurationAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AmazonMQ.ConfigurationAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AmazonMQ.ConfigurationAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ConfigurationAssociationArgs | undefined;
...
export interface ConfigurationAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AmazonMQ.ConfigurationAssociationProperties>;
    /**
