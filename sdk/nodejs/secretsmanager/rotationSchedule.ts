...
export class RotationSchedule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RotationSchedule {
        return new RotationSchedule(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SecretsManager.RotationScheduleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SecretsManager.RotationScheduleProperties>;
    ...
    constructor(name: string, argsOrState?: RotationScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as RotationScheduleArgs | undefined;
...
export interface RotationScheduleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SecretsManager.RotationScheduleProperties>;
    /**
