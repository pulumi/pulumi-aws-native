...
export class ResourcePolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourcePolicy {
        return new ResourcePolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SecretsManager:ResourcePolicy';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SecretsManager.ResourcePolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SecretsManager.ResourcePolicyProperties>;
    ...
    constructor(name: string, argsOrState?: ResourcePolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResourcePolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SecretsManager.ResourcePolicyProperties>;
    /**
