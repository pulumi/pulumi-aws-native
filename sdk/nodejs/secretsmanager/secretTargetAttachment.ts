...
export class SecretTargetAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecretTargetAttachment {
        return new SecretTargetAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SecretsManager:SecretTargetAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SecretsManager.SecretTargetAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SecretsManager.SecretTargetAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: SecretTargetAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SecretTargetAttachmentArgs | undefined;
...
export interface SecretTargetAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SecretsManager.SecretTargetAttachmentProperties>;
    /**
