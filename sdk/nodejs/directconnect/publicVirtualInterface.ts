...
export class PublicVirtualInterface extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicVirtualInterface {
        return new PublicVirtualInterface(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:directconnect:PublicVirtualInterface';
     ...
     */
    declare public readonly allocatePublicVirtualInterfaceRoleArn: pulumi.Output<string | undefined>;
    /**
     * The BGP peers configured on this virtual interface.
     */
    declare public readonly bgpPeers: pulumi.Output<outputs.directconnect.PublicVirtualInterfaceBgpPeer[]>;
    /**
    ...
    constructor(name: string, args: PublicVirtualInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["allocatePublicVirtualInterfaceRoleArn", "routeFilterPrefixes[*]", "vlan"] };
...
export interface PublicVirtualInterfaceArgs {
     ...
     * The BGP peers configured on this virtual interface.
     */
    bgpPeers: pulumi.Input<pulumi.Input<inputs.directconnect.PublicVirtualInterfaceBgpPeerArgs>[]>;
    /**
     * The ID or ARN of the connection or LAG.
     */
