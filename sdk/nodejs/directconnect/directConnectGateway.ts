...
export class DirectConnectGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DirectConnectGateway {
        return new DirectConnectGateway(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:directconnect:DirectConnectGateway';
     ...
     */
    declare public readonly amazonSideAsn: pulumi.Output<string | undefined>;
    /**
     * The ARN of the Direct Connect gateway.
     */
    declare public /*out*/ readonly directConnectGatewayArn: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args?: DirectConnectGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["directConnectGatewayArn"] = undefined /*out*/;
            resourceInputs["directConnectGatewayId"] = undefined /*out*/;
            resourceInputs["directConnectGatewayName"] = undefined /*out*/;
