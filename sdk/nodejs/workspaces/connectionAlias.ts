...
export class ConnectionAlias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WorkSpaces:ConnectionAlias';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WorkSpaces.ConnectionAliasAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WorkSpaces.ConnectionAliasProperties>;
...
export interface ConnectionAliasArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WorkSpaces.ConnectionAliasProperties>;
    /**
