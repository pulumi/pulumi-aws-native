...
export class DBInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Neptune:DBInstance';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Neptune.DBInstanceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Neptune.DBInstanceProperties>;
...
export interface DBInstanceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Neptune.DBInstanceProperties>;
    /**
