...
export class GlobalCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws-native:neptune:GlobalCluster';
     ...
     */
    declare public readonly engine: pulumi.Output<enums.neptune.GlobalClusterEngine | undefined>;
    /**
