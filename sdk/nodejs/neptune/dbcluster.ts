...
export class DBCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBCluster {
        return new DBCluster(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Neptune:DBCluster';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Neptune.DBClusterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Neptune.DBClusterProperties>;
    ...
    constructor(name: string, argsOrState?: DBClusterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DBClusterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Neptune.DBClusterProperties>;
    /**
