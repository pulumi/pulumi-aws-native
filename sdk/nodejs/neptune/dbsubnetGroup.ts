...
export class DBSubnetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Neptune:DBSubnetGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Neptune.DBSubnetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Neptune.DBSubnetGroupProperties>;
...
export interface DBSubnetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Neptune.DBSubnetGroupProperties>;
    /**
