...
export class DBParameterGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBParameterGroup {
        return new DBParameterGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Neptune:DBParameterGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Neptune.DBParameterGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Neptune.DBParameterGroupProperties>;
    ...
    constructor(name: string, argsOrState?: DBParameterGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DBParameterGroupArgs | undefined;
...
export interface DBParameterGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Neptune.DBParameterGroupProperties>;
    /**
