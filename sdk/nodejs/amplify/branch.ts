...
export class Branch extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Branch {
        return new Branch(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Amplify.BranchAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Amplify.BranchProperties>;
    ...
    constructor(name: string, argsOrState?: BranchArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BranchArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Amplify.BranchProperties>;
    /**
