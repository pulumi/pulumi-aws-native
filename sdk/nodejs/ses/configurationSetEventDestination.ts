...
export class ConfigurationSetEventDestination extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationSetEventDestination {
        return new ConfigurationSetEventDestination(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SES:ConfigurationSetEventDestination';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SES.ConfigurationSetEventDestinationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SES.ConfigurationSetEventDestinationProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationSetEventDestinationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigurationSetEventDestinationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SES.ConfigurationSetEventDestinationProperties>;
    /**
