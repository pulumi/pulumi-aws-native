...
export class ReceiptRuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptRuleSet {
        return new ReceiptRuleSet(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SES.ReceiptRuleSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SES.ReceiptRuleSetProperties>;
    ...
    constructor(name: string, argsOrState?: ReceiptRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReceiptRuleSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SES.ReceiptRuleSetProperties>;
    /**
