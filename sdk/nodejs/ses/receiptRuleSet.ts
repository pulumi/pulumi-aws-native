 ...
 *
 * @deprecated ReceiptRuleSet is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class ReceiptRuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptRuleSet {
        pulumi.log.warn("ReceiptRuleSet is deprecated: ReceiptRuleSet is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
    ...
    constructor(name: string, args?: ReceiptRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["ruleSetName"] };
