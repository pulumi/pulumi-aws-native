 ...
 *
 * @deprecated ReceiptFilter is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class ReceiptFilter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptFilter {
        pulumi.log.warn("ReceiptFilter is deprecated: ReceiptFilter is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
        return new ReceiptFilter(name, undefined as any, { ...opts, id: id });
    }
...
export interface ReceiptFilterArgs {
    filter: pulumi.Input<inputs.ses.ReceiptFilterFilterArgs>;
}
