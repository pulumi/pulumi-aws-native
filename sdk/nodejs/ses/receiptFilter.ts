...
export class ReceiptFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptFilter {
        return new ReceiptFilter(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SES.ReceiptFilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SES.ReceiptFilterProperties>;
    ...
    constructor(name: string, argsOrState?: ReceiptFilterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReceiptFilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SES.ReceiptFilterProperties>;
    /**
