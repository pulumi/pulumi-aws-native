...
export class ReceiptRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReceiptRule {
        return new ReceiptRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SES:ReceiptRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SES.ReceiptRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SES.ReceiptRuleProperties>;
    ...
    constructor(name: string, argsOrState?: ReceiptRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReceiptRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SES.ReceiptRuleProperties>;
    /**
