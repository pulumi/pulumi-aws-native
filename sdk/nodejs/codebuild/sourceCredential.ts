...
export class SourceCredential extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SourceCredential {
        return new SourceCredential(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodeBuild.SourceCredentialAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodeBuild.SourceCredentialProperties>;
    ...
    constructor(name: string, argsOrState?: SourceCredentialArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SourceCredentialArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodeBuild.SourceCredentialProperties>;
    /**
