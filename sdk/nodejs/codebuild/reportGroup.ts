...
export class ReportGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CodeBuild:ReportGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodeBuild.ReportGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodeBuild.ReportGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ReportGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReportGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodeBuild.ReportGroupProperties>;
    /**
