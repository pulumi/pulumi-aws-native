...
export class ResolverEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverEndpoint {
        return new ResolverEndpoint(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53Resolver.ResolverEndpointAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53Resolver.ResolverEndpointProperties>;
    ...
    constructor(name: string, argsOrState?: ResolverEndpointArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResolverEndpointArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53Resolver.ResolverEndpointProperties>;
    /**
