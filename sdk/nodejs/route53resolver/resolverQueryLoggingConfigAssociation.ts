...
export class ResolverQueryLoggingConfigAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53Resolver.ResolverQueryLoggingConfigAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53Resolver.ResolverQueryLoggingConfigAssociationProperties>;
...
export interface ResolverQueryLoggingConfigAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53Resolver.ResolverQueryLoggingConfigAssociationProperties>;
    /**
