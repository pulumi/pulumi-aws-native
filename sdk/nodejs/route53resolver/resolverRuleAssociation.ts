...
export class ResolverRuleAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverRuleAssociation {
        return new ResolverRuleAssociation(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53Resolver.ResolverRuleAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53Resolver.ResolverRuleAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: ResolverRuleAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResolverRuleAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53Resolver.ResolverRuleAssociationProperties>;
    /**
