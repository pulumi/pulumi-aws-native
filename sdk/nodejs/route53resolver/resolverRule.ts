...
export class ResolverRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResolverRule {
        return new ResolverRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Route53Resolver:ResolverRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53Resolver.ResolverRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53Resolver.ResolverRuleProperties>;
    ...
    constructor(name: string, argsOrState?: ResolverRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResolverRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53Resolver.ResolverRuleProperties>;
    /**
