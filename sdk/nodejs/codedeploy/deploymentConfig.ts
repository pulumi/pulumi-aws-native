...
export interface DeploymentConfigArgs {
     ...
     * The minimum number of healthy instances that should be available at any time during the deployment. There are two parameters expected in the input: type and value.
     */
    minimumHealthyHosts?: pulumi.Input<inputs.codedeploy.DeploymentConfigMinimumHealthyHostsArgs | undefined>;
    /**
     * The configuration that specifies how the deployment traffic is routed.
     */
    trafficRoutingConfig?: pulumi.Input<inputs.codedeploy.DeploymentConfigTrafficRoutingConfigArgs | undefined>;
    /**
     * The zonal deployment config that specifies how the zonal deployment behaves
     */
    zonalConfig?: pulumi.Input<inputs.codedeploy.DeploymentConfigZonalConfigArgs | undefined>;
}
