...
export class DeploymentConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeploymentConfig {
        return new DeploymentConfig(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodeDeploy.DeploymentConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodeDeploy.DeploymentConfigProperties>;
    ...
    constructor(name: string, argsOrState?: DeploymentConfigArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DeploymentConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodeDeploy.DeploymentConfigProperties>;
    /**
