...
export class Keyspace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Keyspace {
        return new Keyspace(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cassandra:Keyspace';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cassandra.KeyspaceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cassandra.KeyspaceProperties>;
    ...
    constructor(name: string, argsOrState?: KeyspaceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface KeyspaceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cassandra.KeyspaceProperties>;
    /**
