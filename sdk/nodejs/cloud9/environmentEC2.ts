...
export class EnvironmentEC2 extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentEC2 {
        return new EnvironmentEC2(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cloud9.EnvironmentEC2Attributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cloud9.EnvironmentEC2Properties>;
    ...
    constructor(name: string, argsOrState?: EnvironmentEC2Args, opts?: pulumi.CustomResourceOptions) {
...
export interface EnvironmentEC2Args {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cloud9.EnvironmentEC2Properties>;
    /**
