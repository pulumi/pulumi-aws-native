...
export class Model extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Model {
        return new Model(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:Model';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.ModelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.ModelProperties>;
    ...
    constructor(name: string, argsOrState?: ModelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ModelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.ModelProperties>;
    /**
