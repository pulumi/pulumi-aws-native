...
export class DocumentationPart extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DocumentationPart {
        return new DocumentationPart(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.DocumentationPartAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.DocumentationPartProperties>;
    ...
    constructor(name: string, argsOrState?: DocumentationPartArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DocumentationPartArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.DocumentationPartProperties>;
    /**
