...
export class ClientCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientCertificate {
        return new ClientCertificate(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.ClientCertificateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.ClientCertificateProperties>;
    ...
    constructor(name: string, argsOrState?: ClientCertificateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ClientCertificateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.ClientCertificateProperties>;
    /**
