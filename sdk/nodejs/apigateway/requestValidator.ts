...
export class RequestValidator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RequestValidator {
        return new RequestValidator(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.RequestValidatorAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.RequestValidatorProperties>;
    ...
    constructor(name: string, argsOrState?: RequestValidatorArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RequestValidatorArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.RequestValidatorProperties>;
    /**
