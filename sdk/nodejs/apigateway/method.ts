...
export class Method extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Method {
        return new Method(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.MethodAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.MethodProperties>;
    ...
    constructor(name: string, argsOrState?: MethodArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MethodArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.MethodProperties>;
    /**
