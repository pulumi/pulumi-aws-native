...
export class VpcLink extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VpcLink {
        return new VpcLink(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:VpcLink';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.VpcLinkAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.VpcLinkProperties>;
    ...
    constructor(name: string, argsOrState?: VpcLinkArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VpcLinkArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.VpcLinkProperties>;
    /**
