...
export class UsagePlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UsagePlan {
        return new UsagePlan(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:UsagePlan';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.UsagePlanAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.UsagePlanProperties>;
    ...
    constructor(name: string, argsOrState?: UsagePlanArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface UsagePlanArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.UsagePlanProperties>;
    /**
