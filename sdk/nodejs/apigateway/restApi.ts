...
export class RestApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:RestApi';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.RestApiAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.RestApiProperties>;
    ...
    constructor(name: string, argsOrState?: RestApiArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RestApiArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.RestApiProperties>;
    /**
