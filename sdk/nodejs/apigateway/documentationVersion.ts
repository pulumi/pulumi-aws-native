...
export class DocumentationVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DocumentationVersion {
        return new DocumentationVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:DocumentationVersion';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.DocumentationVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.DocumentationVersionProperties>;
    ...
    constructor(name: string, argsOrState?: DocumentationVersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DocumentationVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.DocumentationVersionProperties>;
    /**
