...
export class UsagePlanKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UsagePlanKey {
        return new UsagePlanKey(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:UsagePlanKey';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.UsagePlanKeyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.UsagePlanKeyProperties>;
    ...
    constructor(name: string, argsOrState?: UsagePlanKeyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface UsagePlanKeyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.UsagePlanKeyProperties>;
    /**
