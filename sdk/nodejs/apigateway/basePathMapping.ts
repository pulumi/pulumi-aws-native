...
export class BasePathMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BasePathMapping {
        return new BasePathMapping(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.BasePathMappingAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.BasePathMappingProperties>;
    ...
    constructor(name: string, argsOrState?: BasePathMappingArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BasePathMappingArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.BasePathMappingProperties>;
    /**
