...
export class GatewayResponse extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGateway:GatewayResponse';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGateway.GatewayResponseAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGateway.GatewayResponseProperties>;
    ...
    constructor(name: string, argsOrState?: GatewayResponseArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as GatewayResponseArgs | undefined;
...
export interface GatewayResponseArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGateway.GatewayResponseProperties>;
    /**
