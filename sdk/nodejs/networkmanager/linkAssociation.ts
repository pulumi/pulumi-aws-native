...
export class LinkAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LinkAssociation {
        return new LinkAssociation(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.NetworkManager.LinkAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.NetworkManager.LinkAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: LinkAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LinkAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.NetworkManager.LinkAssociationProperties>;
    /**
