...
export class CustomerGatewayAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomerGatewayAssociation {
        return new CustomerGatewayAssociation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:NetworkManager:CustomerGatewayAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.NetworkManager.CustomerGatewayAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.NetworkManager.CustomerGatewayAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: CustomerGatewayAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CustomerGatewayAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.NetworkManager.CustomerGatewayAssociationProperties>;
    /**
