...
export class TransitGatewayRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:NetworkManager:TransitGatewayRegistration';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.NetworkManager.TransitGatewayRegistrationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.NetworkManager.TransitGatewayRegistrationProperties>;
    ...
    constructor(name: string, argsOrState?: TransitGatewayRegistrationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TransitGatewayRegistrationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.NetworkManager.TransitGatewayRegistrationProperties>;
    /**
