...
export class Accelerator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Accelerator {
        return new Accelerator(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GlobalAccelerator:Accelerator';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GlobalAccelerator.AcceleratorAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GlobalAccelerator.AcceleratorProperties>;
    ...
    constructor(name: string, argsOrState?: AcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AcceleratorArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GlobalAccelerator.AcceleratorProperties>;
    /**
