...
export class DirectoryConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DirectoryConfig {
        return new DirectoryConfig(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppStream.DirectoryConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppStream.DirectoryConfigProperties>;
    ...
    constructor(name: string, argsOrState?: DirectoryConfigArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DirectoryConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppStream.DirectoryConfigProperties>;
    /**
