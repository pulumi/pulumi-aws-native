...
export class StackFleetAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppStream:StackFleetAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppStream.StackFleetAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppStream.StackFleetAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: StackFleetAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as StackFleetAssociationArgs | undefined;
...
export interface StackFleetAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppStream.StackFleetAssociationProperties>;
    /**
