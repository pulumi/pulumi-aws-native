...
export class StackUserAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppStream:StackUserAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppStream.StackUserAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppStream.StackUserAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: StackUserAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as StackUserAssociationArgs | undefined;
...
export interface StackUserAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppStream.StackUserAssociationProperties>;
    /**
