...
export class ImageBuilder extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ImageBuilder {
        return new ImageBuilder(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppStream:ImageBuilder';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppStream.ImageBuilderAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppStream.ImageBuilderProperties>;
    ...
    constructor(name: string, argsOrState?: ImageBuilderArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ImageBuilderArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppStream.ImageBuilderProperties>;
    /**
