...
export class Skill extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Skill {
        return new Skill(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ASK.SkillAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ASK.SkillProperties>;
    ...
    constructor(name: string, argsOrState?: SkillArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SkillArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ASK.SkillProperties>;
    /**
