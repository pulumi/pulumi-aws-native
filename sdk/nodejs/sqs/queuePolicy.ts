...
export class QueuePolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): QueuePolicy {
        return new QueuePolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SQS:QueuePolicy';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SQS.QueuePolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SQS.QueuePolicyProperties>;
    ...
    constructor(name: string, argsOrState?: QueuePolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface QueuePolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SQS.QueuePolicyProperties>;
    /**
