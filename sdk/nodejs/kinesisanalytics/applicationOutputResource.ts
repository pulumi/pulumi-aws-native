 ...
 *
 * @deprecated ApplicationOutputResource is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class ApplicationOutputResource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationOutputResource {
        pulumi.log.warn("ApplicationOutputResource is deprecated: ApplicationOutputResource is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
        return new ApplicationOutputResource(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:kinesisanalytics:ApplicationOutputResource';
    ...
    public readonly output!: pulumi.Output<outputs.kinesisanalytics.ApplicationOutputResourceOutput>;
...
export interface ApplicationOutputResourceArgs {
    ...
    output: pulumi.Input<inputs.kinesisanalytics.ApplicationOutputResourceOutputArgs>;
}
