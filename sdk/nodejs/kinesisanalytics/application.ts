 ...
 *
 * @deprecated Application is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class Application extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Application {
        pulumi.log.warn("Application is deprecated: Application is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
        return new Application(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:kinesisanalytics:Application';
    ...
    public readonly applicationCode!: pulumi.Output<string | undefined>;
    ...
    public readonly inputs!: pulumi.Output<outputs.kinesisanalytics.ApplicationInput[]>;
...
export interface ApplicationArgs {
    ...
    inputs: pulumi.Input<pulumi.Input<inputs.kinesisanalytics.ApplicationInputArgs>[]>;
}
