...
export class AssessmentTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentTemplate {
        return new AssessmentTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Inspector:AssessmentTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Inspector.AssessmentTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Inspector.AssessmentTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: AssessmentTemplateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AssessmentTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Inspector.AssessmentTemplateProperties>;
    /**
