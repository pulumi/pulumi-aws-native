...
export class AssessmentTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AssessmentTarget {
        return new AssessmentTarget(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Inspector:AssessmentTarget';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Inspector.AssessmentTargetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Inspector.AssessmentTargetProperties>;
    ...
    constructor(name: string, argsOrState?: AssessmentTargetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AssessmentTargetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Inspector.AssessmentTargetProperties>;
    /**
