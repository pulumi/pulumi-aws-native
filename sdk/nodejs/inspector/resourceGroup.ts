...
export class ResourceGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Inspector.ResourceGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Inspector.ResourceGroupProperties>;
...
export interface ResourceGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Inspector.ResourceGroupProperties>;
    /**
