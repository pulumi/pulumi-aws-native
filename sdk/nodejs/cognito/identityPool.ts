...
export class IdentityPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IdentityPool {
        return new IdentityPool(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:IdentityPool';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.IdentityPoolAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.IdentityPoolProperties>;
    ...
    constructor(name: string, argsOrState?: IdentityPoolArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IdentityPoolArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.IdentityPoolProperties>;
    /**
