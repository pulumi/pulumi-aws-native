...
export class UserPoolRiskConfigurationAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolRiskConfigurationAttachment {
        return new UserPoolRiskConfigurationAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:UserPoolRiskConfigurationAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolRiskConfigurationAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolRiskConfigurationAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolRiskConfigurationAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as UserPoolRiskConfigurationAttachmentArgs | undefined;
...
export interface UserPoolRiskConfigurationAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolRiskConfigurationAttachmentProperties>;
    /**
