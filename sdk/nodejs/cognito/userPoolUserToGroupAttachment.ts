...
export class UserPoolUserToGroupAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolUserToGroupAttachment {
        return new UserPoolUserToGroupAttachment(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolUserToGroupAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolUserToGroupAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolUserToGroupAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as UserPoolUserToGroupAttachmentArgs | undefined;
...
export interface UserPoolUserToGroupAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolUserToGroupAttachmentProperties>;
    /**
