...
export class UserPoolUICustomizationAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolUICustomizationAttachment {
        return new UserPoolUICustomizationAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:UserPoolUICustomizationAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolUICustomizationAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolUICustomizationAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolUICustomizationAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as UserPoolUICustomizationAttachmentArgs | undefined;
...
export interface UserPoolUICustomizationAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolUICustomizationAttachmentProperties>;
    /**
