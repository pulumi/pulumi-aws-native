...
export class UserPoolClient extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolClient {
        return new UserPoolClient(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:UserPoolClient';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolClientAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolClientProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolClientArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface UserPoolClientArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolClientProperties>;
    /**
