...
export class UserPoolDomain extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolDomain {
        return new UserPoolDomain(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolDomainAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolDomainProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolDomainArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface UserPoolDomainArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolDomainProperties>;
    /**
