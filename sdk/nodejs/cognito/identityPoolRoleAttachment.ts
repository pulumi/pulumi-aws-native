...
export class IdentityPoolRoleAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IdentityPoolRoleAttachment {
        return new IdentityPoolRoleAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:IdentityPoolRoleAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.IdentityPoolRoleAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.IdentityPoolRoleAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: IdentityPoolRoleAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IdentityPoolRoleAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.IdentityPoolRoleAttachmentProperties>;
    /**
