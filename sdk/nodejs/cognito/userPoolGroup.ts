...
export class UserPoolGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserPoolGroup {
        return new UserPoolGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Cognito:UserPoolGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Cognito.UserPoolGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Cognito.UserPoolGroupProperties>;
    ...
    constructor(name: string, argsOrState?: UserPoolGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as UserPoolGroupArgs | undefined;
...
export interface UserPoolGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Cognito.UserPoolGroupProperties>;
    /**
