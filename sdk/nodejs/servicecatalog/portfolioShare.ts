...
export class PortfolioShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PortfolioShare {
        return new PortfolioShare(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:PortfolioShare';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.PortfolioShareAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.PortfolioShareProperties>;
    ...
    constructor(name: string, argsOrState?: PortfolioShareArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PortfolioShareArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.PortfolioShareProperties>;
    /**
