...
export class LaunchTemplateConstraint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LaunchTemplateConstraint {
        return new LaunchTemplateConstraint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:LaunchTemplateConstraint';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.LaunchTemplateConstraintAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.LaunchTemplateConstraintProperties>;
    ...
    constructor(name: string, argsOrState?: LaunchTemplateConstraintArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as LaunchTemplateConstraintArgs | undefined;
...
export interface LaunchTemplateConstraintArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.LaunchTemplateConstraintProperties>;
    /**
