...
export class LaunchNotificationConstraint extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.LaunchNotificationConstraintAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.LaunchNotificationConstraintProperties>;
    ...
    constructor(name: string, argsOrState?: LaunchNotificationConstraintArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as LaunchNotificationConstraintArgs | undefined;
...
export interface LaunchNotificationConstraintArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.LaunchNotificationConstraintProperties>;
    /**
