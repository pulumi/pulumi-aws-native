 ...
 *
 * @deprecated LaunchNotificationConstraint is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class LaunchNotificationConstraint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LaunchNotificationConstraint {
        pulumi.log.warn("LaunchNotificationConstraint is deprecated: LaunchNotificationConstraint is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
