...
export class Portfolio extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Portfolio {
        return new Portfolio(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:Portfolio';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.PortfolioAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.PortfolioProperties>;
    ...
    constructor(name: string, argsOrState?: PortfolioArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PortfolioArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.PortfolioProperties>;
    /**
