...
export class LaunchRoleConstraint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LaunchRoleConstraint {
        return new LaunchRoleConstraint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:LaunchRoleConstraint';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.LaunchRoleConstraintAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.LaunchRoleConstraintProperties>;
    ...
    constructor(name: string, argsOrState?: LaunchRoleConstraintArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as LaunchRoleConstraintArgs | undefined;
...
export interface LaunchRoleConstraintArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.LaunchRoleConstraintProperties>;
    /**
