...
export class TagOption extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagOption {
        return new TagOption(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.TagOptionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.TagOptionProperties>;
    ...
    constructor(name: string, argsOrState?: TagOptionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TagOptionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.TagOptionProperties>;
    /**
