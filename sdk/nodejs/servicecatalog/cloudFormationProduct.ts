...
export class CloudFormationProduct extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:CloudFormationProduct';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.CloudFormationProductAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.CloudFormationProductProperties>;
    ...
    constructor(name: string, argsOrState?: CloudFormationProductArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CloudFormationProductArgs | undefined;
...
export interface CloudFormationProductArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.CloudFormationProductProperties>;
    /**
