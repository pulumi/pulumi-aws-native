...
export class CloudFormationProvisionedProduct extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CloudFormationProvisionedProduct {
        return new CloudFormationProvisionedProduct(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:CloudFormationProvisionedProduct';
    ...
    constructor(name: string, argsOrState?: CloudFormationProvisionedProductArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CloudFormationProvisionedProductArgs | undefined;
