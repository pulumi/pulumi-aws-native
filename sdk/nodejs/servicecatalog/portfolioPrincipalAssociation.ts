...
export class PortfolioPrincipalAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:PortfolioPrincipalAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.PortfolioPrincipalAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.PortfolioPrincipalAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: PortfolioPrincipalAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PortfolioPrincipalAssociationArgs | undefined;
...
export interface PortfolioPrincipalAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.PortfolioPrincipalAssociationProperties>;
    /**
