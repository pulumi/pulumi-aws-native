 ...
 *
 * @deprecated AcceptedPortfolioShare is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class AcceptedPortfolioShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AcceptedPortfolioShare {
        pulumi.log.warn("AcceptedPortfolioShare is deprecated: AcceptedPortfolioShare is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")
    ...
    constructor(name: string, args: AcceptedPortfolioShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["acceptLanguage", "portfolioId"] };
