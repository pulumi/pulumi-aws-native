...
export class AcceptedPortfolioShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AcceptedPortfolioShare {
        return new AcceptedPortfolioShare(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:AcceptedPortfolioShare';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.AcceptedPortfolioShareAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.AcceptedPortfolioShareProperties>;
    ...
    constructor(name: string, argsOrState?: AcceptedPortfolioShareArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as AcceptedPortfolioShareArgs | undefined;
...
export interface AcceptedPortfolioShareArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.AcceptedPortfolioShareProperties>;
    /**
