...
export class ResourceUpdateConstraint extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.ResourceUpdateConstraintAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.ResourceUpdateConstraintProperties>;
    ...
    constructor(name: string, argsOrState?: ResourceUpdateConstraintArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ResourceUpdateConstraintArgs | undefined;
...
export interface ResourceUpdateConstraintArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.ResourceUpdateConstraintProperties>;
    /**
