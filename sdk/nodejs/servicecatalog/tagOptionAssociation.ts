...
export class TagOptionAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceCatalog:TagOptionAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceCatalog.TagOptionAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceCatalog.TagOptionAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: TagOptionAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TagOptionAssociationArgs | undefined;
...
export interface TagOptionAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceCatalog.TagOptionAssociationProperties>;
    /**
