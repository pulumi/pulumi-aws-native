...
export class Graph extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Graph {
        return new Graph(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Detective:Graph';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Detective.GraphAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Detective.GraphProperties>;
    ...
    constructor(name: string, argsOrState?: GraphArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GraphArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Detective.GraphProperties>;
    /**
