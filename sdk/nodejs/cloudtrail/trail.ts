...
export class Trail extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Trail {
        return new Trail(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudTrail.TrailAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudTrail.TrailProperties>;
    ...
    constructor(name: string, argsOrState?: TrailArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TrailArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudTrail.TrailProperties>;
    /**
