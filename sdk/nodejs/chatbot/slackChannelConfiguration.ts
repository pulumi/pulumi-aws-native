...
export class SlackChannelConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SlackChannelConfiguration {
        return new SlackChannelConfiguration(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Chatbot:SlackChannelConfiguration';
    ...
    constructor(name: string, argsOrState?: SlackChannelConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
