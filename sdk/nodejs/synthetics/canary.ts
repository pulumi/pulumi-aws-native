...
export class Canary extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Canary {
        return new Canary(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Synthetics.CanaryAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Synthetics.CanaryProperties>;
    ...
    constructor(name: string, argsOrState?: CanaryArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CanaryArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Synthetics.CanaryProperties>;
    /**
