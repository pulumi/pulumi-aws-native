...
export class EmailChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EmailChannel {
        return new EmailChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:EmailChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.EmailChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.EmailChannelProperties>;
    ...
    constructor(name: string, argsOrState?: EmailChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EmailChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.EmailChannelProperties>;
    /**
