...
export class APNSVoipChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APNSVoipChannel {
        return new APNSVoipChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:APNSVoipChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.APNSVoipChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.APNSVoipChannelProperties>;
    ...
    constructor(name: string, argsOrState?: APNSVoipChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface APNSVoipChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.APNSVoipChannelProperties>;
    /**
