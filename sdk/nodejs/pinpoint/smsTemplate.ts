...
export class SmsTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SmsTemplate {
        return new SmsTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:SmsTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.SmsTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.SmsTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: SmsTemplateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SmsTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.SmsTemplateProperties>;
    /**
