...
export class BaiduChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BaiduChannel {
        return new BaiduChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:BaiduChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.BaiduChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.BaiduChannelProperties>;
    ...
    constructor(name: string, argsOrState?: BaiduChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BaiduChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.BaiduChannelProperties>;
    /**
