...
export class EventStream extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventStream {
        return new EventStream(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:EventStream';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.EventStreamAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.EventStreamProperties>;
    ...
    constructor(name: string, argsOrState?: EventStreamArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EventStreamArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.EventStreamProperties>;
    /**
