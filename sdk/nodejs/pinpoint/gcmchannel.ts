...
export class GCMChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GCMChannel {
        return new GCMChannel(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.GCMChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.GCMChannelProperties>;
    ...
    constructor(name: string, argsOrState?: GCMChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GCMChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.GCMChannelProperties>;
    /**
