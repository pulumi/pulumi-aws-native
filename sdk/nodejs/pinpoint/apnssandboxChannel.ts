...
export class APNSSandboxChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APNSSandboxChannel {
        return new APNSSandboxChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:APNSSandboxChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.APNSSandboxChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.APNSSandboxChannelProperties>;
    ...
    constructor(name: string, argsOrState?: APNSSandboxChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface APNSSandboxChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.APNSSandboxChannelProperties>;
    /**
