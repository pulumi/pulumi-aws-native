...
export class SMSChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SMSChannel {
        return new SMSChannel(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.SMSChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.SMSChannelProperties>;
    ...
    constructor(name: string, argsOrState?: SMSChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SMSChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.SMSChannelProperties>;
    /**
