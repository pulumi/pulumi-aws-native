...
export class APNSChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APNSChannel {
        return new APNSChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:APNSChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.APNSChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.APNSChannelProperties>;
    ...
    constructor(name: string, argsOrState?: APNSChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface APNSChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.APNSChannelProperties>;
    /**
