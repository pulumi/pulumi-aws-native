...
export class PushTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PushTemplate {
        return new PushTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:PushTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.PushTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.PushTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: PushTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PushTemplateArgs | undefined;
...
export interface PushTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.PushTemplateProperties>;
    /**
