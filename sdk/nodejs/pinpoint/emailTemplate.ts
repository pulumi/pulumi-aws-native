...
export class EmailTemplate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.EmailTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.EmailTemplateProperties>;
...
export interface EmailTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.EmailTemplateProperties>;
    /**
