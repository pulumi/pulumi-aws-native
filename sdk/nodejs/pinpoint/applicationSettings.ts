...
export class ApplicationSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationSettings {
        return new ApplicationSettings(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.ApplicationSettingsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.ApplicationSettingsProperties>;
    ...
    constructor(name: string, argsOrState?: ApplicationSettingsArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ApplicationSettingsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.ApplicationSettingsProperties>;
    /**
