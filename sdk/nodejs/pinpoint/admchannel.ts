...
export class ADMChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADMChannel {
        return new ADMChannel(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.ADMChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.ADMChannelProperties>;
    ...
    constructor(name: string, argsOrState?: ADMChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ADMChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.ADMChannelProperties>;
    /**
