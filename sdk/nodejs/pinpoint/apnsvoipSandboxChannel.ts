...
export class APNSVoipSandboxChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APNSVoipSandboxChannel {
        return new APNSVoipSandboxChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:APNSVoipSandboxChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.APNSVoipSandboxChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.APNSVoipSandboxChannelProperties>;
    ...
    constructor(name: string, argsOrState?: APNSVoipSandboxChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface APNSVoipSandboxChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.APNSVoipSandboxChannelProperties>;
    /**
