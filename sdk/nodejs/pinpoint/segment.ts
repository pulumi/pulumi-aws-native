...
export class Segment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Segment {
        return new Segment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:Segment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.SegmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.SegmentProperties>;
    ...
    constructor(name: string, argsOrState?: SegmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SegmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.SegmentProperties>;
    /**
