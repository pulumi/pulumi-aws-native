...
export class Campaign extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Campaign {
        return new Campaign(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Pinpoint:Campaign';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Pinpoint.CampaignAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Pinpoint.CampaignProperties>;
    ...
    constructor(name: string, argsOrState?: CampaignArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CampaignArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Pinpoint.CampaignProperties>;
    /**
