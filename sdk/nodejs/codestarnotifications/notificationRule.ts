...
export class NotificationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotificationRule {
        return new NotificationRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CodeStarNotifications:NotificationRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodeStarNotifications.NotificationRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodeStarNotifications.NotificationRuleProperties>;
    ...
    constructor(name: string, argsOrState?: NotificationRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NotificationRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodeStarNotifications.NotificationRuleProperties>;
    /**
