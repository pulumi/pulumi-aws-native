...
export class Stream extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Stream {
        return new Stream(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Kinesis:Stream';
    ...
    constructor(name: string, argsOrState?: StreamArgs, opts?: pulumi.CustomResourceOptions) {
