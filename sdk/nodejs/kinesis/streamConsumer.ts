...
export class StreamConsumer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamConsumer {
        return new StreamConsumer(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Kinesis.StreamConsumerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Kinesis.StreamConsumerProperties>;
    ...
    constructor(name: string, argsOrState?: StreamConsumerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface StreamConsumerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Kinesis.StreamConsumerProperties>;
    /**
