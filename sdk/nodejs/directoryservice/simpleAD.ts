...
export class SimpleAD extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SimpleAD {
        return new SimpleAD(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:DirectoryService:SimpleAD';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DirectoryService.SimpleADAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DirectoryService.SimpleADProperties>;
    ...
    constructor(name: string, argsOrState?: SimpleADArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SimpleADArgs | undefined;
...
export interface SimpleADArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DirectoryService.SimpleADProperties>;
    /**
