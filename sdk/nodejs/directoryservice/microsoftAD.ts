...
export class MicrosoftAD extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MicrosoftAD {
        return new MicrosoftAD(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DirectoryService.MicrosoftADAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DirectoryService.MicrosoftADProperties>;
    ...
    constructor(name: string, argsOrState?: MicrosoftADArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as MicrosoftADArgs | undefined;
...
export interface MicrosoftADArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DirectoryService.MicrosoftADProperties>;
    /**
