...
export class MountTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MountTarget {
        return new MountTarget(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EFS:MountTarget';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EFS.MountTargetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EFS.MountTargetProperties>;
    ...
    constructor(name: string, argsOrState?: MountTargetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MountTargetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EFS.MountTargetProperties>;
    /**
