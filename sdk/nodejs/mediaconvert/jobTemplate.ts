...
export class JobTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobTemplate {
        return new JobTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:MediaConvert:JobTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.MediaConvert.JobTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.MediaConvert.JobTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: JobTemplateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface JobTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.MediaConvert.JobTemplateProperties>;
    /**
