...
export class Preset extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Preset {
        return new Preset(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.MediaConvert.PresetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.MediaConvert.PresetProperties>;
    ...
    constructor(name: string, argsOrState?: PresetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PresetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.MediaConvert.PresetProperties>;
    /**
