...
export class StreamingDistribution extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StreamingDistribution {
        return new StreamingDistribution(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudFront.StreamingDistributionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudFront.StreamingDistributionProperties>;
    ...
    constructor(name: string, argsOrState?: StreamingDistributionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as StreamingDistributionArgs | undefined;
...
export interface StreamingDistributionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudFront.StreamingDistributionProperties>;
    /**
