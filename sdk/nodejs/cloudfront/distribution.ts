...
export class Distribution extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Distribution {
        return new Distribution(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CloudFront:Distribution';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudFront.DistributionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudFront.DistributionProperties>;
    ...
    constructor(name: string, argsOrState?: DistributionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DistributionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudFront.DistributionProperties>;
    /**
