...
export class KeyGroup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudFront.KeyGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudFront.KeyGroupProperties>;
...
export interface KeyGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudFront.KeyGroupProperties>;
    /**
