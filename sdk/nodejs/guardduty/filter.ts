...
export class Filter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Filter {
        return new Filter(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:Filter';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.FilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.FilterProperties>;
    ...
    constructor(name: string, argsOrState?: FilterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface FilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.FilterProperties>;
    /**
