...
export class Detector extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Detector {
        return new Detector(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:Detector';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.DetectorAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.DetectorProperties>;
    ...
    constructor(name: string, argsOrState?: DetectorArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DetectorArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.DetectorProperties>;
    /**
