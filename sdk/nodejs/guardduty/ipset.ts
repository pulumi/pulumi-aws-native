...
export class IPSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:IPSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.IPSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.IPSetProperties>;
...
export interface IPSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.IPSetProperties>;
    /**
