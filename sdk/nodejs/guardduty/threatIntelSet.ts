...
export class ThreatIntelSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThreatIntelSet {
        return new ThreatIntelSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:ThreatIntelSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.ThreatIntelSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.ThreatIntelSetProperties>;
    ...
    constructor(name: string, argsOrState?: ThreatIntelSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ThreatIntelSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.ThreatIntelSetProperties>;
    /**
