...
export class Master extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Master {
        return new Master(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:Master';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.MasterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.MasterProperties>;
    ...
    constructor(name: string, argsOrState?: MasterArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as MasterArgs | undefined;
...
export interface MasterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.MasterProperties>;
    /**
