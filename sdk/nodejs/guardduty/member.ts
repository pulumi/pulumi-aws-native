...
export class Member extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GuardDuty:Member';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GuardDuty.MemberAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GuardDuty.MemberProperties>;
...
export interface MemberArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GuardDuty.MemberProperties>;
    /**
