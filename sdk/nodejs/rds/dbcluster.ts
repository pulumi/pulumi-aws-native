...
export class DBCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:DBCluster';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.DBClusterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.DBClusterProperties>;
...
export interface DBClusterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.DBClusterProperties>;
    /**
