...
export class DBClusterParameterGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBClusterParameterGroup {
        return new DBClusterParameterGroup(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: DBClusterParameterGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DBClusterParameterGroupArgs | undefined;
