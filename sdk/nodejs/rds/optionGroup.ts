...
export class OptionGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OptionGroup {
        return new OptionGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:OptionGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.OptionGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.OptionGroupProperties>;
    ...
    constructor(name: string, argsOrState?: OptionGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface OptionGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.OptionGroupProperties>;
    /**
