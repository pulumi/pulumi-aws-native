...
export class DBSecurityGroupIngress extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBSecurityGroupIngress {
        return new DBSecurityGroupIngress(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:DBSecurityGroupIngress';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.DBSecurityGroupIngressAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.DBSecurityGroupIngressProperties>;
    ...
    constructor(name: string, argsOrState?: DBSecurityGroupIngressArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DBSecurityGroupIngressArgs | undefined;
...
export interface DBSecurityGroupIngressArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.DBSecurityGroupIngressProperties>;
    /**
