...
export class DBInstance extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.DBInstanceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.DBInstanceProperties>;
...
export interface DBInstanceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.DBInstanceProperties>;
    /**
