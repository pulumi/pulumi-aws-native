...
export class DBProxyTargetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBProxyTargetGroup {
        return new DBProxyTargetGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:DBProxyTargetGroup';
    ...
    constructor(name: string, argsOrState?: DBProxyTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DBProxyTargetGroupArgs | undefined;
