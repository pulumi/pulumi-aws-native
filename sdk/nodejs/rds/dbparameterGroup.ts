...
export class DBParameterGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:DBParameterGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.DBParameterGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.DBParameterGroupProperties>;
...
export interface DBParameterGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.DBParameterGroupProperties>;
    /**
