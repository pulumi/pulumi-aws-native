...
export class DBSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DBSecurityGroup {
        return new DBSecurityGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RDS:DBSecurityGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RDS.DBSecurityGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RDS.DBSecurityGroupProperties>;
    ...
    constructor(name: string, argsOrState?: DBSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DBSecurityGroupArgs | undefined;
...
export interface DBSecurityGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RDS.DBSecurityGroupProperties>;
    /**
