...
export class CacheCluster extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CacheCluster {
        return new CacheCluster(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElastiCache.CacheClusterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElastiCache.CacheClusterProperties>;
    ...
    constructor(name: string, argsOrState?: CacheClusterArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CacheClusterArgs | undefined;
...
export interface CacheClusterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElastiCache.CacheClusterProperties>;
    /**
