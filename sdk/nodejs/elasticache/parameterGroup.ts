...
export class ParameterGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ParameterGroup {
        return new ParameterGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ElastiCache:ParameterGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElastiCache.ParameterGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElastiCache.ParameterGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ParameterGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ParameterGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElastiCache.ParameterGroupProperties>;
    /**
