...
export class SubnetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubnetGroup {
        return new SubnetGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ElastiCache:SubnetGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElastiCache.SubnetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElastiCache.SubnetGroupProperties>;
    ...
    constructor(name: string, argsOrState?: SubnetGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SubnetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElastiCache.SubnetGroupProperties>;
    /**
