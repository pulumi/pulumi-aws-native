...
export class ReplicationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationGroup {
        return new ReplicationGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElastiCache.ReplicationGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElastiCache.ReplicationGroupProperties>;
    /**
     * The update policy associated with the resource
     */
    public readonly updatePolicy!: pulumi.Output<outputs.ElastiCache.ReplicationGroupUpdatePolicy | undefined>;
    ...
    constructor(name: string, argsOrState?: ReplicationGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReplicationGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElastiCache.ReplicationGroupProperties>;
    /**
     * The update policy associated with the resource
     */
    readonly updatePolicy?: pulumi.Input<inputs.ElastiCache.ReplicationGroupUpdatePolicy>;
    /**
