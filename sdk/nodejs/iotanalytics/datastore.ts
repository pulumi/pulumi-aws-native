...
export class Datastore extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoTAnalytics.DatastoreAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoTAnalytics.DatastoreProperties>;
...
export interface DatastoreArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoTAnalytics.DatastoreProperties>;
    /**
