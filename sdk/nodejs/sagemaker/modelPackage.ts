...
export interface ModelPackageArgs {
     ...
     * An array of additional Inference Specification objects.
     */
    additionalInferenceSpecifications?: pulumi.Input<pulumi.Input<inputs.sagemaker.ModelPackageAdditionalInferenceSpecificationDefinitionArgs>[] | undefined>;
    /**
     * An array of additional Inference Specification objects to be added to the existing array. The total number of additional Inference Specification objects cannot exceed 15. Each additional Inference Specification object specifies artifacts based on this model package that can be used on inference endpoints. Generally used with SageMaker Neo to store the compiled artifacts.
     */
    additionalInferenceSpecificationsToAdd?: pulumi.Input<pulumi.Input<inputs.sagemaker.ModelPackageAdditionalInferenceSpecificationDefinitionArgs>[] | undefined>;
    /**
     * A description provided when the model approval is set.
     */
    approvalDescription?: pulumi.Input<string | undefined>;
    /**
     * Whether the model package is to be certified to be listed on AWS Marketplace. For information about listing model packages on AWS Marketplace, see [List Your Algorithm or Model Package on AWS Marketplace](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-mkt-list.html) .
     */
     ...
     * The metadata properties for the model package.
     */
    customerMetadataProperties?: pulumi.Input<inputs.sagemaker.ModelPackageCustomerMetadataPropertiesArgs | undefined>;
    /**
     * The machine learning domain of your model package and its components. Common machine learning domains include computer vision and natural language processing.
     */
     ...
     * Represents the drift check baselines that can be used when the model monitor is set using the model package.
     */
    driftCheckBaselines?: pulumi.Input<inputs.sagemaker.ModelPackageDriftCheckBaselinesArgs | undefined>;
    /**
     * Defines how to perform inference generation after a training job is run.
     */
    inferenceSpecification?: pulumi.Input<inputs.sagemaker.ModelPackageInferenceSpecificationArgs | undefined>;
    /**
     * Metadata properties of the tracking entity, trial, or trial component.
     */
    metadataProperties?: pulumi.Input<inputs.sagemaker.ModelPackageMetadataPropertiesArgs | undefined>;
    /**
     * The approval status of the model. This can be one of the following values.
     *
     * - `APPROVED` - The model is approved
     ...
     * - `PENDING_MANUAL_APPROVAL` - The model is waiting for manual approval.
     */
    modelApprovalStatus?: pulumi.Input<enums.sagemaker.ModelPackageModelApprovalStatus | undefined>;
    /**
     * An Amazon SageMaker Model Card.
     */
    modelCard?: pulumi.Input<inputs.sagemaker.ModelPackageModelCardArgs | undefined>;
    /**
     * Metrics for the model.
     */
    modelMetrics?: pulumi.Input<inputs.sagemaker.ModelPackageModelMetricsArgs | undefined>;
    /**
     * The description of the model package.
     */
    modelPackageDescription?: pulumi.Input<string | undefined>;
    /**
     * The model group to which the model belongs.
     */
     ...
     * Specifies the validation and image scan statuses of the model package.
     */
    modelPackageStatusDetails?: pulumi.Input<inputs.sagemaker.ModelPackageStatusDetailsArgs | undefined>;
    /**
     * The version number of a versioned model.
     */
    modelPackageVersion?: pulumi.Input<number | undefined>;
    /**
     * The Amazon Simple Storage Service path where the sample payload are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
     */
    samplePayloadUrl?: pulumi.Input<string | undefined>;
    securityConfig?: pulumi.Input<inputs.sagemaker.ModelPackageSecurityConfigArgs | undefined>;
    /**
     * Indicates if you want to skip model validation.
     */
    skipModelValidation?: pulumi.Input<enums.sagemaker.ModelPackageSkipModelValidation | undefined>;
    /**
     * A list of algorithms that were used to create a model package.
     */
    sourceAlgorithmSpecification?: pulumi.Input<inputs.sagemaker.ModelPackageSourceAlgorithmSpecificationArgs | undefined>;
    /**
     * The URI of the source for the model package.
     */
     ...
     * Specifies batch transform jobs that SageMaker runs to validate your model package.
     */
    validationSpecification?: pulumi.Input<inputs.sagemaker.ModelPackageValidationSpecificationArgs | undefined>;
}
