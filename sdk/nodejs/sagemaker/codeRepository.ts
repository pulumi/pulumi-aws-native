...
export class CodeRepository extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CodeRepository {
        return new CodeRepository(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SageMaker:CodeRepository';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SageMaker.CodeRepositoryAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SageMaker.CodeRepositoryProperties>;
    ...
    constructor(name: string, argsOrState?: CodeRepositoryArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CodeRepositoryArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SageMaker.CodeRepositoryProperties>;
    /**
