...
export class NotebookInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NotebookInstance {
        return new NotebookInstance(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SageMaker:NotebookInstance';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SageMaker.NotebookInstanceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SageMaker.NotebookInstanceProperties>;
    ...
    constructor(name: string, argsOrState?: NotebookInstanceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NotebookInstanceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SageMaker.NotebookInstanceProperties>;
    /**
