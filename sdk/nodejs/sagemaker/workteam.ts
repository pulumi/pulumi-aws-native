...
export class Workteam extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Workteam {
        return new Workteam(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SageMaker.WorkteamAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SageMaker.WorkteamProperties>;
    ...
    constructor(name: string, argsOrState?: WorkteamArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface WorkteamArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SageMaker.WorkteamProperties>;
    /**
