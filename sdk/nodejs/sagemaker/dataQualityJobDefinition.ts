...
export class DataQualityJobDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly tags!: pulumi.Output<outputs.sagemaker.DataQualityJobDefinitionTag[] | undefined>;
...
export interface DataQualityJobDefinitionArgs {
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.sagemaker.DataQualityJobDefinitionTagArgs>[]>;
}
