...
export class EndpointConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EndpointConfig {
        return new EndpointConfig(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SageMaker.EndpointConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SageMaker.EndpointConfigProperties>;
    ...
    constructor(name: string, argsOrState?: EndpointConfigArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as EndpointConfigArgs | undefined;
...
export interface EndpointConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SageMaker.EndpointConfigProperties>;
    /**
