...
export class TopicPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TopicPolicy {
        return new TopicPolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SNS:TopicPolicy';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SNS.TopicPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SNS.TopicPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: TopicPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TopicPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SNS.TopicPolicyProperties>;
    /**
