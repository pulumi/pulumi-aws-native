...
export class GatewayRoute extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.GatewayRouteAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.GatewayRouteProperties>;
...
export interface GatewayRouteArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.GatewayRouteProperties>;
    /**
