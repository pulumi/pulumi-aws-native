...
export class VirtualService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualService {
        return new VirtualService(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppMesh:VirtualService';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.VirtualServiceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.VirtualServiceProperties>;
    ...
    constructor(name: string, argsOrState?: VirtualServiceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VirtualServiceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.VirtualServiceProperties>;
    /**
