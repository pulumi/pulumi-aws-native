...
export class VirtualRouter extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.VirtualRouterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.VirtualRouterProperties>;
...
export interface VirtualRouterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.VirtualRouterProperties>;
    /**
