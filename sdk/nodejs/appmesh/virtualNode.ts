...
export class VirtualNode extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VirtualNode {
        return new VirtualNode(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.VirtualNodeAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.VirtualNodeProperties>;
    ...
    constructor(name: string, argsOrState?: VirtualNodeArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VirtualNodeArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.VirtualNodeProperties>;
    /**
