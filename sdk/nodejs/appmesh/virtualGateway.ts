...
export class VirtualGateway extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.VirtualGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.VirtualGatewayProperties>;
...
export interface VirtualGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.VirtualGatewayProperties>;
    /**
