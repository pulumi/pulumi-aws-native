...
export class Mesh extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Mesh {
        return new Mesh(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppMesh.MeshAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppMesh.MeshProperties>;
    ...
    constructor(name: string, argsOrState?: MeshArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MeshArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppMesh.MeshProperties>;
    /**
