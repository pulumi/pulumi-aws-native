 ...
 *
 * @deprecated Route is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class Route extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RouteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["meshName", "meshOwner", "routeName", "virtualRouterName"] };
