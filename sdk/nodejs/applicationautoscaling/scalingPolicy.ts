...
export class ScalingPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalingPolicy {
        return new ScalingPolicy(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApplicationAutoScaling:ScalingPolicy';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApplicationAutoScaling.ScalingPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApplicationAutoScaling.ScalingPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: ScalingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ScalingPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApplicationAutoScaling.ScalingPolicyProperties>;
    /**
