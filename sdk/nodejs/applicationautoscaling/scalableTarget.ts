...
export class ScalableTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalableTarget {
        return new ScalableTarget(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApplicationAutoScaling:ScalableTarget';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApplicationAutoScaling.ScalableTargetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApplicationAutoScaling.ScalableTargetProperties>;
    ...
    constructor(name: string, argsOrState?: ScalableTargetArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ScalableTargetArgs | undefined;
...
export interface ScalableTargetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApplicationAutoScaling.ScalableTargetProperties>;
    /**
