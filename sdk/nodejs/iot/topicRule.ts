...
export class TopicRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TopicRule {
        return new TopicRule(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoT.TopicRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoT.TopicRuleProperties>;
    ...
    constructor(name: string, argsOrState?: TopicRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TopicRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoT.TopicRuleProperties>;
    /**
