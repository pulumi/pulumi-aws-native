...
export class ThingPrincipalAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThingPrincipalAttachment {
        return new ThingPrincipalAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IoT:ThingPrincipalAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoT.ThingPrincipalAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoT.ThingPrincipalAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: ThingPrincipalAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ThingPrincipalAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoT.ThingPrincipalAttachmentProperties>;
    /**
