...
export class PolicyPrincipalAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyPrincipalAttachment {
        return new PolicyPrincipalAttachment(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoT.PolicyPrincipalAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoT.PolicyPrincipalAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: PolicyPrincipalAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PolicyPrincipalAttachmentArgs | undefined;
...
export interface PolicyPrincipalAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoT.PolicyPrincipalAttachmentProperties>;
    /**
