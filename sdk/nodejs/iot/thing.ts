...
export class Thing extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Thing {
        return new Thing(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IoT:Thing';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoT.ThingAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoT.ThingProperties>;
    ...
    constructor(name: string, argsOrState?: ThingArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ThingArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoT.ThingProperties>;
    /**
