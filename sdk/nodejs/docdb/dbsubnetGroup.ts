...
export class DBSubnetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:DocDB:DBSubnetGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DocDB.DBSubnetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DocDB.DBSubnetGroupProperties>;
...
export interface DBSubnetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DocDB.DBSubnetGroupProperties>;
    /**
