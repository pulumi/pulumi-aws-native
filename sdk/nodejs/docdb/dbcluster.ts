...
export class DBCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:DocDB:DBCluster';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DocDB.DBClusterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DocDB.DBClusterProperties>;
...
export interface DBClusterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DocDB.DBClusterProperties>;
    /**
