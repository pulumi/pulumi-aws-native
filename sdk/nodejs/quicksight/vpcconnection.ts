...
export class VPCConnection extends pulumi.CustomResource {
    ...
    public readonly availabilityStatus!: pulumi.Output<enums.quicksight.VPCConnectionAvailabilityStatus | undefined>;
...
export interface VPCConnectionArgs {
    availabilityStatus?: pulumi.Input<enums.quicksight.VPCConnectionAvailabilityStatus>;
