...
export class UserProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserProfile {
        return new UserProfile(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.OpsWorks.UserProfileAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.OpsWorks.UserProfileProperties>;
    ...
    constructor(name: string, argsOrState?: UserProfileArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface UserProfileArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.OpsWorks.UserProfileProperties>;
    /**
