...
export class Layer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Layer {
        return new Layer(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:OpsWorks:Layer';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.OpsWorks.LayerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.OpsWorks.LayerProperties>;
    ...
    constructor(name: string, argsOrState?: LayerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LayerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.OpsWorks.LayerProperties>;
    /**
