...
export class RecordSet extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53.RecordSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53.RecordSetProperties>;
...
export interface RecordSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53.RecordSetProperties>;
    /**
