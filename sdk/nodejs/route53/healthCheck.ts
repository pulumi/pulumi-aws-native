...
export class HealthCheck extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HealthCheck {
        return new HealthCheck(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Route53:HealthCheck';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Route53.HealthCheckAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Route53.HealthCheckProperties>;
    ...
    constructor(name: string, argsOrState?: HealthCheckArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface HealthCheckArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Route53.HealthCheckProperties>;
    /**
