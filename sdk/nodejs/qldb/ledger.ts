...
export class Ledger extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ledger {
        return new Ledger(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.QLDB.LedgerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.QLDB.LedgerProperties>;
    ...
    constructor(name: string, argsOrState?: LedgerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LedgerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.QLDB.LedgerProperties>;
    /**
