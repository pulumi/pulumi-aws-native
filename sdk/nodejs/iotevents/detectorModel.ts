...
export class DetectorModel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DetectorModel {
        return new DetectorModel(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoTEvents.DetectorModelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoTEvents.DetectorModelProperties>;
    ...
    constructor(name: string, argsOrState?: DetectorModelArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DetectorModelArgs | undefined;
...
export interface DetectorModelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoTEvents.DetectorModelProperties>;
    /**
