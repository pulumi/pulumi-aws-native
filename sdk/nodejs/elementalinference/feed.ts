...
export class Feed extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws-native:elementalinference:Feed';
    ...
    declare public readonly outputs: pulumi.Output<outputs.elementalinference.FeedGetOutput[]>;
