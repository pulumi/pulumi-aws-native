...
export class Dataset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws-native:rekognition:Dataset';
     ...
     */
    declare public readonly datasetType: pulumi.Output<enums.rekognition.DatasetType>;
    /**
     * The ARN of the project to which the dataset belongs.
     */
    declare public readonly projectArn: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: DatasetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["datasetType", "projectArn"] };
...
export interface DatasetArgs {
     ...
     * The type of the dataset. Specify TRAIN to create a training dataset. Specify TEST to create a test dataset.
     */
    datasetType: pulumi.Input<enums.rekognition.DatasetType>;
    /**
     * The ARN of the project to which the dataset belongs.
     */
