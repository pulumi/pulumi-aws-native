...
export class LoggerDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LoggerDefinition {
        return new LoggerDefinition(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.LoggerDefinitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.LoggerDefinitionProperties>;
    ...
    constructor(name: string, argsOrState?: LoggerDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as LoggerDefinitionArgs | undefined;
...
export interface LoggerDefinitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.LoggerDefinitionProperties>;
    /**
