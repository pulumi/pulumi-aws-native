...
export class ConnectorDefinitionVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorDefinitionVersion {
        return new ConnectorDefinitionVersion(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.ConnectorDefinitionVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.ConnectorDefinitionVersionProperties>;
    ...
    constructor(name: string, argsOrState?: ConnectorDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ConnectorDefinitionVersionArgs | undefined;
...
export interface ConnectorDefinitionVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.ConnectorDefinitionVersionProperties>;
    /**
