...
export class SubscriptionDefinitionVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubscriptionDefinitionVersion {
        return new SubscriptionDefinitionVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Greengrass:SubscriptionDefinitionVersion';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.SubscriptionDefinitionVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.SubscriptionDefinitionVersionProperties>;
    ...
    constructor(name: string, argsOrState?: SubscriptionDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SubscriptionDefinitionVersionArgs | undefined;
...
export interface SubscriptionDefinitionVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.SubscriptionDefinitionVersionProperties>;
    /**
