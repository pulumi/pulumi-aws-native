...
export class DeviceDefinitionVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeviceDefinitionVersion {
        return new DeviceDefinitionVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Greengrass:DeviceDefinitionVersion';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.DeviceDefinitionVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.DeviceDefinitionVersionProperties>;
    ...
    constructor(name: string, argsOrState?: DeviceDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DeviceDefinitionVersionArgs | undefined;
...
export interface DeviceDefinitionVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.DeviceDefinitionVersionProperties>;
    /**
