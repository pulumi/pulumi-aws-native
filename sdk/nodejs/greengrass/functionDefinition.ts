...
export class FunctionDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FunctionDefinition {
        return new FunctionDefinition(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.FunctionDefinitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.FunctionDefinitionProperties>;
    ...
    constructor(name: string, argsOrState?: FunctionDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as FunctionDefinitionArgs | undefined;
...
export interface FunctionDefinitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.FunctionDefinitionProperties>;
    /**
