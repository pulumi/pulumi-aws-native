 ...
 *
 * @deprecated ConnectorDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class ConnectorDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ConnectorDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConnectorDefinition.__pulumiType, name, resourceInputs, opts);
    }
}
