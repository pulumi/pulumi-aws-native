...
export class ConnectorDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorDefinition {
        return new ConnectorDefinition(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Greengrass:ConnectorDefinition';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.ConnectorDefinitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.ConnectorDefinitionProperties>;
    ...
    constructor(name: string, argsOrState?: ConnectorDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ConnectorDefinitionArgs | undefined;
...
export interface ConnectorDefinitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.ConnectorDefinitionProperties>;
    /**
