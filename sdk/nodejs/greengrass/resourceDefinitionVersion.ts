...
export class ResourceDefinitionVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceDefinitionVersion {
        return new ResourceDefinitionVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Greengrass:ResourceDefinitionVersion';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.ResourceDefinitionVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.ResourceDefinitionVersionProperties>;
    ...
    constructor(name: string, argsOrState?: ResourceDefinitionVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ResourceDefinitionVersionArgs | undefined;
...
export interface ResourceDefinitionVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.ResourceDefinitionVersionProperties>;
    /**
