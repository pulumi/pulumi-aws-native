...
export class CoreDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CoreDefinition {
        return new CoreDefinition(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Greengrass:CoreDefinition';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Greengrass.CoreDefinitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Greengrass.CoreDefinitionProperties>;
    ...
    constructor(name: string, argsOrState?: CoreDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CoreDefinitionArgs | undefined;
...
export interface CoreDefinitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Greengrass.CoreDefinitionProperties>;
    /**
