...
export class RobotApplication extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RoboMaker.RobotApplicationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RoboMaker.RobotApplicationProperties>;
    ...
    constructor(name: string, argsOrState?: RobotApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as RobotApplicationArgs | undefined;
...
export interface RobotApplicationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RoboMaker.RobotApplicationProperties>;
    /**
