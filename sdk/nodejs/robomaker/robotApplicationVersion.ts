...
export class RobotApplicationVersion extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RoboMaker.RobotApplicationVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RoboMaker.RobotApplicationVersionProperties>;
    ...
    constructor(name: string, argsOrState?: RobotApplicationVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as RobotApplicationVersionArgs | undefined;
...
export interface RobotApplicationVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RoboMaker.RobotApplicationVersionProperties>;
    /**
