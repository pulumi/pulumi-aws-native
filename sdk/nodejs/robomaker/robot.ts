...
export class Robot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Robot {
        return new Robot(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RoboMaker:Robot';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RoboMaker.RobotAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RoboMaker.RobotProperties>;
    ...
    constructor(name: string, argsOrState?: RobotArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as RobotArgs | undefined;
...
export interface RobotArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RoboMaker.RobotProperties>;
    /**
