...
export class SimulationApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:RoboMaker:SimulationApplication';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RoboMaker.SimulationApplicationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RoboMaker.SimulationApplicationProperties>;
    ...
    constructor(name: string, argsOrState?: SimulationApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SimulationApplicationArgs | undefined;
...
export interface SimulationApplicationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RoboMaker.SimulationApplicationProperties>;
    /**
