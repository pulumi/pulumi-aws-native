...
export class SimulationApplicationVersion extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.RoboMaker.SimulationApplicationVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.RoboMaker.SimulationApplicationVersionProperties>;
    ...
    constructor(name: string, argsOrState?: SimulationApplicationVersionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SimulationApplicationVersionArgs | undefined;
...
export interface SimulationApplicationVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.RoboMaker.SimulationApplicationVersionProperties>;
    /**
