...
export class ReplicationSubnetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationSubnetGroup {
        return new ReplicationSubnetGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:DMS:ReplicationSubnetGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DMS.ReplicationSubnetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DMS.ReplicationSubnetGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ReplicationSubnetGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReplicationSubnetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DMS.ReplicationSubnetGroupProperties>;
    /**
