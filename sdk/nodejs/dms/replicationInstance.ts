...
export class ReplicationInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationInstance {
        return new ReplicationInstance(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DMS.ReplicationInstanceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DMS.ReplicationInstanceProperties>;
    ...
    constructor(name: string, argsOrState?: ReplicationInstanceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReplicationInstanceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DMS.ReplicationInstanceProperties>;
    /**
