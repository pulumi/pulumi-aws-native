...
export class ReplicationTask extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationTask {
        return new ReplicationTask(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:DMS:ReplicationTask';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DMS.ReplicationTaskAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DMS.ReplicationTaskProperties>;
    ...
    constructor(name: string, argsOrState?: ReplicationTaskArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ReplicationTaskArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DMS.ReplicationTaskProperties>;
    /**
