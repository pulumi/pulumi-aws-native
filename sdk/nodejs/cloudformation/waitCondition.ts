...
export class WaitCondition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WaitCondition {
        return new WaitCondition(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudFormation.WaitConditionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudFormation.WaitConditionProperties>;
    ...
    constructor(name: string, argsOrState?: WaitConditionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as WaitConditionArgs | undefined;
...
export interface WaitConditionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudFormation.WaitConditionProperties>;
    /**
