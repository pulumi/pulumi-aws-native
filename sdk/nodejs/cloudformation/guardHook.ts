...
export class GuardHook extends pulumi.CustomResource {
     ...
     */
    declare public readonly failureMode: pulumi.Output<enums.cloudformation.GuardHookFailureMode>;
    /**
     ...
     */
    declare public readonly hookStatus: pulumi.Output<enums.cloudformation.GuardHookHookStatus>;
    /**
     * S3 Bucket where the guard validate report will be uploaded to
     */
    declare public readonly logBucket: pulumi.Output<string | undefined>;
    /**
     * Specifies the S3 location of your input parameters.
     */
    declare public readonly options: pulumi.Output<outputs.cloudformation.OptionsProperties | undefined>;
    /**
     * Specifies the S3 location of your Guard rules.
     */
    declare public readonly ruleLocation: pulumi.Output<outputs.cloudformation.GuardHookS3Location>;
    /**
     ...
     */
    declare public readonly targetOperations: pulumi.Output<enums.cloudformation.GuardHookTargetOperation[]>;
    ...
    constructor(name: string, args: GuardHookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.ruleLocation === undefined && !opts.urn) {
            ...
            resourceInputs["ruleLocation"] = args?.ruleLocation;
