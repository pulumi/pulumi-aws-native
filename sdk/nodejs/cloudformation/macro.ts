...
export class Macro extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Macro {
        return new Macro(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CloudFormation:Macro';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudFormation.MacroAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudFormation.MacroProperties>;
    ...
    constructor(name: string, argsOrState?: MacroArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MacroArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudFormation.MacroProperties>;
    /**
