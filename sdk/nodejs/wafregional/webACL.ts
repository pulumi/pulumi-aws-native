...
export class WebACL extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebACL {
        return new WebACL(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFRegional:WebACL';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.WebACLAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.WebACLProperties>;
    ...
    constructor(name: string, argsOrState?: WebACLArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface WebACLArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.WebACLProperties>;
    /**
