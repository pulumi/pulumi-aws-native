...
export class RateBasedRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RateBasedRule {
        return new RateBasedRule(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.RateBasedRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.RateBasedRuleProperties>;
    ...
    constructor(name: string, argsOrState?: RateBasedRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RateBasedRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.RateBasedRuleProperties>;
    /**
