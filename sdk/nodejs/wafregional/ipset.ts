...
export class IPSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFRegional:IPSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.IPSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.IPSetProperties>;
...
export interface IPSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.IPSetProperties>;
    /**
