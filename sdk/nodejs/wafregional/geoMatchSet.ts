...
export class GeoMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GeoMatchSet {
        return new GeoMatchSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFRegional:GeoMatchSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.GeoMatchSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.GeoMatchSetProperties>;
    ...
    constructor(name: string, argsOrState?: GeoMatchSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GeoMatchSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.GeoMatchSetProperties>;
    /**
