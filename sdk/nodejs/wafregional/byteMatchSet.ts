...
export class ByteMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ByteMatchSet {
        return new ByteMatchSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFRegional:ByteMatchSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.ByteMatchSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.ByteMatchSetProperties>;
    ...
    constructor(name: string, argsOrState?: ByteMatchSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ByteMatchSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.ByteMatchSetProperties>;
    /**
