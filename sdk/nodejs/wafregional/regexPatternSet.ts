...
export class RegexPatternSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegexPatternSet {
        return new RegexPatternSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFRegional:RegexPatternSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFRegional.RegexPatternSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFRegional.RegexPatternSetProperties>;
    ...
    constructor(name: string, argsOrState?: RegexPatternSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RegexPatternSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFRegional.RegexPatternSetProperties>;
    /**
