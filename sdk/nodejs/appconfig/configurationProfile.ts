...
export class ConfigurationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppConfig:ConfigurationProfile';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppConfig.ConfigurationProfileAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppConfig.ConfigurationProfileProperties>;
...
export interface ConfigurationProfileArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppConfig.ConfigurationProfileProperties>;
    /**
