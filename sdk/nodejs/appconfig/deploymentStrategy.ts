...
export class DeploymentStrategy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeploymentStrategy {
        return new DeploymentStrategy(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppConfig.DeploymentStrategyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppConfig.DeploymentStrategyProperties>;
    ...
    constructor(name: string, argsOrState?: DeploymentStrategyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DeploymentStrategyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppConfig.DeploymentStrategyProperties>;
    /**
