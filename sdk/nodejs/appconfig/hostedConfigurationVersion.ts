...
export class HostedConfigurationVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HostedConfigurationVersion {
        return new HostedConfigurationVersion(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppConfig.HostedConfigurationVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppConfig.HostedConfigurationVersionProperties>;
    ...
    constructor(name: string, argsOrState?: HostedConfigurationVersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface HostedConfigurationVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppConfig.HostedConfigurationVersionProperties>;
    /**
