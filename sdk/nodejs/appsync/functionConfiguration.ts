...
export class FunctionConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FunctionConfiguration {
        return new FunctionConfiguration(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppSync:FunctionConfiguration';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.FunctionConfigurationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.FunctionConfigurationProperties>;
    ...
    constructor(name: string, argsOrState?: FunctionConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as FunctionConfigurationArgs | undefined;
...
export interface FunctionConfigurationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.FunctionConfigurationProperties>;
    /**
