...
export class ApiKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiKey {
        return new ApiKey(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.ApiKeyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.ApiKeyProperties>;
    ...
    constructor(name: string, argsOrState?: ApiKeyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ApiKeyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.ApiKeyProperties>;
    /**
