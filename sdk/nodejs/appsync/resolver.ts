...
export class Resolver extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Resolver {
        return new Resolver(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.ResolverAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.ResolverProperties>;
    ...
    constructor(name: string, argsOrState?: ResolverArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResolverArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.ResolverProperties>;
    /**
