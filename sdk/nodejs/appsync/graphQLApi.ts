...
export class GraphQLApi extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GraphQLApi {
        return new GraphQLApi(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppSync:GraphQLApi';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.GraphQLApiAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.GraphQLApiProperties>;
    ...
    constructor(name: string, argsOrState?: GraphQLApiArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GraphQLApiArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.GraphQLApiProperties>;
    /**
