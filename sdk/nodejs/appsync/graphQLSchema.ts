...
export class GraphQLSchema extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GraphQLSchema {
        return new GraphQLSchema(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.GraphQLSchemaAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.GraphQLSchemaProperties>;
    ...
    constructor(name: string, argsOrState?: GraphQLSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as GraphQLSchemaArgs | undefined;
...
export interface GraphQLSchemaArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.GraphQLSchemaProperties>;
    /**
