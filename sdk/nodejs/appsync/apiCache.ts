...
export class ApiCache extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiCache {
        return new ApiCache(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AppSync:ApiCache';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AppSync.ApiCacheAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AppSync.ApiCacheProperties>;
    ...
    constructor(name: string, argsOrState?: ApiCacheArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ApiCacheArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AppSync.ApiCacheProperties>;
    /**
