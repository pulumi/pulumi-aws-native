...
export class Memory extends pulumi.CustomResource {
     ...
     */
    public readonly eventExpiryDuration!: pulumi.Output<number>;
    public /*out*/ readonly failureReason!: pulumi.Output<string>;
    public /*out*/ readonly memoryArn!: pulumi.Output<string>;
    public readonly memoryExecutionRoleArn!: pulumi.Output<string | undefined>;
    public /*out*/ readonly memoryId!: pulumi.Output<string>;
    public readonly memoryStrategies!: pulumi.Output<outputs.bedrockagentcore.MemoryStrategy[] | undefined>;
    public readonly name!: pulumi.Output<string>;
    /**
     * The status of the memory record operation (e.g., SUCCEEDED, FAILED).
     */
    public /*out*/ readonly status!: pulumi.Output<enums.bedrockagentcore.MemoryStatus>;
    ...
    constructor(name: string, args: MemoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.eventExpiryDuration === undefined) && !opts.urn) {
            ...
            resourceInputs["eventExpiryDuration"] = args ? args.eventExpiryDuration : undefined;
            resourceInputs["memoryExecutionRoleArn"] = args ? args.memoryExecutionRoleArn : undefined;
            resourceInputs["memoryStrategies"] = args ? args.memoryStrategies : undefined;
