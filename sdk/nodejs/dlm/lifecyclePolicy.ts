...
export class LifecyclePolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LifecyclePolicy {
        return new LifecyclePolicy(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.DLM.LifecyclePolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.DLM.LifecyclePolicyProperties>;
    ...
    constructor(name: string, argsOrState?: LifecyclePolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LifecyclePolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.DLM.LifecyclePolicyProperties>;
    /**
