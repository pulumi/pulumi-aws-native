...
export class InputSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InputSecurityGroup {
        return new InputSecurityGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.MediaLive.InputSecurityGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.MediaLive.InputSecurityGroupProperties>;
    ...
    constructor(name: string, argsOrState?: InputSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface InputSecurityGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.MediaLive.InputSecurityGroupProperties>;
    /**
