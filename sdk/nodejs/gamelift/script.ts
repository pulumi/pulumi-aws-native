...
export class Script extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Script {
        return new Script(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GameLift.ScriptAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GameLift.ScriptProperties>;
    ...
    constructor(name: string, argsOrState?: ScriptArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ScriptArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GameLift.ScriptProperties>;
    /**
