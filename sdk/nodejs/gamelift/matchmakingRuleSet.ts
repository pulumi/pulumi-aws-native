...
export class MatchmakingRuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MatchmakingRuleSet {
        return new MatchmakingRuleSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GameLift:MatchmakingRuleSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GameLift.MatchmakingRuleSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GameLift.MatchmakingRuleSetProperties>;
    ...
    constructor(name: string, argsOrState?: MatchmakingRuleSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MatchmakingRuleSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GameLift.MatchmakingRuleSetProperties>;
    /**
