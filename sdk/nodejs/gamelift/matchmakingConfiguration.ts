...
export class MatchmakingConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MatchmakingConfiguration {
        return new MatchmakingConfiguration(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GameLift.MatchmakingConfigurationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GameLift.MatchmakingConfigurationProperties>;
    ...
    constructor(name: string, argsOrState?: MatchmakingConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MatchmakingConfigurationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GameLift.MatchmakingConfigurationProperties>;
    /**
