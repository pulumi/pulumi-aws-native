...
export class Build extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Build {
        return new Build(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GameLift:Build';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GameLift.BuildAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GameLift.BuildProperties>;
    ...
    constructor(name: string, argsOrState?: BuildArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BuildArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GameLift.BuildProperties>;
    /**
