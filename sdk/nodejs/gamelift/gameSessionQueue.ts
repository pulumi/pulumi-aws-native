...
export class GameSessionQueue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GameSessionQueue {
        return new GameSessionQueue(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GameLift:GameSessionQueue';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GameLift.GameSessionQueueAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GameLift.GameSessionQueueProperties>;
    ...
    constructor(name: string, argsOrState?: GameSessionQueueArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface GameSessionQueueArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GameLift.GameSessionQueueProperties>;
    /**
