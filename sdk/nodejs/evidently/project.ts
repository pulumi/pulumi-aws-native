...
export class Project extends pulumi.CustomResource {
     ...
     */
    public readonly tags!: pulumi.Output<outputs.evidently.ProjectTag[] | undefined>;
    ...
    constructor(name: string, args?: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["dataDelivery"] = args ? args.dataDelivery : undefined;
            ...
            inputs["arn"] = undefined /*out*/;
            inputs["dataDelivery"] = undefined /*out*/;
...
export interface ProjectArgs {
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.evidently.ProjectTagArgs>[]>;
}
