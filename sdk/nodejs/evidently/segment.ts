...
export class Segment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws-native:evidently:Segment';
     ...
     */
    public readonly tags!: pulumi.Output<outputs.evidently.SegmentTag[] | undefined>;
...
export interface SegmentArgs {
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.evidently.SegmentTagArgs>[]>;
}
