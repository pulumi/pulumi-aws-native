...
export class ConfigurationTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationTemplate {
        return new ConfigurationTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ElasticBeanstalk:ConfigurationTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElasticBeanstalk.ConfigurationTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElasticBeanstalk.ConfigurationTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationTemplateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigurationTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElasticBeanstalk.ConfigurationTemplateProperties>;
    /**
