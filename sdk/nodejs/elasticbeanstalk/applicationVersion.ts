...
export class ApplicationVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationVersion {
        return new ApplicationVersion(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElasticBeanstalk.ApplicationVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElasticBeanstalk.ApplicationVersionProperties>;
    ...
    constructor(name: string, argsOrState?: ApplicationVersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ApplicationVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElasticBeanstalk.ApplicationVersionProperties>;
    /**
