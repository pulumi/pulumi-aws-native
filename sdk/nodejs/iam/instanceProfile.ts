...
export class InstanceProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceProfile {
        return new InstanceProfile(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IAM:InstanceProfile';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IAM.InstanceProfileAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IAM.InstanceProfileProperties>;
    ...
    constructor(name: string, argsOrState?: InstanceProfileArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface InstanceProfileArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IAM.InstanceProfileProperties>;
    /**
