...
export class UserToGroupAddition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): UserToGroupAddition {
        return new UserToGroupAddition(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IAM:UserToGroupAddition';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IAM.UserToGroupAdditionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IAM.UserToGroupAdditionProperties>;
    ...
    constructor(name: string, argsOrState?: UserToGroupAdditionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as UserToGroupAdditionArgs | undefined;
...
export interface UserToGroupAdditionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IAM.UserToGroupAdditionProperties>;
    /**
