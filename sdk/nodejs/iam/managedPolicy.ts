...
export class ManagedPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedPolicy {
        return new ManagedPolicy(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IAM.ManagedPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IAM.ManagedPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: ManagedPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ManagedPolicyArgs | undefined;
...
export interface ManagedPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IAM.ManagedPolicyProperties>;
    /**
