...
export class ServiceLinkedRole extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceLinkedRole {
        return new ServiceLinkedRole(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IAM.ServiceLinkedRoleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IAM.ServiceLinkedRoleProperties>;
    ...
    constructor(name: string, argsOrState?: ServiceLinkedRoleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ServiceLinkedRoleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IAM.ServiceLinkedRoleProperties>;
    /**
