...
export class AccessKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessKey {
        return new AccessKey(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IAM:AccessKey';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IAM.AccessKeyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IAM.AccessKeyProperties>;
    ...
    constructor(name: string, argsOrState?: AccessKeyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AccessKeyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IAM.AccessKeyProperties>;
    /**
