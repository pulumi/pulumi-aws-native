...
export class MaintenanceWindowTarget extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SSM.MaintenanceWindowTargetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SSM.MaintenanceWindowTargetProperties>;
    ...
    constructor(name: string, argsOrState?: MaintenanceWindowTargetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MaintenanceWindowTargetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SSM.MaintenanceWindowTargetProperties>;
    /**
