...
export class Parameter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Parameter {
        return new Parameter(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:SSM:Parameter';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SSM.ParameterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SSM.ParameterProperties>;
    ...
    constructor(name: string, argsOrState?: ParameterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ParameterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SSM.ParameterProperties>;
    /**
