...
export class PatchBaseline extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PatchBaseline {
        return new PatchBaseline(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SSM.PatchBaselineAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SSM.PatchBaselineProperties>;
    ...
    constructor(name: string, argsOrState?: PatchBaselineArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PatchBaselineArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SSM.PatchBaselineProperties>;
    /**
