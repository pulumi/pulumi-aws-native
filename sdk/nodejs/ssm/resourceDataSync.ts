...
export class ResourceDataSync extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceDataSync {
        return new ResourceDataSync(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SSM.ResourceDataSyncAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SSM.ResourceDataSyncProperties>;
    ...
    constructor(name: string, argsOrState?: ResourceDataSyncArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ResourceDataSyncArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SSM.ResourceDataSyncProperties>;
    /**
