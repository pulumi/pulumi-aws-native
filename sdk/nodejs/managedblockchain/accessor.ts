...
export class Accessor extends pulumi.CustomResource {
     ...
     */
    public readonly tags!: pulumi.Output<outputs.managedblockchain.AccessorTag[] | undefined>;
...
export interface AccessorArgs {
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.managedblockchain.AccessorTagArgs>[]>;
}
