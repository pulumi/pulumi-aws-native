...
export class Member extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Member {
        return new Member(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ManagedBlockchain:Member';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ManagedBlockchain.MemberAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ManagedBlockchain.MemberProperties>;
    ...
    constructor(name: string, argsOrState?: MemberArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MemberArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ManagedBlockchain.MemberProperties>;
    /**
