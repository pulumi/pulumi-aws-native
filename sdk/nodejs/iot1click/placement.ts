...
export class Placement extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Placement {
        return new Placement(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoT1Click.PlacementAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoT1Click.PlacementProperties>;
    ...
    constructor(name: string, argsOrState?: PlacementArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PlacementArgs | undefined;
...
export interface PlacementArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoT1Click.PlacementProperties>;
    /**
