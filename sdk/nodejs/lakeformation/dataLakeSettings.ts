...
export class DataLakeSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataLakeSettings {
        return new DataLakeSettings(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:LakeFormation:DataLakeSettings';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.LakeFormation.DataLakeSettingsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.LakeFormation.DataLakeSettingsProperties>;
    ...
    constructor(name: string, argsOrState?: DataLakeSettingsArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DataLakeSettingsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.LakeFormation.DataLakeSettingsProperties>;
    /**
