...
export class Permissions extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Permissions {
        return new Permissions(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:LakeFormation:Permissions';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.LakeFormation.PermissionsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.LakeFormation.PermissionsProperties>;
    ...
    constructor(name: string, argsOrState?: PermissionsArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PermissionsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.LakeFormation.PermissionsProperties>;
    /**
