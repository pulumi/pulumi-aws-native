...
export class JobDefinition extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Batch.JobDefinitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Batch.JobDefinitionProperties>;
...
export interface JobDefinitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Batch.JobDefinitionProperties>;
    /**
