...
export class ComputeEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ComputeEnvironment {
        return new ComputeEnvironment(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Batch.ComputeEnvironmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Batch.ComputeEnvironmentProperties>;
    ...
    constructor(name: string, argsOrState?: ComputeEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ComputeEnvironmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Batch.ComputeEnvironmentProperties>;
    /**
