...
export class JobQueue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): JobQueue {
        return new JobQueue(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Batch.JobQueueAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Batch.JobQueueProperties>;
    ...
    constructor(name: string, argsOrState?: JobQueueArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface JobQueueArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Batch.JobQueueProperties>;
    /**
