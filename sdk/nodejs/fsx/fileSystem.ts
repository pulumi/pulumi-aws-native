...
export class FileSystem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FileSystem {
        return new FileSystem(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:FSx:FileSystem';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.FSx.FileSystemAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.FSx.FileSystemProperties>;
    ...
    constructor(name: string, argsOrState?: FileSystemArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface FileSystemArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.FSx.FileSystemProperties>;
    /**
