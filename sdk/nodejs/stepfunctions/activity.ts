...
export class Activity extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Activity {
        return new Activity(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.StepFunctions.ActivityAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.StepFunctions.ActivityProperties>;
    ...
    constructor(name: string, argsOrState?: ActivityArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ActivityArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.StepFunctions.ActivityProperties>;
    /**
