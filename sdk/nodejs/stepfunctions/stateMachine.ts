...
export class StateMachine extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StateMachine {
        return new StateMachine(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:StepFunctions:StateMachine';
    ...
    constructor(name: string, argsOrState?: StateMachineArgs, opts?: pulumi.CustomResourceOptions) {
