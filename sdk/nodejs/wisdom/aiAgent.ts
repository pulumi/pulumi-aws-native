...
export class AiAgent extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.wisdom.AiAgentAiAgentConfiguration0Properties | outputs.wisdom.AiAgentAiAgentConfiguration1Properties | outputs.wisdom.AiAgentAiAgentConfiguration2Properties | outputs.wisdom.AiAgentAiAgentConfiguration3Properties>;
    /**
...
export interface AiAgentArgs {
     ...
     * Configuration for the AI Agent.
     */
    configuration: pulumi.Input<inputs.wisdom.AiAgentAiAgentConfiguration0PropertiesArgs | inputs.wisdom.AiAgentAiAgentConfiguration1PropertiesArgs | inputs.wisdom.AiAgentAiAgentConfiguration2PropertiesArgs | inputs.wisdom.AiAgentAiAgentConfiguration3PropertiesArgs>;
    /**
     * The description of the AI Agent.
     */
