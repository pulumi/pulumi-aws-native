 ...
 *
 * @deprecated Fleet is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
 */
export class Fleet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FleetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["signalCatalogArn"] };
