...
export class RegexPatternSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFv2:RegexPatternSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFv2.RegexPatternSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFv2.RegexPatternSetProperties>;
...
export interface RegexPatternSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFv2.RegexPatternSetProperties>;
    /**
