...
export class IPSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IPSet {
        return new IPSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFv2:IPSet';
    ...
    constructor(name: string, argsOrState?: IPSetArgs, opts?: pulumi.CustomResourceOptions) {
