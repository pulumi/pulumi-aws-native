...
export class RuleGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RuleGroup {
        return new RuleGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAFv2:RuleGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAFv2.RuleGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAFv2.RuleGroupProperties>;
    ...
    constructor(name: string, argsOrState?: RuleGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RuleGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAFv2.RuleGroupProperties>;
    /**
