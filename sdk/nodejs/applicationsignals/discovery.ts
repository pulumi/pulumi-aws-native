...
export class Discovery extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Discovery {
        return new Discovery(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:applicationsignals:Discovery';
    ...
    constructor(name: string, args?: DiscoveryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Discovery.__pulumiType, name, resourceInputs, opts);
    }
}
