...
export class PullTimeUpdateExclusion extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PullTimeUpdateExclusion {
        return new PullTimeUpdateExclusion(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:ecr:PullTimeUpdateExclusion';
    ...
    constructor(name: string, args: PullTimeUpdateExclusionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["principalArn"] };
