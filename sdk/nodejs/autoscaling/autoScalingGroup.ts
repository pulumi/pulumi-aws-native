...
export class AutoScalingGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AutoScalingGroup {
        return new AutoScalingGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AutoScaling:AutoScalingGroup';
    ...
    constructor(name: string, argsOrState?: AutoScalingGroupArgs, opts?: pulumi.CustomResourceOptions) {
