...
export class LifecycleHook extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LifecycleHook {
        return new LifecycleHook(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AutoScaling:LifecycleHook';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AutoScaling.LifecycleHookAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AutoScaling.LifecycleHookProperties>;
    ...
    constructor(name: string, argsOrState?: LifecycleHookArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LifecycleHookArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AutoScaling.LifecycleHookProperties>;
    /**
