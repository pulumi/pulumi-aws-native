...
export class LaunchConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LaunchConfiguration {
        return new LaunchConfiguration(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AutoScaling.LaunchConfigurationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AutoScaling.LaunchConfigurationProperties>;
    ...
    constructor(name: string, argsOrState?: LaunchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LaunchConfigurationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AutoScaling.LaunchConfigurationProperties>;
    /**
