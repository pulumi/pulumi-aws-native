...
export class FlowTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FlowTemplate {
        return new FlowTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:IoTThingsGraph:FlowTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.IoTThingsGraph.FlowTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.IoTThingsGraph.FlowTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: FlowTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as FlowTemplateArgs | undefined;
...
export interface FlowTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.IoTThingsGraph.FlowTemplateProperties>;
    /**
