...
export class MissionProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:GroundStation:MissionProfile';
    ...
    constructor(name: string, argsOrState?: MissionProfileArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as MissionProfileArgs | undefined;
