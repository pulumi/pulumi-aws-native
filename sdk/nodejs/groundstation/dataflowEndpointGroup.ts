...
export class DataflowEndpointGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataflowEndpointGroup {
        return new DataflowEndpointGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GroundStation.DataflowEndpointGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GroundStation.DataflowEndpointGroupProperties>;
    ...
    constructor(name: string, argsOrState?: DataflowEndpointGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DataflowEndpointGroupArgs | undefined;
...
export interface DataflowEndpointGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GroundStation.DataflowEndpointGroupProperties>;
    /**
