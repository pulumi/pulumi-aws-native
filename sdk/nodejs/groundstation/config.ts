...
export class Config extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Config {
        return new Config(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.GroundStation.ConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.GroundStation.ConfigProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.GroundStation.ConfigProperties>;
    /**
