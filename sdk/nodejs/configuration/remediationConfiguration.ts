...
export class RemediationConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:RemediationConfiguration';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.RemediationConfigurationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.RemediationConfigurationProperties>;
    ...
    constructor(name: string, argsOrState?: RemediationConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RemediationConfigurationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.RemediationConfigurationProperties>;
    /**
