...
export class ConfigurationAggregator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationAggregator {
        return new ConfigurationAggregator(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:ConfigurationAggregator';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.ConfigurationAggregatorAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.ConfigurationAggregatorProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationAggregatorArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigurationAggregatorArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.ConfigurationAggregatorProperties>;
    /**
