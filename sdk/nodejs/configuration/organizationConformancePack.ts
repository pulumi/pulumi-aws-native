...
export class OrganizationConformancePack extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationConformancePack {
        return new OrganizationConformancePack(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:OrganizationConformancePack';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.OrganizationConformancePackAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.OrganizationConformancePackProperties>;
    ...
    constructor(name: string, argsOrState?: OrganizationConformancePackArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface OrganizationConformancePackArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.OrganizationConformancePackProperties>;
    /**
