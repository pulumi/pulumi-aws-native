...
export class AggregationAuthorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AggregationAuthorization {
        return new AggregationAuthorization(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:AggregationAuthorization';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.AggregationAuthorizationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.AggregationAuthorizationProperties>;
    ...
    constructor(name: string, argsOrState?: AggregationAuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as AggregationAuthorizationArgs | undefined;
...
export interface AggregationAuthorizationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.AggregationAuthorizationProperties>;
    /**
