...
export class ConfigRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigRule {
        return new ConfigRule(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.ConfigRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.ConfigRuleProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.ConfigRuleProperties>;
    /**
