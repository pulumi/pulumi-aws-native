...
export class ConfigurationRecorder extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationRecorder {
        return new ConfigurationRecorder(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:ConfigurationRecorder';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.ConfigurationRecorderAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.ConfigurationRecorderProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationRecorderArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigurationRecorderArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.ConfigurationRecorderProperties>;
    /**
