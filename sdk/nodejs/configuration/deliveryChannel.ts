...
export class DeliveryChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeliveryChannel {
        return new DeliveryChannel(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:DeliveryChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.DeliveryChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.DeliveryChannelProperties>;
    ...
    constructor(name: string, argsOrState?: DeliveryChannelArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DeliveryChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.DeliveryChannelProperties>;
    /**
