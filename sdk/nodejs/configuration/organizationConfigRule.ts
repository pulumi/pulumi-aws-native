...
export class OrganizationConfigRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationConfigRule {
        return new OrganizationConfigRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Configuration:OrganizationConfigRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Configuration.OrganizationConfigRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Configuration.OrganizationConfigRuleProperties>;
    ...
    constructor(name: string, argsOrState?: OrganizationConfigRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as OrganizationConfigRuleArgs | undefined;
...
export interface OrganizationConfigRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Configuration.OrganizationConfigRuleProperties>;
    /**
