...
export class HttpNamespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HttpNamespace {
        return new HttpNamespace(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceDiscovery:HttpNamespace';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceDiscovery.HttpNamespaceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceDiscovery.HttpNamespaceProperties>;
    ...
    constructor(name: string, argsOrState?: HttpNamespaceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface HttpNamespaceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceDiscovery.HttpNamespaceProperties>;
    /**
