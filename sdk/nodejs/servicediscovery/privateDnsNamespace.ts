...
export class PrivateDnsNamespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateDnsNamespace {
        return new PrivateDnsNamespace(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceDiscovery:PrivateDnsNamespace';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceDiscovery.PrivateDnsNamespaceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceDiscovery.PrivateDnsNamespaceProperties>;
    ...
    constructor(name: string, argsOrState?: PrivateDnsNamespaceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PrivateDnsNamespaceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceDiscovery.PrivateDnsNamespaceProperties>;
    /**
