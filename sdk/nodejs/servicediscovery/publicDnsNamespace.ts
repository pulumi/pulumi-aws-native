...
export class PublicDnsNamespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PublicDnsNamespace {
        return new PublicDnsNamespace(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ServiceDiscovery:PublicDnsNamespace';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ServiceDiscovery.PublicDnsNamespaceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ServiceDiscovery.PublicDnsNamespaceProperties>;
    ...
    constructor(name: string, argsOrState?: PublicDnsNamespaceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PublicDnsNamespaceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ServiceDiscovery.PublicDnsNamespaceProperties>;
    /**
