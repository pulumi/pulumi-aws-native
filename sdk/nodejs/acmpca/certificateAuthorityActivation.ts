...
export class CertificateAuthorityActivation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CertificateAuthorityActivation {
        return new CertificateAuthorityActivation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ACMPCA:CertificateAuthorityActivation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ACMPCA.CertificateAuthorityActivationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ACMPCA.CertificateAuthorityActivationProperties>;
    ...
    constructor(name: string, argsOrState?: CertificateAuthorityActivationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as CertificateAuthorityActivationArgs | undefined;
...
export interface CertificateAuthorityActivationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ACMPCA.CertificateAuthorityActivationProperties>;
    /**
