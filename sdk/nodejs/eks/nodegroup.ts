...
export class Nodegroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Nodegroup {
        return new Nodegroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EKS.NodegroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EKS.NodegroupProperties>;
    ...
    constructor(name: string, argsOrState?: NodegroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NodegroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EKS.NodegroupProperties>;
    /**
