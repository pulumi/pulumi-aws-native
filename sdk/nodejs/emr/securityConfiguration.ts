...
export class SecurityConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityConfiguration {
        return new SecurityConfiguration(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EMR:SecurityConfiguration';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EMR.SecurityConfigurationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EMR.SecurityConfigurationProperties>;
    ...
    constructor(name: string, argsOrState?: SecurityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SecurityConfigurationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EMR.SecurityConfigurationProperties>;
    /**
