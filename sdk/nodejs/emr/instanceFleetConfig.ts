...
export class InstanceFleetConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceFleetConfig {
        return new InstanceFleetConfig(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EMR:InstanceFleetConfig';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EMR.InstanceFleetConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EMR.InstanceFleetConfigProperties>;
    ...
    constructor(name: string, argsOrState?: InstanceFleetConfigArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as InstanceFleetConfigArgs | undefined;
...
export interface InstanceFleetConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EMR.InstanceFleetConfigProperties>;
    /**
