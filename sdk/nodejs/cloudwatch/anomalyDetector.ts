...
export class AnomalyDetector extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudWatch.AnomalyDetectorAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudWatch.AnomalyDetectorProperties>;
    ...
    constructor(name: string, argsOrState?: AnomalyDetectorArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AnomalyDetectorArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudWatch.AnomalyDetectorProperties>;
    /**
