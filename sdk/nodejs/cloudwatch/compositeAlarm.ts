...
export class CompositeAlarm extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CompositeAlarm {
        return new CompositeAlarm(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CloudWatch:CompositeAlarm';
    ...
    constructor(name: string, argsOrState?: CompositeAlarmArgs, opts?: pulumi.CustomResourceOptions) {
