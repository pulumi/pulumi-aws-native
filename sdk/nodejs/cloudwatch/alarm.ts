...
export class Alarm extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Alarm {
        return new Alarm(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudWatch.AlarmAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudWatch.AlarmProperties>;
    ...
    constructor(name: string, argsOrState?: AlarmArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AlarmArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudWatch.AlarmProperties>;
    /**
