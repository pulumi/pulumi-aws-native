...
export class InsightRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InsightRule {
        return new InsightRule(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CloudWatch.InsightRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CloudWatch.InsightRuleProperties>;
    ...
    constructor(name: string, argsOrState?: InsightRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as InsightRuleArgs | undefined;
...
export interface InsightRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CloudWatch.InsightRuleProperties>;
    /**
