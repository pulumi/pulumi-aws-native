...
export class DataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws-native:dataexchange:DataSet';
     ...
     */
    declare public readonly assetType: pulumi.Output<enums.dataexchange.DataSetAssetType>;
    /**
     ...
     */
    declare public /*out*/ readonly origin: pulumi.Output<enums.dataexchange.DataSetOrigin>;
    /**
    ...
    constructor(name: string, args: DataSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const replaceOnChanges = { replaceOnChanges: ["assetType"] };
...
export interface DataSetArgs {
     ...
     * The type of asset that is added to a data set.
     */
    assetType: pulumi.Input<enums.dataexchange.DataSetAssetType>;
    /**
     * A description for the data set.
     */
