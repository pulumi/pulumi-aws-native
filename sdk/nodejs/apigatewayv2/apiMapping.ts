...
export class ApiMapping extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGatewayV2.ApiMappingAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGatewayV2.ApiMappingProperties>;
    ...
    constructor(name: string, argsOrState?: ApiMappingArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ApiMappingArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGatewayV2.ApiMappingProperties>;
    /**
