...
export class IntegrationResponse extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationResponse {
        return new IntegrationResponse(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGatewayV2:IntegrationResponse';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGatewayV2.IntegrationResponseAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGatewayV2.IntegrationResponseProperties>;
    ...
    constructor(name: string, argsOrState?: IntegrationResponseArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IntegrationResponseArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGatewayV2.IntegrationResponseProperties>;
    /**
