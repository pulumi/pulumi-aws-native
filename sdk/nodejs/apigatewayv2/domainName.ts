...
export class DomainName extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DomainName {
        return new DomainName(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGatewayV2.DomainNameAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGatewayV2.DomainNameProperties>;
    ...
    constructor(name: string, argsOrState?: DomainNameArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DomainNameArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGatewayV2.DomainNameProperties>;
    /**
