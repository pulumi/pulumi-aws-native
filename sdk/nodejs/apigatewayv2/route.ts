...
export class Route extends pulumi.CustomResource {
     ...
     */
    declare public readonly requestModels: pulumi.Output<any | undefined>;
    /**
     * The request parameters for the route. Supported only for WebSocket APIs.
     */
    declare public readonly requestParameters: pulumi.Output<outputs.apigatewayv2.RouteParameterConstraints[] | undefined>;
    /**
     * The route ID.
     */
...
export interface RouteArgs {
     ...
     * Search the [CloudFormation User Guide](https://docs.aws.amazon.com/cloudformation/) for `AWS::ApiGatewayV2::Route` for more information about the expected schema for this property.
     */
    requestModels?: any | undefined;
    /**
     * The request parameters for the route. Supported only for WebSocket APIs.
     */
    requestParameters?: pulumi.Input<pulumi.Input<inputs.apigatewayv2.RouteParameterConstraintsArgs>[] | undefined>;
    /**
     * The route key for the route. For HTTP APIs, the route key can be either ``$default``, or a combination of an HTTP method and resource path, for example, ``GET /pets``.
     */
