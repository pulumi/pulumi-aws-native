...
export class RouteResponse extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RouteResponse {
        return new RouteResponse(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGatewayV2:RouteResponse';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGatewayV2.RouteResponseAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGatewayV2.RouteResponseProperties>;
    ...
    constructor(name: string, argsOrState?: RouteResponseArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RouteResponseArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGatewayV2.RouteResponseProperties>;
    /**
