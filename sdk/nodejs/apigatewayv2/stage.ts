...
export class Stage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Stage {
        return new Stage(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:ApiGatewayV2:Stage';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ApiGatewayV2.StageAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ApiGatewayV2.StageProperties>;
    ...
    constructor(name: string, argsOrState?: StageArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface StageArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ApiGatewayV2.StageProperties>;
    /**
