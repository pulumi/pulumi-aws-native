...
export class Preferences extends pulumi.CustomResource {
     ...
     */
    public readonly idleConnection!: pulumi.Output<outputs.ssmguiconnect.PreferencesIdleConnectionPreferences[] | undefined>;
    ...
    constructor(name: string, args?: PreferencesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["idleConnection"] = args ? args.idleConnection : undefined;
            resourceInputs["accountId"] = undefined /*out*/;
        } else {
            resourceInputs["accountId"] = undefined /*out*/;
            resourceInputs["idleConnection"] = undefined /*out*/;
        }
...
export interface PreferencesArgs {
     ...
     * A map for Idle Connection Preferences
     */
    idleConnection?: pulumi.Input<pulumi.Input<inputs.ssmguiconnect.PreferencesIdleConnectionPreferencesArgs>[]>;
}
