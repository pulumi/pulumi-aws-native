...
export class NotificationChannel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:FMS:NotificationChannel';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.FMS.NotificationChannelAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.FMS.NotificationChannelProperties>;
...
export interface NotificationChannelArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.FMS.NotificationChannelProperties>;
    /**
