...
export class Analyzer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Analyzer {
        return new Analyzer(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AccessAnalyzer.AnalyzerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AccessAnalyzer.AnalyzerProperties>;
    ...
    constructor(name: string, argsOrState?: AnalyzerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface AnalyzerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AccessAnalyzer.AnalyzerProperties>;
    /**
