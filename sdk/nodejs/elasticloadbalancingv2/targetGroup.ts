...
export class TargetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TargetGroup {
        return new TargetGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElasticLoadBalancingV2.TargetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElasticLoadBalancingV2.TargetGroupProperties>;
    ...
    constructor(name: string, argsOrState?: TargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TargetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElasticLoadBalancingV2.TargetGroupProperties>;
    /**
