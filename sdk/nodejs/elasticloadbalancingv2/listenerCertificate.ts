...
export class ListenerCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ListenerCertificate {
        return new ListenerCertificate(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ElasticLoadBalancingV2.ListenerCertificateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ElasticLoadBalancingV2.ListenerCertificateProperties>;
    ...
    constructor(name: string, argsOrState?: ListenerCertificateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ListenerCertificateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ElasticLoadBalancingV2.ListenerCertificateProperties>;
    /**
