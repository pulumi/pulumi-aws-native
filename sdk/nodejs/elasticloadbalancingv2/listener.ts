...
export interface ListenerArgs {
     ...
     * [TLS listener] The name of the Application-Layer Protocol Negotiation (ALPN) policy.
     */
    alpnPolicy?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The default SSL server certificate for a secure listener. You must provide exactly one certificate if the listener protocol is HTTPS or TLS.
     *  For an HTTPS listener, update requires some interruptions. For a TLS listener, update requires no interruption.
     *  To create a certificate list for a secure listener, use [AWS::ElasticLoadBalancingV2::ListenerCertificate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-listenercertificate.html).
     */
    certificates?: pulumi.Input<pulumi.Input<inputs.elasticloadbalancingv2.ListenerCertificateArgs>[] | undefined>;
    /**
     * The actions for the default rule. You cannot define a condition for a default rule.
     *  To create additional rules for an Application Load Balancer, use [AWS::ElasticLoadBalancingV2::ListenerRule](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-listenerrule.html).
     */
     ...
     * The listener attributes. Attributes that you do not modify retain their current values.
     */
    listenerAttributes?: pulumi.Input<pulumi.Input<inputs.elasticloadbalancingv2.ListenerAttributeArgs>[] | undefined>;
    /**
     * The Amazon Resource Name (ARN) of the load balancer.
     */
     ...
     * The mutual authentication configuration information.
     */
    mutualAuthentication?: pulumi.Input<inputs.elasticloadbalancingv2.ListenerMutualAuthenticationArgs | undefined>;
    /**
     * The port on which the load balancer is listening. You can't specify a port for a Gateway Load Balancer.
     */
