...
export class LocalGatewayRoute extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalGatewayRoute {
        return new LocalGatewayRoute(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:LocalGatewayRoute';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.LocalGatewayRouteAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.LocalGatewayRouteProperties>;
    ...
    constructor(name: string, argsOrState?: LocalGatewayRouteArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LocalGatewayRouteArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.LocalGatewayRouteProperties>;
    /**
