...
export class VPCEndpointService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCEndpointService {
        return new VPCEndpointService(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPCEndpointService';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCEndpointServiceAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCEndpointServiceProperties>;
    ...
    constructor(name: string, argsOrState?: VPCEndpointServiceArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VPCEndpointServiceArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCEndpointServiceProperties>;
    /**
