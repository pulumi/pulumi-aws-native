...
export class EC2Fleet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EC2Fleet {
        return new EC2Fleet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:EC2Fleet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.EC2FleetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.EC2FleetProperties>;
    ...
    constructor(name: string, argsOrState?: EC2FleetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EC2FleetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.EC2FleetProperties>;
    /**
