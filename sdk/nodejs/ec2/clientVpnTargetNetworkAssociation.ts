...
export class ClientVpnTargetNetworkAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientVpnTargetNetworkAssociation {
        return new ClientVpnTargetNetworkAssociation(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.ClientVpnTargetNetworkAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.ClientVpnTargetNetworkAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: ClientVpnTargetNetworkAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClientVpnTargetNetworkAssociationArgs | undefined;
...
export interface ClientVpnTargetNetworkAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.ClientVpnTargetNetworkAssociationProperties>;
    /**
