...
export class SubnetRouteTableAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubnetRouteTableAssociation {
        return new SubnetRouteTableAssociation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:SubnetRouteTableAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SubnetRouteTableAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SubnetRouteTableAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: SubnetRouteTableAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SubnetRouteTableAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SubnetRouteTableAssociationProperties>;
    /**
