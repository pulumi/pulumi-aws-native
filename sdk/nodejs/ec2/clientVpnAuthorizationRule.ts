...
export class ClientVpnAuthorizationRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientVpnAuthorizationRule {
        return new ClientVpnAuthorizationRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:ClientVpnAuthorizationRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.ClientVpnAuthorizationRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.ClientVpnAuthorizationRuleProperties>;
    ...
    constructor(name: string, argsOrState?: ClientVpnAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClientVpnAuthorizationRuleArgs | undefined;
...
export interface ClientVpnAuthorizationRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.ClientVpnAuthorizationRuleProperties>;
    /**
