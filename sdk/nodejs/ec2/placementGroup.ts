...
export class PlacementGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PlacementGroup {
        return new PlacementGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:PlacementGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.PlacementGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.PlacementGroupProperties>;
    ...
    constructor(name: string, argsOrState?: PlacementGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PlacementGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.PlacementGroupProperties>;
    /**
