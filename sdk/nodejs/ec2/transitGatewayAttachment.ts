...
export class TransitGatewayAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayAttachment {
        return new TransitGatewayAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TransitGatewayAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TransitGatewayAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TransitGatewayAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: TransitGatewayAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TransitGatewayAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TransitGatewayAttachmentProperties>;
    /**
