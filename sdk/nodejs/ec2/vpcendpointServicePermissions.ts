...
export class VPCEndpointServicePermissions extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCEndpointServicePermissions {
        return new VPCEndpointServicePermissions(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCEndpointServicePermissionsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCEndpointServicePermissionsProperties>;
    ...
    constructor(name: string, argsOrState?: VPCEndpointServicePermissionsArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VPCEndpointServicePermissionsArgs | undefined;
...
export interface VPCEndpointServicePermissionsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCEndpointServicePermissionsProperties>;
    /**
