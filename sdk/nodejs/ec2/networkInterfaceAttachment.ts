...
export class NetworkInterfaceAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkInterfaceAttachment {
        return new NetworkInterfaceAttachment(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.NetworkInterfaceAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.NetworkInterfaceAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: NetworkInterfaceAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NetworkInterfaceAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.NetworkInterfaceAttachmentProperties>;
    /**
