...
export class EIPAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:EIPAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.EIPAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.EIPAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: EIPAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EIPAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.EIPAssociationProperties>;
    /**
