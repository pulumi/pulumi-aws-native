...
export class EgressOnlyInternetGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EgressOnlyInternetGateway {
        return new EgressOnlyInternetGateway(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:EgressOnlyInternetGateway';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.EgressOnlyInternetGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.EgressOnlyInternetGatewayProperties>;
    ...
    constructor(name: string, argsOrState?: EgressOnlyInternetGatewayArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EgressOnlyInternetGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.EgressOnlyInternetGatewayProperties>;
    /**
