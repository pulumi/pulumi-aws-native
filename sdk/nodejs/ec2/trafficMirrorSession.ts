...
export class TrafficMirrorSession extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorSession {
        return new TrafficMirrorSession(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TrafficMirrorSession';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TrafficMirrorSessionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TrafficMirrorSessionProperties>;
    ...
    constructor(name: string, argsOrState?: TrafficMirrorSessionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TrafficMirrorSessionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TrafficMirrorSessionProperties>;
    /**
