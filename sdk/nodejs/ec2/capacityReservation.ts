...
export class CapacityReservation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityReservation {
        return new CapacityReservation(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.CapacityReservationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.CapacityReservationProperties>;
    ...
    constructor(name: string, argsOrState?: CapacityReservationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CapacityReservationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.CapacityReservationProperties>;
    /**
