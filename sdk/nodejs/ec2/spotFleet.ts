...
export class SpotFleet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SpotFleet {
        return new SpotFleet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:SpotFleet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SpotFleetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SpotFleetProperties>;
    ...
    constructor(name: string, argsOrState?: SpotFleetArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SpotFleetArgs | undefined;
...
export interface SpotFleetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SpotFleetProperties>;
    /**
