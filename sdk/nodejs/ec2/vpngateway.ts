...
export class VPNGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPNGateway';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPNGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPNGatewayProperties>;
...
export interface VPNGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPNGatewayProperties>;
    /**
