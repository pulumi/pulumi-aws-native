...
export class TransitGatewayRoute extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayRoute {
        return new TransitGatewayRoute(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TransitGatewayRoute';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TransitGatewayRouteAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TransitGatewayRouteProperties>;
    ...
    constructor(name: string, argsOrState?: TransitGatewayRouteArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TransitGatewayRouteArgs | undefined;
...
export interface TransitGatewayRouteArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TransitGatewayRouteProperties>;
    /**
