...
export class CustomerGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomerGateway {
        return new CustomerGateway(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.CustomerGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.CustomerGatewayProperties>;
    ...
    constructor(name: string, argsOrState?: CustomerGatewayArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CustomerGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.CustomerGatewayProperties>;
    /**
