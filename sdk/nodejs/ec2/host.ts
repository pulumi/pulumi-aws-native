...
export class Host extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Host {
        return new Host(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.HostAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.HostProperties>;
    ...
    constructor(name: string, argsOrState?: HostArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface HostArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.HostProperties>;
    /**
