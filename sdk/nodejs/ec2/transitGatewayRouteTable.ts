...
export class TransitGatewayRouteTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayRouteTable {
        return new TransitGatewayRouteTable(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TransitGatewayRouteTableAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TransitGatewayRouteTableProperties>;
    ...
    constructor(name: string, argsOrState?: TransitGatewayRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TransitGatewayRouteTableArgs | undefined;
...
export interface TransitGatewayRouteTableArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TransitGatewayRouteTableProperties>;
    /**
