...
export class SubnetNetworkAclAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubnetNetworkAclAssociation {
        return new SubnetNetworkAclAssociation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:SubnetNetworkAclAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SubnetNetworkAclAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SubnetNetworkAclAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: SubnetNetworkAclAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SubnetNetworkAclAssociationArgs | undefined;
...
export interface SubnetNetworkAclAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SubnetNetworkAclAssociationProperties>;
    /**
