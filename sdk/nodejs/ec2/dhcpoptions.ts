...
export class DHCPOptions extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DHCPOptions {
        return new DHCPOptions(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.DHCPOptionsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.DHCPOptionsProperties>;
    ...
    constructor(name: string, argsOrState?: DHCPOptionsArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DHCPOptionsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.DHCPOptionsProperties>;
    /**
