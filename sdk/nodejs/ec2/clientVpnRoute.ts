...
export class ClientVpnRoute extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientVpnRoute {
        return new ClientVpnRoute(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:ClientVpnRoute';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.ClientVpnRouteAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.ClientVpnRouteProperties>;
    ...
    constructor(name: string, argsOrState?: ClientVpnRouteArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClientVpnRouteArgs | undefined;
...
export interface ClientVpnRouteArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.ClientVpnRouteProperties>;
    /**
