...
export class VolumeAttachment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VolumeAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VolumeAttachmentProperties>;
...
export interface VolumeAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VolumeAttachmentProperties>;
    /**
