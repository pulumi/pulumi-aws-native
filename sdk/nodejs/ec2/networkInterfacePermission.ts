...
export class NetworkInterfacePermission extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkInterfacePermission {
        return new NetworkInterfacePermission(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.NetworkInterfacePermissionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.NetworkInterfacePermissionProperties>;
    ...
    constructor(name: string, argsOrState?: NetworkInterfacePermissionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NetworkInterfacePermissionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.NetworkInterfacePermissionProperties>;
    /**
