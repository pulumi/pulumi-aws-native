...
export class LaunchTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LaunchTemplate {
        return new LaunchTemplate(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:LaunchTemplate';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.LaunchTemplateAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.LaunchTemplateProperties>;
    ...
    constructor(name: string, argsOrState?: LaunchTemplateArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LaunchTemplateArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.LaunchTemplateProperties>;
    /**
