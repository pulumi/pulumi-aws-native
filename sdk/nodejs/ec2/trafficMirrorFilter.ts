...
export class TrafficMirrorFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorFilter {
        return new TrafficMirrorFilter(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TrafficMirrorFilter';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TrafficMirrorFilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TrafficMirrorFilterProperties>;
    ...
    constructor(name: string, argsOrState?: TrafficMirrorFilterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TrafficMirrorFilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TrafficMirrorFilterProperties>;
    /**
