...
export class VPNGatewayRoutePropagation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPNGatewayRoutePropagation {
        return new VPNGatewayRoutePropagation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPNGatewayRoutePropagation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPNGatewayRoutePropagationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPNGatewayRoutePropagationProperties>;
    ...
    constructor(name: string, argsOrState?: VPNGatewayRoutePropagationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VPNGatewayRoutePropagationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPNGatewayRoutePropagationProperties>;
    /**
