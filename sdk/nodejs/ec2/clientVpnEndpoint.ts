...
export class ClientVpnEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientVpnEndpoint {
        return new ClientVpnEndpoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:ClientVpnEndpoint';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.ClientVpnEndpointAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.ClientVpnEndpointProperties>;
    ...
    constructor(name: string, argsOrState?: ClientVpnEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClientVpnEndpointArgs | undefined;
...
export interface ClientVpnEndpointArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.ClientVpnEndpointProperties>;
    /**
