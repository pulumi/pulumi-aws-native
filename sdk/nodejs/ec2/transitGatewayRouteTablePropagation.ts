...
export class TransitGatewayRouteTablePropagation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayRouteTablePropagation {
        return new TransitGatewayRouteTablePropagation(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: TransitGatewayRouteTablePropagationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as TransitGatewayRouteTablePropagationArgs | undefined;
