...
export class VPCPeeringConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCPeeringConnection {
        return new VPCPeeringConnection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPCPeeringConnection';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCPeeringConnectionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCPeeringConnectionProperties>;
    ...
    constructor(name: string, argsOrState?: VPCPeeringConnectionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VPCPeeringConnectionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCPeeringConnectionProperties>;
    /**
