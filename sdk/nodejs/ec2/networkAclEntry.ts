...
export class NetworkAclEntry extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkAclEntry {
        return new NetworkAclEntry(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:NetworkAclEntry';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.NetworkAclEntryAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.NetworkAclEntryProperties>;
    ...
    constructor(name: string, argsOrState?: NetworkAclEntryArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as NetworkAclEntryArgs | undefined;
...
export interface NetworkAclEntryArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.NetworkAclEntryProperties>;
    /**
