...
export class GatewayRouteTableAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GatewayRouteTableAssociation {
        return new GatewayRouteTableAssociation(name, undefined, { ...opts, id: id });
    }
    ...
    constructor(name: string, argsOrState?: GatewayRouteTableAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as GatewayRouteTableAssociationArgs | undefined;
