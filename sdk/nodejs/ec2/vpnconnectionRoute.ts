...
export class VPNConnectionRoute extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPNConnectionRoute {
        return new VPNConnectionRoute(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPNConnectionRouteAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPNConnectionRouteProperties>;
    ...
    constructor(name: string, argsOrState?: VPNConnectionRouteArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VPNConnectionRouteArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPNConnectionRouteProperties>;
    /**
