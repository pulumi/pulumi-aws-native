...
export class VPCEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCEndpoint {
        return new VPCEndpoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPCEndpoint';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCEndpointAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCEndpointProperties>;
    ...
    constructor(name: string, argsOrState?: VPCEndpointArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VPCEndpointArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCEndpointProperties>;
    /**
