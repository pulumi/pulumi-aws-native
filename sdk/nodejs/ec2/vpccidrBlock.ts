...
export class VPCCidrBlock extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCCidrBlock {
        return new VPCCidrBlock(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCCidrBlockAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCCidrBlockProperties>;
    ...
    constructor(name: string, argsOrState?: VPCCidrBlockArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VPCCidrBlockArgs | undefined;
...
export interface VPCCidrBlockArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCCidrBlockProperties>;
    /**
