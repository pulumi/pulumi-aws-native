...
export class NetworkAcl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkAcl {
        return new NetworkAcl(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.NetworkAclAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.NetworkAclProperties>;
    ...
    constructor(name: string, argsOrState?: NetworkAclArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface NetworkAclArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.NetworkAclProperties>;
    /**
