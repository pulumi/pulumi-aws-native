...
export class TrafficMirrorFilterRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorFilterRule {
        return new TrafficMirrorFilterRule(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TrafficMirrorFilterRule';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TrafficMirrorFilterRuleAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TrafficMirrorFilterRuleProperties>;
    ...
    constructor(name: string, argsOrState?: TrafficMirrorFilterRuleArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TrafficMirrorFilterRuleArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TrafficMirrorFilterRuleProperties>;
    /**
