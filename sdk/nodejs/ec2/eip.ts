...
export class EIP extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EIP {
        return new EIP(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.EIPAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.EIPProperties>;
    ...
    constructor(name: string, argsOrState?: EIPArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EIPArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.EIPProperties>;
    /**
