...
export class TransitGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGateway {
        return new TransitGateway(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TransitGateway';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TransitGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TransitGatewayProperties>;
    ...
    constructor(name: string, argsOrState?: TransitGatewayArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TransitGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TransitGatewayProperties>;
    /**
