...
export class VPCGatewayAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VPCGatewayAttachment {
        return new VPCGatewayAttachment(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:VPCGatewayAttachment';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.VPCGatewayAttachmentAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.VPCGatewayAttachmentProperties>;
    ...
    constructor(name: string, argsOrState?: VPCGatewayAttachmentArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as VPCGatewayAttachmentArgs | undefined;
...
export interface VPCGatewayAttachmentArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.VPCGatewayAttachmentProperties>;
    /**
