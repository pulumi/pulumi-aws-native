...
export class SecurityGroupEgress extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityGroupEgress {
        return new SecurityGroupEgress(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SecurityGroupEgressAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SecurityGroupEgressProperties>;
    ...
    constructor(name: string, argsOrState?: SecurityGroupEgressArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SecurityGroupEgressArgs | undefined;
...
export interface SecurityGroupEgressArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SecurityGroupEgressProperties>;
    /**
