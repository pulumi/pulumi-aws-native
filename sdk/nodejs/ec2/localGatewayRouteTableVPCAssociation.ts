...
export class LocalGatewayRouteTableVPCAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalGatewayRouteTableVPCAssociation {
        return new LocalGatewayRouteTableVPCAssociation(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:LocalGatewayRouteTableVPCAssociation';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.LocalGatewayRouteTableVPCAssociationAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.LocalGatewayRouteTableVPCAssociationProperties>;
    ...
    constructor(name: string, argsOrState?: LocalGatewayRouteTableVPCAssociationArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LocalGatewayRouteTableVPCAssociationArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.LocalGatewayRouteTableVPCAssociationProperties>;
    /**
