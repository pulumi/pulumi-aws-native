...
export class SubnetCidrBlock extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SubnetCidrBlock {
        return new SubnetCidrBlock(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SubnetCidrBlockAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SubnetCidrBlockProperties>;
    ...
    constructor(name: string, argsOrState?: SubnetCidrBlockArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SubnetCidrBlockArgs | undefined;
...
export interface SubnetCidrBlockArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SubnetCidrBlockProperties>;
    /**
