...
export class SecurityGroupIngress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:SecurityGroupIngress';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.SecurityGroupIngressAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.SecurityGroupIngressProperties>;
    ...
    constructor(name: string, argsOrState?: SecurityGroupIngressArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as SecurityGroupIngressArgs | undefined;
...
export interface SecurityGroupIngressArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.SecurityGroupIngressProperties>;
    /**
