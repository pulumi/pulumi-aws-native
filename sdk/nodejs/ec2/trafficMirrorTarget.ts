...
export class TrafficMirrorTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TrafficMirrorTarget {
        return new TrafficMirrorTarget(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EC2:TrafficMirrorTarget';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.TrafficMirrorTargetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.TrafficMirrorTargetProperties>;
    ...
    constructor(name: string, argsOrState?: TrafficMirrorTargetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface TrafficMirrorTargetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.TrafficMirrorTargetProperties>;
    /**
