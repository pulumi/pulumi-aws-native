...
export class InternetGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InternetGateway {
        return new InternetGateway(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EC2.InternetGatewayAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EC2.InternetGatewayProperties>;
    ...
    constructor(name: string, argsOrState?: InternetGatewayArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface InternetGatewayArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EC2.InternetGatewayProperties>;
    /**
