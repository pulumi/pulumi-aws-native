...
export class PreparedStatement extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PreparedStatement {
        return new PreparedStatement(name, undefined as any, { ...opts, id: id });
    }
