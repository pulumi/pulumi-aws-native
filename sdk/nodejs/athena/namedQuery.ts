...
export class NamedQuery extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NamedQuery {
        return new NamedQuery(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Athena:NamedQuery';
    ...
    constructor(name: string, argsOrState?: NamedQueryArgs, opts?: pulumi.CustomResourceOptions) {
