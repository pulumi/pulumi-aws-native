...
export class EventInvokeConfig extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventInvokeConfig {
        return new EventInvokeConfig(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Lambda.EventInvokeConfigAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Lambda.EventInvokeConfigProperties>;
    ...
    constructor(name: string, argsOrState?: EventInvokeConfigArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as EventInvokeConfigArgs | undefined;
...
export interface EventInvokeConfigArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Lambda.EventInvokeConfigProperties>;
    /**
