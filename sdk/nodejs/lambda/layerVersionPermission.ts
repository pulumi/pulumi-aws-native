...
export class LayerVersionPermission extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LayerVersionPermission {
        return new LayerVersionPermission(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Lambda.LayerVersionPermissionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Lambda.LayerVersionPermissionProperties>;
    ...
    constructor(name: string, argsOrState?: LayerVersionPermissionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LayerVersionPermissionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Lambda.LayerVersionPermissionProperties>;
    /**
