...
export class LayerVersion extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LayerVersion {
        return new LayerVersion(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Lambda:LayerVersion';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Lambda.LayerVersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Lambda.LayerVersionProperties>;
    ...
    constructor(name: string, argsOrState?: LayerVersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface LayerVersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Lambda.LayerVersionProperties>;
    /**
