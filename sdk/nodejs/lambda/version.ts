...
export class Version extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Version {
        return new Version(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Lambda:Version';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Lambda.VersionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Lambda.VersionProperties>;
    ...
    constructor(name: string, argsOrState?: VersionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface VersionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Lambda.VersionProperties>;
    /**
