...
export class BackupSelection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupSelection {
        return new BackupSelection(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Backup:BackupSelection';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Backup.BackupSelectionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Backup.BackupSelectionProperties>;
    ...
    constructor(name: string, argsOrState?: BackupSelectionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BackupSelectionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Backup.BackupSelectionProperties>;
    /**
