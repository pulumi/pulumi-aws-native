...
export class BackupPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackupPlan {
        return new BackupPlan(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Backup:BackupPlan';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Backup.BackupPlanAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Backup.BackupPlanProperties>;
    ...
    constructor(name: string, argsOrState?: BackupPlanArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BackupPlanArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Backup.BackupPlanProperties>;
    /**
