...
export class PrimaryTaskSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrimaryTaskSet {
        return new PrimaryTaskSet(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.ECS.PrimaryTaskSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ECS.PrimaryTaskSetProperties>;
    ...
    constructor(name: string, argsOrState?: PrimaryTaskSetArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as PrimaryTaskSetArgs | undefined;
...
export interface PrimaryTaskSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.ECS.PrimaryTaskSetProperties>;
    /**
