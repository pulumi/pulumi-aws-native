...
// Export enums:
export * from "../types/enums/internetmonitor";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "aws-native:internetmonitor:Monitor":
...
pulumi.runtime.registerResourceModule("aws-native", "internetmonitor", _module)
