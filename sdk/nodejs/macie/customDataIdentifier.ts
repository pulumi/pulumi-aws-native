...
export class CustomDataIdentifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomDataIdentifier {
        return new CustomDataIdentifier(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Macie.CustomDataIdentifierAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Macie.CustomDataIdentifierProperties>;
    ...
    constructor(name: string, argsOrState?: CustomDataIdentifierArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CustomDataIdentifierArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Macie.CustomDataIdentifierProperties>;
    /**
