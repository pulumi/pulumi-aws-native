...
export class FindingsFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FindingsFilter {
        return new FindingsFilter(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Macie:FindingsFilter';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Macie.FindingsFilterAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Macie.FindingsFilterProperties>;
    ...
    constructor(name: string, argsOrState?: FindingsFilterArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface FindingsFilterArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Macie.FindingsFilterProperties>;
    /**
