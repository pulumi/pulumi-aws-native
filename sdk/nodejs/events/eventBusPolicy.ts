...
export class EventBusPolicy extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Events.EventBusPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Events.EventBusPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: EventBusPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EventBusPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Events.EventBusPolicyProperties>;
    /**
