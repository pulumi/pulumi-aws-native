...
export class EventBus extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EventBus {
        return new EventBus(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Events:EventBus';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Events.EventBusAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Events.EventBusProperties>;
    ...
    constructor(name: string, argsOrState?: EventBusArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface EventBusArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Events.EventBusProperties>;
    /**
