...
export class DataCatalogEncryptionSettings extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataCatalogEncryptionSettings {
        return new DataCatalogEncryptionSettings(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.DataCatalogEncryptionSettingsAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.DataCatalogEncryptionSettingsProperties>;
    ...
    constructor(name: string, argsOrState?: DataCatalogEncryptionSettingsArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DataCatalogEncryptionSettingsArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.DataCatalogEncryptionSettingsProperties>;
    /**
