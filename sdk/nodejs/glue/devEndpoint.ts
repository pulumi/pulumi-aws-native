...
export class DevEndpoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DevEndpoint {
        return new DevEndpoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Glue:DevEndpoint';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.DevEndpointAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.DevEndpointProperties>;
    ...
    constructor(name: string, argsOrState?: DevEndpointArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DevEndpointArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.DevEndpointProperties>;
    /**
