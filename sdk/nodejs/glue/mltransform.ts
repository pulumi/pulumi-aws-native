...
export class MLTransform extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MLTransform {
        return new MLTransform(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.MLTransformAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.MLTransformProperties>;
    ...
    constructor(name: string, argsOrState?: MLTransformArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface MLTransformArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.MLTransformProperties>;
    /**
