...
export class Crawler extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Crawler {
        return new Crawler(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Glue:Crawler';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.CrawlerAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.CrawlerProperties>;
    ...
    constructor(name: string, argsOrState?: CrawlerArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CrawlerArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.CrawlerProperties>;
    /**
