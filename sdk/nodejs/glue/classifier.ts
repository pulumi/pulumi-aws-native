...
export class Classifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Classifier {
        return new Classifier(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Glue:Classifier';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.ClassifierAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.ClassifierProperties>;
    ...
    constructor(name: string, argsOrState?: ClassifierArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ClassifierArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.ClassifierProperties>;
    /**
