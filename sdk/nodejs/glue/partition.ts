...
export class Partition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Partition {
        return new Partition(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Glue.PartitionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Glue.PartitionProperties>;
    ...
    constructor(name: string, argsOrState?: PartitionArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface PartitionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Glue.PartitionProperties>;
    /**
