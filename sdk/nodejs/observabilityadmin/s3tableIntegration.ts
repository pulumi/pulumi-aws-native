...
export class S3TableIntegration extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): S3TableIntegration {
        return new S3TableIntegration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:observabilityadmin:S3TableIntegration';
     ...
     */
    declare public readonly encryption: pulumi.Output<outputs.observabilityadmin.S3TableIntegrationEncryptionConfig>;
    /**
     * The CloudWatch Logs data sources to associate with the S3 Table Integration
     */
    declare public readonly logSources: pulumi.Output<outputs.observabilityadmin.S3TableIntegrationLogSource[] | undefined>;
    /**
