 ...
 */
export class OrganizationCentralizationRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationCentralizationRule {
        return new OrganizationCentralizationRule(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws-native:observabilityadmin:OrganizationCentralizationRule';
     ...
     */
    public static isInstance(obj: any): obj is OrganizationCentralizationRule {
    ...
    public readonly rule!: pulumi.Output<outputs.observabilityadmin.OrganizationCentralizationRuleCentralizationRule>;
