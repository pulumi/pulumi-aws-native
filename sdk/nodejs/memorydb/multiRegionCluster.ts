...
export class MultiRegionCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly multiRegionClusterNameSuffix: pulumi.Output<string | undefined>;
    /**
     * The name of the parameter group associated with the multi region cluster.
     */
    declare public readonly multiRegionParameterGroupName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly updateStrategy: pulumi.Output<enums.memorydb.MultiRegionClusterUpdateStrategy | undefined>;
