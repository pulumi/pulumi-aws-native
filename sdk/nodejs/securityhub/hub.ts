...
export class Hub extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.SecurityHub.HubAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.SecurityHub.HubProperties>;
...
export interface HubArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.SecurityHub.HubProperties>;
    /**
