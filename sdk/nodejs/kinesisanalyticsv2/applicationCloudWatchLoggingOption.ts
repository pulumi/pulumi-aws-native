...
export class ApplicationCloudWatchLoggingOption extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationCloudWatchLoggingOption {
        return new ApplicationCloudWatchLoggingOption(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOptionAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOptionProperties>;
    ...
    constructor(name: string, argsOrState?: ApplicationCloudWatchLoggingOptionArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ApplicationCloudWatchLoggingOptionArgs | undefined;
...
export interface ApplicationCloudWatchLoggingOptionArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOptionProperties>;
    /**
