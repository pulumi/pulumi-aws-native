...
export class ClusterParameterGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterParameterGroup {
        return new ClusterParameterGroup(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:Redshift:ClusterParameterGroup';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Redshift.ClusterParameterGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Redshift.ClusterParameterGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ClusterParameterGroupArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ClusterParameterGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Redshift.ClusterParameterGroupProperties>;
    /**
