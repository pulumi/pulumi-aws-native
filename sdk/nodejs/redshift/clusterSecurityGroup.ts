...
export class ClusterSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSecurityGroup {
        return new ClusterSecurityGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Redshift.ClusterSecurityGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Redshift.ClusterSecurityGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ClusterSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClusterSecurityGroupArgs | undefined;
...
export interface ClusterSecurityGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Redshift.ClusterSecurityGroupProperties>;
    /**
