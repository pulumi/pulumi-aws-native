...
export class ClusterSecurityGroupIngress extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSecurityGroupIngress {
        return new ClusterSecurityGroupIngress(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Redshift.ClusterSecurityGroupIngressAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Redshift.ClusterSecurityGroupIngressProperties>;
    ...
    constructor(name: string, argsOrState?: ClusterSecurityGroupIngressArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClusterSecurityGroupIngressArgs | undefined;
...
export interface ClusterSecurityGroupIngressArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Redshift.ClusterSecurityGroupIngressProperties>;
    /**
