...
export class ClusterSubnetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterSubnetGroup {
        return new ClusterSubnetGroup(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.Redshift.ClusterSubnetGroupAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.Redshift.ClusterSubnetGroupProperties>;
    ...
    constructor(name: string, argsOrState?: ClusterSubnetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as ClusterSubnetGroupArgs | undefined;
...
export interface ClusterSubnetGroupArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.Redshift.ClusterSubnetGroupProperties>;
    /**
