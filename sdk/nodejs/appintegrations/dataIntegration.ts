...
export class DataIntegration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DataIntegrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            inputs["scheduleConfig"] = args ? args.scheduleConfig : undefined;
            inputs["sourceURI"] = args ? args.sourceURI : undefined;
            inputs["tags"] = args ? args.tags : undefined;
            inputs["dataIntegrationArn"] = undefined /*out*/;
        } else {
            inputs["dataIntegrationArn"] = undefined /*out*/;
            inputs["description"] = undefined /*out*/;
            inputs["kmsKey"] = undefined /*out*/;
            inputs["name"] = undefined /*out*/;
            inputs["scheduleConfig"] = undefined /*out*/;
            inputs["sourceURI"] = undefined /*out*/;
            inputs["tags"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(DataIntegration.__pulumiType, name, inputs, opts);
    }
}
