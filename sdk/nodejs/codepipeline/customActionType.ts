...
export class CustomActionType extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CustomActionType {
        return new CustomActionType(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodePipeline.CustomActionTypeAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodePipeline.CustomActionTypeProperties>;
    ...
    constructor(name: string, argsOrState?: CustomActionTypeArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface CustomActionTypeArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodePipeline.CustomActionTypeProperties>;
    /**
