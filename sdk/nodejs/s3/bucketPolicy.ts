...
export class BucketPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BucketPolicy {
        return new BucketPolicy(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.S3.BucketPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.S3.BucketPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: BucketPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface BucketPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.S3.BucketPolicyProperties>;
    /**
