...
export class AccessPoint extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessPoint {
        return new AccessPoint(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:S3:AccessPoint';
    ...
    constructor(name: string, argsOrState?: AccessPointArgs, opts?: pulumi.CustomResourceOptions) {
