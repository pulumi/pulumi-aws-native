...
export class StorageLens extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:S3:StorageLens';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.S3.StorageLensAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.S3.StorageLensProperties>;
...
export interface StorageLensArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.S3.StorageLensProperties>;
    /**
