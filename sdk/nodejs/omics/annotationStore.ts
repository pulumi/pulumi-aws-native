...
export class AnnotationStore extends pulumi.CustomResource {
    ...
    public readonly storeOptions!: pulumi.Output<outputs.omics.AnnotationStoreStoreOptions | undefined>;
...
export interface AnnotationStoreArgs {
    ...
    storeOptions?: pulumi.Input<inputs.omics.AnnotationStoreStoreOptionsArgs>;
