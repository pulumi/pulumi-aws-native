...
export class ScalingPlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalingPlan {
        return new ScalingPlan(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:AutoScalingPlans:ScalingPlan';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.AutoScalingPlans.ScalingPlanAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.AutoScalingPlans.ScalingPlanProperties>;
    ...
    constructor(name: string, argsOrState?: ScalingPlanArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ScalingPlanArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.AutoScalingPlans.ScalingPlanProperties>;
    /**
