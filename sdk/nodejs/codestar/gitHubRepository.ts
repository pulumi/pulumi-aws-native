...
export class GitHubRepository extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GitHubRepository {
        return new GitHubRepository(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:CodeStar:GitHubRepository';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.CodeStar.GitHubRepositoryAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.CodeStar.GitHubRepositoryProperties>;
    ...
    constructor(name: string, argsOrState?: GitHubRepositoryArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as GitHubRepositoryArgs | undefined;
...
export interface GitHubRepositoryArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.CodeStar.GitHubRepositoryProperties>;
    /**
