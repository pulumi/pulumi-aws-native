...
export class RegistryPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryPolicy {
        return new RegistryPolicy(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EventSchemas.RegistryPolicyAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EventSchemas.RegistryPolicyProperties>;
    ...
    constructor(name: string, argsOrState?: RegistryPolicyArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface RegistryPolicyArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EventSchemas.RegistryPolicyProperties>;
    /**
