...
export class Schema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EventSchemas:Schema';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EventSchemas.SchemaAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EventSchemas.SchemaProperties>;
    ...
    constructor(name: string, argsOrState?: SchemaArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SchemaArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EventSchemas.SchemaProperties>;
    /**
