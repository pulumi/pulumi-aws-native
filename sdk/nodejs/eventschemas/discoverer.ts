...
export class Discoverer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Discoverer {
        return new Discoverer(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:EventSchemas:Discoverer';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.EventSchemas.DiscovererAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.EventSchemas.DiscovererProperties>;
    ...
    constructor(name: string, argsOrState?: DiscovererArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DiscovererArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.EventSchemas.DiscovererProperties>;
    /**
