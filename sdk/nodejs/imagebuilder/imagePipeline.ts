...
export class ImagePipeline extends pulumi.CustomResource {
     ...
     */
    declare public readonly status: pulumi.Output<enums.imagebuilder.ImagePipelineStatus | undefined>;
    /**
     ...
     */
    declare public readonly workflows: pulumi.Output<outputs.imagebuilder.ImagePipelineWorkflowConfiguration[] | undefined>;
...
export interface ImagePipelineArgs {
     ...
     * The tags to be applied to images created by this pipeline.
     */
    imageTags?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
    /**
     * The image tests configuration of the image pipeline.
     */
