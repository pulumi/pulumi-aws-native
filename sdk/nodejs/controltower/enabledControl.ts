...
export class EnabledControl extends pulumi.CustomResource {
     ...
     */
    public readonly tags!: pulumi.Output<outputs.controltower.EnabledControlTag[] | undefined>;
    /**
...
export interface EnabledControlArgs {
     ...
     * A set of tags to assign to the enabled control.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.controltower.EnabledControlTagArgs>[]>;
    /**
     * Arn for Organizational unit to which the control needs to be applied
     */
