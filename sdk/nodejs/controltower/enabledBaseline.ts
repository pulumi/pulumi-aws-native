...
export class EnabledBaseline extends pulumi.CustomResource {
    ...
    public readonly tags!: pulumi.Output<outputs.controltower.EnabledBaselineTag[] | undefined>;
...
export interface EnabledBaselineArgs {
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.controltower.EnabledBaselineTagArgs>[]>;
