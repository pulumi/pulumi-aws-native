...
export class SqlInjectionMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlInjectionMatchSet {
        return new SqlInjectionMatchSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAF:SqlInjectionMatchSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.SqlInjectionMatchSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.SqlInjectionMatchSetProperties>;
    ...
    constructor(name: string, argsOrState?: SqlInjectionMatchSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SqlInjectionMatchSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.SqlInjectionMatchSetProperties>;
    /**
