...
export class XssMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): XssMatchSet {
        return new XssMatchSet(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.XssMatchSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.XssMatchSetProperties>;
    ...
    constructor(name: string, argsOrState?: XssMatchSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface XssMatchSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.XssMatchSetProperties>;
    /**
