...
export class WebACL extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAF:WebACL';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.WebACLAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.WebACLProperties>;
...
export interface WebACLArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.WebACLProperties>;
    /**
