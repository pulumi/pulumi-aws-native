...
export class SizeConstraintSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SizeConstraintSet {
        return new SizeConstraintSet(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAF:SizeConstraintSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.SizeConstraintSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.SizeConstraintSetProperties>;
    ...
    constructor(name: string, argsOrState?: SizeConstraintSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface SizeConstraintSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.SizeConstraintSetProperties>;
    /**
