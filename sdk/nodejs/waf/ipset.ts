...
export class IPSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAF:IPSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.IPSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.IPSetProperties>;
...
export interface IPSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.IPSetProperties>;
    /**
