...
export class ByteMatchSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudformation:WAF:ByteMatchSet';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.WAF.ByteMatchSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.WAF.ByteMatchSetProperties>;
...
export interface ByteMatchSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.WAF.ByteMatchSetProperties>;
    /**
