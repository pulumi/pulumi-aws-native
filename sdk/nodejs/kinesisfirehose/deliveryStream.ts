...
export class DeliveryStream extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DeliveryStream {
        return new DeliveryStream(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.KinesisFirehose.DeliveryStreamAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.KinesisFirehose.DeliveryStreamProperties>;
    ...
    constructor(name: string, argsOrState?: DeliveryStreamArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {
            const args = argsOrState as DeliveryStreamArgs | undefined;
...
export interface DeliveryStreamArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.KinesisFirehose.DeliveryStreamProperties>;
    /**
