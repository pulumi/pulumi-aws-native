...
export class ConfigurationSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConfigurationSet {
        return new ConfigurationSet(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.PinpointEmail.ConfigurationSetAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.PinpointEmail.ConfigurationSetProperties>;
    ...
    constructor(name: string, argsOrState?: ConfigurationSetArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface ConfigurationSetArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.PinpointEmail.ConfigurationSetProperties>;
    /**
