...
export class DedicatedIpPool extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DedicatedIpPool {
        return new DedicatedIpPool(name, undefined, { ...opts, id: id });
    }
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.PinpointEmail.DedicatedIpPoolAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.PinpointEmail.DedicatedIpPoolProperties>;
    ...
    constructor(name: string, argsOrState?: DedicatedIpPoolArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface DedicatedIpPoolArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.PinpointEmail.DedicatedIpPoolProperties>;
    /**
