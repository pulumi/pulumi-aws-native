...
export class Identity extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Identity {
        return new Identity(name, undefined, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudformation:PinpointEmail:Identity';
     ...
     */
    public /*out*/ readonly attributes!: pulumi.Output<outputs.PinpointEmail.IdentityAttributes>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.PinpointEmail.IdentityProperties>;
    ...
    constructor(name: string, argsOrState?: IdentityArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IdentityArgs {
     ...
     * The input properties associated with the resource
     */
    readonly properties: pulumi.Input<inputs.PinpointEmail.IdentityProperties>;
    /**
