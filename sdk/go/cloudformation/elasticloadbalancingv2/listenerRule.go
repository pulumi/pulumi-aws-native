...
type ListenerRule struct {
	...
	Attributes ListenerRuleAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ListenerRulePropertiesOutput `pulumi:"properties"`
}
...
func GetListenerRule(ctx *pulumi.Context,
	...
	var resource ListenerRule
	err := ctx.ReadResource("cloudformation:ElasticLoadBalancingV2:ListenerRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type listenerRuleState struct {
	// The attributes associated with the resource
	Attributes *ListenerRuleAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ListenerRuleProperties `pulumi:"properties"`
}

type ListenerRuleState struct {
	// The attributes associated with the resource
	Attributes ListenerRuleAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ListenerRulePropertiesPtrInput
}
...
type ListenerRuleArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ListenerRulePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
