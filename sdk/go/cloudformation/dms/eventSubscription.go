...
func NewEventSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:DMS:EventSubscription", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventSubscription(ctx *pulumi.Context,
	...
	var resource EventSubscription
	err := ctx.ReadResource("cloudformation:DMS:EventSubscription", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
