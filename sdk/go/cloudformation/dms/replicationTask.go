...
type ReplicationTask struct {
	...
	Attributes ReplicationTaskAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ReplicationTaskPropertiesOutput `pulumi:"properties"`
}
...
func GetReplicationTask(ctx *pulumi.Context,
	...
	var resource ReplicationTask
	err := ctx.ReadResource("cloudformation:DMS:ReplicationTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type replicationTaskState struct {
	// The attributes associated with the resource
	Attributes *ReplicationTaskAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ReplicationTaskProperties `pulumi:"properties"`
}

type ReplicationTaskState struct {
	// The attributes associated with the resource
	Attributes ReplicationTaskAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ReplicationTaskPropertiesPtrInput
}
...
type ReplicationTaskArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ReplicationTaskPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
