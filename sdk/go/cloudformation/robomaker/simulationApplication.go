...
type SimulationApplication struct {
	...
	Attributes SimulationApplicationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties SimulationApplicationPropertiesOutput `pulumi:"properties"`
}
...
func GetSimulationApplication(ctx *pulumi.Context,
	...
	var resource SimulationApplication
	err := ctx.ReadResource("cloudformation:RoboMaker:SimulationApplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type simulationApplicationState struct {
	// The attributes associated with the resource
	Attributes *SimulationApplicationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *SimulationApplicationProperties `pulumi:"properties"`
}

type SimulationApplicationState struct {
	// The attributes associated with the resource
	Attributes SimulationApplicationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SimulationApplicationPropertiesPtrInput
}
...
type SimulationApplicationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SimulationApplicationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
