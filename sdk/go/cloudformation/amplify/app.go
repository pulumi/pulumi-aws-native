...
func NewApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.RegisterResource("cloudformation:Amplify:App", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApp(ctx *pulumi.Context,
	...
	var resource App
	err := ctx.ReadResource("cloudformation:Amplify:App", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
