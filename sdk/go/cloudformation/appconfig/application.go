...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:AppConfig:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("cloudformation:AppConfig:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
