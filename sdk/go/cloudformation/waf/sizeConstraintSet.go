...
type SizeConstraintSet struct {
	...
	Attributes SizeConstraintSetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties SizeConstraintSetPropertiesOutput `pulumi:"properties"`
}
...
func NewSizeConstraintSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAF:SizeConstraintSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSizeConstraintSet(ctx *pulumi.Context,
	...
	var resource SizeConstraintSet
	err := ctx.ReadResource("cloudformation:WAF:SizeConstraintSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type sizeConstraintSetState struct {
	// The attributes associated with the resource
	Attributes *SizeConstraintSetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *SizeConstraintSetProperties `pulumi:"properties"`
}

type SizeConstraintSetState struct {
	// The attributes associated with the resource
	Attributes SizeConstraintSetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SizeConstraintSetPropertiesPtrInput
}
...
type SizeConstraintSetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SizeConstraintSetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
