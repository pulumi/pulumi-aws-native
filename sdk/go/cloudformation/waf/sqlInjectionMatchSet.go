...
func NewSqlInjectionMatchSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAF:SqlInjectionMatchSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlInjectionMatchSet(ctx *pulumi.Context,
	...
	var resource SqlInjectionMatchSet
	err := ctx.ReadResource("cloudformation:WAF:SqlInjectionMatchSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
