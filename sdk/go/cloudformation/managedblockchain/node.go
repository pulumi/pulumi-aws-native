...
type Node struct {
	...
	Attributes NodeAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties NodePropertiesOutput `pulumi:"properties"`
}
...
func GetNode(ctx *pulumi.Context,
	...
	var resource Node
	err := ctx.ReadResource("cloudformation:ManagedBlockchain:Node", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type nodeState struct {
	// The attributes associated with the resource
	Attributes *NodeAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *NodeProperties `pulumi:"properties"`
}

type NodeState struct {
	// The attributes associated with the resource
	Attributes NodeAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties NodePropertiesPtrInput
}
