...
type ScalableTarget struct {
	...
	Attributes ScalableTargetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ScalableTargetPropertiesOutput `pulumi:"properties"`
}
...
func GetScalableTarget(ctx *pulumi.Context,
	...
	var resource ScalableTarget
	err := ctx.ReadResource("cloudformation:ApplicationAutoScaling:ScalableTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type scalableTargetState struct {
	// The attributes associated with the resource
	Attributes *ScalableTargetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ScalableTargetProperties `pulumi:"properties"`
}

type ScalableTargetState struct {
	// The attributes associated with the resource
	Attributes ScalableTargetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ScalableTargetPropertiesPtrInput
}
...
type ScalableTargetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ScalableTargetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
