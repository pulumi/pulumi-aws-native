...
type Flow struct {
	...
	Attributes FlowAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties FlowPropertiesOutput `pulumi:"properties"`
}
...
func NewFlow(ctx *pulumi.Context,
	...
	var resource Flow
	err := ctx.RegisterResource("cloudformation:AppFlow:Flow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFlow(ctx *pulumi.Context,
	...
	var resource Flow
	err := ctx.ReadResource("cloudformation:AppFlow:Flow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type flowState struct {
	// The attributes associated with the resource
	Attributes *FlowAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
...
type FlowState struct {
	// The attributes associated with the resource
	Attributes FlowAttributesPtrInput
	// An explicit logical ID for the resource
