...
type Preset struct {
	...
	Attributes PresetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties PresetPropertiesOutput `pulumi:"properties"`
}
...
func NewPreset(ctx *pulumi.Context,
	...
	var resource Preset
	err := ctx.RegisterResource("cloudformation:MediaConvert:Preset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPreset(ctx *pulumi.Context,
	...
	var resource Preset
	err := ctx.ReadResource("cloudformation:MediaConvert:Preset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type presetState struct {
	// The attributes associated with the resource
	Attributes *PresetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *PresetProperties `pulumi:"properties"`
}

type PresetState struct {
	// The attributes associated with the resource
	Attributes PresetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PresetPropertiesPtrInput
}
...
type PresetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PresetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
