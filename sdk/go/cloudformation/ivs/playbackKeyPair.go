...
type PlaybackKeyPair struct {
	...
	Attributes PlaybackKeyPairAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties PlaybackKeyPairPropertiesOutput `pulumi:"properties"`
}
...
func NewPlaybackKeyPair(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:IVS:PlaybackKeyPair", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPlaybackKeyPair(ctx *pulumi.Context,
	...
	var resource PlaybackKeyPair
	err := ctx.ReadResource("cloudformation:IVS:PlaybackKeyPair", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type playbackKeyPairState struct {
	// The attributes associated with the resource
	Attributes *PlaybackKeyPairAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *PlaybackKeyPairProperties `pulumi:"properties"`
}

type PlaybackKeyPairState struct {
	// The attributes associated with the resource
	Attributes PlaybackKeyPairAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PlaybackKeyPairPropertiesPtrInput
}
...
type PlaybackKeyPairArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PlaybackKeyPairPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type PlaybackKeyPairOutput struct {
	*pulumi.OutputState
}
