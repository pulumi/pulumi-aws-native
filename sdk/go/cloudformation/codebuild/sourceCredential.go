...
type SourceCredential struct {
	...
	Attributes SourceCredentialAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties SourceCredentialPropertiesOutput `pulumi:"properties"`
}
...
func GetSourceCredential(ctx *pulumi.Context,
	...
	var resource SourceCredential
	err := ctx.ReadResource("cloudformation:CodeBuild:SourceCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type sourceCredentialState struct {
	// The attributes associated with the resource
	Attributes *SourceCredentialAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *SourceCredentialProperties `pulumi:"properties"`
}

type SourceCredentialState struct {
	// The attributes associated with the resource
	Attributes SourceCredentialAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SourceCredentialPropertiesPtrInput
}
...
type SourceCredentialArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SourceCredentialPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
