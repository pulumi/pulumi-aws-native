...
type ADMChannel struct {
	...
	Attributes ADMChannelAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ADMChannelPropertiesOutput `pulumi:"properties"`
}
...
func GetADMChannel(ctx *pulumi.Context,
	...
	var resource ADMChannel
	err := ctx.ReadResource("cloudformation:Pinpoint:ADMChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type admchannelState struct {
	// The attributes associated with the resource
	Attributes *ADMChannelAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ADMChannelProperties `pulumi:"properties"`
}

type ADMChannelState struct {
	// The attributes associated with the resource
	Attributes ADMChannelAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ADMChannelPropertiesPtrInput
}
...
type ADMChannelArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ADMChannelPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
