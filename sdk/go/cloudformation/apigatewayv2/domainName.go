...
func NewDomainName(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:ApiGatewayV2:DomainName", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainName(ctx *pulumi.Context,
	...
	var resource DomainName
	err := ctx.ReadResource("cloudformation:ApiGatewayV2:DomainName", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
