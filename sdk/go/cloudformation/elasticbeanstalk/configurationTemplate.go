...
type ConfigurationTemplate struct {
	...
	Attributes ConfigurationTemplateAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ConfigurationTemplatePropertiesOutput `pulumi:"properties"`
}
...
func NewConfigurationTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:ElasticBeanstalk:ConfigurationTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationTemplate(ctx *pulumi.Context,
	...
	var resource ConfigurationTemplate
	err := ctx.ReadResource("cloudformation:ElasticBeanstalk:ConfigurationTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type configurationTemplateState struct {
	// The attributes associated with the resource
	Attributes *ConfigurationTemplateAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ConfigurationTemplateProperties `pulumi:"properties"`
}

type ConfigurationTemplateState struct {
	// The attributes associated with the resource
	Attributes ConfigurationTemplateAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ConfigurationTemplatePropertiesPtrInput
}
...
type ConfigurationTemplateArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ConfigurationTemplatePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
