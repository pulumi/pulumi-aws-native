...
type FunctionConfiguration struct {
	...
	Attributes FunctionConfigurationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties FunctionConfigurationPropertiesOutput `pulumi:"properties"`
}
...
func GetFunctionConfiguration(ctx *pulumi.Context,
	...
	var resource FunctionConfiguration
	err := ctx.ReadResource("cloudformation:AppSync:FunctionConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type functionConfigurationState struct {
	// The attributes associated with the resource
	Attributes *FunctionConfigurationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *FunctionConfigurationProperties `pulumi:"properties"`
}

type FunctionConfigurationState struct {
	// The attributes associated with the resource
	Attributes FunctionConfigurationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FunctionConfigurationPropertiesPtrInput
}
...
type FunctionConfigurationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FunctionConfigurationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
