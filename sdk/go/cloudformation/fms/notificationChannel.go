...
func NewNotificationChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:FMS:NotificationChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationChannel(ctx *pulumi.Context,
	...
	var resource NotificationChannel
	err := ctx.ReadResource("cloudformation:FMS:NotificationChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
