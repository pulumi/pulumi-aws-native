...
func NewApplicationReferenceDataSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:KinesisAnalytics:ApplicationReferenceDataSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationReferenceDataSource(ctx *pulumi.Context,
	...
	var resource ApplicationReferenceDataSource
	err := ctx.ReadResource("cloudformation:KinesisAnalytics:ApplicationReferenceDataSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
