...
type MountTarget struct {
	...
	Attributes MountTargetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties MountTargetPropertiesOutput `pulumi:"properties"`
}
...
func GetMountTarget(ctx *pulumi.Context,
	...
	var resource MountTarget
	err := ctx.ReadResource("cloudformation:EFS:MountTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type mountTargetState struct {
	// The attributes associated with the resource
	Attributes *MountTargetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *MountTargetProperties `pulumi:"properties"`
}

type MountTargetState struct {
	// The attributes associated with the resource
	Attributes MountTargetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MountTargetPropertiesPtrInput
}
...
type MountTargetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MountTargetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
