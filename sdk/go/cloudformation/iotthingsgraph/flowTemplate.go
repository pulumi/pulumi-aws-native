...
type FlowTemplate struct {
	...
	Attributes FlowTemplateAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties FlowTemplatePropertiesOutput `pulumi:"properties"`
}
...
func GetFlowTemplate(ctx *pulumi.Context,
	...
	var resource FlowTemplate
	err := ctx.ReadResource("cloudformation:IoTThingsGraph:FlowTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type flowTemplateState struct {
	// The attributes associated with the resource
	Attributes *FlowTemplateAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *FlowTemplateProperties `pulumi:"properties"`
}

type FlowTemplateState struct {
	// The attributes associated with the resource
	Attributes FlowTemplateAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FlowTemplatePropertiesPtrInput
}
...
type FlowTemplateArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FlowTemplatePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
