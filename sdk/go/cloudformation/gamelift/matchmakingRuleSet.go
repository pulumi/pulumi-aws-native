...
type MatchmakingRuleSet struct {
	...
	Attributes MatchmakingRuleSetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties MatchmakingRuleSetPropertiesOutput `pulumi:"properties"`
}
...
func GetMatchmakingRuleSet(ctx *pulumi.Context,
	...
	var resource MatchmakingRuleSet
	err := ctx.ReadResource("cloudformation:GameLift:MatchmakingRuleSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type matchmakingRuleSetState struct {
	// The attributes associated with the resource
	Attributes *MatchmakingRuleSetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *MatchmakingRuleSetProperties `pulumi:"properties"`
}

type MatchmakingRuleSetState struct {
	// The attributes associated with the resource
	Attributes MatchmakingRuleSetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MatchmakingRuleSetPropertiesPtrInput
}
...
type MatchmakingRuleSetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MatchmakingRuleSetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
