...
func NewFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.RegisterResource("cloudformation:GameLift:Fleet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFleet(ctx *pulumi.Context,
	...
	var resource Fleet
	err := ctx.ReadResource("cloudformation:GameLift:Fleet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
