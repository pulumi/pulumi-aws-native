...
func NewSizeConstraintSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAFRegional:SizeConstraintSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSizeConstraintSet(ctx *pulumi.Context,
	...
	var resource SizeConstraintSet
	err := ctx.ReadResource("cloudformation:WAFRegional:SizeConstraintSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
