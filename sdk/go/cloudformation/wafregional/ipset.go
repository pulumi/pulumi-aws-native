...
func NewIPSet(ctx *pulumi.Context,
	...
	var resource IPSet
	err := ctx.RegisterResource("cloudformation:WAFRegional:IPSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPSet(ctx *pulumi.Context,
	...
	var resource IPSet
	err := ctx.ReadResource("cloudformation:WAFRegional:IPSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
