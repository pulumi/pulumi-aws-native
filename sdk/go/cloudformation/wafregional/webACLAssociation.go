...
func NewWebACLAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAFRegional:WebACLAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebACLAssociation(ctx *pulumi.Context,
	...
	var resource WebACLAssociation
	err := ctx.ReadResource("cloudformation:WAFRegional:WebACLAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
