...
func NewByteMatchSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAFRegional:ByteMatchSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetByteMatchSet(ctx *pulumi.Context,
	...
	var resource ByteMatchSet
	err := ctx.ReadResource("cloudformation:WAFRegional:ByteMatchSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
