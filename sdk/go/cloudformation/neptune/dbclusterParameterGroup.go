...
func NewDBClusterParameterGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:Neptune:DBClusterParameterGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDBClusterParameterGroup(ctx *pulumi.Context,
	...
	var resource DBClusterParameterGroup
	err := ctx.ReadResource("cloudformation:Neptune:DBClusterParameterGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
