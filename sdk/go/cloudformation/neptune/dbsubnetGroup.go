...
func NewDBSubnetGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:Neptune:DBSubnetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDBSubnetGroup(ctx *pulumi.Context,
	...
	var resource DBSubnetGroup
	err := ctx.ReadResource("cloudformation:Neptune:DBSubnetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
