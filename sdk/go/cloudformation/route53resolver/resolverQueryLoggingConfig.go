...
type ResolverQueryLoggingConfig struct {
	...
	Attributes ResolverQueryLoggingConfigAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigPropertiesOutput `pulumi:"properties"`
}
...
func NewResolverQueryLoggingConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:Route53Resolver:ResolverQueryLoggingConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResolverQueryLoggingConfig(ctx *pulumi.Context,
	...
	var resource ResolverQueryLoggingConfig
	err := ctx.ReadResource("cloudformation:Route53Resolver:ResolverQueryLoggingConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type resolverQueryLoggingConfigState struct {
	// The attributes associated with the resource
	Attributes *ResolverQueryLoggingConfigAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ResolverQueryLoggingConfigProperties `pulumi:"properties"`
}

type ResolverQueryLoggingConfigState struct {
	// The attributes associated with the resource
	Attributes ResolverQueryLoggingConfigAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigPropertiesPtrInput
}
...
type ResolverQueryLoggingConfigArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type ResolverQueryLoggingConfigOutput struct {
	*pulumi.OutputState
}
