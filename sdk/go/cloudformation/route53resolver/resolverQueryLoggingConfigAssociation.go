...
type ResolverQueryLoggingConfigAssociation struct {
	...
	Attributes ResolverQueryLoggingConfigAssociationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigAssociationPropertiesOutput `pulumi:"properties"`
}
...
func NewResolverQueryLoggingConfigAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResolverQueryLoggingConfigAssociation(ctx *pulumi.Context,
	...
	var resource ResolverQueryLoggingConfigAssociation
	err := ctx.ReadResource("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type resolverQueryLoggingConfigAssociationState struct {
	// The attributes associated with the resource
	Attributes *ResolverQueryLoggingConfigAssociationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ResolverQueryLoggingConfigAssociationProperties `pulumi:"properties"`
}

type ResolverQueryLoggingConfigAssociationState struct {
	// The attributes associated with the resource
	Attributes ResolverQueryLoggingConfigAssociationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigAssociationPropertiesPtrInput
}
...
type ResolverQueryLoggingConfigAssociationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ResolverQueryLoggingConfigAssociationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type ResolverQueryLoggingConfigAssociationOutput struct {
	*pulumi.OutputState
}
