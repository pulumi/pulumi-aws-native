...
type AcceptedPortfolioShare struct {
	...
	Attributes AcceptedPortfolioShareAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties AcceptedPortfolioSharePropertiesOutput `pulumi:"properties"`
}
...
func GetAcceptedPortfolioShare(ctx *pulumi.Context,
	...
	var resource AcceptedPortfolioShare
	err := ctx.ReadResource("cloudformation:ServiceCatalog:AcceptedPortfolioShare", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type acceptedPortfolioShareState struct {
	// The attributes associated with the resource
	Attributes *AcceptedPortfolioShareAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *AcceptedPortfolioShareProperties `pulumi:"properties"`
}

type AcceptedPortfolioShareState struct {
	// The attributes associated with the resource
	Attributes AcceptedPortfolioShareAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AcceptedPortfolioSharePropertiesPtrInput
}
...
type AcceptedPortfolioShareArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AcceptedPortfolioSharePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
