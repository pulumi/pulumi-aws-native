...
type StackSetConstraint struct {
	...
	Attributes StackSetConstraintAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties StackSetConstraintPropertiesOutput `pulumi:"properties"`
}
...
func GetStackSetConstraint(ctx *pulumi.Context,
	...
	var resource StackSetConstraint
	err := ctx.ReadResource("cloudformation:ServiceCatalog:StackSetConstraint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type stackSetConstraintState struct {
	// The attributes associated with the resource
	Attributes *StackSetConstraintAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *StackSetConstraintProperties `pulumi:"properties"`
}

type StackSetConstraintState struct {
	// The attributes associated with the resource
	Attributes StackSetConstraintAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties StackSetConstraintPropertiesPtrInput
}
...
type StackSetConstraintArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties StackSetConstraintPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
