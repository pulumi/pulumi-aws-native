...
type BackupSelection struct {
	...
	Attributes BackupSelectionAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties BackupSelectionPropertiesOutput `pulumi:"properties"`
}
...
func GetBackupSelection(ctx *pulumi.Context,
	...
	var resource BackupSelection
	err := ctx.ReadResource("cloudformation:Backup:BackupSelection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type backupSelectionState struct {
	// The attributes associated with the resource
	Attributes *BackupSelectionAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *BackupSelectionProperties `pulumi:"properties"`
}

type BackupSelectionState struct {
	// The attributes associated with the resource
	Attributes BackupSelectionAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties BackupSelectionPropertiesPtrInput
}
...
type BackupSelectionArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties BackupSelectionPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
