...
type BackupPlan struct {
	...
	Attributes BackupPlanAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties BackupPlanPropertiesOutput `pulumi:"properties"`
}
...
func GetBackupPlan(ctx *pulumi.Context,
	...
	var resource BackupPlan
	err := ctx.ReadResource("cloudformation:Backup:BackupPlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type backupPlanState struct {
	// The attributes associated with the resource
	Attributes *BackupPlanAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *BackupPlanProperties `pulumi:"properties"`
}

type BackupPlanState struct {
	// The attributes associated with the resource
	Attributes BackupPlanAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties BackupPlanPropertiesPtrInput
}
...
type BackupPlanArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties BackupPlanPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
