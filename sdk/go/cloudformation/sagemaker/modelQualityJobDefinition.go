...
type ModelQualityJobDefinition struct {
	...
	Attributes ModelQualityJobDefinitionAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ModelQualityJobDefinitionPropertiesOutput `pulumi:"properties"`
}
...
func NewModelQualityJobDefinition(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:SageMaker:ModelQualityJobDefinition", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModelQualityJobDefinition(ctx *pulumi.Context,
	...
	var resource ModelQualityJobDefinition
	err := ctx.ReadResource("cloudformation:SageMaker:ModelQualityJobDefinition", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type modelQualityJobDefinitionState struct {
	// The attributes associated with the resource
	Attributes *ModelQualityJobDefinitionAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ModelQualityJobDefinitionProperties `pulumi:"properties"`
}

type ModelQualityJobDefinitionState struct {
	// The attributes associated with the resource
	Attributes ModelQualityJobDefinitionAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ModelQualityJobDefinitionPropertiesPtrInput
}
...
type ModelQualityJobDefinitionArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ModelQualityJobDefinitionPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type ModelQualityJobDefinitionOutput struct {
	*pulumi.OutputState
}
