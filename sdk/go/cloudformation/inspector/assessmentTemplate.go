...
type AssessmentTemplate struct {
	...
	Attributes AssessmentTemplateAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties AssessmentTemplatePropertiesOutput `pulumi:"properties"`
}
...
func GetAssessmentTemplate(ctx *pulumi.Context,
	...
	var resource AssessmentTemplate
	err := ctx.ReadResource("cloudformation:Inspector:AssessmentTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type assessmentTemplateState struct {
	// The attributes associated with the resource
	Attributes *AssessmentTemplateAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *AssessmentTemplateProperties `pulumi:"properties"`
}

type AssessmentTemplateState struct {
	// The attributes associated with the resource
	Attributes AssessmentTemplateAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AssessmentTemplatePropertiesPtrInput
}
...
type AssessmentTemplateArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AssessmentTemplatePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
