...
type ResourceGroup struct {
	...
	Attributes ResourceGroupAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ResourceGroupPropertiesOutput `pulumi:"properties"`
}
...
func GetResourceGroup(ctx *pulumi.Context,
	...
	var resource ResourceGroup
	err := ctx.ReadResource("cloudformation:Inspector:ResourceGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type resourceGroupState struct {
	// The attributes associated with the resource
	Attributes *ResourceGroupAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
...
type ResourceGroupState struct {
	// The attributes associated with the resource
	Attributes ResourceGroupAttributesPtrInput
	// An explicit logical ID for the resource
