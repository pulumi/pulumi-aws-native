...
func NewDBClusterParameterGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:DocDB:DBClusterParameterGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDBClusterParameterGroup(ctx *pulumi.Context,
	...
	var resource DBClusterParameterGroup
	err := ctx.ReadResource("cloudformation:DocDB:DBClusterParameterGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
