...
func NewRuleGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:NetworkFirewall:RuleGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuleGroup(ctx *pulumi.Context,
	...
	var resource RuleGroup
	err := ctx.ReadResource("cloudformation:NetworkFirewall:RuleGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
