...
func NewIPSet(ctx *pulumi.Context,
	...
	var resource IPSet
	err := ctx.RegisterResource("cloudformation:GuardDuty:IPSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPSet(ctx *pulumi.Context,
	...
	var resource IPSet
	err := ctx.ReadResource("cloudformation:GuardDuty:IPSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
