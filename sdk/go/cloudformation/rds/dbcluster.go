...
func NewDBCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:RDS:DBCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDBCluster(ctx *pulumi.Context,
	...
	var resource DBCluster
	err := ctx.ReadResource("cloudformation:RDS:DBCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
