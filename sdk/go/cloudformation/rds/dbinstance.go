...
func NewDBInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:RDS:DBInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDBInstance(ctx *pulumi.Context,
	...
	var resource DBInstance
	err := ctx.ReadResource("cloudformation:RDS:DBInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
