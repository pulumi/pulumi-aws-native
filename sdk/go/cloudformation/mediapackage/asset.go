...
func NewAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.RegisterResource("cloudformation:MediaPackage:Asset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAsset(ctx *pulumi.Context,
	...
	var resource Asset
	err := ctx.ReadResource("cloudformation:MediaPackage:Asset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
