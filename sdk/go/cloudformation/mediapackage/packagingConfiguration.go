...
type PackagingConfiguration struct {
	...
	Attributes PackagingConfigurationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties PackagingConfigurationPropertiesOutput `pulumi:"properties"`
}
...
func NewPackagingConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:MediaPackage:PackagingConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPackagingConfiguration(ctx *pulumi.Context,
	...
	var resource PackagingConfiguration
	err := ctx.ReadResource("cloudformation:MediaPackage:PackagingConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type packagingConfigurationState struct {
	// The attributes associated with the resource
	Attributes *PackagingConfigurationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *PackagingConfigurationProperties `pulumi:"properties"`
}

type PackagingConfigurationState struct {
	// The attributes associated with the resource
	Attributes PackagingConfigurationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PackagingConfigurationPropertiesPtrInput
}
...
type PackagingConfigurationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PackagingConfigurationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type PackagingConfigurationOutput struct {
	*pulumi.OutputState
}
