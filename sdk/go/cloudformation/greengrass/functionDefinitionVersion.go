...
type FunctionDefinitionVersion struct {
	...
	Attributes FunctionDefinitionVersionAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties FunctionDefinitionVersionPropertiesOutput `pulumi:"properties"`
}
...
func GetFunctionDefinitionVersion(ctx *pulumi.Context,
	...
	var resource FunctionDefinitionVersion
	err := ctx.ReadResource("cloudformation:Greengrass:FunctionDefinitionVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type functionDefinitionVersionState struct {
	// The attributes associated with the resource
	Attributes *FunctionDefinitionVersionAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *FunctionDefinitionVersionProperties `pulumi:"properties"`
}

type FunctionDefinitionVersionState struct {
	// The attributes associated with the resource
	Attributes FunctionDefinitionVersionAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FunctionDefinitionVersionPropertiesPtrInput
}
...
type FunctionDefinitionVersionArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties FunctionDefinitionVersionPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
