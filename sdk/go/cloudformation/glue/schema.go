...
func NewSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.RegisterResource("cloudformation:Glue:Schema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.ReadResource("cloudformation:Glue:Schema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
