...
type Workflow struct {
	...
	Attributes WorkflowAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties WorkflowPropertiesOutput `pulumi:"properties"`
}
...
func GetWorkflow(ctx *pulumi.Context,
	...
	var resource Workflow
	err := ctx.ReadResource("cloudformation:Glue:Workflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type workflowState struct {
	// The attributes associated with the resource
	Attributes *WorkflowAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
...
type WorkflowState struct {
	// The attributes associated with the resource
	Attributes WorkflowAttributesPtrInput
	// An explicit logical ID for the resource
