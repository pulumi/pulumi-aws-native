...
type RegistryPolicy struct {
	...
	Attributes RegistryPolicyAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties RegistryPolicyPropertiesOutput `pulumi:"properties"`
}
...
func GetRegistryPolicy(ctx *pulumi.Context,
	...
	var resource RegistryPolicy
	err := ctx.ReadResource("cloudformation:EventSchemas:RegistryPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type registryPolicyState struct {
	// The attributes associated with the resource
	Attributes *RegistryPolicyAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *RegistryPolicyProperties `pulumi:"properties"`
}

type RegistryPolicyState struct {
	// The attributes associated with the resource
	Attributes RegistryPolicyAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties RegistryPolicyPropertiesPtrInput
}
...
type RegistryPolicyArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties RegistryPolicyPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
