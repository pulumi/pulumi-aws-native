...
type VPNConnectionRoute struct {
	...
	Attributes VPNConnectionRouteAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties VPNConnectionRoutePropertiesOutput `pulumi:"properties"`
}
...
func GetVPNConnectionRoute(ctx *pulumi.Context,
	...
	var resource VPNConnectionRoute
	err := ctx.ReadResource("cloudformation:EC2:VPNConnectionRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type vpnconnectionRouteState struct {
	// The attributes associated with the resource
	Attributes *VPNConnectionRouteAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *VPNConnectionRouteProperties `pulumi:"properties"`
}

type VPNConnectionRouteState struct {
	// The attributes associated with the resource
	Attributes VPNConnectionRouteAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties VPNConnectionRoutePropertiesPtrInput
}
...
type VPNConnectionRouteArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties VPNConnectionRoutePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
