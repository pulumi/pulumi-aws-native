...
type TransitGatewayRouteTablePropagation struct {
	...
	Attributes TransitGatewayRouteTablePropagationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties TransitGatewayRouteTablePropagationPropertiesOutput `pulumi:"properties"`
}
...
func GetTransitGatewayRouteTablePropagation(ctx *pulumi.Context,
	...
	var resource TransitGatewayRouteTablePropagation
	err := ctx.ReadResource("cloudformation:EC2:TransitGatewayRouteTablePropagation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type transitGatewayRouteTablePropagationState struct {
	// The attributes associated with the resource
	Attributes *TransitGatewayRouteTablePropagationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *TransitGatewayRouteTablePropagationProperties `pulumi:"properties"`
}

type TransitGatewayRouteTablePropagationState struct {
	// The attributes associated with the resource
	Attributes TransitGatewayRouteTablePropagationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties TransitGatewayRouteTablePropagationPropertiesPtrInput
}
...
type TransitGatewayRouteTablePropagationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties TransitGatewayRouteTablePropagationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
