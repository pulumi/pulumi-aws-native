...
type VPCEndpointService struct {
	...
	Attributes VPCEndpointServiceAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties VPCEndpointServicePropertiesOutput `pulumi:"properties"`
}
...
func GetVPCEndpointService(ctx *pulumi.Context,
	...
	var resource VPCEndpointService
	err := ctx.ReadResource("cloudformation:EC2:VPCEndpointService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type vpcendpointServiceState struct {
	// The attributes associated with the resource
	Attributes *VPCEndpointServiceAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *VPCEndpointServiceProperties `pulumi:"properties"`
}

type VPCEndpointServiceState struct {
	// The attributes associated with the resource
	Attributes VPCEndpointServiceAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties VPCEndpointServicePropertiesPtrInput
}
...
type VPCEndpointServiceArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties VPCEndpointServicePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
