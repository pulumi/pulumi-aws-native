...
type SubnetRouteTableAssociation struct {
	...
	Attributes SubnetRouteTableAssociationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties SubnetRouteTableAssociationPropertiesOutput `pulumi:"properties"`
}
...
func NewSubnetRouteTableAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:EC2:SubnetRouteTableAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubnetRouteTableAssociation(ctx *pulumi.Context,
	...
	var resource SubnetRouteTableAssociation
	err := ctx.ReadResource("cloudformation:EC2:SubnetRouteTableAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type subnetRouteTableAssociationState struct {
	// The attributes associated with the resource
	Attributes *SubnetRouteTableAssociationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *SubnetRouteTableAssociationProperties `pulumi:"properties"`
}

type SubnetRouteTableAssociationState struct {
	// The attributes associated with the resource
	Attributes SubnetRouteTableAssociationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SubnetRouteTableAssociationPropertiesPtrInput
}
...
type SubnetRouteTableAssociationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SubnetRouteTableAssociationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
