...
type EgressOnlyInternetGateway struct {
	...
	Attributes EgressOnlyInternetGatewayAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties EgressOnlyInternetGatewayPropertiesOutput `pulumi:"properties"`
}
...
func NewEgressOnlyInternetGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:EC2:EgressOnlyInternetGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEgressOnlyInternetGateway(ctx *pulumi.Context,
	...
	var resource EgressOnlyInternetGateway
	err := ctx.ReadResource("cloudformation:EC2:EgressOnlyInternetGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type egressOnlyInternetGatewayState struct {
	// The attributes associated with the resource
	Attributes *EgressOnlyInternetGatewayAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *EgressOnlyInternetGatewayProperties `pulumi:"properties"`
}

type EgressOnlyInternetGatewayState struct {
	// The attributes associated with the resource
	Attributes EgressOnlyInternetGatewayAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties EgressOnlyInternetGatewayPropertiesPtrInput
}
...
type EgressOnlyInternetGatewayArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties EgressOnlyInternetGatewayPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
