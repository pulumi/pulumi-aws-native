...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:EC2:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("cloudformation:EC2:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
