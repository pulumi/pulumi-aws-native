...
type SubnetNetworkAclAssociation struct {
	...
	Attributes SubnetNetworkAclAssociationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties SubnetNetworkAclAssociationPropertiesOutput `pulumi:"properties"`
}
...
func GetSubnetNetworkAclAssociation(ctx *pulumi.Context,
	...
	var resource SubnetNetworkAclAssociation
	err := ctx.ReadResource("cloudformation:EC2:SubnetNetworkAclAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type subnetNetworkAclAssociationState struct {
	// The attributes associated with the resource
	Attributes *SubnetNetworkAclAssociationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *SubnetNetworkAclAssociationProperties `pulumi:"properties"`
}

type SubnetNetworkAclAssociationState struct {
	// The attributes associated with the resource
	Attributes SubnetNetworkAclAssociationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SubnetNetworkAclAssociationPropertiesPtrInput
}
...
type SubnetNetworkAclAssociationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties SubnetNetworkAclAssociationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
