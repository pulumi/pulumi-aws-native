...
type NetworkInterfaceAttachment struct {
	...
	Attributes NetworkInterfaceAttachmentAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties NetworkInterfaceAttachmentPropertiesOutput `pulumi:"properties"`
}
...
func GetNetworkInterfaceAttachment(ctx *pulumi.Context,
	...
	var resource NetworkInterfaceAttachment
	err := ctx.ReadResource("cloudformation:EC2:NetworkInterfaceAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type networkInterfaceAttachmentState struct {
	// The attributes associated with the resource
	Attributes *NetworkInterfaceAttachmentAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *NetworkInterfaceAttachmentProperties `pulumi:"properties"`
}

type NetworkInterfaceAttachmentState struct {
	// The attributes associated with the resource
	Attributes NetworkInterfaceAttachmentAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties NetworkInterfaceAttachmentPropertiesPtrInput
}
...
type NetworkInterfaceAttachmentArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties NetworkInterfaceAttachmentPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
