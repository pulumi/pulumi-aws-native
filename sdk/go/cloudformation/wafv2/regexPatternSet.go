...
func NewRegexPatternSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:WAFv2:RegexPatternSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegexPatternSet(ctx *pulumi.Context,
	...
	var resource RegexPatternSet
	err := ctx.ReadResource("cloudformation:WAFv2:RegexPatternSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
