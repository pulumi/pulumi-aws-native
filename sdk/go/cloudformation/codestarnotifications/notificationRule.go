...
type NotificationRule struct {
	...
	Attributes NotificationRuleAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties NotificationRulePropertiesOutput `pulumi:"properties"`
}
...
func GetNotificationRule(ctx *pulumi.Context,
	...
	var resource NotificationRule
	err := ctx.ReadResource("cloudformation:CodeStarNotifications:NotificationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type notificationRuleState struct {
	// The attributes associated with the resource
	Attributes *NotificationRuleAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *NotificationRuleProperties `pulumi:"properties"`
}

type NotificationRuleState struct {
	// The attributes associated with the resource
	Attributes NotificationRuleAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties NotificationRulePropertiesPtrInput
}
...
type NotificationRuleArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties NotificationRulePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
