...
type OrganizationConfigRule struct {
	...
	Attributes OrganizationConfigRuleAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties OrganizationConfigRulePropertiesOutput `pulumi:"properties"`
}
...
func GetOrganizationConfigRule(ctx *pulumi.Context,
	...
	var resource OrganizationConfigRule
	err := ctx.ReadResource("cloudformation:Configuration:OrganizationConfigRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type organizationConfigRuleState struct {
	// The attributes associated with the resource
	Attributes *OrganizationConfigRuleAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *OrganizationConfigRuleProperties `pulumi:"properties"`
}

type OrganizationConfigRuleState struct {
	// The attributes associated with the resource
	Attributes OrganizationConfigRuleAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties OrganizationConfigRulePropertiesPtrInput
}
...
type OrganizationConfigRuleArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties OrganizationConfigRulePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
