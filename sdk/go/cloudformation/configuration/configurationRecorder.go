...
type ConfigurationRecorder struct {
	...
	Attributes ConfigurationRecorderAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ConfigurationRecorderPropertiesOutput `pulumi:"properties"`
}
...
func GetConfigurationRecorder(ctx *pulumi.Context,
	...
	var resource ConfigurationRecorder
	err := ctx.ReadResource("cloudformation:Configuration:ConfigurationRecorder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type configurationRecorderState struct {
	// The attributes associated with the resource
	Attributes *ConfigurationRecorderAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ConfigurationRecorderProperties `pulumi:"properties"`
}

type ConfigurationRecorderState struct {
	// The attributes associated with the resource
	Attributes ConfigurationRecorderAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ConfigurationRecorderPropertiesPtrInput
}
...
type ConfigurationRecorderArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ConfigurationRecorderPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
