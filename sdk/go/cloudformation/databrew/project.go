...
func NewProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:DataBrew:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("cloudformation:DataBrew:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
