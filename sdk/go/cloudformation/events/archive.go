...
type Archive struct {
	...
	Attributes ArchiveAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ArchivePropertiesOutput `pulumi:"properties"`
}
...
func NewArchive(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:Events:Archive", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArchive(ctx *pulumi.Context,
	...
	var resource Archive
	err := ctx.ReadResource("cloudformation:Events:Archive", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type archiveState struct {
	// The attributes associated with the resource
	Attributes *ArchiveAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ArchiveProperties `pulumi:"properties"`
}

type ArchiveState struct {
	// The attributes associated with the resource
	Attributes ArchiveAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ArchivePropertiesPtrInput
}
...
type ArchiveArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ArchivePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
