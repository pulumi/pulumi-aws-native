...
type InfrastructureConfiguration struct {
	...
	Attributes InfrastructureConfigurationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties InfrastructureConfigurationPropertiesOutput `pulumi:"properties"`
}
...
func GetInfrastructureConfiguration(ctx *pulumi.Context,
	...
	var resource InfrastructureConfiguration
	err := ctx.ReadResource("cloudformation:ImageBuilder:InfrastructureConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type infrastructureConfigurationState struct {
	// The attributes associated with the resource
	Attributes *InfrastructureConfigurationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *InfrastructureConfigurationProperties `pulumi:"properties"`
}

type InfrastructureConfigurationState struct {
	// The attributes associated with the resource
	Attributes InfrastructureConfigurationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties InfrastructureConfigurationPropertiesPtrInput
}
...
type InfrastructureConfigurationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties InfrastructureConfigurationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
