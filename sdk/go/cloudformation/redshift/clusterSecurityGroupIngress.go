...
type ClusterSecurityGroupIngress struct {
	...
	Attributes ClusterSecurityGroupIngressAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ClusterSecurityGroupIngressPropertiesOutput `pulumi:"properties"`
}
...
func GetClusterSecurityGroupIngress(ctx *pulumi.Context,
	...
	var resource ClusterSecurityGroupIngress
	err := ctx.ReadResource("cloudformation:Redshift:ClusterSecurityGroupIngress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type clusterSecurityGroupIngressState struct {
	// The attributes associated with the resource
	Attributes *ClusterSecurityGroupIngressAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ClusterSecurityGroupIngressProperties `pulumi:"properties"`
}

type ClusterSecurityGroupIngressState struct {
	// The attributes associated with the resource
	Attributes ClusterSecurityGroupIngressAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ClusterSecurityGroupIngressPropertiesPtrInput
}
...
type ClusterSecurityGroupIngressArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ClusterSecurityGroupIngressPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
