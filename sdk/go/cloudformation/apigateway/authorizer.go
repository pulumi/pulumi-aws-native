...
func NewAuthorizer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:ApiGateway:Authorizer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizer(ctx *pulumi.Context,
	...
	var resource Authorizer
	err := ctx.ReadResource("cloudformation:ApiGateway:Authorizer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
