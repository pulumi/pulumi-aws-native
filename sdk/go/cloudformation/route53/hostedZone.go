...
type HostedZone struct {
	...
	Attributes HostedZoneAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties HostedZonePropertiesOutput `pulumi:"properties"`
}
...
func GetHostedZone(ctx *pulumi.Context,
	...
	var resource HostedZone
	err := ctx.ReadResource("cloudformation:Route53:HostedZone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type hostedZoneState struct {
	// The attributes associated with the resource
	Attributes *HostedZoneAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *HostedZoneProperties `pulumi:"properties"`
}

type HostedZoneState struct {
	// The attributes associated with the resource
	Attributes HostedZoneAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties HostedZonePropertiesPtrInput
}
...
type HostedZoneArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties HostedZonePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
