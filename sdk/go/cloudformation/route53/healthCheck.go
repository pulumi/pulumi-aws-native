...
type HealthCheck struct {
	...
	Attributes HealthCheckAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties HealthCheckPropertiesOutput `pulumi:"properties"`
}
...
func GetHealthCheck(ctx *pulumi.Context,
	...
	var resource HealthCheck
	err := ctx.ReadResource("cloudformation:Route53:HealthCheck", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type healthCheckState struct {
	// The attributes associated with the resource
	Attributes *HealthCheckAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *HealthCheckProperties `pulumi:"properties"`
}

type HealthCheckState struct {
	// The attributes associated with the resource
	Attributes HealthCheckAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties HealthCheckPropertiesPtrInput
}
...
type HealthCheckArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties HealthCheckPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
