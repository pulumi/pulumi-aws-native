...
type AssetModel struct {
	...
	Attributes AssetModelAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties AssetModelPropertiesOutput `pulumi:"properties"`
}
...
func NewAssetModel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:IoTSiteWise:AssetModel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssetModel(ctx *pulumi.Context,
	...
	var resource AssetModel
	err := ctx.ReadResource("cloudformation:IoTSiteWise:AssetModel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type assetModelState struct {
	// The attributes associated with the resource
	Attributes *AssetModelAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *AssetModelProperties `pulumi:"properties"`
}

type AssetModelState struct {
	// The attributes associated with the resource
	Attributes AssetModelAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AssetModelPropertiesPtrInput
}
...
type AssetModelArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties AssetModelPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
