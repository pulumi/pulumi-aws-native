...
func NewDashboard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:IoTSiteWise:Dashboard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDashboard(ctx *pulumi.Context,
	...
	var resource Dashboard
	err := ctx.ReadResource("cloudformation:IoTSiteWise:Dashboard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
