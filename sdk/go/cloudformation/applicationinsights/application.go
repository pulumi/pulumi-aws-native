...
type Application struct {
	...
	Attributes ApplicationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ApplicationPropertiesOutput `pulumi:"properties"`
}
...
func NewApplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:ApplicationInsights:Application", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplication(ctx *pulumi.Context,
	...
	var resource Application
	err := ctx.ReadResource("cloudformation:ApplicationInsights:Application", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
