...
func NewStream(ctx *pulumi.Context,
	...
	var resource Stream
	err := ctx.RegisterResource("cloudformation:Kinesis:Stream", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStream(ctx *pulumi.Context,
	...
	var resource Stream
	err := ctx.ReadResource("cloudformation:Kinesis:Stream", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
