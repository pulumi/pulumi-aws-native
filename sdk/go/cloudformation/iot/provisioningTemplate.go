...
type ProvisioningTemplate struct {
	...
	Attributes ProvisioningTemplateAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties ProvisioningTemplatePropertiesOutput `pulumi:"properties"`
}
...
func GetProvisioningTemplate(ctx *pulumi.Context,
	...
	var resource ProvisioningTemplate
	err := ctx.ReadResource("cloudformation:IoT:ProvisioningTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type provisioningTemplateState struct {
	// The attributes associated with the resource
	Attributes *ProvisioningTemplateAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *ProvisioningTemplateProperties `pulumi:"properties"`
}

type ProvisioningTemplateState struct {
	// The attributes associated with the resource
	Attributes ProvisioningTemplateAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ProvisioningTemplatePropertiesPtrInput
}
...
type ProvisioningTemplateArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties ProvisioningTemplatePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
