...
type TopicRuleDestination struct {
	...
	Attributes TopicRuleDestinationAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties TopicRuleDestinationPropertiesOutput `pulumi:"properties"`
}
...
func NewTopicRuleDestination(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:IoT:TopicRuleDestination", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopicRuleDestination(ctx *pulumi.Context,
	...
	var resource TopicRuleDestination
	err := ctx.ReadResource("cloudformation:IoT:TopicRuleDestination", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type topicRuleDestinationState struct {
	// The attributes associated with the resource
	Attributes *TopicRuleDestinationAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *TopicRuleDestinationProperties `pulumi:"properties"`
}

type TopicRuleDestinationState struct {
	// The attributes associated with the resource
	Attributes TopicRuleDestinationAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties TopicRuleDestinationPropertiesPtrInput
}
...
type TopicRuleDestinationArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties TopicRuleDestinationPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
...
type TopicRuleDestinationOutput struct {
	*pulumi.OutputState
}
