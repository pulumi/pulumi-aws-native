...
type PrivateDnsNamespace struct {
	...
	Attributes PrivateDnsNamespaceAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties PrivateDnsNamespacePropertiesOutput `pulumi:"properties"`
}
...
func NewPrivateDnsNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:ServiceDiscovery:PrivateDnsNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateDnsNamespace(ctx *pulumi.Context,
	...
	var resource PrivateDnsNamespace
	err := ctx.ReadResource("cloudformation:ServiceDiscovery:PrivateDnsNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type privateDnsNamespaceState struct {
	// The attributes associated with the resource
	Attributes *PrivateDnsNamespaceAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
...
type PrivateDnsNamespaceState struct {
	// The attributes associated with the resource
	Attributes PrivateDnsNamespaceAttributesPtrInput
	// An explicit logical ID for the resource
...
type PrivateDnsNamespaceArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties PrivateDnsNamespacePropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
