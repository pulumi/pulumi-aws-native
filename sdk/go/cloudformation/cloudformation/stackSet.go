...
type StackSet struct {
	...
	Attributes StackSetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties StackSetPropertiesOutput `pulumi:"properties"`
}
...
func NewStackSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:CloudFormation:StackSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStackSet(ctx *pulumi.Context,
	...
	var resource StackSet
	err := ctx.ReadResource("cloudformation:CloudFormation:StackSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type stackSetState struct {
	// The attributes associated with the resource
	Attributes *StackSetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *StackSetProperties `pulumi:"properties"`
}

type StackSetState struct {
	// The attributes associated with the resource
	Attributes StackSetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties StackSetPropertiesPtrInput
}
...
type StackSetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties StackSetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
