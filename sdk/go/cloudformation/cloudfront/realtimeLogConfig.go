...
type RealtimeLogConfig struct {
	...
	Attributes RealtimeLogConfigAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties RealtimeLogConfigPropertiesOutput `pulumi:"properties"`
}
...
func NewRealtimeLogConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cloudformation:CloudFront:RealtimeLogConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealtimeLogConfig(ctx *pulumi.Context,
	...
	var resource RealtimeLogConfig
	err := ctx.ReadResource("cloudformation:CloudFront:RealtimeLogConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type realtimeLogConfigState struct {
	// The attributes associated with the resource
	Attributes *RealtimeLogConfigAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *RealtimeLogConfigProperties `pulumi:"properties"`
}

type RealtimeLogConfigState struct {
	// The attributes associated with the resource
	Attributes RealtimeLogConfigAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties RealtimeLogConfigPropertiesPtrInput
}
...
type RealtimeLogConfigArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties RealtimeLogConfigPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
