...
type UserPoolUICustomizationAttachment struct {
	...
	Attributes UserPoolUICustomizationAttachmentAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties UserPoolUICustomizationAttachmentPropertiesOutput `pulumi:"properties"`
}
...
func GetUserPoolUICustomizationAttachment(ctx *pulumi.Context,
	...
	var resource UserPoolUICustomizationAttachment
	err := ctx.ReadResource("cloudformation:Cognito:UserPoolUICustomizationAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type userPoolUICustomizationAttachmentState struct {
	// The attributes associated with the resource
	Attributes *UserPoolUICustomizationAttachmentAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *UserPoolUICustomizationAttachmentProperties `pulumi:"properties"`
}

type UserPoolUICustomizationAttachmentState struct {
	// The attributes associated with the resource
	Attributes UserPoolUICustomizationAttachmentAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties UserPoolUICustomizationAttachmentPropertiesPtrInput
}
...
type UserPoolUICustomizationAttachmentArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties UserPoolUICustomizationAttachmentPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
