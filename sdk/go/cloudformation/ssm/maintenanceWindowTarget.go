...
type MaintenanceWindowTarget struct {
	...
	Attributes MaintenanceWindowTargetAttributesOutput `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrOutput `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata pulumi.AnyOutput `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties MaintenanceWindowTargetPropertiesOutput `pulumi:"properties"`
}
...
func GetMaintenanceWindowTarget(ctx *pulumi.Context,
	...
	var resource MaintenanceWindowTarget
	err := ctx.ReadResource("cloudformation:SSM:MaintenanceWindowTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type maintenanceWindowTargetState struct {
	// The attributes associated with the resource
	Attributes *MaintenanceWindowTargetAttributes `pulumi:"attributes"`
	// An explicit logical ID for the resource
	LogicalId *string `pulumi:"logicalId"`
	// Arbitrary structured data associated with the resource
	Metadata interface{} `pulumi:"metadata"`
	// The input properties associated with the resource
	Properties *MaintenanceWindowTargetProperties `pulumi:"properties"`
}

type MaintenanceWindowTargetState struct {
	// The attributes associated with the resource
	Attributes MaintenanceWindowTargetAttributesPtrInput
	// An explicit logical ID for the resource
	LogicalId pulumi.StringPtrInput
	// Arbitrary structured data associated with the resource
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MaintenanceWindowTargetPropertiesPtrInput
}
...
type MaintenanceWindowTargetArgs struct {
	...
	Metadata pulumi.Input
	// The input properties associated with the resource
	Properties MaintenanceWindowTargetPropertiesInput
	// Use the updateReplacePolicy attribute to retain or (in some cases) backup the existing physical instance of a resource when it is replaced during a stack update operation.
