...
type Cluster struct {
	...
	ClusterEndpoint ClusterEndpointOutput `pulumi:"clusterEndpoint"`
...
// The cluster endpoint.
func (o ClusterOutput) ClusterEndpoint() ClusterEndpointOutput {
	return o.ApplyT(func(v *Cluster) ClusterEndpointOutput { return v.ClusterEndpoint }).(ClusterEndpointOutput)
}
