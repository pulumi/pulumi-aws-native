...
type Cluster struct {
	...
	IpDiscovery ClusterSupportedIpDiscoveryTypesPtrOutput `pulumi:"ipDiscovery"`
	...
	NetworkType ClusterSupportedNetworkTypesPtrOutput `pulumi:"networkType"`
...
type clusterArgs struct {
	...
	// Must be either ipv4 | ipv6 | dual_stack.
	NetworkType *ClusterSupportedNetworkTypes `pulumi:"networkType"`
	// The compute and memory capacity of the nodes in the cluster.
...
type ClusterArgs struct {
	...
	// For clusters wth dual stack NetworkType, IpDiscovery controls the Ip protocol (ipv4 or ipv6) returned by the engine commands such as `cluster info` and `cluster nodes` which are used by clients to connect to the nodes in the cluster.
	IpDiscovery ClusterSupportedIpDiscoveryTypesPtrInput
	// The ID of the KMS key used to encrypt the cluster.
	...
	// Must be either ipv4 | ipv6 | dual_stack.
	NetworkType ClusterSupportedNetworkTypesPtrInput
	// The compute and memory capacity of the nodes in the cluster.
...
// For clusters wth dual stack NetworkType, IpDiscovery controls the Ip protocol (ipv4 or ipv6) returned by the engine commands such as `cluster info` and `cluster nodes` which are used by clients to connect to the nodes in the cluster.
func (o ClusterOutput) IpDiscovery() ClusterSupportedIpDiscoveryTypesPtrOutput {
	return o.ApplyT(func(v *Cluster) ClusterSupportedIpDiscoveryTypesPtrOutput { return v.IpDiscovery }).(ClusterSupportedIpDiscoveryTypesPtrOutput)
}
...
// Must be either ipv4 | ipv6 | dual_stack.
func (o ClusterOutput) NetworkType() ClusterSupportedNetworkTypesPtrOutput {
	return o.ApplyT(func(v *Cluster) ClusterSupportedNetworkTypesPtrOutput { return v.NetworkType }).(ClusterSupportedNetworkTypesPtrOutput)
}
