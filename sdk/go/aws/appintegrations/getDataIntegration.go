...
func (o LookupDataIntegrationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDataIntegrationResult] {
	return pulumix.Output[LookupDataIntegrationResult]{
