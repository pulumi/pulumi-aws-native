...
func (o LookupDirectoryConfigResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDirectoryConfigResult] {
	return pulumix.Output[LookupDirectoryConfigResult]{
