...
func (o LookupClusterSecurityGroupIngressResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupClusterSecurityGroupIngressResult] {
	return pulumix.Output[LookupClusterSecurityGroupIngressResult]{
