...
// BridgeOutputResourceInput is an input type that accepts BridgeOutputResourceArgs and BridgeOutputResourceOutput values.
// You can construct a concrete instance of `BridgeOutputResourceInput` via:
//
...
type BridgeOutputResourceInput interface {
	...
	ToBridgeOutputResourceOutputWithContext(context.Context) BridgeOutputResourceOutput
}
...
func (i BridgeOutputResourceArgs) ToBridgeOutputResourceOutput() BridgeOutputResourceOutput {
	return i.ToBridgeOutputResourceOutputWithContext(context.Background())
}

func (i BridgeOutputResourceArgs) ToBridgeOutputResourceOutputWithContext(ctx context.Context) BridgeOutputResourceOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BridgeOutputResourceOutput)
}

// BridgeOutputResourceArrayInput is an input type that accepts BridgeOutputResourceArray and BridgeOutputResourceArrayOutput values.
// You can construct a concrete instance of `BridgeOutputResourceArrayInput` via:
//
//	BridgeOutputResourceArray{ BridgeOutputResourceArgs{...} }
type BridgeOutputResourceArrayInput interface {
	pulumi.Input

	ToBridgeOutputResourceArrayOutput() BridgeOutputResourceArrayOutput
	ToBridgeOutputResourceArrayOutputWithContext(context.Context) BridgeOutputResourceArrayOutput
}

type BridgeOutputResourceArray []BridgeOutputResourceInput

func (BridgeOutputResourceArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]BridgeOutputResource)(nil)).Elem()
}

func (i BridgeOutputResourceArray) ToBridgeOutputResourceArrayOutput() BridgeOutputResourceArrayOutput {
	return i.ToBridgeOutputResourceArrayOutputWithContext(context.Background())
}

func (i BridgeOutputResourceArray) ToBridgeOutputResourceArrayOutputWithContext(ctx context.Context) BridgeOutputResourceArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BridgeOutputResourceArrayOutput)
}
...
func (o BridgeOutputResourceOutput) NetworkOutput() BridgeNetworkOutputPtrOutput {
	return o.ApplyT(func(v BridgeOutputResource) *BridgeNetworkOutput { return v.NetworkOutput }).(BridgeNetworkOutputPtrOutput)
}

type BridgeOutputResourceArrayOutput struct{ *pulumi.OutputState }

func (BridgeOutputResourceArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]BridgeOutputResource)(nil)).Elem()
}

func (o BridgeOutputResourceArrayOutput) ToBridgeOutputResourceArrayOutput() BridgeOutputResourceArrayOutput {
	return o
}

func (o BridgeOutputResourceArrayOutput) ToBridgeOutputResourceArrayOutputWithContext(ctx context.Context) BridgeOutputResourceArrayOutput {
	return o
}

func (o BridgeOutputResourceArrayOutput) Index(i pulumi.IntInput) BridgeOutputResourceOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) BridgeOutputResource {
		return vs[0].([]BridgeOutputResource)[vs[1].(int)]
	}).(BridgeOutputResourceOutput)
}
...
type BridgeOutputBridgeNetworkOutput struct {
	...
	Port int `pulumi:"port"`
	// The network output protocol.
	Protocol BridgeOutputBridgeNetworkOutputProtocol `pulumi:"protocol"`
	// The network output TTL.
	Ttl int `pulumi:"ttl"`
}

// BridgeOutputBridgeNetworkOutputInput is an input type that accepts BridgeOutputBridgeNetworkOutputArgs and BridgeOutputBridgeNetworkOutputOutput values.
// You can construct a concrete instance of `BridgeOutputBridgeNetworkOutputInput` via:
//
//	BridgeOutputBridgeNetworkOutputArgs{...}
type BridgeOutputBridgeNetworkOutputInput interface {
	pulumi.Input

	ToBridgeOutputBridgeNetworkOutputOutput() BridgeOutputBridgeNetworkOutputOutput
	ToBridgeOutputBridgeNetworkOutputOutputWithContext(context.Context) BridgeOutputBridgeNetworkOutputOutput
}

// The output of the bridge. A network output is delivered to your premises.
type BridgeOutputBridgeNetworkOutputArgs struct {
	// The network output IP Address.
	IpAddress pulumi.StringInput `pulumi:"ipAddress"`
	// The network output's gateway network name.
	NetworkName pulumi.StringInput `pulumi:"networkName"`
	...
	Port pulumi.IntInput `pulumi:"port"`
	// The network output protocol.
	Protocol BridgeOutputBridgeNetworkOutputProtocolInput `pulumi:"protocol"`
	// The network output TTL.
	Ttl pulumi.IntInput `pulumi:"ttl"`
}

func (BridgeOutputBridgeNetworkOutputArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*BridgeOutputBridgeNetworkOutput)(nil)).Elem()
}

func (i BridgeOutputBridgeNetworkOutputArgs) ToBridgeOutputBridgeNetworkOutputOutput() BridgeOutputBridgeNetworkOutputOutput {
	return i.ToBridgeOutputBridgeNetworkOutputOutputWithContext(context.Background())
}

func (i BridgeOutputBridgeNetworkOutputArgs) ToBridgeOutputBridgeNetworkOutputOutputWithContext(ctx context.Context) BridgeOutputBridgeNetworkOutputOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BridgeOutputBridgeNetworkOutputOutput)
}

// The output of the bridge. A network output is delivered to your premises.
type BridgeOutputBridgeNetworkOutputOutput struct{ *pulumi.OutputState }

func (BridgeOutputBridgeNetworkOutputOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*BridgeOutputBridgeNetworkOutput)(nil)).Elem()
}

func (o BridgeOutputBridgeNetworkOutputOutput) ToBridgeOutputBridgeNetworkOutputOutput() BridgeOutputBridgeNetworkOutputOutput {
	return o
}

func (o BridgeOutputBridgeNetworkOutputOutput) ToBridgeOutputBridgeNetworkOutputOutputWithContext(ctx context.Context) BridgeOutputBridgeNetworkOutputOutput {
	return o
}

// The network output IP Address.
func (o BridgeOutputBridgeNetworkOutputOutput) IpAddress() pulumi.StringOutput {
	return o.ApplyT(func(v BridgeOutputBridgeNetworkOutput) string { return v.IpAddress }).(pulumi.StringOutput)
}

// The network output's gateway network name.
func (o BridgeOutputBridgeNetworkOutputOutput) NetworkName() pulumi.StringOutput {
	return o.ApplyT(func(v BridgeOutputBridgeNetworkOutput) string { return v.NetworkName }).(pulumi.StringOutput)
}

// The network output port.
func (o BridgeOutputBridgeNetworkOutputOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v BridgeOutputBridgeNetworkOutput) int { return v.Port }).(pulumi.IntOutput)
}

// The network output protocol.
func (o BridgeOutputBridgeNetworkOutputOutput) Protocol() BridgeOutputBridgeNetworkOutputProtocolOutput {
	return o.ApplyT(func(v BridgeOutputBridgeNetworkOutput) BridgeOutputBridgeNetworkOutputProtocol { return v.Protocol }).(BridgeOutputBridgeNetworkOutputProtocolOutput)
}

// The network output TTL.
func (o BridgeOutputBridgeNetworkOutputOutput) Ttl() pulumi.IntOutput {
	return o.ApplyT(func(v BridgeOutputBridgeNetworkOutput) int { return v.Ttl }).(pulumi.IntOutput)
}

type BridgeOutputBridgeNetworkOutputPtrOutput struct{ *pulumi.OutputState }

func (BridgeOutputBridgeNetworkOutputPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**BridgeOutputBridgeNetworkOutput)(nil)).Elem()
}

func (o BridgeOutputBridgeNetworkOutputPtrOutput) ToBridgeOutputBridgeNetworkOutputPtrOutput() BridgeOutputBridgeNetworkOutputPtrOutput {
	return o
}

func (o BridgeOutputBridgeNetworkOutputPtrOutput) ToBridgeOutputBridgeNetworkOutputPtrOutputWithContext(ctx context.Context) BridgeOutputBridgeNetworkOutputPtrOutput {
	return o
}

func (o BridgeOutputBridgeNetworkOutputPtrOutput) Elem() BridgeOutputBridgeNetworkOutputOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) BridgeOutputBridgeNetworkOutput {
		if v != nil {
			return *v
		}
		var ret BridgeOutputBridgeNetworkOutput
		return ret
	}).(BridgeOutputBridgeNetworkOutputOutput)
}

// The network output IP Address.
func (o BridgeOutputBridgeNetworkOutputPtrOutput) IpAddress() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) *string {
		if v == nil {
			return nil
		}
		return &v.IpAddress
...
// The network output's gateway network name.
func (o BridgeOutputBridgeNetworkOutputPtrOutput) NetworkName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) *string {
		if v == nil {
			return nil
		}
...
// The network output port.
func (o BridgeOutputBridgeNetworkOutputPtrOutput) Port() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) *int {
		if v == nil {
			return nil
		}
		return &v.Port
...
// The network output protocol.
func (o BridgeOutputBridgeNetworkOutputPtrOutput) Protocol() BridgeOutputBridgeNetworkOutputProtocolPtrOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) *BridgeOutputBridgeNetworkOutputProtocol {
		if v == nil {
			return nil
		}
		return &v.Protocol
...
// The network output TTL.
func (o BridgeOutputBridgeNetworkOutputPtrOutput) Ttl() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *BridgeOutputBridgeNetworkOutput) *int {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*BridgeOutputResourceInput)(nil)).Elem(), BridgeOutputResourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*BridgeOutputResourceArrayInput)(nil)).Elem(), BridgeOutputResourceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*BridgeOutputBridgeNetworkOutputInput)(nil)).Elem(), BridgeOutputBridgeNetworkOutputArgs{})
	...
	pulumi.RegisterOutputType(BridgeOutputResourceArrayOutput{})
	pulumi.RegisterOutputType(BridgeOutputBridgeNetworkOutputOutput{})
	pulumi.RegisterOutputType(BridgeOutputBridgeNetworkOutputPtrOutput{})
