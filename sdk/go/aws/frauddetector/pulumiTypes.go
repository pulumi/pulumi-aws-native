...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypeTagInput)(nil)).Elem(), EntityTypeTagArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*EntityTypeTagArrayInput)(nil)).Elem(), EntityTypeTagArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VariableTagArrayInput)(nil)).Elem(), VariableTagArray{})
