...
func NewResourcePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws-native:bedrockagentcore:ResourcePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourcePolicy(ctx *pulumi.Context,
	...
	var resource ResourcePolicy
	err := ctx.ReadResource("aws-native:bedrockagentcore:ResourcePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
