...
type EnvironmentProfile struct {
	...
	AwsAccountRegion pulumi.StringPtrOutput `pulumi:"awsAccountRegion"`
...
// The AWS account in which the Amazon DataZone environment is created.
func (o EnvironmentProfileOutput) AwsAccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EnvironmentProfile) pulumi.StringPtrOutput { return v.AwsAccountId }).(pulumi.StringPtrOutput)
}

// The AWS region in which this environment profile is created.
func (o EnvironmentProfileOutput) AwsAccountRegion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EnvironmentProfile) pulumi.StringPtrOutput { return v.AwsAccountRegion }).(pulumi.StringPtrOutput)
}
