...
func LookupDeployment(ctx *pulumi.Context, args *LookupDeploymentArgs, opts ...pulumi.InvokeOption) (*LookupDeploymentResult, error) {
	...
	err := ctx.Invoke("aws-native:m2:getDeployment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDeploymentOutput(ctx *pulumi.Context, args LookupDeploymentOutputArgs, opts ...pulumi.InvokeOption) LookupDeploymentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDeploymentResultOutput, error) {
			...
			return ctx.InvokeOutput("aws-native:m2:getDeployment", args, LookupDeploymentResultOutput{}, options).(LookupDeploymentResultOutput), nil
...
// The version number of the application to deploy
func (o LookupDeploymentResultOutput) ApplicationVersion() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupDeploymentResult) *int { return v.ApplicationVersion }).(pulumi.IntPtrOutput)
}
...
// The status of the deployment.
func (o LookupDeploymentResultOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDeploymentResult) *string { return v.Status }).(pulumi.StringPtrOutput)
}
