...
func LookupAutoScalingGroupOutput(ctx *pulumi.Context, args LookupAutoScalingGroupOutputArgs, opts ...pulumi.InvokeOption) LookupAutoScalingGroupResultOutput {
	...
	return ctx.InvokeOutput("aws-native:autoscaling:getAutoScalingGroup", args, LookupAutoScalingGroupResultOutput{}, options).(LookupAutoScalingGroupResultOutput)
}
...
// The Availability Zone IDs where the Auto Scaling group can launch instances.
func (o LookupAutoScalingGroupResultOutput) AvailabilityZoneIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupAutoScalingGroupResult) []string { return v.AvailabilityZoneIds }).(pulumi.StringArrayOutput)
}
...
// The deletion protection setting for the Auto Scaling group.
func (o LookupAutoScalingGroupResultOutput) DeletionProtection() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAutoScalingGroupResult) *string { return v.DeletionProtection }).(pulumi.StringPtrOutput)
}
