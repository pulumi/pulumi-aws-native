...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ReplicationConfigurationTypePtrInput)(nil)).Elem(), ReplicationConfigurationTypeArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*RepositoryCatalogDataPropertiesInput)(nil)).Elem(), RepositoryCatalogDataPropertiesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*RepositoryCatalogDataPropertiesPtrInput)(nil)).Elem(), RepositoryCatalogDataPropertiesArgs{})
