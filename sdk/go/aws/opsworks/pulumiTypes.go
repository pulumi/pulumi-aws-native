...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*AppSourceInput)(nil)).Elem(), AppSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppSourcePtrInput)(nil)).Elem(), AppSourceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppSslConfigurationInput)(nil)).Elem(), AppSslConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AppSslConfigurationPtrInput)(nil)).Elem(), AppSslConfigurationArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceEbsBlockDevicePtrInput)(nil)).Elem(), InstanceEbsBlockDeviceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceTimeBasedAutoScalingInput)(nil)).Elem(), InstanceTimeBasedAutoScalingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceTimeBasedAutoScalingPtrInput)(nil)).Elem(), InstanceTimeBasedAutoScalingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerAutoScalingThresholdsInput)(nil)).Elem(), LayerAutoScalingThresholdsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerAutoScalingThresholdsPtrInput)(nil)).Elem(), LayerAutoScalingThresholdsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerLifecycleEventConfigurationInput)(nil)).Elem(), LayerLifecycleEventConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerLifecycleEventConfigurationPtrInput)(nil)).Elem(), LayerLifecycleEventConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerLoadBasedAutoScalingInput)(nil)).Elem(), LayerLoadBasedAutoScalingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerLoadBasedAutoScalingPtrInput)(nil)).Elem(), LayerLoadBasedAutoScalingArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LayerRecipesInput)(nil)).Elem(), LayerRecipesArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StackChefConfigurationPtrInput)(nil)).Elem(), StackChefConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackConfigurationManagerInput)(nil)).Elem(), StackConfigurationManagerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackConfigurationManagerPtrInput)(nil)).Elem(), StackConfigurationManagerArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackElasticIpInput)(nil)).Elem(), StackElasticIpArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackElasticIpArrayInput)(nil)).Elem(), StackElasticIpArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackRdsDbInstanceInput)(nil)).Elem(), StackRdsDbInstanceArgs{})
