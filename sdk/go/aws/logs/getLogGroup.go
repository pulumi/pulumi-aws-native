...
// Indicates whether deletion protection is enabled for this log group. When enabled, deletion protection blocks all deletion operations until it is explicitly disabled.
func (o LookupLogGroupResultOutput) DeletionProtectionEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupLogGroupResult) *bool { return v.DeletionProtectionEnabled }).(pulumi.BoolPtrOutput)
}
