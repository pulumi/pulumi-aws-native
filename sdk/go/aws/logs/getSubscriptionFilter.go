...
func (o LookupSubscriptionFilterResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSubscriptionFilterResult] {
	return pulumix.Output[LookupSubscriptionFilterResult]{
