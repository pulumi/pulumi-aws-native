...
func (o LookupRestoreTestingSelectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRestoreTestingSelectionResult] {
	return pulumix.Output[LookupRestoreTestingSelectionResult]{
