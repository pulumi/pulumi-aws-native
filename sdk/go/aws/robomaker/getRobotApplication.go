...
func (o LookupRobotApplicationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRobotApplicationResult] {
	return pulumix.Output[LookupRobotApplicationResult]{
