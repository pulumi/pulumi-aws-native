...
// The KMS key ARN to encrypt the logs published to the given Amazon S3 destination. When omitted, EMR falls back to cluster-level logging behavior.
func (o StepOutput) EncryptionKeyArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Step) pulumi.StringPtrOutput { return v.EncryptionKeyArn }).(pulumi.StringPtrOutput)
}
...
// The Amazon S3 destination URI for log publishing. When omitted, EMR falls back to cluster-level logging behavior.
func (o StepOutput) LogUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Step) pulumi.StringPtrOutput { return v.LogUri }).(pulumi.StringPtrOutput)
}
