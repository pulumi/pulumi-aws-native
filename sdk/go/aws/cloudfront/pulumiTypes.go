...
type AnycastIpListTypeOutput struct{ *pulumi.OutputState }

func (AnycastIpListTypeOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AnycastIpListType)(nil)).Elem()
}

func (o AnycastIpListTypeOutput) ToAnycastIpListTypeOutput() AnycastIpListTypeOutput {
	return o
}

func (o AnycastIpListTypeOutput) ToAnycastIpListTypeOutputWithContext(ctx context.Context) AnycastIpListTypeOutput {
	return o
}

// The static IP addresses that are allocated to the Anycast static IP list.
func (o AnycastIpListTypeOutput) AnycastIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v AnycastIpListType) []string { return v.AnycastIps }).(pulumi.StringArrayOutput)
}

// The Amazon Resource Name (ARN) of the Anycast static IP list.
func (o AnycastIpListTypeOutput) Arn() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListType) string { return v.Arn }).(pulumi.StringOutput)
}

// The ID of the Anycast static IP list.
func (o AnycastIpListTypeOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListType) string { return v.Id }).(pulumi.StringOutput)
}

// The number of IP addresses in the Anycast static IP list.
func (o AnycastIpListTypeOutput) IpCount() pulumi.IntOutput {
	return o.ApplyT(func(v AnycastIpListType) int { return v.IpCount }).(pulumi.IntOutput)
}

// The last time the Anycast static IP list was modified.
func (o AnycastIpListTypeOutput) LastModifiedTime() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListType) string { return v.LastModifiedTime }).(pulumi.StringOutput)
}

// The name of the Anycast static IP list.
func (o AnycastIpListTypeOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListType) string { return v.Name }).(pulumi.StringOutput)
}

// The status of the Anycast static IP list. Valid values: `Deployed` , `Deploying` , or `Failed` .
func (o AnycastIpListTypeOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListType) string { return v.Status }).(pulumi.StringOutput)
}

type AnycastIpListTypePtrOutput struct{ *pulumi.OutputState }

func (AnycastIpListTypePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AnycastIpListType)(nil)).Elem()
}

func (o AnycastIpListTypePtrOutput) ToAnycastIpListTypePtrOutput() AnycastIpListTypePtrOutput {
	return o
}

func (o AnycastIpListTypePtrOutput) ToAnycastIpListTypePtrOutputWithContext(ctx context.Context) AnycastIpListTypePtrOutput {
	return o
}

func (o AnycastIpListTypePtrOutput) Elem() AnycastIpListTypeOutput {
	return o.ApplyT(func(v *AnycastIpListType) AnycastIpListType {
		if v != nil {
			return *v
		}
		var ret AnycastIpListType
		return ret
	}).(AnycastIpListTypeOutput)
}

// The static IP addresses that are allocated to the Anycast static IP list.
func (o AnycastIpListTypePtrOutput) AnycastIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AnycastIpListType) []string {
		if v == nil {
			return nil
		}
		return v.AnycastIps
...
// The Amazon Resource Name (ARN) of the Anycast static IP list.
func (o AnycastIpListTypePtrOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *string {
		if v == nil {
			return nil
		}
...
// The ID of the Anycast static IP list.
func (o AnycastIpListTypePtrOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *string {
		if v == nil {
			return nil
		}
...
// The number of IP addresses in the Anycast static IP list.
func (o AnycastIpListTypePtrOutput) IpCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *int {
		if v == nil {
			return nil
		}
		return &v.IpCount
...
// The last time the Anycast static IP list was modified.
func (o AnycastIpListTypePtrOutput) LastModifiedTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *string {
		if v == nil {
			return nil
		}
...
// The name of the Anycast static IP list.
func (o AnycastIpListTypePtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *string {
		if v == nil {
			return nil
		}
...
// The status of the Anycast static IP list. Valid values: `Deployed` , `Deploying` , or `Failed` .
func (o AnycastIpListTypePtrOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AnycastIpListType) *string {
		if v == nil {
			return nil
		}
...
// AnycastIpListTagInput is an input type that accepts AnycastIpListTagArgs and AnycastIpListTagOutput values.
// You can construct a concrete instance of `AnycastIpListTagInput` via:
//
//	AnycastIpListTagArgs{...}
type AnycastIpListTagInput interface {
	pulumi.Input

	ToAnycastIpListTagOutput() AnycastIpListTagOutput
	ToAnycastIpListTagOutputWithContext(context.Context) AnycastIpListTagOutput
}

type AnycastIpListTagArgs struct {
	// A string that contains `Tag` key.
	//
	// The string length should be between 1 and 128 characters. Valid characters include `a-z` , `A-Z` , `0-9` , space, and the special characters `_ - . : / = + @` .
...
func (AnycastIpListTagArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AnycastIpListTag)(nil)).Elem()
}

func (i AnycastIpListTagArgs) ToAnycastIpListTagOutput() AnycastIpListTagOutput {
	return i.ToAnycastIpListTagOutputWithContext(context.Background())
}

func (i AnycastIpListTagArgs) ToAnycastIpListTagOutputWithContext(ctx context.Context) AnycastIpListTagOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AnycastIpListTagOutput)
}

// AnycastIpListTagArrayInput is an input type that accepts AnycastIpListTagArray and AnycastIpListTagArrayOutput values.
// You can construct a concrete instance of `AnycastIpListTagArrayInput` via:
//
//	AnycastIpListTagArray{ AnycastIpListTagArgs{...} }
type AnycastIpListTagArrayInput interface {
	pulumi.Input

	ToAnycastIpListTagArrayOutput() AnycastIpListTagArrayOutput
	ToAnycastIpListTagArrayOutputWithContext(context.Context) AnycastIpListTagArrayOutput
}

type AnycastIpListTagArray []AnycastIpListTagInput

func (AnycastIpListTagArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AnycastIpListTag)(nil)).Elem()
}

func (i AnycastIpListTagArray) ToAnycastIpListTagArrayOutput() AnycastIpListTagArrayOutput {
	return i.ToAnycastIpListTagArrayOutputWithContext(context.Background())
}

func (i AnycastIpListTagArray) ToAnycastIpListTagArrayOutputWithContext(ctx context.Context) AnycastIpListTagArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AnycastIpListTagArrayOutput)
}

type AnycastIpListTagOutput struct{ *pulumi.OutputState }

func (AnycastIpListTagOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AnycastIpListTag)(nil)).Elem()
}

func (o AnycastIpListTagOutput) ToAnycastIpListTagOutput() AnycastIpListTagOutput {
	return o
}

func (o AnycastIpListTagOutput) ToAnycastIpListTagOutputWithContext(ctx context.Context) AnycastIpListTagOutput {
	return o
}
...
//
// The string length should be between 1 and 128 characters. Valid characters include `a-z` , `A-Z` , `0-9` , space, and the special characters `_ - . : / = + @` .
func (o AnycastIpListTagOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v AnycastIpListTag) string { return v.Key }).(pulumi.StringOutput)
}

// A string that contains an optional `Tag` value.
//
// The string length should be between 0 and 256 characters. Valid characters include `a-z` , `A-Z` , `0-9` , space, and the special characters `_ - . : / = + @` .
func (o AnycastIpListTagOutput) Value() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AnycastIpListTag) *string { return v.Value }).(pulumi.StringPtrOutput)
}

type AnycastIpListTagArrayOutput struct{ *pulumi.OutputState }

func (AnycastIpListTagArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]AnycastIpListTag)(nil)).Elem()
}

func (o AnycastIpListTagArrayOutput) ToAnycastIpListTagArrayOutput() AnycastIpListTagArrayOutput {
	return o
}

func (o AnycastIpListTagArrayOutput) ToAnycastIpListTagArrayOutputWithContext(ctx context.Context) AnycastIpListTagArrayOutput {
	return o
}

func (o AnycastIpListTagArrayOutput) Index(i pulumi.IntInput) AnycastIpListTagOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) AnycastIpListTag {
		return vs[0].([]AnycastIpListTag)[vs[1].(int)]
	}).(AnycastIpListTagOutput)
}

type AnycastIpListTags struct {
	// A complex type that contains `Tag` elements.
	Items []AnycastIpListTag `pulumi:"items"`
}

// AnycastIpListTagsInput is an input type that accepts AnycastIpListTagsArgs and AnycastIpListTagsOutput values.
// You can construct a concrete instance of `AnycastIpListTagsInput` via:
//
//	AnycastIpListTagsArgs{...}
type AnycastIpListTagsInput interface {
	pulumi.Input

	ToAnycastIpListTagsOutput() AnycastIpListTagsOutput
	ToAnycastIpListTagsOutputWithContext(context.Context) AnycastIpListTagsOutput
}

type AnycastIpListTagsArgs struct {
	// A complex type that contains `Tag` elements.
	Items AnycastIpListTagArrayInput `pulumi:"items"`
}

func (AnycastIpListTagsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*AnycastIpListTags)(nil)).Elem()
}

func (i AnycastIpListTagsArgs) ToAnycastIpListTagsOutput() AnycastIpListTagsOutput {
	return i.ToAnycastIpListTagsOutputWithContext(context.Background())
}

func (i AnycastIpListTagsArgs) ToAnycastIpListTagsOutputWithContext(ctx context.Context) AnycastIpListTagsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AnycastIpListTagsOutput)
}

func (i AnycastIpListTagsArgs) ToAnycastIpListTagsPtrOutput() AnycastIpListTagsPtrOutput {
	return i.ToAnycastIpListTagsPtrOutputWithContext(context.Background())
}

func (i AnycastIpListTagsArgs) ToAnycastIpListTagsPtrOutputWithContext(ctx context.Context) AnycastIpListTagsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AnycastIpListTagsOutput).ToAnycastIpListTagsPtrOutputWithContext(ctx)
}

// AnycastIpListTagsPtrInput is an input type that accepts AnycastIpListTagsArgs, AnycastIpListTagsPtr and AnycastIpListTagsPtrOutput values.
// You can construct a concrete instance of `AnycastIpListTagsPtrInput` via:
//
//	        AnycastIpListTagsArgs{...}
//
//	or:
//
//	        nil
type AnycastIpListTagsPtrInput interface {
	pulumi.Input

	ToAnycastIpListTagsPtrOutput() AnycastIpListTagsPtrOutput
	ToAnycastIpListTagsPtrOutputWithContext(context.Context) AnycastIpListTagsPtrOutput
}

type anycastIpListTagsPtrType AnycastIpListTagsArgs

func AnycastIpListTagsPtr(v *AnycastIpListTagsArgs) AnycastIpListTagsPtrInput {
	return (*anycastIpListTagsPtrType)(v)
}

func (*anycastIpListTagsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AnycastIpListTags)(nil)).Elem()
}

func (i *anycastIpListTagsPtrType) ToAnycastIpListTagsPtrOutput() AnycastIpListTagsPtrOutput {
	return i.ToAnycastIpListTagsPtrOutputWithContext(context.Background())
}

func (i *anycastIpListTagsPtrType) ToAnycastIpListTagsPtrOutputWithContext(ctx context.Context) AnycastIpListTagsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AnycastIpListTagsPtrOutput)
}

type AnycastIpListTagsOutput struct{ *pulumi.OutputState }

func (AnycastIpListTagsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*AnycastIpListTags)(nil)).Elem()
}

func (o AnycastIpListTagsOutput) ToAnycastIpListTagsOutput() AnycastIpListTagsOutput {
	return o
}

func (o AnycastIpListTagsOutput) ToAnycastIpListTagsOutputWithContext(ctx context.Context) AnycastIpListTagsOutput {
	return o
}

func (o AnycastIpListTagsOutput) ToAnycastIpListTagsPtrOutput() AnycastIpListTagsPtrOutput {
	return o.ToAnycastIpListTagsPtrOutputWithContext(context.Background())
}

func (o AnycastIpListTagsOutput) ToAnycastIpListTagsPtrOutputWithContext(ctx context.Context) AnycastIpListTagsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AnycastIpListTags) *AnycastIpListTags {
		return &v
	}).(AnycastIpListTagsPtrOutput)
}

// A complex type that contains `Tag` elements.
func (o AnycastIpListTagsOutput) Items() AnycastIpListTagArrayOutput {
	return o.ApplyT(func(v AnycastIpListTags) []AnycastIpListTag { return v.Items }).(AnycastIpListTagArrayOutput)
}

type AnycastIpListTagsPtrOutput struct{ *pulumi.OutputState }

func (AnycastIpListTagsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AnycastIpListTags)(nil)).Elem()
}

func (o AnycastIpListTagsPtrOutput) ToAnycastIpListTagsPtrOutput() AnycastIpListTagsPtrOutput {
	return o
}

func (o AnycastIpListTagsPtrOutput) ToAnycastIpListTagsPtrOutputWithContext(ctx context.Context) AnycastIpListTagsPtrOutput {
	return o
}

func (o AnycastIpListTagsPtrOutput) Elem() AnycastIpListTagsOutput {
	return o.ApplyT(func(v *AnycastIpListTags) AnycastIpListTags {
		if v != nil {
			return *v
		}
		var ret AnycastIpListTags
		return ret
	}).(AnycastIpListTagsOutput)
}

// A complex type that contains `Tag` elements.
func (o AnycastIpListTagsPtrOutput) Items() AnycastIpListTagArrayOutput {
	return o.ApplyT(func(v *AnycastIpListTags) []AnycastIpListTag {
		if v == nil {
			return nil
		}
		return v.Items
	}).(AnycastIpListTagArrayOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*AnycastIpListTagInput)(nil)).Elem(), AnycastIpListTagArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnycastIpListTagArrayInput)(nil)).Elem(), AnycastIpListTagArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnycastIpListTagsInput)(nil)).Elem(), AnycastIpListTagsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*AnycastIpListTagsPtrInput)(nil)).Elem(), AnycastIpListTagsArgs{})
	...
	pulumi.RegisterOutputType(AnycastIpListTypeOutput{})
	pulumi.RegisterOutputType(AnycastIpListTypePtrOutput{})
	pulumi.RegisterOutputType(AnycastIpListTagOutput{})
	pulumi.RegisterOutputType(AnycastIpListTagArrayOutput{})
	pulumi.RegisterOutputType(AnycastIpListTagsOutput{})
	pulumi.RegisterOutputType(AnycastIpListTagsPtrOutput{})
