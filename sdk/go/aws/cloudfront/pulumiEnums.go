...
type DistributionTenantDomainResultReason string

const (
	DistributionTenantDomainResultReasonPendingValidation = DistributionTenantDomainResultReason("pending-validation")
	DistributionTenantDomainResultReasonValidationFailed  = DistributionTenantDomainResultReason("validation-failed")
	DistributionTenantDomainResultReasonPendingActivation = DistributionTenantDomainResultReason("pending-activation")
	DistributionTenantDomainResultReasonCustomerActivated = DistributionTenantDomainResultReason("customer-activated")
)

type DistributionTenantDomainResultReasonOutput struct{ *pulumi.OutputState }

func (DistributionTenantDomainResultReasonOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DistributionTenantDomainResultReason)(nil)).Elem()
}

func (o DistributionTenantDomainResultReasonOutput) ToDistributionTenantDomainResultReasonOutput() DistributionTenantDomainResultReasonOutput {
	return o
}

func (o DistributionTenantDomainResultReasonOutput) ToDistributionTenantDomainResultReasonOutputWithContext(ctx context.Context) DistributionTenantDomainResultReasonOutput {
	return o
}

func (o DistributionTenantDomainResultReasonOutput) ToDistributionTenantDomainResultReasonPtrOutput() DistributionTenantDomainResultReasonPtrOutput {
	return o.ToDistributionTenantDomainResultReasonPtrOutputWithContext(context.Background())
}

func (o DistributionTenantDomainResultReasonOutput) ToDistributionTenantDomainResultReasonPtrOutputWithContext(ctx context.Context) DistributionTenantDomainResultReasonPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DistributionTenantDomainResultReason) *DistributionTenantDomainResultReason {
		return &v
	}).(DistributionTenantDomainResultReasonPtrOutput)
}

func (o DistributionTenantDomainResultReasonOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DistributionTenantDomainResultReasonOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DistributionTenantDomainResultReason) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DistributionTenantDomainResultReasonOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DistributionTenantDomainResultReasonOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DistributionTenantDomainResultReason) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DistributionTenantDomainResultReasonPtrOutput struct{ *pulumi.OutputState }

func (DistributionTenantDomainResultReasonPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DistributionTenantDomainResultReason)(nil)).Elem()
}

func (o DistributionTenantDomainResultReasonPtrOutput) ToDistributionTenantDomainResultReasonPtrOutput() DistributionTenantDomainResultReasonPtrOutput {
	return o
}

func (o DistributionTenantDomainResultReasonPtrOutput) ToDistributionTenantDomainResultReasonPtrOutputWithContext(ctx context.Context) DistributionTenantDomainResultReasonPtrOutput {
	return o
}

func (o DistributionTenantDomainResultReasonPtrOutput) Elem() DistributionTenantDomainResultReasonOutput {
	return o.ApplyT(func(v *DistributionTenantDomainResultReason) DistributionTenantDomainResultReason {
		if v != nil {
			return *v
		}
		var ret DistributionTenantDomainResultReason
		return ret
	}).(DistributionTenantDomainResultReasonOutput)
}

func (o DistributionTenantDomainResultReasonPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DistributionTenantDomainResultReasonPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *DistributionTenantDomainResultReason) *string {
		if e == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterOutputType(DistributionTenantDomainResultReasonOutput{})
	pulumi.RegisterOutputType(DistributionTenantDomainResultReasonPtrOutput{})
