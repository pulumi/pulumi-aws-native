...
// The globally unique identifier for the identity store.
func (o GroupOutput) IdentityStoreId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.StringPtrOutput { return v.IdentityStoreId }).(pulumi.StringPtrOutput)
}
