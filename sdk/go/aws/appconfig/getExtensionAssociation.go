...
func (o LookupExtensionAssociationResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupExtensionAssociationResult] {
	return pulumix.Output[LookupExtensionAssociationResult]{
