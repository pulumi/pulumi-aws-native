...
func (o LookupResourceDefaultVersionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupResourceDefaultVersionResult] {
	return pulumix.Output[LookupResourceDefaultVersionResult]{
