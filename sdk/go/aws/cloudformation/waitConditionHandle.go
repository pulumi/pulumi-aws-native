...
//
// Deprecated: WaitConditionHandle is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
...
func (*WaitConditionHandle) ElementType() reflect.Type {
	return reflect.TypeOf((**WaitConditionHandle)(nil)).Elem()
}
