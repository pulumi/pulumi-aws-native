...
func (o LookupPublicTypeVersionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPublicTypeVersionResult] {
	return pulumix.Output[LookupPublicTypeVersionResult]{
