...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanCustomizedLoadMetricSpecificationInput)(nil)).Elem(), ScalingPlanCustomizedLoadMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanCustomizedLoadMetricSpecificationPtrInput)(nil)).Elem(), ScalingPlanCustomizedLoadMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanCustomizedScalingMetricSpecificationInput)(nil)).Elem(), ScalingPlanCustomizedScalingMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanCustomizedScalingMetricSpecificationPtrInput)(nil)).Elem(), ScalingPlanCustomizedScalingMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanMetricDimensionInput)(nil)).Elem(), ScalingPlanMetricDimensionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanMetricDimensionArrayInput)(nil)).Elem(), ScalingPlanMetricDimensionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanPredefinedLoadMetricSpecificationInput)(nil)).Elem(), ScalingPlanPredefinedLoadMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanPredefinedLoadMetricSpecificationPtrInput)(nil)).Elem(), ScalingPlanPredefinedLoadMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanPredefinedScalingMetricSpecificationInput)(nil)).Elem(), ScalingPlanPredefinedScalingMetricSpecificationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanPredefinedScalingMetricSpecificationPtrInput)(nil)).Elem(), ScalingPlanPredefinedScalingMetricSpecificationArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanTagFilterInput)(nil)).Elem(), ScalingPlanTagFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ScalingPlanTagFilterArrayInput)(nil)).Elem(), ScalingPlanTagFilterArray{})
