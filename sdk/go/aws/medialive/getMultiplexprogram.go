...
func (o LookupMultiplexprogramResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupMultiplexprogramResult] {
	return pulumix.Output[LookupMultiplexprogramResult]{
