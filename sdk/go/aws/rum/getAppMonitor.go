...
// The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
func (o LookupAppMonitorResultOutput) DomainList() pulumi.ArrayOutput {
	return o.ApplyT(func(v LookupAppMonitorResult) []interface{} { return v.DomainList }).(pulumi.ArrayOutput)
}
