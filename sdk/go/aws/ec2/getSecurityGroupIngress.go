...
func (o LookupSecurityGroupIngressResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSecurityGroupIngressResult] {
	return pulumix.Output[LookupSecurityGroupIngressResult]{
