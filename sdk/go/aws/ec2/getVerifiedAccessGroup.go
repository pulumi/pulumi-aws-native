...
func (o LookupVerifiedAccessGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVerifiedAccessGroupResult] {
	return pulumix.Output[LookupVerifiedAccessGroupResult]{
