...
func (o LookupTrafficMirrorFilterResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTrafficMirrorFilterResult] {
	return pulumix.Output[LookupTrafficMirrorFilterResult]{
