...
func (o LookupEgressOnlyInternetGatewayResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupEgressOnlyInternetGatewayResult] {
	return pulumix.Output[LookupEgressOnlyInternetGatewayResult]{
