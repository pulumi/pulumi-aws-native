...
type UserPool struct {
	...
	WebAuthnFactorConfiguration UserPoolWebAuthnFactorConfigurationPtrOutput `pulumi:"webAuthnFactorConfiguration"`
...
type UserPoolArgs struct {
	...
	WebAuthnFactorConfiguration UserPoolWebAuthnFactorConfigurationPtrInput
	// Sets or displays the authentication domain, typically your user pool domain, that passkey providers must use as a relying party (RP) in their configuration.
	//
	// Under the following conditions, the passkey relying party ID must be the fully-qualified domain name of your custom domain:
	//
...
func (o UserPoolOutput) WebAuthnFactorConfiguration() UserPoolWebAuthnFactorConfigurationPtrOutput {
	return o.ApplyT(func(v *UserPool) UserPoolWebAuthnFactorConfigurationPtrOutput { return v.WebAuthnFactorConfiguration }).(UserPoolWebAuthnFactorConfigurationPtrOutput)
}
