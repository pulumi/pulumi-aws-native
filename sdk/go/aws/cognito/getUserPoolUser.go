...
func (o LookupUserPoolUserResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupUserPoolUserResult] {
	return pulumix.Output[LookupUserPoolUserResult]{
