...
func (o EndpointReplicationConfigOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v EndpointReplicationConfig) string { return v.State }).(pulumi.StringOutput)
}
...
func (o EndpointReplicationConfigPtrOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EndpointReplicationConfig) *string {
		if v == nil {
			return nil
		}
		return &v.State
