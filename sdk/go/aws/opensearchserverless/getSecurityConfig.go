...
func (o LookupSecurityConfigResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSecurityConfigResult] {
	return pulumix.Output[LookupSecurityConfigResult]{
