...
//
// Deprecated: Device is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
type Device struct {
...
func (o DeviceOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Device) pulumi.BoolOutput { return v.Enabled }).(pulumi.BoolOutput)
}
