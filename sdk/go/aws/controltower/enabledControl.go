...
type EnabledControl struct {
	...
	Tags EnabledControlTagArrayOutput `pulumi:"tags"`
...
type EnabledControlArgs struct {
	...
	// A set of tags to assign to the enabled control.
	Tags EnabledControlTagArrayInput
	// Arn for Organizational unit to which the control needs to be applied
...
// A set of tags to assign to the enabled control.
func (o EnabledControlOutput) Tags() EnabledControlTagArrayOutput {
	return o.ApplyT(func(v *EnabledControl) EnabledControlTagArrayOutput { return v.Tags }).(EnabledControlTagArrayOutput)
}
