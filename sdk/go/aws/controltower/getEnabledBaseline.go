...
type LookupEnabledBaselineResult struct {
	...
	Tags                      []EnabledBaselineTag       `pulumi:"tags"`
}
...
func (o LookupEnabledBaselineResultOutput) Tags() EnabledBaselineTagArrayOutput {
	return o.ApplyT(func(v LookupEnabledBaselineResult) []EnabledBaselineTag { return v.Tags }).(EnabledBaselineTagArrayOutput)
}
