...
type LookupEnabledControlResult struct {
	...
	Tags []EnabledControlTag `pulumi:"tags"`
}
...
// A set of tags to assign to the enabled control.
func (o LookupEnabledControlResultOutput) Tags() EnabledControlTagArrayOutput {
	return o.ApplyT(func(v LookupEnabledControlResult) []EnabledControlTag { return v.Tags }).(EnabledControlTagArrayOutput)
}
