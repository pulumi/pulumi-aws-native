...
type EnabledBaseline struct {
	...
	Tags                      EnabledBaselineTagArrayOutput       `pulumi:"tags"`
...
type EnabledBaselineArgs struct {
	...
	Tags               EnabledBaselineTagArrayInput
...
func (o EnabledBaselineOutput) Tags() EnabledBaselineTagArrayOutput {
	return o.ApplyT(func(v *EnabledBaseline) EnabledBaselineTagArrayOutput { return v.Tags }).(EnabledBaselineTagArrayOutput)
}
