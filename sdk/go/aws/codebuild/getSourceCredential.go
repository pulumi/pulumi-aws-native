...
func (o LookupSourceCredentialResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSourceCredentialResult] {
	return pulumix.Output[LookupSourceCredentialResult]{
