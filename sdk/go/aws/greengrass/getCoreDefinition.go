...
func (o LookupCoreDefinitionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupCoreDefinitionResult] {
	return pulumix.Output[LookupCoreDefinitionResult]{
