...
func (o LookupFunctionDefinitionVersionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFunctionDefinitionVersionResult] {
	return pulumix.Output[LookupFunctionDefinitionVersionResult]{
