...
//
// Deprecated: ResourceDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
...
func (o ResourceDefinitionOutput) AwsId() pulumi.StringOutput {
	return o.ApplyT(func(v *ResourceDefinition) pulumi.StringOutput { return v.AwsId }).(pulumi.StringOutput)
}
