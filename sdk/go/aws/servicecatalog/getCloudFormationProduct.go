...
func (o LookupCloudFormationProductResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupCloudFormationProductResult] {
	return pulumix.Output[LookupCloudFormationProductResult]{
