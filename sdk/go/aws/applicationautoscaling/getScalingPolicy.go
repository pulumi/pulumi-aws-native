...
func LookupScalingPolicyOutput(ctx *pulumi.Context, args LookupScalingPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupScalingPolicyResultOutput {
	...
	return ctx.InvokeOutput("aws-native:applicationautoscaling:getScalingPolicy", args, LookupScalingPolicyResultOutput{}, options).(LookupScalingPolicyResultOutput)
}
