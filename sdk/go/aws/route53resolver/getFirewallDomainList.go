...
func LookupFirewallDomainListOutput(ctx *pulumi.Context, args LookupFirewallDomainListOutputArgs, opts ...pulumi.InvokeOption) LookupFirewallDomainListResultOutput {
	...
	return ctx.InvokeOutput("aws-native:route53resolver:getFirewallDomainList", args, LookupFirewallDomainListResultOutput{}, options).(LookupFirewallDomainListResultOutput)
}
