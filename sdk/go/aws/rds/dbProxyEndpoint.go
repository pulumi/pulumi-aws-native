...
type DbProxyEndpoint struct {
	...
	EndpointNetworkType DbProxyEndpointEndpointNetworkTypePtrOutput `pulumi:"endpointNetworkType"`
...
type dbProxyEndpointArgs struct {
	...
	// The network type of the DB proxy endpoint. The network type determines the IP version that the proxy endpoint supports.
	EndpointNetworkType *DbProxyEndpointEndpointNetworkType `pulumi:"endpointNetworkType"`
	// An optional set of key-value pairs to associate arbitrary data of your choosing with the DB proxy endpoint.
...
type DbProxyEndpointArgs struct {
	...
	// The network type of the DB proxy endpoint. The network type determines the IP version that the proxy endpoint supports.
	EndpointNetworkType DbProxyEndpointEndpointNetworkTypePtrInput
	// An optional set of key-value pairs to associate arbitrary data of your choosing with the DB proxy endpoint.
...
// The network type of the DB proxy endpoint. The network type determines the IP version that the proxy endpoint supports.
func (o DbProxyEndpointOutput) EndpointNetworkType() DbProxyEndpointEndpointNetworkTypePtrOutput {
	return o.ApplyT(func(v *DbProxyEndpoint) DbProxyEndpointEndpointNetworkTypePtrOutput { return v.EndpointNetworkType }).(DbProxyEndpointEndpointNetworkTypePtrOutput)
}
