...
type DBCluster struct {
	...
	Engine DBClusterEnginePtrOutput `pulumi:"engine"`
	// The DB engine mode of the DB cluster, either provisioned, serverless, parallelquery, global, or multimaster.
	EngineMode DBClusterEngineModePtrOutput `pulumi:"engineMode"`
	...
	RestoreType DBClusterRestoreTypePtrOutput `pulumi:"restoreType"`
	...
	StorageType DBClusterStorageTypePtrOutput `pulumi:"storageType"`
...
type dbclusterArgs struct {
	...
	// The name of the database engine to be used for this DB cluster. Valid Values: aurora (for MySQL 5.6-compatible Aurora), aurora-mysql (for MySQL 5.7-compatible Aurora), and aurora-postgresql
	Engine *DBClusterEngine `pulumi:"engine"`
	// The DB engine mode of the DB cluster, either provisioned, serverless, parallelquery, global, or multimaster.
	EngineMode *DBClusterEngineMode `pulumi:"engineMode"`
	// The version number of the database engine to use.
	...
	// full-copy - The new DB cluster is restored as a full copy of the source DB cluster.
	// copy-on-write - The new DB cluster is restored as a clone of the source DB cluster.
	RestoreType *DBClusterRestoreType `pulumi:"restoreType"`
	// The ScalingConfiguration property type specifies the scaling configuration of an Aurora Serverless DB cluster.
	...
	// Specifies the storage type to be associated with the DB cluster.
	StorageType *DBClusterStorageType `pulumi:"storageType"`
	// An array of key-value pairs to apply to this resource.
...
type DBClusterArgs struct {
	...
	// The name of the database engine to be used for this DB cluster. Valid Values: aurora (for MySQL 5.6-compatible Aurora), aurora-mysql (for MySQL 5.7-compatible Aurora), and aurora-postgresql
	Engine DBClusterEnginePtrInput
	// The DB engine mode of the DB cluster, either provisioned, serverless, parallelquery, global, or multimaster.
	EngineMode DBClusterEngineModePtrInput
	// The version number of the database engine to use.
	...
	// full-copy - The new DB cluster is restored as a full copy of the source DB cluster.
	// copy-on-write - The new DB cluster is restored as a clone of the source DB cluster.
	RestoreType DBClusterRestoreTypePtrInput
	// The ScalingConfiguration property type specifies the scaling configuration of an Aurora Serverless DB cluster.
	...
	// Specifies the storage type to be associated with the DB cluster.
	StorageType DBClusterStorageTypePtrInput
	// An array of key-value pairs to apply to this resource.
...
// The name of the database engine to be used for this DB cluster. Valid Values: aurora (for MySQL 5.6-compatible Aurora), aurora-mysql (for MySQL 5.7-compatible Aurora), and aurora-postgresql
func (o DBClusterOutput) Engine() DBClusterEnginePtrOutput {
	return o.ApplyT(func(v *DBCluster) DBClusterEnginePtrOutput { return v.Engine }).(DBClusterEnginePtrOutput)
}

// The DB engine mode of the DB cluster, either provisioned, serverless, parallelquery, global, or multimaster.
func (o DBClusterOutput) EngineMode() DBClusterEngineModePtrOutput {
	return o.ApplyT(func(v *DBCluster) DBClusterEngineModePtrOutput { return v.EngineMode }).(DBClusterEngineModePtrOutput)
}
...
// full-copy - The new DB cluster is restored as a full copy of the source DB cluster.
// copy-on-write - The new DB cluster is restored as a clone of the source DB cluster.
func (o DBClusterOutput) RestoreType() DBClusterRestoreTypePtrOutput {
	return o.ApplyT(func(v *DBCluster) DBClusterRestoreTypePtrOutput { return v.RestoreType }).(DBClusterRestoreTypePtrOutput)
}
...
// Specifies the storage type to be associated with the DB cluster.
func (o DBClusterOutput) StorageType() DBClusterStorageTypePtrOutput {
	return o.ApplyT(func(v *DBCluster) DBClusterStorageTypePtrOutput { return v.StorageType }).(DBClusterStorageTypePtrOutput)
}
