...
type DBInstanceLicenseModel string

const (
	DBInstanceLicenseModelBringYourOwnLicense  = DBInstanceLicenseModel("bring-your-own-license")
	DBInstanceLicenseModelGeneralPublicLicense = DBInstanceLicenseModel("general-public-license")
	DBInstanceLicenseModelLicenseIncluded      = DBInstanceLicenseModel("license-included")
	DBInstanceLicenseModelPostgresqlLicense    = DBInstanceLicenseModel("postgresql-license")
)

func (DBInstanceLicenseModel) ElementType() reflect.Type {
	return reflect.TypeOf((*DBInstanceLicenseModel)(nil)).Elem()
}

func (e DBInstanceLicenseModel) ToDBInstanceLicenseModelOutput() DBInstanceLicenseModelOutput {
	return pulumi.ToOutput(e).(DBInstanceLicenseModelOutput)
}

func (e DBInstanceLicenseModel) ToDBInstanceLicenseModelOutputWithContext(ctx context.Context) DBInstanceLicenseModelOutput {
	return pulumi.ToOutputWithContext(ctx, e).(DBInstanceLicenseModelOutput)
}

func (e DBInstanceLicenseModel) ToDBInstanceLicenseModelPtrOutput() DBInstanceLicenseModelPtrOutput {
	return e.ToDBInstanceLicenseModelPtrOutputWithContext(context.Background())
}

func (e DBInstanceLicenseModel) ToDBInstanceLicenseModelPtrOutputWithContext(ctx context.Context) DBInstanceLicenseModelPtrOutput {
	return DBInstanceLicenseModel(e).ToDBInstanceLicenseModelOutputWithContext(ctx).ToDBInstanceLicenseModelPtrOutputWithContext(ctx)
}

func (e DBInstanceLicenseModel) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e DBInstanceLicenseModel) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e DBInstanceLicenseModel) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e DBInstanceLicenseModel) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type DBInstanceLicenseModelOutput struct{ *pulumi.OutputState }

func (DBInstanceLicenseModelOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DBInstanceLicenseModel)(nil)).Elem()
}

func (o DBInstanceLicenseModelOutput) ToDBInstanceLicenseModelOutput() DBInstanceLicenseModelOutput {
	return o
}

func (o DBInstanceLicenseModelOutput) ToDBInstanceLicenseModelOutputWithContext(ctx context.Context) DBInstanceLicenseModelOutput {
	return o
}

func (o DBInstanceLicenseModelOutput) ToDBInstanceLicenseModelPtrOutput() DBInstanceLicenseModelPtrOutput {
	return o.ToDBInstanceLicenseModelPtrOutputWithContext(context.Background())
}

func (o DBInstanceLicenseModelOutput) ToDBInstanceLicenseModelPtrOutputWithContext(ctx context.Context) DBInstanceLicenseModelPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DBInstanceLicenseModel) *DBInstanceLicenseModel {
		return &v
	}).(DBInstanceLicenseModelPtrOutput)
}

func (o DBInstanceLicenseModelOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o DBInstanceLicenseModelOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DBInstanceLicenseModel) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o DBInstanceLicenseModelOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DBInstanceLicenseModelOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e DBInstanceLicenseModel) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type DBInstanceLicenseModelPtrOutput struct{ *pulumi.OutputState }

func (DBInstanceLicenseModelPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DBInstanceLicenseModel)(nil)).Elem()
}

func (o DBInstanceLicenseModelPtrOutput) ToDBInstanceLicenseModelPtrOutput() DBInstanceLicenseModelPtrOutput {
	return o
}

func (o DBInstanceLicenseModelPtrOutput) ToDBInstanceLicenseModelPtrOutputWithContext(ctx context.Context) DBInstanceLicenseModelPtrOutput {
	return o
}

func (o DBInstanceLicenseModelPtrOutput) Elem() DBInstanceLicenseModelOutput {
	return o.ApplyT(func(v *DBInstanceLicenseModel) DBInstanceLicenseModel {
		if v != nil {
			return *v
		}
		var ret DBInstanceLicenseModel
		return ret
	}).(DBInstanceLicenseModelOutput)
}

func (o DBInstanceLicenseModelPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o DBInstanceLicenseModelPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *DBInstanceLicenseModel) *string {
		if e == nil {
			return nil
		}
...
// DBInstanceLicenseModelInput is an input type that accepts DBInstanceLicenseModelArgs and DBInstanceLicenseModelOutput values.
// You can construct a concrete instance of `DBInstanceLicenseModelInput` via:
//
//          DBInstanceLicenseModelArgs{...}
type DBInstanceLicenseModelInput interface {
	pulumi.Input

	ToDBInstanceLicenseModelOutput() DBInstanceLicenseModelOutput
	ToDBInstanceLicenseModelOutputWithContext(context.Context) DBInstanceLicenseModelOutput
}

var dbinstanceLicenseModelPtrType = reflect.TypeOf((**DBInstanceLicenseModel)(nil)).Elem()

type DBInstanceLicenseModelPtrInput interface {
	pulumi.Input

	ToDBInstanceLicenseModelPtrOutput() DBInstanceLicenseModelPtrOutput
	ToDBInstanceLicenseModelPtrOutputWithContext(context.Context) DBInstanceLicenseModelPtrOutput
}

type dbinstanceLicenseModelPtr string

func DBInstanceLicenseModelPtr(v string) DBInstanceLicenseModelPtrInput {
	return (*dbinstanceLicenseModelPtr)(&v)
}

func (*dbinstanceLicenseModelPtr) ElementType() reflect.Type {
	return dbinstanceLicenseModelPtrType
}

func (in *dbinstanceLicenseModelPtr) ToDBInstanceLicenseModelPtrOutput() DBInstanceLicenseModelPtrOutput {
	return pulumi.ToOutput(in).(DBInstanceLicenseModelPtrOutput)
}

func (in *dbinstanceLicenseModelPtr) ToDBInstanceLicenseModelPtrOutputWithContext(ctx context.Context) DBInstanceLicenseModelPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(DBInstanceLicenseModelPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DBInstanceLicenseModelInput)(nil)).Elem(), DBInstanceLicenseModel("bring-your-own-license"))
	pulumi.RegisterInputType(reflect.TypeOf((*DBInstanceLicenseModelPtrInput)(nil)).Elem(), DBInstanceLicenseModel("bring-your-own-license"))
	...
	pulumi.RegisterOutputType(DBInstanceLicenseModelOutput{})
	pulumi.RegisterOutputType(DBInstanceLicenseModelPtrOutput{})
