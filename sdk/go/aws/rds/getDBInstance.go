...
// License model information for this DB instance.
func (o LookupDBInstanceResultOutput) LicenseModel() DBInstanceLicenseModelPtrOutput {
	return o.ApplyT(func(v LookupDBInstanceResult) *DBInstanceLicenseModel { return v.LicenseModel }).(DBInstanceLicenseModelPtrOutput)
}
