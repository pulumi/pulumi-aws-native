...
//
// This setting is required for RDS Custom.
func (o LookupDBInstanceResultOutput) CustomIAMInstanceProfile() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDBInstanceResult) *string { return v.CustomIAMInstanceProfile }).(pulumi.StringPtrOutput)
}
