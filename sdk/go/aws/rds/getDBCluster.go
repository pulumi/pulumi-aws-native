...
// The name of the database engine to be used for this DB cluster. Valid Values: aurora (for MySQL 5.6-compatible Aurora), aurora-mysql (for MySQL 5.7-compatible Aurora), and aurora-postgresql
func (o LookupDBClusterResultOutput) Engine() DBClusterEnginePtrOutput {
	return o.ApplyT(func(v LookupDBClusterResult) *DBClusterEngine { return v.Engine }).(DBClusterEnginePtrOutput)
}
...
// Specifies the storage type to be associated with the DB cluster.
func (o LookupDBClusterResultOutput) StorageType() DBClusterStorageTypePtrOutput {
	return o.ApplyT(func(v LookupDBClusterResult) *DBClusterStorageType { return v.StorageType }).(DBClusterStorageTypePtrOutput)
}
