...
type LookupDbParameterGroupResult struct {
	DbParameterGroupArn *string `pulumi:"dbParameterGroupArn"`
...
func (o LookupDbParameterGroupResultOutput) DbParameterGroupArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDbParameterGroupResult) *string { return v.DbParameterGroupArn }).(pulumi.StringPtrOutput)
}
