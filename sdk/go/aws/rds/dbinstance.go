...
type DBInstance struct {
	...
	LicenseModel DBInstanceLicenseModelPtrOutput `pulumi:"licenseModel"`
...
type dbinstanceArgs struct {
	...
	// License model information for this DB instance.
	LicenseModel *DBInstanceLicenseModel `pulumi:"licenseModel"`
	// The password for the master user.
...
type DBInstanceArgs struct {
	...
	// License model information for this DB instance.
	LicenseModel DBInstanceLicenseModelPtrInput
	// The password for the master user.
...
// License model information for this DB instance.
func (o DBInstanceOutput) LicenseModel() DBInstanceLicenseModelPtrOutput {
	return o.ApplyT(func(v *DBInstance) DBInstanceLicenseModelPtrOutput { return v.LicenseModel }).(DBInstanceLicenseModelPtrOutput)
}
