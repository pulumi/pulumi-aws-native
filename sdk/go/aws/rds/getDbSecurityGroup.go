...
func (o LookupDbSecurityGroupResultOutput) Tags() aws.TagArrayOutput {
	return o.ApplyT(func(v LookupDbSecurityGroupResult) []aws.Tag { return v.Tags }).(aws.TagArrayOutput)
}
