...
func NewApplicationOutputResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws-native:kinesisanalytics:ApplicationOutput", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApplicationOutputResource(ctx *pulumi.Context,
	...
	var resource ApplicationOutputResource
	err := ctx.ReadResource("aws-native:kinesisanalytics:ApplicationOutput", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
