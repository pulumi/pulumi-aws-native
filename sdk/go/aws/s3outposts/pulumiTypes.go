...
func (i BucketFilterAndOperatorArgs) ToOutput(ctx context.Context) pulumix.Output[BucketFilterAndOperator] {
	return pulumix.Output[BucketFilterAndOperator]{
		OutputState: i.ToBucketFilterAndOperatorOutputWithContext(ctx).OutputState,
	}
}
...
func (i *bucketFilterAndOperatorPtrType) ToOutput(ctx context.Context) pulumix.Output[*BucketFilterAndOperator] {
	return pulumix.Output[*BucketFilterAndOperator]{
		OutputState: i.ToBucketFilterAndOperatorPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (o BucketFilterAndOperatorOutput) ToOutput(ctx context.Context) pulumix.Output[BucketFilterAndOperator] {
	return pulumix.Output[BucketFilterAndOperator]{
		OutputState: o.OutputState,
	}
}
...
func (o BucketFilterAndOperatorPtrOutput) ToOutput(ctx context.Context) pulumix.Output[*BucketFilterAndOperator] {
	return pulumix.Output[*BucketFilterAndOperator]{
		OutputState: o.OutputState,
	}
}
