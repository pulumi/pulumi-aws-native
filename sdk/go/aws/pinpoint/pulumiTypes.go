...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ApplicationSettingsLimitsInput)(nil)).Elem(), ApplicationSettingsLimitsArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignEmailMessagePtrInput)(nil)).Elem(), CampaignEmailMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignEventDimensionsInput)(nil)).Elem(), CampaignEventDimensionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignEventDimensionsPtrInput)(nil)).Elem(), CampaignEventDimensionsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignEventFilterInput)(nil)).Elem(), CampaignEventFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignEventFilterPtrInput)(nil)).Elem(), CampaignEventFilterArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignHookInput)(nil)).Elem(), CampaignHookArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignHookPtrInput)(nil)).Elem(), CampaignHookArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageInput)(nil)).Elem(), CampaignInAppMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessagePtrInput)(nil)).Elem(), CampaignInAppMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageBodyConfigInput)(nil)).Elem(), CampaignInAppMessageBodyConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageBodyConfigPtrInput)(nil)).Elem(), CampaignInAppMessageBodyConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageButtonInput)(nil)).Elem(), CampaignInAppMessageButtonArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageButtonPtrInput)(nil)).Elem(), CampaignInAppMessageButtonArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageContentInput)(nil)).Elem(), CampaignInAppMessageContentArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageContentArrayInput)(nil)).Elem(), CampaignInAppMessageContentArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageHeaderConfigInput)(nil)).Elem(), CampaignInAppMessageHeaderConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignInAppMessageHeaderConfigPtrInput)(nil)).Elem(), CampaignInAppMessageHeaderConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignLimitsInput)(nil)).Elem(), CampaignLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignLimitsPtrInput)(nil)).Elem(), CampaignLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignMessageInput)(nil)).Elem(), CampaignMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignMessagePtrInput)(nil)).Elem(), CampaignMessageArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignMessageConfigurationInput)(nil)).Elem(), CampaignMessageConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignMessageConfigurationPtrInput)(nil)).Elem(), CampaignMessageConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignOverrideButtonConfigurationInput)(nil)).Elem(), CampaignOverrideButtonConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignOverrideButtonConfigurationPtrInput)(nil)).Elem(), CampaignOverrideButtonConfigurationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignQuietTimeInput)(nil)).Elem(), CampaignQuietTimeArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignQuietTimePtrInput)(nil)).Elem(), CampaignQuietTimeArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*CampaignSetDimensionInput)(nil)).Elem(), CampaignSetDimensionArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentBehaviorPtrInput)(nil)).Elem(), SegmentBehaviorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentCoordinatesInput)(nil)).Elem(), SegmentCoordinatesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentCoordinatesPtrInput)(nil)).Elem(), SegmentCoordinatesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SegmentDemographicInput)(nil)).Elem(), SegmentDemographicArgs{})
