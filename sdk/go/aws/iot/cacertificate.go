...
type CACertificate struct {
	...
	RegistrationConfig     RegistrationConfigPropertiesPtrOutput        `pulumi:"registrationConfig"`
...
type cacertificateArgs struct {
	...
	RegistrationConfig     *RegistrationConfigProperties        `pulumi:"registrationConfig"`
...
type CACertificateArgs struct {
	...
	RegistrationConfig     RegistrationConfigPropertiesPtrInput
...
func (o CACertificateOutput) CACertificatePem() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CACertificate) pulumi.StringPtrOutput { return v.CACertificatePem }).(pulumi.StringPtrOutput)
}

func (o CACertificateOutput) RegistrationConfig() RegistrationConfigPropertiesPtrOutput {
	return o.ApplyT(func(v *CACertificate) RegistrationConfigPropertiesPtrOutput { return v.RegistrationConfig }).(RegistrationConfigPropertiesPtrOutput)
}
