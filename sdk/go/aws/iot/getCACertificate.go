...
func (o LookupCACertificateResultOutput) RegistrationConfig() RegistrationConfigPropertiesPtrOutput {
	return o.ApplyT(func(v LookupCACertificateResult) *RegistrationConfigProperties { return v.RegistrationConfig }).(RegistrationConfigPropertiesPtrOutput)
}
