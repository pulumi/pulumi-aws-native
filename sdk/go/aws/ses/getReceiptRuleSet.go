...
func (o LookupReceiptRuleSetResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupReceiptRuleSetResult] {
	return pulumix.Output[LookupReceiptRuleSetResult]{
