...
func (in *trustAnchorNotificationChannelPtr) ToOutput(ctx context.Context) pulumix.Output[*TrustAnchorNotificationChannel] {
	return pulumix.Output[*TrustAnchorNotificationChannel]{
		OutputState: in.ToTrustAnchorNotificationChannelPtrOutputWithContext(ctx).OutputState,
	}
}
...
func (in *trustAnchorNotificationEventPtr) ToOutput(ctx context.Context) pulumix.Output[*TrustAnchorNotificationEvent] {
	return pulumix.Output[*TrustAnchorNotificationEvent]{
		OutputState: in.ToTrustAnchorNotificationEventPtrOutputWithContext(ctx).OutputState,
	}
}
