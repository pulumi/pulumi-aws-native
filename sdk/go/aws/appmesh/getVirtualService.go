...
func (o LookupVirtualServiceResultOutput) Tags() aws.TagArrayOutput {
	return o.ApplyT(func(v LookupVirtualServiceResult) []aws.Tag { return v.Tags }).(aws.TagArrayOutput)
}
