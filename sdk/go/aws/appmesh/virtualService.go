...
//
// Deprecated: VirtualService is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.
...
func (o VirtualServiceOutput) Tags() aws.TagArrayOutput {
	return o.ApplyT(func(v *VirtualService) aws.TagArrayOutput { return v.Tags }).(aws.TagArrayOutput)
}
