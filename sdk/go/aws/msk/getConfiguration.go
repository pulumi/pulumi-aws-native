...
type LookupConfigurationResult struct {
	...
	LatestRevision *ConfigurationRevision `pulumi:"latestRevision"`
...
func (o LookupConfigurationResultOutput) LatestRevision() ConfigurationRevisionPtrOutput {
	return o.ApplyT(func(v LookupConfigurationResult) *ConfigurationRevision { return v.LatestRevision }).(ConfigurationRevisionPtrOutput)
}

func (o LookupConfigurationResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupConfigurationResult) *string { return v.State }).(pulumi.StringPtrOutput)
}
