...
type ConfigurationRevisionOutput struct{ *pulumi.OutputState }

func (ConfigurationRevisionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ConfigurationRevision)(nil)).Elem()
}

func (o ConfigurationRevisionOutput) ToConfigurationRevisionOutput() ConfigurationRevisionOutput {
	return o
}

func (o ConfigurationRevisionOutput) ToConfigurationRevisionOutputWithContext(ctx context.Context) ConfigurationRevisionOutput {
	return o
}

func (o ConfigurationRevisionOutput) CreationTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConfigurationRevision) *string { return v.CreationTime }).(pulumi.StringPtrOutput)
}

func (o ConfigurationRevisionOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConfigurationRevision) *string { return v.Description }).(pulumi.StringPtrOutput)
}

func (o ConfigurationRevisionOutput) Revision() pulumi.IntPtrOutput {
	return o.ApplyT(func(v ConfigurationRevision) *int { return v.Revision }).(pulumi.IntPtrOutput)
}

type ConfigurationRevisionPtrOutput struct{ *pulumi.OutputState }

func (ConfigurationRevisionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ConfigurationRevision)(nil)).Elem()
}

func (o ConfigurationRevisionPtrOutput) ToConfigurationRevisionPtrOutput() ConfigurationRevisionPtrOutput {
	return o
}

func (o ConfigurationRevisionPtrOutput) ToConfigurationRevisionPtrOutputWithContext(ctx context.Context) ConfigurationRevisionPtrOutput {
	return o
}

func (o ConfigurationRevisionPtrOutput) Elem() ConfigurationRevisionOutput {
	return o.ApplyT(func(v *ConfigurationRevision) ConfigurationRevision {
		if v != nil {
			return *v
		}
		var ret ConfigurationRevision
		return ret
	}).(ConfigurationRevisionOutput)
}

func (o ConfigurationRevisionPtrOutput) CreationTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConfigurationRevision) *string {
		if v == nil {
			return nil
		}
...
func (o ConfigurationRevisionPtrOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConfigurationRevision) *string {
		if v == nil {
			return nil
		}
...
func (o ConfigurationRevisionPtrOutput) Revision() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ConfigurationRevision) *int {
		if v == nil {
			return nil
		}
		return v.Revision
...
func init() {
	...
	pulumi.RegisterOutputType(ConfigurationRevisionOutput{})
	pulumi.RegisterOutputType(ConfigurationRevisionPtrOutput{})
}
