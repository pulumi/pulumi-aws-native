...
namespace Pulumi.Cloudformation.ImageBuilder
{
    ...
    public partial class InfrastructureConfiguration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.InfrastructureConfigurationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.InfrastructureConfigurationProperties> Properties { get; private set; } = null!;
        ...
        public InfrastructureConfiguration(string name, InfrastructureConfigurationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ImageBuilder:InfrastructureConfiguration", name, args ?? new InfrastructureConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal InfrastructureConfiguration(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ImageBuilder:InfrastructureConfiguration", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private InfrastructureConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ImageBuilder:InfrastructureConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InfrastructureConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.InfrastructureConfigurationPropertiesArgs> Properties { get; set; } = null!;
