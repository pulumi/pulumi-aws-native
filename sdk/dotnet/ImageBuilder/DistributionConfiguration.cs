...
namespace Pulumi.AwsNative.ImageBuilder
{
    ...
    public partial class DistributionConfiguration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DistributionConfigurationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DistributionConfigurationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DistributionConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DistributionConfigurationPropertiesArgs> Properties { get; set; } = null!;
