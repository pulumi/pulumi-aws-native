...
namespace Pulumi.Cloudformation.Kendra
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Kendra:DataSource")]
    public partial class DataSource : Pulumi.CustomResource
    {
        ...
        public DataSource(string name, DataSourceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Kendra:DataSource", name, args ?? new DataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DataSource(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Kendra:DataSource", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Kendra:DataSource", name, null, MakeResourceOptions(options, id))
        {
        }
