...
namespace Pulumi.AwsNative.Route53RecoveryControl
{
    ...
    public partial class ControlPanel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.ControlPanelTag>> Tags { get; private set; } = null!;
    ...
    public sealed class ControlPanelArgs : Pulumi.ResourceArgs
    {
        ...
        /// A collection of tags associated with a resource
        /// </summary>
        public InputList<Inputs.ControlPanelTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ControlPanelTagArgs>());
            set => _tags = value;
        }
