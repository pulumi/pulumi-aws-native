...
namespace Pulumi.AwsNative.Ecr
{
    ...
    public partial class PullTimeUpdateExclusion : global::Pulumi.CustomResource
    {
        ...
        public PullTimeUpdateExclusion(string name, PullTimeUpdateExclusionArgs args, CustomResourceOptions? options = null)
            : base("aws-native:ecr:PullTimeUpdateExclusion", name, args ?? new PullTimeUpdateExclusionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PullTimeUpdateExclusion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:ecr:PullTimeUpdateExclusion", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PullTimeUpdateExclusion Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new PullTimeUpdateExclusion(name, id, options);
        }
    }
