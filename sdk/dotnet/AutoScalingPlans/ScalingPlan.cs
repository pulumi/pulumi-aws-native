...
namespace Pulumi.AwsNative.AutoScalingPlans
{
    ...
    /// </summary>
    [Obsolete(@"ScalingPlan is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class ScalingPlan : global::Pulumi.CustomResource
    {
        ...
        public Output<string> ScalingPlanName { get; private set; } = null!;

        [Output("scalingPlanVersion")]
        public Output<string> ScalingPlanVersion { get; private set; } = null!;
