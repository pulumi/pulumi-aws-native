...
namespace Pulumi.Cloudformation.ServiceDiscovery
{
    ...
    public partial class PrivateDnsNamespace : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PrivateDnsNamespaceAttributes> Attributes { get; private set; } = null!;
    ...
    public sealed class PrivateDnsNamespaceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PrivateDnsNamespacePropertiesArgs> Properties { get; set; } = null!;
