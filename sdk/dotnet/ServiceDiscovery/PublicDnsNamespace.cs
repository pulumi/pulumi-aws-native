...
namespace Pulumi.Cloudformation.ServiceDiscovery
{
    ...
    public partial class PublicDnsNamespace : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PublicDnsNamespaceAttributes> Attributes { get; private set; } = null!;
    ...
    public sealed class PublicDnsNamespaceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PublicDnsNamespacePropertiesArgs> Properties { get; set; } = null!;
