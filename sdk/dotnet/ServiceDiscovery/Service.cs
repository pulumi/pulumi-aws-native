...
namespace Pulumi.Cloudformation.ServiceDiscovery
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceDiscovery:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Service(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceDiscovery:Service", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceDiscovery:Service", name, null, MakeResourceOptions(options, id))
        {
        }
