...
namespace Pulumi.Cloudformation.ServiceDiscovery
{
    ...
    public partial class HttpNamespace : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.HttpNamespaceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.HttpNamespaceProperties> Properties { get; private set; } = null!;
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HttpNamespace Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new HttpNamespace(name, id, options);
        }
    }
    ...
    public sealed class HttpNamespaceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.HttpNamespacePropertiesArgs> Properties { get; set; } = null!;
