...
namespace Pulumi.Cloudformation.ECS
{
    ...
    public partial class Cluster : Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Cluster(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Cluster", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Cluster", name, null, MakeResourceOptions(options, id))
        {
        }
