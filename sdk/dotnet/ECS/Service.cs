...
namespace Pulumi.Cloudformation.ECS
{
    ...
    public partial class Service : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ServiceProperties> Properties { get; private set; } = null!;
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Service(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Service", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ECS:Service", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ServicePropertiesArgs> Properties { get; set; } = null!;
