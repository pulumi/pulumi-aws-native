...
namespace Pulumi.AwsNative.RtbFabric
{
    ...
    public sealed class LinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("moduleConfigurationList")]
        private InputList<Inputs.LinkModuleConfigurationArgs>? _moduleConfigurationList;
        public InputList<Inputs.LinkModuleConfigurationArgs> ModuleConfigurationList
        {
            get => _moduleConfigurationList ?? (_moduleConfigurationList = new InputList<Inputs.LinkModuleConfigurationArgs>());
