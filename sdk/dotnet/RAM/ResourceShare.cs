...
namespace Pulumi.Cloudformation.RAM
{
    ...
    public partial class ResourceShare : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResourceShareAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResourceShareProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ResourceShareArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResourceSharePropertiesArgs> Properties { get; set; } = null!;
