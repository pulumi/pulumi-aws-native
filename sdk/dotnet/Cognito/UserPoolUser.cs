...
namespace Pulumi.Cloudformation.Cognito
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Cognito:UserPoolUser")]
    public partial class UserPoolUser : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.UserPoolUserAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UserPoolUserProperties> Properties { get; private set; } = null!;
        ...
        public UserPoolUser(string name, UserPoolUserArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Cognito:UserPoolUser", name, args ?? new UserPoolUserArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal UserPoolUser(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Cognito:UserPoolUser", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private UserPoolUser(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Cognito:UserPoolUser", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UserPoolUserArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.UserPoolUserPropertiesArgs> Properties { get; set; } = null!;
