...
namespace Pulumi.AwsNative.Cognito
{
    ...
    /// </summary>
    [Obsolete(@"UserPoolRiskConfigurationAttachment is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
