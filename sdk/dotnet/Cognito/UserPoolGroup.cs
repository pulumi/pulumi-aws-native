...
namespace Pulumi.Cloudformation.Cognito
{
    ...
    public partial class UserPoolGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.UserPoolGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UserPoolGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class UserPoolGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.UserPoolGroupPropertiesArgs> Properties { get; set; } = null!;
