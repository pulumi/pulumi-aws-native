...
namespace Pulumi.Cloudformation.Cognito
{
    ...
    public partial class IdentityPool : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.IdentityPoolAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IdentityPoolProperties> Properties { get; private set; } = null!;
    ...
    public sealed class IdentityPoolArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.IdentityPoolPropertiesArgs> Properties { get; set; } = null!;
