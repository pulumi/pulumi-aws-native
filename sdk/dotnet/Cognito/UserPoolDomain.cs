...
namespace Pulumi.AwsNative.Cognito
{
    ...
    public partial class UserPoolDomain : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.UserPoolDomainAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UserPoolDomainProperties> Properties { get; private set; } = null!;
    ...
    public sealed class UserPoolDomainArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.UserPoolDomainPropertiesArgs> Properties { get; set; } = null!;
