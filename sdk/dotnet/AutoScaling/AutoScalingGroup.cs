...
namespace Pulumi.AwsNative.AutoScaling
{
    ...
    public partial class AutoScalingGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.AutoScalingGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AutoScalingGroupProperties> Properties { get; private set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Output("updatePolicy")]
        public Output<Outputs.AutoScalingGroupUpdatePolicy?> UpdatePolicy { get; private set; } = null!;
    ...
    public sealed class AutoScalingGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AutoScalingGroupPropertiesArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Input("updatePolicy")]
        public Input<Inputs.AutoScalingGroupUpdatePolicyArgs>? UpdatePolicy { get; set; }
