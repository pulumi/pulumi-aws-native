...
namespace Pulumi.Cloudformation.AutoScaling.Inputs
{
    ...
    public sealed class AutoScalingGroupScheduledActionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("IgnoreUnmodifiedGroupSizeProperties")]
        public Input<bool>? IgnoreUnmodifiedGroupSizeProperties { get; set; }

        public AutoScalingGroupScheduledActionArgs()
        {
