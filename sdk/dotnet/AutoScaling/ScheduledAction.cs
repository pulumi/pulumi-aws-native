...
namespace Pulumi.Cloudformation.AutoScaling
{
    ...
    public partial class ScheduledAction : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ScheduledActionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ScheduledActionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ScheduledActionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ScheduledActionPropertiesArgs> Properties { get; set; } = null!;
