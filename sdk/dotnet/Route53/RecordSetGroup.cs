...
namespace Pulumi.Cloudformation.Route53
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Route53:RecordSetGroup")]
    public partial class RecordSetGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RecordSetGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RecordSetGroupProperties> Properties { get; private set; } = null!;
        ...
        public RecordSetGroup(string name, RecordSetGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Route53:RecordSetGroup", name, args ?? new RecordSetGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal RecordSetGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Route53:RecordSetGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RecordSetGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Route53:RecordSetGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RecordSetGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RecordSetGroupPropertiesArgs> Properties { get; set; } = null!;
