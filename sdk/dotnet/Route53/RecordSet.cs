...
namespace Pulumi.Cloudformation.Route53
{
    ...
    public partial class RecordSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RecordSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RecordSetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RecordSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RecordSetPropertiesArgs> Properties { get; set; } = null!;
