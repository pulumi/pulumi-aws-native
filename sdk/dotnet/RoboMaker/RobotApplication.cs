...
namespace Pulumi.Cloudformation.RoboMaker
{
    ...
    public partial class RobotApplication : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RobotApplicationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RobotApplicationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RobotApplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RobotApplicationPropertiesArgs> Properties { get; set; } = null!;
