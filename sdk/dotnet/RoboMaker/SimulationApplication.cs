...
namespace Pulumi.Cloudformation.RoboMaker
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:RoboMaker:SimulationApplication")]
    public partial class SimulationApplication : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SimulationApplicationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SimulationApplicationProperties> Properties { get; private set; } = null!;
        ...
        public SimulationApplication(string name, SimulationApplicationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:RoboMaker:SimulationApplication", name, args ?? new SimulationApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SimulationApplication(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:RoboMaker:SimulationApplication", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SimulationApplication(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:RoboMaker:SimulationApplication", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SimulationApplicationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SimulationApplicationPropertiesArgs> Properties { get; set; } = null!;
