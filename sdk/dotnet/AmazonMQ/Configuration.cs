...
namespace Pulumi.AwsNative.AmazonMQ
{
    ...
    public partial class Configuration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationPropertiesArgs> Properties { get; set; } = null!;
