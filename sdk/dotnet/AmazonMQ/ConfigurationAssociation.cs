...
namespace Pulumi.Cloudformation.AmazonMQ
{
    ...
    public partial class ConfigurationAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationAssociationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConfigurationAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationAssociationPropertiesArgs> Properties { get; set; } = null!;
