...
namespace Pulumi.Cloudformation.AmazonMQ
{
    ...
    public partial class Broker : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.BrokerAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BrokerProperties> Properties { get; private set; } = null!;
    ...
    public sealed class BrokerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BrokerPropertiesArgs> Properties { get; set; } = null!;
