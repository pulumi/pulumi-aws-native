...
namespace Pulumi.AwsNative.IAM
{
    ...
    public partial class ManagedPolicy : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ManagedPolicyAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ManagedPolicyProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ManagedPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ManagedPolicyPropertiesArgs> Properties { get; set; } = null!;
