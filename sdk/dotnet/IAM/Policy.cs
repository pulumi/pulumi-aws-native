...
namespace Pulumi.Cloudformation.IAM
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:IAM:Policy")]
    public partial class Policy : Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:IAM:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Policy(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:IAM:Policy", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:IAM:Policy", name, null, MakeResourceOptions(options, id))
        {
        }
