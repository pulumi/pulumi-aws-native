...
namespace Pulumi.AwsNative.IAM
{
    ...
    public partial class ServiceLinkedRole : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ServiceLinkedRoleAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ServiceLinkedRoleProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ServiceLinkedRoleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ServiceLinkedRolePropertiesArgs> Properties { get; set; } = null!;
