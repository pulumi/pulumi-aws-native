...
namespace Pulumi.Cloudformation.IAM
{
    ...
    public partial class UserToGroupAddition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.UserToGroupAdditionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UserToGroupAdditionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class UserToGroupAdditionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.UserToGroupAdditionPropertiesArgs> Properties { get; set; } = null!;
