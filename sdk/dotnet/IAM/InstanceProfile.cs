...
namespace Pulumi.Cloudformation.IAM
{
    ...
    public partial class InstanceProfile : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.InstanceProfileAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.InstanceProfileProperties> Properties { get; private set; } = null!;
    ...
    public sealed class InstanceProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.InstanceProfilePropertiesArgs> Properties { get; set; } = null!;
