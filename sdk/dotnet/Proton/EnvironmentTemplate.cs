...
namespace Pulumi.AwsNative.Proton
{
    ...
    public partial class EnvironmentTemplate : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.EnvironmentTemplateTag>> Tags { get; private set; } = null!;
    ...
    public sealed class EnvironmentTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.EnvironmentTemplateTagArgs>? _tags;
        ...
        ///         &lt;i&gt;Proton User Guide&lt;/i&gt;.&lt;/p&gt;
        /// </summary>
        public InputList<Inputs.EnvironmentTemplateTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.EnvironmentTemplateTagArgs>());
            set => _tags = value;
        }
