...
namespace Pulumi.Cloudformation.DataBrew
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:DataBrew:Job")]
    public partial class Job : Pulumi.CustomResource
    {
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:DataBrew:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Job(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:DataBrew:Job", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:DataBrew:Job", name, null, MakeResourceOptions(options, id))
        {
        }
