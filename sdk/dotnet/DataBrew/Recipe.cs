...
namespace Pulumi.AwsNative.DataBrew
{
    ...
    public partial class Recipe : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RecipeAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RecipeProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RecipeArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RecipePropertiesArgs> Properties { get; set; } = null!;
