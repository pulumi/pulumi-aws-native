...
namespace Pulumi.Cloudformation.WAFRegional
{
    ...
    public partial class GeoMatchSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GeoMatchSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GeoMatchSetProperties> Properties { get; private set; } = null!;
        ...
        public GeoMatchSet(string name, GeoMatchSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:GeoMatchSet", name, args ?? new GeoMatchSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal GeoMatchSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:GeoMatchSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private GeoMatchSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:GeoMatchSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GeoMatchSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GeoMatchSetPropertiesArgs> Properties { get; set; } = null!;
