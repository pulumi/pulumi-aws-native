...
namespace Pulumi.Cloudformation.WAFRegional
{
    ...
    public partial class SqlInjectionMatchSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SqlInjectionMatchSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SqlInjectionMatchSetProperties> Properties { get; private set; } = null!;
        ...
        public SqlInjectionMatchSet(string name, SqlInjectionMatchSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:SqlInjectionMatchSet", name, args ?? new SqlInjectionMatchSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SqlInjectionMatchSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:SqlInjectionMatchSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SqlInjectionMatchSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:WAFRegional:SqlInjectionMatchSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SqlInjectionMatchSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SqlInjectionMatchSetPropertiesArgs> Properties { get; set; } = null!;
