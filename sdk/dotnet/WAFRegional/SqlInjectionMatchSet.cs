...
namespace Pulumi.AwsNative.WAFRegional
{
    ...
    /// </summary>
    [AwsNativeResourceType("aws-native:WAFRegional:SqlInjectionMatchSet")]
    public partial class SqlInjectionMatchSet : Pulumi.CustomResource
    {
        ...
        public SqlInjectionMatchSet(string name, SqlInjectionMatchSetArgs args, CustomResourceOptions? options = null)
            : base("aws-native:WAFRegional:SqlInjectionMatchSet", name, args ?? new SqlInjectionMatchSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SqlInjectionMatchSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:WAFRegional:SqlInjectionMatchSet", name, null, MakeResourceOptions(options, id))
        {
        }
