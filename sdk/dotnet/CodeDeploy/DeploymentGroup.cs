...
namespace Pulumi.AwsNative.CodeDeploy
{
    ...
    public partial class DeploymentGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DeploymentGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DeploymentGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DeploymentGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DeploymentGroupPropertiesArgs> Properties { get; set; } = null!;
