...
namespace Pulumi.AwsNative.CloudTrail
{
    ...
    /// </summary>
    [AwsNativeResourceType("aws-native:cloudtrail:ResourcePolicy")]
    public partial class ResourcePolicy : global::Pulumi.CustomResource
    {
        ...
        public Output<Union<object, string>> ResourcePolicyValue { get; private set; } = null!;
        ...
        public ResourcePolicy(string name, ResourcePolicyArgs args, CustomResourceOptions? options = null)
            : base("aws-native:cloudtrail:ResourcePolicy", name, args ?? new ResourcePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:cloudtrail:ResourcePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResourcePolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public InputUnion<object, string> ResourcePolicyValue { get; set; } = null!;
