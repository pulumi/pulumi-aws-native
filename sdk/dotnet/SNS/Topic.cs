...
namespace Pulumi.Cloudformation.SNS
{
    ...
    public partial class Topic : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TopicAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TopicProperties> Properties { get; private set; } = null!;
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:SNS:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Topic(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:SNS:Topic", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:SNS:Topic", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TopicArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TopicPropertiesArgs> Properties { get; set; } = null!;
