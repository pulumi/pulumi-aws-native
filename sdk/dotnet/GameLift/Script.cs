...
namespace Pulumi.Cloudformation.GameLift
{
    ...
    public partial class Script : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ScriptAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ScriptProperties> Properties { get; private set; } = null!;
        ...
        public Script(string name, ScriptArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:Script", name, args ?? new ScriptArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Script(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:Script", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Script(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:Script", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ScriptArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ScriptPropertiesArgs> Properties { get; set; } = null!;
