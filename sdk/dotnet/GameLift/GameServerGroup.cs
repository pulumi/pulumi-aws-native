...
namespace Pulumi.Cloudformation.GameLift
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:GameLift:GameServerGroup")]
    public partial class GameServerGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GameServerGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GameServerGroupProperties> Properties { get; private set; } = null!;
        ...
        public GameServerGroup(string name, GameServerGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:GameServerGroup", name, args ?? new GameServerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal GameServerGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:GameServerGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private GameServerGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:GameServerGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GameServerGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GameServerGroupPropertiesArgs> Properties { get; set; } = null!;
