...
namespace Pulumi.Cloudformation.GameLift
{
    ...
    public partial class Build : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.BuildAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BuildProperties> Properties { get; private set; } = null!;
    ...
    public sealed class BuildArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BuildPropertiesArgs> Properties { get; set; } = null!;
