...
namespace Pulumi.Cloudformation.GameLift
{
    ...
    public partial class MatchmakingRuleSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MatchmakingRuleSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MatchmakingRuleSetProperties> Properties { get; private set; } = null!;
        ...
        public MatchmakingRuleSet(string name, MatchmakingRuleSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:MatchmakingRuleSet", name, args ?? new MatchmakingRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal MatchmakingRuleSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:MatchmakingRuleSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private MatchmakingRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:GameLift:MatchmakingRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MatchmakingRuleSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MatchmakingRuleSetPropertiesArgs> Properties { get; set; } = null!;
