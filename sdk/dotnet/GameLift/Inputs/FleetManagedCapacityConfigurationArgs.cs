...
namespace Pulumi.AwsNative.GameLift.Inputs
{
    ...
    /// </summary>
    public sealed class FleetManagedCapacityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.AwsNative.GameLift.FleetManagedCapacityConfigurationZeroCapacityStrategy> ZeroCapacityStrategy { get; set; } = null!;

        public FleetManagedCapacityConfigurationArgs()
        {
        }
        public static new FleetManagedCapacityConfigurationArgs Empty => new FleetManagedCapacityConfigurationArgs();
    }
}
