...
namespace Pulumi.Cloudformation.GameLift
{
    ...
    public partial class GameSessionQueue : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GameSessionQueueAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GameSessionQueueProperties> Properties { get; private set; } = null!;
    ...
    public sealed class GameSessionQueueArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GameSessionQueuePropertiesArgs> Properties { get; set; } = null!;
