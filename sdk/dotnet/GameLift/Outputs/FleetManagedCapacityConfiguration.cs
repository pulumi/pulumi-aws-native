...
namespace Pulumi.AwsNative.GameLift.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class FleetManagedCapacityConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.AwsNative.GameLift.FleetManagedCapacityConfigurationZeroCapacityStrategy ZeroCapacityStrategy;

        [OutputConstructor]
        private FleetManagedCapacityConfiguration(
            int? scaleInAfterInactivityMinutes,

            Pulumi.AwsNative.GameLift.FleetManagedCapacityConfigurationZeroCapacityStrategy zeroCapacityStrategy)
        {
