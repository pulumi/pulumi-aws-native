...
namespace Pulumi.Cloudformation.Events
{
    ...
    public partial class EventBus : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EventBusAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EventBusProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EventBusArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EventBusPropertiesArgs> Properties { get; set; } = null!;
