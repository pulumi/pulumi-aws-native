...
namespace Pulumi.Cloudformation.DirectoryService
{
    ...
    public partial class SimpleAD : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SimpleADAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SimpleADProperties> Properties { get; private set; } = null!;
    ...
    public sealed class SimpleADArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SimpleADPropertiesArgs> Properties { get; set; } = null!;
