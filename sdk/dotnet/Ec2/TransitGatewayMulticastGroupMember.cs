...
namespace Pulumi.AwsNative.Ec2
{
    ...
    public partial class TransitGatewayMulticastGroupMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public TransitGatewayMulticastGroupMember(string name, TransitGatewayMulticastGroupMemberArgs args, CustomResourceOptions? options = null)
            : base("aws-native:ec2:TransitGatewayMulticastGroupMember", name, args ?? new TransitGatewayMulticastGroupMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransitGatewayMulticastGroupMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:ec2:TransitGatewayMulticastGroupMember", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TransitGatewayMulticastGroupMember Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TransitGatewayMulticastGroupMember(name, id, options);
        }
    }

    public sealed class TransitGatewayMulticastGroupMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The IP address assigned to the transit gateway multicast group.
        /// </summary>
        ...
        public static new TransitGatewayMulticastGroupMemberArgs Empty => new TransitGatewayMulticastGroupMemberArgs();
    }
}
