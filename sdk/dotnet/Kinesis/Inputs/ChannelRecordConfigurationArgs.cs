...
namespace Pulumi.AwsNative.Kinesis.Inputs
{
    ...
    /// </summary>
    public sealed class ChannelRecordConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("gsrSchemaArn")]
        public Input<string>? GsrSchemaArn { get; set; }

        /// <summary>
        /// The format used to interpret records read from the source stream.
        /// </summary>
        [Input("recordFormatType", required: true)]
        public Input<Pulumi.AwsNative.Kinesis.ChannelRecordConfigurationRecordFormatType> RecordFormatType { get; set; } = null!;

        public ChannelRecordConfigurationArgs()
        {
        }
        public static new ChannelRecordConfigurationArgs Empty => new ChannelRecordConfigurationArgs();
    }
}
