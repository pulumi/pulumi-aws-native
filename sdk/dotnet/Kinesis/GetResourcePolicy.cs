...
namespace Pulumi.AwsNative.Kinesis
{
    public static class GetResourcePolicy
    {
        ...
        public static Task<GetResourcePolicyResult> InvokeAsync(GetResourcePolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourcePolicyResult>("aws-native:kinesis:getResourcePolicy", args ?? new GetResourcePolicyArgs(), options.WithDefaults());
