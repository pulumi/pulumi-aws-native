...
namespace Pulumi.AwsNative.Kinesis
{
    ...
    public partial class StreamConsumer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.StreamConsumerAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.StreamConsumerProperties> Properties { get; private set; } = null!;
    ...
    public sealed class StreamConsumerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.StreamConsumerPropertiesArgs> Properties { get; set; } = null!;
