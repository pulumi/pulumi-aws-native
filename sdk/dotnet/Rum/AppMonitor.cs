...
namespace Pulumi.AwsNative.Rum
{
    ...
    public partial class AppMonitor : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("domainList")]
        public Output<ImmutableArray<object>> DomainList { get; private set; } = null!;
    ...
    public sealed class AppMonitorArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("domainList")]
        private InputList<object>? _domainList;

        /// <summary>
        /// The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        /// </summary>
        public InputList<object> DomainList
        {
            get => _domainList ?? (_domainList = new InputList<object>());
