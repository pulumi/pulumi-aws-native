...
namespace Pulumi.AwsNative.CleanRooms.Outputs
{
    ...
    [OutputType]
    public sealed class AnalysisTemplateErrorMessageConfiguration
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.AwsNative.CleanRooms.AnalysisTemplateErrorMessageConfigurationType Type;

        [OutputConstructor]
        private AnalysisTemplateErrorMessageConfiguration(Pulumi.AwsNative.CleanRooms.AnalysisTemplateErrorMessageConfigurationType type)
        {
            Type = type;
        }
    }
