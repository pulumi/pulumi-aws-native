...
namespace Pulumi.AwsNative.ArcRegionSwitch.Outputs
{
    ...
    [OutputType]
    public sealed class PlanDocumentDbConfiguration
    {
        ...
        public readonly Outputs.PlanDocumentDbUngraceful? Ungraceful;

        [OutputConstructor]
        private PlanDocumentDbConfiguration(
            object behavior,
            ...
            Outputs.PlanDocumentDbUngraceful? ungraceful)
        {
            Behavior = behavior;
