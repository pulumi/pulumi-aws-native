...
namespace Pulumi.Cloudformation.ElasticBeanstalk
{
    ...
    public partial class ConfigurationTemplate : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationTemplateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationTemplateProperties> Properties { get; private set; } = null!;
        ...
        public ConfigurationTemplate(string name, ConfigurationTemplateArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ConfigurationTemplate", name, args ?? new ConfigurationTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ConfigurationTemplate(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ConfigurationTemplate", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ConfigurationTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationTemplatePropertiesArgs> Properties { get; set; } = null!;
