...
namespace Pulumi.Cloudformation.ElasticBeanstalk
{
    ...
    public partial class ApplicationVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ApplicationVersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ApplicationVersionProperties> Properties { get; private set; } = null!;
        ...
        public ApplicationVersion(string name, ApplicationVersionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ApplicationVersion", name, args ?? new ApplicationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ApplicationVersion(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ApplicationVersion", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticBeanstalk:ApplicationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApplicationVersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationVersionPropertiesArgs> Properties { get; set; } = null!;
