...
namespace Pulumi.AwsNative.EKS
{
    ...
    public partial class Nodegroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NodegroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NodegroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class NodegroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NodegroupPropertiesArgs> Properties { get; set; } = null!;
