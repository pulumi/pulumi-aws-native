...
namespace Pulumi.Cloudformation.SageMaker
{
    ...
    public partial class NotebookInstance : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NotebookInstanceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NotebookInstanceProperties> Properties { get; private set; } = null!;
        ...
        public NotebookInstance(string name, NotebookInstanceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:SageMaker:NotebookInstance", name, args ?? new NotebookInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal NotebookInstance(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:SageMaker:NotebookInstance", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NotebookInstance(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:SageMaker:NotebookInstance", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NotebookInstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NotebookInstancePropertiesArgs> Properties { get; set; } = null!;
