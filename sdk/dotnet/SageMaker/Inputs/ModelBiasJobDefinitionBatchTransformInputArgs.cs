...
namespace Pulumi.AwsNative.SageMaker.Inputs
{
    ...
    /// </summary>
    public sealed class ModelBiasJobDefinitionBatchTransformInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.AwsNative.SageMaker.ModelBiasJobDefinitionBatchTransformInputS3DataDistributionType>? S3DataDistributionType { get; set; }

        /// <summary>
        /// Whether the Pipe or File is used as the input mode for transfering data for the monitoring job. Pipe mode is recommended for large datasets. File mode is useful for small files that fit in memory. Defaults to File.
        /// </summary>
        [Input("s3InputMode")]
        public Input<Pulumi.AwsNative.SageMaker.ModelBiasJobDefinitionBatchTransformInputS3InputMode>? S3InputMode { get; set; }
        ...
        public ModelBiasJobDefinitionBatchTransformInputArgs()
        {
        }
        public static new ModelBiasJobDefinitionBatchTransformInputArgs Empty => new ModelBiasJobDefinitionBatchTransformInputArgs();
    }
}
