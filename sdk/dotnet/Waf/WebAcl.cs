...
namespace Pulumi.AwsNative.Waf
{
    ...
    /// </summary>
    [Obsolete(@"WebAcl is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class WebAcl : global::Pulumi.CustomResource
    {
        ...
        [Output("rules")]
        public Output<ImmutableArray<Outputs.WebAclActivatedRule>> Rules { get; private set; } = null!;
