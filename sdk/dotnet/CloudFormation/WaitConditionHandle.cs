...
namespace Pulumi.Cloudformation.CloudFormation
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:CloudFormation:WaitConditionHandle")]
    public partial class WaitConditionHandle : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.WaitConditionHandleAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.WaitConditionHandleProperties> Properties { get; private set; } = null!;
        ...
        public WaitConditionHandle(string name, WaitConditionHandleArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:WaitConditionHandle", name, args ?? new WaitConditionHandleArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal WaitConditionHandle(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:WaitConditionHandle", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private WaitConditionHandle(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:WaitConditionHandle", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WaitConditionHandleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.WaitConditionHandlePropertiesArgs> Properties { get; set; } = null!;
