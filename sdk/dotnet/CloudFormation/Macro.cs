...
namespace Pulumi.Cloudformation.CloudFormation
{
    ...
    public partial class Macro : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MacroAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MacroProperties> Properties { get; private set; } = null!;
        ...
        public Macro(string name, MacroArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:Macro", name, args ?? new MacroArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Macro(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:Macro", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Macro(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:Macro", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MacroArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MacroPropertiesArgs> Properties { get; set; } = null!;
