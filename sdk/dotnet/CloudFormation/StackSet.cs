...
namespace Pulumi.Cloudformation.CloudFormation
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:CloudFormation:StackSet")]
    public partial class StackSet : Pulumi.CustomResource
    {
        ...
        public StackSet(string name, StackSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:StackSet", name, args ?? new StackSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal StackSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:StackSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private StackSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:CloudFormation:StackSet", name, null, MakeResourceOptions(options, id))
        {
        }
