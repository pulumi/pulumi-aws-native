...
namespace Pulumi.Cloudformation.Redshift
{
    ...
    public partial class ClusterParameterGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ClusterParameterGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ClusterParameterGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ClusterParameterGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClusterParameterGroupPropertiesArgs> Properties { get; set; } = null!;
