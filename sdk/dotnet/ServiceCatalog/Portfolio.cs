...
namespace Pulumi.Cloudformation.ServiceCatalog
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ServiceCatalog:Portfolio")]
    public partial class Portfolio : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PortfolioAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PortfolioProperties> Properties { get; private set; } = null!;
        ...
        public Portfolio(string name, PortfolioArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceCatalog:Portfolio", name, args ?? new PortfolioArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Portfolio(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceCatalog:Portfolio", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Portfolio(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ServiceCatalog:Portfolio", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PortfolioArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PortfolioPropertiesArgs> Properties { get; set; } = null!;
