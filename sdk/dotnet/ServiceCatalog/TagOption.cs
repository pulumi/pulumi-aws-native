...
namespace Pulumi.AwsNative.ServiceCatalog
{
    ...
    public partial class TagOption : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TagOptionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TagOptionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class TagOptionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TagOptionPropertiesArgs> Properties { get; set; } = null!;
