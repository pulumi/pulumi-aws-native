...
namespace Pulumi.AwsNative.ServiceCatalog
{
    ...
    public partial class LaunchTemplateConstraint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LaunchTemplateConstraintAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LaunchTemplateConstraintProperties> Properties { get; private set; } = null!;
    ...
    public sealed class LaunchTemplateConstraintArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LaunchTemplateConstraintPropertiesArgs> Properties { get; set; } = null!;
