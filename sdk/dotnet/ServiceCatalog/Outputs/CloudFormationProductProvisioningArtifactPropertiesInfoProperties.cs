...
namespace Pulumi.AwsNative.ServiceCatalog.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class CloudFormationProductProvisioningArtifactPropertiesInfoProperties
    {
        /// <summary>
        /// The physical id of the resource that contains the template. Currently only supports AWS CloudFormation stack arn
        /// </summary>
        public readonly string? ImportFromPhysicalId;
        /// <summary>
        /// The URL of the AWS CloudFormation template in Amazon S3 in JSON format.
        /// </summary>
        public readonly string? LoadTemplateFromUrl;

        [OutputConstructor]
        private CloudFormationProductProvisioningArtifactPropertiesInfoProperties(
            string? importFromPhysicalId,

            string? loadTemplateFromUrl)
        {
            ImportFromPhysicalId = importFromPhysicalId;
