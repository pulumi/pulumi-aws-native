...
namespace Pulumi.AwsNative.Ivs.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class StageAutoParticipantRecordingConfigurationHlsConfigurationPropertiesParticipantRecordingHlsConfigurationProperties
    {
        /// <summary>
        ...
        /// </summary>
        public readonly int? TargetSegmentDurationSeconds;

        [OutputConstructor]
        private StageAutoParticipantRecordingConfigurationHlsConfigurationPropertiesParticipantRecordingHlsConfigurationProperties(int? targetSegmentDurationSeconds)
        {
