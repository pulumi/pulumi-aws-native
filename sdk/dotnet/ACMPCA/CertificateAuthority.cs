...
namespace Pulumi.Cloudformation.ACMPCA
{
    ...
    public partial class CertificateAuthority : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CertificateAuthorityAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CertificateAuthorityProperties> Properties { get; private set; } = null!;
        ...
        public CertificateAuthority(string name, CertificateAuthorityArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ACMPCA:CertificateAuthority", name, args ?? new CertificateAuthorityArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal CertificateAuthority(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ACMPCA:CertificateAuthority", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CertificateAuthority(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ACMPCA:CertificateAuthority", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertificateAuthorityArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CertificateAuthorityPropertiesArgs> Properties { get; set; } = null!;
