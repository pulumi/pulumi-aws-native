...
namespace Pulumi.Cloudformation.GlobalAccelerator
{
    ...
    public partial class Accelerator : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AcceleratorProperties> Properties { get; private set; } = null!;
        ...
        public Accelerator(string name, AcceleratorArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:GlobalAccelerator:Accelerator", name, args ?? new AcceleratorArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Accelerator(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:GlobalAccelerator:Accelerator", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Accelerator(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:GlobalAccelerator:Accelerator", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AcceleratorArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AcceleratorPropertiesArgs> Properties { get; set; } = null!;
