...
namespace Pulumi.Cloudformation.CodeGuruReviewer
{
    ...
    public partial class RepositoryAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RepositoryAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RepositoryAssociationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RepositoryAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RepositoryAssociationPropertiesArgs> Properties { get; set; } = null!;
