...
namespace Pulumi.AwsNative.AccessAnalyzer.Inputs
{
    ...
    /// </summary>
    public sealed class AnalyzerInternalAccessConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("internalAccessAnalysisRule")]
        public Input<Inputs.AnalyzerInternalAccessConfigurationInternalAccessAnalysisRulePropertiesArgs>? InternalAccessAnalysisRule { get; set; }

        public AnalyzerInternalAccessConfigurationArgs()
        {
        }
        public static new AnalyzerInternalAccessConfigurationArgs Empty => new AnalyzerInternalAccessConfigurationArgs();
    }
}
