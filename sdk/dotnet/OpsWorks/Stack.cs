...
namespace Pulumi.Cloudformation.OpsWorks
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:OpsWorks:Stack")]
    public partial class Stack : Pulumi.CustomResource
    {
        ...
        public Stack(string name, StackArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:OpsWorks:Stack", name, args ?? new StackArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Stack(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:OpsWorks:Stack", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Stack(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:OpsWorks:Stack", name, null, MakeResourceOptions(options, id))
        {
        }
