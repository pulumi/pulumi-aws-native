...
namespace Pulumi.AwsNative.OpsWorks
{
    ...
    public partial class Layer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LayerAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LayerProperties> Properties { get; private set; } = null!;
    ...
    public sealed class LayerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LayerPropertiesArgs> Properties { get; set; } = null!;
