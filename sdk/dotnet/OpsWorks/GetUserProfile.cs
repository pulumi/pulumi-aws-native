...
namespace Pulumi.AwsNative.OpsWorks
{
    public static class GetUserProfile
    {
        ...
        public static Task<GetUserProfileResult> InvokeAsync(GetUserProfileArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserProfileResult>("aws-native:opsworks:getUserProfile", args ?? new GetUserProfileArgs(), options.WithDefaults());

        /// <summary>
        /// Resource Type definition for AWS::OpsWorks::UserProfile
        /// </summary>
        public static Output<GetUserProfileResult> Invoke(GetUserProfileInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserProfileResult>("aws-native:opsworks:getUserProfile", args ?? new GetUserProfileInvokeArgs(), options.WithDefaults());
    }
