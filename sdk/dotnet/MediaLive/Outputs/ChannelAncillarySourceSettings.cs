...
namespace Pulumi.AwsNative.MediaLive.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ChannelAncillarySourceSettings
    {
        /// <summary>
        ...
        /// </summary>
        public readonly int? SourceAncillaryChannelNumber;

        [OutputConstructor]
        private ChannelAncillarySourceSettings(int? sourceAncillaryChannelNumber)
        {
