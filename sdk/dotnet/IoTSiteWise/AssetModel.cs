...
namespace Pulumi.Cloudformation.IoTSiteWise
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:IoTSiteWise:AssetModel")]
    public partial class AssetModel : Pulumi.CustomResource
    {
        ...
        public AssetModel(string name, AssetModelArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:IoTSiteWise:AssetModel", name, args ?? new AssetModelArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal AssetModel(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:IoTSiteWise:AssetModel", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private AssetModel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:IoTSiteWise:AssetModel", name, null, MakeResourceOptions(options, id))
        {
        }
