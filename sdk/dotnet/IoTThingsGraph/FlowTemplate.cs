...
namespace Pulumi.Cloudformation.IoTThingsGraph
{
    ...
    public partial class FlowTemplate : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FlowTemplateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FlowTemplateProperties> Properties { get; private set; } = null!;
    ...
    public sealed class FlowTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FlowTemplatePropertiesArgs> Properties { get; set; } = null!;
