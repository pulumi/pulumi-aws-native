...
namespace Pulumi.Cloudformation.Cassandra
{
    ...
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Cassandra:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Table(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Cassandra:Table", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Cassandra:Table", name, null, MakeResourceOptions(options, id))
        {
        }
