...
namespace Pulumi.Cloudformation.EFS
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EFS:FileSystem")]
    public partial class FileSystem : Pulumi.CustomResource
    {
        ...
        public FileSystem(string name, FileSystemArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EFS:FileSystem", name, args ?? new FileSystemArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal FileSystem(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EFS:FileSystem", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private FileSystem(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EFS:FileSystem", name, null, MakeResourceOptions(options, id))
        {
        }
