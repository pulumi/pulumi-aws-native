...
namespace Pulumi.Cloudformation.EFS
{
    ...
    public partial class MountTarget : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MountTargetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MountTargetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class MountTargetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MountTargetPropertiesArgs> Properties { get; set; } = null!;
