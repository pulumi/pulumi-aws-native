...
namespace Pulumi.Cloudformation.Route53Resolver
{
    ...
    public partial class ResolverEndpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResolverEndpointAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResolverEndpointProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ResolverEndpointArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResolverEndpointPropertiesArgs> Properties { get; set; } = null!;
