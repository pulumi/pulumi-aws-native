...
namespace Pulumi.Cloudformation.Route53Resolver
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Route53Resolver:ResolverQueryLoggingConfig")]
    public partial class ResolverQueryLoggingConfig : Pulumi.CustomResource
    {
        ...
        public ResolverQueryLoggingConfig(string name, ResolverQueryLoggingConfigArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfig", name, args ?? new ResolverQueryLoggingConfigArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ResolverQueryLoggingConfig(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfig", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ResolverQueryLoggingConfig(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfig", name, null, MakeResourceOptions(options, id))
        {
        }
