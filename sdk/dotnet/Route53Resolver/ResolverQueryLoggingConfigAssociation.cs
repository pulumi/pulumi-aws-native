...
namespace Pulumi.Cloudformation.Route53Resolver
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation")]
    public partial class ResolverQueryLoggingConfigAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResolverQueryLoggingConfigAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResolverQueryLoggingConfigAssociationProperties> Properties { get; private set; } = null!;
        ...
        public ResolverQueryLoggingConfigAssociation(string name, ResolverQueryLoggingConfigAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation", name, args ?? new ResolverQueryLoggingConfigAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ResolverQueryLoggingConfigAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ResolverQueryLoggingConfigAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Route53Resolver:ResolverQueryLoggingConfigAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResolverQueryLoggingConfigAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResolverQueryLoggingConfigAssociationPropertiesArgs> Properties { get; set; } = null!;
