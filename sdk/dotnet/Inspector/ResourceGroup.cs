...
namespace Pulumi.Cloudformation.Inspector
{
    ...
    public partial class ResourceGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResourceGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResourceGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ResourceGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResourceGroupPropertiesArgs> Properties { get; set; } = null!;
