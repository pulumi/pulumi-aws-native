...
namespace Pulumi.Cloudformation.Inspector
{
    ...
    public partial class AssessmentTemplate : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.AssessmentTemplateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AssessmentTemplateProperties> Properties { get; private set; } = null!;
        ...
        public AssessmentTemplate(string name, AssessmentTemplateArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Inspector:AssessmentTemplate", name, args ?? new AssessmentTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal AssessmentTemplate(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Inspector:AssessmentTemplate", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private AssessmentTemplate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Inspector:AssessmentTemplate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AssessmentTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AssessmentTemplatePropertiesArgs> Properties { get; set; } = null!;
