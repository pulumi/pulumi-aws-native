...
namespace Pulumi.Cloudformation.Transfer
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Transfer:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Transfer:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal User(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Transfer:User", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Transfer:User", name, null, MakeResourceOptions(options, id))
        {
        }
