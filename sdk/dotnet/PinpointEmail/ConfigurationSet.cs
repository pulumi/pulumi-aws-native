...
namespace Pulumi.Cloudformation.PinpointEmail
{
    ...
    public partial class ConfigurationSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationSetProperties> Properties { get; private set; } = null!;
        ...
        public ConfigurationSet(string name, ConfigurationSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSet", name, args ?? new ConfigurationSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ConfigurationSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationSetPropertiesArgs> Properties { get; set; } = null!;
