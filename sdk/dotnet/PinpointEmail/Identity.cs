...
namespace Pulumi.Cloudformation.PinpointEmail
{
    /// <summary>
    ...
    public partial class Identity : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.IdentityAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IdentityProperties> Properties { get; private set; } = null!;
        ...
        public Identity(string name, IdentityArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:Identity", name, args ?? new IdentityArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Identity(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:Identity", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Identity(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:Identity", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IdentityArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.IdentityPropertiesArgs> Properties { get; set; } = null!;
