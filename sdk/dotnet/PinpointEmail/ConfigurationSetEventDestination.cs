...
namespace Pulumi.Cloudformation.PinpointEmail
{
    ...
    public partial class ConfigurationSetEventDestination : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationSetEventDestinationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationSetEventDestinationProperties> Properties { get; private set; } = null!;
        ...
        public ConfigurationSetEventDestination(string name, ConfigurationSetEventDestinationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSetEventDestination", name, args ?? new ConfigurationSetEventDestinationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ConfigurationSetEventDestination(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSetEventDestination", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ConfigurationSetEventDestination(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:PinpointEmail:ConfigurationSetEventDestination", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ConfigurationSetEventDestinationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationSetEventDestinationPropertiesArgs> Properties { get; set; } = null!;
