...
namespace Pulumi.Cloudformation.Budgets
{
    ...
    public partial class Budget : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.BudgetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BudgetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class BudgetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BudgetPropertiesArgs> Properties { get; set; } = null!;
