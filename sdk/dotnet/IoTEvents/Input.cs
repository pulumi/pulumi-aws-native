...
namespace Pulumi.Cloudformation.IoTEvents
{
    /// <summary>
    ...
    public partial class Input : Pulumi.CustomResource
    {
        ...
        public Input(string name, InputArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:IoTEvents:Input", name, args ?? new InputArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Input(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:IoTEvents:Input", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Input(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:IoTEvents:Input", name, null, MakeResourceOptions(options, id))
        {
        }
