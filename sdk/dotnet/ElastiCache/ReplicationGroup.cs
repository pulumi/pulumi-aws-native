...
namespace Pulumi.Cloudformation.ElastiCache
{
    ...
    public partial class ReplicationGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ReplicationGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ReplicationGroupProperties> Properties { get; private set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Output("updatePolicy")]
        public Output<Outputs.ReplicationGroupUpdatePolicy?> UpdatePolicy { get; private set; } = null!;
    ...
    public sealed class ReplicationGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ReplicationGroupPropertiesArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Input("updatePolicy")]
        public Input<Inputs.ReplicationGroupUpdatePolicyArgs>? UpdatePolicy { get; set; }
