...
namespace Pulumi.Cloudformation.ElastiCache
{
    ...
    public partial class SubnetGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SubnetGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SubnetGroupProperties> Properties { get; private set; } = null!;
        ...
        public SubnetGroup(string name, SubnetGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ElastiCache:SubnetGroup", name, args ?? new SubnetGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SubnetGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ElastiCache:SubnetGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SubnetGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ElastiCache:SubnetGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubnetGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubnetGroupPropertiesArgs> Properties { get; set; } = null!;
