...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:TrafficMirrorFilter")]
    public partial class TrafficMirrorFilter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TrafficMirrorFilterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TrafficMirrorFilterProperties> Properties { get; private set; } = null!;
        ...
        public TrafficMirrorFilter(string name, TrafficMirrorFilterArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TrafficMirrorFilter", name, args ?? new TrafficMirrorFilterArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal TrafficMirrorFilter(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TrafficMirrorFilter", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private TrafficMirrorFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TrafficMirrorFilter", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TrafficMirrorFilterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TrafficMirrorFilterPropertiesArgs> Properties { get; set; } = null!;
