...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:NetworkInterfacePermission")]
    public partial class NetworkInterfacePermission : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NetworkInterfacePermissionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkInterfacePermissionProperties> Properties { get; private set; } = null!;
        ...
        public NetworkInterfacePermission(string name, NetworkInterfacePermissionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfacePermission", name, args ?? new NetworkInterfacePermissionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal NetworkInterfacePermission(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfacePermission", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterfacePermission(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfacePermission", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfacePermissionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkInterfacePermissionPropertiesArgs> Properties { get; set; } = null!;
