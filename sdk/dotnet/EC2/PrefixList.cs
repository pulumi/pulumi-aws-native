...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:PrefixList")]
    public partial class PrefixList : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PrefixListAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PrefixListProperties> Properties { get; private set; } = null!;
        ...
        public PrefixList(string name, PrefixListArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PrefixList", name, args ?? new PrefixListArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal PrefixList(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PrefixList", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private PrefixList(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PrefixList", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PrefixListArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PrefixListPropertiesArgs> Properties { get; set; } = null!;
