...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:ClientVpnEndpoint")]
    public partial class ClientVpnEndpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ClientVpnEndpointAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ClientVpnEndpointProperties> Properties { get; private set; } = null!;
        ...
        public ClientVpnEndpoint(string name, ClientVpnEndpointArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnEndpoint", name, args ?? new ClientVpnEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ClientVpnEndpoint(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnEndpoint", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ClientVpnEndpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnEndpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClientVpnEndpointArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClientVpnEndpointPropertiesArgs> Properties { get; set; } = null!;
