...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:GatewayRouteTableAssociation")]
    public partial class GatewayRouteTableAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GatewayRouteTableAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GatewayRouteTableAssociationProperties> Properties { get; private set; } = null!;
        ...
        public GatewayRouteTableAssociation(string name, GatewayRouteTableAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:GatewayRouteTableAssociation", name, args ?? new GatewayRouteTableAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal GatewayRouteTableAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:GatewayRouteTableAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private GatewayRouteTableAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:GatewayRouteTableAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GatewayRouteTableAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GatewayRouteTableAssociationPropertiesArgs> Properties { get; set; } = null!;
