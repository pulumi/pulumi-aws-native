...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:SubnetNetworkAclAssociation")]
    public partial class SubnetNetworkAclAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SubnetNetworkAclAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SubnetNetworkAclAssociationProperties> Properties { get; private set; } = null!;
        ...
        public SubnetNetworkAclAssociation(string name, SubnetNetworkAclAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetNetworkAclAssociation", name, args ?? new SubnetNetworkAclAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SubnetNetworkAclAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetNetworkAclAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SubnetNetworkAclAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetNetworkAclAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubnetNetworkAclAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubnetNetworkAclAssociationPropertiesArgs> Properties { get; set; } = null!;
