...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class VPCEndpointService : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPCEndpointServiceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPCEndpointServiceProperties> Properties { get; private set; } = null!;
        ...
        public VPCEndpointService(string name, VPCEndpointServiceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointService", name, args ?? new VPCEndpointServiceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPCEndpointService(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointService", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPCEndpointService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPCEndpointServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPCEndpointServicePropertiesArgs> Properties { get; set; } = null!;
