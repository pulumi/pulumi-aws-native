...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:CustomerGateway")]
    public partial class CustomerGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CustomerGatewayAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CustomerGatewayProperties> Properties { get; private set; } = null!;
        ...
        public CustomerGateway(string name, CustomerGatewayArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CustomerGateway", name, args ?? new CustomerGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal CustomerGateway(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CustomerGateway", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CustomerGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CustomerGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CustomerGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CustomerGatewayPropertiesArgs> Properties { get; set; } = null!;
