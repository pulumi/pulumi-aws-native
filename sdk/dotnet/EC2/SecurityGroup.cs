...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class SecurityGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SecurityGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SecurityGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class SecurityGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SecurityGroupPropertiesArgs> Properties { get; set; } = null!;
