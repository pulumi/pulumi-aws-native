...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class VolumeAttachment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VolumeAttachmentAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VolumeAttachmentProperties> Properties { get; private set; } = null!;
        ...
        public VolumeAttachment(string name, VolumeAttachmentArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VolumeAttachment", name, args ?? new VolumeAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VolumeAttachment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VolumeAttachment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VolumeAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VolumeAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VolumeAttachmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VolumeAttachmentPropertiesArgs> Properties { get; set; } = null!;
