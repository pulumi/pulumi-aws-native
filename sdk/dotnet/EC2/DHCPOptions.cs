...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:DHCPOptions")]
    public partial class DHCPOptions : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DHCPOptionsAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DHCPOptionsProperties> Properties { get; private set; } = null!;
        ...
        public DHCPOptions(string name, DHCPOptionsArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:DHCPOptions", name, args ?? new DHCPOptionsArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DHCPOptions(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:DHCPOptions", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DHCPOptions(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:DHCPOptions", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DHCPOptionsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DHCPOptionsPropertiesArgs> Properties { get; set; } = null!;
