...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPCEndpointServicePermissions")]
    public partial class VPCEndpointServicePermissions : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPCEndpointServicePermissionsAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPCEndpointServicePermissionsProperties> Properties { get; private set; } = null!;
        ...
        public VPCEndpointServicePermissions(string name, VPCEndpointServicePermissionsArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointServicePermissions", name, args ?? new VPCEndpointServicePermissionsArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPCEndpointServicePermissions(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointServicePermissions", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPCEndpointServicePermissions(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCEndpointServicePermissions", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPCEndpointServicePermissionsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPCEndpointServicePermissionsPropertiesArgs> Properties { get; set; } = null!;
