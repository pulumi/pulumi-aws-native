...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:TransitGatewayRoute")]
    public partial class TransitGatewayRoute : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TransitGatewayRouteAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TransitGatewayRouteProperties> Properties { get; private set; } = null!;
        ...
        public TransitGatewayRoute(string name, TransitGatewayRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TransitGatewayRoute", name, args ?? new TransitGatewayRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal TransitGatewayRoute(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TransitGatewayRoute", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private TransitGatewayRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:TransitGatewayRoute", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TransitGatewayRouteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TransitGatewayRoutePropertiesArgs> Properties { get; set; } = null!;
