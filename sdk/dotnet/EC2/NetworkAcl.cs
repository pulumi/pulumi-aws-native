...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:NetworkAcl")]
    public partial class NetworkAcl : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NetworkAclAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkAclProperties> Properties { get; private set; } = null!;
        ...
        public NetworkAcl(string name, NetworkAclArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkAcl", name, args ?? new NetworkAclArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal NetworkAcl(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkAcl", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NetworkAcl(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkAcl", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkAclArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkAclPropertiesArgs> Properties { get; set; } = null!;
