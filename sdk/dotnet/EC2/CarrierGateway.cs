...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:CarrierGateway")]
    public partial class CarrierGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CarrierGatewayAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CarrierGatewayProperties> Properties { get; private set; } = null!;
        ...
        public CarrierGateway(string name, CarrierGatewayArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CarrierGateway", name, args ?? new CarrierGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal CarrierGateway(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CarrierGateway", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CarrierGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CarrierGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CarrierGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CarrierGatewayPropertiesArgs> Properties { get; set; } = null!;
