...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:SecurityGroupEgress")]
    public partial class SecurityGroupEgress : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SecurityGroupEgressAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SecurityGroupEgressProperties> Properties { get; private set; } = null!;
        ...
        public SecurityGroupEgress(string name, SecurityGroupEgressArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupEgress", name, args ?? new SecurityGroupEgressArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SecurityGroupEgress(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupEgress", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SecurityGroupEgress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupEgress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityGroupEgressArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SecurityGroupEgressPropertiesArgs> Properties { get; set; } = null!;
