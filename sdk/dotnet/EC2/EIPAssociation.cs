...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class EIPAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EIPAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EIPAssociationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EIPAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EIPAssociationPropertiesArgs> Properties { get; set; } = null!;
