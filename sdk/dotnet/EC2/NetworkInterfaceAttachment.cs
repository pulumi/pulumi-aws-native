...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:NetworkInterfaceAttachment")]
    public partial class NetworkInterfaceAttachment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NetworkInterfaceAttachmentAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkInterfaceAttachmentProperties> Properties { get; private set; } = null!;
        ...
        public NetworkInterfaceAttachment(string name, NetworkInterfaceAttachmentArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfaceAttachment", name, args ?? new NetworkInterfaceAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal NetworkInterfaceAttachment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfaceAttachment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInterfaceAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInterfaceAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInterfaceAttachmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkInterfaceAttachmentPropertiesArgs> Properties { get; set; } = null!;
