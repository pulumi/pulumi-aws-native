...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:CapacityReservation")]
    public partial class CapacityReservation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CapacityReservationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CapacityReservationProperties> Properties { get; private set; } = null!;
        ...
        public CapacityReservation(string name, CapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CapacityReservation", name, args ?? new CapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal CapacityReservation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CapacityReservation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CapacityReservation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:CapacityReservation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CapacityReservationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CapacityReservationPropertiesArgs> Properties { get; set; } = null!;
