...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPNGatewayRoutePropagation")]
    public partial class VPNGatewayRoutePropagation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPNGatewayRoutePropagationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPNGatewayRoutePropagationProperties> Properties { get; private set; } = null!;
        ...
        public VPNGatewayRoutePropagation(string name, VPNGatewayRoutePropagationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNGatewayRoutePropagation", name, args ?? new VPNGatewayRoutePropagationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPNGatewayRoutePropagation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNGatewayRoutePropagation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPNGatewayRoutePropagation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNGatewayRoutePropagation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPNGatewayRoutePropagationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPNGatewayRoutePropagationPropertiesArgs> Properties { get; set; } = null!;
