...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:SubnetCidrBlock")]
    public partial class SubnetCidrBlock : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SubnetCidrBlockAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SubnetCidrBlockProperties> Properties { get; private set; } = null!;
        ...
        public SubnetCidrBlock(string name, SubnetCidrBlockArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetCidrBlock", name, args ?? new SubnetCidrBlockArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SubnetCidrBlock(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetCidrBlock", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SubnetCidrBlock(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SubnetCidrBlock", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubnetCidrBlockArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubnetCidrBlockPropertiesArgs> Properties { get; set; } = null!;
