...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPCGatewayAttachment")]
    public partial class VPCGatewayAttachment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPCGatewayAttachmentAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPCGatewayAttachmentProperties> Properties { get; private set; } = null!;
        ...
        public VPCGatewayAttachment(string name, VPCGatewayAttachmentArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCGatewayAttachment", name, args ?? new VPCGatewayAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPCGatewayAttachment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCGatewayAttachment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPCGatewayAttachment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCGatewayAttachment", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPCGatewayAttachmentArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPCGatewayAttachmentPropertiesArgs> Properties { get; set; } = null!;
