...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:EC2Fleet")]
    public partial class EC2Fleet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EC2FleetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EC2FleetProperties> Properties { get; private set; } = null!;
        ...
        public EC2Fleet(string name, EC2FleetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EC2Fleet", name, args ?? new EC2FleetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal EC2Fleet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EC2Fleet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private EC2Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EC2Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EC2FleetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EC2FleetPropertiesArgs> Properties { get; set; } = null!;
