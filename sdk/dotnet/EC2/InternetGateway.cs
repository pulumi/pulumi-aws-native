...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:InternetGateway")]
    public partial class InternetGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.InternetGatewayAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.InternetGatewayProperties> Properties { get; private set; } = null!;
        ...
        public InternetGateway(string name, InternetGatewayArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:InternetGateway", name, args ?? new InternetGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal InternetGateway(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:InternetGateway", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private InternetGateway(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:InternetGateway", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class InternetGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.InternetGatewayPropertiesArgs> Properties { get; set; } = null!;
