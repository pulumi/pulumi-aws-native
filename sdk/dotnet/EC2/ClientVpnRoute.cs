...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:ClientVpnRoute")]
    public partial class ClientVpnRoute : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ClientVpnRouteAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ClientVpnRouteProperties> Properties { get; private set; } = null!;
        ...
        public ClientVpnRoute(string name, ClientVpnRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnRoute", name, args ?? new ClientVpnRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ClientVpnRoute(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnRoute", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ClientVpnRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnRoute", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClientVpnRouteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClientVpnRoutePropertiesArgs> Properties { get; set; } = null!;
