...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:EIP")]
    public partial class EIP : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EIPAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EIPProperties> Properties { get; private set; } = null!;
        ...
        public EIP(string name, EIPArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EIP", name, args ?? new EIPArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal EIP(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EIP", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private EIP(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:EIP", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EIPArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EIPPropertiesArgs> Properties { get; set; } = null!;
