...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPCCidrBlock")]
    public partial class VPCCidrBlock : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPCCidrBlockAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPCCidrBlockProperties> Properties { get; private set; } = null!;
        ...
        public VPCCidrBlock(string name, VPCCidrBlockArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCCidrBlock", name, args ?? new VPCCidrBlockArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPCCidrBlock(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCCidrBlock", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPCCidrBlock(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCCidrBlock", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPCCidrBlockArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPCCidrBlockPropertiesArgs> Properties { get; set; } = null!;
