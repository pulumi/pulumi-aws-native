...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:Volume")]
    public partial class Volume : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VolumeAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VolumeProperties> Properties { get; private set; } = null!;
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Volume(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Volume", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Volume", name, null, MakeResourceOptions(options, id))
        {
        }
