...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:PlacementGroup")]
    public partial class PlacementGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PlacementGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PlacementGroupProperties> Properties { get; private set; } = null!;
        ...
        public PlacementGroup(string name, PlacementGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PlacementGroup", name, args ?? new PlacementGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal PlacementGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PlacementGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private PlacementGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:PlacementGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PlacementGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PlacementGroupPropertiesArgs> Properties { get; set; } = null!;
