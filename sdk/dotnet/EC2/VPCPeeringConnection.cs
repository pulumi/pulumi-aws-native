...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPCPeeringConnection")]
    public partial class VPCPeeringConnection : Pulumi.CustomResource
    {
        ...
        public VPCPeeringConnection(string name, VPCPeeringConnectionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCPeeringConnection", name, args ?? new VPCPeeringConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPCPeeringConnection(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCPeeringConnection", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPCPeeringConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPCPeeringConnection", name, null, MakeResourceOptions(options, id))
        {
        }
