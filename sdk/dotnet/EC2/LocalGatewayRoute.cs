...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class LocalGatewayRoute : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LocalGatewayRouteAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LocalGatewayRouteProperties> Properties { get; private set; } = null!;
        ...
        public LocalGatewayRoute(string name, LocalGatewayRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:LocalGatewayRoute", name, args ?? new LocalGatewayRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal LocalGatewayRoute(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:LocalGatewayRoute", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private LocalGatewayRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:LocalGatewayRoute", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LocalGatewayRouteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LocalGatewayRoutePropertiesArgs> Properties { get; set; } = null!;
