...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPNConnectionRoute")]
    public partial class VPNConnectionRoute : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPNConnectionRouteAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPNConnectionRouteProperties> Properties { get; private set; } = null!;
        ...
        public VPNConnectionRoute(string name, VPNConnectionRouteArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNConnectionRoute", name, args ?? new VPNConnectionRouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPNConnectionRoute(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNConnectionRoute", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPNConnectionRoute(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPNConnectionRoute", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPNConnectionRouteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPNConnectionRoutePropertiesArgs> Properties { get; set; } = null!;
