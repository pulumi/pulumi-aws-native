...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class VPNConnection : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPNConnectionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPNConnectionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class VPNConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPNConnectionPropertiesArgs> Properties { get; set; } = null!;
