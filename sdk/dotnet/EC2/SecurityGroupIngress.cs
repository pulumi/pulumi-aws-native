...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:SecurityGroupIngress")]
    public partial class SecurityGroupIngress : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SecurityGroupIngressAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SecurityGroupIngressProperties> Properties { get; private set; } = null!;
        ...
        public SecurityGroupIngress(string name, SecurityGroupIngressArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupIngress", name, args ?? new SecurityGroupIngressArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SecurityGroupIngress(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupIngress", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SecurityGroupIngress(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:SecurityGroupIngress", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SecurityGroupIngressArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SecurityGroupIngressPropertiesArgs> Properties { get; set; } = null!;
