...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class Route : Pulumi.CustomResource
    {
        ...
        public Route(string name, RouteArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Route", name, args ?? new RouteArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Route(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Route", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Route(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Route", name, null, MakeResourceOptions(options, id))
        {
        }
