...
namespace Pulumi.Cloudformation.EC2
{
    ...
    public partial class TransitGateway : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TransitGatewayAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TransitGatewayProperties> Properties { get; private set; } = null!;
    ...
    public sealed class TransitGatewayArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TransitGatewayPropertiesArgs> Properties { get; set; } = null!;
