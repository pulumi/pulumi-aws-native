...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:NetworkInsightsPath")]
    public partial class NetworkInsightsPath : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.NetworkInsightsPathAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.NetworkInsightsPathProperties> Properties { get; private set; } = null!;
        ...
        public NetworkInsightsPath(string name, NetworkInsightsPathArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInsightsPath", name, args ?? new NetworkInsightsPathArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal NetworkInsightsPath(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInsightsPath", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private NetworkInsightsPath(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:NetworkInsightsPath", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class NetworkInsightsPathArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.NetworkInsightsPathPropertiesArgs> Properties { get; set; } = null!;
