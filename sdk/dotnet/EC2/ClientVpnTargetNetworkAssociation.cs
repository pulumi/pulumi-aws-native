...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:ClientVpnTargetNetworkAssociation")]
    public partial class ClientVpnTargetNetworkAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ClientVpnTargetNetworkAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ClientVpnTargetNetworkAssociationProperties> Properties { get; private set; } = null!;
        ...
        public ClientVpnTargetNetworkAssociation(string name, ClientVpnTargetNetworkAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnTargetNetworkAssociation", name, args ?? new ClientVpnTargetNetworkAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ClientVpnTargetNetworkAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnTargetNetworkAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ClientVpnTargetNetworkAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:ClientVpnTargetNetworkAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ClientVpnTargetNetworkAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClientVpnTargetNetworkAssociationPropertiesArgs> Properties { get; set; } = null!;
