...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:Host")]
    public partial class Host : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.HostAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.HostProperties> Properties { get; private set; } = null!;
        ...
        public Host(string name, HostArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Host", name, args ?? new HostArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Host(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Host", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Host(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:Host", name, null, MakeResourceOptions(options, id))
        {
        }
