...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:RouteTable")]
    public partial class RouteTable : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RouteTableAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RouteTableProperties> Properties { get; private set; } = null!;
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal RouteTable(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:RouteTable", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:RouteTable", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteTableArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RouteTablePropertiesArgs> Properties { get; set; } = null!;
