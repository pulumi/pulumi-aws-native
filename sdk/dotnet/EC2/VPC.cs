...
namespace Pulumi.Cloudformation.EC2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:EC2:VPC")]
    public partial class VPC : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VPCAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VPCProperties> Properties { get; private set; } = null!;
        ...
        public VPC(string name, VPCArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPC", name, args ?? new VPCArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VPC(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPC", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VPC(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EC2:VPC", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VPCArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VPCPropertiesArgs> Properties { get; set; } = null!;
