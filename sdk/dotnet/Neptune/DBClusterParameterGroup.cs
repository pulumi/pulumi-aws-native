...
namespace Pulumi.Cloudformation.Neptune
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Neptune:DBClusterParameterGroup")]
    public partial class DBClusterParameterGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DBClusterParameterGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DBClusterParameterGroupProperties> Properties { get; private set; } = null!;
        ...
        public DBClusterParameterGroup(string name, DBClusterParameterGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBClusterParameterGroup", name, args ?? new DBClusterParameterGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DBClusterParameterGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBClusterParameterGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DBClusterParameterGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBClusterParameterGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DBClusterParameterGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DBClusterParameterGroupPropertiesArgs> Properties { get; set; } = null!;
