...
namespace Pulumi.Cloudformation.Neptune
{
    ...
    public partial class DBCluster : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DBClusterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DBClusterProperties> Properties { get; private set; } = null!;
        ...
        public DBCluster(string name, DBClusterArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBCluster", name, args ?? new DBClusterArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DBCluster(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBCluster", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DBCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Neptune:DBCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DBClusterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DBClusterPropertiesArgs> Properties { get; set; } = null!;
