...
namespace Pulumi.AwsNative.Neptune
{
    ...
    /// </summary>
    [AwsNativeResourceType("aws-native:neptune:GlobalCluster")]
    public partial class GlobalCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("engine")]
        public Output<Pulumi.AwsNative.Neptune.GlobalClusterEngine?> Engine { get; private set; } = null!;
        ...
        public GlobalCluster(string name, GlobalClusterArgs? args = null, CustomResourceOptions? options = null)
            : base("aws-native:neptune:GlobalCluster", name, args ?? new GlobalClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlobalCluster(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:neptune:GlobalCluster", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GlobalClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("engine")]
        public Input<Pulumi.AwsNative.Neptune.GlobalClusterEngine>? Engine { get; set; }
