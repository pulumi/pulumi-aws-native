...
namespace Pulumi.Cloudformation.Logs
{
    ...
    public partial class SubscriptionFilter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SubscriptionFilterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SubscriptionFilterProperties> Properties { get; private set; } = null!;
        ...
        public SubscriptionFilter(string name, SubscriptionFilterArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Logs:SubscriptionFilter", name, args ?? new SubscriptionFilterArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SubscriptionFilter(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Logs:SubscriptionFilter", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionFilter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Logs:SubscriptionFilter", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionFilterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubscriptionFilterPropertiesArgs> Properties { get; set; } = null!;
