...
namespace Pulumi.AwsNative.Logs
{
    ...
    public partial class MetricFilter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MetricFilterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MetricFilterProperties> Properties { get; private set; } = null!;
    ...
    public sealed class MetricFilterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MetricFilterPropertiesArgs> Properties { get; set; } = null!;
