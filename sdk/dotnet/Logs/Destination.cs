...
namespace Pulumi.Cloudformation.Logs
{
    ...
    public partial class Destination : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DestinationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DestinationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DestinationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DestinationPropertiesArgs> Properties { get; set; } = null!;
