...
namespace Pulumi.AwsNative.Logs.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TransformerProcessorTypeConverterProperties
    {
        public readonly ImmutableArray<Outputs.TransformerTypeConverterEntry> Entries;

        [OutputConstructor]
        private TransformerProcessorTypeConverterProperties(ImmutableArray<Outputs.TransformerTypeConverterEntry> entries)
        {
            Entries = entries;
        }
    }
