...
namespace Pulumi.AwsNative.AppConfig
{
    ...
    public partial class ConfigurationProfile : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationProfileAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationProfileProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConfigurationProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationProfilePropertiesArgs> Properties { get; set; } = null!;
