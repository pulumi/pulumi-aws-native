...
namespace Pulumi.AwsNative.AppConfig
{
    ...
    /// </summary>
    [Obsolete(@"ConfigurationProfile is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
