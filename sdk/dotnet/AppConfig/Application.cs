...
namespace Pulumi.Cloudformation.AppConfig
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:AppConfig:Application")]
    public partial class Application : Pulumi.CustomResource
    {
        ...
        public Application(string name, ApplicationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Application(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:Application", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:Application", name, null, MakeResourceOptions(options, id))
        {
        }
