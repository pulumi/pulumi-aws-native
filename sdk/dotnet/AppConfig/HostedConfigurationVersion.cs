...
namespace Pulumi.Cloudformation.AppConfig
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:AppConfig:HostedConfigurationVersion")]
    public partial class HostedConfigurationVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.HostedConfigurationVersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.HostedConfigurationVersionProperties> Properties { get; private set; } = null!;
        ...
        public HostedConfigurationVersion(string name, HostedConfigurationVersionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:HostedConfigurationVersion", name, args ?? new HostedConfigurationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal HostedConfigurationVersion(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:HostedConfigurationVersion", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private HostedConfigurationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppConfig:HostedConfigurationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HostedConfigurationVersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.HostedConfigurationVersionPropertiesArgs> Properties { get; set; } = null!;
