...
namespace Pulumi.AwsNative.Batch.Inputs
{
    ...
    public sealed class JobDefinitionMultiNodeContainerPropertiesArgs : global::Pulumi.ResourceArgs
    {
        [Input("command")]
        ...
        public JobDefinitionMultiNodeContainerPropertiesArgs()
        {
        }
        public static new JobDefinitionMultiNodeContainerPropertiesArgs Empty => new JobDefinitionMultiNodeContainerPropertiesArgs();
    }
}
