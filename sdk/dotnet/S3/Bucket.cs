...
namespace Pulumi.AwsNative.S3
{
    ...
    public partial class Bucket : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.BucketAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BucketProperties> Properties { get; private set; } = null!;
    ...
    public sealed class BucketArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BucketPropertiesArgs> Properties { get; set; } = null!;
