...
namespace Pulumi.Cloudformation.Configuration
{
    ...
    public partial class DeliveryChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DeliveryChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DeliveryChannelProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DeliveryChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DeliveryChannelPropertiesArgs> Properties { get; set; } = null!;
