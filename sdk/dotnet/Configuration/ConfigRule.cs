...
namespace Pulumi.Cloudformation.Configuration
{
    ...
    public partial class ConfigRule : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigRuleAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigRuleProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConfigRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigRulePropertiesArgs> Properties { get; set; } = null!;
