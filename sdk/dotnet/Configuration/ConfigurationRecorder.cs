...
namespace Pulumi.AwsNative.Configuration
{
    ...
    public partial class ConfigurationRecorder : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConfigurationRecorderAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConfigurationRecorderProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConfigurationRecorderArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigurationRecorderPropertiesArgs> Properties { get; set; } = null!;
