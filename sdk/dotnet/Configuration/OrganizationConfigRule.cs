...
namespace Pulumi.AwsNative.Configuration
{
    ...
    public partial class OrganizationConfigRule : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.OrganizationConfigRuleAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.OrganizationConfigRuleProperties> Properties { get; private set; } = null!;
    ...
    public sealed class OrganizationConfigRuleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.OrganizationConfigRulePropertiesArgs> Properties { get; set; } = null!;
