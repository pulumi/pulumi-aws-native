...
namespace Pulumi.AwsNative.IdentityStore
{
    ...
    /// </summary>
    [AwsNativeResourceType("aws-native:identitystore:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("aws-native:identitystore:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:identitystore:Group", name, null, MakeResourceOptions(options, id))
        {
        }
