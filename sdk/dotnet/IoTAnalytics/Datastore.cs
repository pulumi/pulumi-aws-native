...
namespace Pulumi.Cloudformation.IoTAnalytics
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:IoTAnalytics:Datastore")]
    public partial class Datastore : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DatastoreAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DatastoreProperties> Properties { get; private set; } = null!;
        ...
        public Datastore(string name, DatastoreArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:IoTAnalytics:Datastore", name, args ?? new DatastoreArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Datastore(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:IoTAnalytics:Datastore", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Datastore(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:IoTAnalytics:Datastore", name, null, MakeResourceOptions(options, id))
        {
        }
