...
namespace Pulumi.Cloudformation.SES
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:SES:ReceiptRuleSet")]
    public partial class ReceiptRuleSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ReceiptRuleSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ReceiptRuleSetProperties> Properties { get; private set; } = null!;
        ...
        public ReceiptRuleSet(string name, ReceiptRuleSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:SES:ReceiptRuleSet", name, args ?? new ReceiptRuleSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ReceiptRuleSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:SES:ReceiptRuleSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ReceiptRuleSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:SES:ReceiptRuleSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ReceiptRuleSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ReceiptRuleSetPropertiesArgs> Properties { get; set; } = null!;
