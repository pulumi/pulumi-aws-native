...
namespace Pulumi.Cloudformation.SES
{
    ...
    public partial class Template : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TemplateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TemplateProperties> Properties { get; private set; } = null!;
        ...
        public Template(string name, TemplateArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:SES:Template", name, args ?? new TemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Template(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:SES:Template", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Template(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:SES:Template", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TemplatePropertiesArgs> Properties { get; set; } = null!;
