...
namespace Pulumi.AwsNative.BedrockAgentCore
{
    ...
    /// </summary>
    [AwsNativeResourceType("aws-native:bedrockagentcore:ResourcePolicy")]
    public partial class ResourcePolicy : global::Pulumi.CustomResource
    {
        ...
        public ResourcePolicy(string name, ResourcePolicyArgs args, CustomResourceOptions? options = null)
            : base("aws-native:bedrockagentcore:ResourcePolicy", name, args ?? new ResourcePolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourcePolicy(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:bedrockagentcore:ResourcePolicy", name, null, MakeResourceOptions(options, id))
        {
        }
