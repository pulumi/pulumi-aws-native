...
namespace Pulumi.AwsNative.BedrockAgentCore.Inputs
{
    ...
    public sealed class PaymentManagerCustomJwtAuthorizerConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("customClaims")]
        private InputList<Inputs.PaymentManagerCustomClaimValidationTypeArgs>? _customClaims;
        public InputList<Inputs.PaymentManagerCustomClaimValidationTypeArgs> CustomClaims
        {
            get => _customClaims ?? (_customClaims = new InputList<Inputs.PaymentManagerCustomClaimValidationTypeArgs>());
        ...
        public PaymentManagerCustomJwtAuthorizerConfigurationArgs()
        {
        }
        public static new PaymentManagerCustomJwtAuthorizerConfigurationArgs Empty => new PaymentManagerCustomJwtAuthorizerConfigurationArgs();
    }
}
