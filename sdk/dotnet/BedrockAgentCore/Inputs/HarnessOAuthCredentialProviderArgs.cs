...
namespace Pulumi.AwsNative.BedrockAgentCore.Inputs
{
    ...
    public sealed class HarnessOAuthCredentialProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("grantType")]
        public Input<Pulumi.AwsNative.BedrockAgentCore.HarnessOAuthCredentialProviderGrantType>? GrantType { get; set; }
        ...
        public HarnessOAuthCredentialProviderArgs()
        {
        }
        public static new HarnessOAuthCredentialProviderArgs Empty => new HarnessOAuthCredentialProviderArgs();
    }
}
