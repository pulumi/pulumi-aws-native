...
namespace Pulumi.Cloudformation.DMS
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:DMS:Endpoint")]
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EndpointAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EndpointProperties> Properties { get; private set; } = null!;
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:DMS:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Endpoint(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:DMS:Endpoint", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:DMS:Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EndpointArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EndpointPropertiesArgs> Properties { get; set; } = null!;
