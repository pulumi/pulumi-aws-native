...
namespace Pulumi.AwsNative.DMS
{
    ...
    public partial class ReplicationInstance : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ReplicationInstanceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ReplicationInstanceProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ReplicationInstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ReplicationInstancePropertiesArgs> Properties { get; set; } = null!;
