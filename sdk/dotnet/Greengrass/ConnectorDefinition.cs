...
namespace Pulumi.AwsNative.Greengrass
{
    ...
    /// </summary>
    [Obsolete(@"ConnectorDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class ConnectorDefinition : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ConnectorDefinitionVersion?> InitialVersion { get; private set; } = null!;
        ...
        public ConnectorDefinition(string name, ConnectorDefinitionArgs? args = null, CustomResourceOptions? options = null)
