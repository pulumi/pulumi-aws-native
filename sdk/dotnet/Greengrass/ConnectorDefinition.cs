...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class ConnectorDefinition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ConnectorDefinitionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ConnectorDefinitionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ConnectorDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConnectorDefinitionPropertiesArgs> Properties { get; set; } = null!;
