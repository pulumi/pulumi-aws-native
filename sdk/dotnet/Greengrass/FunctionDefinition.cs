...
namespace Pulumi.AwsNative.Greengrass
{
    ...
    /// </summary>
    [Obsolete(@"FunctionDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class FunctionDefinition : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.FunctionDefinitionVersion?> InitialVersion { get; private set; } = null!;
        ...
        public FunctionDefinition(string name, FunctionDefinitionArgs? args = null, CustomResourceOptions? options = null)
