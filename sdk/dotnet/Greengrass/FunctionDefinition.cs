...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class FunctionDefinition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FunctionDefinitionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FunctionDefinitionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class FunctionDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FunctionDefinitionPropertiesArgs> Properties { get; set; } = null!;
