...
namespace Pulumi.AwsNative.Greengrass
{
    ...
    /// </summary>
    [Obsolete(@"DeviceDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    [AwsNativeResourceType("aws-native:greengrass:DeviceDefinition")]
    public partial class DeviceDefinition : global::Pulumi.CustomResource
    {
        [Output("arn")]
        ...
        public Output<Outputs.DeviceDefinitionVersion?> InitialVersion { get; private set; } = null!;
        ...
        public DeviceDefinition(string name, DeviceDefinitionArgs? args = null, CustomResourceOptions? options = null)
    ...
    public sealed class DeviceDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("initialVersion")]
        public Input<Inputs.DeviceDefinitionVersionArgs>? InitialVersion { get; set; }
        ...
        public static new DeviceDefinitionArgs Empty => new DeviceDefinitionArgs();
    }
}
