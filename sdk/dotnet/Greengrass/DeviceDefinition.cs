...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class DeviceDefinition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DeviceDefinitionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DeviceDefinitionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DeviceDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DeviceDefinitionPropertiesArgs> Properties { get; set; } = null!;
