...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class LoggerDefinitionVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LoggerDefinitionVersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LoggerDefinitionVersionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class LoggerDefinitionVersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LoggerDefinitionVersionPropertiesArgs> Properties { get; set; } = null!;
