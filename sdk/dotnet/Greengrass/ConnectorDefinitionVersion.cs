...
namespace Pulumi.AwsNative.Greengrass
{
    ...
    /// </summary>
    [Obsolete(@"ConnectorDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    [AwsNativeResourceType("aws-native:greengrass:ConnectorDefinitionVersion")]
    public partial class ConnectorDefinitionVersion : global::Pulumi.CustomResource
    {
        [Output("awsId")]
