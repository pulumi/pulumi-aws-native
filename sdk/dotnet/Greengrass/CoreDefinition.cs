...
namespace Pulumi.AwsNative.Greengrass
{
    ...
    /// </summary>
    [Obsolete(@"CoreDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class CoreDefinition : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.CoreDefinitionVersion?> InitialVersion { get; private set; } = null!;
