...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Greengrass:CoreDefinition")]
    public partial class CoreDefinition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CoreDefinitionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CoreDefinitionProperties> Properties { get; private set; } = null!;
        ...
        public CoreDefinition(string name, CoreDefinitionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:CoreDefinition", name, args ?? new CoreDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal CoreDefinition(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:CoreDefinition", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CoreDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:CoreDefinition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CoreDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CoreDefinitionPropertiesArgs> Properties { get; set; } = null!;
