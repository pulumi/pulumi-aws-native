...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class SubscriptionDefinitionVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SubscriptionDefinitionVersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SubscriptionDefinitionVersionProperties> Properties { get; private set; } = null!;
        ...
        public SubscriptionDefinitionVersion(string name, SubscriptionDefinitionVersionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:SubscriptionDefinitionVersion", name, args ?? new SubscriptionDefinitionVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SubscriptionDefinitionVersion(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:SubscriptionDefinitionVersion", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SubscriptionDefinitionVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:SubscriptionDefinitionVersion", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SubscriptionDefinitionVersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SubscriptionDefinitionVersionPropertiesArgs> Properties { get; set; } = null!;
