...
namespace Pulumi.Cloudformation.Greengrass
{
    ...
    public partial class Group : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GroupProperties> Properties { get; private set; } = null!;
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Group(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:Group", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Greengrass:Group", name, null, MakeResourceOptions(options, id))
        {
        }
