...
namespace Pulumi.AwsNative.KinesisAnalytics
{
    ...
    /// </summary>
    [Obsolete(@"ApplicationOutputResource is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class ApplicationOutputResource : global::Pulumi.CustomResource
    {
        ...
        public ApplicationOutputResource(string name, ApplicationOutputResourceArgs args, CustomResourceOptions? options = null)
            : base("aws-native:kinesisanalytics:ApplicationOutputResource", name, args ?? new ApplicationOutputResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationOutputResource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:kinesisanalytics:ApplicationOutputResource", name, null, MakeResourceOptions(options, id))
        {
        }
