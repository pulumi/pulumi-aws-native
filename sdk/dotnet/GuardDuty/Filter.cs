...
namespace Pulumi.Cloudformation.GuardDuty
{
    ...
    public partial class Filter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FilterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FilterProperties> Properties { get; private set; } = null!;
    ...
    public sealed class FilterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FilterPropertiesArgs> Properties { get; set; } = null!;
