...
namespace Pulumi.Cloudformation.GuardDuty
{
    ...
    public partial class ThreatIntelSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ThreatIntelSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ThreatIntelSetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ThreatIntelSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ThreatIntelSetPropertiesArgs> Properties { get; set; } = null!;
