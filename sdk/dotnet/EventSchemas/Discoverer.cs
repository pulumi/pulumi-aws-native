...
namespace Pulumi.Cloudformation.EventSchemas
{
    ...
    public partial class Discoverer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DiscovererAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DiscovererProperties> Properties { get; private set; } = null!;
        ...
        public Discoverer(string name, DiscovererArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:EventSchemas:Discoverer", name, args ?? new DiscovererArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Discoverer(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:EventSchemas:Discoverer", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Discoverer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:EventSchemas:Discoverer", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DiscovererArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DiscovererPropertiesArgs> Properties { get; set; } = null!;
