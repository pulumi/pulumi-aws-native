...
namespace Pulumi.Cloudformation.AppStream
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:AppStream:User")]
    public partial class User : Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal User(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:User", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:User", name, null, MakeResourceOptions(options, id))
        {
        }
