...
namespace Pulumi.Cloudformation.AppStream
{
    ...
    public partial class ImageBuilder : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ImageBuilderAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ImageBuilderProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ImageBuilderArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ImageBuilderPropertiesArgs> Properties { get; set; } = null!;
