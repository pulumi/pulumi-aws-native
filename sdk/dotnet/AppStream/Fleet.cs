...
namespace Pulumi.Cloudformation.AppStream
{
    ...
    public partial class Fleet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FleetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FleetProperties> Properties { get; private set; } = null!;
        ...
        public Fleet(string name, FleetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:Fleet", name, args ?? new FleetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Fleet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:Fleet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Fleet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:Fleet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FleetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FleetPropertiesArgs> Properties { get; set; } = null!;
