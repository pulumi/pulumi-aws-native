...
namespace Pulumi.Cloudformation.AppStream
{
    ...
    public partial class DirectoryConfig : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DirectoryConfigAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DirectoryConfigProperties> Properties { get; private set; } = null!;
    ...
    public sealed class DirectoryConfigArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DirectoryConfigPropertiesArgs> Properties { get; set; } = null!;
