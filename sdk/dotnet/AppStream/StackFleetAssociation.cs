...
namespace Pulumi.Cloudformation.AppStream
{
    ...
    public partial class StackFleetAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.StackFleetAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.StackFleetAssociationProperties> Properties { get; private set; } = null!;
        ...
        public StackFleetAssociation(string name, StackFleetAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:StackFleetAssociation", name, args ?? new StackFleetAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal StackFleetAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:StackFleetAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private StackFleetAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppStream:StackFleetAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StackFleetAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.StackFleetAssociationPropertiesArgs> Properties { get; set; } = null!;
