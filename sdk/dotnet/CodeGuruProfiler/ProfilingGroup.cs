...
namespace Pulumi.Cloudformation.CodeGuruProfiler
{
    /// <summary>
    ...
    public partial class ProfilingGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ProfilingGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ProfilingGroupProperties> Properties { get; private set; } = null!;
        ...
        public ProfilingGroup(string name, ProfilingGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:CodeGuruProfiler:ProfilingGroup", name, args ?? new ProfilingGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ProfilingGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:CodeGuruProfiler:ProfilingGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ProfilingGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:CodeGuruProfiler:ProfilingGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProfilingGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ProfilingGroupPropertiesArgs> Properties { get; set; } = null!;
