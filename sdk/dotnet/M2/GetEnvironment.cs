...
namespace Pulumi.AwsNative.M2
{
    public static class GetEnvironment
    {
        ...
        public static Task<GetEnvironmentResult> InvokeAsync(GetEnvironmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnvironmentResult>("aws-native:m2:getEnvironment", args ?? new GetEnvironmentArgs(), options.WithDefaults());

        /// <summary>
        /// Represents a runtime environment that can run migrated mainframe applications.
        /// </summary>
        public static Output<GetEnvironmentResult> Invoke(GetEnvironmentInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetEnvironmentResult>("aws-native:m2:getEnvironment", args ?? new GetEnvironmentInvokeArgs(), options.WithDefaults());
    }
