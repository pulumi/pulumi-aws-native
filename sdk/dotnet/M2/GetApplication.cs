...
namespace Pulumi.AwsNative.M2
{
    public static class GetApplication
    {
        ...
        public static Task<GetApplicationResult> InvokeAsync(GetApplicationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationResult>("aws-native:m2:getApplication", args ?? new GetApplicationArgs(), options.WithDefaults());

        /// <summary>
        /// Represents an application that runs on an AWS Mainframe Modernization Environment
        /// </summary>
        public static Output<GetApplicationResult> Invoke(GetApplicationInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetApplicationResult>("aws-native:m2:getApplication", args ?? new GetApplicationInvokeArgs(), options.WithDefaults());
    }
