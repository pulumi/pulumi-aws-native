...
namespace Pulumi.Cloudformation.WAFv2
{
    /// <summary>
    /// http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-webaclassociation.html
    /// </summary>
    [CloudformationResourceType("cloudformation:WAFv2:WebACLAssociation")]
    public partial class WebACLAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.WebACLAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.WebACLAssociationProperties> Properties { get; private set; } = null!;
        ...
        public WebACLAssociation(string name, WebACLAssociationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:WebACLAssociation", name, args ?? new WebACLAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal WebACLAssociation(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:WebACLAssociation", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private WebACLAssociation(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:WebACLAssociation", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class WebACLAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.WebACLAssociationPropertiesArgs> Properties { get; set; } = null!;
