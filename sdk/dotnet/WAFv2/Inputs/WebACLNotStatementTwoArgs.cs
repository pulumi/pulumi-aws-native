...
namespace Pulumi.Cloudformation.WAFv2.Inputs
{
    ...
    /// </summary>
    public sealed class WebACLNotStatementTwoArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WebACLStatementThreeArgs> Statement { get; set; } = null!;

        public WebACLNotStatementTwoArgs()
        {
        }
    }
}
