...
namespace Pulumi.Cloudformation.WAFv2.Outputs
{
    ...
    [OutputType]
    public sealed class RuleGroupNotStatementOne
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.RuleGroupStatementTwo Statement;

        [OutputConstructor]
        private RuleGroupNotStatementOne(Outputs.RuleGroupStatementTwo Statement)
        {
