...
namespace Pulumi.Cloudformation.WAFv2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:WAFv2:RegexPatternSet")]
    public partial class RegexPatternSet : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RegexPatternSetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RegexPatternSetProperties> Properties { get; private set; } = null!;
        ...
        public RegexPatternSet(string name, RegexPatternSetArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:RegexPatternSet", name, args ?? new RegexPatternSetArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal RegexPatternSet(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:RegexPatternSet", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RegexPatternSet(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:WAFv2:RegexPatternSet", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RegexPatternSetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RegexPatternSetPropertiesArgs> Properties { get; set; } = null!;
