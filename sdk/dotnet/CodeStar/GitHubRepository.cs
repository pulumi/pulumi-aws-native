...
namespace Pulumi.Cloudformation.CodeStar
{
    ...
    public partial class GitHubRepository : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GitHubRepositoryAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GitHubRepositoryProperties> Properties { get; private set; } = null!;
    ...
    public sealed class GitHubRepositoryArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GitHubRepositoryPropertiesArgs> Properties { get; set; } = null!;
