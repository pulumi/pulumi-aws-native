...
namespace Pulumi.AwsNative.DataSync
{
    ...
    /// </summary>
    [Obsolete(@"LocationAzureBlob is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class LocationAzureBlob : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.LocationAzureBlobTag>> Tags { get; private set; } = null!;
    ...
    public sealed class LocationAzureBlobArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.LocationAzureBlobTagArgs>? _tags;

        /// <summary>
        /// An array of key-value pairs to apply to this resource.
        /// </summary>
        public InputList<Inputs.LocationAzureBlobTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.LocationAzureBlobTagArgs>());
            set => _tags = value;
        }
