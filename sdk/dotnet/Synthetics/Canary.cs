...
namespace Pulumi.Cloudformation.Synthetics
{
    /// <summary>
    ...
    public partial class Canary : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CanaryAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CanaryProperties> Properties { get; private set; } = null!;
        ...
        public Canary(string name, CanaryArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Synthetics:Canary", name, args ?? new CanaryArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Canary(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Synthetics:Canary", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Canary(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Synthetics:Canary", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CanaryArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CanaryPropertiesArgs> Properties { get; set; } = null!;
