...
namespace Pulumi.Cloudformation.SSM
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:SSM:MaintenanceWindowTask")]
    public partial class MaintenanceWindowTask : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MaintenanceWindowTaskAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MaintenanceWindowTaskProperties> Properties { get; private set; } = null!;
        ...
        public MaintenanceWindowTask(string name, MaintenanceWindowTaskArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:SSM:MaintenanceWindowTask", name, args ?? new MaintenanceWindowTaskArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal MaintenanceWindowTask(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:SSM:MaintenanceWindowTask", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private MaintenanceWindowTask(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:SSM:MaintenanceWindowTask", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MaintenanceWindowTaskArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MaintenanceWindowTaskPropertiesArgs> Properties { get; set; } = null!;
