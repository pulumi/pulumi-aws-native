...
namespace Pulumi.AwsNative.SSM
{
    ...
    public partial class MaintenanceWindowTarget : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MaintenanceWindowTargetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MaintenanceWindowTargetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class MaintenanceWindowTargetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MaintenanceWindowTargetPropertiesArgs> Properties { get; set; } = null!;
