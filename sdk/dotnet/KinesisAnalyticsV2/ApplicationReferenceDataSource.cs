...
namespace Pulumi.Cloudformation.KinesisAnalyticsV2
{
    ...
    public partial class ApplicationReferenceDataSource : Pulumi.CustomResource
    {
        ...
        public ApplicationReferenceDataSource(string name, ApplicationReferenceDataSourceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:KinesisAnalyticsV2:ApplicationReferenceDataSource", name, args ?? new ApplicationReferenceDataSourceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ApplicationReferenceDataSource(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:KinesisAnalyticsV2:ApplicationReferenceDataSource", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ApplicationReferenceDataSource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:KinesisAnalyticsV2:ApplicationReferenceDataSource", name, null, MakeResourceOptions(options, id))
        {
        }
