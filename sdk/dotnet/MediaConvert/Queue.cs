...
namespace Pulumi.Cloudformation.MediaConvert
{
    ...
    public partial class Queue : Pulumi.CustomResource
    {
        ...
        public Queue(string name, QueueArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:MediaConvert:Queue", name, args ?? new QueueArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Queue(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:MediaConvert:Queue", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Queue(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:MediaConvert:Queue", name, null, MakeResourceOptions(options, id))
        {
        }
