...
namespace Pulumi.AwsNative.MediaConvert
{
    ...
    public partial class Preset : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PresetAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PresetProperties> Properties { get; private set; } = null!;
    ...
    public sealed class PresetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PresetPropertiesArgs> Properties { get; set; } = null!;
