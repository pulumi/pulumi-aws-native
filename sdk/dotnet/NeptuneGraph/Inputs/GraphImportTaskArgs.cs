...
namespace Pulumi.AwsNative.NeptuneGraph.Inputs
{
    ...
    /// </summary>
    public sealed class GraphImportTaskArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("blankNodeHandling")]
        public Input<Pulumi.AwsNative.NeptuneGraph.GraphImportTaskBlankNodeHandling>? BlankNodeHandling { get; set; }

        /// <summary>
        /// If set to true, the task halts when an import error is encountered. If set to false, the task skips the data that caused the error and continues if possible.
        /// </summary>
        [Input("failOnError")]
        public Input<bool>? FailOnError { get; set; }
        ...
        /// </summary>
        [Input("format")]
        public Input<Pulumi.AwsNative.NeptuneGraph.GraphImportTaskFormat>? Format { get; set; }
        ...
        /// </summary>
        [Input("importOptions")]
        public Input<Inputs.GraphImportOptionsArgs>? ImportOptions { get; set; }
        ...
        /// </summary>
        [Input("maxProvisionedMemory")]
        public Input<int>? MaxProvisionedMemory { get; set; }

        /// <summary>
        /// The minimum provisioned memory-optimized Neptune Capacity Units (m-NCUs) to use for the graph. Default: 16
        /// </summary>
        [Input("minProvisionedMemory")]
        public Input<int>? MinProvisionedMemory { get; set; }

        /// <summary>
        /// The parquet type of the import task. Required when Format is PARQUET.
        /// </summary>
        [Input("parquetType")]
        public Input<Pulumi.AwsNative.NeptuneGraph.GraphImportTaskParquetType>? ParquetType { get; set; }
        ...
        public GraphImportTaskArgs()
        {
        }
        public static new GraphImportTaskArgs Empty => new GraphImportTaskArgs();
    }
}
