...
namespace Pulumi.Cloudformation.NetworkFirewall
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:NetworkFirewall:LoggingConfiguration")]
    public partial class LoggingConfiguration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LoggingConfigurationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LoggingConfigurationProperties> Properties { get; private set; } = null!;
        ...
        public LoggingConfiguration(string name, LoggingConfigurationArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:NetworkFirewall:LoggingConfiguration", name, args ?? new LoggingConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal LoggingConfiguration(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:NetworkFirewall:LoggingConfiguration", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private LoggingConfiguration(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:NetworkFirewall:LoggingConfiguration", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class LoggingConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LoggingConfigurationPropertiesArgs> Properties { get; set; } = null!;
