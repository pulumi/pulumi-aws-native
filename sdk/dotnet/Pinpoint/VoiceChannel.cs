...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    public partial class VoiceChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VoiceChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VoiceChannelProperties> Properties { get; private set; } = null!;
    ...
    public sealed class VoiceChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VoiceChannelPropertiesArgs> Properties { get; set; } = null!;
