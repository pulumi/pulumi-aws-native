...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    public partial class Campaign : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CampaignAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CampaignProperties> Properties { get; private set; } = null!;
    ...
    public sealed class CampaignArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CampaignPropertiesArgs> Properties { get; set; } = null!;
