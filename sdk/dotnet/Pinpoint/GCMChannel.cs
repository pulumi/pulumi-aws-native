...
namespace Pulumi.AwsNative.Pinpoint
{
    ...
    public partial class GCMChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GCMChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GCMChannelProperties> Properties { get; private set; } = null!;
    ...
    public sealed class GCMChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GCMChannelPropertiesArgs> Properties { get; set; } = null!;
