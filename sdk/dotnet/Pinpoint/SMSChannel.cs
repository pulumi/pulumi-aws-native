...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Pinpoint:SMSChannel")]
    public partial class SMSChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SMSChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SMSChannelProperties> Properties { get; private set; } = null!;
        ...
        public SMSChannel(string name, SMSChannelArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Pinpoint:SMSChannel", name, args ?? new SMSChannelArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SMSChannel(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Pinpoint:SMSChannel", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SMSChannel(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Pinpoint:SMSChannel", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SMSChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SMSChannelPropertiesArgs> Properties { get; set; } = null!;
