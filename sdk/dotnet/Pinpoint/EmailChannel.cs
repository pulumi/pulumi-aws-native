...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    public partial class EmailChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EmailChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EmailChannelProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EmailChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EmailChannelPropertiesArgs> Properties { get; set; } = null!;
