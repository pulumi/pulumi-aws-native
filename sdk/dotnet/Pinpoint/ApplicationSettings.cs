...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    public partial class ApplicationSettings : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ApplicationSettingsAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ApplicationSettingsProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ApplicationSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApplicationSettingsPropertiesArgs> Properties { get; set; } = null!;
