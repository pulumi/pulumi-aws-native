...
namespace Pulumi.AwsNative.Pinpoint
{
    ...
    public partial class EmailTemplate : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EmailTemplateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EmailTemplateProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EmailTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EmailTemplatePropertiesArgs> Properties { get; set; } = null!;
