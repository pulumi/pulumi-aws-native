...
namespace Pulumi.AwsNative.Pinpoint
{
    ...
    public partial class EventStream : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EventStreamAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EventStreamProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EventStreamArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EventStreamPropertiesArgs> Properties { get; set; } = null!;
