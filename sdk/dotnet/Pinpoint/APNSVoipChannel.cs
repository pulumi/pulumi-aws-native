...
namespace Pulumi.Cloudformation.Pinpoint
{
    ...
    public partial class APNSVoipChannel : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.APNSVoipChannelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.APNSVoipChannelProperties> Properties { get; private set; } = null!;
    ...
    public sealed class APNSVoipChannelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.APNSVoipChannelPropertiesArgs> Properties { get; set; } = null!;
