...
namespace Pulumi.AwsNative.EMR
{
    ...
    public partial class SecurityConfiguration : Pulumi.CustomResource
    {
        ...
        public Output<Union<System.Text.Json.JsonElement, string>> SecurityConfigurationValue { get; private set; } = null!;
    ...
    public sealed class SecurityConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<System.Text.Json.JsonElement, string> SecurityConfigurationValue { get; set; } = null!;
