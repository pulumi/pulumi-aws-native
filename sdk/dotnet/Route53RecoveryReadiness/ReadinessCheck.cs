...
namespace Pulumi.AwsNative.Route53RecoveryReadiness
{
    ...
    public partial class ReadinessCheck : global::Pulumi.CustomResource
    {
        ...
        public ReadinessCheck(string name, ReadinessCheckArgs? args = null, CustomResourceOptions? options = null)
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ReadinessCheck Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
