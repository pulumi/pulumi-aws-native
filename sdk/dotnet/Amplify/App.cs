...
namespace Pulumi.Cloudformation.Amplify
{
    ...
    public partial class App : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.AppAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AppProperties> Properties { get; private set; } = null!;
        ...
        public App(string name, AppArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Amplify:App", name, args ?? new AppArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal App(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Amplify:App", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private App(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Amplify:App", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AppArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AppPropertiesArgs> Properties { get; set; } = null!;
