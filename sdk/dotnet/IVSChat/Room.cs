...
namespace Pulumi.AwsNative.IVSChat
{
    ...
    public partial class Room : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.RoomTag>> Tags { get; private set; } = null!;
    ...
    public sealed class RoomArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.RoomTagArgs>? _tags;

        /// <summary>
        /// An array of key-value pairs to apply to this resource.
        /// </summary>
        public InputList<Inputs.RoomTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.RoomTagArgs>());
            set => _tags = value;
        }
