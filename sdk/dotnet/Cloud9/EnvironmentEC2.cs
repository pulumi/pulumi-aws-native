...
namespace Pulumi.Cloudformation.Cloud9
{
    ...
    public partial class EnvironmentEC2 : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EnvironmentEC2Attributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EnvironmentEC2Properties> Properties { get; private set; } = null!;
    ...
    public sealed class EnvironmentEC2Args : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EnvironmentEC2PropertiesArgs> Properties { get; set; } = null!;
