...
namespace Pulumi.AwsNative.IoT1Click
{
    ...
    public partial class Placement : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PlacementAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PlacementProperties> Properties { get; private set; } = null!;
    ...
    public sealed class PlacementArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PlacementPropertiesArgs> Properties { get; set; } = null!;
