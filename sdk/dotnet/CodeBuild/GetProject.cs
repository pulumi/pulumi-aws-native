...
namespace Pulumi.AwsNative.CodeBuild
{
    public static class GetProject
    {
        ...
        public static Task<GetProjectResult> InvokeAsync(GetProjectArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectResult>("aws-native:codebuild:getProject", args ?? new GetProjectArgs(), options.WithDefaults());

        /// <summary>
        /// Resource Type definition for AWS::CodeBuild::Project
        /// </summary>
        public static Output<GetProjectResult> Invoke(GetProjectInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectResult>("aws-native:codebuild:getProject", args ?? new GetProjectInvokeArgs(), options.WithDefaults());
    }
