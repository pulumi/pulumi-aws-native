...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGateway:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Deployment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Deployment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
