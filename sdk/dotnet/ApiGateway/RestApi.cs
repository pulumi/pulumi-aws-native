...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class RestApi : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RestApiAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RestApiProperties> Properties { get; private set; } = null!;
        ...
        public RestApi(string name, RestApiArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:RestApi", name, args ?? new RestApiArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal RestApi(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:RestApi", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RestApi(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:RestApi", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RestApiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RestApiPropertiesArgs> Properties { get; set; } = null!;
