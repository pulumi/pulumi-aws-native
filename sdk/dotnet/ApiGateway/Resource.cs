...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResourceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResourceProperties> Properties { get; private set; } = null!;
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Resource(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Resource", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResourceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResourcePropertiesArgs> Properties { get; set; } = null!;
