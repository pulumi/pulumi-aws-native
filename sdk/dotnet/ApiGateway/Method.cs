...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class Method : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MethodAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MethodProperties> Properties { get; private set; } = null!;
    ...
    public sealed class MethodArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MethodPropertiesArgs> Properties { get; set; } = null!;
