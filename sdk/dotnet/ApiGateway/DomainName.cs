...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class DomainName : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DomainNameAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DomainNameProperties> Properties { get; private set; } = null!;
        ...
        public DomainName(string name, DomainNameArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DomainName", name, args ?? new DomainNameArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DomainName(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DomainName", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DomainName(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DomainName", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainNameArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DomainNamePropertiesArgs> Properties { get; set; } = null!;
