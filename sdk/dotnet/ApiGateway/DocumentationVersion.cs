...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGateway:DocumentationVersion")]
    public partial class DocumentationVersion : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DocumentationVersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DocumentationVersionProperties> Properties { get; private set; } = null!;
        ...
        public DocumentationVersion(string name, DocumentationVersionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DocumentationVersion", name, args ?? new DocumentationVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DocumentationVersion(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DocumentationVersion", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DocumentationVersion(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:DocumentationVersion", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DocumentationVersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DocumentationVersionPropertiesArgs> Properties { get; set; } = null!;
