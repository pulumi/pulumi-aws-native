...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class UsagePlan : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.UsagePlanAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.UsagePlanProperties> Properties { get; private set; } = null!;
    ...
    public sealed class UsagePlanArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.UsagePlanPropertiesArgs> Properties { get; set; } = null!;
