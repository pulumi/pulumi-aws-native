...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class RequestValidator : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RequestValidatorAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RequestValidatorProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RequestValidatorArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RequestValidatorPropertiesArgs> Properties { get; set; } = null!;
