...
namespace Pulumi.Cloudformation.ApiGateway
{
    ...
    public partial class ClientCertificate : Pulumi.CustomResource
    {
        ...
        public ClientCertificate(string name, ClientCertificateArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:ClientCertificate", name, args ?? new ClientCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ClientCertificate(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:ClientCertificate", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ClientCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGateway:ClientCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
