...
namespace Pulumi.AwsNative.MediaTailor.Inputs
{
    ...
    /// </summary>
    public sealed class LiveSourceHttpPackageConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.AwsNative.MediaTailor.LiveSourceType> Type { get; set; } = null!;

        public LiveSourceHttpPackageConfigurationArgs()
        {
        }
        public static new LiveSourceHttpPackageConfigurationArgs Empty => new LiveSourceHttpPackageConfigurationArgs();
    }
}
