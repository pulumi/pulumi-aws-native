...
namespace Pulumi.Cloudformation.Glue
{
    ...
    public partial class MLTransform : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MLTransformAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MLTransformProperties> Properties { get; private set; } = null!;
    ...
    public sealed class MLTransformArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MLTransformPropertiesArgs> Properties { get; set; } = null!;
