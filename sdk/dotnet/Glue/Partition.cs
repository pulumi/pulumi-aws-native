...
namespace Pulumi.Cloudformation.Glue
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Glue:Partition")]
    public partial class Partition : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.PartitionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.PartitionProperties> Properties { get; private set; } = null!;
        ...
        public Partition(string name, PartitionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Partition", name, args ?? new PartitionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Partition(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Partition", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Partition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Partition", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PartitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.PartitionPropertiesArgs> Properties { get; set; } = null!;
