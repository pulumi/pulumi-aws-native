...
namespace Pulumi.Cloudformation.Glue
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Glue:SchemaVersionMetadata")]
    public partial class SchemaVersionMetadata : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SchemaVersionMetadataAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SchemaVersionMetadataProperties> Properties { get; private set; } = null!;
        ...
        public SchemaVersionMetadata(string name, SchemaVersionMetadataArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:SchemaVersionMetadata", name, args ?? new SchemaVersionMetadataArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal SchemaVersionMetadata(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:SchemaVersionMetadata", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private SchemaVersionMetadata(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:SchemaVersionMetadata", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchemaVersionMetadataArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SchemaVersionMetadataPropertiesArgs> Properties { get; set; } = null!;
