...
namespace Pulumi.AwsNative.Glue
{
    ...
    /// </summary>
    [Obsolete(@"Database is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.")]
    ...
    public partial class Database : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.DatabaseDatabaseInput> DatabaseInput { get; private set; } = null!;
