...
namespace Pulumi.Cloudformation.Glue
{
    ...
    public partial class Job : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.JobAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.JobProperties> Properties { get; private set; } = null!;
        ...
        public Job(string name, JobArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Job", name, args ?? new JobArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Job(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Job", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Job(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Job", name, null, MakeResourceOptions(options, id))
        {
        }
