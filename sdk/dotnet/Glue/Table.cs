...
namespace Pulumi.Cloudformation.Glue
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:Glue:Table")]
    public partial class Table : Pulumi.CustomResource
    {
        ...
        public Table(string name, TableArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Table", name, args ?? new TableArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Table(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Table", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Table(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Glue:Table", name, null, MakeResourceOptions(options, id))
        {
        }
