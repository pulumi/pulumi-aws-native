...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGatewayV2:Model")]
    public partial class Model : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ModelAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ModelProperties> Properties { get; private set; } = null!;
        ...
        public Model(string name, ModelArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Model", name, args ?? new ModelArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Model(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Model", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Model(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Model", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ModelArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ModelPropertiesArgs> Properties { get; set; } = null!;
