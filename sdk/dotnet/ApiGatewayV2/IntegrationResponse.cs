...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    public partial class IntegrationResponse : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.IntegrationResponseAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.IntegrationResponseProperties> Properties { get; private set; } = null!;
        ...
        public IntegrationResponse(string name, IntegrationResponseArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:IntegrationResponse", name, args ?? new IntegrationResponseArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal IntegrationResponse(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:IntegrationResponse", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private IntegrationResponse(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:IntegrationResponse", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class IntegrationResponseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.IntegrationResponsePropertiesArgs> Properties { get; set; } = null!;
