...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGatewayV2:Deployment")]
    public partial class Deployment : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DeploymentAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DeploymentProperties> Properties { get; private set; } = null!;
        ...
        public Deployment(string name, DeploymentArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Deployment", name, args ?? new DeploymentArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Deployment(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Deployment", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Deployment(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Deployment", name, null, MakeResourceOptions(options, id))
        {
        }
