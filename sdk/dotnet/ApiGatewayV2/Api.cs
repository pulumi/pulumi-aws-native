...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGatewayV2:Api")]
    public partial class Api : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ApiAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ApiProperties> Properties { get; private set; } = null!;
        ...
        public Api(string name, ApiArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Api", name, args ?? new ApiArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Api(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Api", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Api(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Api", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ApiArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ApiPropertiesArgs> Properties { get; set; } = null!;
