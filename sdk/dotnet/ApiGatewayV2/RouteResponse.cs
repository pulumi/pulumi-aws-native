...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ApiGatewayV2:RouteResponse")]
    public partial class RouteResponse : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RouteResponseAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RouteResponseProperties> Properties { get; private set; } = null!;
        ...
        public RouteResponse(string name, RouteResponseArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:RouteResponse", name, args ?? new RouteResponseArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal RouteResponse(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:RouteResponse", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private RouteResponse(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:RouteResponse", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RouteResponseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RouteResponsePropertiesArgs> Properties { get; set; } = null!;
