...
namespace Pulumi.Cloudformation.ApiGatewayV2
{
    ...
    public partial class Authorizer : Pulumi.CustomResource
    {
        ...
        public Authorizer(string name, AuthorizerArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Authorizer", name, args ?? new AuthorizerArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Authorizer(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Authorizer", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Authorizer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ApiGatewayV2:Authorizer", name, null, MakeResourceOptions(options, id))
        {
        }
