...
namespace Pulumi.Cloudformation.ManagedBlockchain
{
    /// <summary>
    ...
    public partial class Member : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.MemberAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.MemberProperties> Properties { get; private set; } = null!;
        ...
        public Member(string name, MemberArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ManagedBlockchain:Member", name, args ?? new MemberArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Member(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ManagedBlockchain:Member", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Member(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ManagedBlockchain:Member", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MemberArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MemberPropertiesArgs> Properties { get; set; } = null!;
