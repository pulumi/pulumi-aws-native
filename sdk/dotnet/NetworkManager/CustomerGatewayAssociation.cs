...
namespace Pulumi.Cloudformation.NetworkManager
{
    ...
    public partial class CustomerGatewayAssociation : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CustomerGatewayAssociationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CustomerGatewayAssociationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class CustomerGatewayAssociationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CustomerGatewayAssociationPropertiesArgs> Properties { get; set; } = null!;
