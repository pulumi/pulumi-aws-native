...
namespace Pulumi.AwsNative.QLDB
{
    ...
    public partial class Ledger : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LedgerAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LedgerProperties> Properties { get; private set; } = null!;
    ...
    public sealed class LedgerArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LedgerPropertiesArgs> Properties { get; set; } = null!;
