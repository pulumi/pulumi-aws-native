...
namespace Pulumi.AwsNative.CloudWatch.Inputs
{
    ...
    /// </summary>
    public sealed class LogAlarmWarmUpConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("warmUpPeriodDurationInMinutes")]
        public Input<int>? WarmUpPeriodDurationInMinutes { get; set; }

        public LogAlarmWarmUpConfigurationArgs()
        {
        }
        public static new LogAlarmWarmUpConfigurationArgs Empty => new LogAlarmWarmUpConfigurationArgs();
    }
}
