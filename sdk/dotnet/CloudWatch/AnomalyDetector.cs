...
namespace Pulumi.Cloudformation.CloudWatch
{
    ...
    public partial class AnomalyDetector : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.AnomalyDetectorAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AnomalyDetectorProperties> Properties { get; private set; } = null!;
    ...
    public sealed class AnomalyDetectorArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AnomalyDetectorPropertiesArgs> Properties { get; set; } = null!;
