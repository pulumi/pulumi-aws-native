...
namespace Pulumi.AwsNative.CodePipeline
{
    ...
    public partial class Webhook : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.WebhookAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.WebhookProperties> Properties { get; private set; } = null!;
    ...
    public sealed class WebhookArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.WebhookPropertiesArgs> Properties { get; set; } = null!;
