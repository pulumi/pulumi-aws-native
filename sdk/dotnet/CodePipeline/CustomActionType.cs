...
namespace Pulumi.AwsNative.CodePipeline
{
    ...
    public partial class CustomActionType : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.CustomActionTypeAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.CustomActionTypeProperties> Properties { get; private set; } = null!;
    ...
    public sealed class CustomActionTypeArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.CustomActionTypePropertiesArgs> Properties { get; set; } = null!;
