...
namespace Pulumi.Cloudformation.RDS
{
    ...
    public partial class DBSecurityGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.DBSecurityGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.DBSecurityGroupProperties> Properties { get; private set; } = null!;
        ...
        public DBSecurityGroup(string name, DBSecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:RDS:DBSecurityGroup", name, args ?? new DBSecurityGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal DBSecurityGroup(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:RDS:DBSecurityGroup", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private DBSecurityGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:RDS:DBSecurityGroup", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DBSecurityGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DBSecurityGroupPropertiesArgs> Properties { get; set; } = null!;
