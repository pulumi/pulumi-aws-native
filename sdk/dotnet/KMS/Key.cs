...
namespace Pulumi.Cloudformation.KMS
{
    ...
    public partial class Key : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.KeyAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.KeyProperties> Properties { get; private set; } = null!;
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:KMS:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Key(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:KMS:Key", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:KMS:Key", name, null, MakeResourceOptions(options, id))
        {
        }
