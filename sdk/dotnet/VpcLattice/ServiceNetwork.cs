...
namespace Pulumi.AwsNative.VpcLattice
{
    ...
    public partial class ServiceNetwork : global::Pulumi.CustomResource
    {
        ...
        [Output("tags")]
        public Output<ImmutableArray<Outputs.ServiceNetworkTag>> Tags { get; private set; } = null!;
    ...
    public sealed class ServiceNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.ServiceNetworkTagArgs>? _tags;
        public InputList<Inputs.ServiceNetworkTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ServiceNetworkTagArgs>());
            set => _tags = value;
        }
