...
namespace Pulumi.AwsNative.AppMesh
{
    ...
    public partial class VirtualNode : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VirtualNodeAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualNodeProperties> Properties { get; private set; } = null!;
    ...
    public sealed class VirtualNodeArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VirtualNodePropertiesArgs> Properties { get; set; } = null!;
