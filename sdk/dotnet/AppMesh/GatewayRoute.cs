...
namespace Pulumi.Cloudformation.AppMesh
{
    ...
    public partial class GatewayRoute : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GatewayRouteAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GatewayRouteProperties> Properties { get; private set; } = null!;
    ...
    public sealed class GatewayRouteArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GatewayRoutePropertiesArgs> Properties { get; set; } = null!;
