...
namespace Pulumi.Cloudformation.AppMesh
{
    ...
    public partial class VirtualService : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VirtualServiceAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualServiceProperties> Properties { get; private set; } = null!;
        ...
        public VirtualService(string name, VirtualServiceArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualService", name, args ?? new VirtualServiceArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VirtualService(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualService", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VirtualService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VirtualServicePropertiesArgs> Properties { get; set; } = null!;
