...
namespace Pulumi.Cloudformation.AppMesh
{
    ...
    public partial class VirtualRouter : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VirtualRouterAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VirtualRouterProperties> Properties { get; private set; } = null!;
        ...
        public VirtualRouter(string name, VirtualRouterArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualRouter", name, args ?? new VirtualRouterArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal VirtualRouter(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualRouter", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VirtualRouter(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppMesh:VirtualRouter", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VirtualRouterArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VirtualRouterPropertiesArgs> Properties { get; set; } = null!;
