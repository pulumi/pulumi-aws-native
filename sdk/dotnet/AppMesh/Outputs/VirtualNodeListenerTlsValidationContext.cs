...
namespace Pulumi.AwsNative.AppMesh.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VirtualNodeListenerTlsValidationContext
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.VirtualNodeListenerTlsValidationContextTrust Trust;

        [OutputConstructor]
        private VirtualNodeListenerTlsValidationContext(
            Outputs.VirtualNodeSubjectAlternativeNames? subjectAlternativeNames,

            Outputs.VirtualNodeListenerTlsValidationContextTrust trust)
        {
