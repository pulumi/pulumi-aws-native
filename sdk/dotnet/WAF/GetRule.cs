...
namespace Pulumi.AwsNative.WAF
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("aws-native:waf:getRule", args ?? new GetRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Resource Type definition for AWS::WAF::Rule
        /// </summary>
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("aws-native:waf:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
    }
