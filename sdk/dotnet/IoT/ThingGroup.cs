...
namespace Pulumi.AwsNative.IoT
{
    ...
    public partial class ThingGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.ThingGroupTag>> Tags { get; private set; } = null!;
    ...
    public sealed class ThingGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("tags")]
        private InputList<Inputs.ThingGroupTagArgs>? _tags;

        /// <summary>
        /// An array of key-value pairs to apply to this resource.
        /// </summary>
        public InputList<Inputs.ThingGroupTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ThingGroupTagArgs>());
            set => _tags = value;
        }
