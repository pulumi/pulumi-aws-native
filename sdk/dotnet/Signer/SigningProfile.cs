...
namespace Pulumi.AwsNative.Signer
{
    ...
    public partial class SigningProfile : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.SigningProfileAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.SigningProfileProperties> Properties { get; private set; } = null!;
    ...
    public sealed class SigningProfileArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SigningProfilePropertiesArgs> Properties { get; set; } = null!;
