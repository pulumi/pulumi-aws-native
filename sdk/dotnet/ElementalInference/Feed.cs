...
namespace Pulumi.AwsNative.ElementalInference
{
    ...
    public partial class Feed : global::Pulumi.CustomResource
    {
        ...
        [Output("dataEndpoints")]
        public Output<ImmutableArray<string>> DataEndpoints { get; private set; } = null!;

        [Output("name")]
        public Output<string> Name { get; private set; } = null!;

        [Output("outputs")]
        public Output<ImmutableArray<Outputs.FeedGetOutput>> Outputs { get; private set; } = null!;
        ...
        public Feed(string name, FeedArgs args, CustomResourceOptions? options = null)
            : base("aws-native:elementalinference:Feed", name, args ?? new FeedArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Feed(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("aws-native:elementalinference:Feed", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FeedArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.FeedGetOutputArgs>? _outputs;
        public InputList<Inputs.FeedGetOutputArgs> Outputs
        {
            get => _outputs ?? (_outputs = new InputList<Inputs.FeedGetOutputArgs>());
            set => _outputs = value;
        }
