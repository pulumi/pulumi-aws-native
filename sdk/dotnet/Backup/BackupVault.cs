...
namespace Pulumi.Cloudformation.Backup
{
    ...
    public partial class BackupVault : Pulumi.CustomResource
    {
        ...
        public BackupVault(string name, BackupVaultArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Backup:BackupVault", name, args ?? new BackupVaultArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal BackupVault(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Backup:BackupVault", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private BackupVault(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Backup:BackupVault", name, null, MakeResourceOptions(options, id))
        {
        }
