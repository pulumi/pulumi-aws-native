...
namespace Pulumi.Cloudformation.Backup
{
    ...
    public partial class BackupSelection : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.BackupSelectionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.BackupSelectionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class BackupSelectionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BackupSelectionPropertiesArgs> Properties { get; set; } = null!;
