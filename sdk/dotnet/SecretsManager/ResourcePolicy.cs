...
namespace Pulumi.Cloudformation.SecretsManager
{
    ...
    public partial class ResourcePolicy : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResourcePolicyAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResourcePolicyProperties> Properties { get; private set; } = null!;
    ...
    public sealed class ResourcePolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResourcePolicyPropertiesArgs> Properties { get; set; } = null!;
