...
namespace Pulumi.AwsNative.SecretsManager
{
    ...
    public partial class RotationSchedule : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.RotationScheduleAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.RotationScheduleProperties> Properties { get; private set; } = null!;
    ...
    public sealed class RotationScheduleArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RotationSchedulePropertiesArgs> Properties { get; set; } = null!;
