...
namespace Pulumi.AwsNative.QuickSight.Outputs
{
    ...
    public sealed class AnalysisValidationStrategy
    {
        ...
        /// </summary>
        public readonly Pulumi.AwsNative.QuickSight.AnalysisValidationStrategyMode Mode;

        [OutputConstructor]
        private AnalysisValidationStrategy(Pulumi.AwsNative.QuickSight.AnalysisValidationStrategyMode mode)
        {
            Mode = mode;
        }
    }
