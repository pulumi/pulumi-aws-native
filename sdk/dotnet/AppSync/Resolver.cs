...
namespace Pulumi.Cloudformation.AppSync
{
    ...
    public partial class Resolver : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ResolverAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ResolverProperties> Properties { get; private set; } = null!;
        ...
        public Resolver(string name, ResolverArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:Resolver", name, args ?? new ResolverArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Resolver(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:Resolver", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Resolver(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:Resolver", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResolverArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ResolverPropertiesArgs> Properties { get; set; } = null!;
