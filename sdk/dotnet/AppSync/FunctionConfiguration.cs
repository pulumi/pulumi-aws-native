...
namespace Pulumi.Cloudformation.AppSync
{
    ...
    public partial class FunctionConfiguration : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FunctionConfigurationAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FunctionConfigurationProperties> Properties { get; private set; } = null!;
    ...
    public sealed class FunctionConfigurationArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FunctionConfigurationPropertiesArgs> Properties { get; set; } = null!;
