...
namespace Pulumi.Cloudformation.AppSync
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:AppSync:GraphQLSchema")]
    public partial class GraphQLSchema : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.GraphQLSchemaAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.GraphQLSchemaProperties> Properties { get; private set; } = null!;
        ...
        public GraphQLSchema(string name, GraphQLSchemaArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:GraphQLSchema", name, args ?? new GraphQLSchemaArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal GraphQLSchema(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:GraphQLSchema", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private GraphQLSchema(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:AppSync:GraphQLSchema", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GraphQLSchemaArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GraphQLSchemaPropertiesArgs> Properties { get; set; } = null!;
