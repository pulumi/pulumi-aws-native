...
namespace Pulumi.Cloudformation.ElasticLoadBalancingV2
{
    ...
    public partial class TargetGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.TargetGroupAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.TargetGroupProperties> Properties { get; private set; } = null!;
    ...
    public sealed class TargetGroupArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.TargetGroupPropertiesArgs> Properties { get; set; } = null!;
