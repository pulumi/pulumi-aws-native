...
namespace Pulumi.Cloudformation.ElasticLoadBalancingV2
{
    ...
    /// </summary>
    [CloudformationResourceType("cloudformation:ElasticLoadBalancingV2:ListenerCertificate")]
    public partial class ListenerCertificate : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.ListenerCertificateAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.ListenerCertificateProperties> Properties { get; private set; } = null!;
        ...
        public ListenerCertificate(string name, ListenerCertificateArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticLoadBalancingV2:ListenerCertificate", name, args ?? new ListenerCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal ListenerCertificate(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticLoadBalancingV2:ListenerCertificate", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private ListenerCertificate(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:ElasticLoadBalancingV2:ListenerCertificate", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ListenerCertificateArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ListenerCertificatePropertiesArgs> Properties { get; set; } = null!;
