...
namespace Pulumi.AwsNative.IoTFleetWise.Inputs
{
    ...
    public sealed class SignalCatalogAttributeArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedValues")]
        ...
        [Input("assignedValue")]
        public Input<string>? AssignedValue { get; set; }
        ...
        public SignalCatalogAttributeArgs()
        {
        }
        public static new SignalCatalogAttributeArgs Empty => new SignalCatalogAttributeArgs();
    }
}
