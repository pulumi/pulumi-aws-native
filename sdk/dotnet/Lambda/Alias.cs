...
namespace Pulumi.Cloudformation.Lambda
{
    ...
    public partial class Alias : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.AliasAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.AliasProperties> Properties { get; private set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Output("updatePolicy")]
        public Output<Outputs.AliasUpdatePolicy?> UpdatePolicy { get; private set; } = null!;
    ...
    public sealed class AliasArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AliasPropertiesArgs> Properties { get; set; } = null!;

        /// <summary>
        /// The update policy associated with the resource
        /// </summary>
        [Input("updatePolicy")]
        public Input<Inputs.AliasUpdatePolicyArgs>? UpdatePolicy { get; set; }
