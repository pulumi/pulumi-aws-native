...
namespace Pulumi.Cloudformation.Lambda
{
    ...
    public partial class Function : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.FunctionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.FunctionProperties> Properties { get; private set; } = null!;
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("cloudformation:Lambda:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }
        internal Function(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("cloudformation:Lambda:Function", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("cloudformation:Lambda:Function", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class FunctionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.FunctionPropertiesArgs> Properties { get; set; } = null!;
