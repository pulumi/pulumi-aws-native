...
namespace Pulumi.Cloudformation.Lambda
{
    ...
    public partial class EventInvokeConfig : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.EventInvokeConfigAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.EventInvokeConfigProperties> Properties { get; private set; } = null!;
    ...
    public sealed class EventInvokeConfigArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.EventInvokeConfigPropertiesArgs> Properties { get; set; } = null!;
