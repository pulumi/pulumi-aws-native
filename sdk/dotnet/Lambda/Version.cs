...
namespace Pulumi.AwsNative.Lambda
{
    ...
    public partial class Version : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.VersionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.VersionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class VersionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.VersionPropertiesArgs> Properties { get; set; } = null!;
