...
namespace Pulumi.Cloudformation.Lambda
{
    ...
    public partial class LayerVersionPermission : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("attributes")]
        public Output<Outputs.LayerVersionPermissionAttributes> Attributes { get; private set; } = null!;
        ...
        /// </summary>
        [Output("properties")]
        public Output<Outputs.LayerVersionPermissionProperties> Properties { get; private set; } = null!;
    ...
    public sealed class LayerVersionPermissionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.LayerVersionPermissionPropertiesArgs> Properties { get; set; } = null!;
