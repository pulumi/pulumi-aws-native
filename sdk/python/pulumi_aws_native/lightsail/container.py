...
class Container(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(container_service_deployment, ContainerServiceDeploymentArgs):
            ...
            if not isinstance(private_registry_access, ContainerPrivateRegistryAccessArgs):
