...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] blueprint_id: The ID for a virtual private server image (e.g., app_wordpress_4_4 or app_lamp_7_0 ). Use the get blueprints operation to return a list of available images (or blueprints ).
        :param pulumi.Input[builtins.str] bundle_id: The bundle of specification information for your virtual private server (or instance ), including the pricing plan (e.g., micro_1_0 ).
        ...
        :param pulumi.Input[builtins.str] instance_name: The names to use for your new Lightsail instance.
        :param pulumi.Input[builtins.str] key_pair_name: The name of your key pair.
        ...
        :param pulumi.Input[builtins.str] user_data: A launch script you can create that configures a server with additional user data. For example, you might want to run apt-get -y update.
        """
