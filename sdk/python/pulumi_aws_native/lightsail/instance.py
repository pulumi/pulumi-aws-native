...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(hardware, InstanceHardwareArgs):
            ...
            if not isinstance(location, InstanceLocationArgs):
                location = location or {}
                def _setter(key, value):
                    location[key] = value
                InstanceLocationArgs._configure(_setter, **location)
            __props__.__dict__["location"] = location
            if not isinstance(networking, InstanceNetworkingArgs):
            ...
            if not isinstance(state, InstanceStateArgs):
                state = state or {}
                def _setter(key, value):
                    state[key] = value
