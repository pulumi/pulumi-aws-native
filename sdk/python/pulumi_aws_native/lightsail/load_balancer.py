...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_address_type: The IP address type for the load balancer. The possible values are ipv4 for IPv4 only, and dualstack for IPv4 and IPv6. The default value is dualstack.
...
class LoadBalancer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sessionStickinessEnabled")
    def session_stickiness_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Configuration option to enable session stickiness.
        """
        return pulumi.get(self, "session_stickiness_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="sessionStickinessLbCookieDurationSeconds")
    def session_stickiness_lb_cookie_duration_seconds(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Configuration option to adjust session stickiness cookie duration parameter.
        """
        return pulumi.get(self, "session_stickiness_lb_cookie_duration_seconds")
    ...
    @_builtins.property
    @pulumi.getter(name="tlsPolicyName")
    def tls_policy_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the TLS policy to apply to the load balancer.
        """
        return pulumi.get(self, "tls_policy_name")
