...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: The domain name (e.g., example.com ) for the certificate.
        :param pulumi.Input[builtins.str] certificate_name: The name for the certificate.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subject_alternative_names: An array of strings that specify the alternate domains (e.g., example2.com) and subdomains (e.g., blog.example.com) for the certificate.
...
class Certificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="subjectAlternativeNames")
    def subject_alternative_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of strings that specify the alternate domains (e.g., example2.com) and subdomains (e.g., blog.example.com) for the certificate.
        """
        return pulumi.get(self, "subject_alternative_names")
