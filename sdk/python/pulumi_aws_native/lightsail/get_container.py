...
class GetContainerResult:
    ...
    def container_arn(self) -> Optional[builtins.str]:
        """
...
def get_container(service_name: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContainerResult:
    """
    Resource Type definition for AWS::Lightsail::Container


    :param builtins.str service_name: The name for the container service.
    """
    __args__ = dict()
...
def get_container_output(service_name: Optional[pulumi.Input[builtins.str]] = None,
