...
class GetDiskResult:
    ...
    def disk_arn(self) -> Optional[builtins.str]:
        """
...
def get_disk(disk_name: Optional[builtins.str] = None,
...
def get_disk_output(disk_name: Optional[pulumi.Input[builtins.str]] = None,
