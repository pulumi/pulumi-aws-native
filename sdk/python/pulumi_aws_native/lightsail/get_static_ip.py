...
class GetStaticIpResult:
    ...
    def static_ip_arn(self) -> Optional[_builtins.str]:
        """
...
def get_static_ip(static_ip_name: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStaticIpResult:
    """
    Resource Type definition for AWS::Lightsail::StaticIp


    :param _builtins.str static_ip_name: The name of the static IP address.
    """
    __args__ = dict()
...
def get_static_ip_output(static_ip_name: Optional[pulumi.Input[_builtins.str]] = None,
