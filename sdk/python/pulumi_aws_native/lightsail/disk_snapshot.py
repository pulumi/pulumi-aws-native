...
class DiskSnapshotArgs:
    def __init__(__self__, *,
                 ...
                 disk_snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a DiskSnapshot resource.
        :param pulumi.Input[builtins.str] disk_name: The name of the source disk from which the snapshot was created.
        :param pulumi.Input[builtins.str] disk_snapshot_name: The name of the disk snapshot (e.g., my-disk-snapshot).
    ...
    def disk_snapshot_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_snapshot_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiskSnapshot(pulumi.CustomResource):
    ...
    def disk_snapshot_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="diskSnapshotName")
    def disk_snapshot_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the disk snapshot (e.g., my-disk-snapshot).
        """
        return pulumi.get(self, "disk_snapshot_name")
    ...
    def from_disk_name(self) -> pulumi.Output[builtins.str]:
        """
