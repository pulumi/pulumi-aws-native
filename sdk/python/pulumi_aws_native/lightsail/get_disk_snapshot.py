...
class GetDiskSnapshotResult:
    ...
    def disk_snapshot_arn(self) -> Optional[builtins.str]:
        """
    ...
    def from_disk_name(self) -> Optional[builtins.str]:
        """
...
def get_disk_snapshot(disk_snapshot_name: Optional[builtins.str] = None,
    ...
    :param builtins.str disk_snapshot_name: The name of the disk snapshot (e.g., my-disk-snapshot).
    """
    __args__ = dict()
...
def get_disk_snapshot_output(disk_snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
