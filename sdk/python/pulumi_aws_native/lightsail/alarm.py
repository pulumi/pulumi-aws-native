...
class AlarmArgs:
    def __init__(__self__, *,
                 ...
                 monitored_resource_name: pulumi.Input[builtins.str],
                 threshold: pulumi.Input[builtins.float],
                 alarm_name: Optional[pulumi.Input[builtins.str]] = None,
                 contact_protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] comparison_operator: The arithmetic operation to use when comparing the specified statistic to the threshold. The specified statistic value is used as the first operand.
        :param pulumi.Input[builtins.int] evaluation_periods: The number of most recent periods over which data is compared to the specified threshold. If you are setting an "M out of N" alarm, this value (evaluationPeriods) is the N.
        :param pulumi.Input[builtins.str] metric_name: The name of the metric to associate with the alarm.
        :param pulumi.Input[builtins.str] monitored_resource_name: The name of the Lightsail resource that the alarm monitors.
        :param pulumi.Input[builtins.float] threshold: The value against which the specified statistic is compared.
        :param pulumi.Input[builtins.str] alarm_name: The name for the alarm. Specify the name of an existing alarm to update, and overwrite the previous configuration of the alarm.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_protocols: The contact protocols to use for the alarm, such as Email, SMS (text messaging), or both.
        :param pulumi.Input[builtins.int] datapoints_to_alarm: The number of data points that must be not within the specified threshold to trigger the alarm. If you are setting an "M out of N" alarm, this value (datapointsToAlarm) is the M.
        :param pulumi.Input[builtins.bool] notification_enabled: Indicates whether the alarm is enabled. Notifications are enabled by default if you don't specify this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_triggers: The alarm states that trigger a notification.
        :param pulumi.Input[builtins.str] treat_missing_data: Sets how this alarm will handle missing data points.
        """
    ...
    def monitored_resource_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def monitored_resource_name(self, value: pulumi.Input[builtins.str]):
    ...
    def contact_protocols(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def contact_protocols(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Alarm(pulumi.CustomResource):
    ...
    def alarm_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="contactProtocols")
    def contact_protocols(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The contact protocols to use for the alarm, such as Email, SMS (text messaging), or both.
        """
        return pulumi.get(self, "contact_protocols")
    ...
    @property
    @pulumi.getter(name="monitoredResourceName")
    def monitored_resource_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Lightsail resource that the alarm monitors.
        """
        return pulumi.get(self, "monitored_resource_name")
    ...
    @property
    @pulumi.getter(name="notificationEnabled")
    def notification_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the alarm is enabled. Notifications are enabled by default if you don't specify this parameter.
        """
        return pulumi.get(self, "notification_enabled")
    ...
    @property
    @pulumi.getter(name="notificationTriggers")
    def notification_triggers(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The alarm states that trigger a notification.
        """
        return pulumi.get(self, "notification_triggers")
