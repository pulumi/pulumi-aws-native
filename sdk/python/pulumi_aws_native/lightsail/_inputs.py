...
class ContainerHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] success_codes: The HTTP codes to use when checking for a successful response from a container. You can specify values between 200 and 499. You can specify multiple values (for example, 200,202) or a range of values (for example, 200-299).
        :param pulumi.Input[_builtins.int] timeout_seconds: The amount of time, in seconds, during which no response means a failed health check. You can specify between 2 and 60 seconds. The default value is 2.
        :param pulumi.Input[_builtins.int] unhealthy_threshold: The number of consecutive health check failures required before moving the container to the Unhealthy state. The default value is 2.
        """
...
class ContainerPrivateRegistryAccessArgsDict(TypedDict):
    ...
    """
    ecr_image_puller_role: NotRequired[pulumi.Input[Optional['ContainerPrivateRegistryAccessEcrImagePullerRolePropertiesArgs']]]
    """
    An object to describe a request to activate or deactivate the role that you can use to grant an Amazon Lightsail container service access to Amazon Elastic Container Registry (Amazon ECR) private repositories.
    """
...
class ContainerPublicEndpointArgsDict(TypedDict):
    ...
    """
    health_check_config: NotRequired[pulumi.Input[Optional['ContainerHealthCheckConfigArgs']]]
    """
...
class ContainerServiceDeploymentArgsDict(TypedDict):
    ...
    An object that describes the configuration for the containers of the deployment.
    """
    public_endpoint: NotRequired[pulumi.Input[Optional['ContainerPublicEndpointArgs']]]
    """
...
class ContainerArgsDict(TypedDict):
    ...
    """
    environment: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContainerEnvironmentVariableArgs']]]]]
    """
    ...
    """
    ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContainerPortInfoArgs']]]]]
    """
    The open firewall ports of the container.
    """
...
class DatabaseRelationalDatabaseParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] data_type: Specifies the valid data type for the parameter.
        :param pulumi.Input[_builtins.str] description: Provides a description of the parameter.
        :param pulumi.Input[_builtins.bool] is_modifiable: A Boolean value indicating whether the parameter can be modified.
        :param pulumi.Input[_builtins.str] parameter_name: Specifies the name of the parameter.
        :param pulumi.Input[_builtins.str] parameter_value: Specifies the value of the parameter.
        """
...
class DiskAddOnArgsDict(TypedDict):
    ...
    The add-on type
    """
    auto_snapshot_add_on_request: NotRequired[pulumi.Input[Optional['DiskAutoSnapshotAddOnArgs']]]
    """
...
class DiskAddOnArgs:
    ...
    def add_on_type(self) -> pulumi.Input[_builtins.str]:
        """
        The add-on type
        """
    ...
    @add_on_type.setter
    def add_on_type(self, value: pulumi.Input[_builtins.str]):
...
class InstanceAddOnArgsDict(TypedDict):
    ...
    The add-on type
    """
    auto_snapshot_add_on_request: NotRequired[pulumi.Input[Optional['InstanceAutoSnapshotAddOnArgs']]]
    """
    The parameters for the automatic snapshot add-on, such as the daily time when an automatic snapshot will be created.
    """
...
class InstanceDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] attachment_state: Attachment state of the disk.
        :param pulumi.Input[_builtins.int] iops: IOPS of disk.
        :param pulumi.Input[_builtins.bool] is_system_disk: Is the Attached disk is the system disk of the Instance.
        :param pulumi.Input[_builtins.str] size_in_gb: Size of the disk attached to the Instance.
        """
...
class InstanceHardwareArgsDict(TypedDict):
    ...
    """
    disks: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InstanceDiskArgs']]]]]
    """
...
class InstanceNetworkingArgsDict(TypedDict):
    ...
    """
    monthly_transfer: NotRequired[pulumi.Input[Optional['InstanceMonthlyTransferArgs']]]
    """
...
class InstancePortArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cidr_list_aliases: An alias that defines access for a preconfigured range of IP addresses.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cidrs: The IPv4 address, or range of IPv4 addresses (in CIDR notation) that are allowed to connect to an instance through the ports, and the protocol.
               ...
               - To allow the IP address `192.0.2.44` , specify `192.0.2.44` or `192.0.2.44/32` .
               - To allow the IP addresses `192.0.2.0` to `192.0.2.255` , specify `192.0.2.0/24` .
        :param pulumi.Input[_builtins.str] common_name: CommonName for Protocol of the Instance.
        :param pulumi.Input[_builtins.int] from_port: From Port of the Instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipv6_cidrs: The IPv6 address, or range of IPv6 addresses (in CIDR notation) that are allowed to connect to an instance through the ports, and the protocol. Only devices with an IPv6 address can connect to an instance through IPv6; otherwise, IPv4 should be used.
               
               > The `cidrs` parameter lists the IPv4 addresses that are allowed to connect to an instance.
        :param pulumi.Input[_builtins.str] protocol: Port Protocol of the Instance.
        :param pulumi.Input[_builtins.int] to_port: To Port of the Instance.
        """
