...
__all__ = [
    ...
    'DiskAutoSnapshotAddOnArgsDict',
    'DiskLocationArgs',
    'DiskLocationArgsDict',
    'InstanceAddOnArgs',
    'InstanceAddOnArgsDict',
    'InstanceAutoSnapshotAddOnArgs',
    'InstanceAutoSnapshotAddOnArgsDict',
    'InstanceDiskArgs',
    'InstanceDiskArgsDict',
    'InstanceHardwareArgs',
    'InstanceHardwareArgsDict',
    'InstanceLocationArgs',
    'InstanceLocationArgsDict',
    'InstanceMonthlyTransferArgs',
    'InstanceMonthlyTransferArgsDict',
    'InstanceNetworkingArgs',
    'InstanceNetworkingArgsDict',
    'InstancePortArgs',
    'InstancePortArgsDict',
    'InstanceStateArgs',
...
if not MYPY:
    class BucketAccessRulesArgsDict(TypedDict):
        ...
        """
        allow_public_overrides: NotRequired[pulumi.Input[builtins.bool]]
        """
        A Boolean value that indicates whether the access control list (ACL) permissions that are applied to individual objects override the getObject option that is currently specified.
        """
        get_object: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketAccessRulesArgs:
    def __init__(__self__, *,
                 allow_public_overrides: Optional[pulumi.Input[builtins.bool]] = None,
                 get_object: Optional[pulumi.Input[builtins.str]] = None):
        """
        An object that sets the public accessibility of objects in the specified bucket.
        :param pulumi.Input[builtins.bool] allow_public_overrides: A Boolean value that indicates whether the access control list (ACL) permissions that are applied to individual objects override the getObject option that is currently specified.
        :param pulumi.Input[builtins.str] get_object: Specifies the anonymous access to all objects in a bucket.
        """
    ...
    def allow_public_overrides(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A Boolean value that indicates whether the access control list (ACL) permissions that are applied to individual objects override the getObject option that is currently specified.
        """
    ...
    def allow_public_overrides(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_public_overrides", value)

    @property
    @pulumi.getter(name="getObject")
    def get_object(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the anonymous access to all objects in a bucket.
        """
    ...
    @get_object.setter
    def get_object(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ContainerEnvironmentVariableArgsDict(TypedDict):
        ...
        """
        variable: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ContainerEnvironmentVariableArgs:
    def __init__(__self__, *,
                 ...
                 variable: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] value: The environment variable value.
        :param pulumi.Input[builtins.str] variable: The environment variable key.
        """
    ...
    @property
    @pulumi.getter
    def variable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The environment variable key.
        """
    ...
    @variable.setter
    def variable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContainerHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the health check configuration of an Amazon Lightsail container service.
        :param pulumi.Input[builtins.int] healthy_threshold: The number of consecutive health checks successes required before moving the container to the Healthy state. The default value is 2.
        :param pulumi.Input[builtins.int] interval_seconds: The approximate interval, in seconds, between health checks of an individual container. You can specify between 5 and 300 seconds. The default value is 5.
        :param pulumi.Input[builtins.str] path: The path on the container on which to perform the health check. The default value is /.
        :param pulumi.Input[builtins.str] success_codes: The HTTP codes to use when checking for a successful response from a container. You can specify values between 200 and 499. You can specify multiple values (for example, 200,202) or a range of values (for example, 200-299).
        :param pulumi.Input[builtins.int] timeout_seconds: The amount of time, in seconds, during which no response means a failed health check. You can specify between 2 and 60 seconds. The default value is 2.
        :param pulumi.Input[builtins.int] unhealthy_threshold: The number of consecutive health check failures required before moving the container to the Unhealthy state. The default value is 2.
        """
...
class ContainerPortInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] port: The open firewall ports of the container.
        :param pulumi.Input[builtins.str] protocol: The protocol name for the open ports.
...
class ContainerPrivateRegistryAccessEcrImagePullerRolePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        An object to describe a request to activate or deactivate the role that you can use to grant an Amazon Lightsail container service access to Amazon Elastic Container Registry (Amazon ECR) private repositories.
        :param pulumi.Input[builtins.bool] is_active: A Boolean value that indicates whether to activate the role.
        :param pulumi.Input[builtins.str] principal_arn: The Amazon Resource Name (ARN) of the role, if it is activated.
        """
...
class ContainerPublicDomainNameArgs:
    def __init__(__self__, *,
        ...
        """
        The public domain name to use with the container service, such as example.com and www.example.com.
        :param pulumi.Input[builtins.str] certificate_name: The name of the certificate for the public domains.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_names: An object that describes the configuration for the containers of the deployment.
        """
...
class ContainerArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the settings of a container that will be launched, or that is launched, to an Amazon Lightsail container service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command: The launch command for the container.
        ...
        :param pulumi.Input[builtins.str] image: The name of the image used for the container.
...
if not MYPY:
    class DatabaseRelationalDatabaseParameterArgsDict(TypedDict):
        ...
        """
        apply_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        is_modifiable: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DatabaseRelationalDatabaseParameterArgs:
    def __init__(__self__, *,
                 ...
                 apply_type: Optional[pulumi.Input[builtins.str]] = None,
                 data_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 is_modifiable: Optional[pulumi.Input[builtins.bool]] = None,
                 parameter_name: Optional[pulumi.Input[builtins.str]] = None,
                 parameter_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        Describes the parameters of the database.
        :param pulumi.Input[builtins.str] allowed_values: Specifies the valid range of values for the parameter.
        :param pulumi.Input[builtins.str] apply_method: Indicates when parameter updates are applied. Can be immediate or pending-reboot.
        :param pulumi.Input[builtins.str] apply_type: Specifies the engine-specific parameter type.
        :param pulumi.Input[builtins.str] data_type: Specifies the valid data type for the parameter.
        :param pulumi.Input[builtins.str] description: Provides a description of the parameter.
        :param pulumi.Input[builtins.bool] is_modifiable: A Boolean value indicating whether the parameter can be modified.
        :param pulumi.Input[builtins.str] parameter_name: Specifies the name of the parameter.
        :param pulumi.Input[builtins.str] parameter_value: Specifies the value of the parameter.
        """
    ...
    def apply_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the engine-specific parameter type.
        """
    ...
    @apply_type.setter
    def apply_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_modifiable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A Boolean value indicating whether the parameter can be modified.
        """
    ...
    def is_modifiable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DiskAddOnArgsDict(TypedDict):
        ...
        """
        add_on_type: pulumi.Input[builtins.str]
        """
        The add-on type
        """
...
class DiskAddOnArgs:
    def __init__(__self__, *,
        ...
        """
        A addon associate with a resource.
        :param pulumi.Input[builtins.str] add_on_type: The add-on type
    ...
    def add_on_type(self) -> pulumi.Input[builtins.str]:
        """
        The add-on type
        """
    ...
    @add_on_type.setter
    def add_on_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DiskAutoSnapshotAddOnArgsDict(TypedDict):
        ...
        """
        snapshot_time_of_day: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DiskAutoSnapshotAddOnArgs:
    def __init__(__self__, *,
                 snapshot_time_of_day: Optional[pulumi.Input[builtins.str]] = None):
        """
        An object that represents additional parameters when enabling or modifying the automatic snapshot add-on
        :param pulumi.Input[builtins.str] snapshot_time_of_day: The daily time when an automatic snapshot will be created.
        """
    ...
    def snapshot_time_of_day(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The daily time when an automatic snapshot will be created.
        """
    ...
    def snapshot_time_of_day(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiskLocationArgs:
    def __init__(__self__, *,
        ...
        """
        Location of a resource.
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone in which to create your disk. Use the following format: us-east-2a (case sensitive). Be sure to add the include Availability Zones parameter to your request.
        :param pulumi.Input[builtins.str] region_name: The Region Name in which to create your disk.
        """
...
if not MYPY:
    class InstanceDiskArgsDict(TypedDict):
        ...
        """
        attached_to: NotRequired[pulumi.Input[builtins.str]]
        """
        Instance attached to the disk.
        """
        attachment_state: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        IOPS of disk.
        """
        is_system_disk: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is the Attached disk is the system disk of the Instance.
        """
        size_in_gb: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceDiskArgs:
    def __init__(__self__, *,
                 ...
                 attachment_state: Optional[pulumi.Input[builtins.str]] = None,
                 iops: Optional[pulumi.Input[builtins.int]] = None,
                 is_system_disk: Optional[pulumi.Input[builtins.bool]] = None,
                 size_in_gb: Optional[pulumi.Input[builtins.str]] = None):
        """
        Disk associated with the Instance.
        :param pulumi.Input[builtins.str] disk_name: The names to use for your new Lightsail disk.
        :param pulumi.Input[builtins.str] path: Path of the disk attached to the instance.
        :param pulumi.Input[builtins.str] attached_to: Instance attached to the disk.
        :param pulumi.Input[builtins.str] attachment_state: Attachment state of the disk.
        :param pulumi.Input[builtins.int] iops: IOPS of disk.
        :param pulumi.Input[builtins.bool] is_system_disk: Is the Attached disk is the system disk of the Instance.
        :param pulumi.Input[builtins.str] size_in_gb: Size of the disk attached to the Instance.
        """
    ...
    def attachment_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Attachment state of the disk.
        """
    ...
    def attachment_state(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_system_disk(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is the Attached disk is the system disk of the Instance.
        """
    ...
    def is_system_disk(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_system_disk", value)

    @property
    @pulumi.getter(name="sizeInGb")
    def size_in_gb(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Size of the disk attached to the Instance.
        """
    ...
    @size_in_gb.setter
    def size_in_gb(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceHardwareArgsDict(TypedDict):
        ...
        """
        ram_size_in_gb: NotRequired[pulumi.Input[builtins.int]]
        """
...
class InstanceHardwareArgs:
    def __init__(__self__, *,
                 ...
                 ram_size_in_gb: Optional[pulumi.Input[builtins.int]] = None):
        """
        Hardware of the Instance.
        :param pulumi.Input[builtins.int] cpu_count: CPU count of the Instance.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceDiskArgs']]] disks: Disks attached to the Instance.
        :param pulumi.Input[builtins.int] ram_size_in_gb: RAM Size of the Instance.
        """
    ...
    def ram_size_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        RAM Size of the Instance.
        """
    ...
    def ram_size_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
...
class InstanceLocationArgs:
    def __init__(__self__, *,
        ...
        """
        Location of a resource.
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone in which to create your instance. Use the following format: us-east-2a (case sensitive). Be sure to add the include Availability Zones parameter to your request.
        :param pulumi.Input[builtins.str] region_name: The Region Name in which to create your instance.
        """
        if availability_zone is not None:
            pulumi.set(__self__, "availability_zone", availability_zone)
        if region_name is not None:
...
if not MYPY:
    class InstanceMonthlyTransferArgsDict(TypedDict):
        ...
        """
        gb_per_month_allocated: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceMonthlyTransferArgs:
    def __init__(__self__, *,
                 gb_per_month_allocated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Monthly Transfer of the Instance.
        :param pulumi.Input[builtins.str] gb_per_month_allocated: GbPerMonthAllocated of the Instance.
        """
    ...
    def gb_per_month_allocated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        GbPerMonthAllocated of the Instance.
        """
    ...
    def gb_per_month_allocated(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstancePortArgsDict(TypedDict):
        ...
        """
        access_direction: NotRequired[pulumi.Input[builtins.str]]
        """
        Access Direction for Protocol of the Instance(inbound/outbound).
        """
        access_from: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstancePortArgs:
    def __init__(__self__, *,
                 access_direction: Optional[pulumi.Input[builtins.str]] = None,
                 access_from: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        Port of the Instance.
        :param pulumi.Input[builtins.str] access_direction: Access Direction for Protocol of the Instance(inbound/outbound).
        :param pulumi.Input[builtins.str] access_from: Access From Protocol of the Instance.
        :param pulumi.Input[builtins.str] access_type: Access Type Protocol of the Instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidr_list_aliases: An alias that defines access for a preconfigured range of IP addresses.
               
               The only alias currently supported is `lightsail-connect` , which allows IP addresses of the browser-based RDP/SSH client in the Lightsail console to connect to your instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidrs: The IPv4 address, or range of IPv4 addresses (in CIDR notation) that are allowed to connect to an instance through the ports, and the protocol.
               ...
               - To allow the IP address `192.0.2.44` , specify `192.0.2.44` or `192.0.2.44/32` .
               - To allow the IP addresses `192.0.2.0` to `192.0.2.255` , specify `192.0.2.0/24` .
        :param pulumi.Input[builtins.str] common_name: CommonName for Protocol of the Instance.
        :param pulumi.Input[builtins.int] from_port: From Port of the Instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv6_cidrs: The IPv6 address, or range of IPv6 addresses (in CIDR notation) that are allowed to connect to an instance through the ports, and the protocol. Only devices with an IPv6 address can connect to an instance through IPv6; otherwise, IPv4 should be used.
               
               > The `cidrs` parameter lists the IPv4 addresses that are allowed to connect to an instance.
        :param pulumi.Input[builtins.str] protocol: Port Protocol of the Instance.
        :param pulumi.Input[builtins.int] to_port: To Port of the Instance.
        """
    ...
    def access_direction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Access Direction for Protocol of the Instance(inbound/outbound).
        """
    ...
    def access_direction(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_direction", value)

    @property
    @pulumi.getter(name="accessFrom")
    def access_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Access From Protocol of the Instance.
        """
    ...
    @access_from.setter
    def access_from(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceStateArgs:
    def __init__(__self__, *,
        ...
        """
        Current State of the Instance.
        :param pulumi.Input[builtins.int] code: Status code of the Instance.
        :param pulumi.Input[builtins.str] name: Status code of the Instance.
        """
        if code is not None:
