...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 relational_database_blueprint_id: pulumi.Input[builtins.str],
                 relational_database_bundle_id: pulumi.Input[builtins.str],
                 relational_database_name: pulumi.Input[builtins.str],
                 availability_zone: Optional[pulumi.Input[builtins.str]] = None,
                 backup_retention: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 rotate_master_user_password: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a Database resource.
        :param pulumi.Input[builtins.str] master_database_name: The name of the database to create when the Lightsail database resource is created. For MySQL, if this parameter isn't specified, no database is created in the database resource. For PostgreSQL, if this parameter isn't specified, a database named postgres is created in the database resource.
        :param pulumi.Input[builtins.str] master_username: The name for the master user.
        :param pulumi.Input[builtins.str] relational_database_blueprint_id: The blueprint ID for your new database. A blueprint describes the major engine version of a database.
        :param pulumi.Input[builtins.str] relational_database_bundle_id: The bundle ID for your new database. A bundle describes the performance specifications for your database.
        :param pulumi.Input[builtins.str] relational_database_name: The name to use for your new Lightsail database resource.
        ...
        :param pulumi.Input[builtins.bool] backup_retention: When true, enables automated backup retention for your database. Updates are applied during the next maintenance window because this can result in an outage.
        :param pulumi.Input[builtins.str] ca_certificate_identifier: Indicates the certificate that needs to be associated with the database.
        :param pulumi.Input[builtins.str] master_user_password: The password for the master user. The password can include any printable ASCII character except "/", \"\"\", or "@". It cannot contain spaces.
        :param pulumi.Input[builtins.str] preferred_backup_window: The daily time range during which automated backups are created for your new database if automated backups are enabled.
        :param pulumi.Input[builtins.str] preferred_maintenance_window: The weekly time range during which system maintenance can occur on your new database.
        ...
        :param pulumi.Input[builtins.bool] rotate_master_user_password: When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
    ...
    def relational_database_blueprint_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def relational_database_blueprint_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "relational_database_blueprint_id", value)

    @property
    @pulumi.getter(name="relationalDatabaseBundleId")
    def relational_database_bundle_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def relational_database_bundle_id(self, value: pulumi.Input[builtins.str]):
    ...
    def backup_retention(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def backup_retention(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def rotate_master_user_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def rotate_master_user_password(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("aws-native:lightsail:Database")
class Database(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 preferred_maintenance_window: Optional[pulumi.Input[builtins.str]] = None,
                 publicly_accessible: Optional[pulumi.Input[builtins.bool]] = None,
                 relational_database_blueprint_id: Optional[pulumi.Input[builtins.str]] = None,
                 relational_database_bundle_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] relational_database_bundle_id: The bundle ID for your new database. A bundle describes the performance specifications for your database.
        :param pulumi.Input[builtins.str] relational_database_name: The name to use for your new Lightsail database resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRelationalDatabaseParameterArgs', 'DatabaseRelationalDatabaseParameterArgsDict']]]] relational_database_parameters: Update one or more parameters of the relational database.
        :param pulumi.Input[builtins.bool] rotate_master_user_password: When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
    ...
    @property
    @pulumi.getter(name="backupRetention")
    def backup_retention(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, enables automated backup retention for your database. Updates are applied during the next maintenance window because this can result in an outage.
        """
        return pulumi.get(self, "backup_retention")
    ...
    def database_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="relationalDatabaseBlueprintId")
    def relational_database_blueprint_id(self) -> pulumi.Output[builtins.str]:
        """
        The blueprint ID for your new database. A blueprint describes the major engine version of a database.
        """
        return pulumi.get(self, "relational_database_blueprint_id")
    ...
    @property
    @pulumi.getter(name="relationalDatabaseBundleId")
    def relational_database_bundle_id(self) -> pulumi.Output[builtins.str]:
        """
        The bundle ID for your new database. A bundle describes the performance specifications for your database.
        """
        return pulumi.get(self, "relational_database_bundle_id")
    ...
    @property
    @pulumi.getter(name="rotateMasterUserPassword")
    def rotate_master_user_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
        """
        return pulumi.get(self, "rotate_master_user_password")
