...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] relational_database_bundle_id: The bundle ID for your new database. A bundle describes the performance specifications for your database.
        :param pulumi.Input[_builtins.str] relational_database_name: The name to use for your new Lightsail database resource.
        ...
        :param pulumi.Input[_builtins.bool] backup_retention: When true, enables automated backup retention for your database. Updates are applied during the next maintenance window because this can result in an outage.
        :param pulumi.Input[_builtins.str] ca_certificate_identifier: Indicates the certificate that needs to be associated with the database.
        :param pulumi.Input[_builtins.str] master_user_password: The password for the master user. The password can include any printable ASCII character except "/", \"\"\", or "@". It cannot contain spaces.
        :param pulumi.Input[_builtins.str] preferred_backup_window: The daily time range during which automated backups are created for your new database if automated backups are enabled.
        :param pulumi.Input[_builtins.str] preferred_maintenance_window: The weekly time range during which system maintenance can occur on your new database.
        :param pulumi.Input[_builtins.bool] publicly_accessible: Specifies the accessibility options for your new database. A value of true specifies a database that is available to resources outside of your Lightsail account. A value of false specifies a database that is available only to your Lightsail resources in the same region as your database.
        ...
        :param pulumi.Input[_builtins.bool] rotate_master_user_password: When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
    ...
    def relational_database_blueprint_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def relational_database_blueprint_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "relational_database_blueprint_id", value)

    @_builtins.property
    @pulumi.getter(name="relationalDatabaseBundleId")
    def relational_database_bundle_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def relational_database_bundle_id(self, value: pulumi.Input[_builtins.str]):
...
class Database(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 relational_database_parameters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DatabaseRelationalDatabaseParameterArgs', 'DatabaseRelationalDatabaseParameterArgsDict', 'outputs.DatabaseRelationalDatabaseParameter']]]]] = None,
                 rotate_master_user_password: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] relational_database_bundle_id: The bundle ID for your new database. A bundle describes the performance specifications for your database.
        :param pulumi.Input[_builtins.str] relational_database_name: The name to use for your new Lightsail database resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatabaseRelationalDatabaseParameterArgs', 'DatabaseRelationalDatabaseParameterArgsDict', 'outputs.DatabaseRelationalDatabaseParameter']]]] relational_database_parameters: Update one or more parameters of the relational database.
        :param pulumi.Input[_builtins.bool] rotate_master_user_password: When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
    ...
    @_builtins.property
    @pulumi.getter(name="backupRetention")
    def backup_retention(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When true, enables automated backup retention for your database. Updates are applied during the next maintenance window because this can result in an outage.
        """
        return pulumi.get(self, "backup_retention")
    ...
    @_builtins.property
    @pulumi.getter(name="caCertificateIdentifier")
    def ca_certificate_identifier(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Indicates the certificate that needs to be associated with the database.
        """
        return pulumi.get(self, "ca_certificate_identifier")
    ...
    def database_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="relationalDatabaseBlueprintId")
    def relational_database_blueprint_id(self) -> pulumi.Output[_builtins.str]:
        """
        The blueprint ID for your new database. A blueprint describes the major engine version of a database.
        """
        return pulumi.get(self, "relational_database_blueprint_id")
    ...
    @_builtins.property
    @pulumi.getter(name="relationalDatabaseBundleId")
    def relational_database_bundle_id(self) -> pulumi.Output[_builtins.str]:
        """
        The bundle ID for your new database. A bundle describes the performance specifications for your database.
        """
        return pulumi.get(self, "relational_database_bundle_id")
    ...
    @_builtins.property
    @pulumi.getter(name="rotateMasterUserPassword")
    def rotate_master_user_password(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When true, the master user password is changed to a new strong password generated by Lightsail. Use the get relational database master user password operation to get the new password.
        """
        return pulumi.get(self, "rotate_master_user_password")
