...
class KeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: The tag keys and optional values to add to the resource during create.
        """
...
@pulumi.type_token("aws-native:lightsail:KeyPair")
class KeyPair(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] key_pair_name: The name of the key pair.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tag keys and optional values to add to the resource during create.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["key_pair_arn"] = None
            __props__.__dict__["location"] = None
            __props__.__dict__["resource_type"] = None
            __props__.__dict__["support_code"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["keyPairName"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(KeyPair, __self__).__init__(
            'aws-native:lightsail:KeyPair',
            resource_name,
            __props__,
            opts)
    ...
    def key_pair_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def location(self) -> pulumi.Output['outputs.KeyPairResourceLocation']:
