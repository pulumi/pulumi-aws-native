...
class GetAlarmResult:
    ...
    def alarm_arn(self) -> Optional[builtins.str]:
        """
    ...
    def contact_protocols(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def notification_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_alarm(alarm_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alarm_name: The name for the alarm. Specify the name of an existing alarm to update, and overwrite the previous configuration of the alarm.
    """
    __args__ = dict()
