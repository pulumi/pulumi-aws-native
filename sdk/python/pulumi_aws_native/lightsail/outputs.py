...
class LocationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The AWS Region and Availability Zone where the disk snapshot was created.
        :param builtins.str availability_zone: The Availability Zone where the disk snapshot was created.
        :param builtins.str region_name: The AWS Region where the disk snapshot was created.
        """
        if availability_zone is not None:
            pulumi.set(__self__, "availability_zone", availability_zone)
        if region_name is not None:
