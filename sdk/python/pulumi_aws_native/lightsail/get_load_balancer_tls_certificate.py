...
class GetLoadBalancerTlsCertificateResult:
    ...
    def https_redirection_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def load_balancer_tls_certificate_arn(self) -> Optional[builtins.str]:
        """
...
def get_load_balancer_tls_certificate(certificate_name: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_name: The SSL/TLS certificate name.
...
def get_load_balancer_tls_certificate_output(certificate_name: Optional[pulumi.Input[builtins.str]] = None,
