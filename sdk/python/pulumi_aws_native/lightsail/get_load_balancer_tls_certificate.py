...
class GetLoadBalancerTlsCertificateResult:
    ...
    def https_redirection_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def load_balancer_tls_certificate_arn(self) -> Optional[_builtins.str]:
        """
...
def get_load_balancer_tls_certificate(certificate_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_name: The SSL/TLS certificate name.
