...
class AnomalySubscriptionArgs:
    ...
    def monitor_arn_list(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def monitor_arn_list(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class AnomalySubscription(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="monitorArnList")
    def monitor_arn_list(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of cost anomaly monitors.
        """
        return pulumi.get(self, "monitor_arn_list")
    ...
    def subscription_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="thresholdExpression")
    def threshold_expression(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        An Expression object in JSON String format used to specify the anomalies that you want to generate alerts for.
        """
        return pulumi.get(self, "threshold_expression")
