...
class AnomalySubscriptionArgs:
    ...
    def monitor_arn_list(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def monitor_arn_list(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def threshold_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def threshold_expression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "threshold_expression", value)


@pulumi.type_token("aws-native:ce:AnomalySubscription")
class AnomalySubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="monitorArnList")
    def monitor_arn_list(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of cost anomaly monitors.
        """
        return pulumi.get(self, "monitor_arn_list")
    ...
    def subscription_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="thresholdExpression")
    def threshold_expression(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An Expression object in JSON String format used to specify the anomalies that you want to generate alerts for.
        """
        return pulumi.get(self, "threshold_expression")
