...
class CostCategoryArgs:
    def __init__(__self__, *,
                 ...
                 split_charge_rules: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] rules: JSON array format of Expression in Billing and Cost Management API
        :param pulumi.Input[builtins.str] default_value: The default value for the cost category
        :param pulumi.Input[builtins.str] name: The unique name of the Cost Category.
        :param pulumi.Input[builtins.str] split_charge_rules: Json array format of CostCategorySplitChargeRule in Billing and Cost Management API
    ...
    def split_charge_rules(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def split_charge_rules(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CostCategory(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="splitChargeRules")
    def split_charge_rules(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Json array format of CostCategorySplitChargeRule in Billing and Cost Management API
        """
        return pulumi.get(self, "split_charge_rules")
