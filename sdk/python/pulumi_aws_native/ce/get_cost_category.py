...
class GetCostCategoryResult:
    ...
    def effective_start(self) -> Optional[builtins.str]:
        """
    ...
    def split_charge_rules(self) -> Optional[builtins.str]:
        """
...
def get_cost_category(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Cost category ARN
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_cost_category_output(arn: Optional[pulumi.Input[builtins.str]] = None,
