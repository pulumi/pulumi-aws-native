...
class GetAnomalyMonitorResult:
    ...
    def dimensional_value_count(self) -> Optional[_builtins.int]:
        """
    ...
    def last_evaluated_date(self) -> Optional[_builtins.str]:
        """
    ...
    def last_updated_date(self) -> Optional[_builtins.str]:
        """
...
def get_anomaly_monitor(monitor_arn: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnomalyMonitorResult:
    """
    AWS Cost Anomaly Detection leverages advanced Machine Learning technologies to identify anomalous spend and root causes, so you can quickly take action. You can use Cost Anomaly Detection by creating monitor.


    :param _builtins.str monitor_arn: The Amazon Resource Name (ARN) value for the monitor.
    """
    __args__ = dict()
...
def get_anomaly_monitor_output(monitor_arn: Optional[pulumi.Input[_builtins.str]] = None,
