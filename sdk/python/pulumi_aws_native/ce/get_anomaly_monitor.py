...
class GetAnomalyMonitorResult:
    ...
    def dimensional_value_count(self) -> Optional[builtins.int]:
        """
    ...
    def last_evaluated_date(self) -> Optional[builtins.str]:
        """
    ...
    def last_updated_date(self) -> Optional[builtins.str]:
        """
    ...
    def monitor_name(self) -> Optional[builtins.str]:
        """
...
def get_anomaly_monitor(monitor_arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnomalyMonitorResult:
    """
    AWS Cost Anomaly Detection leverages advanced Machine Learning technologies to identify anomalous spend and root causes, so you can quickly take action. You can use Cost Anomaly Detection by creating monitor.


    :param builtins.str monitor_arn: The Amazon Resource Name (ARN) value for the monitor.
    """
    __args__ = dict()
...
def get_anomaly_monitor_output(monitor_arn: Optional[pulumi.Input[builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAnomalyMonitorResult]:
    """
    AWS Cost Anomaly Detection leverages advanced Machine Learning technologies to identify anomalous spend and root causes, so you can quickly take action. You can use Cost Anomaly Detection by creating monitor.
