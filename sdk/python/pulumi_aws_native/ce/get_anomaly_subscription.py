...
class GetAnomalySubscriptionResult:
    ...
    def monitor_arn_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def subscription_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def threshold_expression(self) -> Optional[_builtins.str]:
        """
...
def get_anomaly_subscription(subscription_arn: Optional[_builtins.str] = None,
