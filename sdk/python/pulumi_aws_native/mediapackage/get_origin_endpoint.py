...
class GetOriginEndpointResult:
    ...
    @property
    @pulumi.getter
    def whitelist(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_origin_endpoint(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the OriginEndpoint.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_origin_endpoint_output(id: Optional[pulumi.Input[builtins.str]] = None,
