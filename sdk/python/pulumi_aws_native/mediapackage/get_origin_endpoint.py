...
class GetOriginEndpointResult:
    ...
    @_builtins.property
    @pulumi.getter
    def whitelist(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_origin_endpoint(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the OriginEndpoint.
    """
    __args__ = dict()
    __args__['id'] = id
