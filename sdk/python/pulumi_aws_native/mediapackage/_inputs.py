...
if not MYPY:
    class AssetEgressEndpointArgsDict(TypedDict):
        ...
        """
        packaging_configuration_id: pulumi.Input[builtins.str]
        """
...
class AssetEgressEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        The endpoint URL used to access an Asset using one PackagingConfiguration.
        :param pulumi.Input[builtins.str] packaging_configuration_id: The ID of the PackagingConfiguration being applied to the Asset.
        :param pulumi.Input[builtins.str] url: The URL of the parent manifest for the repackaged Asset.
        """
    ...
    def packaging_configuration_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the PackagingConfiguration being applied to the Asset.
        """
    ...
    def packaging_configuration_id(self, value: pulumi.Input[builtins.str]):
...
class ChannelIngestEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        An endpoint for ingesting source content for a Channel.
        :param pulumi.Input[builtins.str] id: The system generated unique identifier for the IngestEndpoint
        :param pulumi.Input[builtins.str] password: The system generated password for ingest authentication.
        :param pulumi.Input[builtins.str] url: The ingest URL to which the source stream should be sent.
        :param pulumi.Input[builtins.str] username: The system generated username for ingest authentication.
        """
...
class ChannelLogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] log_group_name: Sets a custom AWS CloudWatch log group name for access logs. If a log group name isn't specified, the defaults are used: /aws/MediaPackage/EgressAccessLogs for egress access logs and /aws/MediaPackage/IngressAccessLogs for ingress access logs.
        """
...
if not MYPY:
    class OriginEndpointAuthorizationArgsDict(TypedDict):
        ...
        """
        cdn_identifier_secret: pulumi.Input[builtins.str]
        """
...
class OriginEndpointAuthorizationArgs:
    def __init__(__self__, *,
        ...
        """
        CDN Authorization credentials
        :param pulumi.Input[builtins.str] cdn_identifier_secret: The Amazon Resource Name (ARN) for the secret in Secrets Manager that your Content Distribution Network (CDN) uses for authorization to access your endpoint.
        :param pulumi.Input[builtins.str] secrets_role_arn: The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        """
    ...
    def cdn_identifier_secret(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) for the secret in Secrets Manager that your Content Distribution Network (CDN) uses for authorization to access your endpoint.
        """
    ...
    def cdn_identifier_secret(self, value: pulumi.Input[builtins.str]):
...
class OriginEndpointCmafEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] constant_initialization_vector: An optional 128-bit, 16-byte hex value represented by a 32-character string, used in conjunction with the key for encrypting blocks. If you don't specify a value, then MediaPackage creates the constant initialization vector (IV).
        :param pulumi.Input['OriginEndpointCmafEncryptionEncryptionMethod'] encryption_method: The encryption method used
        :param pulumi.Input[builtins.int] key_rotation_interval_seconds: Time (in seconds) between each encryption key rotation.
        """
...
if not MYPY:
    class OriginEndpointCmafPackageArgsDict(TypedDict):
        ...
        """
        segment_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OriginEndpointCmafPackageArgs:
    def __init__(__self__, *,
                 ...
                 segment_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] segment_duration_seconds: Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        :param pulumi.Input[builtins.str] segment_prefix: An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
    ...
    def segment_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
        """
    ...
    def segment_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class OriginEndpointDashPackageArgsDict(TypedDict):
        ...
        Parameters for encrypting content.
        """
        include_iframe_only_stream: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        utc_timing_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OriginEndpointDashPackageArgs:
    def __init__(__self__, *,
                 ...
                 include_iframe_only_stream: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 utc_timing_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
        ...
        :param pulumi.Input[builtins.bool] include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        ...
        :param pulumi.Input[builtins.int] manifest_window_seconds: Time window (in seconds) contained in each manifest.
        :param pulumi.Input[builtins.int] min_buffer_time_seconds: Minimum duration (in seconds) that a player will buffer media before starting the presentation.
        :param pulumi.Input[builtins.int] min_update_period_seconds: Minimum duration (in seconds) between potential changes to the Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD).
        ...
        :param pulumi.Input['OriginEndpointStreamSelectionArgs'] stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        :param pulumi.Input[builtins.int] suggested_presentation_delay_seconds: Duration (in seconds) to delay live content before presentation.
        ...
        :param pulumi.Input[builtins.str] utc_timing_uri: Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO, HTTP-HEAD or HTTP-XSDATE
        """
    ...
    def include_iframe_only_stream(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, an I-Frame only stream will be included in the output.
        """
    ...
    def include_iframe_only_stream(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def utc_timing_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO, HTTP-HEAD or HTTP-XSDATE
        """
    ...
    def utc_timing_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class OriginEndpointHlsEncryptionArgsDict(TypedDict):
        ...
        """
        repeat_ext_x_key: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OriginEndpointHlsEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 key_rotation_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 repeat_ext_x_key: Optional[pulumi.Input[builtins.bool]] = None):
        """
        An HTTP Live Streaming (HLS) encryption configuration.
        :param pulumi.Input['OriginEndpointSpekeKeyProviderArgs'] speke_key_provider: Parameters for the SPEKE key provider.
        :param pulumi.Input[builtins.str] constant_initialization_vector: A constant initialization vector for encryption (optional). When not specified the initialization vector will be periodically rotated.
        :param pulumi.Input['OriginEndpointHlsEncryptionEncryptionMethod'] encryption_method: The encryption method to use.
        :param pulumi.Input[builtins.int] key_rotation_interval_seconds: Interval (in seconds) between each encryption key rotation.
        :param pulumi.Input[builtins.bool] repeat_ext_x_key: When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        """
        pulumi.set(__self__, "speke_key_provider", speke_key_provider)
        if constant_initialization_vector is not None:
            pulumi.set(__self__, "constant_initialization_vector", constant_initialization_vector)
    ...
    def repeat_ext_x_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        """
    ...
    def repeat_ext_x_key(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class OriginEndpointHlsManifestArgsDict(TypedDict):
        ...
        When enabled, an I-Frame only stream will be included in the output.
        """
        manifest_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        playlist_window_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OriginEndpointHlsManifestArgs:
    def __init__(__self__, *,
                 ...
                 playlist_window_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 program_date_time_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        A HTTP Live Streaming (HLS) manifest configuration.
        :param pulumi.Input[builtins.str] id: The ID of the manifest. The ID must be unique within the OriginEndpoint and it cannot be changed after it is created.
        ...
        :param pulumi.Input['OriginEndpointAdsOnDeliveryRestrictions'] ads_on_delivery_restrictions: The flags on SCTE-35 segmentation descriptors that have to be present for AWS Elemental MediaPackage to insert ad markers in the output manifest. For information about SCTE-35 in AWS Elemental MediaPackage , see [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html) .
        :param pulumi.Input[builtins.bool] include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        :param pulumi.Input[builtins.str] manifest_name: An optional short string appended to the end of the OriginEndpoint URL. If not specified, defaults to the manifestName for the OriginEndpoint.
        ...
        :param pulumi.Input[builtins.int] playlist_window_seconds: Time window (in seconds) contained in each parent manifest.
        :param pulumi.Input[builtins.int] program_date_time_interval_seconds: The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        :param pulumi.Input[builtins.str] url: The URL of the packaged OriginEndpoint for consumption.
        """
        pulumi.set(__self__, "id", id)
    ...
    def playlist_window_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Time window (in seconds) contained in each parent manifest.
        """
    ...
    def playlist_window_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class OriginEndpointHlsPackageArgsDict(TypedDict):
        ...
        Parameters for encrypting content.
        """
        include_dvb_subtitles: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Limitations for outputs from the endpoint, based on the video bitrate.
        """
        use_audio_rendition_group: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OriginEndpointHlsPackageArgs:
    def __init__(__self__, *,
                 ...
                 include_dvb_subtitles: Optional[pulumi.Input[builtins.bool]] = None,
                 include_iframe_only_stream: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 segment_duration_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 stream_selection: Optional[pulumi.Input['OriginEndpointStreamSelectionArgs']] = None,
                 use_audio_rendition_group: Optional[pulumi.Input[builtins.bool]] = None):
        """
        An HTTP Live Streaming (HLS) packaging configuration.
        ...
        :param pulumi.Input[builtins.bool] include_dvb_subtitles: When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        :param pulumi.Input[builtins.bool] include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        ...
        :param pulumi.Input[builtins.int] playlist_window_seconds: Time window (in seconds) contained in each parent manifest.
        :param pulumi.Input[builtins.int] program_date_time_interval_seconds: The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        :param pulumi.Input[builtins.int] segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments will be rounded to the nearest multiple of the source fragment duration.
        :param pulumi.Input['OriginEndpointStreamSelectionArgs'] stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        :param pulumi.Input[builtins.bool] use_audio_rendition_group: When enabled, audio streams will be placed in rendition groups in the output.
        """
        if ad_markers is not None:
            pulumi.set(__self__, "ad_markers", ad_markers)
        if ad_triggers is not None:
    ...
    def include_dvb_subtitles(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        """
    ...
    def include_dvb_subtitles(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_audio_rendition_group(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, audio streams will be placed in rendition groups in the output.
        """
    ...
    def use_audio_rendition_group(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class OriginEndpointMssPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] manifest_window_seconds: The time window (in seconds) contained in each manifest.
        :param pulumi.Input[builtins.int] segment_duration_seconds: The duration (in seconds) of each segment.
        :param pulumi.Input['OriginEndpointStreamSelectionArgs'] stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        """
        if encryption is not None:
            pulumi.set(__self__, "encryption", encryption)
...
if not MYPY:
    class OriginEndpointSpekeKeyProviderArgsDict(TypedDict):
        ...
        """
        system_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class OriginEndpointSpekeKeyProviderArgs:
    def __init__(__self__, *,
        ...
        """
        A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        :param pulumi.Input[builtins.str] resource_id: The resource ID to include in key requests.
        :param pulumi.Input[builtins.str] role_arn: An Amazon Resource Name (ARN) of an IAM role that AWS Elemental MediaPackage will assume when accessing the key provider service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] system_ids: The system IDs to include in key requests.
        :param pulumi.Input[builtins.str] url: The URL of the external key provider service.
        :param pulumi.Input[builtins.str] certificate_arn: An Amazon Resource Name (ARN) of a Certificate Manager certificate that MediaPackage will use for enforcing secure end-to-end data transfer with the key provider service.
    ...
    def system_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The system IDs to include in key requests.
        """
    ...
    @system_ids.setter
    def system_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class OriginEndpointStreamSelectionArgsDict(TypedDict):
        ...
        """
        max_video_bits_per_second: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum video bitrate (bps) to include in output.
        """
        min_video_bits_per_second: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OriginEndpointStreamSelectionArgs:
    def __init__(__self__, *,
                 max_video_bits_per_second: Optional[pulumi.Input[builtins.int]] = None,
                 min_video_bits_per_second: Optional[pulumi.Input[builtins.int]] = None,
                 stream_order: Optional[pulumi.Input['OriginEndpointStreamSelectionStreamOrder']] = None):
        """
        A StreamSelection configuration.
        :param pulumi.Input[builtins.int] max_video_bits_per_second: The maximum video bitrate (bps) to include in output.
        :param pulumi.Input[builtins.int] min_video_bits_per_second: The minimum video bitrate (bps) to include in output.
    ...
    def max_video_bits_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum video bitrate (bps) to include in output.
        """
    ...
    def max_video_bits_per_second(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_video_bits_per_second", value)

    @property
    @pulumi.getter(name="minVideoBitsPerSecond")
    def min_video_bits_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum video bitrate (bps) to include in output.
        """
    ...
    def min_video_bits_per_second(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class PackagingConfigurationCmafPackageArgsDict(TypedDict):
        ...
        Parameters for encrypting content.
        """
        include_encoder_configuration_in_segments: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class PackagingConfigurationCmafPackageArgs:
    def __init__(__self__, *,
                 ...
                 include_encoder_configuration_in_segments: Optional[pulumi.Input[builtins.bool]] = None,
                 segment_duration_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        A CMAF packaging configuration.
        ...
        :param pulumi.Input[builtins.bool] include_encoder_configuration_in_segments: When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        :param pulumi.Input[builtins.int] segment_duration_seconds: Duration (in seconds) of each segment. Actual segments are rounded to the nearest multiple of the source fragment duration.
        """
        pulumi.set(__self__, "hls_manifests", hls_manifests)
        if encryption is not None:
            pulumi.set(__self__, "encryption", encryption)
    ...
    def include_encoder_configuration_in_segments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        """
    ...
    def include_encoder_configuration_in_segments(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PackagingConfigurationDashManifestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] manifest_name: A short string that's appended to the end of the endpoint URL to create a unique path to this packaging configuration.
        :param pulumi.Input[builtins.int] min_buffer_time_seconds: Minimum duration (in seconds) that a player will buffer media before starting the presentation.
...
class PackagingConfigurationDashPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments are rounded to the nearest multiple of the source segment duration.
...
class PackagingConfigurationHlsEncryptionArgs:
    def __init__(__self__, *,
        ...
        An HTTP Live Streaming (HLS) encryption configuration.
        :param pulumi.Input['PackagingConfigurationSpekeKeyProviderArgs'] speke_key_provider: Parameters for the SPEKE key provider.
        :param pulumi.Input[builtins.str] constant_initialization_vector: An HTTP Live Streaming (HLS) encryption configuration.
...
class PackagingConfigurationHlsPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] include_dvb_subtitles: When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        :param pulumi.Input[builtins.int] segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments are rounded to the nearest multiple of the source fragment duration.
        :param pulumi.Input[builtins.bool] use_audio_rendition_group: When enabled, audio streams will be placed in rendition groups in the output.
        """
        pulumi.set(__self__, "hls_manifests", hls_manifests)
        if encryption is not None:
...
class PackagingConfigurationSpekeKeyProviderArgs:
    def __init__(__self__, *,
        ...
        """
        A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        :param pulumi.Input[builtins.str] role_arn: The ARN for the IAM role that's granted by the key provider to provide access to the key provider API. Valid format: arn:aws:iam::{accountID}:role/{name}
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] system_ids: The system IDs to include in key requests.
        :param pulumi.Input[builtins.str] url: The URL of the external key provider service.
...
class PackagingGroupAuthorizationArgs:
    def __init__(__self__, *,
                 ...
                 secrets_role_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cdn_identifier_secret: The Amazon Resource Name (ARN) for the secret in AWS Secrets Manager that is used for CDN authorization.
        :param pulumi.Input[builtins.str] secrets_role_arn: The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        """
        pulumi.set(__self__, "cdn_identifier_secret", cdn_identifier_secret)
        pulumi.set(__self__, "secrets_role_arn", secrets_role_arn)
...
class PackagingGroupLogConfigurationArgs:
    def __init__(__self__, *,
                 log_group_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] log_group_name: Sets a custom AWS CloudWatch log group name for egress logs. If a log group name isn't specified, the default name is used: /aws/MediaPackage/VodEgressAccessLogs.
        """
        if log_group_name is not None:
            pulumi.set(__self__, "log_group_name", log_group_name)
