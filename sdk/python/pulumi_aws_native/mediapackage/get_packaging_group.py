...
def get_packaging_group(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPackagingGroupResult:
    """
    Resource schema for AWS::MediaPackage::PackagingGroup


    :param builtins.str id: The ID of the PackagingGroup.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_packaging_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
