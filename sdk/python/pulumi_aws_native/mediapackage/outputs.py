...
class AssetEgressEndpoint(dict):
    ...
    def __init__(__self__, *,
                 packaging_configuration_id: _builtins.str,
                 url: _builtins.str):
        """
        The endpoint URL used to access an Asset using one PackagingConfiguration.
        :param _builtins.str packaging_configuration_id: The ID of the PackagingConfiguration being applied to the Asset.
        :param _builtins.str url: The URL of the parent manifest for the repackaged Asset.
        """
    ...
    def packaging_configuration_id(self) -> _builtins.str:
        """
...
class ChannelIngestEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An endpoint for ingesting source content for a Channel.
        :param _builtins.str id: The system generated unique identifier for the IngestEndpoint
        :param _builtins.str password: The system generated password for ingest authentication.
...
class ChannelLogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str log_group_name: Sets a custom AWS CloudWatch log group name for access logs. If a log group name isn't specified, the defaults are used: /aws/MediaPackage/EgressAccessLogs for egress access logs and /aws/MediaPackage/IngressAccessLogs for ingress access logs.
        """
...
class OriginEndpointAuthorization(dict):
    ...
    def __init__(__self__, *,
                 cdn_identifier_secret: _builtins.str,
                 secrets_role_arn: _builtins.str):
        """
        CDN Authorization credentials
        :param _builtins.str cdn_identifier_secret: The Amazon Resource Name (ARN) for the secret in Secrets Manager that your Content Distribution Network (CDN) uses for authorization to access your endpoint.
        :param _builtins.str secrets_role_arn: The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        """
    ...
    def cdn_identifier_secret(self) -> _builtins.str:
        """
...
class OriginEndpointCmafEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Common Media Application Format (CMAF) encryption configuration.
        :param 'OriginEndpointSpekeKeyProvider' speke_key_provider: Parameters for the SPEKE key provider.
        :param _builtins.str constant_initialization_vector: An optional 128-bit, 16-byte hex value represented by a 32-character string, used in conjunction with the key for encrypting blocks. If you don't specify a value, then MediaPackage creates the constant initialization vector (IV).
        :param 'OriginEndpointCmafEncryptionEncryptionMethod' encryption_method: The encryption method used
        :param _builtins.int key_rotation_interval_seconds: Time (in seconds) between each encryption key rotation.
        """
...
class OriginEndpointCmafPackage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 segment_prefix: Optional[_builtins.str] = None,
                 stream_selection: Optional['outputs.OriginEndpointStreamSelection'] = None):
        """
        A Common Media Application Format (CMAF) packaging configuration.
        :param 'OriginEndpointCmafEncryption' encryption: Parameters for encrypting content.
        :param Sequence['OriginEndpointHlsManifest'] hls_manifests: A list of HLS manifest configurations
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
        :param _builtins.str segment_prefix: An optional custom string that is prepended to the name of each segment. If not specified, it defaults to the ChannelId.
        :param 'OriginEndpointStreamSelection' stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        """
    ...
    def segment_prefix(self) -> Optional[_builtins.str]:
        """
...
class OriginEndpointDashPackage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_iframe_only_stream: Optional[_builtins.bool] = None,
                 ...
                 utc_timing_uri: Optional[_builtins.str] = None):
        """
        A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
        ...
        :param 'OriginEndpointAdsOnDeliveryRestrictions' ads_on_delivery_restrictions: The flags on SCTE-35 segmentation descriptors that have to be present for AWS Elemental MediaPackage to insert ad markers in the output manifest. For information about SCTE-35 in AWS Elemental MediaPackage , see [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html) .
        :param 'OriginEndpointDashEncryption' encryption: Parameters for encrypting content.
        :param _builtins.bool include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        ...
        :param _builtins.int manifest_window_seconds: Time window (in seconds) contained in each manifest.
        :param _builtins.int min_buffer_time_seconds: Minimum duration (in seconds) that a player will buffer media before starting the presentation.
        :param _builtins.int min_update_period_seconds: Minimum duration (in seconds) between potential changes to the Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD).
        ...
        :param 'OriginEndpointStreamSelection' stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        :param _builtins.int suggested_presentation_delay_seconds: Duration (in seconds) to delay live content before presentation.
        ...
        :param _builtins.str utc_timing_uri: Specifies the value attribute of the UTCTiming field when utcTiming is set to HTTP-ISO, HTTP-HEAD or HTTP-XSDATE
        """
    ...
    def include_iframe_only_stream(self) -> Optional[_builtins.bool]:
        """
    ...
    def utc_timing_uri(self) -> Optional[_builtins.str]:
        """
...
class OriginEndpointHlsEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_rotation_interval_seconds: Optional[_builtins.int] = None,
                 repeat_ext_x_key: Optional[_builtins.bool] = None):
        """
        An HTTP Live Streaming (HLS) encryption configuration.
        :param 'OriginEndpointSpekeKeyProvider' speke_key_provider: Parameters for the SPEKE key provider.
        :param _builtins.str constant_initialization_vector: A constant initialization vector for encryption (optional). When not specified the initialization vector will be periodically rotated.
        :param 'OriginEndpointHlsEncryptionEncryptionMethod' encryption_method: The encryption method to use.
        :param _builtins.int key_rotation_interval_seconds: Interval (in seconds) between each encryption key rotation.
        :param _builtins.bool repeat_ext_x_key: When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        """
        pulumi.set(__self__, "speke_key_provider", speke_key_provider)
        if constant_initialization_vector is not None:
            pulumi.set(__self__, "constant_initialization_vector", constant_initialization_vector)
    ...
    def repeat_ext_x_key(self) -> Optional[_builtins.bool]:
        """
...
class OriginEndpointHlsManifest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ads_on_delivery_restrictions: Optional['OriginEndpointAdsOnDeliveryRestrictions'] = None,
                 include_iframe_only_stream: Optional[_builtins.bool] = None,
                 manifest_name: Optional[_builtins.str] = None,
        ...
        """
        A HTTP Live Streaming (HLS) manifest configuration.
        :param _builtins.str id: The ID of the manifest. The ID must be unique within the OriginEndpoint and it cannot be changed after it is created.
        ...
        :param 'OriginEndpointAdsOnDeliveryRestrictions' ads_on_delivery_restrictions: The flags on SCTE-35 segmentation descriptors that have to be present for AWS Elemental MediaPackage to insert ad markers in the output manifest. For information about SCTE-35 in AWS Elemental MediaPackage , see [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html) .
        :param _builtins.bool include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        :param _builtins.str manifest_name: An optional short string appended to the end of the OriginEndpoint URL. If not specified, defaults to the manifestName for the OriginEndpoint.
        ...
        :param _builtins.int playlist_window_seconds: Time window (in seconds) contained in each parent manifest.
        :param _builtins.int program_date_time_interval_seconds: The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        :param _builtins.str url: The URL of the packaged OriginEndpoint for consumption.
        """
        pulumi.set(__self__, "id", id)
    ...
    def manifest_name(self) -> Optional[_builtins.str]:
        """
...
class OriginEndpointHlsPackage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_dvb_subtitles: Optional[_builtins.bool] = None,
                 include_iframe_only_stream: Optional[_builtins.bool] = None,
                 ...
                 segment_duration_seconds: Optional[_builtins.int] = None,
                 stream_selection: Optional['outputs.OriginEndpointStreamSelection'] = None,
                 use_audio_rendition_group: Optional[_builtins.bool] = None):
        """
        An HTTP Live Streaming (HLS) packaging configuration.
        ...
        :param 'OriginEndpointAdsOnDeliveryRestrictions' ads_on_delivery_restrictions: The flags on SCTE-35 segmentation descriptors that have to be present for AWS Elemental MediaPackage to insert ad markers in the output manifest. For information about SCTE-35 in AWS Elemental MediaPackage , see [SCTE-35 Message Options in AWS Elemental MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/scte.html) .
        :param 'OriginEndpointHlsEncryption' encryption: Parameters for encrypting content.
        :param _builtins.bool include_dvb_subtitles: When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        :param _builtins.bool include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        ...
        :param _builtins.int playlist_window_seconds: Time window (in seconds) contained in each parent manifest.
        :param _builtins.int program_date_time_interval_seconds: The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments will be rounded to the nearest multiple of the source fragment duration.
        :param 'OriginEndpointStreamSelection' stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        :param _builtins.bool use_audio_rendition_group: When enabled, audio streams will be placed in rendition groups in the output.
        """
        if ad_markers is not None:
            pulumi.set(__self__, "ad_markers", ad_markers)
        if ad_triggers is not None:
    ...
    def include_dvb_subtitles(self) -> Optional[_builtins.bool]:
        """
    ...
    def use_audio_rendition_group(self) -> Optional[_builtins.bool]:
        """
...
class OriginEndpointMssPackage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Microsoft Smooth Streaming (MSS) packaging configuration.
        :param 'OriginEndpointMssEncryption' encryption: Parameters for encrypting content.
        :param _builtins.int manifest_window_seconds: The time window (in seconds) contained in each manifest.
        :param _builtins.int segment_duration_seconds: The duration (in seconds) of each segment.
        :param 'OriginEndpointStreamSelection' stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        """
        if encryption is not None:
            pulumi.set(__self__, "encryption", encryption)
...
class OriginEndpointSpekeKeyProvider(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        :param _builtins.str resource_id: The resource ID to include in key requests.
        :param _builtins.str role_arn: An Amazon Resource Name (ARN) of an IAM role that AWS Elemental MediaPackage will assume when accessing the key provider service.
        :param Sequence[_builtins.str] system_ids: The system IDs to include in key requests.
        :param _builtins.str url: The URL of the external key provider service.
        :param _builtins.str certificate_arn: An Amazon Resource Name (ARN) of a Certificate Manager certificate that MediaPackage will use for enforcing secure end-to-end data transfer with the key provider service.
        :param 'OriginEndpointEncryptionContractConfiguration' encryption_contract_configuration: Use `encryptionContractConfiguration` to configure one or more content encryption keys for your endpoints that use SPEKE Version 2.0. The encryption contract defines which content keys are used to encrypt the audio and video tracks in your stream. To configure the encryption contract, specify which audio and video encryption presets to use.
        """
...
class OriginEndpointStreamSelection(dict):
    ...
    def __init__(__self__, *,
                 max_video_bits_per_second: Optional[_builtins.int] = None,
                 min_video_bits_per_second: Optional[_builtins.int] = None,
                 stream_order: Optional['OriginEndpointStreamSelectionStreamOrder'] = None):
        """
        A StreamSelection configuration.
        :param _builtins.int max_video_bits_per_second: The maximum video bitrate (bps) to include in output.
        :param _builtins.int min_video_bits_per_second: The minimum video bitrate (bps) to include in output.
    ...
    def max_video_bits_per_second(self) -> Optional[_builtins.int]:
        """
    ...
    def min_video_bits_per_second(self) -> Optional[_builtins.int]:
        """
...
class PackagingConfigurationCmafEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A CMAF encryption configuration.
        :param 'PackagingConfigurationSpekeKeyProvider' speke_key_provider: Parameters for the SPEKE key provider.
        """
        pulumi.set(__self__, "speke_key_provider", speke_key_provider)
...
class PackagingConfigurationCmafPackage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_encoder_configuration_in_segments: Optional[_builtins.bool] = None,
                 segment_duration_seconds: Optional[_builtins.int] = None):
        """
        A CMAF packaging configuration.
        :param Sequence['PackagingConfigurationHlsManifest'] hls_manifests: A list of HLS manifest configurations.
        :param 'PackagingConfigurationCmafEncryption' encryption: Parameters for encrypting content.
        :param _builtins.bool include_encoder_configuration_in_segments: When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each segment. Actual segments are rounded to the nearest multiple of the source fragment duration.
        """
        pulumi.set(__self__, "hls_manifests", hls_manifests)
        if encryption is not None:
            pulumi.set(__self__, "encryption", encryption)
    ...
    def include_encoder_configuration_in_segments(self) -> Optional[_builtins.bool]:
        """
...
class PackagingConfigurationDashManifest(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str manifest_name: A short string that's appended to the end of the endpoint URL to create a unique path to this packaging configuration.
        :param _builtins.int min_buffer_time_seconds: Minimum duration (in seconds) that a player will buffer media before starting the presentation.
        ...
        :param 'PackagingConfigurationStreamSelection' stream_selection: Limitations for outputs from the endpoint, based on the video bitrate.
        """
        if manifest_layout is not None:
            pulumi.set(__self__, "manifest_layout", manifest_layout)
        if manifest_name is not None:
...
class PackagingConfigurationDashPackage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PackagingConfigurationDashEncryption' encryption: Parameters for encrypting content.
        :param _builtins.bool include_encoder_configuration_in_segments: When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        :param _builtins.bool include_iframe_only_stream: When enabled, an I-Frame only stream will be included in the output.
        ...
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments are rounded to the nearest multiple of the source segment duration.
...
class PackagingConfigurationHlsEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        An HTTP Live Streaming (HLS) encryption configuration.
        :param 'PackagingConfigurationSpekeKeyProvider' speke_key_provider: Parameters for the SPEKE key provider.
        :param _builtins.str constant_initialization_vector: An HTTP Live Streaming (HLS) encryption configuration.
...
class PackagingConfigurationHlsManifest(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int program_date_time_interval_seconds: The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
        :param _builtins.bool repeat_ext_x_key: When enabled, the EXT-X-KEY tag will be repeated in output manifests.
        :param 'PackagingConfigurationStreamSelection' stream_selection: Video bitrate limitations for outputs from this packaging configuration.
        """
        if ad_markers is not None:
            pulumi.set(__self__, "ad_markers", ad_markers)
        if include_iframe_only_stream is not None:
...
class PackagingConfigurationHlsPackage(dict):
    ...
    def __init__(__self__, *,
        ...
        An HTTP Live Streaming (HLS) packaging configuration.
        :param Sequence['PackagingConfigurationHlsManifest'] hls_manifests: A list of HLS manifest configurations.
        :param 'PackagingConfigurationHlsEncryption' encryption: Parameters for encrypting content.
        :param _builtins.bool include_dvb_subtitles: When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments are rounded to the nearest multiple of the source fragment duration.
        :param _builtins.bool use_audio_rendition_group: When enabled, audio streams will be placed in rendition groups in the output.
        """
        pulumi.set(__self__, "hls_manifests", hls_manifests)
        if encryption is not None:
...
class PackagingConfigurationMssPackage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PackagingConfigurationMssEncryption' encryption: Parameters for encrypting content.
        :param _builtins.int segment_duration_seconds: Duration (in seconds) of each fragment. Actual fragments are rounded to the nearest multiple of the source fragment duration.
        """
...
class PackagingConfigurationSpekeKeyProvider(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        :param _builtins.str role_arn: The ARN for the IAM role that's granted by the key provider to provide access to the key provider API. Valid format: arn:aws:iam::{accountID}:role/{name}
        :param Sequence[_builtins.str] system_ids: The system IDs to include in key requests.
        :param _builtins.str url: The URL of the external key provider service.
        :param 'PackagingConfigurationEncryptionContractConfiguration' encryption_contract_configuration: Use `encryptionContractConfiguration` to configure one or more content encryption keys for your endpoints that use SPEKE Version 2.0. The encryption contract defines which content keys are used to encrypt the audio and video tracks in your stream. To configure the encryption contract, specify which audio and video encryption presets to use.
        """
        pulumi.set(__self__, "role_arn", role_arn)
        pulumi.set(__self__, "system_ids", system_ids)
        pulumi.set(__self__, "url", url)
...
class PackagingGroupAuthorization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secrets_role_arn: _builtins.str):
        """
        :param _builtins.str cdn_identifier_secret: The Amazon Resource Name (ARN) for the secret in AWS Secrets Manager that is used for CDN authorization.
        :param _builtins.str secrets_role_arn: The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
        """
        pulumi.set(__self__, "cdn_identifier_secret", cdn_identifier_secret)
        pulumi.set(__self__, "secrets_role_arn", secrets_role_arn)
...
class PackagingGroupLogConfiguration(dict):
    ...
    def __init__(__self__, *,
                 log_group_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str log_group_name: Sets a custom AWS CloudWatch log group name for egress logs. If a log group name isn't specified, the default name is used: /aws/MediaPackage/VodEgressAccessLogs.
        """
        if log_group_name is not None:
            pulumi.set(__self__, "log_group_name", log_group_name)
