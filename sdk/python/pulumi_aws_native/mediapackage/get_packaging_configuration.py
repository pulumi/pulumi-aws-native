...
class GetPackagingConfigurationResult:
    ...
    def packaging_group_id(self) -> Optional[builtins.str]:
        """
...
def get_packaging_configuration(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the PackagingConfiguration.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_packaging_configuration_output(id: Optional[pulumi.Input[builtins.str]] = None,
