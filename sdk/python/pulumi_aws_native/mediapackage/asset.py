...
class AssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_role_arn: The IAM role_arn used to access the source S3 bucket.
        ...
        :param pulumi.Input[_builtins.str] resource_id: The resource ID to include in SPEKE key requests.
    ...
    def source_role_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def source_role_arn(self, value: pulumi.Input[_builtins.str]):
...
class Asset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 egress_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AssetEgressEndpointArgs', 'AssetEgressEndpointArgsDict', 'outputs.AssetEgressEndpoint']]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] aws_id: The unique identifier for the Asset.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AssetEgressEndpointArgs', 'AssetEgressEndpointArgsDict', 'outputs.AssetEgressEndpoint']]]] egress_endpoints: The list of egress endpoints available for the Asset.
        :param pulumi.Input[_builtins.str] packaging_group_id: The ID of the PackagingGroup for the Asset.
        :param pulumi.Input[_builtins.str] resource_id: The resource ID to include in SPEKE key requests.
        :param pulumi.Input[_builtins.str] source_arn: ARN of the source object in S3.
        :param pulumi.Input[_builtins.str] source_role_arn: The IAM role_arn used to access the source S3 bucket.
    ...
    @_builtins.property
    @pulumi.getter(name="sourceRoleArn")
    def source_role_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The IAM role_arn used to access the source S3 bucket.
        """
        return pulumi.get(self, "source_role_arn")
