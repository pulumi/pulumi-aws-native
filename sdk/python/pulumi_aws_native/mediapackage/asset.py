...
class AssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] packaging_group_id: The ID of the PackagingGroup for the Asset.
    ...
    def source_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_role_arn(self, value: pulumi.Input[builtins.str]):
...
class Asset(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sourceRoleArn")
    def source_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The IAM role_arn used to access the source S3 bucket.
        """
        return pulumi.get(self, "source_role_arn")
