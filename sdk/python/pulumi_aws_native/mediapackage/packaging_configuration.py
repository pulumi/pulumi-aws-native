...
class PackagingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cmaf_package, PackagingConfigurationCmafPackageArgs):
            ...
            if not isinstance(dash_package, PackagingConfigurationDashPackageArgs):
            ...
            if not isinstance(hls_package, PackagingConfigurationHlsPackageArgs):
            ...
            if not isinstance(mss_package, PackagingConfigurationMssPackageArgs):
