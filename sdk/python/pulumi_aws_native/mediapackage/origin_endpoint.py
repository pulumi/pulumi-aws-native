...
class OriginEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(authorization, OriginEndpointAuthorizationArgs):
            ...
            if not isinstance(cmaf_package, OriginEndpointCmafPackageArgs):
            ...
            if not isinstance(dash_package, OriginEndpointDashPackageArgs):
            ...
            if not isinstance(hls_package, OriginEndpointHlsPackageArgs):
            ...
            if not isinstance(mss_package, OriginEndpointMssPackageArgs):
