...
class OriginEndpointArgs:
    def __init__(__self__, *,
                 ...
                 whitelist: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a OriginEndpoint resource.
        :param pulumi.Input[builtins.str] aws_id: The ID of the OriginEndpoint.
        :param pulumi.Input[builtins.str] channel_id: The ID of the Channel the OriginEndpoint is associated with.
        ...
        :param pulumi.Input[builtins.str] description: A short text description of the OriginEndpoint.
        :param pulumi.Input['OriginEndpointHlsPackageArgs'] hls_package: Parameters for Apple HLS packaging.
        :param pulumi.Input[builtins.str] manifest_name: A short string appended to the end of the OriginEndpoint URL.
        ...
        :param pulumi.Input[builtins.int] startover_window_seconds: Maximum duration (seconds) of content to retain for startover playback. If not specified, startover playback will be disabled for the OriginEndpoint.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: A collection of tags associated with a resource
        :param pulumi.Input[builtins.int] time_delay_seconds: Amount of delay (seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelist: A list of source IP CIDR blocks that will be allowed to access the OriginEndpoint.
        """
    ...
    @property
    @pulumi.getter
    def whitelist(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @whitelist.setter
    def whitelist(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class OriginEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="timeDelaySeconds")
    def time_delay_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Amount of delay (seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.
        """
        return pulumi.get(self, "time_delay_seconds")
    ...
    @property
    @pulumi.getter
    def whitelist(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of source IP CIDR blocks that will be allowed to access the OriginEndpoint.
        """
        return pulumi.get(self, "whitelist")
