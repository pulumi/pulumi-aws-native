...
@pulumi.type_token("aws-native:rekognition:Dataset")
class Dataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["datasetType", "projectArn"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(Dataset, __self__).__init__(
            'aws-native:rekognition:Dataset',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="projectArn")
    def project_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the project to which the dataset belongs.
        """
        return pulumi.get(self, "project_arn")
