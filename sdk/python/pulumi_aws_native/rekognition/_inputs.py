...
class StreamProcessorBoundingBoxArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def left(self) -> pulumi.Input[_builtins.float]:
        """
        Left coordinate of the bounding box as a ratio of overall image width.
        """
    ...
    @left.setter
    def left(self, value: pulumi.Input[_builtins.float]):
        pulumi.set(self, "left", value)

    @_builtins.property
    @pulumi.getter
    def top(self) -> pulumi.Input[_builtins.float]:
        """
        Top coordinate of the bounding box as a ratio of overall image height.
        """
    ...
    @top.setter
    def top(self, value: pulumi.Input[_builtins.float]):
