...
class StreamProcessor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(connected_home_settings, StreamProcessorConnectedHomeSettingsArgs):
            ...
            if not isinstance(data_sharing_preference, StreamProcessorDataSharingPreferenceArgs):
            ...
            if not isinstance(face_search_settings, StreamProcessorFaceSearchSettingsArgs):
            ...
            if not isinstance(kinesis_data_stream, StreamProcessorKinesisDataStreamArgs):
            ...
            if not isinstance(kinesis_video_stream, StreamProcessorKinesisVideoStreamArgs):
            ...
            if not isinstance(notification_channel, StreamProcessorNotificationChannelArgs):
            ...
            if not isinstance(s3_destination, StreamProcessorS3DestinationArgs):
