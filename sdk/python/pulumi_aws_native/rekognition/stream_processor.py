...
class StreamProcessorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: The KMS key that is used by Rekognition to encrypt any intermediate customer metadata and store in the customer's S3 bucket.
        :param pulumi.Input[_builtins.str] name: Name of the stream processor. It's an identifier you assign to the stream processor. You can use it to manage the stream processor.
...
class StreamProcessor(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bounding_box_regions_of_interest: pulumi.Input[Optional[Sequence[pulumi.Input[Union['StreamProcessorBoundingBoxArgs', 'StreamProcessorBoundingBoxArgsDict', 'outputs.StreamProcessorBoundingBox']]]]] = None,
                 connected_home_settings: pulumi.Input[Optional[Union['StreamProcessorConnectedHomeSettingsArgs', 'StreamProcessorConnectedHomeSettingsArgsDict', 'outputs.StreamProcessorConnectedHomeSettings']]] = None,
                 ...
                 face_search_settings: pulumi.Input[Optional[Union['StreamProcessorFaceSearchSettingsArgs', 'StreamProcessorFaceSearchSettingsArgsDict', 'outputs.StreamProcessorFaceSearchSettings']]] = None,
                 kinesis_data_stream: pulumi.Input[Optional[Union['StreamProcessorKinesisDataStreamArgs', 'StreamProcessorKinesisDataStreamArgsDict', 'outputs.StreamProcessorKinesisDataStream']]] = None,
                 kinesis_video_stream: pulumi.Input[Optional[Union['StreamProcessorKinesisVideoStreamArgs', 'StreamProcessorKinesisVideoStreamArgsDict', 'outputs.StreamProcessorKinesisVideoStream']]] = None,
                 kms_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 polygon_regions_of_interest: pulumi.Input[Optional[Sequence[pulumi.Input[Sequence[pulumi.Input[Union['StreamProcessorPointArgs', 'StreamProcessorPointArgsDict', 'outputs.StreamProcessorPoint']]]]]]] = None,
                 role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 s3_destination: pulumi.Input[Optional[Union['StreamProcessorS3DestinationArgs', 'StreamProcessorS3DestinationArgsDict', 'outputs.StreamProcessorS3Destination']]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['StreamProcessorBoundingBoxArgs', 'StreamProcessorBoundingBoxArgsDict', 'outputs.StreamProcessorBoundingBox']]]] bounding_box_regions_of_interest: The BoundingBoxRegionsOfInterest specifies an array of bounding boxes of interest in the video frames to analyze, as part of connected home feature. If an object is partially in a region of interest, Rekognition will tag it as detected if the overlap of the object with the region-of-interest is greater than 20%.
        :param pulumi.Input[Union['StreamProcessorConnectedHomeSettingsArgs', 'StreamProcessorConnectedHomeSettingsArgsDict', 'outputs.StreamProcessorConnectedHomeSettings']] connected_home_settings: Connected home settings to use on a streaming video. You can use a stream processor for connected home features and select what you want the stream processor to detect, such as people or pets. When the stream processor has started, one notification is sent for each object class specified. For more information, see the ConnectedHome section of [StreamProcessorSettings](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_StreamProcessorSettings) .
        :param pulumi.Input[Union['StreamProcessorDataSharingPreferenceArgs', 'StreamProcessorDataSharingPreferenceArgsDict', 'outputs.StreamProcessorDataSharingPreference']] data_sharing_preference: Allows you to opt in or opt out to share data with Rekognition to improve model performance. You can choose this option at the account level or on a per-stream basis. Note that if you opt out at the account level this setting is ignored on individual streams. For more information, see [StreamProcessorDataSharingPreference](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_StreamProcessorDataSharingPreference) .
        :param pulumi.Input[Union['StreamProcessorFaceSearchSettingsArgs', 'StreamProcessorFaceSearchSettingsArgsDict', 'outputs.StreamProcessorFaceSearchSettings']] face_search_settings: The input parameters used to recognize faces in a streaming video analyzed by an Amazon Rekognition stream processor. For more information regarding the contents of the parameters, see [FaceSearchSettings](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_FaceSearchSettings) .
        :param pulumi.Input[Union['StreamProcessorKinesisDataStreamArgs', 'StreamProcessorKinesisDataStreamArgsDict', 'outputs.StreamProcessorKinesisDataStream']] kinesis_data_stream: Amazon Rekognition's Video Stream Processor takes a Kinesis video stream as input. This is the Amazon Kinesis Data Streams instance to which the Amazon Rekognition stream processor streams the analysis results. This must be created within the constraints specified at [KinesisDataStream](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_KinesisDataStream) .
        :param pulumi.Input[Union['StreamProcessorKinesisVideoStreamArgs', 'StreamProcessorKinesisVideoStreamArgsDict', 'outputs.StreamProcessorKinesisVideoStream']] kinesis_video_stream: The Kinesis video stream that provides the source of the streaming video for an Amazon Rekognition Video stream processor. For more information, see [KinesisVideoStream](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_KinesisVideoStream) .
        :param pulumi.Input[_builtins.str] kms_key_id: The KMS key that is used by Rekognition to encrypt any intermediate customer metadata and store in the customer's S3 bucket.
        :param pulumi.Input[_builtins.str] name: Name of the stream processor. It's an identifier you assign to the stream processor. You can use it to manage the stream processor.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[Union['StreamProcessorPointArgs', 'StreamProcessorPointArgsDict', 'outputs.StreamProcessorPoint']]]]]] polygon_regions_of_interest: The PolygonRegionsOfInterest specifies a set of polygon areas of interest in the video frames to analyze, as part of connected home feature. Each polygon is in turn, an ordered list of Point
        :param pulumi.Input[_builtins.str] role_arn: ARN of the IAM role that allows access to the stream processor, and provides Rekognition read permissions for KVS stream and write permissions to S3 bucket and SNS topic.
        :param pulumi.Input[Union['StreamProcessorS3DestinationArgs', 'StreamProcessorS3DestinationArgsDict', 'outputs.StreamProcessorS3Destination']] s3_destination: The Amazon S3 bucket location to which Amazon Rekognition publishes the detailed inference results of a video analysis operation. For more information, see the S3Destination section of [StreamProcessorOutput](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_StreamProcessorOutput) .
