...
class ResourceSetArgs:
    def __init__(__self__, *,
                 resource_type_list: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_type_list: Determines the resources that can be associated to the resource set. Depending on your setting for max results and the number of resource sets, a single call might not return the full list.
        :param pulumi.Input[builtins.str] description: A description of the resource set.
        :param pulumi.Input[builtins.str] name: The descriptive name of the resource set. You can't change the name of a resource set after you create it.
        """
    ...
    def resource_type_list(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def resource_type_list(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ResourceSet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="resourceTypeList")
    def resource_type_list(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Determines the resources that can be associated to the resource set. Depending on your setting for max results and the number of resource sets, a single call might not return the full list.
        """
        return pulumi.get(self, "resource_type_list")
