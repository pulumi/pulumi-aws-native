...
class ResourceSetArgs:
    def __init__(__self__, *,
                 resource_type_list: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def resource_type_list(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def resource_type_list(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ResourceSet(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="resourceTypeList")
    def resource_type_list(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Determines the resources that can be associated to the resource set. Depending on your setting for max results and the number of resource sets, a single call might not return the full list.
        """
        return pulumi.get(self, "resource_type_list")
