...
class PolicyIeMap(dict):
    ...
    def __init__(__self__, *,
                 account: Optional[Sequence[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def account(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def orgunit(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class PolicyNetworkAclEntry(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str cidr_block: CIDR block.
...
class PolicyNetworkAclEntrySet(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool force_remediate_for_last_entries: Applies only when remediation is enabled for the policy as a whole. Firewall Manager uses this setting when it finds policy violations that involve conflicts between the custom entries and the policy entries.
