...
def get_resource_set(id: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceSetResult:
    """
    Creates an AWS Firewall Manager resource set.


    :param builtins.str id: A unique identifier for the resource set. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_resource_set_output(id: Optional[pulumi.Input[builtins.str]] = None,
