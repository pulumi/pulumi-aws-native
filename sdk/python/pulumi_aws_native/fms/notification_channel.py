...
class NotificationChannelArgs:
    def __init__(__self__, *,
                 sns_role_name: pulumi.Input[builtins.str],
                 sns_topic_arn: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a NotificationChannel resource.
        :param pulumi.Input[builtins.str] sns_role_name: The Amazon Resource Name (ARN) of the IAM role that allows Amazon SNS to record AWS Firewall Manager activity.
        :param pulumi.Input[builtins.str] sns_topic_arn: The Amazon Resource Name (ARN) of the SNS topic that collects notifications from AWS Firewall Manager .
        """
    ...
    def sns_role_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sns_role_name(self, value: pulumi.Input[builtins.str]):
...
class NotificationChannel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sns_role_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if sns_role_name is None and not opts.urn:
                raise TypeError("Missing required property 'sns_role_name'")
            __props__.__dict__["sns_role_name"] = sns_role_name
