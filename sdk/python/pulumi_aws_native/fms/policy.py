...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(exclude_map, PolicyIeMapArgs):
            ...
            if not isinstance(include_map, PolicyIeMapArgs):
            ...
            if not isinstance(security_service_policy_data, PolicySecurityServicePolicyDataArgs):
