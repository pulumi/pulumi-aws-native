...
class GetNotificationChannelResult:
    ...
    def sns_role_name(self) -> Optional[builtins.str]:
        """
...
def get_notification_channel(sns_topic_arn: Optional[builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNotificationChannelResult:
    """
    Designates the IAM role and Amazon Simple Notification Service (SNS) topic that AWS Firewall Manager uses to record SNS logs.


    :param builtins.str sns_topic_arn: The Amazon Resource Name (ARN) of the SNS topic that collects notifications from AWS Firewall Manager .
    """
    __args__ = dict()
...
def get_notification_channel_output(sns_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
