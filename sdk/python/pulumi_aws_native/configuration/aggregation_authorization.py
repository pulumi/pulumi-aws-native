...
class AggregationAuthorizationArgs:
    def __init__(__self__, *,
                 authorized_account_id: pulumi.Input[_builtins.str],
                 authorized_aws_region: pulumi.Input[_builtins.str],
    ...
    def authorized_account_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def authorized_account_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "authorized_account_id", value)

    @_builtins.property
    @pulumi.getter(name="authorizedAwsRegion")
    def authorized_aws_region(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def authorized_aws_region(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("aws-native:configuration:AggregationAuthorization")
class AggregationAuthorization(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 authorized_account_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] authorized_account_id: The 12-digit account ID of the account authorized to aggregate data.
        :param pulumi.Input[_builtins.str] authorized_aws_region: The region authorized to collect aggregated data.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags for the AggregationAuthorization.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def aggregation_authorization_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="authorizedAccountId")
    def authorized_account_id(self) -> pulumi.Output[_builtins.str]:
        """
        The 12-digit account ID of the account authorized to aggregate data.
        """
        return pulumi.get(self, "authorized_account_id")
