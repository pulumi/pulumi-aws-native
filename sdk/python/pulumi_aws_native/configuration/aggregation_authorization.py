...
__all__ = ['AggregationAuthorization']
...
class AggregationAuthorization(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AggregationAuthorizationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AggregationAuthorizationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AggregationAuthorizationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AggregationAuthorizationProperties']:
        """
