...
class GetConfigurationAggregatorResult:
    ...
    def configuration_aggregator_arn(self) -> Optional[builtins.str]:
        """
...
def get_configuration_aggregator(configuration_aggregator_name: Optional[builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConfigurationAggregatorResult:
    """
    Resource Type definition for AWS::Config::ConfigurationAggregator


    :param builtins.str configuration_aggregator_name: The name of the aggregator.
    """
    __args__ = dict()
...
def get_configuration_aggregator_output(configuration_aggregator_name: Optional[pulumi.Input[builtins.str]] = None,
