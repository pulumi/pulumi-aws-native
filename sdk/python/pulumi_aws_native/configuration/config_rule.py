...
class ConfigRuleArgs:
    def __init__(__self__, *,
                 ...
                 compliance: pulumi.Input[Optional['CompliancePropertiesArgs']] = None,
                 config_rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 evaluation_modes: pulumi.Input[Optional[Sequence[pulumi.Input['ConfigRuleEvaluationModeConfigurationArgs']]]] = None,
                 input_parameters: Optional[Any] = None,
                 maximum_execution_frequency: pulumi.Input[Optional[_builtins.str]] = None,
                 scope: pulumi.Input[Optional['ConfigRuleScopeArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] config_rule_name: A name for the CC rule. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the rule name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
        :param pulumi.Input[_builtins.str] description: The description that you provide for the CC rule.
        ...
        :param pulumi.Input[_builtins.str] maximum_execution_frequency: The maximum frequency with which CC runs evaluations for a rule. You can specify a value for ``MaximumExecutionFrequency`` when:
    ...
    @_builtins.property
    @pulumi.getter
    def compliance(self) -> pulumi.Input[Optional['CompliancePropertiesArgs']]:
        """
    ...
    @compliance.setter
    def compliance(self, value: pulumi.Input[Optional['CompliancePropertiesArgs']]):
    ...
    def evaluation_modes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ConfigRuleEvaluationModeConfigurationArgs']]]]:
        """
    ...
    def evaluation_modes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ConfigRuleEvaluationModeConfigurationArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def scope(self) -> pulumi.Input[Optional['ConfigRuleScopeArgs']]:
        """
    ...
    @scope.setter
    def scope(self, value: pulumi.Input[Optional['ConfigRuleScopeArgs']]):
...
class ConfigRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 compliance: pulumi.Input[Optional[Union['CompliancePropertiesArgs', 'CompliancePropertiesArgsDict', 'outputs.ComplianceProperties']]] = None,
                 config_rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 evaluation_modes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ConfigRuleEvaluationModeConfigurationArgs', 'ConfigRuleEvaluationModeConfigurationArgsDict', 'outputs.ConfigRuleEvaluationModeConfiguration']]]]] = None,
                 input_parameters: Optional[Any] = None,
                 maximum_execution_frequency: pulumi.Input[Optional[_builtins.str]] = None,
                 scope: pulumi.Input[Optional[Union['ConfigRuleScopeArgs', 'ConfigRuleScopeArgsDict', 'outputs.ConfigRuleScope']]] = None,
                 source: pulumi.Input[Optional[Union['ConfigRuleSourceArgs', 'ConfigRuleSourceArgsDict', 'outputs.ConfigRuleSource']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['CompliancePropertiesArgs', 'CompliancePropertiesArgsDict', 'outputs.ComplianceProperties']] compliance: Indicates whether an AWS resource or CC rule is compliant and provides the number of contributors that affect the compliance.
        :param pulumi.Input[_builtins.str] config_rule_name: A name for the CC rule. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the rule name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
        :param pulumi.Input[_builtins.str] description: The description that you provide for the CC rule.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ConfigRuleEvaluationModeConfigurationArgs', 'ConfigRuleEvaluationModeConfigurationArgsDict', 'outputs.ConfigRuleEvaluationModeConfiguration']]]] evaluation_modes: The modes the CC rule can be evaluated in. The valid values are distinct objects. By default, the value is Detective evaluation mode only.
        :param Any input_parameters: A string, in JSON format, that is passed to the CC rule Lambda function.
        ...
        :param pulumi.Input[_builtins.str] maximum_execution_frequency: The maximum frequency with which CC runs evaluations for a rule. You can specify a value for ``MaximumExecutionFrequency`` when:
                 ...
                 By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the ``MaximumExecutionFrequency`` parameter.
        :param pulumi.Input[Union['ConfigRuleScopeArgs', 'ConfigRuleScopeArgsDict', 'outputs.ConfigRuleScope']] scope: Defines which resources can trigger an evaluation for the rule. The scope can include one or more resource types, a combination of one resource type and one resource ID, or a combination of a tag key and value. Specify a scope to constrain the resources that can trigger an evaluation for the rule. If you do not specify a scope, evaluations are triggered when any resource in the recording group changes.
        :param pulumi.Input[Union['ConfigRuleSourceArgs', 'ConfigRuleSourceArgsDict', 'outputs.ConfigRuleSource']] source: Provides the rule owner (```` for managed rules, ``CUSTOM_POLICY`` for Custom Policy rules, and ``CUSTOM_LAMBDA`` for Custom Lambda rules), the rule identifier, and the notifications that cause the function to evaluate your AWS resources.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="configRuleName")
    def config_rule_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A name for the CC rule. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the rule name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
        """
        return pulumi.get(self, "config_rule_name")
