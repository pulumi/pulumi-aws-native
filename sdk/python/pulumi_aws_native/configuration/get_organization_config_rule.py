...
class GetOrganizationConfigRuleResult:
    def __init__(__self__, excluded_accounts=None, id=None, organization_custom_policy_rule_metadata=None, organization_custom_rule_metadata=None, organization_managed_rule_metadata=None):
        ...
        if organization_custom_policy_rule_metadata and not isinstance(organization_custom_policy_rule_metadata, dict):
            raise TypeError("Expected argument 'organization_custom_policy_rule_metadata' to be a dict")
    ...
    def organization_custom_policy_rule_metadata(self) -> Optional['outputs.OrganizationConfigRuleOrganizationCustomPolicyRuleMetadata']:
