...
class ConfigurationRecorder(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigurationRecorderPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationRecorderPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigurationRecorderAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigurationRecorderProperties']:
        """
