...
def get_config_rule(config_rule_name: Optional[builtins.str] = None,
    ...
    :param builtins.str config_rule_name: A name for the CC rule. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the rule name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
    """
    __args__ = dict()
...
def get_config_rule_output(config_rule_name: Optional[pulumi.Input[builtins.str]] = None,
