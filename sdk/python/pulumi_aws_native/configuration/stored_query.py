...
class StoredQueryArgs:
    def __init__(__self__, *,
                 query_expression: pulumi.Input[builtins.str],
                 query_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] query_expression: The expression of the query. For example, `SELECT resourceId, resourceType, supplementaryConfiguration.BucketVersioningConfiguration.status WHERE resourceType = 'AWS::S3::Bucket' AND supplementaryConfiguration.BucketVersioningConfiguration.status = 'Off'.`
        :param pulumi.Input[builtins.str] query_description: A unique description for the query.
        :param pulumi.Input[builtins.str] query_name: The name of the query.
    ...
    def query_expression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def query_expression(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "query_expression", value)

    @property
    @pulumi.getter(name="queryDescription")
    def query_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def query_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StoredQuery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 query_description: Optional[pulumi.Input[builtins.str]] = None,
                 query_expression: Optional[pulumi.Input[builtins.str]] = None,
                 query_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def query_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="queryDescription")
    def query_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A unique description for the query.
        """
        return pulumi.get(self, "query_description")
    ...
    @property
    @pulumi.getter(name="queryExpression")
    def query_expression(self) -> pulumi.Output[builtins.str]:
        """
        The expression of the query. For example, `SELECT resourceId, resourceType, supplementaryConfiguration.BucketVersioningConfiguration.status WHERE resourceType = 'AWS::S3::Bucket' AND supplementaryConfiguration.BucketVersioningConfiguration.status = 'Off'.`
        """
        return pulumi.get(self, "query_expression")
