...
class StoredQueryArgs:
    ...
    def query_expression(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def query_expression(self, value: pulumi.Input[_builtins.str]):
...
class StoredQuery(pulumi.CustomResource):
    ...
    def query_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="queryDescription")
    def query_description(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A unique description for the query.
        """
        return pulumi.get(self, "query_description")
    ...
    @_builtins.property
    @pulumi.getter(name="queryExpression")
    def query_expression(self) -> pulumi.Output[_builtins.str]:
        """
        The expression of the query. For example, `SELECT resourceId, resourceType, supplementaryConfiguration.BucketVersioningConfiguration.status WHERE resourceType = 'AWS::S3::Bucket' AND supplementaryConfiguration.BucketVersioningConfiguration.status = 'Off'.`
        """
        return pulumi.get(self, "query_expression")
