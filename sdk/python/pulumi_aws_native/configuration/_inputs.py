...
class CompliancePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Indicates whether an AWS resource or CC rule is compliant and provides the number of contributors that affect the compliance.
        :param pulumi.Input[builtins.str] type: Compliance type determined by the Config rule
        """
        if type is not None:
...
if not MYPY:
    class ConfigRuleCustomPolicyDetailsArgsDict(TypedDict):
        ...
        """
        policy_runtime: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        policy_text: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConfigRuleCustomPolicyDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        Provides the CustomPolicyDetails, the rule owner (```` for managed rules, ``CUSTOM_POLICY`` for Custom Policy rules, and ``CUSTOM_LAMBDA`` for Custom Lambda rules), the rule identifier, and the events that cause the evaluation of your AWS resources.
        :param pulumi.Input[builtins.bool] enable_debug_log_delivery: The boolean expression for enabling debug logging for your CC Custom Policy rule. The default value is ``false``.
        :param pulumi.Input[builtins.str] policy_runtime: The runtime system for your CC Custom Policy rule. Guard is a policy-as-code language that allows you to write policies that are enforced by CC Custom Policy rules. For more information about Guard, see the [Guard GitHub Repository](https://docs.aws.amazon.com/https://github.com/aws-cloudformation/cloudformation-guard).
        :param pulumi.Input[builtins.str] policy_text: The policy definition containing the logic for your CC Custom Policy rule.
        """
...
class ConfigRuleEvaluationModeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration object for CC rule evaluation mode. The supported valid values are Detective or Proactive.
        :param pulumi.Input[builtins.str] mode: The mode of an evaluation. The valid values are Detective or Proactive.
        """
        if mode is not None:
...
class ConfigRuleScopeArgs:
    def __init__(__self__, *,
        ...
        """
        Defines which resources trigger an evaluation for an CC rule. The scope can include one or more resource types, a combination of a tag key and value, or a combination of one resource type and one resource ID. Specify a scope to constrain which resources trigger an evaluation for a rule. Otherwise, evaluations for the rule are triggered when any resource in your recording group changes in configuration.
        :param pulumi.Input[builtins.str] compliance_resource_id: The ID of the only AWS resource that you want to trigger an evaluation for the rule. If you specify a resource ID, you must specify one resource type for ``ComplianceResourceTypes``.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compliance_resource_types: The resource types of only those AWS resources that you want to trigger an evaluation for the rule. You can only specify one type if you also specify a resource ID for ``ComplianceResourceId``.
        :param pulumi.Input[builtins.str] tag_key: The tag key that is applied to only those AWS resources that you want to trigger an evaluation for the rule.
        :param pulumi.Input[builtins.str] tag_value: The tag value applied to only those AWS resources that you want to trigger an evaluation for the rule. If you specify a value for ``TagValue``, you must also specify a value for ``TagKey``.
        """
...
class ConfigRuleSourceDetailArgs:
    def __init__(__self__, *,
        ...
        """
        Provides the source and the message types that trigger CC to evaluate your AWS resources against a rule. It also provides the frequency with which you want CC to run evaluations for the rule if the trigger type is periodic. You can specify the parameter values for ``SourceDetail`` only for custom rules.
        :param pulumi.Input[builtins.str] event_source: The source of the event, such as an AWS service, that triggers CC to evaluate your AWS resources.
        :param pulumi.Input[builtins.str] message_type: The type of notification that triggers CC to run an evaluation for a rule. You can specify the following notification types:
                 +   ``ConfigurationItemChangeNotification`` - Triggers an evaluation when CC delivers a configuration item as a result of a resource change.
                 +   ``OversizedConfigurationItemChangeNotification`` - Triggers an evaluation when CC delivers an oversized configuration item. CC may generate this notification type when a resource changes and the notification exceeds the maximum size allowed by Amazon SNS.
                 +   ``ScheduledNotification`` - Triggers a periodic evaluation at the frequency specified for ``MaximumExecutionFrequency``.
                 +   ``ConfigurationSnapshotDeliveryCompleted`` - Triggers a periodic evaluation when CC delivers a configuration snapshot.
                ...
                If you want your custom rule to be triggered by configuration changes, specify two SourceDetail objects, one for ``ConfigurationItemChangeNotification`` and one for ``OversizedConfigurationItemChangeNotification``.
        :param pulumi.Input[builtins.str] maximum_execution_frequency: The frequency at which you want CC to run evaluations for a custom rule with a periodic trigger. If you specify a value for ``MaximumExecutionFrequency``, then ``MessageType`` must use the ``ScheduledNotification`` value.
                 By default, rules with a periodic trigger are evaluated every 24 hours. To change the frequency, specify a valid value for the ``MaximumExecutionFrequency`` parameter.
                Based on the valid value you choose, CC runs evaluations once for each valid value. For example, if you choose ``Three_Hours``, CC runs evaluations once every three hours. In this case, ``Three_Hours`` is the frequency of this rule.
        """
...
class ConfigRuleSourceArgs:
    def __init__(__self__, *,
        ...
        """
        Provides the CustomPolicyDetails, the rule owner (```` for managed rules, ``CUSTOM_POLICY`` for Custom Policy rules, and ``CUSTOM_LAMBDA`` for Custom Lambda rules), the rule identifier, and the events that cause the evaluation of your AWS resources.
        :param pulumi.Input[builtins.str] owner: Indicates whether AWS or the customer owns and manages the CC rule.
                 CC Managed Rules are predefined rules owned by AWS. For more information, see [Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html) in the *developer guide*.
                 CC Custom Rules are rules that you can develop either with Guard (``CUSTOM_POLICY``) or LAMlong (``CUSTOM_LAMBDA``). For more information, see [Custom Rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_develop-rules.html) in the *developer guide*.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ConfigRuleSourceDetailArgs']]] source_details: Provides the source and the message types that cause CC to evaluate your AWS resources against a rule. It also provides the frequency with which you want CC to run evaluations for the rule if the trigger type is periodic.
                If the owner is set to ``CUSTOM_POLICY``, the only acceptable values for the CC rule trigger message type are ``ConfigurationItemChangeNotification`` and ``OversizedConfigurationItemChangeNotification``.
        :param pulumi.Input[builtins.str] source_identifier: For CC Managed rules, a predefined identifier from a list. For example, ``IAM_PASSWORD_POLICY`` is a managed rule. To reference a managed rule, see [List of Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html).
                For CC Custom Lambda rules, the identifier is the Amazon Resource Name (ARN) of the rule's LAMlong function, such as ``arn:aws:lambda:us-east-2:123456789012:function:custom_rule_name``.
                For CC Custom Policy rules, this field will be ignored.
        """
...
if not MYPY:
    class ConfigurationAggregatorAccountAggregationSourceArgsDict(TypedDict):
        ...
        """
        all_aws_regions: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ConfigurationAggregatorAccountAggregationSourceArgs:
    def __init__(__self__, *,
                 account_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 all_aws_regions: Optional[pulumi.Input[builtins.bool]] = None,
                 aws_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] account_ids: The 12-digit account ID of the account being aggregated.
        :param pulumi.Input[builtins.bool] all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] aws_regions: The source regions being aggregated.
        """
    ...
    def all_aws_regions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, aggregate existing AWS Config regions and future regions.
        """
    ...
    def all_aws_regions(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ConfigurationAggregatorOrganizationAggregationSourceArgs:
    def __init__(__self__, *,
                 ...
                 aws_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] role_arn: ARN of the IAM role used to retrieve AWS Organizations details associated with the aggregator account.
        :param pulumi.Input[builtins.bool] all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] aws_regions: The source regions being aggregated.
        """
...
class ConformancePackInputParameterArgs:
    def __init__(__self__, *,
        ...
        """
        Input parameters in the form of key-value pairs for the conformance pack.
        :param pulumi.Input[builtins.str] parameter_name: One part of a key-value pair.
        :param pulumi.Input[builtins.str] parameter_value: Another part of the key-value pair.
        """
...
class OrganizationConformancePackConformancePackInputParameterArgs:
    def __init__(__self__, *,
        ...
        Input parameters in the form of key-value pairs for the conformance pack.
        :param pulumi.Input[builtins.str] parameter_name: One part of a key-value pair.
        :param pulumi.Input[builtins.str] parameter_value: One part of a key-value pair.
        """
        pulumi.set(__self__, "parameter_name", parameter_name)
        pulumi.set(__self__, "parameter_value", parameter_value)
...
if not MYPY:
    class TemplateSsmDocumentDetailsPropertiesArgsDict(TypedDict):
        ...
        """
        document_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TemplateSsmDocumentDetailsPropertiesArgs:
    def __init__(__self__, *,
                 document_name: Optional[pulumi.Input[builtins.str]] = None,
                 document_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The TemplateSSMDocumentDetails object contains the name of the SSM document and the version of the SSM document.
        :param pulumi.Input[builtins.str] document_name: The name or Amazon Resource Name (ARN) of the SSM document to use to create a conformance pack. If you use the document name, AWS Config checks only your account and AWS Region for the SSM document.
        :param pulumi.Input[builtins.str] document_version: The version of the SSM document to use to create a conformance pack. By default, AWS Config uses the latest version.
    ...
    def document_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name or Amazon Resource Name (ARN) of the SSM document to use to create a conformance pack. If you use the document name, AWS Config checks only your account and AWS Region for the SSM document.
        """
    ...
    def document_name(self, value: Optional[pulumi.Input[builtins.str]]):
