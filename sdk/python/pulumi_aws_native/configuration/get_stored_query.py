...
class GetStoredQueryResult:
    ...
    def query_arn(self) -> Optional[builtins.str]:
        """
    ...
    def query_description(self) -> Optional[builtins.str]:
        """
    ...
    def query_expression(self) -> Optional[builtins.str]:
        """
...
def get_stored_query(query_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStoredQueryResult:
    """
    Resource Type definition for AWS::Config::StoredQuery


    :param builtins.str query_name: The name of the query.
    """
    __args__ = dict()
...
def get_stored_query_output(query_name: Optional[pulumi.Input[builtins.str]] = None,
