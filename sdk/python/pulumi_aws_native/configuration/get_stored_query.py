...
class GetStoredQueryResult:
    ...
    def query_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def query_description(self) -> Optional[_builtins.str]:
        """
    ...
    def query_expression(self) -> Optional[_builtins.str]:
        """
...
def get_stored_query(query_name: Optional[_builtins.str] = None,
