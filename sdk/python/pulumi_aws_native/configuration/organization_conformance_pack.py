...
class OrganizationConformancePackArgs:
    def __init__(__self__, *,
                 ...
                 organization_conformance_pack_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] delivery_s3_key_prefix: The prefix for the delivery S3 bucket.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_accounts: A list of AWS accounts to be excluded from an organization conformance pack while deploying a conformance pack.
        :param pulumi.Input[builtins.str] organization_conformance_pack_name: The name of the organization conformance pack.
        :param pulumi.Input[builtins.str] template_body: A string containing full conformance pack template body.
        :param pulumi.Input[builtins.str] template_s3_uri: Location of file containing the template body.
        """
    ...
    def organization_conformance_pack_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def organization_conformance_pack_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrganizationConformancePack(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="organizationConformancePackName")
    def organization_conformance_pack_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the organization conformance pack.
        """
        return pulumi.get(self, "organization_conformance_pack_name")
