...
class OrganizationConformancePackArgs:
    ...
    def _configure(
        ...
        if organization_conformance_pack_name is None and 'organizationConformancePackName' in kwargs:
            organization_conformance_pack_name = kwargs['organizationConformancePackName']
        ...
        if organization_conformance_pack_name is not None:
            _setter("organization_conformance_pack_name", organization_conformance_pack_name)
