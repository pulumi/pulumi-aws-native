...
class ConfigRuleCustomPolicyDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 policy_runtime: Optional[_builtins.str] = None,
    ...
    def policy_runtime(self) -> Optional[_builtins.str]:
        """
    ...
    def policy_text(self) -> Optional[_builtins.str]:
        """
...
class ConfigRuleScope(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tag_value: The tag value applied to only those AWS resources that you want to trigger an evaluation for the rule. If you specify a value for ``TagValue``, you must also specify a value for ``TagKey``.
        """
...
class ConfigRuleSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str source_identifier: For CC Managed rules, a predefined identifier from a list. For example, ``IAM_PASSWORD_POLICY`` is a managed rule. To reference a managed rule, see [List of Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html).
...
class ConfigRuleSourceDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str maximum_execution_frequency: The frequency at which you want CC to run evaluations for a custom rule with a periodic trigger. If you specify a value for ``MaximumExecutionFrequency``, then ``MessageType`` must use the ``ScheduledNotification`` value.
...
class ConfigurationAggregatorAccountAggregationSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 all_aws_regions: Optional[_builtins.bool] = None,
                 aws_regions: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] account_ids: The 12-digit account ID of the account being aggregated.
        :param _builtins.bool all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param Sequence[_builtins.str] aws_regions: The source regions being aggregated.
        """
    ...
    def all_aws_regions(self) -> Optional[_builtins.bool]:
        """
...
class ConfigurationAggregatorOrganizationAggregationSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aws_regions: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str role_arn: ARN of the IAM role used to retrieve AWS Organizations details associated with the aggregator account.
        :param _builtins.bool all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param Sequence[_builtins.str] aws_regions: The source regions being aggregated.
        """
...
@pulumi.output_type
class ConnectorAzureConnectorConfiguration(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if key == "clientIdentifier":
            suggest = "client_identifier"
        elif key == "tenantIdentifier":
            suggest = "tenant_identifier"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ConnectorAzureConnectorConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ConnectorAzureConnectorConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 client_identifier: _builtins.str,
                 tenant_identifier: _builtins.str):
        """
        Configuration for connecting to Microsoft Azure.

        :param _builtins.str client_identifier: The Azure client (application) identifier.
        :param _builtins.str tenant_identifier: The Azure tenant identifier.
        """
    ...
    def client_identifier(self) -> _builtins.str:
        """
...
@pulumi.output_type
class ConnectorConfiguration(dict):
    """
    The configuration for the connector. Specify the third-party cloud provider configuration.
    """
    def __init__(__self__, *,
                 azure: Optional['outputs.ConnectorAzureConnectorConfiguration'] = None):
        """
        The configuration for the connector. Specify the third-party cloud provider configuration.

        :param 'ConnectorAzureConnectorConfiguration' azure: The configuration for connecting to Microsoft Azure.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def azure(self) -> Optional['outputs.ConnectorAzureConnectorConfiguration']:
        """
...
class RemediationConfigurationExecutionControls(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'RemediationConfigurationSsmControls' ssm_controls: A SsmControls object.
        """
...
class RemediationConfigurationSsmControls(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int concurrent_execution_rate_percentage: The maximum percentage of remediation actions allowed to run in parallel on the non-compliant resources for that specific rule. You can specify a percentage, such as 10%. The default value is 10.
        :param _builtins.int error_percentage: The percentage of errors that are allowed before SSM stops running automations on non-compliant resources for that specific rule. You can specify a percentage of errors, for example 10%. If you do not specifiy a percentage, the default is 50%. For example, if you set the ErrorPercentage to 40% for 10 non-compliant resources, then SSM stops running the automations when the fifth error is received.
        """
