...
class ComplianceProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Indicates whether an AWS resource or CC rule is compliant and provides the number of contributors that affect the compliance.
        :param builtins.str type: Compliance type determined by the Config rule
        """
        if type is not None:
...
class ConfigRuleCustomPolicyDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 policy_runtime: Optional[builtins.str] = None,
                 policy_text: Optional[builtins.str] = None):
        """
        Provides the CustomPolicyDetails, the rule owner (```` for managed rules, ``CUSTOM_POLICY`` for Custom Policy rules, and ``CUSTOM_LAMBDA`` for Custom Lambda rules), the rule identifier, and the events that cause the evaluation of your AWS resources.
        :param builtins.bool enable_debug_log_delivery: The boolean expression for enabling debug logging for your CC Custom Policy rule. The default value is ``false``.
        :param builtins.str policy_runtime: The runtime system for your CC Custom Policy rule. Guard is a policy-as-code language that allows you to write policies that are enforced by CC Custom Policy rules. For more information about Guard, see the [Guard GitHub Repository](https://docs.aws.amazon.com/https://github.com/aws-cloudformation/cloudformation-guard).
        :param builtins.str policy_text: The policy definition containing the logic for your CC Custom Policy rule.
        """
    ...
    def policy_runtime(self) -> Optional[builtins.str]:
        """
    ...
    def policy_text(self) -> Optional[builtins.str]:
        """
...
class ConfigRuleEvaluationModeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration object for CC rule evaluation mode. The supported valid values are Detective or Proactive.
        :param builtins.str mode: The mode of an evaluation. The valid values are Detective or Proactive.
        """
        if mode is not None:
...
class ConfigRuleScope(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines which resources trigger an evaluation for an CC rule. The scope can include one or more resource types, a combination of a tag key and value, or a combination of one resource type and one resource ID. Specify a scope to constrain which resources trigger an evaluation for a rule. Otherwise, evaluations for the rule are triggered when any resource in your recording group changes in configuration.
        :param builtins.str compliance_resource_id: The ID of the only AWS resource that you want to trigger an evaluation for the rule. If you specify a resource ID, you must specify one resource type for ``ComplianceResourceTypes``.
        :param Sequence[builtins.str] compliance_resource_types: The resource types of only those AWS resources that you want to trigger an evaluation for the rule. You can only specify one type if you also specify a resource ID for ``ComplianceResourceId``.
        :param builtins.str tag_key: The tag key that is applied to only those AWS resources that you want to trigger an evaluation for the rule.
        :param builtins.str tag_value: The tag value applied to only those AWS resources that you want to trigger an evaluation for the rule. If you specify a value for ``TagValue``, you must also specify a value for ``TagKey``.
        """
...
class ConfigRuleSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides the CustomPolicyDetails, the rule owner (```` for managed rules, ``CUSTOM_POLICY`` for Custom Policy rules, and ``CUSTOM_LAMBDA`` for Custom Lambda rules), the rule identifier, and the events that cause the evaluation of your AWS resources.
        :param builtins.str owner: Indicates whether AWS or the customer owns and manages the CC rule.
        ...
        :param builtins.str source_identifier: For CC Managed rules, a predefined identifier from a list. For example, ``IAM_PASSWORD_POLICY`` is a managed rule. To reference a managed rule, see [List of Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html).
...
class ConfigRuleSourceDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides the source and the message types that trigger CC to evaluate your AWS resources against a rule. It also provides the frequency with which you want CC to run evaluations for the rule if the trigger type is periodic. You can specify the parameter values for ``SourceDetail`` only for custom rules.
        :param builtins.str event_source: The source of the event, such as an AWS service, that triggers CC to evaluate your AWS resources.
        :param builtins.str message_type: The type of notification that triggers CC to run an evaluation for a rule. You can specify the following notification types:
        ...
        :param builtins.str maximum_execution_frequency: The frequency at which you want CC to run evaluations for a custom rule with a periodic trigger. If you specify a value for ``MaximumExecutionFrequency``, then ``MessageType`` must use the ``ScheduledNotification`` value.
...
class ConfigurationAggregatorAccountAggregationSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 all_aws_regions: Optional[builtins.bool] = None,
                 aws_regions: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] account_ids: The 12-digit account ID of the account being aggregated.
        :param builtins.bool all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param Sequence[builtins.str] aws_regions: The source regions being aggregated.
        """
    ...
    def all_aws_regions(self) -> Optional[builtins.bool]:
        """
...
class ConfigurationAggregatorOrganizationAggregationSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aws_regions: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str role_arn: ARN of the IAM role used to retrieve AWS Organizations details associated with the aggregator account.
        :param builtins.bool all_aws_regions: If true, aggregate existing AWS Config regions and future regions.
        :param Sequence[builtins.str] aws_regions: The source regions being aggregated.
        """
...
class ConformancePackInputParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Input parameters in the form of key-value pairs for the conformance pack.
        :param builtins.str parameter_name: One part of a key-value pair.
        :param builtins.str parameter_value: Another part of the key-value pair.
        """
...
class OrganizationConformancePackConformancePackInputParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        Input parameters in the form of key-value pairs for the conformance pack.
        :param builtins.str parameter_name: One part of a key-value pair.
        :param builtins.str parameter_value: One part of a key-value pair.
        """
        pulumi.set(__self__, "parameter_name", parameter_name)
        pulumi.set(__self__, "parameter_value", parameter_value)
...
class TemplateSsmDocumentDetailsProperties(dict):
    ...
    def __init__(__self__, *,
                 document_name: Optional[builtins.str] = None,
                 document_version: Optional[builtins.str] = None):
        """
        The TemplateSSMDocumentDetails object contains the name of the SSM document and the version of the SSM document.
        :param builtins.str document_name: The name or Amazon Resource Name (ARN) of the SSM document to use to create a conformance pack. If you use the document name, AWS Config checks only your account and AWS Region for the SSM document.
        :param builtins.str document_version: The version of the SSM document to use to create a conformance pack. By default, AWS Config uses the latest version.
