...
class GetChallengeResult:
    ...
    def challenge_arn(self) -> Optional[builtins.str]:
        """
...
def get_challenge(challenge_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str challenge_arn: The Amazon Resource Name (ARN) of the challenge.
    """
    __args__ = dict()
...
def get_challenge_output(challenge_arn: Optional[pulumi.Input[builtins.str]] = None,
