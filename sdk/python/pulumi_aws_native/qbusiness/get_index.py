...
def get_index(application_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_id: The identifier of the Amazon Q Business application using the index.
    :param builtins.str index_id: The identifier for the index.
    """
    __args__ = dict()
...
def get_index_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
