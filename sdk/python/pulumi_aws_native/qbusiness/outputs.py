...
class DataAccessorActionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: The Amazon Q Business action that is allowed.
        :param 'DataAccessorActionFilterConfiguration' filter_configuration: The filter configuration for the action, if any.
        """
...
class DataAccessorActionFilterConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'DataAccessorAttributeFilter' document_attribute_filter: Enables filtering of responses based on document attributes or metadata fields.
        """
...
class DataAccessorAttributeFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DataAccessorAttributeFilter'] and_all_filters: Performs a logical `AND` operation on all supplied filters.
        :param 'DataAccessorDocumentAttribute' contains_all: Returns `true` when a document contains all the specified document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `stringListValue` .
        :param 'DataAccessorDocumentAttribute' contains_any: Returns `true` when a document contains any of the specified document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `stringListValue` .
        :param 'DataAccessorDocumentAttribute' equals_to: Performs an equals operation on two document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `dateValue` , `longValue` , `stringListValue` and `stringValue` .
        :param 'DataAccessorDocumentAttribute' greater_than: Performs a greater than operation on two document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `dateValue` and `longValue` .
        :param 'DataAccessorDocumentAttribute' greater_than_or_equals: Performs a greater or equals than operation on two document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `dateValue` and `longValue` .
        :param 'DataAccessorDocumentAttribute' less_than: Performs a less than operation on two document attributes or metadata fields. Supported for the following [document attribute value types](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `dateValue` and `longValue` .
        :param 'DataAccessorDocumentAttribute' less_than_or_equals: Performs a less than or equals operation on two document attributes or metadata fields.Supported for the following [document attribute value type](https://docs.aws.amazon.com/amazonq/latest/api-reference/API_DocumentAttributeValue.html) : `dateValue` and `longValue` .
        :param 'DataAccessorAttributeFilter' not_filter: Performs a logical `NOT` operation on all supplied filters.
        :param Sequence['DataAccessorAttributeFilter'] or_all_filters: Performs a logical `OR` operation on all supplied filters.
        """
...
class DataAccessorAuthenticationDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] external_ids: A list of external identifiers associated with this authentication configuration. These are used to correlate the data accessor with external systems.
        """
...
class DataAccessorDocumentAttributeValue1Properties(dict):
    ...
    def __init__(__self__, *,
                 string_list_value: Sequence[_builtins.str]):
        pulumi.set(__self__, "string_list_value", string_list_value)

    @_builtins.property
    @pulumi.getter(name="stringListValue")
    def string_list_value(self) -> Sequence[_builtins.str]:
...
class DataAccessorDocumentAttributeValue3Properties(dict):
    ...
    def __init__(__self__, *,
                 date_value: _builtins.str):
        pulumi.set(__self__, "date_value", date_value)

    @_builtins.property
    @pulumi.getter(name="dateValue")
    def date_value(self) -> _builtins.str:
...
class DataSourceAudioExtractionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'DataSourceAudioExtractionStatus' audio_extraction_status: The status of audio extraction (ENABLED or DISABLED) for processing audio content from files.
        """
...
class DataSourceHookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str lambda_arn: The Amazon Resource Name (ARN) of the Lambda function during ingestion. For more information, see [Using Lambda functions for Amazon Q Business document enrichment](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/cde-lambda-operations.html) .
        :param _builtins.str role_arn: The Amazon Resource Name (ARN) of a role with permission to run `PreExtractionHookConfiguration` and `PostExtractionHookConfiguration` for altering document metadata and content during the document ingestion process.
        :param _builtins.str s3_bucket_name: Stores the original, raw documents or the structured, parsed documents before and after altering them. For more information, see [Data contracts for Lambda functions](https://docs.aws.amazon.com/amazonq/latest/business-use-dg/cde-lambda-operations.html#cde-lambda-operations-data-contracts) .
        """
...
class DataSourceImageExtractionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'DataSourceImageExtractionStatus' image_extraction_status: Specify whether to extract semantic meaning from images and visuals from documents.
        """
...
class DataSourceMediaExtractionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'DataSourceAudioExtractionConfiguration' audio_extraction_configuration: Configuration settings for extracting and processing audio content from media files.
        ...
        :param 'DataSourceVideoExtractionConfiguration' video_extraction_configuration: Configuration settings for extracting and processing video content from media files.
        """
...
class DataSourceVideoExtractionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'DataSourceVideoExtractionStatus' video_extraction_status: The status of video extraction (ENABLED or DISABLED) for processing video content from files.
        """
...
class DataSourceVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] security_group_ids: A list of identifiers of security groups within your Amazon VPC. The security groups should enable Amazon Q Business to connect to the data source.
...
class IndexCapacityConfiguration(dict):
    def __init__(__self__, *,
                 units: Optional[_builtins.float] = None):
        """
        :param _builtins.float units: The number of storage units configured for an Amazon Q Business index.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def units(self) -> Optional[_builtins.float]:
        """
...
class IndexDocumentAttributeConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the document attribute.
...
class IndexTextDocumentStatistics(dict):
    ...
    def __init__(__self__, *,
                 indexed_text_bytes: Optional[_builtins.float] = None,
                 indexed_text_document_count: Optional[_builtins.float] = None):
        """
        :param _builtins.float indexed_text_bytes: The total size, in bytes, of the indexed documents.
        :param _builtins.float indexed_text_document_count: The number of text documents indexed.
        """
    ...
    def indexed_text_bytes(self) -> Optional[_builtins.float]:
        """
    ...
    def indexed_text_document_count(self) -> Optional[_builtins.float]:
        """
...
class PermissionCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 condition_values: Sequence[_builtins.str]):
    ...
    def condition_values(self) -> Sequence[_builtins.str]:
...
class PluginCustomPluginConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str description: A description for your custom plugin configuration.
        """
...
@pulumi.output_type
class WebExperienceBrowserExtensionConfiguration(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "enabledBrowserExtensions":
            suggest = "enabled_browser_extensions"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in WebExperienceBrowserExtensionConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        WebExperienceBrowserExtensionConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 enabled_browser_extensions: Sequence['WebExperienceBrowserExtension']):
        """
        :param Sequence['WebExperienceBrowserExtension'] enabled_browser_extensions: Specify the browser extensions allowed for your Amazon Q web experience.
    ...
    def enabled_browser_extensions(self) -> Sequence['WebExperienceBrowserExtension']:
        """
...
class WebExperienceCustomizationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 custom_css_url: Optional[_builtins.str] = None,
                 favicon_url: Optional[_builtins.str] = None,
                 font_url: Optional[_builtins.str] = None,
                 logo_url: Optional[_builtins.str] = None):
        """
        :param _builtins.str custom_css_url: Provides the URL where the custom CSS file is hosted for an Amazon Q web experience.
        :param _builtins.str favicon_url: Provides the URL where the custom favicon file is hosted for an Amazon Q web experience.
        :param _builtins.str font_url: Provides the URL where the custom font file is hosted for an Amazon Q web experience.
        :param _builtins.str logo_url: Provides the URL where the custom logo file is hosted for an Amazon Q web experience.
        """
    ...
    def custom_css_url(self) -> Optional[_builtins.str]:
        """
    ...
    def favicon_url(self) -> Optional[_builtins.str]:
        """
