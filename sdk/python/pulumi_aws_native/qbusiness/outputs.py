...
class ApplicationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: The identifier of the AWS KMS key. Amazon Q Business doesn't support asymmetric keys.
        """
...
class ApplicationQuickSightConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_namespace: The Amazon QuickSight namespace that is used as the identity provider. For more information about QuickSight namespaces, see [Namespace operations](https://docs.aws.amazon.com/quicksight/latest/developerguide/namespace-operations.html) .
        """
...
class DataAccessorActionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The Amazon Q Business action that is allowed.
...
class DataAccessorDocumentAttribute(dict):
    def __init__(__self__, *,
                 ...
                 value: Any):
        """
        :param builtins.str name: The identifier for the attribute.
...
class DataAccessorDocumentAttributeValue2Properties(dict):
    ...
    def long_value(self) -> builtins.float:
...
class DataSourceDocumentAttributeCondition(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The identifier of the document attribute used for the condition.
...
class DataSourceDocumentAttributeTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[Any] = None):
        """
        :param builtins.str key: The identifier of the target document attribute or metadata field. For example, 'Department' could be an identifier for the target attribute or metadata field that includes the department names associated with the documents.
...
class DataSourceVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: A list of identifiers of security groups within your Amazon VPC. The security groups should enable Amazon Q Business to connect to the data source.
...
class IndexCapacityConfiguration(dict):
    def __init__(__self__, *,
                 units: Optional[builtins.float] = None):
        """
        :param builtins.float units: The number of storage units configured for an Amazon Q Business index.
        """
    ...
    @property
    @pulumi.getter
    def units(self) -> Optional[builtins.float]:
        """
...
class IndexDocumentAttributeConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the document attribute.
...
class IndexTextDocumentStatistics(dict):
    ...
    def __init__(__self__, *,
                 indexed_text_bytes: Optional[builtins.float] = None,
                 indexed_text_document_count: Optional[builtins.float] = None):
        """
        :param builtins.float indexed_text_bytes: The total size, in bytes, of the indexed documents.
        :param builtins.float indexed_text_document_count: The number of text documents indexed.
        """
    ...
    def indexed_text_bytes(self) -> Optional[builtins.float]:
        """
    ...
    def indexed_text_document_count(self) -> Optional[builtins.float]:
        """
...
class PluginCustomPluginConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: A description for your custom plugin configuration.
        """
...
class WebExperienceCustomizationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 custom_css_url: Optional[builtins.str] = None,
                 favicon_url: Optional[builtins.str] = None,
                 font_url: Optional[builtins.str] = None,
                 logo_url: Optional[builtins.str] = None):
        """
        :param builtins.str custom_css_url: Provides the URL where the custom CSS file is hosted for an Amazon Q web experience.
        :param builtins.str favicon_url: Provides the URL where the custom favicon file is hosted for an Amazon Q web experience.
        :param builtins.str font_url: Provides the URL where the custom font file is hosted for an Amazon Q web experience.
        :param builtins.str logo_url: Provides the URL where the custom logo file is hosted for an Amazon Q web experience.
        """
    ...
    def custom_css_url(self) -> Optional[builtins.str]:
        """
    ...
    def favicon_url(self) -> Optional[builtins.str]:
        """
    ...
    def font_url(self) -> Optional[builtins.str]:
        """
    ...
    def logo_url(self) -> Optional[builtins.str]:
        """
