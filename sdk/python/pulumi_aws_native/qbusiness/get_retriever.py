...
class GetRetrieverResult:
    ...
    def retriever_arn(self) -> Optional[builtins.str]:
        """
    ...
    def retriever_id(self) -> Optional[builtins.str]:
        """
...
def get_retriever(application_id: Optional[builtins.str] = None,
                  retriever_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRetrieverResult:
    """
    Definition of AWS::QBusiness::Retriever Resource Type


    :param builtins.str application_id: The identifier of the Amazon Q Business application using the retriever.
    :param builtins.str retriever_id: The identifier of the retriever used by your Amazon Q Business application.
    """
    __args__ = dict()
...
def get_retriever_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
                         retriever_id: Optional[pulumi.Input[builtins.str]] = None,
