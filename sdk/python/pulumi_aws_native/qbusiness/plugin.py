...
class PluginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The identifier of the application that will contain the plugin.
        ...
        :param pulumi.Input[builtins.str] server_url: The plugin server URL used for configuration.
...
class Plugin(pulumi.CustomResource):
    ...
    def plugin_arn(self) -> pulumi.Output[builtins.str]:
        """
