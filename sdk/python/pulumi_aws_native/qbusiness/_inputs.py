...
class ApplicationEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_id: The identifier of the AWS KMS key. Amazon Q Business doesn't support asymmetric keys.
        """
...
if not MYPY:
    class ApplicationQuickSightConfigurationArgsDict(TypedDict):
        client_namespace: pulumi.Input[builtins.str]
        """
...
class ApplicationQuickSightConfigurationArgs:
    def __init__(__self__, *,
                 client_namespace: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_namespace: The Amazon QuickSight namespace that is used as the identity provider. For more information about QuickSight namespaces, see [Namespace operations](https://docs.aws.amazon.com/quicksight/latest/developerguide/namespace-operations.html) .
        """
        pulumi.set(__self__, "client_namespace", client_namespace)

    @property
    @pulumi.getter(name="clientNamespace")
    def client_namespace(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon QuickSight namespace that is used as the identity provider. For more information about QuickSight namespaces, see [Namespace operations](https://docs.aws.amazon.com/quicksight/latest/developerguide/namespace-operations.html) .
        """
    ...
    def client_namespace(self, value: pulumi.Input[builtins.str]):
...
class DataAccessorActionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The Amazon Q Business action that is allowed.
...
if not MYPY:
    class DataAccessorDocumentAttributeValue1PropertiesArgsDict(TypedDict):
        string_list_value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
elif False:
...
class DataAccessorDocumentAttributeValue1PropertiesArgs:
    ...
    def string_list_value(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "string_list_value")

    @string_list_value.setter
    def string_list_value(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "string_list_value", value)


if not MYPY:
    class DataAccessorDocumentAttributeValue2PropertiesArgsDict(TypedDict):
        long_value: pulumi.Input[builtins.float]
elif False:
...
class DataAccessorDocumentAttributeValue2PropertiesArgs:
    ...
    def long_value(self) -> pulumi.Input[builtins.float]:
        return pulumi.get(self, "long_value")

    @long_value.setter
    def long_value(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "long_value", value)


if not MYPY:
    class DataAccessorDocumentAttributeValue3PropertiesArgsDict(TypedDict):
        date_value: pulumi.Input[builtins.str]
elif False:
...
class DataAccessorDocumentAttributeValue3PropertiesArgs:
    ...
    def date_value(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "date_value")

    @date_value.setter
    def date_value(self, value: pulumi.Input[builtins.str]):
...
class DataAccessorDocumentAttributeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The identifier for the attribute.
...
class DataSourceDocumentAttributeConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The identifier of the document attribute used for the condition.
...
class DataSourceDocumentAttributeTargetArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[Union['DataSourceDocumentAttributeValue0PropertiesArgs', 'DataSourceDocumentAttributeValue1PropertiesArgs', 'DataSourceDocumentAttributeValue2PropertiesArgs', 'DataSourceDocumentAttributeValue3PropertiesArgs']]] = None):
        """
        :param pulumi.Input[builtins.str] key: The identifier of the target document attribute or metadata field. For example, 'Department' could be an identifier for the target attribute or metadata field that includes the department names associated with the documents.
...
class DataSourceHookConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DataSourceDocumentAttributeConditionArgs'] invocation_condition: The condition used for when a Lambda function should be invoked.
               ...
               For example, you can specify a condition that if there are empty date-time values, then Amazon Q Business should invoke a function that inserts the current date-time.
        :param pulumi.Input[builtins.str] lambda_arn: The Amazon Resource Name (ARN) of a role with permission to run a Lambda function during ingestion. For more information, see [IAM roles for Custom Document Enrichment (CDE)](https://docs.aws.amazon.com/amazonq/latest/business-use-dg/iam-roles.html#cde-iam-role) .
...
class DataSourceVpcConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of identifiers of security groups within your Amazon VPC. The security groups should enable Amazon Q Business to connect to the data source.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of identifiers for subnets within your Amazon VPC. The subnets should be able to connect to each other in the VPC, and they should have outgoing access to the Internet through a NAT device.
        """
...
if not MYPY:
    class IndexCapacityConfigurationArgsDict(TypedDict):
        units: NotRequired[pulumi.Input[builtins.float]]
        """
...
class IndexCapacityConfigurationArgs:
    def __init__(__self__, *,
                 units: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] units: The number of storage units configured for an Amazon Q Business index.
        """
    ...
    @property
    @pulumi.getter
    def units(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The number of storage units configured for an Amazon Q Business index.
        """
    ...
    @units.setter
    def units(self, value: Optional[pulumi.Input[builtins.float]]):
...
class IndexDocumentAttributeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the document attribute.
...
class PluginCustomPluginConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description for your custom plugin configuration.
        """
...
class WebExperienceCustomizationConfigurationArgs:
    def __init__(__self__, *,
                 custom_css_url: Optional[pulumi.Input[builtins.str]] = None,
                 favicon_url: Optional[pulumi.Input[builtins.str]] = None,
                 font_url: Optional[pulumi.Input[builtins.str]] = None,
                 logo_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] custom_css_url: Provides the URL where the custom CSS file is hosted for an Amazon Q web experience.
        :param pulumi.Input[builtins.str] favicon_url: Provides the URL where the custom favicon file is hosted for an Amazon Q web experience.
        :param pulumi.Input[builtins.str] font_url: Provides the URL where the custom font file is hosted for an Amazon Q web experience.
        :param pulumi.Input[builtins.str] logo_url: Provides the URL where the custom logo file is hosted for an Amazon Q web experience.
        """
    ...
    def custom_css_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Provides the URL where the custom CSS file is hosted for an Amazon Q web experience.
        """
    ...
    def custom_css_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_css_url", value)

    @property
    @pulumi.getter(name="faviconUrl")
    def favicon_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Provides the URL where the custom favicon file is hosted for an Amazon Q web experience.
        """
    ...
    @favicon_url.setter
    def favicon_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "favicon_url", value)

    @property
    @pulumi.getter(name="fontUrl")
    def font_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Provides the URL where the custom font file is hosted for an Amazon Q web experience.
        """
    ...
    @font_url.setter
    def font_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WebExperienceOpenIdConnectProviderConfigurationArgsDict(TypedDict):
        secrets_arn: pulumi.Input[builtins.str]
        secrets_role: pulumi.Input[builtins.str]
elif False:
...
class WebExperienceOpenIdConnectProviderConfigurationArgs:
    ...
    def secrets_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "secrets_arn")

    @secrets_arn.setter
    def secrets_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "secrets_arn", value)

    @property
    @pulumi.getter(name="secretsRole")
    def secrets_role(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "secrets_role")

    @secrets_role.setter
    def secrets_role(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "secrets_role", value)


if not MYPY:
    class WebExperienceSamlProviderConfigurationArgsDict(TypedDict):
        authentication_url: pulumi.Input[builtins.str]
elif False:
...
class WebExperienceSamlProviderConfigurationArgs:
    ...
    def authentication_url(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "authentication_url")

    @authentication_url.setter
    def authentication_url(self, value: pulumi.Input[builtins.str]):
