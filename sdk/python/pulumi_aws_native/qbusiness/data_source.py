...
class DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_arn: The Amazon Resource Name (ARN) of an IAM role with permission to access the data source and required resources.
