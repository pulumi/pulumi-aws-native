...
class GetPluginResult:
    ...
    def plugin_arn(self) -> Optional[builtins.str]:
        """
...
def get_plugin(application_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_id: The identifier of the application that will contain the plugin.
    :param builtins.str plugin_id: The identifier of the plugin.
    """
    __args__ = dict()
...
def get_plugin_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
