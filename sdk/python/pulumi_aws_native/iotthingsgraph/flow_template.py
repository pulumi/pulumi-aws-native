...
warnings.warn("""FlowTemplate is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class FlowTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 definition: Optional[pulumi.Input[pulumi.InputType['FlowTemplateDefinitionDocumentArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""FlowTemplate is deprecated: FlowTemplate is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
