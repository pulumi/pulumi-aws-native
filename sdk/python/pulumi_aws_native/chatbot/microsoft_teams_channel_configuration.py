...
class MicrosoftTeamsChannelConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 teams_channel_id: pulumi.Input[builtins.str],
                 teams_tenant_id: pulumi.Input[builtins.str],
                 configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 customization_resource_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 guardrail_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 teams_channel_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_role_required: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a MicrosoftTeamsChannelConfiguration resource.
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role that defines the permissions for AWS Chatbot
        :param pulumi.Input[builtins.str] team_id: The id of the Microsoft Teams team
        :param pulumi.Input[builtins.str] teams_channel_id: The id of the Microsoft Teams channel
        :param pulumi.Input[builtins.str] teams_tenant_id: The id of the Microsoft Teams tenant
        :param pulumi.Input[builtins.str] configuration_name: The name of the configuration
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] customization_resource_arns: ARNs of Custom Actions to associate with notifications in the provided chat channel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] guardrail_policies: The list of IAM policy ARNs that are applied as channel guardrails. The AWS managed 'AdministratorAccess' policy is applied as a default if this is not set.
        :param pulumi.Input[builtins.str] logging_level: Specifies the logging level for this configuration:ERROR,INFO or NONE. This property affects the log entries pushed to Amazon CloudWatch logs
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sns_topic_arns: ARNs of SNS topics which delivers notifications to AWS Chatbot, for example CloudWatch alarm notifications.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: The tags to add to the configuration
        :param pulumi.Input[builtins.str] teams_channel_name: The name of the Microsoft Teams channel
        :param pulumi.Input[builtins.bool] user_role_required: Enables use of a user role requirement in your chat configuration
        """
    ...
    def teams_channel_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def teams_channel_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "teams_channel_id", value)

    @property
    @pulumi.getter(name="teamsTenantId")
    def teams_tenant_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def teams_tenant_id(self, value: pulumi.Input[builtins.str]):
    ...
    def customization_resource_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def customization_resource_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "customization_resource_arns", value)

    @property
    @pulumi.getter(name="guardrailPolicies")
    def guardrail_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def guardrail_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def teams_channel_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def teams_channel_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "teams_channel_name", value)

    @property
    @pulumi.getter(name="userRoleRequired")
    def user_role_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def user_role_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MicrosoftTeamsChannelConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 teams_channel_id: Optional[pulumi.Input[builtins.str]] = None,
                 teams_channel_name: Optional[pulumi.Input[builtins.str]] = None,
                 teams_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_role_required: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="customizationResourceArns")
    def customization_resource_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        ARNs of Custom Actions to associate with notifications in the provided chat channel.
        """
        return pulumi.get(self, "customization_resource_arns")
    ...
    @property
    @pulumi.getter(name="guardrailPolicies")
    def guardrail_policies(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of IAM policy ARNs that are applied as channel guardrails. The AWS managed 'AdministratorAccess' policy is applied as a default if this is not set.
        """
        return pulumi.get(self, "guardrail_policies")
    ...
    @property
    @pulumi.getter(name="loggingLevel")
    def logging_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the logging level for this configuration:ERROR,INFO or NONE. This property affects the log entries pushed to Amazon CloudWatch logs
        """
        return pulumi.get(self, "logging_level")
    ...
    @property
    @pulumi.getter(name="snsTopicArns")
    def sns_topic_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        ARNs of SNS topics which delivers notifications to AWS Chatbot, for example CloudWatch alarm notifications.
        """
        return pulumi.get(self, "sns_topic_arns")
    ...
    @property
    @pulumi.getter(name="teamsChannelId")
    def teams_channel_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the Microsoft Teams channel
        """
        return pulumi.get(self, "teams_channel_id")
    ...
    @property
    @pulumi.getter(name="teamsChannelName")
    def teams_channel_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Microsoft Teams channel
        """
        return pulumi.get(self, "teams_channel_name")
    ...
    @property
    @pulumi.getter(name="teamsTenantId")
    def teams_tenant_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the Microsoft Teams tenant
        """
        return pulumi.get(self, "teams_tenant_id")
    ...
    @property
    @pulumi.getter(name="userRoleRequired")
    def user_role_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables use of a user role requirement in your chat configuration
        """
        return pulumi.get(self, "user_role_required")
