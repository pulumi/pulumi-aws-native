...
class MicrosoftTeamsChannelConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] team_id: The id of the Microsoft Teams team
        :param pulumi.Input[_builtins.str] teams_channel_id: The id of the Microsoft Teams channel
        :param pulumi.Input[_builtins.str] teams_tenant_id: The id of the Microsoft Teams tenant
        :param pulumi.Input[_builtins.str] configuration_name: The name of the configuration
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] customization_resource_arns: ARNs of Custom Actions to associate with notifications in the provided chat channel.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] guardrail_policies: The list of IAM policy ARNs that are applied as channel guardrails. The AWS managed 'AdministratorAccess' policy is applied as a default if this is not set.
        :param pulumi.Input[_builtins.str] logging_level: Specifies the logging level for this configuration:ERROR,INFO or NONE. This property affects the log entries pushed to Amazon CloudWatch logs
        ...
        :param pulumi.Input[_builtins.str] teams_channel_name: The name of the Microsoft Teams channel
    ...
    def teams_tenant_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def teams_tenant_id(self, value: pulumi.Input[_builtins.str]):
...
class MicrosoftTeamsChannelConfiguration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="customizationResourceArns")
    def customization_resource_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        ARNs of Custom Actions to associate with notifications in the provided chat channel.
        """
        return pulumi.get(self, "customization_resource_arns")
    ...
    @_builtins.property
    @pulumi.getter(name="guardrailPolicies")
    def guardrail_policies(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The list of IAM policy ARNs that are applied as channel guardrails. The AWS managed 'AdministratorAccess' policy is applied as a default if this is not set.
        """
        return pulumi.get(self, "guardrail_policies")
    ...
    @_builtins.property
    @pulumi.getter(name="loggingLevel")
    def logging_level(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the logging level for this configuration:ERROR,INFO or NONE. This property affects the log entries pushed to Amazon CloudWatch logs
        """
        return pulumi.get(self, "logging_level")
    ...
    @_builtins.property
    @pulumi.getter(name="snsTopicArns")
    def sns_topic_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        ARNs of SNS topics which delivers notifications to AWS Chatbot, for example CloudWatch alarm notifications.
        """
        return pulumi.get(self, "sns_topic_arns")
    ...
    @_builtins.property
    @pulumi.getter(name="teamsChannelId")
    def teams_channel_id(self) -> pulumi.Output[_builtins.str]:
        """
        The id of the Microsoft Teams channel
        """
        return pulumi.get(self, "teams_channel_id")
    ...
    @_builtins.property
    @pulumi.getter(name="teamsChannelName")
    def teams_channel_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the Microsoft Teams channel
        """
        return pulumi.get(self, "teams_channel_name")
    ...
    @_builtins.property
    @pulumi.getter(name="teamsTenantId")
    def teams_tenant_id(self) -> pulumi.Output[_builtins.str]:
        """
        The id of the Microsoft Teams tenant
        """
        return pulumi.get(self, "teams_tenant_id")
    ...
    @_builtins.property
    @pulumi.getter(name="userRoleRequired")
    def user_role_required(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Enables use of a user role requirement in your chat configuration
        """
        return pulumi.get(self, "user_role_required")
