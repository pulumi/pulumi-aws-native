...
class SlackChannelConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 slack_workspace_id: pulumi.Input[_builtins.str],
    ...
    def slack_workspace_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def slack_workspace_id(self, value: pulumi.Input[_builtins.str]):
...
class SlackChannelConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 slack_workspace_id: Optional[pulumi.Input[_builtins.str]] = None,
                 sns_topic_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="slackWorkspaceId")
    def slack_workspace_id(self) -> pulumi.Output[_builtins.str]:
        """
        The id of the Slack workspace
        """
        return pulumi.get(self, "slack_workspace_id")
