...
class CustomActionAttachment(dict):
    ...
    def __init__(__self__, *,
                 button_text: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str button_text: The text of the button that appears on the notification.
        ...
        :param builtins.str notification_type: The type of notification that the custom action should be attached to.
        :param Mapping[str, builtins.str] variables: The variables to extract from the notification.
        """
    ...
    def button_text(self) -> Optional[builtins.str]:
        """
...
class CustomActionAttachmentCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: A value that is compared with the actual value of the variable based on the behavior of the operator.
        """
...
class CustomActionDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str command_text: The command string to run which may include variables by prefixing with a dollar sign ($).
        """
