...
def get_queue_inline_policy(queue: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQueueInlinePolicyResult:
    """
    Schema for SQS QueueInlinePolicy


    :param builtins.str queue: The URL of the SQS queue.
    """
    __args__ = dict()
...
def get_queue_inline_policy_output(queue: Optional[pulumi.Input[builtins.str]] = None,
