...
def get_stream(id: Optional[builtins.str] = None,
               ledger_name: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamResult:
    """
    Resource schema for AWS::QLDB::Stream.


    :param builtins.str id: The unique ID that QLDB assigns to each QLDB journal stream. For example: `IiPT4brpZCqCq3f4MTHbYy` .
    :param builtins.str ledger_name: The name of the ledger.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_stream_output(id: Optional[pulumi.Input[builtins.str]] = None,
