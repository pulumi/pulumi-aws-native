...
class Stream(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['stream_name'] = stream_name
            __props__['tags'] = tags
            __props__['arn'] = None
            __props__['id'] = None
