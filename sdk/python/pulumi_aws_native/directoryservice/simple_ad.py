...
class SimpleAD(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SimpleADPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SimpleADPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SimpleADAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SimpleADProperties']:
        """
