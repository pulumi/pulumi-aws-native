...
class SimpleAdArgs:
    def __init__(__self__, *,
                 ...
                 create_alias: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] size: The size of the directory.
        :param pulumi.Input['SimpleAdVpcSettingsArgs'] vpc_settings: VPC settings of the Simple AD directory server in AWS.
        :param pulumi.Input[builtins.bool] create_alias: The name of the configuration set.
        :param pulumi.Input[builtins.str] description: Description for the directory.
        :param pulumi.Input[builtins.bool] enable_sso: Whether to enable single sign-on for a Simple Active Directory in AWS.
        :param pulumi.Input[builtins.str] name: The fully qualified domain name for the AWS Managed Simple AD directory.
        :param pulumi.Input[builtins.str] password: The password for the default administrative user named Admin.
        :param pulumi.Input[builtins.str] short_name: The NetBIOS name for your domain.
        """
    ...
    def create_alias(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @create_alias.setter
    def create_alias(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SimpleAd(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="createAlias")
    def create_alias(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The name of the configuration set.
        """
        return pulumi.get(self, "create_alias")
    ...
    @property
    @pulumi.getter(name="shortName")
    def short_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The NetBIOS name for your domain.
        """
        return pulumi.get(self, "short_name")
