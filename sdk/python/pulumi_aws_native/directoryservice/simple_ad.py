...
class SimpleAdArgs:
    def __init__(__self__, *,
                 ...
                 create_alias: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: Description for the directory.
        :param pulumi.Input[_builtins.bool] enable_sso: Whether to enable single sign-on for a Simple Active Directory in AWS.
        :param pulumi.Input[_builtins.str] name: The fully qualified domain name for the AWS Managed Simple AD directory.
    ...
    def create_alias(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @create_alias.setter
    def create_alias(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class SimpleAd(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="createAlias")
    def create_alias(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        The name of the configuration set.
        """
        return pulumi.get(self, "create_alias")
