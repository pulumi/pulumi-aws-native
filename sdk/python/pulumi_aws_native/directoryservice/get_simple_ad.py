...
class GetSimpleAdResult:
    ...
    def enable_sso(self) -> Optional[builtins.bool]:
        """
...
def get_simple_ad(directory_id: Optional[builtins.str] = None,
    ...
    :param builtins.str directory_id: The unique identifier for a directory.
    """
    __args__ = dict()
...
def get_simple_ad_output(directory_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:directoryservice:getSimpleAd', __args__, opts=opts, typ=GetSimpleAdResult)
    return __ret__.apply(lambda __response__: GetSimpleAdResult(
