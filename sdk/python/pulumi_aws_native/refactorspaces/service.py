...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_identifier: The unique identifier of the application.
        ...
        :param pulumi.Input[builtins.str] description: A description of the service.
