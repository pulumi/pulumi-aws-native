...
@pulumi.type_token("aws-native:glue:Integration")
class Integration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["integration_config"] = integration_config
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["additionalEncryptionContext.*", "integrationConfig", "integrationName", "kmsKeyId", "sourceArn", "targetArn"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(Integration, __self__).__init__(
            'aws-native:glue:Integration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["integration_arn"] = None
        __props__.__dict__["integration_config"] = None
    ...
    @_builtins.property
    @pulumi.getter(name="integrationConfig")
    def integration_config(self) -> pulumi.Output[Optional['outputs.IntegrationConfig']]:
        """
        The structure used to define properties associated with the zero-ETL integration. For more information, see [IntegrationConfig structure.](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-integrations.html#aws-glue-api-integrations-IntegrationConfig)
        """
        return pulumi.get(self, "integration_config")
