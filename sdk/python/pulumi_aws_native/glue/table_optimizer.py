...
class TableOptimizerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableOptimizerConfigurationArgs'] table_optimizer_configuration: Specifies configuration details of a table optimizer.
...
@pulumi.type_token("aws-native:glue:TableOptimizer")
class TableOptimizer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["catalogId", "databaseName", "tableName", "type"])
