...
class MlTransform(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(input_record_tables, MlTransformInputRecordTablesArgs):
            ...
            if not isinstance(transform_encryption, MlTransformTransformEncryptionArgs):
            ...
            if not isinstance(transform_parameters, MlTransformTransformParametersArgs):
