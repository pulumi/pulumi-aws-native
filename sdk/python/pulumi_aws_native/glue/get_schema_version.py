...
def get_schema_version(version_id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaVersionResult:
    """
    This resource represents an individual schema version of a schema defined in Glue Schema Registry.


    :param builtins.str version_id: Represents the version ID associated with the schema version.
    """
    __args__ = dict()
...
def get_schema_version_output(version_id: Optional[pulumi.Input[builtins.str]] = None,
