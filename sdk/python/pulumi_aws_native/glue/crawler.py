...
class Crawler(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(recrawl_policy, CrawlerRecrawlPolicyArgs):
            ...
            if not isinstance(schedule, CrawlerScheduleArgs):
                schedule = schedule or {}
                def _setter(key, value):
                    schedule[key] = value
                CrawlerScheduleArgs._configure(_setter, **schedule)
            __props__.__dict__["schedule"] = schedule
            if not isinstance(schema_change_policy, CrawlerSchemaChangePolicyArgs):
            ...
            if not isinstance(targets, CrawlerTargetsArgs):
                targets = targets or {}
                def _setter(key, value):
                    targets[key] = value
