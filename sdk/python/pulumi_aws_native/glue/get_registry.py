...
def get_registry(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Amazon Resource Name for the created Registry.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_registry_output(arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:glue:getRegistry', __args__, opts=opts, typ=GetRegistryResult)
