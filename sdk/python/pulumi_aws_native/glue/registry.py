...
class RegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the registry. If description is not provided, there will not be any default value for this.
        :param pulumi.Input[builtins.str] name: Name of the registry to be created of max length of 255, and may only contain letters, numbers, hyphen, underscore, dollar sign, or hash mark.  No whitespace.
...
@pulumi.type_token("aws-native:glue:Registry")
class Registry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] description: A description of the registry. If description is not provided, there will not be any default value for this.
        :param pulumi.Input[builtins.str] name: Name of the registry to be created of max length of 255, and may only contain letters, numbers, hyphen, underscore, dollar sign, or hash mark.  No whitespace.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: List of tags to tag the Registry
        """
        ...
    @overload
    def __init__(__self__,
