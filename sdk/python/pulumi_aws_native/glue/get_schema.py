...
class GetSchemaResult:
    ...
    def initial_schema_version_id(self) -> Optional[builtins.str]:
        """
...
def get_schema(arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaResult:
    """
    This resource represents a schema of Glue Schema Registry.


    :param builtins.str arn: Amazon Resource Name for the Schema.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_schema_output(arn: Optional[pulumi.Input[builtins.str]] = None,
