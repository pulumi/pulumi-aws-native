...
class SchemaVersionMetadata(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SchemaVersionMetadataPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SchemaVersionMetadataPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SchemaVersionMetadataAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SchemaVersionMetadataProperties']:
        """
