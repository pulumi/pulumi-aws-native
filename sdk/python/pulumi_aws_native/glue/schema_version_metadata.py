...
class SchemaVersionMetadataArgs:
    def __init__(__self__, *,
                 ...
                 schema_version_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] schema_version_id: Represents the version ID associated with the schema version.
    ...
    def schema_version_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def schema_version_id(self, value: pulumi.Input[builtins.str]):
...
class SchemaVersionMetadata(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 schema_version_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="schemaVersionId")
    def schema_version_id(self) -> pulumi.Output[builtins.str]:
        """
        Represents the version ID associated with the schema version.
        """
        return pulumi.get(self, "schema_version_id")
