...
class Classifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(csv_classifier, ClassifierCsvClassifierArgs):
            ...
            if not isinstance(grok_classifier, ClassifierGrokClassifierArgs):
            ...
            if not isinstance(json_classifier, ClassifierJsonClassifierArgs):
            ...
            if not isinstance(xml_classifier, ClassifierXmlClassifierArgs):
