...
warnings.warn("""Classifier is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Classifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 xml_classifier: Optional[pulumi.Input[pulumi.InputType['ClassifierXmlClassifierArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Classifier is deprecated: Classifier is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
