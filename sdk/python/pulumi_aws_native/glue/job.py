...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(command, JobCommandArgs):
                command = command or {}
                def _setter(key, value):
                    command[key] = value
            ...
            if not isinstance(connections, JobConnectionsListArgs):
            ...
            if not isinstance(execution_property, JobExecutionPropertyArgs):
            ...
            if not isinstance(notification_property, JobNotificationPropertyArgs):
