...
class CrawlerDeltaTargetArgsDict(TypedDict):
    ...
    """
    delta_tables: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
    """
    A list of the Amazon S3 paths to the Delta tables.
    """
    write_manifest: NotRequired[pulumi.Input[_builtins.bool]]
    """
...
class CrawlerDeltaTargetArgs:
    def __init__(__self__, *,
                 ...
                 delta_tables: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    def delta_tables(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A list of the Amazon S3 paths to the Delta tables.
        """
    ...
    @delta_tables.setter
    def delta_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "delta_tables", value)

    @_builtins.property
    @pulumi.getter(name="writeManifest")
    def write_manifest(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Specifies whether to write the manifest files to the Delta table path.
        """
    ...
    def write_manifest(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class CrawlerHudiTargetArgsDict(TypedDict):
    ...
    """
    maximum_traversal_depth: NotRequired[pulumi.Input[_builtins.int]]
    """
...
class CrawlerHudiTargetArgs:
    def __init__(__self__, *,
                 ...
                 maximum_traversal_depth: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def maximum_traversal_depth(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Hudi metadata folder in your Amazon S3 path. Used to limit the crawler run time.
        """
    ...
    def maximum_traversal_depth(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class CrawlerJdbcTargetArgsDict(TypedDict):
    ...
    """
    enable_additional_metadata: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
    """
...
class CrawlerJdbcTargetArgs:
    def __init__(__self__, *,
                 connection_name: Optional[pulumi.Input[_builtins.str]] = None,
                 enable_additional_metadata: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 path: Optional[pulumi.Input[_builtins.str]] = None):
        """
        Specifies a JDBC data store to crawl.
    ...
    def enable_additional_metadata(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specify a value of RAWTYPES or COMMENTS to enable additional metadata in table responses. RAWTYPES provides the native-level datatype. COMMENTS provides comments associated with a column or table in the database.
    ...
    def enable_additional_metadata(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class DataCatalogEncryptionSettingsConnectionPasswordEncryptionArgsDict(TypedDict):
    ...
    """
    return_connection_password_encrypted: NotRequired[pulumi.Input[_builtins.bool]]
    """
...
class DataCatalogEncryptionSettingsConnectionPasswordEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 return_connection_password_encrypted: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        When connection password protection is enabled, the Data Catalog uses a customer-provided key to encrypt the password as part of CreateConnection or UpdateConnection and store it in the ENCRYPTED_PASSWORD field in the connection properties. You can enable catalog encryption or only password encryption.
    ...
    def return_connection_password_encrypted(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        When the ReturnConnectionPasswordEncrypted flag is set to 'true', passwords remain encrypted in the responses of GetConnection and GetConnections. This encryption takes effect independently from catalog encryption.
        """
    ...
    def return_connection_password_encrypted(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class DataCatalogEncryptionSettingsEncryptionAtRestArgsDict(TypedDict):
    ...
    """
    catalog_encryption_mode: NotRequired[pulumi.Input[_builtins.str]]
    """
...
class DataCatalogEncryptionSettingsEncryptionAtRestArgs:
    def __init__(__self__, *,
                 catalog_encryption_mode: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def catalog_encryption_mode(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The encryption-at-rest mode for encrypting Data Catalog data.
        """
    ...
    def catalog_encryption_mode(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class DataCatalogEncryptionSettingsArgsDict(TypedDict):
    ...
    """
    connection_password_encryption: NotRequired[pulumi.Input['DataCatalogEncryptionSettingsConnectionPasswordEncryptionArgsDict']]
    """
    When connection password protection is enabled, the Data Catalog uses a customer-provided key to encrypt the password as part of `CreateConnection` or `UpdateConnection` and store it in the `ENCRYPTED_PASSWORD` field in the connection properties. You can enable catalog encryption or only password encryption.
    """
    encryption_at_rest: NotRequired[pulumi.Input['DataCatalogEncryptionSettingsEncryptionAtRestArgsDict']]
    """
    Specifies the encryption-at-rest configuration for the Data Catalog.
    """
...
class JobCommandArgsDict(TypedDict):
    ...
    """
    script_location: NotRequired[pulumi.Input[_builtins.str]]
    """
...
class JobCommandArgs:
    def __init__(__self__, *,
                 ...
                 script_location: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    def script_location(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Specifies the Amazon Simple Storage Service (Amazon S3) path to a script that executes a job
        """
    ...
    def script_location(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "script_location", value)


class JobConnectionsListArgsDict(TypedDict):
    connections: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
    """
...
class JobExecutionPropertyArgsDict(TypedDict):
    max_concurrent_runs: NotRequired[pulumi.Input[_builtins.float]]
    """
