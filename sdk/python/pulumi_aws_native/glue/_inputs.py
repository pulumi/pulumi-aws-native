...
class CrawlerCatalogTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: The name of the database to be synchronized.
        :param pulumi.Input[builtins.str] dlq_event_queue_arn: A valid Amazon dead-letter SQS ARN. For example, arn:aws:sqs:region:account:deadLetterQueue.
        :param pulumi.Input[builtins.str] event_queue_arn: A valid Amazon SQS ARN. For example, arn:aws:sqs:region:account:sqs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables: A list of the tables to be synchronized.
        """
...
if not MYPY:
    class CrawlerDeltaTargetArgsDict(TypedDict):
        ...
        """
        delta_tables: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of the Amazon S3 paths to the Delta tables.
        """
        write_manifest: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CrawlerDeltaTargetArgs:
    def __init__(__self__, *,
                 ...
                 delta_tables: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 write_manifest: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Specifies a Delta data store to crawl one or more Delta tables.
    ...
    def delta_tables(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of the Amazon S3 paths to the Delta tables.
        """
    ...
    @delta_tables.setter
    def delta_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "delta_tables", value)

    @property
    @pulumi.getter(name="writeManifest")
    def write_manifest(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to write the manifest files to the Delta table path.
        """
    ...
    def write_manifest(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CrawlerHudiTargetArgsDict(TypedDict):
        ...
        """
        maximum_traversal_depth: NotRequired[pulumi.Input[builtins.int]]
        """
...
class CrawlerHudiTargetArgs:
    def __init__(__self__, *,
                 ...
                 maximum_traversal_depth: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusions: A list of global patterns used to exclude from the crawl.
        :param pulumi.Input[builtins.int] maximum_traversal_depth: The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Hudi metadata folder in your Amazon S3 path. Used to limit the crawler run time.
    ...
    def maximum_traversal_depth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Hudi metadata folder in your Amazon S3 path. Used to limit the crawler run time.
        """
    ...
    def maximum_traversal_depth(self, value: Optional[pulumi.Input[builtins.int]]):
...
class CrawlerIcebergTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusions: A list of global patterns used to exclude from the crawl.
        :param pulumi.Input[builtins.int] maximum_traversal_depth: The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Iceberg metadata folder in your Amazon S3 path. Used to limit the crawler run time.
...
if not MYPY:
    class CrawlerJdbcTargetArgsDict(TypedDict):
        ...
        """
        enable_additional_metadata: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CrawlerJdbcTargetArgs:
    def __init__(__self__, *,
                 connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 enable_additional_metadata: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None):
        """
        Specifies a JDBC data store to crawl.
        :param pulumi.Input[builtins.str] connection_name: The name of the connection to use to connect to the JDBC target.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enable_additional_metadata: Specify a value of RAWTYPES or COMMENTS to enable additional metadata in table responses. RAWTYPES provides the native-level datatype. COMMENTS provides comments associated with a column or table in the database.
               
               If you do not need additional metadata, keep the field empty.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusions: A list of glob patterns used to exclude from the crawl. For more information, see Catalog Tables with a Crawler.
    ...
    def enable_additional_metadata(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specify a value of RAWTYPES or COMMENTS to enable additional metadata in table responses. RAWTYPES provides the native-level datatype. COMMENTS provides comments associated with a column or table in the database.
    ...
    def enable_additional_metadata(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CrawlerLakeFormationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies AWS Lake Formation configuration settings for the crawler
        :param pulumi.Input[builtins.str] account_id: Required for cross account crawls. For same account crawls as the target data, this can be left as null.
        :param pulumi.Input[builtins.bool] use_lake_formation_credentials: Specifies whether to use AWS Lake Formation credentials for the crawler instead of the IAM role credentials.
        """
...
class CrawlerRecrawlPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        When crawling an Amazon S3 data source after the first crawl is complete, specifies whether to crawl the entire dataset again or to crawl only folders that were added since the last crawler run. For more information, see Incremental Crawls in AWS Glue in the developer guide.
        :param pulumi.Input[builtins.str] recrawl_behavior: Specifies whether to crawl the entire dataset again or to crawl only folders that were added since the last crawler run. A value of CRAWL_EVERYTHING specifies crawling the entire dataset again. A value of CRAWL_NEW_FOLDERS_ONLY specifies crawling only folders that were added since the last crawler run. A value of CRAWL_EVENT_MODE specifies crawling only the changes identified by Amazon S3 events.
        """
...
class CrawlerS3TargetArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a data store in Amazon Simple Storage Service (Amazon S3).
        :param pulumi.Input[builtins.str] connection_name: The name of a connection which allows a job or crawler to access data in Amazon S3 within an Amazon Virtual Private Cloud environment (Amazon VPC).
        :param pulumi.Input[builtins.str] dlq_event_queue_arn: A valid Amazon dead-letter SQS ARN. For example, arn:aws:sqs:region:account:deadLetterQueue.
        :param pulumi.Input[builtins.str] event_queue_arn: A valid Amazon SQS ARN. For example, arn:aws:sqs:region:account:sqs.
...
class CrawlerScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        A scheduling object using a cron statement to schedule an event.
        :param pulumi.Input[builtins.str] schedule_expression: A cron expression used to specify the schedule. For more information, see Time-Based Schedules for Jobs and Crawlers. For example, to run something every day at 12:15 UTC, specify cron(15 12 * * ? *).
        """
...
class CrawlerSchemaChangePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        The policy that specifies update and delete behaviors for the crawler. The policy tells the crawler what to do in the event that it detects a change in a table that already exists in the customer's database at the time of the crawl. The SchemaChangePolicy does not affect whether or how new tables and partitions are added. New tables and partitions are always created regardless of the SchemaChangePolicy on a crawler. The SchemaChangePolicy consists of two components, UpdateBehavior and DeleteBehavior.
        :param pulumi.Input[builtins.str] delete_behavior: The deletion behavior when the crawler finds a deleted object. A value of LOG specifies that if a table or partition is found to no longer exist, do not delete it, only log that it was found to no longer exist. A value of DELETE_FROM_DATABASE specifies that if a table or partition is found to have been removed, delete it from the database. A value of DEPRECATE_IN_DATABASE specifies that if a table has been found to no longer exist, to add a property to the table that says 'DEPRECATED' and includes a timestamp with the time of deprecation.
        :param pulumi.Input[builtins.str] update_behavior: The update behavior when the crawler finds a changed schema. A value of LOG specifies that if a table or a partition already exists, and a change is detected, do not update it, only log that a change was detected. Add new tables and new partitions (including on existing tables). A value of UPDATE_IN_DATABASE specifies that if a table or partition already exists, and a change is detected, update it. Add new tables and partitions.
        """
...
if not MYPY:
    class CrawlerTargetsArgsDict(TypedDict):
        ...
        """
        hudi_targets: NotRequired[pulumi.Input[Sequence[pulumi.Input['CrawlerHudiTargetArgsDict']]]]
        """
        Specifies Apache Hudi data store targets.
        """
...
class DatabaseDataLakePrincipalArgs:
    def __init__(__self__, *,
        ...
        """
        The AWS Lake Formation principal.
        :param pulumi.Input[builtins.str] data_lake_principal_identifier: An identifier for the AWS Lake Formation principal.
        """
...
class DatabaseFederatedDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        A FederatedDatabase structure that references an entity outside the AWS Glue Data Catalog.
        :param pulumi.Input[builtins.str] connection_name: The name of the connection to the external metastore.
        :param pulumi.Input[builtins.str] identifier: A unique identifier for the federated database.
        """
        if connection_name is not None:
            pulumi.set(__self__, "connection_name", connection_name)
...
class DatabaseIdentifierArgs:
    def __init__(__self__, *,
        ...
        """
        A structure that describes a target database for resource linking.
        :param pulumi.Input[builtins.str] catalog_id: The ID of the Data Catalog in which the database resides.
        :param pulumi.Input[builtins.str] database_name: The name of the catalog database.
...
class DatabaseInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the database.
        ...
        :param pulumi.Input[builtins.str] location_uri: The location of the database (for example, an HDFS path).
        :param pulumi.Input[builtins.str] name: The name of the database. For hive compatibility, this is folded to lowercase when it is stored.
...
if not MYPY:
    class JobCommandArgsDict(TypedDict):
        ...
        """
        script_location: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobCommandArgs:
    def __init__(__self__, *,
                 ...
                 script_location: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the job command
        :param pulumi.Input[builtins.str] python_version: The Python version being used to execute a Python shell job.
        :param pulumi.Input[builtins.str] runtime: Runtime is used to specify the versions of Ray, Python and additional libraries available in your environment
        :param pulumi.Input[builtins.str] script_location: Specifies the Amazon Simple Storage Service (Amazon S3) path to a script that executes a job
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def script_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Amazon Simple Storage Service (Amazon S3) path to a script that executes a job
        """
    ...
    def script_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "script_location", value)


if not MYPY:
    class JobConnectionsListArgsDict(TypedDict):
        connections: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class JobConnectionsListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] connections: A list of connections used by the job.
        """
...
if not MYPY:
    class JobExecutionPropertyArgsDict(TypedDict):
        max_concurrent_runs: NotRequired[pulumi.Input[builtins.float]]
        """
...
class JobExecutionPropertyArgs:
    def __init__(__self__, *,
                 max_concurrent_runs: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] max_concurrent_runs: The maximum number of concurrent runs allowed for the job.
        """
    ...
    def max_concurrent_runs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum number of concurrent runs allowed for the job.
        """
    ...
    def max_concurrent_runs(self, value: Optional[pulumi.Input[builtins.float]]):
...
class JobNotificationPropertyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] notify_delay_after: It is the number of minutes to wait before sending a job run delay notification after a job run starts
        """
...
class SchemaRegistryArgs:
    def __init__(__self__, *,
        ...
        """
        Identifier for the registry which the schema is part of.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name for the Registry.
        :param pulumi.Input[builtins.str] name: Name of the registry in which the schema will be created.
        """
        if arn is not None:
...
class SchemaVersionSchemaArgs:
    def __init__(__self__, *,
        ...
        """
        Identifier for the schema where the schema version will be created.
        :param pulumi.Input[builtins.str] registry_name: Name of the registry to identify where the Schema is located.
        :param pulumi.Input[builtins.str] schema_arn: Amazon Resource Name for the Schema. This attribute can be used to uniquely represent the Schema.
        :param pulumi.Input[builtins.str] schema_name: Name of the schema. This parameter requires RegistryName to be provided.
        """
...
if not MYPY:
    class SchemaVersionArgsDict(TypedDict):
        ...
        """
        version_number: NotRequired[pulumi.Input[builtins.int]]
        """
...
class SchemaVersionArgs:
    def __init__(__self__, *,
        ...
        """
        Specify checkpoint version for update. This is only required to update the Compatibility.
        :param pulumi.Input[builtins.bool] is_latest: Indicates if the latest version needs to be updated.
        :param pulumi.Input[builtins.int] version_number: Indicates the version number in the schema to update.
        """
...
class TriggerActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] crawler_name: The name of the crawler to be used with this action.
        :param pulumi.Input[builtins.str] job_name: The name of a job to be executed.
        ...
        :param pulumi.Input[builtins.str] security_configuration: The name of the SecurityConfiguration structure to be used with this action.
        :param pulumi.Input[builtins.int] timeout: The JobRun timeout in minutes. This is the maximum time that a job run can consume resources before it is terminated and enters TIMEOUT status. The default is 2,880 minutes (48 hours). This overrides the timeout value set in the parent job.
        """
...
class TriggerConditionArgs:
    def __init__(__self__, *,
        ...
        """
        Defines a condition under which a trigger fires.
        :param pulumi.Input[builtins.str] crawl_state: The state of the crawler to which this condition applies.
        :param pulumi.Input[builtins.str] crawler_name: The name of the crawler to which this condition applies.
        :param pulumi.Input[builtins.str] job_name: The name of the job whose JobRuns this condition applies to, and on which this trigger waits.
        :param pulumi.Input[builtins.str] logical_operator: A logical operator.
        :param pulumi.Input[builtins.str] state: The condition state. Currently, the values supported are SUCCEEDED, STOPPED, TIMEOUT, and FAILED.
        """
...
class TriggerEventBatchingConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] batch_window: Window of time in seconds after which EventBridge event trigger fires. Window starts when first event is received.
        """
...
class TriggerPredicateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] logical: An optional field if only one condition is listed. If multiple conditions are listed, then this field is required.
        """
