...
class LocationEfsArgs:
    def __init__(__self__, *,
                 ...
                 efs_filesystem_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_point_arn: The Amazon Resource Name (ARN) for the Amazon EFS Access point that DataSync uses when accessing the EFS file system.
        :param pulumi.Input[builtins.str] efs_filesystem_arn: The Amazon Resource Name (ARN) for the Amazon EFS file system.
        :param pulumi.Input[builtins.str] file_system_access_role_arn: The Amazon Resource Name (ARN) of the AWS IAM role that the DataSync will assume when mounting the EFS file system.
        ...
        :param pulumi.Input[builtins.str] subdirectory: A subdirectory in the location's path. This subdirectory in the EFS file system is used to read data from the EFS source location or write data to the EFS destination.
    ...
    def efs_filesystem_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def efs_filesystem_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LocationEfs(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["ec2Config", "efsFilesystemArn"])
    ...
    @property
    @pulumi.getter(name="efsFilesystemArn")
    def efs_filesystem_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) for the Amazon EFS file system.
        """
        return pulumi.get(self, "efs_filesystem_arn")
