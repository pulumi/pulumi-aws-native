...
class GetLocationEfsResult:
    ...
    def file_system_access_role_arn(self) -> Optional[builtins.str]:
        """
...
def get_location_efs(location_arn: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocationEfsResult:
    """
    Resource schema for AWS::DataSync::LocationEFS.


    :param builtins.str location_arn: The Amazon Resource Name (ARN) of the Amazon EFS file system location that is created.
    """
    __args__ = dict()
...
def get_location_efs_output(location_arn: Optional[pulumi.Input[builtins.str]] = None,
