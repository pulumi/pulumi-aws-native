...
class LocationNfsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_hostname: The name of the NFS server. This value is the IP address or DNS name of the NFS server.
        :param pulumi.Input[builtins.str] subdirectory: The subdirectory in the NFS file system that is used to read data from the NFS source location or write data to the NFS destination.
