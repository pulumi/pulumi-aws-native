...
def get_location_f_sx_lustre(location_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str location_arn: The Amazon Resource Name (ARN) of the Amazon FSx for Lustre file system location that is created.
    """
    __args__ = dict()
...
def get_location_f_sx_lustre_output(location_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:datasync:getLocationFSxLustre', __args__, opts=opts, typ=GetLocationFSxLustreResult)
    return __ret__.apply(lambda __response__: GetLocationFSxLustreResult(
