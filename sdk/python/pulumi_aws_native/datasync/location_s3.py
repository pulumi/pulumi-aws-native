...
class LocationS3Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_bucket_arn: The Amazon Resource Name (ARN) of the Amazon S3 bucket.
        ...
        :param pulumi.Input[builtins.str] subdirectory: A subdirectory in the Amazon S3 bucket. This subdirectory in Amazon S3 is used to read data from the S3 source location or write data to the S3 destination.
...
class LocationS3(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["s3BucketArn"])
    ...
    @property
    @pulumi.getter(name="s3BucketArn")
    def s3_bucket_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Amazon S3 bucket.
        """
        return pulumi.get(self, "s3_bucket_arn")
