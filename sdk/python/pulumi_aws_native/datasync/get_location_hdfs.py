...
class GetLocationHdfsResult:
    ...
    def block_size(self) -> Optional[builtins.int]:
        """
    ...
    def kms_key_provider_uri(self) -> Optional[builtins.str]:
        """
    ...
    def replication_factor(self) -> Optional[builtins.int]:
        """
    ...
    def simple_user(self) -> Optional[builtins.str]:
        """
...
def get_location_hdfs(location_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocationHdfsResult:
    """
    Resource schema for AWS::DataSync::LocationHDFS.


    :param builtins.str location_arn: The Amazon Resource Name (ARN) of the HDFS location.
    """
    __args__ = dict()
...
def get_location_hdfs_output(location_arn: Optional[pulumi.Input[builtins.str]] = None,
