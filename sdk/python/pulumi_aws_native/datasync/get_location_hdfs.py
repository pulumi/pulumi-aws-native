...
class GetLocationHdfsResult:
    ...
    def kms_key_provider_uri(self) -> Optional[_builtins.str]:
        """
    ...
    def simple_user(self) -> Optional[_builtins.str]:
        """
...
def get_location_hdfs_output(location_arn: pulumi.Input[Optional[_builtins.str]] = None,
