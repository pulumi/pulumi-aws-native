...
class LocationFSxOpenZfsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_arns: The ARNs of the security groups that are to use to configure the FSx OpenZFS file system.
        :param pulumi.Input[builtins.str] fsx_filesystem_arn: The Amazon Resource Name (ARN) for the FSx OpenZFS file system.
...
@pulumi.type_token("aws-native:datasync:LocationFSxOpenZfs")
