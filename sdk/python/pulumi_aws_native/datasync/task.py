...
class TaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_location_arn: The ARN of an AWS storage resource's location.
        :param pulumi.Input[builtins.str] source_location_arn: The ARN of the source location for the task.
        :param pulumi.Input[builtins.str] cloud_watch_log_group_arn: The ARN of the Amazon CloudWatch log group that is used to monitor and log events in the task.
        ...
        :param pulumi.Input[builtins.str] name: The name of a task. This value is a text reference that is used to identify the task in the console.
...
class Task(pulumi.CustomResource):
    ...
    def destination_network_interface_arns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def source_network_interface_arns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
