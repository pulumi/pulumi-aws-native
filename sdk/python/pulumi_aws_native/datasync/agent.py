...
class AgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] activation_key: Activation key of the Agent.
        :param pulumi.Input[builtins.str] agent_name: The name configured for the agent. Text reference used to identify the agent in the console.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_arns: The ARNs of the security group used to protect your data transfer task subnets.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_arns: The ARNs of the subnets in which DataSync will create elastic network interfaces for each data transfer task.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[builtins.str] vpc_endpoint_id: The ID of the VPC endpoint that the agent has access to.
        """
...
class Agent(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="activationKey")
    def activation_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Activation key of the Agent.
        """
        return pulumi.get(self, "activation_key")
