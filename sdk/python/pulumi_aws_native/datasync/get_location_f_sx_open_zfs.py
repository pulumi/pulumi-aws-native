...
def get_location_f_sx_open_zfs(location_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location_arn: The Amazon Resource Name (ARN) of the Amazon FSx OpenZFS file system location that is created.
    """
    __args__ = dict()
...
def get_location_f_sx_open_zfs_output(location_arn: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:datasync:getLocationFSxOpenZfs', __args__, opts=opts, typ=GetLocationFSxOpenZfsResult)
