...
def get_agent(agent_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAgentResult:
    """
    Resource schema for AWS::DataSync::Agent.


    :param builtins.str agent_arn: The DataSync Agent ARN.
    """
    __args__ = dict()
...
def get_agent_output(agent_arn: Optional[pulumi.Input[builtins.str]] = None,
