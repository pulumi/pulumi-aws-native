...
class LocationAzureBlobArgs:
    ...
    def azure_blob_container_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_blob_container_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LocationAzureBlob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="azureBlobContainerUrl")
    def azure_blob_container_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of the Azure Blob container that was described.
        """
        return pulumi.get(self, "azure_blob_container_url")
