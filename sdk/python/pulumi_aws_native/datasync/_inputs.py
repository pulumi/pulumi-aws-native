...
if not MYPY:
    class LocationAzureBlobAzureBlobSasConfigurationArgsDict(TypedDict):
        ...
        """
        azure_blob_sas_token: pulumi.Input[builtins.str]
        """
...
class LocationAzureBlobAzureBlobSasConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the shared access signature (SAS) that DataSync uses to access your Azure Blob Storage container.
        :param pulumi.Input[builtins.str] azure_blob_sas_token: Specifies the shared access signature (SAS) token, which indicates the permissions DataSync needs to access your Azure Blob Storage container.
        """
        pulumi.set(__self__, "azure_blob_sas_token", azure_blob_sas_token)

    @property
    @pulumi.getter(name="azureBlobSasToken")
    def azure_blob_sas_token(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the shared access signature (SAS) token, which indicates the permissions DataSync needs to access your Azure Blob Storage container.
        """
    ...
    def azure_blob_sas_token(self, value: pulumi.Input[builtins.str]):
...
class LocationEfsEc2ConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The subnet and security group that DataSync uses to access target EFS file system.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_arns: The Amazon Resource Names (ARNs) of the security groups that are configured for the Amazon EC2 resource.
        :param pulumi.Input[builtins.str] subnet_arn: The ARN of the subnet that DataSync uses to access the target EFS file system.
        """
...
class LocationHdfsNameNodeArgs:
    def __init__(__self__, *,
        ...
        """
        HDFS Name Node IP and port information.
        :param pulumi.Input[builtins.str] hostname: The DNS name or IP address of the Name Node in the customer's on premises HDFS cluster.
        :param pulumi.Input[builtins.int] port: The port on which the Name Node is listening on for client requests.
        """
...
class LocationNfsOnPremConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Contains a list of Amazon Resource Names (ARNs) of agents that are used to connect an NFS server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] agent_arns: ARN(s) of the agent(s) to use for an NFS location.
        """
...
class LocationS3s3ConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The Amazon Resource Name (ARN) of the AWS IAM role that is used to access an Amazon S3 bucket.
        :param pulumi.Input[builtins.str] bucket_access_role_arn: The ARN of the IAM role of the Amazon S3 bucket.
        """
...
class TaskFilterRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: A single filter string that consists of the patterns to include or exclude. The patterns are delimited by "|".
        """
...
if not MYPY:
    class TaskManifestConfigSourceS3ArgsDict(TypedDict):
        ...
        """
        bucket_access_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the AWS Identity and Access Management (IAM) role that allows DataSync to access your manifest.
        """
        manifest_object_path: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the Amazon S3 object key of your manifest.
        """
        manifest_object_version_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the object version ID of the manifest that you want DataSync to use.
        """
        s3_bucket_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TaskManifestConfigSourceS3Args:
    def __init__(__self__, *,
                 bucket_access_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 manifest_object_path: Optional[pulumi.Input[builtins.str]] = None,
                 manifest_object_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 s3_bucket_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Specifies the S3 bucket where you're hosting the manifest that you want AWS DataSync to use.
        :param pulumi.Input[builtins.str] bucket_access_role_arn: Specifies the AWS Identity and Access Management (IAM) role that allows DataSync to access your manifest.
        :param pulumi.Input[builtins.str] manifest_object_path: Specifies the Amazon S3 object key of your manifest.
        :param pulumi.Input[builtins.str] manifest_object_version_id: Specifies the object version ID of the manifest that you want DataSync to use.
        :param pulumi.Input[builtins.str] s3_bucket_arn: Specifies the Amazon Resource Name (ARN) of the S3 bucket where you're hosting your manifest.
        """
    ...
    @property
    @pulumi.getter(name="bucketAccessRoleArn")
    def bucket_access_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the AWS Identity and Access Management (IAM) role that allows DataSync to access your manifest.
        """
        return pulumi.get(self, "bucket_access_role_arn")
    ...
    @bucket_access_role_arn.setter
    def bucket_access_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bucket_access_role_arn", value)

    @property
    @pulumi.getter(name="manifestObjectPath")
    def manifest_object_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Amazon S3 object key of your manifest.
        """
    ...
    def manifest_object_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "manifest_object_path", value)

    @property
    @pulumi.getter(name="manifestObjectVersionId")
    def manifest_object_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the object version ID of the manifest that you want DataSync to use.
        """
    ...
    def manifest_object_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TaskOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bytes_per_second: A value that limits the bandwidth used by AWS DataSync.
...
class TaskScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the schedule you want your task to use for repeated executions.
        :param pulumi.Input[builtins.str] schedule_expression: A cron expression that specifies when AWS DataSync initiates a scheduled transfer from a source to a destination location
