...
class LocationAzureBlobAzureBlobSasConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the shared access signature (SAS) that DataSync uses to access your Azure Blob Storage container.
        :param builtins.str azure_blob_sas_token: Specifies the shared access signature (SAS) token, which indicates the permissions DataSync needs to access your Azure Blob Storage container.
        """
...
class LocationEfsEc2Config(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The subnet and security group that DataSync uses to access target EFS file system.
        :param Sequence[builtins.str] security_group_arns: The Amazon Resource Names (ARNs) of the security groups that are configured for the Amazon EC2 resource.
        :param builtins.str subnet_arn: The ARN of the subnet that DataSync uses to access the target EFS file system.
        """
...
class LocationFSxOntapSmb(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str password: The password of the user who can mount the share and has the permissions to access files and folders in the SMB share.
        :param builtins.str user: The user who can mount the share, has the permissions to access files and folders in the SMB share.
        :param builtins.str domain: The name of the Windows domain that the SMB server belongs to.
        """
        pulumi.set(__self__, "mount_options", mount_options)
...
class LocationHdfsNameNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        HDFS Name Node IP and port information.
        :param builtins.str hostname: The DNS name or IP address of the Name Node in the customer's on premises HDFS cluster.
        :param builtins.int port: The port on which the Name Node is listening on for client requests.
        """
...
class LocationNfsOnPremConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains a list of Amazon Resource Names (ARNs) of agents that are used to connect an NFS server.
        :param Sequence[builtins.str] agent_arns: ARN(s) of the agent(s) to use for an NFS location.
        """
...
class LocationS3s3Config(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Amazon Resource Name (ARN) of the AWS IAM role that is used to access an Amazon S3 bucket.
        :param builtins.str bucket_access_role_arn: The ARN of the IAM role of the Amazon S3 bucket.
        """
...
class TaskFilterRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: A single filter string that consists of the patterns to include or exclude. The patterns are delimited by "|".
        """
...
class TaskManifestConfigSourceS3(dict):
    ...
    def __init__(__self__, *,
                 bucket_access_role_arn: Optional[builtins.str] = None,
                 manifest_object_path: Optional[builtins.str] = None,
                 manifest_object_version_id: Optional[builtins.str] = None,
                 s3_bucket_arn: Optional[builtins.str] = None):
        """
        Specifies the S3 bucket where you're hosting the manifest that you want AWS DataSync to use.
        :param builtins.str bucket_access_role_arn: Specifies the AWS Identity and Access Management (IAM) role that allows DataSync to access your manifest.
        :param builtins.str manifest_object_path: Specifies the Amazon S3 object key of your manifest.
        :param builtins.str manifest_object_version_id: Specifies the object version ID of the manifest that you want DataSync to use.
        :param builtins.str s3_bucket_arn: Specifies the Amazon Resource Name (ARN) of the S3 bucket where you're hosting your manifest.
        """
    ...
    @property
    @pulumi.getter(name="bucketAccessRoleArn")
    def bucket_access_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_object_path(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_object_version_id(self) -> Optional[builtins.str]:
        """
    ...
    def s3_bucket_arn(self) -> Optional[builtins.str]:
        """
...
class TaskOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int bytes_per_second: A value that limits the bandwidth used by AWS DataSync.
...
class TaskSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the schedule you want your task to use for repeated executions.
        :param builtins.str schedule_expression: A cron expression that specifies when AWS DataSync initiates a scheduled transfer from a source to a destination location
