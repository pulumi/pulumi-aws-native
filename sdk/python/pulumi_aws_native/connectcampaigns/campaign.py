...
class CampaignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CampaignDialerConfigArgs'] dialer_config: Contains dialer configuration for an outbound campaign.
        :param pulumi.Input['CampaignOutboundCallConfigArgs'] outbound_call_config: Contains outbound call configuration for an outbound campaign.
...
class Campaign(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] connect_instance_arn: Amazon Connect Instance Arn
        :param pulumi.Input[pulumi.InputType['CampaignDialerConfigArgs']] dialer_config: Contains dialer configuration for an outbound campaign.
        :param pulumi.Input[str] name: Amazon Connect Campaign Name
        :param pulumi.Input[pulumi.InputType['CampaignOutboundCallConfigArgs']] outbound_call_config: Contains outbound call configuration for an outbound campaign.
