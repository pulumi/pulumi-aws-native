...
class CampaignArgs:
    def __init__(__self__, *,
                 connect_instance_arn: pulumi.Input[_builtins.str],
    ...
    def connect_instance_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def connect_instance_arn(self, value: pulumi.Input[_builtins.str]):
...
class Campaign(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="connectInstanceArn")
    def connect_instance_arn(self) -> pulumi.Output[_builtins.str]:
        """
        Amazon Connect Instance Arn
        """
        return pulumi.get(self, "connect_instance_arn")
