...
class CampaignDialerConfigArgsDict(TypedDict):
    ...
    """
    agentless_dialer_config: NotRequired[pulumi.Input[Optional['CampaignAgentlessDialerConfigArgsDict']]]
    """
    The configuration of the agentless dialer.
    """
    predictive_dialer_config: NotRequired[pulumi.Input[Optional['CampaignPredictiveDialerConfigArgsDict']]]
    """
    The configuration of the predictive dialer.
    """
    progressive_dialer_config: NotRequired[pulumi.Input[Optional['CampaignProgressiveDialerConfigArgsDict']]]
    """
...
class CampaignOutboundCallConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connect_source_phone_number: The phone number associated with the Amazon Connect instance, in E.164 format. If you do not specify a source phone number, you must specify a queue.
        """
    ...
    def connect_contact_flow_arn(self) -> pulumi.Input[_builtins.str]:
        """
        The identifier of the contact flow for the outbound call.
        """
    ...
    def connect_contact_flow_arn(self, value: pulumi.Input[_builtins.str]):
