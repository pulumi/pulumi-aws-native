...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] engine: The engine type used by the cluster.
        :param pulumi.Input[_builtins.str] engine_version: The Redis engine version used by the cluster.
        :param pulumi.Input[_builtins.str] final_snapshot_name: The user-supplied name of a final cluster snapshot. This is the unique name that identifies the snapshot. MemoryDB creates the snapshot, and then deletes the cluster immediately afterward.
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: The ID of the KMS key used to encrypt the cluster.
        :param pulumi.Input[_builtins.str] maintenance_window: Specifies the weekly time range during which maintenance on the cluster is performed. It is specified as a range in the format ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period.
        :param pulumi.Input[_builtins.str] multi_region_cluster_name: The name of the Global Datastore, it is generated by MemoryDB adding a prefix to MultiRegionClusterNameSuffix.
        :param pulumi.Input['ClusterSupportedNetworkTypes'] network_type: Must be either ipv4 | ipv6 | dual_stack.
        :param pulumi.Input[_builtins.int] num_replicas_per_shard: The number of replicas to apply to each shard. The limit is 5.
        :param pulumi.Input[_builtins.int] num_shards: The number of shards the cluster will contain.
        :param pulumi.Input[_builtins.str] parameter_group_name: The name of the parameter group associated with the cluster.
        :param pulumi.Input[_builtins.int] port: The port number on which each member of the cluster accepts connections.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: One or more Amazon VPC security groups associated with this cluster.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] snapshot_arns: A list of Amazon Resource Names (ARN) that uniquely identify the RDB snapshot files stored in Amazon S3. The snapshot files are used to populate the new cluster. The Amazon S3 object name in the ARN cannot contain any commas.
        :param pulumi.Input[_builtins.str] snapshot_name: The name of a snapshot from which to restore data into the new cluster. The snapshot status changes to restoring while the new cluster is being created.
        :param pulumi.Input[_builtins.int] snapshot_retention_limit: The number of days for which MemoryDB retains automatic snapshots before deleting them. For example, if you set SnapshotRetentionLimit to 5, a snapshot that was taken today is retained for 5 days before being deleted.
        :param pulumi.Input[_builtins.str] snapshot_window: The daily time range (in UTC) during which MemoryDB begins taking a daily snapshot of your cluster.
...
class Cluster(pulumi.CustomResource):
    ...
    def parameter_group_status(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="snsTopicStatus")
    def sns_topic_status(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The status of the Amazon SNS notification topic. Notifications are sent only if the status is enabled.
        """
        return pulumi.get(self, "sns_topic_status")
    ...
    @_builtins.property
    @pulumi.getter(name="subnetGroupName")
    def subnet_group_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the subnet group to be used for the cluster.
        """
        return pulumi.get(self, "subnet_group_name")
