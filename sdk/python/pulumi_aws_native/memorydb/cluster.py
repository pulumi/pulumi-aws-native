...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] multi_region_cluster_name: The name of the Global Datastore, it is generated by MemoryDB adding a prefix to MultiRegionClusterNameSuffix.
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["clusterName", "dataTiering", "kmsKeyId", "multiRegionClusterName", "port", "snapshotArns[*]", "snapshotName", "subnetGroupName", "tlsEnabled"])
