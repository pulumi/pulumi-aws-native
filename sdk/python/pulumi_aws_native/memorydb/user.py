...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_string: Access permissions string used for this user account.
        ...
        :param pulumi.Input[builtins.str] user_name: The name of the user.
        """
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessString")
    def access_string(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Access permissions string used for this user account.
        """
        return pulumi.get(self, "access_string")
