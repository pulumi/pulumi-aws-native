...
class ParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] family: The name of the parameter group family that this parameter group is compatible with.
        :param pulumi.Input[builtins.str] description: A description of the parameter group.
        :param pulumi.Input[builtins.str] parameter_group_name: The name of the parameter group.
