...
class GetClusterResult:
    ...
    def num_replicas_per_shard(self) -> Optional[builtins.int]:
        """
    ...
    def parameter_group_status(self) -> Optional[builtins.str]:
        """
    ...
    def sns_topic_status(self) -> Optional[builtins.str]:
        """
...
def get_cluster(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the cluster. This value must be unique as it also serves as the cluster identifier.
    """
    __args__ = dict()
