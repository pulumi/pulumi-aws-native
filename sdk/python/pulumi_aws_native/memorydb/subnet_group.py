...
class SubnetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description of the subnet group.
        :param pulumi.Input[builtins.str] subnet_group_name: The name of the subnet group. This value must be unique as it also serves as the subnet group identifier.
