...
class MultiRegionPropertiesPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The Multi-region properties associated to this cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clusters: The set of linked clusters that form the multi-Region cluster configuration. Each linked cluster represents a database instance in a different Region.
