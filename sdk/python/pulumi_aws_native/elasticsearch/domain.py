...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(advanced_security_options, DomainAdvancedSecurityOptionsInputArgs):
            ...
            if not isinstance(cognito_options, DomainCognitoOptionsArgs):
            ...
            if not isinstance(domain_endpoint_options, DomainEndpointOptionsArgs):
            ...
            if not isinstance(ebs_options, DomainEbsOptionsArgs):
            ...
            if not isinstance(elasticsearch_cluster_config, DomainElasticsearchClusterConfigArgs):
            ...
            if not isinstance(encryption_at_rest_options, DomainEncryptionAtRestOptionsArgs):
            ...
            if not isinstance(node_to_node_encryption_options, DomainNodeToNodeEncryptionOptionsArgs):
            ...
            if not isinstance(snapshot_options, DomainSnapshotOptionsArgs):
            ...
            if not isinstance(vpc_options, DomainVpcOptionsArgs):
