...
if not MYPY:
    class EnvironmentModuleLoggingConfigurationArgsDict(TypedDict):
        ...
        """
        cloud_watch_log_group_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentModuleLoggingConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Logging configuration for a specific airflow component.
        :param pulumi.Input[builtins.str] cloud_watch_log_group_arn: The ARN of the CloudWatch Logs log group for each type of Apache Airflow log type that you have enabled.
               
               > `CloudWatchLogGroupArn` is available only as a return value, accessible when specified as an attribute in the [`Fn:GetAtt`](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mwaa-environment.html#aws-resource-mwaa-environment-return-values) intrinsic function. Any value you provide for `CloudWatchLogGroupArn` is discarded by Amazon MWAA.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether to enable the Apache Airflow log type (e.g. `DagProcessingLogs` ) in CloudWatch Logs.
    ...
    def cloud_watch_log_group_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnvironmentNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configures the network resources of the environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security groups to use for the environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of subnets to use for the environment. These must be private subnets, in the same VPC, in two different availability zones.
        """
