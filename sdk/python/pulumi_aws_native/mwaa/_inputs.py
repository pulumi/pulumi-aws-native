...
class EnvironmentLoggingConfigurationArgsDict(TypedDict):
    ...
    """
    dag_processing_logs: NotRequired[pulumi.Input[Optional['EnvironmentModuleLoggingConfigurationArgsDict']]]
    """
    Defines the processing logs sent to CloudWatch Logs and the logging level to send.
    """
    scheduler_logs: NotRequired[pulumi.Input[Optional['EnvironmentModuleLoggingConfigurationArgsDict']]]
    """
    Defines the scheduler logs sent to CloudWatch Logs and the logging level to send.
    """
    task_logs: NotRequired[pulumi.Input[Optional['EnvironmentModuleLoggingConfigurationArgsDict']]]
    """
    Defines the task logs sent to CloudWatch Logs and the logging level to send.
    """
    webserver_logs: NotRequired[pulumi.Input[Optional['EnvironmentModuleLoggingConfigurationArgsDict']]]
    """
    Defines the web server logs sent to CloudWatch Logs and the logging level to send.
    """
    worker_logs: NotRequired[pulumi.Input[Optional['EnvironmentModuleLoggingConfigurationArgsDict']]]
    """
