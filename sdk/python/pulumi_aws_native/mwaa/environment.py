...
class Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(logging_configuration, EnvironmentLoggingConfigurationArgs):
            ...
            if not isinstance(network_configuration, EnvironmentNetworkConfigurationArgs):
