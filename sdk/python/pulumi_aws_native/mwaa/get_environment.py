...
class GetEnvironmentResult:
    ...
    def airflow_version(self) -> Optional[builtins.str]:
        """
    ...
    def celery_executor_queue(self) -> Optional[builtins.str]:
        """
    ...
    def dag_s3_path(self) -> Optional[builtins.str]:
        """
    ...
    def database_vpc_endpoint_service(self) -> Optional[builtins.str]:
        """
    ...
    def environment_class(self) -> Optional[builtins.str]:
        """
    ...
    def max_webservers(self) -> Optional[builtins.int]:
        """
    ...
    def min_webservers(self) -> Optional[builtins.int]:
        """
    ...
    def min_workers(self) -> Optional[builtins.int]:
        """
    ...
    def plugins_s3_object_version(self) -> Optional[builtins.str]:
        """
    ...
    def plugins_s3_path(self) -> Optional[builtins.str]:
        """
    ...
    def requirements_s3_object_version(self) -> Optional[builtins.str]:
        """
    ...
    def requirements_s3_path(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def schedulers(self) -> Optional[builtins.int]:
        """
    ...
    def source_bucket_arn(self) -> Optional[builtins.str]:
        """
    ...
    def startup_script_s3_object_version(self) -> Optional[builtins.str]:
        """
    ...
    def startup_script_s3_path(self) -> Optional[builtins.str]:
        """
    ...
    def webserver_url(self) -> Optional[builtins.str]:
        """
    ...
    def webserver_vpc_endpoint_service(self) -> Optional[builtins.str]:
        """
...
def get_environment(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of your Amazon MWAA environment.
    """
    __args__ = dict()
    __args__['name'] = name
