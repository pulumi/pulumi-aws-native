...
class EnvironmentModuleLoggingConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enabled: Indicates whether to enable the Apache Airflow log type (e.g. `DagProcessingLogs` ) in CloudWatch Logs.
        :param 'EnvironmentLoggingLevel' log_level: Defines the Apache Airflow logs to send for the log type (e.g. `DagProcessingLogs` ) to CloudWatch Logs.
        """
