...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(access_logging_policy, LoadBalancerAccessLoggingPolicyArgs):
            ...
            if not isinstance(connection_draining_policy, LoadBalancerConnectionDrainingPolicyArgs):
            ...
            if not isinstance(connection_settings, LoadBalancerConnectionSettingsArgs):
