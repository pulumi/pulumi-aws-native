...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 source_security_group_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 source_security_group_owner_alias: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def source_security_group_group_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "source_security_group_group_name")

    @source_security_group_group_name.setter
    def source_security_group_group_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "source_security_group_group_name", value)

    @_builtins.property
    @pulumi.getter(name="sourceSecurityGroupOwnerAlias")
    def source_security_group_owner_alias(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "source_security_group_owner_alias")

    @source_security_group_owner_alias.setter
    def source_security_group_owner_alias(self, value: pulumi.Input[Optional[_builtins.str]]):
