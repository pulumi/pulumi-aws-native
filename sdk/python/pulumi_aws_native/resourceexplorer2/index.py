...
class IndexArgs:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input['IndexTagMapArgs']]:
        return pulumi.get(self, "tags")

    @tags.setter
    def tags(self, value: Optional[pulumi.Input['IndexTagMapArgs']]):
...
class Index(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 tags: Optional[pulumi.Input[pulumi.InputType['IndexTagMapArgs']]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(tags, IndexTagMapArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional['outputs.IndexTagMap']]:
        return pulumi.get(self, "tags")
