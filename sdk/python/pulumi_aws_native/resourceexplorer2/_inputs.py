...
class ViewIncludedPropertyArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the property that is included in this view.
        """
...
class ViewSearchFilterArgs:
    def __init__(__self__, *,
                 filter_string: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] filter_string: The string that contains the search keywords, prefixes, and operators to control the results that can be returned by a Search operation.
