...
class ViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tag key and value pairs that are attached to the view.
        :param pulumi.Input[builtins.str] view_name: The name of the new view.
        """
...
class View(pulumi.CustomResource):
    ...
    def view_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="viewName")
    def view_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the new view.
        """
        return pulumi.get(self, "view_name")
