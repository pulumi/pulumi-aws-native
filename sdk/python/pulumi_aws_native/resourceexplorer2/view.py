...
class ViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tag key and value pairs that are attached to the view.
        :param pulumi.Input[_builtins.str] view_name: The name of the new view.
        """
...
class View(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 filters: pulumi.Input[Optional[Union['ViewSearchFilterArgs', 'ViewSearchFilterArgsDict', 'outputs.ViewSearchFilter']]] = None,
        ...
        :param pulumi.Input[Union['ViewSearchFilterArgs', 'ViewSearchFilterArgsDict', 'outputs.ViewSearchFilter']] filters: An array of strings that include search keywords, prefixes, and operators that filter the results that are returned for queries made using this view. When you use this view in a [Search](https://docs.aws.amazon.com/resource-explorer/latest/apireference/API_Search.html) operation, the filter string is combined with the search's `QueryString` parameter using a logical `AND` operator.
               
               For information about the supported syntax, see [Search query reference for Resource Explorer](https://docs.aws.amazon.com/resource-explorer/latest/userguide/using-search-query-syntax.html) in the *AWS Resource Explorer User Guide* .
               
               > This query string in the context of this operation supports only [filter prefixes](https://docs.aws.amazon.com/resource-explorer/latest/userguide/using-search-query-syntax.html#query-syntax-filters) with optional [operators](https://docs.aws.amazon.com/resource-explorer/latest/userguide/using-search-query-syntax.html#query-syntax-operators) . It doesn't support free-form text. For example, the string `region:us* service:ec2 -tag:stage=prod` includes all Amazon EC2 resources in any AWS Region that begin with the letters `us` and are *not* tagged with a key `Stage` that has the value `prod` .
        :param pulumi.Input[Sequence[pulumi.Input[Union['ViewIncludedPropertyArgs', 'ViewIncludedPropertyArgsDict', 'outputs.ViewIncludedProperty']]]] included_properties: A list of fields that provide additional information about the view.
        :param pulumi.Input[_builtins.str] scope: The root ARN of the account, an organizational unit (OU), or an organization ARN. If left empty, the default is account.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tag key and value pairs that are attached to the view.
        :param pulumi.Input[_builtins.str] view_name: The name of the new view.
        """
    ...
    def view_arn(self) -> pulumi.Output[_builtins.str]:
        """
