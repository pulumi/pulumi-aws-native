...
class DefaultViewAssociationArgs:
    def __init__(__self__, *,
                 view_arn: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DefaultViewAssociation resource.
        :param pulumi.Input[builtins.str] view_arn: The ARN of the view to set as the default for the AWS Region and AWS account in which you call this operation. The specified view must already exist in the specified Region.
        """
        pulumi.set(__self__, "view_arn", view_arn)

    @property
    @pulumi.getter(name="viewArn")
    def view_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @view_arn.setter
    def view_arn(self, value: pulumi.Input[builtins.str]):
...
class DefaultViewAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 view_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def associated_aws_principal(self) -> pulumi.Output[builtins.str]:
        """
