...
class DefaultViewAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] view_arn: The ARN of the view to set as the default for the AWS Region and AWS account in which you call this operation. The specified view must already exist in the specified Region.
        """
        pulumi.set(__self__, "view_arn", view_arn)

    @_builtins.property
    @pulumi.getter(name="viewArn")
    def view_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @view_arn.setter
    def view_arn(self, value: pulumi.Input[_builtins.str]):
...
class DefaultViewAssociation(pulumi.CustomResource):
    ...
    def associated_aws_principal(self) -> pulumi.Output[_builtins.str]:
        """
