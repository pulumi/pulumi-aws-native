...
class ViewIncludedProperty(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: The name of the property that is included in this view.
        """
...
class ViewSearchFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str filter_string: The string that contains the search keywords, prefixes, and operators to control the results that can be returned by a Search operation.
