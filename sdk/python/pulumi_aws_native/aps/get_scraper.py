...
class GetScraperResult:
    ...
    def scraper_id(self) -> Optional[_builtins.str]:
        """
...
def get_scraper_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
