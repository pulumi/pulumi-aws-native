...
class RuleGroupsNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data: The RuleGroupsNamespace data.
        :param pulumi.Input[builtins.str] workspace: Required to identify a specific APS Workspace associated with this RuleGroupsNamespace.
        :param pulumi.Input[builtins.str] name: The RuleGroupsNamespace name.
...
class RuleGroupsNamespace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def workspace(self) -> pulumi.Output[builtins.str]:
        """
        Required to identify a specific APS Workspace associated with this RuleGroupsNamespace.
        """
        return pulumi.get(self, "workspace")
