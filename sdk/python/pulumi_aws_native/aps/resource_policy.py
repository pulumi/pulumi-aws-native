...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_document: The JSON to use as the Resource-based Policy.
        :param pulumi.Input[builtins.str] workspace_arn: The Arn of an APS Workspace that the PolicyDocument will be attached to.
        """
...
@pulumi.type_token("aws-native:aps:ResourcePolicy")
class ResourcePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 workspace_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if workspace_arn is None and not opts.urn:
                raise TypeError("Missing required property 'workspace_arn'")
            __props__.__dict__["workspace_arn"] = workspace_arn
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["workspaceArn"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ResourcePolicy, __self__).__init__(
            'aws-native:aps:ResourcePolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["workspace_arn"] = None
    ...
    @property
    @pulumi.getter(name="workspaceArn")
    def workspace_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Arn of an APS Workspace that the PolicyDocument will be attached to.
        """
        return pulumi.get(self, "workspace_arn")
