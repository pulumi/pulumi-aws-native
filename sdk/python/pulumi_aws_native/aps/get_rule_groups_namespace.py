...
def get_rule_groups_namespace(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The RuleGroupsNamespace ARN.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_rule_groups_namespace_output(arn: Optional[pulumi.Input[builtins.str]] = None,
