...
def get_rule_groups_namespace(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The RuleGroupsNamespace ARN.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_rule_groups_namespace_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
