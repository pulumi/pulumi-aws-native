...
class AnomalyDetectorRandomCutForestConfigurationArgsDict(TypedDict):
    ...
    """
    ignore_near_expected_from_above: NotRequired[pulumi.Input[Optional['AnomalyDetectorIgnoreNearExpectedArgs']]]
    """
    Configuration for ignoring values that are near expected values from above during anomaly detection.
    """
    ignore_near_expected_from_below: NotRequired[pulumi.Input[Optional['AnomalyDetectorIgnoreNearExpectedArgs']]]
    """
...
class ScraperComponentArgsDict(TypedDict):
    ...
    """
    config: NotRequired[pulumi.Input[Optional['ScraperComponentConfigArgs']]]
    """
...
class ScraperDestinationArgsDict(TypedDict):
    ...
    """
    amp_configuration: NotRequired[pulumi.Input[Optional['ScraperDestinationAmpConfigurationPropertiesArgs']]]
    """
    Configuration for Amazon Managed Prometheus metrics destination
    """
...
class ScraperLoggingDestinationArgsDict(TypedDict):
    ...
    """
    cloud_watch_logs: NotRequired[pulumi.Input[Optional['ScraperCloudWatchLogDestinationArgs']]]
    """
...
class ScraperSourceArgsDict(TypedDict):
    ...
    """
    eks_configuration: NotRequired[pulumi.Input[Optional['ScraperSourceEksConfigurationPropertiesArgs']]]
    """
    Configuration for EKS metrics source
    """
    vpc_configuration: NotRequired[pulumi.Input[Optional['ScraperSourceVpcConfigurationPropertiesArgs']]]
    """
    Configuration for VPC metrics source
    """
...
class WorkspaceConfigurationArgsDict(TypedDict):
    ...
    """
    limits_per_label_sets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkspaceLimitsPerLabelSetArgs']]]]]
    """
