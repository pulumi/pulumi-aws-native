...
class GetAzsResult:
    ...
    @property
    @pulumi.getter
    def azs(self) -> Sequence[builtins.str]:
...
def get_azs(region: Optional[builtins.str] = None,
...
def get_azs_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
