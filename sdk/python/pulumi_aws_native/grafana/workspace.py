...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(network_access_control, WorkspaceNetworkAccessControlArgs):
            ...
            if not isinstance(saml_configuration, WorkspaceSamlConfigurationArgs):
            ...
            if not isinstance(vpc_configuration, WorkspaceVpcConfigurationArgs):
