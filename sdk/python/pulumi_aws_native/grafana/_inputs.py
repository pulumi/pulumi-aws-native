...
if not MYPY:
    class WorkspaceAssertionAttributesArgsDict(TypedDict):
        ...
        """
        groups: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkspaceAssertionAttributesArgs:
    def __init__(__self__, *,
                 ...
                 groups: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        Maps Grafana friendly names to the IdPs SAML attributes.
        :param pulumi.Input[builtins.str] email: Name of the attribute within the SAML assert to use as the users email in Grafana.
        :param pulumi.Input[builtins.str] groups: Name of the attribute within the SAML assert to use as the users groups in Grafana.
        :param pulumi.Input[builtins.str] login: Name of the attribute within the SAML assert to use as the users login handle in Grafana.
        :param pulumi.Input[builtins.str] name: Name of the attribute within the SAML assert to use as the users name in Grafana.
        :param pulumi.Input[builtins.str] org: Name of the attribute within the SAML assert to use as the users organizations in Grafana.
        :param pulumi.Input[builtins.str] role: Name of the attribute within the SAML assert to use as the users roles in Grafana.
        """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the attribute within the SAML assert to use as the users groups in Grafana.
        """
    ...
    @groups.setter
    def groups(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkspaceIdpMetadataArgsDict(TypedDict):
        ...
        """
        xml: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkspaceIdpMetadataArgs:
    def __init__(__self__, *,
                 ...
                 xml: Optional[pulumi.Input[builtins.str]] = None):
        """
        IdP Metadata used to configure SAML authentication in Grafana.
        :param pulumi.Input[builtins.str] url: URL that vends the IdPs metadata.
        :param pulumi.Input[builtins.str] xml: XML blob of the IdPs metadata.
        """
        if url is not None:
    ...
    @property
    @pulumi.getter
    def xml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        XML blob of the IdPs metadata.
        """
    ...
    @xml.setter
    def xml(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkspaceNetworkAccessControlArgsDict(TypedDict):
        ...
        """
        prefix_list_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        vpce_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class WorkspaceNetworkAccessControlArgs:
    def __init__(__self__, *,
                 ...
                 vpce_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The configuration settings for Network Access Control.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_list_ids: The list of prefix list IDs. A prefix list is a list of CIDR ranges of IP addresses. The IP addresses specified are allowed to access your workspace. If the list is not included in the configuration then no IP addresses will be allowed to access the workspace.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpce_ids: The list of Amazon VPC endpoint IDs for the workspace. If a NetworkAccessConfiguration is specified then only VPC endpoints specified here will be allowed to access the workspace.
        """
    ...
    def vpce_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of Amazon VPC endpoint IDs for the workspace. If a NetworkAccessConfiguration is specified then only VPC endpoints specified here will be allowed to access the workspace.
        """
    ...
    @vpce_ids.setter
    def vpce_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class WorkspaceRoleValuesArgsDict(TypedDict):
        ...
        """
        admin: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of SAML roles which will be mapped into the Grafana Admin role.
        """
        editor: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class WorkspaceRoleValuesArgs:
    def __init__(__self__, *,
                 admin: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 editor: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Maps SAML roles to the Grafana Editor and Admin roles.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] admin: List of SAML roles which will be mapped into the Grafana Admin role.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] editor: List of SAML roles which will be mapped into the Grafana Editor role.
        """
    ...
    @property
    @pulumi.getter
    def admin(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of SAML roles which will be mapped into the Grafana Admin role.
        """
    ...
    @admin.setter
    def admin(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "admin", value)

    @property
    @pulumi.getter
    def editor(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of SAML roles which will be mapped into the Grafana Editor role.
        """
    ...
    @editor.setter
    def editor(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class WorkspaceSamlConfigurationArgsDict(TypedDict):
        ...
        """
        allowed_organizations: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        login_validity_duration: NotRequired[pulumi.Input[builtins.float]]
        """
...
class WorkspaceSamlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 login_validity_duration: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_organizations: List of SAML organizations allowed to access Grafana.
        ...
        :param pulumi.Input[builtins.float] login_validity_duration: The maximum lifetime an authenticated user can be logged in (in minutes) before being required to re-authenticate.
    ...
    def login_validity_duration(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum lifetime an authenticated user can be logged in (in minutes) before being required to re-authenticate.
        """
    ...
    def login_validity_duration(self, value: Optional[pulumi.Input[builtins.float]]):
