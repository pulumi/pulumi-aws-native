...
def get_simulation_application(arn: Optional[builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSimulationApplicationResult:
    """
    This schema is for testing purpose only.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the simulation application.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_simulation_application_output(arn: Optional[pulumi.Input[builtins.str]] = None,
