...
def get_simulation_application_version(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the simulation application version.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_simulation_application_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
