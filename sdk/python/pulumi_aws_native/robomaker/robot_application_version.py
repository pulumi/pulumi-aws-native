...
class RobotApplicationVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] application: The application information for the robot application.
...
@pulumi.type_token("aws-native:robomaker:RobotApplicationVersion")
