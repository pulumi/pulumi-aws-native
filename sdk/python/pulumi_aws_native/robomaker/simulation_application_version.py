...
class SimulationApplicationVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application: The application information for the simulation application.
...
class SimulationApplicationVersion(pulumi.CustomResource):
    ...
    def application_version(self) -> pulumi.Output[builtins.str]:
        """
