...
class RobotApplicationSourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str s3_bucket: The Arn of the S3Bucket that stores the robot application source.
        :param _builtins.str s3_key: The s3 key of robot application source.
        """
...
class SimulationApplicationRenderingEngine(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: The version of the rendering engine.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "version", version)
...
class SimulationApplicationSourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str s3_bucket: The Amazon S3 bucket name.
        :param _builtins.str s3_key: The s3 object key.
        """
        pulumi.set(__self__, "architecture", architecture)
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_key", s3_key)
