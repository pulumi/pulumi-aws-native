...
def get_robot(arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRobotResult:
    """
    AWS::RoboMaker::Robot resource creates an AWS RoboMaker Robot.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the robot.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_robot_output(arn: Optional[pulumi.Input[builtins.str]] = None,
