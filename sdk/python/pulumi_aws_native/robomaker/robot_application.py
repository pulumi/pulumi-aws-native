...
class RobotApplication(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RobotApplicationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RobotApplicationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RobotApplicationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RobotApplicationProperties']:
        """
