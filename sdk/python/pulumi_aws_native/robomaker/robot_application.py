...
class RobotApplicationArgs:
    def __init__(__self__, *,
                 ...
                 current_revision_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] current_revision_id: The revision ID of robot application.
        :param pulumi.Input[builtins.str] environment: The URI of the Docker image for the robot application.
        :param pulumi.Input[builtins.str] name: The name of the robot application.
        :param pulumi.Input[Sequence[pulumi.Input['RobotApplicationSourceConfigArgs']]] sources: The sources of the robot application.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map that contains tag keys and tag values that are attached to the robot application.
        """
    ...
    def current_revision_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_revision_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:robomaker:RobotApplication")
class RobotApplication(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="currentRevisionId")
    def current_revision_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The revision ID of robot application.
        """
        return pulumi.get(self, "current_revision_id")
