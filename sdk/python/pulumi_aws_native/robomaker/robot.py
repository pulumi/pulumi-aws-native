...
class RobotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] greengrass_group_id: The Greengrass group id.
        :param pulumi.Input[_builtins.str] fleet: The Amazon Resource Name (ARN) of the fleet.
        :param pulumi.Input[_builtins.str] name: The name for the robot.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A map that contains tag keys and tag values that are attached to the robot.
        """
    ...
    def greengrass_group_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def greengrass_group_id(self, value: pulumi.Input[_builtins.str]):
...
class Robot(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def fleet(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the fleet.
        """
        return pulumi.get(self, "fleet")
    ...
    @_builtins.property
    @pulumi.getter(name="greengrassGroupId")
    def greengrass_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Greengrass group id.
        """
        return pulumi.get(self, "greengrass_group_id")
