...
class SimulationApplication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(rendering_engine, SimulationApplicationRenderingEngineArgs):
            ...
            if not isinstance(robot_software_suite, SimulationApplicationRobotSoftwareSuiteArgs):
            ...
            if not isinstance(simulation_software_suite, SimulationApplicationSimulationSoftwareSuiteArgs):
            ...
            if not isinstance(tags, SimulationApplicationTagsArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
