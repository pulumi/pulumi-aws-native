...
class SimulationApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] current_revision_id: The current revision id.
        :param pulumi.Input[builtins.str] environment: The URI of the Docker image for the robot application.
        :param pulumi.Input[builtins.str] name: The name of the simulation application.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map that contains tag keys and tag values that are attached to the simulation application.
        """
...
@pulumi.type_token("aws-native:robomaker:SimulationApplication")
