...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 skip_shard_migration_wait: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] engine_version: The version of OpenSearch to use. The value must be in the format `OpenSearch_X.Y` or `Elasticsearch_X.Y` . If not specified, the latest version of OpenSearch is used. For information about the versions that OpenSearch Service supports, see [Supported versions of OpenSearch and Elasticsearch](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/what-is.html#choosing-version) in the *Amazon OpenSearch Service Developer Guide* .
        ...
        :param pulumi.Input[builtins.str] ip_address_type: Choose either dual stack or IPv4 as your IP address type. Dual stack allows you to share domain resources across IPv4 and IPv6 address types, and is the recommended option. If you set your IP address type to dual stack, you can't change your address type later.
    ...
    def skip_shard_migration_wait(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "skip_shard_migration_wait")

    @skip_shard_migration_wait.setter
    def skip_shard_migration_wait(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Domain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="advancedOptions")
    def advanced_options(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Additional options to specify for the OpenSearch Service domain. For more information, see [AdvancedOptions](https://docs.aws.amazon.com/opensearch-service/latest/APIReference/API_CreateDomain.html#API_CreateDomain_RequestBody) in the OpenSearch Service API reference.
        """
        return pulumi.get(self, "advanced_options")
    ...
    def domain_endpoint_v2(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def domain_endpoints(self) -> pulumi.Output[Mapping[str, builtins.str]]:
    ...
    @property
    @pulumi.getter(name="skipShardMigrationWait")
    def skip_shard_migration_wait(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "skip_shard_migration_wait")
