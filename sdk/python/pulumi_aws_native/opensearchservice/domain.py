...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cluster_config, DomainClusterConfigArgs):
            ...
            if not isinstance(off_peak_window_options, DomainOffPeakWindowOptionsArgs):
            ...
            if not isinstance(software_update_options, DomainSoftwareUpdateOptionsArgs):
