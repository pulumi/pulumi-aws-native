...
class DomainNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] count: The number of nodes of a particular node type in the cluster.
        :param pulumi.Input[builtins.bool] enabled: A boolean that indicates whether a particular node type is enabled or not.
