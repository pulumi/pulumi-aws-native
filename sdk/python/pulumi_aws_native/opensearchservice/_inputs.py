...
class ApplicationAppConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The configuration value.
        """
...
if not MYPY:
    class ApplicationDataSourceArgsDict(TypedDict):
        ...
        """
        data_source_description: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationDataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_source_description: Description of the data source.
        """
...
if not MYPY:
    class DomainAdvancedSecurityOptionsInputArgsDict(TypedDict):
        anonymous_auth_disable_date: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DomainAdvancedSecurityOptionsInputArgs:
    def __init__(__self__, *,
                 anonymous_auth_disable_date: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def anonymous_auth_disable_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Date and time when the migration period will be disabled. Only necessary when [enabling fine-grained access control on an existing domain](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/fgac.html#fgac-enabling-existing) .
        """
    ...
    def anonymous_auth_disable_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] dedicated_master_count: The number of instances to use for the master node. If you specify this property, you must specify `true` for the `DedicatedMasterEnabled` property.
        :param pulumi.Input[builtins.bool] dedicated_master_enabled: Indicates whether to use a dedicated master node for the OpenSearch Service domain. A dedicated master node is a cluster node that performs cluster management tasks, but doesn't hold data or respond to data upload requests. Dedicated master nodes offload cluster management tasks to increase the stability of your search clusters. See [Dedicated master nodes in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-dedicatedmasternodes.html) .
        :param pulumi.Input[builtins.str] dedicated_master_type: The hardware configuration of the computer that hosts the dedicated master node, such as `m3.medium.search` . If you specify this property, you must specify `true` for the `DedicatedMasterEnabled` property. For valid values, see [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html) .
        :param pulumi.Input[builtins.int] instance_count: The number of data nodes (instances) to use in the OpenSearch Service domain.
        :param pulumi.Input[builtins.str] instance_type: The instance type for your data nodes, such as `m3.medium.search` . For valid values, see [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html) .
        :param pulumi.Input[builtins.bool] multi_az_with_standby_enabled: Indicates whether Multi-AZ with Standby deployment option is enabled. For more information, see [Multi-AZ with Standby](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html#managedomains-za-standby) .
        :param pulumi.Input[Sequence[pulumi.Input['DomainNodeOptionArgs']]] node_options: List of node options for the domain.
        :param pulumi.Input[builtins.int] warm_count: The number of warm nodes in the cluster.
        :param pulumi.Input[builtins.bool] warm_enabled: Whether to enable UltraWarm storage for the cluster. See [UltraWarm storage for Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ultrawarm.html) .
        :param pulumi.Input[builtins.str] warm_type: The instance type for the cluster's warm nodes.
        ...
        :param pulumi.Input[builtins.bool] zone_awareness_enabled: Indicates whether to enable zone awareness for the OpenSearch Service domain. When you enable zone awareness, OpenSearch Service allocates the nodes and replica index shards that belong to a cluster across two Availability Zones (AZs) in the same region to prevent data loss and minimize downtime in the event of node or data center failure. Don't enable zone awareness if your cluster has no replica index shards or is a single-node cluster. For more information, see [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html) .
        """
...
class DomainCognitoOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable or disable Amazon Cognito authentication for OpenSearch Dashboards. See [Amazon Cognito authentication for OpenSearch Dashboards](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cognito-auth.html) .
        :param pulumi.Input[builtins.str] identity_pool_id: The Amazon Cognito identity pool ID that you want OpenSearch Service to use for OpenSearch Dashboards authentication.
               
               Required if you enabled Cognito Authentication for OpenSearch Dashboards.
        :param pulumi.Input[builtins.str] role_arn: The `AmazonOpenSearchServiceCognitoAccess` role that allows OpenSearch Service to configure your user pool and identity pool.
               
               Required if you enabled Cognito Authentication for OpenSearch Dashboards.
        :param pulumi.Input[builtins.str] user_pool_id: The Amazon Cognito user pool ID that you want OpenSearch Service to use for OpenSearch Dashboards authentication.
...
class DomainColdStorageOptionsArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable or disable cold storage on the domain. You must enable UltraWarm storage to enable cold storage.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class DomainEbsOptionsArgsDict(TypedDict):
        ebs_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainEbsOptionsArgs:
    def __init__(__self__, *,
                 ebs_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] ebs_enabled: Specifies whether Amazon EBS volumes are attached to data nodes in the OpenSearch Service domain.
        :param pulumi.Input[builtins.int] iops: The number of I/O operations per second (IOPS) that the volume supports. This property applies only to the `gp3` and provisioned IOPS EBS volume types.
        :param pulumi.Input[builtins.int] throughput: The throughput (in MiB/s) of the EBS volumes attached to data nodes. Applies only to the `gp3` volume type.
        :param pulumi.Input[builtins.int] volume_size: The size (in GiB) of the EBS volume for each data node. The minimum and maximum size of an EBS volume depends on the EBS volume type and the instance type to which it is attached. For more information, see [EBS volume size limits](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html#ebsresource) in the *Amazon OpenSearch Service Developer Guide* .
        :param pulumi.Input[builtins.str] volume_type: The EBS volume type to use with the OpenSearch Service domain. If you choose `gp3` , you must also specify values for `Iops` and `Throughput` . For more information about each type, see [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html) in the *Amazon EC2 User Guide for Linux Instances* .
        """
    ...
    def ebs_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether Amazon EBS volumes are attached to data nodes in the OpenSearch Service domain.
        """
    ...
    @ebs_enabled.setter
    def ebs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainEncryptionAtRestOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specify `true` to enable encryption at rest. Required if you enable fine-grained access control in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
               
               If no encryption at rest options were initially specified in the template, updating this property by adding it causes no interruption. However, if you change this property after it's already been set within a template, the domain is deleted and recreated in order to modify the property.
        :param pulumi.Input[builtins.str] kms_key_id: The KMS key ID. Takes the form `1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a` . Required if you enable encryption at rest.
...
class DomainEndpointOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] custom_endpoint: The fully qualified URL for your custom endpoint. Required if you enabled a custom endpoint for the domain.
        :param pulumi.Input[builtins.str] custom_endpoint_certificate_arn: The AWS Certificate Manager ARN for your domain's SSL/TLS certificate. Required if you enabled a custom endpoint for the domain.
        :param pulumi.Input[builtins.bool] custom_endpoint_enabled: True to enable a custom endpoint for the domain. If enabled, you must also provide values for `CustomEndpoint` and `CustomEndpointCertificateArn` .
        :param pulumi.Input[builtins.bool] enforce_https: True to require that all traffic to the domain arrive over HTTPS. Required if you enable fine-grained access control in [AdvancedSecurityOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
        :param pulumi.Input[builtins.str] tls_security_policy: The minimum TLS version required for traffic to the domain. The policy can be one of the following values:
...
if not MYPY:
    class DomainIdentityCenterOptionsArgsDict(TypedDict):
        ...
        """
        enabled_api_access: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether Identity Center is enabled.
        """
        identity_center_application_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        identity_store_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DomainIdentityCenterOptionsArgs:
    def __init__(__self__, *,
                 enabled_api_access: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        Options for configuring Identity Center
        :param pulumi.Input[builtins.bool] enabled_api_access: Whether Identity Center is enabled.
        :param pulumi.Input[builtins.str] identity_center_application_arn: The ARN of the Identity Center application.
        :param pulumi.Input[builtins.str] identity_center_instance_arn: The ARN of the Identity Center instance.
        :param pulumi.Input[builtins.str] identity_store_id: The IdentityStoreId for Identity Center options.
    ...
    def enabled_api_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether Identity Center is enabled.
        """
    ...
    def enabled_api_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainIdpArgs:
    def __init__(__self__, *,
                 ...
                 metadata_content: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] entity_id: The unique entity ID of the application in the SAML identity provider.
...
if not MYPY:
    class DomainLogPublishingOptionArgsDict(TypedDict):
        cloud_watch_logs_log_group_arn: NotRequired[pulumi.Input[builtins.str]]
        enabled: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class DomainMasterUserOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] master_user_arn: Amazon Resource Name (ARN) for the master user. The ARN can point to an IAM user or role. This property is required for Amazon Cognito to work, and it must match the role configured for Cognito. Only specify if `InternalUserDatabaseEnabled` is false in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
        :param pulumi.Input[builtins.str] master_user_name: Username for the master user. Only specify if `InternalUserDatabaseEnabled` is true in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
               
               If you don't want to specify this value directly within the template, you can use a [dynamic reference](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html) instead.
        :param pulumi.Input[builtins.str] master_user_password: Password for the master user. Only specify if `InternalUserDatabaseEnabled` is true in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
...
class DomainNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] count: The number of nodes of a specific type within the cluster.
        :param pulumi.Input[builtins.bool] enabled: A boolean value indicating whether a specific node type is active or inactive.
        :param pulumi.Input[builtins.str] type: The instance type of a particular node within the cluster.
        """
...
class DomainOffPeakWindowOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether off-peak window settings are enabled for the domain.
...
class DomainSamlOptionsArgs:
    def __init__(__self__, *,
                 ...
                 subject_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: True to enable SAML authentication for a domain.
        :param pulumi.Input['DomainIdpArgs'] idp: The SAML Identity Provider's information.
        :param pulumi.Input[builtins.str] master_backend_role: The backend role that the SAML master user is mapped to.
        :param pulumi.Input[builtins.str] master_user_name: The SAML master user name, which is stored in the domain's internal user database.
        :param pulumi.Input[builtins.str] roles_key: Element of the SAML assertion to use for backend roles. Default is `roles` .
        :param pulumi.Input[builtins.int] session_timeout_minutes: The duration, in minutes, after which a user session becomes inactive. Acceptable values are between 1 and 1440, and the default value is 60.
        :param pulumi.Input[builtins.str] subject_key: Element of the SAML assertion to use for the user name. Default is `NameID` .
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if idp is not None:
...
if not MYPY:
    class DomainSnapshotOptionsArgsDict(TypedDict):
        automated_snapshot_start_hour: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DomainSnapshotOptionsArgs:
    ...
    def automated_snapshot_start_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The hour in UTC during which the service takes an automated daily snapshot of the indexes in the OpenSearch Service domain. For example, if you specify 0, OpenSearch Service takes an automated snapshot everyday between midnight and 1 am. You can specify a value between 0 and 23.
        """
    ...
    def automated_snapshot_start_hour(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DomainSoftwareUpdateOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] auto_software_update_enabled: Specifies whether automatic service software updates are enabled for the domain.
        """
...
class DomainWindowStartTimeArgs:
    def __init__(__self__, *,
                 ...
                 minutes: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] hours: The start hour of the window in Coordinated Universal Time (UTC), using 24-hour time. For example, 17 refers to 5:00 P.M. UTC. The minimum value is 0 and the maximum value is 23.
        :param pulumi.Input[builtins.int] minutes: The start minute of the window, in UTC. The minimum value is 0 and the maximum value is 59.
        """
...
class DomainZoneAwarenessConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] availability_zone_count: If you enabled multiple Availability Zones (AZs), the number of AZs that you want the domain to use.
...
if not MYPY:
    class IamIdentityCenterOptionsPropertiesArgsDict(TypedDict):
        ...
        """
        iam_role_for_identity_center_application_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IamIdentityCenterOptionsPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 iam_role_for_identity_center_application_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Options for configuring IAM Identity Center
        :param pulumi.Input[builtins.bool] enabled: Whether IAM Identity Center is enabled.
        :param Any iam_identity_center_instance_arn: The ARN of the IAM Identity Center instance.
        :param pulumi.Input[builtins.str] iam_role_for_identity_center_application_arn: The ARN of the IAM role for Identity Center application.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def iam_role_for_identity_center_application_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the IAM role for Identity Center application.
        """
    ...
    def iam_role_for_identity_center_application_arn(self, value: Optional[pulumi.Input[builtins.str]]):
