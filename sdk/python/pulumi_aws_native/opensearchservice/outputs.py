...
class DomainNodeConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The number of nodes of a particular node type in the cluster.
        :param builtins.bool enabled: A boolean that indicates whether a particular node type is enabled or not.
