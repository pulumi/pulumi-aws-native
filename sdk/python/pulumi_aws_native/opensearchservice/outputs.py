...
class ApplicationAppConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: The configuration value.
        """
...
class ApplicationDataSource(dict):
    ...
    def __init__(__self__, *,
                 data_source_arn: Any,
                 data_source_description: Optional[builtins.str] = None):
        """
        Datasource arn and description
        :param Any data_source_arn: The ARN of the data source.
        :param builtins.str data_source_description: Description of the data source.
        """
    ...
    def data_source_description(self) -> Optional[builtins.str]:
        """
...
class DomainAdvancedSecurityOptionsInput(dict):
    ...
    def anonymous_auth_disable_date(self) -> Optional[builtins.str]:
        """
...
class DomainClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int dedicated_master_count: The number of instances to use for the master node. If you specify this property, you must specify `true` for the `DedicatedMasterEnabled` property.
        :param builtins.bool dedicated_master_enabled: Indicates whether to use a dedicated master node for the OpenSearch Service domain. A dedicated master node is a cluster node that performs cluster management tasks, but doesn't hold data or respond to data upload requests. Dedicated master nodes offload cluster management tasks to increase the stability of your search clusters. See [Dedicated master nodes in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-dedicatedmasternodes.html) .
        :param builtins.str dedicated_master_type: The hardware configuration of the computer that hosts the dedicated master node, such as `m3.medium.search` . If you specify this property, you must specify `true` for the `DedicatedMasterEnabled` property. For valid values, see [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html) .
        :param builtins.int instance_count: The number of data nodes (instances) to use in the OpenSearch Service domain.
        :param builtins.str instance_type: The instance type for your data nodes, such as `m3.medium.search` . For valid values, see [Supported instance types in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html) .
        :param builtins.bool multi_az_with_standby_enabled: Indicates whether Multi-AZ with Standby deployment option is enabled. For more information, see [Multi-AZ with Standby](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html#managedomains-za-standby) .
        ...
        :param builtins.bool warm_enabled: Whether to enable UltraWarm storage for the cluster. See [UltraWarm storage for Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ultrawarm.html) .
        :param builtins.str warm_type: The instance type for the cluster's warm nodes.
        ...
        :param builtins.bool zone_awareness_enabled: Indicates whether to enable zone awareness for the OpenSearch Service domain. When you enable zone awareness, OpenSearch Service allocates the nodes and replica index shards that belong to a cluster across two Availability Zones (AZs) in the same region to prevent data loss and minimize downtime in the event of node or data center failure. Don't enable zone awareness if your cluster has no replica index shards or is a single-node cluster. For more information, see [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html) .
        """
...
class DomainCognitoOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether to enable or disable Amazon Cognito authentication for OpenSearch Dashboards. See [Amazon Cognito authentication for OpenSearch Dashboards](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/cognito-auth.html) .
        :param builtins.str identity_pool_id: The Amazon Cognito identity pool ID that you want OpenSearch Service to use for OpenSearch Dashboards authentication.
               
               Required if you enabled Cognito Authentication for OpenSearch Dashboards.
        :param builtins.str role_arn: The `AmazonOpenSearchServiceCognitoAccess` role that allows OpenSearch Service to configure your user pool and identity pool.
               
               Required if you enabled Cognito Authentication for OpenSearch Dashboards.
        :param builtins.str user_pool_id: The Amazon Cognito user pool ID that you want OpenSearch Service to use for OpenSearch Dashboards authentication.
...
class DomainColdStorageOptions(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Whether to enable or disable cold storage on the domain. You must enable UltraWarm storage to enable cold storage.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class DomainEbsOptions(dict):
    ...
    def __init__(__self__, *,
                 ebs_enabled: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool ebs_enabled: Specifies whether Amazon EBS volumes are attached to data nodes in the OpenSearch Service domain.
        :param builtins.int iops: The number of I/O operations per second (IOPS) that the volume supports. This property applies only to the `gp3` and provisioned IOPS EBS volume types.
        :param builtins.int throughput: The throughput (in MiB/s) of the EBS volumes attached to data nodes. Applies only to the `gp3` volume type.
        :param builtins.int volume_size: The size (in GiB) of the EBS volume for each data node. The minimum and maximum size of an EBS volume depends on the EBS volume type and the instance type to which it is attached. For more information, see [EBS volume size limits](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/limits.html#ebsresource) in the *Amazon OpenSearch Service Developer Guide* .
        :param builtins.str volume_type: The EBS volume type to use with the OpenSearch Service domain. If you choose `gp3` , you must also specify values for `Iops` and `Throughput` . For more information about each type, see [Amazon EBS volume types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html) in the *Amazon EC2 User Guide for Linux Instances* .
        """
    ...
    def ebs_enabled(self) -> Optional[builtins.bool]:
        """
...
class DomainEncryptionAtRestOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Specify `true` to enable encryption at rest. Required if you enable fine-grained access control in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
               
               If no encryption at rest options were initially specified in the template, updating this property by adding it causes no interruption. However, if you change this property after it's already been set within a template, the domain is deleted and recreated in order to modify the property.
        :param builtins.str kms_key_id: The KMS key ID. Takes the form `1a2a3a4-1a2a-3a4a-5a6a-1a2a3a4a5a6a` . Required if you enable encryption at rest.
...
class DomainIdentityCenterOptions(dict):
    ...
    def __init__(__self__, *,
                 enabled_api_access: Optional[builtins.bool] = None,
                 identity_center_application_arn: Optional[builtins.str] = None,
        ...
        """
        Options for configuring Identity Center
        :param builtins.bool enabled_api_access: Whether Identity Center is enabled.
        :param builtins.str identity_center_application_arn: The ARN of the Identity Center application.
        :param builtins.str identity_center_instance_arn: The ARN of the Identity Center instance.
        :param builtins.str identity_store_id: The IdentityStoreId for Identity Center options.
    ...
    def enabled_api_access(self) -> Optional[builtins.bool]:
        """
...
class DomainIdp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_id: The unique entity ID of the application in the SAML identity provider.
...
class DomainLogPublishingOption(dict):
    ...
    def __init__(__self__, *,
                 cloud_watch_logs_log_group_arn: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None):
...
class DomainMasterUserOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str master_user_arn: Amazon Resource Name (ARN) for the master user. The ARN can point to an IAM user or role. This property is required for Amazon Cognito to work, and it must match the role configured for Cognito. Only specify if `InternalUserDatabaseEnabled` is false in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
        :param builtins.str master_user_name: Username for the master user. Only specify if `InternalUserDatabaseEnabled` is true in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
        ...
        :param builtins.str master_user_password: Password for the master user. Only specify if `InternalUserDatabaseEnabled` is true in [AdvancedSecurityOptionsInput](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html) .
...
class DomainNodeConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The number of nodes of a specific type within the cluster.
        :param builtins.bool enabled: A boolean value indicating whether a specific node type is active or inactive.
        :param builtins.str type: The instance type of a particular node within the cluster.
        """
...
class DomainOffPeakWindowOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Specifies whether off-peak window settings are enabled for the domain.
...
class DomainSamlOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subject_key: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: True to enable SAML authentication for a domain.
        :param 'DomainIdp' idp: The SAML Identity Provider's information.
        :param builtins.str master_backend_role: The backend role that the SAML master user is mapped to.
        :param builtins.str master_user_name: The SAML master user name, which is stored in the domain's internal user database.
        :param builtins.str roles_key: Element of the SAML assertion to use for backend roles. Default is `roles` .
        :param builtins.int session_timeout_minutes: The duration, in minutes, after which a user session becomes inactive. Acceptable values are between 1 and 1440, and the default value is 60.
        :param builtins.str subject_key: Element of the SAML assertion to use for the user name. Default is `NameID` .
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if idp is not None:
...
class DomainServiceSoftwareOptions(dict):
    ...
    def __init__(__self__, *,
                 automated_update_date: Optional[builtins.str] = None,
                 cancellable: Optional[builtins.bool] = None,
                 current_version: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 new_version: Optional[builtins.str] = None,
                 optional_deployment: Optional[builtins.bool] = None,
                 update_available: Optional[builtins.bool] = None,
                 update_status: Optional[builtins.str] = None):
        """
        :param builtins.str automated_update_date: The timestamp, in Epoch time, until which you can manually request a service software update. After this date, we automatically update your service software.
        :param builtins.bool cancellable: True if you're able to cancel your service software version update. False if you can't cancel your service software update.
        :param builtins.str current_version: The current service software version present on the domain.
        :param builtins.str description: A description of the service software update status.
        :param builtins.str new_version: The new service software version, if one is available.
        :param builtins.bool optional_deployment: True if a service software is never automatically updated. False if a service software is automatically updated after the automated update date.
        :param builtins.bool update_available: True if you're able to update your service software version. False if you can't update your service software version.
        :param builtins.str update_status: The status of your service software update.
        """
    ...
    def automated_update_date(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def cancellable(self) -> Optional[builtins.bool]:
        """
    ...
    def new_version(self) -> Optional[builtins.str]:
        """
    ...
    def optional_deployment(self) -> Optional[builtins.bool]:
        """
    ...
    def update_available(self) -> Optional[builtins.bool]:
        """
...
class DomainSnapshotOptions(dict):
    ...
    def automated_snapshot_start_hour(self) -> Optional[builtins.int]:
        """
...
class DomainSoftwareUpdateOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool auto_software_update_enabled: Specifies whether automatic service software updates are enabled for the domain.
        """
...
class DomainWindowStartTime(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int hours: The start hour of the window in Coordinated Universal Time (UTC), using 24-hour time. For example, 17 refers to 5:00 P.M. UTC. The minimum value is 0 and the maximum value is 23.
        :param builtins.int minutes: The start minute of the window, in UTC. The minimum value is 0 and the maximum value is 59.
        """
...
class DomainZoneAwarenessConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int availability_zone_count: If you enabled multiple Availability Zones (AZs), the number of AZs that you want the domain to use.
...
class IamIdentityCenterOptionsProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 iam_role_for_identity_center_application_arn: Optional[builtins.str] = None):
        """
        Options for configuring IAM Identity Center
        :param builtins.bool enabled: Whether IAM Identity Center is enabled.
        :param Any iam_identity_center_instance_arn: The ARN of the IAM Identity Center instance.
        :param builtins.str iam_role_for_identity_center_application_arn: The ARN of the IAM role for Identity Center application.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def iam_role_for_identity_center_application_arn(self) -> Optional[builtins.str]:
        """
