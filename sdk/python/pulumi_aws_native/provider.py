...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 s3_force_path_style: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 skip_get_ec2_platforms: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_account_ids: List of allowed AWS account IDs to prevent you from mistakenly using an incorrect one. Conflicts with `forbiddenAccountIds`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] forbidden_account_ids: List of forbidden AWS account IDs to prevent you from mistakenly using the wrong one (and potentially end up destroying a live environment). Conflicts with `allowedAccountIds`.
        ...
        :param pulumi.Input[builtins.str] shared_credentials_file: The path to the shared credentials file. If not set this defaults to `~/.aws/credentials`.
        :param pulumi.Input[builtins.bool] skip_credentials_validation: Skip the credentials validation via STS API. Used for AWS API implementations that do not have STS available/implemented.
        :param pulumi.Input[builtins.bool] skip_get_ec2_platforms: Skip getting the supported EC2 platforms. Used by users that don't have `ec2:DescribeAccountAttributes` permissions.
        :param pulumi.Input[builtins.bool] skip_metadata_api_check: Skip the AWS Metadata API check. Useful for AWS API implementations that do not have a metadata API endpoint. Setting to true prevents Pulumi from authenticating via the Metadata API. You may need to use other authentication methods like static credentials, configuration variables, or environment variables.
        :param pulumi.Input[builtins.bool] skip_region_validation: Skip static validation of region name. Used by users of alternative AWS-like APIs or users with access to regions that are not public.
        ...
        :param pulumi.Input[builtins.str] token: Session token for validating temporary credentials. Typically provided after successful identity federation or Multi-Factor Authentication (MFA) login. With MFA login, this is the session token provided afterward, not the 6 digit MFA code used to get temporary credentials.
        """
        if region is None:
    ...
    def s3_force_path_style(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def s3_force_path_style(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def skip_get_ec2_platforms(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_get_ec2_platforms(self, value: Optional[pulumi.Input[builtins.bool]]):
