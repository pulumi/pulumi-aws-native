...
class DetectorModelArgs:
    def __init__(__self__, *,
                 ...
                 detector_model_description: Optional[pulumi.Input[builtins.str]] = None,
                 detector_model_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] role_arn: The ARN of the role that grants permission to ITE to perform its operations.
        :param pulumi.Input[builtins.str] detector_model_description: A brief description of the detector model.
        :param pulumi.Input[builtins.str] detector_model_name: The name of the detector model.
        ...
        :param pulumi.Input[builtins.str] key: The value used to identify a detector instance. When a device or system sends input, a new detector instance with a unique key value is created. ITE can continue to route input to its corresponding detector instance based on this identifying information. 
    ...
    def detector_model_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def detector_model_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "detector_model_description", value)

    @property
    @pulumi.getter(name="detectorModelName")
    def detector_model_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def detector_model_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DetectorModel(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="detectorModelDescription")
    def detector_model_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A brief description of the detector model.
        """
        return pulumi.get(self, "detector_model_description")
    ...
    @property
    @pulumi.getter(name="detectorModelName")
    def detector_model_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the detector model.
        """
        return pulumi.get(self, "detector_model_name")
