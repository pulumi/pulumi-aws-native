...
warnings.warn("""AlarmModel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class AlarmModel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AlarmModelTagArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AlarmModel is deprecated: AlarmModel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
