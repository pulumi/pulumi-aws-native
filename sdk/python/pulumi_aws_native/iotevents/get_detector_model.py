...
class GetDetectorModelResult:
    ...
    def detector_model_description(self) -> Optional[_builtins.str]:
        """
...
def get_detector_model(detector_model_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str detector_model_name: The name of the detector model.
    """
    __args__ = dict()
...
def get_detector_model_output(detector_model_name: Optional[pulumi.Input[_builtins.str]] = None,
