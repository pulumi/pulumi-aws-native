...
class GetAlarmModelResult:
    ...
    def alarm_model_description(self) -> Optional[builtins.str]:
        """
...
def get_alarm_model(alarm_model_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alarm_model_name: The name of the alarm model.
    """
    __args__ = dict()
...
def get_alarm_model_output(alarm_model_name: Optional[pulumi.Input[builtins.str]] = None,
