...
class AlarmModelAssetPropertyTimestampArgs:
    def __init__(__self__, *,
        ...
        A structure that contains timestamp information. For more information, see [TimeInNanos](https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_TimeInNanos.html) in the *API Reference*.
         ...
         For more information, see [Expressions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-expressions.html) in the *Developer Guide*.
        :param pulumi.Input[builtins.str] time_in_seconds: The timestamp, in seconds, in the Unix epoch format. The valid range is between 1-31556889864403199.
        :param pulumi.Input[builtins.str] offset_in_nanos: The nanosecond offset converted from ``timeInSeconds``. The valid range is between 0-999999999.
        """
...
class AlarmModelAssetPropertyValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] quality: The quality of the asset property value. The value must be ``'GOOD'``, ``'BAD'``, or ``'UNCERTAIN'``.
...
class AlarmModelAssetPropertyVariantArgs:
    def __init__(__self__, *,
        ...
        A structure that contains an asset property value. For more information, see [Variant](https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_Variant.html) in the *API Reference*.
         ...
         For more information, see [Expressions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-expressions.html) in the *Developer Guide*.
         You must specify one of the following value types, depending on the ``dataType`` of the specified asset property. For more information, see [AssetProperty](https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_AssetProperty.html) in the *API Reference*.
        :param pulumi.Input[builtins.str] boolean_value: The asset property value is a Boolean value that must be ``'TRUE'`` or ``'FALSE'``. You must use an expression, and the evaluated result should be a Boolean value.
        :param pulumi.Input[builtins.str] double_value: The asset property value is a double. You must use an expression, and the evaluated result should be a double.
        :param pulumi.Input[builtins.str] integer_value: The asset property value is an integer. You must use an expression, and the evaluated result should be an integer.
        :param pulumi.Input[builtins.str] string_value: The asset property value is a string. You must use an expression, and the evaluated result should be a string.
        """
...
class AlarmModelDynamoDbArgs:
    def __init__(__self__, *,
        ...
        Defines an action to write to the Amazon DynamoDB table that you created. The standard action payload contains all the information about the detector model instance and the event that triggered the action. You can customize the [payload](https://docs.aws.amazon.com/iotevents/latest/apireference/API_Payload.html). One column of the DynamoDB table receives all attribute-value pairs in the payload that you specify.
         ...
         For more information, see [Expressions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-expressions.html) in the *Developer Guide*.
         If the defined payload type is a string, ``DynamoDBAction`` writes non-JSON data to the DynamoDB table as binary data. The DynamoDB console displays the data as Base64-encoded text. The value for the ``payloadField`` parameter is ``<payload-field>_raw``.
        :param pulumi.Input[builtins.str] hash_key_field: The name of the hash key (also called the partition key). The ``hashKeyField`` value must match the partition key of the target DynamoDB table.
        :param pulumi.Input[builtins.str] hash_key_value: The value of the hash key (also called the partition key).
        :param pulumi.Input[builtins.str] table_name: The name of the DynamoDB table. The ``tableName`` value must match the table name of the target DynamoDB table.
        :param pulumi.Input[builtins.str] hash_key_type: The data type for the hash key (also called the partition key). You can specify the following values:
                 +   ``'STRING'`` - The hash key is a string.
                 +   ``'NUMBER'`` - The hash key is a number.
                 
                If you don't specify ``hashKeyType``, the default value is ``'STRING'``.
        :param pulumi.Input[builtins.str] operation: The type of operation to perform. You can specify the following values: 
                 +   ``'INSERT'`` - Insert data as a new item into the DynamoDB table. This item uses the specified hash key as a partition key. If you specified a range key, the item uses the range key as a sort key.
                 +   ``'UPDATE'`` - Update an existing item of the DynamoDB table with new data. This item's partition key must match the specified hash key. If you specified a range key, the range key must match the item's sort key.
                 +   ``'DELETE'`` - Delete an existing item of the DynamoDB table. This item's partition key must match the specified hash key. If you specified a range key, the range key must match the item's sort key.
        ...
        :param pulumi.Input['AlarmModelPayloadArgs'] payload: Information needed to configure the payload.
                By default, ITE generates a standard payload in JSON for any action. This action payload contains all attribute-value pairs that have the information about the detector model instance and the event triggered the action. To configure the action payload, you can use ``contentExpression``.
        :param pulumi.Input[builtins.str] payload_field: The name of the DynamoDB column that receives the action payload.
                If you don't specify this parameter, the name of the DynamoDB column is ``payload``.
        :param pulumi.Input[builtins.str] range_key_field: The name of the range key (also called the sort key). The ``rangeKeyField`` value must match the sort key of the target DynamoDB table.
        :param pulumi.Input[builtins.str] range_key_type: The data type for the range key (also called the sort key), You can specify the following values:
                 +   ``'STRING'`` - The range key is a string.
                 +   ``'NUMBER'`` - The range key is number.
                 
                If you don't specify ``rangeKeyField``, the default value is ``'STRING'``.
        :param pulumi.Input[builtins.str] range_key_value: The value of the range key (also called the sort key).
        """
...
class AlarmModelFirehoseArgs:
    def __init__(__self__, *,
        ...
        """
        Sends information about the detector model instance and the event that triggered the action to an Amazon Kinesis Data Firehose delivery stream.
        :param pulumi.Input[builtins.str] delivery_stream_name: The name of the Kinesis Data Firehose delivery stream where the data is written.
        ...
        :param pulumi.Input[builtins.str] separator: A character separator that is used to separate records written to the Kinesis Data Firehose delivery stream. Valid values are: '\\n' (newline), '\\t' (tab), '\\r\\n' (Windows newline), ',' (comma).
        """
...
if not MYPY:
    class AlarmModelInitializationConfigurationArgsDict(TypedDict):
        ...
        Specifies the default alarm state. The configuration applies to all alarms that were created based on this alarm model.
        """
        disabled_on_initialization: pulumi.Input[builtins.bool]
        """
...
class AlarmModelInitializationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the default alarm state. The configuration applies to all alarms that were created based on this alarm model.
        :param pulumi.Input[builtins.bool] disabled_on_initialization: The value must be ``TRUE`` or ``FALSE``. If ``FALSE``, all alarm instances created based on the alarm model are activated. The default value is ``TRUE``.
        """
        pulumi.set(__self__, "disabled_on_initialization", disabled_on_initialization)

    @property
    @pulumi.getter(name="disabledOnInitialization")
    def disabled_on_initialization(self) -> pulumi.Input[builtins.bool]:
        """
        The value must be ``TRUE`` or ``FALSE``. If ``FALSE``, all alarm instances created based on the alarm model are activated. The default value is ``TRUE``.
        """
    ...
    def disabled_on_initialization(self, value: pulumi.Input[builtins.bool]):
...
class AlarmModelIotEventsArgs:
    def __init__(__self__, *,
        ...
        """
        Sends an ITE input, passing in information about the detector model instance and the event that triggered the action.
        :param pulumi.Input[builtins.str] input_name: The name of the ITE input where the data is sent.
...
class AlarmModelIotSiteWiseArgs:
    def __init__(__self__, *,
        ...
        Sends information about the detector model instance and the event that triggered the action to a specified asset property in ITSW.
         ...
         You must specify either ``propertyAlias`` or both ``assetId`` and ``propertyId`` to identify the target asset property in ITSW.
         For more information, see [Expressions](https://docs.aws.amazon.com/iotevents/latest/developerguide/iotevents-expressions.html) in the *Developer Guide*.
        :param pulumi.Input[builtins.str] asset_id: The ID of the asset that has the specified property.
        :param pulumi.Input[builtins.str] entry_id: A unique identifier for this entry. You can use the entry ID to track which data entry causes an error in case of failure. The default is a new unique identifier.
        :param pulumi.Input[builtins.str] property_alias: The alias of the asset property.
        :param pulumi.Input[builtins.str] property_id: The ID of the asset property.
...
class AlarmModelIotTopicPublishArgs:
    def __init__(__self__, *,
        ...
        """
        Information required to publish the MQTT message through the IoT message broker.
        :param pulumi.Input[builtins.str] mqtt_topic: The MQTT topic of the message. You can use a string expression that includes variables (``$variable.<variable-name>``) and input values (``$input.<input-name>.<path-to-datum>``) as the topic string.
...
class AlarmModelLambdaArgs:
    def __init__(__self__, *,
        ...
        """
        Calls a Lambda function, passing in information about the detector model instance and the event that triggered the action.
        :param pulumi.Input[builtins.str] function_arn: The ARN of the Lambda function that is executed.
...
if not MYPY:
    class AlarmModelPayloadArgsDict(TypedDict):
        ...
        Information needed to configure the payload.
         By default, ITE generates a standard payload in JSON for any action. This action payload contains all attribute-value pairs that have the information about the detector model instance and the event triggered the action. To configure the action payload, you can use ``contentExpression``.
        """
        content_expression: pulumi.Input[builtins.str]
        """
...
class AlarmModelPayloadArgs:
    def __init__(__self__, *,
        ...
        Information needed to configure the payload.
         By default, ITE generates a standard payload in JSON for any action. This action payload contains all attribute-value pairs that have the information about the detector model instance and the event triggered the action. To configure the action payload, you can use ``contentExpression``.
        :param pulumi.Input[builtins.str] content_expression: The content of the payload. You can use a string expression that includes quoted strings (``'<string>'``), variables (``$variable.<variable-name>``), input values (``$input.<input-name>.<path-to-datum>``), string concatenations, and quoted strings that contain ``${}`` as the content. The recommended maximum size of a content expression is 1 KB.
        :param pulumi.Input[builtins.str] type: The value of the payload type can be either ``STRING`` or ``JSON``.
        """
    ...
    def content_expression(self) -> pulumi.Input[builtins.str]:
        """
        The content of the payload. You can use a string expression that includes quoted strings (``'<string>'``), variables (``$variable.<variable-name>``), input values (``$input.<input-name>.<path-to-datum>``), string concatenations, and quoted strings that contain ``${}`` as the content. The recommended maximum size of a content expression is 1 KB.
        """
    ...
    def content_expression(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AlarmModelSimpleRuleArgsDict(TypedDict):
        ...
        """
        input_property: pulumi.Input[builtins.str]
        """
...
class AlarmModelSimpleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] input_property: The value on the left side of the comparison operator. You can specify an ITE input attribute as an input property.
        :param pulumi.Input[builtins.str] threshold: The value on the right side of the comparison operator. You can enter a number or specify an ITE input attribute.
        """
    ...
    def input_property(self) -> pulumi.Input[builtins.str]:
        """
        The value on the left side of the comparison operator. You can specify an ITE input attribute as an input property.
        """
    ...
    def input_property(self, value: pulumi.Input[builtins.str]):
...
class AlarmModelSnsArgs:
    def __init__(__self__, *,
        ...
        """
        Information required to publish the Amazon SNS message.
        :param pulumi.Input[builtins.str] target_arn: The ARN of the Amazon SNS target where the message is sent.
...
class AlarmModelSqsArgs:
    def __init__(__self__, *,
        ...
        """
        Sends information about the detector model instance and the event that triggered the action to an Amazon SQS queue.
        :param pulumi.Input[builtins.str] queue_url: The URL of the SQS queue where the data is written.
        ...
        :param pulumi.Input[builtins.bool] use_base64: Set this to TRUE if you want the data to be base-64 encoded before it is written to the queue. Otherwise, set this to FALSE.
        """
...
if not MYPY:
    class DetectorModelClearTimerArgsDict(TypedDict):
        ...
        Information needed to clear the timer.
        """
        timer_name: pulumi.Input[builtins.str]
        """
...
class DetectorModelClearTimerArgs:
    def __init__(__self__, *,
        ...
        """
        Information needed to clear the timer.
        :param pulumi.Input[builtins.str] timer_name: The name of the timer to clear.
        """
        pulumi.set(__self__, "timer_name", timer_name)

    @property
    @pulumi.getter(name="timerName")
    def timer_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the timer to clear.
        """
    ...
    @timer_name.setter
    def timer_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DetectorModelDefinitionArgsDict(TypedDict):
        ...
        """
        initial_state_name: pulumi.Input[builtins.str]
        """
...
class DetectorModelDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        Information that defines how a detector operates.
        :param pulumi.Input[builtins.str] initial_state_name: The state that is entered at the creation of each detector (instance).
    ...
    def initial_state_name(self) -> pulumi.Input[builtins.str]:
        """
        The state that is entered at the creation of each detector (instance).
        """
    ...
    def initial_state_name(self, value: pulumi.Input[builtins.str]):
...
class DetectorModelEventArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the ``actions`` to be performed when the ``condition`` evaluates to TRUE.
        :param pulumi.Input[builtins.str] event_name: The name of the event.
        :param pulumi.Input[Sequence[pulumi.Input['DetectorModelActionArgs']]] actions: The actions to be performed.
        :param pulumi.Input[builtins.str] condition: Optional. The Boolean expression that, when TRUE, causes the ``actions`` to be performed. If not present, the actions are performed (=TRUE). If the expression result is not a Boolean value, the actions are not performed (=FALSE).
        """
...
class DetectorModelResetTimerArgs:
    def __init__(__self__, *,
        ...
        """
        Information required to reset the timer. The timer is reset to the previously evaluated result of the duration. The duration expression isn't reevaluated when you reset the timer.
        :param pulumi.Input[builtins.str] timer_name: The name of the timer to reset.
        """
        pulumi.set(__self__, "timer_name", timer_name)
...
if not MYPY:
    class DetectorModelSetTimerArgsDict(TypedDict):
        ...
        """
        duration_expression: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DetectorModelSetTimerArgs:
    def __init__(__self__, *,
                 timer_name: pulumi.Input[builtins.str],
                 duration_expression: Optional[pulumi.Input[builtins.str]] = None,
                 seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        Information needed to set the timer.
        :param pulumi.Input[builtins.str] timer_name: The name of the timer.
        :param pulumi.Input[builtins.str] duration_expression: The duration of the timer, in seconds. You can use a string expression that includes numbers, variables (``$variable.<variable-name>``), and input values (``$input.<input-name>.<path-to-datum>``) as the duration. The range of the duration is 1-31622400 seconds. To ensure accuracy, the minimum duration is 60 seconds. The evaluated result of the duration is rounded down to the nearest whole number.
        :param pulumi.Input[builtins.int] seconds: The number of seconds until the timer expires. The minimum value is 60 seconds to ensure accuracy. The maximum value is 31622400 seconds.
        """
        pulumi.set(__self__, "timer_name", timer_name)
    ...
    def duration_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration of the timer, in seconds. You can use a string expression that includes numbers, variables (``$variable.<variable-name>``), and input values (``$input.<input-name>.<path-to-datum>``) as the duration. The range of the duration is 1-31622400 seconds. To ensure accuracy, the minimum duration is 60 seconds. The evaluated result of the duration is rounded down to the nearest whole number.
        """
    ...
    def duration_expression(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DetectorModelSetVariableArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the variable and its new value.
        :param pulumi.Input[builtins.str] value: The new value of the variable.
...
if not MYPY:
    class DetectorModelStateArgsDict(TypedDict):
        ...
        """
        state_name: pulumi.Input[builtins.str]
        """
...
class DetectorModelStateArgs:
    def __init__(__self__, *,
        ...
        """
        Information that defines a state of a detector.
        :param pulumi.Input[builtins.str] state_name: The name of the state.
    ...
    def state_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the state.
        """
    ...
    @state_name.setter
    def state_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DetectorModelTransitionEventArgsDict(TypedDict):
        ...
        """
        next_state: pulumi.Input[builtins.str]
        """
...
class DetectorModelTransitionEventArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the actions performed and the next state entered when a ``condition`` evaluates to TRUE.
        :param pulumi.Input[builtins.str] condition: Required. A Boolean expression that when TRUE causes the actions to be performed and the ``nextState`` to be entered.
        :param pulumi.Input[builtins.str] event_name: The name of the transition event.
        :param pulumi.Input[builtins.str] next_state: The next state to enter.
        :param pulumi.Input[Sequence[pulumi.Input['DetectorModelActionArgs']]] actions: The actions to be performed.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "event_name", event_name)
    ...
    def next_state(self) -> pulumi.Input[builtins.str]:
        """
        The next state to enter.
        """
    ...
    @next_state.setter
    def next_state(self, value: pulumi.Input[builtins.str]):
...
class InputAttributeArgs:
    def __init__(__self__, *,
        ...
        """
        The attributes from the JSON payload that are made available by the input. Inputs are derived from messages sent to the ITE system using ``BatchPutMessage``. Each such message contains a JSON payload. Those attributes (and their paired values) specified here are available for use in the ``condition`` expressions used by detectors.
        :param pulumi.Input[builtins.str] json_path: An expression that specifies an attribute-value pair in a JSON structure. Use this to specify an attribute from the JSON payload that is made available by the input. Inputs are derived from messages sent to ITE (``BatchPutMessage``). Each such message contains a JSON payload. The attribute (and its paired value) specified here are available for use in the ``condition`` expressions used by detectors. 
                Syntax: ``<field-name>.<field-name>...``
        """
