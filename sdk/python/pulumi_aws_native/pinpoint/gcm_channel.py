...
warnings.warn("""GcmChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class GcmChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_json: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GcmChannel is deprecated: GcmChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
