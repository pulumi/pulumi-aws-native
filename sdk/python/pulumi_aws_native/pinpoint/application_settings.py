...
class ApplicationSettings(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApplicationSettingsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApplicationSettingsPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApplicationSettingsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApplicationSettingsProperties']:
        """
