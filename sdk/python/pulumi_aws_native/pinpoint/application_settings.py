...
class ApplicationSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(campaign_hook, ApplicationSettingsCampaignHookArgs):
            ...
            if not isinstance(limits, ApplicationSettingsLimitsArgs):
                limits = limits or {}
                def _setter(key, value):
                    limits[key] = value
                ApplicationSettingsLimitsArgs._configure(_setter, **limits)
            __props__.__dict__["limits"] = limits
            if not isinstance(quiet_time, ApplicationSettingsQuietTimeArgs):
