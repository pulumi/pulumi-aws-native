...
warnings.warn("""ApnsChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ApnsChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 token_key_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApnsChannel is deprecated: ApnsChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        ...
        super(ApnsChannel, __self__).__init__(
            'aws-native:pinpoint:ApnsChannel',
            resource_name,
            __props__,
            opts)
