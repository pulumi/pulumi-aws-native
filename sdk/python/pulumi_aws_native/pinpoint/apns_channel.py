...
warnings.warn("""APNSChannel is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class APNSChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 token_key_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""APNSChannel is deprecated: APNSChannel is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
