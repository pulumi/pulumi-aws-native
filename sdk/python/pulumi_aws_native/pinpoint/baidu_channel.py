...
class BaiduChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BaiduChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['BaiduChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.BaiduChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BaiduChannelProperties']:
        """
