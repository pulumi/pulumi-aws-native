...
class InAppTemplateBodyConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str body: The main body text of the message.
        :param builtins.str text_color: The color of the body text, expressed as a hex color code (such as #000000 for black).
        """
...
class InAppTemplateDefaultButtonConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 border_radius: Optional[builtins.int] = None,
                 button_action: Optional['InAppTemplateButtonAction'] = None,
                 link: Optional[builtins.str] = None,
                 text: Optional[builtins.str] = None,
                 text_color: Optional[builtins.str] = None):
        """
        :param builtins.str background_color: The background color of a button, expressed as a hex color code (such as #000000 for black).
        :param builtins.int border_radius: The border radius of a button.
        ...
        :param builtins.str link: The destination (such as a URL) for a button.
        :param builtins.str text: The text that appears on a button in an in-app message.
        :param builtins.str text_color: The color of the body text in a button, expressed as a hex color code (such as #000000 for black).
        """
    ...
    def border_radius(self) -> Optional[builtins.int]:
        """
...
class InAppTemplateHeaderConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str header: The title text of the in-app message.
        :param builtins.str text_color: The color of the title text, expressed as a hex color code (such as #000000 for black).
        """
        if alignment is not None:
            pulumi.set(__self__, "alignment", alignment)
...
class InAppTemplateInAppMessageContent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str background_color: The background color for an in-app message banner, expressed as a hex color code (such as #000000 for black).
        ...
        :param builtins.str image_url: The URL of the image that appears on an in-app message banner.
