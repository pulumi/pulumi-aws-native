...
warnings.warn("""VoiceChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class VoiceChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 enabled: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""VoiceChannel is deprecated: VoiceChannel is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
