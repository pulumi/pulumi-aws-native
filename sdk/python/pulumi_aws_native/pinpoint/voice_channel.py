...
class VoiceChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VoiceChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VoiceChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VoiceChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VoiceChannelProperties']:
        """
