...
class Campaign(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(campaign_hook, CampaignHookArgs):
            ...
            if not isinstance(custom_delivery_configuration, CampaignCustomDeliveryConfigurationArgs):
            ...
            if not isinstance(limits, CampaignLimitsArgs):
                limits = limits or {}
                def _setter(key, value):
                    limits[key] = value
                CampaignLimitsArgs._configure(_setter, **limits)
            __props__.__dict__["limits"] = limits
            if not isinstance(message_configuration, CampaignMessageConfigurationArgs):
            ...
            if not isinstance(schedule, CampaignScheduleArgs):
            ...
            if not isinstance(template_configuration, CampaignTemplateConfigurationArgs):
