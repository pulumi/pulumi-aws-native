...
class EmailChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EmailChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EmailChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EmailChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EmailChannelProperties']:
        """
