...
class ADMChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ADMChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ADMChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ADMChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ADMChannelProperties']:
        """
