...
class SegmentGpsPointArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             coordinates: Optional[pulumi.Input['SegmentCoordinatesArgs']] = None,
             range_in_kilometers: Optional[pulumi.Input[float]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class SegmentRecencyArgs:
    ...
    def _configure(
             ...
             recency_type: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if duration is None:
