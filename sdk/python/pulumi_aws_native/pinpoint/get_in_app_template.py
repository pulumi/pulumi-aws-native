...
class GetInAppTemplateResult:
    ...
    def template_description(self) -> Optional[builtins.str]:
        """
...
def get_in_app_template(template_name: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInAppTemplateResult:
    """
    Resource Type definition for AWS::Pinpoint::InAppTemplate


    :param builtins.str template_name: The name of the in-app message template.
    """
    __args__ = dict()
...
def get_in_app_template_output(template_name: Optional[pulumi.Input[builtins.str]] = None,
