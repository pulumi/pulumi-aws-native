...
class PushTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(gcm, PushTemplateAndroidPushNotificationTemplateArgs):
                gcm = gcm or {}
                def _setter(key, value):
                    gcm[key] = value
