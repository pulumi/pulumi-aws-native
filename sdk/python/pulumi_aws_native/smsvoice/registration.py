...
class RegistrationArgs:
    def __init__(__self__, *,
                 registration_type: pulumi.Input[_builtins.str],
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a Registration resource.

        :param pulumi.Input[_builtins.str] registration_type: The type of registration form to create.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of tags (key and value pairs) to associate with the registration.
        """
    ...
    def registration_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def registration_type(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("aws-native:smsvoice:Registration")
class Registration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] registration_type: The type of registration form to create.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: An array of tags (key and value pairs) to associate with the registration.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if registration_type is None and not opts.urn:
                raise TypeError("Missing required property 'registration_type'")
            __props__.__dict__["registration_type"] = registration_type
            __props__.__dict__["tags"] = tags
            __props__.__dict__["created_timestamp"] = None
            __props__.__dict__["current_version_number"] = None
            __props__.__dict__["registration_arn"] = None
            __props__.__dict__["registration_id"] = None
            __props__.__dict__["registration_status"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["registrationType"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(Registration, __self__).__init__(
            'aws-native:smsvoice:Registration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["registration_id"] = None
        __props__.__dict__["registration_status"] = None
        __props__.__dict__["registration_type"] = None
    ...
    def current_version_number(self) -> pulumi.Output[_builtins.int]:
        """
    ...
    def registration_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def registration_status(self) -> pulumi.Output['RegistrationStatus']:
        """
