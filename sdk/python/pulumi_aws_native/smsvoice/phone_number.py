...
class PhoneNumberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] opt_out_list_name: The name of the OptOutList to associate with the phone number. You can use the OptOutListName or OptOutListArn.
