...
class ConfigurationSetEventDestinationArgsDict(TypedDict):
    ...
    """
    cloud_watch_logs_destination: NotRequired[pulumi.Input[Optional['ConfigurationSetCloudWatchLogsDestinationArgs']]]
    """
    An object that contains IamRoleArn and LogGroupArn associated with an Amazon CloudWatch event destination.
    """
    kinesis_firehose_destination: NotRequired[pulumi.Input[Optional['ConfigurationSetKinesisFirehoseDestinationArgs']]]
    """
    An object that contains IamRoleArn and DeliveryStreamArn associated with an Amazon Kinesis Firehose event destination.
    """
    sns_destination: NotRequired[pulumi.Input[Optional['ConfigurationSetSnsDestinationArgs']]]
    """
...
class ProtectConfigurationCountryRuleSetArgsDict(TypedDict):
    mms: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ProtectConfigurationCountryRuleArgs']]]]]
    """
    The set of `CountryRule` s to control which destination countries End User Messaging  can send your MMS messages to.
    """
    sms: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ProtectConfigurationCountryRuleArgs']]]]]
    """
    The set of `CountryRule` s to control which destination countries End User Messaging  can send your SMS messages to.
    """
    voice: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ProtectConfigurationCountryRuleArgs']]]]]
    """
