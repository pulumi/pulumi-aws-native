...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_arn: The Amazon Resource Name (ARN) of the AWS End User Messaging SMS and Voice resource to attach the resource-based policy to.
        """
...
@pulumi.type_token("aws-native:smsvoice:ResourcePolicy")
class ResourcePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ResourcePolicy, __self__).__init__(
            'aws-native:smsvoice:ResourcePolicy',
            resource_name,
            __props__,
            opts)
