...
class GetInvoiceUnitResult:
    ...
    def invoice_unit_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def tax_inheritance_disabled(self) -> Optional[_builtins.bool]:
        """
...
def get_invoice_unit(invoice_unit_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str invoice_unit_arn: The ARN to identify an invoice unit. This information can't be modified or deleted.
    """
    __args__ = dict()
