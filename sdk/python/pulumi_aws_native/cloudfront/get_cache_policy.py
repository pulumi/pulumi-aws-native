...
def get_cache_policy(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique identifier for the cache policy. For example: `2766f7b2-75c5-41c6-8f06-bf4303a2f2f5` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_cache_policy_output(id: Optional[pulumi.Input[builtins.str]] = None,
