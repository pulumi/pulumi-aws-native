...
class Distribution(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 distribution_config: pulumi.Input[Optional[Union['DistributionConfigArgs', 'DistributionConfigArgsDict', 'outputs.DistributionConfig']]] = None,
        ...
        :param pulumi.Input[Union['DistributionConfigArgs', 'DistributionConfigArgsDict', 'outputs.DistributionConfig']] distribution_config: The distribution's configuration.
