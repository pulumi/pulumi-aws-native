...
class DistributionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DistributionTagArgs']]] tags: A complex type that contains zero or more ``Tag`` elements.
        """
...
class Distribution(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DistributionTagArgs']]]] tags: A complex type that contains zero or more ``Tag`` elements.
        """
        ...
    @overload
    def __init__(__self__,
