...
class GetFunctionResult:
    ...
    def function_code(self) -> Optional[builtins.str]:
        """
...
def get_function(function_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str function_arn: The ARN of the function. For example:
...
def get_function_output(function_arn: Optional[pulumi.Input[builtins.str]] = None,
