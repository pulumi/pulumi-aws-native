...
__all__ = ['CloudFrontOriginAccessIdentity']
...
class CloudFrontOriginAccessIdentity(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CloudFrontOriginAccessIdentityPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CloudFrontOriginAccessIdentityPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CloudFrontOriginAccessIdentityAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CloudFrontOriginAccessIdentityProperties']:
        """
