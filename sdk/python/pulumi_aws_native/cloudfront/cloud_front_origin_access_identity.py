...
class CloudFrontOriginAccessIdentity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cloud_front_origin_access_identity_config: pulumi.Input[Optional[Union['CloudFrontOriginAccessIdentityConfigArgs', 'CloudFrontOriginAccessIdentityConfigArgsDict', 'outputs.CloudFrontOriginAccessIdentityConfig']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['CloudFrontOriginAccessIdentityConfigArgs', 'CloudFrontOriginAccessIdentityConfigArgsDict', 'outputs.CloudFrontOriginAccessIdentityConfig']] cloud_front_origin_access_identity_config: The current configuration information for the identity.
        """
        ...
    @overload
    def __init__(__self__,
