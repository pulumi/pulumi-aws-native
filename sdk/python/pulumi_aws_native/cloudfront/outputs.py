...
class AnycastIpList(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AnycastIpList. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AnycastIpList.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 status: str):
        """
        :param Sequence[str] anycast_ips: The static IP addresses that are allocated to the Anycast static IP list.
        :param str arn: The Amazon Resource Name (ARN) of the Anycast static IP list.
        :param str id: The ID of the Anycast static IP list.
        :param int ip_count: The number of IP addresses in the Anycast static IP list.
        :param str last_modified_time: The last time the Anycast static IP list was modified.
        :param str name: The name of the Anycast static IP list.
        :param str status: The status of the Anycast static IP list. Valid values: `Deployed` , `Deploying` , or `Failed` .
        """
    ...
    def anycast_ips(self) -> Sequence[str]:
        """
...
@pulumi.output_type
class AnycastIpListTag(dict):
    def __init__(__self__, *,
                 key: str,
                 value: Optional[str] = None):
        """
        :param str key: A string that contains `Tag` key.
               
               The string length should be between 1 and 128 characters. Valid characters include `a-z` , `A-Z` , `0-9` , space, and the special characters `_ - . : / = + @` .
        :param str value: A string that contains an optional `Tag` value.
...
@pulumi.output_type
class AnycastIpListTags(dict):
    def __init__(__self__, *,
                 items: Optional[Sequence['outputs.AnycastIpListTag']] = None):
        """
        :param Sequence['AnycastIpListTag'] items: A complex type that contains `Tag` elements.
        """
    ...
    @property
    @pulumi.getter
    def items(self) -> Optional[Sequence['outputs.AnycastIpListTag']]:
        """
