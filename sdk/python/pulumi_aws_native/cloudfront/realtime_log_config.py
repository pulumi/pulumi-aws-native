...
class RealtimeLogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] sampling_rate: The sampling rate for this real-time log configuration. The sampling rate determines the percentage of viewer requests that are represented in the real-time log data. The sampling rate is an integer between 1 and 100, inclusive.
...
class RealtimeLogConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="samplingRate")
    def sampling_rate(self) -> pulumi.Output[_builtins.float]:
        """
        The sampling rate for this real-time log configuration. The sampling rate determines the percentage of viewer requests that are represented in the real-time log data. The sampling rate is an integer between 1 and 100, inclusive.
        """
        return pulumi.get(self, "sampling_rate")
