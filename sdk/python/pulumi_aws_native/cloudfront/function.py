...
class FunctionArgs:
    ...
    def function_code(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def function_code(self, value: pulumi.Input[_builtins.str]):
...
class Function(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="functionCode")
    def function_code(self) -> pulumi.Output[_builtins.str]:
        """
        The function code. For more information about writing a CloudFront function, see [Writing function code for CloudFront Functions](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/writing-function-code.html) in the *Amazon CloudFront Developer Guide*.
        """
        return pulumi.get(self, "function_code")
