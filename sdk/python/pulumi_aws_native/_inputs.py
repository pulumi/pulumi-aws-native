...
class AutoNamingArgs:
    def __init__(__self__, *,
        ...
        """
        Auto-naming specification for the resource.
        :param pulumi.Input[builtins.int] max_length: The maximum length of the name.
        :param pulumi.Input[builtins.int] min_length: The minimum length of the name.
        :param pulumi.Input[builtins.str] property_name: The name of the property in the Cloud Control payload that is used to set the name of the resource.
        """
...
class ProviderAssumeRoleArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration for a Provider to assume a role.
        :param pulumi.Input[builtins.int] duration_seconds: Number of seconds to restrict the assume role session duration.
        :param pulumi.Input[builtins.str] external_id: External identifier to use when assuming the role.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_arns: Set of Amazon Resource Names (ARNs) of IAM Policies describing further restricting permissions for the role.
        :param pulumi.Input[builtins.str] role_arn: Amazon Resource Name (ARN) of the IAM Role to assume.
        :param pulumi.Input[builtins.str] session_name: Session name to use when assuming the role.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of assume role session tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transitive_tag_keys: A list of keys for session tags that you want to set as transitive. If you set a tag key as transitive, the corresponding key and value passes to subsequent sessions in a role chain.
        """
...
if not MYPY:
    class ProviderAutoNamingArgsDict(TypedDict):
        ...
        """
        auto_trim: NotRequired[pulumi.Input[builtins.bool]]
        """
        Automatically trim the auto-generated name to meet the maximum length constraint.
        """
        random_suffix_min_length: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ProviderAutoNamingArgs:
    def __init__(__self__, *,
                 auto_trim: Optional[pulumi.Input[builtins.bool]] = None,
                 random_suffix_min_length: Optional[pulumi.Input[builtins.int]] = None):
        """
        The configuration for automatically naming resources.
        :param pulumi.Input[builtins.bool] auto_trim: Automatically trim the auto-generated name to meet the maximum length constraint.
        :param pulumi.Input[builtins.int] random_suffix_min_length: The minimum length of the random suffix to append to the auto-generated name.
        """
    ...
    def auto_trim(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Automatically trim the auto-generated name to meet the maximum length constraint.
        """
    ...
    @auto_trim.setter
    def auto_trim(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_trim", value)

    @property
    @pulumi.getter(name="randomSuffixMinLength")
    def random_suffix_min_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum length of the random suffix to append to the auto-generated name.
        """
    ...
    def random_suffix_min_length(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProviderDefaultTagsArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration with resource tag settings to apply across all resources handled by this provider. This is designed to replace redundant per-resource `tags` configurations. Provider tags can be overridden with new values, but not excluded from specific resources. To override provider tag values, use the `tags` argument within a resource to configure new tag values for matching keys.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A group of tags to set across all resources.
        """
        if tags is not None:
            pulumi.set(__self__, "tags", tags)
...
if not MYPY:
    class ProviderEndpointArgsDict(TypedDict):
        ...
        """
        cloudcontrol: NotRequired[pulumi.Input[builtins.str]]
        """
        Override the default endpoint for AWS CloudControl
        """
        cloudformation: NotRequired[pulumi.Input[builtins.str]]
        """
        Override the default endpoint for AWS CloudFormation
        """
        ec2: NotRequired[pulumi.Input[builtins.str]]
        """
        Override the default endpoint for AWS Elastic Compute Cloud (EC2)
        """
        ssm: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProviderEndpointArgs:
    def __init__(__self__, *,
                 cloudcontrol: Optional[pulumi.Input[builtins.str]] = None,
                 cloudformation: Optional[pulumi.Input[builtins.str]] = None,
                 ec2: Optional[pulumi.Input[builtins.str]] = None,
                 ssm: Optional[pulumi.Input[builtins.str]] = None,
                 sts: Optional[pulumi.Input[builtins.str]] = None):
        """
        The configuration for for customizing service endpoints.
        :param pulumi.Input[builtins.str] cloudcontrol: Override the default endpoint for AWS CloudControl
        :param pulumi.Input[builtins.str] cloudformation: Override the default endpoint for AWS CloudFormation
        :param pulumi.Input[builtins.str] ec2: Override the default endpoint for AWS Elastic Compute Cloud (EC2)
        :param pulumi.Input[builtins.str] ssm: Override the default endpoint for AWS Systems Manager
        :param pulumi.Input[builtins.str] sts: Override the default endpoint for AWS Security Token Service (STS)
        """
    ...
    @property
    @pulumi.getter
    def cloudcontrol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Override the default endpoint for AWS CloudControl
        """
    ...
    @cloudcontrol.setter
    def cloudcontrol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloudcontrol", value)

    @property
    @pulumi.getter
    def cloudformation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Override the default endpoint for AWS CloudFormation
        """
    ...
    def cloudformation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloudformation", value)

    @property
    @pulumi.getter
    def ec2(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Override the default endpoint for AWS Elastic Compute Cloud (EC2)
        """
    ...
    @ec2.setter
    def ec2(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ec2", value)

    @property
    @pulumi.getter
    def ssm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Override the default endpoint for AWS Systems Manager
        """
    ...
    @ssm.setter
    def ssm(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProviderIgnoreTagsArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration with resource tag settings to ignore across all resources handled by this provider (except any individual service tag resources such as `ec2.Tag`) for situations where external systems are managing certain resource tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] key_prefixes: List of exact resource tag keys to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning the tag in any `tags` attributes and displaying any configuration difference for the tag value. If any resource configuration still has this tag key configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] keys: List of resource tag key prefixes to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning any tag key matching the prefixes in any `tags` attributes and displaying any configuration difference for those tag values. If any resource configuration still has a tag matching one of the prefixes configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.
        """
