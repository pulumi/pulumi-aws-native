...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] email: The email address of the owner to assign to the new member account.
        :param pulumi.Input[builtins.str] account_name: The friendly name of the member account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] parent_ids: List of parent nodes for the member account. Currently only one parent at a time is supported. Default is root.
        :param pulumi.Input[builtins.str] role_name: The name of an IAM role that AWS Organizations automatically preconfigures in the new member account. Default name is OrganizationAccountAccessRole if not specified.
...
class Account(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="parentIds")
    def parent_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of parent nodes for the member account. Currently only one parent at a time is supported. Default is root.
        """
        return pulumi.get(self, "parent_ids")
