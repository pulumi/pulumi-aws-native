...
class GetAccountResult:
    def __init__(__self__, account_id=None, account_name=None, arn=None, email=None, joined_method=None, joined_timestamp=None, parent_ids=None, paths=None, state=None, status=None, tags=None):
