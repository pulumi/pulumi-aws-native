...
class GetResourcePolicyResult:
    def __init__(__self__, arn=None, content=None, id=None, tags=None):
...
def get_resource_policy(id: Optional[str] = None,
    ...
    :param str id: The unique identifier (ID) associated with this resource policy.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_resource_policy_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:organizations:getResourcePolicy', __args__, opts=opts, typ=GetResourcePolicyResult)
