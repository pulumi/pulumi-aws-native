...
class GetOrganizationResult:
    ...
    def management_account_arn(self) -> Optional[builtins.str]:
        """
    ...
    def management_account_email(self) -> Optional[builtins.str]:
        """
...
def get_organization(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique identifier (ID) of an organization.
    """
    __args__ = dict()
    __args__['id'] = id
