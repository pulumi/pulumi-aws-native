...
class GetPortfolioShareResult:
    ...
    def share_tag_options(self) -> Optional[builtins.bool]:
        """
...
def get_portfolio_share(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str portfolio_id: The portfolio identifier.
    """
    __args__ = dict()
...
def get_portfolio_share_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
