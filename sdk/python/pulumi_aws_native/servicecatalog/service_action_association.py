...
class ServiceActionAssociationArgs:
    def __init__(__self__, *,
                 ...
                 provisioning_artifact_id: pulumi.Input[_builtins.str],
    ...
    def provisioning_artifact_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def provisioning_artifact_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "provisioning_artifact_id", value)

    @_builtins.property
    @pulumi.getter(name="serviceActionId")
    def service_action_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def service_action_id(self, value: pulumi.Input[_builtins.str]):
...
class ServiceActionAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_action_id: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="serviceActionId")
    def service_action_id(self) -> pulumi.Output[_builtins.str]:
        """
        The self-service action identifier. For example, `act-fs7abcd89wxyz` .
        """
        return pulumi.get(self, "service_action_id")
