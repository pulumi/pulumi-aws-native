...
warnings.warn("""TagOptionAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class TagOptionAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tag_option_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagOptionAssociation is deprecated: TagOptionAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
