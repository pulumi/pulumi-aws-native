...
class TagOptionAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_id: The CloudformationProduct or Portfolio identifier.
        :param pulumi.Input[builtins.str] tag_option_id: The TagOption identifier.
        """
...
class TagOptionAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="tagOptionId")
    def tag_option_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The TagOption identifier.
        """
        return pulumi.get(self, "tag_option_id")
