...
__all__ = ['ResourceUpdateConstraint']
...
class ResourceUpdateConstraint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResourceUpdateConstraintPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResourceUpdateConstraintPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResourceUpdateConstraintAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResourceUpdateConstraintProperties']:
        """
