...
class CloudFormationProvisionedProductProvisioningParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The parameter key.
...
if not MYPY:
    class CloudFormationProvisionedProductProvisioningPreferencesArgsDict(TypedDict):
        stack_set_accounts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        stack_set_failure_tolerance_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        stack_set_failure_tolerance_percentage: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        Conditional: You must specify either `StackSetFailureToleranceCount` or `StackSetFailureTolerancePercentage` , but not both.
        """
        stack_set_max_concurrency_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        stack_set_max_concurrency_percentage: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        stack_set_regions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CloudFormationProvisionedProductProvisioningPreferencesArgs:
    def __init__(__self__, *,
                 stack_set_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 stack_set_failure_tolerance_count: Optional[pulumi.Input[builtins.int]] = None,
                 stack_set_failure_tolerance_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 stack_set_max_concurrency_count: Optional[pulumi.Input[builtins.int]] = None,
                 stack_set_max_concurrency_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 stack_set_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stack_set_accounts: One or more AWS accounts where the provisioned product will be available.
               ...
               If no values are specified, the default value is all acounts from the `STACKSET` constraint.
        :param pulumi.Input[builtins.int] stack_set_failure_tolerance_count: The number of accounts, per Region, for which this operation can fail before AWS Service Catalog stops the operation in that Region. If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the operation in any subsequent Regions.
               ...
               The default value is `0` if no value is specified.
        :param pulumi.Input[builtins.int] stack_set_failure_tolerance_percentage: The percentage of accounts, per Region, for which this stack operation can fail before AWS Service Catalog stops the operation in that Region. If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the operation in any subsequent Regions.
               ...
               Conditional: You must specify either `StackSetFailureToleranceCount` or `StackSetFailureTolerancePercentage` , but not both.
        :param pulumi.Input[builtins.int] stack_set_max_concurrency_count: The maximum number of accounts in which to perform this operation at one time. This is dependent on the value of `StackSetFailureToleranceCount` . `StackSetMaxConcurrentCount` is at most one more than the `StackSetFailureToleranceCount` .
               ...
               Conditional: You must specify either `StackSetMaxConcurrentCount` or `StackSetMaxConcurrentPercentage` , but not both.
        :param pulumi.Input[builtins.int] stack_set_max_concurrency_percentage: The maximum percentage of accounts in which to perform this operation at one time.
        ...
        :param pulumi.Input['CloudFormationProvisionedProductProvisioningPreferencesStackSetOperationType'] stack_set_operation_type: Determines what action AWS Service Catalog performs to a stack set or a stack instance represented by the provisioned product. The default value is `UPDATE` if nothing is specified.
               ...
               - **UPDATE** - Updates the stack set represented by the provisioned product and also its stack instances.
               - **DELETE** - Deletes a stack instance in the stack set represented by the provisioned product.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stack_set_regions: One or more AWS Regions where the provisioned product will be available.
    ...
    def stack_set_accounts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more AWS accounts where the provisioned product will be available.
    ...
    def stack_set_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "stack_set_accounts", value)

    @property
    @pulumi.getter(name="stackSetFailureToleranceCount")
    def stack_set_failure_tolerance_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of accounts, per Region, for which this operation can fail before AWS Service Catalog stops the operation in that Region. If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the operation in any subsequent Regions.
    ...
    def stack_set_failure_tolerance_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "stack_set_failure_tolerance_count", value)

    @property
    @pulumi.getter(name="stackSetFailureTolerancePercentage")
    def stack_set_failure_tolerance_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The percentage of accounts, per Region, for which this stack operation can fail before AWS Service Catalog stops the operation in that Region. If the operation is stopped in a Region, AWS Service Catalog doesn't attempt the operation in any subsequent Regions.
    ...
    def stack_set_failure_tolerance_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "stack_set_failure_tolerance_percentage", value)

    @property
    @pulumi.getter(name="stackSetMaxConcurrencyCount")
    def stack_set_max_concurrency_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of accounts in which to perform this operation at one time. This is dependent on the value of `StackSetFailureToleranceCount` . `StackSetMaxConcurrentCount` is at most one more than the `StackSetFailureToleranceCount` .
    ...
    def stack_set_max_concurrency_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "stack_set_max_concurrency_count", value)

    @property
    @pulumi.getter(name="stackSetMaxConcurrencyPercentage")
    def stack_set_max_concurrency_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum percentage of accounts in which to perform this operation at one time.
    ...
    def stack_set_max_concurrency_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def stack_set_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more AWS Regions where the provisioned product will be available.
    ...
    def stack_set_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
