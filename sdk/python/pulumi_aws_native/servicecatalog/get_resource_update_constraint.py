...
class GetResourceUpdateConstraintResult:
    ...
    def tag_update_on_provisioned_product(self) -> Optional[builtins.str]:
        """
...
def get_resource_update_constraint(id: Optional[builtins.str] = None,
...
def get_resource_update_constraint_output(id: Optional[pulumi.Input[builtins.str]] = None,
