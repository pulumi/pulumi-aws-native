...
class GetCloudFormationProvisionedProductResult:
    ...
    @_builtins.property
    @pulumi.getter
    def outputs(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def path_name(self) -> Optional[_builtins.str]:
        """
    ...
    def provisioning_artifact_name(self) -> Optional[_builtins.str]:
        """
...
def get_cloud_formation_provisioned_product(provisioned_product_id: Optional[_builtins.str] = None,
