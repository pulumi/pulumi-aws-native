...
def get_service_action(id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceActionResult:
    """
    Resource Schema for AWS::ServiceCatalog::ServiceAction


    :param builtins.str id: The self-service action identifier. For example, `act-fs7abcd89wxyz` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_service_action_output(id: Optional[pulumi.Input[builtins.str]] = None,
