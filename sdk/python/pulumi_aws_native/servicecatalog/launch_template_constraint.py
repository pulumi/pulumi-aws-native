...
warnings.warn("""LaunchTemplateConstraint is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class LaunchTemplateConstraint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rules: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""LaunchTemplateConstraint is deprecated: LaunchTemplateConstraint is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
