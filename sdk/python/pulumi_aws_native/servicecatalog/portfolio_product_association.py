...
class PortfolioProductAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_portfolio_id: The identifier of the source portfolio. The source portfolio must be a portfolio imported from a different account than the one creating the association. This account must have previously shared this portfolio with the account creating the association.
        """
...
@pulumi.type_token("aws-native:servicecatalog:PortfolioProductAssociation")
class PortfolioProductAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["acceptLanguage", "portfolioId", "productId", "sourcePortfolioId"])
