...
class Portfolio(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PortfolioPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PortfolioPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PortfolioAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PortfolioProperties']:
        """
