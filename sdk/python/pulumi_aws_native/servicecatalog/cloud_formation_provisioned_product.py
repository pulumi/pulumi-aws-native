...
class CloudFormationProvisionedProductArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CloudFormationProvisionedProductAcceptLanguage'] accept_language: The language code.
               ...
               - `jp` - Japanese
               - `zh` - Chinese
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_arns: Passed to AWS CloudFormation . The SNS topic ARNs to which to publish stack-related events.
        :param pulumi.Input[builtins.str] path_id: The path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
               
               > You must provide the name or ID, but not both.
        :param pulumi.Input[builtins.str] path_name: The name of the path. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
               
               > You must provide the name or ID, but not both.
        :param pulumi.Input[builtins.str] product_id: The product identifier.
               
               > You must specify either the ID or the name of the product, but not both.
        :param pulumi.Input[builtins.str] product_name: The name of the Service Catalog product.
               
               Each time a stack is created or updated, if `ProductName` is provided it will successfully resolve to `ProductId` as long as only one product exists in the account or Region with that `ProductName` .
               
               > You must specify either the name or the ID of the product, but not both.
        :param pulumi.Input[builtins.str] provisioned_product_name: A user-friendly name for the provisioned product. This value must be unique for the AWS account and cannot be updated after the product is provisioned.
        :param pulumi.Input[builtins.str] provisioning_artifact_id: The identifier of the provisioning artifact (also known as a version).
               
               > You must specify either the ID or the name of the provisioning artifact, but not both.
        :param pulumi.Input[builtins.str] provisioning_artifact_name: The name of the provisioning artifact (also known as a version) for the product. This name must be unique for the product.
...
class CloudFormationProvisionedProduct(pulumi.CustomResource):
    ...
    def cloudformation_stack_arn(self) -> pulumi.Output[builtins.str]:
    ...
    @property
    @pulumi.getter(name="pathId")
    def path_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
    ...
    @property
    @pulumi.getter(name="provisionedProductName")
    def provisioned_product_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A user-friendly name for the provisioned product. This value must be unique for the AWS account and cannot be updated after the product is provisioned.
        """
        return pulumi.get(self, "provisioned_product_name")
    ...
    @property
    @pulumi.getter(name="provisioningArtifactId")
    def provisioning_artifact_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier of the provisioning artifact (also known as a version).
