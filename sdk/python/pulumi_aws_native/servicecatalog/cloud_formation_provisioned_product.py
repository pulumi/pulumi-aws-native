...
class CloudFormationProvisionedProductArgs:
    def __init__(__self__, *,
                 accept_language: pulumi.Input[Optional['CloudFormationProvisionedProductAcceptLanguage']] = None,
                 ...
                 provisioning_parameters: pulumi.Input[Optional[Sequence[pulumi.Input['CloudFormationProvisionedProductProvisioningParameterArgs']]]] = None,
                 provisioning_preferences: pulumi.Input[Optional['CloudFormationProvisionedProductProvisioningPreferencesArgs']] = None,
        ...
        :param pulumi.Input['CloudFormationProvisionedProductAcceptLanguage'] accept_language: The language code.
               ...
               - `jp` - Japanese
               - `zh` - Chinese
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notification_arns: Passed to AWS CloudFormation . The SNS topic ARNs to which to publish stack-related events.
        :param pulumi.Input[_builtins.str] path_id: The path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
               
               > You must provide the name or ID, but not both.
        :param pulumi.Input[_builtins.str] path_name: The name of the path. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
               
               > You must provide the name or ID, but not both.
        :param pulumi.Input[_builtins.str] product_id: The product identifier.
               
               > You must specify either the ID or the name of the product, but not both.
        :param pulumi.Input[_builtins.str] product_name: The name of the Service Catalog product.
               
               Each time a stack is created or updated, if `ProductName` is provided it will successfully resolve to `ProductId` as long as only one product exists in the account or Region with that `ProductName` .
               
               > You must specify either the name or the ID of the product, but not both.
        :param pulumi.Input[_builtins.str] provisioned_product_name: A user-friendly name for the provisioned product. This value must be unique for the AWS account and cannot be updated after the product is provisioned.
        :param pulumi.Input[_builtins.str] provisioning_artifact_id: The identifier of the provisioning artifact (also known as a version).
    ...
    def accept_language(self) -> pulumi.Input[Optional['CloudFormationProvisionedProductAcceptLanguage']]:
        """
        The language code.
    ...
    def accept_language(self, value: pulumi.Input[Optional['CloudFormationProvisionedProductAcceptLanguage']]):
    ...
    def provisioning_parameters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CloudFormationProvisionedProductProvisioningParameterArgs']]]]:
        """
    ...
    def provisioning_parameters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CloudFormationProvisionedProductProvisioningParameterArgs']]]]):
        pulumi.set(self, "provisioning_parameters", value)

    @_builtins.property
    @pulumi.getter(name="provisioningPreferences")
    def provisioning_preferences(self) -> pulumi.Input[Optional['CloudFormationProvisionedProductProvisioningPreferencesArgs']]:
        """
    ...
    def provisioning_preferences(self, value: pulumi.Input[Optional['CloudFormationProvisionedProductProvisioningPreferencesArgs']]):
...
class CloudFormationProvisionedProduct(pulumi.CustomResource):
    ...
    def cloudformation_stack_arn(self) -> pulumi.Output[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter(name="pathId")
    def path_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use [ListLaunchPaths](https://docs.aws.amazon.com/servicecatalog/latest/dg/API_ListLaunchPaths.html) .
    ...
    @_builtins.property
    @pulumi.getter(name="provisionedProductName")
    def provisioned_product_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A user-friendly name for the provisioned product. This value must be unique for the AWS account and cannot be updated after the product is provisioned.
        """
        return pulumi.get(self, "provisioned_product_name")
    ...
    @_builtins.property
    @pulumi.getter(name="provisioningArtifactId")
    def provisioning_artifact_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The identifier of the provisioning artifact (also known as a version).
