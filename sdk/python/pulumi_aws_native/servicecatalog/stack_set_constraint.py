...
class StackSetConstraint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StackSetConstraintPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StackSetConstraintPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StackSetConstraintAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StackSetConstraintProperties']:
        """
