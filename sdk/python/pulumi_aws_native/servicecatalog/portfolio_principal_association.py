...
class PortfolioPrincipalAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] principal_type: The principal type. The supported value is IAM if you use a fully defined Amazon Resource Name (ARN), or IAM_PATTERN if you use an ARN with no accountID, with or without wildcard characters.
        ...
        :param pulumi.Input[builtins.str] principal_arn: The ARN of the principal (user, role, or group).
        """
...
class PortfolioPrincipalAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="principalArn")
    def principal_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the principal (user, role, or group).
        """
        return pulumi.get(self, "principal_arn")
