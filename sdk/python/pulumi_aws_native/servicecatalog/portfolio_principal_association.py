...
warnings.warn("""PortfolioPrincipalAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class PortfolioPrincipalAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 principal_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PortfolioPrincipalAssociation is deprecated: PortfolioPrincipalAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
