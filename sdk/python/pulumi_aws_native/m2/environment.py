...
class EnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: The type of instance underlying the environment.
        :param pulumi.Input[builtins.str] description: The description of the environment.
        :param pulumi.Input[builtins.str] engine_version: The version of the runtime engine for the environment.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ID or the Amazon Resource Name (ARN) of the customer managed KMS Key used for encrypting environment-related resources.
        ...
        :param pulumi.Input[builtins.str] preferred_maintenance_window: Configures a desired maintenance window for the environment. If you do not provide a value, a random system-generated value will be assigned.
        :param pulumi.Input[builtins.bool] publicly_accessible: Specifies whether the environment is publicly accessible.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The list of security groups for the VPC associated with this environment.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The unique identifiers of the subnets assigned to this runtime environment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags associated to this environment.
        """
