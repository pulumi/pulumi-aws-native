...
class EnvironmentHighAvailabilityConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the details of a high availability configuration.
        :param builtins.int desired_capacity: The number of instances in a high availability configuration. The minimum possible value is 1 and the maximum is 100.
        """
