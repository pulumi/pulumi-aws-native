...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: The ID or the Amazon Resource Name (ARN) of the customer managed KMS Key used for encrypting application-related resources.
        :param pulumi.Input[_builtins.str] name: The name of the application.
        :param pulumi.Input[_builtins.str] role_arn: The Amazon Resource Name (ARN) of the role associated with the application.
...
@pulumi.type_token("aws-native:m2:Application")
