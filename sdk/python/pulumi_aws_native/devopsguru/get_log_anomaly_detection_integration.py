...
def get_log_anomaly_detection_integration(account_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_id: The account ID associated with the integration of DevOps Guru with CloudWatch log groups for log anomaly detection.
    """
    __args__ = dict()
...
def get_log_anomaly_detection_integration_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
