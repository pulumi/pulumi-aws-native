...
def get_notification_channel(id: Optional[builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNotificationChannelResult:
    """
    This resource schema represents the NotificationChannel resource in the Amazon DevOps Guru.


    :param builtins.str id: The ID of a notification channel.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_notification_channel_output(id: Optional[pulumi.Input[builtins.str]] = None,
