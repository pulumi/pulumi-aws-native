...
class NotificationChannelSnsChannelConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Information about a notification channel configured in DevOps Guru to send notifications when insights are created.
        :param pulumi.Input[builtins.str] topic_arn: The Amazon Resource Name (ARN) of an Amazon Simple Notification Service topic.
        """
...
if not MYPY:
    class ResourceCollectionCloudFormationCollectionFilterArgsDict(TypedDict):
        ...
        """
        stack_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ResourceCollectionCloudFormationCollectionFilterArgs:
    def __init__(__self__, *,
                 stack_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        CloudFormation resource for DevOps Guru to monitor
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stack_names: An array of CloudFormation stack names.
        """
    ...
    def stack_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of CloudFormation stack names.
        """
    ...
    @stack_names.setter
    def stack_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ResourceCollectionTagCollectionArgsDict(TypedDict):
        ...
        """
        app_boundary_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ResourceCollectionTagCollectionArgs:
    def __init__(__self__, *,
                 app_boundary_key: Optional[pulumi.Input[builtins.str]] = None,
                 tag_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Tagged resource for DevOps Guru to monitor
        :param pulumi.Input[builtins.str] app_boundary_key: A Tag key for DevOps Guru app boundary.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tag_values: Tag values of DevOps Guru app boundary.
        """
    ...
    def app_boundary_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A Tag key for DevOps Guru app boundary.
        """
    ...
    def app_boundary_key(self, value: Optional[pulumi.Input[builtins.str]]):
