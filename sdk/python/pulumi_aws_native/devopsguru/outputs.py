...
class NotificationChannelSnsChannelConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a notification channel configured in DevOps Guru to send notifications when insights are created.
        :param builtins.str topic_arn: The Amazon Resource Name (ARN) of an Amazon Simple Notification Service topic.
        """
...
class ResourceCollectionCloudFormationCollectionFilter(dict):
    ...
    def __init__(__self__, *,
                 stack_names: Optional[Sequence[builtins.str]] = None):
        """
        CloudFormation resource for DevOps Guru to monitor
        :param Sequence[builtins.str] stack_names: An array of CloudFormation stack names.
        """
    ...
    def stack_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResourceCollectionTagCollection(dict):
    ...
    def __init__(__self__, *,
                 app_boundary_key: Optional[builtins.str] = None,
                 tag_values: Optional[Sequence[builtins.str]] = None):
        """
        Tagged resource for DevOps Guru to monitor
        :param builtins.str app_boundary_key: A Tag key for DevOps Guru app boundary.
        :param Sequence[builtins.str] tag_values: Tag values of DevOps Guru app boundary.
        """
    ...
    def app_boundary_key(self) -> Optional[builtins.str]:
        """
