...
def get_repository_association(association_arn: Optional[builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRepositoryAssociationResult:
    """
    This resource schema represents the RepositoryAssociation resource in the Amazon CodeGuru Reviewer service.


    :param builtins.str association_arn: The Amazon Resource Name (ARN) of the repository association.
    """
    __args__ = dict()
...
def get_repository_association_output(association_arn: Optional[pulumi.Input[builtins.str]] = None,
