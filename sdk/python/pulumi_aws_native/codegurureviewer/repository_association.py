...
class RepositoryAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: The name of the S3 bucket associated with an associated S3 repository. It must start with `codeguru-reviewer-`.
        :param pulumi.Input[builtins.str] connection_arn: The Amazon Resource Name (ARN) of an AWS CodeStar Connections connection.
        :param pulumi.Input[builtins.str] name: Name of the repository to be associated.
        :param pulumi.Input[builtins.str] owner: The owner of the repository. For a Bitbucket repository, this is the username for the account that owns the repository.
