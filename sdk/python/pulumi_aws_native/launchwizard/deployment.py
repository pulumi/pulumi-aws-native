...
class DeploymentArgs:
    ...
    def deployment_pattern_name(self) -> pulumi.Input[builtins.str]:
        """
...
class Deployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deployment_pattern_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 specifications: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="deploymentPatternName")
    def deployment_pattern_name(self) -> pulumi.Output[builtins.str]:
        """
        Workload deployment pattern name
        """
        return pulumi.get(self, "deployment_pattern_name")
