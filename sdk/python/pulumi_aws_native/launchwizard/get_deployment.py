...
def get_deployment(arn: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeploymentResult:
    """
    Definition of AWS::LaunchWizard::Deployment Resource Type


    :param builtins.str arn: ARN of the LaunchWizard deployment
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_deployment_output(arn: Optional[pulumi.Input[builtins.str]] = None,
