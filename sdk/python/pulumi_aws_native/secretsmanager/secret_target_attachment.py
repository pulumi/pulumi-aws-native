...
class SecretTargetAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_id: The ARN or name of the secret. To reference a secret also created in this template, use the see [Ref](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-ref.html) function with the secret's logical ID. This field is unique for each target attachment definition.
        :param pulumi.Input[builtins.str] target_id: The ID of the database or cluster.
        :param pulumi.Input[builtins.str] target_type: A string that defines the type of service or database associated with the secret. This value instructs Secrets Manager how to update the secret with the details of the service or database. This value must be one of the following:
