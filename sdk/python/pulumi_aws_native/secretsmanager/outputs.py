...
class RotationScheduleHostedRotationLambda(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclude_characters: Optional[builtins.str] = None,
                 kms_key_arn: Optional[builtins.str] = None,
                 master_secret_arn: Optional[builtins.str] = None,
                 master_secret_kms_key_arn: Optional[builtins.str] = None,
                 rotation_lambda_name: Optional[builtins.str] = None,
                 runtime: Optional[builtins.str] = None,
                 superuser_secret_arn: Optional[builtins.str] = None,
                 superuser_secret_kms_key_arn: Optional[builtins.str] = None,
                 vpc_security_group_ids: Optional[builtins.str] = None,
                 vpc_subnet_ids: Optional[builtins.str] = None):
        """
        :param builtins.str rotation_type: The type of rotation template to use
        :param builtins.str exclude_characters: A string of the characters that you don't want in the password.
        :param builtins.str kms_key_arn: The ARN of the KMS key that Secrets Manager uses to encrypt the secret. If you don't specify this value, then Secrets Manager uses the key aws/secretsmanager. If aws/secretsmanager doesn't yet exist, then Secrets Manager creates it for you automatically the first time it encrypts the secret value.
        :param builtins.str master_secret_arn: The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        :param builtins.str master_secret_kms_key_arn: The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        :param builtins.str rotation_lambda_name: The name of the Lambda rotation function.
        :param builtins.str runtime: The python runtime associated with the Lambda function
        :param builtins.str superuser_secret_arn: The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        :param builtins.str superuser_secret_kms_key_arn: The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        :param builtins.str vpc_security_group_ids: A comma-separated list of security group IDs applied to the target database.
        :param builtins.str vpc_subnet_ids: A comma separated list of VPC subnet IDs of the target database network. The Lambda rotation function is in the same subnet group.
        """
    ...
    def master_secret_arn(self) -> Optional[builtins.str]:
        """
    ...
    def master_secret_kms_key_arn(self) -> Optional[builtins.str]:
        """
    ...
    def rotation_lambda_name(self) -> Optional[builtins.str]:
        """
    ...
    def superuser_secret_arn(self) -> Optional[builtins.str]:
        """
        The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        """
    ...
    def superuser_secret_kms_key_arn(self) -> Optional[builtins.str]:
        """
        The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        """
    ...
    def vpc_security_group_ids(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_subnet_ids(self) -> Optional[builtins.str]:
        """
...
class RotationScheduleRotationRules(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int automatically_after_days: The number of days between automatic scheduled rotations of the secret. You can use this value to check that your secret meets your compliance guidelines for how often secrets must be rotated.
        ...
        :param builtins.str schedule_expression: A cron() or rate() expression that defines the schedule for rotating your secret. Secrets Manager rotation schedules use UTC time zone.
        """
...
class SecretGenerateSecretString(dict):
    ...
    def __init__(__self__, *,
                 ...
                 generate_string_key: Optional[builtins.str] = None,
        ...
        :param builtins.bool exclude_punctuation: Specifies whether to exclude the following punctuation characters from the password: ``! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~``. If you don't include this switch, the password can contain punctuation.
        :param builtins.bool exclude_uppercase: Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.
        :param builtins.str generate_string_key: The JSON key name for the key/value pair, where the value is the generated password. This pair is added to the JSON structure specified by the ``SecretStringTemplate`` parameter. If you specify this parameter, then you must also specify ``SecretStringTemplate``.
        :param builtins.bool include_space: Specifies whether to include the space character. If you include this switch, the password can contain space characters.
        :param builtins.int password_length: The length of the password. If you don't include this parameter, the default length is 32 characters.
        :param builtins.bool require_each_included_type: Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.
        :param builtins.str secret_string_template: A template that the generated string must match. When you make a change to this property, a new secret version is created.
        """
        if exclude_characters is not None:
            pulumi.set(__self__, "exclude_characters", exclude_characters)
    ...
    def generate_string_key(self) -> Optional[builtins.str]:
        """
    ...
    def secret_string_template(self) -> Optional[builtins.str]:
        """
...
class SecretReplicaRegion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a ``Region`` and the ``KmsKeyId`` for a replica secret.
        :param builtins.str region: A string that represents a ``Region``, for example "us-east-1".
        :param builtins.str kms_key_id: The ARN, key ID, or alias of the KMS key to encrypt the secret. If you don't include this field, Secrets Manager uses ``aws/secretsmanager``.
        """
