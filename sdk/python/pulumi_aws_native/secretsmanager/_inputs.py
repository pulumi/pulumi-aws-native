...
class RotationScheduleHostedRotationLambdaArgsDict(TypedDict):
    ...
    """
    exclude_characters: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    master_secret_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    master_secret_kms_key_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    rotation_lambda_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    superuser_secret_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
    """
    superuser_secret_kms_key_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
    """
    vpc_security_group_ids: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    A comma-separated list of security group IDs applied to the target database.
    """
    vpc_subnet_ids: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RotationScheduleHostedRotationLambdaArgs:
    def __init__(__self__, *,
                 rotation_type: pulumi.Input[_builtins.str],
                 exclude_characters: pulumi.Input[Optional[_builtins.str]] = None,
                 kms_key_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 master_secret_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 master_secret_kms_key_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 rotation_lambda_name: pulumi.Input[Optional[_builtins.str]] = None,
                 runtime: pulumi.Input[Optional[_builtins.str]] = None,
                 superuser_secret_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 superuser_secret_kms_key_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 vpc_security_group_ids: pulumi.Input[Optional[_builtins.str]] = None,
                 vpc_subnet_ids: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] rotation_type: The type of rotation template to use
        :param pulumi.Input[_builtins.str] exclude_characters: A string of the characters that you don't want in the password.
        :param pulumi.Input[_builtins.str] kms_key_arn: The ARN of the KMS key that Secrets Manager uses to encrypt the secret. If you don't specify this value, then Secrets Manager uses the key aws/secretsmanager. If aws/secretsmanager doesn't yet exist, then Secrets Manager creates it for you automatically the first time it encrypts the secret value.
        :param pulumi.Input[_builtins.str] master_secret_arn: The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        :param pulumi.Input[_builtins.str] master_secret_kms_key_arn: The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        :param pulumi.Input[_builtins.str] rotation_lambda_name: The name of the Lambda rotation function.
        :param pulumi.Input[_builtins.str] runtime: The python runtime associated with the Lambda function
        :param pulumi.Input[_builtins.str] superuser_secret_arn: The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        :param pulumi.Input[_builtins.str] superuser_secret_kms_key_arn: The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        :param pulumi.Input[_builtins.str] vpc_security_group_ids: A comma-separated list of security group IDs applied to the target database.
        :param pulumi.Input[_builtins.str] vpc_subnet_ids: A comma separated list of VPC subnet IDs of the target database network. The Lambda rotation function is in the same subnet group.
        """
    ...
    def rotation_type(self) -> pulumi.Input[_builtins.str]:
        """
        The type of rotation template to use
        """
    ...
    def rotation_type(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "rotation_type", value)

    @_builtins.property
    @pulumi.getter(name="excludeCharacters")
    def exclude_characters(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A string of the characters that you don't want in the password.
        """
    ...
    def exclude_characters(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def master_secret_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        """
    ...
    def master_secret_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "master_secret_arn", value)

    @_builtins.property
    @pulumi.getter(name="masterSecretKmsKeyArn")
    def master_secret_kms_key_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        """
    ...
    def master_secret_kms_key_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "master_secret_kms_key_arn", value)

    @_builtins.property
    @pulumi.getter(name="rotationLambdaName")
    def rotation_lambda_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the Lambda rotation function.
        """
    ...
    def rotation_lambda_name(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def superuser_secret_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ARN of the secret that contains superuser credentials, if you use the alternating users rotation strategy. CloudFormation grants the execution role for the Lambda rotation function GetSecretValue permission to the secret in this property.
        """
    ...
    def superuser_secret_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "superuser_secret_arn", value)

    @_builtins.property
    @pulumi.getter(name="superuserSecretKmsKeyArn")
    def superuser_secret_kms_key_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ARN of the KMS key that Secrets Manager used to encrypt the superuser secret, if you use the alternating users strategy and the superuser secret is encrypted with a customer managed key. You don't need to specify this property if the superuser secret is encrypted using the key aws/secretsmanager. CloudFormation grants the execution role for the Lambda rotation function Decrypt, DescribeKey, and GenerateDataKey permission to the key in this property.
        """
    ...
    def superuser_secret_kms_key_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "superuser_secret_kms_key_arn", value)

    @_builtins.property
    @pulumi.getter(name="vpcSecurityGroupIds")
    def vpc_security_group_ids(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A comma-separated list of security group IDs applied to the target database.
        """
    ...
    def vpc_security_group_ids(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "vpc_security_group_ids", value)

    @_builtins.property
    @pulumi.getter(name="vpcSubnetIds")
    def vpc_subnet_ids(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A comma separated list of VPC subnet IDs of the target database network. The Lambda rotation function is in the same subnet group.
        """
    ...
    def vpc_subnet_ids(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class RotationScheduleRotationRulesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] automatically_after_days: The number of days between automatic scheduled rotations of the secret. You can use this value to check that your secret meets your compliance guidelines for how often secrets must be rotated.
        :param pulumi.Input[_builtins.str] duration: The length of the rotation window in hours, for example 3h for a three hour window. Secrets Manager rotates your secret at any time during this window. The window must not extend into the next rotation window or the next UTC day. The window starts according to the ScheduleExpression. If you don't specify a Duration, for a ScheduleExpression in hours, the window automatically closes after one hour. For a ScheduleExpression in days, the window automatically closes at the end of the UTC day.
        :param pulumi.Input[_builtins.str] schedule_expression: A cron() or rate() expression that defines the schedule for rotating your secret. Secrets Manager rotation schedules use UTC time zone.
        """
...
class SecretGenerateSecretStringArgsDict(TypedDict):
    ...
    A string of the characters that you don't want in the password.
    """
    exclude_lowercase: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.
    """
    exclude_numbers: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.
    """
    exclude_punctuation: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to exclude the following punctuation characters from the password: ``! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~``. If you don't include this switch, the password can contain punctuation.
    """
    exclude_uppercase: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.
    """
    generate_string_key: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    include_space: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to include the space character. If you include this switch, the password can contain space characters.
    """
    password_length: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The length of the password. If you don't include this parameter, the default length is 32 characters.
    """
    require_each_included_type: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.
    """
    secret_string_template: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class SecretGenerateSecretStringArgs:
    def __init__(__self__, *,
                 exclude_characters: pulumi.Input[Optional[_builtins.str]] = None,
                 exclude_lowercase: pulumi.Input[Optional[_builtins.bool]] = None,
                 exclude_numbers: pulumi.Input[Optional[_builtins.bool]] = None,
                 exclude_punctuation: pulumi.Input[Optional[_builtins.bool]] = None,
                 exclude_uppercase: pulumi.Input[Optional[_builtins.bool]] = None,
                 generate_string_key: pulumi.Input[Optional[_builtins.str]] = None,
                 include_space: pulumi.Input[Optional[_builtins.bool]] = None,
                 password_length: pulumi.Input[Optional[_builtins.int]] = None,
                 require_each_included_type: pulumi.Input[Optional[_builtins.bool]] = None,
                 secret_string_template: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Generates a random password. We recommend that you specify the maximum length and include every character type that the system you are generating a password for can support.
         *Required permissions:*``secretsmanager:GetRandomPassword``. For more information, see [IAM policy actions for Secrets Manager](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awssecretsmanager.html#awssecretsmanager-actions-as-permissions) and [Authentication and access control in Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access.html).

        :param pulumi.Input[_builtins.str] exclude_characters: A string of the characters that you don't want in the password.
        :param pulumi.Input[_builtins.bool] exclude_lowercase: Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.
        :param pulumi.Input[_builtins.bool] exclude_numbers: Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.
        :param pulumi.Input[_builtins.bool] exclude_punctuation: Specifies whether to exclude the following punctuation characters from the password: ``! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~``. If you don't include this switch, the password can contain punctuation.
        :param pulumi.Input[_builtins.bool] exclude_uppercase: Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.
        :param pulumi.Input[_builtins.str] generate_string_key: The JSON key name for the key/value pair, where the value is the generated password. This pair is added to the JSON structure specified by the ``SecretStringTemplate`` parameter. If you specify this parameter, then you must also specify ``SecretStringTemplate``.
        :param pulumi.Input[_builtins.bool] include_space: Specifies whether to include the space character. If you include this switch, the password can contain space characters.
        :param pulumi.Input[_builtins.int] password_length: The length of the password. If you don't include this parameter, the default length is 32 characters.
        :param pulumi.Input[_builtins.bool] require_each_included_type: Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.
        :param pulumi.Input[_builtins.str] secret_string_template: A template that the generated string must match. When you make a change to this property, a new secret version is created.
        """
        if exclude_characters is not None:
            pulumi.set(__self__, "exclude_characters", exclude_characters)
    ...
    def exclude_lowercase(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to exclude lowercase letters from the password. If you don't include this switch, the password can contain lowercase letters.
        """
    ...
    def exclude_lowercase(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "exclude_lowercase", value)

    @_builtins.property
    @pulumi.getter(name="excludeNumbers")
    def exclude_numbers(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to exclude numbers from the password. If you don't include this switch, the password can contain numbers.
        """
    ...
    def exclude_numbers(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "exclude_numbers", value)

    @_builtins.property
    @pulumi.getter(name="excludePunctuation")
    def exclude_punctuation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to exclude the following punctuation characters from the password: ``! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~``. If you don't include this switch, the password can contain punctuation.
        """
    ...
    def exclude_punctuation(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "exclude_punctuation", value)

    @_builtins.property
    @pulumi.getter(name="excludeUppercase")
    def exclude_uppercase(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to exclude uppercase letters from the password. If you don't include this switch, the password can contain uppercase letters.
        """
    ...
    def exclude_uppercase(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "exclude_uppercase", value)

    @_builtins.property
    @pulumi.getter(name="generateStringKey")
    def generate_string_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The JSON key name for the key/value pair, where the value is the generated password. This pair is added to the JSON structure specified by the ``SecretStringTemplate`` parameter. If you specify this parameter, then you must also specify ``SecretStringTemplate``.
        """
    ...
    def generate_string_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "generate_string_key", value)

    @_builtins.property
    @pulumi.getter(name="includeSpace")
    def include_space(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to include the space character. If you include this switch, the password can contain space characters.
        """
    ...
    def include_space(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def require_each_included_type(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to include at least one upper and lowercase letter, one number, and one punctuation. If you don't include this switch, the password contains at least one of every character type.
        """
    ...
    def require_each_included_type(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "require_each_included_type", value)

    @_builtins.property
    @pulumi.getter(name="secretStringTemplate")
    def secret_string_template(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A template that the generated string must match. When you make a change to this property, a new secret version is created.
        """
    ...
    def secret_string_template(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class SecretReplicaRegionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: A string that represents a ``Region``, for example "us-east-1".
        :param pulumi.Input[_builtins.str] kms_key_id: The ARN, key ID, or alias of the KMS key to encrypt the secret. If you don't include this field, Secrets Manager uses ``aws/secretsmanager``.
        """
