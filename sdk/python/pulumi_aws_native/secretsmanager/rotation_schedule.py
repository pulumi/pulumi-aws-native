...
class RotationScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret_id: The ARN or name of the secret to rotate.
        ...
        :param pulumi.Input[bool] rotate_immediately_on_update: Specifies whether to rotate the secret immediately or wait until the next scheduled rotation window.
        :param pulumi.Input[str] rotation_lambda_arn: The ARN of an existing Lambda rotation function. To specify a rotation function that is also defined in this template, use the Ref function.
