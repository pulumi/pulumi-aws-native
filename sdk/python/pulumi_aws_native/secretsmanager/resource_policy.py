...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret_id: The ARN or name of the secret to attach the resource-based policy.
        :param pulumi.Input[bool] block_public_policy: Specifies whether to block resource-based policies that allow broad access to the secret.
        """
