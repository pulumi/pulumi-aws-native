...
class EnvironmentFederationParameters(dict):
    ...
    def __init__(__self__, *,
                 application_call_back_url: Optional[builtins.str] = None,
                 attribute_map: Optional[Sequence['outputs.EnvironmentFederationParametersAttributeMapItemProperties']] = None,
                 federation_provider_name: Optional[builtins.str] = None,
                 federation_urn: Optional[builtins.str] = None,
                 saml_metadata_document: Optional[builtins.str] = None,
                 saml_metadata_url: Optional[builtins.str] = None):
        """
        Additional parameters to identify Federation mode
        :param builtins.str application_call_back_url: SAML metadata URL to link with the Environment
        ...
        :param builtins.str federation_provider_name: Federation provider name to link with the Environment
        :param builtins.str federation_urn: SAML metadata URL to link with the Environment
        :param builtins.str saml_metadata_document: SAML metadata document to link the federation provider to the Environment
        :param builtins.str saml_metadata_url: SAML metadata URL to link with the Environment
        """
    ...
    def application_call_back_url(self) -> Optional[builtins.str]:
        """
    ...
    def federation_provider_name(self) -> Optional[builtins.str]:
        """
    ...
    def federation_urn(self) -> Optional[builtins.str]:
        """
        SAML metadata URL to link with the Environment
        """
    ...
    def saml_metadata_url(self) -> Optional[builtins.str]:
        """
        SAML metadata URL to link with the Environment
        """
