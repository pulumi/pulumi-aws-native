...
class FhirDatastoreCreatedAt(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The time that a Data Store was created.
        :param builtins.int nanos: Nanoseconds.
        :param builtins.str seconds: Seconds since epoch.
        """
...
class FhirDatastoreIdentityProviderConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fine_grained_authorization_enabled: Optional[builtins.bool] = None,
                 idp_lambda_arn: Optional[builtins.str] = None,
        ...
        :param builtins.bool fine_grained_authorization_enabled: Flag to indicate if fine-grained authorization will be enabled for the datastore
        :param builtins.str idp_lambda_arn: The Amazon Resource Name (ARN) of the Lambda function that will be used to decode the access token created by the authorization server.
        :param builtins.str metadata: The JSON metadata elements for identity provider configuration.
        """
    ...
    def fine_grained_authorization_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def idp_lambda_arn(self) -> Optional[builtins.str]:
        """
...
class FhirDatastoreKmsEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_id: The KMS encryption key id/alias used to encrypt the Data Store contents at rest.
        """
