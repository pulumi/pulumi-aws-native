...
class FhirDatastoreIdentityProviderConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fine_grained_authorization_enabled: Optional[_builtins.bool] = None,
                 idp_lambda_arn: Optional[_builtins.str] = None,
        ...
        :param _builtins.str metadata: The JSON metadata elements for identity provider configuration.
        """
    ...
    def fine_grained_authorization_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def idp_lambda_arn(self) -> Optional[_builtins.str]:
        """
