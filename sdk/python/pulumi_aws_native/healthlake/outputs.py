...
class FhirDatastoreIdentityProviderConfiguration(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             authorization_strategy: Optional['FhirDatastoreIdentityProviderConfigurationAuthorizationStrategy'] = None,
             fine_grained_authorization_enabled: Optional[bool] = None,
             idp_lambda_arn: Optional[str] = None,
             metadata: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class FhirDatastoreKmsEncryptionConfig(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             cmk_type: Optional['FhirDatastoreKmsEncryptionConfigCmkType'] = None,
             kms_key_id: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class FhirDatastorePreloadDataConfig(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             preload_data_type: Optional['FhirDatastorePreloadDataConfigPreloadDataType'] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class FhirDatastoreSseConfiguration(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             kms_encryption_config: Optional['outputs.FhirDatastoreKmsEncryptionConfig'] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
