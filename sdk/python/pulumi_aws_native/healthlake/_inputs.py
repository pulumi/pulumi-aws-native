...
if not MYPY:
    class FhirDatastoreIdentityProviderConfigurationArgsDict(TypedDict):
        ...
        """
        fine_grained_authorization_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Flag to indicate if fine-grained authorization will be enabled for the datastore
        """
        idp_lambda_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FhirDatastoreIdentityProviderConfigurationArgs:
    def __init__(__self__, *,
                 authorization_strategy: pulumi.Input['FhirDatastoreIdentityProviderConfigurationAuthorizationStrategy'],
                 fine_grained_authorization_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 idp_lambda_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] fine_grained_authorization_enabled: Flag to indicate if fine-grained authorization will be enabled for the datastore
        :param pulumi.Input[builtins.str] idp_lambda_arn: The Amazon Resource Name (ARN) of the Lambda function that will be used to decode the access token created by the authorization server.
        :param pulumi.Input[builtins.str] metadata: The JSON metadata elements for identity provider configuration.
        """
    ...
    def fine_grained_authorization_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag to indicate if fine-grained authorization will be enabled for the datastore
        """
    ...
    def fine_grained_authorization_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fine_grained_authorization_enabled", value)

    @property
    @pulumi.getter(name="idpLambdaArn")
    def idp_lambda_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Lambda function that will be used to decode the access token created by the authorization server.
        """
    ...
    def idp_lambda_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FhirDatastoreKmsEncryptionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The KMS encryption key id/alias used to encrypt the Data Store contents at rest.
        """
