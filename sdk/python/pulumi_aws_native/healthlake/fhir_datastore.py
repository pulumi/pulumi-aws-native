...
class FhirDatastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(identity_provider_configuration, FhirDatastoreIdentityProviderConfigurationArgs):
            ...
            if not isinstance(preload_data_config, FhirDatastorePreloadDataConfigArgs):
            ...
            if not isinstance(sse_configuration, FhirDatastoreSseConfigurationArgs):
