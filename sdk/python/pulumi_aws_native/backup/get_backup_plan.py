...
class GetBackupPlanResult:
    ...
    def backup_plan_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def backup_plan_id(self) -> Optional[_builtins.str]:
        """
    ...
    def backup_plan_tags(self) -> Optional[Mapping[str, _builtins.str]]:
        """
