...
class GetReportPlanResult:
    ...
    def report_plan_arn(self) -> Optional[builtins.str]:
        """
    ...
    def report_plan_description(self) -> Optional[builtins.str]:
        """
...
def get_report_plan(report_plan_arn: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReportPlanResult:
    """
    Contains detailed information about a report plan in AWS Backup Audit Manager.


    :param builtins.str report_plan_arn: An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.
    """
    __args__ = dict()
...
def get_report_plan_output(report_plan_arn: Optional[pulumi.Input[builtins.str]] = None,
