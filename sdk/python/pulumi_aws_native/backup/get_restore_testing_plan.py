...
class GetRestoreTestingPlanResult:
    ...
    def restore_testing_plan_arn(self) -> Optional[builtins.str]:
        """
    ...
    def start_window_hours(self) -> Optional[builtins.int]:
        """
...
def get_restore_testing_plan(restore_testing_plan_name: Optional[builtins.str] = None,
    ...
    :param builtins.str restore_testing_plan_name: The RestoreTestingPlanName is a unique string that is the name of the restore testing plan. This cannot be changed after creation, and it must consist of only alphanumeric characters and underscores.
    """
    __args__ = dict()
...
def get_restore_testing_plan_output(restore_testing_plan_name: Optional[pulumi.Input[builtins.str]] = None,
