...
class GetRestoreTestingPlanResult:
    ...
    def restore_testing_plan_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def start_window_hours(self) -> Optional[_builtins.int]:
        """
...
def get_restore_testing_plan(restore_testing_plan_name: Optional[_builtins.str] = None,
