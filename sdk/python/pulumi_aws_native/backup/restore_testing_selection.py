...
class RestoreTestingSelectionArgs:
    def __init__(__self__, *,
                 ...
                 restore_testing_selection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] iam_role_arn: The Amazon Resource Name (ARN) of the IAM role that AWS Backup uses to create the target resource; for example: `arn:aws:iam::123456789012:role/S3Access` .
        :param pulumi.Input[builtins.str] protected_resource_type: The type of AWS resource included in a resource testing selection; for example, an Amazon EBS volume or an Amazon RDS database.
        :param pulumi.Input[builtins.str] restore_testing_plan_name: Unique string that is the name of the restore testing plan.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protected_resource_arns: You can include specific ARNs, such as `ProtectedResourceArns: ["arn:aws:...", "arn:aws:..."]` or you can include a wildcard: `ProtectedResourceArns: ["*"]` , but not both.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] restore_metadata_overrides: You can override certain restore metadata keys by including the parameter `RestoreMetadataOverrides` in the body of `RestoreTestingSelection` . Key values are not case sensitive.
        ...
        :param pulumi.Input[builtins.str] restore_testing_selection_name: The unique name of the restore testing selection that belongs to the related restore testing plan.
        :param pulumi.Input[builtins.int] validation_window_hours: This is amount of hours (1 to 168) available to run a validation script on the data. The data will be deleted upon the completion of the validation script or the end of the specified retention period, whichever comes first.
        """
    ...
    def restore_testing_selection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_testing_selection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestoreTestingSelection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="protectedResourceArns")
    def protected_resource_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        You can include specific ARNs, such as `ProtectedResourceArns: ["arn:aws:...", "arn:aws:..."]` or you can include a wildcard: `ProtectedResourceArns: ["*"]` , but not both.
        """
        return pulumi.get(self, "protected_resource_arns")
    ...
    @property
    @pulumi.getter(name="restoreMetadataOverrides")
    def restore_metadata_overrides(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        You can override certain restore metadata keys by including the parameter `RestoreMetadataOverrides` in the body of `RestoreTestingSelection` . Key values are not case sensitive.
    ...
    @property
    @pulumi.getter(name="restoreTestingSelectionName")
    def restore_testing_selection_name(self) -> pulumi.Output[builtins.str]:
        """
        The unique name of the restore testing selection that belongs to the related restore testing plan.
        """
        return pulumi.get(self, "restore_testing_selection_name")
    ...
    @property
    @pulumi.getter(name="validationWindowHours")
    def validation_window_hours(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        This is amount of hours (1 to 168) available to run a validation script on the data. The data will be deleted upon the completion of the validation script or the end of the specified retention period, whichever comes first.
        """
        return pulumi.get(self, "validation_window_hours")
