...
class RestoreTestingPlanArgs:
    def __init__(__self__, *,
                 ...
                 start_window_hours: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def start_window_hours(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class RestoreTestingPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 recovery_point_selection: pulumi.Input[Optional[Union['RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgs', 'RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgsDict', 'outputs.RestoreTestingPlanRestoreTestingRecoveryPointSelection']]] = None,
                 restore_testing_plan_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgs', 'RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgsDict', 'outputs.RestoreTestingPlanRestoreTestingRecoveryPointSelection']] recovery_point_selection: The specified criteria to assign a set of resources, such as recovery point types or backup vaults.
        :param pulumi.Input[_builtins.str] restore_testing_plan_name: The RestoreTestingPlanName is a unique string that is the name of the restore testing plan. This cannot be changed after creation, and it must consist of only alphanumeric characters and underscores.
        :param pulumi.Input[_builtins.str] schedule_expression: A CRON expression in specified timezone when a restore testing plan is executed. When no CRON expression is provided, AWS Backup will use the default expression `cron(0 5 ? * * *)` .
        :param pulumi.Input[_builtins.str] schedule_expression_timezone: Optional. This is the timezone in which the schedule expression is set. By default, ScheduleExpressions are in UTC. You can modify this to a specified timezone.
        :param pulumi.Input[_builtins.int] start_window_hours: Defaults to 24 hours.
               ...
               A value in hours after a restore test is scheduled before a job will be canceled if it doesn't start successfully. This value is optional. If this value is included, this parameter has a maximum value of 168 hours (one week).
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Optional tags to include. A tag is a key-value pair you can use to manage, filter, and search for your resources. Allowed characters include UTF-8 letters,numbers, spaces, and the following characters: `+ - = . _ : /.`
        """
        ...
    @overload
    def __init__(__self__,
