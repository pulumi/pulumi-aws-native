...
class RestoreTestingPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] schedule_expression: A CRON expression in specified timezone when a restore testing plan is executed. When no CRON expression is provided, AWS Backup will use the default expression `cron(0 5 ? * * *)` .
        :param pulumi.Input[builtins.str] restore_testing_plan_name: The RestoreTestingPlanName is a unique string that is the name of the restore testing plan. This cannot be changed after creation, and it must consist of only alphanumeric characters and underscores.
        :param pulumi.Input[builtins.str] schedule_expression_timezone: Optional. This is the timezone in which the schedule expression is set. By default, ScheduleExpressions are in UTC. You can modify this to a specified timezone.
        :param pulumi.Input[builtins.int] start_window_hours: Defaults to 24 hours.
    ...
    def start_window_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def start_window_hours(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RestoreTestingPlan(pulumi.CustomResource):
    ...
    def restore_testing_plan_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="scheduleExpressionTimezone")
    def schedule_expression_timezone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional. This is the timezone in which the schedule expression is set. By default, ScheduleExpressions are in UTC. You can modify this to a specified timezone.
        """
        return pulumi.get(self, "schedule_expression_timezone")
    ...
    @property
    @pulumi.getter(name="startWindowHours")
    def start_window_hours(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Defaults to 24 hours.
