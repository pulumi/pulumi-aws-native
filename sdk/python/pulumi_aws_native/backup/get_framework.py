...
class GetFrameworkResult:
    ...
    def framework_arn(self) -> Optional[builtins.str]:
        """
    ...
    def framework_description(self) -> Optional[builtins.str]:
        """
    ...
    def framework_status(self) -> Optional[builtins.str]:
        """
...
def get_framework(framework_arn: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFrameworkResult:
    """
    Contains detailed information about a framework. Frameworks contain controls, which evaluate and report on your backup events and resources. Frameworks generate daily compliance results.


    :param builtins.str framework_arn: An Amazon Resource Name (ARN) that uniquely identifies Framework as a resource
    """
    __args__ = dict()
...
def get_framework_output(framework_arn: Optional[pulumi.Input[builtins.str]] = None,
