...
def get_backup_vault(backup_vault_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBackupVaultResult:
    """
    Resource Type definition for AWS::Backup::BackupVault


    :param builtins.str backup_vault_name: The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created.
    """
    __args__ = dict()
...
def get_backup_vault_output(backup_vault_name: Optional[pulumi.Input[builtins.str]] = None,
