...
class BackupVaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] backup_vault_name: The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] backup_vault_tags: The tags to assign to the backup vault.
