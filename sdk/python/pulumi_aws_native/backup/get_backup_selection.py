...
class GetBackupSelectionResult:
    ...
    def selection_id(self) -> Optional[builtins.str]:
        """
...
def get_backup_selection(id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBackupSelectionResult:
    """
    Resource Type definition for AWS::Backup::BackupSelection


    :param builtins.str id: Uniquely identifies the backup selection.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_backup_selection_output(id: Optional[pulumi.Input[builtins.str]] = None,
