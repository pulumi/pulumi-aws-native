...
class GetRestoreTestingSelectionResult:
    ...
    def protected_resource_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def restore_metadata_overrides(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def validation_window_hours(self) -> Optional[builtins.int]:
        """
...
def get_restore_testing_selection(restore_testing_plan_name: Optional[builtins.str] = None,
                                  restore_testing_selection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str restore_testing_plan_name: Unique string that is the name of the restore testing plan.
    ...
    :param builtins.str restore_testing_selection_name: The unique name of the restore testing selection that belongs to the related restore testing plan.
    """
    __args__ = dict()
...
def get_restore_testing_selection_output(restore_testing_plan_name: Optional[pulumi.Input[builtins.str]] = None,
