...
class BackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 backup_plan_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] backup_plan_tags: The tags to assign to the backup plan.
        """
    ...
    def backup_plan_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def backup_plan_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class BackupPlan(pulumi.CustomResource):
    ...
    def backup_plan_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="backupPlanTags")
    def backup_plan_tags(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The tags to assign to the backup plan.
        """
        return pulumi.get(self, "backup_plan_tags")
