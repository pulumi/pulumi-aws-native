...
class FrameworkArgs:
    def __init__(__self__, *,
                 ...
                 framework_description: Optional[pulumi.Input[builtins.str]] = None,
                 framework_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] framework_description: An optional description of the framework with a maximum 1,024 characters.
        :param pulumi.Input[builtins.str] framework_name: The unique name of a framework. This name is between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
    ...
    def framework_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def framework_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "framework_description", value)

    @property
    @pulumi.getter(name="frameworkName")
    def framework_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def framework_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Framework(pulumi.CustomResource):
    ...
    def framework_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="frameworkDescription")
    def framework_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An optional description of the framework with a maximum 1,024 characters.
        """
        return pulumi.get(self, "framework_description")
    ...
    @property
    @pulumi.getter(name="frameworkName")
    def framework_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique name of a framework. This name is between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
        """
        return pulumi.get(self, "framework_name")
    ...
    def framework_status(self) -> pulumi.Output[builtins.str]:
        """
