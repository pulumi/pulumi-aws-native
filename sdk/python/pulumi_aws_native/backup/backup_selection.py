...
class BackupSelection(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BackupSelectionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['BackupSelectionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.BackupSelectionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BackupSelectionProperties']:
        """
