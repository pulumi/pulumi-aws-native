...
class BackupPlanAdvancedBackupSettingResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param Any backup_options: The backup option for the resource. Each option is a key-value pair. This option is only available for Windows VSS backup jobs.
               ...
               For more information about Windows VSS backups, see [Creating a VSS-Enabled Windows Backup](https://docs.aws.amazon.com/aws-backup/latest/devguide/windows-backups.html) .
        :param pulumi.Input[_builtins.str] resource_type: The name of a resource type. The only supported resource type is EC2.
        """
...
class BackupPlanBackupRuleResourceTypeArgsDict(TypedDict):
    ...
    """
    copy_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupPlanCopyActionResourceTypeArgsDict']]]]]
    """
    ...
    """
    index_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupPlanIndexActionsResourceTypeArgsDict']]]]]
    """
    ...
    """
    lifecycle: NotRequired[pulumi.Input[Optional['BackupPlanLifecycleResourceTypeArgsDict']]]
    """
    ...
    """
    scan_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupPlanScanActionResourceTypeArgsDict']]]]]
...
class BackupPlanBackupRuleResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] completion_window_minutes: A value in minutes after a backup job is successfully started before it must be completed or it is canceled by AWS Backup .
        ...
        :param pulumi.Input[_builtins.bool] enable_continuous_backup: Enables continuous backup and point-in-time restores (PITR).
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] recovery_point_tags: The tags to assign to the resources.
        :param pulumi.Input[_builtins.str] schedule_expression: A CRON expression specifying when AWS Backup initiates a backup job.
        :param pulumi.Input[_builtins.str] schedule_expression_timezone: This is the timezone in which the schedule expression is set. By default, ScheduleExpressions are in UTC. You can modify this to a specified timezone.
    ...
    def target_backup_vault(self) -> pulumi.Input[_builtins.str]:
        """
        The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created. They consist of letters, numbers, and hyphens.
        """
    ...
    def target_backup_vault(self, value: pulumi.Input[_builtins.str]):
...
class BackupPlanCopyActionResourceTypeArgs:
    ...
    def destination_backup_vault_arn(self) -> pulumi.Input[_builtins.str]:
        """
        An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup. For example, `arn:aws:backup:us-east-1:123456789012:vault:aBackupVault.`
        """
    ...
    def destination_backup_vault_arn(self, value: pulumi.Input[_builtins.str]):
...
class BackupPlanLifecycleResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] opt_in_to_archive_for_supported_resources: If the value is true, your backup plan transitions supported resources to archive (cold) storage tier in accordance with your lifecycle settings.
        """
...
class BackupPlanResourceTypeArgsDict(TypedDict):
    ...
    """
    advanced_backup_settings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupPlanAdvancedBackupSettingResourceTypeArgsDict']]]]]
    """
    A list of backup options for each resource type.
    """
    scan_settings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupPlanScanSettingResourceTypeArgsDict']]]]]
...
class BackupSelectionConditionResourceTypeArgs:
    def __init__(__self__, *,
                 ...
                 condition_value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] condition_key: The key in a key-value pair. For example, in `"Department": "accounting"` , `"Department"` is the key.
        :param pulumi.Input[_builtins.str] condition_type: An operation, such as `STRINGEQUALS` , that is applied to a key-value pair used to filter resources in a selection.
        :param pulumi.Input[_builtins.str] condition_value: The value in a key-value pair. For example, in `"Department": "accounting"` , `"accounting"` is the value.
        """
        pulumi.set(__self__, "condition_key", condition_key)
...
class BackupSelectionResourceTypeArgsDict(TypedDict):
    ...
    """
    conditions: NotRequired[pulumi.Input[Optional['BackupSelectionResourceTypeConditionsPropertiesArgsDict']]]
    """
    ...
    """
    list_of_tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupSelectionConditionResourceTypeArgsDict']]]]]
    """
    A list of conditions that you define to assign resources to your backup plans using tags. For example, `"StringEquals": { "ConditionKey": "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators are case sensitive.
...
class BackupSelectionResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BackupSelectionConditionResourceTypeArgs']]] list_of_tags: A list of conditions that you define to assign resources to your backup plans using tags. For example, `"StringEquals": { "ConditionKey": "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators are case sensitive.
               ...
               - When you specify more than one condition, you assign all resources that match AT LEAST ONE condition (using OR logic).
               - `ListOfTags` only supports `StringEquals` . `Conditions` supports `StringEquals` , `StringLike` , `StringNotEquals` , and `StringNotLike` .
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] not_resources: A list of Amazon Resource Names (ARNs) to exclude from a backup plan. The maximum number of ARNs is 500 without wildcards, or 30 ARNs with wildcards.
               
               If you need to exclude many resources from a backup plan, consider a different resource selection strategy, such as assigning only one or a few resource types or refining your resource selection using tags.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: An array of strings that contain Amazon Resource Names (ARNs) of resources to assign to a backup plan.
        """
    ...
    def selection_name(self) -> pulumi.Input[_builtins.str]:
        """
        The display name of a resource selection document.
        """
    ...
    def selection_name(self, value: pulumi.Input[_builtins.str]):
...
class BackupSelectionResourceTypeConditionsPropertiesArgsDict(TypedDict):
    ...
    - `Conditions` supports `StringEquals` , `StringLike` , `StringNotEquals` , and `StringNotLike` . `ListOfTags` only supports `StringEquals` .
    """
    string_equals: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupSelectionConditionParameterArgsDict']]]]]
    string_like: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupSelectionConditionParameterArgsDict']]]]]
    string_not_equals: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupSelectionConditionParameterArgsDict']]]]]
    string_not_like: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BackupSelectionConditionParameterArgsDict']]]]]
...
class BackupVaultLockConfigurationTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_retention_days: The AWS Backup Vault Lock configuration that specifies the minimum retention period that the vault retains its recovery points. This setting can be useful if, for example, your organization's policies require you to retain certain data for at least seven years (2555 days).
               ...
               If this parameter is specified, any backup or copy job to the vault must have a lifecycle policy with a retention period equal to or longer than the minimum retention period. If the job's retention period is shorter than that minimum retention period, then the vault fails that backup or copy job, and you should either modify your lifecycle settings or use a different vault. Recovery points already saved in the vault prior to Vault Lock are not affected.
        :param pulumi.Input[_builtins.int] changeable_for_days: The AWS Backup Vault Lock configuration that specifies the number of days before the lock date. For example, setting `ChangeableForDays` to 30 on Jan. 1, 2022 at 8pm UTC will set the lock date to Jan. 31, 2022 at 8pm UTC.
               ...
               If this parameter is not specified, you can delete Vault Lock from the vault using `DeleteBackupVaultLockConfiguration` or change the Vault Lock configuration using `PutBackupVaultLockConfiguration` at any time.
        :param pulumi.Input[_builtins.int] max_retention_days: The AWS Backup Vault Lock configuration that specifies the maximum retention period that the vault retains its recovery points. This setting can be useful if, for example, your organization's policies require you to destroy certain data after retaining it for four years (1460 days).
...
class BackupVaultNotificationObjectTypeArgs:
    def __init__(__self__, *,
                 ...
                 sns_topic_arn: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] backup_vault_events: An array of events that indicate the status of jobs to back up resources to the backup vault. For valid events, see [BackupVaultEvents](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_PutBackupVaultNotifications.html#API_PutBackupVaultNotifications_RequestSyntax) in the *AWS Backup API Guide* .
        :param pulumi.Input[_builtins.str] sns_topic_arn: An ARN that uniquely identifies an Amazon Simple Notification Service (Amazon SNS) topic; for example, `arn:aws:sns:us-west-2:111122223333:MyTopic` .
        """
...
class FrameworkControlArgsDict(TypedDict):
    ...
    """
    control_input_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FrameworkControlInputParameterArgsDict']]]]]
    """
    A list of ParameterName and ParameterValue pairs.
    """
    control_scope: NotRequired[pulumi.Input[Optional['FrameworkControlControlScopePropertiesArgsDict']]]
    """
...
class FrameworkControlArgs:
    ...
    def control_name(self) -> pulumi.Input[_builtins.str]:
        """
        The name of a control. This name is between 1 and 256 characters.
        """
    ...
    @control_name.setter
    def control_name(self, value: pulumi.Input[_builtins.str]):
...
class FrameworkControlControlScopePropertiesArgsDict(TypedDict):
    ...
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FrameworkTagArgsDict']]]]]
    """
...
class FrameworkControlControlScopePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] compliance_resource_ids: The ID of the only AWS resource that you want your control scope to contain.
...
class FrameworkControlInputParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] parameter_name: The name of a parameter, for example, `BackupPlanFrequency` .
        :param pulumi.Input[_builtins.str] parameter_value: The value of parameter, for example, `hourly` .
        """
...
class LogicallyAirGappedBackupVaultNotificationObjectTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sns_topic_arn: The Amazon Resource Name (ARN) that specifies the topic for a backup vault’s events; for example, `arn:aws:sns:us-west-2:111122223333:MyVaultTopic` .
        """
        pulumi.set(__self__, "backup_vault_events", backup_vault_events)
        pulumi.set(__self__, "sns_topic_arn", sns_topic_arn)
...
class ReportDeliveryChannelPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] s3_key_prefix: The prefix for where AWS Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name. If not specified, there is no prefix.
        """
...
class ReportSettingPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] report_template: Identifies the report template for the report. Reports are built using a report template. The report templates are: `BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] accounts: The list of AWS accounts that a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] framework_arns: The Amazon Resource Names (ARNs) of the frameworks a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] organization_units: The list of AWS organization units that a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] regions: The list of AWS regions that a report covers.
        """
...
class RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RestoreTestingPlanRestoreTestingRecoveryPointType']]] recovery_point_types: These are the types of recovery points.
               ...
               Include `SNAPSHOT` to restore only snapshot recovery points; include `CONTINUOUS` to restore continuous recovery points (point in time restore / PITR); use both to restore either a snapshot or a continuous recovery point. The recovery point will be determined by the value for `Algorithm` .
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] exclude_vaults: Accepted values include specific ARNs or list of selectors. Defaults to empty list if not listed.
        :param pulumi.Input[_builtins.int] selection_window_days: Accepted values are integers from 1 to 365.
        """
...
class RestoreTestingSelectionProtectedResourceConditionsArgsDict(TypedDict):
    string_equals: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RestoreTestingSelectionKeyValueArgsDict']]]]]
    """
    Filters the values of your tagged resources for only those resources that you tagged with the same value. Also called "exact matching."
    """
    string_not_equals: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RestoreTestingSelectionKeyValueArgsDict']]]]]
    """
