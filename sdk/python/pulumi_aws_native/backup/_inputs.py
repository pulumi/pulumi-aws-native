...
class BackupPlanAdvancedBackupSettingResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param Any backup_options: The backup option for the resource. Each option is a key-value pair. This option is only available for Windows VSS backup jobs.
               ...
               For more information about Windows VSS backups, see [Creating a VSS-Enabled Windows Backup](https://docs.aws.amazon.com/aws-backup/latest/devguide/windows-backups.html) .
        :param pulumi.Input[builtins.str] resource_type: The name of a resource type. The only supported resource type is EC2.
        """
...
if not MYPY:
    class BackupPlanBackupRuleResourceTypeArgsDict(TypedDict):
        ...
        """
        target_backup_vault: pulumi.Input[builtins.str]
        """
        ...
        """
        completion_window_minutes: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        start_window_minutes: NotRequired[pulumi.Input[builtins.float]]
        """
...
class BackupPlanBackupRuleResourceTypeArgs:
    def __init__(__self__, *,
                 rule_name: pulumi.Input[builtins.str],
                 target_backup_vault: pulumi.Input[builtins.str],
                 completion_window_minutes: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 start_window_minutes: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.str] rule_name: A display name for a backup rule.
        :param pulumi.Input[builtins.str] target_backup_vault: The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created. They consist of letters, numbers, and hyphens.
        ...
        :param pulumi.Input[builtins.str] schedule_expression_timezone: This is the timezone in which the schedule expression is set. By default, ScheduleExpressions are in UTC. You can modify this to a specified timezone.
        :param pulumi.Input[builtins.float] start_window_minutes: An optional value that specifies a period of time in minutes after a backup is scheduled before a job is canceled if it doesn't start successfully.
    ...
    def target_backup_vault(self) -> pulumi.Input[builtins.str]:
        """
        The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created. They consist of letters, numbers, and hyphens.
        """
    ...
    def target_backup_vault(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_backup_vault", value)

    @property
    @pulumi.getter(name="completionWindowMinutes")
    def completion_window_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        A value in minutes after a backup job is successfully started before it must be completed or it is canceled by AWS Backup .
        """
    ...
    def completion_window_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def start_window_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        An optional value that specifies a period of time in minutes after a backup is scheduled before a job is canceled if it doesn't start successfully.
    ...
    def start_window_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "start_window_minutes", value)


if not MYPY:
    class BackupPlanCopyActionResourceTypeArgsDict(TypedDict):
        destination_backup_vault_arn: pulumi.Input[builtins.str]
        """
...
class BackupPlanCopyActionResourceTypeArgs:
    def __init__(__self__, *,
                 ...
                 lifecycle: Optional[pulumi.Input['BackupPlanLifecycleResourceTypeArgs']] = None):
        """
        :param pulumi.Input[builtins.str] destination_backup_vault_arn: An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup. For example, `arn:aws:backup:us-east-1:123456789012:vault:aBackupVault.`
    ...
    def destination_backup_vault_arn(self) -> pulumi.Input[builtins.str]:
        """
        An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup. For example, `arn:aws:backup:us-east-1:123456789012:vault:aBackupVault.`
        """
    ...
    def destination_backup_vault_arn(self, value: pulumi.Input[builtins.str]):
...
class BackupPlanLifecycleResourceTypeArgs:
    def __init__(__self__, *,
                 delete_after_days: Optional[pulumi.Input[builtins.float]] = None,
    ...
    def delete_after_days(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def move_to_cold_storage_after_days(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class BackupPlanResourceTypeArgsDict(TypedDict):
        backup_plan_name: pulumi.Input[builtins.str]
        """
...
class BackupPlanResourceTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backup_plan_name: The display name of a backup plan.
    ...
    def backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
        The display name of a backup plan.
        """
    ...
    def backup_plan_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BackupSelectionConditionParameterArgsDict(TypedDict):
        condition_key: NotRequired[pulumi.Input[builtins.str]]
        """
        The key in a key-value pair. For example, in the tag `Department: Accounting` , `Department` is the key.
        """
        condition_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BackupSelectionConditionParameterArgs:
    def __init__(__self__, *,
                 condition_key: Optional[pulumi.Input[builtins.str]] = None,
                 condition_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] condition_key: The key in a key-value pair. For example, in the tag `Department: Accounting` , `Department` is the key.
        :param pulumi.Input[builtins.str] condition_value: The value in a key-value pair. For example, in the tag `Department: Accounting` , `Accounting` is the value.
        """
    ...
    def condition_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The key in a key-value pair. For example, in the tag `Department: Accounting` , `Department` is the key.
        """
    ...
    def condition_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "condition_key", value)

    @property
    @pulumi.getter(name="conditionValue")
    def condition_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value in a key-value pair. For example, in the tag `Department: Accounting` , `Accounting` is the value.
        """
    ...
    def condition_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupSelectionConditionResourceTypeArgs:
    def __init__(__self__, *,
                 ...
                 condition_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] condition_key: The key in a key-value pair. For example, in `"Department": "accounting"` , `"Department"` is the key.
        :param pulumi.Input[builtins.str] condition_type: An operation, such as `STRINGEQUALS` , that is applied to a key-value pair used to filter resources in a selection.
        :param pulumi.Input[builtins.str] condition_value: The value in a key-value pair. For example, in `"Department": "accounting"` , `"accounting"` is the value.
        """
        pulumi.set(__self__, "condition_key", condition_key)
...
if not MYPY:
    class BackupSelectionResourceTypeArgsDict(TypedDict):
        ...
        """
        selection_name: pulumi.Input[builtins.str]
        """
        ...
        """
        not_resources: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BackupSelectionResourceTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role that AWS Backup uses to authenticate when backing up the target resource; for example, `arn:aws:iam::123456789012:role/S3Access` .
        :param pulumi.Input[builtins.str] selection_name: The display name of a resource selection document.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BackupSelectionConditionResourceTypeArgs']]] list_of_tags: A list of conditions that you define to assign resources to your backup plans using tags. For example, `"StringEquals": { "ConditionKey": "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },` . Condition operators are case sensitive.
               ...
               - When you specify more than one condition, you assign all resources that match AT LEAST ONE condition (using OR logic).
               - `ListOfTags` only supports `StringEquals` . `Conditions` supports `StringEquals` , `StringLike` , `StringNotEquals` , and `StringNotLike` .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_resources: A list of Amazon Resource Names (ARNs) to exclude from a backup plan. The maximum number of ARNs is 500 without wildcards, or 30 ARNs with wildcards.
               
               If you need to exclude many resources from a backup plan, consider a different resource selection strategy, such as assigning only one or a few resource types or refining your resource selection using tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: An array of strings that contain Amazon Resource Names (ARNs) of resources to assign to a backup plan.
        """
    ...
    def selection_name(self) -> pulumi.Input[builtins.str]:
        """
        The display name of a resource selection document.
        """
    ...
    def selection_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BackupVaultLockConfigurationTypeArgsDict(TypedDict):
        ...
        """
        changeable_for_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_retention_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BackupVaultLockConfigurationTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] min_retention_days: The AWS Backup Vault Lock configuration that specifies the minimum retention period that the vault retains its recovery points. This setting can be useful if, for example, your organization's policies require you to retain certain data for at least seven years (2555 days).
               
               If this parameter is not specified, Vault Lock will not enforce a minimum retention period.
               
               If this parameter is specified, any backup or copy job to the vault must have a lifecycle policy with a retention period equal to or longer than the minimum retention period. If the job's retention period is shorter than that minimum retention period, then the vault fails that backup or copy job, and you should either modify your lifecycle settings or use a different vault. Recovery points already saved in the vault prior to Vault Lock are not affected.
        :param pulumi.Input[builtins.int] changeable_for_days: The AWS Backup Vault Lock configuration that specifies the number of days before the lock date. For example, setting `ChangeableForDays` to 30 on Jan. 1, 2022 at 8pm UTC will set the lock date to Jan. 31, 2022 at 8pm UTC.
               ...
               If this parameter is not specified, you can delete Vault Lock from the vault using `DeleteBackupVaultLockConfiguration` or change the Vault Lock configuration using `PutBackupVaultLockConfiguration` at any time.
        :param pulumi.Input[builtins.int] max_retention_days: The AWS Backup Vault Lock configuration that specifies the maximum retention period that the vault retains its recovery points. This setting can be useful if, for example, your organization's policies require you to destroy certain data after retaining it for four years (1460 days).
    ...
    def changeable_for_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The AWS Backup Vault Lock configuration that specifies the number of days before the lock date. For example, setting `ChangeableForDays` to 30 on Jan. 1, 2022 at 8pm UTC will set the lock date to Jan. 31, 2022 at 8pm UTC.
    ...
    def changeable_for_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BackupVaultNotificationObjectTypeArgs:
    def __init__(__self__, *,
                 ...
                 sns_topic_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_vault_events: An array of events that indicate the status of jobs to back up resources to the backup vault. For valid events, see [BackupVaultEvents](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_PutBackupVaultNotifications.html#API_PutBackupVaultNotifications_RequestSyntax) in the *AWS Backup API Guide* .
        :param pulumi.Input[builtins.str] sns_topic_arn: An ARN that uniquely identifies an Amazon Simple Notification Service (Amazon SNS) topic; for example, `arn:aws:sns:us-west-2:111122223333:MyTopic` .
        """
    ...
    def backup_vault_events(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        An array of events that indicate the status of jobs to back up resources to the backup vault. For valid events, see [BackupVaultEvents](https://docs.aws.amazon.com/aws-backup/latest/devguide/API_PutBackupVaultNotifications.html#API_PutBackupVaultNotifications_RequestSyntax) in the *AWS Backup API Guide* .
        """
    ...
    def backup_vault_events(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class FrameworkControlControlScopePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The scope of a control. The control scope defines what the control will evaluate. Three examples of control scopes are: a specific backup plan, all backup plans with a specific tag, or all backup plans.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compliance_resource_ids: The ID of the only AWS resource that you want your control scope to contain.
...
class FrameworkControlInputParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_name: The name of a parameter, for example, `BackupPlanFrequency` .
        :param pulumi.Input[builtins.str] parameter_value: The value of parameter, for example, `hourly` .
        """
...
if not MYPY:
    class FrameworkControlArgsDict(TypedDict):
        control_name: pulumi.Input[builtins.str]
        """
...
class FrameworkControlArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] control_name: The name of a control. This name is between 1 and 256 characters.
    ...
    def control_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of a control. This name is between 1 and 256 characters.
        """
    ...
    @control_name.setter
    def control_name(self, value: pulumi.Input[builtins.str]):
...
class FrameworkTagArgs:
    def __init__(__self__, *,
        ...
        """
        A key-value pair to associate with a resource.
        :param pulumi.Input[builtins.str] key: The key name of the tag. You can specify a value that is 1 to 128 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        :param pulumi.Input[builtins.str] value: The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
        if key is not None:
...
class LogicallyAirGappedBackupVaultNotificationObjectTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sns_topic_arn: The Amazon Resource Name (ARN) that specifies the topic for a backup vault’s events; for example, `arn:aws:sns:us-west-2:111122223333:MyVaultTopic` .
        """
        pulumi.set(__self__, "backup_vault_events", backup_vault_events)
        pulumi.set(__self__, "sns_topic_arn", sns_topic_arn)
...
class ReportDeliveryChannelPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_key_prefix: The prefix for where AWS Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name. If not specified, there is no prefix.
        """
...
class ReportSettingPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Identifies the report template for the report. Reports are built using a report template.
        :param pulumi.Input[builtins.str] report_template: Identifies the report template for the report. Reports are built using a report template. The report templates are: `BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accounts: The list of AWS accounts that a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] framework_arns: The Amazon Resource Names (ARNs) of the frameworks a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organization_units: The list of AWS organization units that a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: The list of AWS regions that a report covers.
        """
...
class RestoreTestingPlanRestoreTestingRecoveryPointSelectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_vaults: Accepted values include wildcard ["*"] or by specific ARNs or ARN wilcard replacement ["arn:aws:backup:us-west-2:123456789012:backup-vault:asdf", ...] ["arn:aws:backup:*:*:backup-vault:asdf-*", ...]
        :param pulumi.Input[Sequence[pulumi.Input['RestoreTestingPlanRestoreTestingRecoveryPointType']]] recovery_point_types: These are the types of recovery points.
               ...
               Include `SNAPSHOT` to restore only snapshot recovery points; include `CONTINUOUS` to restore continuous recovery points (point in time restore / PITR); use both to restore either a snapshot or a continuous recovery point. The recovery point will be determined by the value for `Algorithm` .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_vaults: Accepted values include specific ARNs or list of selectors. Defaults to empty list if not listed.
        :param pulumi.Input[builtins.int] selection_window_days: Accepted values are integers from 1 to 365.
        """
