...
class ReportPlanArgs:
    def __init__(__self__, *,
                 ...
                 report_plan_description: Optional[pulumi.Input[builtins.str]] = None,
                 report_plan_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] report_plan_description: An optional description of the report plan with a maximum of 1,024 characters.
        :param pulumi.Input[builtins.str] report_plan_name: The unique name of the report plan. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
    ...
    def report_plan_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def report_plan_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "report_plan_description", value)

    @property
    @pulumi.getter(name="reportPlanName")
    def report_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def report_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:backup:ReportPlan")
class ReportPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["reportPlanName"])
    ...
    def report_plan_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="reportPlanDescription")
    def report_plan_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An optional description of the report plan with a maximum of 1,024 characters.
        """
        return pulumi.get(self, "report_plan_description")
    ...
    @property
    @pulumi.getter(name="reportPlanName")
    def report_plan_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique name of the report plan. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
        """
        return pulumi.get(self, "report_plan_name")
