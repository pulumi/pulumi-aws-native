...
class ServiceNetworkResourceAssociationArgs:
    def __init__(__self__, *,
                 resource_configuration_id: Optional[pulumi.Input[str]] = None,
                 service_network_id: Optional[pulumi.Input[str]] = None,
    ...
    def resource_configuration_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def service_network_id(self, value: Optional[pulumi.Input[str]]):
