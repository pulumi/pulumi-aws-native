...
def get_service_network_service_association(arn: Optional[builtins.str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceNetworkServiceAssociationResult:
    """
    Associates a service with a service network.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the association between the service network and the service.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_service_network_service_association_output(arn: Optional[pulumi.Input[builtins.str]] = None,
