...
class GetServiceNetworkVpcAssociationResult:
    ...
    def service_network_id(self) -> Optional[builtins.str]:
        """
    ...
    def service_network_name(self) -> Optional[builtins.str]:
        """
...
def get_service_network_vpc_association(arn: Optional[builtins.str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceNetworkVpcAssociationResult:
    """
    Associates a VPC with a service network.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the association between the service network and the VPC.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_service_network_vpc_association_output(arn: Optional[pulumi.Input[builtins.str]] = None,
