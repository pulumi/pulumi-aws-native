...
def get_service_network(arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceNetworkResult:
    """
    A service network is a logical boundary for a collection of services. You can associate services and VPCs with a service network.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the service network.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_service_network_output(arn: Optional[pulumi.Input[builtins.str]] = None,
