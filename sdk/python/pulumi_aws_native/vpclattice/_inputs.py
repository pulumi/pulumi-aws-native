...
class ListenerWeightedTargetGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] target_group_identifier: The ID of the target group.
        :param pulumi.Input[builtins.int] weight: Only required if you specify multiple target groups for a forward action. The weight determines how requests are distributed to the target group. For example, if you specify two target groups, each with a weight of 10, each target group receives half the requests. If you specify two target groups, one with a weight of 10 and the other with a weight of 20, the target group with a weight of 20 receives twice as many requests as the other target group. If there's only one target group specified, then the default value is 100.
        """
...
if not MYPY:
    class ResourceConfigurationDefinition0PropertiesArgsDict(TypedDict):
        ...
        """
        ip_resource: pulumi.Input[builtins.str]
elif False:
...
class ResourceConfigurationDefinition0PropertiesArgs:
    ...
    def ip_resource(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "ip_resource")

    @ip_resource.setter
    def ip_resource(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ResourceConfigurationDefinition1PropertiesArgsDict(TypedDict):
        ...
        - *IP address* - For IPv4 and IPv6, only IP addresses in the VPC are supported.
        """
        arn_resource: pulumi.Input[builtins.str]
elif False:
...
class ResourceConfigurationDefinition1PropertiesArgs:
    ...
    def arn_resource(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "arn_resource")

    @arn_resource.setter
    def arn_resource(self, value: pulumi.Input[builtins.str]):
...
class RuleHeaderMatchTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] contains: A contains type match.
        :param pulumi.Input[builtins.str] exact: An exact type match.
        :param pulumi.Input[builtins.str] prefix: A prefix type match. Matches the value with the prefix.
        """
...
class RulePathMatchTypeArgs:
    def __init__(__self__, *,
                 ...
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] exact: An exact match of the path.
        :param pulumi.Input[builtins.str] prefix: A prefix match of the path.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if prefix is not None:
...
class ServiceNetworkSharingConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Specify if the service network should be enabled for sharing.
        """
...
class TargetGroupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] port: The port on which the targets are listening. For HTTP, the default is 80. For HTTPS, the default is 443. Not supported if the target group type is `LAMBDA` .
        ...
        :param pulumi.Input[builtins.str] vpc_identifier: The ID of the VPC. Not supported if the target group type is `LAMBDA` .
        """
...
class TargetGroupHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether health checking is enabled.
        ...
        :param pulumi.Input[builtins.int] healthy_threshold_count: The number of consecutive successful health checks required before considering an unhealthy target healthy. The range is 2–10. The default is 5.
...
if not MYPY:
    class TargetGroupMatcherArgsDict(TypedDict):
        http_code: pulumi.Input[builtins.str]
        """
...
class TargetGroupMatcherArgs:
    def __init__(__self__, *,
                 http_code: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] http_code: The HTTP code to use when checking for a successful response from a target.
        """
        pulumi.set(__self__, "http_code", http_code)

    @property
    @pulumi.getter(name="httpCode")
    def http_code(self) -> pulumi.Input[builtins.str]:
        """
        The HTTP code to use when checking for a successful response from a target.
        """
    ...
    @http_code.setter
    def http_code(self, value: pulumi.Input[builtins.str]):
...
class TargetGroupTargetArgs:
    def __init__(__self__, *,
                 ...
                 port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] id: The ID of the target. If the target group type is `INSTANCE` , this is an instance ID. If the target group type is `IP` , this is an IP address. If the target group type is `LAMBDA` , this is the ARN of a Lambda function. If the target group type is `ALB` , this is the ARN of an Application Load Balancer.
        :param pulumi.Input[builtins.int] port: The port on which the target is listening. For HTTP, the default is 80. For HTTPS, the default is 443.
        """
