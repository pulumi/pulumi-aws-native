...
def get_auth_policy(resource_identifier: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthPolicyResult:
    """
    Creates or updates the auth policy.


    :param builtins.str resource_identifier: The ID or ARN of the service network or service for which the policy is created.
    """
    __args__ = dict()
...
def get_auth_policy_output(resource_identifier: Optional[pulumi.Input[builtins.str]] = None,
