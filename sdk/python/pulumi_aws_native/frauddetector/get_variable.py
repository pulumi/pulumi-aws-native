...
def get_variable(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The ARN of the variable.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_variable_output(arn: Optional[pulumi.Input[builtins.str]] = None,
