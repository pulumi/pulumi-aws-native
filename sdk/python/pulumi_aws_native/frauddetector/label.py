...
class LabelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The label description.
...
class Label(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] description: The label description.
        :param pulumi.Input[builtins.str] name: The name of the label.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: Tags associated with this label.
        """
        ...
    @overload
    def __init__(__self__,
