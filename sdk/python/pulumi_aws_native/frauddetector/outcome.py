...
class OutcomeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The outcome description.
        :param pulumi.Input[builtins.str] name: The name of the outcome.
...
class Outcome(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] description: The outcome description.
        :param pulumi.Input[builtins.str] name: The name of the outcome.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: Tags associated with this outcome.
        """
        ...
    @overload
    def __init__(__self__,
