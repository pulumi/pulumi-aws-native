...
class ListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] elements: The elements in this list.
        ...
        :param pulumi.Input[builtins.str] variable_type: The variable type of the list.
        """
...
class List(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def elements(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The elements in this list.
        """
        return pulumi.get(self, "elements")
