...
class DetectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] detector_id: The ID of the detector
        ...
        :param pulumi.Input[builtins.str] description: The description of the detector.
...
class Detector(pulumi.CustomResource):
    ...
    def detector_version_id(self) -> pulumi.Output[builtins.str]:
        """
