...
class DetectorEntityTypeArgsDict(TypedDict):
    ...
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorTagArgsDict']]]]]
    """
...
class DetectorEventTypeArgsDict(TypedDict):
    ...
    """
    entity_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorEntityTypeArgsDict']]]]]
    """
    The event type entity types.
    """
    event_variables: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorEventVariableArgsDict']]]]]
    """
    ...
    For example, when creating `AWS::FraudDetector::Detector` you must define at least two variables. You can set `Inline=true` for these variables and CloudFormation will create/update/delete the Variables as part of stack operations. However, if you set `Inline=false` , CloudFormation will associate the variables to your detector but not execute any changes to the variables.
    """
    labels: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorLabelArgsDict']]]]]
    """
...
class DetectorRuleArgsDict(TypedDict):
    ...
    The time when the event type was last updated.
    """
    outcomes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorOutcomeArgsDict']]]]]
    """
    The rule outcome.
    """
...
class EventTypeEntityTypeArgsDict(TypedDict):
    ...
    `^[0-9a-z_-]+$`
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EventTypeTagArgsDict']]]]]
    """
    Tags associated with this event type.
    """
