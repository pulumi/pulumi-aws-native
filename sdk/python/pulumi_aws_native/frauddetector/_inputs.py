...
if not MYPY:
    class DetectorEntityTypeArgsDict(TypedDict):
        ...
        The description.
        """
        inline: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        last_updated_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DetectorEntityTypeArgs:
    def __init__(__self__, *,
                 ...
                 inline: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] arn: The entity type ARN.
        :param pulumi.Input[builtins.str] created_time: The time when the entity type was created.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.bool] inline: Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
               
               For example, when creating `AWS::FraudDetector::Detector` you must define at least two variables. You can set `Inline=true` for these Variables and CloudFormation will create/update/delete the variables as part of stack operations. However, if you set `Inline=false` , CloudFormation will associate the variables to your detector but not execute any changes to the variables.
        :param pulumi.Input[builtins.str] last_updated_time: The time when the entity type was last updated.
        :param pulumi.Input[builtins.str] name: The entity type name.
    ...
    @property
    @pulumi.getter
    def inline(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
    ...
    @inline.setter
    def inline(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DetectorEventTypeArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['DetectorTagArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The ARN of the event type.
        :param pulumi.Input[builtins.str] created_time: The time when the event type was created.
        :param pulumi.Input[builtins.str] description: The description of the event type.
        ...
        :param pulumi.Input[builtins.str] last_updated_time: The time when the event type was last updated.
        :param pulumi.Input[builtins.str] name: The name for the event type
...
class DetectorEventVariableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: The event variable ARN.
        :param pulumi.Input[builtins.str] created_time: The time when the event variable was created.
        ...
        :param pulumi.Input['DetectorEventVariableDataType'] data_type: The data type of the event variable.
               ...
               Valid values: `STRING | INTEGER | BOOLEAN | FLOAT`
        :param pulumi.Input[builtins.str] default_value: The default value of the event variable. This is required if you are providing the details of your variables instead of the ARN.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.bool] inline: Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
               
               For example, when creating `AWS::FraudDetector::Detector` you must define at least two variables. You can set `Inline=true` for these variables and CloudFormation will create/update/delete the variables as part of stack operations. However, if you set `Inline=false` , CloudFormation will associate the variables to your detector but not execute any changes to the variables.
        :param pulumi.Input[builtins.str] last_updated_time: The time when the event variable was last updated.
        :param pulumi.Input[builtins.str] name: The name of the event variable.
...
class DetectorLabelArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['DetectorTagArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The label ARN.
        :param pulumi.Input[builtins.str] created_time: The time when the label was created.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.bool] inline: Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
               
               For example, when creating `AWS::FraudDetector::Detector` you must define at least two variables. You can set `Inline=true` for these variables and CloudFormation will create/update/delete the variables as part of stack operations. However, if you set `Inline=false` , CloudFormation will associate the variables to your detector but not execute any changes to the variables.
        :param pulumi.Input[builtins.str] last_updated_time: The time when the label was last updated.
...
class DetectorModelArgs:
    def __init__(__self__, *,
        ...
        """
        A model to associate with a detector.
        :param pulumi.Input[builtins.str] arn: The ARN of the model.
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class DetectorOutcomeArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['DetectorTagArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The outcome ARN.
        :param pulumi.Input[builtins.str] created_time: The time when the outcome was created.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.bool] inline: Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
               
               For example, when creating `AWS::FraudDetector::Detector` you must define at least two variables. You can set `Inline=true` for these variables and CloudFormation will create/update/delete the variables as part of stack operations. However, if you set `Inline=false` , CloudFormation will associate the variables to your detector but not execute any changes to the variables.
        :param pulumi.Input[builtins.str] last_updated_time: The time when the outcome was last updated.
        :param pulumi.Input[builtins.str] name: The outcome name.
...
if not MYPY:
    class DetectorRuleArgsDict(TypedDict):
        ...
        The description.
        """
        detector_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The rule ID.
        """
        rule_version: NotRequired[pulumi.Input[builtins.str]]
        """
        The rule version.
        """
        tags: NotRequired[pulumi.Input[Sequence[pulumi.Input['DetectorTagArgsDict']]]]
...
class DetectorRuleArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['DetectorTagArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The rule ARN.
        :param pulumi.Input[builtins.str] created_time: The time when the event type was created.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.str] detector_id: The detector for which the rule is associated.
        :param pulumi.Input[builtins.str] expression: The rule expression. A rule expression captures the business logic. For more information, see [Rule language reference](https://docs.aws.amazon.com/frauddetector/latest/ug/rule-language-reference.html) .
        ...
        :param pulumi.Input[builtins.str] rule_id: The rule ID.
        :param pulumi.Input[builtins.str] rule_version: The rule version.
        :param pulumi.Input[Sequence[pulumi.Input['DetectorTagArgs']]] tags: Tags associated with this event type.
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class DetectorTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: A tag key.
        :param pulumi.Input[builtins.str] value: A value assigned to a tag key.
        """
...
class EventTypeEventVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_value: The default value of the event variable
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.bool] inline: Indicates whether the resource is defined within this CloudFormation template and impacts the create, update, and delete behavior of the stack. If the value is `true` , CloudFormation will create/update/delete the resource when creating/updating/deleting the stack. If the value is `false` , CloudFormation will validate that the object exists and then use it within the resource without making changes to the object.
