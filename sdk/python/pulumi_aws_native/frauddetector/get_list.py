...
class GetListResult:
    ...
    def variable_type(self) -> Optional[builtins.str]:
        """
...
def get_list_output(arn: Optional[pulumi.Input[builtins.str]] = None,
