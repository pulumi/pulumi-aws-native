...
class GetAiPromptVersionResult:
    ...
    def ai_prompt_version_id(self) -> Optional[builtins.str]:
...
def get_ai_prompt_version(ai_prompt_id: Optional[builtins.str] = None,
    ...
    :param builtins.float version_number: The version number for this AI Prompt version.
    """
    __args__ = dict()
...
def get_ai_prompt_version_output(ai_prompt_id: Optional[pulumi.Input[builtins.str]] = None,
