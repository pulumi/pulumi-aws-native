...
class GetMessageTemplateResult:
    ...
    def message_template_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def message_template_id(self) -> Optional[_builtins.str]:
        """
...
def get_message_template(message_template_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str message_template_arn: The Amazon Resource Name (ARN) of the message template.
    """
    __args__ = dict()
