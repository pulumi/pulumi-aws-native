...
class AiAgentVersionArgs:
    ...
    def ai_agent_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @ai_agent_id.setter
    def ai_agent_id(self, value: pulumi.Input[_builtins.str]):
...
class AiAgentVersion(pulumi.CustomResource):
    ...
    def ai_agent_version_id(self) -> pulumi.Output[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter(name="modifiedTimeSeconds")
    def modified_time_seconds(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The time the AI Agent version was last modified in seconds.
        """
        return pulumi.get(self, "modified_time_seconds")
    ...
    def version_number(self) -> pulumi.Output[_builtins.float]:
        """
