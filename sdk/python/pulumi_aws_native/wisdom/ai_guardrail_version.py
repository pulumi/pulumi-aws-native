...
class AiGuardrailVersionArgs:
    ...
    def ai_guardrail_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def ai_guardrail_id(self, value: pulumi.Input[_builtins.str]):
...
class AiGuardrailVersion(pulumi.CustomResource):
    ...
    def ai_guardrail_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="aiGuardrailId")
    def ai_guardrail_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the AI guardrail version.
        """
        return pulumi.get(self, "ai_guardrail_id")
    ...
    def ai_guardrail_version_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the AI guardrail version.
        """
