...
class AiAgentArgs:
    def __init__(__self__, *,
                 ...
                 configuration: pulumi.Input[Union['AiAgentAiAgentConfiguration0PropertiesArgs', 'AiAgentAiAgentConfiguration1PropertiesArgs', 'AiAgentAiAgentConfiguration2PropertiesArgs', 'AiAgentAiAgentConfiguration3PropertiesArgs', 'AiAgentAiAgentConfiguration4PropertiesArgs', 'AiAgentAiAgentConfiguration5PropertiesArgs']],
        ...
        :param pulumi.Input[Union['AiAgentAiAgentConfiguration0PropertiesArgs', 'AiAgentAiAgentConfiguration1PropertiesArgs', 'AiAgentAiAgentConfiguration2PropertiesArgs', 'AiAgentAiAgentConfiguration3PropertiesArgs', 'AiAgentAiAgentConfiguration4PropertiesArgs', 'AiAgentAiAgentConfiguration5PropertiesArgs']] configuration: Configuration for the AI Agent.
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input[Union['AiAgentAiAgentConfiguration0PropertiesArgs', 'AiAgentAiAgentConfiguration1PropertiesArgs', 'AiAgentAiAgentConfiguration2PropertiesArgs', 'AiAgentAiAgentConfiguration3PropertiesArgs', 'AiAgentAiAgentConfiguration4PropertiesArgs', 'AiAgentAiAgentConfiguration5PropertiesArgs']]:
        """
    ...
    def configuration(self, value: pulumi.Input[Union['AiAgentAiAgentConfiguration0PropertiesArgs', 'AiAgentAiAgentConfiguration1PropertiesArgs', 'AiAgentAiAgentConfiguration2PropertiesArgs', 'AiAgentAiAgentConfiguration3PropertiesArgs', 'AiAgentAiAgentConfiguration4PropertiesArgs', 'AiAgentAiAgentConfiguration5PropertiesArgs']]):
