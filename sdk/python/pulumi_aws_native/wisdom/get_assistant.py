...
class GetAssistantResult:
    ...
    def assistant_id(self) -> Optional[_builtins.str]:
        """
...
def get_assistant(assistant_id: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssistantResult:
    """
    Definition of AWS::Wisdom::Assistant Resource Type


    :param _builtins.str assistant_id: The ID of the Wisdom assistant.
    """
    __args__ = dict()
