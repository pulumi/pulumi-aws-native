...
class GetAssistantResult:
    ...
    def assistant_id(self) -> Optional[builtins.str]:
        """
...
def get_assistant(assistant_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssistantResult:
    """
    Definition of AWS::Wisdom::Assistant Resource Type


    :param builtins.str assistant_id: The ID of the Wisdom assistant.
    """
    __args__ = dict()
...
def get_assistant_output(assistant_id: Optional[pulumi.Input[builtins.str]] = None,
