...
class AiPromptVersionArgs:
    ...
    @ai_prompt_id.setter
    def ai_prompt_id(self, value: pulumi.Input[str]):
...
class AiPromptVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ai_prompt_id: Optional[pulumi.Input[str]] = None,
    ...
    def ai_prompt_version_id(self) -> pulumi.Output[str]:
