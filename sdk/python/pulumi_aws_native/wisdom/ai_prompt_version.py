...
__all__ = ['AiPromptVersionArgs', 'AiPromptVersion']

@pulumi.input_type
class AiPromptVersionArgs:
    def __init__(__self__, *,
                 ai_prompt_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ai_prompt_id: The identifier of the Amazon Q in Connect AI prompt.
        ...
        :param pulumi.Input[builtins.float] modified_time_seconds: The time the AI Prompt version was last modified in seconds.
        """
    ...
    def ai_prompt_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ai_prompt_id.setter
    def ai_prompt_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ai_prompt_id", value)
...
class AiPromptVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ai_prompt_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AiPromptVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AiPromptVersionArgs.__new__(AiPromptVersionArgs)

            if ai_prompt_id is None and not opts.urn:
                raise TypeError("Missing required property 'ai_prompt_id'")
            __props__.__dict__["ai_prompt_id"] = ai_prompt_id
            ...
            __props__.__dict__["ai_prompt_version_id"] = None
            __props__.__dict__["assistant_arn"] = None
            __props__.__dict__["version_number"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["aiPromptId", "assistantId", "modifiedTimeSeconds"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(AiPromptVersion, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AiPromptVersion':
        """
        ...
        __props__.__dict__["version_number"] = None
        return AiPromptVersion(resource_name, opts=opts, __props__=__props__)
    ...
    def ai_prompt_version_id(self) -> pulumi.Output[builtins.str]:
