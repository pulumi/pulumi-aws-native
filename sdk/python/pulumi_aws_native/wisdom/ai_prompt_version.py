...
class AiPromptVersionArgs:
    ...
    def ai_prompt_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @ai_prompt_id.setter
    def ai_prompt_id(self, value: pulumi.Input[_builtins.str]):
...
class AiPromptVersion(pulumi.CustomResource):
    ...
    def ai_prompt_version_id(self) -> pulumi.Output[_builtins.str]:
