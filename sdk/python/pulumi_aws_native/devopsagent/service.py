...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["kmsKeyArn", "serviceDetails.azureIdentity", "serviceDetails.dynatrace", "serviceDetails.gitLab", "serviceDetails.mcpServer", "serviceDetails.mcpServerGrafana", "serviceDetails.mcpServerNewRelic", "serviceDetails.mcpServerSplunk", "serviceDetails.pagerDuty", "serviceDetails.serviceNow", "serviceType"])
