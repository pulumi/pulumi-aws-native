...
class MonitorHealthEventsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float availability_score_threshold: The health event threshold percentage set for availability scores. When the overall availability score is at or below this percentage, Internet Monitor creates a health event.
        ...
        :param builtins.float performance_score_threshold: The health event threshold percentage set for performance scores. When the overall performance score is at or below this percentage, Internet Monitor creates a health event.
        """
...
class MonitorLocalHealthEventsConfig(dict):
    ...
    def __init__(__self__, *,
                 health_score_threshold: Optional[builtins.float] = None,
                 min_traffic_impact: Optional[builtins.float] = None,
                 status: Optional['MonitorLocalHealthEventsConfigStatus'] = None):
        """
        :param builtins.float health_score_threshold: The health event threshold percentage set for a local health score.
        :param builtins.float min_traffic_impact: The minimum percentage of overall traffic for an application that must be impacted by an issue before Internet Monitor creates an event when a threshold is crossed for a local health score.
    ...
    def health_score_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def min_traffic_impact(self) -> Optional[builtins.float]:
        """
...
class MonitorS3Config(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The Amazon S3 bucket name for internet measurements publishing.
        :param builtins.str bucket_prefix: An optional Amazon S3 bucket prefix for internet measurements publishing.
