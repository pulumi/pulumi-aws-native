...
class MonitorArgs:
    def __init__(__self__, *,
                 ...
                 include_linked_accounts: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 resources_to_add: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 resources_to_remove: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] include_linked_accounts: A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        ...
        :param pulumi.Input[builtins.str] monitor_name: The name of the monitor. A monitor name can contain only alphanumeric characters, dashes (-), periods (.), and underscores (_).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: The resources that have been added for the monitor, listed by their Amazon Resource Names (ARNs). Use this option to add or remove resources when making an update.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources_to_add: The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs). Resources can be Amazon Virtual Private Cloud VPCs, Network Load Balancers (NLBs), Amazon CloudFront distributions, or Amazon WorkSpaces directories.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources_to_remove: The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs)
    ...
    def include_linked_accounts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_linked_accounts(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def resources_to_add(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def resources_to_add(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "resources_to_add", value)

    @property
    @pulumi.getter(name="resourcesToRemove")
    def resources_to_remove(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def resources_to_remove(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Monitor(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="includeLinkedAccounts")
    def include_linked_accounts(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        """
        return pulumi.get(self, "include_linked_accounts")
    ...
    @property
    @pulumi.getter(name="linkedAccountId")
    def linked_account_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The account ID for an account that you've set up cross-account sharing for in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        """
        return pulumi.get(self, "linked_account_id")
    ...
    def monitor_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def processing_status_info(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="resourcesToAdd")
    def resources_to_add(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs). Resources can be Amazon Virtual Private Cloud VPCs, Network Load Balancers (NLBs), Amazon CloudFront distributions, or Amazon WorkSpaces directories.
    ...
    @property
    @pulumi.getter(name="resourcesToRemove")
    def resources_to_remove(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs)
