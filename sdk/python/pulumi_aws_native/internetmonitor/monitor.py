...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(health_events_config, MonitorHealthEventsConfigArgs):
            ...
            if not isinstance(internet_measurements_log_delivery, MonitorInternetMeasurementsLogDeliveryArgs):
