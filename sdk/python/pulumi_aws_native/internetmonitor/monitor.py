...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] include_linked_accounts: A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        ...
        :param pulumi.Input[_builtins.str] monitor_name: The name of the monitor. A monitor name can contain only alphanumeric characters, dashes (-), periods (.), and underscores (_).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources: The resources that have been added for the monitor, listed by their Amazon Resource Names (ARNs). Use this option to add or remove resources when making an update.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources_to_add: The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs). Resources can be Amazon Virtual Private Cloud VPCs, Network Load Balancers (NLBs), Amazon CloudFront distributions, or Amazon WorkSpaces directories.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources_to_remove: The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs)
...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 health_events_config: pulumi.Input[Optional[Union['MonitorHealthEventsConfigArgs', 'MonitorHealthEventsConfigArgsDict', 'outputs.MonitorHealthEventsConfig']]] = None,
                 include_linked_accounts: pulumi.Input[Optional[_builtins.bool]] = None,
                 internet_measurements_log_delivery: pulumi.Input[Optional[Union['MonitorInternetMeasurementsLogDeliveryArgs', 'MonitorInternetMeasurementsLogDeliveryArgsDict', 'outputs.MonitorInternetMeasurementsLogDelivery']]] = None,
                 linked_account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 max_city_networks_to_monitor: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor_name: pulumi.Input[Optional[_builtins.str]] = None,
                 resources: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Union['MonitorHealthEventsConfigArgs', 'MonitorHealthEventsConfigArgsDict', 'outputs.MonitorHealthEventsConfig']] health_events_config: A complex type with the configuration information that determines the threshold and other conditions for when Internet Monitor creates a health event for an overall performance or availability issue, across an application's geographies.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resources_to_remove: The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs)
               ...
               > You can specify this field for a monitor update only if the `Resources` field is empty.
        :param pulumi.Input['MonitorConfigState'] status: The status of a monitor. The accepted values that you can specify for `Status` are `ACTIVE` and `INACTIVE` .
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags for a monitor, listed as a set of *key:value* pairs.
        :param pulumi.Input[_builtins.int] traffic_percentage_to_monitor: The percentage of the internet-facing traffic for your application that you want to monitor. You can also, optionally, set a limit for the number of city-networks (client locations and ASNs, typically internet service providers) that Internet Monitor will monitor traffic for. The city-networks maximum limit caps the number of city-networks that Internet Monitor monitors for your application, regardless of the percentage of traffic that you choose to monitor.
        """
        ...
    @overload
    ...
    @_builtins.property
    @pulumi.getter(name="includeLinkedAccounts")
    def include_linked_accounts(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        """
        return pulumi.get(self, "include_linked_accounts")
    ...
    @_builtins.property
    @pulumi.getter(name="linkedAccountId")
    def linked_account_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The account ID for an account that you've set up cross-account sharing for in Internet Monitor. You configure cross-account sharing by using Amazon CloudWatch Observability Access Manager. For more information, see [Internet Monitor cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cwim-cross-account.html) in the Amazon CloudWatch User Guide.
        """
        return pulumi.get(self, "linked_account_id")
    ...
    def processing_status_info(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="resourcesToAdd")
    def resources_to_add(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs). Resources can be Amazon Virtual Private Cloud VPCs, Network Load Balancers (NLBs), Amazon CloudFront distributions, or Amazon WorkSpaces directories.
    ...
    @_builtins.property
    @pulumi.getter(name="resourcesToRemove")
    def resources_to_remove(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs)
