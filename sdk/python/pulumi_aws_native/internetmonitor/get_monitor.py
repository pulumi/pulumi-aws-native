...
class GetMonitorResult:
    ...
    def max_city_networks_to_monitor(self) -> Optional[builtins.int]:
        """
    ...
    def monitor_arn(self) -> Optional[builtins.str]:
        """
    ...
    def processing_status_info(self) -> Optional[builtins.str]:
        """
    ...
    def traffic_percentage_to_monitor(self) -> Optional[builtins.int]:
        """
...
def get_monitor(monitor_name: Optional[builtins.str] = None,
    ...
    :param builtins.str monitor_name: The name of the monitor. A monitor name can contain only alphanumeric characters, dashes (-), periods (.), and underscores (_).
    """
    __args__ = dict()
