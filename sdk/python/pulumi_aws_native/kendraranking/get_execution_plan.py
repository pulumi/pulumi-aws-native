...
def get_execution_plan(id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetExecutionPlanResult:
    """
    A KendraRanking Rescore execution plan


    :param builtins.str id: The identifier of the rescore execution plan.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_execution_plan_output(id: Optional[pulumi.Input[builtins.str]] = None,
