...
class ExecutionPlanCapacityUnitsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 rescore_capacity_units: _builtins.int):
        """
        :param _builtins.int rescore_capacity_units: The amount of extra capacity for your rescore execution plan.
    ...
    def rescore_capacity_units(self) -> _builtins.int:
        """
