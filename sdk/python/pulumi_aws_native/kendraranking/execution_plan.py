...
class ExecutionPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description for the execution plan
        :param pulumi.Input[builtins.str] name: A name for the rescore execution plan.
