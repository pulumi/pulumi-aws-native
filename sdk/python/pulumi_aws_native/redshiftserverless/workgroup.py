...
class WorkgroupInitArgs:
    def __init__(__self__, *,
                 ...
                 snapshot_owner_account: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] base_capacity: The base compute capacity of the workgroup in Redshift Processing Units (RPUs).
        ...
        :param pulumi.Input[builtins.int] max_capacity: The max compute capacity of the workgroup in Redshift Processing Units (RPUs).
        :param pulumi.Input[builtins.str] namespace_name: The namespace the workgroup is associated with.
        :param pulumi.Input[builtins.int] port: The custom port to use when connecting to a workgroup. Valid port ranges are 5431-5455 and 8191-8215. The default is 5439.
        ...
        :param pulumi.Input[builtins.str] recovery_point_id: The recovery point id to restore from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security group IDs to associate with the workgroup.
        :param pulumi.Input[builtins.str] snapshot_arn: The Amazon Resource Name (ARN) of the snapshot to restore from.
        :param pulumi.Input[builtins.str] snapshot_name: The snapshot name to restore from.
        :param pulumi.Input[builtins.str] snapshot_owner_account: The Amazon Web Services account that owns the snapshot.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of subnet IDs the workgroup is associated with.
        ...
        :param pulumi.Input[builtins.str] track_name: An optional parameter for the name of the track for the workgroup. If you don't provide a track name, the workgroup is assigned to the current track.
    ...
    def snapshot_owner_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def snapshot_owner_account(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Workgroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="baseCapacity")
    def base_capacity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The base compute capacity of the workgroup in Redshift Processing Units (RPUs).
        """
        return pulumi.get(self, "base_capacity")
    ...
    @property
    @pulumi.getter(name="snapshotOwnerAccount")
    def snapshot_owner_account(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Web Services account that owns the snapshot.
        """
        return pulumi.get(self, "snapshot_owner_account")
    ...
    @property
    @pulumi.getter(name="trackName")
    def track_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An optional parameter for the name of the track for the workgroup. If you don't provide a track name, the workgroup is assigned to the current track.
        """
        return pulumi.get(self, "track_name")
