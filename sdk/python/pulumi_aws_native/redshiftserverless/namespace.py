...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 final_snapshot_retention_period: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 redshift_idc_application_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_password_secret_kms_key_id: The ID of the AWS Key Management Service (KMS) key used to encrypt and store the namespace's admin credentials secret. You can only use this parameter if manageAdminPassword is true.
        :param pulumi.Input[builtins.str] admin_user_password: The password associated with the admin user for the namespace that is being created. Password must be at least 8 characters in length, should be any printable ASCII character. Must contain at least one lowercase letter, one uppercase letter and one decimal digit. You can't use adminUserPassword if manageAdminPassword is true.
        :param pulumi.Input[builtins.str] admin_username: The user name associated with the admin user for the namespace that is being created. Only alphanumeric characters and underscores are allowed. It should start with an alphabet.
        :param pulumi.Input[builtins.str] db_name: The database name associated for the namespace that is being created. Only alphanumeric characters and underscores are allowed. It should start with an alphabet.
        :param pulumi.Input[builtins.str] default_iam_role_arn: The default IAM role ARN for the namespace that is being created.
        :param pulumi.Input[builtins.str] final_snapshot_name: The name of the namespace the source snapshot was created from. Please specify the name if needed before deleting namespace
        :param pulumi.Input[builtins.int] final_snapshot_retention_period: The number of days to retain automated snapshot in the destination region after they are copied from the source region. If the value is -1, the manual snapshot is retained indefinitely. The value must be either -1 or an integer between 1 and 3,653.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] iam_roles: A list of AWS Identity and Access Management (IAM) roles that can be used by the namespace to access other AWS services. You must supply the IAM roles in their Amazon Resource Name (ARN) format. The Default role limit for each request is 10.
        :param pulumi.Input[builtins.str] kms_key_id: The AWS Key Management Service (KMS) key ID of the encryption key that you want to use to encrypt data in the namespace.
        ...
        :param pulumi.Input[builtins.bool] manage_admin_password: If true, Amazon Redshift uses AWS Secrets Manager to manage the namespace's admin credentials. You can't use adminUserPassword if manageAdminPassword is true. If manageAdminPassword is false or not set, Amazon Redshift uses adminUserPassword for the admin user account's password.
        :param pulumi.Input[builtins.str] namespace_name: A unique identifier for the namespace. You use this identifier to refer to the namespace for any subsequent namespace operations such as deleting or modifying. All alphabetical characters must be lower case. Namespace name should be unique for all namespaces within an AWS account.
        ...
        :param pulumi.Input[builtins.str] redshift_idc_application_arn: The ARN for the Redshift application that integrates with IAM Identity Center.
    ...
    def final_snapshot_retention_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def final_snapshot_retention_period(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def redshift_idc_application_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redshift_idc_application_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Namespace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="adminPasswordSecretKmsKeyId")
    def admin_password_secret_kms_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the AWS Key Management Service (KMS) key used to encrypt and store the namespace's admin credentials secret. You can only use this parameter if manageAdminPassword is true.
        """
        return pulumi.get(self, "admin_password_secret_kms_key_id")
    ...
    @property
    @pulumi.getter(name="adminUsername")
    def admin_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user name associated with the admin user for the namespace that is being created. Only alphanumeric characters and underscores are allowed. It should start with an alphabet.
        """
        return pulumi.get(self, "admin_username")
    ...
    @property
    @pulumi.getter(name="finalSnapshotRetentionPeriod")
    def final_snapshot_retention_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of days to retain automated snapshot in the destination region after they are copied from the source region. If the value is -1, the manual snapshot is retained indefinitely. The value must be either -1 or an integer between 1 and 3,653.
        """
        return pulumi.get(self, "final_snapshot_retention_period")
    ...
    @property
    @pulumi.getter(name="redshiftIdcApplicationArn")
    def redshift_idc_application_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN for the Redshift application that integrates with IAM Identity Center.
        """
        return pulumi.get(self, "redshift_idc_application_arn")
