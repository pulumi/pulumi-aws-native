...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if final_snapshot_retention_period is None and 'finalSnapshotRetentionPeriod' in kwargs:
        ...
        if final_snapshot_retention_period is not None:
            _setter("final_snapshot_retention_period", final_snapshot_retention_period)
