...
class AccessPointObjectLambdaConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_features: A container for allowed features. Valid inputs are `GetObject-Range` , `GetObject-PartNumber` , `HeadObject-Range` , and `HeadObject-PartNumber` .
        :param pulumi.Input[builtins.bool] cloud_watch_metrics_enabled: A container for whether the CloudWatch metrics configuration is enabled.
        """
...
class AccessPointTransformationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration to define what content transformation will be applied on which S3 Action.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] actions: A container for the action of an Object Lambda Access Point configuration. Valid inputs are `GetObject` , `HeadObject` , `ListObject` , and `ListObjectV2` .
