...
class AccessPointPolicyArgs:
    def __init__(__self__, *,
                 object_lambda_access_point: pulumi.Input[_builtins.str],
                 policy_document: Any):
        """
    ...
    def object_lambda_access_point(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def object_lambda_access_point(self, value: pulumi.Input[_builtins.str]):
...
class AccessPointPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="objectLambdaAccessPoint")
    def object_lambda_access_point(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Amazon S3 ObjectLambdaAccessPoint to which the policy applies.
        """
        return pulumi.get(self, "object_lambda_access_point")
