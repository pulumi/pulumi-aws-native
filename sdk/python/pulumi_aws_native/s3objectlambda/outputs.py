...
class AccessPointAlias(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: The value of the Object Lambda alias.
        :param builtins.str status: The status of the Object Lambda alias.
        """
...
class AccessPointAwsLambda(dict):
    ...
    def __init__(__self__, *,
                 ...
                 function_payload: Optional[builtins.str] = None):
    ...
    def function_payload(self) -> Optional[builtins.str]:
...
class AccessPointObjectLambdaConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allowed_features: Optional[Sequence[builtins.str]] = None,
                 cloud_watch_metrics_enabled: Optional[builtins.bool] = None):
        """
        Configuration to be applied to this Object lambda Access Point. It specifies Supporting Access Point, Transformation Configurations. Customers can also set if they like to enable Cloudwatch metrics for accesses to this Object lambda Access Point. Default setting for Cloudwatch metrics is disable.
        :param builtins.str supporting_access_point: Standard access point associated with the Object Lambda Access Point.
        ...
        :param Sequence[builtins.str] allowed_features: A container for allowed features. Valid inputs are `GetObject-Range` , `GetObject-PartNumber` , `HeadObject-Range` , and `HeadObject-PartNumber` .
        :param builtins.bool cloud_watch_metrics_enabled: A container for whether the CloudWatch metrics configuration is enabled.
        """
    ...
    def cloud_watch_metrics_enabled(self) -> Optional[builtins.bool]:
        """
...
class AccessPointPolicyStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_public: Specifies whether the Object lambda Access Point Policy is Public or not. Object lambda Access Points are private by default.
        """
...
class AccessPointPublicAccessBlockConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Public Access Block Configuration is used to block policies that would allow public access to this Object lambda Access Point. All public access to Object lambda Access Points are blocked by default, and any policy that would give public access to them will be also blocked. This behavior cannot be changed for Object lambda Access Points.
        :param builtins.bool block_public_acls: Specifies whether Amazon S3 should block public access control lists (ACLs) to this object lambda access point. Setting this element to TRUE causes the following behavior:
...
class AccessPointTransformationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration to define what content transformation will be applied on which S3 Action.
        :param Sequence[builtins.str] actions: A container for the action of an Object Lambda Access Point configuration. Valid inputs are `GetObject` , `HeadObject` , `ListObject` , and `ListObjectV2` .
