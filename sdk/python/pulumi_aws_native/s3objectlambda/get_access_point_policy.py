...
def get_access_point_policy(object_lambda_access_point: Optional[builtins.str] = None,
    ...
    :param builtins.str object_lambda_access_point: The name of the Amazon S3 ObjectLambdaAccessPoint to which the policy applies.
    """
    __args__ = dict()
...
def get_access_point_policy_output(object_lambda_access_point: Optional[pulumi.Input[builtins.str]] = None,
