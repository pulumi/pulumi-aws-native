...
def get_stack(id: Optional[str] = None,
    ...
    return AwaitableGetStackResult(
        ...
        chef_configuration=pulumi.get(__ret__, 'chef_configuration'),
        configuration_manager=pulumi.get(__ret__, 'configuration_manager'),
        custom_cookbooks_source=pulumi.get(__ret__, 'custom_cookbooks_source'),
        custom_json=pulumi.get(__ret__, 'custom_json'),
        default_availability_zone=pulumi.get(__ret__, 'default_availability_zone'),
        default_instance_profile_arn=pulumi.get(__ret__, 'default_instance_profile_arn'),
        default_os=pulumi.get(__ret__, 'default_os'),
        default_root_device_type=pulumi.get(__ret__, 'default_root_device_type'),
        default_ssh_key_name=pulumi.get(__ret__, 'default_ssh_key_name'),
        default_subnet_id=pulumi.get(__ret__, 'default_subnet_id'),
        ecs_cluster_arn=pulumi.get(__ret__, 'ecs_cluster_arn'),
        elastic_ips=pulumi.get(__ret__, 'elastic_ips'),
        hostname_theme=pulumi.get(__ret__, 'hostname_theme'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        rds_db_instances=pulumi.get(__ret__, 'rds_db_instances'),
        tags=pulumi.get(__ret__, 'tags'),
        use_custom_cookbooks=pulumi.get(__ret__, 'use_custom_cookbooks'),
        use_opsworks_security_groups=pulumi.get(__ret__, 'use_opsworks_security_groups'))
