...
class Layer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(custom_recipes, LayerRecipesArgs):
            ...
            if not isinstance(lifecycle_event_configuration, LayerLifecycleEventConfigurationArgs):
            ...
            if not isinstance(load_based_auto_scaling, LayerLoadBasedAutoScalingArgs):
