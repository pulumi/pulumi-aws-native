...
class Stack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(chef_configuration, StackChefConfigurationArgs):
            ...
            if not isinstance(configuration_manager, StackConfigurationManagerArgs):
            ...
            if not isinstance(custom_cookbooks_source, StackSourceArgs):
