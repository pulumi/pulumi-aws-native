...
class GetClusterResult:
    ...
    def capacity_providers(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_cluster(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: A user-generated string that you use to identify your cluster. If you don't specify a name, CFNlong generates a unique physical ID for the name.
    """
    __args__ = dict()
