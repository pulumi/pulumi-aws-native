...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(deployment_configuration, ServiceDeploymentConfigurationArgs):
            ...
            if not isinstance(deployment_controller, ServiceDeploymentControllerArgs):
            ...
            if not isinstance(service_connect_configuration, ServiceConnectConfigurationArgs):
