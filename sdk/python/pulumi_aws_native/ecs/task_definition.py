...
class TaskDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(ephemeral_storage, TaskDefinitionEphemeralStorageArgs):
            ...
            if not isinstance(proxy_configuration, TaskDefinitionProxyConfigurationArgs):
            ...
            if not isinstance(runtime_platform, TaskDefinitionRuntimePlatformArgs):
