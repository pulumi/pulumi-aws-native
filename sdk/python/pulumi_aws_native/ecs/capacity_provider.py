...
class CapacityProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: The cluster that this capacity provider is associated with. Managed instances capacity providers are cluster-scoped, meaning they can only be used within their associated cluster.
