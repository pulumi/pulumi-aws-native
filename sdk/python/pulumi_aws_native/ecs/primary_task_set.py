...
class PrimaryTaskSetArgs:
    def __init__(__self__, *,
                 ...
                 task_set_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] task_set_id: The ID or full Amazon Resource Name (ARN) of the task set.
        """
    ...
    def task_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @task_set_id.setter
    def task_set_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "task_set_id", value)


@pulumi.type_token("aws-native:ecs:PrimaryTaskSet")
class PrimaryTaskSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["cluster", "service"])
