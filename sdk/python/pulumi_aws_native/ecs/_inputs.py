...
class ClusterManagedStorageConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The managed storage configuration for the cluster.
        :param pulumi.Input[builtins.str] fargate_ephemeral_storage_kms_key_id: Specify the KMSlong key ID for the Fargate ephemeral storage.
                The key must be a single Region key.
        :param pulumi.Input[builtins.str] kms_key_id: Specify a KMSlong key ID to encrypt the managed storage.
                The key must be a single Region key.
        """
