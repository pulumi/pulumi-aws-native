...
class ClusterManagedStorageConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The managed storage configuration for the cluster.
        :param builtins.str fargate_ephemeral_storage_kms_key_id: Specify the KMSlong key ID for the Fargate ephemeral storage.
                The key must be a single Region key.
        :param builtins.str kms_key_id: Specify a KMSlong key ID to encrypt the managed storage.
                The key must be a single Region key.
        """
...
class ServiceManagedEbsVolumeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool encrypted: Indicates whether the volume should be encrypted. If no value is specified, encryption is turned on by default. This parameter maps 1:1 with the ``Encrypted`` parameter of the [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html) in the *Amazon EC2 API Reference*.
        :param builtins.str filesystem_type: The filesystem type for the volume. For volumes created from a snapshot, you must specify the same filesystem type that the volume was using when the snapshot was created. If there is a filesystem type mismatch, the task will fail to start.
        ...
        :param builtins.int size_in_gi_b: The size of the volume in GiB. You must specify either a volume size or a snapshot ID. If you specify a snapshot ID, the snapshot size is used for the volume size by default. You can optionally specify a volume size greater than or equal to the snapshot size. This parameter maps 1:1 with the ``Size`` parameter of the [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html) in the *Amazon EC2 API Reference*.
                The following are the supported volume size values for each volume type.
                 ...
                 +  ``standard``: 1-1,024
        :param builtins.str snapshot_id: The snapshot that Amazon ECS uses to create the volume. You must specify either a snapshot ID or a volume size. This parameter maps 1:1 with the ``SnapshotId`` parameter of the [CreateVolume API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html) in the *Amazon EC2 API Reference*.
