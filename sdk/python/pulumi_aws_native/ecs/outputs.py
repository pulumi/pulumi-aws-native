...
__all__ = [
    ...
    'ServiceDeploymentEarlySuccessCriteria',
    ...
    'TaskDefinitionS3FilesVolumeConfiguration',
...
@pulumi.output_type
class CapacityProviderCapacityReservationRequest(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderCapacityReservationRequest. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderCapacityReservationRequest.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 reservation_preference: Optional['CapacityProviderCapacityReservationRequestReservationPreference'] = None):
    ...
    def reservation_preference(self) -> Optional['CapacityProviderCapacityReservationRequestReservationPreference']:
...
class CapacityProviderInstanceLaunchTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 capacity_reservations: Optional['outputs.CapacityProviderCapacityReservationRequest'] = None,
        ...
        :param 'CapacityProviderInstanceLaunchTemplateCapacityOptionType' capacity_option_type: The capacity option type. This determines whether Amazon ECS launches On-Demand or Spot Instances for your managed instance capacity provider.
    ...
    def capacity_reservations(self) -> Optional['outputs.CapacityProviderCapacityReservationRequest']:
...
class CapacityProviderManagedInstancesProvider(dict):
    ...
    def infrastructure_optimization(self) -> Optional['outputs.CapacityProviderManagedInstancesProviderInfrastructureOptimizationProperties']:
        """
...
@pulumi.output_type
class CapacityProviderManagedInstancesProviderInfrastructureOptimizationProperties(dict):
    """
    Defines how Amazon ECS Managed Instances optimizes the infrastructure in your capacity provider. Configure it to turn on or off the infrastructure optimization in your capacity provider, and to control the idle EC2 instances optimization delay.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderManagedInstancesProviderInfrastructureOptimizationProperties. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderManagedInstancesProviderInfrastructureOptimizationProperties.__key_warning(key)
        return super().__getitem__(key)
...
class DaemonAlarmConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] alarm_names: The CloudWatch alarm names to monitor during a daemon deployment.
        :param _builtins.bool enable: Determines whether to use the CloudWatch alarm option in the daemon deployment process. The default value is ``false``.
        """
...
class DaemonDeploymentConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DaemonAlarmConfiguration' alarms: The CloudWatch alarm configuration for the daemon deployment. When alarms are triggered during a deployment, the deployment can be automatically rolled back.
        :param _builtins.int bake_time_in_minutes: The amount of time (in minutes) to wait after a successful deployment step before proceeding. This allows time to monitor for issues before continuing. The default value is 0.
        :param _builtins.float drain_percent: The percentage of container instances to drain simultaneously during a daemon deployment. Valid values are between 0.0 and 100.0.
        """
...
class DaemonTaskDefinitionDaemonContainerDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str image: The image used to start the container. This string is passed directly to the Docker daemon. Images in the Docker Hub registry are available by default. Other repositories are specified with either ``repository-url/image:tag`` or ``repository-url/image@digest``.
        :param _builtins.str name: The name of the container. Up to 255 letters (uppercase and lowercase), numbers, underscores, and hyphens are allowed.
        :param Sequence[_builtins.str] command: The command that's passed to the container.
        :param _builtins.int cpu: The number of ``cpu`` units reserved for the container.
        :param Sequence['DaemonTaskDefinitionContainerDependency'] depends_on: The dependencies defined for container startup and shutdown. A container can contain multiple dependencies on other containers in a task definition.
        :param Sequence[_builtins.str] entry_point: The entry point that's passed to the container.
        :param Sequence['DaemonTaskDefinitionKeyValuePair'] environment: The environment variables to pass to a container.
        :param Sequence['DaemonTaskDefinitionEnvironmentFile'] environment_files: A list of files containing the environment variables to pass to a container.
        ...
        :param 'DaemonTaskDefinitionFirelensConfiguration' firelens_configuration: The FireLens configuration for the container. This is used to specify and configure a log router for container logs.
        :param 'DaemonTaskDefinitionHealthCheck' health_check: The container health check command and associated configuration parameters for the container.
        ...
        :param 'DaemonTaskDefinitionLinuxParameters' linux_parameters: Linux-specific modifications that are applied to the container configuration, such as Linux kernel capabilities.
        :param 'DaemonTaskDefinitionLogConfiguration' log_configuration: The log configuration specification for the container.
        :param _builtins.int memory: The amount (in MiB) of memory to present to the container. If the container attempts to exceed the memory specified here, the container is killed.
        :param _builtins.int memory_reservation: The soft limit (in MiB) of memory to reserve for the container.
        :param Sequence['DaemonTaskDefinitionMountPoint'] mount_points: The mount points for data volumes in your container.
        :param _builtins.bool privileged: When this parameter is true, the container is given elevated privileges on the host container instance (similar to the ``root`` user).
        ...
        :param 'DaemonTaskDefinitionRepositoryCredentials' repository_credentials: The private repository authentication credentials to use.
        :param 'DaemonTaskDefinitionRestartPolicy' restart_policy: The restart policy for the container. When you set up a restart policy, Amazon ECS can restart the container without needing to replace the task.
        :param Sequence['DaemonTaskDefinitionSecret'] secrets: The secrets to pass to the container.
        ...
        :param Sequence['DaemonTaskDefinitionSystemControl'] system_controls: A list of namespaced kernel parameters to set in the container.
        :param Sequence['DaemonTaskDefinitionUlimit'] ulimits: A list of ``ulimits`` to set in the container.
        :param _builtins.str user: The user to use inside the container.
        :param _builtins.str working_directory: The working directory to run commands inside the container in.
        """
...
class DaemonTaskDefinitionLinuxParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DaemonTaskDefinitionKernelCapabilities' capabilities: The Linux capabilities for the container that are added to or dropped from the default configuration provided by Docker.
                 For tasks that use the Fargate launch type, ``capabilities`` is supported for all platform versions but the ``add`` parameter is only supported if using platform version 1.4.0 or later.
        :param Sequence['DaemonTaskDefinitionDevice'] devices: Any host devices to expose to the container. This parameter maps to ``Devices`` in the docker container create command and the ``--device`` option to docker run.
        ...
        :param Sequence['DaemonTaskDefinitionTmpfs'] tmpfs: The container path, mount options, and size (in MiB) of the tmpfs mount. This parameter maps to the ``--tmpfs`` option to docker run.
        """
...
class DaemonTaskDefinitionLogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['DaemonTaskDefinitionSecret'] secret_options: The secrets to pass to the log configuration. For more information, see [Specifying sensitive data](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html) in the *Amazon Elastic Container Service Developer Guide*.
        """
...
class ExpressGatewayServiceAwsLogsConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceAwsLogsConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceAwsLogsConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str log_group: The name of the CloudWatch Logs log group to send container logs to.
        :param _builtins.str log_stream_prefix: The prefix for the CloudWatch Logs log stream names. The default for an Express service is `ecs` .
        """
...
@pulumi.output_type
class ExpressGatewayServiceConfiguration(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "createdAt":
        ...
        elif key == "ingressPaths":
            suggest = "ingress_paths"
        elif key == "networkConfiguration":
            suggest = "network_configuration"
        elif key == "primaryContainer":
            suggest = "primary_container"
        elif key == "scalingTarget":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 ingress_paths: Optional[Sequence['outputs.ExpressGatewayServiceIngressPathSummary']] = None,
                 memory: Optional[_builtins.str] = None,
                 network_configuration: Optional['outputs.ExpressGatewayServiceNetworkConfiguration'] = None,
        ...
        :param _builtins.str created_at: The Unix timestamp for when this service revision was created.
        :param _builtins.str execution_role_arn: The ARN of the task execution role for the service revision.
        :param _builtins.str health_check_path: The health check path for this service revision.
        :param Sequence['ExpressGatewayServiceIngressPathSummary'] ingress_paths: The entry point into this service revision.
        :param _builtins.str memory: The memory allocation for tasks in this service revision.
        :param 'ExpressGatewayServiceNetworkConfiguration' network_configuration: The network configuration for tasks in this service revision.
        :param 'ExpressGatewayServiceExpressGatewayContainer' primary_container: The primary container configuration for this service revision.
        :param 'ExpressGatewayServiceExpressGatewayScalingTarget' scaling_target: The auto-scaling configuration for this service revision.
        :param _builtins.str service_revision_arn: The ARN of the service revision.
        :param _builtins.str task_role_arn: The ARN of the task role for the service revision.
        """
        if cpu is not None:
            pulumi.set(__self__, "cpu", cpu)
    ...
    def ingress_paths(self) -> Optional[Sequence['outputs.ExpressGatewayServiceIngressPathSummary']]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="networkConfiguration")
    def network_configuration(self) -> Optional['outputs.ExpressGatewayServiceNetworkConfiguration']:
        """
    ...
    def primary_container(self) -> Optional['outputs.ExpressGatewayServiceExpressGatewayContainer']:
        """
    ...
    def scaling_target(self) -> Optional['outputs.ExpressGatewayServiceExpressGatewayScalingTarget']:
        """
    ...
    def service_revision_arn(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class ExpressGatewayServiceExpressGatewayContainer(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "awsLogsConfiguration":
            suggest = "aws_logs_configuration"
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceExpressGatewayContainer. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceExpressGatewayContainer.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 image: _builtins.str,
                 aws_logs_configuration: Optional['outputs.ExpressGatewayServiceAwsLogsConfiguration'] = None,
                 command: Optional[Sequence[_builtins.str]] = None,
                 container_port: Optional[_builtins.int] = None,
                 environment: Optional[Sequence['outputs.ExpressGatewayServiceKeyValuePair']] = None,
                 repository_credentials: Optional['outputs.ExpressGatewayServiceExpressGatewayRepositoryCredentials'] = None,
                 secrets: Optional[Sequence['outputs.ExpressGatewayServiceSecret']] = None):
        """
        :param _builtins.str image: The image used to start a container. This string is passed directly to the Docker daemon. Images in the Docker Hub registry are available by default. Other repositories are specified with either `repository-url/image:tag` or `repository-url/image@digest` .
        ...
        :param 'ExpressGatewayServiceAwsLogsConfiguration' aws_logs_configuration: The log configuration for the container.
        :param Sequence[_builtins.str] command: The command that is passed to the container.
        :param _builtins.int container_port: The port number on the container that receives traffic from the load balancer. Default is 80.
        :param Sequence['ExpressGatewayServiceKeyValuePair'] environment: The environment variables to pass to the container.
        :param 'ExpressGatewayServiceExpressGatewayRepositoryCredentials' repository_credentials: The configuration for repository credentials for private registry authentication.
        :param Sequence['ExpressGatewayServiceSecret'] secrets: The secrets to pass to the container.
        """
        pulumi.set(__self__, "image", image)
    ...
    def aws_logs_configuration(self) -> Optional['outputs.ExpressGatewayServiceAwsLogsConfiguration']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def environment(self) -> Optional[Sequence['outputs.ExpressGatewayServiceKeyValuePair']]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="repositoryCredentials")
    def repository_credentials(self) -> Optional['outputs.ExpressGatewayServiceExpressGatewayRepositoryCredentials']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def secrets(self) -> Optional[Sequence['outputs.ExpressGatewayServiceSecret']]:
        """
        The secrets to pass to the container.
        """
        return pulumi.get(self, "secrets")
...
@pulumi.output_type
class ExpressGatewayServiceExpressGatewayRepositoryCredentials(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "credentialsParameter":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceExpressGatewayRepositoryCredentials. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceExpressGatewayRepositoryCredentials.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class ExpressGatewayServiceExpressGatewayScalingTarget(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceExpressGatewayScalingTarget. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceExpressGatewayScalingTarget.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 auto_scaling_metric: Optional['ExpressGatewayServiceScalingMetric'] = None,
                 auto_scaling_target_value: Optional[_builtins.int] = None,
                 max_task_count: Optional[_builtins.int] = None,
                 min_task_count: Optional[_builtins.int] = None):
        """
        :param 'ExpressGatewayServiceScalingMetric' auto_scaling_metric: The metric used for auto-scaling decisions. The default metric used for an Express service is `CPUUtilization` .
        :param _builtins.int auto_scaling_target_value: The target value for the auto-scaling metric. The default value for an Express service is 60.
        :param _builtins.int max_task_count: The maximum number of tasks to run in the Express service.
        :param _builtins.int min_task_count: The minimum number of tasks to run in the Express service.
        """
    ...
    def auto_scaling_metric(self) -> Optional['ExpressGatewayServiceScalingMetric']:
        """
    ...
    def auto_scaling_target_value(self) -> Optional[_builtins.int]:
        """
    ...
    def max_task_count(self) -> Optional[_builtins.int]:
        """
    ...
    def min_task_count(self) -> Optional[_builtins.int]:
        """
...
@pulumi.output_type
class ExpressGatewayServiceIngressPathSummary(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "accessType":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceIngressPathSummary. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceIngressPathSummary.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 access_type: Optional['ExpressGatewayServiceAccessType'] = None,
                 endpoint: Optional[_builtins.str] = None):
        """
        :param 'ExpressGatewayServiceAccessType' access_type: The type of access to the endpoint for the Express service.
        :param _builtins.str endpoint: The endpoint for access to the service.
        """
    ...
    def access_type(self) -> Optional['ExpressGatewayServiceAccessType']:
        """
...
@pulumi.output_type
class ExpressGatewayServiceKeyValuePair(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str):
        """
...
class ExpressGatewayServiceNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] security_groups: The IDs of the security groups associated with the Express service.
        :param Sequence[_builtins.str] subnets: The IDs of the subnets associated with the Express service.
        """
...
@pulumi.output_type
class ExpressGatewayServiceSecret(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "valueFrom":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceSecret. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceSecret.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the secret.
        :param _builtins.str value_from: The secret to expose to the container. The supported values are either the full ARN of the AWS Secrets Manager secret or the full ARN of the parameter in the SSM Parameter Store.
...
@pulumi.output_type
class ExpressGatewayServiceStatus(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "statusCode":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExpressGatewayServiceStatus. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExpressGatewayServiceStatus.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 status_code: Optional['ExpressGatewayServiceStatusCode'] = None):
        """
        :param 'ExpressGatewayServiceStatusCode' status_code: The status of the Express service.
        """
    ...
    def status_code(self) -> Optional['ExpressGatewayServiceStatusCode']:
        """
...
class ServiceDeploymentConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "earlySuccessCriteria":
            suggest = "early_success_criteria"
    ...
    def __init__(__self__, *,
                 ...
                 early_success_criteria: Optional['outputs.ServiceDeploymentEarlySuccessCriteria'] = None,
        ...
        :param _builtins.int bake_time_in_minutes: The duration waiting before terminating the previous service revision and marking a deployment complete.
    ...
    def early_success_criteria(self) -> Optional['outputs.ServiceDeploymentEarlySuccessCriteria']:
...
@pulumi.output_type
class ServiceDeploymentEarlySuccessCriteria(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "healthyPercent":
            suggest = "healthy_percent"
        elif key == "sourceServiceRevisionCleanup":
            suggest = "source_service_revision_cleanup"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ServiceDeploymentEarlySuccessCriteria. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ServiceDeploymentEarlySuccessCriteria.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 enable: Optional[_builtins.bool] = None,
                 healthy_percent: Optional[_builtins.int] = None,
                 source_service_revision_cleanup: Optional['ServiceDeploymentEarlySuccessCriteriaSourceServiceRevisionCleanup'] = None):
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
    ...
    def healthy_percent(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "healthy_percent")

    @_builtins.property
    @pulumi.getter(name="sourceServiceRevisionCleanup")
    def source_service_revision_cleanup(self) -> Optional['ServiceDeploymentEarlySuccessCriteriaSourceServiceRevisionCleanup']:
...
class ServiceEbsTagSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ServiceEbsTagSpecificationPropagateTags' propagate_tags: Determines whether to propagate the tags from the task definition to the Amazon EBS volume. Tags can only propagate to a ``SERVICE`` specified in ``ServiceVolumeConfiguration``. If no value is specified, the tags aren't propagated.
...
class ServiceVpcLatticeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str role_arn: The ARN of the IAM role to associate with this VPC Lattice configuration. This is the Amazon ECS infrastructure IAM role that is used to manage your VPC Lattice infrastructure.
...
class TaskDefinitionPortMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str protocol: The protocol that's used for the port mapping. Valid values are ``tcp`` and ``udp`` (case-sensitive). The default is ``tcp``. Amazon ECS treats any other specified value as ``tcp``. ``protocol`` is immutable in a Service Connect service. To update this field, you must delete and redeploy the service.
        """
...
class TaskDefinitionS3FilesVolumeConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TaskDefinitionS3FilesVolumeConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TaskDefinitionS3FilesVolumeConfiguration.__key_warning(key)
        return super().__getitem__(key)
