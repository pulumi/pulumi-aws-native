...
@pulumi.type_token("aws-native:ecs:CapacityProviderCapacityReservationRequestReservationPreference")
class CapacityProviderCapacityReservationRequestReservationPreference(_builtins.str, Enum):
