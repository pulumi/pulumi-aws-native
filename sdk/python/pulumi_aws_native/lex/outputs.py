...
class BotAllowedInputTypes(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the allowed input types.
        :param builtins.bool allow_audio_input: Indicates whether audio input is allowed.
        :param builtins.bool allow_dtmf_input: Indicates whether DTMF input is allowed.
        """
...
class BotAudioAndDtmfInputSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the audio and DTMF input specification.
        :param builtins.int start_timeout_ms: Time for which a bot waits before assuming that the customer isn't going to speak or press a key. This timeout is shared between Audio and DTMF inputs.
        """
...
class BotAudioSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the audio input specifications.
        :param builtins.int end_timeout_ms: Time for which a bot waits after the customer stops speaking to assume the utterance is finished.
        :param builtins.int max_length_ms: Time for how long Amazon Lex waits before speech input is truncated and the speech is returned to application.
        """
...
class BotBedrockModelSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str bedrock_model_custom_prompt: The custom prompt used in the Bedrock model specification details.
...
class BotBedrockModelSpecificationBedrockGuardrailConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The guardrail configuration in the Bedrock model specification details.
        :param builtins.str bedrock_guardrail_identifier: The unique guardrail id for the Bedrock guardrail configuration.
        :param builtins.str bedrock_guardrail_version: The guardrail version for the Bedrock guardrail configuration.
        """
...
class BotButton(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A button to use on a response card used to gather slot values from a user.
        :param builtins.str text: The text that appears on the button.
        :param builtins.str value: The value returned to Amazon Lex when the user chooses this button.
        """
...
class BotCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides an expression that evaluates to true or false.
        :param builtins.str expression_string: The expression string that is evaluated.
        """
...
class BotConditionalSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_active: Determines whether a conditional branch is active. When active is false, the conditions are not evaluated.
        """
...
class BotCustomPayload(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A message in a custom format defined by the client application.
        :param builtins.str value: The string that is sent to your application.
        """
        pulumi.set(__self__, "value", value)
...
class BotCustomVocabularyItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A custom vocabulary item that contains the phrase to recognize and a weight to give the boost.
        :param builtins.str phrase: Phrase that should be recognized.
        :param builtins.str display_as: Defines how you want your phrase to look in your transcription output.
        :param builtins.int weight: The degree to which the phrase recognition is boosted. The weight 0 means that no boosting will be applied and the entry will only be used for performing replacements using the displayAs field.
        """
...
class BotDtmfSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the settings on DTMF input.
        :param builtins.str deletion_character: The DTMF character that clears the accumulated DTMF digits and immediately ends the input.
        :param builtins.str end_character: The DTMF character that immediately ends input. If the user does not press this character, the input ends after the end timeout.
        :param builtins.int end_timeout_ms: How long the bot should wait after the last DTMF character input before assuming that the input has concluded.
        :param builtins.int max_length: The maximum number of DTMF digits allowed in an utterance.
        """
...
class BotGrammarSlotTypeSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the Amazon S3 bucket name and location for the grammar that is the source for the slot type.
        :param builtins.str s3_bucket_name: The name of the S3 bucket that contains the grammar source.
        :param builtins.str s3_object_key: The path to the grammar in the S3 bucket.
        :param builtins.str kms_key_arn: The Amazon KMS key required to decrypt the contents of the grammar, if any.
        """
...
class BotImageResponseCard(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A message that defines a response card that the client application can show to the user.
        :param builtins.str title: The title to display on the response card.
        :param Sequence['BotButton'] buttons: A list of buttons that should be displayed on the response card.
        :param builtins.str image_url: The URL of an image to display on the response card.
        :param builtins.str subtitle: The subtitle to display on the response card.
        """
...
class BotInputContext(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        InputContext specified for the intent.
        :param builtins.str name: The name of the context.
        """
        pulumi.set(__self__, "name", name)
...
class BotIntent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an action that the user wants to perform.
        :param builtins.str name: The name of the intent.
...
class BotIntentClosingSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_active: Specifies whether an intent's closing response is used. When this field is false, the closing response isn't sent to the user. If the active field isn't specified, the default is true.
...
class BotIntentConfirmationSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_active: Specifies whether the intent's confirmation is sent to the user. When this field is false, confirmation and declination responses aren't sent. If the active field isn't specified, the default is true.
        """
...
class BotPlainTextMessage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A message in plain text format.
        :param builtins.str value: The message to send to the user.
        """
        pulumi.set(__self__, "value", value)
...
class BotPromptAttemptSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the settings on a prompt attempt.
        :param builtins.bool allow_interrupt: Indicates whether the user can interrupt a speech prompt attempt from the bot.
        """
...
class BotQnAIntentConfigurationDataSourceConfigurationPropertiesBedrockKnowledgeStoreConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains details about the configuration of a Amazon Bedrock knowledge base.
        :param builtins.str bedrock_knowledge_base_arn: The base ARN of the knowledge base used.
        ...
        :param builtins.bool exact_response: Specifies whether to return an exact response, or to return an answer generated by the model, using the fields you specify from the database.
        """
...
class BotQnAIntentConfigurationDataSourceConfigurationPropertiesBedrockKnowledgeStoreConfigurationPropertiesBkbExactResponseFieldsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains the names of the fields used for an exact response to the user.
        :param builtins.str answer_field: The answer field used for an exact response from Bedrock Knowledge Store.
        """
...
class BotQnAIntentConfigurationDataSourceConfigurationPropertiesOpensearchConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains details about the configuration of the Amazon OpenSearch Service database used for the AMAZON.QnAIntent.
        :param builtins.str domain_endpoint: The endpoint of the Amazon OpenSearch Service domain.
        :param builtins.bool exact_response: Specifies whether to return an exact response or to return an answer generated by the model using the fields you specify from the database.
        ...
        :param Sequence[builtins.str] include_fields: List of fields to include
        :param builtins.str index_name: The name of the Amazon OpenSearch Service index.
        """
...
class BotQnAIntentConfigurationDataSourceConfigurationPropertiesOpensearchConfigurationPropertiesExactResponseFieldsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains the names of the fields used for an exact response to the user.
        :param builtins.str answer_field: The name of the field that contains the answer to the query made to the OpenSearch Service database.
        :param builtins.str question_field: The name of the field that contains the query made to the OpenSearch Service database.
        """
        if answer_field is not None:
            pulumi.set(__self__, "answer_field", answer_field)
...
class BotQnAKendraConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains details about the configuration of the Amazon Kendra index used for the AMAZON.QnAIntent.
        :param builtins.bool exact_response: Specifies whether to return an exact response from the Amazon Kendra index or to let the Amazon Bedrock model you select generate a response based on the results.
        ...
        :param builtins.str query_filter_string: Contains the Amazon Kendra filter string to use if enabled.
        """
        pulumi.set(__self__, "exact_response", exact_response)
        pulumi.set(__self__, "kendra_index", kendra_index)
        pulumi.set(__self__, "query_filter_string_enabled", query_filter_string_enabled)
...
class BotReplication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameter used to create a replication of the source bot in the secondary region.
        :param Sequence[builtins.str] replica_regions: List of secondary regions for bot replication.
        """
...
class BotS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_object_key: The Amazon S3 key of the deployment package.
        :param builtins.str s3_object_version: For versioned objects, the version of the deployment package object to use. If not specified, the current object version will be used.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_object_key", s3_object_key)
...
class BotSampleValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines one of the values for a slot type.
        :param builtins.str value: The value that can be used for a slot type.
        """
        pulumi.set(__self__, "value", value)
...
class BotSlotValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The value to set in a slot.
        :param builtins.str interpreted_value: The value that Amazon Lex determines for the slot.
        """
...
class BotSlotValueRegexFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A regular expression used to validate the value of a slot.
        :param builtins.str pattern: Regex pattern
        """
...
class BotSsmlMessage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A message in Speech Synthesis Markup Language (SSML).
        :param builtins.str value: The SSML text that defines the prompt.
        """
        pulumi.set(__self__, "value", value)
...
class BotTextInputSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the text input specifications.
        :param builtins.int start_timeout_ms: Time for which a bot waits before re-prompting a customer for text input.
        """
        pulumi.set(__self__, "start_timeout_ms", start_timeout_ms)
...
class BotVoiceSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings for using an Amazon Polly voice to communicate with a user.
        :param builtins.str voice_id: The Amazon Polly voice ID that Amazon Lex uses for voice interaction with the user.
...
class BotWaitAndContinueSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_active: Specifies whether the bot will wait for a user to respond.
