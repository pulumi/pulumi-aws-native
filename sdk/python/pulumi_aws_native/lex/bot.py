...
class BotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] idle_session_ttl_in_seconds: IdleSessionTTLInSeconds of the resource
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role used to build and run the bot.
        :param pulumi.Input[builtins.bool] auto_build_bot_locales: Specifies whether to build the bot locales after bot creation completes.
