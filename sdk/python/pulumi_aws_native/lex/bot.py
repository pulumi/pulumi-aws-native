...
class BotArgs:
    def __init__(__self__, *,
                 ...
                 auto_build_bot_locales: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] idle_session_ttl_in_seconds: The time, in seconds, that Amazon Lex should keep information about a user's conversation with the bot.
               
               A user interaction remains active for the amount of time specified. If no conversation occurs during this time, the session expires and Amazon Lex deletes any data provided before the timeout.
               
               You can specify between 60 (1 minute) and 86,400 (24 hours) seconds.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role used to build and run the bot.
        :param pulumi.Input[builtins.bool] auto_build_bot_locales: Indicates whether Amazon Lex V2 should automatically build the locales for the bot after a change.
        ...
        :param pulumi.Input[builtins.str] name: The name of the bot locale.
    ...
    def auto_build_bot_locales(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_build_bot_locales(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Bot(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoBuildBotLocales")
    def auto_build_bot_locales(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether Amazon Lex V2 should automatically build the locales for the bot after a change.
        """
        return pulumi.get(self, "auto_build_bot_locales")
