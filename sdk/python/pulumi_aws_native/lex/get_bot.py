...
class GetBotResult:
    ...
    def idle_session_ttl_in_seconds(self) -> Optional[builtins.int]:
        """
...
def get_bot(id: Optional[builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBotResult:
    """
    Amazon Lex conversational bot performing automated tasks such as ordering a pizza, booking a hotel, and so on.


    :param builtins.str id: The unique identifier of the bot.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_bot_output(id: Optional[pulumi.Input[builtins.str]] = None,
