...
if not MYPY:
    class BotBedrockAgentIntentConfigurationBedrockAgentConfigurationPropertiesArgsDict(TypedDict):
        bedrock_agent_alias_id: NotRequired[pulumi.Input[builtins.str]]
        bedrock_agent_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class BotBedrockAgentIntentConfigurationBedrockAgentConfigurationPropertiesArgs:
    def __init__(__self__, *,
                 bedrock_agent_alias_id: Optional[pulumi.Input[builtins.str]] = None,
                 bedrock_agent_id: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def bedrock_agent_alias_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bedrock_agent_alias_id")

    @bedrock_agent_alias_id.setter
    def bedrock_agent_alias_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bedrock_agent_alias_id", value)

    @property
    @pulumi.getter(name="bedrockAgentId")
    def bedrock_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bedrock_agent_id")

    @bedrock_agent_id.setter
    def bedrock_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BotBedrockAgentIntentConfigurationBedrockAgentIntentKnowledgeBaseConfigurationPropertiesArgsDict(TypedDict):
        bedrock_knowledge_base_arn: pulumi.Input[builtins.str]
...
class BotBedrockAgentIntentConfigurationBedrockAgentIntentKnowledgeBaseConfigurationPropertiesArgs:
    ...
    def bedrock_knowledge_base_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "bedrock_knowledge_base_arn")

    @bedrock_knowledge_base_arn.setter
    def bedrock_knowledge_base_arn(self, value: pulumi.Input[builtins.str]):
...
class BotConditionalSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_active: Determines whether a conditional branch is active. When `IsActive` is false, the conditions are not evaluated.
        """
...
class BotGrammarSlotTypeSourceArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_bucket_name: The name of the Amazon S3 bucket that contains the grammar source.
        :param pulumi.Input[builtins.str] s3_object_key: The path to the grammar in the Amazon S3 bucket.
        :param pulumi.Input[builtins.str] kms_key_arn: The AWS KMS key required to decrypt the contents of the grammar, if any.
        """
...
class BotIntentClosingSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_active: Specifies whether an intent's closing response is used. When this field is false, the closing response isn't sent to the user. If the `IsActive` field isn't specified, the default is true.
...
class BotIntentConfirmationSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_active: Specifies whether the intent's confirmation is sent to the user. When this field is false, confirmation and declination responses aren't sent. If the `IsActive` field isn't specified, the default is true.
        """
...
class BotIntentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the intent. Intent names must be unique within the locale that contains the intent and can't match the name of any built-in intent.
...
if not MYPY:
    class BotQInConnectIntentConfigurationQInConnectAssistantConfigurationPropertiesArgsDict(TypedDict):
        assistant_arn: pulumi.Input[builtins.str]
elif False:
...
class BotQInConnectIntentConfigurationQInConnectAssistantConfigurationPropertiesArgs:
    ...
    def assistant_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "assistant_arn")

    @assistant_arn.setter
    def assistant_arn(self, value: pulumi.Input[builtins.str]):
...
class BotQnAKendraConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 query_filter_string: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] exact_response: Specifies whether to return an exact response from the Amazon Kendra index or to let the Amazon Bedrock model you select generate a response based on the results. To use this feature, you must first add FAQ questions to your index by following the steps at [Adding frequently asked questions (FAQs) to an index](https://docs.aws.amazon.com/kendra/latest/dg/in-creating-faq.html) .
        ...
        :param pulumi.Input[builtins.str] query_filter_string: Contains the Amazon Kendra filter string to use if enabled. For more information on the Amazon Kendra search filter JSON format, see [Using document attributes to filter search results](https://docs.aws.amazon.com/kendra/latest/dg/filtering.html#search-filtering) .
        """
        pulumi.set(__self__, "exact_response", exact_response)
        pulumi.set(__self__, "kendra_index", kendra_index)
        pulumi.set(__self__, "query_filter_string_enabled", query_filter_string_enabled)
...
class BotResponseSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_interrupt: Indicates whether the user can interrupt a speech response from Amazon Lex.
        """
        pulumi.set(__self__, "message_groups_list", message_groups_list)
        if allow_interrupt is not None:
            pulumi.set(__self__, "allow_interrupt", allow_interrupt)
...
class BotS3LocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_bucket: The S3 bucket name.
        :param pulumi.Input[builtins.str] s3_object_key: The path and file name to the object in the S3 bucket.
        :param pulumi.Input[builtins.str] s3_object_version: The version of the object in the S3 bucket.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_object_key", s3_object_key)
...
class BotSlotValueRegexFilterArgs:
    def __init__(__self__, *,
                 pattern: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pattern: A regular expression used to validate the value of a slot.
...
class BotSlotValueArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] interpreted_value: The value that Amazon Lex determines for the slot. The actual value depends on the setting of the value selection strategy for the bot. You can choose to use the value entered by the user, or you can have Amazon Lex choose the first value in the `resolvedValues` list.
        """
...
class BotStillWaitingResponseSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_interrupt: Indicates that the user can interrupt the response by speaking while the message is being played.
        """
        pulumi.set(__self__, "frequency_in_seconds", frequency_in_seconds)
        pulumi.set(__self__, "message_groups_list", message_groups_list)
        pulumi.set(__self__, "timeout_in_seconds", timeout_in_seconds)
...
class BotVoiceSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] voice_id: The identifier of the Amazon Polly voice to use.
...
class BotWaitAndContinueSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_active: Specifies whether the bot will wait for a user to respond. When this field is false, wait and continue responses for a slot aren't used. If the `IsActive` field isn't specified, the default is true.
