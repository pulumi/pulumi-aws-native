...
class Assessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(assessment_reports_destination, AssessmentReportsDestinationArgs):
            ...
            if not isinstance(aws_account, AssessmentAwsAccountArgs):
            ...
            if not isinstance(scope, AssessmentScopeArgs):
                scope = scope or {}
                def _setter(key, value):
                    scope[key] = value
