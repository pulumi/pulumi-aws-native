...
class AssessmentAwsAccountArgs:
    def __init__(__self__, *,
        ...
        """
        The AWS account associated with the assessment.
        :param pulumi.Input[builtins.str] email_address: The email address that's associated with the AWS account .
        :param pulumi.Input[builtins.str] id: The identifier for the AWS account .
        :param pulumi.Input[builtins.str] name: The name of the AWS account .
        """
...
class AssessmentAwsServiceArgs:
    def __init__(__self__, *,
        ...
        """
        An AWS service such as Amazon S3, AWS CloudTrail, and so on.
        :param pulumi.Input[builtins.str] service_name: The name of the AWS service .
        """
...
if not MYPY:
    class AssessmentDelegationArgsDict(TypedDict):
        ...
        """
        assessment_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The identifier for the assessment that's associated with the delegation.
        """
        assessment_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        control_set_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        *Pattern* : `^[a-zA-Z0-9-_()\\\\[\\\\]\\\\s]+$`
        """
        creation_time: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        last_updated: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AssessmentDelegationArgs:
    def __init__(__self__, *,
                 ...
                 creation_time: Optional[pulumi.Input[builtins.float]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 last_updated: Optional[pulumi.Input[builtins.float]] = None,
        ...
        """
        The assignment of a control set to a delegate for review.
        :param pulumi.Input[builtins.str] assessment_id: The identifier for the assessment that's associated with the delegation.
        :param pulumi.Input[builtins.str] assessment_name: The name of the assessment that's associated with the delegation.
        :param pulumi.Input[builtins.str] comment: The comment that's related to the delegation.
        :param pulumi.Input[builtins.str] control_set_id: The identifier for the control set that's associated with the delegation.
        :param pulumi.Input[builtins.str] created_by: The user or role that created the delegation.
               ...
               *Pattern* : `^[a-zA-Z0-9-_()\\\\[\\\\]\\\\s]+$`
        :param pulumi.Input[builtins.float] creation_time: Specifies when the delegation was created.
        :param pulumi.Input[builtins.str] id: The unique identifier for the delegation.
        :param pulumi.Input[builtins.float] last_updated: Specifies when the delegation was last updated.
    ...
    def creation_time(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies when the delegation was created.
        """
    ...
    def creation_time(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def last_updated(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies when the delegation was last updated.
        """
    ...
    @last_updated.setter
    def last_updated(self, value: Optional[pulumi.Input[builtins.float]]):
...
class AssessmentReportsDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        The destination in which evidence reports are stored for the specified assessment.
        :param pulumi.Input[builtins.str] destination: The destination bucket where Audit Manager stores assessment reports.
