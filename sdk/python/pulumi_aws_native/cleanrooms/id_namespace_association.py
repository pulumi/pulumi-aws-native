...
class IdNamespaceAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] membership_identifier: The unique identifier of the membership that contains the ID namespace association.
        :param pulumi.Input[builtins.str] description: The description of the ID namespace association.
        ...
        :param pulumi.Input[builtins.str] name: The name of this ID namespace association.
...
class IdNamespaceAssociation(pulumi.CustomResource):
    ...
    def id_namespace_association_identifier(self) -> pulumi.Output[builtins.str]:
        """
