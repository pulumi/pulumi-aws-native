...
class GetIdNamespaceAssociationResult:
    ...
    def id_namespace_association_identifier(self) -> Optional[builtins.str]:
        """
...
def get_id_namespace_association(id_namespace_association_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str id_namespace_association_identifier: The unique identifier of the ID namespace association that you want to retrieve.
    :param builtins.str membership_identifier: The unique identifier of the membership that contains the ID namespace association.
    """
    __args__ = dict()
...
def get_id_namespace_association_output(id_namespace_association_identifier: Optional[pulumi.Input[builtins.str]] = None,
