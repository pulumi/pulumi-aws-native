...
class GetIdNamespaceAssociationResult:
    ...
    def id_namespace_association_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_id_namespace_association(id_namespace_association_identifier: Optional[_builtins.str] = None,
