...
class IdMappingTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] membership_identifier: The unique identifier of the membership resource for the ID mapping table.
        :param pulumi.Input[builtins.str] description: The description of the ID mapping table.
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) of the AWS KMS key.
        :param pulumi.Input[builtins.str] name: The name of the ID mapping table.
...
class IdMappingTable(pulumi.CustomResource):
    ...
    def id_mapping_table_identifier(self) -> pulumi.Output[builtins.str]:
        """
