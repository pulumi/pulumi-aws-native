...
class AnalysisTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        AnalysisTemplateArgs._configure(
    ...
    def _configure(
        ...
        if analysis_parameters is not None:
            _setter("analysis_parameters", analysis_parameters)
...
class AnalysisTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AnalysisTemplateArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(source, AnalysisTemplateAnalysisSourceArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
