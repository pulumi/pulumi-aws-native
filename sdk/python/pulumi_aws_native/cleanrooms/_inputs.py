...
class AnalysisTemplateAnalysisParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the parameter. The name must use only alphanumeric, underscore (_), or hyphen (-) characters but cannot start or end with a hyphen.
        :param pulumi.Input['AnalysisTemplateAnalysisParameterType'] type: The type of parameter.
        :param pulumi.Input[builtins.str] default_value: Optional. The default value that is applied in the analysis template. The member who can query can override this value in the query editor.
        """
...
if not MYPY:
    class AnalysisTemplateAnalysisSchemaArgsDict(TypedDict):
        referenced_tables: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class AnalysisTemplateAnalysisSchemaArgs:
    def __init__(__self__, *,
                 referenced_tables: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] referenced_tables: The tables referenced in the analysis schema.
        """
        pulumi.set(__self__, "referenced_tables", referenced_tables)

    @property
    @pulumi.getter(name="referencedTables")
    def referenced_tables(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The tables referenced in the analysis schema.
        """
    ...
    def referenced_tables(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class CollaborationDataEncryptionMetadataArgsDict(TypedDict):
        allow_cleartext: pulumi.Input[builtins.bool]
        """
...
class CollaborationDataEncryptionMetadataArgs:
    def __init__(__self__, *,
                 ...
                 preserve_nulls: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] allow_cleartext: Indicates whether encrypted tables can contain cleartext data ( `TRUE` ) or are to cryptographically process every column ( `FALSE` ).
        :param pulumi.Input[builtins.bool] allow_duplicates: Indicates whether Fingerprint columns can contain duplicate entries ( `TRUE` ) or are to contain only non-repeated values ( `FALSE` ).
        :param pulumi.Input[builtins.bool] allow_joins_on_columns_with_different_names: Indicates whether Fingerprint columns can be joined on any other Fingerprint column with a different name ( `TRUE` ) or can only be joined on Fingerprint columns of the same name ( `FALSE` ).
        :param pulumi.Input[builtins.bool] preserve_nulls: Indicates whether NULL values are to be copied as NULL to encrypted tables ( `TRUE` ) or cryptographically processed ( `FALSE` ).
        """
    ...
    def allow_cleartext(self) -> pulumi.Input[builtins.bool]:
        """
        Indicates whether encrypted tables can contain cleartext data ( `TRUE` ) or are to cryptographically process every column ( `FALSE` ).
        """
    ...
    def allow_cleartext(self, value: pulumi.Input[builtins.bool]):
...
class CollaborationJobComputePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration creator has configured the collaboration member to pay for query and job compute costs ( `TRUE` ) or has not configured the collaboration member to pay for query and job compute costs ( `FALSE` ).
...
class CollaborationMemberSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] account_id: The identifier used to reference members of the collaboration. Currently only supports AWS account ID.
        :param pulumi.Input[builtins.str] display_name: The member's display name.
...
class CollaborationModelInferencePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration creator has configured the collaboration member to pay for model inference costs ( `TRUE` ) or has not configured the collaboration member to pay for model inference costs ( `FALSE` ).
...
class CollaborationModelTrainingPaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration creator has configured the collaboration member to pay for model training costs ( `TRUE` ) or has not configured the collaboration member to pay for model training costs ( `FALSE` ).
...
class CollaborationQueryComputePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration creator has configured the collaboration member to pay for query compute costs ( `TRUE` ) or has not configured the collaboration member to pay for query compute costs ( `FALSE` ).
...
if not MYPY:
    class ConfiguredTableAggregateColumnArgsDict(TypedDict):
        column_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
...
class ConfiguredTableAggregateColumnArgs:
    ...
    def column_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "column_names")

    @column_names.setter
    def column_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ConfiguredTableAggregationConstraintArgsDict(TypedDict):
        ...
        minimum: pulumi.Input[builtins.float]
...
class ConfiguredTableAggregationConstraintArgs:
    ...
    @property
    @pulumi.getter
    def minimum(self) -> pulumi.Input[builtins.float]:
        return pulumi.get(self, "minimum")

    @minimum.setter
    def minimum(self, value: pulumi.Input[builtins.float]):
...
if not MYPY:
    class ConfiguredTableAnalysisRuleAggregationArgsDict(TypedDict):
        ...
        dimension_columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        join_columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
...
class ConfiguredTableAnalysisRuleAggregationArgs:
    ...
    def dimension_columns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "dimension_columns")

    @dimension_columns.setter
    def dimension_columns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "dimension_columns", value)

    @property
    @pulumi.getter(name="joinColumns")
    def join_columns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "join_columns")

    @join_columns.setter
    def join_columns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ConfiguredTableAnalysisRuleCustomArgsDict(TypedDict):
        allowed_analyses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        additional_analyses: NotRequired[pulumi.Input['ConfiguredTableAdditionalAnalyses']]
        allowed_analysis_providers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        differential_privacy: NotRequired[pulumi.Input['ConfiguredTableDifferentialPrivacyArgsDict']]
        disallowed_output_columns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class ConfiguredTableAnalysisRuleCustomArgs:
    def __init__(__self__, *,
                 allowed_analyses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 additional_analyses: Optional[pulumi.Input['ConfiguredTableAdditionalAnalyses']] = None,
                 allowed_analysis_providers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 differential_privacy: Optional[pulumi.Input['ConfiguredTableDifferentialPrivacyArgs']] = None,
                 disallowed_output_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
    ...
    def allowed_analyses(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "allowed_analyses")

    @allowed_analyses.setter
    def allowed_analyses(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def allowed_analysis_providers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "allowed_analysis_providers")

    @allowed_analysis_providers.setter
    def allowed_analysis_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def disallowed_output_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "disallowed_output_columns")

    @disallowed_output_columns.setter
    def disallowed_output_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ConfiguredTableAnalysisRuleListArgsDict(TypedDict):
        join_columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        list_columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        additional_analyses: NotRequired[pulumi.Input['ConfiguredTableAdditionalAnalyses']]
        allowed_join_operators: NotRequired[pulumi.Input[Sequence[pulumi.Input['ConfiguredTableJoinOperator']]]]
elif False:
...
class ConfiguredTableAnalysisRuleListArgs:
    ...
    def list_columns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "list_columns")

    @list_columns.setter
    def list_columns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ConfiguredTableAssociationAnalysisRuleAggregationArgsDict(TypedDict):
        allowed_additional_analyses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        allowed_result_receivers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class ConfiguredTableAssociationAnalysisRuleAggregationArgs:
    def __init__(__self__, *,
                 allowed_additional_analyses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allowed_result_receivers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
    ...
    def allowed_additional_analyses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "allowed_additional_analyses")

    @allowed_additional_analyses.setter
    def allowed_additional_analyses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_additional_analyses", value)

    @property
    @pulumi.getter(name="allowedResultReceivers")
    def allowed_result_receivers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "allowed_result_receivers")

    @allowed_result_receivers.setter
    def allowed_result_receivers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ConfiguredTableAthenaTableReferenceArgsDict(TypedDict):
        ...
        work_group: pulumi.Input[builtins.str]
...
class ConfiguredTableAthenaTableReferenceArgs:
    ...
    def work_group(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "work_group")

    @work_group.setter
    def work_group(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ConfiguredTableSnowflakeTableSchemaV1ArgsDict(TypedDict):
        column_name: pulumi.Input[builtins.str]
        column_type: pulumi.Input[builtins.str]
elif False:
...
class ConfiguredTableSnowflakeTableSchemaV1Args:
    ...
    def column_type(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "column_type")

    @column_type.setter
    def column_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IdMappingTableInputReferenceConfigArgsDict(TypedDict):
        input_reference_arn: pulumi.Input[builtins.str]
        """
        ...
        """
        manage_resource_policies: pulumi.Input[builtins.bool]
        """
...
class IdMappingTableInputReferenceConfigArgs:
    def __init__(__self__, *,
                 ...
                 manage_resource_policies: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] input_reference_arn: The Amazon Resource Name (ARN) of the referenced resource in AWS Entity Resolution . Valid values are ID mapping workflow ARNs.
        :param pulumi.Input[builtins.bool] manage_resource_policies: When `TRUE` , AWS Clean Rooms manages permissions for the ID mapping table resource.
    ...
    def input_reference_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the referenced resource in AWS Entity Resolution . Valid values are ID mapping workflow ARNs.
        """
    ...
    def input_reference_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "input_reference_arn", value)

    @property
    @pulumi.getter(name="manageResourcePolicies")
    def manage_resource_policies(self) -> pulumi.Input[builtins.bool]:
        """
        When `TRUE` , AWS Clean Rooms manages permissions for the ID mapping table resource.
    ...
    def manage_resource_policies(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "manage_resource_policies", value)


if not MYPY:
    class IdNamespaceAssociationIdMappingConfigArgsDict(TypedDict):
        allow_use_as_dimension_column: pulumi.Input[builtins.bool]
        """
...
class IdNamespaceAssociationIdMappingConfigArgs:
    def __init__(__self__, *,
                 allow_use_as_dimension_column: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] allow_use_as_dimension_column: An indicator as to whether you can use your column as a dimension column in the ID mapping table ( `TRUE` ) or not ( `FALSE` ).
    ...
    def allow_use_as_dimension_column(self) -> pulumi.Input[builtins.bool]:
        """
        An indicator as to whether you can use your column as a dimension column in the ID mapping table ( `TRUE` ) or not ( `FALSE` ).
    ...
    def allow_use_as_dimension_column(self, value: pulumi.Input[builtins.bool]):
...
class IdNamespaceAssociationInputReferenceConfigArgs:
    def __init__(__self__, *,
                 ...
                 manage_resource_policies: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] input_reference_arn: The Amazon Resource Name (ARN) of the AWS Entity Resolution resource that is being associated to the collaboration. Valid resource ARNs are from the ID namespaces that you own.
        :param pulumi.Input[builtins.bool] manage_resource_policies: When `TRUE` , AWS Clean Rooms manages permissions for the ID namespace association resource.
...
class MembershipJobComputePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration member has accepted to pay for job compute costs ( `TRUE` ) or has not accepted to pay for query and job compute costs ( `FALSE` ).
...
class MembershipModelInferencePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration member has accepted to pay for model inference costs ( `TRUE` ) or has not accepted to pay for model inference costs ( `FALSE` ).
...
class MembershipModelTrainingPaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration member has accepted to pay for model training costs ( `TRUE` ) or has not accepted to pay for model training costs ( `FALSE` ).
...
class MembershipProtectedJobResultConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The unique ARN for an IAM role that is used by AWS Clean Rooms to write protected job results to the result location, given by the member who can receive results.
        """
...
class MembershipProtectedJobS3OutputConfigurationInputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The S3 bucket for job output.
        :param pulumi.Input[builtins.str] key_prefix: The S3 prefix to unload the protected job results.
        """
        pulumi.set(__self__, "bucket", bucket)
...
class MembershipProtectedQueryResultConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The unique ARN for an IAM role that is used by AWS Clean Rooms to write protected query results to the result location, given by the member who can receive results.
        """
        pulumi.set(__self__, "output_configuration", output_configuration)
...
if not MYPY:
    class MembershipProtectedQueryS3OutputConfigurationArgsDict(TypedDict):
        ...
        """
        single_file_output: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class MembershipProtectedQueryS3OutputConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 result_format: pulumi.Input['MembershipResultFormat'],
                 key_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 single_file_output: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: The S3 bucket to unload the protected query results.
        :param pulumi.Input['MembershipResultFormat'] result_format: Intended file format of the result.
        :param pulumi.Input[builtins.str] key_prefix: The S3 prefix to unload the protected query results.
        :param pulumi.Input[builtins.bool] single_file_output: Indicates whether files should be output as a single file ( `TRUE` ) or output as multiple files ( `FALSE` ). This parameter is only supported for analyses with the Spark analytics engine.
        """
        pulumi.set(__self__, "bucket", bucket)
    ...
    def single_file_output(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether files should be output as a single file ( `TRUE` ) or output as multiple files ( `FALSE` ). This parameter is only supported for analyses with the Spark analytics engine.
        """
    ...
    def single_file_output(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MembershipQueryComputePaymentConfigArgs:
    def __init__(__self__, *,
                 is_responsible: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_responsible: Indicates whether the collaboration member has accepted to pay for query compute costs ( `TRUE` ) or has not accepted to pay for query compute costs ( `FALSE` ).
...
if not MYPY:
    class ParametersPropertiesArgsDict(TypedDict):
        ...
        """
        epsilon: pulumi.Input[builtins.int]
        """
        The epsilon value that you want to use.
        """
        users_noise_per_query: pulumi.Input[builtins.int]
        """
...
class ParametersPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the epsilon and noise parameters for the privacy budget template.
        :param pulumi.Input[builtins.int] epsilon: The epsilon value that you want to use.
        :param pulumi.Input[builtins.int] users_noise_per_query: Noise added per query is measured in terms of the number of users whose contributions you want to obscure. This value governs the rate at which the privacy budget is depleted.
        """
    ...
    @property
    @pulumi.getter
    def epsilon(self) -> pulumi.Input[builtins.int]:
        """
        The epsilon value that you want to use.
        """
    ...
    @epsilon.setter
    def epsilon(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "epsilon", value)

    @property
    @pulumi.getter(name="usersNoisePerQuery")
    def users_noise_per_query(self) -> pulumi.Input[builtins.int]:
        """
        Noise added per query is measured in terms of the number of users whose contributions you want to obscure. This value governs the rate at which the privacy budget is depleted.
        """
    ...
    def users_noise_per_query(self, value: pulumi.Input[builtins.int]):
