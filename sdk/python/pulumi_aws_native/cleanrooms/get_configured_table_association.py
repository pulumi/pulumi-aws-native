...
class GetConfiguredTableAssociationResult:
    ...
    def configured_table_association_identifier(self) -> Optional[builtins.str]:
        """
...
def get_configured_table_association(configured_table_association_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str configured_table_association_identifier: Returns the unique identifier of the specified configured table association.
           
           Example: `a1b2c3d4-5678-90ab-cdef-EXAMPLE33333`
    :param builtins.str membership_identifier: The unique ID for the membership this configured table association belongs to.
    """
    __args__ = dict()
...
def get_configured_table_association_output(configured_table_association_identifier: Optional[pulumi.Input[builtins.str]] = None,
