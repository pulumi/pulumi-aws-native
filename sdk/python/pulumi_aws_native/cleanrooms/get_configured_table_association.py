...
class GetConfiguredTableAssociationResult:
    ...
    def configured_table_association_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_configured_table_association(configured_table_association_identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str configured_table_association_identifier: Returns the unique identifier of the specified configured table association.
           ...
           Example: `a1b2c3d4-5678-90ab-cdef-EXAMPLE33333`
    :param _builtins.str membership_identifier: The unique ID for the membership this configured table association belongs to.
    """
    __args__ = dict()
