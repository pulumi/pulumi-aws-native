...
class GetPrivacyBudgetTemplateResult:
    ...
    def privacy_budget_template_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_privacy_budget_template(membership_identifier: Optional[_builtins.str] = None,
                                privacy_budget_template_identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str privacy_budget_template_identifier: A unique identifier for one of your memberships for a collaboration. The privacy budget template is created in the collaboration that this membership belongs to. Accepts a membership ID.
    """
    __args__ = dict()
