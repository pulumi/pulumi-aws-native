...
class GetPrivacyBudgetTemplateResult:
    ...
    def privacy_budget_template_identifier(self) -> Optional[builtins.str]:
        """
...
def get_privacy_budget_template(membership_identifier: Optional[builtins.str] = None,
                                privacy_budget_template_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str privacy_budget_template_identifier: A unique identifier for one of your memberships for a collaboration. The privacy budget template is created in the collaboration that this membership belongs to. Accepts a membership ID.
    """
    __args__ = dict()
...
def get_privacy_budget_template_output(membership_identifier: Optional[pulumi.Input[builtins.str]] = None,
                                       privacy_budget_template_identifier: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetPrivacyBudgetTemplateResult(
        ...
        privacy_budget_template_identifier=pulumi.get(__response__, 'privacy_budget_template_identifier'),
