...
def get_cross_account_attachment(attachment_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str attachment_arn: The Amazon Resource Name (ARN) of the attachment.
    """
    __args__ = dict()
...
def get_cross_account_attachment_output(attachment_arn: Optional[pulumi.Input[builtins.str]] = None,
