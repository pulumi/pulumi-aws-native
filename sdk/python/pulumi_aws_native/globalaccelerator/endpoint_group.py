...
class EndpointGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] health_check_interval_seconds: The time in seconds between each health check for an endpoint. Must be a value of 10 or 30
        :param pulumi.Input[builtins.str] health_check_path: If the protocol is HTTP/S, then this value provides the ping path that Global Accelerator uses for the destination on the endpoints for health checks. The default is slash (/).
        :param pulumi.Input[builtins.int] health_check_port: The port that AWS Global Accelerator uses to check the health of endpoints in this endpoint group.
        ...
        :param pulumi.Input[builtins.int] threshold_count: The number of consecutive health checks required to set the state of the endpoint to unhealthy.
        :param pulumi.Input[builtins.float] traffic_dial_percentage: The percentage of traffic to sent to an AWS Region
        """
...
class EndpointGroup(pulumi.CustomResource):
    ...
    def endpoint_group_arn(self) -> pulumi.Output[builtins.str]:
        """
