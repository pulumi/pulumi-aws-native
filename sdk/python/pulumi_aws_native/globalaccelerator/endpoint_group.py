...
class EndpointGroupArgs:
    ...
    def health_check_protocol(self) -> pulumi.Input[Optional['EndpointGroupHealthCheckProtocol']]:
        """
    ...
    def health_check_protocol(self, value: pulumi.Input[Optional['EndpointGroupHealthCheckProtocol']]):
