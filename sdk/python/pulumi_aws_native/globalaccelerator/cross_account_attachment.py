...
class CrossAccountAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The Friendly identifier of the attachment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] principals: Principals to share the resources with.
...
class CrossAccountAttachment(pulumi.CustomResource):
    ...
    def attachment_arn(self) -> pulumi.Output[builtins.str]:
        """
