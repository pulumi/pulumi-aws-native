...
class GetEndpointGroupResult:
    ...
    def endpoint_group_arn(self) -> Optional[builtins.str]:
        """
    ...
    def threshold_count(self) -> Optional[builtins.int]:
        """
    ...
    def traffic_dial_percentage(self) -> Optional[builtins.float]:
        """
...
def get_endpoint_group(endpoint_group_arn: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEndpointGroupResult:
    """
    Resource Type definition for AWS::GlobalAccelerator::EndpointGroup


    :param builtins.str endpoint_group_arn: The Amazon Resource Name (ARN) of the endpoint group
    """
    __args__ = dict()
...
def get_endpoint_group_output(endpoint_group_arn: Optional[pulumi.Input[builtins.str]] = None,
