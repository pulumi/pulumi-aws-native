...
class GetAcceleratorResult:
    ...
    def accelerator_arn(self) -> Optional[builtins.str]:
        """
    ...
    def dual_stack_dns_name(self) -> Optional[builtins.str]:
        """
...
def get_accelerator(accelerator_arn: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAcceleratorResult:
    """
    Resource Type definition for AWS::GlobalAccelerator::Accelerator


    :param builtins.str accelerator_arn: The Amazon Resource Name (ARN) of the accelerator.
    """
    __args__ = dict()
...
def get_accelerator_output(accelerator_arn: Optional[pulumi.Input[builtins.str]] = None,
