...
class AcceleratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Indicates whether an accelerator is enabled. The value is true or false.
        :param pulumi.Input['AcceleratorIpAddressType'] ip_address_type: IP Address type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: The IP addresses from BYOIP Prefix pool.
        :param pulumi.Input[builtins.str] name: Name of accelerator.
