...
class ApplicationAlarm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A CloudWatch alarm to be monitored for the component.
        :param builtins.str alarm_name: The name of the CloudWatch alarm to be monitored for the component.
...
class ApplicationAlarmMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A metric to be monitored for the component.
        :param builtins.str alarm_metric_name: The name of the metric to be monitored for the component.
        """
...
class ApplicationComponentMonitoringSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str tier: The tier of the application component.
        :param builtins.str component_arn: The ARN of the compnonent.
...
class ApplicationCustomComponent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_list: Sequence[builtins.str]):
        """
        The custom grouped component.
        :param builtins.str component_name: The name of the component.
        :param Sequence[builtins.str] resource_list: The list of resource ARNs that belong to the component.
        """
        pulumi.set(__self__, "component_name", component_name)
    ...
    def resource_list(self) -> Sequence[builtins.str]:
        """
...
class ApplicationHaClusterPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 prometheus_port: Optional[builtins.str] = None):
        """
        The HA cluster Prometheus Exporter settings.
        :param builtins.str prometheus_port: Prometheus exporter port.
        """
    ...
    def prometheus_port(self) -> Optional[builtins.str]:
        """
...
class ApplicationHanaPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 agree_to_install_hanadb_client: builtins.bool,
        ...
        """
        The HANA DB Prometheus Exporter settings.
        :param builtins.bool agree_to_install_hanadb_client: A flag which indicates agreeing to install SAP HANA DB client.
        :param builtins.str hana_port: The HANA DB port.
        :param builtins.str hana_secret_name: The secret name which manages the HANA DB credentials e.g. {
                 "username": "<>",
                 "password": "<>"
               }.
        :param builtins.str hanasid: HANA DB SID.
        :param builtins.str prometheus_port: Prometheus exporter port.
        """
    ...
    def agree_to_install_hanadb_client(self) -> builtins.bool:
        """
...
class ApplicationJmxPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jmxurl: Optional[builtins.str] = None,
                 prometheus_port: Optional[builtins.str] = None):
        """
        The JMX Prometheus Exporter settings.
        :param builtins.str host_port: Java agent host port
        :param builtins.str jmxurl: JMX service URL.
        :param builtins.str prometheus_port: Prometheus exporter port.
        """
    ...
    @property
    @pulumi.getter
    def jmxurl(self) -> Optional[builtins.str]:
        """
        JMX service URL.
        """
...
class ApplicationLog(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_path: Optional[builtins.str] = None,
                 pattern_set: Optional[builtins.str] = None):
        """
        A log to be monitored for the component.
        :param builtins.str log_type: The log type decides the log patterns against which Application Insights analyzes the log.
        :param 'ApplicationLogEncoding' encoding: The type of encoding of the logs to be monitored.
        :param builtins.str log_group_name: The CloudWatch log group name to be associated to the monitored log.
        :param builtins.str log_path: The path of the logs to be monitored.
        :param builtins.str pattern_set: The name of the log pattern set.
        """
    ...
    def log_path(self) -> Optional[builtins.str]:
        """
    ...
    def pattern_set(self) -> Optional[builtins.str]:
        """
...
class ApplicationLogPattern(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The log pattern.
        :param builtins.str pattern: The log pattern.
        :param builtins.str pattern_name: The name of the log pattern.
        :param builtins.int rank: Rank of the log pattern.
        """
...
class ApplicationLogPatternSet(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str pattern_set_name: The name of the log pattern set.
        """
...
class ApplicationNetWeaverPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 instance_numbers: Sequence[builtins.str],
                 sapsid: builtins.str,
                 prometheus_port: Optional[builtins.str] = None):
        """
        The NetWeaver Prometheus Exporter Settings.
        :param Sequence[builtins.str] instance_numbers: SAP instance numbers for ASCS, ERS, and App Servers.
        :param builtins.str sapsid: SAP NetWeaver SID.
        :param builtins.str prometheus_port: Prometheus exporter port.
        """
    ...
    def instance_numbers(self) -> Sequence[builtins.str]:
        """
...
class ApplicationProcess(dict):
    ...
    def __init__(__self__, *,
        ...
        A process to be monitored for the component.
        :param Sequence['ApplicationAlarmMetric'] alarm_metrics: A list of metrics to monitor for the component.
        :param builtins.str process_name: The name of the process to be monitored for the component.
        """
        pulumi.set(__self__, "alarm_metrics", alarm_metrics)
...
class ApplicationSqlServerPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
        ...
        The SQL prometheus exporter settings.
        :param builtins.str prometheus_port: Prometheus exporter port.
        :param builtins.str sql_secret_name: Secret name which managers SQL exporter connection. e.g. {"data_source_name": "sqlserver://<USERNAME>:<PASSWORD>@localhost:1433"}
        """
        pulumi.set(__self__, "prometheus_port", prometheus_port)
...
class ApplicationWindowsEvent(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str event_name: The type of Windows Events to log.
        :param builtins.str log_group_name: The CloudWatch log group name to be associated to the monitored log.
        :param builtins.str pattern_set: The name of the log pattern set.
        """
