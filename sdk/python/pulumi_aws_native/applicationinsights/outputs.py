...
class ApplicationAlarmMetric(dict):
    ...
    def alarm_metric_name(self) -> _builtins.str:
        """
...
class ApplicationCustomComponent(dict):
    ...
    def resource_list(self) -> Sequence[_builtins.str]:
        """
...
class ApplicationHaClusterPrometheusExporter(dict):
    ...
    def prometheus_port(self) -> Optional[_builtins.str]:
        """
...
class ApplicationHanaPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 agree_to_install_hanadb_client: _builtins.bool,
                 hana_port: _builtins.str,
                 hana_secret_name: _builtins.str,
                 hanasid: _builtins.str,
                 prometheus_port: Optional[_builtins.str] = None):
        """
        The HANA DB Prometheus Exporter settings.
        ...
        :param _builtins.str hanasid: HANA DB SID.
        :param _builtins.str prometheus_port: Prometheus exporter port.
        """
    ...
    def agree_to_install_hanadb_client(self) -> _builtins.bool:
        """
    ...
    def hana_port(self) -> _builtins.str:
        """
        The HANA DB port.
        """
    ...
    def hana_secret_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def hanasid(self) -> _builtins.str:
        """
        HANA DB SID.
        """
...
class ApplicationJmxPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jmxurl: Optional[_builtins.str] = None,
                 prometheus_port: Optional[_builtins.str] = None):
        """
        The JMX Prometheus Exporter settings.
    ...
    @_builtins.property
    @pulumi.getter
    def jmxurl(self) -> Optional[_builtins.str]:
        """
        JMX service URL.
        """
...
class ApplicationLog(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_path: Optional[_builtins.str] = None,
        ...
        :param _builtins.str log_path: The path of the logs to be monitored.
    ...
    def log_path(self) -> Optional[_builtins.str]:
        """
    ...
    def pattern_set(self) -> Optional[_builtins.str]:
        """
...
class ApplicationLogPatternSet(dict):
    ...
    def pattern_set_name(self) -> _builtins.str:
        """
        The name of the log pattern set.
        """
...
class ApplicationNetWeaverPrometheusExporter(dict):
    ...
    def __init__(__self__, *,
                 instance_numbers: Sequence[_builtins.str],
                 sapsid: _builtins.str,
                 prometheus_port: Optional[_builtins.str] = None):
        """
        The NetWeaver Prometheus Exporter Settings.
    ...
    def instance_numbers(self) -> Sequence[_builtins.str]:
        """
...
class ApplicationSqlServerPrometheusExporter(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="prometheusPort")
    def prometheus_port(self) -> _builtins.str:
        """
        Prometheus exporter port.
        """
        return pulumi.get(self, "prometheus_port")
    ...
    def sql_secret_name(self) -> _builtins.str:
        """
