...
def get_bucket_policy(bucket: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bucket: The name of the S3 directory bucket to which the policy applies.
    """
    __args__ = dict()
    __args__['bucket'] = bucket
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('aws-native:s3express:getBucketPolicy', __args__, opts=opts, typ=GetBucketPolicyResult).value
...
def get_bucket_policy_output(bucket: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:s3express:getBucketPolicy', __args__, opts=opts, typ=GetBucketPolicyResult)
