...
class GetManagedPolicyResult:
    ...
    def attachment_count(self) -> Optional[builtins.int]:
        """
    ...
    def default_version_id(self) -> Optional[builtins.str]:
        """
    ...
    def is_attachable(self) -> Optional[builtins.bool]:
        """
    ...
    def permissions_boundary_usage_count(self) -> Optional[builtins.int]:
        """
    ...
    def policy_arn(self) -> Optional[builtins.str]:
        """
...
def get_managed_policy(policy_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_arn: The Amazon Resource Name (ARN) of the managed policy that you want information about.
...
def get_managed_policy_output(policy_arn: Optional[pulumi.Input[builtins.str]] = None,
