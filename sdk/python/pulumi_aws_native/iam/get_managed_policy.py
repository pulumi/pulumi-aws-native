...
class GetManagedPolicyResult:
    ...
    def attachment_count(self) -> Optional[_builtins.int]:
        """
    ...
    def is_attachable(self) -> Optional[_builtins.bool]:
        """
    ...
    def permissions_boundary_usage_count(self) -> Optional[_builtins.int]:
        """
...
def get_managed_policy(policy_arn: Optional[_builtins.str] = None,
