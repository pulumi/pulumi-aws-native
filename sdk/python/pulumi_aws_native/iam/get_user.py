...
def get_user(user_name: Optional[builtins.str] = None,
    ...
    :param builtins.str user_name: The name of the user to create. Do not include the path in this value.
...
def get_user_output(user_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:iam:getUser', __args__, opts=opts, typ=GetUserResult)
