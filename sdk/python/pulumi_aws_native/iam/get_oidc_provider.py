...
class GetOidcProviderResult:
    ...
    def client_id_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def thumbprint_list(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_oidc_provider(arn: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOidcProviderResult:
    """
    Resource Type definition for AWS::IAM::OIDCProvider


    :param _builtins.str arn: Amazon Resource Name (ARN) of the OIDC provider
    """
    __args__ = dict()
    __args__['arn'] = arn
