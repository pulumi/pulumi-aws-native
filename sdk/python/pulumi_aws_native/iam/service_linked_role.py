...
class ServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] a_ws_service_name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-servicelinkedrole.html#cfn-iam-servicelinkedrole-awsservicename
