...
class ServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_service_name: The service principal for the AWS service to which this role is attached.
        :param pulumi.Input[builtins.str] custom_suffix: A string that you provide, which is combined with the service-provided prefix to form the complete role name.
...
class ServiceLinkedRole(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="awsServiceName")
    def aws_service_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The service principal for the AWS service to which this role is attached.
        """
        return pulumi.get(self, "aws_service_name")
