...
class ServiceLinkedRole(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ServiceLinkedRolePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ServiceLinkedRolePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ServiceLinkedRoleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ServiceLinkedRoleProperties']:
        """
