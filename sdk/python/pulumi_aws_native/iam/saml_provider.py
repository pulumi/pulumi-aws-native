...
class SamlProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assertion_encryption_mode: pulumi.Input[Optional['SamlProviderAssertionEncryptionMode']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 private_key_list: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SamlProviderSamlPrivateKeyArgs', 'SamlProviderSamlPrivateKeyArgsDict', 'outputs.SamlProviderSamlPrivateKey']]]]] = None,
                 remove_private_key: pulumi.Input[Optional[_builtins.str]] = None,
                 saml_metadata_document: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the provider to create.
               ...
               This parameter allows (through its [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex) ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
        :param pulumi.Input[Sequence[pulumi.Input[Union['SamlProviderSamlPrivateKeyArgs', 'SamlProviderSamlPrivateKeyArgsDict', 'outputs.SamlProviderSamlPrivateKey']]]] private_key_list: The private key metadata for the SAML provider.
        :param pulumi.Input[_builtins.str] remove_private_key: The Key ID of the private key to remove
        :param pulumi.Input[_builtins.str] saml_metadata_document: An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document includes the issuer's name, expiration information, and keys that can be used to validate the SAML authentication response (assertions) that are received from the IdP. You must generate the metadata document using the identity management software that is used as your organization's IdP.
               
               For more information, see [About SAML 2.0-based federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_saml.html) in the *IAM User Guide*
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: A list of tags that you want to attach to the new IAM SAML provider. Each tag consists of a key name and an associated value. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the *IAM User Guide* .
