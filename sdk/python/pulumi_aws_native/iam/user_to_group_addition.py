...
class UserToGroupAddition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserToGroupAdditionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserToGroupAdditionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserToGroupAdditionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserToGroupAdditionProperties']:
        """
