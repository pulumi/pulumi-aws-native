...
class GetRoleResult:
    ...
    def managed_policy_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def max_session_duration(self) -> Optional[builtins.int]:
        """
    ...
    def permissions_boundary(self) -> Optional[builtins.str]:
        """
...
def get_role(role_name: Optional[builtins.str] = None,
    ...
    :param builtins.str role_name: A name for the IAM role, up to 64 characters in length. For valid values, see the `RoleName` parameter for the [`CreateRole`](https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html) action in the *IAM User Guide* .
...
def get_role_output(role_name: Optional[pulumi.Input[builtins.str]] = None,
