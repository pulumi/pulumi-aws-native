...
class GroupPolicyArgs:
    def __init__(__self__, *,
                 policy_document: pulumi.Input[Union[str, Any]],
                 policy_name: pulumi.Input[str]):
        """
        :param pulumi.Input[Union[str, Any]] policy_document: The policy document.
    ...
    def policy_document(self) -> pulumi.Input[Union[str, Any]]:
        """
        The policy document.
        """
    ...
    def policy_document(self, value: pulumi.Input[Union[str, Any]]):
...
class RolePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, Any]] policy_document: The entire contents of the policy that defines permissions. For more information, see [Overview of JSON policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policies-json).
        :param pulumi.Input[str] policy_name: The friendly name (not ARN) identifying the policy.
        """
        pulumi.set(__self__, "policy_document", policy_document)
        pulumi.set(__self__, "policy_name", policy_name)
...
class UserPolicyArgs:
    def __init__(__self__, *,
        ...
        Contains information about an attached policy.
         An attached policy is a managed policy that has been attached to a user, group, or role.
         For more information about managed policies, refer to [Managed Policies and Inline Policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the *User Guide*.
        :param pulumi.Input[Union[Any, str]] policy_document: The entire contents of the policy that defines permissions. For more information, see [Overview of JSON policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policies-json).
        :param pulumi.Input[str] policy_name: The friendly name (not ARN) identifying the policy.
        """
        pulumi.set(__self__, "policy_document", policy_document)
        pulumi.set(__self__, "policy_name", policy_name)
