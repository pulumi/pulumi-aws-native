...
def get_instance_profile(instance_profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_profile_name: The name of the instance profile to create.
...
def get_instance_profile_output(instance_profile_name: Optional[pulumi.Input[builtins.str]] = None,
