...
class ManagedPolicyArgs:
    def __init__(__self__, *,
                 ...
                 managed_policy_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: A friendly description of the policy.
                Typically used to store information about the permissions defined in the policy. For example, "Grants access to production DynamoDB tables."
                The policy description is immutable. After a value is assigned, it cannot be changed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: The name (friendly name, not ARN) of the group to attach the policy to.
                This parameter allows (through its [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex)) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
        :param pulumi.Input[builtins.str] managed_policy_name: The friendly name of the policy.
        ...
        :param pulumi.Input[builtins.str] path: The path for the policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: The name (friendly name, not ARN) of the role to attach the policy to.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The name (friendly name, not ARN) of the IAM user to attach the policy to.
                This parameter allows (through its [regex pattern](https://docs.aws.amazon.com/http://wikipedia.org/wiki/regex)) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
        """
    ...
    def managed_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedPolicy(pulumi.CustomResource):
    ...
    def is_attachable(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="managedPolicyName")
    def managed_policy_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The friendly name of the policy.
          If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name.
          If you specify a name, you must specify the ``CAPABILITY_NAMED_IAM`` value to acknowledge your template's capabilities. For more information, see [Acknowledging Resources in Templates](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html#using-iam-capabilities).
    ...
    def permissions_boundary_usage_count(self) -> pulumi.Output[builtins.int]:
        """
