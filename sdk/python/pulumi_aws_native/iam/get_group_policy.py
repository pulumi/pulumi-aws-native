...
def get_group_policy(group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str group_name: The name of the group to associate the policy with.
...
def get_group_policy_output(group_name: Optional[pulumi.Input[builtins.str]] = None,
