...
class ServerCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] server_certificate_name: The name for the server certificate. Do not include the path in this value. The name of the certificate cannot contain any spaces.
...
@pulumi.type_token("aws-native:iam:ServerCertificate")
class ServerCertificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="serverCertificateName")
    def server_certificate_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name for the server certificate. Do not include the path in this value. The name of the certificate cannot contain any spaces.
