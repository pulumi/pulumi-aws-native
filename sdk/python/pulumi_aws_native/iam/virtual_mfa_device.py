...
class VirtualMfaDeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The IAM user associated with this virtual MFA device.
        :param pulumi.Input[builtins.str] path: The path for the virtual MFA device. For more information about paths, see [IAM identifiers](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the *IAM User Guide* .
        ...
        :param pulumi.Input[builtins.str] virtual_mfa_device_name: The name of the virtual MFA device, which must be unique. Use with path to uniquely identify a virtual MFA device.
...
@pulumi.type_token("aws-native:iam:VirtualMfaDevice")
class VirtualMfaDevice(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="virtualMfaDeviceName")
    def virtual_mfa_device_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the virtual MFA device, which must be unique. Use with path to uniquely identify a virtual MFA device.
