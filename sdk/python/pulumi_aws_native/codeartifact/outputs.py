...
class PackageGroupRestrictionType(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] repositories: The repositories to add to the allowed repositories list. The allowed repositories list is used when the `RestrictionMode` is set to `ALLOW_SPECIFIC_REPOSITORIES` .
        """
