...
class PackageGroupArgs:
    def __init__(__self__, *,
                 ...
                 contact_info: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_name: The name of the domain that contains the package group.
        :param pulumi.Input[builtins.str] pattern: The package group pattern that is used to gather packages.
        :param pulumi.Input[builtins.str] contact_info: The contact info of the package group.
        :param pulumi.Input[builtins.str] description: The text description of the package group.
        :param pulumi.Input[builtins.str] domain_owner: The 12-digit account ID of the AWS account that owns the domain.
    ...
    def contact_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @contact_info.setter
    def contact_info(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PackageGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contactInfo")
    def contact_info(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The contact info of the package group.
        """
        return pulumi.get(self, "contact_info")
    ...
    @property
    @pulumi.getter(name="domainOwner")
    def domain_owner(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The 12-digit account ID of the AWS account that owns the domain.
        """
        return pulumi.get(self, "domain_owner")
