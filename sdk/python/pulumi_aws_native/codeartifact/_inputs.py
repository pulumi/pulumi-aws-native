...
if not MYPY:
    class PackageGroupRestrictionTypeArgsDict(TypedDict):
        ...
        """
        repositories: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PackageGroupRestrictionTypeArgs:
    def __init__(__self__, *,
                 restriction_mode: pulumi.Input['PackageGroupRestrictionTypeRestrictionMode'],
                 repositories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repositories: The repositories to add to the allowed repositories list. The allowed repositories list is used when the `RestrictionMode` is set to `ALLOW_SPECIFIC_REPOSITORIES` .
        """
    ...
    @property
    @pulumi.getter
    def repositories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The repositories to add to the allowed repositories list. The allowed repositories list is used when the `RestrictionMode` is set to `ALLOW_SPECIFIC_REPOSITORIES` .
        """
    ...
    @repositories.setter
    def repositories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
