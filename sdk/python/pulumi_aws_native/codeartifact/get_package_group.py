...
class GetPackageGroupResult:
    ...
    def contact_info(self) -> Optional[builtins.str]:
        """
    ...
    def domain_owner(self) -> Optional[builtins.str]:
        """
...
def get_package_group(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The ARN of the package group.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_package_group_output(arn: Optional[pulumi.Input[builtins.str]] = None,
