...
class AccessPointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_system_id: The ID of the EFS file system that the access point applies to. Accepts only the ID format for input when specifying a file system, for example ``fs-0123456789abcedf2``.
        ...
        :param pulumi.Input[builtins.str] client_token: The opaque string specified in the request to ensure idempotent creation.
