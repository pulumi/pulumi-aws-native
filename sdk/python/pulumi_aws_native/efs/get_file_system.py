...
class GetFileSystemResult:
    ...
    def provisioned_throughput_in_mibps(self) -> Optional[builtins.float]:
        """
...
def get_file_system(file_system_id: Optional[builtins.str] = None,
    ...
    :param builtins.str file_system_id: The ID of the EFS file system. For example: `fs-abcdef0123456789a`
    """
    __args__ = dict()
...
def get_file_system_output(file_system_id: Optional[pulumi.Input[builtins.str]] = None,
