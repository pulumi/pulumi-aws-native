...
class DevicePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_devices: The number of devices that Device Farm can add to your device pool. Device Farm adds devices that are available and meet the criteria that you assign for the `rules` parameter. Depending on how many devices meet these constraints, your device pool might contain fewer devices than the value for this parameter.
               
               By specifying the maximum number of devices, you can control the costs that you incur by running tests.
        :param pulumi.Input[_builtins.str] name: The device pool's name.
...
class DevicePool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] name: The device pool's name.
        :param pulumi.Input[_builtins.str] project_arn: The ARN of the project for the device pool.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DevicePoolRuleArgs', 'DevicePoolRuleArgsDict', 'outputs.DevicePoolRule']]]] rules: The device pool's rules.
