...
class ProjectVpcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The VPC security groups and subnets that are attached to a project
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: An array of security group Ids in your Amazon VPC
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A array of subnet IDs in your Amazon VPC.
...
class TestGridProjectVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: A list of VPC IDs.
