...
class GetProjectResult:
    def __init__(__self__, arn=None, default_job_timeout_minutes=None, environment_variables=None, execution_role_arn=None, name=None, tags=None, vpc_config=None):
