...
class GetInstanceProfileResult:
    ...
    def exclude_app_packages_from_cleanup(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def package_cleanup(self) -> Optional[_builtins.bool]:
        """
    ...
    def reboot_after_use(self) -> Optional[_builtins.bool]:
        """
...
def get_instance_profile(arn: Optional[_builtins.str] = None,
