...
class InstanceProfileArgs:
    def __init__(__self__, *,
                 ...
                 exclude_app_packages_from_cleanup: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_app_packages_from_cleanup: An array of strings containing the list of app packages that should not be cleaned up from the device after a test run completes.
    ...
    def exclude_app_packages_from_cleanup(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def exclude_app_packages_from_cleanup(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def package_cleanup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def package_cleanup(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "package_cleanup", value)

    @property
    @pulumi.getter(name="rebootAfterUse")
    def reboot_after_use(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reboot_after_use(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class InstanceProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="excludeAppPackagesFromCleanup")
    def exclude_app_packages_from_cleanup(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of strings containing the list of app packages that should not be cleaned up from the device after a test run completes.
    ...
    @property
    @pulumi.getter(name="packageCleanup")
    def package_cleanup(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set to `true` , Device Farm removes app packages after a test run. The default value is `false` for private devices.
        """
        return pulumi.get(self, "package_cleanup")
    ...
    @property
    @pulumi.getter(name="rebootAfterUse")
    def reboot_after_use(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set to `true` , Device Farm reboots the instance after a test run. The default value is `true` .
        """
        return pulumi.get(self, "reboot_after_use")
