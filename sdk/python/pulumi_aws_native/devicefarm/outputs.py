...
class ProjectVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The VPC security groups and subnets that are attached to a project
        :param Sequence[builtins.str] security_group_ids: An array of security group Ids in your Amazon VPC
        :param Sequence[builtins.str] subnet_ids: A array of subnet IDs in your Amazon VPC.
...
class TestGridProjectVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str vpc_id: A list of VPC IDs.
