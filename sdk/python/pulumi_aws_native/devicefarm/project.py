...
class ProjectArgs:
    def __init__(__self__, *,
                 default_job_timeout_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None,
                 vpc_config: Optional[pulumi.Input['ProjectVpcConfigArgs']] = None):
        """
        The set of arguments for constructing a Project resource.
        :param pulumi.Input[builtins.int] default_job_timeout_minutes: Sets the execution timeout value (in minutes) for a project. All test runs in this project use the specified execution timeout value unless overridden when scheduling a run.
        :param pulumi.Input[builtins.str] name: The project's name.
    ...
    def default_job_timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_job_timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Project(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultJobTimeoutMinutes")
    def default_job_timeout_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Sets the execution timeout value (in minutes) for a project. All test runs in this project use the specified execution timeout value unless overridden when scheduling a run.
        """
        return pulumi.get(self, "default_job_timeout_minutes")
