...
warnings.warn("""Repository is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Repository(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 triggers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RepositoryTriggerArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Repository is deprecated: Repository is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
