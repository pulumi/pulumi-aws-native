...
class GlobalTableGlobalSecondaryIndexArgsDict(TypedDict):
    ...
    """
    read_on_demand_throughput_settings: NotRequired[pulumi.Input[Optional['GlobalTableReadOnDemandThroughputSettingsArgsDict']]]
    read_provisioned_throughput_settings: NotRequired[pulumi.Input[Optional['GlobalTableGlobalReadProvisionedThroughputSettingsArgsDict']]]
    warm_throughput: NotRequired[pulumi.Input[Optional['GlobalTableWarmThroughputArgsDict']]]
    """
    Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index. If you use this parameter, you must specify `ReadUnitsPerSecond` , `WriteUnitsPerSecond` , or both.
    """
    write_on_demand_throughput_settings: NotRequired[pulumi.Input[Optional['GlobalTableWriteOnDemandThroughputSettingsArgsDict']]]
    """
    ...
    """
    write_provisioned_throughput_settings: NotRequired[pulumi.Input[Optional['GlobalTableWriteProvisionedThroughputSettingsArgsDict']]]
    """
...
class GlobalTableReadProvisionedThroughputSettingsArgsDict(TypedDict):
    read_capacity_auto_scaling_settings: NotRequired[pulumi.Input[Optional['GlobalTableCapacityAutoScalingSettingsArgsDict']]]
    """
...
class GlobalTableReplicaGlobalSecondaryIndexSpecificationArgsDict(TypedDict):
    ...
    The name of the global secondary index. The name must be unique among all other indexes on this table.
    """
    contributor_insights_specification: NotRequired[pulumi.Input[Optional['GlobalTableContributorInsightsSpecificationArgsDict']]]
    """
    ...
    """
    read_provisioned_throughput_settings: NotRequired[pulumi.Input[Optional['GlobalTableReadProvisionedThroughputSettingsArgsDict']]]
    """
...
class GlobalTableReplicaSpecificationArgsDict(TypedDict):
    ...
    """
    global_secondary_indexes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['GlobalTableReplicaGlobalSecondaryIndexSpecificationArgsDict']]]]]
    """
    ...
    kinesis_stream_specification: NotRequired[pulumi.Input[Optional['GlobalTableKinesisStreamSpecificationArgsDict']]]
    """
    Defines the Kinesis Data Streams configuration for the specified replica.
    """
    point_in_time_recovery_specification: NotRequired[pulumi.Input[Optional['GlobalTablePointInTimeRecoverySpecificationArgsDict']]]
    """
    ...
    """
    replica_stream_specification: NotRequired[pulumi.Input[Optional['GlobalTableReplicaStreamSpecificationArgsDict']]]
    """
    Represents the DynamoDB Streams configuration for a global table replica.
    """
    resource_policy: NotRequired[pulumi.Input[Optional['GlobalTableResourcePolicyArgsDict']]]
    """
    ...
    """
    sse_specification: NotRequired[pulumi.Input[Optional['GlobalTableReplicaSseSpecificationArgsDict']]]
    """
...
class GlobalTableReplicaSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] deletion_protection_enabled: Determines if a replica is protected from deletion. When enabled, the table cannot be deleted by any user or process. This setting is disabled by default. For more information, see [Using deletion protection](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.Basics.html#WorkingWithTables.Basics.DeletionProtection) in the *Amazon DynamoDB Developer Guide* .
        ...
        :param pulumi.Input[_builtins.str] table_class: The table class of the specified table. Valid values are `STANDARD` and `STANDARD_INFREQUENT_ACCESS` .
...
class GlobalTableReplicaSseSpecificationArgs:
    ...
    def kms_master_key_id(self) -> pulumi.Input[_builtins.str]:
        """
        The AWS  key that should be used for the AWS  encryption. To specify a key, use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. Note that you should only provide this parameter if the key is different from the default DynamoDB key `alias/aws/dynamodb` .
        """
    ...
    def kms_master_key_id(self, value: pulumi.Input[_builtins.str]):
...
class GlobalTableSseSpecificationArgs:
    ...
    def sse_enabled(self) -> pulumi.Input[_builtins.bool]:
        """
        Indicates whether server-side encryption is performed using an AWS managed key or an AWS owned key. If enabled (true), server-side encryption type is set to KMS and an AWS managed key is used ( AWS  charges apply). If disabled (false) or not specified,server-side encryption is set to an AWS owned key. If you choose to use KMS encryption, you can also use customer managed KMS keys by specifying them in the `ReplicaSpecification.SSESpecification` object. You cannot mix AWS managed and customer managed KMS keys.
        """
    ...
    @sse_enabled.setter
    def sse_enabled(self, value: pulumi.Input[_builtins.bool]):
...
class GlobalTableStreamSpecificationArgs:
    ...
    def stream_view_type(self) -> pulumi.Input[_builtins.str]:
        """
        When an item in the table is modified, `StreamViewType` determines what information is written to the stream for this table. Valid values for `StreamViewType` are:
    ...
    def stream_view_type(self, value: pulumi.Input[_builtins.str]):
...
class GlobalTableTargetTrackingScalingPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] scale_in_cooldown: The amount of time, in seconds, after a scale-in activity completes before another scale-in activity can start.
        :param pulumi.Input[_builtins.int] scale_out_cooldown: The amount of time, in seconds, after a scale-out activity completes before another scale-out activity can start.
        """
...
class GlobalTableWriteProvisionedThroughputSettingsArgsDict(TypedDict):
    write_capacity_auto_scaling_settings: NotRequired[pulumi.Input[Optional['GlobalTableCapacityAutoScalingSettingsArgsDict']]]
    """
    Specifies auto scaling settings for the replica table or global secondary index.
    """
...
class TableGlobalSecondaryIndexArgsDict(TypedDict):
    ...
    Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected.
    """
    contributor_insights_specification: NotRequired[pulumi.Input[Optional['TableContributorInsightsSpecificationArgsDict']]]
    """
    ...
    """
    on_demand_throughput: NotRequired[pulumi.Input[Optional['TableOnDemandThroughputArgsDict']]]
    """
    ...
    """
    warm_throughput: NotRequired[pulumi.Input[Optional['TableWarmThroughputArgsDict']]]
    """
    Represents the warm throughput value (in read units per second and write units per second) for the specified secondary index. If you use this parameter, you must specify ``ReadUnitsPerSecond``, ``WriteUnitsPerSecond``, or both.
    """
...
class TableImportSourceSpecificationArgsDict(TypedDict):
    ...
    """
    input_format_options: NotRequired[pulumi.Input[Optional['TableInputFormatOptionsArgsDict']]]
    """
...
class TableInputFormatOptionsArgsDict(TypedDict):
    ...
    """
    csv: NotRequired[pulumi.Input[Optional['TableCsvArgsDict']]]
    """
    The options for imported source files in CSV format. The values are Delimiter and HeaderList.
    """
...
class TableProvisionedThroughputArgs:
    ...
    @_builtins.property
    @pulumi.getter(name="readCapacityUnits")
    def read_capacity_units(self) -> pulumi.Input[_builtins.int]:
        """
        The maximum number of strongly consistent reads consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
         If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
    ...
    @read_capacity_units.setter
    def read_capacity_units(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "read_capacity_units", value)

    @_builtins.property
    @pulumi.getter(name="writeCapacityUnits")
    def write_capacity_units(self) -> pulumi.Input[_builtins.int]:
        """
        The maximum number of writes consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
         If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
    ...
    def write_capacity_units(self, value: pulumi.Input[_builtins.int]):
...
class TableStreamSpecificationArgsDict(TypedDict):
    ...
    When an item in the table is modified, ``StreamViewType`` determines what information is written to the stream for this table. Valid values for ``StreamViewType`` are:
      ...
      +  ``NEW_AND_OLD_IMAGES`` - Both the new and the old item images of the item are written to the stream.
    """
    resource_policy: NotRequired[pulumi.Input[Optional['TableResourcePolicyArgsDict']]]
    """
