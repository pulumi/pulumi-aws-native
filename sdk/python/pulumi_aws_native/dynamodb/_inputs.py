...
if not MYPY:
    class GlobalTableCapacityAutoScalingSettingsArgsDict(TypedDict):
        ...
        """
        seed_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
...
class GlobalTableCapacityAutoScalingSettingsArgs:
    def __init__(__self__, *,
                 ...
                 seed_capacity: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_capacity: The maximum provisioned capacity units for the global table.
        :param pulumi.Input[builtins.int] min_capacity: The minimum provisioned capacity units for the global table.
    ...
    def seed_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        When switching billing mode from `PAY_PER_REQUEST` to `PROVISIONED` , DynamoDB requires you to specify read and write capacity unit values for the table and for each global secondary index. These values will be applied to all replicas. The table will use these provisioned values until CloudFormation creates the autoscaling policies you configured in your template. CloudFormation cannot determine what capacity the table and its global secondary indexes will require in this time period, since they are application-dependent.
    ...
    def seed_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class GlobalTableKinesisStreamSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] stream_arn: The ARN for a specific Kinesis data stream.
...
class GlobalTableProjectionArgs:
    def __init__(__self__, *,
                 ...
                 projection_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def projection_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GlobalTableReadOnDemandThroughputSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_read_request_units: Maximum number of read request units for the specified replica of a global table.
        """
...
class GlobalTableReadProvisionedThroughputSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] read_capacity_units: Specifies a fixed read capacity for the replica table or global secondary index.
        """
...
if not MYPY:
    class GlobalTableReplicaSpecificationArgsDict(TypedDict):
        ...
        """
        table_class: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GlobalTableReplicaSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] region: The region in which this replica exists.
        ...
        :param pulumi.Input[builtins.bool] deletion_protection_enabled: Determines if a replica is protected from deletion. When enabled, the table cannot be deleted by any user or process. This setting is disabled by default. For more information, see [Using deletion protection](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.Basics.html#WorkingWithTables.Basics.DeletionProtection) in the *Amazon DynamoDB Developer Guide* .
        ...
        :param pulumi.Input[builtins.str] table_class: The table class of the specified table. Valid values are `STANDARD` and `STANDARD_INFREQUENT_ACCESS` .
...
if not MYPY:
    class GlobalTableReplicaSseSpecificationArgsDict(TypedDict):
        kms_master_key_id: pulumi.Input[builtins.str]
        """
...
class GlobalTableReplicaSseSpecificationArgs:
    ...
    def kms_master_key_id(self) -> pulumi.Input[builtins.str]:
        """
        The AWS KMS key that should be used for the AWS KMS encryption. To specify a key, use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. Note that you should only provide this parameter if the key is different from the default DynamoDB key `alias/aws/dynamodb` .
        """
    ...
    def kms_master_key_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class GlobalTableSseSpecificationArgsDict(TypedDict):
        sse_enabled: pulumi.Input[builtins.bool]
        """
...
class GlobalTableSseSpecificationArgs:
    def __init__(__self__, *,
                 sse_enabled: pulumi.Input[builtins.bool],
                 sse_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def sse_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Indicates whether server-side encryption is performed using an AWS managed key or an AWS owned key. If enabled (true), server-side encryption type is set to KMS and an AWS managed key is used ( AWS KMS charges apply). If disabled (false) or not specified,server-side encryption is set to an AWS owned key. If you choose to use KMS encryption, you can also use customer managed KMS keys by specifying them in the `ReplicaSpecification.SSESpecification` object. You cannot mix AWS managed and customer managed KMS keys.
        """
    ...
    @sse_enabled.setter
    def sse_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    @sse_type.setter
    def sse_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GlobalTableStreamSpecificationArgs:
    ...
    def stream_view_type(self, value: pulumi.Input[builtins.str]):
...
class GlobalTableTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key of the tag. Tag keys are case sensitive. Each DynamoDB table can only have up to one tag with the same key. If you try to add an existing tag (same key), the existing tag value will be updated to the new value.
...
class GlobalTableTargetTrackingScalingPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] target_value: Defines a target value for the scaling policy.
        :param pulumi.Input[builtins.bool] disable_scale_in: Indicates whether scale in by the target tracking scaling policy is disabled. The default value is `false` .
        :param pulumi.Input[builtins.int] scale_in_cooldown: The amount of time, in seconds, after a scale-in activity completes before another scale-in activity can start.
        :param pulumi.Input[builtins.int] scale_out_cooldown: The amount of time, in seconds, after a scale-out activity completes before another scale-out activity can start.
        """
...
class GlobalTableTimeToLiveSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether TTL is to be enabled (true) or disabled (false) on the table.
        :param pulumi.Input[builtins.str] attribute_name: The name of the attribute used to store the expiration time for items in the table.
...
if not MYPY:
    class GlobalTableWarmThroughputArgsDict(TypedDict):
        read_units_per_second: NotRequired[pulumi.Input[builtins.int]]
        """
        Represents the number of read operations your base table can instantaneously support.
        """
        write_units_per_second: NotRequired[pulumi.Input[builtins.int]]
        """
...
class GlobalTableWarmThroughputArgs:
    def __init__(__self__, *,
                 read_units_per_second: Optional[pulumi.Input[builtins.int]] = None,
                 write_units_per_second: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] read_units_per_second: Represents the number of read operations your base table can instantaneously support.
        :param pulumi.Input[builtins.int] write_units_per_second: Represents the number of write operations your base table can instantaneously support.
        """
    ...
    def read_units_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Represents the number of read operations your base table can instantaneously support.
        """
    ...
    def read_units_per_second(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "read_units_per_second", value)

    @property
    @pulumi.getter(name="writeUnitsPerSecond")
    def write_units_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Represents the number of write operations your base table can instantaneously support.
        """
...
class GlobalTableWitnessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] region: The name of the AWS Region that serves as a witness for the MRSC global table.
        """
...
class GlobalTableWriteOnDemandThroughputSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_write_request_units: Maximum number of write request settings for the specified replica of a global table.
        """
...
class TableCsvArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] header_list: List of the headers used to specify a common header for all source CSV files being imported. If this field is specified then the first line of each CSV file is treated as data instead of the header. If this field is not specified the the first line of each CSV file is treated as the header.
        """
...
class TableImportSourceSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the properties of data being imported from the S3 bucket source to the table.
        :param pulumi.Input[builtins.str] input_format: The format of the source data. Valid values for ``ImportFormat`` are ``CSV``, ``DYNAMODB_JSON`` or ``ION``.
...
class TableOnDemandThroughputArgs:
    def __init__(__self__, *,
        ...
        """
        Sets the maximum number of read and write units for the specified on-demand table. If you use this property, you must specify ``MaxReadRequestUnits``, ``MaxWriteRequestUnits``, or both.
        :param pulumi.Input[builtins.int] max_read_request_units: Maximum number of read request units for the specified table.
                To specify a maximum ``OnDemandThroughput`` on your table, set the value of ``MaxReadRequestUnits`` as greater than or equal to 1. To remove the maximum ``OnDemandThroughput`` that is currently set on your table, set the value of ``MaxReadRequestUnits`` to -1.
        :param pulumi.Input[builtins.int] max_write_request_units: Maximum number of write request units for the specified table.
                To specify a maximum ``OnDemandThroughput`` on your table, set the value of ``MaxWriteRequestUnits`` as greater than or equal to 1. To remove the maximum ``OnDemandThroughput`` that is currently set on your table, set the value of ``MaxWriteRequestUnits`` to -1.
        """
        if max_read_request_units is not None:
            pulumi.set(__self__, "max_read_request_units", max_read_request_units)
...
if not MYPY:
    class TableProvisionedThroughputArgsDict(TypedDict):
        ...
        """
        read_capacity_units: pulumi.Input[builtins.int]
        """
        The maximum number of strongly consistent reads consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
         If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
        write_capacity_units: pulumi.Input[builtins.int]
        """
...
class TableProvisionedThroughputArgs:
    def __init__(__self__, *,
        ...
        """
        Throughput for the specified table, which consists of values for ``ReadCapacityUnits`` and ``WriteCapacityUnits``. For more information about the contents of a provisioned throughput structure, see [Table ProvisionedThroughput](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ProvisionedThroughput.html).
        :param pulumi.Input[builtins.int] read_capacity_units: The maximum number of strongly consistent reads consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
                If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        :param pulumi.Input[builtins.int] write_capacity_units: The maximum number of writes consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
                If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
        pulumi.set(__self__, "read_capacity_units", read_capacity_units)
    ...
    @property
    @pulumi.getter(name="readCapacityUnits")
    def read_capacity_units(self) -> pulumi.Input[builtins.int]:
        """
        The maximum number of strongly consistent reads consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
         If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
    ...
    @read_capacity_units.setter
    def read_capacity_units(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "read_capacity_units", value)

    @property
    @pulumi.getter(name="writeCapacityUnits")
    def write_capacity_units(self) -> pulumi.Input[builtins.int]:
        """
        The maximum number of writes consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
         If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
    ...
    def write_capacity_units(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class TableS3BucketSourceArgsDict(TypedDict):
        ...
        The S3 bucket that is being imported from.
        """
        s3_bucket_owner: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TableS3BucketSourceArgs:
    def __init__(__self__, *,
        ...
        """
        The S3 bucket that is being imported from.
        :param pulumi.Input[builtins.str] s3_bucket: The S3 bucket that is being imported from.
        :param pulumi.Input[builtins.str] s3_bucket_owner: The account number of the S3 bucket that is being imported from. If the bucket is owned by the requester this is optional.
        :param pulumi.Input[builtins.str] s3_key_prefix: The key prefix shared by all S3 Objects that are being imported.
        """
...
class TableTimeToLiveSpecificationArgs:
    def __init__(__self__, *,
        ...
        Represents the settings used to enable or disable Time to Live (TTL) for the specified table.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether TTL is to be enabled (true) or disabled (false) on the table.
        :param pulumi.Input[builtins.str] attribute_name: The name of the TTL attribute used to store the expiration time for items in the table.
                  +  The ``AttributeName`` property is required when enabling the TTL, or when TTL is already enabled.
                 +  To update this property, you must first disable TTL and then enable TTL with the new attribute name.
        """
        pulumi.set(__self__, "enabled", enabled)
