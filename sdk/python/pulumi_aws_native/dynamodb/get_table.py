...
class GetTableResult:
    ...
    def table_class(self) -> Optional[builtins.str]:
        """
...
def get_table(table_name: Optional[builtins.str] = None,
    ...
    :param builtins.str table_name: A name for the table. If you don't specify a name, CFNlong generates a unique physical ID and uses that ID for the table name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
...
def get_table_output(table_name: Optional[pulumi.Input[builtins.str]] = None,
