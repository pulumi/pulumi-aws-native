...
class GlobalTableAttributeDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_name: A name for the attribute.
        :param builtins.str attribute_type: The data type for the attribute, where:
...
class GlobalTableCapacityAutoScalingSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 seed_capacity: Optional[builtins.int] = None):
        """
        :param builtins.int max_capacity: The maximum provisioned capacity units for the global table.
        :param builtins.int min_capacity: The minimum provisioned capacity units for the global table.
    ...
    def seed_capacity(self) -> Optional[builtins.int]:
        """
...
class GlobalTableGlobalSecondaryIndex(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str index_name: The name of the global secondary index. The name must be unique among all other indexes on this table.
...
class GlobalTableKeySchema(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_name: The name of a key attribute.
        :param builtins.str key_type: The role that this key attribute will assume:
...
class GlobalTableKinesisStreamSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str stream_arn: The ARN for a specific Kinesis data stream.
...
class GlobalTableLocalSecondaryIndex(dict):
    ...
    def __init__(__self__, *,
                 ...
                 projection: 'outputs.GlobalTableProjection'):
        """
        :param builtins.str index_name: The name of the local secondary index. The name must be unique among all other indexes on this table.
...
class GlobalTableProjection(dict):
    ...
    def __init__(__self__, *,
                 ...
                 projection_type: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] non_key_attributes: Represents the non-key attribute names which will be projected into the index.
               
               For global and local secondary indexes, the total count of `NonKeyAttributes` summed across all of the secondary indexes, must not exceed 100. If you project the same attribute into two different indexes, this counts as two distinct attributes when determining the total. This limit only applies when you specify the ProjectionType of `INCLUDE` . You still can specify the ProjectionType of `ALL` to project all attributes from the source table, even if the table has more than 100 attributes.
        :param builtins.str projection_type: The set of attributes that are projected into the index:
    ...
    def projection_type(self) -> Optional[builtins.str]:
        """
...
class GlobalTableReadOnDemandThroughputSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_read_request_units: Maximum number of read request units for the specified replica of a global table.
        """
...
class GlobalTableReadProvisionedThroughputSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int read_capacity_units: Specifies a fixed read capacity for the replica table or global secondary index.
        """
...
class GlobalTableReplicaSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 table_class: Optional[builtins.str] = None,
                 tags: Optional[Sequence['outputs.GlobalTableTag']] = None):
        """
        :param builtins.str region: The region in which this replica exists.
        ...
        :param builtins.bool deletion_protection_enabled: Determines if a replica is protected from deletion. When enabled, the table cannot be deleted by any user or process. This setting is disabled by default. For more information, see [Using deletion protection](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.Basics.html#WorkingWithTables.Basics.DeletionProtection) in the *Amazon DynamoDB Developer Guide* .
        ...
        :param builtins.str table_class: The table class of the specified table. Valid values are `STANDARD` and `STANDARD_INFREQUENT_ACCESS` .
...
class GlobalTableSseSpecification(dict):
    ...
    def sse_enabled(self) -> builtins.bool:
        """
        Indicates whether server-side encryption is performed using an AWS managed key or an AWS owned key. If enabled (true), server-side encryption type is set to KMS and an AWS managed key is used ( AWS KMS charges apply). If disabled (false) or not specified,server-side encryption is set to an AWS owned key. If you choose to use KMS encryption, you can also use customer managed KMS keys by specifying them in the `ReplicaSpecification.SSESpecification` object. You cannot mix AWS managed and customer managed KMS keys.
        """
    ...
    def sse_type(self) -> Optional[builtins.str]:
        """
...
class GlobalTableStreamSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str stream_view_type: When an item in the table is modified, `StreamViewType` determines what information is written to the stream for this table. Valid values for `StreamViewType` are:
...
class GlobalTableTag(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the tag. Tag keys are case sensitive. Each DynamoDB table can only have up to one tag with the same key. If you try to add an existing tag (same key), the existing tag value will be updated to the new value.
...
class GlobalTableTargetTrackingScalingPolicyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.float target_value: Defines a target value for the scaling policy.
        :param builtins.bool disable_scale_in: Indicates whether scale in by the target tracking scaling policy is disabled. The default value is `false` .
        :param builtins.int scale_in_cooldown: The amount of time, in seconds, after a scale-in activity completes before another scale-in activity can start.
        :param builtins.int scale_out_cooldown: The amount of time, in seconds, after a scale-out activity completes before another scale-out activity can start.
        """
...
class GlobalTableTimeToLiveSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Indicates whether TTL is to be enabled (true) or disabled (false) on the table.
        :param builtins.str attribute_name: The name of the attribute used to store the expiration time for items in the table.
...
class GlobalTableWarmThroughput(dict):
    ...
    def __init__(__self__, *,
                 read_units_per_second: Optional[builtins.int] = None,
                 write_units_per_second: Optional[builtins.int] = None):
        """
        :param builtins.int read_units_per_second: Represents the number of read operations your base table can instantaneously support.
        :param builtins.int write_units_per_second: Represents the number of write operations your base table can instantaneously support.
        """
    ...
    def read_units_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def write_units_per_second(self) -> Optional[builtins.int]:
        """
...
class GlobalTableWriteOnDemandThroughputSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_write_request_units: Maximum number of write request settings for the specified replica of a global table.
        """
...
class TableCsv(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] header_list: List of the headers used to specify a common header for all source CSV files being imported. If this field is specified then the first line of each CSV file is treated as data instead of the header. If this field is not specified the the first line of each CSV file is treated as the header.
        """
...
class TableImportSourceSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the properties of data being imported from the S3 bucket source to the table.
        :param builtins.str input_format: The format of the source data. Valid values for ``ImportFormat`` are ``CSV``, ``DYNAMODB_JSON`` or ``ION``.
...
class TableOnDemandThroughput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sets the maximum number of read and write units for the specified on-demand table. If you use this property, you must specify ``MaxReadRequestUnits``, ``MaxWriteRequestUnits``, or both.
        :param builtins.int max_read_request_units: Maximum number of read request units for the specified table.
                To specify a maximum ``OnDemandThroughput`` on your table, set the value of ``MaxReadRequestUnits`` as greater than or equal to 1. To remove the maximum ``OnDemandThroughput`` that is currently set on your table, set the value of ``MaxReadRequestUnits`` to -1.
        :param builtins.int max_write_request_units: Maximum number of write request units for the specified table.
...
class TableProvisionedThroughput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Throughput for the specified table, which consists of values for ``ReadCapacityUnits`` and ``WriteCapacityUnits``. For more information about the contents of a provisioned throughput structure, see [Table ProvisionedThroughput](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ProvisionedThroughput.html).
        :param builtins.int read_capacity_units: The maximum number of strongly consistent reads consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
                If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        :param builtins.int write_capacity_units: The maximum number of writes consumed per second before DynamoDB returns a ``ThrottlingException``. For more information, see [Specifying Read and Write Requirements](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughput.html) in the *Amazon DynamoDB Developer Guide*.
                If read/write capacity mode is ``PAY_PER_REQUEST`` the value is set to 0.
        """
        pulumi.set(__self__, "read_capacity_units", read_capacity_units)
...
class TableS3BucketSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_bucket_owner: Optional[builtins.str] = None,
                 s3_key_prefix: Optional[builtins.str] = None):
        """
        The S3 bucket that is being imported from.
        :param builtins.str s3_bucket: The S3 bucket that is being imported from.
        :param builtins.str s3_bucket_owner: The account number of the S3 bucket that is being imported from. If the bucket is owned by the requester this is optional.
        :param builtins.str s3_key_prefix: The key prefix shared by all S3 Objects that are being imported.
        """
    ...
    def s3_bucket_owner(self) -> Optional[builtins.str]:
        """
...
class TableSseSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_master_key_id: The KMS key that should be used for the KMS encryption. To specify a key, use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. Note that you should only provide this parameter if the key is different from the default DynamoDB key ``alias/aws/dynamodb``.
        :param builtins.str sse_type: Server-side encryption type. The only supported value is:
...
class TableTimeToLiveSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        Represents the settings used to enable or disable Time to Live (TTL) for the specified table.
        :param builtins.bool enabled: Indicates whether TTL is to be enabled (true) or disabled (false) on the table.
        :param builtins.str attribute_name: The name of the TTL attribute used to store the expiration time for items in the table.
