...
class GetReplicationConfigResult:
    ...
    def replication_config_arn(self) -> Optional[builtins.str]:
        """
    ...
    def replication_config_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def source_endpoint_arn(self) -> Optional[builtins.str]:
        """
    ...
    def target_endpoint_arn(self) -> Optional[builtins.str]:
        """
...
def get_replication_config(replication_config_arn: Optional[builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReplicationConfigResult:
    """
    A replication configuration that you later provide to configure and start a AWS DMS Serverless replication


    :param builtins.str replication_config_arn: The Amazon Resource Name (ARN) of the Replication Config
    """
    __args__ = dict()
...
def get_replication_config_output(replication_config_arn: Optional[pulumi.Input[builtins.str]] = None,
