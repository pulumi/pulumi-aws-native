...
class GetDataMigrationResult:
    ...
    def data_migration_arn(self) -> Optional[builtins.str]:
        """
    ...
    def data_migration_create_time(self) -> Optional[builtins.str]:
        """
    ...
    def data_migration_name(self) -> Optional[builtins.str]:
        """
    ...
    def migration_project_identifier(self) -> Optional[builtins.str]:
        """
...
def get_data_migration(data_migration_arn: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataMigrationResult:
    """
    Resource schema for AWS::DMS::DataMigration.


    :param builtins.str data_migration_arn: The property describes an ARN of the data migration.
    """
    __args__ = dict()
...
def get_data_migration_output(data_migration_arn: Optional[pulumi.Input[builtins.str]] = None,
