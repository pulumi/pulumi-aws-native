...
class GetDataMigrationResult:
    ...
    def data_migration_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def data_migration_create_time(self) -> Optional[_builtins.str]:
        """
    ...
    def data_migration_name(self) -> Optional[_builtins.str]:
        """
    ...
    def migration_project_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_data_migration(data_migration_arn: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataMigrationResult:
    """
    Resource schema for AWS::DMS::DataMigration.


    :param _builtins.str data_migration_arn: The property describes an ARN of the data migration.
    """
    __args__ = dict()
