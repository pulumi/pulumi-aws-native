...
class DataProviderArgs:
    ...
    def exact_settings(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def exact_settings(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "exact_settings", value)

    @_builtins.property
    @pulumi.getter
    def settings(self) -> pulumi.Input[Optional['SettingsPropertiesArgs']]:
        """
    ...
    @settings.setter
    def settings(self, value: pulumi.Input[Optional['SettingsPropertiesArgs']]):
...
class DataProvider(pulumi.CustomResource):
    ...
    def data_provider_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def data_provider_creation_time(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataProviderIdentifier")
    def data_provider_identifier(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The property describes an identifier for the data provider. It is used for describing/deleting/modifying can be name/arn
        """
        return pulumi.get(self, "data_provider_identifier")
    ...
    @_builtins.property
    @pulumi.getter(name="dataProviderName")
    def data_provider_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The property describes a name to identify the data provider.
        """
        return pulumi.get(self, "data_provider_name")
    ...
    @_builtins.property
    @pulumi.getter(name="exactSettings")
    def exact_settings(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        The property describes the exact settings which can be modified
        """
        return pulumi.get(self, "exact_settings")
