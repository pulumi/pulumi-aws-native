...
class GetMigrationProjectResult:
    ...
    def migration_project_arn(self) -> Optional[builtins.str]:
        """
    ...
    def migration_project_creation_time(self) -> Optional[builtins.str]:
        """
    ...
    def migration_project_name(self) -> Optional[builtins.str]:
        """
    ...
    def transformation_rules(self) -> Optional[builtins.str]:
        """
...
def get_migration_project(migration_project_arn: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMigrationProjectResult:
    """
    Resource schema for AWS::DMS::MigrationProject


    :param builtins.str migration_project_arn: The property describes an ARN of the migration project.
    """
    __args__ = dict()
...
def get_migration_project_output(migration_project_arn: Optional[pulumi.Input[builtins.str]] = None,
