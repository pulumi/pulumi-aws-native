...
class GetMigrationProjectResult:
    ...
    def migration_project_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def migration_project_creation_time(self) -> Optional[_builtins.str]:
        """
    ...
    def migration_project_name(self) -> Optional[_builtins.str]:
        """
    ...
    def transformation_rules(self) -> Optional[_builtins.str]:
        """
...
def get_migration_project(migration_project_arn: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMigrationProjectResult:
    """
    Resource schema for AWS::DMS::MigrationProject


    :param _builtins.str migration_project_arn: The property describes an ARN of the migration project.
    """
    __args__ = dict()
