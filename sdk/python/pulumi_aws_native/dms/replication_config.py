...
class ReplicationConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_endpoint_arn: The Amazon Resource Name (ARN) of the source endpoint for this AWS DMS Serverless replication configuration
        ...
        :param Any replication_settings: JSON settings for Servereless replications that are provisioned using this replication configuration
               ...
               Search the [CloudFormation User Guide](https://docs.aws.amazon.com/cloudformation/) for `AWS::DMS::ReplicationConfig` for more information about the expected schema for this property.
        :param pulumi.Input[_builtins.str] resource_identifier: A unique value or name that you get set for a given resource that can be used to construct an Amazon Resource Name (ARN) for that resource
...
class ReplicationConfig(pulumi.CustomResource):
    ...
    def replication_config_arn(self) -> pulumi.Output[_builtins.str]:
        """
