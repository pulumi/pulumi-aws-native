...
class MigrationProjectArgs:
    def __init__(__self__, *,
                 ...
                 instance_profile_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 instance_profile_name: Optional[pulumi.Input[builtins.str]] = None,
                 migration_project_creation_time: Optional[pulumi.Input[builtins.str]] = None,
                 migration_project_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 migration_project_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 transformation_rules: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MigrationProject resource.
        :param pulumi.Input[builtins.str] description: The optional description of the migration project.
        :param pulumi.Input[builtins.str] instance_profile_arn: The property describes an instance profile arn for the migration project. For read
        :param pulumi.Input[builtins.str] instance_profile_identifier: The property describes an instance profile identifier for the migration project. For create
        :param pulumi.Input[builtins.str] instance_profile_name: The property describes an instance profile name for the migration project. For read
        :param pulumi.Input[builtins.str] migration_project_creation_time: The property describes a creating time of the migration project.
        ...
        :param pulumi.Input[builtins.str] migration_project_name: The property describes a name to identify the migration project.
        ...
        :param pulumi.Input[builtins.str] transformation_rules: The property describes transformation rules for the migration project.
        """
    ...
    def instance_profile_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_profile_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def migration_project_creation_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def migration_project_creation_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "migration_project_creation_time", value)

    @property
    @pulumi.getter(name="migrationProjectIdentifier")
    def migration_project_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def migration_project_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "migration_project_identifier", value)

    @property
    @pulumi.getter(name="migrationProjectName")
    def migration_project_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def migration_project_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transformation_rules(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transformation_rules(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MigrationProject(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="instanceProfileIdentifier")
    def instance_profile_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes an instance profile identifier for the migration project. For create
        """
        return pulumi.get(self, "instance_profile_identifier")
    ...
    @property
    @pulumi.getter(name="instanceProfileName")
    def instance_profile_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes an instance profile name for the migration project. For read
        """
        return pulumi.get(self, "instance_profile_name")
    ...
    def migration_project_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="migrationProjectCreationTime")
    def migration_project_creation_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes a creating time of the migration project.
        """
        return pulumi.get(self, "migration_project_creation_time")
    ...
    @property
    @pulumi.getter(name="migrationProjectIdentifier")
    def migration_project_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes an identifier for the migration project. It is used for describing/deleting/modifying can be name/arn
        """
        return pulumi.get(self, "migration_project_identifier")
    ...
    @property
    @pulumi.getter(name="migrationProjectName")
    def migration_project_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes a name to identify the migration project.
        """
        return pulumi.get(self, "migration_project_name")
    ...
    @property
    @pulumi.getter(name="transformationRules")
    def transformation_rules(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property describes transformation rules for the migration project.
        """
        return pulumi.get(self, "transformation_rules")
