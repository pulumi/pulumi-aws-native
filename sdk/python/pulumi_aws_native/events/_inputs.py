...
if not MYPY:
    class ConnectionApiKeyAuthParametersArgsDict(TypedDict):
        ...
        """
        api_key_value: pulumi.Input[builtins.str]
        """
...
class ConnectionApiKeyAuthParametersArgs:
    def __init__(__self__, *,
                 ...
                 api_key_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] api_key_name: The name of the API key to use for authorization.
        :param pulumi.Input[builtins.str] api_key_value: The value for the API key to use for authorization.
        """
    ...
    def api_key_value(self) -> pulumi.Input[builtins.str]:
        """
        The value for the API key to use for authorization.
        """
    ...
    def api_key_value(self, value: pulumi.Input[builtins.str]):
...
class ConnectionBasicAuthParametersArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password: The password associated with the user name to use for Basic authorization.
        :param pulumi.Input[builtins.str] username: The user name to use for Basic authorization.
        """
...
class ConnectionClientParametersArgs:
    def __init__(__self__, *,
                 ...
                 client_secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_id: The client ID to use for OAuth authorization.
        :param pulumi.Input[builtins.str] client_secret: The client secret assciated with the client ID to use for OAuth authorization.
        """
...
class ConnectionOAuthParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authorization_endpoint: The URL to the authorization endpoint when OAuth is specified as the authorization type.
...
class ConnectionParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The key for a query string parameter.
        :param pulumi.Input[builtins.str] value: The value associated with the key for the query string parameter.
        :param pulumi.Input[builtins.bool] is_value_secret: Specifies whether the value is secret.
        """
...
class ConnectionResourceParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_configuration_arn: The Amazon Resource Name (ARN) of the Amazon VPC Lattice resource configuration for the resource endpoint.
        :param pulumi.Input[builtins.str] resource_association_arn: For connections to private APIs, the Amazon Resource Name (ARN) of the resource association EventBridge created between the connection and the private API's resource configuration.
...
if not MYPY:
    class EndpointPrimaryArgsDict(TypedDict):
        health_check: pulumi.Input[builtins.str]
        """
...
class EndpointPrimaryArgs:
    ...
    def health_check(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the health check used by the endpoint to determine whether failover is triggered.
        """
    ...
    @health_check.setter
    def health_check(self, value: pulumi.Input[builtins.str]):
...
class EndpointSecondaryArgs:
    def __init__(__self__, *,
                 route: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] route: Defines the secondary Region.
        """
...
if not MYPY:
    class RuleAppSyncParametersArgsDict(TypedDict):
        graph_ql_operation: pulumi.Input[builtins.str]
        """
...
class RuleAppSyncParametersArgs:
    def __init__(__self__, *,
                 graph_ql_operation: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] graph_ql_operation: The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.
    ...
    def graph_ql_operation(self) -> pulumi.Input[builtins.str]:
        """
        The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.
    ...
    def graph_ql_operation(self, value: pulumi.Input[builtins.str]):
...
class RuleAwsVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] assign_public_ip: Specifies whether the task's elastic network interface receives a public IP address. You can specify `ENABLED` only when `LaunchType` in `EcsParameters` is set to `FARGATE` .
...
class RuleBatchArrayPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size: The size of the array, if this is an array batch job. Valid values are integers between 2 and 10,000.
        """
        if size is not None:
...
class RuleBatchRetryStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] attempts: The number of times to attempt to retry, if the job fails. Valid values are 1–10.
        """
...
class RuleHttpParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] header_parameters: The headers that need to be sent as part of request invoking the API Gateway API or EventBridge ApiDestination.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] path_parameter_values: The path parameter values to be used to populate API Gateway API or EventBridge ApiDestination path wildcards ("*").
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] query_string_parameters: The query string keys/values that need to be sent as part of request invoking the API Gateway API or EventBridge ApiDestination.
        """
        if header_parameters is not None:
            pulumi.set(__self__, "header_parameters", header_parameters)
...
if not MYPY:
    class RuleInputTransformerArgsDict(TypedDict):
        ...
        `}`
        """
        input_paths_map: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class RuleInputTransformerArgs:
    def __init__(__self__, *,
                 input_template: pulumi.Input[builtins.str],
                 input_paths_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] input_template: Input template where you specify placeholders that will be filled with the values of the keys from `InputPathsMap` to customize the data sent to the target. Enclose each `InputPathsMaps` value in brackets: < *value* >
               ...
               `}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_paths_map: Map of JSON paths to be extracted from the event. You can then insert these in the template in `InputTemplate` to produce the output you want to be sent to the target.
    ...
    def input_paths_map(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Map of JSON paths to be extracted from the event. You can then insert these in the template in `InputTemplate` to produce the output you want to be sent to the target.
    ...
    def input_paths_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class RulePlacementConstraintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of constraint. Use distinctInstance to ensure that each task in a particular group is running on a different container instance. Use memberOf to restrict the selection to a group of valid candidates.
        """
...
if not MYPY:
    class RuleRedshiftDataParametersArgsDict(TypedDict):
        ...
        """
        sqls: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleRedshiftDataParametersArgs:
    def __init__(__self__, *,
                 ...
                 sqls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] secret_manager_arn: The name or ARN of the secret that enables access to the database. Required when authenticating using AWS Secrets Manager.
        :param pulumi.Input[builtins.str] sql: The SQL statement text to run.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sqls: One or more SQL statements to run. The SQL statements are run as a single transaction. They run serially in the order of the array. Subsequent SQL statements don't start until the previous statement in the array completes. If any SQL statement fails, then because they are run as one transaction, all work is rolled back.
    ...
    @property
    @pulumi.getter
    def sqls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more SQL statements to run. The SQL statements are run as a single transaction. They run serially in the order of the array. Subsequent SQL statements don't start until the previous statement in the array completes. If any SQL statement fails, then because they are run as one transaction, all work is rolled back.
        """
    ...
    @sqls.setter
    def sqls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RuleRetryPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] maximum_event_age_in_seconds: The maximum amount of time, in seconds, to continue to make retry attempts.
        :param pulumi.Input[builtins.int] maximum_retry_attempts: The maximum number of retry attempts to make before the request fails. Retry attempts continue until either the maximum number of attempts is made or until the duration of the `MaximumEventAgeInSeconds` is met.
        """
...
if not MYPY:
    class RuleSqsParametersArgsDict(TypedDict):
        message_group_id: pulumi.Input[builtins.str]
        """
...
class RuleSqsParametersArgs:
    ...
    def message_group_id(self) -> pulumi.Input[builtins.str]:
        """
        The FIFO message group ID to use as the target.
        """
    ...
    def message_group_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class RuleTargetArgsDict(TypedDict):
        ...
        """
        input_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuleTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: The ID of the target within the specified rule. Use this ID to reference the target when updating the rule. We recommend using a memorable and unique string.
        ...
        :param pulumi.Input['RuleHttpParametersArgs'] http_parameters: Contains the HTTP parameters to use when the target is a API Gateway endpoint or EventBridge ApiDestination.
               ...
               If you specify an API Gateway API or EventBridge ApiDestination as a target, you can use this parameter to specify headers, path parameters, and query string keys/values as part of your target invoking request. If you're using ApiDestinations, the corresponding Connection can also have these values configured. In case of any conflicting keys, values from the Connection take precedence.
        :param pulumi.Input[builtins.str] input: Valid JSON text passed to the target. In this case, nothing from the event itself is passed to the target. For more information, see [The JavaScript Object Notation (JSON) Data Interchange Format](https://docs.aws.amazon.com/http://www.rfc-editor.org/rfc/rfc7159.txt) .
        :param pulumi.Input[builtins.str] input_path: The value of the JSONPath that is used for extracting part of the matched event when passing it to the target. You may use JSON dot notation or bracket notation. For more information about JSON paths, see [JSONPath](https://docs.aws.amazon.com/http://goessner.net/articles/JsonPath/) .
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be used for this target when the rule is triggered. If one rule triggers multiple targets, you can use a different IAM role for each target.
