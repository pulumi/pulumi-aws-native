...
class ConnectionApiKeyAuthParametersArgs:
    def __init__(__self__, *,
                 ...
                 api_key_value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] api_key_name: The name of the API key to use for authorization.
        :param pulumi.Input[_builtins.str] api_key_value: The value for the API key to use for authorization.
        """
...
class ConnectionAuthParametersArgsDict(TypedDict):
    api_key_auth_parameters: NotRequired[pulumi.Input[Optional['ConnectionApiKeyAuthParametersArgs']]]
    """
    The API Key parameters to use for authorization.
    """
    basic_auth_parameters: NotRequired[pulumi.Input[Optional['ConnectionBasicAuthParametersArgs']]]
    """
    The authorization parameters for Basic authorization.
    """
    connectivity_parameters: NotRequired[pulumi.Input[Optional['ConnectionConnectivityParametersArgs']]]
    """
    ...
    """
    invocation_http_parameters: NotRequired[pulumi.Input[Optional['ConnectionHttpParametersArgs']]]
    """
    Additional parameters for the connection that are passed through with every invocation to the HTTP endpoint.
    """
    o_auth_parameters: NotRequired[pulumi.Input[Optional['ConnectionOAuthParametersArgs']]]
    """
...
class ConnectionBasicAuthParametersArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The password associated with the user name to use for Basic authorization.
        :param pulumi.Input[_builtins.str] username: The user name to use for Basic authorization.
        """
...
class ConnectionClientParametersArgs:
    def __init__(__self__, *,
                 ...
                 client_secret: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] client_id: The client ID to use for OAuth authorization.
        :param pulumi.Input[_builtins.str] client_secret: The client secret assciated with the client ID to use for OAuth authorization.
        """
...
class ConnectionHttpParametersArgsDict(TypedDict):
    body_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConnectionParameterArgs']]]]]
    """
    Any additional body string parameters for the connection.
    """
    header_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConnectionParameterArgs']]]]]
    """
    Any additional header parameters for the connection.
    """
    query_string_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConnectionParameterArgs']]]]]
    """
...
class ConnectionOAuthParametersArgsDict(TypedDict):
    ...
    """
    o_auth_http_parameters: NotRequired[pulumi.Input[Optional['ConnectionHttpParametersArgs']]]
    """
...
class ConnectionParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_value_secret: Specifies whether the value is secret.
        """
...
class EndpointSecondaryArgs:
    def __init__(__self__, *,
                 route: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] route: Defines the secondary Region.
        """
...
class RuleAppSyncParametersArgsDict(TypedDict):
    graph_ql_operation: pulumi.Input[_builtins.str]
    """
...
class RuleAppSyncParametersArgs:
    def __init__(__self__, *,
                 graph_ql_operation: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] graph_ql_operation: The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.
    ...
    def graph_ql_operation(self) -> pulumi.Input[_builtins.str]:
        """
        The GraphQL operation; that is, the query, mutation, or subscription to be parsed and executed by the GraphQL service.
    ...
    def graph_ql_operation(self, value: pulumi.Input[_builtins.str]):
...
class RuleBatchParametersArgsDict(TypedDict):
    ...
    """
    array_properties: NotRequired[pulumi.Input[Optional['RuleBatchArrayPropertiesArgs']]]
    """
    The array properties for the submitted job, such as the size of the array. The array size can be between 2 and 10,000. If you specify array properties for a job, it becomes an array job. This parameter is used only if the target is an AWS Batch job.
    """
    retry_strategy: NotRequired[pulumi.Input[Optional['RuleBatchRetryStrategyArgs']]]
    """
...
class RuleEcsParametersArgsDict(TypedDict):
    ...
    """
    capacity_provider_strategy: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleCapacityProviderStrategyItemArgs']]]]]
    """
    ...
    """
    network_configuration: NotRequired[pulumi.Input[Optional['RuleNetworkConfigurationArgs']]]
    """
    Use this structure if the Amazon ECS task uses the `awsvpc` network mode. This structure specifies the VPC subnets and security groups associated with the task, and whether a public IP address is to be used. This structure is required if `LaunchType` is `FARGATE` because the `awsvpc` mode is required for Fargate tasks.

    If you specify `NetworkConfiguration` when the target ECS task does not use the `awsvpc` network mode, the task fails.
    """
    placement_constraints: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RulePlacementConstraintArgs']]]]]
    """
    An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime).
    """
    placement_strategies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RulePlacementStrategyArgs']]]]]
    """
    ...
    """
    tag_list: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleTagArgs']]]]]
    """
...
class RuleHttpParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] query_string_parameters: The query string keys/values that need to be sent as part of request invoking the API Gateway API or EventBridge ApiDestination.
        """
        if header_parameters is not None:
            pulumi.set(__self__, "header_parameters", header_parameters)
...
class RuleInputTransformerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] input_template: Input template where you specify placeholders that will be filled with the values of the keys from `InputPathsMap` to customize the data sent to the target. Enclose each `InputPathsMaps` value in brackets: < *value* >
               ...
               `}`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] input_paths_map: Map of JSON paths to be extracted from the event. You can then insert these in the template in `InputTemplate` to produce the output you want to be sent to the target.
...
class RuleNetworkConfigurationArgsDict(TypedDict):
    aws_vpc_configuration: NotRequired[pulumi.Input[Optional['RuleAwsVpcConfigurationArgs']]]
    """
...
class RuleRedshiftDataParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secret_manager_arn: The name or ARN of the secret that enables access to the database. Required when authenticating using AWS Secrets Manager.
        :param pulumi.Input[_builtins.str] sql: The SQL statement text to run.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sqls: One or more SQL statements to run. The SQL statements are run as a single transaction. They run serially in the order of the array. Subsequent SQL statements don't start until the previous statement in the array completes. If any SQL statement fails, then because they are run as one transaction, all work is rolled back.
...
class RuleSageMakerPipelineParametersArgsDict(TypedDict):
    pipeline_parameter_list: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleSageMakerPipelineParameterArgs']]]]]
    """
...
class RuleSqsParametersArgs:
    ...
    def message_group_id(self, value: pulumi.Input[_builtins.str]):
...
class RuleTargetArgsDict(TypedDict):
    ...
    """
    app_sync_parameters: NotRequired[pulumi.Input[Optional['RuleAppSyncParametersArgs']]]
    """
    Contains the GraphQL operation to be parsed and executed, if the event target is an AWS AppSync API.
    """
    batch_parameters: NotRequired[pulumi.Input[Optional['RuleBatchParametersArgs']]]
    """
    ...
    """
    dead_letter_config: NotRequired[pulumi.Input[Optional['RuleDeadLetterConfigArgs']]]
    """
    The `DeadLetterConfig` that defines the target queue to send dead-letter queue events to.
    """
    ecs_parameters: NotRequired[pulumi.Input[Optional['RuleEcsParametersArgs']]]
    """
    ...
    """
    http_parameters: NotRequired[pulumi.Input[Optional['RuleHttpParametersArgs']]]
    """
    ...
    """
    input_transformer: NotRequired[pulumi.Input[Optional['RuleInputTransformerArgs']]]
    """
    Settings to enable you to provide custom input to a target based on certain event data. You can extract one or more key-value pairs from the event and then use that data to send customized input to the target.
    """
    kinesis_parameters: NotRequired[pulumi.Input[Optional['RuleKinesisParametersArgs']]]
    """
    The custom parameter you can use to control the shard assignment, when the target is a Kinesis data stream. If you do not include this parameter, the default is to use the `eventId` as the partition key.
    """
    redshift_data_parameters: NotRequired[pulumi.Input[Optional['RuleRedshiftDataParametersArgs']]]
    """
    Contains the Amazon Redshift Data API parameters to use when the target is a Amazon Redshift cluster.

    If you specify a Amazon Redshift Cluster as a Target, you can use this to specify parameters to invoke the Amazon Redshift Data API ExecuteStatement based on EventBridge events.
    """
    retry_policy: NotRequired[pulumi.Input[Optional['RuleRetryPolicyArgs']]]
    """
    ...
    """
    run_command_parameters: NotRequired[pulumi.Input[Optional['RuleRunCommandParametersArgs']]]
    """
    Parameters used when you are using the rule to invoke Amazon EC2 Run Command.
    """
    sage_maker_pipeline_parameters: NotRequired[pulumi.Input[Optional['RuleSageMakerPipelineParametersArgs']]]
    """
    ...
    """
    sqs_parameters: NotRequired[pulumi.Input[Optional['RuleSqsParametersArgs']]]
    """
...
class RuleTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RuleHttpParametersArgs'] http_parameters: Contains the HTTP parameters to use when the target is a API Gateway endpoint or EventBridge ApiDestination.
               ...
               If you specify an API Gateway API or EventBridge ApiDestination as a target, you can use this parameter to specify headers, path parameters, and query string keys/values as part of your target invoking request. If you're using ApiDestinations, the corresponding Connection can also have these values configured. In case of any conflicting keys, values from the Connection take precedence.
        :param pulumi.Input[_builtins.str] input: Valid JSON text passed to the target. In this case, nothing from the event itself is passed to the target. For more information, see [The JavaScript Object Notation (JSON) Data Interchange Format](https://docs.aws.amazon.com/http://www.rfc-editor.org/rfc/rfc7159.txt) .
        :param pulumi.Input[_builtins.str] input_path: The value of the JSONPath that is used for extracting part of the matched event when passing it to the target. You may use JSON dot notation or bracket notation. For more information about JSON paths, see [JSONPath](https://docs.aws.amazon.com/http://goessner.net/articles/JsonPath/) .
        ...
        :param pulumi.Input[_builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be used for this target when the rule is triggered. If one rule triggers multiple targets, you can use a different IAM role for each target.
