...
class EventBusPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EventBusPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EventBusPolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EventBusPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EventBusPolicyProperties']:
        """
