...
class ApiDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_arn: The arn of the connection.
        ...
        :param pulumi.Input[builtins.str] invocation_endpoint: Url endpoint to invoke.
        :param pulumi.Input[builtins.str] description: A description for the API destination to create.
        :param pulumi.Input[builtins.int] invocation_rate_limit_per_second: The maximum number of requests per second to send to the HTTP invocation endpoint.
        :param pulumi.Input[builtins.str] name: Name of the apiDestination.
        """
