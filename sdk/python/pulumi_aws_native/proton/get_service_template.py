...
def get_service_template(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: <p>The Amazon Resource Name (ARN) of the service template.</p>
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_service_template_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServiceTemplateResult]:
    """
    Definition of AWS::Proton::ServiceTemplate Resource Type
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:proton:getServiceTemplate', __args__, opts=opts, typ=GetServiceTemplateResult)
    return __ret__.apply(lambda __response__: GetServiceTemplateResult(
