...
def get_service_template(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: <p>The Amazon Resource Name (ARN) of the service template.</p>
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_service_template_output(arn: Optional[pulumi.Input[builtins.str]] = None,
