...
class ServiceTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: <p>A description of the service template.</p>
        :param pulumi.Input[builtins.str] display_name: <p>The name of the service template as displayed in the developer interface.</p>
        :param pulumi.Input[builtins.str] encryption_key: <p>A customer provided encryption key that's used to encrypt data.</p>
        :param pulumi.Input[builtins.str] name: The name of the service template.
