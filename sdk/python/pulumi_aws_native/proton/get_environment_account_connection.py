...
class GetEnvironmentAccountConnectionResult:
    ...
    def codebuild_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def component_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def environment_account_id(self) -> Optional[builtins.str]:
        """
    ...
    def management_account_id(self) -> Optional[builtins.str]:
        """
...
def get_environment_account_connection(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the environment account connection.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_environment_account_connection_output(arn: Optional[pulumi.Input[builtins.str]] = None,
