...
def get_environment_template(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: <p>The Amazon Resource Name (ARN) of the environment template.</p>
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_environment_template_output(arn: Optional[pulumi.Input[builtins.str]] = None,
