...
class EnvironmentTemplateArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def provisioning(self) -> pulumi.Input[Optional['EnvironmentTemplateProvisioning']]:
        """
    ...
    @provisioning.setter
    def provisioning(self, value: pulumi.Input[Optional['EnvironmentTemplateProvisioning']]):
