...
def get_profiling_group(profiling_group_name: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProfilingGroupResult:
    """
    This resource schema represents the Profiling Group resource in the Amazon CodeGuru Profiler service.


    :param builtins.str profiling_group_name: The name of the profiling group.
    """
    __args__ = dict()
...
def get_profiling_group_output(profiling_group_name: Optional[pulumi.Input[builtins.str]] = None,
