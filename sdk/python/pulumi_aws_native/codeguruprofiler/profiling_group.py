...
class ProfilingGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ProfilingGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ProfilingGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ProfilingGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ProfilingGroupProperties']:
        """
