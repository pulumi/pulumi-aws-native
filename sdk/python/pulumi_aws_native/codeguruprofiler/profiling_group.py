...
class ProfilingGroupArgs:
    def __init__(__self__, *,
                 ...
                 profiling_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] profiling_group_name: The name of the profiling group.
    ...
    def profiling_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def profiling_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProfilingGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="profilingGroupName")
    def profiling_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the profiling group.
        """
        return pulumi.get(self, "profiling_group_name")
