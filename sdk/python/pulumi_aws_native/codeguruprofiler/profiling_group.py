...
class ProfilingGroupArgs:
    def __init__(__self__, *,
                 agent_permissions: pulumi.Input[Optional['AgentPermissionsPropertiesArgs']] = None,
                 anomaly_detection_notification_configuration: pulumi.Input[Optional[Sequence[pulumi.Input['ProfilingGroupChannelArgs']]]] = None,
                 compute_platform: pulumi.Input[Optional['ProfilingGroupComputePlatform']] = None,
                 profiling_group_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] profiling_group_name: The name of the profiling group.
    ...
    def agent_permissions(self) -> pulumi.Input[Optional['AgentPermissionsPropertiesArgs']]:
        """
    ...
    def agent_permissions(self, value: pulumi.Input[Optional['AgentPermissionsPropertiesArgs']]):
        pulumi.set(self, "agent_permissions", value)

    @_builtins.property
    @pulumi.getter(name="anomalyDetectionNotificationConfiguration")
    def anomaly_detection_notification_configuration(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ProfilingGroupChannelArgs']]]]:
        """
    ...
    def anomaly_detection_notification_configuration(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ProfilingGroupChannelArgs']]]]):
        pulumi.set(self, "anomaly_detection_notification_configuration", value)

    @_builtins.property
    @pulumi.getter(name="computePlatform")
    def compute_platform(self) -> pulumi.Input[Optional['ProfilingGroupComputePlatform']]:
        """
    ...
    def compute_platform(self, value: pulumi.Input[Optional['ProfilingGroupComputePlatform']]):
        pulumi.set(self, "compute_platform", value)

    @_builtins.property
    @pulumi.getter(name="profilingGroupName")
    def profiling_group_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def profiling_group_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("aws-native:codeguruprofiler:ProfilingGroup")
class ProfilingGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 agent_permissions: pulumi.Input[Optional[Union['AgentPermissionsPropertiesArgs', 'AgentPermissionsPropertiesArgsDict', 'outputs.AgentPermissionsProperties']]] = None,
                 anomaly_detection_notification_configuration: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ProfilingGroupChannelArgs', 'ProfilingGroupChannelArgsDict', 'outputs.ProfilingGroupChannel']]]]] = None,
                 compute_platform: pulumi.Input[Optional['ProfilingGroupComputePlatform']] = None,
                 profiling_group_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['AgentPermissionsPropertiesArgs', 'AgentPermissionsPropertiesArgsDict', 'outputs.AgentPermissionsProperties']] agent_permissions: The agent permissions attached to this profiling group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ProfilingGroupChannelArgs', 'ProfilingGroupChannelArgsDict', 'outputs.ProfilingGroupChannel']]]] anomaly_detection_notification_configuration: Configuration for Notification Channels for Anomaly Detection feature in CodeGuru Profiler which enables customers to detect anomalies in the application profile for those methods that represent the highest proportion of CPU time or latency
        :param pulumi.Input['ProfilingGroupComputePlatform'] compute_platform: The compute platform of the profiling group.
        :param pulumi.Input[_builtins.str] profiling_group_name: The name of the profiling group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags associated with a profiling group.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="profilingGroupName")
    def profiling_group_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the profiling group.
        """
        return pulumi.get(self, "profiling_group_name")
