...
class AccessPointVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vpc_id: Virtual Private Cloud (VPC) Id from which AccessPoint will allow requests.
        """
...
class BucketAbortIncompleteMultipartUploadArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the days since the initiation of an incomplete multipart upload that Amazon S3Outposts will wait before permanently removing all parts of the upload.
        :param pulumi.Input[builtins.int] days_after_initiation: Specifies the number of days after which Amazon S3Outposts aborts an incomplete multipart upload.
        """
...
class BucketFilterAndOperatorPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] prefix: Prefix identifies one or more objects to which the rule applies.
        """
...
class BucketRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] expiration_date: Indicates when objects are deleted from Amazon S3Outposts. The date value must be in ISO 8601 format. The time is always midnight UTC.
        :param pulumi.Input[builtins.int] expiration_in_days: Indicates the number of days after creation when objects are deleted from Amazon S3Outposts.
        :param pulumi.Input['BucketRuleFilterPropertiesArgs'] filter: The container for the filter of the lifecycle rule.
        :param pulumi.Input[builtins.str] id: Unique identifier for the lifecycle rule. The value can't be longer than 255 characters.
...
class EndpointFailedReasonArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] error_code: The failure code, if any, for a create or delete endpoint operation.
        :param pulumi.Input[builtins.str] message: Additional error details describing the endpoint failure and recommended action.
        """
