...
def get_bucket(arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBucketResult:
    """
    Resource Type Definition for AWS::S3Outposts::Bucket


    :param builtins.str arn: The Amazon Resource Name (ARN) of the specified bucket.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_bucket_output(arn: Optional[pulumi.Input[builtins.str]] = None,
