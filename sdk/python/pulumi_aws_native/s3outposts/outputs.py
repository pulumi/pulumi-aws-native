...
class AccessPointVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str vpc_id: Virtual Private Cloud (VPC) Id from which AccessPoint will allow requests.
        """
...
class BucketFilterAndOperatorProperties(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str prefix: Prefix identifies one or more objects to which the rule applies.
        """
...
class BucketRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str id: Unique identifier for the lifecycle rule. The value can't be longer than 255 characters.
...
class EndpointFailedReason(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str error_code: The failure code, if any, for a create or delete endpoint operation.
        :param _builtins.str message: Additional error details describing the endpoint failure and recommended action.
        """
