...
def get_access_point(arn: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessPointResult:
    """
    Resource Type Definition for AWS::S3Outposts::AccessPoint


    :param builtins.str arn: The Amazon Resource Name (ARN) of the specified AccessPoint.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_access_point_output(arn: Optional[pulumi.Input[builtins.str]] = None,
