...
class EndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] outpost_id: The id of the customer outpost on which the bucket resides.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group to use with the endpoint.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet in the selected VPC. The subnet must belong to the Outpost.
        ...
        :param pulumi.Input[builtins.str] customer_owned_ipv4_pool: The ID of the customer-owned IPv4 pool for the Endpoint. IP addresses will be allocated from this pool for the endpoint.
