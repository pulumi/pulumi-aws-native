...
class ProfilePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] statement_id: A unique identifier for the cross-account permission statement.
        :param pulumi.Input[_builtins.str] profile_version: The version of the signing profile.
        """
