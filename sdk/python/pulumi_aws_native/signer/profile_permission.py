...
class ProfilePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The AWS Signer action permitted as part of cross-account permissions.
        :param pulumi.Input[builtins.str] principal: The AWS principal receiving cross-account permissions. This may be an IAM role or another AWS account ID.
        :param pulumi.Input[builtins.str] profile_name: The human-readable name of the signing profile.
        :param pulumi.Input[builtins.str] statement_id: A unique identifier for the cross-account permission statement.
        :param pulumi.Input[builtins.str] profile_version: The version of the signing profile.
        """
...
@pulumi.type_token("aws-native:signer:ProfilePermission")
class ProfilePermission(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="profileVersion")
    def profile_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the signing profile.
        """
        return pulumi.get(self, "profile_version")
