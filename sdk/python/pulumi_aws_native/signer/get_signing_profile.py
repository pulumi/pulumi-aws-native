...
class GetSigningProfileResult:
    ...
    def profile_version_arn(self) -> Optional[builtins.str]:
        """
...
def get_signing_profile(arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSigningProfileResult:
    """
    A signing profile is a signing template that can be used to carry out a pre-defined signing job.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the specified signing profile.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_signing_profile_output(arn: Optional[pulumi.Input[builtins.str]] = None,
