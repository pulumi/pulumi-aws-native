...
class SigningProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_name: A name for the signing profile. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the signing profile name. 
...
class SigningProfile(pulumi.CustomResource):
    ...
    def profile_version_arn(self) -> pulumi.Output[builtins.str]:
        """
