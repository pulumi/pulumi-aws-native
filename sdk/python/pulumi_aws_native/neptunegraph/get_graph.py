...
class GetGraphResult:
    ...
    def graph_arn(self) -> Optional[_builtins.str]:
        """
        Graph resource ARN
        """
    ...
    def graph_id(self) -> Optional[_builtins.str]:
        """
    ...
    def provisioned_memory(self) -> Optional[_builtins.int]:
        """
    ...
    def public_connectivity(self) -> Optional[_builtins.bool]:
        """
...
def get_graph(graph_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str graph_id: The auto-generated id assigned by the service.
    """
    __args__ = dict()
