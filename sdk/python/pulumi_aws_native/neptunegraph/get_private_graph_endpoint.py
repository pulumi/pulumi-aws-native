...
class GetPrivateGraphEndpointResult:
    ...
    def private_graph_endpoint_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_private_graph_endpoint(private_graph_endpoint_identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_graph_endpoint_identifier: PrivateGraphEndpoint resource identifier generated by concatenating the associated GraphIdentifier and VpcId with an underscore separator.
...
def get_private_graph_endpoint_output(private_graph_endpoint_identifier: Optional[pulumi.Input[_builtins.str]] = None,
