...
class GraphArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] provisioned_memory: Memory for the Graph.
        ...
        :param pulumi.Input[builtins.str] graph_name: Contains a user-supplied name for the Graph. 
               
               If you don't specify a name, we generate a unique Graph Name using a combination of Stack Name and a UUID comprising of 4 characters.
               
               _Important_: If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name.
        :param pulumi.Input[builtins.bool] public_connectivity: Specifies whether the Graph can be reached over the internet. Access to all graphs requires IAM authentication.
        ...
        :param pulumi.Input[builtins.int] replica_count: Specifies the number of replicas you want when finished. All replicas will be provisioned in different availability zones.
...
class Graph(pulumi.CustomResource):
    ...
    def graph_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="graphName")
    def graph_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Contains a user-supplied name for the Graph. 
    ...
    @property
    @pulumi.getter(name="publicConnectivity")
    def public_connectivity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the Graph can be reached over the internet. Access to all graphs requires IAM authentication.
