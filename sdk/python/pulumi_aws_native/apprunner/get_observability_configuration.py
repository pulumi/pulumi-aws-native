...
class GetObservabilityConfigurationResult:
    ...
    def observability_configuration_revision(self) -> Optional[_builtins.int]:
        """
...
def get_observability_configuration(observability_configuration_arn: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObservabilityConfigurationResult:
    """
    The AWS::AppRunner::ObservabilityConfiguration resource  is an AWS App Runner resource type that specifies an App Runner observability configuration


    :param _builtins.str observability_configuration_arn: The Amazon Resource Name (ARN) of this ObservabilityConfiguration
    """
    __args__ = dict()
