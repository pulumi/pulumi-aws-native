...
class GetAutoScalingConfigurationResult:
    ...
    def auto_scaling_configuration_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def auto_scaling_configuration_revision(self) -> Optional[_builtins.int]:
        """
...
def get_auto_scaling_configuration(auto_scaling_configuration_arn: Optional[_builtins.str] = None,
