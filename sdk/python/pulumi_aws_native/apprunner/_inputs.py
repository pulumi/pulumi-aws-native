...
class ServiceAuthenticationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Authentication Configuration
        :param pulumi.Input[builtins.str] access_role_arn: Access Role Arn
        :param pulumi.Input[builtins.str] connection_arn: Connection Arn
        """
...
class ServiceCodeConfigurationValuesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] build_command: Build Command
        ...
        :param pulumi.Input[builtins.str] start_command: Start Command
        """
...
class ServiceCodeRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceCodeConfigurationArgs'] code_configuration: Configuration for building and running the service from a source code repository.
               ...
               > `CodeConfiguration` is required only for `CreateService` request.
        :param pulumi.Input[builtins.str] source_directory: Source Directory
        """
...
class ServiceEgressConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_connector_arn: The Amazon Resource Name (ARN) of the App Runner VpcConnector.
        """
...
class ServiceEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Encryption configuration (KMS key)
        :param pulumi.Input[builtins.str] kms_key: The KMS Key
        """
...
class ServiceHealthCheckConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Health check configuration
        :param pulumi.Input[builtins.int] healthy_threshold: Health check Healthy Threshold
        :param pulumi.Input[builtins.int] interval: Health check Interval
        :param pulumi.Input[builtins.str] path: Health check Path
        ...
        :param pulumi.Input[builtins.int] unhealthy_threshold: Health check Unhealthy Threshold
        """
...
class ServiceImageRepositoryArgs:
    def __init__(__self__, *,
        ...
        """
        Image Repository
        :param pulumi.Input[builtins.str] image_identifier: Image Identifier
...
if not MYPY:
    class ServiceIngressConfigurationArgsDict(TypedDict):
        ...
        """
        is_publicly_accessible: pulumi.Input[builtins.bool]
        """
...
class ServiceIngressConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Network ingress configuration
        :param pulumi.Input[builtins.bool] is_publicly_accessible: It's set to true if the Apprunner service is publicly accessible. It's set to false otherwise.
        """
        pulumi.set(__self__, "is_publicly_accessible", is_publicly_accessible)

    @property
    @pulumi.getter(name="isPubliclyAccessible")
    def is_publicly_accessible(self) -> pulumi.Input[builtins.bool]:
        """
        It's set to true if the Apprunner service is publicly accessible. It's set to false otherwise.
        """
    ...
    def is_publicly_accessible(self, value: pulumi.Input[builtins.bool]):
...
class ServiceInstanceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Instance Configuration
        :param pulumi.Input[builtins.str] cpu: CPU
        :param pulumi.Input[builtins.str] instance_role_arn: Instance Role Arn
        :param pulumi.Input[builtins.str] memory: Memory
        """
        if cpu is not None:
...
class ServiceKeyValuePairArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The key name string to map to a value.
        :param pulumi.Input[builtins.str] value: The value string to which the key name is mapped.
        """
        if name is not None:
...
class ServiceObservabilityConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Service observability configuration
        :param pulumi.Input[builtins.bool] observability_enabled: Observability enabled
        :param pulumi.Input[builtins.str] observability_configuration_arn: The Amazon Resource Name (ARN) of the App Runner ObservabilityConfiguration.
        """
...
class ServiceSourceCodeVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: Source Code Version Value
        """
...
class ServiceSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_deployments_enabled: Auto Deployment enabled
...
class VpcIngressConnectionIngressVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC that the VPC endpoint is used in.
        """
