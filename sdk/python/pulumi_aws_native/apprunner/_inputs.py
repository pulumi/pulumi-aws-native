...
class ServiceCodeConfigurationValuesArgsDict(TypedDict):
    ...
    Port
    """
    runtime_environment_secrets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceKeyValuePairArgs']]]]]
    """
    The secrets and parameters that get referenced by your service as environment variables
    """
    runtime_environment_variables: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceKeyValuePairArgs']]]]]
    """
...
class ServiceCodeConfigurationValuesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_command: Start Command
        """
...
class ServiceCodeConfigurationArgsDict(TypedDict):
    ...
    """
    code_configuration_values: NotRequired[pulumi.Input[Optional['ServiceCodeConfigurationValuesArgs']]]
    """
...
class ServiceCodeRepositoryArgsDict(TypedDict):
    ...
    """
    code_configuration: NotRequired[pulumi.Input[Optional['ServiceCodeConfigurationArgs']]]
    """
...
class ServiceCodeRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceCodeConfigurationArgs'] code_configuration: Configuration for building and running the service from a source code repository.
               ...
               > `CodeConfiguration` is required only for `CreateService` request.
        :param pulumi.Input[_builtins.str] source_directory: Source Directory
        """
...
class ServiceHealthCheckConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] unhealthy_threshold: Health check Unhealthy Threshold
        """
...
class ServiceImageRepositoryArgsDict(TypedDict):
    ...
    """
    image_configuration: NotRequired[pulumi.Input[Optional['ServiceImageConfigurationArgs']]]
    """
...
class ServiceIngressConfigurationArgs:
    ...
    def is_publicly_accessible(self) -> pulumi.Input[_builtins.bool]:
        """
        It's set to true if the Apprunner service is publicly accessible. It's set to false otherwise.
        """
    ...
    def is_publicly_accessible(self, value: pulumi.Input[_builtins.bool]):
...
class ServiceNetworkConfigurationArgsDict(TypedDict):
    ...
    """
    egress_configuration: NotRequired[pulumi.Input[Optional['ServiceEgressConfigurationArgs']]]
    """
    Network configuration settings for outbound message traffic.
    """
    ingress_configuration: NotRequired[pulumi.Input[Optional['ServiceIngressConfigurationArgs']]]
    """
...
class ServiceSourceConfigurationArgsDict(TypedDict):
    ...
    """
    authentication_configuration: NotRequired[pulumi.Input[Optional['ServiceAuthenticationConfigurationArgs']]]
    """
    ...
    """
    code_repository: NotRequired[pulumi.Input[Optional['ServiceCodeRepositoryArgs']]]
    """
    The description of a source code repository.

    You must provide either this member or `ImageRepository` (but not both).
    """
    image_repository: NotRequired[pulumi.Input[Optional['ServiceImageRepositoryArgs']]]
    """
