...
class GetVpcConnectorResult:
    ...
    def vpc_connector_revision(self) -> Optional[builtins.int]:
        """
...
def get_vpc_connector(vpc_connector_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpcConnectorResult:
    """
    The AWS::AppRunner::VpcConnector resource specifies an App Runner VpcConnector.


    :param builtins.str vpc_connector_arn: The Amazon Resource Name (ARN) of this VPC connector.
    """
    __args__ = dict()
...
def get_vpc_connector_output(vpc_connector_arn: Optional[pulumi.Input[builtins.str]] = None,
