...
warnings.warn("""ListenerCertificate is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ListenerCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 listener_arn: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ListenerCertificate is deprecated: ListenerCertificate is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
