...
class ListenerRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] priority: The rule priority. A listener can't have multiple rules with the same priority.
                If you try to reorder rules by updating their priorities, do not specify a new priority if an existing rule already uses this priority, as this can cause an error. If you need to reuse a priority with a different rule, you must remove it as a priority first, and then specify it in a subsequent update.
        :param pulumi.Input[builtins.str] listener_arn: The Amazon Resource Name (ARN) of the listener.
        """
...
class ListenerRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="listenerArn")
    def listener_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the listener.
        """
        return pulumi.get(self, "listener_arn")
