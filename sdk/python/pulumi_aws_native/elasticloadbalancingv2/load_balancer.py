...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scheme: The nodes of an Internet-facing load balancer have public IP addresses. The DNS name of an Internet-facing load balancer is publicly resolvable to the public IP addresses of the nodes. Therefore, Internet-facing load balancers can route requests from clients over the internet.
                The nodes of an internal load balancer have only private IP addresses. The DNS name of an internal load balancer is publicly resolvable to the private IP addresses of the nodes. Therefore, internal load balancers can route requests only from clients with access to the VPC for the load balancer.
                The default is an Internet-facing load balancer.
                You can't specify a scheme for a Gateway Load Balancer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: [Application Load Balancers and Network Load Balancers] The IDs of the security groups for the load balancer.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The IDs of the subnets. You can specify only one subnet per Availability Zone. You must specify either subnets or subnet mappings, but not both. To specify an Elastic IP address, specify subnet mappings instead of subnets.
    ...
    def enable_prefix_for_ipv6_source_nat(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enable_prefix_for_ipv6_source_nat(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def canonical_hosted_zone_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="enablePrefixForIpv6SourceNat")
    def enable_prefix_for_ipv6_source_nat(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [Network Load Balancers with UDP listeners] Indicates whether to use an IPv6 prefix from each subnet for source NAT. The IP address type must be ``dualstack``. The default value is ``off``.
        """
        return pulumi.get(self, "enable_prefix_for_ipv6_source_nat")
    ...
    def load_balancer_full_name(self) -> pulumi.Output[builtins.str]:
        """
