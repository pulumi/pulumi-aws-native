...
class GetTargetGroupResult:
    ...
    def health_check_port(self) -> Optional[builtins.str]:
        """
    ...
    def load_balancer_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def target_group_full_name(self) -> Optional[builtins.str]:
        """
    ...
    def target_group_name(self) -> Optional[builtins.str]:
        """
...
def get_target_group(target_group_arn: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTargetGroupResult:
    """
    Resource Type definition for AWS::ElasticLoadBalancingV2::TargetGroup


    :param builtins.str target_group_arn: The ARN of the Target Group
    """
    __args__ = dict()
...
def get_target_group_output(target_group_arn: Optional[pulumi.Input[builtins.str]] = None,
