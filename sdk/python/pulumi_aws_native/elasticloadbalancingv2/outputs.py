...
class ListenerAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int order: The order for the action. This value is required for rules with multiple actions. The action with the lowest value for order is performed first.
        ...
        :param builtins.str target_group_arn: The Amazon Resource Name (ARN) of the target group. Specify only when ``Type`` is ``forward`` and you want to route to a single target group. To route to one or more target groups, use ``ForwardConfig`` instead.
        """
...
class ListenerAuthenticateCognitoConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_timeout: Optional[builtins.str] = None):
        """
        Specifies information required when integrating with Amazon Cognito to authenticate users.
        :param builtins.str user_pool_arn: The Amazon Resource Name (ARN) of the Amazon Cognito user pool.
        :param builtins.str user_pool_client_id: The ID of the Amazon Cognito user pool client.
        :param builtins.str user_pool_domain: The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.
        :param Mapping[str, builtins.str] authentication_request_extra_params: The query parameters (up to 10) to include in the redirect request to the authorization endpoint.
        :param builtins.str on_unauthenticated_request: The behavior if the user is not authenticated. The following are possible values:
                 +  deny```` - Return an HTTP 401 Unauthorized error.
                 +  allow```` - Allow the request to be forwarded to the target.
                 +  authenticate```` - Redirect the request to the IdP authorization endpoint. This is the default value.
        :param builtins.str scope: The set of user claims to be requested from the IdP. The default is ``openid``.
                To verify which scope values your IdP supports and how to separate multiple values, see the documentation for your IdP.
        :param builtins.str session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        :param builtins.str session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        """
    ...
    def session_timeout(self) -> Optional[builtins.str]:
        """
...
class ListenerAuthenticateOidcConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_cookie_name: Optional[builtins.str] = None,
                 session_timeout: Optional[builtins.str] = None,
                 use_existing_client_secret: Optional[builtins.bool] = None):
        """
        Specifies information required using an identity provide (IdP) that is compliant with OpenID Connect (OIDC) to authenticate users.
        :param builtins.str authorization_endpoint: The authorization endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param builtins.str client_id: The OAuth 2.0 client identifier.
        :param builtins.str issuer: The OIDC issuer identifier of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param builtins.str token_endpoint: The token endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param builtins.str user_info_endpoint: The user info endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param Mapping[str, builtins.str] authentication_request_extra_params: The query parameters (up to 10) to include in the redirect request to the authorization endpoint.
        :param builtins.str client_secret: The OAuth 2.0 client secret. This parameter is required if you are creating a rule. If you are modifying a rule, you can omit this parameter if you set ``UseExistingClientSecret`` to true.
        :param builtins.str on_unauthenticated_request: The behavior if the user is not authenticated. The following are possible values:
                 +  deny```` - Return an HTTP 401 Unauthorized error.
                 +  allow```` - Allow the request to be forwarded to the target.
                 +  authenticate```` - Redirect the request to the IdP authorization endpoint. This is the default value.
        ...
        :param builtins.str session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        :param builtins.str session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        :param builtins.bool use_existing_client_secret: Indicates whether to use the existing client secret when modifying a rule. If you are creating a rule, you can omit this parameter or set it to false.
        """
    ...
    def use_existing_client_secret(self) -> Optional[builtins.bool]:
        """
...
class ListenerCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies an SSL server certificate to use as the default certificate for a secure listener.
        :param builtins.str certificate_arn: The Amazon Resource Name (ARN) of the certificate.
        """
...
class ListenerFixedResponseConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies information required when returning a custom HTTP response.
        :param builtins.str status_code: The HTTP response code (2XX, 4XX, or 5XX).
        :param builtins.str content_type: The content type.
                Valid Values: text/plain | text/css | text/html | application/javascript | application/json
        :param builtins.str message_body: The message.
        """
...
class ListenerMutualAuthentication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The mutual authentication configuration information.
        :param builtins.str advertise_trust_store_ca_names: Indicates whether trust store CA certificate names are advertised. The default value is ``off``.
        :param builtins.bool ignore_client_certificate_expiry: Indicates whether expired client certificates are ignored.
        :param builtins.str mode: The client certificate handling method. The possible values are ``off``, ``passthrough``, and ``verify``. The default value is ``off``.
...
class ListenerRedirectConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        Information about a redirect action.
         ...
         For example, you can change the path to "/new/#{path}", the hostname to "example.#{host}", or the query to "#{query}&value=xyz".
        :param builtins.str status_code: The HTTP redirect code. The redirect is either permanent (HTTP 301) or temporary (HTTP 302).
        :param builtins.str host: The hostname. This component is not percent-encoded. The hostname can contain #{host}.
        :param builtins.str path: The absolute path, starting with the leading "/". This component is not percent-encoded. The path can contain #{host}, #{path}, and #{port}.
        :param builtins.str port: The port. You can specify a value from 1 to 65535 or #{port}.
        :param builtins.str protocol: The protocol. You can specify HTTP, HTTPS, or #{protocol}. You can redirect HTTP to HTTP, HTTP to HTTPS, and HTTPS to HTTPS. You can't redirect HTTPS to HTTP.
        :param builtins.str query: The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading "?", as it is automatically added. You can specify any of the reserved keywords.
        """
        pulumi.set(__self__, "status_code", status_code)
        if host is not None:
...
class ListenerRuleAuthenticateCognitoConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str scope: The set of user claims to be requested from the IdP. The default is ``openid``.
                To verify which scope values your IdP supports and how to separate multiple values, see the documentation for your IdP.
        :param builtins.str session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        :param builtins.int session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        """
        pulumi.set(__self__, "user_pool_arn", user_pool_arn)
        pulumi.set(__self__, "user_pool_client_id", user_pool_client_id)
        pulumi.set(__self__, "user_pool_domain", user_pool_domain)
...
class ListenerRuleHttpHeaderConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        Information about an HTTP header condition.
         There is a set of standard HTTP header fields. You can also define custom HTTP header fields.
        :param builtins.str http_header_name: The name of the HTTP header field. The maximum size is 40 characters. The header name is case insensitive. The allowed characters are specified by RFC 7230. Wildcards are not supported.
        :param Sequence[builtins.str] values: The strings to compare against the value of the HTTP header. The maximum size of each string is 128 characters. The comparison strings are case insensitive. The following wildcard characters are supported: * (matches 0 or more characters) and ? (matches exactly 1 character).
...
class ListenerRuleHttpRequestMethodConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        Information about an HTTP method condition.
         HTTP defines a set of request methods, also referred to as HTTP verbs. For more information, see the [HTTP Method Registry](https://docs.aws.amazon.com/https://www.iana.org/assignments/http-methods/http-methods.xhtml). You can also define custom HTTP methods.
        :param Sequence[builtins.str] values: The name of the request method. The maximum size is 40 characters. The allowed characters are A-Z, hyphen (-), and underscore (_). The comparison is case sensitive. Wildcards are not supported; therefore, the method name must be an exact match.
...
class ListenerRulePathPatternConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a path pattern condition.
        :param Sequence[builtins.str] values: The path patterns to compare against the request URL. The maximum size of each string is 128 characters. The comparison is case sensitive. The following wildcard characters are supported: * (matches 0 or more characters) and ? (matches exactly 1 character).
...
class ListenerRuleQueryStringKeyValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a key/value pair.
        :param builtins.str key: The key. You can omit the key.
...
class ListenerRuleRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a condition for a listener rule.
        :param builtins.str field: The field in the HTTP request. The following are the possible values:
                 +   ``http-header`` 
                 +   ``http-request-method`` 
                 +   ``host-header`` 
                 +   ``path-pattern`` 
        ...
        :param Sequence[builtins.str] values: The condition value. Specify only when ``Field`` is ``host-header`` or ``path-pattern``. Alternatively, to specify multiple host names or multiple path patterns, use ``HostHeaderConfig`` or ``PathPatternConfig``.
...
class ListenerRuleSourceIpConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        Information about a source IP condition.
         You can use this condition to route based on the IP address of the source that connects to the load balancer. If a client is behind a proxy, this is the IP address of the proxy not the IP address of the client.
        :param Sequence[builtins.str] values: The source IP addresses, in CIDR format. You can use both IPv4 and IPv6 addresses. Wildcards are not supported.
...
class ListenerRuleTargetGroupTuple(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about how traffic will be distributed between multiple target groups in a forward rule.
        :param builtins.str target_group_arn: The Amazon Resource Name (ARN) of the target group.
...
class LoadBalancerSubnetMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 i_pv6_address: Optional[builtins.str] = None,
                 private_i_pv4_address: Optional[builtins.str] = None,
                 source_nat_ipv6_prefix: Optional[builtins.str] = None):
        """
        Specifies a subnet for a load balancer.
        :param builtins.str subnet_id: The ID of the subnet.
        :param builtins.str allocation_id: [Network Load Balancers] The allocation ID of the Elastic IP address for an internet-facing load balancer.
        :param builtins.str i_pv6_address: [Network Load Balancers] The IPv6 address.
        :param builtins.str private_i_pv4_address: [Network Load Balancers] The private IPv4 address for an internal load balancer.
        :param builtins.str source_nat_ipv6_prefix: [Network Load Balancers with UDP listeners] The IPv6 prefix to use for source NAT. Specify an IPv6 prefix (/80 netmask) from the subnet CIDR block or ``auto_assigned`` to use an IPv6 prefix selected at random from the subnet CIDR block.
        """
    ...
    def i_pv6_address(self) -> Optional[builtins.str]:
        """
    ...
    def private_i_pv4_address(self) -> Optional[builtins.str]:
        """
    ...
    def source_nat_ipv6_prefix(self) -> Optional[builtins.str]:
        """
...
class TargetGroupAttribute(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str key: The value of the attribute.
        :param builtins.str value: The name of the attribute.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class TargetGroupMatcher(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str grpc_code: You can specify values between 0 and 99. You can specify multiple values, or a range of values. The default value is 12.
        :param builtins.str http_code: For Application Load Balancers, you can specify values between 200 and 499, and the default value is 200. You can specify multiple values or a range of values. 
        """
...
class TargetGroupTargetDescription(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the target. If the target type of the target group is instance, specify an instance ID. If the target type is ip, specify an IP address. If the target type is lambda, specify the ARN of the Lambda function. If the target type is alb, specify the ARN of the Application Load Balancer target. 
        :param builtins.str availability_zone: An Availability Zone or all. This determines whether the target receives traffic from the load balancer nodes in the specified Availability Zone or from all enabled Availability Zones for the load balancer.
        :param builtins.int port: The port on which the target is listening. If the target group protocol is GENEVE, the supported port is 6081. If the target type is alb, the targeted Application Load Balancer must have at least one listener whose port matches the target group port. Not used if the target is a Lambda function.
        """
...
class TrustStoreRevocation(dict):
    ...
    def __init__(__self__, *,
                 number_of_revoked_entries: Optional[builtins.int] = None,
                 revocation_id: Optional[builtins.str] = None,
                 revocation_type: Optional[builtins.str] = None,
                 trust_store_arn: Optional[builtins.str] = None):
        """
        :param builtins.int number_of_revoked_entries: The number of revoked certificates.
        :param builtins.str revocation_id: The revocation ID of the revocation file.
        :param builtins.str revocation_type: The type of revocation file.
        :param builtins.str trust_store_arn: The Amazon Resource Name (ARN) of the trust store.
        """
    ...
    def number_of_revoked_entries(self) -> Optional[builtins.int]:
        """
    ...
    def revocation_id(self) -> Optional[builtins.str]:
        """
    ...
    def revocation_type(self) -> Optional[builtins.str]:
        """
...
class TrustStoreRevocationRevocationContent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str revocation_type: The type of revocation file.
        :param builtins.str s3_bucket: The Amazon S3 bucket for the revocation file.
        :param builtins.str s3_key: The Amazon S3 path for the revocation file.
        :param builtins.str s3_object_version: The Amazon S3 object version of the revocation file.
        """
        if revocation_type is not None:
            pulumi.set(__self__, "revocation_type", revocation_type)
