...
__all__ = [
    ...
    'ListenerJwtValidationActionAdditionalClaim',
    'ListenerJwtValidationConfig',
    ...
    'ListenerRuleJwtValidationActionAdditionalClaim',
    'ListenerRuleJwtValidationConfig',
...
class ListenerAction(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "jwtValidationConfig":
            suggest = "jwt_validation_config"
    ...
    def __init__(__self__, *,
                 ...
                 jwt_validation_config: Optional['outputs.ListenerJwtValidationConfig'] = None,
...
class ListenerAuthenticateCognitoConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_timeout: Optional[_builtins.str] = None):
        """
        Specifies information required when integrating with Amazon Cognito to authenticate users.
        :param _builtins.str user_pool_arn: The Amazon Resource Name (ARN) of the Amazon Cognito user pool.
        :param _builtins.str user_pool_client_id: The ID of the Amazon Cognito user pool client.
        :param _builtins.str user_pool_domain: The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.
        ...
        :param _builtins.str on_unauthenticated_request: The behavior if the user is not authenticated. The following are possible values:
                 +  deny```` - Return an HTTP 401 Unauthorized error.
                 +  allow```` - Allow the request to be forwarded to the target.
                 +  authenticate```` - Redirect the request to the IdP authorization endpoint. This is the default value.
        :param _builtins.str scope: The set of user claims to be requested from the IdP. The default is ``openid``.
    ...
    def session_timeout(self) -> Optional[_builtins.str]:
        """
...
class ListenerAuthenticateOidcConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_cookie_name: Optional[_builtins.str] = None,
                 session_timeout: Optional[_builtins.str] = None,
                 use_existing_client_secret: Optional[_builtins.bool] = None):
        """
        Specifies information required using an identity provide (IdP) that is compliant with OpenID Connect (OIDC) to authenticate users.
        ...
        :param _builtins.str token_endpoint: The token endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param _builtins.str user_info_endpoint: The user info endpoint of the IdP. This must be a full URL, including the HTTPS protocol, the domain, and the path.
        :param Mapping[str, _builtins.str] authentication_request_extra_params: The query parameters (up to 10) to include in the redirect request to the authorization endpoint.
        ...
        :param _builtins.str session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        :param _builtins.str session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        :param _builtins.bool use_existing_client_secret: Indicates whether to use the existing client secret when modifying a rule. If you are creating a rule, you can omit this parameter or set it to false.
        """
    ...
    def use_existing_client_secret(self) -> Optional[_builtins.bool]:
        """
...
@pulumi.output_type
class ListenerJwtValidationConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "jwksEndpoint":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ListenerJwtValidationConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ListenerJwtValidationConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 additional_claims: Optional[Sequence['outputs.ListenerJwtValidationActionAdditionalClaim']] = None):
        pulumi.set(__self__, "issuer", issuer)
    ...
    def additional_claims(self) -> Optional[Sequence['outputs.ListenerJwtValidationActionAdditionalClaim']]:
...
class ListenerRedirectConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str protocol: The protocol. You can specify HTTP, HTTPS, or #{protocol}. You can redirect HTTP to HTTP, HTTP to HTTPS, and HTTPS to HTTPS. You can't redirect HTTPS to HTTP.
        :param _builtins.str query: The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading "?", as it is automatically added. You can specify any of the reserved keywords.
        """
        pulumi.set(__self__, "status_code", status_code)
        if host is not None:
...
class ListenerRuleAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jwt_validation_config: Optional['outputs.ListenerRuleJwtValidationConfig'] = None,
                 order: Optional[_builtins.int] = None,
...
class ListenerRuleAuthenticateCognitoConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str scope: The set of user claims to be requested from the IdP. The default is ``openid``.
                To verify which scope values your IdP supports and how to separate multiple values, see the documentation for your IdP.
        :param _builtins.str session_cookie_name: The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.
        :param _builtins.int session_timeout: The maximum duration of the authentication session, in seconds. The default is 604800 seconds (7 days).
        """
        pulumi.set(__self__, "user_pool_arn", user_pool_arn)
        pulumi.set(__self__, "user_pool_client_id", user_pool_client_id)
        pulumi.set(__self__, "user_pool_domain", user_pool_domain)
...
@pulumi.output_type
class ListenerRuleJwtValidationConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "jwksEndpoint":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ListenerRuleJwtValidationConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ListenerRuleJwtValidationConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 issuer: _builtins.str,
                 jwks_endpoint: _builtins.str,
                 additional_claims: Optional[Sequence['outputs.ListenerRuleJwtValidationActionAdditionalClaim']] = None):
        pulumi.set(__self__, "issuer", issuer)
        pulumi.set(__self__, "jwks_endpoint", jwks_endpoint)
        if additional_claims is not None:
            pulumi.set(__self__, "additional_claims", additional_claims)
    ...
    @_builtins.property
    @pulumi.getter(name="additionalClaims")
    def additional_claims(self) -> Optional[Sequence['outputs.ListenerRuleJwtValidationActionAdditionalClaim']]:
        return pulumi.get(self, "additional_claims")
...
class ListenerRuleQueryStringKeyValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a key/value pair.
        :param _builtins.str key: The key. You can omit the key.
...
class LoadBalancerSubnetMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_nat_ipv6_prefix: Optional[_builtins.str] = None):
        """
        Specifies a subnet for a load balancer.
        ...
        :param _builtins.str source_nat_ipv6_prefix: [Network Load Balancers with UDP listeners] The IPv6 prefix to use for source NAT. Specify an IPv6 prefix (/80 netmask) from the subnet CIDR block or ``auto_assigned`` to use an IPv6 prefix selected at random from the subnet CIDR block.
        """
    ...
    def i_pv6_address(self) -> Optional[_builtins.str]:
        """
    ...
    def source_nat_ipv6_prefix(self) -> Optional[_builtins.str]:
        """
...
class TargetGroupTargetDescription(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "quicServerId":
            suggest = "quic_server_id"
    ...
    def quic_server_id(self) -> Optional[_builtins.str]:
        """
...
class TrustStoreRevocation(dict):
    ...
    def __init__(__self__, *,
                 number_of_revoked_entries: Optional[_builtins.int] = None,
                 revocation_id: Optional[_builtins.str] = None,
                 revocation_type: Optional[_builtins.str] = None,
                 trust_store_arn: Optional[_builtins.str] = None):
        """
        :param _builtins.int number_of_revoked_entries: The number of revoked certificates.
        :param _builtins.str revocation_id: The revocation ID of the revocation file.
        :param _builtins.str revocation_type: The type of revocation file.
        :param _builtins.str trust_store_arn: The Amazon Resource Name (ARN) of the trust store.
        """
    ...
    def number_of_revoked_entries(self) -> Optional[_builtins.int]:
        """
    ...
    def revocation_id(self) -> Optional[_builtins.str]:
        """
    ...
    def revocation_type(self) -> Optional[_builtins.str]:
        """
...
class TrustStoreRevocationRevocationContent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str revocation_type: The type of revocation file.
        :param _builtins.str s3_bucket: The Amazon S3 bucket for the revocation file.
        :param _builtins.str s3_key: The Amazon S3 path for the revocation file.
        :param _builtins.str s3_object_version: The Amazon S3 object version of the revocation file.
        """
        if revocation_type is not None:
            pulumi.set(__self__, "revocation_type", revocation_type)
