...
class ListenerMutualAuthentication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The mutual authentication configuration information.
        :param builtins.str advertise_trust_store_ca_names: Indicates whether trust store CA certificate names are advertised.
        :param builtins.bool ignore_client_certificate_expiry: Indicates whether expired client certificates are ignored.
        :param builtins.str mode: The client certificate handling method. Options are ``off``, ``passthrough`` or ``verify``. The default value is ``off``.
