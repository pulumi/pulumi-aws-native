...
class TrustStoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ca_certificates_bundle_s3_bucket: The name of the S3 bucket to fetch the CA certificate bundle from.
        :param pulumi.Input[builtins.str] ca_certificates_bundle_s3_key: The name of the S3 object to fetch the CA certificate bundle from.
        :param pulumi.Input[builtins.str] ca_certificates_bundle_s3_object_version: The version of the S3 bucket that contains the CA certificate bundle.
        :param pulumi.Input[builtins.str] name: The name of the trust store.
...
class TrustStore(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="caCertificatesBundleS3Bucket")
    def ca_certificates_bundle_s3_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the S3 bucket to fetch the CA certificate bundle from.
        """
        return pulumi.get(self, "ca_certificates_bundle_s3_bucket")
    ...
    @property
    @pulumi.getter(name="caCertificatesBundleS3Key")
    def ca_certificates_bundle_s3_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the S3 object to fetch the CA certificate bundle from.
        """
        return pulumi.get(self, "ca_certificates_bundle_s3_key")
    ...
    def number_of_ca_certificates(self) -> pulumi.Output[builtins.int]:
        """
