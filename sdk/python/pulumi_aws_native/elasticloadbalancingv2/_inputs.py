...
class ListenerMutualAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        The mutual authentication configuration information.
        :param pulumi.Input[builtins.str] advertise_trust_store_ca_names: Indicates whether trust store CA certificate names are advertised. The default value is ``off``.
        ...
        :param pulumi.Input[builtins.str] mode: The client certificate handling method. The possible values are ``off``, ``passthrough``, and ``verify``. The default value is ``off``.
