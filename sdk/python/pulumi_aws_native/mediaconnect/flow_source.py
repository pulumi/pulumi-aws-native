...
class FlowSourceInitArgs:
    ...
    def flow_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the flow.
        """
    ...
    @flow_arn.setter
    def flow_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowSource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="entitlementArn")
    def entitlement_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the entitlement that allows you to subscribe to content that comes from another AWS account. The entitlement is set by the content originator and the ARN is generated as part of the originator's flow.
        """
        return pulumi.get(self, "entitlement_arn")
    ...
    @property
    @pulumi.getter(name="flowArn")
    def flow_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the flow.
        """
        return pulumi.get(self, "flow_arn")
    ...
    def ingest_ip(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="ingestPort")
    def ingest_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port that the flow will be listening on for incoming content.
        """
        return pulumi.get(self, "ingest_port")
    ...
    @property
    @pulumi.getter(name="maxBitrate")
    def max_bitrate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The smoothing max bitrate for RIST, RTP, and RTP-FEC streams.
        """
        return pulumi.get(self, "max_bitrate")
    ...
    @property
    @pulumi.getter(name="senderControlPort")
    def sender_control_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port that the flow uses to send outbound requests to initiate connection with the sender for fujitsu-qos protocol.
        """
        return pulumi.get(self, "sender_control_port")
    ...
    @property
    @pulumi.getter(name="senderIpAddress")
    def sender_ip_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP address that the flow communicates with to initiate connection with the sender for fujitsu-qos protocol.
        """
        return pulumi.get(self, "sender_ip_address")
    ...
    def source_ingest_port(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sourceListenerAddress")
    def source_listener_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Source IP or domain name for SRT-caller protocol.
        """
        return pulumi.get(self, "source_listener_address")
    ...
    @property
    @pulumi.getter(name="sourceListenerPort")
    def source_listener_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Source port for SRT-caller protocol.
        """
        return pulumi.get(self, "source_listener_port")
    ...
    @property
    @pulumi.getter(name="vpcInterfaceName")
    def vpc_interface_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the VPC Interface this Source is configured with.
        """
        return pulumi.get(self, "vpc_interface_name")
    ...
    @property
    @pulumi.getter(name="whitelistCidr")
    def whitelist_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The range of IP addresses that should be allowed to contribute content to your source. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        """
        return pulumi.get(self, "whitelist_cidr")
