...
__all__ = [
    ...
    'BridgeOutputBridgeNetworkOutputArgs',
    'BridgeOutputArgs',
...
@pulumi.input_type
class BridgeOutputBridgeNetworkOutputArgs:
    def __init__(__self__, *,
                 ip_address: pulumi.Input[str],
                 network_name: pulumi.Input[str],
                 port: pulumi.Input[int],
                 protocol: pulumi.Input['BridgeOutputBridgeNetworkOutputProtocol'],
                 ttl: pulumi.Input[int]):
        """
        The output of the bridge. A network output is delivered to your premises.
        :param pulumi.Input[str] ip_address: The network output IP Address.
        :param pulumi.Input[str] network_name: The network output's gateway network name.
        :param pulumi.Input[int] port: The network output port.
        :param pulumi.Input['BridgeOutputBridgeNetworkOutputProtocol'] protocol: The network output protocol.
        :param pulumi.Input[int] ttl: The network output TTL.
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "network_name", network_name)
    ...
    @property
    @pulumi.getter
    def protocol(self) -> pulumi.Input['BridgeOutputBridgeNetworkOutputProtocol']:
        """
        The network output protocol.
        """
        return pulumi.get(self, "protocol")
    ...
    @protocol.setter
    def protocol(self, value: pulumi.Input['BridgeOutputBridgeNetworkOutputProtocol']):
        pulumi.set(self, "protocol", value)
