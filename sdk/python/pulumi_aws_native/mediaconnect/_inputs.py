...
if not MYPY:
    class BridgeEgressGatewayBridgeArgsDict(TypedDict):
        max_bitrate: pulumi.Input[builtins.int]
        """
...
class BridgeEgressGatewayBridgeArgs:
    def __init__(__self__, *,
                 max_bitrate: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_bitrate: The maximum expected bitrate of the egress bridge.
        """
        pulumi.set(__self__, "max_bitrate", max_bitrate)

    @property
    @pulumi.getter(name="maxBitrate")
    def max_bitrate(self) -> pulumi.Input[builtins.int]:
        """
        The maximum expected bitrate of the egress bridge.
        """
    ...
    @max_bitrate.setter
    def max_bitrate(self, value: pulumi.Input[builtins.int]):
...
class BridgeFlowSourceArgs:
    def __init__(__self__, *,
        ...
        """
        The source of the bridge. A flow source originates in MediaConnect as an existing cloud flow.
        :param pulumi.Input[builtins.str] flow_arn: The ARN of the cloud flow used as a source of this bridge.
        :param pulumi.Input[builtins.str] name: The name of the flow source.
...
if not MYPY:
    class BridgeIngressGatewayBridgeArgsDict(TypedDict):
        ...
        """
        max_outputs: pulumi.Input[builtins.int]
        """
...
class BridgeIngressGatewayBridgeArgs:
    def __init__(__self__, *,
                 ...
                 max_outputs: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_bitrate: The maximum expected bitrate of the ingress bridge.
        :param pulumi.Input[builtins.int] max_outputs: The maximum number of outputs on the ingress bridge.
        """
        pulumi.set(__self__, "max_bitrate", max_bitrate)
    ...
    def max_outputs(self) -> pulumi.Input[builtins.int]:
        """
        The maximum number of outputs on the ingress bridge.
        """
    ...
    @max_outputs.setter
    def max_outputs(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class BridgeMulticastSourceSettingsArgsDict(TypedDict):
        ...
        """
        multicast_source_ip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BridgeMulticastSourceSettingsArgs:
    def __init__(__self__, *,
                 multicast_source_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        The settings related to the multicast source.
        :param pulumi.Input[builtins.str] multicast_source_ip: The IP address of the source for source-specific multicast (SSM).
        """
    ...
    def multicast_source_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address of the source for source-specific multicast (SSM).
        """
    ...
    def multicast_source_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BridgeNetworkOutputArgs:
    def __init__(__self__, *,
        ...
        """
        The output of the bridge. A network output is delivered to your premises.
        :param pulumi.Input[builtins.str] ip_address: The network output IP Address.
        :param pulumi.Input[builtins.str] name: The network output name.
        :param pulumi.Input[builtins.str] network_name: The network output's gateway network name.
        :param pulumi.Input[builtins.int] port: The network output port.
        :param pulumi.Input['BridgeProtocolEnum'] protocol: The network output protocol.
        :param pulumi.Input[builtins.int] ttl: The network output TTL.
        """
...
if not MYPY:
    class BridgeNetworkSourceArgsDict(TypedDict):
        ...
        """
        multicast_ip: pulumi.Input[builtins.str]
        """
...
class BridgeNetworkSourceArgs:
    def __init__(__self__, *,
        ...
        """
        The source of the bridge. A network source originates at your premises.
        :param pulumi.Input[builtins.str] multicast_ip: The network source multicast IP.
        :param pulumi.Input[builtins.str] name: The name of the network source.
        :param pulumi.Input[builtins.str] network_name: The network source's gateway network name.
        :param pulumi.Input[builtins.int] port: The network source port.
    ...
    def multicast_ip(self) -> pulumi.Input[builtins.str]:
        """
        The network source multicast IP.
        """
    ...
    @multicast_ip.setter
    def multicast_ip(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BridgeSourcePriorityArgsDict(TypedDict):
        ...
        The priority you want to assign to a source. You can have a primary stream and a backup stream or two equally prioritized streams.
        """
        primary_source: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BridgeSourcePriorityArgs:
    def __init__(__self__, *,
                 primary_source: Optional[pulumi.Input[builtins.str]] = None):
        """
        The priority you want to assign to a source. You can have a primary stream and a backup stream or two equally prioritized streams.
        :param pulumi.Input[builtins.str] primary_source: The name of the source you choose as the primary source for this flow.
        """
    ...
    def primary_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the source you choose as the primary source for this flow.
        """
    ...
    def primary_source(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BridgeSourceVpcInterfaceAttachmentArgsDict(TypedDict):
        ...
        """
        vpc_interface_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BridgeSourceVpcInterfaceAttachmentArgs:
    def __init__(__self__, *,
                 vpc_interface_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The settings for attaching a VPC interface to an resource.
        :param pulumi.Input[builtins.str] vpc_interface_name: The name of the VPC interface to use for this resource.
        """
    ...
    def vpc_interface_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the VPC interface to use for this resource.
        """
    ...
    def vpc_interface_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FlowBlackFramesArgsDict(TypedDict):
        ...
        """
        threshold_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FlowBlackFramesArgs:
    def __init__(__self__, *,
                 ...
                 threshold_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        Configures settings for the BlackFrames metric.
        :param pulumi.Input['FlowBlackFramesState'] state: Indicates whether the BlackFrames metric is enabled or disabled.
        :param pulumi.Input[builtins.int] threshold_seconds: Specifies the number of consecutive seconds of black frames that triggers an event or alert.
        """
        if state is not None:
            pulumi.set(__self__, "state", state)
    ...
    def threshold_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the number of consecutive seconds of black frames that triggers an event or alert.
        """
    ...
    def threshold_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FlowEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the encryption of the flow.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the role that you created during setup (when you set up AWS Elemental MediaConnect as a trusted entity).
        ...
        :param pulumi.Input[builtins.str] constant_initialization_vector: A 128-bit, 16-byte hex value represented by a 32-character string, to be used with the key for encrypting content. This parameter is not valid for static key encryption.
        :param pulumi.Input[builtins.str] device_id: The value of one of the devices that you configured with your digital rights management (DRM) platform key provider. This parameter is required for SPEKE encryption and is not valid for static key encryption.
        ...
        :param pulumi.Input[builtins.str] region: The AWS Region that the API Gateway proxy endpoint was created in. This parameter is required for SPEKE encryption and is not valid for static key encryption.
        :param pulumi.Input[builtins.str] resource_id: An identifier for the content. The service sends this value to the key server to identify the current endpoint. The resource ID is also known as the content ID. This parameter is required for SPEKE encryption and is not valid for static key encryption.
        :param pulumi.Input[builtins.str] secret_arn:  The ARN of the secret that you created in AWS Secrets Manager to store the encryption key. This parameter is required for static key encryption and is not valid for SPEKE encryption.
        :param pulumi.Input[builtins.str] url: The URL from the API Gateway proxy that you set up to talk to your key server. This parameter is required for SPEKE encryption and is not valid for static key encryption.
        """
    ...
    def constant_initialization_vector(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A 128-bit, 16-byte hex value represented by a 32-character string, to be used with the key for encrypting content. This parameter is not valid for static key encryption.
        """
    ...
    def constant_initialization_vector(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FlowFailoverConfigSourcePriorityPropertiesArgsDict(TypedDict):
        ...
        The priority you want to assign to a source. You can have a primary stream and a backup stream or two equally prioritized streams.
        """
        primary_source: pulumi.Input[builtins.str]
        """
        The name of the source you choose as the primary source for this flow.
        """
elif False:
...
class FlowFailoverConfigSourcePriorityPropertiesArgs:
    ...
    @property
    @pulumi.getter(name="primarySource")
    def primary_source(self) -> pulumi.Input[builtins.str]:
        """
        The name of the source you choose as the primary source for this flow.
        """
        return pulumi.get(self, "primary_source")
    ...
    @primary_source.setter
    def primary_source(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "primary_source", value)
...
if not MYPY:
    class FlowFailoverConfigArgsDict(TypedDict):
        ...
        """
        recovery_window: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FlowFailoverConfigArgs:
    def __init__(__self__, *,
                 ...
                 recovery_window: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] recovery_window: Search window time to look for dash-7 packets
    ...
    def recovery_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Search window time to look for dash-7 packets
        """
    ...
    def recovery_window(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class FlowFmtpArgsDict(TypedDict):
        ...
        """
        channel_order: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        exact_framerate: NotRequired[pulumi.Input[builtins.str]]
        """
        The frame rate for the video stream, in frames/second. For example: 60000/1001.
        """
        par: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowFmtpArgs:
    def __init__(__self__, *,
                 channel_order: Optional[pulumi.Input[builtins.str]] = None,
                 colorimetry: Optional[pulumi.Input['FlowFmtpColorimetry']] = None,
                 exact_framerate: Optional[pulumi.Input[builtins.str]] = None,
                 par: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        A set of parameters that define the media stream.
        :param pulumi.Input[builtins.str] channel_order: The format of the audio channel.
        :param pulumi.Input['FlowFmtpColorimetry'] colorimetry: The format used for the representation of color.
        :param pulumi.Input[builtins.str] exact_framerate: The frame rate for the video stream, in frames/second. For example: 60000/1001.
        :param pulumi.Input[builtins.str] par: The pixel aspect ratio (PAR) of the video.
    ...
    def channel_order(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The format of the audio channel.
        """
    ...
    def channel_order(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def exact_framerate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The frame rate for the video stream, in frames/second. For example: 60000/1001.
        """
    ...
    def exact_framerate(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exact_framerate", value)

    @property
    @pulumi.getter
    def par(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The pixel aspect ratio (PAR) of the video.
        """
    ...
    @par.setter
    def par(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowFrozenFramesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] threshold_seconds: Specifies the number of consecutive seconds of a static image that triggers an event or alert.
        """
        if state is not None:
            pulumi.set(__self__, "state", state)
        if threshold_seconds is not None:
...
class FlowGatewayBridgeSourceArgs:
    def __init__(__self__, *,
        ...
        """
        The source configuration for cloud flows receiving a stream from a bridge.
        :param pulumi.Input[builtins.str] bridge_arn: The ARN of the bridge feeding this flow.
...
if not MYPY:
    class FlowInputConfigurationArgsDict(TypedDict):
        ...
        """
        input_port: pulumi.Input[builtins.int]
        """
...
class FlowInputConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The transport parameters associated with an incoming media stream.
        :param pulumi.Input[builtins.int] input_port: The port that the flow listens on for an incoming media stream.
    ...
    def input_port(self) -> pulumi.Input[builtins.int]:
        """
        The port that the flow listens on for an incoming media stream.
        """
    ...
    @input_port.setter
    def input_port(self, value: pulumi.Input[builtins.int]):
...
class FlowInterfaceArgs:
    def __init__(__self__, *,
        ...
        """
        The VPC interface that you want to use for the media stream associated with the output.
        :param pulumi.Input[builtins.str] name: The name of the VPC interface that you want to use for the media stream associated with the output.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class FlowMaintenanceArgsDict(TypedDict):
        ...
        """
        maintenance_start_hour: pulumi.Input[builtins.str]
        """
...
class FlowMaintenanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] maintenance_start_hour: UTC time when the maintenance will happen. Use 24-hour HH:MM format. Minutes must be 00. Example: 13:00. The default value is 02:00.
        """
    ...
    def maintenance_start_hour(self) -> pulumi.Input[builtins.str]:
        """
        UTC time when the maintenance will happen. Use 24-hour HH:MM format. Minutes must be 00. Example: 13:00. The default value is 02:00.
        """
    ...
    def maintenance_start_hour(self, value: pulumi.Input[builtins.str]):
...
class FlowMediaStreamAttributesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lang: The audio language, in a format that is recognized by the receiver.
        """
        if fmtp is not None:
...
if not MYPY:
    class FlowMediaStreamSourceConfigurationArgsDict(TypedDict):
        ...
        """
        media_stream_name: pulumi.Input[builtins.str]
        """
...
class FlowMediaStreamSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] media_stream_name: A name that helps you distinguish one media stream from another.
    ...
    def media_stream_name(self) -> pulumi.Input[builtins.str]:
        """
        A name that helps you distinguish one media stream from another.
        """
    ...
    def media_stream_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FlowMediaStreamArgsDict(TypedDict):
        ...
        """
        media_stream_id: pulumi.Input[builtins.int]
        """
        ...
        Attributes that are related to the media stream.
        """
        clock_rate: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        fmt: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FlowMediaStreamArgs:
    def __init__(__self__, *,
                 ...
                 clock_rate: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fmt: Optional[pulumi.Input[builtins.int]] = None,
                 video_format: Optional[pulumi.Input['FlowMediaStreamVideoFormat']] = None):
        """
        A single track or stream of media that contains video, audio, or ancillary data. After you add a media stream to a flow, you can associate it with sources and outputs on that flow, as long as they use the CDI protocol or the ST 2110 JPEG XS protocol. Each source or output can consist of one or many media streams.
        :param pulumi.Input[builtins.int] media_stream_id: A unique identifier for the media stream.
        :param pulumi.Input[builtins.str] media_stream_name: A name that helps you distinguish one media stream from another.
        ...
        :param pulumi.Input[builtins.int] clock_rate: The sample rate for the stream. This value in measured in kHz.
        :param pulumi.Input[builtins.str] description: A description that can help you quickly identify what your media stream is used for.
        :param pulumi.Input[builtins.int] fmt: The format type number (sometimes referred to as RTP payload type) of the media stream. MediaConnect assigns this value to the media stream. For ST 2110 JPEG XS outputs, you need to provide this value to the receiver.
    ...
    def media_stream_id(self) -> pulumi.Input[builtins.int]:
        """
        A unique identifier for the media stream.
        """
    ...
    def media_stream_id(self, value: pulumi.Input[builtins.int]):
    ...
    def clock_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The sample rate for the stream. This value in measured in kHz.
        """
    ...
    @clock_rate.setter
    def clock_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def fmt(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The format type number (sometimes referred to as RTP payload type) of the media stream. MediaConnect assigns this value to the media stream. For ST 2110 JPEG XS outputs, you need to provide this value to the receiver.
        """
    ...
    @fmt.setter
    def fmt(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FlowNdiConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the configuration settings for NDI outputs. Required when the flow includes NDI outputs.
        :param pulumi.Input[builtins.str] machine_name: A prefix for the names of the NDI sources that the flow creates. If a custom name isn't specified, MediaConnect generates a unique 12-character ID as the prefix.
...
if not MYPY:
    class FlowNdiDiscoveryServerConfigArgsDict(TypedDict):
        ...
        """
        discovery_server_address: pulumi.Input[builtins.str]
        """
        The unique network address of the NDI discovery server.
        """
        vpc_interface_adapter: pulumi.Input[builtins.str]
        """
        The identifier for the Virtual Private Cloud (VPC) network interface used by the flow.
        """
        discovery_server_port: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FlowNdiDiscoveryServerConfigArgs:
    def __init__(__self__, *,
                 discovery_server_address: pulumi.Input[builtins.str],
                 vpc_interface_adapter: pulumi.Input[builtins.str],
                 discovery_server_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        Specifies the configuration settings for individual NDI discovery servers. A maximum of 3 servers is allowed.
        :param pulumi.Input[builtins.str] discovery_server_address: The unique network address of the NDI discovery server.
        :param pulumi.Input[builtins.str] vpc_interface_adapter: The identifier for the Virtual Private Cloud (VPC) network interface used by the flow.
        :param pulumi.Input[builtins.int] discovery_server_port: The port for the NDI discovery server. Defaults to 5959 if a custom port isn't specified.
        """
    ...
    def discovery_server_address(self) -> pulumi.Input[builtins.str]:
        """
        The unique network address of the NDI discovery server.
        """
    ...
    def discovery_server_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "discovery_server_address", value)

    @property
    @pulumi.getter(name="vpcInterfaceAdapter")
    def vpc_interface_adapter(self) -> pulumi.Input[builtins.str]:
        """
        The identifier for the Virtual Private Cloud (VPC) network interface used by the flow.
        """
    ...
    def vpc_interface_adapter(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vpc_interface_adapter", value)

    @property
    @pulumi.getter(name="discoveryServerPort")
    def discovery_server_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The port for the NDI discovery server. Defaults to 5959 if a custom port isn't specified.
        """
    ...
    def discovery_server_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class FlowOutputDestinationConfigurationArgsDict(TypedDict):
        ...
        """
        destination_port: pulumi.Input[builtins.int]
        """
...
class FlowOutputDestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The definition of a media stream that is associated with the output.
        :param pulumi.Input[builtins.str] destination_ip: The IP address where contents of the media stream will be sent.
        :param pulumi.Input[builtins.int] destination_port: The port to use when the content of the media stream is distributed to the output.
    ...
    def destination_port(self) -> pulumi.Input[builtins.int]:
        """
        The port to use when the content of the media stream is distributed to the output.
        """
    ...
    def destination_port(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class FlowOutputEncodingParametersArgsDict(TypedDict):
        ...
        """
        compression_factor: pulumi.Input[builtins.float]
        """
...
class FlowOutputEncodingParametersArgs:
    def __init__(__self__, *,
        ...
        """
        A collection of parameters that determine how MediaConnect will convert the content. These fields only apply to outputs on flows that have a CDI source.
        :param pulumi.Input[builtins.float] compression_factor: A value that is used to calculate compression for an output. The bitrate of the output is calculated as follows: Output bitrate = (1 / compressionFactor) * (source bitrate) This property only applies to outputs that use the ST 2110 JPEG XS protocol, with a flow source that uses the CDI protocol. Valid values are in the range of 3.0 to 10.0, inclusive.
    ...
    def compression_factor(self) -> pulumi.Input[builtins.float]:
        """
        A value that is used to calculate compression for an output. The bitrate of the output is calculated as follows: Output bitrate = (1 / compressionFactor) * (source bitrate) This property only applies to outputs that use the ST 2110 JPEG XS protocol, with a flow source that uses the CDI protocol. Valid values are in the range of 3.0 to 10.0, inclusive.
        """
    ...
    def compression_factor(self, value: pulumi.Input[builtins.float]):
...
class FlowOutputVpcInterfaceAttachmentArgs:
    def __init__(__self__, *,
        ...
        """
        The settings for attaching a VPC interface to an output.
        :param pulumi.Input[builtins.str] vpc_interface_name: The name of the VPC interface to use for this output.
        """
        if vpc_interface_name is not None:
            pulumi.set(__self__, "vpc_interface_name", vpc_interface_name)
...
class FlowSilentAudioArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] threshold_seconds: Specifies the number of consecutive seconds of silence that triggers an event or alert.
        """
        if state is not None:
            pulumi.set(__self__, "state", state)
        if threshold_seconds is not None:
...
if not MYPY:
    class FlowSourceArgsDict(TypedDict):
        ...
        """
        entitlement_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The source configuration for cloud flows receiving a stream from a bridge.
        """
        ingest_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        The IP address that the flow will be listening on for incoming content.
        """
        ingest_port: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_sync_buffer: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        The media stream that is associated with the source, and the parameters for that association.
        """
        min_latency: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        sender_control_port: NotRequired[pulumi.Input[builtins.int]]
        """
        The port that the flow uses to send outbound requests to initiate connection with the sender for fujitsu-qos protocol.
        """
        sender_ip_address: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        source_ingest_port: NotRequired[pulumi.Input[builtins.str]]
        """
        The port that the flow will be listening on for incoming content.(ReadOnly)
        """
        source_listener_address: NotRequired[pulumi.Input[builtins.str]]
        """
        Source IP or domain name for SRT-caller protocol.
        """
        source_listener_port: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        whitelist_cidr: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowSourceArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 entitlement_arn: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_bridge_source: Optional[pulumi.Input['FlowGatewayBridgeSourceArgs']] = None,
                 ingest_ip: Optional[pulumi.Input[builtins.str]] = None,
                 ingest_port: Optional[pulumi.Input[builtins.int]] = None,
                 max_bitrate: Optional[pulumi.Input[builtins.int]] = None,
                 max_latency: Optional[pulumi.Input[builtins.int]] = None,
                 max_sync_buffer: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 min_latency: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 protocol: Optional[pulumi.Input['FlowSourceProtocol']] = None,
                 sender_control_port: Optional[pulumi.Input[builtins.int]] = None,
                 sender_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 source_arn: Optional[pulumi.Input[builtins.str]] = None,
                 source_ingest_port: Optional[pulumi.Input[builtins.str]] = None,
                 source_listener_address: Optional[pulumi.Input[builtins.str]] = None,
                 source_listener_port: Optional[pulumi.Input[builtins.int]] = None,
                 stream_id: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_interface_name: Optional[pulumi.Input[builtins.str]] = None,
                 whitelist_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        The settings for the source of the flow.
        ...
        :param pulumi.Input[builtins.str] description: A description for the source. This value is not used or seen outside of the current AWS Elemental MediaConnect account.
        :param pulumi.Input[builtins.str] entitlement_arn: The ARN of the entitlement that allows you to subscribe to content that comes from another AWS account. The entitlement is set by the content originator and the ARN is generated as part of the originator's flow.
        ...
        :param pulumi.Input[builtins.str] ingest_ip: The IP address that the flow will be listening on for incoming content.
        :param pulumi.Input[builtins.int] ingest_port: The port that the flow will be listening on for incoming content.
        :param pulumi.Input[builtins.int] max_bitrate: The smoothing max bitrate for RIST, RTP, and RTP-FEC streams.
        :param pulumi.Input[builtins.int] max_latency: The maximum latency in milliseconds. This parameter applies only to RIST-based and Zixi-based streams.
        :param pulumi.Input[builtins.int] max_sync_buffer: The size of the buffer (in milliseconds) to use to sync incoming source data.
        ...
        :param pulumi.Input[builtins.int] min_latency: The minimum latency in milliseconds.
        ...
        :param pulumi.Input[builtins.int] sender_control_port: The port that the flow uses to send outbound requests to initiate connection with the sender for fujitsu-qos protocol.
        :param pulumi.Input[builtins.str] sender_ip_address: The IP address that the flow communicates with to initiate connection with the sender for fujitsu-qos protocol.
        :param pulumi.Input[builtins.str] source_arn: The ARN of the source.
        :param pulumi.Input[builtins.str] source_ingest_port: The port that the flow will be listening on for incoming content.(ReadOnly)
        :param pulumi.Input[builtins.str] source_listener_address: Source IP or domain name for SRT-caller protocol.
        :param pulumi.Input[builtins.int] source_listener_port: Source port for SRT-caller protocol.
        :param pulumi.Input[builtins.str] stream_id: The stream ID that you want to use for this transport. This parameter applies only to Zixi-based streams.
        :param pulumi.Input[builtins.str] vpc_interface_name: The name of the VPC Interface this Source is configured with.
        :param pulumi.Input[builtins.str] whitelist_cidr: The range of IP addresses that should be allowed to contribute content to your source. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        """
    ...
    def entitlement_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the entitlement that allows you to subscribe to content that comes from another AWS account. The entitlement is set by the content originator and the ARN is generated as part of the originator's flow.
        """
    ...
    def entitlement_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ingest_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address that the flow will be listening on for incoming content.
        """
    ...
    @ingest_ip.setter
    def ingest_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingest_ip", value)

    @property
    @pulumi.getter(name="ingestPort")
    def ingest_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The port that the flow will be listening on for incoming content.
        """
    ...
    @ingest_port.setter
    def ingest_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def max_sync_buffer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The size of the buffer (in milliseconds) to use to sync incoming source data.
        """
    ...
    def max_sync_buffer(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def min_latency(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum latency in milliseconds.
        """
    ...
    @min_latency.setter
    def min_latency(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def sender_control_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The port that the flow uses to send outbound requests to initiate connection with the sender for fujitsu-qos protocol.
        """
    ...
    def sender_control_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sender_control_port", value)

    @property
    @pulumi.getter(name="senderIpAddress")
    def sender_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address that the flow communicates with to initiate connection with the sender for fujitsu-qos protocol.
        """
    ...
    def sender_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_ingest_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The port that the flow will be listening on for incoming content.(ReadOnly)
        """
    ...
    def source_ingest_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_ingest_port", value)

    @property
    @pulumi.getter(name="sourceListenerAddress")
    def source_listener_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Source IP or domain name for SRT-caller protocol.
        """
    ...
    def source_listener_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_listener_address", value)

    @property
    @pulumi.getter(name="sourceListenerPort")
    def source_listener_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Source port for SRT-caller protocol.
        """
    ...
    def source_listener_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def whitelist_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The range of IP addresses that should be allowed to contribute content to your source. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        """
    ...
    def whitelist_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowVpcInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_interface_ids: IDs of the network interfaces created in customer's account by MediaConnect.
...
class GatewayNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        The network settings for a gateway.
        :param pulumi.Input[builtins.str] cidr_block: A unique IP address range to use for this network. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        :param pulumi.Input[builtins.str] name: The name of the network. This name is used to reference the network and must be unique among networks in this gateway.
        """
