...
class GetFlowEntitlementResult:
    ...
    @property
    @pulumi.getter
    def subscribers(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_flow_entitlement(entitlement_arn: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFlowEntitlementResult:
    """
    Resource schema for AWS::MediaConnect::FlowEntitlement


    :param builtins.str entitlement_arn: The ARN of the entitlement.
    """
    __args__ = dict()
...
def get_flow_entitlement_output(entitlement_arn: Optional[pulumi.Input[builtins.str]] = None,
