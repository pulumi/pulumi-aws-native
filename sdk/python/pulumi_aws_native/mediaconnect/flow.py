...
class FlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone that you want to create the flow in. These options are limited to the Availability Zones within the current AWS.
        ...
        :param pulumi.Input[builtins.str] name: The name of the flow.
...
class Flow(pulumi.CustomResource):
    ...
    def egress_ip(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def flow_availability_zone(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def flow_ndi_machine_name(self) -> pulumi.Output[builtins.str]:
        """
