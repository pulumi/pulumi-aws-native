...
def get_gateway(gateway_arn: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayResult:
    """
    Resource schema for AWS::MediaConnect::Gateway


    :param builtins.str gateway_arn: The Amazon Resource Name (ARN) of the gateway.
    """
    __args__ = dict()
...
def get_gateway_output(gateway_arn: Optional[pulumi.Input[builtins.str]] = None,
