...
def get_bridge_output_resource(bridge_arn: Optional[builtins.str] = None,
...
def get_bridge_output_resource_output(bridge_arn: Optional[pulumi.Input[builtins.str]] = None,
