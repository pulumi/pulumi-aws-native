...
class FlowOutput(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cidrAllowList")
    def cidr_allow_list(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The range of IP addresses that should be allowed to initiate output requests to this flow. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        """
        return pulumi.get(self, "cidr_allow_list")
    ...
    @_builtins.property
    @pulumi.getter(name="ndiProgramName")
    def ndi_program_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A suffix for the names of the NDI sources that the flow creates. If a custom name isn't specified, MediaConnect uses the output name.
        """
        return pulumi.get(self, "ndi_program_name")
    ...
    @_builtins.property
    @pulumi.getter(name="ndiSpeedHqQuality")
    def ndi_speed_hq_quality(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        A quality setting for the NDI Speed HQ encoder.
        """
        return pulumi.get(self, "ndi_speed_hq_quality")
    ...
    def output_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="remoteId")
    def remote_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The remote ID for the Zixi-pull stream.
        """
        return pulumi.get(self, "remote_id")
    ...
    @_builtins.property
    @pulumi.getter(name="smoothingLatency")
    def smoothing_latency(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The smoothing latency in milliseconds for RIST, RTP, and RTP-FEC streams.
        """
        return pulumi.get(self, "smoothing_latency")
