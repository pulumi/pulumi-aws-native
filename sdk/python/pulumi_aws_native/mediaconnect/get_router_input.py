...
__all__ = [
    'GetRouterInputResult',
    'AwaitableGetRouterInputResult',
    'get_router_input',
    'get_router_input_output',
]
...
class GetRouterInputResult:
    def __init__(__self__, arn=None, configuration=None, content_quality_analysis_configuration=None, content_quality_analysis_type=None, created_at=None, id=None, input_type=None, ip_address=None, maintenance_configuration=None, maintenance_type=None, maximum_bitrate=None, name=None, routed_outputs=None, routing_scope=None, state=None, tags=None, tier=None, transit_encryption=None, updated_at=None):
        ...
        if routed_outputs and not isinstance(routed_outputs, int):
            raise TypeError("Expected argument 'routed_outputs' to be a int")
        pulumi.set(__self__, "routed_outputs", routed_outputs)
        ...
        if transit_encryption and not isinstance(transit_encryption, dict):
            raise TypeError("Expected argument 'transit_encryption' to be a dict")
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> Optional[Union['outputs.RouterInputConfiguration0Properties', 'outputs.RouterInputConfiguration1Properties', 'outputs.RouterInputConfiguration2Properties', 'outputs.RouterInputConfiguration3Properties', 'outputs.RouterInputConfiguration4Properties']]:
    ...
    def input_type(self) -> Optional['RouterInputType']:
        """
    ...
    def maintenance_configuration(self) -> Optional[Union['outputs.RouterInputMaintenanceConfiguration0Properties', 'outputs.RouterInputMaintenanceConfiguration1Properties']]:
        """
    ...
    def maintenance_type(self) -> Optional['RouterInputMaintenanceType']:
        """
    ...
    def routed_outputs(self) -> Optional[_builtins.int]:
        """
    ...
    def routing_scope(self) -> Optional['RouterInputRoutingScope']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def state(self) -> Optional['RouterInputState']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tier(self) -> Optional['RouterInputTier']:
        """
    ...
    def transit_encryption(self) -> Optional['outputs.RouterInputTransitEncryption']:
        """
...
class AwaitableGetRouterInputResult(GetRouterInputResult):
...
def get_router_input(arn: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRouterInputResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:mediaconnect:getRouterInput', __args__, opts=opts, typ=GetRouterInputResult).value
    ...
    return AwaitableGetRouterInputResult(
        ...
        routed_outputs=pulumi.get(__ret__, 'routed_outputs'),
...
def get_router_input_output(arn: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:mediaconnect:getRouterInput', __args__, opts=opts, typ=GetRouterInputResult)
    return __ret__.apply(lambda __response__: GetRouterInputResult(
        ...
        routed_outputs=pulumi.get(__response__, 'routed_outputs'),
