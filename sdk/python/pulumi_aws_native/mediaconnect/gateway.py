...
class GatewayArgs:
    def __init__(__self__, *,
                 egress_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def egress_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def egress_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
@pulumi.type_token("aws-native:mediaconnect:Gateway")
class Gateway(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="egressCidrBlocks")
    def egress_cidr_blocks(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The range of IP addresses that contribute content or initiate output requests for flows communicating with this gateway. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
        """
        return pulumi.get(self, "egress_cidr_blocks")
