...
warnings.warn("""Gateway is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GatewayNetworkArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Gateway is deprecated: Gateway is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
