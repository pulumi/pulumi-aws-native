...
class FlowEntitlementArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def subscribers(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @subscribers.setter
    def subscribers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class FlowEntitlement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dataTransferSubscriberFeePercent")
    def data_transfer_subscriber_fee_percent(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Percentage from 0-100 of the data transfer cost to be billed to the subscriber.
        """
        return pulumi.get(self, "data_transfer_subscriber_fee_percent")
    ...
    def entitlement_arn(self) -> pulumi.Output[_builtins.str]:
        """
