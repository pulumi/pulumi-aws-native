...
class FlowEntitlementArgs:
    def __init__(__self__, *,
                 ...
                 subscribers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 data_transfer_subscriber_fee_percent: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: A description of the entitlement.
        :param pulumi.Input[builtins.str] flow_arn: The ARN of the flow.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscribers: The AWS account IDs that you want to share your content with. The receiving accounts (subscribers) will be allowed to create their own flow using your content as the source.
        :param pulumi.Input[builtins.int] data_transfer_subscriber_fee_percent: Percentage from 0-100 of the data transfer cost to be billed to the subscriber.
        ...
        :param pulumi.Input[builtins.str] name: The name of the entitlement.
        """
    ...
    @property
    @pulumi.getter
    def subscribers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @subscribers.setter
    def subscribers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "subscribers", value)

    @property
    @pulumi.getter(name="dataTransferSubscriberFeePercent")
    def data_transfer_subscriber_fee_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def data_transfer_subscriber_fee_percent(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FlowEntitlement(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 subscribers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="dataTransferSubscriberFeePercent")
    def data_transfer_subscriber_fee_percent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage from 0-100 of the data transfer cost to be billed to the subscriber.
        """
        return pulumi.get(self, "data_transfer_subscriber_fee_percent")
    ...
    def entitlement_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def subscribers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The AWS account IDs that you want to share your content with. The receiving accounts (subscribers) will be allowed to create their own flow using your content as the source.
        """
        return pulumi.get(self, "subscribers")
