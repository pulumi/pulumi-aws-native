...
class BridgeSourceInitArgs:
    def __init__(__self__, *,
                 bridge_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bridge_arn: The Amazon Resource Number (ARN) of the bridge.
        :param pulumi.Input['BridgeSourceBridgeFlowSourceArgs'] flow_source: The source of the flow.
        :param pulumi.Input[builtins.str] name: The name of the source.
    ...
    def bridge_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bridge_arn.setter
    def bridge_arn(self, value: pulumi.Input[builtins.str]):
...
class BridgeSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bridge_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="bridgeArn")
    def bridge_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Number (ARN) of the bridge.
        """
        return pulumi.get(self, "bridge_arn")
