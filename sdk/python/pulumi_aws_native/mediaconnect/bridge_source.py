...
warnings.warn("""BridgeSource is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class BridgeSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 network_source: Optional[pulumi.Input[pulumi.InputType['BridgeSourceBridgeNetworkSourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""BridgeSource is deprecated: BridgeSource is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
