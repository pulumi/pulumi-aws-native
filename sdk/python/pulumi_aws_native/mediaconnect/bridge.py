...
class BridgeArgs:
    def __init__(__self__, *,
                 placement_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] placement_arn: The placement Amazon Resource Number (ARN) of the bridge.
        ...
        :param pulumi.Input[builtins.str] name: The name of the bridge.
    ...
    def placement_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def placement_arn(self, value: pulumi.Input[builtins.str]):
...
class Bridge(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 placement_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="placementArn")
    def placement_arn(self) -> pulumi.Output[builtins.str]:
        """
        The placement Amazon Resource Number (ARN) of the bridge.
        """
        return pulumi.get(self, "placement_arn")
