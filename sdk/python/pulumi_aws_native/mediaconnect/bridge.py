...
class Bridge(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(egress_gateway_bridge, BridgeEgressGatewayBridgeArgs):
            ...
            if not isinstance(ingress_gateway_bridge, BridgeIngressGatewayBridgeArgs):
            ...
            if not isinstance(source_failover_config, BridgeFailoverConfigArgs):
