...
warnings.warn("""Bridge is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Bridge(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BridgeSourceArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Bridge is deprecated: Bridge is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
