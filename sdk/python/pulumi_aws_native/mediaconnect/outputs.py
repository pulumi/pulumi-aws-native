...
__all__ = [
    ...
    'BridgeNetworkSource',
    'BridgeOutput',
    'BridgeOutputBridgeNetworkOutput',
    'BridgeSource',
...
@pulumi.output_type
class BridgeOutputBridgeNetworkOutput(dict):
    """
    The output of the bridge. A network output is delivered to your premises.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BridgeOutputBridgeNetworkOutput. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BridgeOutputBridgeNetworkOutput.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 network_name: str,
                 port: int,
                 protocol: 'BridgeOutputBridgeNetworkOutputProtocol',
                 ttl: int):
        """
        The output of the bridge. A network output is delivered to your premises.
        :param str ip_address: The network output IP Address.
        :param str network_name: The network output's gateway network name.
        :param int port: The network output port.
        :param 'BridgeOutputBridgeNetworkOutputProtocol' protocol: The network output protocol.
        :param int ttl: The network output TTL.
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "network_name", network_name)
    ...
    @property
    @pulumi.getter
    def protocol(self) -> 'BridgeOutputBridgeNetworkOutputProtocol':
        """
        The network output protocol.
        """
        return pulumi.get(self, "protocol")
