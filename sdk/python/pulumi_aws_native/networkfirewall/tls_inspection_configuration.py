...
class TlsInspectionConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 tls_inspection_configuration_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: A description of the TLS inspection configuration.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: The key:value pairs to associate with the resource.
        :param pulumi.Input[builtins.str] tls_inspection_configuration_name: The descriptive name of the TLS inspection configuration. You can't change the name of a TLS inspection configuration after you create it.
        """
    ...
    def tls_inspection_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tls_inspection_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TlsInspectionConfiguration(pulumi.CustomResource):
    ...
    def tls_inspection_configuration_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="tlsInspectionConfigurationName")
    def tls_inspection_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
        The descriptive name of the TLS inspection configuration. You can't change the name of a TLS inspection configuration after you create it.
        """
        return pulumi.get(self, "tls_inspection_configuration_name")
