...
class GetTlsInspectionConfigurationResult:
    ...
    def tls_inspection_configuration_id(self) -> Optional[_builtins.str]:
        """
...
def get_tls_inspection_configuration(tls_inspection_configuration_arn: Optional[_builtins.str] = None,
