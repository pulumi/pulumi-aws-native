...
def get_firewall_policy(firewall_policy_arn: Optional[builtins.str] = None,
...
def get_firewall_policy_output(firewall_policy_arn: Optional[pulumi.Input[builtins.str]] = None,
