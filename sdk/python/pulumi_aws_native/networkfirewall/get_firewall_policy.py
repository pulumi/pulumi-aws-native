...
class GetFirewallPolicyResult:
    ...
    def firewall_policy_id(self) -> Optional[_builtins.str]:
        """
...
def get_firewall_policy(firewall_policy_arn: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallPolicyResult:
    """
    Resource type definition for AWS::NetworkFirewall::FirewallPolicy


    :param _builtins.str firewall_policy_arn: The Amazon Resource Name (ARN) of the `FirewallPolicy` .
    """
    __args__ = dict()
