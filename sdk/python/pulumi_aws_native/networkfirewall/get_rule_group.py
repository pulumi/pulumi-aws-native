...
class GetRuleGroupResult:
    ...
    def rule_group_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def rule_group_id(self) -> Optional[_builtins.str]:
        """
...
def get_rule_group(rule_group_arn: Optional[_builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRuleGroupResult:
    """
    Resource type definition for AWS::NetworkFirewall::RuleGroup


    :param _builtins.str rule_group_arn: The Amazon Resource Name (ARN) of the rule group.
    """
    __args__ = dict()
...
def get_rule_group_output(rule_group_arn: Optional[pulumi.Input[_builtins.str]] = None,
