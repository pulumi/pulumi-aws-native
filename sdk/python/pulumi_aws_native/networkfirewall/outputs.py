...
class TlsInspectionConfigurationServerCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str resource_arn: The Amazon Resource Name (ARN) of the AWS Certificate Manager SSL/TLS server certificate that's used for inbound SSL/TLS inspection.
        """
...
class TlsInspectionConfigurationServerCertificateConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str certificate_authority_arn: The Amazon Resource Name (ARN) of the imported certificate authority (CA) certificate within AWS Certificate Manager (ACM) to use for outbound SSL/TLS inspection.
