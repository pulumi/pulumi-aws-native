...
class RuleGroupMatchAttributes(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.int] protocols: The protocols to inspect for, specified using each protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
...
class TlsInspectionConfigurationServerCertificateScope(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.int] protocols: The protocols to decrypt for inspection, specified using each protocol's assigned internet protocol number
