...
class FirewallPolicyActionDefinitionArgsDict(TypedDict):
    publish_metric_action: NotRequired[pulumi.Input[Optional['FirewallPolicyPublishMetricActionArgs']]]
    """
...
class FirewallPolicyPolicyVariablesPropertiesArgsDict(TypedDict):
    ...
    """
    rule_variables: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['FirewallPolicyIpSetArgs']]]]]
...
class FirewallPolicyStatefulEngineOptionsArgsDict(TypedDict):
    flow_timeouts: NotRequired[pulumi.Input[Optional['FirewallPolicyStatefulEngineOptionsFlowTimeoutsPropertiesArgs']]]
    """
    Configures the amount of time that can pass without any traffic sent through the firewall before the firewall determines that the connection is idle.
    """
...
class FirewallPolicyStatefulRuleGroupReferenceArgsDict(TypedDict):
    ...
    """
    override: NotRequired[pulumi.Input[Optional['FirewallPolicyStatefulRuleGroupOverrideArgs']]]
    """
...
class FirewallPolicyArgsDict(TypedDict):
    ...
    """
    policy_variables: NotRequired[pulumi.Input[Optional['FirewallPolicyPolicyVariablesPropertiesArgs']]]
    """
    Contains variables that you can use to override default Suricata settings in your firewall policy.
    """
    ...
    """
    stateful_engine_options: NotRequired[pulumi.Input[Optional['FirewallPolicyStatefulEngineOptionsArgs']]]
    """
    Additional options governing how Network Firewall handles stateful rules. The stateful rule groups that you use in your policy must have stateful rule options settings that are compatible with these settings.
    """
    stateful_rule_group_references: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyStatefulRuleGroupReferenceArgs']]]]]
    """
    References to the stateful rule groups that are used in the policy. These define the inspection criteria in stateful rules.
    """
    stateless_custom_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyCustomActionArgs']]]]]
    """
    The custom action definitions that are available for use in the firewall policy's `StatelessDefaultActions` setting. You name each custom action that you define, and then you can use it by name in your default actions specifications.
    """
    stateless_rule_group_references: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyStatelessRuleGroupReferenceArgs']]]]]
    """
...
class RuleGroupActionDefinitionArgsDict(TypedDict):
    publish_metric_action: NotRequired[pulumi.Input[Optional['RuleGroupPublishMetricActionArgs']]]
    """
    Stateless inspection criteria that publishes the specified metrics to Amazon CloudWatch for the matching packet. This setting defines a CloudWatch dimension value to be published.
...
class RuleGroupMatchAttributesArgsDict(TypedDict):
    destination_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupPortRangeArgs']]]]]
    """
    The destination port to inspect for. You can specify an individual port, for example `1994` and you can specify a port range, for example `1990:1994` . To match with any port, specify `ANY` .

    This setting is only used for protocols 6 (TCP) and 17 (UDP).
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupAddressArgs']]]]]
    """
    ...
    """
    source_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupPortRangeArgs']]]]]
    """
    The source port to inspect for. You can specify an individual port, for example `1994` and you can specify a port range, for example `1990:1994` . To match with any port, specify `ANY` .
    ...
    This setting is only used for protocols 6 (TCP) and 17 (UDP).
    """
    sources: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupAddressArgs']]]]]
    """
    The source IP addresses and address ranges to inspect for, in CIDR notation. If not specified, this matches with any source address.
    """
    tcp_flags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupTcpFlagFieldArgs']]]]]
    """
...
class RuleGroupReferenceSetsArgsDict(TypedDict):
    ip_set_references: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['RuleGroupIpSetReferenceArgs']]]]]
    """
...
class RuleGroupRuleVariablesArgsDict(TypedDict):
    ip_sets: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['RuleGroupIpSetArgs']]]]]
    """
    A list of IP addresses and address ranges, in CIDR notation.
    """
    port_sets: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['RuleGroupPortSetArgs']]]]]
    """
...
class RuleGroupRulesSourceArgsDict(TypedDict):
    rules_source_list: NotRequired[pulumi.Input[Optional['RuleGroupRulesSourceListArgs']]]
    """
    ...
    """
    stateful_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupStatefulRuleArgs']]]]]
    """
    ...
    """
    stateless_rules_and_custom_actions: NotRequired[pulumi.Input[Optional['RuleGroupStatelessRulesAndCustomActionsArgs']]]
    """
...
class RuleGroupStatelessRulesAndCustomActionsArgsDict(TypedDict):
    ...
    """
    custom_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleGroupCustomActionArgs']]]]]
    """
...
class RuleGroupArgsDict(TypedDict):
    ...
    """
    reference_sets: NotRequired[pulumi.Input[Optional['RuleGroupReferenceSetsArgs']]]
    """
    The reference sets for the stateful rule group.
    """
    rule_variables: NotRequired[pulumi.Input[Optional['RuleGroupRuleVariablesArgs']]]
    """
    Settings that are available for use in the rules in the rule group. You can only use these for stateful rule groups.
    """
    stateful_rule_options: NotRequired[pulumi.Input[Optional['RuleGroupStatefulRuleOptionsArgs']]]
    """
...
class TlsInspectionConfigurationServerCertificateConfigurationArgsDict(TypedDict):
    ...
    """
    check_certificate_revocation_status: NotRequired[pulumi.Input[Optional['TlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusPropertiesArgs']]]
    """
    When enabled, Network Firewall checks if the server certificate presented by the server in the SSL/TLS connection has a revoked or unkown status. If the certificate has an unknown or revoked status, you must specify the actions that Network Firewall takes on outbound traffic. To check the certificate revocation status, you must also specify a `CertificateAuthorityArn` in [ServerCertificateConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-networkfirewall-servercertificateconfiguration.html) .
    """
    scopes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationServerCertificateScopeArgs']]]]]
    """
    A list of scopes.
    """
    server_certificates: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationServerCertificateArgs']]]]]
    """
...
class TlsInspectionConfigurationServerCertificateScopeArgsDict(TypedDict):
    destination_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationPortRangeArgs']]]]]
    """
    ...
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationAddressArgs']]]]]
    """
    ...
    """
    source_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationPortRangeArgs']]]]]
    """
    ...
    You can specify individual ports, for example `1994` , and you can specify port ranges, such as `1990:1994` .
    """
    sources: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationAddressArgs']]]]]
    """
...
class TlsInspectionConfigurationTlsInspectionConfigurationArgsDict(TypedDict):
    server_certificate_configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TlsInspectionConfigurationServerCertificateConfigurationArgs']]]]]
    """
