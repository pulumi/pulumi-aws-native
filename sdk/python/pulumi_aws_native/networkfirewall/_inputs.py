...
class FirewallPolicyCustomActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action_name: The descriptive name of the custom action. You can't change the name of a custom action after you create it.
        """
...
if not MYPY:
    class FirewallPolicyIpSetArgsDict(TypedDict):
        definition: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class FirewallPolicyIpSetArgs:
    def __init__(__self__, *,
                 definition: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] definition: The list of IP addresses and address ranges, in CIDR notation.
        """
    ...
    @property
    @pulumi.getter
    def definition(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of IP addresses and address ranges, in CIDR notation.
        """
    ...
    @definition.setter
    def definition(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class FirewallPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateless_default_actions: The actions to take on a packet if it doesn't match any of the stateless rules in the policy. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe` .
               
               You must specify one of the standard actions: `aws:pass` , `aws:drop` , or `aws:forward_to_sfe` . In addition, you can specify custom actions that are compatible with your standard section choice.
               
               For example, you could specify `["aws:pass"]` or you could specify `["aws:pass", "customActionName"]` . For information about compatibility, see the custom action descriptions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateless_fragment_default_actions: The actions to take on a fragmented packet if it doesn't match any of the stateless rules in the policy. If you want non-matching fragmented packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe` .
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateful_default_actions: The default actions to take on a packet that doesn't match any stateful rules. The stateful default action is optional, and is only valid when using the strict rule order.
        ...
        :param pulumi.Input[builtins.str] tls_inspection_configuration_arn: The Amazon Resource Name (ARN) of the TLS inspection configuration.
        """
...
class LoggingConfigurationLogDestinationConfigArgs:
    def __init__(__self__, *,
                 ...
                 log_type: pulumi.Input['LoggingConfigurationLogDestinationConfigLogType']):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] log_destination: A key-value pair to configure the logDestinations.
...
class RuleGroupAddressArgs:
    def __init__(__self__, *,
                 address_definition: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] address_definition: Specify an IP address or a block of IP addresses in Classless Inter-Domain Routing (CIDR) notation. Network Firewall supports all address ranges for IPv4 and IPv6.
...
class RuleGroupHeaderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination: The destination IP address or address range to inspect for, in CIDR notation. To match with any address, specify `ANY` .
               ...
               For more information about CIDR notation, see the Wikipedia entry [Classless Inter-Domain Routing](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) .
        :param pulumi.Input[builtins.str] destination_port: The destination port to inspect for. You can specify an individual port, for example `1994` and you can specify a port range, for example `1990:1994` . To match with any port, specify `ANY` .
        ...
        :param pulumi.Input[builtins.str] source: The source IP address or address range to inspect for, in CIDR notation. To match with any address, specify `ANY` .
               ...
               For more information about CIDR notation, see the Wikipedia entry [Classless Inter-Domain Routing](https://docs.aws.amazon.com/https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) .
        :param pulumi.Input[builtins.str] source_port: The source port to inspect for. You can specify an individual port, for example `1994` and you can specify a port range, for example `1990:1994` . To match with any port, specify `ANY` .
        """
...
if not MYPY:
    class RuleGroupIpSetReferenceArgsDict(TypedDict):
        reference_arn: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class RuleGroupIpSetReferenceArgs:
    def __init__(__self__, *,
                 reference_arn: Optional[pulumi.Input[builtins.str]] = None):
        if reference_arn is not None:
            pulumi.set(__self__, "reference_arn", reference_arn)

    @property
    @pulumi.getter(name="referenceArn")
    def reference_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "reference_arn")

    @reference_arn.setter
    def reference_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleGroupMatchAttributesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] protocols: The protocols to inspect for, specified using each protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
...
class RuleGroupPortRangeArgs:
    def __init__(__self__, *,
                 ...
                 to_port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] from_port: The lower limit of the port range. This must be less than or equal to the `ToPort` specification.
        :param pulumi.Input[builtins.int] to_port: The upper limit of the port range. This must be greater than or equal to the `FromPort` specification.
        """
...
class RuleGroupRuleOptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] keyword: The Suricata rule option keywords. For Network Firewall , the keyword signature ID (sid) is required in the format `sid:112233` . The sid must be unique within the rule group. For information about Suricata rule option keywords, see [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options) .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] settings: The Suricata rule option settings. Settings have zero or more values, and the number of possible settings and required settings depends on the keyword. The format for Settings is `number` . For information about Suricata rule option settings, see [Rule options](https://docs.aws.amazon.com/https://suricata.readthedocs.io/en/suricata-6.0.9/rules/intro.html#rule-options) .
        """
...
class RuleGroupRulesSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rules_string: Stateful inspection criteria, provided in Suricata compatible rules. Suricata is an open-source threat detection framework that includes a standard rule-based language for network traffic inspection.
...
class TlsInspectionConfigurationServerCertificateScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TlsInspectionConfigurationAddressArgs']]] destinations: The destination IP addresses and address ranges to decrypt for inspection, in CIDR notation. If not specified, this
               matches with any destination address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] protocols: The protocols to decrypt for inspection, specified using each protocol's assigned internet protocol number
               (IANA). Network Firewall currently supports only TCP.
