...
def get_document(name: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDocumentResult:
    """
    The AWS::SSM::Document resource is an SSM document in AWS Systems Manager that defines the actions that Systems Manager performs, which can be used to set up and run commands on your instances.


    :param builtins.str name: A name for the Systems Manager document.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_document_output(name: Optional[pulumi.Input[builtins.str]] = None,
