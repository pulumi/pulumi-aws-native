...
class ResourceDataSyncArgs:
    def __init__(__self__, *,
                 ...
                 sync_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) of an encryption key for a destination in Amazon S3 . You can use a KMS key to encrypt inventory data in Amazon S3 . You must specify a key that exist in the same AWS Region as the destination Amazon S3 bucket.
        ...
        :param pulumi.Input[builtins.str] sync_name: A name for the resource data sync.
        ...
        :param pulumi.Input[builtins.str] sync_type: The type of resource data sync. If `SyncType` is `SyncToDestination` , then the resource data sync synchronizes data to an S3 bucket. If the `SyncType` is `SyncFromSource` then the resource data sync synchronizes data from AWS Organizations or from multiple AWS Regions .
        """
    ...
    def sync_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_name.setter
    def sync_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_type.setter
    def sync_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ResourceDataSync(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="syncFormat")
    def sync_format(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A supported sync format. The following format is currently supported: JsonSerDe
        """
        return pulumi.get(self, "sync_format")
    ...
    @property
    @pulumi.getter(name="syncName")
    def sync_name(self) -> pulumi.Output[builtins.str]:
        """
        A name for the resource data sync.
        """
        return pulumi.get(self, "sync_name")
