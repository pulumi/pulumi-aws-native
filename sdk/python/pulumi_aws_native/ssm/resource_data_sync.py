...
class ResourceDataSync(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResourceDataSyncPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResourceDataSyncPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResourceDataSyncAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResourceDataSyncProperties']:
        """
