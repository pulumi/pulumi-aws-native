...
class GetAssociationResult:
    ...
    def apply_only_at_cron_interval(self) -> Optional[builtins.bool]:
        """
    ...
    def association_name(self) -> Optional[builtins.str]:
        """
    ...
    def automation_target_parameter_name(self) -> Optional[builtins.str]:
        """
    ...
    def calendar_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def max_errors(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[Mapping[str, Sequence[builtins.str]]]:
        """
...
def get_association(association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str association_id: Unique identifier of the association.
    """
    __args__ = dict()
