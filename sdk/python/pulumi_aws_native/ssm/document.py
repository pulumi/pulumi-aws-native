...
class DocumentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A name for the Systems Manager document.
        ...
        :param pulumi.Input[builtins.str] target_type: Specify a target type to define the kinds of resources the document can run on.
        ...
        :param pulumi.Input[builtins.str] version_name: An optional field specifying the version of the artifact you are creating with the document. This value is unique across all versions of a document, and cannot be changed.
        """
