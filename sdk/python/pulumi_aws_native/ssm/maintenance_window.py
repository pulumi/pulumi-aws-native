...
class MaintenanceWindow(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MaintenanceWindowPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MaintenanceWindowPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MaintenanceWindowAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MaintenanceWindowProperties']:
        """
