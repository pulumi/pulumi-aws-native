...
@pulumi.type_token("aws-native:ssm:MaintenanceWindowTarget")
class MaintenanceWindowTarget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["window_target_id"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["windowId"])
    ...
    def window_target_id(self) -> pulumi.Output[_builtins.str]:
        """
