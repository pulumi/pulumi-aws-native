...
class GetPatchBaselineResult:
    ...
    def approved_patches(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def approved_patches_enable_non_security(self) -> Optional[builtins.bool]:
        """
    ...
    def default_baseline(self) -> Optional[builtins.bool]:
        """
    ...
    def patch_groups(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def rejected_patches(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_patch_baseline(id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPatchBaselineResult:
    """
    Resource Type definition for AWS::SSM::PatchBaseline


    :param builtins.str id: The ID of the patch baseline.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_patch_baseline_output(id: Optional[pulumi.Input[builtins.str]] = None,
