...
class ResourceDefaultVersionArgs:
    def __init__(__self__, *,
                 ...
                 type_version_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type_version_arn: The Amazon Resource Name (ARN) of the type version.
        :param pulumi.Input[builtins.str] version_id: The ID of an existing version of the resource to set as the default.
        """
    ...
    def type_version_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def type_version_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:cloudformation:ResourceDefaultVersion")
class ResourceDefaultVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="typeVersionArn")
    def type_version_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the type version.
        """
        return pulumi.get(self, "type_version_arn")
