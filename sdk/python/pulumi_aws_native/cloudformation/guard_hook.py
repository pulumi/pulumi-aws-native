...
class GuardHookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] execution_role: The execution role ARN assumed by hooks to read Guard rules from S3 and write Guard outputs to S3.
        ...
        :param pulumi.Input[builtins.str] log_bucket: S3 Bucket where the guard validate report will be uploaded to
...
@pulumi.type_token("aws-native:cloudformation:GuardHook")
class GuardHook(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="logBucket")
    def log_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        S3 Bucket where the guard validate report will be uploaded to
        """
        return pulumi.get(self, "log_bucket")
