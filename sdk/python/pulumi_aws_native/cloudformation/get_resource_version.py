...
class GetResourceVersionResult:
    ...
    def type_arn(self) -> Optional[builtins.str]:
        """
...
def get_resource_version(arn: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceVersionResult:
    """
    A resource that has been registered in the CloudFormation Registry.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the type, here the ResourceVersion. This is used to uniquely identify a ResourceVersion resource
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_resource_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
