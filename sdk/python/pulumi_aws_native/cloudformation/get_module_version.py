...
def get_module_version(arn: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetModuleVersionResult:
    """
    A module that has been registered in the CloudFormation registry.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the module.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_module_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
