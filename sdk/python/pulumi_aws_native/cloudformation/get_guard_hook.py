...
class GetGuardHookResult:
    ...
    def log_bucket(self) -> Optional[builtins.str]:
        """
...
def get_guard_hook(hook_arn: Optional[builtins.str] = None,
...
def get_guard_hook_output(hook_arn: Optional[pulumi.Input[builtins.str]] = None,
