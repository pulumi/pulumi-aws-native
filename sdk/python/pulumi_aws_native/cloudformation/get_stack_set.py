...
class GetStackSetResult:
    ...
    def administration_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def execution_role_name(self) -> Optional[builtins.str]:
        """
...
def get_stack_set(stack_set_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStackSetResult:
    """
    StackSet as a resource provides one-click experience for provisioning a StackSet and StackInstances


    :param builtins.str stack_set_id: The ID of the stack set that you're creating.
    """
    __args__ = dict()
...
def get_stack_set_output(stack_set_id: Optional[pulumi.Input[builtins.str]] = None,
