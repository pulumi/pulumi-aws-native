...
class OptionsPropertiesArgsDict(TypedDict):
    ...
    """
    input_params: NotRequired[pulumi.Input[Optional[Union['GuardHookS3LocationArgs', Sequence[pulumi.Input['GuardHookS3LocationArgs']]]]]]
    """
...
class StackFiltersPropertiesArgsDict(TypedDict):
    ...
    """
    stack_names: NotRequired[pulumi.Input[Optional['StackFiltersPropertiesStackNamesPropertiesArgs']]]
    """
    List of stack names as filters
    """
    stack_roles: NotRequired[pulumi.Input[Optional['StackFiltersPropertiesStackRolesPropertiesArgs']]]
    """
    List of stack roles that are performing the stack operations.
    """
...
class StackSetAutoDeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] retain_stacks_on_account_removal: If set to true, stack resources are retained when an account is removed from a target organization or OU. If set to false, stack resources are deleted. Specify only if Enabled is set to True.
        """
...
class StackSetDeploymentTargetsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] organizational_unit_ids: The organization root ID or organizational unit (OU) IDs to which StackSets deploys.
        """
...
class StackSetOperationPreferencesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['StackSetConcurrencyMode'] concurrency_mode: Specifies how the concurrency level behaves during the operation execution.
               ...
               If failure tolerance or Maximum concurrent accounts are set to percentages, the behavior is similar.
               - `SOFT_FAILURE_TOLERANCE` : This option decouples `FailureToleranceCount` from the actual concurrency. This allows StackSet operations to run at the concurrency level set by the `MaxConcurrentCount` value, or `MaxConcurrentPercentage` , regardless of the number of failures.
        :param pulumi.Input[_builtins.int] failure_tolerance_count: The number of accounts per Region this operation can fail in before CloudFormation stops the operation in that Region. If the operation is stopped in a Region, CloudFormation doesn't attempt the operation in any subsequent Regions.
               
               Conditional: You must specify either `FailureToleranceCount` or `FailureTolerancePercentage` (but not both).
        :param pulumi.Input[_builtins.int] failure_tolerance_percentage: The percentage of accounts per Region this stack operation can fail in before CloudFormation stops the operation in that Region. If the operation is stopped in a Region, CloudFormation doesn't attempt the operation in any subsequent Regions.
               
               When calculating the number of accounts based on the specified percentage, CloudFormation rounds *down* to the next whole number.
               
               Conditional: You must specify either `FailureToleranceCount` or `FailureTolerancePercentage` , but not both.
        :param pulumi.Input[_builtins.int] max_concurrent_count: The maximum number of accounts in which to perform this operation at one time. This is dependent on the value of `FailureToleranceCount` . `MaxConcurrentCount` is at most one more than the `FailureToleranceCount` .
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] region_order: The order of the Regions where you want to perform the stack operation.
        """
...
class StackSetParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] parameter_key: The key associated with the parameter. If you don't specify a key and value for a particular parameter, AWS CloudFormation uses the default value that is specified in your template.
        :param pulumi.Input[_builtins.str] parameter_value: The input value associated with the parameter.
        """
...
class StackSetStackInstancesArgsDict(TypedDict):
    ...
    """
    parameter_overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StackSetParameterArgs']]]]]
    """
