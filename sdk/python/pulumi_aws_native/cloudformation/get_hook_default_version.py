...
def get_hook_default_version(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The Amazon Resource Name (ARN) of the type. This is used to uniquely identify a HookDefaultVersion
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_hook_default_version_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
