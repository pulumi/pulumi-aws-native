...
def get_hook_default_version(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the type. This is used to uniquely identify a HookDefaultVersion
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_hook_default_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
