...
class HookVersionLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_role_arn: Optional[_builtins.str] = None):
        """
        :param _builtins.str log_group_name: The Amazon CloudWatch log group to which CloudFormation sends error logging information when invoking the type's handlers.
    ...
    def log_role_arn(self) -> Optional[_builtins.str]:
        """
...
class OptionsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Union['GuardHookS3Location', Sequence['GuardHookS3Location']] input_params: Specifies the S3 location of input parameter files for your Guard rules. You can specify either a single S3 location or an array of up to 10 S3 locations.
        """
...
class StackOutput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: User defined description associated with the output.
        :param _builtins.str export_name: The name of the export associated with the output.
        :param _builtins.str output_key: The key associated with the output.
        :param _builtins.str output_value: The value associated with the output.
        """
    ...
    def export_name(self) -> Optional[_builtins.str]:
        """
...
class StackSetDeploymentTargets(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] organizational_unit_ids: The organization root ID or organizational unit (OU) IDs to which StackSets deploys.
        """
...
class StackSetOperationPreferences(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int failure_tolerance_count: The number of accounts per Region this operation can fail in before CloudFormation stops the operation in that Region. If the operation is stopped in a Region, CloudFormation doesn't attempt the operation in any subsequent Regions.
               
               Conditional: You must specify either `FailureToleranceCount` or `FailureTolerancePercentage` (but not both).
        :param _builtins.int failure_tolerance_percentage: The percentage of accounts per Region this stack operation can fail in before CloudFormation stops the operation in that Region. If the operation is stopped in a Region, CloudFormation doesn't attempt the operation in any subsequent Regions.
               
               When calculating the number of accounts based on the specified percentage, CloudFormation rounds *down* to the next whole number.
               
               Conditional: You must specify either `FailureToleranceCount` or `FailureTolerancePercentage` , but not both.
        :param _builtins.int max_concurrent_count: The maximum number of accounts in which to perform this operation at one time. This is dependent on the value of `FailureToleranceCount` . `MaxConcurrentCount` is at most one more than the `FailureToleranceCount` .
        ...
        :param Sequence[_builtins.str] region_order: The order of the Regions where you want to perform the stack operation.
        """
    ...
    def region_order(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class TargetFilters0Properties(dict):
    ...
    def target_names(self) -> Optional[Sequence[_builtins.str]]:
        """
