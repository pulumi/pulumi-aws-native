...
class HookTypeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] configuration: The configuration data for the extension, in this account and region.
        ...
        :param pulumi.Input[builtins.str] type_arn: The Amazon Resource Name (ARN) of the type without version number.
...
class HookTypeConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["configurationAlias"])
    ...
    def configuration_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="typeArn")
    def type_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the type without version number.
        """
        return pulumi.get(self, "type_arn")
