...
class PublicTypeVersionArgs:
    def __init__(__self__, *,
                 ...
                 log_delivery_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 public_version_number: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Number (ARN) of the extension.
        :param pulumi.Input[builtins.str] log_delivery_bucket: A url to the S3 bucket where logs for the testType run will be available
        :param pulumi.Input[builtins.str] public_version_number: The version number of a public third-party extension
    ...
    def log_delivery_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_delivery_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_delivery_bucket", value)

    @property
    @pulumi.getter(name="publicVersionNumber")
    def public_version_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_version_number(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:cloudformation:PublicTypeVersion")
class PublicTypeVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="logDeliveryBucket")
    def log_delivery_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A url to the S3 bucket where logs for the testType run will be available
        """
        return pulumi.get(self, "log_delivery_bucket")
    ...
    def public_type_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="publicVersionNumber")
    def public_version_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version number of a public third-party extension
        """
        return pulumi.get(self, "public_version_number")
    ...
    def type_version_arn(self) -> pulumi.Output[builtins.str]:
        """
