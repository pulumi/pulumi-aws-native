...
class WaitConditionHandle(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['WaitConditionHandlePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WaitConditionHandlePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.WaitConditionHandleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WaitConditionHandleProperties']:
        """
