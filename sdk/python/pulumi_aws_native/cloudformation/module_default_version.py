...
class ModuleDefaultVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ModuleDefaultVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ModuleDefaultVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ModuleDefaultVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ModuleDefaultVersionProperties']:
        """
