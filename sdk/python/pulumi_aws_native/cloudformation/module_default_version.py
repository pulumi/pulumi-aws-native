...
class ModuleDefaultVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the module version to set as the default version.
        :param pulumi.Input[builtins.str] module_name: The name of a module existing in the registry.
        :param pulumi.Input[builtins.str] version_id: The ID of an existing version of the named module to set as the default.
        """
        if arn is not None:
...
@pulumi.type_token("aws-native:cloudformation:ModuleDefaultVersion")
