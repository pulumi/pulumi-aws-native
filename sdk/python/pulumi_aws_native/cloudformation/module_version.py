...
class ModuleVersionArgs:
    def __init__(__self__, *,
                 ...
                 module_package: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ModuleVersion resource.
        :param pulumi.Input[builtins.str] module_name: The name of the module being registered.
               
               Recommended module naming pattern: company_or_organization::service::type::MODULE.
        :param pulumi.Input[builtins.str] module_package: The url to the S3 bucket containing the schema and template fragment for the module you want to register.
        """
    ...
    def module_package(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def module_package(self, value: pulumi.Input[builtins.str]):
...
class ModuleVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 module_package: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="modulePackage")
    def module_package(self) -> pulumi.Output[builtins.str]:
        """
        The url to the S3 bucket containing the schema and template fragment for the module you want to register.
        """
        return pulumi.get(self, "module_package")
