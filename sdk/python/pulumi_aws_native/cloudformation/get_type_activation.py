...
class GetTypeActivationResult:
    ...
    def type_name_alias(self) -> Optional[builtins.str]:
        """
...
def get_type_activation(arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTypeActivationResult:
    """
    Enable a resource that has been published in the CloudFormation Registry.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the extension.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_type_activation_output(arn: Optional[pulumi.Input[builtins.str]] = None,
