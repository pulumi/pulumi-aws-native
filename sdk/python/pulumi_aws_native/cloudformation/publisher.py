...
class PublisherArgs:
    def __init__(__self__, *,
                 accept_terms_and_conditions: pulumi.Input[builtins.bool],
                 connection_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Publisher resource.
        :param pulumi.Input[builtins.bool] accept_terms_and_conditions: Whether you accept the terms and conditions for publishing extensions in the CloudFormation registry. You must accept the terms and conditions in order to publish public extensions to the CloudFormation registry. The terms and conditions can be found at https://cloudformation-registry-documents.s3.amazonaws.com/Terms_and_Conditions_for_AWS_CloudFormation_Registry_Publishers.pdf
        :param pulumi.Input[builtins.str] connection_arn: If you are using a Bitbucket or GitHub account for identity verification, the Amazon Resource Name (ARN) for your connection to that account.
        """
    ...
    def accept_terms_and_conditions(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def accept_terms_and_conditions(self, value: pulumi.Input[builtins.bool]):
...
class Publisher(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 accept_terms_and_conditions: Optional[pulumi.Input[builtins.bool]] = None,
                 connection_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="acceptTermsAndConditions")
    def accept_terms_and_conditions(self) -> pulumi.Output[builtins.bool]:
        """
        Whether you accept the terms and conditions for publishing extensions in the CloudFormation registry. You must accept the terms and conditions in order to publish public extensions to the CloudFormation registry. The terms and conditions can be found at https://cloudformation-registry-documents.s3.amazonaws.com/Terms_and_Conditions_for_AWS_CloudFormation_Registry_Publishers.pdf
        """
        return pulumi.get(self, "accept_terms_and_conditions")
    ...
    @property
    @pulumi.getter(name="connectionArn")
    def connection_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If you are using a Bitbucket or GitHub account for identity verification, the Amazon Resource Name (ARN) for your connection to that account.
        """
        return pulumi.get(self, "connection_arn")
    ...
    def publisher_profile(self) -> pulumi.Output[builtins.str]:
        """
