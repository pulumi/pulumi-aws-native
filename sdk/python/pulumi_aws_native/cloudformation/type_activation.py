...
class TypeActivationArgs:
    def __init__(__self__, *,
                 ...
                 public_type_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 type_name_alias: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_update: Whether to automatically update the extension in this account and region when a new minor version is published by the extension publisher. Major versions released by the publisher must be manually updated.
        ...
        :param pulumi.Input[builtins.str] major_version: The Major Version of the type you want to enable
        :param pulumi.Input[builtins.str] public_type_arn: The Amazon Resource Number (ARN) assigned to the public extension upon publication
        :param pulumi.Input[builtins.str] publisher_id: The reserved publisher id for this type, or the publisher id assigned by CloudFormation for publishing in this region.
        ...
        :param pulumi.Input[builtins.str] type_name_alias: An alias to assign to the public extension in this account and region. If you specify an alias for the extension, you must then use the alias to refer to the extension in your templates.
    ...
    def public_type_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_type_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def type_name_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def type_name_alias(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TypeActivation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="majorVersion")
    def major_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Major Version of the type you want to enable
        """
        return pulumi.get(self, "major_version")
    ...
    @property
    @pulumi.getter(name="publicTypeArn")
    def public_type_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Number (ARN) assigned to the public extension upon publication
        """
        return pulumi.get(self, "public_type_arn")
    ...
    @property
    @pulumi.getter(name="typeNameAlias")
    def type_name_alias(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An alias to assign to the public extension in this account and region. If you specify an alias for the extension, you must then use the alias to refer to the extension in your templates.
        """
        return pulumi.get(self, "type_name_alias")
