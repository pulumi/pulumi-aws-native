...
class GetPublisherResult:
    ...
    def publisher_profile(self) -> Optional[builtins.str]:
        """
...
def get_publisher(publisher_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPublisherResult:
    """
    Register as a publisher in the CloudFormation Registry.


    :param builtins.str publisher_id: The reserved publisher id for this type, or the publisher id assigned by CloudFormation for publishing in this region.
    """
    __args__ = dict()
...
def get_publisher_output(publisher_id: Optional[pulumi.Input[builtins.str]] = None,
