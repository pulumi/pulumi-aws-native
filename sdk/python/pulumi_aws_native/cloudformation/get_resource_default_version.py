...
def get_resource_default_version(arn: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceDefaultVersionResult:
    """
    The default version of a resource that has been registered in the CloudFormation Registry.


    :param _builtins.str arn: The Amazon Resource Name (ARN) of the type. This is used to uniquely identify a ResourceDefaultVersion
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_resource_default_version_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
