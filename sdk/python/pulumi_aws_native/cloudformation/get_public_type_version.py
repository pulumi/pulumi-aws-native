...
class GetPublicTypeVersionResult:
    ...
    def public_type_arn(self) -> Optional[builtins.str]:
        """
    ...
    def type_version_arn(self) -> Optional[builtins.str]:
        """
...
def get_public_type_version(public_type_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPublicTypeVersionResult:
    """
    Test and Publish a resource that has been registered in the CloudFormation Registry.


    :param builtins.str public_type_arn: The Amazon Resource Number (ARN) assigned to the public extension upon publication
    """
    __args__ = dict()
...
def get_public_type_version_output(public_type_arn: Optional[pulumi.Input[builtins.str]] = None,
