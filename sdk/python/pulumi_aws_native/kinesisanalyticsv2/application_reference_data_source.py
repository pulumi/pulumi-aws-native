...
__all__ = ['ApplicationReferenceDataSource']
...
class ApplicationReferenceDataSource(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApplicationReferenceDataSourcePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApplicationReferenceDataSourcePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApplicationReferenceDataSourceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApplicationReferenceDataSourceProperties']:
        """
