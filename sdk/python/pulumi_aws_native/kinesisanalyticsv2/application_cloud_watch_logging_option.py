...
warnings.warn("""ApplicationCloudWatchLoggingOption is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ApplicationCloudWatchLoggingOption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 cloud_watch_logging_option: Optional[pulumi.Input[pulumi.InputType['ApplicationCloudWatchLoggingOptionCloudWatchLoggingOptionArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationCloudWatchLoggingOption is deprecated: ApplicationCloudWatchLoggingOption is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
