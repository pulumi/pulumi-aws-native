...
__all__ = ['ApplicationCloudWatchLoggingOption']
...
class ApplicationCloudWatchLoggingOption(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApplicationCloudWatchLoggingOptionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApplicationCloudWatchLoggingOptionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApplicationCloudWatchLoggingOptionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApplicationCloudWatchLoggingOptionProperties']:
        """
