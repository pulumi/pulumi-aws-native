...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(application_configuration, ApplicationConfigurationArgs):
            ...
            if not isinstance(application_maintenance_configuration, ApplicationMaintenanceConfigurationArgs):
            ...
            if not isinstance(run_configuration, ApplicationRunConfigurationArgs):
