...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] runtime_environment: The runtime environment for the application.
        :param pulumi.Input[builtins.str] service_execution_role: Specifies the IAM role that the application uses to access external resources.
        ...
        :param pulumi.Input[builtins.str] application_description: The description of the application.
