...
class ApplicationCheckpointConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] min_pause_between_checkpoints: Describes the minimum time in milliseconds after a checkpoint operation completes that a new checkpoint operation can start. If a checkpoint operation takes longer than the CheckpointInterval, the application otherwise performs continual checkpoint operations. For more information, see Tuning Checkpointing in the Apache Flink Documentation.
        """
...
if not MYPY:
    class ApplicationCodeContentArgsDict(TypedDict):
        ...
        """
        zip_file_content: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationCodeContentArgs:
    def __init__(__self__, *,
                 ...
                 zip_file_content: Optional[pulumi.Input[builtins.str]] = None):
        """
        Specifies either the application code, or the location of the application code, for a Flink-based Kinesis Data Analytics application.
        ...
        :param pulumi.Input[builtins.str] text_content: The text-format code for a Flink-based Kinesis Data Analytics application.
        :param pulumi.Input[builtins.str] zip_file_content: The zip-format code for a Flink-based Kinesis Data Analytics application.
        """
    ...
    def zip_file_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The zip-format code for a Flink-based Kinesis Data Analytics application.
        """
    ...
    def zip_file_content(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ApplicationGlueDataCatalogConfigurationArgsDict(TypedDict):
        ...
        """
        database_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationGlueDataCatalogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration of the Glue Data Catalog that you use for Apache Flink SQL queries and table API transforms that you write in an application.
        :param pulumi.Input[builtins.str] database_arn: The Amazon Resource Name (ARN) of the database.
        """
...
class ApplicationInputLambdaProcessorArgs:
    def __init__(__self__, *,
        ...
        """
        An object that contains the Amazon Resource Name (ARN) of the Amazon Lambda function that is used to preprocess records in the stream in a SQL-based Kinesis Data Analytics application.
        :param pulumi.Input[builtins.str] resource_arn: The ARN of the Amazon Lambda function that operates on records in the stream.
        """
...
class ApplicationInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name_prefix: The name prefix to use when creating an in-application stream. Suppose that you specify a prefix `"MyInApplicationStream"`. Kinesis Data Analytics then creates one or more (as per the InputParallelism count you specified) in-application streams with the names `"MyInApplicationStream_001"`, `"MyInApplicationStream_002"`, and so on.
...
class ApplicationKinesisFirehoseInputArgs:
    def __init__(__self__, *,
        ...
        """
        For a SQL-based Kinesis Data Analytics application, identifies a Kinesis Data Firehose delivery stream as the streaming source. You provide the delivery stream's Amazon Resource Name (ARN).
        :param pulumi.Input[builtins.str] resource_arn: The Amazon Resource Name (ARN) of the delivery stream.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
if not MYPY:
    class ApplicationMaintenanceConfigurationArgsDict(TypedDict):
        ...
        """
        application_maintenance_window_start_time: pulumi.Input[builtins.str]
        """
...
class ApplicationMaintenanceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the maintenance configuration for the application.
        :param pulumi.Input[builtins.str] application_maintenance_window_start_time: The start time for the maintenance window.
        """
    ...
    def application_maintenance_window_start_time(self) -> pulumi.Input[builtins.str]:
        """
        The start time for the maintenance window.
        """
    ...
    def application_maintenance_window_start_time(self, value: pulumi.Input[builtins.str]):
...
class ApplicationMavenReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        The information required to specify a Maven reference. You can use Maven references to specify dependency JAR files.
        :param pulumi.Input[builtins.str] artifact_id: The artifact ID of the Maven reference.
        :param pulumi.Input[builtins.str] group_id: The group ID of the Maven reference.
        :param pulumi.Input[builtins.str] version: The version of the Maven reference.
        """
...
class ApplicationParallelismConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] parallelism: Describes the initial number of parallel tasks that a Java-based Kinesis Data Analytics application can perform. The Kinesis Data Analytics service can increase this number automatically if ParallelismConfiguration:AutoScalingEnabled is set to true.
        :param pulumi.Input[builtins.int] parallelism_per_kpu: Describes the number of parallel tasks that a Java-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application. For more information about KPUs, see Amazon Kinesis Data Analytics Pricing.
        """
        pulumi.set(__self__, "configuration_type", configuration_type)
...
if not MYPY:
    class ApplicationPropertyGroupArgsDict(TypedDict):
        ...
        """
        property_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Describes the key of an application execution property key-value pair.
        """
        property_map: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ApplicationPropertyGroupArgs:
    def __init__(__self__, *,
                 property_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 property_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Property key-value pairs passed into an application.
        :param pulumi.Input[builtins.str] property_group_id: Describes the key of an application execution property key-value pair.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] property_map: Describes the value of an application execution property key-value pair.
        """
    ...
    def property_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Describes the key of an application execution property key-value pair.
        """
    ...
    def property_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "property_group_id", value)

    @property
    @pulumi.getter(name="propertyMap")
    def property_map(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Describes the value of an application execution property key-value pair.
        """
    ...
    @property_map.setter
    def property_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ApplicationRestoreConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] snapshot_name: The identifier of an existing snapshot of application state to use to restart an application. The application uses this value if RESTORE_FROM_CUSTOM_SNAPSHOT is specified for the ApplicationRestoreType.
        """
...
if not MYPY:
    class ApplicationS3ContentBaseLocationArgsDict(TypedDict):
        ...
        """
        base_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationS3ContentBaseLocationArgs:
    def __init__(__self__, *,
        ...
        """
        The base location of the Amazon Data Analytics application.
        :param pulumi.Input[builtins.str] bucket_arn: The Amazon Resource Name (ARN) of the S3 bucket.
        :param pulumi.Input[builtins.str] base_path: The base path for the S3 bucket.
        """
...
class ApplicationS3ContentLocationArgs:
    def __init__(__self__, *,
        ...
        """
        The location of an application or a custom artifact.
        :param pulumi.Input[builtins.str] bucket_arn: The Amazon Resource Name (ARN) for the S3 bucket containing the application code.
...
if not MYPY:
    class ApplicationSystemRollbackConfigurationArgsDict(TypedDict):
        ...
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
        rollback_enabled: pulumi.Input[builtins.bool]
        """
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
elif False:
...
class ApplicationSystemRollbackConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        :param pulumi.Input[builtins.bool] rollback_enabled: Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
        pulumi.set(__self__, "rollback_enabled", rollback_enabled)

    @property
    @pulumi.getter(name="rollbackEnabled")
    def rollback_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
    ...
    def rollback_enabled(self, value: pulumi.Input[builtins.bool]):
...
class ApplicationVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the parameters of a VPC used by the application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The array of SecurityGroup IDs used by the VPC configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The array of Subnet IDs used by the VPC configuration.
        """
