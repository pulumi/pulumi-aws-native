...
class ApplicationCheckpointConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 checkpoint_interval: Optional[builtins.int] = None,
                 checkpointing_enabled: Optional[builtins.bool] = None,
                 min_pause_between_checkpoints: Optional[builtins.int] = None):
        """
        Describes an application's checkpointing configuration. Checkpointing is the process of persisting application state for fault tolerance. For more information, see Checkpoints for Fault Tolerance in the Apache Flink Documentation.
        ...
        :param builtins.int checkpoint_interval: Describes the interval in milliseconds between checkpoint operations.
        :param builtins.bool checkpointing_enabled: Describes whether checkpointing is enabled for a Flink-based Kinesis Data Analytics application.
        :param builtins.int min_pause_between_checkpoints: Describes the minimum time in milliseconds after a checkpoint operation completes that a new checkpoint operation can start. If a checkpoint operation takes longer than the CheckpointInterval, the application otherwise performs continual checkpoint operations. For more information, see Tuning Checkpointing in the Apache Flink Documentation.
        """
    ...
    def checkpoint_interval(self) -> Optional[builtins.int]:
        """
    ...
    def checkpointing_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def min_pause_between_checkpoints(self) -> Optional[builtins.int]:
        """
        Describes the minimum time in milliseconds after a checkpoint operation completes that a new checkpoint operation can start. If a checkpoint operation takes longer than the CheckpointInterval, the application otherwise performs continual checkpoint operations. For more information, see Tuning Checkpointing in the Apache Flink Documentation.
        """
...
class ApplicationCodeContent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 text_content: Optional[builtins.str] = None,
                 zip_file_content: Optional[builtins.str] = None):
        """
        Specifies either the application code, or the location of the application code, for a Flink-based Kinesis Data Analytics application.
        ...
        :param builtins.str text_content: The text-format code for a Flink-based Kinesis Data Analytics application.
        :param builtins.str zip_file_content: The zip-format code for a Flink-based Kinesis Data Analytics application.
        """
    ...
    def text_content(self) -> Optional[builtins.str]:
        """
    ...
    def zip_file_content(self) -> Optional[builtins.str]:
        """
...
class ApplicationCsvMappingParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        `"name1", "address1"`
        `"name2", "address2"`
        :param builtins.str record_column_delimiter: The column delimiter. For example, in a CSV format, a comma (",") is the typical column delimiter.
        :param builtins.str record_row_delimiter: The row delimiter. For example, in a CSV format, '\\n' is the typical row delimiter.
        """
...
class ApplicationFlinkRunConfiguration(dict):
    ...
    def allow_non_restored_state(self) -> Optional[builtins.bool]:
        """
...
class ApplicationGlueDataCatalogConfiguration(dict):
    ...
    def __init__(__self__, *,
                 database_arn: Optional[builtins.str] = None):
        """
        The configuration of the Glue Data Catalog that you use for Apache Flink SQL queries and table API transforms that you write in an application.
        :param builtins.str database_arn: The Amazon Resource Name (ARN) of the database.
        """
    ...
    def database_arn(self) -> Optional[builtins.str]:
        """
...
class ApplicationInput(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name_prefix: The name prefix to use when creating an in-application stream. Suppose that you specify a prefix `"MyInApplicationStream"`. Kinesis Data Analytics then creates one or more (as per the InputParallelism count you specified) in-application streams with the names `"MyInApplicationStream_001"`, `"MyInApplicationStream_002"`, and so on.
...
class ApplicationInputLambdaProcessor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object that contains the Amazon Resource Name (ARN) of the Amazon Lambda function that is used to preprocess records in the stream in a SQL-based Kinesis Data Analytics application.
        :param builtins.str resource_arn: The ARN of the Amazon Lambda function that operates on records in the stream.
        """
...
class ApplicationInputParallelism(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        For a SQL-based Kinesis Data Analytics application, describes the number of in-application streams to create for a given streaming source.
        :param builtins.int count: The number of in-application streams to create.
        """
...
class ApplicationJsonMappingParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        For a SQL-based Kinesis Data Analytics application, provides additional mapping information when JSON is the record format on the streaming source.
        :param builtins.str record_row_path: The path to the top-level parent that contains the records.
        """
...
class ApplicationKinesisFirehoseInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        For a SQL-based Kinesis Data Analytics application, identifies a Kinesis Data Firehose delivery stream as the streaming source. You provide the delivery stream's Amazon Resource Name (ARN).
        :param builtins.str resource_arn: The Amazon Resource Name (ARN) of the delivery stream.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationKinesisStreamsInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identifies a Kinesis data stream as the streaming source. You provide the stream's Amazon Resource Name (ARN).
        :param builtins.str resource_arn: The ARN of the input Kinesis data stream to read.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationMaintenanceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the maintenance configuration for the application.
        :param builtins.str application_maintenance_window_start_time: The start time for the maintenance window.
        """
...
class ApplicationMavenReference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The information required to specify a Maven reference. You can use Maven references to specify dependency JAR files.
        :param builtins.str artifact_id: The artifact ID of the Maven reference.
        :param builtins.str group_id: The group ID of the Maven reference.
        :param builtins.str version: The version of the Maven reference.
        """
...
class ApplicationParallelismConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parallelism_per_kpu: Optional[builtins.int] = None):
        """
        Describes parameters for how a Flink-based Kinesis Data Analytics application executes multiple tasks simultaneously. For more information about parallelism, see Parallel Execution in the Apache Flink Documentation
        ...
        :param builtins.bool auto_scaling_enabled: Describes whether the Kinesis Data Analytics service can increase the parallelism of the application in response to increased throughput.
        :param builtins.int parallelism: Describes the initial number of parallel tasks that a Java-based Kinesis Data Analytics application can perform. The Kinesis Data Analytics service can increase this number automatically if ParallelismConfiguration:AutoScalingEnabled is set to true.
        :param builtins.int parallelism_per_kpu: Describes the number of parallel tasks that a Java-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application. For more information about KPUs, see Amazon Kinesis Data Analytics Pricing.
        """
        pulumi.set(__self__, "configuration_type", configuration_type)
    ...
    def parallelism_per_kpu(self) -> Optional[builtins.int]:
        """
...
class ApplicationPropertyGroup(dict):
    ...
    def __init__(__self__, *,
                 property_group_id: Optional[builtins.str] = None,
                 property_map: Optional[Mapping[str, builtins.str]] = None):
        """
        Property key-value pairs passed into an application.
        :param builtins.str property_group_id: Describes the key of an application execution property key-value pair.
        :param Mapping[str, builtins.str] property_map: Describes the value of an application execution property key-value pair.
        """
    ...
    def property_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def property_map(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ApplicationRecordColumn(dict):
    ...
    def __init__(__self__, *,
        ...
        For a SQL-based Kinesis Data Analytics application, describes the mapping of each data element in the streaming source to the corresponding column in the in-application stream.
        Also used to describe the format of the reference data source.
        :param builtins.str name: The name of the column that is created in the in-application input stream or reference table.
        :param builtins.str sql_type: The type of column created in the in-application input stream or reference table.
        :param builtins.str mapping: A reference to the data element in the streaming input or the reference data source.
        """
...
class ApplicationRestoreConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str snapshot_name: The identifier of an existing snapshot of application state to use to restart an application. The application uses this value if RESTORE_FROM_CUSTOM_SNAPSHOT is specified for the ApplicationRestoreType.
        """
...
class ApplicationS3ContentBaseLocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 base_path: Optional[builtins.str] = None):
        """
        The base location of the Amazon Data Analytics application.
        :param builtins.str bucket_arn: The Amazon Resource Name (ARN) of the S3 bucket.
        :param builtins.str base_path: The base path for the S3 bucket.
        """
    ...
    def base_path(self) -> Optional[builtins.str]:
        """
...
class ApplicationS3ContentLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The location of an application or a custom artifact.
        :param builtins.str bucket_arn: The Amazon Resource Name (ARN) for the S3 bucket containing the application code.
        :param builtins.str file_key: The file key for the object containing the application code.
        :param builtins.str object_version: The version of the object containing the application code.
        """
        pulumi.set(__self__, "bucket_arn", bucket_arn)
...
class ApplicationSnapshotConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes whether snapshots are enabled for a Flink-based Kinesis Data Analytics application.
        :param builtins.bool snapshots_enabled: Describes whether snapshots are enabled for a Flink-based Kinesis Data Analytics application.
        """
        pulumi.set(__self__, "snapshots_enabled", snapshots_enabled)

    @property
    @pulumi.getter(name="snapshotsEnabled")
    def snapshots_enabled(self) -> builtins.bool:
        """
        Describes whether snapshots are enabled for a Flink-based Kinesis Data Analytics application.
        """
...
class ApplicationSystemRollbackConfiguration(dict):
    ...
    def __init__(__self__, *,
                 rollback_enabled: builtins.bool):
        """
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        :param builtins.bool rollback_enabled: Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
        pulumi.set(__self__, "rollback_enabled", rollback_enabled)

    @property
    @pulumi.getter(name="rollbackEnabled")
    def rollback_enabled(self) -> builtins.bool:
        """
        Describes whether system initiated rollbacks are enabled for a Flink-based Kinesis Data Analytics application.
        """
...
class ApplicationVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the parameters of a VPC used by the application.
        :param Sequence[builtins.str] security_group_ids: The array of SecurityGroup IDs used by the VPC configuration.
        :param Sequence[builtins.str] subnet_ids: The array of Subnet IDs used by the VPC configuration.
        """
