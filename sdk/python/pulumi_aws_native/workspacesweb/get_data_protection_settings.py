...
def get_data_protection_settings(data_protection_settings_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_protection_settings_arn: The ARN of the data protection settings resource.
    """
    __args__ = dict()
