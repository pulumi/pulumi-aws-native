...
class GetTrustStoreResult:
    ...
    def certificate_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_trust_store(trust_store_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str trust_store_arn: The ARN of the trust store.
    """
    __args__ = dict()
...
def get_trust_store_output(trust_store_arn: Optional[pulumi.Input[builtins.str]] = None,
