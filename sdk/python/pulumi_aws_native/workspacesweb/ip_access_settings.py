...
class IpAccessSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: Additional encryption context of the IP access settings.
        :param pulumi.Input[builtins.str] customer_managed_key: The custom managed key of the IP access settings.
