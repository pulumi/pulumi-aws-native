...
class GetUserSettingsResult:
    ...
    def additional_encryption_context(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def customer_managed_key(self) -> Optional[builtins.str]:
        """
    ...
    def disconnect_timeout_in_minutes(self) -> Optional[builtins.float]:
        """
    ...
    def idle_disconnect_timeout_in_minutes(self) -> Optional[builtins.float]:
        """
...
def get_user_settings(user_settings_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUserSettingsResult:
    """
    Definition of AWS::WorkSpacesWeb::UserSettings Resource Type


    :param builtins.str user_settings_arn: The ARN of the user settings.
    """
    __args__ = dict()
...
def get_user_settings_output(user_settings_arn: Optional[pulumi.Input[builtins.str]] = None,
