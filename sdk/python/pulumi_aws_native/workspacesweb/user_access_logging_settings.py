...
class UserAccessLoggingSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kinesis_stream_arn: Kinesis stream ARN to which log events are published.
...
class UserAccessLoggingSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] kinesis_stream_arn: Kinesis stream ARN to which log events are published.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: The tags to add to the user access logging settings resource. A tag is a key-value pair.
        """
        ...
    @overload
    def __init__(__self__,
