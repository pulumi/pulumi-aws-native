...
class GetBrowserSettingsResult:
    ...
    def browser_policy(self) -> Optional[builtins.str]:
        """
...
def get_browser_settings(browser_settings_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str browser_settings_arn: The ARN of the browser settings.
    """
    __args__ = dict()
...
def get_browser_settings_output(browser_settings_arn: Optional[pulumi.Input[builtins.str]] = None,
