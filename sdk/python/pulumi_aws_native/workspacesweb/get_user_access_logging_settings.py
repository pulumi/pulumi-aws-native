...
class GetUserAccessLoggingSettingsResult:
    ...
    def kinesis_stream_arn(self) -> Optional[builtins.str]:
        """
...
def get_user_access_logging_settings(user_access_logging_settings_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str user_access_logging_settings_arn: The ARN of the user access logging settings.
    """
    __args__ = dict()
...
def get_user_access_logging_settings_output(user_access_logging_settings_arn: Optional[pulumi.Input[builtins.str]] = None,
