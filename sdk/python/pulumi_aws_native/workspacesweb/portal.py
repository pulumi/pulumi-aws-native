...
class PortalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: The additional encryption context of the portal.
        ...
        :param pulumi.Input[builtins.str] browser_settings_arn: The ARN of the browser settings that is associated with this web portal.
        :param pulumi.Input[builtins.str] customer_managed_key: The customer managed key of the web portal.
               
               *Pattern* : `^arn:[\\w+=\\/,.@-]+:kms:[a-zA-Z0-9\\-]*:[a-zA-Z0-9]{1,12}:key\\/[a-zA-Z0-9-]+$`
        :param pulumi.Input[builtins.str] data_protection_settings_arn: The ARN of the data protection settings.
        :param pulumi.Input[builtins.str] display_name: The name of the web portal.
        ...
        :param pulumi.Input[builtins.str] user_settings_arn: The ARN of the user settings that is associated with the web portal.
        """
    ...
    def ip_access_settings_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ip_access_settings_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_access_settings_arn", value)

    @property
    @pulumi.getter(name="maxConcurrentSessions")
    def max_concurrent_sessions(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_concurrent_sessions(self, value: Optional[pulumi.Input[builtins.float]]):
...
class Portal(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="browserSettingsArn")
    def browser_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the browser settings that is associated with this web portal.
        """
        return pulumi.get(self, "browser_settings_arn")
    ...
    @property
    @pulumi.getter(name="dataProtectionSettingsArn")
    def data_protection_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the data protection settings.
        """
        return pulumi.get(self, "data_protection_settings_arn")
    ...
    @property
    @pulumi.getter(name="ipAccessSettingsArn")
    def ip_access_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the IP access settings that is associated with the web portal.
        """
        return pulumi.get(self, "ip_access_settings_arn")
    ...
    @property
    @pulumi.getter(name="maxConcurrentSessions")
    def max_concurrent_sessions(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The maximum number of concurrent sessions for the portal.
        """
        return pulumi.get(self, "max_concurrent_sessions")
    ...
    @property
    @pulumi.getter(name="networkSettingsArn")
    def network_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the network settings that is associated with the web portal.
        """
        return pulumi.get(self, "network_settings_arn")
    ...
    def portal_endpoint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def service_provider_saml_metadata(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="userAccessLoggingSettingsArn")
    def user_access_logging_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the user access logging settings that is associated with the web portal.
        """
        return pulumi.get(self, "user_access_logging_settings_arn")
    ...
    @property
    @pulumi.getter(name="userSettingsArn")
    def user_settings_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the user settings that is associated with the web portal.
        """
        return pulumi.get(self, "user_settings_arn")
