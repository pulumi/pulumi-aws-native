...
class PortalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] browser_settings_arn: The ARN of the browser settings that is associated with this web portal.
        :param pulumi.Input[_builtins.str] customer_managed_key: The customer managed key of the web portal.
               
               *Pattern* : `^arn:[\\w+=\\/,.@-]+:kms:[a-zA-Z0-9\\-]*:[a-zA-Z0-9]{1,12}:key\\/[a-zA-Z0-9-]+$`
        :param pulumi.Input[_builtins.str] data_protection_settings_arn: The ARN of the data protection settings.
        :param pulumi.Input[_builtins.str] display_name: The name of the web portal.
        :param pulumi.Input['PortalInstanceType'] instance_type: The type and resources of the underlying instance.
        :param pulumi.Input[_builtins.str] ip_access_settings_arn: The ARN of the IP access settings that is associated with the web portal.
        :param pulumi.Input[_builtins.float] max_concurrent_sessions: The maximum number of concurrent sessions for the portal.
        :param pulumi.Input[_builtins.str] network_settings_arn: The ARN of the network settings that is associated with the web portal.
        :param pulumi.Input[_builtins.str] session_logger_arn: The ARN of the session logger that is associated with the portal.
        ...
        :param pulumi.Input[_builtins.str] trust_store_arn: The ARN of the trust store that is associated with the web portal.
        :param pulumi.Input[_builtins.str] user_access_logging_settings_arn: The ARN of the user access logging settings that is associated with the web portal.
        :param pulumi.Input[_builtins.str] user_settings_arn: The ARN of the user settings that is associated with the web portal.
        """
...
class Portal(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] network_settings_arn: The ARN of the network settings that is associated with the web portal.
        :param pulumi.Input[_builtins.str] session_logger_arn: The ARN of the session logger that is associated with the portal.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags to add to the web portal. A tag is a key-value pair.
        :param pulumi.Input[_builtins.str] trust_store_arn: The ARN of the trust store that is associated with the web portal.
        :param pulumi.Input[_builtins.str] user_access_logging_settings_arn: The ARN of the user access logging settings that is associated with the web portal.
        :param pulumi.Input[_builtins.str] user_settings_arn: The ARN of the user settings that is associated with the web portal.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="browserSettingsArn")
    def browser_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the browser settings that is associated with this web portal.
        """
        return pulumi.get(self, "browser_settings_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="dataProtectionSettingsArn")
    def data_protection_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the data protection settings.
        """
        return pulumi.get(self, "data_protection_settings_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="ipAccessSettingsArn")
    def ip_access_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the IP access settings that is associated with the web portal.
        """
        return pulumi.get(self, "ip_access_settings_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="maxConcurrentSessions")
    def max_concurrent_sessions(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The maximum number of concurrent sessions for the portal.
        """
        return pulumi.get(self, "max_concurrent_sessions")
    ...
    @_builtins.property
    @pulumi.getter(name="networkSettingsArn")
    def network_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the network settings that is associated with the web portal.
        """
        return pulumi.get(self, "network_settings_arn")
    ...
    def service_provider_saml_metadata(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sessionLoggerArn")
    def session_logger_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the session logger that is associated with the portal.
        """
        return pulumi.get(self, "session_logger_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="trustStoreArn")
    def trust_store_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the trust store that is associated with the web portal.
        """
        return pulumi.get(self, "trust_store_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="userAccessLoggingSettingsArn")
    def user_access_logging_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the user access logging settings that is associated with the web portal.
        """
        return pulumi.get(self, "user_access_logging_settings_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="userSettingsArn")
    def user_settings_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of the user settings that is associated with the web portal.
        """
        return pulumi.get(self, "user_settings_arn")
