...
class BrowserSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: Additional encryption context of the browser settings.
        :param pulumi.Input[builtins.str] browser_policy: A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
        :param pulumi.Input[builtins.str] customer_managed_key: The custom managed key of the browser settings.
...
class BrowserSettings(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="browserPolicy")
    def browser_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
        """
        return pulumi.get(self, "browser_policy")
