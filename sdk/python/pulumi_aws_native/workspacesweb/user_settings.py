...
class UserSettingsArgs:
    def __init__(__self__, *,
                 ...
                 disconnect_timeout_in_minutes: Optional[pulumi.Input[builtins.float]] = None,
                 idle_disconnect_timeout_in_minutes: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: The additional encryption context of the user settings.
        ...
        :param pulumi.Input[builtins.str] customer_managed_key: The customer managed key used to encrypt sensitive information in the user settings.
        ...
        :param pulumi.Input[builtins.float] disconnect_timeout_in_minutes: The amount of time that a streaming session remains active after users disconnect.
        :param pulumi.Input[builtins.float] idle_disconnect_timeout_in_minutes: The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the disconnect timeout interval begins.
    ...
    def disconnect_timeout_in_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def disconnect_timeout_in_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "disconnect_timeout_in_minutes", value)

    @property
    @pulumi.getter(name="idleDisconnectTimeoutInMinutes")
    def idle_disconnect_timeout_in_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def idle_disconnect_timeout_in_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
...
class UserSettings(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="disconnectTimeoutInMinutes")
    def disconnect_timeout_in_minutes(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The amount of time that a streaming session remains active after users disconnect.
        """
        return pulumi.get(self, "disconnect_timeout_in_minutes")
    ...
    @property
    @pulumi.getter(name="idleDisconnectTimeoutInMinutes")
    def idle_disconnect_timeout_in_minutes(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the disconnect timeout interval begins.
        """
        return pulumi.get(self, "idle_disconnect_timeout_in_minutes")
