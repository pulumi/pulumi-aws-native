...
def get_network_settings(network_settings_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str network_settings_arn: The ARN of the network settings.
    """
    __args__ = dict()
...
def get_network_settings_output(network_settings_arn: Optional[pulumi.Input[builtins.str]] = None,
