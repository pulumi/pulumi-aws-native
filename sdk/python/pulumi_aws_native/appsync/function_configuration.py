...
class FunctionConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 request_mapping_template_s3_location: Optional[pulumi.Input[builtins.str]] = None,
                 response_mapping_template: Optional[pulumi.Input[builtins.str]] = None,
                 response_mapping_template_s3_location: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_id: The AWS AppSync GraphQL API that you want to attach using this function.
        :param pulumi.Input[builtins.str] data_source_name: The name of data source this function will attach.
        :param pulumi.Input[builtins.str] code: The resolver code that contains the request and response functions. When code is used, the runtime is required. The runtime value must be APPSYNC_JS.
        :param pulumi.Input[builtins.str] code_s3_location: The Amazon S3 endpoint (where the code is located??).
        :param pulumi.Input[builtins.str] description: The function description.
        :param pulumi.Input[builtins.str] function_version: The version of the request mapping template. Currently, only the 2018-05-29 version of the template is supported.
        :param pulumi.Input[builtins.int] max_batch_size: The maximum number of resolver request inputs that will be sent to a single AWS Lambda function in a BatchInvoke operation.
        :param pulumi.Input[builtins.str] name: The name of the function.
        :param pulumi.Input[builtins.str] request_mapping_template: The Function request mapping template. Functions support only the 2018-05-29 version of the request mapping template.
        :param pulumi.Input[builtins.str] request_mapping_template_s3_location: Describes a Sync configuration for a resolver. Contains information on which Conflict Detection, as well as Resolution strategy, should be performed when the resolver is invoked.
        :param pulumi.Input[builtins.str] response_mapping_template: The Function response mapping template.
        :param pulumi.Input[builtins.str] response_mapping_template_s3_location: The location of a response mapping template in an Amazon S3 bucket. Use this if you want to provision with a template file in Amazon S3 rather than embedding it in your CloudFormation template.
    ...
    def request_mapping_template_s3_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_mapping_template_s3_location(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def response_mapping_template_s3_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def response_mapping_template_s3_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FunctionConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="functionVersion")
    def function_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the request mapping template. Currently, only the 2018-05-29 version of the template is supported.
        """
        return pulumi.get(self, "function_version")
    ...
    @property
    @pulumi.getter(name="requestMappingTemplateS3Location")
    def request_mapping_template_s3_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes a Sync configuration for a resolver. Contains information on which Conflict Detection, as well as Resolution strategy, should be performed when the resolver is invoked.
        """
        return pulumi.get(self, "request_mapping_template_s3_location")
    ...
    @property
    @pulumi.getter(name="responseMappingTemplateS3Location")
    def response_mapping_template_s3_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The location of a response mapping template in an Amazon S3 bucket. Use this if you want to provision with a template file in Amazon S3 rather than embedding it in your CloudFormation template.
        """
        return pulumi.get(self, "response_mapping_template_s3_location")
