...
class ApiCache(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApiCachePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApiCachePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApiCacheAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApiCacheProperties']:
        """
