...
class GetFunctionConfigurationResult:
    ...
    def request_mapping_template(self) -> Optional[_builtins.str]:
        """
    ...
    def response_mapping_template(self) -> Optional[_builtins.str]:
        """
...
def get_function_configuration(function_arn: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionConfigurationResult:
    """
    An example resource schema demonstrating some basic constructs and validation rules.


    :param _builtins.str function_arn: The ARN for the function generated by the service
    """
    __args__ = dict()
