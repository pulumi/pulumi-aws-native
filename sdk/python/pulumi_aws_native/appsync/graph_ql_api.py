...
class GraphQLApi(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GraphQLApiPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GraphQLApiPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GraphQLApiAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GraphQLApiProperties']:
        """
