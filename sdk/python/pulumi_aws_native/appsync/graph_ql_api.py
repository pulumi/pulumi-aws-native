...
class GraphQlApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(lambda_authorizer_config, GraphQlApiLambdaAuthorizerConfigArgs):
            ...
            if not isinstance(log_config, GraphQlApiLogConfigArgs):
            ...
            if not isinstance(open_id_connect_config, GraphQlApiOpenIdConnectConfigArgs):
            ...
            if not isinstance(user_pool_config, GraphQlApiUserPoolConfigArgs):
