...
class SourceApiAssociationArgs:
    def __init__(__self__, *,
                 ...
                 merged_api_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 source_api_association_config: Optional[pulumi.Input['SourceApiAssociationConfigArgs']] = None,
                 source_api_identifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SourceApiAssociation resource.
        :param pulumi.Input[builtins.str] description: Description of the SourceApiAssociation.
        :param pulumi.Input[builtins.str] merged_api_identifier: Identifier of the Merged GraphQLApi to associate. It could be either GraphQLApi ApiId or ARN
        ...
        :param pulumi.Input[builtins.str] source_api_identifier: Identifier of the Source GraphQLApi to associate. It could be either GraphQLApi ApiId or ARN
        """
    ...
    def merged_api_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def merged_api_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_api_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_api_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SourceApiAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["mergedApiIdentifier", "sourceApiIdentifier"])
    ...
    def last_successful_merge_date(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="mergedApiIdentifier")
    def merged_api_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifier of the Merged GraphQLApi to associate. It could be either GraphQLApi ApiId or ARN
        """
        return pulumi.get(self, "merged_api_identifier")
    ...
    def source_api_association_status_detail(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sourceApiIdentifier")
    def source_api_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifier of the Source GraphQLApi to associate. It could be either GraphQLApi ApiId or ARN
        """
        return pulumi.get(self, "source_api_identifier")
