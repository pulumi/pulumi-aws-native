...
class ResolverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The APSYlong GraphQL API to which you want to attach this resolver.
        :param pulumi.Input[builtins.str] field_name: The GraphQL field on a type that invokes the resolver.
        :param pulumi.Input[builtins.str] type_name: The GraphQL type that invokes this resolver.
        ...
        :param pulumi.Input[builtins.str] code_s3_location: The Amazon S3 endpoint.
        :param pulumi.Input[builtins.str] data_source_name: The resolver data source name.
        :param pulumi.Input[builtins.str] kind: The resolver type.
                 +  *UNIT*: A UNIT resolver type. A UNIT resolver is the default resolver type. You can use a UNIT resolver to run a GraphQL query against a single data source.
                 +  *PIPELINE*: A PIPELINE resolver type. You can use a PIPELINE resolver to invoke a series of ``Function`` objects in a serial manner. You can use a pipeline resolver to run a GraphQL query against multiple data sources.
        :param pulumi.Input[builtins.int] max_batch_size: The maximum number of resolver request inputs that will be sent to a single LAMlong function in a ``BatchInvoke`` operation.
        ...
        :param pulumi.Input[builtins.str] request_mapping_template: The request mapping template.
                Request mapping templates are optional when using a Lambda data source. For all other data sources, a request mapping template is required.
        :param pulumi.Input[builtins.str] request_mapping_template_s3_location: The location of a request mapping template in an S3 bucket. Use this if you want to provision with a template file in S3 rather than embedding it in your CFNshort template.
        :param pulumi.Input[builtins.str] response_mapping_template: The response mapping template.
        :param pulumi.Input[builtins.str] response_mapping_template_s3_location: The location of a response mapping template in an S3 bucket. Use this if you want to provision with a template file in S3 rather than embedding it in your CFNshort template.
...
@pulumi.type_token("aws-native:appsync:Resolver")
class Resolver(pulumi.CustomResource):
    ...
    def resolver_arn(self) -> pulumi.Output[builtins.str]:
        """
