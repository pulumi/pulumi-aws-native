...
class Resolver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(caching_config, ResolverCachingConfigArgs):
            ...
            if not isinstance(pipeline_config, ResolverPipelineConfigArgs):
            ...
            if not isinstance(runtime, ResolverAppSyncRuntimeArgs):
                runtime = runtime or {}
                def _setter(key, value):
                    runtime[key] = value
                ResolverAppSyncRuntimeArgs._configure(_setter, **runtime)
            __props__.__dict__["runtime"] = runtime
            if not isinstance(sync_config, ResolverSyncConfigArgs):
