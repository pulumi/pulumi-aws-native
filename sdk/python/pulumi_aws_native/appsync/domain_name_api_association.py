...
class DomainNameApiAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The API ID.
...
@pulumi.type_token("aws-native:appsync:DomainNameApiAssociation")
class DomainNameApiAssociation(pulumi.CustomResource):
    ...
    def api_association_identifier(self) -> pulumi.Output[builtins.str]:
