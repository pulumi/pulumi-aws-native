...
class GetDomainNameApiAssociationResult:
    ...
    def api_association_identifier(self) -> Optional[builtins.str]:
...
def get_domain_name_api_association(api_association_identifier: Optional[builtins.str] = None,
...
def get_domain_name_api_association_output(api_association_identifier: Optional[pulumi.Input[builtins.str]] = None,
