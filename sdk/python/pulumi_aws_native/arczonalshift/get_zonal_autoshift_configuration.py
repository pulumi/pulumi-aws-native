...
def get_zonal_autoshift_configuration(resource_identifier: Optional[builtins.str] = None,
...
def get_zonal_autoshift_configuration_output(resource_identifier: Optional[pulumi.Input[builtins.str]] = None,
