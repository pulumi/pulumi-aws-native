...
def get_autoshift_observer_notification_status(account_id: Optional[builtins.str] = None,
...
def get_autoshift_observer_notification_status_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
