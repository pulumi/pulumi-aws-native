...
if not MYPY:
    class ZonalAutoshiftConfigurationControlConditionArgsDict(TypedDict):
        alarm_identifier: pulumi.Input[builtins.str]
        """
...
class ZonalAutoshiftConfigurationControlConditionArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] alarm_identifier: The Amazon Resource Name (ARN) for an Amazon CloudWatch alarm that you specify as a control condition for a practice run.
        :param pulumi.Input[builtins.str] type: The type of alarm specified for a practice run. You can only specify Amazon CloudWatch alarms for practice runs, so the only valid value is `CLOUDWATCH` .
        """
    ...
    def alarm_identifier(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) for an Amazon CloudWatch alarm that you specify as a control condition for a practice run.
        """
    ...
    def alarm_identifier(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ZonalAutoshiftConfigurationPracticeRunConfigurationArgsDict(TypedDict):
        ...
        """
        blocked_dates: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ZonalAutoshiftConfigurationPracticeRunConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 blocked_dates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 blocked_windows: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def blocked_dates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of one or more dates that you can specify when AWS does not start practice runs for a resource. Dates are in UTC.
    ...
    def blocked_dates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def blocked_windows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
