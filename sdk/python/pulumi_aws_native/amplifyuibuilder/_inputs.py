...
class ComponentActionParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model: The name of the data model. Use when the action performs an operation on an Amplify DataStore model.
...
class ComponentBindingPropertiesValuePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: An Amazon S3 bucket.
        :param pulumi.Input[builtins.str] default_value: The default value to assign to the property.
        :param pulumi.Input[builtins.str] field: The field to bind the data to.
        :param pulumi.Input[builtins.str] key: The storage key for an Amazon S3 bucket.
        :param pulumi.Input[builtins.str] model: An Amplify DataStore model.
        ...
        :param pulumi.Input[builtins.str] slot_name: The name of a component slot.
        :param pulumi.Input[builtins.str] user_attribute: An authenticated user attribute.
        """
...
class ComponentBindingPropertiesValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_value: The default value of the property.
        :param pulumi.Input[builtins.str] type: The property type.
        """
...
class ComponentChildArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] component_type: The type of the child component.
        :param pulumi.Input[builtins.str] name: The name of the child component.
        ...
        :param pulumi.Input[builtins.str] source_id: The unique ID of the child component in its original source system, such as Figma.
        """
...
if not MYPY:
    class ComponentConditionPropertyArgsDict(TypedDict):
        ...
        """
        operand: NotRequired[pulumi.Input[builtins.str]]
        """
        The value of the property to evaluate.
        """
        operand_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ComponentConditionPropertyArgs:
    def __init__(__self__, *,
                 ...
                 field: Optional[pulumi.Input[builtins.str]] = None,
                 operand: Optional[pulumi.Input[builtins.str]] = None,
                 operand_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] field: The name of a field. Specify this when the property is a data model.
        :param pulumi.Input[builtins.str] operand: The value of the property to evaluate.
        :param pulumi.Input[builtins.str] operand_type: The type of the property to evaluate.
        :param pulumi.Input[builtins.str] operator: The operator to use to perform the evaluation, such as `eq` to represent equals.
        :param pulumi.Input[builtins.str] property: The name of the conditional property.
    ...
    @property
    @pulumi.getter
    def operand(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of the property to evaluate.
        """
    ...
    @operand.setter
    def operand(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operand", value)

    @property
    @pulumi.getter(name="operandType")
    def operand_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the property to evaluate.
        """
    ...
    @operand_type.setter
    def operand_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComponentDataConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] model: The name of the data model to use to bind data to a component.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identifiers: A list of IDs to use to bind data to a component. Use this property to bind specifically chosen data, rather than data retrieved from a query.
...
if not MYPY:
    class ComponentEventArgsDict(TypedDict):
        ...
        """
        binding_event: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ComponentEventArgs:
    def __init__(__self__, *,
                 ...
                 binding_event: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input['ComponentActionParametersArgs']] = None):
        """
        :param pulumi.Input[builtins.str] action: The action to perform when a specific event is raised.
        :param pulumi.Input[builtins.str] binding_event: Binds an event to an action on a component. When you specify a `bindingEvent` , the event is called when the action is performed.
    ...
    def binding_event(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Binds an event to an action on a component. When you specify a `bindingEvent` , the event is called when the action is performed.
        """
    ...
    def binding_event(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ComponentFormBindingElementArgsDict(TypedDict):
        element: pulumi.Input[builtins.str]
        """
...
class ComponentFormBindingElementArgs:
    def __init__(__self__, *,
                 ...
                 property: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] element: The name of the component to retrieve a value from.
        :param pulumi.Input[builtins.str] property: The property to retrieve a value from.
        """
    ...
    @property
    @pulumi.getter
    def element(self) -> pulumi.Input[builtins.str]:
        """
        The name of the component to retrieve a value from.
        """
    ...
    @element.setter
    def element(self, value: pulumi.Input[builtins.str]):
...
class ComponentMutationActionSetStateParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] component_name: The name of the component that is being modified.
        :param pulumi.Input[builtins.str] property: The name of the component property to apply the state configuration to.
...
class ComponentPredicateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] field: The field to query.
        :param pulumi.Input[builtins.str] operand: The value to use when performing the evaluation.
        :param pulumi.Input[builtins.str] operand_type: The type of value to use when performing the evaluation.
        :param pulumi.Input[builtins.str] operator: The operator to use to perform the evaluation.
...
class ComponentPropertyBindingPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 field: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] property: The component property to bind to the data field.
        :param pulumi.Input[builtins.str] field: The data field to bind the property to.
        """
        pulumi.set(__self__, "property", property)
        if field is not None:
            pulumi.set(__self__, "field", field)
...
if not MYPY:
    class ComponentPropertyArgsDict(TypedDict):
        ...
        """
        imported_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ComponentPropertyArgs:
    def __init__(__self__, *,
                 ...
                 imported_value: Optional[pulumi.Input[builtins.str]] = None,
                 model: Optional[pulumi.Input[builtins.str]] = None,
                 property: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_attribute: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] component_name: The name of the component that is affected by an event.
        ...
        :param pulumi.Input[builtins.bool] configured: Specifies whether the user configured the property in Amplify Studio after importing it.
        :param pulumi.Input[builtins.str] default_value: The default value to assign to the component property.
        :param pulumi.Input[builtins.str] event: An event that occurs in your app. Use this for workflow data binding.
        :param pulumi.Input[builtins.str] imported_value: The default value assigned to the property when the component is imported into an app.
        :param pulumi.Input[builtins.str] model: The data model to use to assign a value to the component property.
        :param pulumi.Input[builtins.str] property: The name of the component's property that is affected by an event.
        :param pulumi.Input[builtins.str] type: The component type.
        :param pulumi.Input[builtins.str] user_attribute: An authenticated user attribute to use to assign a value to the component property.
        :param pulumi.Input[builtins.str] value: The value to assign to the component property.
        """
        if binding_properties is not None:
            pulumi.set(__self__, "binding_properties", binding_properties)
    ...
    def imported_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default value assigned to the property when the component is imported into an app.
        """
    ...
    def imported_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComponentSortPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] field: The field to perform the sort on.
        """
...
if not MYPY:
    class ComponentVariantArgsDict(TypedDict):
        ...
        """
        variant_values: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ComponentVariantArgs:
    def __init__(__self__, *,
                 ...
                 variant_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variant_values: The combination of variants that comprise this variant.
        """
    ...
    def variant_values(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The combination of variants that comprise this variant.
        """
    ...
    def variant_values(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "variant_values", value)


if not MYPY:
    class FormButtonArgsDict(TypedDict):
        children: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FormButtonArgs:
    def __init__(__self__, *,
                 children: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] children: Describes the button's properties.
        :param pulumi.Input[builtins.bool] excluded: Specifies whether the button is visible on the form.
    ...
    @property
    @pulumi.getter
    def children(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Describes the button's properties.
        """
        return pulumi.get(self, "children")
    ...
    @children.setter
    def children(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "children", value)
...
if not MYPY:
    class FormDataTypeConfigArgsDict(TypedDict):
        ...
        """
        data_type_name: pulumi.Input[builtins.str]
        """
...
class FormDataTypeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_type_name: The unique name of the data type you are using as the data source for the form.
        """
    ...
    def data_type_name(self) -> pulumi.Input[builtins.str]:
        """
        The unique name of the data type you are using as the data source for the form.
        """
    ...
    def data_type_name(self, value: pulumi.Input[builtins.str]):
...
class FormFieldConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] excluded: Specifies whether to hide a field.
        ...
        :param pulumi.Input[builtins.str] label: The label for the field.
...
if not MYPY:
    class FormFieldInputConfigArgsDict(TypedDict):
        ...
        """
        default_checked: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether a field has a default value.
        """
        default_country_code: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        descriptive_text: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        placeholder: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        step: NotRequired[pulumi.Input[builtins.float]]
        """
...
class FormFieldInputConfigArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 default_checked: Optional[pulumi.Input[builtins.bool]] = None,
                 default_country_code: Optional[pulumi.Input[builtins.str]] = None,
                 default_value: Optional[pulumi.Input[builtins.str]] = None,
                 descriptive_text: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 step: Optional[pulumi.Input[builtins.float]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None,
                 value_mappings: Optional[pulumi.Input['FormValueMappingsArgs']] = None):
        """
        :param pulumi.Input[builtins.str] type: The input type for the field.
        :param pulumi.Input[builtins.bool] default_checked: Specifies whether a field has a default value.
        :param pulumi.Input[builtins.str] default_country_code: The default country code for a phone number.
        :param pulumi.Input[builtins.str] default_value: The default value for the field.
        :param pulumi.Input[builtins.str] descriptive_text: The text to display to describe the field.
        :param pulumi.Input['FormFileUploaderFieldConfigArgs'] file_uploader_config: The configuration for the file uploader field.
        :param pulumi.Input[builtins.bool] is_array: Specifies whether to render the field as an array. This property is ignored if the `dataSourceType` for the form is a Data Store.
        :param pulumi.Input[builtins.float] max_value: The maximum value to display for the field.
        :param pulumi.Input[builtins.float] min_value: The minimum value to display for the field.
        :param pulumi.Input[builtins.str] name: The name of the field.
        :param pulumi.Input[builtins.str] placeholder: The text to display as a placeholder for the field.
        :param pulumi.Input[builtins.bool] read_only: Specifies a read only field.
        :param pulumi.Input[builtins.bool] required: Specifies a field that requires input.
        :param pulumi.Input[builtins.float] step: The stepping increment for a numeric value in a field.
        :param pulumi.Input[builtins.str] value: The value for the field.
    ...
    def default_checked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether a field has a default value.
        """
    ...
    def default_checked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "default_checked", value)

    @property
    @pulumi.getter(name="defaultCountryCode")
    def default_country_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default country code for a phone number.
        """
    ...
    def default_country_code(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def descriptive_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The text to display to describe the field.
        """
    ...
    def descriptive_text(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def step(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The stepping increment for a numeric value in a field.
        """
    ...
    @step.setter
    def step(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class FormFieldPosition1PropertiesArgsDict(TypedDict):
        right_of: pulumi.Input[builtins.str]
elif False:
...
class FormFieldPosition1PropertiesArgs:
    ...
    def right_of(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "right_of")

    @right_of.setter
    def right_of(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "right_of", value)


if not MYPY:
    class FormFieldPosition2PropertiesArgsDict(TypedDict):
        below: pulumi.Input[builtins.str]
elif False:
...
class FormFieldPosition2PropertiesArgs:
    ...
    @property
    @pulumi.getter
    def below(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "below")

    @below.setter
    def below(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FormFieldValidationConfigurationArgsDict(TypedDict):
        ...
        """
        num_values: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]
        """
        The validation to perform on a number value.
        """
        str_values: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The validation to perform on a string value.
        """
        validation_message: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FormFieldValidationConfigurationArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 num_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]] = None,
                 str_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 validation_message: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The validation to perform on an object type. ``
        :param pulumi.Input[Sequence[pulumi.Input[builtins.float]]] num_values: The validation to perform on a number value.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] str_values: The validation to perform on a string value.
        :param pulumi.Input[builtins.str] validation_message: The validation message to display.
        """
        pulumi.set(__self__, "type", type)
    ...
    def num_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]:
        """
        The validation to perform on a number value.
        """
    ...
    @num_values.setter
    def num_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]):
        pulumi.set(self, "num_values", value)

    @property
    @pulumi.getter(name="strValues")
    def str_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The validation to perform on a string value.
        """
    ...
    @str_values.setter
    def str_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "str_values", value)

    @property
    @pulumi.getter(name="validationMessage")
    def validation_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The validation message to display.
        """
    ...
    def validation_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "validation_message", value)


if not MYPY:
    class FormFileUploaderFieldConfigArgsDict(TypedDict):
        accepted_file_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        is_resumable: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        max_file_count: NotRequired[pulumi.Input[builtins.float]]
        """
        Specifies the maximum number of files that can be selected to upload. The default value is an unlimited number of files.
        """
        max_size: NotRequired[pulumi.Input[builtins.float]]
        """
        The maximum file size in bytes that the file uploader will accept. The default value is an unlimited file size.
        """
        show_thumbnails: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FormFileUploaderFieldConfigArgs:
    def __init__(__self__, *,
                 accepted_file_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 access_level: pulumi.Input['FormStorageAccessLevel'],
                 is_resumable: Optional[pulumi.Input[builtins.bool]] = None,
                 max_file_count: Optional[pulumi.Input[builtins.float]] = None,
                 max_size: Optional[pulumi.Input[builtins.float]] = None,
                 show_thumbnails: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accepted_file_types: The file types that are allowed to be uploaded by the file uploader. Provide this information in an array of strings specifying the valid file extensions.
        ...
        :param pulumi.Input[builtins.bool] is_resumable: Allows the file upload operation to be paused and resumed. The default value is `false` .
               
               When `isResumable` is set to `true` , the file uploader uses a multipart upload to break the files into chunks before upload. The progress of the upload isn't continuous, because the file uploader uploads a chunk at a time.
        :param pulumi.Input[builtins.float] max_file_count: Specifies the maximum number of files that can be selected to upload. The default value is an unlimited number of files.
        :param pulumi.Input[builtins.float] max_size: The maximum file size in bytes that the file uploader will accept. The default value is an unlimited file size.
        :param pulumi.Input[builtins.bool] show_thumbnails: Specifies whether to display or hide the image preview after selecting a file for upload. The default value is `true` to display the image preview.
        """
    ...
    def accepted_file_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The file types that are allowed to be uploaded by the file uploader. Provide this information in an array of strings specifying the valid file extensions.
        """
    ...
    def accepted_file_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def is_resumable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allows the file upload operation to be paused and resumed. The default value is `false` .
    ...
    @is_resumable.setter
    def is_resumable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_resumable", value)

    @property
    @pulumi.getter(name="maxFileCount")
    def max_file_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies the maximum number of files that can be selected to upload. The default value is an unlimited number of files.
        """
    ...
    def max_file_count(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def show_thumbnails(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to display or hide the image preview after selecting a file for upload. The default value is `true` to display the image preview.
        """
    ...
    def show_thumbnails(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FormInputValuePropertyBindingPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 field: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] property: The form property to bind to the data field.
        :param pulumi.Input[builtins.str] field: The data field to bind the property to.
        """
        pulumi.set(__self__, "property", property)
        if field is not None:
...
class FormInputValuePropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The value to assign to the input field.
        """
        if binding_properties is not None:
            pulumi.set(__self__, "binding_properties", binding_properties)
        if concat is not None:
...
if not MYPY:
    class FormSectionalElementArgsDict(TypedDict):
        ...
        """
        level: NotRequired[pulumi.Input[builtins.float]]
        """
        Specifies the size of the font for a `Heading` sectional element. Valid values are `1 | 2 | 3 | 4 | 5 | 6` .
        """
        orientation: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FormSectionalElementArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 excluded: Optional[pulumi.Input[builtins.bool]] = None,
                 level: Optional[pulumi.Input[builtins.float]] = None,
                 orientation: Optional[pulumi.Input[builtins.str]] = None,
                 position: Optional[pulumi.Input[Union['FormFieldPosition0PropertiesArgs', 'FormFieldPosition1PropertiesArgs', 'FormFieldPosition2PropertiesArgs']]] = None,
                 text: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of sectional element. Valid values are `Heading` , `Text` , and `Divider` .
        :param pulumi.Input[builtins.bool] excluded: Excludes a sectional element that was generated by default for a specified data model.
        :param pulumi.Input[builtins.float] level: Specifies the size of the font for a `Heading` sectional element. Valid values are `1 | 2 | 3 | 4 | 5 | 6` .
        :param pulumi.Input[builtins.str] orientation: Specifies the orientation for a `Divider` sectional element. Valid values are `horizontal` or `vertical` .
        ...
        :param pulumi.Input[builtins.str] text: The text for a `Text` sectional element.
        """
        pulumi.set(__self__, "type", type)
        if excluded is not None:
            pulumi.set(__self__, "excluded", excluded)
    ...
    @property
    @pulumi.getter
    def level(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies the size of the font for a `Heading` sectional element. Valid values are `1 | 2 | 3 | 4 | 5 | 6` .
        """
    ...
    @level.setter
    def level(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class FormStyleConfig0PropertiesArgsDict(TypedDict):
        token_reference: pulumi.Input[builtins.str]
elif False:
...
class FormStyleConfig0PropertiesArgs:
    ...
    def token_reference(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "token_reference")

    @token_reference.setter
    def token_reference(self, value: pulumi.Input[builtins.str]):
...
class ThemeValuesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The name of the property.
...
class ThemeValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The value of a theme property.
        """
        if children is not None:
            pulumi.set(__self__, "children", children)
        if value is not None:
