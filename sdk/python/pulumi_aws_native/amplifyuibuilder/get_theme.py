...
def get_theme(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The unique ID for the Amplify app associated with the theme.
    :param builtins.str environment_name: The name of the backend environment that is a part of the Amplify app.
    :param builtins.str id: The ID for the theme.
    """
    __args__ = dict()
...
def get_theme_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
