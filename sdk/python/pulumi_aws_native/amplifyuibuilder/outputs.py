...
class ComponentActionParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str model: The name of the data model. Use when the action performs an operation on an Amplify DataStore model.
...
class ComponentBindingPropertiesValue(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str default_value: The default value of the property.
        :param builtins.str type: The property type.
        """
...
class ComponentBindingPropertiesValueProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket: An Amazon S3 bucket.
        :param builtins.str default_value: The default value to assign to the property.
        :param builtins.str field: The field to bind the data to.
        :param builtins.str key: The storage key for an Amazon S3 bucket.
        :param builtins.str model: An Amplify DataStore model.
        :param Sequence['ComponentPredicate'] predicates: A list of predicates for binding a component's properties to data.
        :param builtins.str slot_name: The name of a component slot.
        :param builtins.str user_attribute: An authenticated user attribute.
        """
...
class ComponentChild(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component_type: The type of the child component.
        :param builtins.str name: The name of the child component.
        ...
        :param builtins.str source_id: The unique ID of the child component in its original source system, such as Figma.
        """
...
class ComponentConditionProperty(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field: Optional[builtins.str] = None,
                 operand: Optional[builtins.str] = None,
                 operand_type: Optional[builtins.str] = None,
        ...
        :param builtins.str field: The name of a field. Specify this when the property is a data model.
        :param builtins.str operand: The value of the property to evaluate.
        :param builtins.str operand_type: The type of the property to evaluate.
        :param builtins.str operator: The operator to use to perform the evaluation, such as `eq` to represent equals.
        :param builtins.str property: The name of the conditional property.
    ...
    @property
    @pulumi.getter
    def operand(self) -> Optional[builtins.str]:
        """
    ...
    def operand_type(self) -> Optional[builtins.str]:
        """
...
class ComponentDataConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str model: The name of the data model to use to bind data to a component.
        :param Sequence[builtins.str] identifiers: A list of IDs to use to bind data to a component. Use this property to bind specifically chosen data, rather than data retrieved from a query.
...
class ComponentEvent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 binding_event: Optional[builtins.str] = None,
                 parameters: Optional['outputs.ComponentActionParameters'] = None):
        """
        :param builtins.str action: The action to perform when a specific event is raised.
        :param builtins.str binding_event: Binds an event to an action on a component. When you specify a `bindingEvent` , the event is called when the action is performed.
    ...
    def binding_event(self) -> Optional[builtins.str]:
        """
...
class ComponentFormBindingElement(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str element: The name of the component to retrieve a value from.
        :param builtins.str property: The property to retrieve a value from.
        """
...
class ComponentMutationActionSetStateParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component_name: The name of the component that is being modified.
        :param builtins.str property: The name of the component property to apply the state configuration to.
...
class ComponentPredicate(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str field: The field to query.
        :param builtins.str operand: The value to use when performing the evaluation.
        :param builtins.str operand_type: The type of value to use when performing the evaluation.
        :param builtins.str operator: The operator to use to perform the evaluation.
...
class ComponentProperty(dict):
    ...
    def __init__(__self__, *,
                 ...
                 imported_value: Optional[builtins.str] = None,
                 model: Optional[builtins.str] = None,
                 property: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None,
                 user_attribute: Optional[builtins.str] = None,
        ...
        :param builtins.str component_name: The name of the component that is affected by an event.
        ...
        :param builtins.bool configured: Specifies whether the user configured the property in Amplify Studio after importing it.
        :param builtins.str default_value: The default value to assign to the component property.
        :param builtins.str event: An event that occurs in your app. Use this for workflow data binding.
        :param builtins.str imported_value: The default value assigned to the property when the component is imported into an app.
        :param builtins.str model: The data model to use to assign a value to the component property.
        :param builtins.str property: The name of the component's property that is affected by an event.
        :param builtins.str type: The component type.
        :param builtins.str user_attribute: An authenticated user attribute to use to assign a value to the component property.
        :param builtins.str value: The value to assign to the component property.
        """
        if binding_properties is not None:
            pulumi.set(__self__, "binding_properties", binding_properties)
    ...
    def imported_value(self) -> Optional[builtins.str]:
        """
...
class ComponentPropertyBindingProperties(dict):
    def __init__(__self__, *,
                 ...
                 field: Optional[builtins.str] = None):
        """
        :param builtins.str property: The component property to bind to the data field.
        :param builtins.str field: The data field to bind the property to.
        """
        pulumi.set(__self__, "property", property)
        if field is not None:
            pulumi.set(__self__, "field", field)
...
class ComponentSortProperty(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str field: The field to perform the sort on.
        """
...
class ComponentVariant(dict):
    ...
    def __init__(__self__, *,
                 ...
                 variant_values: Optional[Mapping[str, builtins.str]] = None):
        """
        ...
        :param Mapping[str, builtins.str] variant_values: The combination of variants that comprise this variant.
        """
    ...
    def variant_values(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class FormButton(dict):
    def __init__(__self__, *,
                 children: Optional[builtins.str] = None,
                 excluded: Optional[builtins.bool] = None,
                 position: Optional[Any] = None):
        """
        :param builtins.str children: Describes the button's properties.
        :param builtins.bool excluded: Specifies whether the button is visible on the form.
    ...
    @property
    @pulumi.getter
    def children(self) -> Optional[builtins.str]:
        """
...
class FormDataTypeConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str data_type_name: The unique name of the data type you are using as the data source for the form.
        """
...
class FormFieldInputConfig(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 default_checked: Optional[builtins.bool] = None,
                 default_country_code: Optional[builtins.str] = None,
                 default_value: Optional[builtins.str] = None,
                 descriptive_text: Optional[builtins.str] = None,
                 ...
                 placeholder: Optional[builtins.str] = None,
                 read_only: Optional[builtins.bool] = None,
                 required: Optional[builtins.bool] = None,
                 step: Optional[builtins.float] = None,
                 value: Optional[builtins.str] = None,
                 value_mappings: Optional['outputs.FormValueMappings'] = None):
        """
        :param builtins.str type: The input type for the field.
        :param builtins.bool default_checked: Specifies whether a field has a default value.
        :param builtins.str default_country_code: The default country code for a phone number.
        :param builtins.str default_value: The default value for the field.
        :param builtins.str descriptive_text: The text to display to describe the field.
        :param 'FormFileUploaderFieldConfig' file_uploader_config: The configuration for the file uploader field.
        :param builtins.bool is_array: Specifies whether to render the field as an array. This property is ignored if the `dataSourceType` for the form is a Data Store.
        :param builtins.float max_value: The maximum value to display for the field.
        :param builtins.float min_value: The minimum value to display for the field.
        :param builtins.str name: The name of the field.
        :param builtins.str placeholder: The text to display as a placeholder for the field.
        :param builtins.bool read_only: Specifies a read only field.
        :param builtins.bool required: Specifies a field that requires input.
        :param builtins.float step: The stepping increment for a numeric value in a field.
        :param builtins.str value: The value for the field.
    ...
    def default_checked(self) -> Optional[builtins.bool]:
        """
    ...
    def default_country_code(self) -> Optional[builtins.str]:
        """
    ...
    def descriptive_text(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def placeholder(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def step(self) -> Optional[builtins.float]:
        """
...
class FormFieldValidationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 num_values: Optional[Sequence[builtins.float]] = None,
                 str_values: Optional[Sequence[builtins.str]] = None,
                 validation_message: Optional[builtins.str] = None):
        """
        :param builtins.str type: The validation to perform on an object type. ``
        :param Sequence[builtins.float] num_values: The validation to perform on a number value.
        :param Sequence[builtins.str] str_values: The validation to perform on a string value.
        :param builtins.str validation_message: The validation message to display.
        """
        pulumi.set(__self__, "type", type)
    ...
    def num_values(self) -> Optional[Sequence[builtins.float]]:
        """
    ...
    def str_values(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def validation_message(self) -> Optional[builtins.str]:
        """
...
class FormFileUploaderFieldConfig(dict):
    ...
    def __init__(__self__, *,
                 accepted_file_types: Sequence[builtins.str],
                 access_level: 'FormStorageAccessLevel',
                 is_resumable: Optional[builtins.bool] = None,
                 max_file_count: Optional[builtins.float] = None,
                 max_size: Optional[builtins.float] = None,
                 show_thumbnails: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] accepted_file_types: The file types that are allowed to be uploaded by the file uploader. Provide this information in an array of strings specifying the valid file extensions.
        ...
        :param builtins.bool is_resumable: Allows the file upload operation to be paused and resumed. The default value is `false` .
        ...
        :param builtins.float max_file_count: Specifies the maximum number of files that can be selected to upload. The default value is an unlimited number of files.
        :param builtins.float max_size: The maximum file size in bytes that the file uploader will accept. The default value is an unlimited file size.
        :param builtins.bool show_thumbnails: Specifies whether to display or hide the image preview after selecting a file for upload. The default value is `true` to display the image preview.
        """
    ...
    def accepted_file_types(self) -> Sequence[builtins.str]:
        """
    ...
    def is_resumable(self) -> Optional[builtins.bool]:
        """
    ...
    def max_file_count(self) -> Optional[builtins.float]:
        """
    ...
    def max_size(self) -> Optional[builtins.float]:
        """
    ...
    def show_thumbnails(self) -> Optional[builtins.bool]:
        """
...
class FormInputValueProperty(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: The value to assign to the input field.
        """
        if binding_properties is not None:
            pulumi.set(__self__, "binding_properties", binding_properties)
        if concat is not None:
...
class FormInputValuePropertyBindingProperties(dict):
    def __init__(__self__, *,
                 ...
                 field: Optional[builtins.str] = None):
        """
        :param builtins.str property: The form property to bind to the data field.
        :param builtins.str field: The data field to bind the property to.
        """
        pulumi.set(__self__, "property", property)
        if field is not None:
...
class FormSectionalElement(dict):
    def __init__(__self__, *,
                 ...
                 orientation: Optional[builtins.str] = None,
                 position: Optional[Any] = None,
                 text: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of sectional element. Valid values are `Heading` , `Text` , and `Divider` .
        :param builtins.bool excluded: Excludes a sectional element that was generated by default for a specified data model.
        :param builtins.float level: Specifies the size of the font for a `Heading` sectional element. Valid values are `1 | 2 | 3 | 4 | 5 | 6` .
        :param builtins.str orientation: Specifies the orientation for a `Divider` sectional element. Valid values are `horizontal` or `vertical` .
        ...
        :param builtins.str text: The text for a `Text` sectional element.
        """
        pulumi.set(__self__, "type", type)
        if excluded is not None:
            pulumi.set(__self__, "excluded", excluded)
    ...
    @property
    @pulumi.getter
    def orientation(self) -> Optional[builtins.str]:
        """
...
class ThemeValue(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str value: The value of a theme property.
        """
        if children is not None:
            pulumi.set(__self__, "children", children)
        if value is not None:
...
class ThemeValues(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The name of the property.
