...
def get_form(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The unique ID of the Amplify app associated with the form.
    :param builtins.str environment_name: The name of the backend environment that is a part of the Amplify app.
    :param builtins.str id: The ID for the form.
    """
    __args__ = dict()
...
def get_form_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
