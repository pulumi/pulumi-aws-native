...
class Component(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(binding_properties, ComponentBindingPropertiesArgs):
            ...
            if not isinstance(collection_properties, ComponentCollectionPropertiesArgs):
            ...
            if not isinstance(events, ComponentEventsArgs):
                events = events or {}
                def _setter(key, value):
                    events[key] = value
            ...
            if not isinstance(overrides, ComponentOverridesArgs):
            ...
            if not isinstance(properties, ComponentPropertiesArgs):
            ...
            if not isinstance(tags, ComponentTagsArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
