...
class FormArgs:
    ...
    def _configure(
        ...
        _setter("sectional_elements", sectional_elements)
        _setter("style", style)
        ...
        if label_decorator is not None:
            _setter("label_decorator", label_decorator)
        if name is not None:
            _setter("name", name)
        if tags is not None:
            _setter("tags", tags)
...
class Form(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            FormArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cta, FormCtaArgs):
                cta = cta or {}
                def _setter(key, value):
                    cta[key] = value
                FormCtaArgs._configure(_setter, **cta)
            __props__.__dict__["cta"] = cta
            if not isinstance(data_type, FormDataTypeConfigArgs):
            ...
            if not isinstance(fields, FormFieldsMapArgs):
                fields = fields or {}
                def _setter(key, value):
                    fields[key] = value
            ...
            if not isinstance(sectional_elements, FormSectionalElementMapArgs):
            ...
            if not isinstance(style, FormStyleArgs):
                style = style or {}
                def _setter(key, value):
                    style[key] = value
            ...
            if not isinstance(tags, FormTagsArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
