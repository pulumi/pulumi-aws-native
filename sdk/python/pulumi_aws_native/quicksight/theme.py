...
class ThemeArgs:
    def __init__(__self__, *,
                 ...
                 base_theme_id: pulumi.Input[builtins.str],
                 configuration: pulumi.Input['ThemeConfigurationArgs'],
                 theme_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The ID of the AWS account where you want to store the new theme.
        :param pulumi.Input[builtins.str] base_theme_id: The ID of the theme that a custom theme will inherit from. All themes inherit from one of the starting themes defined by Amazon Quick Sight. For a list of the starting themes, use `ListThemes` or choose *Themes* from within an analysis.
        ...
        :param pulumi.Input[builtins.str] theme_id: An ID for the theme that you want to create. The theme ID is unique per AWS Region in each AWS account.
        :param pulumi.Input[builtins.str] name: A display name for the theme.
        ...
        :param pulumi.Input[builtins.str] version_description: A description of the first version of the theme that you're creating. Every time `UpdateTheme` is called, a new version is created. Each version of the theme has a description of the version in the `VersionDescription` field.
        """
    ...
    def base_theme_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def base_theme_id(self, value: pulumi.Input[builtins.str]):
    ...
    def theme_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @theme_id.setter
    def theme_id(self, value: pulumi.Input[builtins.str]):
...
class Theme(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 base_theme_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="baseThemeId")
    def base_theme_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the theme that a custom theme will inherit from. All themes inherit from one of the starting themes defined by Amazon Quick Sight. For a list of the starting themes, use `ListThemes` or choose *Themes* from within an analysis.
        """
        return pulumi.get(self, "base_theme_id")
