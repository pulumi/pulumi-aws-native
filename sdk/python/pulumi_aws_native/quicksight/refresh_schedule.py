...
class RefreshScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The AWS account ID of the account that you are creating a schedule in.
        :param pulumi.Input[builtins.str] data_set_id: The ID of the dataset that you are creating a refresh schedule for.
...
@pulumi.type_token("aws-native:quicksight:RefreshSchedule")
class RefreshSchedule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataSetId")
    def data_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the dataset that you are creating a refresh schedule for.
        """
        return pulumi.get(self, "data_set_id")
