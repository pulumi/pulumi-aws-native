...
class TemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The ID for the AWS account that the group is in. You use the ID for the AWS account that contains your Amazon Quick Sight account.
        :param pulumi.Input[builtins.str] template_id: An ID for the template that you want to create. This template is unique per AWS Region ; in each AWS account.
        :param pulumi.Input[builtins.str] name: A display name for the template.
