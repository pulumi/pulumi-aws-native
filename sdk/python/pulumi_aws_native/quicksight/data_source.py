...
class DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_source_id: An ID for the data source. This ID is unique per AWS Region for each AWS account.
        ...
        :param pulumi.Input[builtins.str] name: A display name for the data source.
...
class DataSource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataSourceId")
    def data_source_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An ID for the data source. This ID is unique per AWS Region for each AWS account.
        """
        return pulumi.get(self, "data_source_id")
