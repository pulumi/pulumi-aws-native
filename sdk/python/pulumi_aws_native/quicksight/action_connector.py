...
class ActionConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 authentication_config: pulumi.Input[Optional[Union['ActionConnectorAuthConfigArgs', 'ActionConnectorAuthConfigArgsDict', 'outputs.ActionConnectorAuthConfig']]] = None,
                 aws_account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 permissions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ActionConnectorResourcePermissionArgs', 'ActionConnectorResourcePermissionArgsDict', 'outputs.ActionConnectorResourcePermission']]]]] = None,
