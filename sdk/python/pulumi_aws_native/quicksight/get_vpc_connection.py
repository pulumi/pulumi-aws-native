...
class GetVpcConnectionResult:
    ...
    def dns_resolvers(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_vpc_connection(aws_account_id: Optional[_builtins.str] = None,
                       vpc_connection_id: Optional[_builtins.str] = None,
