...
class GetVpcConnectionResult:
    ...
    def dns_resolvers(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_vpc_connection(aws_account_id: Optional[builtins.str] = None,
                       vpc_connection_id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpcConnectionResult:
    """
    Definition of the AWS::QuickSight::VPCConnection Resource Type.


    :param builtins.str aws_account_id: The AWS account ID of the account where you want to create a new VPC connection.
    :param builtins.str vpc_connection_id: The ID of the VPC connection that you're creating. This ID is a unique identifier for each AWS Region in an AWS account.
    """
    __args__ = dict()
...
def get_vpc_connection_output(aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
