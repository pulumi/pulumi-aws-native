...
class DataSetArgs:
    ...
    def _configure(
        ...
        if data_set_refresh_properties is not None:
            _setter("data_set_refresh_properties", data_set_refresh_properties)
        ...
        if ingestion_wait_policy is not None:
            _setter("ingestion_wait_policy", ingestion_wait_policy)
        if logical_table_map is not None:
            _setter("logical_table_map", logical_table_map)
        if name is not None:
            _setter("name", name)
        if permissions is not None:
            _setter("permissions", permissions)
        if physical_table_map is not None:
            _setter("physical_table_map", physical_table_map)
...
class DataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(data_set_refresh_properties, DataSetRefreshPropertiesArgs):
            ...
            if not isinstance(data_set_usage_configuration, DataSetUsageConfigurationArgs):
            ...
            if not isinstance(field_folders, DataSetFieldFolderMapArgs):
            ...
            if not isinstance(ingestion_wait_policy, DataSetIngestionWaitPolicyArgs):
            ...
            if not isinstance(logical_table_map, DataSetLogicalTableMapArgs):
            ...
            if not isinstance(physical_table_map, DataSetPhysicalTableMapArgs):
            ...
            if not isinstance(row_level_permission_data_set, DataSetRowLevelPermissionDataSetArgs):
            ...
            if not isinstance(row_level_permission_tag_configuration, DataSetRowLevelPermissionTagConfigurationArgs):
