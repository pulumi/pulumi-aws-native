...
class DashboardArgs:
    def __init__(__self__, *,
                 ...
                 link_entities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The ID of the AWS account where you want to create the dashboard.
        :param pulumi.Input[builtins.str] dashboard_id: The ID for the dashboard, also added to the IAM policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] link_entities: A list of analysis Amazon Resource Names (ARNs) to be linked to the dashboard.
        ...
        :param pulumi.Input[builtins.str] name: The display name of the dashboard.
        ...
        :param pulumi.Input[builtins.str] theme_arn: The Amazon Resource Name (ARN) of the theme that is being used for this dashboard. If you add a value for this field, it overrides the value that is used in the source entity. The theme ARN must exist in the same AWS account where you create the dashboard.
        ...
        :param pulumi.Input[builtins.str] version_description: A description for the first version of the dashboard being created.
        """
    ...
    def link_entities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def link_entities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Dashboard(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="linkEntities")
    def link_entities(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of analysis Amazon Resource Names (ARNs) to be linked to the dashboard.
        """
        return pulumi.get(self, "link_entities")
