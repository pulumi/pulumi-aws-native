...
class Analysis(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(definition, AnalysisDefinitionArgs):
            ...
            if not isinstance(parameters, AnalysisParametersArgs):
            ...
            if not isinstance(source_entity, AnalysisSourceEntityArgs):
