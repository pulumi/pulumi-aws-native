...
class GetThemeResult:
    ...
    def base_theme_id(self) -> Optional[builtins.str]:
        """
...
def get_theme(aws_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str aws_account_id: The ID of the AWS account where you want to store the new theme.
    :param builtins.str theme_id: An ID for the theme that you want to create. The theme ID is unique per AWS Region in each AWS account.
    """
    __args__ = dict()
...
def get_theme_output(aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
