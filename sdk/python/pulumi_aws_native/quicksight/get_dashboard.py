...
class GetDashboardResult:
    ...
    def last_published_time(self) -> Optional[_builtins.str]:
        """
    ...
    def link_entities(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_dashboard(aws_account_id: Optional[_builtins.str] = None,
