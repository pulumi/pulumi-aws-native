...
class GetDashboardResult:
    ...
    def last_published_time(self) -> Optional[builtins.str]:
        """
    ...
    def link_entities(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_dashboard(aws_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str aws_account_id: The ID of the AWS account where you want to create the dashboard.
    :param builtins.str dashboard_id: The ID for the dashboard, also added to the IAM policy.
    """
    __args__ = dict()
...
def get_dashboard_output(aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
