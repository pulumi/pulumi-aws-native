...
def get_template(aws_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str aws_account_id: The ID for the AWS account that the group is in. You use the ID for the AWS account that contains your Amazon Quick Sight account.
    :param builtins.str template_id: An ID for the template that you want to create. This template is unique per AWS Region ; in each AWS account.
    """
    __args__ = dict()
...
def get_template_output(aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
