...
class GetDataSetResult:
    ...
    def consumed_spice_capacity_in_bytes(self) -> Optional[builtins.float]:
        """
...
def get_data_set(aws_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str aws_account_id: The AWS account ID.
    :param builtins.str data_set_id: An ID for the dataset that you want to create. This ID is unique per AWS Region for each AWS account.
    """
    __args__ = dict()
...
def get_data_set_output(aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
