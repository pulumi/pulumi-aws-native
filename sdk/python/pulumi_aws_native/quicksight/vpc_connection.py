...
class VpcConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The AWS account ID of the account where you want to create a new VPC connection.
        ...
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM role associated with the VPC connection.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The Amazon EC2 security group IDs associated with the VPC connection.
        ...
        :param pulumi.Input[builtins.str] vpc_connection_id: The ID of the VPC connection that you're creating. This ID is a unique identifier for each AWS Region in an AWS account.
        """
...
class VpcConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcConnectionId")
    def vpc_connection_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the VPC connection that you're creating. This ID is a unique identifier for each AWS Region in an AWS account.
        """
        return pulumi.get(self, "vpc_connection_id")
