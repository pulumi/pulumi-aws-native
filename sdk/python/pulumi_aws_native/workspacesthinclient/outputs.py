...
class EnvironmentMaintenanceWindow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 end_time_hour: Optional[_builtins.int] = None,
                 end_time_minute: Optional[_builtins.int] = None,
                 start_time_hour: Optional[_builtins.int] = None,
                 start_time_minute: Optional[_builtins.int] = None):
        """
        ...
        :param _builtins.int end_time_hour: The hour end time of maintenance window.
        :param _builtins.int end_time_minute: The minute end time of maintenance window.
        :param _builtins.int start_time_hour: The hour start time of maintenance window.
        :param _builtins.int start_time_minute: The minute start time of maintenance window.
        """
    ...
    def end_time_hour(self) -> Optional[_builtins.int]:
        """
    ...
    def end_time_minute(self) -> Optional[_builtins.int]:
        """
    ...
    def start_time_hour(self) -> Optional[_builtins.int]:
        """
    ...
    def start_time_minute(self) -> Optional[_builtins.int]:
        """
...
class EnvironmentTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str value: The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
