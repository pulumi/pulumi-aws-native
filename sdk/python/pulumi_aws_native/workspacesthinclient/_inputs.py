...
if not MYPY:
    class EnvironmentMaintenanceWindowArgsDict(TypedDict):
        ...
        """
        end_time_hour: NotRequired[pulumi.Input[builtins.int]]
        """
        The hour end time of maintenance window.
        """
        end_time_minute: NotRequired[pulumi.Input[builtins.int]]
        """
        The minute end time of maintenance window.
        """
        start_time_hour: NotRequired[pulumi.Input[builtins.int]]
        """
        The hour start time of maintenance window.
        """
        start_time_minute: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EnvironmentMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 end_time_hour: Optional[pulumi.Input[builtins.int]] = None,
                 end_time_minute: Optional[pulumi.Input[builtins.int]] = None,
                 start_time_hour: Optional[pulumi.Input[builtins.int]] = None,
                 start_time_minute: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] end_time_hour: The hour end time of maintenance window.
        :param pulumi.Input[builtins.int] end_time_minute: The minute end time of maintenance window.
        :param pulumi.Input[builtins.int] start_time_hour: The hour start time of maintenance window.
        :param pulumi.Input[builtins.int] start_time_minute: The minute start time of maintenance window.
        """
    ...
    def end_time_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The hour end time of maintenance window.
        """
    ...
    def end_time_hour(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "end_time_hour", value)

    @property
    @pulumi.getter(name="endTimeMinute")
    def end_time_minute(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minute end time of maintenance window.
        """
    ...
    def end_time_minute(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "end_time_minute", value)

    @property
    @pulumi.getter(name="startTimeHour")
    def start_time_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The hour start time of maintenance window.
        """
    ...
    def start_time_hour(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "start_time_hour", value)

    @property
    @pulumi.getter(name="startTimeMinute")
    def start_time_minute(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minute start time of maintenance window.
        """
    ...
    def start_time_minute(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EnvironmentTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
