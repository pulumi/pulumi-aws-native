...
class EnvironmentMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] end_time_hour: The hour end time of maintenance window.
        :param pulumi.Input[_builtins.int] end_time_minute: The minute end time of maintenance window.
        :param pulumi.Input[_builtins.int] start_time_hour: The hour start time of maintenance window.
        :param pulumi.Input[_builtins.int] start_time_minute: The minute start time of maintenance window.
        """
...
class EnvironmentTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
