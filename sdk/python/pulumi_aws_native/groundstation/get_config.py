...
def get_config(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The ARN of the config, such as `arn:aws:groundstation:us-east-2:1234567890:config/tracking/9940bf3b-d2ba-427e-9906-842b5e5d2296` .
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_config_output(arn: Optional[pulumi.Input[builtins.str]] = None,
