...
class ScalingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(predictive_scaling_configuration, ScalingPolicyPredictiveScalingConfigurationArgs):
            ...
            if not isinstance(target_tracking_configuration, ScalingPolicyTargetTrackingConfigurationArgs):
