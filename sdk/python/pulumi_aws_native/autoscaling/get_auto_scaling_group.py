...
class GetAutoScalingGroupResult:
    ...
    @property
    @pulumi.getter
    def cooldown(self) -> Optional[builtins.str]:
        """
    ...
    def default_instance_warmup(self) -> Optional[builtins.int]:
        """
    ...
    def desired_capacity_type(self) -> Optional[builtins.str]:
        """
    ...
    def health_check_grace_period(self) -> Optional[builtins.int]:
        """
    ...
    def launch_configuration_name(self) -> Optional[builtins.str]:
        """
    ...
    def max_instance_lifetime(self) -> Optional[builtins.int]:
        """
    ...
    def new_instances_protected_from_scale_in(self) -> Optional[builtins.bool]:
        """
    ...
    def service_linked_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def termination_policies(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def vpc_zone_identifier(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_auto_scaling_group(auto_scaling_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str auto_scaling_group_name: The name of the Auto Scaling group. This name must be unique per Region per account.
...
def get_auto_scaling_group_output(auto_scaling_group_name: Optional[pulumi.Input[builtins.str]] = None,
