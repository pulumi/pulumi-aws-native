...
class AutoScalingGroupBaselinePerformanceFactorsRequestArgsDict(TypedDict):
    ...
    """
    cpu: NotRequired[pulumi.Input[Optional['AutoScalingGroupCpuPerformanceFactorRequestArgs']]]
    """
...
class AutoScalingGroupCapacityReservationSpecificationArgsDict(TypedDict):
    ...
    """
    capacity_reservation_target: NotRequired[pulumi.Input[Optional['AutoScalingGroupCapacityReservationTargetArgs']]]
    """
...
class AutoScalingGroupCpuPerformanceFactorRequestArgsDict(TypedDict):
    ...
    The CPU performance to consider, using an instance family as the baseline reference.
    """
    references: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutoScalingGroupPerformanceFactorReferenceRequestArgs']]]]]
    """
...
class AutoScalingGroupInstanceLifecyclePolicyArgsDict(TypedDict):
    ...
    """
    retention_triggers: NotRequired[pulumi.Input[Optional['AutoScalingGroupRetentionTriggersArgs']]]
    """
...
class AutoScalingGroupInstanceRequirementsArgsDict(TypedDict):
    ...
    """
    accelerator_count: NotRequired[pulumi.Input[Optional['AutoScalingGroupAcceleratorCountRequestArgs']]]
    """
    ...
    """
    accelerator_total_memory_mi_b: NotRequired[pulumi.Input[Optional['AutoScalingGroupAcceleratorTotalMemoryMiBRequestArgs']]]
    """
    ...
    Indicates whether bare metal instance types are included, excluded, or required.
     Default: ``excluded``
    """
    baseline_ebs_bandwidth_mbps: NotRequired[pulumi.Input[Optional['AutoScalingGroupBaselineEbsBandwidthMbpsRequestArgs']]]
    """
    The minimum and maximum baseline bandwidth performance for an instance type, in Mbps. For more information, see [Amazon EBS–optimized instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html) in the *Amazon EC2 User Guide*.
     Default: No minimum or maximum limits
    """
    baseline_performance_factors: NotRequired[pulumi.Input[Optional['AutoScalingGroupBaselinePerformanceFactorsRequestArgs']]]
    """
    ...
    """
    memory_gi_b_per_v_cpu: NotRequired[pulumi.Input[Optional['AutoScalingGroupMemoryGiBPerVCpuRequestArgs']]]
    """
    The minimum and maximum amount of memory per vCPU for an instance type, in GiB.
     Default: No minimum or maximum limits
    """
    network_bandwidth_gbps: NotRequired[pulumi.Input[Optional['AutoScalingGroupNetworkBandwidthGbpsRequestArgs']]]
    """
    The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps).
     Default: No minimum or maximum limits
    """
    network_interface_count: NotRequired[pulumi.Input[Optional['AutoScalingGroupNetworkInterfaceCountRequestArgs']]]
    """
    ...
    [Price protection] The price protection threshold for Spot Instances, as a percentage higher than an identified Spot price. The identified Spot price is the price of the lowest priced current generation C, M, or R instance type with your specified attributes. If no current generation C, M, or R instance type matches your attributes, then the identified price is from either the lowest priced current generation instance types or, failing that, the lowest priced previous generation instance types that match your attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price exceeds your specified threshold.
     ...
     If you set ``DesiredCapacityType`` to ``vcpu`` or ``memory-mib``, the price protection threshold is based on the per-vCPU or per-memory price instead of the per instance price. 
      Only one of ``SpotMaxPricePercentageOverLowestPrice`` or ``MaxSpotPriceAsPercentageOfOptimalOnDemandPrice`` can be specified. If you don't specify either, Amazon EC2 Auto Scaling will automatically apply optimal price protection to consistently select from a wide range of instance types. To indicate no price protection threshold for Spot Instances, meaning you want to consider all instance types that match your attributes, include one of these parameters and specify a high value, such as ``999999``.
    """
    total_local_storage_gb: NotRequired[pulumi.Input[Optional['AutoScalingGroupTotalLocalStorageGbRequestArgs']]]
    """
...
class AutoScalingGroupLaunchTemplateOverridesArgsDict(TypedDict):
    ...
    """
    instance_requirements: NotRequired[pulumi.Input[Optional['AutoScalingGroupInstanceRequirementsArgs']]]
    """
    ...
    """
    launch_template_specification: NotRequired[pulumi.Input[Optional['AutoScalingGroupLaunchTemplateSpecificationArgs']]]
    """
...
class AutoScalingGroupLaunchTemplateArgsDict(TypedDict):
    ...
    The launch template.
    """
    overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutoScalingGroupLaunchTemplateOverridesArgs']]]]]
    """
...
class AutoScalingGroupMixedInstancesPolicyArgsDict(TypedDict):
    ...
    """
    instances_distribution: NotRequired[pulumi.Input[Optional['AutoScalingGroupInstancesDistributionArgs']]]
    """
...
class LaunchConfigurationBlockDeviceMappingArgsDict(TypedDict):
    ...
    """
    ebs: NotRequired[pulumi.Input[Optional['LaunchConfigurationBlockDeviceArgs']]]
    """
...
class ScalingPolicyMetricDataQueryArgsDict(TypedDict):
    ...
    """
    metric_stat: NotRequired[pulumi.Input[Optional['ScalingPolicyMetricStatArgs']]]
    """
