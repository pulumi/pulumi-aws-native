...
class GetScheduledActionResult:
    ...
    def scheduled_action_name(self) -> Optional[_builtins.str]:
        """
...
def get_scheduled_action(auto_scaling_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_action_name: Auto-generated unique identifier
    """
    __args__ = dict()
...
def get_scheduled_action_output(auto_scaling_group_name: Optional[pulumi.Input[_builtins.str]] = None,
