...
class ScheduledActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_size: The minimum size of the Auto Scaling group.
        :param pulumi.Input[_builtins.int] min_size: The minimum size of the Auto Scaling group.
        :param pulumi.Input[_builtins.str] recurrence: The recurring schedule for the action, in Unix cron syntax format. When StartTime and EndTime are specified with Recurrence , they form the boundaries of when the recurring action starts and stops.
        :param pulumi.Input[_builtins.str] start_time: The earliest scheduled start time to return. If scheduled action names are provided, this parameter is ignored.
        :param pulumi.Input[_builtins.str] time_zone: The time zone for the cron expression.
        """
