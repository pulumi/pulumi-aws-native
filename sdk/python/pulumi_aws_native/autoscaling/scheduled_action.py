...
class ScheduledAction(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ScheduledActionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ScheduledActionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ScheduledActionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ScheduledActionProperties']:
        """
