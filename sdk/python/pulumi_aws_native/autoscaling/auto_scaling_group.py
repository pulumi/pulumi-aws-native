...
class AutoScalingGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(instance_maintenance_policy, AutoScalingGroupInstanceMaintenancePolicyArgs):
            ...
            if not isinstance(launch_template, AutoScalingGroupLaunchTemplateSpecificationArgs):
            ...
            if not isinstance(mixed_instances_policy, AutoScalingGroupMixedInstancesPolicyArgs):
