...
class AutoScalingGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] max_size: The maximum size of the group.
                 With a mixed instances policy that uses instance weighting, Amazon EC2 Auto Scaling may need to go above ``MaxSize`` to meet your capacity requirements. In this event, Amazon EC2 Auto Scaling will never go above ``MaxSize`` by more than your largest instance weight (weights that define how many units each instance contributes to the desired capacity of the group).
        :param pulumi.Input[_builtins.str] min_size: The minimum size of the group.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zone_ids: The Availability Zone IDs where the Auto Scaling group can launch instances.
        ...
        :param pulumi.Input[_builtins.str] cooldown: *Only needed if you use simple scaling policies.*
                ...
                Default: ``300`` seconds
        :param pulumi.Input[_builtins.int] default_instance_warmup: The amount of time, in seconds, until a new instance is considered to have finished initializing and resource consumption to become stable after it enters the ``InService`` state.
                During an instance refresh, Amazon EC2 Auto Scaling waits for the warm-up period after it replaces an instance before it moves on to replacing the next instance. Amazon EC2 Auto Scaling also waits for the warm-up period before aggregating the metrics for new instances with existing instances in the Amazon CloudWatch metrics that are used for scaling, resulting in more reliable usage data. For more information, see [Set the default instance warmup for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-default-instance-warmup.html) in the *Amazon EC2 Auto Scaling User Guide*.
                 ...
                 Default: None
        :param pulumi.Input[_builtins.str] deletion_protection: The deletion protection setting for the Auto Scaling group.
        :param pulumi.Input[_builtins.str] desired_capacity: The desired capacity is the initial capacity of the Auto Scaling group at the time of its creation and the capacity it attempts to maintain. It can scale beyond this capacity if you configure automatic scaling.
        ...
        :param pulumi.Input[_builtins.str] desired_capacity_type: The unit of measurement for the value specified for desired capacity. Amazon EC2 Auto Scaling supports ``DesiredCapacityType`` for attribute-based instance type selection only. For more information, see [Create a mixed instances group using attribute-based instance type selection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-mixed-instances-group-attribute-based-instance-type-selection.html) in the *Amazon EC2 Auto Scaling User Guide*.
                By default, Amazon EC2 Auto Scaling specifies ``units``, which translates into number of instances.
                Valid values: ``units`` | ``vcpu`` | ``memory-mib``
        :param pulumi.Input[_builtins.int] health_check_grace_period: The amount of time, in seconds, that Amazon EC2 Auto Scaling waits before checking the health status of an EC2 instance that has come into service and marking it unhealthy due to a failed health check. This is useful if your instances do not immediately pass their health checks after they enter the ``InService`` state. For more information, see [Set the health check grace period for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/health-check-grace-period.html) in the *Amazon EC2 Auto Scaling User Guide*.
                Default: ``0`` seconds
        :param pulumi.Input[_builtins.str] health_check_type: A comma-separated value string of one or more health check types.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] load_balancer_names: A list of Classic Load Balancers associated with this Auto Scaling group. For Application Load Balancers, Network Load Balancers, and Gateway Load Balancers, specify the ``TargetGroupARNs`` property instead.
        :param pulumi.Input[_builtins.int] max_instance_lifetime: The maximum amount of time, in seconds, that an instance can be in service. The default is null. If specified, the value must be either 0 or a number equal to or greater than 86,400 seconds (1 day). For more information, see [Replace Auto Scaling instances based on maximum instance lifetime](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-max-instance-lifetime.html) in the *Amazon EC2 Auto Scaling User Guide*.
        ...
        :param pulumi.Input[_builtins.bool] new_instances_protected_from_scale_in: Indicates whether newly launched instances are protected from termination by Amazon EC2 Auto Scaling when scaling in. For more information about preventing instances from terminating on scale in, see [Use instance scale-in protection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-protection.html) in the *Amazon EC2 Auto Scaling User Guide*.
        ...
        :param pulumi.Input[_builtins.str] placement_group: The name of the placement group into which to launch your instances. For more information, see [Placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html) in the *Amazon EC2 User Guide*.
                 A *cluster* placement group is a logical grouping of instances within a single Availability Zone. You cannot specify multiple Availability Zones and a cluster placement group.
        :param pulumi.Input[_builtins.str] service_linked_role_arn: The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other AWS service on your behalf. By default, Amazon EC2 Auto Scaling uses a service-linked role named ``AWSServiceRoleForAutoScaling``, which it creates if it does not exist. For more information, see [Service-linked roles](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html) in the *Amazon EC2 Auto Scaling User Guide*.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_group_arns: The Amazon Resource Names (ARN) of the Elastic Load Balancing target groups to associate with the Auto Scaling group. Instances are registered as targets with the target groups. The target groups receive incoming traffic and route requests to one or more registered targets. For more information, see [Use Elastic Load Balancing to distribute traffic across the instances in your Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html) in the *Amazon EC2 Auto Scaling User Guide*.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vpc_zone_identifier: A list of subnet IDs for a virtual private cloud (VPC) where instances in the Auto Scaling group can be created.
    ...
    def min_size(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @min_size.setter
    def min_size(self, value: pulumi.Input[_builtins.str]):
...
class AutoScalingGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_scaling_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 availability_zone_distribution: pulumi.Input[Optional[Union['AutoScalingGroupAvailabilityZoneDistributionArgs', 'AutoScalingGroupAvailabilityZoneDistributionArgsDict', 'outputs.AutoScalingGroupAvailabilityZoneDistribution']]] = None,
                 availability_zone_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 availability_zone_impairment_policy: pulumi.Input[Optional[Union['AutoScalingGroupAvailabilityZoneImpairmentPolicyArgs', 'AutoScalingGroupAvailabilityZoneImpairmentPolicyArgsDict', 'outputs.AutoScalingGroupAvailabilityZoneImpairmentPolicy']]] = None,
                 availability_zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 capacity_rebalance: pulumi.Input[Optional[_builtins.bool]] = None,
                 capacity_reservation_specification: pulumi.Input[Optional[Union['AutoScalingGroupCapacityReservationSpecificationArgs', 'AutoScalingGroupCapacityReservationSpecificationArgsDict', 'outputs.AutoScalingGroupCapacityReservationSpecification']]] = None,
                 context: pulumi.Input[Optional[_builtins.str]] = None,
                 cooldown: pulumi.Input[Optional[_builtins.str]] = None,
                 default_instance_warmup: pulumi.Input[Optional[_builtins.int]] = None,
                 deletion_protection: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 health_check_type: pulumi.Input[Optional[_builtins.str]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 instance_lifecycle_policy: pulumi.Input[Optional[Union['AutoScalingGroupInstanceLifecyclePolicyArgs', 'AutoScalingGroupInstanceLifecyclePolicyArgsDict', 'outputs.AutoScalingGroupInstanceLifecyclePolicy']]] = None,
                 instance_maintenance_policy: pulumi.Input[Optional[Union['AutoScalingGroupInstanceMaintenancePolicyArgs', 'AutoScalingGroupInstanceMaintenancePolicyArgsDict', 'outputs.AutoScalingGroupInstanceMaintenancePolicy']]] = None,
                 launch_configuration_name: pulumi.Input[Optional[_builtins.str]] = None,
                 launch_template: pulumi.Input[Optional[Union['AutoScalingGroupLaunchTemplateSpecificationArgs', 'AutoScalingGroupLaunchTemplateSpecificationArgsDict', 'outputs.AutoScalingGroupLaunchTemplateSpecification']]] = None,
                 lifecycle_hook_specification_list: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutoScalingGroupLifecycleHookSpecificationArgs', 'AutoScalingGroupLifecycleHookSpecificationArgsDict', 'outputs.AutoScalingGroupLifecycleHookSpecification']]]]] = None,
                 load_balancer_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 max_instance_lifetime: pulumi.Input[Optional[_builtins.int]] = None,
                 max_size: pulumi.Input[Optional[_builtins.str]] = None,
                 metrics_collection: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutoScalingGroupMetricsCollectionArgs', 'AutoScalingGroupMetricsCollectionArgsDict', 'outputs.AutoScalingGroupMetricsCollection']]]]] = None,
                 min_size: pulumi.Input[Optional[_builtins.str]] = None,
                 mixed_instances_policy: pulumi.Input[Optional[Union['AutoScalingGroupMixedInstancesPolicyArgs', 'AutoScalingGroupMixedInstancesPolicyArgsDict', 'outputs.AutoScalingGroupMixedInstancesPolicy']]] = None,
                 new_instances_protected_from_scale_in: pulumi.Input[Optional[_builtins.bool]] = None,
                 notification_configuration: pulumi.Input[Optional[Union['AutoScalingGroupNotificationConfigurationArgs', 'AutoScalingGroupNotificationConfigurationArgsDict', 'outputs.AutoScalingGroupNotificationConfiguration']]] = None,
                 notification_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutoScalingGroupNotificationConfigurationArgs', 'AutoScalingGroupNotificationConfigurationArgsDict', 'outputs.AutoScalingGroupNotificationConfiguration']]]]] = None,
                 placement_group: pulumi.Input[Optional[_builtins.str]] = None,
                 service_linked_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 skip_zonal_shift_validation: pulumi.Input[Optional[_builtins.bool]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutoScalingGroupTagPropertyArgs', 'AutoScalingGroupTagPropertyArgsDict', 'outputs.AutoScalingGroupTagProperty']]]]] = None,
                 target_group_arns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 termination_policies: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 traffic_sources: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutoScalingGroupTrafficSourceIdentifierArgs', 'AutoScalingGroupTrafficSourceIdentifierArgsDict', 'outputs.AutoScalingGroupTrafficSourceIdentifier']]]]] = None,
                 vpc_zone_identifier: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] auto_scaling_group_name: The name of the Auto Scaling group. This name must be unique per Region per account.
                The name can contain any ASCII character 33 to 126 including most punctuation characters, digits, and upper and lowercased letters.
                 You cannot use a colon (:) in the name.
        :param pulumi.Input[Union['AutoScalingGroupAvailabilityZoneDistributionArgs', 'AutoScalingGroupAvailabilityZoneDistributionArgsDict', 'outputs.AutoScalingGroupAvailabilityZoneDistribution']] availability_zone_distribution: The EC2 instance capacity distribution across Availability Zones for the Auto Scaling group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zone_ids: The Availability Zone IDs where the Auto Scaling group can launch instances.
        :param pulumi.Input[Union['AutoScalingGroupAvailabilityZoneImpairmentPolicyArgs', 'AutoScalingGroupAvailabilityZoneImpairmentPolicyArgsDict', 'outputs.AutoScalingGroupAvailabilityZoneImpairmentPolicy']] availability_zone_impairment_policy: The Availability Zone impairment policy for the Auto Scaling group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] availability_zones: A list of Availability Zones where instances in the Auto Scaling group can be created. Used for launching into the default VPC subnet in each Availability Zone when not using the ``VPCZoneIdentifier`` property, or for attaching a network interface when an existing network interface ID is specified in a launch template.
        :param pulumi.Input[_builtins.bool] capacity_rebalance: Indicates whether Capacity Rebalancing is enabled. Otherwise, Capacity Rebalancing is disabled. When you turn on Capacity Rebalancing, Amazon EC2 Auto Scaling attempts to launch a Spot Instance whenever Amazon EC2 notifies that a Spot Instance is at an elevated risk of interruption. After launching a new instance, it then terminates an old instance. For more information, see [Use Capacity Rebalancing to handle Amazon EC2 Spot Interruptions](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-capacity-rebalancing.html) in the in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[Union['AutoScalingGroupCapacityReservationSpecificationArgs', 'AutoScalingGroupCapacityReservationSpecificationArgsDict', 'outputs.AutoScalingGroupCapacityReservationSpecification']] capacity_reservation_specification: The capacity reservation specification for the Auto Scaling group.
        :param pulumi.Input[_builtins.str] context: Reserved.
        :param pulumi.Input[_builtins.str] cooldown: *Only needed if you use simple scaling policies.*
                The amount of time, in seconds, between one scaling activity ending and another one starting due to simple scaling policies. For more information, see [Scaling cooldowns for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-scaling-cooldowns.html) in the *Amazon EC2 Auto Scaling User Guide*.
                Default: ``300`` seconds
        ...
        :param pulumi.Input[_builtins.str] instance_id: The ID of the instance used to base the launch configuration on. For more information, see [Create an Auto Scaling group using an EC2 instance](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-from-instance.html) in the *Amazon EC2 Auto Scaling User Guide*.
                If you specify ``LaunchTemplate``, ``MixedInstancesPolicy``, or ``LaunchConfigurationName``, don't specify ``InstanceId``.
        :param pulumi.Input[Union['AutoScalingGroupInstanceLifecyclePolicyArgs', 'AutoScalingGroupInstanceLifecyclePolicyArgsDict', 'outputs.AutoScalingGroupInstanceLifecyclePolicy']] instance_lifecycle_policy: The instance lifecycle policy for the Auto Scaling group.
        :param pulumi.Input[Union['AutoScalingGroupInstanceMaintenancePolicyArgs', 'AutoScalingGroupInstanceMaintenancePolicyArgsDict', 'outputs.AutoScalingGroupInstanceMaintenancePolicy']] instance_maintenance_policy: An instance maintenance policy. For more information, see [Set instance maintenance policy](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-maintenance-policy.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[_builtins.str] launch_configuration_name: The name of the launch configuration to use to launch instances.
                Required only if you don't specify ``LaunchTemplate``, ``MixedInstancesPolicy``, or ``InstanceId``.
        :param pulumi.Input[Union['AutoScalingGroupLaunchTemplateSpecificationArgs', 'AutoScalingGroupLaunchTemplateSpecificationArgsDict', 'outputs.AutoScalingGroupLaunchTemplateSpecification']] launch_template: Information used to specify the launch template and version to use to launch instances. You can alternatively associate a launch template to the Auto Scaling group by specifying a ``MixedInstancesPolicy``. For more information about creating launch templates, see [Create a launch template for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-launch-template.html) in the *Amazon EC2 Auto Scaling User Guide*.
                If you omit this property, you must specify ``MixedInstancesPolicy``, ``LaunchConfigurationName``, or ``InstanceId``.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingGroupLifecycleHookSpecificationArgs', 'AutoScalingGroupLifecycleHookSpecificationArgsDict', 'outputs.AutoScalingGroupLifecycleHookSpecification']]]] lifecycle_hook_specification_list: One or more lifecycle hooks to add to the Auto Scaling group before instances are launched.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] load_balancer_names: A list of Classic Load Balancers associated with this Auto Scaling group. For Application Load Balancers, Network Load Balancers, and Gateway Load Balancers, specify the ``TargetGroupARNs`` property instead.
        :param pulumi.Input[_builtins.int] max_instance_lifetime: The maximum amount of time, in seconds, that an instance can be in service. The default is null. If specified, the value must be either 0 or a number equal to or greater than 86,400 seconds (1 day). For more information, see [Replace Auto Scaling instances based on maximum instance lifetime](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-max-instance-lifetime.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[_builtins.str] max_size: The maximum size of the group.
                 With a mixed instances policy that uses instance weighting, Amazon EC2 Auto Scaling may need to go above ``MaxSize`` to meet your capacity requirements. In this event, Amazon EC2 Auto Scaling will never go above ``MaxSize`` by more than your largest instance weight (weights that define how many units each instance contributes to the desired capacity of the group).
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingGroupMetricsCollectionArgs', 'AutoScalingGroupMetricsCollectionArgsDict', 'outputs.AutoScalingGroupMetricsCollection']]]] metrics_collection: Enables the monitoring of group metrics of an Auto Scaling group. By default, these metrics are disabled.
        :param pulumi.Input[_builtins.str] min_size: The minimum size of the group.
        :param pulumi.Input[Union['AutoScalingGroupMixedInstancesPolicyArgs', 'AutoScalingGroupMixedInstancesPolicyArgsDict', 'outputs.AutoScalingGroupMixedInstancesPolicy']] mixed_instances_policy: An embedded object that specifies a mixed instances policy.
                The policy includes properties that not only define the distribution of On-Demand Instances and Spot Instances, the maximum price to pay for Spot Instances (optional), and how the Auto Scaling group allocates instance types to fulfill On-Demand and Spot capacities, but also the properties that specify the instance configuration information—the launch template and instance types. The policy can also include a weight for each instance type and different launch templates for individual instance types.
                For more information, see [Auto Scaling groups with multiple instance types and purchase options](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[_builtins.bool] new_instances_protected_from_scale_in: Indicates whether newly launched instances are protected from termination by Amazon EC2 Auto Scaling when scaling in. For more information about preventing instances from terminating on scale in, see [Use instance scale-in protection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-protection.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingGroupNotificationConfigurationArgs', 'AutoScalingGroupNotificationConfigurationArgsDict', 'outputs.AutoScalingGroupNotificationConfiguration']]]] notification_configurations: Configures an Auto Scaling group to send notifications when specified events take place.
        :param pulumi.Input[_builtins.str] placement_group: The name of the placement group into which to launch your instances. For more information, see [Placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html) in the *Amazon EC2 User Guide*.
                 A *cluster* placement group is a logical grouping of instances within a single Availability Zone. You cannot specify multiple Availability Zones and a cluster placement group.
        :param pulumi.Input[_builtins.str] service_linked_role_arn: The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other AWS service on your behalf. By default, Amazon EC2 Auto Scaling uses a service-linked role named ``AWSServiceRoleForAutoScaling``, which it creates if it does not exist. For more information, see [Service-linked roles](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingGroupTagPropertyArgs', 'AutoScalingGroupTagPropertyArgsDict', 'outputs.AutoScalingGroupTagProperty']]]] tags: One or more tags. You can tag your Auto Scaling group and propagate the tags to the Amazon EC2 instances it launches. Tags are not propagated to Amazon EBS volumes. To add tags to Amazon EBS volumes, specify the tags in a launch template but use caution. If the launch template specifies an instance tag with a key that is also specified for the Auto Scaling group, Amazon EC2 Auto Scaling overrides the value of that instance tag with the value specified by the Auto Scaling group. For more information, see [Tag Auto Scaling groups and instances](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-tagging.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_group_arns: The Amazon Resource Names (ARN) of the Elastic Load Balancing target groups to associate with the Auto Scaling group. Instances are registered as targets with the target groups. The target groups receive incoming traffic and route requests to one or more registered targets. For more information, see [Use Elastic Load Balancing to distribute traffic across the instances in your Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html) in the *Amazon EC2 Auto Scaling User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] termination_policies: A policy or a list of policies that are used to select the instance to terminate. These policies are executed in the order that you list them. For more information, see [Configure termination policies for Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-termination-policies.html) in the *Amazon EC2 Auto Scaling User Guide*.
                Valid values: ``Default`` | ``AllocationStrategy`` | ``ClosestToNextInstanceHour`` | ``NewestInstance`` | ``OldestInstance`` | ``OldestLaunchConfiguration`` | ``OldestLaunchTemplate`` | ``arn:aws:lambda:region:account-id:function:my-function:my-alias``
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingGroupTrafficSourceIdentifierArgs', 'AutoScalingGroupTrafficSourceIdentifierArgsDict', 'outputs.AutoScalingGroupTrafficSourceIdentifier']]]] traffic_sources: The traffic sources associated with this Auto Scaling group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vpc_zone_identifier: A list of subnet IDs for a virtual private cloud (VPC) where instances in the Auto Scaling group can be created.
                If this resource specifies public subnets and is also in a VPC that is defined in the same stack template, you must use the [DependsOn attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html) to declare a dependency on the [VPC-gateway attachment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpc-gateway-attachment.html).
                 When you update ``VPCZoneIdentifier``, this retains the same Auto Scaling group and replaces old instances with new ones, according to the specified subnets. To control how CloudFormation replaces the instances, add an [UpdatePolicy attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html) to your stack. Set the update policy to ``AutoScalingInstanceRefresh``. For more information, see the [AutoScalingInstanceRefresh policy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-instancerefresh).
                 Required to launch instances into a nondefault VPC. If you specify ``VPCZoneIdentifier`` with ``AvailabilityZones``, the subnets that you specify for this property must reside in those Availability Zones.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["availability_zone_ids"] = availability_zone_ids
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["availability_zone_ids"] = None
    ...
    @_builtins.property
    @pulumi.getter(name="autoScalingGroupName")
    def auto_scaling_group_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the Auto Scaling group. This name must be unique per Region per account.
         The name can contain any ASCII character 33 to 126 including most punctuation characters, digits, and upper and lowercased letters.
          You cannot use a colon (:) in the name.
    ...
    @_builtins.property
    @pulumi.getter(name="availabilityZoneIds")
    def availability_zone_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The Availability Zone IDs where the Auto Scaling group can launch instances.
        """
        return pulumi.get(self, "availability_zone_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="desiredCapacity")
    def desired_capacity(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The desired capacity is the initial capacity of the Auto Scaling group at the time of its creation and the capacity it attempts to maintain. It can scale beyond this capacity if you configure automatic scaling.
         The number must be greater than or equal to the minimum size of the group and less than or equal to the maximum size of the group. If you do not specify a desired capacity when creating the stack, the default is the minimum size of the group.
         CloudFormation marks the Auto Scaling group as successful (by setting its status to CREATE_COMPLETE) when the desired capacity is reached. However, if a maximum Spot price is set in the launch template or launch configuration that you specified, then desired capacity is not used as a criteria for success. Whether your request is fulfilled depends on Spot Instance capacity and your maximum price.
    ...
    @_builtins.property
    @pulumi.getter(name="loadBalancerNames")
    def load_balancer_names(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of Classic Load Balancers associated with this Auto Scaling group. For Application Load Balancers, Network Load Balancers, and Gateway Load Balancers, specify the ``TargetGroupARNs`` property instead.
        """
        return pulumi.get(self, "load_balancer_names")
    ...
    @_builtins.property
    @pulumi.getter(name="maxSize")
    def max_size(self) -> pulumi.Output[_builtins.str]:
        """
        The maximum size of the group.
          With a mixed instances policy that uses instance weighting, Amazon EC2 Auto Scaling may need to go above ``MaxSize`` to meet your capacity requirements. In this event, Amazon EC2 Auto Scaling will never go above ``MaxSize`` by more than your largest instance weight (weights that define how many units each instance contributes to the desired capacity of the group).
        """
    ...
    @_builtins.property
    @pulumi.getter(name="minSize")
    def min_size(self) -> pulumi.Output[_builtins.str]:
        """
        The minimum size of the group.
        """
        return pulumi.get(self, "min_size")
    ...
    @_builtins.property
    @pulumi.getter(name="newInstancesProtectedFromScaleIn")
    def new_instances_protected_from_scale_in(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates whether newly launched instances are protected from termination by Amazon EC2 Auto Scaling when scaling in. For more information about preventing instances from terminating on scale in, see [Use instance scale-in protection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-protection.html) in the *Amazon EC2 Auto Scaling User Guide*.
        """
        return pulumi.get(self, "new_instances_protected_from_scale_in")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceLinkedRoleArn")
    def service_linked_role_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call other AWS service on your behalf. By default, Amazon EC2 Auto Scaling uses a service-linked role named ``AWSServiceRoleForAutoScaling``, which it creates if it does not exist. For more information, see [Service-linked roles](https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html) in the *Amazon EC2 Auto Scaling User Guide*.
        """
        return pulumi.get(self, "service_linked_role_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="skipZonalShiftValidation")
    def skip_zonal_shift_validation(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "skip_zonal_shift_validation")
    ...
    @_builtins.property
    @pulumi.getter(name="vpcZoneIdentifier")
    def vpc_zone_identifier(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A list of subnet IDs for a virtual private cloud (VPC) where instances in the Auto Scaling group can be created.
         If this resource specifies public subnets and is also in a VPC that is defined in the same stack template, you must use the [DependsOn attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html) to declare a dependency on the [VPC-gateway attachment](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpc-gateway-attachment.html).
          When you update ``VPCZoneIdentifier``, this retains the same Auto Scaling group and replaces old instances with new ones, according to the specified subnets. To control how CloudFormation replaces the instances, add an [UpdatePolicy attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html) to your stack. Set the update policy to ``AutoScalingInstanceRefresh``. For more information, see the [AutoScalingInstanceRefresh policy](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-instancerefresh).
