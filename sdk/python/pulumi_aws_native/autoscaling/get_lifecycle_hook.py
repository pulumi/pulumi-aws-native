...
class GetLifecycleHookResult:
    ...
    def lifecycle_transition(self) -> Optional[builtins.str]:
        """
...
def get_lifecycle_hook(auto_scaling_group_name: Optional[builtins.str] = None,
                       lifecycle_hook_name: Optional[builtins.str] = None,
    ...
    :param builtins.str auto_scaling_group_name: The name of the Auto Scaling group for the lifecycle hook.
...
def get_lifecycle_hook_output(auto_scaling_group_name: Optional[pulumi.Input[builtins.str]] = None,
