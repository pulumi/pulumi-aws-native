...
class LaunchConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 classic_link_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 classic_link_vpc_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 instance_monitoring: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] image_id: Provides the unique ID of the Amazon Machine Image (AMI) that was assigned during registration.
        :param pulumi.Input[builtins.str] instance_type: Specifies the instance type of the EC2 instance.
        :param pulumi.Input[builtins.bool] associate_public_ip_address: For Auto Scaling groups that are running in a virtual private cloud (VPC), specifies whether to assign a public IP address to the group's instances.
        ...
        :param pulumi.Input[builtins.str] classic_link_vpc_id: The ID of a ClassicLink-enabled VPC to link your EC2-Classic instances to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] classic_link_vpc_security_groups: The IDs of one or more security groups for the VPC that you specified in the ClassicLinkVPCId property.
        :param pulumi.Input[builtins.bool] ebs_optimized: Specifies whether the launch configuration is optimized for EBS I/O (true) or not (false).
        :param pulumi.Input[builtins.str] iam_instance_profile: Provides the name or the Amazon Resource Name (ARN) of the instance profile associated with the IAM role for the instance. The instance profile contains the IAM role.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Amazon EC2 instance you want to use to create the launch configuration.
        :param pulumi.Input[builtins.bool] instance_monitoring: Controls whether instances in this group are launched with detailed (true) or basic (false) monitoring.
        :param pulumi.Input[builtins.str] kernel_id: Provides the ID of the kernel associated with the EC2 AMI.
        :param pulumi.Input[builtins.str] key_name: Provides the name of the EC2 key pair.
        :param pulumi.Input[builtins.str] launch_configuration_name: The name of the launch configuration. This name must be unique per Region per account.
        :param pulumi.Input['LaunchConfigurationMetadataOptionsArgs'] metadata_options: The metadata options for the instances.
        :param pulumi.Input[builtins.str] placement_tenancy: The tenancy of the instance, either default or dedicated.
        :param pulumi.Input[builtins.str] ram_disk_id: The ID of the RAM disk to select.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: A list that contains the security groups to assign to the instances in the Auto Scaling group.
        :param pulumi.Input[builtins.str] spot_price: The maximum hourly price you are willing to pay for any Spot Instances launched to fulfill the request.
        :param pulumi.Input[builtins.str] user_data: The Base64-encoded user data to make available to the launched EC2 instances.
        """
    ...
    def classic_link_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def classic_link_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "classic_link_vpc_id", value)

    @property
    @pulumi.getter(name="classicLinkVpcSecurityGroups")
    def classic_link_vpc_security_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def classic_link_vpc_security_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def instance_monitoring(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def instance_monitoring(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LaunchConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="classicLinkVpcId")
    def classic_link_vpc_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of a ClassicLink-enabled VPC to link your EC2-Classic instances to.
        """
        return pulumi.get(self, "classic_link_vpc_id")
    ...
    @property
    @pulumi.getter(name="classicLinkVpcSecurityGroups")
    def classic_link_vpc_security_groups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of one or more security groups for the VPC that you specified in the ClassicLinkVPCId property.
        """
        return pulumi.get(self, "classic_link_vpc_security_groups")
    ...
    @property
    @pulumi.getter(name="instanceMonitoring")
    def instance_monitoring(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Controls whether instances in this group are launched with detailed (true) or basic (false) monitoring.
        """
        return pulumi.get(self, "instance_monitoring")
