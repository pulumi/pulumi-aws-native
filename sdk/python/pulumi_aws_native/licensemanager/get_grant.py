...
class GetGrantResult:
    ...
    def grant_arn(self) -> Optional[builtins.str]:
        """
        Arn of the grant.
        """
...
def get_grant(grant_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGrantResult:
    """
    An example resource schema demonstrating some basic constructs and validation rules.


    :param builtins.str grant_arn: Arn of the grant.
    """
    __args__ = dict()
...
def get_grant_output(grant_arn: Optional[pulumi.Input[builtins.str]] = None,
