...
class License(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(consumption_configuration, LicenseConsumptionConfigurationArgs):
            ...
            if not isinstance(issuer, LicenseIssuerDataArgs):
                issuer = issuer or {}
                def _setter(key, value):
                    issuer[key] = value
            ...
            if not isinstance(validity, LicenseValidityDateFormatArgs):
