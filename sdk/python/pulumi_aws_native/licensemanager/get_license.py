...
class GetLicenseResult:
    ...
    @_builtins.property
    @pulumi.getter
    def beneficiary(self) -> Optional[_builtins.str]:
        """
    ...
    def license_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def license_name(self) -> Optional[_builtins.str]:
        """
...
def get_license(license_arn: Optional[_builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLicenseResult:
    """
    Resource Type definition for AWS::LicenseManager::License


    :param _builtins.str license_arn: Amazon Resource Name is a unique name for each resource.
    """
    __args__ = dict()
