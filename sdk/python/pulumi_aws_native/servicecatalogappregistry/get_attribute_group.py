...
def get_attribute_group(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAttributeGroupResult:
    """
    Resource Schema for AWS::ServiceCatalogAppRegistry::AttributeGroup.


    :param builtins.str id: The globally unique attribute group identifier of the attribute group.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_attribute_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
