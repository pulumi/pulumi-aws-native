...
class GetAttributeGroupAssociationResult:
    ...
    def attribute_group_arn(self) -> Optional[_builtins.str]:
        """
...
def get_attribute_group_association(application_arn: Optional[_builtins.str] = None,
                                    attribute_group_arn: Optional[_builtins.str] = None,
