...
class AttributeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the attribute group. 
        :param pulumi.Input[builtins.str] name: The name of the attribute group. 
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value pairs you can use to associate with the attribute group.
        """
