...
class AttributeGroupAssociationArgs:
    def __init__(__self__, *,
                 ...
                 attribute_group: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AttributeGroupAssociation resource.
        :param pulumi.Input[builtins.str] application: The name or the Id of the Application.
        :param pulumi.Input[builtins.str] attribute_group: The name or the Id of the AttributeGroup.
        """
    ...
    def attribute_group(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def attribute_group(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "attribute_group", value)


@pulumi.type_token("aws-native:servicecatalogappregistry:AttributeGroupAssociation")
class AttributeGroupAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attribute_group: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="attributeGroup")
    def attribute_group(self) -> pulumi.Output[builtins.str]:
        """
        The name or the Id of the AttributeGroup.
        """
        return pulumi.get(self, "attribute_group")
    ...
    def attribute_group_arn(self) -> pulumi.Output[builtins.str]:
        """
