...
class AttributeGroupAssociationArgs:
    ...
    def attribute_group(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def attribute_group(self, value: pulumi.Input[_builtins.str]):
...
class AttributeGroupAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attribute_group: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="attributeGroup")
    def attribute_group(self) -> pulumi.Output[_builtins.str]:
        """
        The name or the Id of the AttributeGroup.
        """
        return pulumi.get(self, "attribute_group")
    ...
    def attribute_group_arn(self) -> pulumi.Output[_builtins.str]:
        """
