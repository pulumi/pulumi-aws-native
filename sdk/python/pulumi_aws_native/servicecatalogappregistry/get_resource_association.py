...
def get_resource_association(application_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str application_arn: The Amazon resource name (ARN) that specifies the application.
    :param builtins.str resource_arn: The Amazon resource name (ARN) that specifies the resource.
...
def get_resource_association_output(application_arn: Optional[pulumi.Input[builtins.str]] = None,
