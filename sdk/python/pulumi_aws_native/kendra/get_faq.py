...
def get_faq(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The identifier for the FAQ. For example:
           
           `f61995a6-cd5c-4e99-9cfc-58816d8bfaa7`
    :param builtins.str index_id: Index ID
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_faq_output(id: Optional[pulumi.Input[builtins.str]] = None,
