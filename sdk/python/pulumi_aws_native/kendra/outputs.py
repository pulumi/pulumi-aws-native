...
class DataSourceAccessControlListConfiguration(dict):
    ...
    def __init__(__self__, *,
                 key_path: Optional[builtins.str] = None):
        """
        :param builtins.str key_path: Path to the AWS S3 bucket that contains the access control list files.
        """
    ...
    def key_path(self) -> Optional[builtins.str]:
        """
...
class DataSourceColumnConfiguration(dict):
    ...
    def __init__(__self__, *,
                 change_detecting_columns: Sequence[builtins.str],
                 document_data_column_name: builtins.str,
                 document_id_column_name: builtins.str,
                 document_title_column_name: Optional[builtins.str] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param Sequence[builtins.str] change_detecting_columns: One to five columns that indicate when a document in the database has changed.
        :param builtins.str document_data_column_name: The column that contains the contents of the document.
        :param builtins.str document_id_column_name: The column that provides the document's identifier.
        :param builtins.str document_title_column_name: The column that contains the title of the document.
    ...
    def change_detecting_columns(self) -> Sequence[builtins.str]:
        """
    ...
    def document_title_column_name(self) -> Optional[builtins.str]:
        """
...
class DataSourceConfluenceAttachmentConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_attachments: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool crawl_attachments: `TRUE` to index attachments of pages and blogs in Confluence.
        """
    ...
    def crawl_attachments(self) -> Optional[builtins.bool]:
        """
...
class DataSourceConfluenceAttachmentToIndexFieldMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 date_field_format: Optional[builtins.str] = None):
    ...
    def date_field_format(self) -> Optional[builtins.str]:
...
class DataSourceConfluenceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 inclusion_patterns: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user name and password required to connect to the Confluence instance. If you use Confluence Cloud, you use a generated API token as the password.
        ...
        :param builtins.str server_url: The URL of your Confluence instance. Use the full URL of the server. For example, *https://server.example.com:port/* . You can also use an IP address, for example, *https://192.168.1.113/* .
        ...
        :param Sequence[builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain blog posts, pages, spaces, or attachments in your Confluence. Content that matches the patterns are excluded from the index. Content that doesn't match the patterns is included in the index. If content matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the content isn't included in the index.
        :param Sequence[builtins.str] inclusion_patterns: A list of regular expression patterns to include certain blog posts, pages, spaces, or attachments in your Confluence. Content that matches the patterns are included in the index. Content that doesn't match the patterns is excluded from the index. If content matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the content isn't included in the index.
    ...
    def exclusion_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def inclusion_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceConfluenceSpaceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 crawl_archived_spaces: Optional[builtins.bool] = None,
                 crawl_personal_spaces: Optional[builtins.bool] = None,
                 exclude_spaces: Optional[Sequence[builtins.str]] = None,
                 include_spaces: Optional[Sequence[builtins.str]] = None,
                 space_field_mappings: Optional[Sequence['outputs.DataSourceConfluenceSpaceToIndexFieldMapping']] = None):
        """
        :param builtins.bool crawl_archived_spaces: `TRUE` to index archived spaces.
        :param builtins.bool crawl_personal_spaces: `TRUE` to index personal spaces. You can add restrictions to items in personal spaces. If personal spaces are indexed, queries without user context information may return restricted items from a personal space in their results. For more information, see [Filtering on user context](https://docs.aws.amazon.com/kendra/latest/dg/user-context-filter.html) .
        :param Sequence[builtins.str] exclude_spaces: A list of space keys of Confluence spaces. If you include a key, the blogs, documents, and attachments in the space are not indexed. If a space is in both the `ExcludeSpaces` and the `IncludeSpaces` list, the space is excluded.
        :param Sequence[builtins.str] include_spaces: A list of space keys for Confluence spaces. If you include a key, the blogs, documents, and attachments in the space are indexed. Spaces that aren't in the list aren't indexed. A space in the list must exist. Otherwise, Amazon Kendra logs an error when the data source is synchronized. If a space is in both the `IncludeSpaces` and the `ExcludeSpaces` list, the space is excluded.
    ...
    def crawl_archived_spaces(self) -> Optional[builtins.bool]:
        """
    ...
    def crawl_personal_spaces(self) -> Optional[builtins.bool]:
        """
    ...
    def exclude_spaces(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def include_spaces(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceConnectionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 database_port: builtins.int,
                 secret_arn: builtins.str,
                 table_name: builtins.str):
        """
        :param builtins.str database_host: The name of the host for the database. Can be either a string (host.subdomain.domain.tld) or an IPv4 or IPv6 address.
        :param builtins.str database_name: The name of the database containing the document data.
        :param builtins.int database_port: The port that the database uses for connections.
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that stores the credentials. The credentials should be a user-password pair. For more information, see [Using a Database Data Source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-database.html) . For more information about AWS Secrets Manager , see [What Is AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html) in the *AWS Secrets Manager* user guide.
        :param builtins.str table_name: The name of the table that contains the document data.
        """
    ...
    def database_port(self) -> builtins.int:
        """
...
class DataSourceCustomDocumentEnrichmentConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of an IAM role with permission to run `PreExtractionHookConfiguration` and `PostExtractionHookConfiguration` for altering document metadata and content during the document ingestion process. For more information, see [an IAM roles for Amazon Kendra](https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html) .
        """
...
class DataSourceDocumentAttributeCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition_document_attribute_key: The identifier of the document attribute used for the condition.
...
class DataSourceDocumentAttributeTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_document_attribute_value_deletion: Optional[builtins.bool] = None):
    ...
    def target_document_attribute_value_deletion(self) -> Optional[builtins.bool]:
...
class DataSourceDocumentAttributeValue(dict):
    ...
    def __init__(__self__, *,
                 date_value: Optional[builtins.str] = None,
                 long_value: Optional[builtins.int] = None,
                 string_list_value: Optional[Sequence[builtins.str]] = None,
                 string_value: Optional[builtins.str] = None):
        """
        :param builtins.str date_value: A date expressed as an ISO 8601 string.
               
               It is important for the time zone to be included in the ISO 8601 date-time format. For example, 2012-03-25T12:30:10+01:00 is the ISO 8601 date-time format for March 25th 2012 at 12:30PM (plus 10 seconds) in Central European Time.
        :param builtins.int long_value: A long integer value.
        :param Sequence[builtins.str] string_list_value: A list of strings. The default maximum length or number of strings is 10.
        :param builtins.str string_value: A string, such as "department".
        """
    ...
    def date_value(self) -> Optional[builtins.str]:
        """
    ...
    def long_value(self) -> Optional[builtins.int]:
        """
    ...
    def string_list_value(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceDocumentsMetadataConfiguration(dict):
    ...
    def __init__(__self__, *,
                 s3_prefix: Optional[builtins.str] = None):
        """
        :param builtins.str s3_prefix: A prefix used to filter metadata configuration files in the AWS S3 bucket. The S3 bucket might contain multiple metadata files. Use `S3Prefix` to include only the desired metadata files.
        """
    ...
    def s3_prefix(self) -> Optional[builtins.str]:
        """
...
class DataSourceGoogleDriveConfiguration(dict):
    ...
    def __init__(__self__, *,
                 secret_arn: builtins.str,
                 exclude_mime_types: Optional[Sequence[builtins.str]] = None,
                 exclude_shared_drives: Optional[Sequence[builtins.str]] = None,
                 exclude_user_accounts: Optional[Sequence[builtins.str]] = None,
                 exclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of a AWS Secrets Manager secret that contains the credentials required to connect to Google Drive. For more information, see [Using a Google Workspace Drive data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-google-drive.html) .
        :param Sequence[builtins.str] exclude_mime_types: A list of MIME types to exclude from the index. All documents matching the specified MIME type are excluded.
        ...
        :param Sequence[builtins.str] exclude_shared_drives: A list of identifiers or shared drives to exclude from the index. All files and folders stored on the shared drive are excluded.
        :param Sequence[builtins.str] exclude_user_accounts: A list of email addresses of the users. Documents owned by these users are excluded from the index. Documents shared with excluded users are indexed unless they are excluded in another way.
        :param Sequence[builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain items in your Google Drive, including shared drives and users' My Drives. Items that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param Sequence[builtins.str] inclusion_patterns: A list of regular expression patterns to include certain items in your Google Drive, including shared drives and users' My Drives. Items that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
    ...
    def exclude_mime_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def exclude_shared_drives(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def exclude_user_accounts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceHookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str lambda_arn: The Amazon Resource Name (ARN) of an IAM role with permission to run a Lambda function during ingestion. For more information, see [an IAM roles for Amazon Kendra](https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html) .
        :param builtins.str s3_bucket: Stores the original, raw documents or the structured, parsed documents before and after altering them. For more information, see [Data contracts for Lambda functions](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#cde-data-contracts-lambda) .
...
class DataSourceInlineCustomDocumentEnrichmentConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 document_content_deletion: Optional[builtins.bool] = None,
    ...
    def document_content_deletion(self) -> Optional[builtins.bool]:
...
class DataSourceOneDriveConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_local_groups: Optional[builtins.bool] = None,
                 exclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[builtins.str]] = None):
        """
        :param 'DataSourceOneDriveUsers' one_drive_users: A list of user accounts whose documents should be indexed.
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user name and password to connect to OneDrive. The user name should be the application ID for the OneDrive application, and the password is the application key for the OneDrive application.
        :param builtins.str tenant_domain: The Azure Active Directory domain of the organization.
        :param builtins.bool disable_local_groups: `TRUE` to disable local groups information.
        :param Sequence[builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain documents in your OneDrive. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
        ...
        :param Sequence[builtins.str] inclusion_patterns: A list of regular expression patterns to include certain documents in your OneDrive. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
    ...
    def disable_local_groups(self) -> Optional[builtins.bool]:
        """
...
class DataSourceOneDriveUsers(dict):
    ...
    def one_drive_user_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceProxyConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: The name of the website host you want to connect to via a web proxy server.
               
               For example, the host name of https://a.example.com/page1.html is "a.example.com".
        :param builtins.int port: The port number of the website host you want to connect to via a web proxy server.
               
               For example, the port for https://a.example.com/page1.html is 443, the standard port for HTTPS.
        :param builtins.str credentials: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret. You create a secret to store your credentials in [AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
...
class DataSourceS3DataSourceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        S3 data source configuration
        :param builtins.str bucket_name: The name of the bucket that contains the documents.
        ...
        :param Sequence[builtins.str] inclusion_patterns: A list of glob patterns (patterns that can expand a wildcard pattern into a list of path names that match the given pattern) for certain file names and file types to include in your index. If a document matches both an inclusion and exclusion prefix or pattern, the exclusion prefix takes precendence and the document is not indexed. Examples of glob patterns include:
               ...
               For more examples, see [Use of Exclude and Include Filters](https://docs.aws.amazon.com/cli/latest/reference/s3/#use-of-exclude-and-include-filters) in the AWS CLI Command Reference.
        :param Sequence[builtins.str] inclusion_prefixes: A list of S3 prefixes for the documents that should be included in the index.
        """
...
class DataSourceS3Path(dict):
    def __init__(__self__, *,
                 ...
                 key: builtins.str):
        """
        :param builtins.str bucket: The name of the S3 bucket that contains the file.
        :param builtins.str key: The name of the file.
        """
...
class DataSourceSalesforceChatterFeedConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 document_title_field_name: Optional[builtins.str] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 include_filter_types: Optional[Sequence['DataSourceSalesforceChatterFeedIncludeFilterType']] = None):
        """
        :param builtins.str document_data_field_name: The name of the column in the Salesforce FeedItem table that contains the content to index. Typically this is the `Body` column.
        :param builtins.str document_title_field_name: The name of the column in the Salesforce FeedItem table that contains the title of the document. This is typically the `Title` column.
    ...
    def document_title_field_name(self) -> Optional[builtins.str]:
        """
...
class DataSourceSalesforceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_attachments: Optional[builtins.bool] = None,
                 exclude_attachment_file_patterns: Optional[Sequence[builtins.str]] = None,
                 include_attachment_file_patterns: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the key/value pairs required to connect to your Salesforce instance. The secret must contain a JSON structure with the following keys:
        ...
        :param builtins.str server_url: The instance URL for the Salesforce site that you want to index.
        ...
        :param builtins.bool crawl_attachments: Indicates whether Amazon Kendra should index attachments to Salesforce objects.
        :param Sequence[builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns to exclude certain documents in your Salesforce. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
               
               The pattern is applied to the name of the attached file.
        :param Sequence[builtins.str] include_attachment_file_patterns: A list of regular expression patterns to include certain documents in your Salesforce. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
    ...
    def exclude_attachment_file_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def include_attachment_file_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceSalesforceStandardKnowledgeArticleTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param builtins.str document_data_field_name: The name of the field that contains the document data to index.
        :param builtins.str document_title_field_name: The name of the field that contains the document title.
...
class DataSourceSalesforceStandardObjectAttachmentConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param builtins.str document_title_field_name: The name of the field used for the document title.
...
class DataSourceServiceNowConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host_url: The ServiceNow instance that the data source connects to. The host endpoint should look like the following: *{instance}.service-now.com.*
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager secret that contains the user name and password required to connect to the ServiceNow instance. You can also provide OAuth authentication credentials of user name, password, client ID, and client secret. For more information, see [Using a ServiceNow data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-servicenow.html) .
...
class DataSourceServiceNowKnowledgeArticleConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_attachment_file_patterns: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str document_data_field_name: The name of the ServiceNow field that is mapped to the index document contents field in the Amazon Kendra index.
        :param builtins.bool crawl_attachments: `TRUE` to index attachments to knowledge articles.
        :param builtins.str document_title_field_name: The name of the ServiceNow field that is mapped to the index document title field.
        :param Sequence[builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns applied to exclude certain knowledge article attachments. Attachments that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param builtins.str filter_query: A query that selects the knowledge articles to index. The query can return articles from multiple knowledge bases, and the knowledge bases can be public or private.
        ...
        :param Sequence[builtins.str] include_attachment_file_patterns: A list of regular expression patterns applied to include knowledge article attachments. Attachments that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        """
        pulumi.set(__self__, "document_data_field_name", document_data_field_name)
        if crawl_attachments is not None:
            pulumi.set(__self__, "crawl_attachments", crawl_attachments)
...
class DataSourceServiceNowServiceCatalogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str document_data_field_name: The name of the ServiceNow field that is mapped to the index document contents field in the Amazon Kendra index.
        :param builtins.bool crawl_attachments: `TRUE` to index attachments to service catalog items.
        :param builtins.str document_title_field_name: The name of the ServiceNow field that is mapped to the index document title field.
        :param Sequence[builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns to exclude certain attachments of catalogs in your ServiceNow. Item that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param Sequence[builtins.str] include_attachment_file_patterns: A list of regular expression patterns to include certain attachments of catalogs in your ServiceNow. Item that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
...
class DataSourceSharePointConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_change_log: Optional[builtins.bool] = None,
                 vpc_configuration: Optional['outputs.DataSourceVpcConfiguration'] = None):
        """
        SharePoint configuration
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user name and password required to connect to the SharePoint instance. For more information, see [Microsoft SharePoint](https://docs.aws.amazon.com/kendra/latest/dg/data-source-sharepoint.html) .
        ...
        :param Sequence[builtins.str] urls: The Microsoft SharePoint site URLs for the documents you want to index.
        :param builtins.bool crawl_attachments: `TRUE` to index document attachments.
        :param builtins.bool disable_local_groups: `TRUE` to disable local groups information.
        :param builtins.str document_title_field_name: The Microsoft SharePoint attribute field that contains the title of the document.
        :param Sequence[builtins.str] exclusion_patterns: A list of regular expression patterns. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an exclusion pattern and an inclusion pattern, the document is not included in the index.
        ...
        :param Sequence[builtins.str] inclusion_patterns: A list of regular expression patterns to include certain documents in your SharePoint. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
        ...
        :param builtins.bool use_change_log: `TRUE` to use the SharePoint change log to determine which documents require updating in the index. Depending on the change log's size, it may take longer for Amazon Kendra to use the change log than to scan all of your documents in SharePoint.
        :param 'DataSourceVpcConfiguration' vpc_configuration: Provides information for connecting to an Amazon VPC.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
    ...
    def use_change_log(self) -> Optional[builtins.bool]:
        """
...
class DataSourceVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: A list of identifiers of security groups within your Amazon VPC. The security groups should enable Amazon Kendra to connect to the data source.
        :param Sequence[builtins.str] subnet_ids: A list of identifiers for subnets within your Amazon VPC. The subnets should be able to connect to each other in the VPC, and they should have outgoing access to the Internet through a NAT device.
        """
...
class DataSourceWebCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_depth: Optional[builtins.int] = None,
                 max_content_size_per_page_in_mega_bytes: Optional[builtins.float] = None,
                 max_links_per_page: Optional[builtins.int] = None,
                 max_urls_per_minute_crawl_rate: Optional[builtins.int] = None,
                 proxy_configuration: Optional['outputs.DataSourceProxyConfiguration'] = None,
                 url_exclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 url_inclusion_patterns: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param builtins.int crawl_depth: The 'depth' or number of levels from the seed level to crawl. For example, the seed URL page is depth 1 and any hyperlinks on this page that are also crawled are depth 2.
        :param builtins.float max_content_size_per_page_in_mega_bytes: The maximum size (in MB) of a web page or attachment to crawl.
               
               Files larger than this size (in MB) are skipped/not crawled.
               
               The default maximum size of a web page or attachment is set to 50 MB.
        :param builtins.int max_links_per_page: The maximum number of URLs on a web page to include when crawling a website. This number is per web page.
               
               As a website’s web pages are crawled, any URLs the web pages link to are also crawled. URLs on a web page are crawled in order of appearance.
               
               The default maximum links per page is 100.
        :param builtins.int max_urls_per_minute_crawl_rate: The maximum number of URLs crawled per website host per minute.
        ...
        :param Sequence[builtins.str] url_exclusion_patterns: A list of regular expression patterns to exclude certain URLs to crawl. URLs that match the patterns are excluded from the index. URLs that don't match the patterns are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index.
        :param Sequence[builtins.str] url_inclusion_patterns: A list of regular expression patterns to include certain URLs to crawl. URLs that match the patterns are included in the index. URLs that don't match the patterns are excluded from the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index.
        """
        pulumi.set(__self__, "urls", urls)
    ...
    def crawl_depth(self) -> Optional[builtins.int]:
        """
    ...
    def max_content_size_per_page_in_mega_bytes(self) -> Optional[builtins.float]:
        """
    ...
    def max_links_per_page(self) -> Optional[builtins.int]:
        """
    ...
    def max_urls_per_minute_crawl_rate(self) -> Optional[builtins.int]:
        """
    ...
    def url_exclusion_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def url_inclusion_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataSourceWebCrawlerSeedUrlConfiguration(dict):
    ...
    def __init__(__self__, *,
                 seed_urls: Sequence[builtins.str],
                 web_crawler_mode: Optional['DataSourceWebCrawlerSeedUrlConfigurationWebCrawlerMode'] = None):
        """
        :param Sequence[builtins.str] seed_urls: The list of seed or starting point URLs of the websites you want to crawl.
    ...
    def seed_urls(self) -> Sequence[builtins.str]:
        """
...
class DataSourceWebCrawlerSiteMapsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 site_maps: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] site_maps: The list of sitemap URLs of the websites you want to crawl.
    ...
    def site_maps(self) -> Sequence[builtins.str]:
        """
...
class DataSourceWorkDocsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_comments: Optional[builtins.bool] = None,
                 exclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[builtins.str]] = None,
                 use_change_log: Optional[builtins.bool] = None):
        """
        :param builtins.str organization_id: The identifier of the directory corresponding to your Amazon WorkDocs site repository.
        ...
        :param builtins.bool crawl_comments: `TRUE` to include comments on documents in your index. Including comments in your index means each comment is a document that can be searched on.
               
               The default is set to `FALSE` .
        :param Sequence[builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain files in your Amazon WorkDocs site repository. Files that match the patterns are excluded from the index. Files that don’t match the patterns are included in the index. If a file matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the file isn't included in the index.
        ...
        :param Sequence[builtins.str] inclusion_patterns: A list of regular expression patterns to include certain files in your Amazon WorkDocs site repository. Files that match the patterns are included in the index. Files that don't match the patterns are excluded from the index. If a file matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the file isn't included in the index.
        :param builtins.bool use_change_log: `TRUE` to use the Amazon WorkDocs change log to determine which documents require updating in the index. Depending on the change log's size, it may take longer for Amazon Kendra to use the change log than to scan all of your documents in Amazon WorkDocs.
        """
    ...
    def crawl_comments(self) -> Optional[builtins.bool]:
        """
...
class IndexCapacityUnitsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 query_capacity_units: builtins.int,
                 storage_capacity_units: builtins.int):
        """
        :param builtins.int query_capacity_units: The amount of extra query capacity for an index and [GetQuerySuggestions](https://docs.aws.amazon.com/kendra/latest/dg/API_GetQuerySuggestions.html) capacity.
        ...
        :param builtins.int storage_capacity_units: The amount of extra storage capacity for an index. A single capacity unit provides 30 GB of storage space or 100,000 documents, whichever is reached first. You can add up to 100 extra capacity units.
        """
    ...
    def query_capacity_units(self) -> builtins.int:
        """
    ...
    def storage_capacity_units(self) -> builtins.int:
        """
...
class IndexJwtTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 claim_regex: Optional[builtins.str] = None,
                 group_attribute_field: Optional[builtins.str] = None,
                 issuer: Optional[builtins.str] = None,
                 secret_manager_arn: Optional[builtins.str] = None,
                 url: Optional[builtins.str] = None,
                 user_name_attribute_field: Optional[builtins.str] = None):
    ...
    def claim_regex(self) -> Optional[builtins.str]:
        return pulumi.get(self, "claim_regex")

    @property
    @pulumi.getter(name="groupAttributeField")
    def group_attribute_field(self) -> Optional[builtins.str]:
        return pulumi.get(self, "group_attribute_field")
    ...
    @property
    @pulumi.getter(name="userNameAttributeField")
    def user_name_attribute_field(self) -> Optional[builtins.str]:
        return pulumi.get(self, "user_name_attribute_field")
...
class IndexRelevance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 freshness: Optional[builtins.bool] = None,
    ...
    @property
    @pulumi.getter
    def freshness(self) -> Optional[builtins.bool]:
...
class IndexSearch(dict):
    def __init__(__self__, *,
                 displayable: Optional[builtins.bool] = None,
                 facetable: Optional[builtins.bool] = None,
                 searchable: Optional[builtins.bool] = None,
                 sortable: Optional[builtins.bool] = None):
    ...
    @property
    @pulumi.getter
    def displayable(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "displayable")

    @property
    @pulumi.getter
    def facetable(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "facetable")

    @property
    @pulumi.getter
    def searchable(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "searchable")

    @property
    @pulumi.getter
    def sortable(self) -> Optional[builtins.bool]:
...
class IndexServerSideEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: The identifier of the AWS KMS key . Amazon Kendra doesn't support asymmetric keys.
        """
