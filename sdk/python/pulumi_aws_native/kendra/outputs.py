...
class DataSourceAccessControlListConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key_path: Path to the AWS S3 bucket that contains the access control list files.
        """
...
class DataSourceColumnConfiguration(dict):
    ...
    def __init__(__self__, *,
                 change_detecting_columns: Sequence[_builtins.str],
                 document_data_column_name: _builtins.str,
                 document_id_column_name: _builtins.str,
                 document_title_column_name: Optional[_builtins.str] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param Sequence[_builtins.str] change_detecting_columns: One to five columns that indicate when a document in the database has changed.
        :param _builtins.str document_data_column_name: The column that contains the contents of the document.
        :param _builtins.str document_id_column_name: The column that provides the document's identifier.
        :param _builtins.str document_title_column_name: The column that contains the title of the document.
    ...
    def change_detecting_columns(self) -> Sequence[_builtins.str]:
        """
    ...
    def document_data_column_name(self) -> _builtins.str:
        """
    ...
    def document_id_column_name(self) -> _builtins.str:
        """
    ...
    def document_title_column_name(self) -> Optional[_builtins.str]:
        """
...
class DataSourceConfluenceAttachmentConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_attachments: Optional[_builtins.bool] = None):
        """
        ...
        :param _builtins.bool crawl_attachments: `TRUE` to index attachments of pages and blogs in Confluence.
        """
    ...
    def crawl_attachments(self) -> Optional[_builtins.bool]:
        """
...
class DataSourceConfluenceAttachmentToIndexFieldMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 index_field_name: _builtins.str,
                 date_field_format: Optional[_builtins.str] = None):
    ...
    def index_field_name(self) -> _builtins.str:
        return pulumi.get(self, "index_field_name")

    @_builtins.property
    @pulumi.getter(name="dateFieldFormat")
    def date_field_format(self) -> Optional[_builtins.str]:
...
class DataSourceConfluenceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user name and password required to connect to the Confluence instance. If you use Confluence Cloud, you use a generated API token as the password.
        ...
        :param _builtins.str server_url: The URL of your Confluence instance. Use the full URL of the server. For example, *https://server.example.com:port/* . You can also use an IP address, for example, *https://192.168.1.113/* .
        ...
        :param Sequence[_builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain blog posts, pages, spaces, or attachments in your Confluence. Content that matches the patterns are excluded from the index. Content that doesn't match the patterns is included in the index. If content matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the content isn't included in the index.
        :param Sequence[_builtins.str] inclusion_patterns: A list of regular expression patterns to include certain blog posts, pages, spaces, or attachments in your Confluence. Content that matches the patterns are included in the index. Content that doesn't match the patterns is excluded from the index. If content matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the content isn't included in the index.
...
class DataSourceConfluenceSpaceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 crawl_archived_spaces: Optional[_builtins.bool] = None,
                 crawl_personal_spaces: Optional[_builtins.bool] = None,
                 exclude_spaces: Optional[Sequence[_builtins.str]] = None,
                 include_spaces: Optional[Sequence[_builtins.str]] = None,
                 space_field_mappings: Optional[Sequence['outputs.DataSourceConfluenceSpaceToIndexFieldMapping']] = None):
        """
        :param _builtins.bool crawl_archived_spaces: `TRUE` to index archived spaces.
        :param _builtins.bool crawl_personal_spaces: `TRUE` to index personal spaces. You can add restrictions to items in personal spaces. If personal spaces are indexed, queries without user context information may return restricted items from a personal space in their results. For more information, see [Filtering on user context](https://docs.aws.amazon.com/kendra/latest/dg/user-context-filter.html) .
        :param Sequence[_builtins.str] exclude_spaces: A list of space keys of Confluence spaces. If you include a key, the blogs, documents, and attachments in the space are not indexed. If a space is in both the `ExcludeSpaces` and the `IncludeSpaces` list, the space is excluded.
        :param Sequence[_builtins.str] include_spaces: A list of space keys for Confluence spaces. If you include a key, the blogs, documents, and attachments in the space are indexed. Spaces that aren't in the list aren't indexed. A space in the list must exist. Otherwise, Amazon Kendra logs an error when the data source is synchronized. If a space is in both the `IncludeSpaces` and the `ExcludeSpaces` list, the space is excluded.
    ...
    def crawl_archived_spaces(self) -> Optional[_builtins.bool]:
        """
    ...
    def crawl_personal_spaces(self) -> Optional[_builtins.bool]:
        """
    ...
    def exclude_spaces(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def include_spaces(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DataSourceConnectionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 database_host: _builtins.str,
                 database_name: _builtins.str,
                 database_port: _builtins.int,
                 secret_arn: _builtins.str,
                 table_name: _builtins.str):
        """
        :param _builtins.str database_host: The name of the host for the database. Can be either a string (host.subdomain.domain.tld) or an IPv4 or IPv6 address.
        :param _builtins.str database_name: The name of the database containing the document data.
        :param _builtins.int database_port: The port that the database uses for connections.
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that stores the credentials. The credentials should be a user-password pair. For more information, see [Using a Database Data Source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-database.html) . For more information about AWS Secrets Manager , see [What Is AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html) in the *AWS Secrets Manager* user guide.
        :param _builtins.str table_name: The name of the table that contains the document data.
        """
    ...
    def database_port(self) -> _builtins.int:
        """
...
class DataSourceCustomDocumentEnrichmentConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str role_arn: The Amazon Resource Name (ARN) of an IAM role with permission to run `PreExtractionHookConfiguration` and `PostExtractionHookConfiguration` for altering document metadata and content during the document ingestion process. For more information, see [an IAM roles for Amazon Kendra](https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html) .
        """
...
class DataSourceDocumentAttributeCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str condition_document_attribute_key: The identifier of the document attribute used for the condition.
...
class DataSourceDocumentAttributeTarget(dict):
    ...
    def __init__(__self__, *,
                 target_document_attribute_key: _builtins.str,
    ...
    def target_document_attribute_key(self) -> _builtins.str:
...
class DataSourceDocumentAttributeValue(dict):
    ...
    def __init__(__self__, *,
                 ...
                 string_list_value: Optional[Sequence[_builtins.str]] = None,
                 string_value: Optional[_builtins.str] = None):
        """
        :param _builtins.str date_value: A date expressed as an ISO 8601 string.
               
               It is important for the time zone to be included in the ISO 8601 date-time format. For example, 2012-03-25T12:30:10+01:00 is the ISO 8601 date-time format for March 25th 2012 at 12:30PM (plus 10 seconds) in Central European Time.
        :param _builtins.int long_value: A long integer value.
        :param Sequence[_builtins.str] string_list_value: A list of strings. The default maximum length or number of strings is 10.
        :param _builtins.str string_value: A string, such as "department".
        """
    ...
    def string_list_value(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DataSourceDocumentsMetadataConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str s3_prefix: A prefix used to filter metadata configuration files in the AWS S3 bucket. The S3 bucket might contain multiple metadata files. Use `S3Prefix` to include only the desired metadata files.
        """
...
class DataSourceGoogleDriveConfiguration(dict):
    ...
    def __init__(__self__, *,
                 secret_arn: _builtins.str,
                 exclude_mime_types: Optional[Sequence[_builtins.str]] = None,
                 exclude_shared_drives: Optional[Sequence[_builtins.str]] = None,
                 exclude_user_accounts: Optional[Sequence[_builtins.str]] = None,
                 exclusion_patterns: Optional[Sequence[_builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of a AWS Secrets Manager secret that contains the credentials required to connect to Google Drive. For more information, see [Using a Google Workspace Drive data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-google-drive.html) .
        :param Sequence[_builtins.str] exclude_mime_types: A list of MIME types to exclude from the index. All documents matching the specified MIME type are excluded.
        ...
        :param Sequence[_builtins.str] exclude_shared_drives: A list of identifiers or shared drives to exclude from the index. All files and folders stored on the shared drive are excluded.
        :param Sequence[_builtins.str] exclude_user_accounts: A list of email addresses of the users. Documents owned by these users are excluded from the index. Documents shared with excluded users are indexed unless they are excluded in another way.
        :param Sequence[_builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain items in your Google Drive, including shared drives and users' My Drives. Items that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param Sequence[_builtins.str] inclusion_patterns: A list of regular expression patterns to include certain items in your Google Drive, including shared drives and users' My Drives. Items that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
    ...
    def exclude_mime_types(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def exclude_shared_drives(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def exclude_user_accounts(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DataSourceHookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str lambda_arn: The Amazon Resource Name (ARN) of an IAM role with permission to run a Lambda function during ingestion. For more information, see [an IAM roles for Amazon Kendra](https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html) .
...
class DataSourceOneDriveConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_local_groups: Optional[_builtins.bool] = None,
                 exclusion_patterns: Optional[Sequence[_builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[_builtins.str]] = None):
        """
        :param 'DataSourceOneDriveUsers' one_drive_users: A list of user accounts whose documents should be indexed.
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the user name and password to connect to OneDrive. The user name should be the application ID for the OneDrive application, and the password is the application key for the OneDrive application.
        :param _builtins.str tenant_domain: The Azure Active Directory domain of the organization.
        :param _builtins.bool disable_local_groups: `TRUE` to disable local groups information.
        :param Sequence[_builtins.str] exclusion_patterns: A list of regular expression patterns to exclude certain documents in your OneDrive. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
        ...
        :param Sequence[_builtins.str] inclusion_patterns: A list of regular expression patterns to include certain documents in your OneDrive. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
    ...
    def disable_local_groups(self) -> Optional[_builtins.bool]:
        """
...
class DataSourceOneDriveUsers(dict):
    ...
    def one_drive_user_list(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DataSourceProxyConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host: The name of the website host you want to connect to via a web proxy server.
               
               For example, the host name of https://a.example.com/page1.html is "a.example.com".
        :param _builtins.int port: The port number of the website host you want to connect to via a web proxy server.
               
               For example, the port for https://a.example.com/page1.html is 443, the standard port for HTTPS.
        :param _builtins.str credentials: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret. You create a secret to store your credentials in [AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
...
class DataSourceSalesforceChatterFeedConfiguration(dict):
    ...
    def __init__(__self__, *,
                 document_data_field_name: _builtins.str,
                 document_title_field_name: Optional[_builtins.str] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 include_filter_types: Optional[Sequence['DataSourceSalesforceChatterFeedIncludeFilterType']] = None):
        """
        :param _builtins.str document_data_field_name: The name of the column in the Salesforce FeedItem table that contains the content to index. Typically this is the `Body` column.
        :param _builtins.str document_title_field_name: The name of the column in the Salesforce FeedItem table that contains the title of the document. This is typically the `Title` column.
    ...
    def document_data_field_name(self) -> _builtins.str:
        """
    ...
    def document_title_field_name(self) -> Optional[_builtins.str]:
        """
...
class DataSourceSalesforceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_attachments: Optional[_builtins.bool] = None,
                 exclude_attachment_file_patterns: Optional[Sequence[_builtins.str]] = None,
                 include_attachment_file_patterns: Optional[Sequence[_builtins.str]] = None,
        ...
        """
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of an AWS Secrets Manager secret that contains the key/value pairs required to connect to your Salesforce instance. The secret must contain a JSON structure with the following keys:
        ...
        :param _builtins.str server_url: The instance URL for the Salesforce site that you want to index.
        ...
        :param _builtins.bool crawl_attachments: Indicates whether Amazon Kendra should index attachments to Salesforce objects.
        :param Sequence[_builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns to exclude certain documents in your Salesforce. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
               
               The pattern is applied to the name of the attached file.
        :param Sequence[_builtins.str] include_attachment_file_patterns: A list of regular expression patterns to include certain documents in your Salesforce. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
    ...
    def exclude_attachment_file_patterns(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def include_attachment_file_patterns(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DataSourceSalesforceStandardKnowledgeArticleTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param _builtins.str document_data_field_name: The name of the field that contains the document data to index.
        :param _builtins.str document_title_field_name: The name of the field that contains the document title.
...
class DataSourceSalesforceStandardObjectAttachmentConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None):
        """
        :param _builtins.str document_title_field_name: The name of the field used for the document title.
...
class DataSourceServiceNowConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host_url: The ServiceNow instance that the data source connects to. The host endpoint should look like the following: *{instance}.service-now.com.*
        :param _builtins.str secret_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager secret that contains the user name and password required to connect to the ServiceNow instance. You can also provide OAuth authentication credentials of user name, password, client ID, and client secret. For more information, see [Using a ServiceNow data source](https://docs.aws.amazon.com/kendra/latest/dg/data-source-servicenow.html) .
...
class DataSourceServiceNowKnowledgeArticleConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_attachment_file_patterns: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str document_data_field_name: The name of the ServiceNow field that is mapped to the index document contents field in the Amazon Kendra index.
        :param _builtins.bool crawl_attachments: `TRUE` to index attachments to knowledge articles.
        :param _builtins.str document_title_field_name: The name of the ServiceNow field that is mapped to the index document title field.
        :param Sequence[_builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns applied to exclude certain knowledge article attachments. Attachments that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param _builtins.str filter_query: A query that selects the knowledge articles to index. The query can return articles from multiple knowledge bases, and the knowledge bases can be public or private.
        ...
        :param Sequence[_builtins.str] include_attachment_file_patterns: A list of regular expression patterns applied to include knowledge article attachments. Attachments that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        """
        pulumi.set(__self__, "document_data_field_name", document_data_field_name)
        if crawl_attachments is not None:
            pulumi.set(__self__, "crawl_attachments", crawl_attachments)
...
class DataSourceServiceNowServiceCatalogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str document_data_field_name: The name of the ServiceNow field that is mapped to the index document contents field in the Amazon Kendra index.
        :param _builtins.bool crawl_attachments: `TRUE` to index attachments to service catalog items.
        :param _builtins.str document_title_field_name: The name of the ServiceNow field that is mapped to the index document title field.
        :param Sequence[_builtins.str] exclude_attachment_file_patterns: A list of regular expression patterns to exclude certain attachments of catalogs in your ServiceNow. Item that match the patterns are excluded from the index. Items that don't match the patterns are included in the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
        ...
        :param Sequence[_builtins.str] include_attachment_file_patterns: A list of regular expression patterns to include certain attachments of catalogs in your ServiceNow. Item that match the patterns are included in the index. Items that don't match the patterns are excluded from the index. If an item matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the item isn't included in the index.
...
class DataSourceSharePointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool crawl_attachments: `TRUE` to index document attachments.
        :param _builtins.bool disable_local_groups: `TRUE` to disable local groups information.
        :param _builtins.str document_title_field_name: The Microsoft SharePoint attribute field that contains the title of the document.
        :param Sequence[_builtins.str] exclusion_patterns: A list of regular expression patterns. Documents that match the patterns are excluded from the index. Documents that don't match the patterns are included in the index. If a document matches both an exclusion pattern and an inclusion pattern, the document is not included in the index.
        ...
        :param Sequence[_builtins.str] inclusion_patterns: A list of regular expression patterns to include certain documents in your SharePoint. Documents that match the patterns are included in the index. Documents that don't match the patterns are excluded from the index. If a document matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the document isn't included in the index.
        ...
        :param _builtins.bool use_change_log: `TRUE` to use the SharePoint change log to determine which documents require updating in the index. Depending on the change log's size, it may take longer for Amazon Kendra to use the change log than to scan all of your documents in SharePoint.
        :param 'DataSourceVpcConfiguration' vpc_configuration: Provides information for connecting to an Amazon VPC.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
...
class DataSourceToIndexFieldMapping(dict):
    ...
    def __init__(__self__, *,
                 data_source_field_name: _builtins.str,
                 index_field_name: _builtins.str,
                 date_field_format: Optional[_builtins.str] = None):
        pulumi.set(__self__, "data_source_field_name", data_source_field_name)
        pulumi.set(__self__, "index_field_name", index_field_name)
    ...
    @_builtins.property
    @pulumi.getter(name="dataSourceFieldName")
    def data_source_field_name(self) -> _builtins.str:
        return pulumi.get(self, "data_source_field_name")
...
class DataSourceVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] security_group_ids: A list of identifiers of security groups within your Amazon VPC. The security groups should enable Amazon Kendra to connect to the data source.
        :param Sequence[_builtins.str] subnet_ids: A list of identifiers for subnets within your Amazon VPC. The subnets should be able to connect to each other in the VPC, and they should have outgoing access to the Internet through a NAT device.
        """
...
class DataSourceWebCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int crawl_depth: The 'depth' or number of levels from the seed level to crawl. For example, the seed URL page is depth 1 and any hyperlinks on this page that are also crawled are depth 2.
        :param _builtins.float max_content_size_per_page_in_mega_bytes: The maximum size (in MB) of a web page or attachment to crawl.
               
               Files larger than this size (in MB) are skipped/not crawled.
               
               The default maximum size of a web page or attachment is set to 50 MB.
        :param _builtins.int max_links_per_page: The maximum number of URLs on a web page to include when crawling a website. This number is per web page.
               
               As a website’s web pages are crawled, any URLs the web pages link to are also crawled. URLs on a web page are crawled in order of appearance.
               
               The default maximum links per page is 100.
        :param _builtins.int max_urls_per_minute_crawl_rate: The maximum number of URLs crawled per website host per minute.
...
class DataSourceWebCrawlerSeedUrlConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] seed_urls: The list of seed or starting point URLs of the websites you want to crawl.
...
class DataSourceWebCrawlerSiteMapsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] site_maps: The list of sitemap URLs of the websites you want to crawl.
...
class DataSourceWorkDocsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crawl_comments: Optional[_builtins.bool] = None,
                 exclusion_patterns: Optional[Sequence[_builtins.str]] = None,
                 field_mappings: Optional[Sequence['outputs.DataSourceToIndexFieldMapping']] = None,
                 inclusion_patterns: Optional[Sequence[_builtins.str]] = None,
                 use_change_log: Optional[_builtins.bool] = None):
    ...
    def crawl_comments(self) -> Optional[_builtins.bool]:
        """
...
class IndexCapacityUnitsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int query_capacity_units: The amount of extra query capacity for an index and [GetQuerySuggestions](https://docs.aws.amazon.com/kendra/latest/dg/API_GetQuerySuggestions.html) capacity.
        ...
        :param _builtins.int storage_capacity_units: The amount of extra storage capacity for an index. A single capacity unit provides 30 GB of storage space or 100,000 documents, whichever is reached first. You can add up to 100 extra capacity units.
        """
...
class IndexServerSideEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str kms_key_id: The identifier of the AWS KMS key . Amazon Kendra doesn't support asymmetric keys.
        """
