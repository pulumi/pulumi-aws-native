...
class IndexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the index.
...
@pulumi.type_token("aws-native:kendra:Index")
