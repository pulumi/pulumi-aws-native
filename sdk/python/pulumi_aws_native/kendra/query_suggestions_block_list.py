...
class QuerySuggestionsBlockListArgs:
    def __init__(__self__, *,
                 ...
                 source_s3_path: pulumi.Input['QuerySuggestionsBlockListS3PathArgs'],
        ...
        :param pulumi.Input[_builtins.str] description: A description for the block list.
        :param pulumi.Input[_builtins.str] name: The name of the block list.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: A list of key-value pairs that identify or categorize the block list.
        """
    ...
    def source_s3_path(self) -> pulumi.Input['QuerySuggestionsBlockListS3PathArgs']:
        return pulumi.get(self, "source_s3_path")

    @source_s3_path.setter
    def source_s3_path(self, value: pulumi.Input['QuerySuggestionsBlockListS3PathArgs']):
...
@pulumi.type_token("aws-native:kendra:QuerySuggestionsBlockList")
class QuerySuggestionsBlockList(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(QuerySuggestionsBlockList, __self__).__init__(
            'aws-native:kendra:QuerySuggestionsBlockList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'QuerySuggestionsBlockList':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceS3Path")
    def source_s3_path(self) -> pulumi.Output['outputs.QuerySuggestionsBlockListS3Path']:
        return pulumi.get(self, "source_s3_path")
