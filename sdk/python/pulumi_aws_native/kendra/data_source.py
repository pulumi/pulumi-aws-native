...
class DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] index_id: The identifier of the index you want to use with the data source connector.
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of a role with permission to access the data source.
               
               You can't specify the `RoleArn` parameter when the `Type` parameter is set to `CUSTOM` .
               
               The `RoleArn` parameter is required for all other data sources.
        :param pulumi.Input[builtins.str] schedule: Sets the frequency that Amazon Kendra checks the documents in your data source and updates the index. If you don't set a schedule, Amazon Kendra doesn't periodically update the index.
