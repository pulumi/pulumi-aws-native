...
def get_device_profile(id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeviceProfileResult:
    """
    Device Profile's resource schema demonstrating some basic constructs and validation rules.


    :param builtins.str id: Service profile Id. Returned after successful create.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_device_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
