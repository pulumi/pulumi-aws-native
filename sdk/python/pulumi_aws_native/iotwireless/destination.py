...
class DestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] expression: Destination expression
        :param pulumi.Input['DestinationExpressionType'] expression_type: Must be RuleName
        :param pulumi.Input[builtins.str] description: Destination description
        :param pulumi.Input[builtins.str] name: Unique name of destination
        :param pulumi.Input[builtins.str] role_arn: AWS role ARN that grants access
