...
class FuotaTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: FUOTA task description
        :param pulumi.Input[_builtins.str] disassociate_multicast_group: Multicast group to disassociate. Only for update request.
        :param pulumi.Input[_builtins.str] disassociate_wireless_device: Wireless device to disassociate. Only for update request.
        :param pulumi.Input[_builtins.str] name: Name of FUOTA task
    ...
    def firmware_update_image(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def firmware_update_image(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "firmware_update_image", value)

    @_builtins.property
    @pulumi.getter(name="firmwareUpdateRole")
    def firmware_update_role(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def firmware_update_role(self, value: pulumi.Input[_builtins.str]):
...
class FuotaTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 lo_ra_wan: pulumi.Input[Optional[Union['FuotaTaskLoRaWanArgs', 'FuotaTaskLoRaWanArgsDict', 'outputs.FuotaTaskLoRaWan']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] firmware_update_image: FUOTA task firmware update image binary S3 link
        :param pulumi.Input[_builtins.str] firmware_update_role: FUOTA task firmware IAM role for reading S3
        :param pulumi.Input[Union['FuotaTaskLoRaWanArgs', 'FuotaTaskLoRaWanArgsDict', 'outputs.FuotaTaskLoRaWan']] lo_ra_wan: FUOTA task LoRaWAN
        :param pulumi.Input[_builtins.str] name: Name of FUOTA task
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: A list of key-value pairs that contain metadata for the FUOTA task.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter(name="associateMulticastGroup")
    def associate_multicast_group(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Multicast group to associate. Only for update request.
        """
        return pulumi.get(self, "associate_multicast_group")
    ...
    @_builtins.property
    @pulumi.getter(name="associateWirelessDevice")
    def associate_wireless_device(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Wireless device to associate. Only for update request.
        """
        return pulumi.get(self, "associate_wireless_device")
    ...
    @_builtins.property
    @pulumi.getter(name="disassociateMulticastGroup")
    def disassociate_multicast_group(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Multicast group to disassociate. Only for update request.
        """
        return pulumi.get(self, "disassociate_multicast_group")
    ...
    @_builtins.property
    @pulumi.getter(name="disassociateWirelessDevice")
    def disassociate_wireless_device(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Wireless device to disassociate. Only for update request.
        """
        return pulumi.get(self, "disassociate_wireless_device")
    ...
    @_builtins.property
    @pulumi.getter(name="firmwareUpdateImage")
    def firmware_update_image(self) -> pulumi.Output[_builtins.str]:
        """
        FUOTA task firmware update image binary S3 link
        """
        return pulumi.get(self, "firmware_update_image")
    ...
    @_builtins.property
    @pulumi.getter(name="firmwareUpdateRole")
    def firmware_update_role(self) -> pulumi.Output[_builtins.str]:
        """
        FUOTA task firmware IAM role for reading S3
        """
        return pulumi.get(self, "firmware_update_role")
    ...
    def fuota_task_status(self) -> pulumi.Output[_builtins.str]:
        """
