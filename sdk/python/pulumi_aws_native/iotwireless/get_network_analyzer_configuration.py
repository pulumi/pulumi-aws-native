...
class GetNetworkAnalyzerConfigurationResult:
    ...
    def wireless_devices(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def wireless_gateways(self) -> Optional[Sequence[_builtins.str]]:
        """
        List of wireless gateway resources that have been added to the network analyzer configuration
        """
...
def get_network_analyzer_configuration(name: Optional[_builtins.str] = None,
