...
class DeviceProfileLoRaWanDeviceProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] factory_preset_freqs_list: The list of values that make up the FactoryPresetFreqs value. Valid range of values include a minimum value of 1000000 and a maximum value of 16700000.
        :param pulumi.Input[_builtins.str] mac_version: The MAC version (such as OTAA 1.1 or OTAA 1.0.3) to use with this device profile.
        :param pulumi.Input[_builtins.int] max_duty_cycle: The MaxDutyCycle value.
        :param pulumi.Input[_builtins.int] max_eirp: The MaxEIRP value.
        :param pulumi.Input[_builtins.int] ping_slot_dr: The PingSlotDR value.
        :param pulumi.Input[_builtins.int] ping_slot_freq: The PingSlotFreq value.
        :param pulumi.Input[_builtins.int] ping_slot_period: The PingSlotPeriod value.
        :param pulumi.Input[_builtins.str] reg_params_revision: The version of regional parameters.
        :param pulumi.Input[_builtins.str] rf_region: The frequency band (RFRegion) value.
        :param pulumi.Input[_builtins.int] rx_data_rate2: The RXDataRate2 value.
        :param pulumi.Input[_builtins.int] rx_delay1: The RXDelay1 value.
        :param pulumi.Input[_builtins.int] rx_dr_offset1: The RXDROffset1 value.
        :param pulumi.Input[_builtins.int] rx_freq2: The RXFreq2 value.
        :param pulumi.Input[_builtins.bool] supports32_bit_f_cnt: The Supports32BitFCnt value.
        :param pulumi.Input[_builtins.bool] supports_class_b: The SupportsClassB value.
        :param pulumi.Input[_builtins.bool] supports_class_c: The SupportsClassC value.
        :param pulumi.Input[_builtins.bool] supports_join: The SupportsJoin value.
        """
...
class FuotaTaskLoRaWanArgs:
    ...
    @_builtins.property
    @pulumi.getter(name="rfRegion")
    def rf_region(self) -> pulumi.Input[_builtins.str]:
        """
        FUOTA task LoRaWAN RF region
        """
        return pulumi.get(self, "rf_region")
    ...
    @rf_region.setter
    def rf_region(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "rf_region", value)
...
class MulticastGroupLoRaWanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] number_of_devices_in_group: Multicast group number of devices in group. Returned after successful read.
        :param pulumi.Input[_builtins.int] number_of_devices_requested: Multicast group number of devices requested. Returned after successful read.
        """
    ...
    def dl_class(self) -> pulumi.Input[_builtins.str]:
        """
        Multicast group LoRaWAN DL Class
        """
    ...
    @dl_class.setter
    def dl_class(self, value: pulumi.Input[_builtins.str]):
...
class ServiceProfileLoRaWanServiceProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] channel_mask: The ChannelMask value.
               ...
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] dev_status_req_freq: The DevStatusReqFreq value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] dl_bucket_size: The DLBucketSize value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] dl_rate: The DLRate value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.str] dl_rate_policy: The DLRatePolicy value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] dr_max: The DRMax value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] dr_min: The DRMin value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.bool] hr_allowed: The HRAllowed value that describes whether handover roaming is allowed.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] min_gw_diversity: The MinGwDiversity value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.bool] nwk_geo_loc: The NwkGeoLoc value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.bool] pr_allowed: The PRAllowed value that describes whether passive roaming is allowed.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.bool] ra_allowed: The RAAllowed value that describes whether roaming activation is allowed.
        :param pulumi.Input[_builtins.bool] report_dev_status_battery: The ReportDevStatusBattery value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.bool] report_dev_status_margin: The ReportDevStatusMargin value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] target_per: The TargetPer value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] ul_bucket_size: The UlBucketSize value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.int] ul_rate: The ULRate value.
               
               This property is `ReadOnly` and can't be inputted for create. It's returned with `Fn::GetAtt`
        :param pulumi.Input[_builtins.str] ul_rate_policy: The ULRatePolicy value.
...
class TaskDefinitionLoRaWanGatewayVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] station: The basic station version of the wireless gateway.
        """
...
class TaskDefinitionLoRaWanUpdateGatewayTaskCreateArgsDict(TypedDict):
    current_version: NotRequired[pulumi.Input[Optional['TaskDefinitionLoRaWanGatewayVersionArgsDict']]]
    """
    ...
    """
    update_version: NotRequired[pulumi.Input[Optional['TaskDefinitionLoRaWanGatewayVersionArgsDict']]]
    """
...
class TaskDefinitionLoRaWanUpdateGatewayTaskCreateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] update_signature: The signature used to verify the update firmware.
...
class TaskDefinitionUpdateWirelessGatewayTaskCreateArgsDict(TypedDict):
    lo_ra_wan: NotRequired[pulumi.Input[Optional['TaskDefinitionLoRaWanUpdateGatewayTaskCreateArgsDict']]]
    """
...
class TaskDefinitionUpdateWirelessGatewayTaskCreateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] update_data_source: The link to the S3 bucket.
        """
...
class WirelessDeviceAbpV10xArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] dev_addr: The DevAddr value.
    ...
    def dev_addr(self) -> pulumi.Input[_builtins.str]:
        """
        The DevAddr value.
        """
    ...
    @dev_addr.setter
    def dev_addr(self, value: pulumi.Input[_builtins.str]):
...
class WirelessDeviceFPortsArgsDict(TypedDict):
    applications: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WirelessDeviceApplicationArgsDict']]]]]
    """
...
class WirelessDeviceLoRaWanDeviceArgsDict(TypedDict):
    abp_v10x: NotRequired[pulumi.Input[Optional['WirelessDeviceAbpV10xArgsDict']]]
    """
    ABP device object for LoRaWAN specification v1.0.x.
    """
    abp_v11: NotRequired[pulumi.Input[Optional['WirelessDeviceAbpV11ArgsDict']]]
    """
    ...
    """
    f_ports: NotRequired[pulumi.Input[Optional['WirelessDeviceFPortsArgsDict']]]
    """
    List of FPort assigned for different LoRaWAN application packages to use.
    """
    otaa_v10x: NotRequired[pulumi.Input[Optional['WirelessDeviceOtaaV10xArgsDict']]]
    """
    OTAA device object for create APIs for v1.0.x
    """
    otaa_v11: NotRequired[pulumi.Input[Optional['WirelessDeviceOtaaV11ArgsDict']]]
    """
...
class WirelessDeviceLoRaWanDeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dev_eui: The DevEUI value.
        :param pulumi.Input[_builtins.str] device_profile_id: The ID of the device profile for the new wireless device.
        ...
        :param pulumi.Input[_builtins.str] service_profile_id: The ID of the service profile.
        """
...
class WirelessDeviceOtaaV10xArgs:
    def __init__(__self__, *,
                 ...
                 app_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] app_eui: The AppEUI value. You specify this value when using LoRaWAN versions v1.0.2 or v1.0.3.
        :param pulumi.Input[_builtins.str] app_key: The AppKey value.
        """
    ...
    def app_eui(self) -> pulumi.Input[_builtins.str]:
        """
        The AppEUI value. You specify this value when using LoRaWAN versions v1.0.2 or v1.0.3.
        """
    ...
    @app_eui.setter
    def app_eui(self, value: pulumi.Input[_builtins.str]):
...
class WirelessDeviceOtaaV11Args:
    def __init__(__self__, *,
                 ...
                 nwk_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] app_key: The AppKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the AppKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        :param pulumi.Input[_builtins.str] join_eui: The JoinEUI value.
        :param pulumi.Input[_builtins.str] nwk_key: The NwkKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the NwkKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
        pulumi.set(__self__, "app_key", app_key)
    ...
    def join_eui(self) -> pulumi.Input[_builtins.str]:
        """
        The JoinEUI value.
        """
    ...
    @join_eui.setter
    def join_eui(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "join_eui", value)

    @_builtins.property
    @pulumi.getter(name="nwkKey")
    def nwk_key(self) -> pulumi.Input[_builtins.str]:
        """
        The NwkKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the NwkKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
    ...
    @nwk_key.setter
    def nwk_key(self, value: pulumi.Input[_builtins.str]):
...
class WirelessDeviceSessionKeysAbpV10xArgs:
    def __init__(__self__, *,
                 ...
                 nwk_s_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] app_s_key: The AppSKey value.
        :param pulumi.Input[_builtins.str] nwk_s_key: The NwkKey value.
        """
    ...
    def app_s_key(self) -> pulumi.Input[_builtins.str]:
        """
        The AppSKey value.
        """
    ...
    @app_s_key.setter
    def app_s_key(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "app_s_key", value)

    @_builtins.property
    @pulumi.getter(name="nwkSKey")
    def nwk_s_key(self) -> pulumi.Input[_builtins.str]:
        """
        The NwkKey value.
        """
    ...
    @nwk_s_key.setter
    def nwk_s_key(self, value: pulumi.Input[_builtins.str]):
...
class WirelessDeviceSessionKeysAbpV11Args:
    def __init__(__self__, *,
                 ...
                 s_nwk_s_int_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] app_s_key: The AppSKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the AppSKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        :param pulumi.Input[_builtins.str] f_nwk_s_int_key: The FNwkSIntKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the FNwkSIntKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        :param pulumi.Input[_builtins.str] nwk_s_enc_key: The NwkSEncKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the NwkSEncKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        :param pulumi.Input[_builtins.str] s_nwk_s_int_key: The SNwkSIntKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the SNwkSIntKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
        pulumi.set(__self__, "app_s_key", app_s_key)
    ...
    def f_nwk_s_int_key(self) -> pulumi.Input[_builtins.str]:
        """
        The FNwkSIntKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the FNwkSIntKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
    ...
    def f_nwk_s_int_key(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "f_nwk_s_int_key", value)

    @_builtins.property
    @pulumi.getter(name="nwkSEncKey")
    def nwk_s_enc_key(self) -> pulumi.Input[_builtins.str]:
        """
        The NwkSEncKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the NwkSEncKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
    ...
    def nwk_s_enc_key(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "nwk_s_enc_key", value)

    @_builtins.property
    @pulumi.getter(name="sNwkSIntKey")
    def s_nwk_s_int_key(self) -> pulumi.Input[_builtins.str]:
        """
        The SNwkSIntKey is a secret key, which you should handle in a similar way as you would an application password. You can protect the SNwkSIntKey value by storing it in the AWS Secrets Manager and use the [secretsmanager](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/dynamic-references.html#dynamic-references-secretsmanager) to reference this value.
        """
    ...
    def s_nwk_s_int_key(self, value: pulumi.Input[_builtins.str]):
...
class WirelessGatewayLoRaWanGatewayArgs:
    def __init__(__self__, *,
                 ...
                 rf_region: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] gateway_eui: The gateway's EUI value.
        :param pulumi.Input[_builtins.str] rf_region: The frequency band (RFRegion) value.
        """
    ...
    def gateway_eui(self) -> pulumi.Input[_builtins.str]:
        """
        The gateway's EUI value.
        """
    ...
    @gateway_eui.setter
    def gateway_eui(self, value: pulumi.Input[_builtins.str]):
