...
class WirelessGatewayArgs:
    def __init__(__self__, *,
                 ...
                 last_uplink_received_at: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Description of Wireless Gateway.
        :param pulumi.Input[builtins.str] last_uplink_received_at: The date and time when the most recent uplink was received.
        :param pulumi.Input[builtins.str] name: Name of Wireless Gateway.
        ...
        :param pulumi.Input[builtins.str] thing_arn: Thing Arn. Passed into Update to associate a Thing with the Wireless Gateway.
        :param pulumi.Input[builtins.str] thing_name: Thing Name. If there is a Thing created, this can be returned with a Get call.
        """
    ...
    def last_uplink_received_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_uplink_received_at(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WirelessGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lastUplinkReceivedAt")
    def last_uplink_received_at(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The date and time when the most recent uplink was received.
        """
        return pulumi.get(self, "last_uplink_received_at")
    ...
    @property
    @pulumi.getter(name="thingArn")
    def thing_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Thing Arn. Passed into Update to associate a Thing with the Wireless Gateway.
        """
        return pulumi.get(self, "thing_arn")
