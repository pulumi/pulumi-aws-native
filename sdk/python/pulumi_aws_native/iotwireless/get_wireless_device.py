...
def get_wireless_device(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDeviceResult:
    """
    Create and manage wireless gateways, including LoRa gateways.


    :param builtins.str id: Wireless device Id. Returned after successful create.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_wireless_device_output(id: Optional[pulumi.Input[builtins.str]] = None,
