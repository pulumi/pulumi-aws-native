...
class GetFuotaTaskResult:
    ...
    def associate_multicast_group(self) -> Optional[builtins.str]:
        """
    ...
    def disassociate_multicast_group(self) -> Optional[builtins.str]:
        """
    ...
    def firmware_update_image(self) -> Optional[builtins.str]:
        """
    ...
    def firmware_update_role(self) -> Optional[builtins.str]:
        """
    ...
    def fuota_task_status(self) -> Optional[builtins.str]:
        """
...
def get_fuota_task(id: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFuotaTaskResult:
    """
    Create and manage FUOTA tasks.


    :param builtins.str id: FUOTA task id. Returned after successful create.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_fuota_task_output(id: Optional[pulumi.Input[builtins.str]] = None,
