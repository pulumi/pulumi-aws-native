...
class GetTaskDefinitionResult:
    ...
    def auto_create_tasks(self) -> Optional[builtins.bool]:
        """
...
def get_task_definition(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTaskDefinitionResult:
    """
    Creates a gateway task definition.


    :param builtins.str id: The ID of the new wireless gateway task definition
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_task_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
