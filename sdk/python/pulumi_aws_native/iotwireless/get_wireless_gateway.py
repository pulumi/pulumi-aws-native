...
class GetWirelessGatewayResult:
    ...
    def last_uplink_received_at(self) -> Optional[builtins.str]:
        """
    ...
    def thing_name(self) -> Optional[builtins.str]:
        """
...
def get_wireless_gateway(id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessGatewayResult:
    """
    Create and manage wireless gateways, including LoRa gateways.


    :param builtins.str id: Id for Wireless Gateway. Returned upon successful create.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_wireless_gateway_output(id: Optional[pulumi.Input[builtins.str]] = None,
