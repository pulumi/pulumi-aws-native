...
def get_database(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: The name for the database. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the database name.
    """
    __args__ = dict()
