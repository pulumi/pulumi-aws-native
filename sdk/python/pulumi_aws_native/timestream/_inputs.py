...
class LogDeliveryConfigurationPropertiesS3ConfigurationPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        S3 configuration for sending logs to customer account from the InfluxDB instance.
        :param pulumi.Input[builtins.str] bucket_name: The bucket name for logs to be sent from the InfluxDB instance
        :param pulumi.Input[builtins.bool] enabled: Specifies whether logging to customer specified bucket is enabled.
        """
...
class MagneticStoreWritePropertiesPropertiesMagneticStoreRejectedDataLocationPropertiesS3ConfigurationPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        S3 configuration for location to store rejections from magnetic store writes
        :param pulumi.Input[builtins.str] bucket_name: The bucket name used to store the data.
        :param pulumi.Input[builtins.str] encryption_option: Either SSE_KMS or SSE_S3.
        :param pulumi.Input[builtins.str] kms_key_id: Must be provided if SSE_KMS is specified as the encryption option
        :param pulumi.Input[builtins.str] object_key_prefix: String used to prefix all data in the bucket.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
if not MYPY:
    class MagneticStoreWritePropertiesPropertiesArgsDict(TypedDict):
        ...
        """
        enable_magnetic_store_writes: pulumi.Input[builtins.bool]
        """
...
class MagneticStoreWritePropertiesPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The properties that determine whether magnetic store writes are enabled.
        :param pulumi.Input[builtins.bool] enable_magnetic_store_writes: Boolean flag indicating whether magnetic store writes are enabled.
    ...
    def enable_magnetic_store_writes(self) -> pulumi.Input[builtins.bool]:
        """
        Boolean flag indicating whether magnetic store writes are enabled.
        """
    ...
    def enable_magnetic_store_writes(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class RetentionPropertiesPropertiesArgsDict(TypedDict):
        ...
        """
        magnetic_store_retention_period_in_days: NotRequired[pulumi.Input[builtins.str]]
        """
        The duration for which data must be stored in the magnetic store.
        """
        memory_store_retention_period_in_hours: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RetentionPropertiesPropertiesArgs:
    def __init__(__self__, *,
                 magnetic_store_retention_period_in_days: Optional[pulumi.Input[builtins.str]] = None,
                 memory_store_retention_period_in_hours: Optional[pulumi.Input[builtins.str]] = None):
        """
        The retention duration of the memory store and the magnetic store.
        :param pulumi.Input[builtins.str] magnetic_store_retention_period_in_days: The duration for which data must be stored in the magnetic store.
        :param pulumi.Input[builtins.str] memory_store_retention_period_in_hours: The duration for which data must be stored in the memory store.
        """
    ...
    def magnetic_store_retention_period_in_days(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration for which data must be stored in the magnetic store.
        """
    ...
    def magnetic_store_retention_period_in_days(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "magnetic_store_retention_period_in_days", value)

    @property
    @pulumi.getter(name="memoryStoreRetentionPeriodInHours")
    def memory_store_retention_period_in_hours(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration for which data must be stored in the memory store.
        """
    ...
    def memory_store_retention_period_in_hours(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScheduledQueryMultiMeasureMappingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_multi_measure_name: The name of the target multi-measure name in the derived table. This input is required when measureNameColumn is not provided. If MeasureNameColumn is provided, then value from that column will be used as multi-measure name.
        """
        pulumi.set(__self__, "multi_measure_attribute_mappings", multi_measure_attribute_mappings)
...
class ScheduledQueryS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] object_key_prefix: Prefix for the error report key. Timestream by default adds the following prefix to the error report path.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
class ScheduledQueryScheduleConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for when the scheduled query is executed.
        :param pulumi.Input[builtins.str] schedule_expression: An expression that denotes when to trigger the scheduled query run. This can be a cron expression or a rate expression.
        """
...
class ScheduledQueryTimestreamConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] measure_name_column: Name of the measure column. Also see `MultiMeasureMappings` and `MixedMeasureMappings` for how measure name properties on those relate to `MeasureNameColumn` .
