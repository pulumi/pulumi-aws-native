...
class TableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: The name for the database which the table to be created belongs to.
        ...
        :param pulumi.Input[builtins.str] table_name: The name for the table. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the table name.
