...
class Table(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(magnetic_store_write_properties, MagneticStoreWritePropertiesPropertiesArgs):
            ...
            if not isinstance(retention_properties, RetentionPropertiesPropertiesArgs):
