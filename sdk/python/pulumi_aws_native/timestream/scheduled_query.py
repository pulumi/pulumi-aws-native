...
class ScheduledQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(error_report_configuration, ScheduledQueryErrorReportConfigurationArgs):
            ...
            if not isinstance(notification_configuration, ScheduledQueryNotificationConfigurationArgs):
            ...
            if not isinstance(schedule_configuration, ScheduledQueryScheduleConfigurationArgs):
            ...
            if not isinstance(target_configuration, ScheduledQueryTargetConfigurationArgs):
