...
class ScheduledQueryArgs:
    def __init__(__self__, *,
                 ...
                 scheduled_query_execution_role_arn: pulumi.Input[builtins.str],
                 client_token: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_query_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] query_string: The query string to run. Parameter names can be specified in the query string `@` character followed by an identifier. The named Parameter `@scheduled_runtime` is reserved and can be used in the query to get the time at which the query is scheduled to run.
        ...
        :param pulumi.Input[builtins.str] scheduled_query_execution_role_arn: The ARN for the IAM role that Timestream will assume when running the scheduled query.
        :param pulumi.Input[builtins.str] client_token: Using a ClientToken makes the call to CreateScheduledQuery idempotent, in other words, making the same request repeatedly will produce the same result. Making multiple identical CreateScheduledQuery requests has the same effect as making a single request.
               
               - If CreateScheduledQuery is called without a `ClientToken` , the Query SDK generates a `ClientToken` on your behalf.
               - After 8 hours, any request with the same `ClientToken` is treated as a new request.
        :param pulumi.Input[builtins.str] kms_key_id: The Amazon KMS key used to encrypt the scheduled query resource, at-rest. If the Amazon KMS key is not specified, the scheduled query resource will be encrypted with a Timestream owned Amazon KMS key. To specify a KMS key, use the key ID, key ARN, alias name, or alias ARN. When using an alias name, prefix the name with *alias/*
               
               If ErrorReportConfiguration uses `SSE_KMS` as encryption type, the same KmsKeyId is used to encrypt the error report at rest.
        :param pulumi.Input[builtins.str] scheduled_query_name: A name for the query. Scheduled query names must be unique within each Region.
    ...
    def scheduled_query_execution_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def scheduled_query_execution_role_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def scheduled_query_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scheduled_query_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScheduledQuery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 scheduled_query_execution_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_query_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="scheduledQueryExecutionRoleArn")
    def scheduled_query_execution_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN for the IAM role that Timestream will assume when running the scheduled query.
        """
        return pulumi.get(self, "scheduled_query_execution_role_arn")
    ...
    @property
    @pulumi.getter(name="scheduledQueryName")
    def scheduled_query_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A name for the query. Scheduled query names must be unique within each Region.
        """
        return pulumi.get(self, "scheduled_query_name")
    ...
    def sq_error_report_configuration(self) -> pulumi.Output[builtins.str]:
        """
        Configuration for error reporting. Error reports will be generated when a problem is encountered when writing the query results.
        """
    ...
    def sq_kms_key_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def sq_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def sq_notification_configuration(self) -> pulumi.Output[builtins.str]:
        """
        Notification configuration for the scheduled query. A notification is sent by Timestream when a query run finishes, when the state is updated or when you delete it.
        """
    ...
    def sq_query_string(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def sq_schedule_configuration(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def sq_scheduled_query_execution_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN for the IAM role that Timestream will assume when running the scheduled query.
        """
    ...
    def sq_target_configuration(self) -> pulumi.Output[builtins.str]:
        """
