...
class InfluxDbInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] allocated_storage: The allocated storage for the InfluxDB instance.
        :param pulumi.Input[builtins.str] bucket: The bucket for the InfluxDB instance.
        :param pulumi.Input['InfluxDbInstanceDbInstanceType'] db_instance_type: The compute instance of the InfluxDB instance.
        :param pulumi.Input[builtins.str] db_parameter_group_identifier: The name of an existing InfluxDB parameter group.
        ...
        :param pulumi.Input[builtins.str] name: The unique name that is associated with the InfluxDB instance.
        :param pulumi.Input['InfluxDbInstanceNetworkType'] network_type: Network type of the InfluxDB Instance.
        :param pulumi.Input[builtins.str] organization: The organization for the InfluxDB instance.
        :param pulumi.Input[builtins.str] password: The password for the InfluxDB instance.
        :param pulumi.Input[builtins.int] port: The port number on which InfluxDB accepts connections.
        :param pulumi.Input[builtins.bool] publicly_accessible: Attach a public IP to the customer ENI.
        ...
        :param pulumi.Input[builtins.str] username: The username for the InfluxDB instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_security_group_ids: A list of Amazon EC2 VPC security groups to associate with this InfluxDB instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_subnet_ids: A list of EC2 subnet IDs for this InfluxDB instance.
        """
...
class InfluxDbInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcSubnetIds")
    def vpc_subnet_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of EC2 subnet IDs for this InfluxDB instance.
        """
        return pulumi.get(self, "vpc_subnet_ids")
