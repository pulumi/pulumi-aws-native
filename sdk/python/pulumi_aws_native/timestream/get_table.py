...
def get_table(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: The name for the database which the table to be created belongs to.
    :param builtins.str table_name: The name for the table. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the table name.
    """
    __args__ = dict()
