...
__all__ = [
    'InfluxDbClusterMaintenanceSchedule',
    'InfluxDbInstanceMaintenanceSchedule',
...
@pulumi.output_type
class InfluxDbClusterMaintenanceSchedule(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in InfluxDbClusterMaintenanceSchedule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        InfluxDbClusterMaintenanceSchedule.__key_warning(key)
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str preferred_maintenance_window: The preferred maintenance window in format ddd:HH:MM-ddd:HH:MM.
        :param _builtins.str timezone: The IANA timezone identifier for the maintenance schedule.
        """
...
@pulumi.output_type
class InfluxDbInstanceMaintenanceSchedule(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in InfluxDbInstanceMaintenanceSchedule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        InfluxDbInstanceMaintenanceSchedule.__key_warning(key)
        return super().__getitem__(key)
...
class MagneticStoreWritePropertiesPropertiesMagneticStoreRejectedDataLocationPropertiesS3ConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str object_key_prefix: String used to prefix all data in the bucket.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
class RetentionPropertiesProperties(dict):
    ...
    def __init__(__self__, *,
                 magnetic_store_retention_period_in_days: Optional[_builtins.str] = None,
    ...
    def magnetic_store_retention_period_in_days(self) -> Optional[_builtins.str]:
        """
    ...
    def memory_store_retention_period_in_hours(self) -> Optional[_builtins.str]:
        """
...
class ScheduledQueryTimestreamConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str measure_name_column: Name of the measure column. Also see `MultiMeasureMappings` and `MixedMeasureMappings` for how measure name properties on those relate to `MeasureNameColumn` .
