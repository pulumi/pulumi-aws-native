...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: The name for the database. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the database name.
        :param pulumi.Input[builtins.str] kms_key_id: The KMS key for the database. If the KMS key is not specified, the database will be encrypted with a Timestream managed KMS key located in your account.
