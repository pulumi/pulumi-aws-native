...
class GetScheduledQueryResult:
    ...
    def sq_error_report_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def sq_kms_key_id(self) -> Optional[builtins.str]:
        """
    ...
    def sq_name(self) -> Optional[builtins.str]:
        """
    ...
    def sq_notification_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def sq_query_string(self) -> Optional[builtins.str]:
        """
    ...
    def sq_schedule_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def sq_scheduled_query_execution_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def sq_target_configuration(self) -> Optional[builtins.str]:
        """
...
def get_scheduled_query(arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScheduledQueryResult:
    """
    The AWS::Timestream::ScheduledQuery resource creates a Timestream Scheduled Query.


    :param builtins.str arn: The `ARN` of the scheduled query.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_scheduled_query_output(arn: Optional[pulumi.Input[builtins.str]] = None,
