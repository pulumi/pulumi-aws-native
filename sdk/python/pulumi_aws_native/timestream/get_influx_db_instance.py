...
class GetInfluxDbInstanceResult:
    ...
    def db_parameter_group_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def influx_auth_parameters_secret_arn(self) -> Optional[builtins.str]:
        """
...
def get_influx_db_instance(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The service generated unique identifier for InfluxDB instance.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_influx_db_instance_output(id: Optional[pulumi.Input[builtins.str]] = None,
