...
class AutomationRuleCriteriaArgsDict(TypedDict):
    ebs_volume_size_in_gib: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleIntegerCriteriaConditionArgs']]]]]
    ebs_volume_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringCriteriaConditionArgs']]]]]
    estimated_monthly_savings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDoubleCriteriaConditionArgs']]]]]
    look_back_period_in_days: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleIntegerCriteriaConditionArgs']]]]]
    region: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringCriteriaConditionArgs']]]]]
    resource_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringCriteriaConditionArgs']]]]]
    resource_tag: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleResourceTagsCriteriaConditionArgs']]]]]
    restart_needed: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringCriteriaConditionArgs']]]]]
