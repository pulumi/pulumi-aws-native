...
class AssumeRole(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration for a Provider to assume a role.
        :param builtins.int duration_seconds: Number of seconds to restrict the assume role session duration.
        :param builtins.str external_id: External identifier to use when assuming the role.
        :param builtins.str policy: IAM Policy JSON describing further restricting permissions for the IAM Role being assumed.
        :param Sequence[builtins.str] policy_arns: Set of Amazon Resource Names (ARNs) of IAM Policies describing further restricting permissions for the role.
        :param builtins.str role_arn: Amazon Resource Name (ARN) of the IAM Role to assume.
        :param builtins.str session_name: Session name to use when assuming the role.
        :param Mapping[str, builtins.str] tags: Map of assume role session tags.
        :param Sequence[builtins.str] transitive_tag_keys: A list of keys for session tags that you want to set as transitive. If you set a tag key as transitive, the corresponding key and value passes to subsequent sessions in a role chain.
        """
...
class AutoNaming(dict):
    ...
    """
    def __init__(__self__, *,
                 auto_trim: Optional[builtins.bool] = None,
                 random_suffix_min_length: Optional[builtins.int] = None):
        """
        The configuration for automatically naming resources.
        :param builtins.bool auto_trim: Automatically trim the auto-generated name to meet the maximum length constraint.
        :param builtins.int random_suffix_min_length: The minimum length of the random suffix to append to the auto-generated name.
        """
    ...
    def auto_trim(self) -> Optional[builtins.bool]:
        """
    ...
    def random_suffix_min_length(self) -> Optional[builtins.int]:
        """
...
class DefaultTags(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration with resource tag settings to apply across all resources handled by this provider. This is designed to replace redundant per-resource `tags` configurations. Provider tags can be overridden with new values, but not excluded from specific resources. To override provider tag values, use the `tags` argument within a resource to configure new tag values for matching keys.
        :param Mapping[str, builtins.str] tags: A group of tags to set across all resources.
        """
        if tags is not None:
            pulumi.set(__self__, "tags", tags)
...
class Endpoints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration for for customizing service endpoints.
        :param builtins.str cloudcontrol: Override the default endpoint for AWS CloudControl
        :param builtins.str cloudformation: Override the default endpoint for AWS CloudFormation
        :param builtins.str ec2: Override the default endpoint for AWS Elastic Compute Cloud (EC2)
        :param builtins.str ssm: Override the default endpoint for AWS Systems Manager
        :param builtins.str sts: Override the default endpoint for AWS Security Token Service (STS)
        """
...
class IgnoreTags(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration with resource tag settings to ignore across all resources handled by this provider (except any individual service tag resources such as `ec2.Tag`) for situations where external systems are managing certain resource tags.
        :param Sequence[builtins.str] key_prefixes: List of exact resource tag keys to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning the tag in any `tags` attributes and displaying any configuration difference for the tag value. If any resource configuration still has this tag key configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.
        :param Sequence[builtins.str] keys: List of resource tag key prefixes to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning any tag key matching the prefixes in any `tags` attributes and displaying any configuration difference for those tag values. If any resource configuration still has a tag matching one of the prefixes configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.
        """
