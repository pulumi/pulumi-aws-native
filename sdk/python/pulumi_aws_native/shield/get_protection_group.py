...
class GetProtectionGroupResult:
    ...
    def protection_group_arn(self) -> Optional[builtins.str]:
        """
...
def get_protection_group(protection_group_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str protection_group_arn: The ARN (Amazon Resource Name) of the protection group.
    """
    __args__ = dict()
...
def get_protection_group_output(protection_group_arn: Optional[pulumi.Input[builtins.str]] = None,
