...
class ProtectionArgs:
    def __init__(__self__, *,
                 ...
                 health_check_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_check_arns: The Amazon Resource Names (ARNs) of the health check to associate with the protection.
        :param pulumi.Input[builtins.str] name: Friendly name for the Protection.
    ...
    def health_check_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def health_check_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Protection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="healthCheckArns")
    def health_check_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The Amazon Resource Names (ARNs) of the health check to associate with the protection.
        """
        return pulumi.get(self, "health_check_arns")
    ...
    def protection_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def protection_id(self) -> pulumi.Output[builtins.str]:
        """
