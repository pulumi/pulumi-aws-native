...
class ProtectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] health_check_arns: The Amazon Resource Names (ARNs) of the health check to associate with the protection.
        :param pulumi.Input[_builtins.str] name: Friendly name for the Protection.
...
class Protection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 application_layer_automatic_response_configuration: pulumi.Input[Optional[Union['ProtectionApplicationLayerAutomaticResponseConfigurationArgs', 'ProtectionApplicationLayerAutomaticResponseConfigurationArgsDict', 'outputs.ProtectionApplicationLayerAutomaticResponseConfiguration']]] = None,
                 health_check_arns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="healthCheckArns")
    def health_check_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The Amazon Resource Names (ARNs) of the health check to associate with the protection.
        """
        return pulumi.get(self, "health_check_arns")
    ...
    def protection_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def protection_id(self) -> pulumi.Output[_builtins.str]:
        """
