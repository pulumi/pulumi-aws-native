...
class ProtectionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protection_group_id: The name of the protection group. You use this to identify the protection group in lists and to manage the protection group, for example to update, delete, or describe it.
