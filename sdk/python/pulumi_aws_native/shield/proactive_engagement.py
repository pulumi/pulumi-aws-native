...
@pulumi.type_token("aws-native:shield:ProactiveEngagement")
class ProactiveEngagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 emergency_contact_list: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ProactiveEngagementEmergencyContactArgs', 'ProactiveEngagementEmergencyContactArgsDict', 'outputs.ProactiveEngagementEmergencyContact']]]]] = None,
