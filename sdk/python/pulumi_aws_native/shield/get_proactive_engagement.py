...
def get_proactive_engagement(account_id: Optional[builtins.str] = None,
...
def get_proactive_engagement_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
