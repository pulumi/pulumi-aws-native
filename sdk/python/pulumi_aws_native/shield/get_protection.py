...
class GetProtectionResult:
    ...
    def health_check_arns(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def protection_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def protection_id(self) -> Optional[_builtins.str]:
        """
...
def get_protection(protection_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str protection_arn: The ARN (Amazon Resource Name) of the protection.
    """
    __args__ = dict()
...
def get_protection_output(protection_arn: Optional[pulumi.Input[_builtins.str]] = None,
