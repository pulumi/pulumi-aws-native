...
if not MYPY:
    class ApiKeyRestrictionsArgsDict(TypedDict):
        ...
        - `geo-maps:GetMaptile` - Allows getting map tiles for rendering.
        ...
        """
        allow_referers: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
...
class ApiKeyRestrictionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allow_actions: A list of allowed actions that an API key resource grants permissions to perform. You must have at least one action for each type of resource. For example, if you have a place resource, you must include at least one place action.
               ...
               > You must use these strings exactly. For example, to provide access to map rendering, the only valid action is `geo:GetMap*` as an input to the list. `["geo:GetMap*"]` is valid but `["geo:GetMapTile"]` is not. Similarly, you cannot use `["geo:SearchPlaceIndexFor*"]` - you must list each of the Place actions separately.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allow_resources: A list of allowed resource ARNs that a API key bearer can perform actions on.
               ...
               For more information about ARN format, see [Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) .
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allow_referers: An optional list of allowed HTTP referers for which requests must originate from. Requests using this API key from other domains will not be allowed.
...
if not MYPY:
    class MapConfigurationArgsDict(TypedDict):
        ...
        """
        custom_layers: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        political_view: NotRequired[pulumi.Input[str]]
        """
...
class MapConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] style: Specifies the map style selected from an available data provider.
               ...
               - `VectorOpenDataVisualizationLight` – The Open Data Visualization Light map style is a light-themed style with muted colors and fewer features that aids in understanding overlaid data.
               - `VectorOpenDataVisualizationDark` – The Open Data Visualization Dark map style is a dark-themed style with muted colors and fewer features that aids in understanding overlaid data.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] custom_layers: Specifies the custom layers for the style. Leave unset to not enable any custom layer, or, for styles that support custom layers, you can enable layer(s), such as the `POI` layer for the VectorEsriNavigation style.
               
               > Currenlty only `VectorEsriNavigation` supports CustomLayers. For more information, see [Custom Layers](https://docs.aws.amazon.com//location/latest/developerguide/map-concepts.html#map-custom-layers) .
        :param pulumi.Input[str] political_view: Specifies the map political view selected from an available data provider.
        """
