...
class ApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] force_delete: ForceDelete bypasses an API key's expiry conditions and deletes the key. Set the parameter `true` to delete the key or to `false` to not preemptively delete the API key.
               
               Valid values: `true` , or `false` .
               
               > This action is irreversible. Only use ForceDelete if you are certain the key is no longer in use.
        :param pulumi.Input[_builtins.bool] force_update: The boolean flag to be included for updating `ExpireTime` or Restrictions details.
        ...
        :param pulumi.Input[_builtins.str] key_name: A custom name for the API key resource.
...
class ApiKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="noExpiry")
    def no_expiry(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether the API key should expire. Set to `true` to set the API key to have no expiration time.
        """
        return pulumi.get(self, "no_expiry")
