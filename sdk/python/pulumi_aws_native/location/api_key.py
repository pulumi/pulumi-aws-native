...
class ApiKeyArgs:
    def __init__(__self__, *,
                 ...
                 no_expiry: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Updates the description for the API key resource.
        :param pulumi.Input[builtins.str] expire_time: The optional timestamp for when the API key resource will expire in [ISO 8601 format](https://docs.aws.amazon.com/https://www.iso.org/iso-8601-date-and-time-format.html) .
        :param pulumi.Input[builtins.bool] force_delete: ForceDelete bypasses an API key's expiry conditions and deletes the key. Set the parameter `true` to delete the key or to `false` to not preemptively delete the API key.
               
               Valid values: `true` , or `false` .
               
               > This action is irreversible. Only use ForceDelete if you are certain the key is no longer in use.
        :param pulumi.Input[builtins.bool] force_update: The boolean flag to be included for updating `ExpireTime` or Restrictions details.
        ...
        :param pulumi.Input[builtins.str] key_name: A custom name for the API key resource.
        ...
        :param pulumi.Input[builtins.bool] no_expiry: Whether the API key should expire. Set to `true` to set the API key to have no expiration time.
    ...
    def no_expiry(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @no_expiry.setter
    def no_expiry(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ApiKey(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="noExpiry")
    def no_expiry(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the API key should expire. Set to `true` to set the API key to have no expiration time.
        """
        return pulumi.get(self, "no_expiry")
