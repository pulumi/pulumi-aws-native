...
class TrackerArgs:
    def __init__(__self__, *,
                 ...
                 event_bridge_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kms_key_enable_geospatial_queries: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 pricing_plan_data_source: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: An optional description for the tracker resource.
        :param pulumi.Input[builtins.str] kms_key_id: A key identifier for an [AWS KMS customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/create-keys.html) . Enter a key ID, key ARN, alias name, or alias ARN.
        ...
        :param pulumi.Input[builtins.str] pricing_plan_data_source: This shape is deprecated since 2022-02-01: Deprecated. No longer allowed.
    ...
    def event_bridge_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "event_bridge_enabled")

    @event_bridge_enabled.setter
    def event_bridge_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "event_bridge_enabled", value)

    @property
    @pulumi.getter(name="kmsKeyEnableGeospatialQueries")
    def kms_key_enable_geospatial_queries(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "kms_key_enable_geospatial_queries")

    @kms_key_enable_geospatial_queries.setter
    def kms_key_enable_geospatial_queries(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pricing_plan_data_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pricing_plan_data_source(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Tracker(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="eventBridgeEnabled")
    def event_bridge_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "event_bridge_enabled")

    @property
    @pulumi.getter(name="kmsKeyEnableGeospatialQueries")
    def kms_key_enable_geospatial_queries(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "kms_key_enable_geospatial_queries")
    ...
    @property
    @pulumi.getter(name="pricingPlanDataSource")
    def pricing_plan_data_source(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This shape is deprecated since 2022-02-01: Deprecated. No longer allowed.
        """
        return pulumi.get(self, "pricing_plan_data_source")
