...
class GetTrackerResult:
    ...
    def event_bridge_enabled(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "event_bridge_enabled")

    @_builtins.property
    @pulumi.getter(name="kmsKeyEnableGeospatialQueries")
    def kms_key_enable_geospatial_queries(self) -> Optional[_builtins.bool]:
    ...
    def pricing_plan_data_source(self) -> Optional[_builtins.str]:
        """
    ...
    def tracker_arn(self) -> Optional[_builtins.str]:
        """
...
def get_tracker(tracker_name: Optional[_builtins.str] = None,
