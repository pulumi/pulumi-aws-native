...
class GetGeofenceCollectionResult:
    ...
    def collection_arn(self) -> Optional[builtins.str]:
        """
    ...
    def pricing_plan_data_source(self) -> Optional[builtins.str]:
        """
...
def get_geofence_collection(collection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str collection_name: A custom name for the geofence collection.
