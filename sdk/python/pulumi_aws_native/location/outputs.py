...
class ApiKeyRestrictions(dict):
    ...
    def __init__(__self__, *,
                 allow_actions: Sequence[builtins.str],
                 allow_resources: Sequence[builtins.str],
                 allow_referers: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] allow_actions: A list of allowed actions that an API key resource grants permissions to perform. You must have at least one action for each type of resource. For example, if you have a place resource, you must include at least one place action.
        ...
        :param Sequence[builtins.str] allow_resources: A list of allowed resource ARNs that a API key bearer can perform actions on.
        ...
        :param Sequence[builtins.str] allow_referers: An optional list of allowed HTTP referers for which requests must originate from. Requests using this API key from other domains will not be allowed.
    ...
    def allow_actions(self) -> Sequence[builtins.str]:
        """
    ...
    def allow_resources(self) -> Sequence[builtins.str]:
        """
    ...
    def allow_referers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MapConfiguration(dict):
    ...
    def __init__(__self__, *,
                 style: builtins.str,
                 custom_layers: Optional[Sequence[builtins.str]] = None,
                 political_view: Optional[builtins.str] = None):
        """
        :param builtins.str style: Specifies the map style selected from an available data provider.
        ...
        :param Sequence[builtins.str] custom_layers: Specifies the custom layers for the style. Leave unset to not enable any custom layer, or, for styles that support custom layers, you can enable layer(s), such as the `POI` layer for the VectorEsriNavigation style.
        ...
        :param builtins.str political_view: Specifies the map political view selected from an available data provider.
        """
    ...
    def custom_layers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def political_view(self) -> Optional[builtins.str]:
        """
