...
class GeofenceCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] collection_name: A custom name for the geofence collection.
        ...
        :param pulumi.Input[_builtins.str] description: An optional description for the geofence collection.
...
@pulumi.type_token("aws-native:location:GeofenceCollection")
