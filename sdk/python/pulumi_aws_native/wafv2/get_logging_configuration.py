...
class GetLoggingConfigurationResult:
    ...
    def log_destination_configs(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def managed_by_firewall_manager(self) -> Optional[_builtins.bool]:
        """
...
def get_logging_configuration(resource_arn: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingConfigurationResult:
    """
    A WAFv2 Logging Configuration Resource Provider


    :param _builtins.str resource_arn: The Amazon Resource Name (ARN) of the web ACL that you want to associate with LogDestinationConfigs.
    """
    __args__ = dict()
