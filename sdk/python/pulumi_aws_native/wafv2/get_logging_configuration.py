...
class GetLoggingConfigurationResult:
    ...
    def log_destination_configs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def managed_by_firewall_manager(self) -> Optional[builtins.bool]:
        """
...
def get_logging_configuration(resource_arn: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingConfigurationResult:
    """
    A WAFv2 Logging Configuration Resource Provider


    :param builtins.str resource_arn: The Amazon Resource Name (ARN) of the web ACL that you want to associate with LogDestinationConfigs.
    """
    __args__ = dict()
...
def get_logging_configuration_output(resource_arn: Optional[pulumi.Input[builtins.str]] = None,
