...
class WebAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description of the web ACL that helps with identification.
        :param pulumi.Input[_builtins.str] name: The name of the web ACL. You cannot change the name of a web ACL after you create it.
...
class WebAcl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 application_config: pulumi.Input[Optional[Union['WebAclApplicationConfigArgs', 'WebAclApplicationConfigArgsDict', 'outputs.WebAclApplicationConfig']]] = None,
                 ...
                 custom_response_bodies: pulumi.Input[Optional[Mapping[str, pulumi.Input[Union['WebAclCustomResponseBodyArgs', 'WebAclCustomResponseBodyArgsDict', 'outputs.WebAclCustomResponseBody']]]]] = None,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 monetization_config: pulumi.Input[Optional[Union['WebAclMonetizationConfigArgs', 'WebAclMonetizationConfigArgsDict', 'outputs.WebAclMonetizationConfig']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 on_source_d_do_s_protection_config: pulumi.Input[Optional[Union['WebAclOnSourceDDoSProtectionConfigArgs', 'WebAclOnSourceDDoSProtectionConfigArgsDict', 'outputs.WebAclOnSourceDDoSProtectionConfig']]] = None,
        ...
        :param pulumi.Input[Union['WebAclApplicationConfigArgs', 'WebAclApplicationConfigArgsDict', 'outputs.WebAclApplicationConfig']] application_config: Collection of application attributes.
        :param pulumi.Input[Union['WebAclAssociationConfigArgs', 'WebAclAssociationConfigArgsDict', 'outputs.WebAclAssociationConfig']] association_config: Specifies custom configurations for the associations between the web ACL and protected resources.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['WebAclCustomResponseBodyArgs', 'WebAclCustomResponseBodyArgsDict', 'outputs.WebAclCustomResponseBody']]]] custom_response_bodies: A map of custom response keys and content bodies. When you create a rule with a block action, you can send a custom response to the web request. You define these for the web ACL, and then use them in the rules and default actions that you define in the web ACL.
               
               For information about customizing web requests and responses, see [Customizing web requests and responses in AWS WAF](https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html) in the *AWS WAF Developer Guide* .
               
               For information about the limits on count and size for custom request and response settings, see [AWS WAF quotas](https://docs.aws.amazon.com/waf/latest/developerguide/limits.html) in the *AWS WAF Developer Guide* .
        :param pulumi.Input[Union['WebAclDataProtectionConfigArgs', 'WebAclDataProtectionConfigArgsDict', 'outputs.WebAclDataProtectionConfig']] data_protection_config: Collection of dataProtects.
        :param pulumi.Input[Union['WebAclDefaultActionArgs', 'WebAclDefaultActionArgsDict', 'outputs.WebAclDefaultAction']] default_action: The action to perform if none of the `Rules` contained in the `WebACL` match.
        :param pulumi.Input[_builtins.str] description: A description of the web ACL that helps with identification.
        :param pulumi.Input[_builtins.str] name: The name of the web ACL. You cannot change the name of a web ACL after you create it.
        :param pulumi.Input[Union['WebAclOnSourceDDoSProtectionConfigArgs', 'WebAclOnSourceDDoSProtectionConfigArgsDict', 'outputs.WebAclOnSourceDDoSProtectionConfig']] on_source_d_do_s_protection_config: Configures the level of DDoS protection that applies to web ACLs associated with Application Load Balancers.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WebAclRuleArgs', 'WebAclRuleArgsDict', 'outputs.WebAclRule']]]] rules: Collection of Rules.
        :param pulumi.Input['WebAclScope'] scope: Specifies whether this is for an Amazon CloudFront distribution or for a regional application. For an AWS Amplify application, use `CLOUDFRONT` . A regional application can be an Application Load Balancer (ALB), an  REST API, an AWS AppSync GraphQL API, an Amazon Cognito user pool, an AWS App Runner service, or an AWS Verified Access instance. Valid Values are `CLOUDFRONT` and `REGIONAL` .
               
               > For `CLOUDFRONT` , you must create your WAFv2 resources in the US East (N. Virginia) Region, `us-east-1` .
               
               For information about how to define the association of the web ACL with your resource, see `WebACLAssociation` .
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Key:value pairs associated with an AWS resource. The key:value pair can be anything you define. Typically, the tag key represents a category (such as "environment") and the tag value represents a specific value within that category (such as "test," "development," or "production"). You can add up to 50 tags to each AWS resource.
               
               > To modify tags on existing resources, use the AWS WAF APIs or command line interface. With AWS CloudFormation , you can only add tags to AWS WAF resources during resource creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] token_domains: Specifies the domains that AWS WAF should accept in a web request token. This enables the use of tokens across multiple protected websites. When AWS WAF provides a token, it uses the domain of the AWS resource that the web ACL is protecting. If you don't specify a list of token domains, AWS WAF accepts tokens only for the domain of the protected resource. With a token domain list, AWS WAF accepts the resource's host domain plus all domains in the token domain list, including their prefixed subdomains.
        :param pulumi.Input[Union['WebAclVisibilityConfigArgs', 'WebAclVisibilityConfigArgsDict', 'outputs.WebAclVisibilityConfig']] visibility_config: Defines and enables Amazon CloudWatch metrics and web request sample collection.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def label_namespace(self) -> pulumi.Output[_builtins.str]:
        """
