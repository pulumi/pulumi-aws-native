...
class WebAcl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(association_config, WebAclAssociationConfigArgs):
            ...
            if not isinstance(captcha_config, WebAclCaptchaConfigArgs):
            ...
            if not isinstance(challenge_config, WebAclChallengeConfigArgs):
            ...
            if not isinstance(custom_response_bodies, WebAclCustomResponseBodiesArgs):
            ...
            if not isinstance(default_action, WebAclDefaultActionArgs):
            ...
            if not isinstance(visibility_config, WebAclVisibilityConfigArgs):
