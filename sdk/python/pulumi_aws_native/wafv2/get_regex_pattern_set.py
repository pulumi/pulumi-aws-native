...
class GetRegexPatternSetResult:
    ...
    def regular_expression_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_regex_pattern_set(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Id of the RegexPatternSet
    :param builtins.str name: Name of the RegexPatternSet.
...
def get_regex_pattern_set_output(id: Optional[pulumi.Input[builtins.str]] = None,
