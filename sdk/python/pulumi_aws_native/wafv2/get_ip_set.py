...
def get_ip_set(id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the IP set. You cannot change the name of an `IPSet` after you create it.
...
def get_ip_set_output(id: Optional[pulumi.Input[builtins.str]] = None,
