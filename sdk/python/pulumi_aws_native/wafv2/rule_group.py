...
class RuleGroupArgs:
    ...
    def _configure(
        ...
        if available_labels is not None:
            _setter("available_labels", available_labels)
        if consumed_labels is not None:
            _setter("consumed_labels", consumed_labels)
...
class RuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(custom_response_bodies, RuleGroupCustomResponseBodiesArgs):
            ...
            if not isinstance(visibility_config, RuleGroupVisibilityConfigArgs):
