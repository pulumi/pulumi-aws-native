...
class RuleGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] capacity: The web ACL capacity units (WCUs) required for this rule group.
        ...
        :param pulumi.Input[builtins.str] description: A description of the rule group that helps with identification.
        :param pulumi.Input[builtins.str] name: The name of the rule group. You cannot change the name of a rule group after you create it.
