...
class LoggingConfigurationConditionLabelNameConditionPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        A single label name condition.
        :param pulumi.Input[builtins.str] label_name: The label name that a log record must contain in order to meet the condition. This must be a fully qualified label name. Fully qualified labels have a prefix, optional namespaces, and label name. The prefix identifies the rule group or web ACL context of the rule that added the label. 
        """
...
class LoggingConfigurationFieldToMatchSingleHeaderPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Inspect a single header. Provide the name of the header to inspect, for example, User-Agent or Referer. This setting isn't case sensitive.
        :param pulumi.Input[builtins.str] name: The name of the query header to inspect.
        """
...
class RuleGroupAsnMatchStatementArgs:
    ...
    @asn_list.setter
    def asn_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
if not MYPY:
    class RuleGroupByteMatchStatementArgsDict(TypedDict):
        ...
        *ENDS_WITH*
        ...
        """
        search_string_base64: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuleGroupByteMatchStatementArgs:
    def __init__(__self__, *,
                 ...
                 search_string_base64: Optional[pulumi.Input[builtins.str]] = None):
        """
        Byte Match statement.
        ...
        :param pulumi.Input[builtins.str] search_string: A string value that you want AWS WAF to search for. AWS WAF searches only in the part of web requests that you designate for inspection in `FieldToMatch` . The maximum length of the value is 200 bytes. For alphabetic characters A-Z and a-z, the value is case sensitive.
               ...
               You must specify either `SearchString` or `SearchStringBase64` in a `ByteMatchStatement` .
        :param pulumi.Input[builtins.str] search_string_base64: String to search for in a web request component, base64-encoded. If you don't want to encode the string, specify the unencoded value in `SearchString` instead.
    ...
    def search_string_base64(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String to search for in a web request component, base64-encoded. If you don't want to encode the string, specify the unencoded value in `SearchString` instead.
    ...
    def search_string_base64(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RuleGroupCookieMatchPatternArgsDict(TypedDict):
        ...
        """
        excluded_cookies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Inspect only the cookies whose keys don't match any of the strings specified here.
        """
        included_cookies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleGroupCookieMatchPatternArgs:
    def __init__(__self__, *,
                 ...
                 excluded_cookies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_cookies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The pattern to look for in the request cookies.
        :param Any all: Inspect all parts of the web request cookies.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_cookies: Inspect only the cookies whose keys don't match any of the strings specified here.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_cookies: Inspect only the cookies that have a key that matches one of the strings specified here.
        """
        if all is not None:
    ...
    def excluded_cookies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Inspect only the cookies whose keys don't match any of the strings specified here.
        """
    ...
    def excluded_cookies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_cookies", value)

    @property
    @pulumi.getter(name="includedCookies")
    def included_cookies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Inspect only the cookies that have a key that matches one of the strings specified here.
        """
    ...
    def included_cookies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RuleGroupCustomHttpHeaderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the custom header.
               ...
               For custom request header insertion, when AWS WAF inserts the header into the request, it prefixes this name `x-amzn-waf-` , to avoid confusion with the headers that are already in the request. For example, for the header name `sample` , AWS WAF inserts the header `x-amzn-waf-sample` .
        :param pulumi.Input[builtins.str] value: The value of the custom header.
        """
        pulumi.set(__self__, "name", name)
...
class RuleGroupCustomResponseBodyArgs:
    def __init__(__self__, *,
        ...
        """
        Custom response body.
        :param pulumi.Input[builtins.str] content: The payload of the custom response.
...
if not MYPY:
    class RuleGroupCustomResponseArgsDict(TypedDict):
        ...
        Custom response.
        """
        response_code: pulumi.Input[builtins.int]
        """
        ...
        """
        custom_response_body_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuleGroupCustomResponseArgs:
    def __init__(__self__, *,
                 response_code: pulumi.Input[builtins.int],
                 custom_response_body_key: Optional[pulumi.Input[builtins.str]] = None,
                 response_headers: Optional[pulumi.Input[Sequence[pulumi.Input['RuleGroupCustomHttpHeaderArgs']]]] = None):
        """
        Custom response.
        :param pulumi.Input[builtins.int] response_code: The HTTP status code to return to the client.
               
               For a list of status codes that you can use in your custom responses, see [Supported status codes for custom response](https://docs.aws.amazon.com/waf/latest/developerguide/customizing-the-response-status-codes.html) in the *AWS WAF Developer Guide* .
        :param pulumi.Input[builtins.str] custom_response_body_key: Custom response body key.
    ...
    def response_code(self) -> pulumi.Input[builtins.int]:
        """
        The HTTP status code to return to the client.
    ...
    def response_code(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "response_code", value)

    @property
    @pulumi.getter(name="customResponseBodyKey")
    def custom_response_body_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Custom response body key.
        """
    ...
    def custom_response_body_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleGroupForwardedIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RuleGroupForwardedIpConfigurationFallbackBehavior'] fallback_behavior: The match status to assign to the web request if the request doesn't have a valid IP address in the specified position.
               ...
               - `MATCH` - Treat the web request as matching the rule statement. AWS WAF applies the rule action to the request.
               - `NO_MATCH` - Treat the web request as not matching the rule statement.
        :param pulumi.Input[builtins.str] header_name: The name of the HTTP header to use for the IP address. For example, to use the X-Forwarded-For (XFF) header, set this to `X-Forwarded-For` .
...
if not MYPY:
    class RuleGroupGeoMatchStatementArgsDict(TypedDict):
        country_codes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleGroupGeoMatchStatementArgs:
    def __init__(__self__, *,
                 country_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 forwarded_ip_config: Optional[pulumi.Input['RuleGroupForwardedIpConfigurationArgs']] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] country_codes: An array of two-character country codes that you want to match against, for example, `[ "US", "CN" ]` , from the alpha-2 country ISO codes of the ISO 3166 international standard.
    ...
    def country_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of two-character country codes that you want to match against, for example, `[ "US", "CN" ]` , from the alpha-2 country ISO codes of the ISO 3166 international standard.
    ...
    def country_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RuleGroupHeaderMatchPatternArgsDict(TypedDict):
        ...
        """
        excluded_headers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Inspect only the headers whose keys don't match any of the strings specified here.
        """
        included_headers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleGroupHeaderMatchPatternArgs:
    def __init__(__self__, *,
                 all: Optional[Any] = None,
                 excluded_headers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_headers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The pattern to look for in the request headers.
        :param Any all: Inspect all parts of the web request headers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_headers: Inspect only the headers whose keys don't match any of the strings specified here.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_headers: Inspect only the headers that have a key that matches one of the strings specified here.
        """
        if all is not None:
            pulumi.set(__self__, "all", all)
    ...
    def excluded_headers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Inspect only the headers whose keys don't match any of the strings specified here.
        """
    ...
    def excluded_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_headers", value)

    @property
    @pulumi.getter(name="includedHeaders")
    def included_headers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Inspect only the headers that have a key that matches one of the strings specified here.
        """
    ...
    def included_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RuleGroupImmunityTimePropertyArgsDict(TypedDict):
        immunity_time: pulumi.Input[builtins.int]
        """
...
class RuleGroupImmunityTimePropertyArgs:
    def __init__(__self__, *,
                 immunity_time: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] immunity_time: The amount of time, in seconds, that a `CAPTCHA` or challenge timestamp is considered valid by AWS WAF . The default setting is 300.
    ...
    def immunity_time(self) -> pulumi.Input[builtins.int]:
        """
        The amount of time, in seconds, that a `CAPTCHA` or challenge timestamp is considered valid by AWS WAF . The default setting is 300.
    ...
    def immunity_time(self, value: pulumi.Input[builtins.int]):
...
class RuleGroupIpSetReferenceStatementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the `IPSet` that this statement references.
...
class RuleGroupJsonMatchPatternArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_paths: Match only the specified include paths. See also `MatchScope` in the `JsonBody` `FieldToMatch` specification.
...
class RuleGroupLabelMatchStatementArgs:
    def __init__(__self__, *,
                 ...
                 scope: pulumi.Input['RuleGroupLabelMatchScope']):
        """
        :param pulumi.Input[builtins.str] key: The string to match against. The setting you provide for this depends on the match statement's `Scope` setting:
...
class RuleGroupLabelSummaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: An individual label specification.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class RuleGroupLabelArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The label string.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class RuleGroupRateBasedStatementArgsDict(TypedDict):
        ...
        """
        evaluation_window_sec: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RuleGroupRateBasedStatementArgs:
    def __init__(__self__, *,
                 ...
                 evaluation_window_sec: Optional[pulumi.Input[builtins.int]] = None,
                 forwarded_ip_config: Optional[pulumi.Input['RuleGroupForwardedIpConfigurationArgs']] = None,
        ...
        :param pulumi.Input['RuleGroupRateBasedStatementAggregateKeyType'] aggregate_key_type: Setting that indicates how to aggregate the request counts.
               ...
               To aggregate on a combination of the IP address with other aggregate keys, use `CUSTOM_KEYS` .
        :param pulumi.Input[builtins.int] limit: The limit on requests during the specified evaluation window for a single aggregation instance for the rate-based rule. If the rate-based statement includes a `ScopeDownStatement` , this limit is applied only to the requests that match the statement.
    ...
    def evaluation_window_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of time, in seconds, that AWS WAF should include in its request counts, looking back from the current time. For example, for a setting of 120, when AWS WAF checks the rate, it counts the requests for the 2 minutes immediately preceding the current time. Valid settings are 60, 120, 300, and 600.
    ...
    def evaluation_window_sec(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RuleGroupRateLimitCookieArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a cookie as an aggregate key for a rate-based rule.
        :param pulumi.Input[builtins.str] name: The name of the cookie to use.
...
class RuleGroupRateLimitHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a header as an aggregate key for a rate-based rule.
        :param pulumi.Input[builtins.str] name: The name of the header to use.
        :param pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]] text_transformations: Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. Text transformations are used in rule match statements, to transform the `FieldToMatch` request component before inspecting it, and they're used in rate-based rule statements, to transform request components before using them as custom aggregation keys. If you specify one or more transformations to apply, AWS WAF performs all transformations on the specified content, starting from the lowest priority setting, and then uses the transformed component contents.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "text_transformations", text_transformations)
...
class RuleGroupRateLimitLabelNamespaceArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a label namespace to use as an aggregate key for a rate-based rule.
        :param pulumi.Input[builtins.str] namespace: The namespace to use for aggregation.
        """
...
class RuleGroupRateLimitQueryArgumentArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a query argument in the request as an aggregate key for a rate-based rule.
        :param pulumi.Input[builtins.str] name: The name of the query argument to use.
        :param pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]] text_transformations: Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. Text transformations are used in rule match statements, to transform the `FieldToMatch` request component before inspecting it, and they're used in rate-based rule statements, to transform request components before using them as custom aggregation keys. If you specify one or more transformations to apply, AWS WAF performs all transformations on the specified content, starting from the lowest priority setting, and then uses the transformed component contents.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "text_transformations", text_transformations)
...
if not MYPY:
    class RuleGroupRegexMatchStatementArgsDict(TypedDict):
        ...
        The part of the web request that you want AWS WAF to inspect.
        """
        regex_string: pulumi.Input[builtins.str]
        """
...
class RuleGroupRegexMatchStatementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input['RuleGroupFieldToMatchArgs'] field_to_match: The part of the web request that you want AWS WAF to inspect.
        :param pulumi.Input[builtins.str] regex_string: The string representing the regular expression.
        :param pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]] text_transformations: Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. If you specify one or more transformations in a rule statement, AWS WAF performs all transformations on the content of the request component identified by `FieldToMatch` , starting from the lowest priority setting, before inspecting the content for a match.
        """
        pulumi.set(__self__, "field_to_match", field_to_match)
    ...
    def regex_string(self) -> pulumi.Input[builtins.str]:
        """
        The string representing the regular expression.
        """
    ...
    @regex_string.setter
    def regex_string(self, value: pulumi.Input[builtins.str]):
...
class RuleGroupRegexPatternSetReferenceStatementArgs:
    def __init__(__self__, *,
                 ...
                 text_transformations: pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]]):
        """
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the `RegexPatternSet` that this statement references.
        :param pulumi.Input['RuleGroupFieldToMatchArgs'] field_to_match: The part of the web request that you want AWS WAF to inspect.
        :param pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]] text_transformations: Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. If you specify one or more transformations in a rule statement, AWS WAF performs all transformations on the content of the request component identified by `FieldToMatch` , starting from the lowest priority setting, before inspecting the content for a match.
        """
        pulumi.set(__self__, "arn", arn)
...
class RuleGroupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the rule.
               ...
               If you change the name of a `Rule` after you create it and you want the rule's metric name to reflect the change, update the metric name in the rule's `VisibilityConfig` settings. AWS WAF doesn't automatically update the metric name when you update the rule name.
        :param pulumi.Input[builtins.int] priority: If you define more than one `Rule` in a `WebACL` , AWS WAF evaluates each request against the `Rules` in order based on the value of `Priority` . AWS WAF processes rules with lower priority first. The priorities don't need to be consecutive, but they must all be different.
...
class RuleGroupSizeConstraintStatementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RuleGroupFieldToMatchArgs'] field_to_match: The part of the web request that you want AWS WAF to inspect.
        :param pulumi.Input[builtins.float] size: The size, in byte, to compare to the request part, after any transformations.
        :param pulumi.Input[Sequence[pulumi.Input['RuleGroupTextTransformationArgs']]] text_transformations: Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. If you specify one or more transformations in a rule statement, AWS WAF performs all transformations on the content of the request component identified by `FieldToMatch` , starting from the lowest priority setting, before inspecting the content for a match.
        """
...
class RuleGroupTextTransformationArgs:
    def __init__(__self__, *,
        ...
        """
        Text Transformation on the Search String before match.
        :param pulumi.Input[builtins.int] priority: Sets the relative processing order for multiple transformations. AWS WAF processes all transformations, from lowest priority to highest, before inspecting the transformed content. The priorities don't need to be consecutive, but they must all be different.
...
if not MYPY:
    class RuleGroupVisibilityConfigArgsDict(TypedDict):
        ...
        """
        cloud_watch_metrics_enabled: pulumi.Input[builtins.bool]
        """
        ...
        """
        sampled_requests_enabled: pulumi.Input[builtins.bool]
        """
...
class RuleGroupVisibilityConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Visibility Metric of the RuleGroup.
        :param pulumi.Input[builtins.bool] cloud_watch_metrics_enabled: Indicates whether the associated resource sends metrics to Amazon CloudWatch. For the list of available metrics, see [AWS WAF Metrics](https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#waf-metrics) in the *AWS WAF Developer Guide* .
               
               For web ACLs, the metrics are for web requests that have the web ACL default action applied. AWS WAF applies the default action to web requests that pass the inspection of all rules in the web ACL without being either allowed or blocked. For more information,
               see [The web ACL default action](https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-default-action.html) in the *AWS WAF Developer Guide* .
        :param pulumi.Input[builtins.str] metric_name: A name of the Amazon CloudWatch metric dimension. The name can contain only the characters: A-Z, a-z, 0-9, - (hyphen), and _ (underscore). The name can be from one to 128 characters long. It can't contain whitespace or metric names that are reserved for AWS WAF , for example `All` and `Default_Action` .
        :param pulumi.Input[builtins.bool] sampled_requests_enabled: Indicates whether AWS WAF should store a sampling of the web requests that match the rules. You can view the sampled requests through the AWS WAF console.
    ...
    def cloud_watch_metrics_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Indicates whether the associated resource sends metrics to Amazon CloudWatch. For the list of available metrics, see [AWS WAF Metrics](https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#waf-metrics) in the *AWS WAF Developer Guide* .
    ...
    def cloud_watch_metrics_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def sampled_requests_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Indicates whether AWS WAF should store a sampling of the web requests that match the rules. You can view the sampled requests through the AWS WAF console.
    ...
    def sampled_requests_enabled(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class WebAclAwsManagedRulesAcfpRuleSetArgsDict(TypedDict):
        ...
        """
        creation_path: pulumi.Input[builtins.str]
        """
        ...
        """
        registration_page_path: pulumi.Input[builtins.str]
        """
        ...
        """
        enable_regex_in_path: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WebAclAwsManagedRulesAcfpRuleSetArgs:
    def __init__(__self__, *,
                 ...
                 enable_regex_in_path: Optional[pulumi.Input[builtins.bool]] = None,
                 response_inspection: Optional[pulumi.Input['WebAclResponseInspectionArgs']] = None):
        """
        Configures how to use the Account creation fraud prevention managed rule group in the web ACL
        :param pulumi.Input[builtins.str] creation_path: The path of the account creation endpoint for your application. This is the page on your website that accepts the completed registration form for a new user. This page must accept `POST` requests.
               
               For example, for the URL `https://example.com/web/newaccount` , you would provide the path `/web/newaccount` . Account creation page paths that start with the path that you provide are considered a match. For example `/web/newaccount` matches the account creation paths `/web/newaccount` , `/web/newaccount/` , `/web/newaccountPage` , and `/web/newaccount/thisPage` , but doesn't match the path `/home/web/newaccount` or `/website/newaccount` .
        :param pulumi.Input[builtins.str] registration_page_path: The path of the account registration endpoint for your application. This is the page on your website that presents the registration form to new users.
        ...
        :param pulumi.Input[builtins.bool] enable_regex_in_path: Allow the use of regular expressions in the registration page path and the account creation path.
    ...
    def creation_path(self) -> pulumi.Input[builtins.str]:
        """
        The path of the account creation endpoint for your application. This is the page on your website that accepts the completed registration form for a new user. This page must accept `POST` requests.
    ...
    def creation_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "creation_path", value)

    @property
    @pulumi.getter(name="registrationPagePath")
    def registration_page_path(self) -> pulumi.Input[builtins.str]:
        """
        The path of the account registration endpoint for your application. This is the page on your website that presents the registration form to new users.
    ...
    def registration_page_path(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_regex_in_path(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allow the use of regular expressions in the registration page path and the account creation path.
        """
    ...
    def enable_regex_in_path(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebAclAwsManagedRulesAtpRuleSetArgs:
    def __init__(__self__, *,
        ...
        """
        Configures how to use the Account Takeover Prevention managed rule group in the web ACL
        :param pulumi.Input[builtins.str] login_path: The path of the login endpoint for your application. For example, for the URL `https://example.com/web/login` , you would provide the path `/web/login` . Login paths that start with the path that you provide are considered a match. For example `/web/login` matches the login paths `/web/login` , `/web/login/` , `/web/loginPage` , and `/web/login/thisPage` , but doesn't match the login path `/home/web/login` or `/website/login` .
               
               The rule group inspects only HTTP `POST` requests to your specified login endpoint.
        :param pulumi.Input[builtins.bool] enable_regex_in_path: Allow the use of regular expressions in the login page path.
    ...
    def login_path(self) -> pulumi.Input[builtins.str]:
        """
        The path of the login endpoint for your application. For example, for the URL `https://example.com/web/login` , you would provide the path `/web/login` . Login paths that start with the path that you provide are considered a match. For example `/web/login` matches the login paths `/web/login` , `/web/login/` , `/web/loginPage` , and `/web/login/thisPage` , but doesn't match the login path `/home/web/login` or `/website/login` .
    ...
    @login_path.setter
    def login_path(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class WebAclAwsManagedRulesBotControlRuleSetArgsDict(TypedDict):
        ...
        """
        enable_machine_learning: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WebAclAwsManagedRulesBotControlRuleSetArgs:
    def __init__(__self__, *,
                 inspection_level: pulumi.Input['WebAclAwsManagedRulesBotControlRuleSetInspectionLevel'],
                 enable_machine_learning: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Configures how to use the Bot Control managed rule group in the web ACL
        ...
        :param pulumi.Input[builtins.bool] enable_machine_learning: Applies only to the targeted inspection level.
    ...
    def enable_machine_learning(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Applies only to the targeted inspection level.
    ...
    def enable_machine_learning(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebAclExcludedRuleArgs:
    def __init__(__self__, *,
        ...
        """
        Excluded Rule in the RuleGroup or ManagedRuleGroup will not be evaluated.
        :param pulumi.Input[builtins.str] name: The name of the rule whose action you want to override to `Count` .
        """
        pulumi.set(__self__, "name", name)
...
class WebAclFieldIdentifierArgs:
    def __init__(__self__, *,
                 identifier: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] identifier: The name of the field.
...
class WebAclFieldToProtectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] field_keys: List of field keys to protect
        """
...
if not MYPY:
    class WebAclManagedRuleGroupConfigArgsDict(TypedDict):
        ...
        """
        login_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WebAclManagedRuleGroupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] login_path: > Instead of this setting, provide your configuration under `AWSManagedRulesATPRuleSet` .
    ...
    @property
    @pulumi.getter(name="loginPath")
    def login_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        > Instead of this setting, provide your configuration under `AWSManagedRulesATPRuleSet` .
        """
        return pulumi.get(self, "login_path")
    ...
    @login_path.setter
    def login_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "login_path", value)
...
class WebAclManagedRuleGroupStatementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the managed rule group. You use this, along with the vendor name, to identify the rule group.
        :param pulumi.Input[builtins.str] vendor_name: The name of the managed rule group vendor. You use this, along with the rule group name, to identify a rule group.
        ...
        :param pulumi.Input[builtins.str] version: The version of the managed rule group to use. If you specify this, the version setting is fixed until you change it. If you don't specify this, AWS WAF uses the vendor's default version, and then keeps the version at the vendor's default when the vendor updates the managed rule group settings.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class WebAclResponseInspectionBodyContainsArgsDict(TypedDict):
        ...
        """
        failure_strings: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Strings in the body of the response that indicate a failed login or account creation attempt. To be counted as a failure, the string can be anywhere in the body and must be an exact match, including case. Each string must be unique among the success and failure strings.

        JSON example: `"FailureStrings": [ "Request failed" ]`
        """
        success_strings: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class WebAclResponseInspectionBodyContainsArgs:
    def __init__(__self__, *,
        ...
        """
        Response body contents that indicate success or failure of a login request
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] failure_strings: Strings in the body of the response that indicate a failed login or account creation attempt. To be counted as a failure, the string can be anywhere in the body and must be an exact match, including case. Each string must be unique among the success and failure strings.
               
               JSON example: `"FailureStrings": [ "Request failed" ]`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] success_strings: Strings in the body of the response that indicate a successful login or account creation attempt. To be counted as a success, the string can be anywhere in the body and must be an exact match, including case. Each string must be unique among the success and failure strings.
    ...
    def failure_strings(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Strings in the body of the response that indicate a failed login or account creation attempt. To be counted as a failure, the string can be anywhere in the body and must be an exact match, including case. Each string must be unique among the success and failure strings.
    ...
    def failure_strings(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "failure_strings", value)

    @property
    @pulumi.getter(name="successStrings")
    def success_strings(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Strings in the body of the response that indicate a successful login or account creation attempt. To be counted as a success, the string can be anywhere in the body and must be an exact match, including case. Each string must be unique among the success and failure strings.
    ...
    def success_strings(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class WebAclResponseInspectionHeaderArgsDict(TypedDict):
        ...
        """
        failure_values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        success_values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class WebAclResponseInspectionHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        Response headers that indicate success or failure of a login request
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] failure_values: Values in the response header with the specified name that indicate a failed login or account creation attempt. To be counted as a failure, the value must be an exact match, including case. Each value must be unique among the success and failure values.
               
               JSON examples: `"FailureValues": [ "LoginFailed", "Failed login" ]` and `"FailureValues": [ "AccountCreationFailed" ]`
        :param pulumi.Input[builtins.str] name: The name of the header to match against. The name must be an exact match, including case.
               
               JSON example: `"Name": [ "RequestResult" ]`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] success_values: Values in the response header with the specified name that indicate a successful login or account creation attempt. To be counted as a success, the value must be an exact match, including case. Each value must be unique among the success and failure values.
    ...
    def failure_values(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Values in the response header with the specified name that indicate a failed login or account creation attempt. To be counted as a failure, the value must be an exact match, including case. Each value must be unique among the success and failure values.
    ...
    def failure_values(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def success_values(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Values in the response header with the specified name that indicate a successful login or account creation attempt. To be counted as a success, the value must be an exact match, including case. Each value must be unique among the success and failure values.
    ...
    def success_values(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class WebAclResponseInspectionStatusCodeArgsDict(TypedDict):
        ...
        """
        failure_codes: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
        """
        ...
        """
        success_codes: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
        """
...
class WebAclResponseInspectionStatusCodeArgs:
    def __init__(__self__, *,
        ...
        """
        Response status codes that indicate success or failure of a login request
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] failure_codes: Status codes in the response that indicate a failed login or account creation attempt. To be counted as a failure, the response status code must match one of these. Each code must be unique among the success and failure status codes.
               
               JSON example: `"FailureCodes": [ 400, 404 ]`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] success_codes: Status codes in the response that indicate a successful login or account creation attempt. To be counted as a success, the response status code must match one of these. Each code must be unique among the success and failure status codes.
    ...
    def failure_codes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
        Status codes in the response that indicate a failed login or account creation attempt. To be counted as a failure, the response status code must match one of these. Each code must be unique among the success and failure status codes.
    ...
    def failure_codes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        pulumi.set(self, "failure_codes", value)

    @property
    @pulumi.getter(name="successCodes")
    def success_codes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
        Status codes in the response that indicate a successful login or account creation attempt. To be counted as a success, the response status code must match one of these. Each code must be unique among the success and failure status codes.
    ...
    def success_codes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
class WebAclRuleActionOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the rule to override.
        """
...
class WebAclRuleGroupReferenceStatementArgs:
    def __init__(__self__, *,
                 ...
                 rule_action_overrides: Optional[pulumi.Input[Sequence[pulumi.Input['WebAclRuleActionOverrideArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the entity.
        :param pulumi.Input[Sequence[pulumi.Input['WebAclExcludedRuleArgs']]] excluded_rules: Rules in the referenced rule group whose actions are set to `Count` .
