...
class WebAclAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_arn: The Amazon Resource Name (ARN) of the resource to associate with the web ACL.
...
@pulumi.type_token("aws-native:wafv2:WebAclAssociation")
