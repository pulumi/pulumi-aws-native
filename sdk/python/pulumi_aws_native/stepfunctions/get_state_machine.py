...
class GetStateMachineResult:
    ...
    def definition_string(self) -> Optional[builtins.str]:
        """
    ...
    def state_machine_revision_id(self) -> Optional[builtins.str]:
        """
...
def get_state_machine(arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStateMachineResult:
    """
    Resource schema for StateMachine


    :param builtins.str arn: Returns the ARN of the resource.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_state_machine_output(arn: Optional[pulumi.Input[builtins.str]] = None,
