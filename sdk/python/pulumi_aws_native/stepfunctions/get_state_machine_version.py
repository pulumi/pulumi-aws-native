...
def get_state_machine_version(arn: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStateMachineVersionResult:
    """
    Resource schema for StateMachineVersion


    :param builtins.str arn: Returns the ARN of the state machine version. For example, `arn:aws:states:us-east-1:123456789012:stateMachine:myStateMachine:1` .
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_state_machine_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
