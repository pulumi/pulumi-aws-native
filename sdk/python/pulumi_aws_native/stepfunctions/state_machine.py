...
class StateMachineArgs:
    def __init__(__self__, *,
                 ...
                 definition_string: Optional[pulumi.Input[builtins.str]] = None,
                 definition_substitutions: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.str, builtins.int, builtins.bool]]]]] = None,
                 ...
                 state_machine_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] definition_string: The Amazon States Language definition of the state machine. The state machine definition must be in JSON. See [Amazon States Language](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html) .
        :param pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.str, builtins.int, builtins.bool]]]] definition_substitutions: A map (string to string) that specifies the mappings for placeholder variables in the state machine definition. This enables the customer to inject values obtained at runtime, for example from intrinsic functions, in the state machine definition. Variables can be template parameter names, resource logical IDs, resource attributes, or a variable in a key-value map.
        ...
        :param pulumi.Input[builtins.str] state_machine_name: The name of the state machine.
    ...
    def definition_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def definition_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "definition_string", value)

    @property
    @pulumi.getter(name="definitionSubstitutions")
    def definition_substitutions(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.str, builtins.int, builtins.bool]]]]]:
        """
        A map (string to string) that specifies the mappings for placeholder variables in the state machine definition. This enables the customer to inject values obtained at runtime, for example from intrinsic functions, in the state machine definition. Variables can be template parameter names, resource logical IDs, resource attributes, or a variable in a key-value map.
    ...
    def definition_substitutions(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.str, builtins.int, builtins.bool]]]]]):
    ...
    def state_machine_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def state_machine_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StateMachine(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="definitionString")
    def definition_string(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon States Language definition of the state machine. The state machine definition must be in JSON. See [Amazon States Language](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html) .
        """
        return pulumi.get(self, "definition_string")
    ...
    @property
    @pulumi.getter(name="stateMachineName")
    def state_machine_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the state machine.
    ...
    def state_machine_revision_id(self) -> pulumi.Output[builtins.str]:
        """
