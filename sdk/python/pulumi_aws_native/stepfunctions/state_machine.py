...
class StateMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(definition, StateMachineDefinitionArgs):
                definition = definition or {}
                def _setter(key, value):
                    definition[key] = value
                StateMachineDefinitionArgs._configure(_setter, **definition)
            __props__.__dict__["definition"] = definition
            if not isinstance(definition_s3_location, StateMachineS3LocationArgs):
            ...
            if not isinstance(definition_substitutions, StateMachineDefinitionSubstitutionsArgs):
            ...
            if not isinstance(logging_configuration, StateMachineLoggingConfigurationArgs):
            ...
            if not isinstance(tracing_configuration, StateMachineTracingConfigurationArgs):
