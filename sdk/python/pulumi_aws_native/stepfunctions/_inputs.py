...
class ActivityEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: An alias, alias ARN, key ID, or key ARN of a symmetric encryption AWS  key to encrypt data. To specify a AWS  key in a different AWS account, you must use the key ARN or alias ARN.
        """
...
class StateMachineAliasDeploymentPreferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] alarms: A list of CloudWatch alarm names that will be monitored during the deployment. The deployment will fail and rollback if any alarms go into ALARM state.
        :param pulumi.Input[_builtins.int] interval: The time in minutes between each traffic shifting increment.
        :param pulumi.Input[_builtins.int] percentage: The percentage of traffic to shift to the new version in each increment.
        """
...
class StateMachineAliasRoutingConfigurationVersionArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] state_machine_version_arn: The Amazon Resource Name (ARN) that identifies one or two state machine versions defined in the routing configuration.
        :param pulumi.Input[_builtins.int] weight: The percentage of traffic you want to route to the state machine version. The sum of the weights in the routing configuration must be equal to 100.
        """
        pulumi.set(__self__, "state_machine_version_arn", state_machine_version_arn)
...
class StateMachineLogDestinationArgsDict(TypedDict):
    cloud_watch_logs_log_group: NotRequired[pulumi.Input[Optional['StateMachineCloudWatchLogsLogGroupArgsDict']]]
    """
...
class StateMachineLoggingConfigurationArgsDict(TypedDict):
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StateMachineLogDestinationArgsDict']]]]]
    """
...
class StateMachineS3LocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: For versioning-enabled buckets, a specific version of the state machine definition.
        """
