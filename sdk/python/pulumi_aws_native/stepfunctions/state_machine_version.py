...
class StateMachineVersionArgs:
    ...
    def state_machine_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def state_machine_arn(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("aws-native:stepfunctions:StateMachineVersion")
class StateMachineVersion(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="stateMachineArn")
    def state_machine_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The Amazon Resource Name (ARN) of the state machine.
        """
        return pulumi.get(self, "state_machine_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="stateMachineRevisionId")
    def state_machine_revision_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Identifier for a state machine revision, which is an immutable, read-only snapshot of a state machine’s definition and configuration.
