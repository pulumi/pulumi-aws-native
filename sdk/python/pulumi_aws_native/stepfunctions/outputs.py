...
class ActivityEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int kms_data_key_reuse_period_seconds: Maximum duration that Step Functions will reuse data keys. When the period expires, Step Functions will call `GenerateDataKey` . Only applies to customer managed keys.
        :param builtins.str kms_key_id: An alias, alias ARN, key ID, or key ARN of a symmetric encryption AWS KMS key to encrypt data. To specify a AWS KMS key in a different AWS account, you must use the key ARN or alias ARN.
        """
...
class StateMachineAliasDeploymentPreference(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] alarms: A list of CloudWatch alarm names that will be monitored during the deployment. The deployment will fail and rollback if any alarms go into ALARM state.
        :param builtins.int interval: The time in minutes between each traffic shifting increment.
        :param builtins.int percentage: The percentage of traffic to shift to the new version in each increment.
        """
...
class StateMachineAliasRoutingConfigurationVersion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str state_machine_version_arn: The Amazon Resource Name (ARN) that identifies one or two state machine versions defined in the routing configuration.
        :param builtins.int weight: The percentage of traffic you want to route to the state machine version. The sum of the weights in the routing configuration must be equal to 100.
        """
        pulumi.set(__self__, "state_machine_version_arn", state_machine_version_arn)
...
class StateMachineCloudWatchLogsLogGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_group_arn: The ARN of the the CloudWatch log group to which you want your logs emitted to. The ARN must end with `:*`
        """
...
class StateMachineS3Location(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket: The name of the S3 bucket where the state machine definition JSON or YAML file is stored.
        :param builtins.str key: The name of the state machine definition file (Amazon S3 object name).
        :param builtins.str version: For versioning-enabled buckets, a specific version of the state machine definition.
        """
...
class StateMachineTracingConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: When set to `true` , X-Ray tracing is enabled.
        """
