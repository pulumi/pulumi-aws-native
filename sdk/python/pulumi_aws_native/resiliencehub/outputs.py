...
class AppEventSubscription(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Unique name to identify an event subscription.
        :param builtins.str sns_topic_arn: Amazon Resource Name (ARN) of the Amazon Simple Notification Service topic.
        """
...
class AppPermissionModel(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cross_account_role_arns: Optional[Sequence[builtins.str]] = None,
                 invoker_role_name: Optional[builtins.str] = None):
        """
        Defines the roles and credentials that AWS Resilience Hub would use while creating the application, importing its resources, and running an assessment.
        ...
        :param Sequence[builtins.str] cross_account_role_arns: Defines a list of role Amazon Resource Names (ARNs) to be used in other accounts. These ARNs are used for querying purposes while importing resources and assessing your application.
        :param builtins.str invoker_role_name: Existing AWS IAM role name in the primary AWS account that will be assumed by AWS Resilience Hub Service Principle to obtain a read-only access to your application resources while running an assessment.
        """
    ...
    def cross_account_role_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def invoker_role_name(self) -> Optional[builtins.str]:
        """
...
class AppPhysicalResourceId(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str identifier: Identifier of the physical resource.
        :param builtins.str type: Specifies the type of physical resource identifier.
               ...
               - `AWS::S3::Bucket`
               - `AWS::SQS::Queue`
        :param builtins.str aws_account_id: The AWS account that owns the physical resource.
        :param builtins.str aws_region: The AWS Region that the physical resource is located in.
        """
...
class AppResourceMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 eks_source_name: Optional[builtins.str] = None,
                 logical_stack_name: Optional[builtins.str] = None,
                 resource_name: Optional[builtins.str] = None,
                 terraform_source_name: Optional[builtins.str] = None):
        """
        Resource mapping is used to map logical resources from template to physical resource
        :param builtins.str mapping_type: Specifies the type of resource mapping.
        :param 'AppPhysicalResourceId' physical_resource_id: Identifier of the physical resource.
        :param builtins.str eks_source_name: Name of the Amazon Elastic Kubernetes Service cluster and namespace that this resource is mapped to when the `mappingType` is `EKS` .
               
               > This parameter accepts values in "eks-cluster/namespace" format.
        :param builtins.str logical_stack_name: Name of the AWS CloudFormation stack this resource is mapped to when the `mappingType` is `CfnStack` .
        :param builtins.str resource_name: Name of the resource that this resource is mapped to when the `mappingType` is `Resource` .
        :param builtins.str terraform_source_name: Name of the Terraform source that this resource is mapped to when the `mappingType` is `Terraform` .
        """
    ...
    def eks_source_name(self) -> Optional[builtins.str]:
        """
    ...
    def logical_stack_name(self) -> Optional[builtins.str]:
        """
    ...
    def terraform_source_name(self) -> Optional[builtins.str]:
        """
...
class ResiliencyPolicyFailurePolicy(dict):
    ...
    def __init__(__self__, *,
                 rpo_in_secs: builtins.int,
                 rto_in_secs: builtins.int):
        """
        Failure Policy.
        :param builtins.int rpo_in_secs: RPO in seconds.
        :param builtins.int rto_in_secs: RTO in seconds.
        """
    ...
    def rpo_in_secs(self) -> builtins.int:
        """
        RPO in seconds.
        """
    ...
    def rto_in_secs(self) -> builtins.int:
        """
        RTO in seconds.
        """
