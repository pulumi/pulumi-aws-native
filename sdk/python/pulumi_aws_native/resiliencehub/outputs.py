...
class AppPermissionModel(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cross_account_role_arns: Optional[Sequence[_builtins.str]] = None,
    ...
    def cross_account_role_arns(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def invoker_role_name(self) -> Optional[_builtins.str]:
        """
...
class AppPhysicalResourceId(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str identifier: Identifier of the physical resource.
        :param _builtins.str type: Specifies the type of physical resource identifier.
               ...
               - `AWS::S3::Bucket`
               - `AWS::SQS::Queue`
        :param _builtins.str aws_account_id: The AWS account that owns the physical resource.
        :param _builtins.str aws_region: The AWS Region that the physical resource is located in.
        """
...
class AppResourceMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 eks_source_name: Optional[_builtins.str] = None,
                 logical_stack_name: Optional[_builtins.str] = None,
    ...
    def eks_source_name(self) -> Optional[_builtins.str]:
        """
    ...
    def terraform_source_name(self) -> Optional[_builtins.str]:
        """
...
class ResiliencyPolicyFailurePolicy(dict):
    ...
    def rpo_in_secs(self) -> _builtins.int:
        """
        RPO in seconds.
        """
    ...
    def rto_in_secs(self) -> _builtins.int:
        """
        RTO in seconds.
        """
