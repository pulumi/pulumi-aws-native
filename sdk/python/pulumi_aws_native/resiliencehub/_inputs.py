...
class AppEventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Unique name to identify an event subscription.
        :param pulumi.Input[_builtins.str] sns_topic_arn: Amazon Resource Name (ARN) of the Amazon Simple Notification Service topic.
        """
...
class AppPermissionModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cross_account_role_arns: Defines a list of role Amazon Resource Names (ARNs) to be used in other accounts. These ARNs are used for querying purposes while importing resources and assessing your application.
        :param pulumi.Input[_builtins.str] invoker_role_name: Existing AWS IAM role name in the primary AWS account that will be assumed by AWS Resilience Hub Service Principle to obtain a read-only access to your application resources while running an assessment.
        """
...
class AppPhysicalResourceIdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the type of physical resource identifier.
               ...
               - `AWS::S3::Bucket`
               - `AWS::SQS::Queue`
        :param pulumi.Input[_builtins.str] aws_account_id: The AWS account that owns the physical resource.
        :param pulumi.Input[_builtins.str] aws_region: The AWS Region that the physical resource is located in.
        """
...
class AppResourceMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mapping_type: Specifies the type of resource mapping.
    ...
    def mapping_type(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the type of resource mapping.
        """
    ...
    @mapping_type.setter
    def mapping_type(self, value: pulumi.Input[_builtins.str]):
...
class ResiliencyPolicyFailurePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] rpo_in_secs: RPO in seconds.
        :param pulumi.Input[_builtins.int] rto_in_secs: RTO in seconds.
        """
    ...
    def rpo_in_secs(self) -> pulumi.Input[_builtins.int]:
        """
        RPO in seconds.
        """
    ...
    @rpo_in_secs.setter
    def rpo_in_secs(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "rpo_in_secs", value)

    @_builtins.property
    @pulumi.getter(name="rtoInSecs")
    def rto_in_secs(self) -> pulumi.Input[_builtins.int]:
        """
        RTO in seconds.
        """
    ...
    @rto_in_secs.setter
    def rto_in_secs(self, value: pulumi.Input[_builtins.int]):
...
class ResiliencyPolicyPolicyMapArgsDict(TypedDict):
    ...
    """
    region: NotRequired[pulumi.Input[Optional['ResiliencyPolicyFailurePolicyArgsDict']]]
    """
