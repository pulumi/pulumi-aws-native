...
class GetAppResult:
    ...
    def app_template_body(self) -> Optional[_builtins.str]:
        """
    ...
    def resiliency_policy_arn(self) -> Optional[_builtins.str]:
        """
...
def get_app(app_arn: Optional[_builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppResult:
    """
    Resource Type Definition for AWS::ResilienceHub::App.


    :param _builtins.str app_arn: Amazon Resource Name (ARN) of the App.
    """
    __args__ = dict()
