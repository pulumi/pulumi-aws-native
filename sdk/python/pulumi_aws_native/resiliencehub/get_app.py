...
class GetAppResult:
    ...
    def app_template_body(self) -> Optional[builtins.str]:
        """
    ...
    def resiliency_policy_arn(self) -> Optional[builtins.str]:
        """
...
def get_app(app_arn: Optional[builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppResult:
    """
    Resource Type Definition for AWS::ResilienceHub::App.


    :param builtins.str app_arn: Amazon Resource Name (ARN) of the App.
    """
    __args__ = dict()
...
def get_app_output(app_arn: Optional[pulumi.Input[builtins.str]] = None,
