...
class ResiliencyPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_description: Description of Resiliency Policy.
        :param pulumi.Input[builtins.str] policy_name: Name of Resiliency Policy.
