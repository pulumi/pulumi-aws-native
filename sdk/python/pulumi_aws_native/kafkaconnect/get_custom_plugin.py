...
class GetCustomPluginResult:
    ...
    def custom_plugin_arn(self) -> Optional[builtins.str]:
        """
...
def get_custom_plugin(custom_plugin_arn: Optional[builtins.str] = None,
...
def get_custom_plugin_output(custom_plugin_arn: Optional[pulumi.Input[builtins.str]] = None,
