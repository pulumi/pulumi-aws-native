...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(capacity, ConnectorCapacityArgs):
            ...
            if not isinstance(kafka_cluster, ConnectorKafkaClusterArgs):
            ...
            if not isinstance(kafka_cluster_client_authentication, ConnectorKafkaClusterClientAuthenticationArgs):
            ...
            if not isinstance(kafka_cluster_encryption_in_transit, ConnectorKafkaClusterEncryptionInTransitArgs):
            ...
            if not isinstance(log_delivery, ConnectorLogDeliveryArgs):
            ...
            if not isinstance(worker_configuration, ConnectorWorkerConfigurationArgs):
