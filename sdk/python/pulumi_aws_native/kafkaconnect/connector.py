...
class ConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] connector_configuration: The configuration for the connector.
        ...
        :param pulumi.Input[builtins.str] kafka_connect_version: The version of Kafka Connect. It has to be compatible with both the Kafka cluster's version and the plugins.
        :param pulumi.Input[Sequence[pulumi.Input['ConnectorPluginArgs']]] plugins: List of plugins to use with the connector.
        :param pulumi.Input[builtins.str] service_execution_role_arn: The Amazon Resource Name (ARN) of the IAM role used by the connector to access Amazon S3 objects and other external resources.
        :param pulumi.Input[builtins.str] connector_description: A summary description of the connector.
    ...
    def kafka_connect_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def kafka_connect_version(self, value: pulumi.Input[builtins.str]):
    ...
    def connector_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connector_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Connector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kafka_connect_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="connectorDescription")
    def connector_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A summary description of the connector.
        """
        return pulumi.get(self, "connector_description")
    ...
    @property
    @pulumi.getter(name="kafkaConnectVersion")
    def kafka_connect_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of Kafka Connect. It has to be compatible with both the Kafka cluster's version and the plugins.
        """
        return pulumi.get(self, "kafka_connect_version")
