...
class ConnectorArgs:
    ...
    def _configure(
        ...
        if kafka_connect_version is None and 'kafkaConnectVersion' in kwargs:
            kafka_connect_version = kwargs['kafkaConnectVersion']
        if kafka_connect_version is None:
            raise TypeError("Missing 'kafka_connect_version' argument")
        if plugins is None:
        ...
        if connector_description is None and 'connectorDescription' in kwargs:
