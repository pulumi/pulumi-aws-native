...
class ConnectorApacheKafkaCluster(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of how to connect to an Apache Kafka cluster.
        :param builtins.str bootstrap_servers: The bootstrap servers string of the Apache Kafka cluster.
...
class ConnectorAutoScaling(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about auto scaling of a connector.
        :param builtins.int max_worker_count: The maximum number of workers for a connector.
        :param builtins.int mcu_count: Specifies how many MSK Connect Units (MCU) as the minimum scaling unit.
        :param builtins.int min_worker_count: The minimum number of workers for a connector.
    ...
    def mcu_count(self) -> builtins.int:
        """
...
class ConnectorCloudWatchLogsLogDelivery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about delivering logs to Amazon CloudWatch Logs.
        :param builtins.bool enabled: Specifies whether the logs get sent to the specified CloudWatch Logs destination.
        :param builtins.str log_group: The CloudWatch log group that is the destination for log delivery.
        """
...
class ConnectorCustomPlugin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about a custom plugin.
        :param builtins.str custom_plugin_arn: The Amazon Resource Name (ARN) of the custom plugin to use.
        :param builtins.int revision: The revision of the custom plugin to use.
        """
...
class ConnectorFirehoseLogDelivery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about delivering logs to Amazon Kinesis Data Firehose.
        :param builtins.bool enabled: Specifies whether the logs get sent to the specified Kinesis Data Firehose delivery stream.
        :param builtins.str delivery_stream: The Kinesis Data Firehose delivery stream that is the destination for log delivery.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ConnectorProvisionedCapacity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mcu_count: Optional[builtins.int] = None):
        """
        Details about a fixed capacity allocated to a connector.
        :param builtins.int worker_count: Number of workers for a connector.
        :param builtins.int mcu_count: Specifies how many MSK Connect Units (MCU) are allocated to the connector.
        """
    ...
    @property
    @pulumi.getter(name="mcuCount")
    def mcu_count(self) -> Optional[builtins.int]:
        """
...
class ConnectorS3LogDelivery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about delivering logs to Amazon S3.
        :param builtins.bool enabled: Specifies whether the logs get sent to the specified Amazon S3 destination.
        :param builtins.str bucket: The name of the S3 bucket that is the destination for log delivery.
        :param builtins.str prefix: The S3 prefix that is the destination for log delivery.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ConnectorScaleInPolicy(dict):
    ...
    def __init__(__self__, *,
                 cpu_utilization_percentage: builtins.int):
        """
        Information about the scale in policy of the connector.
        :param builtins.int cpu_utilization_percentage: Specifies the CPU utilization percentage threshold at which connector scale in should trigger.
        """
        pulumi.set(__self__, "cpu_utilization_percentage", cpu_utilization_percentage)

    @property
    @pulumi.getter(name="cpuUtilizationPercentage")
    def cpu_utilization_percentage(self) -> builtins.int:
        """
...
class ConnectorScaleOutPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about the scale out policy of the connector.
        :param builtins.int cpu_utilization_percentage: Specifies the CPU utilization percentage threshold at which connector scale out should trigger.
        """
        pulumi.set(__self__, "cpu_utilization_percentage", cpu_utilization_percentage)
...
class ConnectorVpc(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a VPC used with the connector.
        :param Sequence[builtins.str] security_groups: The AWS security groups to associate with the elastic network interfaces in order to specify what the connector has access to.
        :param Sequence[builtins.str] subnets: The list of subnets to connect to in the virtual private cloud (VPC). AWS creates elastic network interfaces inside these subnets.
        """
...
class ConnectorWorkerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the worker configuration to use with the connector.
        :param builtins.int revision: The revision of the worker configuration to use.
        :param builtins.str worker_configuration_arn: The Amazon Resource Name (ARN) of the worker configuration to use.
        """
        pulumi.set(__self__, "revision", revision)
...
class CustomPluginFileDescription(dict):
    ...
    def __init__(__self__, *,
                 file_md5: Optional[builtins.str] = None,
                 file_size: Optional[builtins.int] = None):
        """
        Details about the custom plugin file.
        :param builtins.str file_md5: The hex-encoded MD5 checksum of the custom plugin file. You can use it to validate the file.
        :param builtins.int file_size: The size in bytes of the custom plugin file. You can use it to validate the file.
        """
    ...
    def file_md5(self) -> Optional[builtins.str]:
        """
...
class CustomPluginS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The S3 bucket Amazon Resource Name (ARN), file key, and object version of the plugin file stored in Amazon S3.
        :param builtins.str bucket_arn: The Amazon Resource Name (ARN) of an S3 bucket.
        :param builtins.str file_key: The file key for an object in an S3 bucket.
        :param builtins.str object_version: The version of an object in an S3 bucket.
        """
