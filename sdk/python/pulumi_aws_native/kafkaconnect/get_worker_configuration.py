...
class GetWorkerConfigurationResult:
    ...
    def worker_configuration_arn(self) -> Optional[_builtins.str]:
        """
...
def get_worker_configuration(worker_configuration_arn: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkerConfigurationResult:
    """
    The configuration of the workers, which are the processes that run the connector logic.


    :param _builtins.str worker_configuration_arn: The Amazon Resource Name (ARN) of the custom configuration.
    """
    __args__ = dict()
