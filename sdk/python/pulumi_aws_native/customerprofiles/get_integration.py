...
class GetIntegrationResult:
    ...
    def event_trigger_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_integration(domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str uri: The URI of the S3 bucket or any other type of data source.
    """
    __args__ = dict()
...
def get_integration_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
