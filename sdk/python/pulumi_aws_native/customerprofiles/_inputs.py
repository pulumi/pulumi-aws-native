...
class CalculatedAttributeDefinitionConditionsArgsDict(TypedDict):
    ...
    """
    range: NotRequired[pulumi.Input[Optional['CalculatedAttributeDefinitionRangeArgs']]]
    """
    The relative time period over which data is included in the aggregation.
    """
    threshold: NotRequired[pulumi.Input[Optional['CalculatedAttributeDefinitionThresholdArgs']]]
    """
...
class CalculatedAttributeDefinitionRangeArgsDict(TypedDict):
    ...
    """
    value_range: NotRequired[pulumi.Input[Optional['CalculatedAttributeDefinitionValueRangeArgs']]]
    """
...
class DomainAutoMergingArgsDict(TypedDict):
    ...
    """
    conflict_resolution: NotRequired[pulumi.Input[Optional['DomainConflictResolutionArgs']]]
    """
    ...
    """
    consolidation: NotRequired[pulumi.Input[Optional['DomainConsolidationArgs']]]
    """
...
class DomainDataStoreArgsDict(TypedDict):
    ...
    """
    readiness: NotRequired[pulumi.Input[Optional['DomainReadinessArgs']]]
...
class DomainExportingConfigArgsDict(TypedDict):
    ...
    """
    s3_exporting: NotRequired[pulumi.Input[Optional['DomainS3ExportingConfigArgs']]]
...
class DomainMatchingArgsDict(TypedDict):
    ...
    """
    auto_merging: NotRequired[pulumi.Input[Optional['DomainAutoMergingArgs']]]
    """
    Configuration information about the auto-merging process.
    """
    exporting_config: NotRequired[pulumi.Input[Optional['DomainExportingConfigArgs']]]
    """
    The S3 location where Identity Resolution Jobs write result files.
    """
    job_schedule: NotRequired[pulumi.Input[Optional['DomainJobScheduleArgs']]]
    """
    The day and time when do you want to start the Identity Resolution Job every week.
    """
...
class DomainRuleBasedMatchingArgsDict(TypedDict):
    ...
    """
    attribute_types_selector: NotRequired[pulumi.Input[Optional['DomainAttributeTypesSelectorArgs']]]
    """
    Configures information about the `AttributeTypesSelector` where the rule-based identity resolution uses to match profiles.
    """
    conflict_resolution: NotRequired[pulumi.Input[Optional['DomainConflictResolutionArgs']]]
    ...
    The S3 location where Identity Resolution Jobs write result files.
    """
    matching_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DomainMatchingRuleArgs']]]]]
    """
...
class EventTriggerLimitsArgsDict(TypedDict):
    ...
    """
    periods: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EventTriggerPeriodArgs']]]]]
    """
...
class IntegrationSourceConnectorPropertiesArgsDict(TypedDict):
    marketo: NotRequired[pulumi.Input[Optional['IntegrationMarketoSourcePropertiesArgs']]]
    """
    The properties that are applied when Marketo is being used as a source.
    """
    s3: NotRequired[pulumi.Input[Optional['IntegrationS3SourcePropertiesArgs']]]
    """
    The properties that are applied when Amazon S3 is being used as the flow source.
    """
    salesforce: NotRequired[pulumi.Input[Optional['IntegrationSalesforceSourcePropertiesArgs']]]
    """
    The properties that are applied when Salesforce is being used as a source.
    """
    service_now: NotRequired[pulumi.Input[Optional['IntegrationServiceNowSourcePropertiesArgs']]]
    """
    The properties that are applied when ServiceNow is being used as a source.
    """
    zendesk: NotRequired[pulumi.Input[Optional['IntegrationZendeskSourcePropertiesArgs']]]
    """
...
class IntegrationSourceFlowConfigArgsDict(TypedDict):
    ...
    """
    incremental_pull_config: NotRequired[pulumi.Input[Optional['IntegrationIncrementalPullConfigArgs']]]
    """
...
class IntegrationTaskArgsDict(TypedDict):
    ...
    """
    connector_operator: NotRequired[pulumi.Input[Optional['IntegrationConnectorOperatorArgs']]]
    """
    ...
    """
    task_properties: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IntegrationTaskPropertiesMapArgs']]]]]
    """
...
class IntegrationTriggerConfigArgsDict(TypedDict):
    ...
    """
    trigger_properties: NotRequired[pulumi.Input[Optional['IntegrationTriggerPropertiesArgs']]]
    """
...
class IntegrationTriggerPropertiesArgsDict(TypedDict):
    scheduled: NotRequired[pulumi.Input[Optional['IntegrationScheduledTriggerPropertiesArgs']]]
    """
...
class ObjectTypeFieldMapArgsDict(TypedDict):
    ...
    Name of the field.
    """
    object_type_field: NotRequired[pulumi.Input[Optional['ObjectTypeFieldArgs']]]
    """
...
class ObjectTypeKeyMapArgsDict(TypedDict):
    ...
    Name of the key.
    """
    object_type_key_list: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ObjectTypeKeyArgs']]]]]
    """
...
class RecommenderConfigArgsDict(TypedDict):
    ...
    """
    events_config: NotRequired[pulumi.Input[Optional['RecommenderEventsConfigArgs']]]
...
class SegmentDefinitionAddressDimensionArgsDict(TypedDict):
    ...
    """
    city: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    country: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    county: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    postal_code: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    province: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    state: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
...
class SegmentDefinitionCalculatedAttributeDimensionArgsDict(TypedDict):
    ...
    dimension_type: pulumi.Input['SegmentDefinitionAttributeDimensionType']
    values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    condition_overrides: NotRequired[pulumi.Input[Optional['SegmentDefinitionConditionOverridesArgs']]]
...
class SegmentDefinitionConditionOverridesArgsDict(TypedDict):
    ...
    """
    range: NotRequired[pulumi.Input[Optional['SegmentDefinitionRangeOverrideArgs']]]
...
class SegmentDefinitionDimension1PropertiesArgsDict(TypedDict):
    ...
    The criteria that define the dimensions for the segment.
    """
    calculated_attributes: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['SegmentDefinitionCalculatedAttributeDimensionArgs']]]]]
...
class SegmentDefinitionGroupArgsDict(TypedDict):
    ...
    """
    dimensions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['SegmentDefinitionDimension0PropertiesArgs', 'SegmentDefinitionDimension1PropertiesArgs']]]]]]
    """
    Defines the attributes to segment on.
    """
    source_segments: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SegmentDefinitionSourceSegmentArgs']]]]]
    """
...
class SegmentDefinitionProfileAttributesArgsDict(TypedDict):
    ...
    """
    account_number: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    additional_information: NotRequired[pulumi.Input[Optional['SegmentDefinitionExtraLengthValueProfileDimensionArgs']]]
    address: NotRequired[pulumi.Input[Optional['SegmentDefinitionAddressDimensionArgs']]]
    attributes: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['SegmentDefinitionAttributeDimensionArgs']]]]]
    billing_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionAddressDimensionArgs']]]
    birth_date: NotRequired[pulumi.Input[Optional['SegmentDefinitionDateDimensionArgs']]]
    business_email_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    business_name: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    business_phone_number: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    email_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    first_name: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    gender_string: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    home_phone_number: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    last_name: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    mailing_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionAddressDimensionArgs']]]
    middle_name: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    mobile_phone_number: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    party_type_string: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    personal_email_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    phone_number: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileDimensionArgs']]]
    profile_type: NotRequired[pulumi.Input[Optional['SegmentDefinitionProfileTypeDimensionArgs']]]
    shipping_address: NotRequired[pulumi.Input[Optional['SegmentDefinitionAddressDimensionArgs']]]
...
class SegmentDefinitionSegmentGroupArgsDict(TypedDict):
    groups: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SegmentDefinitionGroupArgs']]]]]
    """
