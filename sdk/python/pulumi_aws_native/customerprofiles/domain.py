...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dead_letter_queue_url: The URL of the SQS dead letter queue
        :param pulumi.Input[builtins.str] default_encryption_key: The default encryption key
