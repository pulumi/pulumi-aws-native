...
class EventStreamArgs:
    def __init__(__self__, *,
                 ...
                 event_stream_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a EventStream resource.
        :param pulumi.Input[builtins.str] domain_name: The unique name of the domain.
        :param pulumi.Input[builtins.str] uri: The StreamARN of the destination to deliver profile events to. For example, arn:aws:kinesis:region:account-id:stream/stream-name.
        :param pulumi.Input[builtins.str] event_stream_name: The name of the event stream.
    ...
    def event_stream_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_stream_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventStream(pulumi.CustomResource):
    ...
    def event_stream_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="eventStreamName")
    def event_stream_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the event stream.
        """
        return pulumi.get(self, "event_stream_name")
