...
def get_calculated_attribute_definition(calculated_attribute_name: Optional[builtins.str] = None,
    ...
    :param builtins.str calculated_attribute_name: The name of an attribute defined in a profile object type.
