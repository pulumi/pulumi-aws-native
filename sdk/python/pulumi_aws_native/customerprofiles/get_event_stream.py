...
class GetEventStreamResult:
    ...
    def event_stream_arn(self) -> Optional[_builtins.str]:
        """
...
def get_event_stream(domain_name: Optional[_builtins.str] = None,
                     event_stream_name: Optional[_builtins.str] = None,
