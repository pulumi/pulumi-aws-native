...
class IntegrationArgs:
    def __init__(__self__, *,
                 ...
                 event_trigger_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_trigger_names: A list of unique names for active event triggers associated with the integration.
        ...
        :param pulumi.Input[builtins.str] object_type_name: The name of the ObjectType defined for the 3rd party data in Profile Service
        ...
        :param pulumi.Input[builtins.str] uri: The URI of the S3 bucket or any other type of data source.
        """
    ...
    def event_trigger_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def event_trigger_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Integration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="eventTriggerNames")
    def event_trigger_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of unique names for active event triggers associated with the integration.
        """
        return pulumi.get(self, "event_trigger_names")
    ...
    @property
    @pulumi.getter(name="objectTypeName")
    def object_type_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the ObjectType defined for the 3rd party data in Profile Service
        """
        return pulumi.get(self, "object_type_name")
