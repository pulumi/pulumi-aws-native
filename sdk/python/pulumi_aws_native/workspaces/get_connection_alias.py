...
class GetConnectionAliasResult:
    ...
    def alias_id(self) -> Optional[builtins.str]:
        """
...
def get_connection_alias(alias_id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectionAliasResult:
    """
    Resource Type definition for AWS::WorkSpaces::ConnectionAlias


    :param builtins.str alias_id: The identifier of the connection alias, returned as a string.
    """
    __args__ = dict()
...
def get_connection_alias_output(alias_id: Optional[pulumi.Input[builtins.str]] = None,
