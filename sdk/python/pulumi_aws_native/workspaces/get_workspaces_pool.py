...
class GetWorkspacesPoolResult:
    ...
    def pool_arn(self) -> Optional[builtins.str]:
        """
...
def get_workspaces_pool(pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str pool_id: The identifier of the pool.
    """
    __args__ = dict()
