...
class ConnectionAlias(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConnectionAliasPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectionAliasPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConnectionAliasAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConnectionAliasProperties']:
        """
