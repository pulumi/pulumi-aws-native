...
def get_vpc_endpoint(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The identifier of the VPC Endpoint
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_vpc_endpoint_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:opensearchserverless:getVpcEndpoint', __args__, opts=opts, typ=GetVpcEndpointResult)
