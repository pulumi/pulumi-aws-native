...
class GetCollectionResult:
    ...
    def dashboard_endpoint(self) -> Optional[builtins.str]:
        """
...
def get_collection(id: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCollectionResult:
    """
    Amazon OpenSearchServerless collection resource


    :param builtins.str id: The identifier of the collection
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_collection_output(id: Optional[pulumi.Input[builtins.str]] = None,
