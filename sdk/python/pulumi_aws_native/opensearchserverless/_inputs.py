...
if not MYPY:
    class IndexPropertyMappingMethodPropertiesParametersPropertiesArgsDict(TypedDict):
        ...
        """
        ef_construction: NotRequired[pulumi.Input[builtins.int]]
        """
        The size of the dynamic list used during k-NN graph creation
        """
        m: NotRequired[pulumi.Input[builtins.int]]
        """
...
class IndexPropertyMappingMethodPropertiesParametersPropertiesArgs:
    def __init__(__self__, *,
                 ef_construction: Optional[pulumi.Input[builtins.int]] = None,
                 m: Optional[pulumi.Input[builtins.int]] = None):
        """
        Additional parameters for the k-NN algorithm
        :param pulumi.Input[builtins.int] ef_construction: The size of the dynamic list used during k-NN graph creation
        :param pulumi.Input[builtins.int] m: Number of neighbors to consider during k-NN search
        """
    ...
    def ef_construction(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The size of the dynamic list used during k-NN graph creation
        """
    ...
    def ef_construction(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ef_construction", value)

    @property
    @pulumi.getter
    def m(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of neighbors to consider during k-NN search
        """
    ...
    @m.setter
    def m(self, value: Optional[pulumi.Input[builtins.int]]):
...
class IndexPropertyMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] dimension: Dimension size for vector fields, defines the number of dimensions in the vector
        :param pulumi.Input[builtins.bool] index: Whether a field should be indexed
        ...
        :param pulumi.Input[builtins.str] value: Default value for the field when not specified in a document
        """
...
if not MYPY:
    class IndexSettingsIndexPropertiesArgsDict(TypedDict):
        ...
        Index settings.
        """
        knn: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enable/disable k-nearest neighbor search capability
        """
        knn_algo_param_ef_search: NotRequired[pulumi.Input[builtins.int]]
        """
        Size of the dynamic list for the nearest neighbors
        """
        refresh_interval: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IndexSettingsIndexPropertiesArgs:
    def __init__(__self__, *,
                 knn: Optional[pulumi.Input[builtins.bool]] = None,
                 knn_algo_param_ef_search: Optional[pulumi.Input[builtins.int]] = None,
                 refresh_interval: Optional[pulumi.Input[builtins.str]] = None):
        """
        Index settings.
        :param pulumi.Input[builtins.bool] knn: Enable/disable k-nearest neighbor search capability
        :param pulumi.Input[builtins.int] knn_algo_param_ef_search: Size of the dynamic list for the nearest neighbors
        :param pulumi.Input[builtins.str] refresh_interval: How often to perform refresh operation (e.g. '1s', '5s')
        """
        if knn is not None:
    ...
    @property
    @pulumi.getter
    def knn(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable/disable k-nearest neighbor search capability
        """
    ...
    @knn.setter
    def knn(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "knn", value)

    @property
    @pulumi.getter(name="knnAlgoParamEfSearch")
    def knn_algo_param_ef_search(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Size of the dynamic list for the nearest neighbors
        """
    ...
    def knn_algo_param_ef_search(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SecurityConfigIamIdentityCenterConfigOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        Describes IAM Identity Center options for an OpenSearch Serverless security configuration in the form of a key-value map
        :param pulumi.Input[builtins.str] instance_arn: The ARN of the IAM Identity Center instance used to integrate with OpenSearch Serverless.
        :param pulumi.Input[builtins.str] application_arn: The ARN of the IAM Identity Center application used to integrate with OpenSearch Serverless.
        :param pulumi.Input[builtins.str] application_description: The description of the IAM Identity Center application used to integrate with OpenSearch Serverless
        :param pulumi.Input[builtins.str] application_name: The name of the IAM Identity Center application used to integrate with OpenSearch Serverless
        :param pulumi.Input[builtins.str] group_attribute: The group attribute for this IAM Identity Center integration. Defaults to `GroupId` .
        :param pulumi.Input[builtins.str] user_attribute: The user attribute for this IAM Identity Center integration. Defaults to `UserId`
        """
...
if not MYPY:
    class SecurityConfigSamlConfigOptionsArgsDict(TypedDict):
        ...
        """
        open_search_serverless_entity_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SecurityConfigSamlConfigOptionsArgs:
    def __init__(__self__, *,
                 metadata: pulumi.Input[builtins.str],
                 group_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 open_search_serverless_entity_id: Optional[pulumi.Input[builtins.str]] = None,
                 session_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 user_attribute: Optional[pulumi.Input[builtins.str]] = None):
        """
        Describes saml options in form of key value map
        :param pulumi.Input[builtins.str] metadata: The XML saml provider metadata document that you want to use
        :param pulumi.Input[builtins.str] group_attribute: Group attribute for this saml integration
        :param pulumi.Input[builtins.str] open_search_serverless_entity_id: Custom entity id attribute to override default entity id for this saml integration
        :param pulumi.Input[builtins.int] session_timeout: Defines the session timeout in minutes
        :param pulumi.Input[builtins.str] user_attribute: Custom attribute for this saml integration
        """
    ...
    def open_search_serverless_entity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Custom entity id attribute to override default entity id for this saml integration
        """
    ...
    def open_search_serverless_entity_id(self, value: Optional[pulumi.Input[builtins.str]]):
