...
class IndexPropertyMappingMethodPropertiesArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional['IndexPropertyMappingMethodPropertiesParametersPropertiesArgs']]]
    """
    Additional parameters for the k-NN algorithm
    """
...
class IndexPropertyMappingArgsDict(TypedDict):
    ...
    """
    method: NotRequired[pulumi.Input[Optional['IndexPropertyMappingMethodPropertiesArgs']]]
    """
    Configuration for k-NN search method
    """
    properties: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['IndexPropertyMappingArgs']]]]]
    """
...
class IndexSettingsArgsDict(TypedDict):
    index: NotRequired[pulumi.Input[Optional['IndexSettingsIndexPropertiesArgs']]]
    """
    Index settings.
    """
