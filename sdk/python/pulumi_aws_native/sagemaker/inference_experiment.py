...
class InferenceExperiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(data_storage_config, InferenceExperimentDataStorageConfigArgs):
            ...
            if not isinstance(schedule, InferenceExperimentScheduleArgs):
                schedule = schedule or {}
                def _setter(key, value):
                    schedule[key] = value
                InferenceExperimentScheduleArgs._configure(_setter, **schedule)
            __props__.__dict__["schedule"] = schedule
            if not isinstance(shadow_mode_config, InferenceExperimentShadowModeConfigArgs):
