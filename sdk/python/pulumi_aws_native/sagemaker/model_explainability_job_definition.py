...
class ModelExplainabilityJobDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_definition_name: The name of the model explainability job definition. The name must be unique within an AWS Region in the AWS account.
