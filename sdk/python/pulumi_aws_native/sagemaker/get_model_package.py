...
class GetModelPackageResult:
    def __init__(__self__, additional_inference_specification_definition=None, additional_inference_specifications=None, additional_inference_specifications_to_add=None, approval_description=None, certify_for_marketplace=None, created_by=None, creation_time=None, customer_metadata_properties=None, environment=None, last_modified_by=None, last_modified_time=None, model_approval_status=None, model_package_arn=None, model_package_name=None, model_package_status=None, model_package_status_details=None, model_package_status_item=None, model_package_version=None, tags=None):
        ...
        if additional_inference_specifications_to_add and not isinstance(additional_inference_specifications_to_add, list):
            raise TypeError("Expected argument 'additional_inference_specifications_to_add' to be a list")
        ...
        if model_package_status_item and not isinstance(model_package_status_item, dict):
            raise TypeError("Expected argument 'model_package_status_item' to be a dict")
    ...
    def additional_inference_specification_definition(self) -> Optional['outputs.ModelPackageAdditionalInferenceSpecificationDefinition']:
    ...
    def additional_inference_specifications_to_add(self) -> Optional[Sequence['outputs.ModelPackageAdditionalInferenceSpecificationDefinition']]:
    ...
    def created_by(self) -> Optional['outputs.ModelPackageCreatedBy']:
    ...
    def last_modified_by(self) -> Optional['outputs.ModelPackageLastModifiedBy']:
    ...
    def model_package_status_item(self) -> Optional['outputs.ModelPackageStatusItem']:
...
class AwaitableGetModelPackageResult(GetModelPackageResult):
    ...
    def __await__(self):
        ...
        return GetModelPackageResult(
            additional_inference_specification_definition=self.additional_inference_specification_definition,
...
def get_model_package(model_package_arn: Optional[str] = None,
    ...
    return AwaitableGetModelPackageResult(
        additional_inference_specification_definition=__ret__.additional_inference_specification_definition,
        additional_inference_specifications=__ret__.additional_inference_specifications,
        additional_inference_specifications_to_add=__ret__.additional_inference_specifications_to_add,
