...
class GetModelPackageResult:
    ...
    def certify_for_marketplace(self) -> Optional[_builtins.bool]:
        """
    ...
    def model_package_version(self) -> Optional[_builtins.int]:
        """
...
def get_model_package(model_package_arn: Optional[_builtins.str] = None,
