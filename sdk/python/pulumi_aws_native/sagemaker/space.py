...
class SpaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] space_display_name: The name of the space that appears in the Studio UI.
        :param pulumi.Input[builtins.str] space_name: A name for the Space.
...
class Space(pulumi.CustomResource):
    ...
    def space_arn(self) -> pulumi.Output[builtins.str]:
        """
