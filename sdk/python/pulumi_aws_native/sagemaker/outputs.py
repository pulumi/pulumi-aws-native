...
class DomainFSxLustreFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_system_path: Optional[str] = None):
        """
        :param str file_system_id: The globally unique, 17-digit, ID of the file system, assigned by Amazon FSx for Lustre.
...
class InferenceComponentSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The specification for the inference component
        :param str base_inference_component_name: The name of an existing inference component that is to contain the inference component that you're creating with your request.
    ...
    def base_inference_component_name(self) -> Optional[str]:
        """
