...
class AppImageConfigContainerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container configuration for a SageMaker image.
        :param Sequence[builtins.str] container_arguments: A list of arguments to apply to the container.
        :param Sequence[builtins.str] container_entrypoint: The custom entry point to use on container.
...
class AppImageConfigCustomImageContainerEnvironmentVariable(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key that identifies a container environment variable.
        :param builtins.str value: The value of the container environment variable.
        """
...
class AppImageConfigFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Amazon Elastic File System (EFS) storage configuration for a SageMaker image.
        :param builtins.int default_gid: The default POSIX group ID (GID). If not specified, defaults to 100.
        :param builtins.int default_uid: The default POSIX user ID (UID). If not specified, defaults to 1000.
...
class AppResourceSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sage_maker_image_arn: Optional[builtins.str] = None,
                 sage_maker_image_version_arn: Optional[builtins.str] = None):
        """
        :param 'AppResourceSpecInstanceType' instance_type: The instance type that the image version runs on.
        :param builtins.str lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration to attach to the Resource.
        :param builtins.str sage_maker_image_arn: The ARN of the SageMaker image that the image version belongs to.
        :param builtins.str sage_maker_image_version_arn: The ARN of the image version created on the instance.
        """
    ...
    def sage_maker_image_arn(self) -> Optional[builtins.str]:
        """
    ...
    def sage_maker_image_version_arn(self) -> Optional[builtins.str]:
        """
...
class ClusterLifeCycleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The lifecycle configuration for a SageMaker HyperPod cluster.
        :param builtins.str on_create: The file name of the entrypoint script of lifecycle scripts under SourceS3Uri. This entrypoint script runs during cluster creation.
        :param builtins.str source_s3_uri: An Amazon S3 bucket path where your lifecycle scripts are stored.
        """
...
class ClusterOrchestratorEksConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies parameter(s) related to EKS as orchestrator, e.g. the EKS cluster nodes will attach to,
        :param builtins.str cluster_arn: The ARN of the EKS cluster, such as arn:aws:eks:us-west-2:123456789012:cluster/my-eks-cluster
        """
...
class DataQualityJobDefinitionBatchTransformInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclude_features_attribute: Optional[builtins.str] = None,
        ...
        """
        The batch transform input for a monitoring job.
        :param builtins.str data_captured_destination_s3_uri: A URI that identifies the Amazon S3 storage location where Batch Transform Job captures data.
        :param 'DataQualityJobDefinitionDatasetFormat' dataset_format: The dataset format for your batch transform job.
        :param builtins.str local_path: Path to the filesystem where the endpoint data is available to the container.
        :param builtins.str exclude_features_attribute: Indexes or names of the features to be excluded from analysis
    ...
    def exclude_features_attribute(self) -> Optional[builtins.str]:
        """
...
class DataQualityJobDefinitionClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for the cluster used to run model monitoring jobs.
        :param builtins.int instance_count: The number of ML compute instances to use in the model monitoring job. For distributed processing jobs, specify a value greater than 1. The default value is 1.
        ...
        :param builtins.str volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the model monitoring job.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
...
class DataQualityJobDefinitionConstraintsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The baseline constraints resource for a monitoring job.
        :param builtins.str s3_uri: The Amazon S3 URI for baseline constraint file in Amazon S3 that the current monitoring job should validated against.
        """
...
class DataQualityJobDefinitionCsv(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The CSV format
        :param builtins.bool header: A boolean flag indicating if given CSV has header
        """
...
class DataQualityJobDefinitionDataQualityAppSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container image configuration object for the monitoring job.
        :param builtins.str image_uri: The container image to be run by the monitoring job.
        :param Sequence[builtins.str] container_arguments: An array of arguments for the container used to run the monitoring job.
        :param Sequence[builtins.str] container_entrypoint: Specifies the entrypoint for a container used to run the monitoring job.
...
class DataQualityJobDefinitionDataQualityBaselineConfig(dict):
    ...
    def __init__(__self__, *,
                 baselining_job_name: Optional[builtins.str] = None,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param builtins.str baselining_job_name: The name of the job that performs baselining for the data quality monitoring job.
    ...
    def baselining_job_name(self) -> Optional[builtins.str]:
        """
...
class DataQualityJobDefinitionDatasetFormat(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parquet: Optional[builtins.bool] = None):
        """
        The dataset format of the data to monitor
        """
        if csv is not None:
    ...
    @property
    @pulumi.getter
    def parquet(self) -> Optional[builtins.bool]:
...
class DataQualityJobDefinitionEndpointInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The endpoint for a monitoring job.
        :param builtins.str endpoint_name: An endpoint in customer's account which has enabled `DataCaptureConfig` enabled.
        :param builtins.str local_path: Path to the filesystem where the endpoint data is available to the container.
        :param builtins.str exclude_features_attribute: Indexes or names of the features to be excluded from analysis
...
class DataQualityJobDefinitionJson(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Json format
        :param builtins.bool line: A boolean flag indicating if it is JSON line format
        """
        if line is not None:
...
class DataQualityJobDefinitionMonitoringOutputConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt the model artifacts at rest using Amazon S3 server-side encryption.
        """
...
class DataQualityJobDefinitionS3Output(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about where and how to store the results of a monitoring job.
        :param builtins.str local_path: The local path to the Amazon S3 storage location where Amazon SageMaker saves the results of a monitoring job. LocalPath is an absolute path for the output data.
        :param builtins.str s3_uri: A URI that identifies the Amazon S3 storage location where Amazon SageMaker saves the results of a monitoring job.
...
class DataQualityJobDefinitionStatisticsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The baseline statistics resource for a monitoring job.
        :param builtins.str s3_uri: The Amazon S3 URI for the baseline statistics file in Amazon S3 that the current monitoring job should be validated against.
        """
        if s3_uri is not None:
            pulumi.set(__self__, "s3_uri", s3_uri)
...
class DataQualityJobDefinitionVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies a VPC that your training jobs and hosted models have access to. Control access to and from your training and model containers by configuring the VPC.
        :param Sequence[builtins.str] security_group_ids: The VPC security group IDs, in the form sg-xxxxxxxx. Specify the security groups for the VPC that is specified in the Subnets field.
        :param Sequence[builtins.str] subnets: The ID of the subnets in the VPC to which you want to connect to your monitoring jobs.
        """
        pulumi.set(__self__, "security_group_ids", security_group_ids)
        pulumi.set(__self__, "subnets", subnets)
...
class Device(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: Description of the device
        :param builtins.str iot_thing_name: AWS Internet of Things (IoT) object name.
        """
...
class DeviceFleetEdgeOutputConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str s3_output_location: The Amazon Simple Storage (S3) bucket URI
        :param builtins.str kms_key_id: The KMS key id used for encryption on the S3 bucket
        """
...
class DomainCodeEditorAppSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str built_in_lifecycle_config_arn: The lifecycle configuration that runs before the default lifecycle configuration.
        ...
        :param Sequence[builtins.str] lifecycle_config_arns: A list of LifecycleConfigArns available for use with CodeEditor apps.
        """
...
class DomainCodeRepository(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str repository_url: A CodeRepository (valid URL) to be used within Jupyter's Git extension.
        """
...
class DomainCustomImage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str image_name: The name of the CustomImage. Must be unique to your account.
        :param builtins.int image_version_number: The version number of the CustomImage.
        """
...
class DomainDefaultEbsStorageSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties related to the Amazon Elastic Block Store volume. Must be provided if storage type is Amazon EBS and must not be provided if storage type is not Amazon EBS
        :param builtins.int default_ebs_volume_size_in_gb: Default size of the Amazon EBS volume in Gb
        :param builtins.int maximum_ebs_volume_size_in_gb: Maximum size of the Amazon EBS volume in Gb. Must be greater than or equal to the DefaultEbsVolumeSizeInGb.
        """
...
class DomainDefaultSpaceSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] security_groups: The security groups for the Amazon Virtual Private Cloud (VPC) that Studio uses for communication.
...
class DomainDockerSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] vpc_only_trusted_accounts: A list of account id's that would be used to pull images from in VpcOnly mode
        """
...
class DomainFSxLustreFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_system_path: Optional[builtins.str] = None):
        """
        :param builtins.str file_system_id: The globally unique, 17-digit, ID of the file system, assigned by Amazon FSx for Lustre.
        :param builtins.str file_system_path: The path to the file system directory that is accessible in Amazon SageMaker Studio. Permitted users can access only this directory and below.
        """
        pulumi.set(__self__, "file_system_id", file_system_id)
        if file_system_path is not None:
            pulumi.set(__self__, "file_system_path", file_system_path)
...
class DomainIdleSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int idle_timeout_in_minutes: The time that SageMaker waits after the application becomes idle before shutting it down.
        ...
        :param builtins.int max_idle_timeout_in_minutes: The maximum value in minutes that custom idle shutdown can be set to by the user.
        :param builtins.int min_idle_timeout_in_minutes: The minimum value in minutes that custom idle shutdown can be set to by the user.
        """
...
class DomainJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] lifecycle_config_arns: A list of LifecycleConfigArns available for use with JupyterLab apps.
        """
        if app_lifecycle_management is not None:
            pulumi.set(__self__, "app_lifecycle_management", app_lifecycle_management)
        if built_in_lifecycle_config_arn is not None:
...
class DomainJupyterServerAppSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] lifecycle_config_arns: A list of LifecycleConfigArns available for use with JupyterServer apps.
        """
        if default_resource_spec is not None:
            pulumi.set(__self__, "default_resource_spec", default_resource_spec)
        if lifecycle_config_arns is not None:
...
class DomainKernelGatewayAppSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] lifecycle_config_arns: A list of LifecycleConfigArns available for use with KernelGateway apps.
        """
        if custom_images is not None:
            pulumi.set(__self__, "custom_images", custom_images)
        if default_resource_spec is not None:
...
class DomainResourceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration to attach to the Resource.
        :param builtins.str sage_maker_image_arn: The Amazon Resource Name (ARN) of the SageMaker image that the image version belongs to.
        :param builtins.str sage_maker_image_version_arn: The Amazon Resource Name (ARN) of the image version created on the instance.
        """
        if instance_type is not None:
            pulumi.set(__self__, "instance_type", instance_type)
        if lifecycle_config_arn is not None:
...
class DomainSharingSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_kms_key_id: When NotebookOutputOption is Allowed, the AWS Key Management Service (KMS) encryption key ID used to encrypt the notebook cell output in the Amazon S3 bucket.
        :param builtins.str s3_output_path: When NotebookOutputOption is Allowed, the Amazon S3 bucket used to store the shared notebook snapshots.
        """
...
class DomainUnifiedStudioSettings(dict):
    ...
    def __init__(__self__, *,
                 domain_account_id: Optional[builtins.str] = None,
                 domain_id: Optional[builtins.str] = None,
                 domain_region: Optional[builtins.str] = None,
        ...
        """
        A collection of settings that apply to an Amazon SageMaker AI domain when you use it in Amazon SageMaker Unified Studio.
        :param builtins.str domain_account_id: The ID of the AWS account that has the Amazon SageMaker Unified Studio domain. The default value, if you don't specify an ID, is the ID of the account that has the Amazon SageMaker AI domain.
        :param builtins.str domain_id: The ID of the Amazon SageMaker Unified Studio domain associated with this domain.
        :param builtins.str domain_region: The AWS Region where the domain is located in Amazon SageMaker Unified Studio. The default value, if you don't specify a Region, is the Region where the Amazon SageMaker AI domain is located.
    ...
    def domain_account_id(self) -> Optional[builtins.str]:
        """
    ...
    def domain_region(self) -> Optional[builtins.str]:
        """
    ...
    def project_s3_path(self) -> Optional[builtins.str]:
        """
...
class DomainUserSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A collection of settings that apply to users of Amazon SageMaker Studio. These settings are specified when the CreateUserProfile API is called, and as DefaultUserSettings when the CreateDomain API is called.
        :param builtins.str execution_role: The execution role for the user.
        ...
        :param 'DomainCustomPosixUserConfig' custom_posix_user_config: Details about the POSIX identity that is used for file system operations.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param builtins.str default_landing_uri: Defines which Amazon SageMaker application users are directed to by default.
...
class EndpointAlarm(dict):
    ...
    def __init__(__self__, *,
                 alarm_name: builtins.str):
        """
        :param builtins.str alarm_name: The name of the CloudWatch alarm.
        """
        pulumi.set(__self__, "alarm_name", alarm_name)
...
class EndpointBlueGreenUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int maximum_execution_timeout_in_seconds: The maximum time allowed for the blue/green update, in seconds.
        :param builtins.int termination_wait_in_seconds: The wait time before terminating the old endpoint during a blue/green deployment.
        """
...
class EndpointCapacitySize(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str type: Specifies whether the `Value` is an instance count or a capacity unit.
        :param builtins.int value: The value representing either the number of instances or the number of capacity units.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class EndpointRollingUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int wait_interval_in_seconds: The time to wait between steps during the rolling update, in seconds.
        :param builtins.int maximum_execution_timeout_in_seconds: The maximum time allowed for the rolling update, in seconds.
...
class EndpointTrafficRoutingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 wait_interval_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str type: Specifies the type of traffic routing (e.g., 'AllAtOnce', 'Canary', 'Linear').
        ...
        :param builtins.int wait_interval_in_seconds: Specifies the wait interval between traffic shifts, in seconds.
        """
        pulumi.set(__self__, "type", type)
...
class EndpointVariantProperty(dict):
    ...
    def __init__(__self__, *,
                 variant_property_type: Optional[builtins.str] = None):
        """
        :param builtins.str variant_property_type: The type of variant property (e.g., 'DesiredInstanceCount', 'DesiredWeight', 'DataCaptureConfig').
        """
    ...
    def variant_property_type(self) -> Optional[builtins.str]:
        """
...
class FeatureGroupFeatureDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str feature_name: The name of a feature. The type must be a string. `FeatureName` cannot be any of the following: `is_deleted` , `write_time` , `api_invocation_time` .
...
class FeatureGroupOnlineStoreSecurityConfig(dict):
    ...
    def __init__(__self__, *,
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_id: The AWS Key Management Service (KMS) key ARN that SageMaker Feature Store uses to encrypt the Amazon S3 objects at rest using Amazon S3 server-side encryption.
...
class FeatureGroupS3StorageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_id: The AWS Key Management Service (KMS) key ARN of the key used to encrypt any objects written into the `OfflineStore` S3 location.
...
class FeatureGroupThroughputConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int provisioned_read_capacity_units: For provisioned feature groups with online store enabled, this indicates the read throughput you are billed for and can consume without throttling.
        :param builtins.int provisioned_write_capacity_units: For provisioned feature groups, this indicates the write throughput you are billed for and can consume without throttling.
        """
...
class InferenceComponentCapacitySize(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int value: Defines the capacity size, either as a number of inference component copies or a capacity percentage.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class InferenceComponentComputeResourceRequirements(dict):
    ...
    def __init__(__self__, *,
                 max_memory_required_in_mb: Optional[builtins.int] = None,
                 min_memory_required_in_mb: Optional[builtins.int] = None,
                 number_of_accelerator_devices_required: Optional[builtins.float] = None,
                 number_of_cpu_cores_required: Optional[builtins.float] = None):
        """
        :param builtins.int max_memory_required_in_mb: The maximum MB of memory to allocate to run a model that you assign to an inference component.
        :param builtins.int min_memory_required_in_mb: The minimum MB of memory to allocate to run a model that you assign to an inference component.
        :param builtins.float number_of_accelerator_devices_required: The number of accelerators to allocate to run a model that you assign to an inference component. Accelerators include GPUs and AWS Inferentia.
        :param builtins.float number_of_cpu_cores_required: The number of CPU cores to allocate to run a model that you assign to an inference component.
        """
    ...
    def max_memory_required_in_mb(self) -> Optional[builtins.int]:
        """
    ...
    def min_memory_required_in_mb(self) -> Optional[builtins.int]:
        """
    ...
    def number_of_accelerator_devices_required(self) -> Optional[builtins.float]:
        """
    ...
    def number_of_cpu_cores_required(self) -> Optional[builtins.float]:
        """
...
class InferenceComponentContainerSpecification(dict):
    ...
    def __init__(__self__, *,
                 artifact_url: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str artifact_url: The Amazon S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        :param Mapping[str, builtins.str] environment: The environment variables to set in the Docker container. Each key and value in the Environment string-to-string map can have length of up to 1024. We support up to 16 entries in the map.
        :param builtins.str image: The Amazon Elastic Container Registry (Amazon ECR) path where the Docker image for the model is stored.
        """
    ...
    def artifact_url(self) -> Optional[builtins.str]:
        """
...
class InferenceComponentDeployedImage(dict):
    ...
    def __init__(__self__, *,
                 resolution_time: Optional[builtins.str] = None,
                 resolved_image: Optional[builtins.str] = None,
                 specified_image: Optional[builtins.str] = None):
        """
        :param builtins.str resolution_time: The date and time when the image path for the model resolved to the `ResolvedImage`
        :param builtins.str resolved_image: The specific digest path of the image hosted in this `ProductionVariant` .
        :param builtins.str specified_image: The image path you specified when you created the model.
        """
    ...
    def resolution_time(self) -> Optional[builtins.str]:
        """
    ...
    def resolved_image(self) -> Optional[builtins.str]:
        """
    ...
    def specified_image(self) -> Optional[builtins.str]:
        """
...
class InferenceComponentRollingUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int maximum_execution_timeout_in_seconds: The time limit for the total deployment. Exceeding this limit causes a timeout.
        ...
        :param builtins.int wait_interval_in_seconds: The length of the baking period, during which SageMaker AI monitors alarms for each batch on the new fleet.
        """
...
class InferenceComponentRuntimeConfig(dict):
    ...
    def __init__(__self__, *,
                 copy_count: Optional[builtins.int] = None,
                 current_copy_count: Optional[builtins.int] = None,
                 desired_copy_count: Optional[builtins.int] = None):
        """
        The runtime config for the inference component
        :param builtins.int copy_count: The number of runtime copies of the model container to deploy with the inference component. Each copy can serve inference requests.
        """
    ...
    def copy_count(self) -> Optional[builtins.int]:
        """
    ...
    def current_copy_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "current_copy_count")

    @property
    @pulumi.getter(name="desiredCopyCount")
    def desired_copy_count(self) -> Optional[builtins.int]:
...
class InferenceComponentSpecification(dict):
    ...
    def __init__(__self__, *,
                 base_inference_component_name: Optional[builtins.str] = None,
        ...
        """
        The specification for the inference component
        :param builtins.str base_inference_component_name: The name of an existing inference component that is to contain the inference component that you're creating with your request.
        ...
        :param builtins.str model_name: The name of an existing SageMaker AI model object in your account that you want to deploy with the inference component.
    ...
    def base_inference_component_name(self) -> Optional[builtins.str]:
        """
...
class InferenceComponentStartupParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int model_data_download_timeout_in_seconds: The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this inference component.
        """
...
class InferenceExperimentCaptureContentTypeHeader(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration specifying how to treat different headers. If no headers are specified SageMaker will by default base64 encode when capturing the data.
        :param Sequence[builtins.str] csv_content_types: The list of all content type headers that SageMaker will treat as CSV and capture accordingly.
        :param Sequence[builtins.str] json_content_types: The list of all content type headers that SageMaker will treat as JSON and capture accordingly.
        """
...
class InferenceExperimentDataStorageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Amazon S3 location and configuration for storing inference request and response data.
        :param builtins.str destination: The Amazon S3 bucket where the inference request and response data is stored.
        ...
        :param builtins.str kms_key: The AWS Key Management Service key that Amazon SageMaker uses to encrypt captured data at rest using Amazon S3 server-side encryption.
        """
...
class InferenceExperimentEndpointMetadata(dict):
    ...
    def __init__(__self__, *,
                 endpoint_name: builtins.str,
                 endpoint_config_name: Optional[builtins.str] = None,
        ...
        :param builtins.str endpoint_config_name: The name of the endpoint configuration.
...
class InferenceExperimentModelVariantConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str model_name: The name of the Amazon SageMaker Model entity.
        :param builtins.str variant_name: The name of the variant.
        """
...
class InferenceExperimentRealTimeInferenceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The infrastructure configuration for deploying the model to a real-time inference endpoint.
        :param builtins.int instance_count: The number of instances of the type specified by InstanceType.
        :param builtins.str instance_type: The instance type the model is deployed to.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
...
class InferenceExperimentSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The duration for which you want the inference experiment to run.
        :param builtins.str end_time: The timestamp at which the inference experiment ended or will end.
        :param builtins.str start_time: The timestamp at which the inference experiment started or will start.
        """
...
class InferenceExperimentShadowModeConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str source_model_variant_name: The name of the production variant, which takes all the inference requests.
        """
...
class InferenceExperimentShadowModelVariantConfig(dict):
    ...
    def __init__(__self__, *,
                 sampling_percentage: builtins.int,
                 shadow_model_variant_name: builtins.str):
        """
        The name and sampling percentage of a shadow variant.
        :param builtins.int sampling_percentage: The percentage of inference requests that Amazon SageMaker replicates from the production variant to the shadow variant.
        :param builtins.str shadow_model_variant_name: The name of the shadow variant.
        """
    ...
    def sampling_percentage(self) -> builtins.int:
        """
...
class ModelBiasJobDefinitionBatchTransformInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 features_attribute: Optional[builtins.str] = None,
                 inference_attribute: Optional[builtins.str] = None,
                 probability_attribute: Optional[builtins.str] = None,
                 probability_threshold_attribute: Optional[builtins.float] = None,
        ...
        :param builtins.str local_path: Path to the filesystem where the endpoint data is available to the container.
        :param builtins.str end_time_offset: Monitoring end time offset, e.g. PT0H
        :param builtins.str features_attribute: JSONpath to locate features in JSONlines dataset
        :param builtins.str inference_attribute: Index or JSONpath to locate predicted label(s)
        :param builtins.str probability_attribute: Index or JSONpath to locate probabilities
        :param builtins.float probability_threshold_attribute: The threshold for the class probability to be evaluated as a positive result.
        ...
        :param builtins.str start_time_offset: Monitoring start time offset, e.g. -PT1H
        """
        pulumi.set(__self__, "data_captured_destination_s3_uri", data_captured_destination_s3_uri)
        pulumi.set(__self__, "dataset_format", dataset_format)
        pulumi.set(__self__, "local_path", local_path)
    ...
    def features_attribute(self) -> Optional[builtins.str]:
        """
    ...
    def inference_attribute(self) -> Optional[builtins.str]:
        """
    ...
    def probability_attribute(self) -> Optional[builtins.str]:
        """
    ...
    def probability_threshold_attribute(self) -> Optional[builtins.float]:
        """
...
class ModelBiasJobDefinitionModelBiasAppSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container image configuration object for the monitoring job.
        :param builtins.str config_uri: The S3 URI to an analysis configuration file
        :param builtins.str image_uri: The container image to be run by the monitoring job.
        :param Any environment: Sets the environment variables in the Docker container
        """
...
class ModelBiasJobDefinitionModelBiasBaselineConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param builtins.str baselining_job_name: The name of the baseline model bias job.
...
class ModelCardAdditionalInformation(dict):
    ...
    def __init__(__self__, *,
                 caveats_and_recommendations: Optional[builtins.str] = None,
                 custom_details: Optional[Mapping[str, builtins.str]] = None,
                 ethical_considerations: Optional[builtins.str] = None):
        """
        :param builtins.str caveats_and_recommendations: Caveats and recommendations for people who might use this model in their applications.
        :param Mapping[str, builtins.str] custom_details: customer details.
        :param builtins.str ethical_considerations: Any ethical considerations that the author wants to provide.
        """
    ...
    def caveats_and_recommendations(self) -> Optional[builtins.str]:
        """
    ...
    def ethical_considerations(self) -> Optional[builtins.str]:
        """
...
class ModelCardBarChartMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Sequence[builtins.float],
                 notes: Optional[builtins.str] = None,
                 x_axis_name: Optional[Sequence[builtins.str]] = None,
                 y_axis_name: Optional[builtins.str] = None):
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence[builtins.float]:
        return pulumi.get(self, "value")
    ...
    def x_axis_name(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "x_axis_name")

    @property
    @pulumi.getter(name="yAxisName")
    def y_axis_name(self) -> Optional[builtins.str]:
...
class ModelCardBusinessDetails(dict):
    ...
    def __init__(__self__, *,
                 business_problem: Optional[builtins.str] = None,
                 business_stakeholders: Optional[builtins.str] = None,
                 line_of_business: Optional[builtins.str] = None):
        """
        Business details.
        :param builtins.str business_problem: What business problem does the model solve?
        :param builtins.str business_stakeholders: Business stakeholders.
        :param builtins.str line_of_business: Line of business.
        """
    ...
    def business_problem(self) -> Optional[builtins.str]:
        """
    ...
    def business_stakeholders(self) -> Optional[builtins.str]:
        """
    ...
    def line_of_business(self) -> Optional[builtins.str]:
        """
        Line of business.
        """
...
class ModelCardContainer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 nearest_model_name: Optional[builtins.str] = None):
        """
        :param builtins.str image: Inference environment path. The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored.
        :param builtins.str model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored.
        :param builtins.str nearest_model_name: The name of a pre-trained machine learning benchmarked by Amazon SageMaker Inference Recommender model that matches your model.
        """
        pulumi.set(__self__, "image", image)
    ...
    def nearest_model_name(self) -> Optional[builtins.str]:
        """
...
class ModelCardEvaluationDetail(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 datasets: Optional[Sequence[builtins.str]] = None,
                 evaluation_job_arn: Optional[builtins.str] = None,
                 evaluation_observation: Optional[builtins.str] = None,
                 metadata: Optional[Mapping[str, builtins.str]] = None,
                 metric_groups: Optional[Sequence['outputs.ModelCardMetricGroup']] = None):
        """
        item of evaluation details
        :param Mapping[str, builtins.str] metadata: additional attributes associated with the evaluation results.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def datasets(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "datasets")

    @property
    @pulumi.getter(name="evaluationJobArn")
    def evaluation_job_arn(self) -> Optional[builtins.str]:
        return pulumi.get(self, "evaluation_job_arn")

    @property
    @pulumi.getter(name="evaluationObservation")
    def evaluation_observation(self) -> Optional[builtins.str]:
...
class ModelCardIntendedUses(dict):
    ...
    def __init__(__self__, *,
                 explanations_for_risk_rating: Optional[builtins.str] = None,
                 factors_affecting_model_efficiency: Optional[builtins.str] = None,
                 intended_uses: Optional[builtins.str] = None,
                 purpose_of_model: Optional[builtins.str] = None,
                 risk_rating: Optional['ModelCardRiskRating'] = None):
        """
        Intended usage of model.
        :param builtins.str explanations_for_risk_rating: An explanation of why your organization categorizes the model with its risk rating.
        :param builtins.str factors_affecting_model_efficiency: Factors affecting model efficacy.
        :param builtins.str intended_uses: intended use cases.
        :param builtins.str purpose_of_model: Why the model was developed?
    ...
    def explanations_for_risk_rating(self) -> Optional[builtins.str]:
        """
    ...
    def factors_affecting_model_efficiency(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="intendedUses")
    def intended_uses(self) -> Optional[builtins.str]:
        """
        intended use cases.
        """
        return pulumi.get(self, "intended_uses")
    ...
    def purpose_of_model(self) -> Optional[builtins.str]:
        """
...
class ModelCardLinearGraphMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Sequence[Sequence[builtins.float]],
                 notes: Optional[builtins.str] = None,
                 x_axis_name: Optional[builtins.str] = None,
                 y_axis_name: Optional[builtins.str] = None):
        """
        Linear graph metric.
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Sequence[Sequence[builtins.float]]:
        return pulumi.get(self, "value")
    ...
    @property
    @pulumi.getter(name="xAxisName")
    def x_axis_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "x_axis_name")
...
class ModelCardMatrixMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 notes: Optional[builtins.str] = None,
                 x_axis_name: Optional[Sequence[builtins.str]] = None,
                 y_axis_name: Optional[Sequence[builtins.str]] = None):
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
        if notes is not None:
    ...
    @property
    @pulumi.getter(name="yAxisName")
    def y_axis_name(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "y_axis_name")
...
class ModelCardModelOverview(dict):
    ...
    def __init__(__self__, *,
                 algorithm_type: Optional[builtins.str] = None,
                 inference_environment: Optional['outputs.ModelCardModelOverviewInferenceEnvironmentProperties'] = None,
                 model_artifact: Optional[Sequence[builtins.str]] = None,
                 model_creator: Optional[builtins.str] = None,
                 model_description: Optional[builtins.str] = None,
                 model_id: Optional[builtins.str] = None,
                 model_name: Optional[builtins.str] = None,
                 model_owner: Optional[builtins.str] = None,
                 model_version: Optional[builtins.float] = None,
                 problem_type: Optional[builtins.str] = None):
        """
        Overview about the model.
        :param builtins.str algorithm_type: Algorithm used to solve the problem.
        :param 'ModelCardModelOverviewInferenceEnvironmentProperties' inference_environment: Overview about the inference.
        :param Sequence[builtins.str] model_artifact: Location of the model artifact.
        :param builtins.str model_creator: Creator of model.
        :param builtins.str model_description: description of model.
        :param builtins.str model_id: SageMaker Model Arn or Non SageMaker Model id.
        :param builtins.str model_name: Name of the model.
        :param builtins.str model_owner: Owner of model.
        :param builtins.float model_version: Version of the model.
        :param builtins.str problem_type: Problem being solved with the model.
        """
    ...
    def algorithm_type(self) -> Optional[builtins.str]:
        """
    ...
    def model_artifact(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def model_creator(self) -> Optional[builtins.str]:
        """
        Creator of model.
        """
    ...
    def model_owner(self) -> Optional[builtins.str]:
        """
        Owner of model.
        """
    ...
    def model_version(self) -> Optional[builtins.float]:
        """
    ...
    def problem_type(self) -> Optional[builtins.str]:
        """
...
class ModelCardModelOverviewInferenceEnvironmentProperties(dict):
    ...
    def __init__(__self__, *,
                 container_image: Optional[Sequence[builtins.str]] = None):
        """
        Overview about the inference.
        :param Sequence[builtins.str] container_image: SageMaker inference image uri.
        """
    ...
    def container_image(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ModelCardModelPackageCreator(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str user_profile_name: The name of the user's profile in Studio
        """
    ...
    def user_profile_name(self) -> Optional[builtins.str]:
        """
...
class ModelCardModelPackageDetails(dict):
    ...
    def __init__(__self__, *,
                 approval_description: Optional[builtins.str] = None,
                 ...
                 model_package_arn: Optional[builtins.str] = None,
                 model_package_description: Optional[builtins.str] = None,
                 model_package_group_name: Optional[builtins.str] = None,
                 ...
                 model_package_version: Optional[builtins.float] = None,
                 source_algorithms: Optional[Sequence['outputs.ModelCardSourceAlgorithm']] = None,
                 task: Optional[builtins.str] = None):
        """
        Metadata information related to model package version
        :param builtins.str approval_description: A description provided for the model approval
        :param 'ModelCardModelPackageCreator' created_by: Information about the user who created model package.
        :param builtins.str domain: The machine learning domain of the model package you specified. Common machine learning domains include computer vision and natural language processing.
        ...
        :param builtins.str model_package_description: A brief summary of the model package
        :param builtins.str model_package_group_name: If the model is a versioned model, the name of the model group that the versioned model belongs to.
        :param builtins.str model_package_name: Name of the model package
        :param 'ModelCardModelPackageDetailsModelPackageStatus' model_package_status: Current status of model package
        :param builtins.float model_package_version: Version of the model package
        :param Sequence['ModelCardSourceAlgorithm'] source_algorithms: A list of algorithms that were used to create a model package.
        :param builtins.str task: The machine learning task you specified that your model package accomplishes. Common machine learning tasks include object detection and image classification.
        """
    ...
    def model_package_description(self) -> Optional[builtins.str]:
        """
    ...
    def model_package_group_name(self) -> Optional[builtins.str]:
        """
    ...
    def model_package_version(self) -> Optional[builtins.float]:
        """
...
class ModelCardObjectiveFunction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str notes: Notes about the object function, including other considerations for possible objective functions.
        """
...
class ModelCardObjectiveFunctionFunctionProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 facet: Optional[builtins.str] = None,
    ...
    @property
    @pulumi.getter
    def facet(self) -> Optional[builtins.str]:
...
class ModelCardSecurityConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_id: A Key Management Service key ID to use for encrypting a model card.
        """
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class ModelCardSourceAlgorithm(dict):
    ...
    def __init__(__self__, *,
                 ...
                 model_data_url: Optional[builtins.str] = None):
        """
        :param builtins.str algorithm_name: The name of an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param builtins.str model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored.
        """
...
class ModelCardTrainingDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 training_observations: Optional[builtins.str] = None):
        """
        Overview about the training.
        ...
        :param builtins.str training_observations: Any observations about training.
        """
    ...
    def training_observations(self) -> Optional[builtins.str]:
        """
...
class ModelCardTrainingDetailsTrainingJobDetailsProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 training_arn: Optional[builtins.str] = None,
                 training_datasets: Optional[Sequence[builtins.str]] = None,
        ...
        """
        Details about any associated training jobs.
        :param builtins.str training_arn: SageMaker Training job arn.
        :param Sequence[builtins.str] training_datasets: Location of the model datasets.
        """
    ...
    def training_arn(self) -> Optional[builtins.str]:
        """
    ...
    def training_datasets(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ModelCardTrainingDetailsTrainingJobDetailsPropertiesTrainingEnvironmentProperties(dict):
    ...
    def __init__(__self__, *,
                 container_image: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] container_image: SageMaker training image uri.
        """
        if container_image is not None:
            pulumi.set(__self__, "container_image", container_image)
...
class ModelCardTrainingHyperParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        training hyper parameter
        :param builtins.str name: The name of the hyper parameter.
        :param builtins.str value: The value specified for the hyper parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class ModelCardTrainingMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        training metric data.
        :param builtins.str name: The name of the result from the SageMaker AI training job.
        :param builtins.float value: The value of a result from the SageMaker AI training job.
        :param builtins.str notes: Any additional notes describing the result of the training job.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
        if notes is not None:
...
class ModelCardUserContext(dict):
    ...
    def __init__(__self__, *,
                 domain_id: Optional[builtins.str] = None,
                 user_profile_arn: Optional[builtins.str] = None,
                 user_profile_name: Optional[builtins.str] = None):
        """
        Information about the user who created or modified an experiment, trial, trial component, lineage group, project, or model card.
        :param builtins.str domain_id: The domain associated with the user.
        :param builtins.str user_profile_arn: The Amazon Resource Name (ARN) of the user's profile.
        :param builtins.str user_profile_name: The name of the user's profile.
        """
        if domain_id is not None:
            pulumi.set(__self__, "domain_id", domain_id)
...
class ModelExplainabilityJobDefinitionModelExplainabilityBaselineConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param builtins.str baselining_job_name: The name of the baseline model explainability job.
...
class ModelPackageAdditionalInferenceSpecificationDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 description: Optional[builtins.str] = None,
                 supported_content_types: Optional[Sequence[builtins.str]] = None,
                 supported_realtime_inference_instance_types: Optional[Sequence[builtins.str]] = None,
                 supported_response_mime_types: Optional[Sequence[builtins.str]] = None,
                 supported_transform_instance_types: Optional[Sequence[builtins.str]] = None):
        """
        Additional Inference Specification specifies details about inference jobs that can be run with models based on this model package.AdditionalInferenceSpecifications can be added to existing model packages using AdditionalInferenceSpecificationsToAdd.
        ...
        :param builtins.str name: A unique name to identify the additional inference specification. The name must be unique within the list of your additional inference specifications for a particular model package.
        :param builtins.str description: A description of the additional Inference specification.
        :param Sequence[builtins.str] supported_content_types: The supported MIME types for the input data.
        :param Sequence[builtins.str] supported_realtime_inference_instance_types: A list of the instance types that are used to generate inferences in real-time
        :param Sequence[builtins.str] supported_response_mime_types: The supported MIME types for the output data.
        :param Sequence[builtins.str] supported_transform_instance_types: A list of the instance types on which a transformation job can be run or on which an endpoint can be deployed.
        """
        pulumi.set(__self__, "containers", containers)
        pulumi.set(__self__, "name", name)
        if description is not None:
    ...
    def supported_content_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def supported_realtime_inference_instance_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def supported_response_mime_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def supported_transform_instance_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ModelPackageContainerDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 framework_version: Optional[builtins.str] = None,
        ...
        """
        Describes the Docker container for the model package.
        :param builtins.str image: The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored.
        :param builtins.str container_hostname: The DNS host name for the Docker container.
        :param builtins.str framework: The machine learning framework of the model package container image.
        :param builtins.str framework_version: The framework version of the Model Package Container Image.
        :param builtins.str image_digest: An MD5 hash of the training algorithm that identifies the Docker image used for training.
        :param builtins.str model_data_url: A structure with Model Input details.
        :param builtins.str nearest_model_name: The name of a pre-trained machine learning benchmarked by Amazon SageMaker Inference Recommender model that matches your model.
        """
        pulumi.set(__self__, "image", image)
    ...
    def framework_version(self) -> Optional[builtins.str]:
        """
...
class ModelPackageContainerDefinitionModelInputProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_input_config: The input configuration object for the model.
        """
...
class ModelPackageFileSource(dict):
    ...
    def __init__(__self__, *,
                 s3_uri: builtins.str,
                 content_digest: Optional[builtins.str] = None,
                 content_type: Optional[builtins.str] = None):
        """
        Represents a File Source Object.
        :param builtins.str s3_uri: The Amazon S3 URI for the file source.
        :param builtins.str content_digest: The digest of the file source.
        :param builtins.str content_type: The type of content stored in the file source.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
    ...
    def content_digest(self) -> Optional[builtins.str]:
        """
...
class ModelPackageInferenceSpecification(dict):
    ...
    def __init__(__self__, *,
                 containers: Sequence['outputs.ModelPackageContainerDefinition'],
                 supported_content_types: Sequence[builtins.str],
                 supported_response_mime_types: Sequence[builtins.str],
                 supported_realtime_inference_instance_types: Optional[Sequence[builtins.str]] = None,
                 supported_transform_instance_types: Optional[Sequence[builtins.str]] = None):
        """
        Details about inference jobs that can be run with models based on this model package.
    ...
    @property
    @pulumi.getter(name="supportedContentTypes")
    def supported_content_types(self) -> Sequence[builtins.str]:
        """
        The supported MIME types for the input data.
        """
        return pulumi.get(self, "supported_content_types")
    ...
    @property
    @pulumi.getter(name="supportedResponseMimeTypes")
    def supported_response_mime_types(self) -> Sequence[builtins.str]:
        """
        The supported MIME types for the output data.
        """
        return pulumi.get(self, "supported_response_mime_types")
...
class ModelPackageMetadataProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 generated_by: Optional[builtins.str] = None,
                 project_id: Optional[builtins.str] = None,
                 repository: Optional[builtins.str] = None):
        """
        Metadata properties of the tracking entity, trial, or trial component.
        :param builtins.str commit_id: The commit ID.
        :param builtins.str generated_by: The entity this entity was generated by.
        :param builtins.str project_id: The project ID metadata.
        :param builtins.str repository: The repository metadata.
        """
    ...
    def generated_by(self) -> Optional[builtins.str]:
        """
...
class ModelPackageMetricsSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a Metric Source Object.
        :param builtins.str content_type: The type of content stored in the metric source.
        :param builtins.str s3_uri: The Amazon S3 URI for the metric source.
        :param builtins.str content_digest: The digest of the metric source.
        """
        pulumi.set(__self__, "content_type", content_type)
        pulumi.set(__self__, "s3_uri", s3_uri)
        if content_digest is not None:
...
class ModelPackageModelAccessConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the access configuration file for the ML model.
        :param builtins.bool accept_eula: Specifies agreement to the model end-user license agreement (EULA).
        """
...
class ModelPackageModelCard(dict):
    ...
    def __init__(__self__, *,
                 model_card_content: builtins.str,
                 model_card_status: 'ModelPackageModelCardModelCardStatus'):
        """
        The model card associated with the model package.
        :param builtins.str model_card_content: The content of the model card.
    ...
    def model_card_content(self) -> builtins.str:
        """
        The content of the model card.
        """
...
class ModelPackageS3DataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_uri: Depending on the value specified for the S3DataType, identifies either a key name prefix or a manifest.
        """
...
class ModelPackageS3ModelDataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_uri: Specifies the S3 path of ML model data to deploy.
        """
...
class ModelPackageSecurityConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An optional AWS Key Management Service key to encrypt, decrypt, and re-encrypt model package information for regulated workloads with highly sensitive data.
        :param builtins.str kms_key_id: The AWS KMS Key ID (KMSKeyId) used for encryption of model package information.
        """
        pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class ModelPackageSourceAlgorithm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your Amazon SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param builtins.str algorithm_name: The name of an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your Amazon SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param builtins.str model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        """
        pulumi.set(__self__, "algorithm_name", algorithm_name)
        if model_data_url is not None:
            pulumi.set(__self__, "model_data_url", model_data_url)
...
class ModelPackageStatusItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the overall status of a model package.
        :param builtins.str name: The name of the model package for which the overall status is being reported.
        :param 'ModelPackageStatusItemStatus' status: The current status.
        :param builtins.str failure_reason: If the overall status is Failed, the reason for the failure.
        """
        pulumi.set(__self__, "name", name)
...
class ModelPackageTransformInput(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str content_type: The multipurpose internet mail extension (MIME) type of the data. Amazon SageMaker uses the MIME type with each http call to transfer data to the transform job.
...
class ModelPackageTransformJobDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 environment: Optional['outputs.ModelPackageEnvironment'] = None,
                 max_concurrent_transforms: Optional[builtins.int] = None,
                 max_payload_in_mb: Optional[builtins.int] = None):
        """
        Defines the input needed to run a transform job using the inference specification specified in the algorithm.
        ...
        :param builtins.int max_concurrent_transforms: The maximum number of parallel requests that can be sent to each instance in a transform job. The default value is 1.
        :param builtins.int max_payload_in_mb: The maximum payload size allowed, in MB. A payload is the data portion of a record (without metadata).
        """
    ...
    def max_concurrent_transforms(self) -> Optional[builtins.int]:
        """
    ...
    def max_payload_in_mb(self) -> Optional[builtins.int]:
        """
...
class ModelPackageTransformOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 accept: Optional[builtins.str] = None,
                 assemble_with: Optional['ModelPackageTransformOutputAssembleWith'] = None,
                 kms_key_id: Optional[builtins.str] = None):
        """
        Describes the results of a transform job.
        :param builtins.str s3_output_path: The Amazon S3 path where you want Amazon SageMaker to store the results of the transform job.
        :param builtins.str accept: The MIME type used to specify the output data. Amazon SageMaker uses the MIME type with each http call to transfer data from the transform job.
    ...
    @property
    @pulumi.getter
    def accept(self) -> Optional[builtins.str]:
        """
...
class ModelPackageTransformResources(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the resources, including ML instance types and ML instance count, to use for transform job.
        :param builtins.int instance_count: The number of ML compute instances to use in the transform job. For distributed transform jobs, specify a value greater than 1. The default value is 1.
        :param builtins.str instance_type: The ML compute instance type for the transform job.
        :param builtins.str volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt model data on the storage volume attached to the ML compute instance(s) that run the batch transform job.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
        if volume_kms_key_id is not None:
...
class ModelPackageValidationProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains data, such as the inputs and targeted instance types that are used in the process of validating the model package.
        :param builtins.str profile_name: The name of the profile for the model package.
...
class ModelPackageValidationSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str validation_role: The IAM roles to be used for the validation of the model package.
        """
...
class ModelQualityJobDefinitionModelQualityBaselineConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param builtins.str baselining_job_name: The name of the job that performs baselining for the monitoring job.
...
class MonitoringScheduleConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 monitoring_job_definition_name: Optional[builtins.str] = None,
        ...
        :param builtins.str monitoring_job_definition_name: Name of the job definition
    ...
    def monitoring_job_definition_name(self) -> Optional[builtins.str]:
        """
...
class MonitoringScheduleMonitoringExecutionSummary(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failure_reason: Optional[builtins.str] = None,
                 processing_job_arn: Optional[builtins.str] = None):
        """
        Summary of information about monitoring job
        :param builtins.str creation_time: The time at which the monitoring job was created.
        :param builtins.str last_modified_time: A timestamp that indicates the last time the monitoring job was modified.
        ...
        :param builtins.str monitoring_schedule_name: The name of the monitoring schedule.
        :param builtins.str scheduled_time: The time the monitoring job was scheduled.
        :param builtins.str endpoint_name: The name of the endpoint used to run the monitoring job.
        :param builtins.str failure_reason: Contains the reason a monitoring job failed, if it failed.
        :param builtins.str processing_job_arn: The Amazon Resource Name (ARN) of the monitoring job.
        """
...
class MonitoringScheduleMonitoringJobDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of an IAM role that Amazon SageMaker can assume to perform tasks on your behalf.
...
class MonitoringScheduleScheduleConfig(dict):
    ...
    def __init__(__self__, *,
                 schedule_expression: builtins.str,
                 data_analysis_end_time: Optional[builtins.str] = None,
                 data_analysis_start_time: Optional[builtins.str] = None):
        """
        Configuration details about the monitoring schedule.
        :param builtins.str schedule_expression: A cron expression or 'NOW' that describes details about the monitoring schedule.
        :param builtins.str data_analysis_end_time: Data Analysis end time, e.g. PT0H
        :param builtins.str data_analysis_start_time: Data Analysis start time, e.g. -PT1H
        """
        pulumi.set(__self__, "schedule_expression", schedule_expression)
    ...
    def data_analysis_end_time(self) -> Optional[builtins.str]:
        """
    ...
    def data_analysis_start_time(self) -> Optional[builtins.str]:
        """
...
class OfflineStoreConfigProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool disable_glue_table_creation: Set to `True` to disable the automatic creation of an AWS Glue table when configuring an `OfflineStore` . If set to `False` , Feature Store will name the `OfflineStore` Glue table following [Athena's naming recommendations](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html) .
...
class OnlineStoreConfigProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration of an `OnlineStore` .
        :param builtins.bool enable_online_store: Turn `OnlineStore` off by specifying `False` for the `EnableOnlineStore` flag. Turn `OnlineStore` on by specifying `True` for the `EnableOnlineStore` flag.
...
class ParallelismConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The parallelism configuration applied to the pipeline.
        :param builtins.int max_parallel_execution_steps: Maximum parallel execution steps
        """
...
class PartnerAppConfig(dict):
    ...
    def __init__(__self__, *,
                 admin_users: Optional[Sequence[builtins.str]] = None,
                 arguments: Optional[Mapping[str, builtins.str]] = None):
        """
        A collection of configuration settings for the PartnerApp.
        :param Sequence[builtins.str] admin_users: A list of users with administrator privileges for the PartnerApp.
        :param Mapping[str, builtins.str] arguments: A list of arguments to pass to the PartnerApp.
        """
    ...
    def admin_users(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PartnerAppMaintenanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A collection of settings that specify the maintenance schedule for the PartnerApp.
        :param builtins.str maintenance_window_start: The maintenance window start day and time for the PartnerApp.
        """
...
class PipelineDefinition0Properties(dict):
    ...
    def __init__(__self__, *,
                 pipeline_definition_body: builtins.str):
        """
        The definition of the pipeline. This can be either a JSON string or an Amazon S3 location.
        :param builtins.str pipeline_definition_body: A specification that defines the pipeline in JSON format.
        """
        pulumi.set(__self__, "pipeline_definition_body", pipeline_definition_body)

    @property
    @pulumi.getter(name="pipelineDefinitionBody")
    def pipeline_definition_body(self) -> builtins.str:
        """
...
class PipelineS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket: The name of the S3 bucket where the PipelineDefinition file is stored.
        :param builtins.str key: The file name of the PipelineDefinition file (Amazon S3 object name).
        :param builtins.str e_tag: The Amazon S3 ETag (a file checksum) of the PipelineDefinition file. If you don't specify a value, SageMaker skips ETag validation of your PipelineDefinition file.
        :param builtins.str version: For versioning-enabled buckets, a specific version of the PipelineDefinition file.
        """
...
class ProjectCfnStackParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the parameter.
...
class ServiceCatalogProvisionedProductDetailsProperties(dict):
    ...
    def __init__(__self__, *,
                 provisioned_product_id: Optional[builtins.str] = None,
                 provisioned_product_status_message: Optional[builtins.str] = None):
        """
        Provisioned ServiceCatalog  Details
        :param builtins.str provisioned_product_id: The ID of the provisioned product.
        :param builtins.str provisioned_product_status_message: The current status of the product.
    ...
    def provisioned_product_status_message(self) -> Optional[builtins.str]:
        """
...
class SpaceEbsStorageSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties related to the space's Amazon Elastic Block Store volume.
        :param builtins.int ebs_volume_size_in_gb: Size of the Amazon EBS volume in Gb
        """
...
class SpaceIdleSettings(dict):
    ...
    def __init__(__self__, *,
                 idle_timeout_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.int idle_timeout_in_minutes: The space idle timeout value set in minutes
        """
        if idle_timeout_in_minutes is not None:
            pulumi.set(__self__, "idle_timeout_in_minutes", idle_timeout_in_minutes)
...
class SpaceOwnershipSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str owner_user_profile_name: The user profile who is the owner of the space.
        """
...
class UserProfileUserSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'UserProfileCustomPosixUserConfig' custom_posix_user_config: Details about the POSIX identity that is used for file system operations.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param builtins.str default_landing_uri: Defines which Amazon SageMaker application users are directed to by default.
        :param builtins.str execution_role: The user profile Amazon Resource Name (ARN).
