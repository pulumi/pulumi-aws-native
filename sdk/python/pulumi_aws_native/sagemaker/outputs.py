...
class DomainUnifiedStudioSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 single_sign_on_application_arn: Optional[_builtins.str] = None,
        ...
        :param _builtins.str single_sign_on_application_arn: The ARN of the DataZone application managed by SageMaker Unified Studio in the AWS IAM Identity Center.
