...
class GetStudioLifecycleConfigResult:
    ...
    def studio_lifecycle_config_arn(self) -> Optional[builtins.str]:
        """
...
def get_studio_lifecycle_config(studio_lifecycle_config_name: Optional[builtins.str] = None,
    ...
    :param builtins.str studio_lifecycle_config_name: The name of the Amazon SageMaker Studio Lifecycle Configuration.
    """
    __args__ = dict()
...
def get_studio_lifecycle_config_output(studio_lifecycle_config_name: Optional[pulumi.Input[builtins.str]] = None,
