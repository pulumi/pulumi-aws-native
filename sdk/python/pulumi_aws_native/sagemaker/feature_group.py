...
class FeatureGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_time_feature_name: The Event Time Feature Name.
        ...
        :param pulumi.Input[builtins.str] record_identifier_feature_name: The Record Identifier Feature Name.
        :param pulumi.Input[builtins.str] description: Description about the FeatureGroup.
        :param pulumi.Input[builtins.str] feature_group_name: The Name of the FeatureGroup.
...
class FeatureGroup(pulumi.CustomResource):
    ...
    def feature_group_status(self) -> pulumi.Output[builtins.str]:
        """
