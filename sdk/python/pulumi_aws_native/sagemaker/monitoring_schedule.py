...
class MonitoringSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(last_monitoring_execution_summary, MonitoringScheduleMonitoringExecutionSummaryArgs):
            ...
            if not isinstance(monitoring_schedule_config, MonitoringScheduleConfigArgs):
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["monitoring_schedule_name"])
