...
class MonitoringSchedule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MonitoringSchedulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MonitoringSchedulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MonitoringScheduleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MonitoringScheduleProperties']:
        """
