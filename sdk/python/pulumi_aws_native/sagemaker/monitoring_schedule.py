...
class MonitoringScheduleArgs:
    def __init__(__self__, *,
                 ...
                 monitoring_schedule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_name: The name of the endpoint using the monitoring schedule.
        :param pulumi.Input[builtins.str] failure_reason: Contains the reason a monitoring job failed, if it failed.
        ...
        :param pulumi.Input[builtins.str] monitoring_schedule_name: The name of the monitoring schedule.
    ...
    def monitoring_schedule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monitoring_schedule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MonitoringSchedule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="monitoringScheduleName")
    def monitoring_schedule_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the monitoring schedule.
        """
        return pulumi.get(self, "monitoring_schedule_name")
