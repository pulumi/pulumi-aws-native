...
class Model(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(inference_execution_config, ModelInferenceExecutionConfigArgs):
            ...
            if not isinstance(primary_container, ModelContainerDefinitionArgs):
            ...
            if not isinstance(vpc_config, ModelVpcConfigArgs):
