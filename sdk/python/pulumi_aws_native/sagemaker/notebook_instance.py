...
warnings.warn("""NotebookInstance is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class NotebookInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volume_size_in_gb: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""NotebookInstance is deprecated: NotebookInstance is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
