...
class NotebookInstance(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NotebookInstancePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NotebookInstancePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NotebookInstanceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NotebookInstanceProperties']:
        """
