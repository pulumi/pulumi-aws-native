...
class ModelQualityJobDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ModelQualityJobDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ModelQualityJobDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ModelQualityJobDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ModelQualityJobDefinitionProperties']:
        """
