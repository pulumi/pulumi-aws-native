...
class ModelQualityJobDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_definition_name: The name of the monitoring job definition.
...
class ModelQualityJobDefinition(pulumi.CustomResource):
    ...
    pulumi_type = "aws-native:sagemaker:ModelQualityJobDefinition"
