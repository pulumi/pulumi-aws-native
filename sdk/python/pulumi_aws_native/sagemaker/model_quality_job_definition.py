...
class ModelQualityJobDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(job_resources, ModelQualityJobDefinitionMonitoringResourcesArgs):
            ...
            if not isinstance(model_quality_app_specification, ModelQualityJobDefinitionModelQualityAppSpecificationArgs):
            ...
            if not isinstance(model_quality_baseline_config, ModelQualityJobDefinitionModelQualityBaselineConfigArgs):
            ...
            if not isinstance(model_quality_job_input, ModelQualityJobDefinitionModelQualityJobInputArgs):
            ...
            if not isinstance(model_quality_job_output_config, ModelQualityJobDefinitionMonitoringOutputConfigArgs):
            ...
            if not isinstance(network_config, ModelQualityJobDefinitionNetworkConfigArgs):
            ...
            if not isinstance(stopping_condition, ModelQualityJobDefinitionStoppingConditionArgs):
