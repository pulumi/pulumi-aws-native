...
class ProcessingJobArgs:
    def __init__(__self__, *,
                 ...
                 environment: pulumi.Input[Optional['ProcessingJobEnvironmentArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def environment(self) -> pulumi.Input[Optional['ProcessingJobEnvironmentArgs']]:
        """
    ...
    @environment.setter
    def environment(self, value: pulumi.Input[Optional['ProcessingJobEnvironmentArgs']]):
...
class ProcessingJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment: pulumi.Input[Optional[Union['ProcessingJobEnvironmentArgs', 'ProcessingJobEnvironmentArgsDict']]] = None,
