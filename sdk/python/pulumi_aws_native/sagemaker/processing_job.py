...
class ProcessingJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProcessingJobExperimentConfigArgs'] experiment_config: Associates a SageMaker job as a trial component with an experiment and trial. Specified when you call the following APIs:
        ...
        :param pulumi.Input['ProcessingJobStoppingConditionArgs'] stopping_condition: Specifies a limit to how long a job can run. When the job reaches the time limit, SageMaker ends the job. Use this API to cap costs.
...
class ProcessingJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ProcessingJobExperimentConfigArgs', 'ProcessingJobExperimentConfigArgsDict']] experiment_config: Associates a SageMaker job as a trial component with an experiment and trial. Specified when you call the following APIs:
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of an IAM role that Amazon SageMaker can assume to perform tasks on your behalf.
        :param pulumi.Input[Union['ProcessingJobStoppingConditionArgs', 'ProcessingJobStoppingConditionArgsDict']] stopping_condition: Specifies a limit to how long a job can run. When the job reaches the time limit, SageMaker ends the job. Use this API to cap costs.
