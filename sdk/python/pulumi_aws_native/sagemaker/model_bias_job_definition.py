...
class ModelBiasJobDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_definition_name: The name of the bias job definition. The name must be unique within an AWS Region in the AWS account.
...
class ModelBiasJobDefinition(pulumi.CustomResource):
    ...
    def job_definition_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="jobDefinitionName")
    def job_definition_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the bias job definition. The name must be unique within an AWS Region in the AWS account.
        """
        return pulumi.get(self, "job_definition_name")
