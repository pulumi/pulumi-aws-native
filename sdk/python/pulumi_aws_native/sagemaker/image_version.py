...
class ImageVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] base_image: The container image that the SageMaker image version is based on.
        :param pulumi.Input[builtins.str] image_name: The name of the parent image.
...
class ImageVersion(pulumi.CustomResource):
    ...
    def image_version_arn(self) -> pulumi.Output[builtins.str]:
        """
