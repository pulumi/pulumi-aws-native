...
class ModelCard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(content, ModelCardContentArgs):
                content = content or {}
                def _setter(key, value):
                    content[key] = value
            ...
            if not isinstance(created_by, ModelCardUserContextArgs):
                created_by = created_by or {}
                def _setter(key, value):
                    created_by[key] = value
                ModelCardUserContextArgs._configure(_setter, **created_by)
            __props__.__dict__["created_by"] = created_by
            if not isinstance(last_modified_by, ModelCardUserContextArgs):
            ...
            if not isinstance(security_config, ModelCardSecurityConfigArgs):
