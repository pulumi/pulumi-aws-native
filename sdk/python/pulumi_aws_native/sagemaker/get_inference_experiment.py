...
def get_inference_experiment(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name for the inference experiment.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_inference_experiment_output(name: Optional[pulumi.Input[builtins.str]] = None,
