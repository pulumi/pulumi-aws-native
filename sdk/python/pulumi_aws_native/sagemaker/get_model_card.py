...
class GetModelCardResult:
    ...
    def model_card_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def model_card_version(self) -> Optional[_builtins.int]:
        """
...
def get_model_card(model_card_name: Optional[_builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetModelCardResult:
    """
    Resource Type definition for AWS::SageMaker::ModelCard.


    :param _builtins.str model_card_name: The unique name of the model card.
    """
    __args__ = dict()
