...
class GetMlflowTrackingServerResult:
    ...
    def artifact_store_uri(self) -> Optional[builtins.str]:
        """
    ...
    def automatic_model_registration(self) -> Optional[builtins.bool]:
        """
    ...
    def tracking_server_arn(self) -> Optional[builtins.str]:
        """
    ...
    def weekly_maintenance_window_start(self) -> Optional[builtins.str]:
        """
...
def get_mlflow_tracking_server(tracking_server_name: Optional[builtins.str] = None,
    ...
    :param builtins.str tracking_server_name: The name of the MLFlow Tracking Server.
    """
    __args__ = dict()
...
def get_mlflow_tracking_server_output(tracking_server_name: Optional[pulumi.Input[builtins.str]] = None,
