...
class GetImageResult:
    ...
    def image_arn(self) -> Optional[builtins.str]:
        """
    ...
    def image_description(self) -> Optional[builtins.str]:
        """
    ...
    def image_display_name(self) -> Optional[builtins.str]:
        """
    ...
    def image_role_arn(self) -> Optional[builtins.str]:
        """
...
def get_image(image_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImageResult:
    """
    Resource Type definition for AWS::SageMaker::Image


    :param builtins.str image_arn: The Amazon Resource Name (ARN) of the image.
...
def get_image_output(image_arn: Optional[pulumi.Input[builtins.str]] = None,
