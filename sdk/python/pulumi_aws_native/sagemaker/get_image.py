...
class GetImageResult:
    ...
    def image_description(self) -> Optional[_builtins.str]:
        """
    ...
    def image_display_name(self) -> Optional[_builtins.str]:
        """
    ...
    def image_role_arn(self) -> Optional[_builtins.str]:
        """
...
def get_image(image_arn: Optional[_builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImageResult:
    """
    Resource Type definition for AWS::SageMaker::Image


    :param _builtins.str image_arn: The Amazon Resource Name (ARN) of the image.
