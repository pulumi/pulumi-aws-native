...
class GetProjectResult:
    ...
    def project_arn(self) -> Optional[builtins.str]:
        """
...
def get_project(project_arn: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectResult:
    """
    Resource Type definition for AWS::SageMaker::Project


    :param builtins.str project_arn: The Amazon Resource Name (ARN) of the project.
    """
    __args__ = dict()
...
def get_project_output(project_arn: Optional[pulumi.Input[builtins.str]] = None,
