...
class GetModelPackageGroupResult:
    ...
    def model_package_group_arn(self) -> Optional[builtins.str]:
        """
...
def get_model_package_group(model_package_group_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetModelPackageGroupResult:
    """
    Resource Type definition for AWS::SageMaker::ModelPackageGroup


    :param builtins.str model_package_group_arn: The Amazon Resource Name (ARN) of the model group.
    """
    __args__ = dict()
...
def get_model_package_group_output(model_package_group_arn: Optional[pulumi.Input[builtins.str]] = None,
