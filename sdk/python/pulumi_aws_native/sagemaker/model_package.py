...
class ModelPackageArgs:
    def __init__(__self__, *,
                 ...
                 approval_description: Optional[pulumi.Input[builtins.str]] = None,
                 certify_for_marketplace: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 model_package_description: Optional[pulumi.Input[builtins.str]] = None,
                 model_package_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 model_package_name: Optional[pulumi.Input[builtins.str]] = None,
                 model_package_status_details: Optional[pulumi.Input['ModelPackageStatusDetailsArgs']] = None,
                 model_package_version: Optional[pulumi.Input[builtins.int]] = None,
                 sample_payload_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] approval_description: A description provided when the model approval is set.
        :param pulumi.Input[builtins.bool] certify_for_marketplace: Whether the model package is to be certified to be listed on AWS Marketplace. For information about listing model packages on AWS Marketplace, see [List Your Algorithm or Model Package on AWS Marketplace](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-mkt-list.html) .
        :param pulumi.Input[builtins.str] client_token: A unique token that guarantees that the call to this API is idempotent.
        ...
        :param pulumi.Input[builtins.str] domain: The machine learning domain of your model package and its components. Common machine learning domains include computer vision and natural language processing.
        ...
        :param pulumi.Input[builtins.str] last_modified_time: The last time the model package was modified.
        ...
        :param pulumi.Input[builtins.str] model_package_description: The description of the model package.
        :param pulumi.Input[builtins.str] model_package_group_name: The model group to which the model belongs.
        :param pulumi.Input[builtins.str] model_package_name: The name of the model package. The name can be as follows:
        ...
        :param pulumi.Input[builtins.int] model_package_version: The version number of a versioned model.
        :param pulumi.Input[builtins.str] sample_payload_url: The Amazon Simple Storage Service path where the sample payload are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        ...
        :param pulumi.Input[builtins.str] source_uri: The URI of the source for the model package.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[builtins.str] task: The machine learning task your model package accomplishes. Common machine learning tasks include object detection and image classification.
    ...
    def approval_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def approval_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "approval_description", value)

    @property
    @pulumi.getter(name="certifyForMarketplace")
    def certify_for_marketplace(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def certify_for_marketplace(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def model_package_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def model_package_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def model_package_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def model_package_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def model_package_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def model_package_version(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "model_package_version", value)

    @property
    @pulumi.getter(name="samplePayloadUrl")
    def sample_payload_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sample_payload_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelPackage(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="approvalDescription")
    def approval_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A description provided when the model approval is set.
        """
        return pulumi.get(self, "approval_description")
    ...
    @property
    @pulumi.getter(name="certifyForMarketplace")
    def certify_for_marketplace(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the model package is to be certified to be listed on AWS Marketplace. For information about listing model packages on AWS Marketplace, see [List Your Algorithm or Model Package on AWS Marketplace](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-mkt-list.html) .
        """
        return pulumi.get(self, "certify_for_marketplace")
    ...
    def model_package_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="modelPackageDescription")
    def model_package_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the model package.
        """
        return pulumi.get(self, "model_package_description")
    ...
    @property
    @pulumi.getter(name="modelPackageGroupName")
    def model_package_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The model group to which the model belongs.
        """
        return pulumi.get(self, "model_package_group_name")
    ...
    @property
    @pulumi.getter(name="modelPackageName")
    def model_package_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the model package. The name can be as follows:
    ...
    @property
    @pulumi.getter(name="modelPackageVersion")
    def model_package_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The version number of a versioned model.
        """
        return pulumi.get(self, "model_package_version")
    ...
    @property
    @pulumi.getter(name="samplePayloadUrl")
    def sample_payload_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Simple Storage Service path where the sample payload are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        """
        return pulumi.get(self, "sample_payload_url")
