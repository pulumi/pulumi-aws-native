...
class GetInferenceComponentResult:
    ...
    def inference_component_arn(self) -> Optional[builtins.str]:
        """
    ...
    def inference_component_name(self) -> Optional[builtins.str]:
        """
...
def get_inference_component(inference_component_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str inference_component_arn: The Amazon Resource Name (ARN) of the inference component.
    """
    __args__ = dict()
...
def get_inference_component_output(inference_component_arn: Optional[pulumi.Input[builtins.str]] = None,
