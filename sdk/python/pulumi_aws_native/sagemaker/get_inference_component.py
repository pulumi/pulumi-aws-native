...
class GetInferenceComponentResult:
    ...
    def inference_component_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def inference_component_name(self) -> Optional[_builtins.str]:
        """
...
def get_inference_component(inference_component_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str inference_component_arn: The Amazon Resource Name (ARN) of the inference component.
    """
    __args__ = dict()
