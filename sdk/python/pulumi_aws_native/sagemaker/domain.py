...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(default_space_settings, DomainDefaultSpaceSettingsArgs):
            ...
            if not isinstance(default_user_settings, DomainUserSettingsArgs):
            ...
            if not isinstance(domain_settings, DomainSettingsArgs):
