...
def get_device_fleet(device_fleet_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeviceFleetResult:
    """
    Resource schema for AWS::SageMaker::DeviceFleet


    :param builtins.str device_fleet_name: The name of the edge device fleet
    """
    __args__ = dict()
...
def get_device_fleet_output(device_fleet_name: Optional[pulumi.Input[builtins.str]] = None,
