...
class MlflowTrackingServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] artifact_store_uri: The Amazon S3 URI for MLFlow Tracking Server artifacts.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of an IAM role that enables Amazon SageMaker to perform tasks on behalf of the customer.
        :param pulumi.Input[builtins.bool] automatic_model_registration: A flag to enable Automatic SageMaker Model Registration.
        :param pulumi.Input[builtins.str] mlflow_version: The MLFlow Version used on the MLFlow Tracking Server.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[builtins.str] tracking_server_name: The name of the MLFlow Tracking Server.
        :param pulumi.Input['MlflowTrackingServerTrackingServerSize'] tracking_server_size: The size of the MLFlow Tracking Server.
        :param pulumi.Input[builtins.str] weekly_maintenance_window_start: The start of the time window for maintenance of the MLFlow Tracking Server in UTC time.
        """
...
class MlflowTrackingServer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="mlflowVersion")
    def mlflow_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The MLFlow Version used on the MLFlow Tracking Server.
        """
        return pulumi.get(self, "mlflow_version")
    ...
    def tracking_server_arn(self) -> pulumi.Output[builtins.str]:
        """
