...
class DataQualityJobDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(data_quality_app_specification, DataQualityJobDefinitionDataQualityAppSpecificationArgs):
            ...
            if not isinstance(data_quality_baseline_config, DataQualityJobDefinitionDataQualityBaselineConfigArgs):
            ...
            if not isinstance(data_quality_job_input, DataQualityJobDefinitionDataQualityJobInputArgs):
            ...
            if not isinstance(data_quality_job_output_config, DataQualityJobDefinitionMonitoringOutputConfigArgs):
            ...
            if not isinstance(job_resources, DataQualityJobDefinitionMonitoringResourcesArgs):
            ...
            if not isinstance(network_config, DataQualityJobDefinitionNetworkConfigArgs):
            ...
            if not isinstance(stopping_condition, DataQualityJobDefinitionStoppingConditionArgs):
