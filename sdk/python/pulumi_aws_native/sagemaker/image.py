...
class ImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] image_display_name: The display name of the image.
               
               *Length Constraints* : Minimum length of 1. Maximum length of 128.
               
               *Pattern* : `^\\S(.*\\S)?$`
        :param pulumi.Input[_builtins.str] image_name: The name of the Image. Must be unique by region in your account.
    ...
    def image_role_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def image_role_arn(self, value: pulumi.Input[_builtins.str]):
...
class Image(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="imageDisplayName")
    def image_display_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The display name of the image.
    ...
    @_builtins.property
    @pulumi.getter(name="imageRoleArn")
    def image_role_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The Amazon Resource Name (ARN) of an IAM role that enables Amazon SageMaker to perform tasks on your behalf.
