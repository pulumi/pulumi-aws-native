...
class UserProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] single_sign_on_user_identifier: A specifier for the type of value specified in SingleSignOnUserValue. Currently, the only supported value is "UserName". If the Domain's AuthMode is SSO, this field is required. If the Domain's AuthMode is not SSO, this field cannot be specified.
        ...
        :param pulumi.Input[builtins.str] user_profile_name: A name for the UserProfile.
...
class UserProfile(pulumi.CustomResource):
    ...
    def user_profile_arn(self) -> pulumi.Output[builtins.str]:
        """
