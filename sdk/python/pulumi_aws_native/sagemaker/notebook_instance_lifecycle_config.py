...
class NotebookInstanceLifecycleConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] notebook_instance_lifecycle_config_name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-notebookinstancelifecycleconfig.html#cfn-sagemaker-notebookinstancelifecycleconfig-notebookinstancelifecycleconfigname
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NotebookInstanceLifecycleConfigNotebookInstanceLifecycleHookArgs']]]] on_create: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-notebookinstancelifecycleconfig.html#cfn-sagemaker-notebookinstancelifecycleconfig-oncreate
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NotebookInstanceLifecycleConfigNotebookInstanceLifecycleHookArgs']]]] on_start: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-notebookinstancelifecycleconfig.html#cfn-sagemaker-notebookinstancelifecycleconfig-onstart
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="notebookInstanceLifecycleConfigName")
    def notebook_instance_lifecycle_config_name(self) -> pulumi.Output[str]:
        return pulumi.get(self, "notebook_instance_lifecycle_config_name")
