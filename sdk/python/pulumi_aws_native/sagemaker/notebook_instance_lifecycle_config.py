...
warnings.warn("""NotebookInstanceLifecycleConfig is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class NotebookInstanceLifecycleConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 on_start: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NotebookInstanceLifecycleConfigNotebookInstanceLifecycleHookArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NotebookInstanceLifecycleConfig is deprecated: NotebookInstanceLifecycleConfig is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
