...
class DeviceFleetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: Role associated with the device fleet
        :param pulumi.Input[builtins.str] description: Description for the edge device fleet
