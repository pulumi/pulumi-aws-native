...
class GetImageVersionResult:
    ...
    @_builtins.property
    @pulumi.getter
    def horovod(self) -> Optional[_builtins.bool]:
    ...
    def image_version_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def ml_framework(self) -> Optional[_builtins.str]:
    ...
    def programming_lang(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "programming_lang")

    @_builtins.property
    @pulumi.getter(name="releaseNotes")
    def release_notes(self) -> Optional[_builtins.str]:
...
def get_image_version(image_version_arn: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImageVersionResult:
    """
    Resource Type definition for AWS::SageMaker::ImageVersion


    :param _builtins.str image_version_arn: The Amazon Resource Name (ARN) of the image version.
...
def get_image_version_output(image_version_arn: Optional[pulumi.Input[_builtins.str]] = None,
