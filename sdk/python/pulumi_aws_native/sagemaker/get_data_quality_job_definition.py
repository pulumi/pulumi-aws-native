...
def get_data_quality_job_definition(job_definition_arn: Optional[_builtins.str] = None,
...
def get_data_quality_job_definition_output(job_definition_arn: Optional[pulumi.Input[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataQualityJobDefinitionResult]:
    """
    Resource Type definition for AWS::SageMaker::DataQualityJobDefinition
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:sagemaker:getDataQualityJobDefinition', __args__, opts=opts, typ=GetDataQualityJobDefinitionResult)
    return __ret__.apply(lambda __response__: GetDataQualityJobDefinitionResult(
