...
def get_monitoring_schedule(monitoring_schedule_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringScheduleResult:
    """
    Resource Type definition for AWS::SageMaker::MonitoringSchedule


    :param builtins.str monitoring_schedule_arn: The Amazon Resource Name (ARN) of the monitoring schedule.
    """
    __args__ = dict()
...
def get_monitoring_schedule_output(monitoring_schedule_arn: Optional[pulumi.Input[builtins.str]] = None,
