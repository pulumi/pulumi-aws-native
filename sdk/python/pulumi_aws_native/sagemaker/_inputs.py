...
__all__ = [
    ...
    'DomainS3FileSystemConfigArgsDict',
    'DomainSettingsArgs',
    ...
    'UserProfileS3FileSystemConfigArgsDict',
...
if not MYPY:
    class AppImageConfigContainerConfigArgsDict(TypedDict):
        ...
        """
        container_entrypoint: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AppImageConfigContainerConfigArgs:
    def __init__(__self__, *,
                 ...
                 container_entrypoint: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        The container configuration for a SageMaker image.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_arguments: A list of arguments to apply to the container.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_entrypoint: The custom entry point to use on container.
    ...
    def container_entrypoint(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The custom entry point to use on container.
        """
    ...
    def container_entrypoint(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AppImageConfigCustomImageContainerEnvironmentVariableArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key that identifies a container environment variable.
        :param pulumi.Input[builtins.str] value: The value of the container environment variable.
        """
...
class AppImageConfigFileSystemConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The Amazon Elastic File System (EFS) storage configuration for a SageMaker image.
        :param pulumi.Input[builtins.int] default_gid: The default POSIX group ID (GID). If not specified, defaults to 100.
        :param pulumi.Input[builtins.int] default_uid: The default POSIX user ID (UID). If not specified, defaults to 1000.
...
if not MYPY:
    class AppResourceSpecArgsDict(TypedDict):
        ...
        """
        sage_maker_image_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The ARN of the SageMaker image that the image version belongs to.
        """
        sage_maker_image_version_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppResourceSpecArgs:
    def __init__(__self__, *,
                 ...
                 sage_maker_image_arn: Optional[pulumi.Input[builtins.str]] = None,
                 sage_maker_image_version_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input['AppResourceSpecInstanceType'] instance_type: The instance type that the image version runs on.
        :param pulumi.Input[builtins.str] lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration to attach to the Resource.
        :param pulumi.Input[builtins.str] sage_maker_image_arn: The ARN of the SageMaker image that the image version belongs to.
        :param pulumi.Input[builtins.str] sage_maker_image_version_arn: The ARN of the image version created on the instance.
        """
    ...
    def sage_maker_image_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the SageMaker image that the image version belongs to.
        """
    ...
    def sage_maker_image_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sage_maker_image_arn", value)

    @property
    @pulumi.getter(name="sageMakerImageVersionArn")
    def sage_maker_image_version_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the image version created on the instance.
        """
    ...
    def sage_maker_image_version_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterInstanceGroupArgsDict(TypedDict):
        ...
        """
        training_plan_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterInstanceGroupArgs:
    def __init__(__self__, *,
                 ...
                 training_plan_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Details of an instance group in a SageMaker HyperPod cluster.
        :param pulumi.Input[builtins.int] instance_count: The number of instances you specified to add to the instance group of a SageMaker HyperPod cluster.
        :param pulumi.Input[builtins.int] current_count: The number of instances that are currently in the instance group of a SageMaker HyperPod cluster.
        :param pulumi.Input[builtins.int] threads_per_core: The number you specified to TreadsPerCore in CreateCluster for enabling or disabling multithreading. For instance types that support multithreading, you can specify 1 for disabling multithreading and 2 for enabling multithreading.
        :param pulumi.Input[builtins.str] training_plan_arn: The Amazon Resource Name (ARN) of the training plan to use for this cluster instance group. For more information about how to reserve GPU capacity for your SageMaker HyperPod clusters using Amazon SageMaker Training Plan, see CreateTrainingPlan.
        """
    ...
    def instance_group_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "instance_group_name")

    @instance_group_name.setter
    def instance_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def current_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of instances that are currently in the instance group of a SageMaker HyperPod cluster.
        """
    ...
    def training_plan_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the training plan to use for this cluster instance group. For more information about how to reserve GPU capacity for your SageMaker HyperPod clusters using Amazon SageMaker Training Plan, see CreateTrainingPlan.
        """
    ...
    def training_plan_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterLifeCycleConfigArgsDict(TypedDict):
        ...
        """
        on_create: pulumi.Input[builtins.str]
        """
        The file name of the entrypoint script of lifecycle scripts under SourceS3Uri. This entrypoint script runs during cluster creation.
        """
        source_s3_uri: pulumi.Input[builtins.str]
        """
...
class ClusterLifeCycleConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The lifecycle configuration for a SageMaker HyperPod cluster.
        :param pulumi.Input[builtins.str] on_create: The file name of the entrypoint script of lifecycle scripts under SourceS3Uri. This entrypoint script runs during cluster creation.
        :param pulumi.Input[builtins.str] source_s3_uri: An Amazon S3 bucket path where your lifecycle scripts are stored.
        """
    ...
    def on_create(self) -> pulumi.Input[builtins.str]:
        """
        The file name of the entrypoint script of lifecycle scripts under SourceS3Uri. This entrypoint script runs during cluster creation.
        """
    ...
    @on_create.setter
    def on_create(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "on_create", value)

    @property
    @pulumi.getter(name="sourceS3Uri")
    def source_s3_uri(self) -> pulumi.Input[builtins.str]:
        """
        An Amazon S3 bucket path where your lifecycle scripts are stored.
        """
    ...
    def source_s3_uri(self, value: pulumi.Input[builtins.str]):
...
class ClusterOrchestratorEksConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies parameter(s) related to EKS as orchestrator, e.g. the EKS cluster nodes will attach to,
        :param pulumi.Input[builtins.str] cluster_arn: The ARN of the EKS cluster, such as arn:aws:eks:us-west-2:123456789012:cluster/my-eks-cluster
        """
...
if not MYPY:
    class DataQualityJobDefinitionBatchTransformInputArgsDict(TypedDict):
        ...
        """
        exclude_features_attribute: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DataQualityJobDefinitionBatchTransformInputArgs:
    def __init__(__self__, *,
                 ...
                 local_path: pulumi.Input[builtins.str],
                 exclude_features_attribute: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        The batch transform input for a monitoring job.
        :param pulumi.Input[builtins.str] data_captured_destination_s3_uri: A URI that identifies the Amazon S3 storage location where Batch Transform Job captures data.
        ...
        :param pulumi.Input[builtins.str] local_path: Path to the filesystem where the endpoint data is available to the container.
        :param pulumi.Input[builtins.str] exclude_features_attribute: Indexes or names of the features to be excluded from analysis
    ...
    def exclude_features_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indexes or names of the features to be excluded from analysis
        """
    ...
    def exclude_features_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataQualityJobDefinitionClusterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for the cluster used to run model monitoring jobs.
        :param pulumi.Input[builtins.int] instance_count: The number of ML compute instances to use in the model monitoring job. For distributed processing jobs, specify a value greater than 1. The default value is 1.
        ...
        :param pulumi.Input[builtins.str] volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the model monitoring job.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
...
class DataQualityJobDefinitionConstraintsResourceArgs:
    def __init__(__self__, *,
        ...
        """
        The baseline constraints resource for a monitoring job.
        :param pulumi.Input[builtins.str] s3_uri: The Amazon S3 URI for baseline constraint file in Amazon S3 that the current monitoring job should validated against.
        """
...
class DataQualityJobDefinitionCsvArgs:
    def __init__(__self__, *,
        ...
        """
        The CSV format
        :param pulumi.Input[builtins.bool] header: A boolean flag indicating if given CSV has header
        """
...
class DataQualityJobDefinitionDataQualityAppSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        Container image configuration object for the monitoring job.
        :param pulumi.Input[builtins.str] image_uri: The container image to be run by the monitoring job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_arguments: An array of arguments for the container used to run the monitoring job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_entrypoint: Specifies the entrypoint for a container used to run the monitoring job.
...
if not MYPY:
    class DataQualityJobDefinitionDataQualityBaselineConfigArgsDict(TypedDict):
        ...
        """
        baselining_job_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DataQualityJobDefinitionDataQualityBaselineConfigArgs:
    def __init__(__self__, *,
                 baselining_job_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param pulumi.Input[builtins.str] baselining_job_name: The name of the job that performs baselining for the data quality monitoring job.
    ...
    def baselining_job_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the job that performs baselining for the data quality monitoring job.
        """
    ...
    def baselining_job_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DataQualityJobDefinitionDatasetFormatArgsDict(TypedDict):
        ...
        parquet: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class DataQualityJobDefinitionDatasetFormatArgs:
    def __init__(__self__, *,
                 ...
                 parquet: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The dataset format of the data to monitor
        """
        if csv is not None:
    ...
    @property
    @pulumi.getter
    def parquet(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "parquet")

    @parquet.setter
    def parquet(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DataQualityJobDefinitionEndpointInputArgs:
    def __init__(__self__, *,
        ...
        """
        The endpoint for a monitoring job.
        :param pulumi.Input[builtins.str] endpoint_name: An endpoint in customer's account which has enabled `DataCaptureConfig` enabled.
        :param pulumi.Input[builtins.str] local_path: Path to the filesystem where the endpoint data is available to the container.
        :param pulumi.Input[builtins.str] exclude_features_attribute: Indexes or names of the features to be excluded from analysis
...
class DataQualityJobDefinitionJsonArgs:
    def __init__(__self__, *,
        ...
        """
        The Json format
        :param pulumi.Input[builtins.bool] line: A boolean flag indicating if it is JSON line format
        """
        if line is not None:
...
class DataQualityJobDefinitionMonitoringOutputConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt the model artifacts at rest using Amazon S3 server-side encryption.
        """
...
class DataQualityJobDefinitionNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Networking options for a job, such as network traffic encryption between containers, whether to allow inbound and outbound network calls to and from containers, and the VPC subnets and security groups to use for VPC-enabled jobs.
        :param pulumi.Input[builtins.bool] enable_inter_container_traffic_encryption: Whether to encrypt all communications between distributed processing jobs. Choose True to encrypt communications. Encryption provides greater security for distributed processing jobs, but the processing might take longer.
        :param pulumi.Input[builtins.bool] enable_network_isolation: Whether to allow inbound and outbound network calls to and from the containers used for the processing job.
...
class DataQualityJobDefinitionS3OutputArgs:
    def __init__(__self__, *,
        ...
        """
        Information about where and how to store the results of a monitoring job.
        :param pulumi.Input[builtins.str] local_path: The local path to the Amazon S3 storage location where Amazon SageMaker saves the results of a monitoring job. LocalPath is an absolute path for the output data.
        :param pulumi.Input[builtins.str] s3_uri: A URI that identifies the Amazon S3 storage location where Amazon SageMaker saves the results of a monitoring job.
...
class DataQualityJobDefinitionStatisticsResourceArgs:
    def __init__(__self__, *,
        ...
        """
        The baseline statistics resource for a monitoring job.
        :param pulumi.Input[builtins.str] s3_uri: The Amazon S3 URI for the baseline statistics file in Amazon S3 that the current monitoring job should be validated against.
        """
        if s3_uri is not None:
            pulumi.set(__self__, "s3_uri", s3_uri)
...
if not MYPY:
    class DataQualityJobDefinitionStoppingConditionArgsDict(TypedDict):
        ...
        """
        max_runtime_in_seconds: pulumi.Input[builtins.int]
        """
...
class DataQualityJobDefinitionStoppingConditionArgs:
    ...
    def max_runtime_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
        The maximum runtime allowed in seconds.
        """
    ...
    def max_runtime_in_seconds(self, value: pulumi.Input[builtins.int]):
...
class DataQualityJobDefinitionVpcConfigArgs:
    def __init__(__self__, *,
        ...
        Specifies a VPC that your training jobs and hosted models have access to. Control access to and from your training and model containers by configuring the VPC.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The VPC security group IDs, in the form sg-xxxxxxxx. Specify the security groups for the VPC that is specified in the Subnets field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The ID of the subnets in the VPC to which you want to connect to your monitoring jobs.
        """
        pulumi.set(__self__, "security_group_ids", security_group_ids)
        pulumi.set(__self__, "subnets", subnets)
...
class DeviceFleetEdgeOutputConfigArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_output_location: The Amazon Simple Storage (S3) bucket URI
        :param pulumi.Input[builtins.str] kms_key_id: The KMS key id used for encryption on the S3 bucket
        """
...
class DeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] iot_thing_name: AWS Internet of Things (IoT) object name.
        """
...
class DomainCodeRepositoryArgs:
    def __init__(__self__, *,
                 repository_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] repository_url: A CodeRepository (valid URL) to be used within Jupyter's Git extension.
        """
...
if not MYPY:
    class DomainCustomFileSystemConfigArgsDict(TypedDict):
        ...
        """
        s3_file_system_config: NotRequired[pulumi.Input['DomainS3FileSystemConfigArgsDict']]
        """
...
class DomainCustomFileSystemConfigArgs:
    def __init__(__self__, *,
                 ...
                 s3_file_system_config: Optional[pulumi.Input['DomainS3FileSystemConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['DomainS3FileSystemConfigArgs'] s3_file_system_config: Configuration settings for a custom Amazon S3 file system.
        """
    ...
    def s3_file_system_config(self) -> Optional[pulumi.Input['DomainS3FileSystemConfigArgs']]:
        """
        Configuration settings for a custom Amazon S3 file system.
        """
        return pulumi.get(self, "s3_file_system_config")

    @s3_file_system_config.setter
    def s3_file_system_config(self, value: Optional[pulumi.Input['DomainS3FileSystemConfigArgs']]):
        pulumi.set(self, "s3_file_system_config", value)
...
class DomainCustomImageArgs:
    def __init__(__self__, *,
        ...
        """
        A custom SageMaker image.
        :param pulumi.Input[builtins.str] app_image_config_name: The Name of the AppImageConfig.
        :param pulumi.Input[builtins.str] image_name: The name of the CustomImage. Must be unique to your account.
        :param pulumi.Input[builtins.int] image_version_number: The version number of the CustomImage.
        """
...
class DomainDefaultEbsStorageSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        Properties related to the Amazon Elastic Block Store volume. Must be provided if storage type is Amazon EBS and must not be provided if storage type is not Amazon EBS
        :param pulumi.Input[builtins.int] default_ebs_volume_size_in_gb: Default size of the Amazon EBS volume in Gb
        :param pulumi.Input[builtins.int] maximum_ebs_volume_size_in_gb: Maximum size of the Amazon EBS volume in Gb. Must be greater than or equal to the DefaultEbsVolumeSizeInGb.
        """
...
class DomainDefaultSpaceSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: The security groups for the Amazon Virtual Private Cloud (VPC) that Studio uses for communication.
...
class DomainDockerSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_only_trusted_accounts: A list of account id's that would be used to pull images from in VpcOnly mode
        """
...
class DomainFSxLustreFileSystemConfigArgs:
    def __init__(__self__, *,
                 ...
                 file_system_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] file_system_id: The globally unique, 17-digit, ID of the file system, assigned by Amazon FSx for Lustre.
        :param pulumi.Input[builtins.str] file_system_path: The path to the file system directory that is accessible in Amazon SageMaker Studio. Permitted users can access only this directory and below.
        """
        pulumi.set(__self__, "file_system_id", file_system_id)
        if file_system_path is not None:
            pulumi.set(__self__, "file_system_path", file_system_path)
...
class DomainHiddenSageMakerImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] version_aliases: The version aliases you are hiding from the Studio user interface.
        """
...
class DomainIdleSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] idle_timeout_in_minutes: The time that SageMaker waits after the application becomes idle before shutting it down.
        ...
        :param pulumi.Input[builtins.int] max_idle_timeout_in_minutes: The maximum value in minutes that custom idle shutdown can be set to by the user.
        :param pulumi.Input[builtins.int] min_idle_timeout_in_minutes: The minimum value in minutes that custom idle shutdown can be set to by the user.
        """
...
class DomainJupyterLabAppSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] lifecycle_config_arns: A list of LifecycleConfigArns available for use with JupyterLab apps.
        """
        if app_lifecycle_management is not None:
            pulumi.set(__self__, "app_lifecycle_management", app_lifecycle_management)
        if built_in_lifecycle_config_arn is not None:
...
class DomainJupyterServerAppSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] lifecycle_config_arns: A list of LifecycleConfigArns available for use with JupyterServer apps.
        """
        if default_resource_spec is not None:
            pulumi.set(__self__, "default_resource_spec", default_resource_spec)
        if lifecycle_config_arns is not None:
...
class DomainKernelGatewayAppSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] lifecycle_config_arns: A list of LifecycleConfigArns available for use with KernelGateway apps.
        """
        if custom_images is not None:
            pulumi.set(__self__, "custom_images", custom_images)
        if default_resource_spec is not None:
...
class DomainResourceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration to attach to the Resource.
        :param pulumi.Input[builtins.str] sage_maker_image_arn: The Amazon Resource Name (ARN) of the SageMaker image that the image version belongs to.
        :param pulumi.Input[builtins.str] sage_maker_image_version_arn: The Amazon Resource Name (ARN) of the image version created on the instance.
        """
        if instance_type is not None:
            pulumi.set(__self__, "instance_type", instance_type)
        if lifecycle_config_arn is not None:
...
if not MYPY:
    ...
    DomainS3FileSystemConfigArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class DomainS3FileSystemConfigArgs:
    def __init__(__self__, *,
                 mount_path: Optional[pulumi.Input[builtins.str]] = None,
                 s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mount_path: The file system path where the Amazon S3 storage location will be mounted within the Amazon SageMaker Studio environment.
        :param pulumi.Input[builtins.str] s3_uri: The Amazon S3 URI of the S3 file system configuration.
        """
        if mount_path is not None:
            pulumi.set(__self__, "mount_path", mount_path)
        if s3_uri is not None:
...
class DomainSharingSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_kms_key_id: When NotebookOutputOption is Allowed, the AWS Key Management Service (KMS) encryption key ID used to encrypt the notebook cell output in the Amazon S3 bucket.
        :param pulumi.Input[builtins.str] s3_output_path: When NotebookOutputOption is Allowed, the Amazon S3 bucket used to store the shared notebook snapshots.
        """
...
class DomainUserSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DomainCodeEditorAppSettingsArgs'] code_editor_app_settings: The Code Editor application settings.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param pulumi.Input[Sequence[pulumi.Input['DomainCustomFileSystemConfigArgs']]] custom_file_system_configs: The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker AI Studio.
        ...
        :param pulumi.Input['DomainCustomPosixUserConfigArgs'] custom_posix_user_config: Details about the POSIX identity that is used for file system operations.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param pulumi.Input[builtins.str] default_landing_uri: Defines which Amazon SageMaker application users are directed to by default.
...
class EndpointAlarmArgs:
    def __init__(__self__, *,
                 alarm_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] alarm_name: The name of the CloudWatch alarm.
        """
...
class EndpointBlueGreenUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] maximum_execution_timeout_in_seconds: The maximum time allowed for the blue/green update, in seconds.
        :param pulumi.Input[builtins.int] termination_wait_in_seconds: The wait time before terminating the old endpoint during a blue/green deployment.
        """
...
class EndpointCapacitySizeArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] type: Specifies whether the `Value` is an instance count or a capacity unit.
        :param pulumi.Input[builtins.int] value: The value representing either the number of instances or the number of capacity units.
        """
...
class EndpointRollingUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] wait_interval_in_seconds: The time to wait between steps during the rolling update, in seconds.
        :param pulumi.Input[builtins.int] maximum_execution_timeout_in_seconds: The maximum time allowed for the rolling update, in seconds.
...
if not MYPY:
    class EndpointTrafficRoutingConfigArgsDict(TypedDict):
        ...
        """
        wait_interval_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EndpointTrafficRoutingConfigArgs:
    def __init__(__self__, *,
                 ...
                 wait_interval_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of traffic routing (e.g., 'AllAtOnce', 'Canary', 'Linear').
        ...
        :param pulumi.Input[builtins.int] wait_interval_in_seconds: Specifies the wait interval between traffic shifts, in seconds.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter(name="waitIntervalInSeconds")
    def wait_interval_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the wait interval between traffic shifts, in seconds.
        """
        return pulumi.get(self, "wait_interval_in_seconds")
    ...
    @wait_interval_in_seconds.setter
    def wait_interval_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "wait_interval_in_seconds", value)


if not MYPY:
    class EndpointVariantPropertyArgsDict(TypedDict):
        variant_property_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EndpointVariantPropertyArgs:
    def __init__(__self__, *,
                 variant_property_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] variant_property_type: The type of variant property (e.g., 'DesiredInstanceCount', 'DesiredWeight', 'DataCaptureConfig').
        """
    ...
    def variant_property_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of variant property (e.g., 'DesiredInstanceCount', 'DesiredWeight', 'DataCaptureConfig').
        """
    ...
    def variant_property_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FeatureGroupFeatureDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 feature_type: pulumi.Input['FeatureGroupFeatureDefinitionFeatureType']):
        """
        :param pulumi.Input[builtins.str] feature_name: The name of a feature. The type must be a string. `FeatureName` cannot be any of the following: `is_deleted` , `write_time` , `api_invocation_time` .
...
class FeatureGroupOnlineStoreSecurityConfigArgs:
    def __init__(__self__, *,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key_id: The AWS Key Management Service (KMS) key ARN that SageMaker Feature Store uses to encrypt the Amazon S3 objects at rest using Amazon S3 server-side encryption.
...
class FeatureGroupS3StorageConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_uri: The S3 URI, or location in Amazon S3, of `OfflineStore` .
               ...
               S3 URIs have a format similar to the following: `s3://example-bucket/prefix/` .
        :param pulumi.Input[builtins.str] kms_key_id: The AWS Key Management Service (KMS) key ARN of the key used to encrypt any objects written into the `OfflineStore` S3 location.
...
class FeatureGroupThroughputConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] provisioned_read_capacity_units: For provisioned feature groups with online store enabled, this indicates the read throughput you are billed for and can consume without throttling.
        :param pulumi.Input[builtins.int] provisioned_write_capacity_units: For provisioned feature groups, this indicates the write throughput you are billed for and can consume without throttling.
        """
...
class InferenceComponentCapacitySizeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InferenceComponentCapacitySizeType'] type: Specifies the endpoint capacity type.
               ...
               - **COPY_COUNT** - The endpoint activates based on the number of inference component copies.
               - **CAPACITY_PERCENT** - The endpoint activates based on the specified percentage of capacity.
        :param pulumi.Input[builtins.int] value: Defines the capacity size, either as a number of inference component copies or a capacity percentage.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class InferenceComponentComputeResourceRequirementsArgsDict(TypedDict):
        max_memory_required_in_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum MB of memory to allocate to run a model that you assign to an inference component.
        """
        min_memory_required_in_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The minimum MB of memory to allocate to run a model that you assign to an inference component.
        """
        number_of_accelerator_devices_required: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        number_of_cpu_cores_required: NotRequired[pulumi.Input[builtins.float]]
        """
...
class InferenceComponentComputeResourceRequirementsArgs:
    def __init__(__self__, *,
                 max_memory_required_in_mb: Optional[pulumi.Input[builtins.int]] = None,
                 min_memory_required_in_mb: Optional[pulumi.Input[builtins.int]] = None,
                 number_of_accelerator_devices_required: Optional[pulumi.Input[builtins.float]] = None,
                 number_of_cpu_cores_required: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.int] max_memory_required_in_mb: The maximum MB of memory to allocate to run a model that you assign to an inference component.
        :param pulumi.Input[builtins.int] min_memory_required_in_mb: The minimum MB of memory to allocate to run a model that you assign to an inference component.
        :param pulumi.Input[builtins.float] number_of_accelerator_devices_required: The number of accelerators to allocate to run a model that you assign to an inference component. Accelerators include GPUs and AWS Inferentia.
        :param pulumi.Input[builtins.float] number_of_cpu_cores_required: The number of CPU cores to allocate to run a model that you assign to an inference component.
        """
    ...
    def max_memory_required_in_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum MB of memory to allocate to run a model that you assign to an inference component.
        """
    ...
    def max_memory_required_in_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_memory_required_in_mb", value)

    @property
    @pulumi.getter(name="minMemoryRequiredInMb")
    def min_memory_required_in_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum MB of memory to allocate to run a model that you assign to an inference component.
        """
    ...
    def min_memory_required_in_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_memory_required_in_mb", value)

    @property
    @pulumi.getter(name="numberOfAcceleratorDevicesRequired")
    def number_of_accelerator_devices_required(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The number of accelerators to allocate to run a model that you assign to an inference component. Accelerators include GPUs and AWS Inferentia.
        """
    ...
    def number_of_accelerator_devices_required(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "number_of_accelerator_devices_required", value)

    @property
    @pulumi.getter(name="numberOfCpuCoresRequired")
    def number_of_cpu_cores_required(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The number of CPU cores to allocate to run a model that you assign to an inference component.
        """
    ...
    def number_of_cpu_cores_required(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "number_of_cpu_cores_required", value)


if not MYPY:
    class InferenceComponentContainerSpecificationArgsDict(TypedDict):
        artifact_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InferenceComponentContainerSpecificationArgs:
    def __init__(__self__, *,
                 artifact_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] artifact_url: The Amazon S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: The environment variables to set in the Docker container. Each key and value in the Environment string-to-string map can have length of up to 1024. We support up to 16 entries in the map.
        :param pulumi.Input[builtins.str] image: The Amazon Elastic Container Registry (Amazon ECR) path where the Docker image for the model is stored.
        """
    ...
    def artifact_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        """
    ...
    @artifact_url.setter
    def artifact_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InferenceComponentDeployedImageArgsDict(TypedDict):
        resolution_time: NotRequired[pulumi.Input[builtins.str]]
        """
        The date and time when the image path for the model resolved to the `ResolvedImage`
        """
        resolved_image: NotRequired[pulumi.Input[builtins.str]]
        """
        The specific digest path of the image hosted in this `ProductionVariant` .
        """
        specified_image: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InferenceComponentDeployedImageArgs:
    def __init__(__self__, *,
                 resolution_time: Optional[pulumi.Input[builtins.str]] = None,
                 resolved_image: Optional[pulumi.Input[builtins.str]] = None,
                 specified_image: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] resolution_time: The date and time when the image path for the model resolved to the `ResolvedImage`
        :param pulumi.Input[builtins.str] resolved_image: The specific digest path of the image hosted in this `ProductionVariant` .
        :param pulumi.Input[builtins.str] specified_image: The image path you specified when you created the model.
        """
    ...
    def resolution_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The date and time when the image path for the model resolved to the `ResolvedImage`
        """
    ...
    def resolution_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resolution_time", value)

    @property
    @pulumi.getter(name="resolvedImage")
    def resolved_image(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The specific digest path of the image hosted in this `ProductionVariant` .
        """
    ...
    def resolved_image(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resolved_image", value)

    @property
    @pulumi.getter(name="specifiedImage")
    def specified_image(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The image path you specified when you created the model.
        """
    ...
    def specified_image(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InferenceComponentRollingUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] maximum_execution_timeout_in_seconds: The time limit for the total deployment. Exceeding this limit causes a timeout.
        ...
        :param pulumi.Input[builtins.int] wait_interval_in_seconds: The length of the baking period, during which SageMaker AI monitors alarms for each batch on the new fleet.
        """
...
if not MYPY:
    class InferenceComponentRuntimeConfigArgsDict(TypedDict):
        ...
        """
        copy_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        current_copy_count: NotRequired[pulumi.Input[builtins.int]]
        desired_copy_count: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class InferenceComponentRuntimeConfigArgs:
    def __init__(__self__, *,
                 copy_count: Optional[pulumi.Input[builtins.int]] = None,
                 current_copy_count: Optional[pulumi.Input[builtins.int]] = None,
                 desired_copy_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        The runtime config for the inference component
        :param pulumi.Input[builtins.int] copy_count: The number of runtime copies of the model container to deploy with the inference component. Each copy can serve inference requests.
        """
    ...
    def copy_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of runtime copies of the model container to deploy with the inference component. Each copy can serve inference requests.
        """
    ...
    @copy_count.setter
    def copy_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "copy_count", value)

    @property
    @pulumi.getter(name="currentCopyCount")
    def current_copy_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "current_copy_count")

    @current_copy_count.setter
    def current_copy_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "current_copy_count", value)

    @property
    @pulumi.getter(name="desiredCopyCount")
    def desired_copy_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "desired_copy_count")

    @desired_copy_count.setter
    def desired_copy_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class InferenceComponentSpecificationArgsDict(TypedDict):
        ...
        """
        base_inference_component_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InferenceComponentSpecificationArgs:
    def __init__(__self__, *,
                 base_inference_component_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        The specification for the inference component
        :param pulumi.Input[builtins.str] base_inference_component_name: The name of an existing inference component that is to contain the inference component that you're creating with your request.
        ...
        :param pulumi.Input[builtins.str] model_name: The name of an existing SageMaker AI model object in your account that you want to deploy with the inference component.
    ...
    def base_inference_component_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of an existing inference component that is to contain the inference component that you're creating with your request.
    ...
    def base_inference_component_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InferenceComponentStartupParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] model_data_download_timeout_in_seconds: The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this inference component.
        """
...
class InferenceExperimentCaptureContentTypeHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration specifying how to treat different headers. If no headers are specified SageMaker will by default base64 encode when capturing the data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] csv_content_types: The list of all content type headers that SageMaker will treat as CSV and capture accordingly.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] json_content_types: The list of all content type headers that SageMaker will treat as JSON and capture accordingly.
        """
...
class InferenceExperimentDataStorageConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The Amazon S3 location and configuration for storing inference request and response data.
        :param pulumi.Input[builtins.str] destination: The Amazon S3 bucket where the inference request and response data is stored.
        ...
        :param pulumi.Input[builtins.str] kms_key: The AWS Key Management Service key that Amazon SageMaker uses to encrypt captured data at rest using Amazon S3 server-side encryption.
        """
...
if not MYPY:
    class InferenceExperimentModelVariantConfigArgsDict(TypedDict):
        ...
        """
        variant_name: pulumi.Input[builtins.str]
        """
...
class InferenceExperimentModelVariantConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model_name: The name of the Amazon SageMaker Model entity.
        :param pulumi.Input[builtins.str] variant_name: The name of the variant.
        """
    ...
    def variant_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the variant.
        """
    ...
    @variant_name.setter
    def variant_name(self, value: pulumi.Input[builtins.str]):
...
class InferenceExperimentRealTimeInferenceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The infrastructure configuration for deploying the model to a real-time inference endpoint.
        :param pulumi.Input[builtins.int] instance_count: The number of instances of the type specified by InstanceType.
        :param pulumi.Input[builtins.str] instance_type: The instance type the model is deployed to.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
...
class InferenceExperimentScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        The duration for which you want the inference experiment to run.
        :param pulumi.Input[builtins.str] end_time: The timestamp at which the inference experiment ended or will end.
        :param pulumi.Input[builtins.str] start_time: The timestamp at which the inference experiment started or will start.
        """
...
if not MYPY:
    class InferenceExperimentShadowModeConfigArgsDict(TypedDict):
        ...
        """
        source_model_variant_name: pulumi.Input[builtins.str]
        """
...
class InferenceExperimentShadowModeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source_model_variant_name: The name of the production variant, which takes all the inference requests.
        """
    ...
    def source_model_variant_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the production variant, which takes all the inference requests.
        """
    ...
    def source_model_variant_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class InferenceExperimentShadowModelVariantConfigArgsDict(TypedDict):
        ...
        """
        sampling_percentage: pulumi.Input[builtins.int]
        """
        The percentage of inference requests that Amazon SageMaker replicates from the production variant to the shadow variant.
        """
        shadow_model_variant_name: pulumi.Input[builtins.str]
        """
...
class InferenceExperimentShadowModelVariantConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The name and sampling percentage of a shadow variant.
        :param pulumi.Input[builtins.int] sampling_percentage: The percentage of inference requests that Amazon SageMaker replicates from the production variant to the shadow variant.
        :param pulumi.Input[builtins.str] shadow_model_variant_name: The name of the shadow variant.
        """
    ...
    def sampling_percentage(self) -> pulumi.Input[builtins.int]:
        """
        The percentage of inference requests that Amazon SageMaker replicates from the production variant to the shadow variant.
        """
    ...
    def sampling_percentage(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "sampling_percentage", value)

    @property
    @pulumi.getter(name="shadowModelVariantName")
    def shadow_model_variant_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the shadow variant.
        """
    ...
    def shadow_model_variant_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ModelBiasJobDefinitionBatchTransformInputArgsDict(TypedDict):
        ...
        """
        features_attribute: NotRequired[pulumi.Input[builtins.str]]
        """
        JSONpath to locate features in JSONlines dataset
        """
        inference_attribute: NotRequired[pulumi.Input[builtins.str]]
        """
        Index or JSONpath to locate predicted label(s)
        """
        probability_attribute: NotRequired[pulumi.Input[builtins.str]]
        """
        Index or JSONpath to locate probabilities
        """
        probability_threshold_attribute: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ModelBiasJobDefinitionBatchTransformInputArgs:
    def __init__(__self__, *,
                 ...
                 features_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 inference_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 probability_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 probability_threshold_attribute: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] local_path: Path to the filesystem where the endpoint data is available to the container.
        :param pulumi.Input[builtins.str] end_time_offset: Monitoring end time offset, e.g. PT0H
        :param pulumi.Input[builtins.str] features_attribute: JSONpath to locate features in JSONlines dataset
        :param pulumi.Input[builtins.str] inference_attribute: Index or JSONpath to locate predicted label(s)
        :param pulumi.Input[builtins.str] probability_attribute: Index or JSONpath to locate probabilities
        :param pulumi.Input[builtins.float] probability_threshold_attribute: The threshold for the class probability to be evaluated as a positive result.
        ...
        :param pulumi.Input[builtins.str] start_time_offset: Monitoring start time offset, e.g. -PT1H
        """
        pulumi.set(__self__, "data_captured_destination_s3_uri", data_captured_destination_s3_uri)
        pulumi.set(__self__, "dataset_format", dataset_format)
        pulumi.set(__self__, "local_path", local_path)
    ...
    def features_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        JSONpath to locate features in JSONlines dataset
        """
    ...
    def features_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "features_attribute", value)

    @property
    @pulumi.getter(name="inferenceAttribute")
    def inference_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Index or JSONpath to locate predicted label(s)
        """
    ...
    def inference_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inference_attribute", value)

    @property
    @pulumi.getter(name="probabilityAttribute")
    def probability_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Index or JSONpath to locate probabilities
        """
    ...
    def probability_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "probability_attribute", value)

    @property
    @pulumi.getter(name="probabilityThresholdAttribute")
    def probability_threshold_attribute(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The threshold for the class probability to be evaluated as a positive result.
        """
    ...
    def probability_threshold_attribute(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class ModelBiasJobDefinitionModelBiasAppSpecificationArgsDict(TypedDict):
        ...
        Container image configuration object for the monitoring job.
        """
        config_uri: pulumi.Input[builtins.str]
        """
...
class ModelBiasJobDefinitionModelBiasAppSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        Container image configuration object for the monitoring job.
        :param pulumi.Input[builtins.str] config_uri: The S3 URI to an analysis configuration file
        :param pulumi.Input[builtins.str] image_uri: The container image to be run by the monitoring job.
        :param Any environment: Sets the environment variables in the Docker container
        """
    ...
    def config_uri(self) -> pulumi.Input[builtins.str]:
        """
        The S3 URI to an analysis configuration file
        """
    ...
    @config_uri.setter
    def config_uri(self, value: pulumi.Input[builtins.str]):
...
class ModelBiasJobDefinitionModelBiasBaselineConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param pulumi.Input[builtins.str] baselining_job_name: The name of the baseline model bias job.
...
if not MYPY:
    class ModelCardAdditionalInformationArgsDict(TypedDict):
        caveats_and_recommendations: NotRequired[pulumi.Input[builtins.str]]
        """
        Caveats and recommendations for people who might use this model in their applications.
        """
        custom_details: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        customer details.
        """
        ethical_considerations: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardAdditionalInformationArgs:
    def __init__(__self__, *,
                 caveats_and_recommendations: Optional[pulumi.Input[builtins.str]] = None,
                 custom_details: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ethical_considerations: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] caveats_and_recommendations: Caveats and recommendations for people who might use this model in their applications.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_details: customer details.
        :param pulumi.Input[builtins.str] ethical_considerations: Any ethical considerations that the author wants to provide.
        """
    ...
    def caveats_and_recommendations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Caveats and recommendations for people who might use this model in their applications.
        """
    ...
    def caveats_and_recommendations(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ethical_considerations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Any ethical considerations that the author wants to provide.
        """
    ...
    def ethical_considerations(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardBarChartMetricArgsDict(TypedDict):
        ...
        value: pulumi.Input[Sequence[pulumi.Input[builtins.float]]]
        notes: NotRequired[pulumi.Input[builtins.str]]
        x_axis_name: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        y_axis_name: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ModelCardBarChartMetricArgs:
    def __init__(__self__, *,
                 ...
                 x_axis_name: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 y_axis_name: Optional[pulumi.Input[builtins.str]] = None):
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
    ...
    @property
    @pulumi.getter
    def value(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.float]]]:
        return pulumi.get(self, "value")

    @value.setter
    def value(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.float]]]):
        pulumi.set(self, "value", value)
    ...
    def x_axis_name(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "x_axis_name")

    @x_axis_name.setter
    def x_axis_name(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "x_axis_name", value)

    @property
    @pulumi.getter(name="yAxisName")
    def y_axis_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "y_axis_name")

    @y_axis_name.setter
    def y_axis_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardBusinessDetailsArgsDict(TypedDict):
        ...
        Business details.
        """
        business_problem: NotRequired[pulumi.Input[builtins.str]]
        """
        What business problem does the model solve?
        """
        business_stakeholders: NotRequired[pulumi.Input[builtins.str]]
        """
        Business stakeholders.
        """
        line_of_business: NotRequired[pulumi.Input[builtins.str]]
        """
        Line of business.
        """
elif False:
...
class ModelCardBusinessDetailsArgs:
    def __init__(__self__, *,
                 business_problem: Optional[pulumi.Input[builtins.str]] = None,
                 business_stakeholders: Optional[pulumi.Input[builtins.str]] = None,
                 line_of_business: Optional[pulumi.Input[builtins.str]] = None):
        """
        Business details.
        :param pulumi.Input[builtins.str] business_problem: What business problem does the model solve?
        :param pulumi.Input[builtins.str] business_stakeholders: Business stakeholders.
        :param pulumi.Input[builtins.str] line_of_business: Line of business.
        """
    ...
    def business_problem(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        What business problem does the model solve?
        """
    ...
    def business_problem(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "business_problem", value)

    @property
    @pulumi.getter(name="businessStakeholders")
    def business_stakeholders(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Business stakeholders.
        """
    ...
    def business_stakeholders(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "business_stakeholders", value)

    @property
    @pulumi.getter(name="lineOfBusiness")
    def line_of_business(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Line of business.
        """
    ...
    def line_of_business(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardContainerArgsDict(TypedDict):
        ...
        """
        nearest_model_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardContainerArgs:
    def __init__(__self__, *,
                 ...
                 nearest_model_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] image: Inference environment path. The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored.
        :param pulumi.Input[builtins.str] model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored.
        :param pulumi.Input[builtins.str] nearest_model_name: The name of a pre-trained machine learning benchmarked by Amazon SageMaker Inference Recommender model that matches your model.
        """
        pulumi.set(__self__, "image", image)
    ...
    def nearest_model_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of a pre-trained machine learning benchmarked by Amazon SageMaker Inference Recommender model that matches your model.
        """
    ...
    def nearest_model_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardEvaluationDetailArgsDict(TypedDict):
        ...
        """
        name: pulumi.Input[builtins.str]
        datasets: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        evaluation_job_arn: NotRequired[pulumi.Input[builtins.str]]
        evaluation_observation: NotRequired[pulumi.Input[builtins.str]]
...
class ModelCardEvaluationDetailArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 datasets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 evaluation_job_arn: Optional[pulumi.Input[builtins.str]] = None,
                 evaluation_observation: Optional[pulumi.Input[builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 metric_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ModelCardMetricGroupArgs']]]] = None):
        """
        item of evaluation details
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: additional attributes associated with the evaluation results.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def datasets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "datasets")

    @datasets.setter
    def datasets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "datasets", value)

    @property
    @pulumi.getter(name="evaluationJobArn")
    def evaluation_job_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "evaluation_job_arn")

    @evaluation_job_arn.setter
    def evaluation_job_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "evaluation_job_arn", value)

    @property
    @pulumi.getter(name="evaluationObservation")
    def evaluation_observation(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "evaluation_observation")

    @evaluation_observation.setter
    def evaluation_observation(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardIntendedUsesArgsDict(TypedDict):
        ...
        """
        explanations_for_risk_rating: NotRequired[pulumi.Input[builtins.str]]
        """
        An explanation of why your organization categorizes the model with its risk rating.
        """
        factors_affecting_model_efficiency: NotRequired[pulumi.Input[builtins.str]]
        """
        Factors affecting model efficacy.
        """
        intended_uses: NotRequired[pulumi.Input[builtins.str]]
        """
        intended use cases.
        """
        purpose_of_model: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardIntendedUsesArgs:
    def __init__(__self__, *,
                 explanations_for_risk_rating: Optional[pulumi.Input[builtins.str]] = None,
                 factors_affecting_model_efficiency: Optional[pulumi.Input[builtins.str]] = None,
                 intended_uses: Optional[pulumi.Input[builtins.str]] = None,
                 purpose_of_model: Optional[pulumi.Input[builtins.str]] = None,
                 risk_rating: Optional[pulumi.Input['ModelCardRiskRating']] = None):
        """
        Intended usage of model.
        :param pulumi.Input[builtins.str] explanations_for_risk_rating: An explanation of why your organization categorizes the model with its risk rating.
        :param pulumi.Input[builtins.str] factors_affecting_model_efficiency: Factors affecting model efficacy.
        :param pulumi.Input[builtins.str] intended_uses: intended use cases.
        :param pulumi.Input[builtins.str] purpose_of_model: Why the model was developed?
    ...
    def explanations_for_risk_rating(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An explanation of why your organization categorizes the model with its risk rating.
        """
    ...
    def explanations_for_risk_rating(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "explanations_for_risk_rating", value)

    @property
    @pulumi.getter(name="factorsAffectingModelEfficiency")
    def factors_affecting_model_efficiency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Factors affecting model efficacy.
        """
    ...
    def factors_affecting_model_efficiency(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "factors_affecting_model_efficiency", value)

    @property
    @pulumi.getter(name="intendedUses")
    def intended_uses(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        intended use cases.
        """
        return pulumi.get(self, "intended_uses")
    ...
    @intended_uses.setter
    def intended_uses(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "intended_uses", value)

    @property
    @pulumi.getter(name="purposeOfModel")
    def purpose_of_model(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Why the model was developed?
        """
    ...
    def purpose_of_model(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelCardLinearGraphMetricArgsDict(TypedDict):
        ...
        value: pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]
        notes: NotRequired[pulumi.Input[builtins.str]]
        x_axis_name: NotRequired[pulumi.Input[builtins.str]]
        y_axis_name: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ModelCardLinearGraphMetricArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]],
                 notes: Optional[pulumi.Input[builtins.str]] = None,
                 x_axis_name: Optional[pulumi.Input[builtins.str]] = None,
                 y_axis_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Linear graph metric.
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]:
        return pulumi.get(self, "value")

    @value.setter
    def value(self, value: pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]):
        pulumi.set(self, "value", value)
    ...
    @property
    @pulumi.getter(name="xAxisName")
    def x_axis_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "x_axis_name")

    @x_axis_name.setter
    def x_axis_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "x_axis_name", value)
...
if not MYPY:
    class ModelCardMatrixMetricArgsDict(TypedDict):
        ...
        notes: NotRequired[pulumi.Input[builtins.str]]
        x_axis_name: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        y_axis_name: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class ModelCardMatrixMetricArgs:
    def __init__(__self__, *,
                 ...
                 notes: Optional[pulumi.Input[builtins.str]] = None,
                 x_axis_name: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 y_axis_name: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
        if notes is not None:
    ...
    @property
    @pulumi.getter(name="yAxisName")
    def y_axis_name(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "y_axis_name")

    @y_axis_name.setter
    def y_axis_name(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "y_axis_name", value)
...
if not MYPY:
    class ModelCardModelOverviewInferenceEnvironmentPropertiesArgsDict(TypedDict):
        ...
        """
        container_image: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ModelCardModelOverviewInferenceEnvironmentPropertiesArgs:
    def __init__(__self__, *,
                 container_image: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Overview about the inference.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_image: SageMaker inference image uri.
        """
    ...
    def container_image(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        SageMaker inference image uri.
        """
    ...
    def container_image(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ModelCardModelOverviewArgsDict(TypedDict):
        ...
        """
        algorithm_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Overview about the inference.
        """
        model_artifact: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Location of the model artifact.
        """
        model_creator: NotRequired[pulumi.Input[builtins.str]]
        """
        Creator of model.
        """
        model_description: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Name of the model.
        """
        model_owner: NotRequired[pulumi.Input[builtins.str]]
        """
        Owner of model.
        """
        model_version: NotRequired[pulumi.Input[builtins.float]]
        """
        Version of the model.
        """
        problem_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardModelOverviewArgs:
    def __init__(__self__, *,
                 algorithm_type: Optional[pulumi.Input[builtins.str]] = None,
                 inference_environment: Optional[pulumi.Input['ModelCardModelOverviewInferenceEnvironmentPropertiesArgs']] = None,
                 model_artifact: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 model_creator: Optional[pulumi.Input[builtins.str]] = None,
                 model_description: Optional[pulumi.Input[builtins.str]] = None,
                 model_id: Optional[pulumi.Input[builtins.str]] = None,
                 model_name: Optional[pulumi.Input[builtins.str]] = None,
                 model_owner: Optional[pulumi.Input[builtins.str]] = None,
                 model_version: Optional[pulumi.Input[builtins.float]] = None,
                 problem_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Overview about the model.
        :param pulumi.Input[builtins.str] algorithm_type: Algorithm used to solve the problem.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] model_artifact: Location of the model artifact.
        :param pulumi.Input[builtins.str] model_creator: Creator of model.
        :param pulumi.Input[builtins.str] model_description: description of model.
        :param pulumi.Input[builtins.str] model_id: SageMaker Model Arn or Non SageMaker Model id.
        :param pulumi.Input[builtins.str] model_name: Name of the model.
        :param pulumi.Input[builtins.str] model_owner: Owner of model.
        :param pulumi.Input[builtins.float] model_version: Version of the model.
        :param pulumi.Input[builtins.str] problem_type: Problem being solved with the model.
        """
    ...
    def algorithm_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Algorithm used to solve the problem.
        """
    ...
    def algorithm_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def model_artifact(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Location of the model artifact.
        """
    ...
    def model_artifact(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "model_artifact", value)

    @property
    @pulumi.getter(name="modelCreator")
    def model_creator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Creator of model.
        """
    ...
    def model_creator(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def model_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Owner of model.
        """
    ...
    @model_owner.setter
    def model_owner(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_owner", value)

    @property
    @pulumi.getter(name="modelVersion")
    def model_version(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Version of the model.
        """
    ...
    def model_version(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "model_version", value)

    @property
    @pulumi.getter(name="problemType")
    def problem_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Problem being solved with the model.
        """
    ...
    @problem_type.setter
    def problem_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "problem_type", value)


if not MYPY:
    class ModelCardModelPackageCreatorArgsDict(TypedDict):
        user_profile_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardModelPackageCreatorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] user_profile_name: The name of the user's profile in Studio
        """
...
if not MYPY:
    class ModelCardModelPackageDetailsArgsDict(TypedDict):
        ...
        """
        approval_description: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        model_package_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The Amazon Resource Name (ARN) of the model package
        """
        model_package_description: NotRequired[pulumi.Input[builtins.str]]
        """
        A brief summary of the model package
        """
        model_package_group_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        model_package_version: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ModelCardModelPackageDetailsArgs:
    def __init__(__self__, *,
                 ...
                 model_package_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 model_package_version: Optional[pulumi.Input[builtins.float]] = None,
        ...
        """
        Metadata information related to model package version
        :param pulumi.Input[builtins.str] approval_description: A description provided for the model approval
        :param pulumi.Input['ModelCardModelPackageCreatorArgs'] created_by: Information about the user who created model package.
        :param pulumi.Input[builtins.str] domain: The machine learning domain of the model package you specified. Common machine learning domains include computer vision and natural language processing.
        ...
        :param pulumi.Input[builtins.str] model_package_arn: The Amazon Resource Name (ARN) of the model package
        :param pulumi.Input[builtins.str] model_package_description: A brief summary of the model package
        :param pulumi.Input[builtins.str] model_package_group_name: If the model is a versioned model, the name of the model group that the versioned model belongs to.
        :param pulumi.Input[builtins.str] model_package_name: Name of the model package
        :param pulumi.Input['ModelCardModelPackageDetailsModelPackageStatus'] model_package_status: Current status of model package
        :param pulumi.Input[builtins.float] model_package_version: Version of the model package
        ...
        :param pulumi.Input[builtins.str] task: The machine learning task you specified that your model package accomplishes. Common machine learning tasks include object detection and image classification.
        """
    ...
    def model_package_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the model package
        """
    ...
    def model_package_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def model_package_version(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Version of the model package
        """
    ...
    def model_package_version(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class ModelCardObjectiveFunctionFunctionPropertiesArgsDict(TypedDict):
        ...
        facet: NotRequired[pulumi.Input[builtins.str]]
...
class ModelCardObjectiveFunctionFunctionPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 facet: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def facet(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "facet")

    @facet.setter
    def facet(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelCardObjectiveFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] notes: Notes about the object function, including other considerations for possible objective functions.
        """
        if function is not None:
            pulumi.set(__self__, "function", function)
        if notes is not None:
...
class ModelCardSecurityConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_id: A Key Management Service key ID to use for encrypting a model card.
        """
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
if not MYPY:
    class ModelCardSimpleMetricArgsDict(TypedDict):
        ...
        value: pulumi.Input[Union[builtins.float, builtins.str, builtins.bool]]
        notes: NotRequired[pulumi.Input[builtins.str]]
        x_axis_name: NotRequired[pulumi.Input[builtins.str]]
        y_axis_name: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ModelCardSimpleMetricArgs:
    ...
    @property
    @pulumi.getter
    def value(self) -> pulumi.Input[Union[builtins.float, builtins.str, builtins.bool]]:
        return pulumi.get(self, "value")

    @value.setter
    def value(self, value: pulumi.Input[Union[builtins.float, builtins.str, builtins.bool]]):
        pulumi.set(self, "value", value)
...
if not MYPY:
    class ModelCardSourceAlgorithmArgsDict(TypedDict):
        algorithm_name: pulumi.Input[builtins.str]
        """
...
class ModelCardSourceAlgorithmArgs:
    def __init__(__self__, *,
                 ...
                 model_data_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm_name: The name of an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param pulumi.Input[builtins.str] model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored.
        """
    ...
    def algorithm_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        """
    ...
    def algorithm_name(self, value: pulumi.Input[builtins.str]):
...
class ModelCardTrainingDetailsTrainingJobDetailsPropertiesTrainingEnvironmentPropertiesArgs:
    def __init__(__self__, *,
                 container_image: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_image: SageMaker training image uri.
        """
        if container_image is not None:
            pulumi.set(__self__, "container_image", container_image)
...
if not MYPY:
    class ModelCardTrainingDetailsTrainingJobDetailsPropertiesArgsDict(TypedDict):
        ...
        training_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        SageMaker Training job arn.
        """
        training_datasets: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ModelCardTrainingDetailsTrainingJobDetailsPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 training_arn: Optional[pulumi.Input[builtins.str]] = None,
                 training_datasets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        Details about any associated training jobs.
        :param pulumi.Input[builtins.str] training_arn: SageMaker Training job arn.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] training_datasets: Location of the model datasets.
        """
    ...
    def training_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SageMaker Training job arn.
        """
    ...
    @training_arn.setter
    def training_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "training_arn", value)

    @property
    @pulumi.getter(name="trainingDatasets")
    def training_datasets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Location of the model datasets.
        """
    ...
    def training_datasets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ModelCardTrainingDetailsArgsDict(TypedDict):
        ...
        Details about any associated training jobs.
        """
        training_observations: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardTrainingDetailsArgs:
    def __init__(__self__, *,
                 ...
                 training_observations: Optional[pulumi.Input[builtins.str]] = None):
        """
        Overview about the training.
        ...
        :param pulumi.Input[builtins.str] training_observations: Any observations about training.
        """
    ...
    def training_observations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Any observations about training.
        """
    ...
    def training_observations(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelCardTrainingHyperParameterArgs:
    def __init__(__self__, *,
        ...
        """
        training hyper parameter
        :param pulumi.Input[builtins.str] name: The name of the hyper parameter.
        :param pulumi.Input[builtins.str] value: The value specified for the hyper parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class ModelCardTrainingMetricArgs:
    def __init__(__self__, *,
        ...
        """
        training metric data.
        :param pulumi.Input[builtins.str] name: The name of the result from the SageMaker AI training job.
        :param pulumi.Input[builtins.float] value: The value of a result from the SageMaker AI training job.
        :param pulumi.Input[builtins.str] notes: Any additional notes describing the result of the training job.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
        if notes is not None:
...
if not MYPY:
    class ModelCardUserContextArgsDict(TypedDict):
        ...
        """
        user_profile_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelCardUserContextArgs:
    def __init__(__self__, *,
                 domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
                 user_profile_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Information about the user who created or modified an experiment, trial, trial component, lineage group, project, or model card.
        :param pulumi.Input[builtins.str] domain_id: The domain associated with the user.
        :param pulumi.Input[builtins.str] user_profile_arn: The Amazon Resource Name (ARN) of the user's profile.
        :param pulumi.Input[builtins.str] user_profile_name: The name of the user's profile.
        """
        if domain_id is not None:
            pulumi.set(__self__, "domain_id", domain_id)
    ...
    def user_profile_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the user's profile.
        """
    ...
    def user_profile_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelExplainabilityJobDefinitionModelExplainabilityBaselineConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param pulumi.Input[builtins.str] baselining_job_name: The name of the baseline model explainability job.
...
if not MYPY:
    class ModelPackageAdditionalInferenceSpecificationDefinitionArgsDict(TypedDict):
        ...
        """
        supported_content_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The supported MIME types for the input data.
        """
        supported_realtime_inference_instance_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of the instance types that are used to generate inferences in real-time
        """
        supported_response_mime_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The supported MIME types for the output data.
        """
        supported_transform_instance_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ModelPackageAdditionalInferenceSpecificationDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 supported_content_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 supported_realtime_inference_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 supported_response_mime_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 supported_transform_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Additional Inference Specification specifies details about inference jobs that can be run with models based on this model package.AdditionalInferenceSpecifications can be added to existing model packages using AdditionalInferenceSpecificationsToAdd.
        ...
        :param pulumi.Input[builtins.str] name: A unique name to identify the additional inference specification. The name must be unique within the list of your additional inference specifications for a particular model package.
        :param pulumi.Input[builtins.str] description: A description of the additional Inference specification.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_content_types: The supported MIME types for the input data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_realtime_inference_instance_types: A list of the instance types that are used to generate inferences in real-time
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_response_mime_types: The supported MIME types for the output data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_transform_instance_types: A list of the instance types on which a transformation job can be run or on which an endpoint can be deployed.
        """
        pulumi.set(__self__, "containers", containers)
        pulumi.set(__self__, "name", name)
        if description is not None:
    ...
    def supported_content_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The supported MIME types for the input data.
        """
    ...
    def supported_content_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "supported_content_types", value)

    @property
    @pulumi.getter(name="supportedRealtimeInferenceInstanceTypes")
    def supported_realtime_inference_instance_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of the instance types that are used to generate inferences in real-time
        """
    ...
    def supported_realtime_inference_instance_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "supported_realtime_inference_instance_types", value)

    @property
    @pulumi.getter(name="supportedResponseMimeTypes")
    def supported_response_mime_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The supported MIME types for the output data.
        """
    ...
    def supported_response_mime_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "supported_response_mime_types", value)

    @property
    @pulumi.getter(name="supportedTransformInstanceTypes")
    def supported_transform_instance_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of the instance types on which a transformation job can be run or on which an endpoint can be deployed.
        """
    ...
    def supported_transform_instance_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ModelPackageContainerDefinitionModelInputPropertiesArgsDict(TypedDict):
        data_input_config: pulumi.Input[builtins.str]
        """
...
class ModelPackageContainerDefinitionModelInputPropertiesArgs:
    def __init__(__self__, *,
                 data_input_config: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] data_input_config: The input configuration object for the model.
        """
        pulumi.set(__self__, "data_input_config", data_input_config)

    @property
    @pulumi.getter(name="dataInputConfig")
    def data_input_config(self) -> pulumi.Input[builtins.str]:
        """
        The input configuration object for the model.
        """
    ...
    def data_input_config(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ModelPackageContainerDefinitionArgsDict(TypedDict):
        ...
        """
        framework_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelPackageContainerDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 framework_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        Describes the Docker container for the model package.
        :param pulumi.Input[builtins.str] image: The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored.
        :param pulumi.Input[builtins.str] container_hostname: The DNS host name for the Docker container.
        :param pulumi.Input[builtins.str] framework: The machine learning framework of the model package container image.
        :param pulumi.Input[builtins.str] framework_version: The framework version of the Model Package Container Image.
        :param pulumi.Input[builtins.str] image_digest: An MD5 hash of the training algorithm that identifies the Docker image used for training.
        :param pulumi.Input[builtins.str] model_data_url: A structure with Model Input details.
        :param pulumi.Input[builtins.str] nearest_model_name: The name of a pre-trained machine learning benchmarked by Amazon SageMaker Inference Recommender model that matches your model.
        """
        pulumi.set(__self__, "image", image)
    ...
    def framework_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The framework version of the Model Package Container Image.
        """
    ...
    def framework_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelPackageFileSourceArgsDict(TypedDict):
        ...
        """
        content_digest: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelPackageFileSourceArgs:
    def __init__(__self__, *,
                 s3_uri: pulumi.Input[builtins.str],
                 content_digest: Optional[pulumi.Input[builtins.str]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Represents a File Source Object.
        :param pulumi.Input[builtins.str] s3_uri: The Amazon S3 URI for the file source.
        :param pulumi.Input[builtins.str] content_digest: The digest of the file source.
        :param pulumi.Input[builtins.str] content_type: The type of content stored in the file source.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
    ...
    def content_digest(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The digest of the file source.
        """
    ...
    def content_digest(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ModelPackageInferenceSpecificationArgsDict(TypedDict):
        ...
        The Amazon ECR registry path of the Docker image that contains the inference code.
        """
        supported_content_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        The supported MIME types for the input data.
        """
        supported_response_mime_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        The supported MIME types for the output data.
        """
        supported_realtime_inference_instance_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
...
class ModelPackageInferenceSpecificationArgs:
    ...
    @property
    @pulumi.getter(name="supportedContentTypes")
    def supported_content_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The supported MIME types for the input data.
        """
        return pulumi.get(self, "supported_content_types")
    ...
    @supported_content_types.setter
    def supported_content_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "supported_content_types", value)

    @property
    @pulumi.getter(name="supportedResponseMimeTypes")
    def supported_response_mime_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The supported MIME types for the output data.
        """
        return pulumi.get(self, "supported_response_mime_types")
    ...
    @supported_response_mime_types.setter
    def supported_response_mime_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "supported_response_mime_types", value)
...
if not MYPY:
    class ModelPackageMetadataPropertiesArgsDict(TypedDict):
        ...
        The commit ID.
        """
        generated_by: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelPackageMetadataPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 generated_by: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 repository: Optional[pulumi.Input[builtins.str]] = None):
        """
        Metadata properties of the tracking entity, trial, or trial component.
        :param pulumi.Input[builtins.str] commit_id: The commit ID.
        :param pulumi.Input[builtins.str] generated_by: The entity this entity was generated by.
        :param pulumi.Input[builtins.str] project_id: The project ID metadata.
        :param pulumi.Input[builtins.str] repository: The repository metadata.
        """
    ...
    def generated_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The entity this entity was generated by.
        """
    ...
    @generated_by.setter
    def generated_by(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelPackageMetricsSourceArgs:
    def __init__(__self__, *,
        ...
        """
        Represents a Metric Source Object.
        :param pulumi.Input[builtins.str] content_type: The type of content stored in the metric source.
        :param pulumi.Input[builtins.str] s3_uri: The Amazon S3 URI for the metric source.
        :param pulumi.Input[builtins.str] content_digest: The digest of the metric source.
        """
        pulumi.set(__self__, "content_type", content_type)
        pulumi.set(__self__, "s3_uri", s3_uri)
        if content_digest is not None:
...
class ModelPackageModelAccessConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the access configuration file for the ML model.
        :param pulumi.Input[builtins.bool] accept_eula: Specifies agreement to the model end-user license agreement (EULA).
        """
...
if not MYPY:
    class ModelPackageModelCardArgsDict(TypedDict):
        ...
        """
        model_card_content: pulumi.Input[builtins.str]
        """
        The content of the model card.
        """
...
class ModelPackageModelCardArgs:
    def __init__(__self__, *,
        ...
        """
        The model card associated with the model package.
        :param pulumi.Input[builtins.str] model_card_content: The content of the model card.
    ...
    def model_card_content(self) -> pulumi.Input[builtins.str]:
        """
        The content of the model card.
        """
    ...
    def model_card_content(self, value: pulumi.Input[builtins.str]):
...
class ModelPackageS3DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_uri: Depending on the value specified for the S3DataType, identifies either a key name prefix or a manifest.
        """
...
class ModelPackageS3ModelDataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_uri: Specifies the S3 path of ML model data to deploy.
        """
...
class ModelPackageSecurityConfigArgs:
    def __init__(__self__, *,
        ...
        """
        An optional AWS Key Management Service key to encrypt, decrypt, and re-encrypt model package information for regulated workloads with highly sensitive data.
        :param pulumi.Input[builtins.str] kms_key_id: The AWS KMS Key ID (KMSKeyId) used for encryption of model package information.
        """
        pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class ModelPackageSourceAlgorithmArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your Amazon SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param pulumi.Input[builtins.str] algorithm_name: The name of an algorithm that was used to create the model package. The algorithm must be either an algorithm resource in your Amazon SageMaker account or an algorithm in AWS Marketplace that you are subscribed to.
        :param pulumi.Input[builtins.str] model_data_url: The Amazon S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
        """
        pulumi.set(__self__, "algorithm_name", algorithm_name)
        if model_data_url is not None:
            pulumi.set(__self__, "model_data_url", model_data_url)
...
class ModelPackageStatusItemArgs:
    def __init__(__self__, *,
        ...
        """
        Represents the overall status of a model package.
        :param pulumi.Input[builtins.str] name: The name of the model package for which the overall status is being reported.
        :param pulumi.Input['ModelPackageStatusItemStatus'] status: The current status.
        :param pulumi.Input[builtins.str] failure_reason: If the overall status is Failed, the reason for the failure.
        """
        pulumi.set(__self__, "name", name)
...
class ModelPackageTransformInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The multipurpose internet mail extension (MIME) type of the data. Amazon SageMaker uses the MIME type with each http call to transfer data to the transform job.
...
if not MYPY:
    class ModelPackageTransformJobDefinitionArgsDict(TypedDict):
        ...
        """
        max_concurrent_transforms: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum number of parallel requests that can be sent to each instance in a transform job. The default value is 1.
        """
        max_payload_in_mb: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ModelPackageTransformJobDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 environment: Optional[pulumi.Input['ModelPackageEnvironmentArgs']] = None,
                 max_concurrent_transforms: Optional[pulumi.Input[builtins.int]] = None,
                 max_payload_in_mb: Optional[pulumi.Input[builtins.int]] = None):
        """
        Defines the input needed to run a transform job using the inference specification specified in the algorithm.
        ...
        :param pulumi.Input[builtins.int] max_concurrent_transforms: The maximum number of parallel requests that can be sent to each instance in a transform job. The default value is 1.
        :param pulumi.Input[builtins.int] max_payload_in_mb: The maximum payload size allowed, in MB. A payload is the data portion of a record (without metadata).
        """
    ...
    def max_concurrent_transforms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of parallel requests that can be sent to each instance in a transform job. The default value is 1.
        """
    ...
    def max_concurrent_transforms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_concurrent_transforms", value)

    @property
    @pulumi.getter(name="maxPayloadInMb")
    def max_payload_in_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum payload size allowed, in MB. A payload is the data portion of a record (without metadata).
        """
    ...
    def max_payload_in_mb(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ModelPackageTransformOutputArgsDict(TypedDict):
        ...
        """
        accept: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelPackageTransformOutputArgs:
    def __init__(__self__, *,
                 s3_output_path: pulumi.Input[builtins.str],
                 accept: Optional[pulumi.Input[builtins.str]] = None,
                 assemble_with: Optional[pulumi.Input['ModelPackageTransformOutputAssembleWith']] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Describes the results of a transform job.
        :param pulumi.Input[builtins.str] s3_output_path: The Amazon S3 path where you want Amazon SageMaker to store the results of the transform job.
        :param pulumi.Input[builtins.str] accept: The MIME type used to specify the output data. Amazon SageMaker uses the MIME type with each http call to transfer data from the transform job.
    ...
    @property
    @pulumi.getter
    def accept(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The MIME type used to specify the output data. Amazon SageMaker uses the MIME type with each http call to transfer data from the transform job.
        """
    ...
    @accept.setter
    def accept(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelPackageTransformResourcesArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the resources, including ML instance types and ML instance count, to use for transform job.
        :param pulumi.Input[builtins.int] instance_count: The number of ML compute instances to use in the transform job. For distributed transform jobs, specify a value greater than 1. The default value is 1.
        :param pulumi.Input[builtins.str] instance_type: The ML compute instance type for the transform job.
        :param pulumi.Input[builtins.str] volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt model data on the storage volume attached to the ML compute instance(s) that run the batch transform job.
        """
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "instance_type", instance_type)
        if volume_kms_key_id is not None:
...
class ModelPackageValidationProfileArgs:
    def __init__(__self__, *,
        ...
        """
        Contains data, such as the inputs and targeted instance types that are used in the process of validating the model package.
        :param pulumi.Input[builtins.str] profile_name: The name of the profile for the model package.
...
if not MYPY:
    class ModelPackageValidationSpecificationArgsDict(TypedDict):
        ...
        """
        validation_role: pulumi.Input[builtins.str]
        """
...
class ModelPackageValidationSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] validation_role: The IAM roles to be used for the validation of the model package.
        """
    ...
    def validation_role(self) -> pulumi.Input[builtins.str]:
        """
        The IAM roles to be used for the validation of the model package.
        """
    ...
    def validation_role(self, value: pulumi.Input[builtins.str]):
...
class ModelQualityJobDefinitionModelQualityBaselineConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
        :param pulumi.Input[builtins.str] baselining_job_name: The name of the job that performs baselining for the monitoring job.
...
if not MYPY:
    class MonitoringScheduleConfigArgsDict(TypedDict):
        ...
        """
        monitoring_job_definition_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MonitoringScheduleConfigArgs:
    def __init__(__self__, *,
                 ...
                 monitoring_job_definition_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] monitoring_job_definition_name: Name of the job definition
    ...
    def monitoring_job_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the job definition
        """
    ...
    def monitoring_job_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MonitoringScheduleMonitoringExecutionSummaryArgsDict(TypedDict):
        ...
        """
        last_modified_time: pulumi.Input[builtins.str]
        """
        ...
        """
        monitoring_schedule_name: pulumi.Input[builtins.str]
        """
        ...
        """
        processing_job_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MonitoringScheduleMonitoringExecutionSummaryArgs:
    def __init__(__self__, *,
                 ...
                 failure_reason: Optional[pulumi.Input[builtins.str]] = None,
                 processing_job_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Summary of information about monitoring job
        :param pulumi.Input[builtins.str] creation_time: The time at which the monitoring job was created.
        :param pulumi.Input[builtins.str] last_modified_time: A timestamp that indicates the last time the monitoring job was modified.
        ...
        :param pulumi.Input[builtins.str] scheduled_time: The time the monitoring job was scheduled.
        :param pulumi.Input[builtins.str] endpoint_name: The name of the endpoint used to run the monitoring job.
        :param pulumi.Input[builtins.str] failure_reason: Contains the reason a monitoring job failed, if it failed.
        :param pulumi.Input[builtins.str] processing_job_arn: The Amazon Resource Name (ARN) of the monitoring job.
        """
    ...
    def last_modified_time(self) -> pulumi.Input[builtins.str]:
        """
        A timestamp that indicates the last time the monitoring job was modified.
        """
    ...
    def last_modified_time(self, value: pulumi.Input[builtins.str]):
    ...
    def monitoring_schedule_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the monitoring schedule.
        """
    ...
    def monitoring_schedule_name(self, value: pulumi.Input[builtins.str]):
    ...
    def processing_job_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the monitoring job.
        """
    ...
    def processing_job_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MonitoringScheduleScheduleConfigArgsDict(TypedDict):
        ...
        """
        data_analysis_end_time: NotRequired[pulumi.Input[builtins.str]]
        """
        Data Analysis end time, e.g. PT0H
        """
        data_analysis_start_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MonitoringScheduleScheduleConfigArgs:
    def __init__(__self__, *,
                 schedule_expression: pulumi.Input[builtins.str],
                 data_analysis_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 data_analysis_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        Configuration details about the monitoring schedule.
        :param pulumi.Input[builtins.str] schedule_expression: A cron expression or 'NOW' that describes details about the monitoring schedule.
        :param pulumi.Input[builtins.str] data_analysis_end_time: Data Analysis end time, e.g. PT0H
        :param pulumi.Input[builtins.str] data_analysis_start_time: Data Analysis start time, e.g. -PT1H
        """
    ...
    def data_analysis_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data Analysis end time, e.g. PT0H
        """
    ...
    def data_analysis_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_analysis_end_time", value)

    @property
    @pulumi.getter(name="dataAnalysisStartTime")
    def data_analysis_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data Analysis start time, e.g. -PT1H
        """
    ...
    def data_analysis_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OfflineStoreConfigPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disable_glue_table_creation: Set to `True` to disable the automatic creation of an AWS Glue table when configuring an `OfflineStore` . If set to `False` , Feature Store will name the `OfflineStore` Glue table following [Athena's naming recommendations](https://docs.aws.amazon.com/athena/latest/ug/tables-databases-columns-names.html) .
...
class OnlineStoreConfigPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration of an `OnlineStore` .
        :param pulumi.Input[builtins.bool] enable_online_store: Turn `OnlineStore` off by specifying `False` for the `EnableOnlineStore` flag. Turn `OnlineStore` on by specifying `True` for the `EnableOnlineStore` flag.
...
class ParallelismConfigurationPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The parallelism configuration applied to the pipeline.
        :param pulumi.Input[builtins.int] max_parallel_execution_steps: Maximum parallel execution steps
        """
...
class PartnerAppConfigArgs:
    def __init__(__self__, *,
        ...
        """
        A collection of configuration settings for the PartnerApp.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] admin_users: A list of users with administrator privileges for the PartnerApp.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] arguments: A list of arguments to pass to the PartnerApp.
        """
...
if not MYPY:
    class PartnerAppMaintenanceConfigArgsDict(TypedDict):
        ...
        """
        maintenance_window_start: pulumi.Input[builtins.str]
        """
...
class PartnerAppMaintenanceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        A collection of settings that specify the maintenance schedule for the PartnerApp.
        :param pulumi.Input[builtins.str] maintenance_window_start: The maintenance window start day and time for the PartnerApp.
        """
        pulumi.set(__self__, "maintenance_window_start", maintenance_window_start)

    @property
    @pulumi.getter(name="maintenanceWindowStart")
    def maintenance_window_start(self) -> pulumi.Input[builtins.str]:
        """
        The maintenance window start day and time for the PartnerApp.
        """
    ...
    def maintenance_window_start(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PipelineDefinition0PropertiesArgsDict(TypedDict):
        ...
        """
        pipeline_definition_body: pulumi.Input[builtins.str]
        """
...
class PipelineDefinition0PropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The definition of the pipeline. This can be either a JSON string or an Amazon S3 location.
        :param pulumi.Input[builtins.str] pipeline_definition_body: A specification that defines the pipeline in JSON format.
        """
        pulumi.set(__self__, "pipeline_definition_body", pipeline_definition_body)

    @property
    @pulumi.getter(name="pipelineDefinitionBody")
    def pipeline_definition_body(self) -> pulumi.Input[builtins.str]:
        """
        A specification that defines the pipeline in JSON format.
        """
    ...
    def pipeline_definition_body(self, value: pulumi.Input[builtins.str]):
...
class PipelineS3LocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The name of the S3 bucket where the PipelineDefinition file is stored.
        :param pulumi.Input[builtins.str] key: The file name of the PipelineDefinition file (Amazon S3 object name).
        :param pulumi.Input[builtins.str] e_tag: The Amazon S3 ETag (a file checksum) of the PipelineDefinition file. If you don't specify a value, SageMaker skips ETag validation of your PipelineDefinition file.
        :param pulumi.Input[builtins.str] version: For versioning-enabled buckets, a specific version of the PipelineDefinition file.
        """
...
if not MYPY:
    class ServiceCatalogProvisionedProductDetailsPropertiesArgsDict(TypedDict):
        ...
        """
        provisioned_product_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The ID of the provisioned product.
        """
        provisioned_product_status_message: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceCatalogProvisionedProductDetailsPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 provisioned_product_status_message: Optional[pulumi.Input[builtins.str]] = None):
        """
        Provisioned ServiceCatalog  Details
        :param pulumi.Input[builtins.str] provisioned_product_id: The ID of the provisioned product.
        :param pulumi.Input[builtins.str] provisioned_product_status_message: The current status of the product.
    ...
    def provisioned_product_status_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The current status of the product.
    ...
    def provisioned_product_status_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SpaceCustomFileSystemArgsDict(TypedDict):
        ...
        s3_file_system: NotRequired[pulumi.Input['SpaceS3FileSystemArgsDict']]
elif False:
...
class SpaceCustomFileSystemArgs:
    def __init__(__self__, *,
                 ...
                 s3_file_system: Optional[pulumi.Input['SpaceS3FileSystemArgs']] = None):
    ...
    def s3_file_system(self) -> Optional[pulumi.Input['SpaceS3FileSystemArgs']]:
        return pulumi.get(self, "s3_file_system")

    @s3_file_system.setter
    def s3_file_system(self, value: Optional[pulumi.Input['SpaceS3FileSystemArgs']]):
        pulumi.set(self, "s3_file_system", value)
...
class SpaceEbsStorageSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        Properties related to the space's Amazon Elastic Block Store volume.
        :param pulumi.Input[builtins.int] ebs_volume_size_in_gb: Size of the Amazon EBS volume in Gb
        """
...
class SpaceIdleSettingsArgs:
    def __init__(__self__, *,
                 idle_timeout_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] idle_timeout_in_minutes: The space idle timeout value set in minutes
        """
        if idle_timeout_in_minutes is not None:
            pulumi.set(__self__, "idle_timeout_in_minutes", idle_timeout_in_minutes)
...
class SpaceOwnershipSettingsArgs:
    def __init__(__self__, *,
                 owner_user_profile_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] owner_user_profile_name: The user profile who is the owner of the space.
        """
...
if not MYPY:
    ...
    SpaceS3FileSystemArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class SpaceS3FileSystemArgs:
    def __init__(__self__, *,
                 s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        if s3_uri is not None:
            pulumi.set(__self__, "s3_uri", s3_uri)
...
if not MYPY:
    class SpaceSettingsArgsDict(TypedDict):
        ...
        The kernel gateway app settings.
        """
        remote_access: NotRequired[pulumi.Input['SpaceRemoteAccess']]
        """
        This is a flag used to indicate if remote access is enabled.
        """
        space_managed_resources: NotRequired[pulumi.Input['SpaceManagedResources']]
        """
...
class SpaceSettingsArgs:
    def __init__(__self__, *,
                 ...
                 remote_access: Optional[pulumi.Input['SpaceRemoteAccess']] = None,
                 space_managed_resources: Optional[pulumi.Input['SpaceManagedResources']] = None,
        ...
        :param pulumi.Input['SpaceRemoteAccess'] remote_access: This is a flag used to indicate if remote access is enabled.
        :param pulumi.Input['SpaceManagedResources'] space_managed_resources: This is a flag used to indicate if space managed resources needs to be created.
    ...
    def remote_access(self) -> Optional[pulumi.Input['SpaceRemoteAccess']]:
        """
        This is a flag used to indicate if remote access is enabled.
        """
    ...
    def remote_access(self, value: Optional[pulumi.Input['SpaceRemoteAccess']]):
        pulumi.set(self, "remote_access", value)

    @property
    @pulumi.getter(name="spaceManagedResources")
    def space_managed_resources(self) -> Optional[pulumi.Input['SpaceManagedResources']]:
        """
        This is a flag used to indicate if space managed resources needs to be created.
        """
        return pulumi.get(self, "space_managed_resources")

    @space_managed_resources.setter
    def space_managed_resources(self, value: Optional[pulumi.Input['SpaceManagedResources']]):
        pulumi.set(self, "space_managed_resources", value)
...
if not MYPY:
    class UserProfileCustomFileSystemConfigArgsDict(TypedDict):
        ...
        The settings for a custom Amazon FSx for Lustre file system.
        """
        s3_file_system_config: NotRequired[pulumi.Input['UserProfileS3FileSystemConfigArgsDict']]
        """
        Configuration settings for a custom Amazon S3 file system.
        """
elif False:
...
class UserProfileCustomFileSystemConfigArgs:
    def __init__(__self__, *,
                 ...
                 s3_file_system_config: Optional[pulumi.Input['UserProfileS3FileSystemConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['UserProfileS3FileSystemConfigArgs'] s3_file_system_config: Configuration settings for a custom Amazon S3 file system.
        """
        if efs_file_system_config is not None:
            pulumi.set(__self__, "efs_file_system_config", efs_file_system_config)
        if f_sx_lustre_file_system_config is not None:
    ...
    @property
    @pulumi.getter(name="s3FileSystemConfig")
    def s3_file_system_config(self) -> Optional[pulumi.Input['UserProfileS3FileSystemConfigArgs']]:
        """
        Configuration settings for a custom Amazon S3 file system.
        """
        return pulumi.get(self, "s3_file_system_config")
    ...
    @s3_file_system_config.setter
    def s3_file_system_config(self, value: Optional[pulumi.Input['UserProfileS3FileSystemConfigArgs']]):
        pulumi.set(self, "s3_file_system_config", value)
...
if not MYPY:
    class UserProfileS3FileSystemConfigArgsDict(TypedDict):
        mount_path: NotRequired[pulumi.Input[builtins.str]]
        """
        The file system path where the Amazon S3 storage location will be mounted within the Amazon SageMaker Studio environment.
        """
    ...
    UserProfileS3FileSystemConfigArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class UserProfileS3FileSystemConfigArgs:
    def __init__(__self__, *,
                 mount_path: Optional[pulumi.Input[builtins.str]] = None,
                 s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
...
class UserProfileUserSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['UserProfileCodeEditorAppSettingsArgs'] code_editor_app_settings: The Code Editor application settings.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param pulumi.Input[Sequence[pulumi.Input['UserProfileCustomFileSystemConfigArgs']]] custom_file_system_configs: The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker AI Studio.
        ...
        :param pulumi.Input['UserProfileCustomPosixUserConfigArgs'] custom_posix_user_config: Details about the POSIX identity that is used for file system operations.
               ...
               SageMaker applies these settings only to private spaces that the user creates in the domain. SageMaker doesn't apply these settings to shared spaces.
        :param pulumi.Input[builtins.str] default_landing_uri: Defines which Amazon SageMaker application users are directed to by default.
        :param pulumi.Input[builtins.str] execution_role: The user profile Amazon Resource Name (ARN).
