...
class ProjectArgs:
    ...
    def _configure(
        ...
        if service_catalog_provisioned_product_details is not None:
            _setter("service_catalog_provisioned_product_details", service_catalog_provisioned_product_details)
        if tags is not None:
            _setter("tags", tags)
...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(service_catalog_provisioned_product_details, ServiceCatalogProvisionedProductDetailsPropertiesArgs):
            ...
            if not isinstance(service_catalog_provisioning_details, ServiceCatalogProvisioningDetailsPropertiesArgs):
