...
class EndpointConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(async_inference_config, EndpointConfigAsyncInferenceConfigArgs):
            ...
            if not isinstance(data_capture_config, EndpointConfigDataCaptureConfigArgs):
            ...
            if not isinstance(explainer_config, EndpointConfigExplainerConfigArgs):
