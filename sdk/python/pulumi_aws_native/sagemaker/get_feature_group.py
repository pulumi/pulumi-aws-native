...
class GetFeatureGroupResult:
    ...
    def feature_group_status(self) -> Optional[_builtins.str]:
        """
...
def get_feature_group(feature_group_name: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFeatureGroupResult:
    """
    Resource Type definition for AWS::SageMaker::FeatureGroup


    :param _builtins.str feature_group_name: The Name of the FeatureGroup.
    """
    __args__ = dict()
...
def get_feature_group_output(feature_group_name: Optional[pulumi.Input[_builtins.str]] = None,
