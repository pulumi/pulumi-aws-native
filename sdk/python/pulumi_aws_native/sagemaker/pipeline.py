...
class PipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pipeline_description: The description of the Pipeline.
...
class Pipeline(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="pipelineDisplayName")
    def pipeline_display_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The display name of the Pipeline.
        """
        return pulumi.get(self, "pipeline_display_name")
