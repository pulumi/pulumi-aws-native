...
warnings.warn("""ReportDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ReportDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_unit: Optional[pulumi.Input['ReportDefinitionTimeUnit']] = None,
                 __props__=None):
        pulumi.log.warn("""ReportDefinition is deprecated: ReportDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
