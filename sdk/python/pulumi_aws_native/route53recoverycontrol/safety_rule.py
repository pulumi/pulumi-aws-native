...
class SafetyRuleArgs:
    ...
    def _configure(
        ...
        if gating_rule is not None:
            _setter("gating_rule", gating_rule)
        if name is not None:
            _setter("name", name)
...
class SafetyRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(assertion_rule, SafetyRuleAssertionRuleArgs):
            ...
            if not isinstance(gating_rule, SafetyRuleGatingRuleArgs):
            ...
            if not isinstance(rule_config, SafetyRuleRuleConfigArgs):
