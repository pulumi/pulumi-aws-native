...
def get_routing_control(routing_control_arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRoutingControlResult:
    """
    AWS Route53 Recovery Control Routing Control resource schema .


    :param builtins.str routing_control_arn: The Amazon Resource Name (ARN) of the routing control.
    """
    __args__ = dict()
...
def get_routing_control_output(routing_control_arn: Optional[pulumi.Input[builtins.str]] = None,
