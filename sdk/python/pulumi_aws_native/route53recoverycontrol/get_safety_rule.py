...
class GetSafetyRuleResult:
    ...
    def safety_rule_arn(self) -> Optional[builtins.str]:
        """
...
def get_safety_rule(safety_rule_arn: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSafetyRuleResult:
    """
    Resource schema for AWS Route53 Recovery Control basic constructs and validation rules.


    :param builtins.str safety_rule_arn: The Amazon Resource Name (ARN) of the safety rule.
    """
    __args__ = dict()
...
def get_safety_rule_output(safety_rule_arn: Optional[pulumi.Input[builtins.str]] = None,
