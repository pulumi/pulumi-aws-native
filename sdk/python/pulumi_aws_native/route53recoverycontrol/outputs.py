...
class ClusterEndpoint(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str endpoint: A cluster endpoint URL for one of the five redundant clusters that you specify to set or retrieve a routing control state.
        :param _builtins.str region: The AWS Region for a cluster endpoint.
        """
...
class SafetyRuleAssertionRule(dict):
    ...
    def __init__(__self__, *,
                 asserted_controls: Sequence[_builtins.str],
                 wait_period_ms: _builtins.int):
        """
        An assertion rule enforces that, when a routing control state is changed, that the criteria set by the rule configuration is met. Otherwise, the change to the routing control is not accepted.
        :param Sequence[_builtins.str] asserted_controls: The routing controls that are part of transactions that are evaluated to determine if a request to change a routing control state is allowed. For example, you might include three routing controls, one for each of three AWS Regions.
        :param _builtins.int wait_period_ms: An evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail. This helps prevent "flapping" of state. The wait period is 5000 ms by default, but you can choose a custom value.
        """
    ...
    def asserted_controls(self) -> Sequence[_builtins.str]:
        """
    ...
    def wait_period_ms(self) -> _builtins.int:
        """
...
class SafetyRuleGatingRule(dict):
    ...
    def __init__(__self__, *,
                 gating_controls: Sequence[_builtins.str],
                 target_controls: Sequence[_builtins.str],
                 wait_period_ms: _builtins.int):
        """
        A gating rule verifies that a set of gating controls evaluates as true, based on a rule configuration that you specify. If the gating rule evaluates to true, Amazon Route 53 Application Recovery Controller allows a set of routing control state changes to run and complete against the set of target controls.
        :param Sequence[_builtins.str] gating_controls: The gating controls for the gating rule. That is, routing controls that are evaluated by the rule configuration that you specify.
        :param Sequence[_builtins.str] target_controls: Routing controls that can only be set or unset if the specified RuleConfig evaluates to true for the specified GatingControls. For example, say you have three gating controls, one for each of three AWS Regions. Now you specify AtLeast 2 as your RuleConfig. With these settings, you can only change (set or unset) the routing controls that you have specified as TargetControls if that rule evaluates to true. 
    ...
    def gating_controls(self) -> Sequence[_builtins.str]:
        """
    ...
    def target_controls(self) -> Sequence[_builtins.str]:
        """
...
class SafetyRuleRuleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The rule configuration for an assertion rule or gating rule. This is the criteria that you set for specific assertion controls (routing controls) or gating controls. This configuration specifies how many controls must be enabled after a transaction completes.
        :param _builtins.bool inverted: Logical negation of the rule. If the rule would usually evaluate true, it's evaluated as false, and vice versa.
        :param _builtins.int threshold: The value of N, when you specify an ATLEAST rule type. That is, Threshold is the number of controls that must be set when you specify an ATLEAST type.
