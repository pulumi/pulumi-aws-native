...
class RoutingControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_arn: Arn associated with Control Panel
        :param pulumi.Input[builtins.str] control_panel_arn: The Amazon Resource Name (ARN) of the control panel.
        :param pulumi.Input[builtins.str] name: The name of the routing control. You can use any non-white space character in the name.
        """
...
class RoutingControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["clusterArn", "controlPanelArn"])
    ...
    def routing_control_arn(self) -> pulumi.Output[builtins.str]:
        """
