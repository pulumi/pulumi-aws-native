...
class GetControlPanelResult:
    ...
    def control_panel_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def default_control_panel(self) -> Optional[_builtins.bool]:
        """
    ...
    def routing_control_count(self) -> Optional[_builtins.int]:
        """
...
def get_control_panel(control_panel_arn: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetControlPanelResult:
    """
    AWS Route53 Recovery Control Control Panel resource schema .


    :param _builtins.str control_panel_arn: The Amazon Resource Name (ARN) of the cluster.
    """
    __args__ = dict()
...
def get_control_panel_output(control_panel_arn: Optional[pulumi.Input[_builtins.str]] = None,
