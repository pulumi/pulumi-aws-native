...
class Placement(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PlacementPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PlacementPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PlacementAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PlacementProperties']:
        """
