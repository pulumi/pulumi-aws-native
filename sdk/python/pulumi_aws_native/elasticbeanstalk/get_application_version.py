...
def get_application_version(application_name: Optional[builtins.str] = None,
    ...
    :param builtins.str application_name: The name of the Elastic Beanstalk application that is associated with this application version. 
    """
    __args__ = dict()
...
def get_application_version_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
