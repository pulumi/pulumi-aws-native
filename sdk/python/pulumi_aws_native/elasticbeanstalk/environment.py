...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 operations_role: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application_name: The name of the application that is associated with this environment.
        :param pulumi.Input[builtins.str] cname_prefix: If specified, the environment attempts to use this value as the prefix for the CNAME in your Elastic Beanstalk environment URL. If not specified, the CNAME is generated automatically by appending a random alphanumeric string to the environment name.
        :param pulumi.Input[builtins.str] description: Your description for this environment.
        :param pulumi.Input[builtins.str] environment_name: A unique name for the environment.
        :param pulumi.Input[builtins.str] operations_role: The Amazon Resource Name (ARN) of an existing IAM role to be used as the environment's operations role.
        ...
        :param pulumi.Input[builtins.str] platform_arn: The Amazon Resource Name (ARN) of the custom platform to use with the environment.
        :param pulumi.Input[builtins.str] solution_stack_name: The name of an Elastic Beanstalk solution stack (platform version) to use with the environment.
        ...
        :param pulumi.Input[builtins.str] template_name: The name of the Elastic Beanstalk configuration template to use with the environment.
        ...
        :param pulumi.Input[builtins.str] version_label: The name of the application version to deploy.
        """
    ...
    def operations_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operations_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Environment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cnamePrefix")
    def cname_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If specified, the environment attempts to use this value as the prefix for the CNAME in your Elastic Beanstalk environment URL. If not specified, the CNAME is generated automatically by appending a random alphanumeric string to the environment name.
        """
        return pulumi.get(self, "cname_prefix")
    ...
    @property
    @pulumi.getter(name="operationsRole")
    def operations_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of an existing IAM role to be used as the environment's operations role.
        """
        return pulumi.get(self, "operations_role")
