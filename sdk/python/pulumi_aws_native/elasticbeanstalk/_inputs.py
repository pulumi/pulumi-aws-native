...
class ApplicationMaxAgeRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] delete_source_from_s3: Set to true to delete a version's source bundle from Amazon S3 when Elastic Beanstalk deletes the application version.
        :param pulumi.Input[builtins.bool] enabled: Specify true to apply the rule, or false to disable it.
        :param pulumi.Input[builtins.int] max_age_in_days: Specify the number of days to retain an application versions.
        """
...
class ApplicationMaxCountRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] delete_source_from_s3: Set to true to delete a version's source bundle from Amazon S3 when Elastic Beanstalk deletes the application version.
        :param pulumi.Input[builtins.bool] enabled: Specify true to apply the rule, or false to disable it.
        :param pulumi.Input[builtins.int] max_count: Specify the maximum number of application versions to retain.
        """
        if delete_source_from_s3 is not None:
            pulumi.set(__self__, "delete_source_from_s3", delete_source_from_s3)
        if enabled is not None:
...
if not MYPY:
    class ApplicationResourceLifecycleConfigArgsDict(TypedDict):
        service_role: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationResourceLifecycleConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service_role: The ARN of an IAM service role that Elastic Beanstalk has permission to assume. The ServiceRole property is required the first time that you provide a ResourceLifecycleConfig for the application. After you provide it once, Elastic Beanstalk persists the Service Role with the application, and you don't need to specify it again. You can, however, specify it in subsequent updates to change the Service Role to another value.
...
class ApplicationVersionSourceBundleArgs:
    def __init__(__self__, *,
                 ...
                 s3_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] s3_bucket: The Amazon S3 bucket where the data is located.
        :param pulumi.Input[builtins.str] s3_key: The Amazon S3 key where the data is located.
        """
...
class ConfigurationTemplateConfigurationOptionSettingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: A unique namespace that identifies the option's associated AWS resource.
        :param pulumi.Input[builtins.str] option_name: The name of the configuration option.
        :param pulumi.Input[builtins.str] resource_name: A unique resource name for the option setting. Use it for a time–based scaling configuration option. 
        :param pulumi.Input[builtins.str] value: The current value for the configuration option.
        """
...
class ConfigurationTemplateSourceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 template_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] application_name: The name of the application associated with the configuration.
        :param pulumi.Input[builtins.str] template_name: The name of the configuration template.
        """
...
class EnvironmentTierArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of this environment tier.
        :param pulumi.Input[builtins.str] type: The type of this environment tier.
        :param pulumi.Input[builtins.str] version: The version of this environment tier. When you don't set a value to it, Elastic Beanstalk uses the latest compatible worker tier version.
        """
        if name is not None:
