...
class ApplicationResourceLifecycleConfigArgsDict(TypedDict):
    ...
    """
    version_lifecycle_config: NotRequired[pulumi.Input[Optional['ApplicationVersionLifecycleConfigArgs']]]
    """
...
class ApplicationVersionLifecycleConfigArgsDict(TypedDict):
    max_age_rule: NotRequired[pulumi.Input[Optional['ApplicationMaxAgeRuleArgs']]]
    """
    Specify a max age rule to restrict the length of time that application versions are retained for an application.
    """
    max_count_rule: NotRequired[pulumi.Input[Optional['ApplicationMaxCountRuleArgs']]]
    """
