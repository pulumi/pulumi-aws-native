...
class ExtensionResourceArgs:
    def __init__(__self__, *,
                 ...
                 create_only: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags_property: Optional[pulumi.Input[builtins.str]] = None,
                 tags_style: Optional[pulumi.Input[builtins.str]] = None,
                 write_only: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] type: CloudFormation type name. This has three parts, each separated by two colons. For AWS resources this starts with `AWS::` e.g. `AWS::Logs::LogGroup`. Third party resources should use a namespace prefix e.g. `MyCompany::MyService::MyResource`.
        ...
        :param pulumi.Input[builtins.str] tags_property: Optional name of the property containing the tags. Defaults to "Tags" if the `tagsStyle` is set to either "stringMap" or "keyValueArray". This is used to apply default tags to the resource and can be ignored if not using default tags.
        :param pulumi.Input[builtins.str] tags_style: Optional style of tags this resource uses. Valid values are "stringMap", "keyValueArray" or "none". Defaults to `keyValueArray` if `tagsProperty` is set. This is used to apply default tags to the resource and can be ignored if not using default tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] write_only: Property names as defined by `writeOnlyProperties` in the CloudFormation schema. Write-only properties are not returned during read operations and have to be included in all update operations as CloudControl itself can't read their previous values.
               In the CloudFormation schema these are fully qualified property paths (e.g. `/properties/AccessToken`) whereas here we only include the top-level property name (e.g. `AccessToken`).
        """
    ...
    def create_only(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @create_only.setter
    def create_only(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "create_only", value)

    @property
    @pulumi.getter(name="tagsProperty")
    def tags_property(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tags_property(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tags_property", value)

    @property
    @pulumi.getter(name="tagsStyle")
    def tags_style(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tags_style.setter
    def tags_style(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tags_style", value)

    @property
    @pulumi.getter(name="writeOnly")
    def write_only(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @write_only.setter
    def write_only(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
