...
class GetJobDefinitionResult:
    ...
    def platform_capabilities(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def scheduling_priority(self) -> Optional[builtins.int]:
        """
...
def get_job_definition(job_definition_name: Optional[builtins.str] = None,
    ...
    :param builtins.str job_definition_name: The name of the job definition.
    """
    __args__ = dict()
