...
class ComputeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(compute_resources, ComputeEnvironmentComputeResourcesArgs):
            ...
            if not isinstance(eks_configuration, ComputeEnvironmentEksConfigurationArgs):
            ...
            if not isinstance(update_policy, ComputeEnvironmentUpdatePolicyArgs):
