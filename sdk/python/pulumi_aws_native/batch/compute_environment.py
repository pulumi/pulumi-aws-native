...
class ComputeEnvironment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ComputeEnvironmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ComputeEnvironmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ComputeEnvironmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ComputeEnvironmentProperties']:
        """
