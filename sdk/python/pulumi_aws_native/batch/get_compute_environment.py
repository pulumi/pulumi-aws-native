...
class GetComputeEnvironmentResult:
    ...
    def compute_environment_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def unmanagedv_cpus(self) -> Optional[_builtins.int]:
        """
...
def get_compute_environment(compute_environment_arn: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeEnvironmentResult:
    """
    Resource Type definition for AWS::Batch::ComputeEnvironment


    :param _builtins.str compute_environment_arn: Returns the compute environment ARN, such as `batch: *us-east-1* : *111122223333* :compute-environment/ *ComputeEnvironmentName*` .
    """
    __args__ = dict()
