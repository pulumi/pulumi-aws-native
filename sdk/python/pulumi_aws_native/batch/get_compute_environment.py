...
class GetComputeEnvironmentResult:
    ...
    def compute_environment_arn(self) -> Optional[builtins.str]:
        """
    ...
    def unmanagedv_cpus(self) -> Optional[builtins.int]:
        """
...
def get_compute_environment(compute_environment_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeEnvironmentResult:
    """
    Resource Type definition for AWS::Batch::ComputeEnvironment


    :param builtins.str compute_environment_arn: Returns the compute environment ARN, such as `batch: *us-east-1* : *111122223333* :compute-environment/ *ComputeEnvironmentName*` .
    """
    __args__ = dict()
...
def get_compute_environment_output(compute_environment_arn: Optional[pulumi.Input[builtins.str]] = None,
