...
class JobQueueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_queue_type: The type of job queue. For service jobs that run on SageMaker Training, this value is `SAGEMAKER_TRAINING` . For regular container jobs, this value is `EKS` , `ECS` , or `ECS_FARGATE` depending on the compute environment.
...
class JobQueue(pulumi.CustomResource):
    ...
    def job_queue_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="jobQueueName")
    def job_queue_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the job queue. It can be up to 128 letters long. It can contain uppercase and lowercase letters, numbers, hyphens (-), and underscores (_).
        """
        return pulumi.get(self, "job_queue_name")
