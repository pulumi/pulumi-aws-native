...
warnings.warn("""JobQueue is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class JobQueue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""JobQueue is deprecated: JobQueue is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
