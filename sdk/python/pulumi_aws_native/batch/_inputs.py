...
class ComputeEnvironmentComputeResourcesArgsDict(TypedDict):
    ...
    """
    ec2_configuration: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComputeEnvironmentEc2ConfigurationObjectArgs']]]]]
    """
    ...
    """
    launch_template: NotRequired[pulumi.Input[Optional['ComputeEnvironmentLaunchTemplateSpecificationArgs']]]
    """
    ...
    > This parameter isn't applicable to jobs that are running on Fargate resources. Don't specify it.
    """
    scaling_policy: NotRequired[pulumi.Input[Optional['ComputeEnvironmentComputeScalingPolicyArgs']]]
...
class ComputeEnvironmentLaunchTemplateSpecificationArgsDict(TypedDict):
    ...
    The name of the launch template.
    """
    overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComputeEnvironmentLaunchTemplateSpecificationOverrideArgs']]]]]
    """
...
class JobDefinitionContainerPropertiesArgsDict(TypedDict):
    ...
    """
    environment: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEnvironmentArgs']]]]]
    """
    ...
    """
    ephemeral_storage: NotRequired[pulumi.Input[Optional['JobDefinitionEphemeralStorageArgs']]]
    """
    ...
    """
    fargate_platform_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionContainerPropertiesFargatePlatformConfigurationPropertiesArgs']]]
    """
    The platform configuration for jobs that are running on Fargate resources. Jobs that are running on Amazon EC2 resources must not specify this parameter.
    """
    ...
    """
    linux_parameters: NotRequired[pulumi.Input[Optional['JobDefinitionLinuxParametersArgs']]]
    """
    Linux-specific modifications that are applied to the container, such as details for device mappings.
    """
    log_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionLogConfigurationArgs']]]
    """
    ...
    """
    mount_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionMountPointArgs']]]]]
    """
    The mount points for data volumes in your container. This parameter maps to `Volumes` in the [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/#create-a-container) section of the [Docker Remote API](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.23/) and the `--volume` option to [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/) .
    """
    network_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionNetworkConfigurationArgs']]]
    """
    ...
    """
    repository_credentials: NotRequired[pulumi.Input[Optional['JobDefinitionRepositoryCredentialsArgs']]]
    """
    The private repository authentication credentials to use.
    """
    resource_requirements: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionResourceRequirementArgs']]]]]
    """
    The type and amount of resources to assign to a container. The supported resources include `GPU` , `MEMORY` , and `VCPU` .
    """
    runtime_platform: NotRequired[pulumi.Input[Optional['JobDefinitionRuntimePlatformArgs']]]
    """
    An object that represents the compute environment architecture for AWS Batch jobs on Fargate.
    """
    secrets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionSecretArgs']]]]]
    """
    ...
    """
    ulimits: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionUlimitArgs']]]]]
    """
    ...
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionVolumeArgs']]]]]
    """
...
class JobDefinitionEcsTaskPropertiesArgsDict(TypedDict):
    containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionTaskContainerPropertiesArgs']]]]]
    """
...
class JobDefinitionEfsVolumeConfigurationArgsDict(TypedDict):
    ...
    """
    authorization_config: NotRequired[pulumi.Input[Optional['JobDefinitionEfsAuthorizationConfigArgs']]]
    """
...
class JobDefinitionEksContainerArgsDict(TypedDict):
    ...
    """
    env: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEksContainerEnvironmentVariableArgs']]]]]
    """
    ...
    """
    resources: NotRequired[pulumi.Input[Optional['JobDefinitionEksContainerResourceRequirementsArgs']]]
    """
    ...
    """
    security_context: NotRequired[pulumi.Input[Optional['JobDefinitionEksContainerSecurityContextArgs']]]
    """
    ...
    """
    volume_mounts: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEksContainerVolumeMountArgs']]]]]
    """
...
class JobDefinitionEksPodPropertiesArgsDict(TypedDict):
    containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEksContainerArgs']]]]]
    """
    ...
    """
    image_pull_secrets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionImagePullSecretArgs']]]]]
    """
    ...
    """
    init_containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEksContainerArgs']]]]]
    """
    ...
    > This object is limited to 10 elements.
    """
    metadata: NotRequired[pulumi.Input[Optional['JobDefinitionEksMetadataArgs']]]
    """
    ...
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEksVolumeArgs']]]]]
    """
...
class JobDefinitionEksPropertiesArgsDict(TypedDict):
    pod_properties: NotRequired[pulumi.Input[Optional['JobDefinitionEksPodPropertiesArgs']]]
    """
...
class JobDefinitionEksVolumeArgsDict(TypedDict):
    ...
    """
    empty_dir: NotRequired[pulumi.Input[Optional['JobDefinitionEksEmptyDirArgs']]]
    """
    ...
    """
    host_path: NotRequired[pulumi.Input[Optional['JobDefinitionEksHostPathArgs']]]
    """
    ...
    """
    persistent_volume_claim: NotRequired[pulumi.Input[Optional['JobDefinitionEksPersistentVolumeClaimArgs']]]
    """
    ...
    """
    secret: NotRequired[pulumi.Input[Optional['JobDefinitionEksSecretArgs']]]
    """
...
class JobDefinitionLinuxParametersArgsDict(TypedDict):
    devices: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionDeviceArgs']]]]]
    """
    ...
    > This parameter isn't applicable to jobs that are running on Fargate resources. Don't provide it for these jobs.
    """
    tmpfs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionTmpfsArgs']]]]]
    """
...
class JobDefinitionLogConfigurationArgsDict(TypedDict):
    ...
    """
    secret_options: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionSecretArgs']]]]]
    """
...
class JobDefinitionNodeRangePropertyArgsDict(TypedDict):
    ...
    """
    consumable_resource_properties: NotRequired[pulumi.Input[Optional['JobDefinitionConsumableResourcePropertiesArgs']]]
    """
    Contains a list of consumable resources required by a job.
    """
    container: NotRequired[pulumi.Input[Optional['JobDefinitionMultiNodeContainerPropertiesArgs']]]
    """
    The container details for the node range.
    """
    ecs_properties: NotRequired[pulumi.Input[Optional['JobDefinitionMultiNodeEcsPropertiesArgs']]]
    """
    This is an object that represents the properties of the node range for a multi-node parallel job.
    """
    eks_properties: NotRequired[pulumi.Input[Optional['JobDefinitionEksPropertiesArgs']]]
    """
    This is an object that represents the properties of the node range for a multi-node parallel job.
    """
    instance_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
...
class JobDefinitionRetryStrategyArgsDict(TypedDict):
    ...
    """
    evaluate_on_exit: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionEvaluateOnExitArgs']]]]]
    """
...
class JobDefinitionTaskContainerPropertiesArgsDict(TypedDict):
    ...
    """
    depends_on: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobDefinitionTaskContainerDependencyArgs']]]]]
    """
    ...
    """
    firelens_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionTaskContainerPropertiesFirelensConfigurationPropertiesArgs']]]
    """
    The FireLens configuration for the container. This is used to specify and configure a log router for container logs. For more information, see [Custom log](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html) routing in the *Amazon Elastic Container Service Developer Guide* .
    """
    linux_parameters: NotRequired[pulumi.Input[Optional['JobDefinitionLinuxParametersArgs']]]
...
class JobDefinitionVolumeArgsDict(TypedDict):
    efs_volume_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionEfsVolumeConfigurationArgs']]]
    """
    ...
    """
    host: NotRequired[pulumi.Input[Optional['JobDefinitionHostArgs']]]
    """
    ...
    """
    s3_files_volume_configuration: NotRequired[pulumi.Input[Optional['JobDefinitionS3FilesVolumeConfigurationArgs']]]
...
class SchedulingPolicyFairsharePolicyArgsDict(TypedDict):
    ...
    """
    share_distribution: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SchedulingPolicyShareAttributesArgs']]]]]
    """
