...
class ComputeEnvironmentLaunchTemplateSpecificationOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] target_instance_types: The instance type or family that this override launch template should be applied to.
...
class JobDefinitionConsumableResourceRequirement(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int quantity: The quantity of the consumable resource that is needed.
        """
...
class JobDefinitionEksContainerResourceRequirements(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, str] limits: The type and quantity of the resources to reserve for the container. The values vary based on the `name` that's specified. Resources can be requested using either the `limits` or the `requests` objects.
        ...
        :param Mapping[str, str] requests: The type and quantity of the resources to request for the container. The values vary based on the `name` that's specified. Resources can be requested by using either the `limits` or the `requests` objects.
...
class JobDefinitionEksContainerVolumeMount(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str sub_path: A sub-path inside the referenced volume instead of its root.
        """
...
class JobDefinitionEksMetadata(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, str] annotations: Key-value pairs used to attach arbitrary, non-identifying metadata to Kubernetes objects. Valid annotation keys have two segments: an optional prefix and a name, separated by a slash (/).
...
class JobDefinitionEksPersistentVolumeClaim(dict):
    ...
    def __init__(__self__, *,
                 ...
                 read_only: Optional[bool] = None):
        """
        :param str claim_name: The name of the `persistentVolumeClaim` bounded to a `persistentVolume` . For more information, see [Persistent Volume Claims](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims) in the *Kubernetes documentation* .
        :param bool read_only: An optional boolean value indicating if the mount is read only. Default is false. For more information, see [Read Only Mounts](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/storage/volumes/#read-only-mounts) in the *Kubernetes documentation* .
        """
...
class SchedulingPolicyFairsharePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Fair Share Policy for the Job Queue.
        :param float compute_reservation: A value used to reserve some of the available maximum vCPU for share identifiers that aren't already used.
        ...
        :param float share_decay_seconds: The amount of time (in seconds) to use to calculate a fair-share percentage for each share identifier in use. A value of zero (0) indicates the default minimum time window (600 seconds). The maximum supported value is 604800 (1 week).
...
class SchedulingPolicyShareAttributes(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str share_identifier: A share identifier or share identifier prefix. If the string ends with an asterisk (*), this entry specifies the weight factor to use for share identifiers that start with that prefix. The list of share identifiers in a fair-share policy can't overlap. For example, you can't have one that specifies a `shareIdentifier` of `UserA*` and another that specifies a `shareIdentifier` of `UserA-1` .
               
               There can be no more than 500 share identifiers active in a job queue.
               
               The string is limited to 255 alphanumeric characters, and can be followed by an asterisk (*).
        :param float weight_factor: The weight factor for the share identifier. The default value is 1.0. A lower value has a higher priority for compute resources. For example, jobs that use a share identifier with a weight factor of 0.125 (1/8) get 8 times the compute resources of jobs that use a share identifier with a weight factor of 1.
