...
class ComputeEnvironmentComputeResources(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ComputeEnvironmentLaunchTemplateSpecification' launch_template: An object that represents a launch template that's associated with a compute resource. You must specify either the launch template ID or launch template name in the request, but not both.
...
class JobDefinitionContainerProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionEnvironment'] environment: The Environment property type specifies environment variables to use in a job definition.
        ...
        :param 'JobDefinitionFargatePlatformConfiguration' fargate_platform_configuration: The platform configuration for jobs that are running on Fargate resources. Jobs that run on Amazon EC2 resources must not specify this parameter.
        ...
        :param 'JobDefinitionLogConfiguration' log_configuration: Log configuration options to send to a custom log driver for the container.
        ...
        :param Sequence['JobDefinitionMountPoints'] mount_points: Details for a Docker volume mount point that's used in a job's container properties. This parameter maps to `Volumes` in the [Create a container](https://docs.aws.amazon.com/https://docs.docker.com/engine/api/v1.43/#tag/Container/operation/ContainerCreate) section of the *Docker Remote API* and the `--volume` option to docker run.
        ...
        :param 'JobDefinitionRepositoryCredentials' repository_credentials: The repository credentials for private registry authentication.
        :param Sequence['JobDefinitionResourceRequirement'] resource_requirements: The type and amount of a resource to assign to a container. The supported resources include `GPU` , `MEMORY` , and `VCPU` .
        ...
        :param Sequence['JobDefinitionUlimit'] ulimits: The `ulimit` settings to pass to the container. For more information, see [Ulimit](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_Ulimit.html) .
...
class JobDefinitionEcsTaskProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 volumes: Optional[Sequence['outputs.JobDefinitionVolumes']] = None):
        """
        :param Sequence['JobDefinitionTaskContainerProperties'] containers: Container properties are used for Amazon ECS-based job definitions. These properties to describe the container that's launched as part of a job.
        :param 'JobDefinitionEphemeralStorage' ephemeral_storage: The amount of ephemeral storage to allocate for the task. This parameter is used to expand the total amount of ephemeral storage available, beyond the default amount, for tasks hosted on AWS Fargate .
        :param str execution_role_arn: The Amazon Resource Name (ARN) of the execution role that AWS Batch can assume. For jobs that run on Fargate resources, you must provide an execution role. For more information, see [AWS Batch execution IAM role](https://docs.aws.amazon.com/batch/latest/userguide/execution-IAM-role.html) in the *AWS Batch User Guide* .
...
class JobDefinitionEksContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionEksContainerEnvironmentVariable'] env: An environment variable.
        ...
        :param Sequence['JobDefinitionEksContainerVolumeMount'] volume_mounts: The volume mounts for a container for an Amazon EKS job. For more information about volumes and volume mounts in Kubernetes, see [Volumes](https://docs.aws.amazon.com/https://kubernetes.io/docs/concepts/storage/volumes/) in the *Kubernetes documentation* .
        """
        pulumi.set(__self__, "image", image)
        if args is not None:
...
class JobDefinitionEksProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'JobDefinitionPodProperties' pod_properties: The properties for the pod.
        """
...
class JobDefinitionLinuxParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['JobDefinitionDevice'] devices: An object that represents a container instance host device.
        ...
        :param int swappiness: You can use this parameter to tune a container's memory swappiness behavior. A `swappiness` value of `0` causes swapping to not occur unless absolutely necessary. A `swappiness` value of `100` causes pages to be swapped aggressively. Valid values are whole numbers between `0` and `100` . If the `swappiness` parameter isn't specified, a default value of `60` is used. If a value isn't specified for `maxSwap` , then this parameter is ignored. If `maxSwap` is set to 0, the container doesn't use swap. This parameter maps to the `--memory-swappiness` option to [docker run](https://docs.aws.amazon.com/https://docs.docker.com/engine/reference/run/) .
               ...
               > This parameter isn't applicable to jobs that are running on Fargate resources. Don't provide it for these jobs.
        :param Sequence['JobDefinitionTmpfs'] tmpfs: The container path, mount options, and size of the `tmpfs` mount.
...
class JobDefinitionLogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionSecret'] secret_options: An object that represents the secret to expose to your container. Secrets can be exposed to a container in the following ways:
...
class JobDefinitionNodeProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionNodeRangeProperty'] node_range_properties: This is an object that represents the properties of the node range for a multi-node parallel job.
...
class JobDefinitionNodeRangeProperty(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'JobDefinitionContainerProperties' container: Container properties are used for Amazon ECS based job definitions. These properties to describe the container that's launched as part of a job.
        :param 'JobDefinitionEcsProperties' ecs_properties: An object that contains the properties for the Amazon ECS resources of a job.
...
class JobDefinitionPodProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['JobDefinitionEksContainer'] containers: EKS container properties are used in job definitions for Amazon EKS based job definitions to describe the properties for a container node in the pod that's launched as part of a job. This can't be specified for Amazon ECS based job definitions.
        ...
        :param Sequence['JobDefinitionImagePullSecret'] image_pull_secrets: References a Kubernetes secret resource. This name of the secret must start and end with an alphanumeric character, is required to be lowercase, can include periods (.) and hyphens (-), and can't contain more than 253 characters.
        ...
        :param Sequence['JobDefinitionEksVolume'] volumes: Specifies an Amazon EKS volume for a job definition.
        """
        if containers is not None:
            pulumi.set(__self__, "containers", containers)
...
class JobDefinitionRetryStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionEvaluateOnExit'] evaluate_on_exit: Specifies an array of up to 5 conditions to be met, and an action to take ( `RETRY` or `EXIT` ) if all conditions are met. If none of the `EvaluateOnExit` conditions in a `RetryStrategy` match, then the job is retried.
        """
...
class JobDefinitionTaskContainerProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['JobDefinitionTaskContainerDependency'] depends_on: A list of containers that this task depends on.
