...
class SchedulingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SchedulingPolicyFairsharePolicyArgs'] fairshare_policy: The fair share policy for a scheduling policy.
...
class SchedulingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['SchedulingPolicyFairsharePolicyArgs']] fairshare_policy: The fair share policy for a scheduling policy.
        :param pulumi.Input[str] name: Name of Scheduling Policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A key-value pair to associate with a resource.
        """
        ...
