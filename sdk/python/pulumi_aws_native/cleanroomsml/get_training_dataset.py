...
class GetTrainingDatasetResult:
    ...
    def training_dataset_arn(self) -> Optional[_builtins.str]:
        """
...
def get_training_dataset(training_dataset_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str training_dataset_arn: The Amazon Resource Name (ARN) of the training dataset.
    """
    __args__ = dict()
