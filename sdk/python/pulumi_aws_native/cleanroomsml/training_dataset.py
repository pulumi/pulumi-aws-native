...
class TrainingDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM role that Clean Rooms ML can assume to read the data referred to in the `dataSource` field of each dataset.
        ...
        :param pulumi.Input[builtins.str] description: The description of the training dataset.
        :param pulumi.Input[builtins.str] name: The name of the training dataset.
...
class TrainingDataset(pulumi.CustomResource):
    ...
    def training_dataset_arn(self) -> pulumi.Output[builtins.str]:
        """
