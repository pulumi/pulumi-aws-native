...
class FieldAttributesArgsDict(TypedDict):
    ...
    """
    text: NotRequired[pulumi.Input[Optional['FieldTextAttributesArgsDict']]]
...
class LayoutBasicLayoutArgsDict(TypedDict):
    ...
    """
    more_info: NotRequired[pulumi.Input[Optional['LayoutSectionsArgsDict']]]
    top_panel: NotRequired[pulumi.Input[Optional['LayoutSectionsArgsDict']]]
...
class LayoutSectionsArgsDict(TypedDict):
    ...
    """
    sections: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LayoutSectionPropertiesArgsDict']]]]]
    """
