...
@pulumi.type_token("aws-native:ecr:PullTimeUpdateExclusion")
class PullTimeUpdateExclusion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["principalArn"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(PullTimeUpdateExclusion, __self__).__init__(
            'aws-native:ecr:PullTimeUpdateExclusion',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PullTimeUpdateExclusion':
        """
