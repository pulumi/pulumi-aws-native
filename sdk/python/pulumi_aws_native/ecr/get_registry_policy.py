...
def get_registry_policy(registry_id: Optional[builtins.str] = None,
    ...
    :param builtins.str registry_id: The account ID of the private registry the policy is associated with.
    """
    __args__ = dict()
...
def get_registry_policy_output(registry_id: Optional[pulumi.Input[builtins.str]] = None,
