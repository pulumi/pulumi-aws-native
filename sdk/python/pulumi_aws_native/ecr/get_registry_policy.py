...
def get_registry_policy(registry_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str registry_id: The account ID of the private registry the policy is associated with.
    """
    __args__ = dict()
