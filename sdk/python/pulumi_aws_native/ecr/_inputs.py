...
class ReplicationConfigurationReplicationRuleArgsDict(TypedDict):
    ...
    An array of objects representing the destination for a replication rule.
    """
    repository_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ReplicationConfigurationRepositoryFilterArgs']]]]]
    """
...
class SigningConfigurationRuleArgsDict(TypedDict):
    ...
    """
    repository_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SigningConfigurationRepositoryFilterArgs']]]]]
    """
