...
class ReplicationConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 replication_configuration: pulumi.Input[Optional[Union['ReplicationConfigurationArgs', 'ReplicationConfigurationArgsDict', 'outputs.ReplicationConfiguration']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ReplicationConfigurationArgs', 'ReplicationConfigurationArgsDict', 'outputs.ReplicationConfiguration']] replication_configuration: The replication configuration for a registry.
        """
        ...
    @overload
    def __init__(__self__,
