...
class PermissionsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-resource.html
        :param 'PermissionsDataLocationResource' data_location_resource: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-resource.html#cfn-lakeformation-permissions-resource-datalocationresource
        :param 'PermissionsDatabaseResource' database_resource: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-resource.html#cfn-lakeformation-permissions-resource-databaseresource
        :param 'PermissionsTableResource' table_resource: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-resource.html#cfn-lakeformation-permissions-resource-tableresource
        :param 'PermissionsTableWithColumnsResource' table_with_columns_resource: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-resource.html#cfn-lakeformation-permissions-resource-tablewithcolumnsresource
        """
...
class PermissionsTableResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PermissionsTableWildcard' table_wildcard: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-tableresource.html#cfn-lakeformation-permissions-tableresource-tablewildcard
        """
        if catalog_id is not None:
            pulumi.set(__self__, "catalog_id", catalog_id)
...
class PermissionsTableWithColumnsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PermissionsColumnWildcard' column_wildcard: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lakeformation-permissions-tablewithcolumnsresource.html#cfn-lakeformation-permissions-tablewithcolumnsresource-columnwildcard
