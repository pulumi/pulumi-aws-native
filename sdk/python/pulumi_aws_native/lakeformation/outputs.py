...
class PrincipalPermissionsTableWithColumnsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] column_names: The list of column names for the table. At least one of ``ColumnNames`` or ``ColumnWildcard`` is required.
...
class TagAssociationDatabaseResource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str catalog_id: The identifier for the Data Catalog . By default, it should be the account ID of the caller.
        :param _builtins.str name: The name of the database resource. Unique to the Data Catalog.
        """
        pulumi.set(__self__, "catalog_id", catalog_id)
        pulumi.set(__self__, "name", name)
...
class TagAssociationTableWithColumnsResource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str catalog_id: A wildcard object representing every table under a database.
