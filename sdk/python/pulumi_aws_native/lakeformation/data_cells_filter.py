...
class DataCellsFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_name: The name of the Database that the Table resides in.
        :param pulumi.Input[builtins.str] table_catalog_id: The Catalog Id of the Table on which to create a Data Cells Filter.
        :param pulumi.Input[builtins.str] table_name: The name of the Table to create a Data Cells Filter for.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] column_names: A list of columns to be included in this Data Cells Filter.
        ...
        :param pulumi.Input[builtins.str] name: The desired name of the Data Cells Filter.
...
class DataCellsFilter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="columnNames")
    def column_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of columns to be included in this Data Cells Filter.
        """
        return pulumi.get(self, "column_names")
    ...
    @property
    @pulumi.getter(name="tableCatalogId")
    def table_catalog_id(self) -> pulumi.Output[builtins.str]:
        """
        The Catalog Id of the Table on which to create a Data Cells Filter.
        """
        return pulumi.get(self, "table_catalog_id")
