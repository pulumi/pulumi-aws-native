...
class Permissions(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PermissionsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PermissionsPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PermissionsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PermissionsProperties']:
        """
