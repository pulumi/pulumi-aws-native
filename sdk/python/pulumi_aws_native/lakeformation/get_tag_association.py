...
class GetTagAssociationResult:
    ...
    def tags_identifier(self) -> Optional[builtins.str]:
        """
...
def get_tag_association(resource_identifier: Optional[builtins.str] = None,
                        tags_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_identifier: Unique string identifying the resource. Used as primary identifier, which ideally should be a string
    :param builtins.str tags_identifier: Unique string identifying the resource's tags. Used as primary identifier, which ideally should be a string
    """
    __args__ = dict()
...
def get_tag_association_output(resource_identifier: Optional[pulumi.Input[builtins.str]] = None,
                               tags_identifier: Optional[pulumi.Input[builtins.str]] = None,
