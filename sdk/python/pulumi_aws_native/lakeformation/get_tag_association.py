...
class GetTagAssociationResult:
    ...
    def tags_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_tag_association(resource_identifier: Optional[_builtins.str] = None,
                        tags_identifier: Optional[_builtins.str] = None,
