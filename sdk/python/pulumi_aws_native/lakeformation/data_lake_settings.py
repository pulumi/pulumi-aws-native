...
class DataLakeSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(admins, DataLakeSettingsAdminsArgs):
                admins = admins or {}
                def _setter(key, value):
                    admins[key] = value
            ...
            if not isinstance(create_database_default_permissions, DataLakeSettingsCreateDatabaseDefaultPermissionsArgs):
            ...
            if not isinstance(create_table_default_permissions, DataLakeSettingsCreateTableDefaultPermissionsArgs):
            ...
            if not isinstance(external_data_filtering_allow_list, DataLakeSettingsExternalDataFilteringAllowListArgs):
