...
class PrincipalPermissionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] catalog: The identifier for the GLUDC. By default, the account ID. The GLUDC is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment.
        """
...
class PrincipalPermissions(pulumi.CustomResource):
    ...
    def principal_identifier(self) -> pulumi.Output[builtins.str]:
        """
