...
class PrincipalPermissionsResourceArgsDict(TypedDict):
    ...
    """
    catalog: NotRequired[pulumi.Input[Optional['PrincipalPermissionsCatalogResourceArgsDict']]]
    """
    ...
    """
    data_cells_filter: NotRequired[pulumi.Input[Optional['PrincipalPermissionsDataCellsFilterResourceArgsDict']]]
    """
    A data cell filter.
    """
    data_location: NotRequired[pulumi.Input[Optional['PrincipalPermissionsDataLocationResourceArgsDict']]]
    """
    The location of an Amazon S3 path where permissions are granted or revoked.
    """
    database: NotRequired[pulumi.Input[Optional['PrincipalPermissionsDatabaseResourceArgsDict']]]
    """
    The database for the resource. Unique to the Data Catalog. A database is a set of associated table definitions organized into a logical group. You can Grant and Revoke database permissions to a principal.
    """
    lf_tag: NotRequired[pulumi.Input[Optional['PrincipalPermissionsLfTagKeyResourceArgsDict']]]
    """
    The LF-tag key and values attached to a resource.
    """
    lf_tag_policy: NotRequired[pulumi.Input[Optional['PrincipalPermissionsLfTagPolicyResourceArgsDict']]]
    """
    A list of LF-tag conditions that define a resource's LF-tag policy.
    """
    table: NotRequired[pulumi.Input[Optional['PrincipalPermissionsTableResourceArgsDict']]]
    """
    The table for the resource. A table is a metadata definition that represents your data. You can Grant and Revoke table privileges to a principal.
    """
    table_with_columns: NotRequired[pulumi.Input[Optional['PrincipalPermissionsTableWithColumnsResourceArgsDict']]]
    """
...
class PrincipalPermissionsTableResourceArgsDict(TypedDict):
    ...
    The name of the table.
    """
    table_wildcard: NotRequired[pulumi.Input[Optional['PrincipalPermissionsTableWildcardArgsDict']]]
    """
...
class PrincipalPermissionsTableWithColumnsResourceArgsDict(TypedDict):
    ...
    """
    column_wildcard: NotRequired[pulumi.Input[Optional['PrincipalPermissionsColumnWildcardArgsDict']]]
    """
...
class PrincipalPermissionsTableWithColumnsResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] column_names: The list of column names for the table. At least one of ``ColumnNames`` or ``ColumnWildcard`` is required.
...
class TagAssociationDatabaseResourceArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] catalog_id: The identifier for the Data Catalog . By default, it should be the account ID of the caller.
        :param pulumi.Input[_builtins.str] name: The name of the database resource. Unique to the Data Catalog.
        """
        pulumi.set(__self__, "catalog_id", catalog_id)
        pulumi.set(__self__, "name", name)
...
class TagAssociationResourceArgsDict(TypedDict):
    catalog: NotRequired[pulumi.Input[Optional['TagAssociationCatalogResourceArgsDict']]]
    """
    The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your AWS Lake Formation environment.
    """
    database: NotRequired[pulumi.Input[Optional['TagAssociationDatabaseResourceArgsDict']]]
    """
    The database for the resource. Unique to the Data Catalog. A database is a set of associated table definitions organized into a logical group. You can Grant and Revoke database permissions to a principal.
    """
    table: NotRequired[pulumi.Input[Optional['TagAssociationTableResourceArgsDict']]]
    """
    The table for the resource. A table is a metadata definition that represents your data. You can Grant and Revoke table privileges to a principal.
    """
    table_with_columns: NotRequired[pulumi.Input[Optional['TagAssociationTableWithColumnsResourceArgsDict']]]
    """
    The table with columns for the resource. A principal with permissions to this resource can select metadata from the columns of a table in the Data Catalog and the underlying data in Amazon S3.
    """
...
class TagAssociationTableResourceArgsDict(TypedDict):
    ...
    The name of the table.
    """
    table_wildcard: NotRequired[pulumi.Input[Optional['TagAssociationTableWildcardArgsDict']]]
    """
...
class TagAssociationTableWithColumnsResourceArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] catalog_id: A wildcard object representing every table under a database.
