...
class StreamingImageArgs:
    def __init__(__self__, *,
                 ec2_image_id: pulumi.Input[builtins.str],
                 studio_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_configuration_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_configuration_key_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @ec2_image_id.setter
    def ec2_image_id(self, value: pulumi.Input[builtins.str]):
    ...
    def encryption_configuration_key_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "encryption_configuration_key_arn")

    @encryption_configuration_key_arn.setter
    def encryption_configuration_key_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encryption_configuration_key_arn", value)

    @property
    @pulumi.getter(name="encryptionConfigurationKeyType")
    def encryption_configuration_key_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "encryption_configuration_key_type")

    @encryption_configuration_key_type.setter
    def encryption_configuration_key_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamingImage(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ec2_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_configuration_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_configuration_key_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="encryptionConfigurationKeyArn")
    def encryption_configuration_key_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "encryption_configuration_key_arn")

    @property
    @pulumi.getter(name="encryptionConfigurationKeyType")
    def encryption_configuration_key_type(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "encryption_configuration_key_type")
