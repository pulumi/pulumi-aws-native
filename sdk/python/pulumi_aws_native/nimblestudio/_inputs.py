...
class LaunchProfileStreamConfigurationSessionStorageArgsDict(TypedDict):
    ...
    root: NotRequired[pulumi.Input[Optional['LaunchProfileStreamingSessionStorageRootArgsDict']]]
...
class LaunchProfileStreamConfigurationArgsDict(TypedDict):
    ...
    session_backup: NotRequired[pulumi.Input[Optional['LaunchProfileStreamConfigurationSessionBackupArgsDict']]]
    session_persistence_mode: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    session_storage: NotRequired[pulumi.Input[Optional['LaunchProfileStreamConfigurationSessionStorageArgsDict']]]
    volume_configuration: NotRequired[pulumi.Input[Optional['LaunchProfileVolumeConfigurationArgsDict']]]
...
class StudioComponentActiveDirectoryConfigurationArgsDict(TypedDict):
    computer_attributes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StudioComponentActiveDirectoryComputerAttributeArgsDict']]]]]
...
class StudioComponentConfigurationArgsDict(TypedDict):
    active_directory_configuration: NotRequired[pulumi.Input[Optional['StudioComponentActiveDirectoryConfigurationArgsDict']]]
    compute_farm_configuration: NotRequired[pulumi.Input[Optional['StudioComponentComputeFarmConfigurationArgsDict']]]
    license_service_configuration: NotRequired[pulumi.Input[Optional['StudioComponentLicenseServiceConfigurationArgsDict']]]
    shared_file_system_configuration: NotRequired[pulumi.Input[Optional['StudioComponentSharedFileSystemConfigurationArgsDict']]]
