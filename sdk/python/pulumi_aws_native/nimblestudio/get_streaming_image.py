...
class GetStreamingImageResult:
    ...
    def encryption_configuration_key_arn(self) -> Optional[builtins.str]:
        return pulumi.get(self, "encryption_configuration_key_arn")

    @property
    @pulumi.getter(name="encryptionConfigurationKeyType")
    def encryption_configuration_key_type(self) -> Optional[builtins.str]:
...
def get_streaming_image(streaming_image_id: Optional[builtins.str] = None,
...
def get_streaming_image_output(streaming_image_id: Optional[pulumi.Input[builtins.str]] = None,
