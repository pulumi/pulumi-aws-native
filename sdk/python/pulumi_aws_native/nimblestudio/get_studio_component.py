...
def get_studio_component(studio_component_id: Optional[builtins.str] = None,
...
def get_studio_component_output(studio_component_id: Optional[pulumi.Input[builtins.str]] = None,
