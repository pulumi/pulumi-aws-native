...
class GetStudioComponentResult:
    ...
    def ec2_security_group_ids(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def studio_component_id(self) -> Optional[_builtins.str]:
...
def get_studio_component(studio_component_id: Optional[_builtins.str] = None,
