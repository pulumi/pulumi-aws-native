...
class LaunchProfileStreamConfiguration(dict):
    ...
    def _configure(
             ...
             clipboard_mode: Optional['LaunchProfileStreamingClipboardMode'] = None,
             ec2_instance_types: Optional[Sequence['LaunchProfileStreamingInstanceType']] = None,
             streaming_image_ids: Optional[Sequence[str]] = None,
             automatic_termination_mode: Optional['LaunchProfileAutomaticTerminationMode'] = None,
             max_session_length_in_minutes: Optional[float] = None,
             max_stopped_session_length_in_minutes: Optional[float] = None,
             session_backup: Optional['outputs.LaunchProfileStreamConfigurationSessionBackup'] = None,
...
class StreamingImageEncryptionConfiguration(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             key_type: Optional['StreamingImageEncryptionConfigurationKeyType'] = None,
             key_arn: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class StudioEncryptionConfiguration(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             key_type: Optional['StudioEncryptionConfigurationKeyType'] = None,
             key_arn: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if key_type is None and 'keyType' in kwargs:
