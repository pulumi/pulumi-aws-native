...
def get_sampling_rule(rule_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSamplingRuleResult:
    """
    This schema provides construct and validation rules for AWS-XRay SamplingRule resource parameters.


    :param builtins.str rule_arn: The sampling rule ARN that was created or updated.
    """
    __args__ = dict()
...
def get_sampling_rule_output(rule_arn: Optional[pulumi.Input[builtins.str]] = None,
