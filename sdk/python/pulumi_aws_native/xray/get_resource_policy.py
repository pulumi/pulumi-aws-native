...
def get_resource_policy(policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_name: The name of the resource policy. Must be unique within a specific AWS account.
    """
    __args__ = dict()
