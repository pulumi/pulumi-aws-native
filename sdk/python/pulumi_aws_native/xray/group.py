...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] filter_expression: The filter expression defining criteria by which to group traces.
        :param pulumi.Input[builtins.str] group_name: The case-sensitive name of the new group. Names must be unique.
...
@pulumi.type_token("aws-native:xray:Group")
class Group(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="filterExpression")
    def filter_expression(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The filter expression defining criteria by which to group traces.
        """
        return pulumi.get(self, "filter_expression")
