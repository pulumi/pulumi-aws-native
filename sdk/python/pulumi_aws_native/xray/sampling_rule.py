...
class SamplingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(sampling_rule, SamplingRuleArgs):
            ...
            if not isinstance(sampling_rule_record, SamplingRuleRecordArgs):
            ...
            if not isinstance(sampling_rule_update, SamplingRuleUpdateArgs):
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["sampling_rule.version", "sampling_rule_record.sampling_rule.version"])
