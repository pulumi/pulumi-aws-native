...
def get_group(group_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupResult:
    """
    This schema provides construct and validation rules for AWS-XRay Group resource parameters.


    :param builtins.str group_arn: The ARN of the group that was generated on creation.
    """
    __args__ = dict()
...
def get_group_output(group_arn: Optional[pulumi.Input[builtins.str]] = None,
