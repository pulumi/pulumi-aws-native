...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_document: The resource policy document, which can be up to 5kb in size.
        :param pulumi.Input[builtins.bool] bypass_policy_lockout_check: A flag to indicate whether to bypass the resource policy lockout safety check
        :param pulumi.Input[builtins.str] policy_name: The name of the resource policy. Must be unique within a specific AWS account.
        """
