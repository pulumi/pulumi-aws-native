...
class SamplingRuleRecordArgsDict(TypedDict):
    ...
    """
    sampling_rule: NotRequired[pulumi.Input[Optional['SamplingRuleArgs']]]
...
class SamplingRuleUpdateArgsDict(TypedDict):
    ...
    sampling_rate_boost: NotRequired[pulumi.Input[Optional['SamplingRuleSamplingRateBoostArgs']]]
