...
class GroupInsightsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 insights_enabled: Optional[builtins.bool] = None,
                 notifications_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool insights_enabled: Set the InsightsEnabled value to true to enable insights or false to disable insights.
        :param builtins.bool notifications_enabled: Set the NotificationsEnabled value to true to enable insights notifications. Notifications can only be enabled on a group with InsightsEnabled set to true.
        """
    ...
    def insights_enabled(self) -> Optional[builtins.bool]:
        """
...
class SamplingRule(dict):
    ...
    def __init__(__self__, *,
                 fixed_rate: builtins.float,
                 host: builtins.str,
                 http_method: builtins.str,
                 priority: builtins.int,
                 reservoir_size: builtins.int,
                 resource_arn: builtins.str,
                 service_name: builtins.str,
                 service_type: builtins.str,
                 url_path: builtins.str,
                 attributes: Optional[Mapping[str, builtins.str]] = None,
                 rule_arn: Optional[builtins.str] = None,
                 rule_name: Optional[builtins.str] = None,
                 version: Optional[builtins.int] = None):
        """
        :param builtins.float fixed_rate: The percentage of matching requests to instrument, after the reservoir is exhausted.
        :param builtins.str host: Matches the hostname from a request URL.
        :param builtins.str http_method: Matches the HTTP method from a request URL.
        :param builtins.int priority: The priority of the sampling rule.
        :param builtins.int reservoir_size: A fixed number of matching requests to instrument per second, prior to applying the fixed rate. The reservoir is not used directly by services, but applies to all services using the rule collectively.
        :param builtins.str resource_arn: Matches the ARN of the AWS resource on which the service runs.
        :param builtins.str service_name: Matches the name that the service uses to identify itself in segments.
        :param builtins.str service_type: Matches the origin that the service uses to identify its type in segments.
        :param builtins.str url_path: Matches the path from a request URL.
        :param Mapping[str, builtins.str] attributes: Matches attributes derived from the request.
        :param builtins.str rule_arn: The ARN of the sampling rule. Specify a rule by either name or ARN, but not both.
               
               > Specifying a sampling rule by name is recommended, as specifying by ARN will be deprecated in future.
        :param builtins.str rule_name: The name of the sampling rule. Specify a rule by either name or ARN, but not both.
        :param builtins.int version: The version of the sampling rule format (1)
        """
    ...
    def reservoir_size(self) -> builtins.int:
        """
...
class SamplingRuleRecord(dict):
    ...
    def __init__(__self__, *,
                 ...
                 modified_at: Optional[builtins.str] = None,
                 sampling_rule: Optional['outputs.SamplingRule'] = None):
        """
        :param builtins.str created_at: When the rule was created, in Unix time seconds.
        :param builtins.str modified_at: When the rule was modified, in Unix time seconds.
        """
...
class SamplingRuleUpdate(dict):
    ...
    def __init__(__self__, *,
                 attributes: Optional[Mapping[str, builtins.str]] = None,
                 fixed_rate: Optional[builtins.float] = None,
                 host: Optional[builtins.str] = None,
                 http_method: Optional[builtins.str] = None,
                 priority: Optional[builtins.int] = None,
                 reservoir_size: Optional[builtins.int] = None,
    ...
    @property
    @pulumi.getter(name="fixedRate")
    def fixed_rate(self) -> Optional[builtins.float]:
        """
        The percentage of matching requests to instrument, after the reservoir is exhausted.
        """
        return pulumi.get(self, "fixed_rate")
    ...
    @property
    @pulumi.getter(name="reservoirSize")
    def reservoir_size(self) -> Optional[builtins.int]:
        """
        A fixed number of matching requests to instrument per second, prior to applying the fixed rate. The reservoir is not used directly by services, but applies to all services using the rule collectively.
        """
        return pulumi.get(self, "reservoir_size")
