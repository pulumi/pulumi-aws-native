...
def get_code_security_scan_configuration(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Code Security Scan Configuration ARN
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_code_security_scan_configuration_output(arn: Optional[pulumi.Input[builtins.str]] = None,
