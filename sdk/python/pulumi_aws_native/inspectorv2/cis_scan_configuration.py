...
class CisScanConfigurationArgs:
    def __init__(__self__, *,
                 scan_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] scan_name: Name of the scan
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The CIS scan configuration's tags.
        """
    ...
    def scan_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the scan
        """
    ...
    @scan_name.setter
    def scan_name(self, value: pulumi.Input[builtins.str]):
...
class CisScanConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 scan_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="scanName")
    def scan_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the scan
        """
        return pulumi.get(self, "scan_name")
