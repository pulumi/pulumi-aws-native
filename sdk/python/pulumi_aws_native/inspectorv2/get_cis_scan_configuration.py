...
class GetCisScanConfigurationResult:
    ...
    def scan_name(self) -> Optional[_builtins.str]:
        """
        Name of the scan
        """
...
def get_cis_scan_configuration(arn: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCisScanConfigurationResult:
    """
    CIS Scan Configuration resource schema


    :param _builtins.str arn: CIS Scan configuration unique identifier
    """
    __args__ = dict()
    __args__['arn'] = arn
