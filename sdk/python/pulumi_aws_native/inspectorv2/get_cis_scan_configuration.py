...
class GetCisScanConfigurationResult:
    ...
    def scan_name(self) -> Optional[builtins.str]:
        """
        Name of the scan
        """
...
def get_cis_scan_configuration(arn: Optional[builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCisScanConfigurationResult:
    """
    CIS Scan Configuration resource schema


    :param builtins.str arn: CIS Scan configuration unique identifier
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_cis_scan_configuration_output(arn: Optional[pulumi.Input[builtins.str]] = None,
