...
class GetHubResult:
    ...
    def auto_enable_controls(self) -> Optional[builtins.bool]:
        """
    ...
    def control_finding_generator(self) -> Optional[builtins.str]:
        """
...
def get_hub(arn: Optional[builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHubResult:
    """
    The AWS::SecurityHub::Hub resource represents the implementation of the AWS Security Hub service in your account. One hub resource is created for each Region in which you enable Security Hub.


    :param builtins.str arn: An ARN is automatically created for the customer.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_hub_output(arn: Optional[pulumi.Input[builtins.str]] = None,
