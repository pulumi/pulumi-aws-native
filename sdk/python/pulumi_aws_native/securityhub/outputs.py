...
class AutomationRuleDateFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str end: A timestamp that provides the end date for the date filter.
        ...
        :param builtins.str start: A timestamp that provides the start date for the date filter.
                For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
        """
...
class AutomationRuleMapFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: The value for the key in the map filter. Filter values are case sensitive. For example, one of the values for a tag called ``Department`` might be ``Security``. If you provide ``security`` as the filter value, then there's no match.
        """
...
class AutomationRuleRelatedFinding(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str product_arn: The Amazon Resource Name (ARN) for the product that generated a related finding.
        """
...
class AutomationRuleSeverityUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 normalized: Optional[builtins.int] = None,
        ...
        :param builtins.int normalized: The normalized severity for the finding. This attribute is to be deprecated in favor of ``Label``.
    ...
    @property
    @pulumi.getter
    def normalized(self) -> Optional[builtins.int]:
        """
...
class AutomationRuleV2CompositeFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'AutomationRuleV2AllowedOperators' operator: The logical operator used to combine multiple filter conditions.
...
class ConfigurationPolicyParameterValue(dict):
    ...
    def __init__(__self__, *,
                 boolean: Optional[builtins.bool] = None,
                 double: Optional[builtins.float] = None,
                 enum: Optional[builtins.str] = None,
                 enum_list: Optional[Sequence[builtins.str]] = None,
                 integer: Optional[builtins.int] = None,
                 integer_list: Optional[Sequence[builtins.int]] = None,
                 string: Optional[builtins.str] = None,
                 string_list: Optional[Sequence[builtins.str]] = None):
        """
        An object that includes the data type of a security control parameter and its current value.
        :param builtins.bool boolean: A control parameter that is a boolean.
        :param builtins.float double: A control parameter that is a double.
        :param builtins.str enum: A control parameter that is an enum.
        :param Sequence[builtins.str] enum_list: A control parameter that is a list of enums.
        :param builtins.int integer: A control parameter that is an integer.
        :param Sequence[builtins.int] integer_list: A control parameter that is a list of integers.
        :param builtins.str string: A control parameter that is a string.
        :param Sequence[builtins.str] string_list: A control parameter that is a list of strings.
        """
    ...
    @property
    @pulumi.getter
    def boolean(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def double(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def enum(self) -> Optional[builtins.str]:
        """
    ...
    def enum_list(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def integer(self) -> Optional[builtins.int]:
        """
    ...
    def integer_list(self) -> Optional[Sequence[builtins.int]]:
        """
...
class ConfigurationPolicySecurityControlCustomParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str security_control_id: The ID of the security control.
        """
    ...
    def security_control_id(self) -> Optional[builtins.str]:
        """
...
class ConfigurationPolicySecurityControlsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 disabled_security_control_identifiers: Optional[Sequence[builtins.str]] = None,
                 enabled_security_control_identifiers: Optional[Sequence[builtins.str]] = None,
                 security_control_custom_parameters: Optional[Sequence['outputs.ConfigurationPolicySecurityControlCustomParameter']] = None):
        """
        An object that defines which security controls are enabled in an AWS Security Hub configuration policy.
        :param Sequence[builtins.str] disabled_security_control_identifiers: A list of security controls that are disabled in the configuration policy
        :param Sequence[builtins.str] enabled_security_control_identifiers: A list of security controls that are enabled in the configuration policy.
    ...
    def disabled_security_control_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enabled_security_control_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConfigurationPolicySecurityHubPolicy(dict):
    ...
    def __init__(__self__, *,
                 enabled_standard_identifiers: Optional[Sequence[builtins.str]] = None,
                 security_controls_configuration: Optional['outputs.ConfigurationPolicySecurityControlsConfiguration'] = None,
                 service_enabled: Optional[builtins.bool] = None):
        """
        An object that defines how AWS Security Hub is configured.
        :param Sequence[builtins.str] enabled_standard_identifiers: A list that defines which security standards are enabled in the configuration policy.
    ...
    def enabled_standard_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SecurityControlParameterValue(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool boolean: A control parameter that is a boolean.
        :param builtins.float double: A control parameter that is a double.
        :param builtins.str enum: A control parameter that is a enum.
        :param Sequence[builtins.str] enum_list: A control parameter that is a list of enums.
        :param builtins.int integer: A control parameter that is a integer.
        :param Sequence[builtins.int] integer_list: A control parameter that is a list of integers.
        :param builtins.str string: A control parameter that is a string.
        :param Sequence[builtins.str] string_list: A control parameter that is a list of strings.
        """
...
class StandardsControl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides details about an individual security control. For a list of ASH controls, see [controls reference](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-controls-reference.html) in the *User Guide*.
        :param builtins.str standards_control_arn: The Amazon Resource Name (ARN) of the control.
        :param builtins.str reason: A user-defined reason for changing a control's enablement status in a specified standard. If you are disabling a control, then this property is required.
        """
