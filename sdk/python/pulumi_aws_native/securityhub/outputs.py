...
class AutomationRuleDateFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start: A timestamp that provides the start date for the date filter.
                For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
        """
...
class AutomationRuleSeverityUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 normalized: Optional[_builtins.int] = None,
        ...
        :param _builtins.int normalized: The normalized severity for the finding. This attribute is to be deprecated in favor of ``Label``.
    ...
    @_builtins.property
    @pulumi.getter
    def normalized(self) -> Optional[_builtins.int]:
        """
...
class ConfigurationPolicyParameterValue(dict):
    ...
    def __init__(__self__, *,
                 ...
                 double: Optional[_builtins.float] = None,
                 enum: Optional[_builtins.str] = None,
                 enum_list: Optional[Sequence[_builtins.str]] = None,
                 integer: Optional[_builtins.int] = None,
                 integer_list: Optional[Sequence[_builtins.int]] = None,
        ...
        :param Sequence[_builtins.str] enum_list: A control parameter that is a list of enums.
        :param _builtins.int integer: A control parameter that is an integer.
        :param Sequence[_builtins.int] integer_list: A control parameter that is a list of integers.
        :param _builtins.str string: A control parameter that is a string.
        :param Sequence[_builtins.str] string_list: A control parameter that is a list of strings.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def double(self) -> Optional[_builtins.float]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def enum(self) -> Optional[_builtins.str]:
        """
    ...
    def enum_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def integer_list(self) -> Optional[Sequence[_builtins.int]]:
        """
...
class ConfigurationPolicySecurityControlCustomParameter(dict):
    ...
    def security_control_id(self) -> Optional[_builtins.str]:
        """
...
class ConfigurationPolicySecurityControlsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 disabled_security_control_identifiers: Optional[Sequence[_builtins.str]] = None,
                 enabled_security_control_identifiers: Optional[Sequence[_builtins.str]] = None,
    ...
    def disabled_security_control_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def enabled_security_control_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConfigurationPolicySecurityHubPolicy(dict):
    ...
    def __init__(__self__, *,
                 enabled_standard_identifiers: Optional[Sequence[_builtins.str]] = None,
    ...
    def enabled_standard_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class SecurityControlParameterConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'SecurityControlParameterConfigurationValueType' value_type: Identifies whether a control parameter uses a custom user-defined value or subscribes to the default AWS Security Hub CSPM behavior.
...
class SecurityControlParameterValue(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool boolean: A control parameter that is a boolean.
        :param _builtins.float double: A control parameter that is a double.
        :param _builtins.str enum: A control parameter that is a enum.
        :param Sequence[_builtins.str] enum_list: A control parameter that is a list of enums.
        :param _builtins.int integer: A control parameter that is a integer.
        :param Sequence[_builtins.int] integer_list: A control parameter that is a list of integers.
        :param _builtins.str string: A control parameter that is a string.
        :param Sequence[_builtins.str] string_list: A control parameter that is a list of strings.
        """
...
class StandardsControl(dict):
    ...
    def __init__(__self__, *,
                 standards_control_arn: _builtins.str,
    ...
    def standards_control_arn(self) -> _builtins.str:
        """
