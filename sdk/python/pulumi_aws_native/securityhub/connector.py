...
class ConnectorArgs:
    def __init__(__self__, *,
                 provider: pulumi.Input['ConnectorProviderArgs'],
    ...
    @_builtins.property
    @pulumi.getter
    def provider(self) -> pulumi.Input['ConnectorProviderArgs']:
        return pulumi.get(self, "provider")

    @provider.setter
    def provider(self, value: pulumi.Input['ConnectorProviderArgs']):
...
@pulumi.type_token("aws-native:securityhub:Connector")
class Connector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 provider: Optional[pulumi.Input[Union['ConnectorProviderArgs', 'ConnectorProviderArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["name", "provider.azure.awsConfigConnectorArn"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(Connector, __self__).__init__(
            'aws-native:securityhub:Connector',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def provider(self) -> pulumi.Output['outputs.ConnectorProvider']:
        return pulumi.get(self, "provider")
