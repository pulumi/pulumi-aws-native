...
class GetAutomationRuleResult:
    ...
    def is_terminal(self) -> Optional[builtins.bool]:
        """
    ...
    def rule_order(self) -> Optional[builtins.int]:
        """
...
def get_automation_rule(rule_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_arn: The Amazon Resource Name (ARN) of the automation rule that you create. For example, `arn:aws:securityhub:us-east-1:123456789012:automation-rule/a1b2c3d4-5678-90ab-cdef-EXAMPLE11111` .
    """
    __args__ = dict()
...
def get_automation_rule_output(rule_arn: Optional[pulumi.Input[builtins.str]] = None,
