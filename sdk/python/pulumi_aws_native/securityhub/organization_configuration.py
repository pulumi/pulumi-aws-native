...
class OrganizationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_enable: Whether to automatically enable Security Hub in new member accounts when they join the organization.
...
@pulumi.type_token("aws-native:securityhub:OrganizationConfiguration")
class OrganizationConfiguration(pulumi.CustomResource):
    ...
    def member_account_limit_reached(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def organization_configuration_identifier(self) -> pulumi.Output[builtins.str]:
        """
