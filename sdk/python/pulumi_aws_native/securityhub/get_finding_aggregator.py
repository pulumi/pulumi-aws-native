...
class GetFindingAggregatorResult:
    ...
    def finding_aggregation_region(self) -> Optional[builtins.str]:
        """
    ...
    def finding_aggregator_arn(self) -> Optional[builtins.str]:
        """
...
def get_finding_aggregator(finding_aggregator_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str finding_aggregator_arn: The ARN of the finding aggregator. You use the finding aggregator ARN to retrieve details for, update, and delete the finding aggregator.
    """
    __args__ = dict()
...
def get_finding_aggregator_output(finding_aggregator_arn: Optional[pulumi.Input[builtins.str]] = None,
