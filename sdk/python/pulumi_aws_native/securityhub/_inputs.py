...
class AutomationRuleDateFilterArgsDict(TypedDict):
    ...
    """
    date_range: NotRequired[pulumi.Input[Optional['AutomationRuleDateRangeArgsDict']]]
    """
...
class AutomationRuleMapFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutomationRuleMapFilterComparison'] comparison: The condition to apply to the key value when filtering Security Hub CSPM findings with a map filter.
                To search for values that have the filter value, use one of the following comparison operators:
                 +  To search for values that include the filter value, use ``CONTAINS``. For example, for the ``ResourceTags`` field, the filter ``Department CONTAINS Security`` matches findings that include the value ``Security`` for the ``Department`` tag. In the same example, a finding with a value of ``Security team`` for the ``Department`` tag is a match.
                 +  To search for values that exactly match the filter value, use ``EQUALS``. For example, for the ``ResourceTags`` field, the filter ``Department EQUALS Security`` matches findings that have the value ``Security`` for the ``Department`` tag.
...
class AutomationRuleStringFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutomationRuleStringFilterComparison'] comparison: The condition to apply to a string value when filtering Security Hub CSPM findings.
                To search for values that have the filter value, use one of the following comparison operators:
                 +  To search for values that include the filter value, use ``CONTAINS``. For example, the filter ``Title CONTAINS CloudFront`` matches findings that have a ``Title`` that includes the string CloudFront.
                 +  To search for values that exactly match the filter value, use ``EQUALS``. For example, the filter ``AwsAccountId EQUALS 123456789012`` only matches findings that have an account ID of ``123456789012``.
                 +  To search for values that start with the filter value, use ``PREFIX``. For example, the filter ``ResourceRegion PREFIX us`` matches findings that have a ``ResourceRegion`` that starts with ``us``. A ``ResourceRegion`` that starts with a different value, such as ``af``, ``ap``, or ``ca``, doesn't match.
...
class AutomationRuleV2AutomationRulesActionV2ArgsDict(TypedDict):
    ...
    """
    external_integration_configuration: NotRequired[pulumi.Input[Optional['AutomationRuleV2ExternalIntegrationConfigurationArgsDict']]]
    """
    The settings for integrating automation rule actions with external systems or service.
    """
    finding_fields_update: NotRequired[pulumi.Input[Optional['AutomationRuleV2AutomationRulesFindingFieldsUpdateV2ArgsDict']]]
    """
...
class AutomationRuleV2CompositeFilterArgsDict(TypedDict):
    ...
    """
    boolean_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2OcsfBooleanFilterArgsDict']]]]]
    """
    Enables filtering based on boolean field values
    """
    date_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2OcsfDateFilterArgsDict']]]]]
    """
    Enables filtering based on date and timestamp fields
    """
    map_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2OcsfMapFilterArgsDict']]]]]
    """
    Enables filtering based on map field value
    """
    number_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2OcsfNumberFilterArgsDict']]]]]
    """
    ...
    """
    string_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2OcsfStringFilterArgsDict']]]]]
    """
...
class AutomationRuleV2CriteriaArgsDict(TypedDict):
    ...
    """
    ocsf_finding_criteria: NotRequired[pulumi.Input[Optional['AutomationRuleV2OcsfFindingFiltersArgsDict']]]
    """
...
class AutomationRuleV2DateFilterArgsDict(TypedDict):
    ...
    A date filter for querying findings
    """
    date_range: NotRequired[pulumi.Input[Optional['AutomationRuleV2DateRangeArgsDict']]]
    """
    A date range for the date filter.
    """
    end: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class AutomationRuleV2OcsfFindingFiltersArgsDict(TypedDict):
    ...
    The filtering conditions that align with OCSF standards
    """
    composite_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleV2CompositeFilterArgsDict']]]]]
    """
...
class AutomationRulesActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutomationRulesActionType'] type: Specifies the type of action that Security Hub CSPM takes when a finding matches the defined criteria of a rule.
        """
        pulumi.set(__self__, "finding_fields_update", finding_fields_update)
        pulumi.set(__self__, "type", type)
...
class AutomationRulesFindingFieldsUpdateArgsDict(TypedDict):
    ...
    """
    note: NotRequired[pulumi.Input[Optional['AutomationRuleNoteUpdateArgsDict']]]
    """
    The rule action will update the ``Note`` field of a finding.
    """
    related_findings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleRelatedFindingArgsDict']]]]]
    """
    The rule action will update the ``RelatedFindings`` field of a finding.
    """
    severity: NotRequired[pulumi.Input[Optional['AutomationRuleSeverityUpdateArgsDict']]]
    """
    ...
    """
    workflow: NotRequired[pulumi.Input[Optional['AutomationRuleWorkflowUpdateArgsDict']]]
    """
...
class AutomationRulesFindingFiltersArgsDict(TypedDict):
    ...
    """
    aws_account_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The AWS-account ID in which a finding was generated.
      Array Members: Minimum number of 1 item. Maximum number of 100 items.
    """
    company_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The name of the company for the product that generated the finding. For control-based findings, the company is AWS.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    compliance_associated_standards_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The unique identifier of a standard in which a control is enabled. This field consists of the resource portion of the Amazon Resource Name (ARN) returned for a standard in the [DescribeStandards](https://docs.aws.amazon.com/securityhub/1.0/APIReference/API_DescribeStandards.html) API response.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    compliance_security_control_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The security control ID for which a finding was generated. Security control IDs are the same across standards.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    compliance_status: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The result of a security check. This field is only used for findings generated from controls.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    confidence: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleNumberFilterArgsDict']]]]]
    """
    The likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. ``Confidence`` is scored on a 0–100 basis using a ratio scale. A value of ``0`` means 0 percent confidence, and a value of ``100`` means 100 percent confidence. For example, a data exfiltration detection based on a statistical deviation of network traffic has low confidence because an actual exfiltration hasn't been verified. For more information, see [Confidence](https://docs.aws.amazon.com/securityhub/latest/userguide/asff-top-level-attributes.html#asff-confidence) in the *User Guide*.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    created_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDateFilterArgsDict']]]]]
    """
    A timestamp that indicates when this finding record was created.
     For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    criticality: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleNumberFilterArgsDict']]]]]
    """
    The level of importance that is assigned to the resources that are associated with a finding. ``Criticality`` is scored on a 0–100 basis, using a ratio scale that supports only full integers. A score of ``0`` means that the underlying resources have no criticality, and a score of ``100`` is reserved for the most critical resources. For more information, see [Criticality](https://docs.aws.amazon.com/securityhub/latest/userguide/asff-top-level-attributes.html#asff-criticality) in the *User Guide*.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    description: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    A finding's description.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    first_observed_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDateFilterArgsDict']]]]]
    """
    A timestamp that indicates when the potential security issue captured by a finding was first observed by the security findings product.
     For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    generator_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The identifier for the solution-specific component that generated a finding.
      Array Members: Minimum number of 1 item. Maximum number of 100 items.
    """
    id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The product-specific identifier for a finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    last_observed_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDateFilterArgsDict']]]]]
    """
    A timestamp that indicates when the security findings provider most recently observed a change in the resource that is involved in the finding.
     For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    note_text: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The text of a user-defined note that's added to a finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    note_updated_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDateFilterArgsDict']]]]]
    """
    The timestamp of when the note was updated.
     For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    note_updated_by: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The principal that created a note.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    product_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The Amazon Resource Name (ARN) for a third-party product that generated a finding in Security Hub CSPM.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    product_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    Provides the name of the product that generated the finding. For control-based findings, the product name is Security Hub CSPM.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    record_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    Provides the current state of a finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    related_findings_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The product-generated identifier for a related finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    related_findings_product_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The ARN for the product that generated a related finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    resource_details_other: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleMapFilterArgsDict']]]]]
    """
    Custom fields and values about the resource that a finding pertains to.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    resource_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The identifier for the given resource type. For AWS resources that are identified by Amazon Resource Names (ARNs), this is the ARN. For AWS resources that lack ARNs, this is the identifier as defined by the AWS-service that created the resource. For non-AWS resources, this is a unique identifier that is associated with the resource.
      Array Members: Minimum number of 1 item. Maximum number of 100 items.
    """
    resource_partition: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The partition in which the resource that the finding pertains to is located. A partition is a group of AWS-Regions. Each AWS-account is scoped to one partition.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    resource_region: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The AWS-Region where the resource that a finding pertains to is located.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    resource_tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleMapFilterArgsDict']]]]]
    """
    A list of AWS tags associated with a resource at the time the finding was processed.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    resource_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    A finding's title.
      Array Members: Minimum number of 1 item. Maximum number of 100 items.
    """
    severity_label: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    The severity value of the finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    source_url: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    Provides a URL that links to a page about the current finding in the finding product.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    title: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    A finding's title.
      Array Members: Minimum number of 1 item. Maximum number of 100 items.
    """
    type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    One or more finding types in the format of namespace/category/classifier that classify a finding. For a list of namespaces, classifiers, and categories, see [Types taxonomy for ASFF](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings-format-type-taxonomy.html) in the *User Guide*.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    updated_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleDateFilterArgsDict']]]]]
    """
    A timestamp that indicates when the finding record was most recently updated.
     For more information about the validation and formatting of timestamp fields in ASHlong, see [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    user_defined_fields: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleMapFilterArgsDict']]]]]
    """
    A list of user-defined name and value string pairs added to a finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    verification_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
    Provides the veracity of a finding.
      Array Members: Minimum number of 1 item. Maximum number of 20 items.
    """
    workflow_status: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleStringFilterArgsDict']]]]]
    """
...
class AutomationRulesFindingFiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AutomationRuleStringFilterArgs']]] note_updated_by: The principal that created a note.
                 Array Members: Minimum number of 1 item. Maximum number of 20 items.
        :param pulumi.Input[Sequence[pulumi.Input['AutomationRuleStringFilterArgs']]] product_arn: The Amazon Resource Name (ARN) for a third-party product that generated a finding in Security Hub CSPM.
                 Array Members: Minimum number of 1 item. Maximum number of 20 items.
        :param pulumi.Input[Sequence[pulumi.Input['AutomationRuleStringFilterArgs']]] product_name: Provides the name of the product that generated the finding. For control-based findings, the product name is Security Hub CSPM.
                 Array Members: Minimum number of 1 item. Maximum number of 20 items.
...
class ConfigurationPolicyParameterConfigurationArgsDict(TypedDict):
    ...
    """
    value: NotRequired[pulumi.Input[Optional['ConfigurationPolicyParameterValueArgsDict']]]
...
class ConfigurationPolicyPolicyArgsDict(TypedDict):
    ...
    """
    security_hub: NotRequired[pulumi.Input[Optional['ConfigurationPolicySecurityHubPolicyArgsDict']]]
    """
...
class ConfigurationPolicySecurityControlCustomParameterArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['ConfigurationPolicyParameterConfigurationArgsDict']]]]]
    """
...
class ConfigurationPolicySecurityControlsConfigurationArgsDict(TypedDict):
    ...
    """
    security_control_custom_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConfigurationPolicySecurityControlCustomParameterArgsDict']]]]]
    """
...
class ConfigurationPolicySecurityHubPolicyArgsDict(TypedDict):
    ...
    """
    security_controls_configuration: NotRequired[pulumi.Input[Optional['ConfigurationPolicySecurityControlsConfigurationArgsDict']]]
    """
...
class InsightAwsSecurityFindingFiltersArgsDict(TypedDict):
    ...
    """
    aws_account_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The AWS account ID in which a finding is generated.
    """
    aws_account_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the AWS account in which a finding is generated.
    """
    company_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the findings provider (company) that owns the solution (product) that generates findings.
    """
    compliance_associated_standards_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The unique identifier of a standard in which a control is enabled.
    """
    compliance_security_control_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The unique identifier of a control across standards.
    """
    compliance_security_control_parameters_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of a security control parameter.
    """
    compliance_security_control_parameters_value: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The current value of a security control parameter.
    """
    compliance_status: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    Exclusive to findings that are generated as the result of a check run against a specific rule in a supported standard.
    """
    confidence: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    A finding's confidence.
    """
    created_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    An ISO8601-formatted timestamp that indicates when the security findings provider captured the potential security issue that a finding captured.
    """
    criticality: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The level of importance assigned to the resources associated with the finding.
    """
    description: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    A finding's description.
    """
    finding_provider_fields_confidence: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The finding provider value for the finding confidence.
    """
    finding_provider_fields_criticality: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The finding provider value for the level of importance assigned to the resources associated with the findings.
    """
    finding_provider_fields_related_findings_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The finding identifier of a related finding that is identified by the finding provider.
    """
    finding_provider_fields_related_findings_product_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The ARN of the solution that generated a related finding that is identified by the finding provider.
    """
    finding_provider_fields_severity_label: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The finding provider value for the severity label.
    """
    finding_provider_fields_severity_original: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The finding provider's original value for the severity.
    """
    finding_provider_fields_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    One or more finding types that the finding provider assigned to the finding.
    """
    first_observed_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    An ISO8601-formatted timestamp that indicates when the security findings provider first observed the potential security issue that a finding captured.
    """
    generator_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The identifier for the solution-specific component (a discrete unit of logic) that generated a finding.
    """
    id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The security findings provider-specific identifier for a finding.
    """
    keyword: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightKeywordFilterArgsDict']]]]]
    """
    A keyword for a finding.
    """
    last_observed_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    An ISO8601-formatted timestamp that indicates when the security findings provider most recently observed the potential security issue that a finding captured.
    """
    malware_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the malware that was observed.
    """
    malware_path: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The filesystem path of the malware that was observed.
    """
    malware_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The state of the malware that was observed.
    """
    malware_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The type of the malware that was observed.
    """
    network_destination_domain: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The destination domain of network-related information about a finding.
    """
    network_destination_ip_v4: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The destination IPv4 address of network-related information about a finding.
    """
    network_destination_ip_v6: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The destination IPv6 address of network-related information about a finding.
    """
    network_destination_port: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The destination port of network-related information about a finding.
    """
    network_direction: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    Indicates the direction of network traffic associated with a finding.
    """
    network_protocol: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The protocol of network-related information about a finding.
    """
    network_source_domain: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The source domain of network-related information about a finding.
    """
    network_source_ip_v4: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The source IPv4 address of network-related information about a finding.
    """
    network_source_ip_v6: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The source IPv6 address of network-related information about a finding.
    """
    network_source_mac: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The source media access control (MAC) address of network-related information about a finding.
    """
    network_source_port: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The source port of network-related information about a finding.
    """
    note_text: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The text of a note.
    """
    note_updated_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    The timestamp of when the note was updated.
    """
    note_updated_by: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The principal that created a note.
    """
    process_launched_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    A timestamp that identifies when the process was launched.
    """
    process_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the process.
    """
    process_parent_pid: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The parent process ID.
    """
    process_path: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The path to the process executable.
    """
    process_pid: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The process ID.
    """
    process_terminated_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    A timestamp that identifies when the process was terminated.
    """
    product_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The ARN generated by Security Hub that uniquely identifies a third-party company (security findings provider) after this provider's product (solution that generates findings) is registered with Security Hub.
    """
    product_fields: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightMapFilterArgsDict']]]]]
    """
    A data type where security findings providers can include additional solution-specific details that aren't part of the defined AwsSecurityFinding format.
    """
    product_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the solution (product) that generates findings.
    """
    recommendation_text: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The recommendation of what to do about the issue described in a finding.
    """
    record_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The updated record state for the finding.
    """
    region: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The Region from which the finding was generated.
    """
    related_findings_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The solution-generated identifier for a related finding.
    """
    related_findings_product_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The ARN of the solution that generated a related finding.
    """
    resource_application_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The ARN of the application that is related to a finding.
    """
    resource_application_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the application that is related to a finding.
    """
    resource_aws_ec2_instance_iam_instance_profile_arn: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The IAM profile ARN of the instance.
    """
    resource_aws_ec2_instance_image_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The Amazon Machine Image (AMI) ID of the instance.
    """
    resource_aws_ec2_instance_ip_v4_addresses: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The IPv4 addresses associated with the instance.
    """
    resource_aws_ec2_instance_ip_v6_addresses: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightIpFilterArgsDict']]]]]
    """
    The IPv6 addresses associated with the instance.
    """
    resource_aws_ec2_instance_key_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The key name associated with the instance.
    """
    resource_aws_ec2_instance_launched_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    The date and time the instance was launched.
    """
    resource_aws_ec2_instance_subnet_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The identifier of the subnet that the instance was launched in.
    """
    resource_aws_ec2_instance_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The instance type of the instance.
    """
    resource_aws_ec2_instance_vpc_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The identifier of the VPC that the instance was launched in.
    """
    resource_aws_iam_access_key_created_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    The creation date/time of the IAM access key related to a finding.
    """
    resource_aws_iam_access_key_principal_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the principal that is associated with an IAM access key.
    """
    resource_aws_iam_access_key_status: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The status of the IAM access key related to a finding.
    """
    resource_aws_iam_access_key_user_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The user associated with the IAM access key related to a finding.
    """
    resource_aws_iam_user_user_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of an IAM user.
    """
    resource_aws_s3_bucket_owner_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The canonical user ID of the owner of the S3 bucket.
    """
    resource_aws_s3_bucket_owner_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The display name of the owner of the S3 bucket.
    """
    resource_container_image_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The identifier of the image related to a finding.
    """
    resource_container_image_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the image related to a finding.
    """
    resource_container_launched_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    A timestamp that identifies when the container was started.
    """
    resource_container_name: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The name of the container related to a finding.
    """
    resource_details_other: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightMapFilterArgsDict']]]]]
    """
    The details of a resource that doesn't have a specific subfield for the resource type defined.
    """
    resource_id: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The canonical identifier for the given resource type.
    """
    resource_partition: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The canonical AWS partition name that the Region is assigned to.
    """
    resource_region: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The canonical AWS external Region name where this resource is located.
    """
    resource_tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightMapFilterArgsDict']]]]]
    """
    A list of AWS tags associated with a resource at the time the finding was processed.
    """
    resource_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    Specifies the type of the resource that details are provided for.
    """
    sample: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightBooleanFilterArgsDict']]]]]
    """
    Indicates whether or not sample findings are included in the filter results.
    """
    severity_label: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The label of a finding's severity.
    """
    severity_normalized: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The normalized severity of a finding.
    """
    severity_product: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightNumberFilterArgsDict']]]]]
    """
    The native severity as defined by the security findings provider's solution that generated the finding.
    """
    source_url: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    A URL that links to a page about the current finding in the security findings provider's solution.
    """
    threat_intel_indicator_category: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The category of a threat intelligence indicator.
    """
    threat_intel_indicator_last_observed_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    A timestamp that identifies the last observation of a threat intelligence indicator.
    """
    threat_intel_indicator_source: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The source of the threat intelligence.
    """
    threat_intel_indicator_source_url: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The URL for more details from the source of the threat intelligence.
    """
    threat_intel_indicator_type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The type of a threat intelligence indicator.
    """
    threat_intel_indicator_value: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The value of a threat intelligence indicator.
    """
    title: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    A finding's title.
    """
    type: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    A finding type in the format of namespace/category/classifier that classifies a finding.
    """
    updated_at: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightDateFilterArgsDict']]]]]
    """
    An ISO8601-formatted timestamp that indicates when the security findings provider last updated the finding record.
    """
    user_defined_fields: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightMapFilterArgsDict']]]]]
    """
    A list of name/value string pairs associated with the finding.
    """
    verification_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The veracity of a finding.
    """
    vulnerabilities_exploit_available: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    Indicates whether a software vulnerability in your environment has a known exploit.
    """
    vulnerabilities_fix_available: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    Indicates whether a vulnerability is fixed in a newer version of the affected software packages.
    """
    workflow_state: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
    The workflow state of a finding.
    """
    workflow_status: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InsightStringFilterArgsDict']]]]]
    """
...
class InsightDateFilterArgsDict(TypedDict):
    ...
    A date filter for querying findings.
    """
    date_range: NotRequired[pulumi.Input[Optional['InsightDateRangeArgsDict']]]
    """
    A date range for the date filter.
    """
    end: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class SecurityControlParameterConfigurationArgsDict(TypedDict):
    ...
    """
    value: NotRequired[pulumi.Input[Optional['SecurityControlParameterValueArgsDict']]]
    """
