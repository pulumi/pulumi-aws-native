...
class GetOrganizationConfigurationResult:
    ...
    def auto_enable(self) -> Optional[builtins.bool]:
        """
    ...
    def member_account_limit_reached(self) -> Optional[builtins.bool]:
        """
    ...
    def organization_configuration_identifier(self) -> Optional[builtins.str]:
        """
...
def get_organization_configuration(organization_configuration_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str organization_configuration_identifier: The identifier of the OrganizationConfiguration being created and assigned as the unique identifier.
    """
    __args__ = dict()
...
def get_organization_configuration_output(organization_configuration_identifier: Optional[pulumi.Input[builtins.str]] = None,
