...
class GetInsightResult:
    ...
    def group_by_attribute(self) -> Optional[_builtins.str]:
        """
    ...
    def insight_arn(self) -> Optional[_builtins.str]:
        """
...
def get_insight(insight_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str insight_arn: The ARN of a Security Hub insight
    """
    __args__ = dict()
