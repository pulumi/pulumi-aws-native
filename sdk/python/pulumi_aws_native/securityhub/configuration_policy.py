...
class ConfigurationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: User-defined tags associated with a configuration policy. For more information, see [Tagging AWS Security Hub resources](https://docs.aws.amazon.com/securityhub/latest/userguide/tagging-resources.html) in the *Security Hub user guide* .
        """
...
class ConfigurationPolicy(pulumi.CustomResource):
    ...
    def service_enabled(self) -> pulumi.Output[builtins.bool]:
        """
