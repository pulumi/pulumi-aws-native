...
class ConfigurationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: User-defined tags associated with a configuration policy. For more information, see [Tagging Security Hub resources](https://docs.aws.amazon.com/securityhub/latest/userguide/tagging-resources.html) in the *Security Hub user guide* .
        """
...
class ConfigurationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ConfigurationPolicyPolicyArgs', 'ConfigurationPolicyPolicyArgsDict']] configuration_policy: An object that defines how Security Hub is configured. It includes whether Security Hub is enabled or disabled, a list of enabled security standards, a list of enabled or disabled security controls, and a list of custom parameter values for specified controls. If you provide a list of security controls that are enabled in the configuration policy, Security Hub disables all other controls (including newly released controls). If you provide a list of security controls that are disabled in the configuration policy, Security Hub enables all other controls (including newly released controls).
        :param pulumi.Input[_builtins.str] description: The description of the configuration policy.
        :param pulumi.Input[_builtins.str] name: The name of the configuration policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: User-defined tags associated with a configuration policy. For more information, see [Tagging Security Hub resources](https://docs.aws.amazon.com/securityhub/latest/userguide/tagging-resources.html) in the *Security Hub user guide* .
        """
    ...
    def service_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
