...
class GetDelegatedAdminResult:
    ...
    def delegated_admin_identifier(self) -> Optional[builtins.str]:
        """
...
def get_delegated_admin(delegated_admin_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str delegated_admin_identifier: The ID of the delegated Security Hub administrator account, in the format of `accountID/Region` .
    """
    __args__ = dict()
...
def get_delegated_admin_output(delegated_admin_identifier: Optional[pulumi.Input[builtins.str]] = None,
