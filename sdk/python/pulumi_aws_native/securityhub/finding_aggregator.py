...
class FindingAggregatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: If ``RegionLinkingMode`` is ``ALL_REGIONS_EXCEPT_SPECIFIED``, then this is a space-separated list of Regions that do not aggregate findings to the aggregation Region.
...
class FindingAggregator(pulumi.CustomResource):
    ...
    def finding_aggregation_region(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def finding_aggregator_arn(self) -> pulumi.Output[builtins.str]:
        """
