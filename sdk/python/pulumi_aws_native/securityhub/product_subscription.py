...
class ProductSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] product_arn: The generic ARN of the product being subscribed to
        """
...
@pulumi.type_token("aws-native:securityhub:ProductSubscription")
class ProductSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="productArn")
    def product_arn(self) -> pulumi.Output[builtins.str]:
        """
        The generic ARN of the product being subscribed to
        """
        return pulumi.get(self, "product_arn")
    ...
    def product_subscription_arn(self) -> pulumi.Output[builtins.str]:
        """
