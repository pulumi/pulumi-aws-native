...
class SecurityControlArgs:
    def __init__(__self__, *,
                 ...
                 last_update_reason: Optional[pulumi.Input[builtins.str]] = None,
                 security_control_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] last_update_reason: The most recent reason for updating the customizable properties of a security control. This differs from the UpdateReason field of the BatchUpdateStandardsControlAssociations API, which tracks the reason for updating the enablement status of a control. This field accepts alphanumeric characters in addition to white spaces, dashes, and underscores.
        :param pulumi.Input[builtins.str] security_control_arn: The Amazon Resource Name (ARN) for a security control across standards, such as `arn:aws:securityhub:eu-central-1:123456789012:security-control/S3.1`. This parameter doesn't mention a specific standard.
        :param pulumi.Input[builtins.str] security_control_id: The unique identifier of a security control across standards. Values for this field typically consist of an AWS service name and a number, such as APIGateway.3.
        """
    ...
    def last_update_reason(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_update_reason(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_update_reason", value)

    @property
    @pulumi.getter(name="securityControlArn")
    def security_control_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_control_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityControl(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lastUpdateReason")
    def last_update_reason(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The most recent reason for updating the customizable properties of a security control. This differs from the UpdateReason field of the BatchUpdateStandardsControlAssociations API, which tracks the reason for updating the enablement status of a control. This field accepts alphanumeric characters in addition to white spaces, dashes, and underscores.
        """
        return pulumi.get(self, "last_update_reason")
    ...
    @property
    @pulumi.getter(name="securityControlArn")
    def security_control_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) for a security control across standards, such as `arn:aws:securityhub:eu-central-1:123456789012:security-control/S3.1`. This parameter doesn't mention a specific standard.
        """
        return pulumi.get(self, "security_control_arn")
    ...
    @property
    @pulumi.getter(name="securityControlId")
    def security_control_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique identifier of a security control across standards. Values for this field typically consist of an AWS service name and a number, such as APIGateway.3.
        """
        return pulumi.get(self, "security_control_id")
