...
class PolicyAssociationArgs:
    def __init__(__self__, *,
                 configuration_policy_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] configuration_policy_id: The universally unique identifier (UUID) of the configuration policy or a value of SELF_MANAGED_SECURITY_HUB for a self-managed configuration
        :param pulumi.Input[builtins.str] target_id: The identifier of the target account, organizational unit, or the root
    ...
    def configuration_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def configuration_policy_id(self, value: pulumi.Input[builtins.str]):
...
class PolicyAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration_policy_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def association_identifier(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def association_status_message(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="configurationPolicyId")
    def configuration_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The universally unique identifier (UUID) of the configuration policy or a value of SELF_MANAGED_SECURITY_HUB for a self-managed configuration
        """
        return pulumi.get(self, "configuration_policy_id")
