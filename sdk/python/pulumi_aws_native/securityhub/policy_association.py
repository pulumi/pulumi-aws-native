...
class PolicyAssociationArgs:
    def __init__(__self__, *,
                 configuration_policy_id: pulumi.Input[_builtins.str],
    ...
    def configuration_policy_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def configuration_policy_id(self, value: pulumi.Input[_builtins.str]):
...
class PolicyAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 target_id: pulumi.Input[Optional[_builtins.str]] = None,
                 target_type: pulumi.Input[Optional['PolicyAssociationTargetType']] = None,
                 __props__=None):
        """
    ...
    def association_identifier(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def association_status_message(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="configurationPolicyId")
    def configuration_policy_id(self) -> pulumi.Output[_builtins.str]:
        """
        The universally unique identifier (UUID) of the configuration policy or a value of SELF_MANAGED_SECURITY_HUB for a self-managed configuration
        """
        return pulumi.get(self, "configuration_policy_id")
