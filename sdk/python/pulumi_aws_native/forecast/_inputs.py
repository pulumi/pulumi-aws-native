...
class DatasetAttributesItemPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] attribute_name: Name of the dataset field
...
class EncryptionConfigPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        A Key Management Service (KMS) key and the Identity and Access Management (IAM) role that Amazon Forecast can assume to access the key.
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) of the KMS key.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM role that Amazon Forecast can assume to access the AWS KMS key.
