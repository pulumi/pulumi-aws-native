...
class GetDatasetGroupResult:
    ...
    def dataset_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def dataset_group_arn(self) -> Optional[builtins.str]:
        """
...
def get_dataset_group(dataset_group_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str dataset_group_arn: The Amazon Resource Name (ARN) of the dataset group to delete.
    """
    __args__ = dict()
...
def get_dataset_group_output(dataset_group_arn: Optional[pulumi.Input[builtins.str]] = None,
