...
class DatasetGroupArgs:
    def __init__(__self__, *,
                 ...
                 dataset_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dataset_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dataset_arns: An array of Amazon Resource Names (ARNs) of the datasets that you want to include in the dataset group.
        :param pulumi.Input[builtins.str] dataset_group_name: A name for the dataset group.
    ...
    def dataset_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @dataset_arns.setter
    def dataset_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dataset_arns", value)

    @property
    @pulumi.getter(name="datasetGroupName")
    def dataset_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dataset_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:forecast:DatasetGroup")
class DatasetGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="datasetArns")
    def dataset_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of Amazon Resource Names (ARNs) of the datasets that you want to include in the dataset group.
        """
        return pulumi.get(self, "dataset_arns")
    ...
    @property
    @pulumi.getter(name="datasetGroupName")
    def dataset_group_name(self) -> pulumi.Output[builtins.str]:
        """
        A name for the dataset group.
        """
        return pulumi.get(self, "dataset_group_name")
