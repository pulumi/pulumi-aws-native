...
class GetDatasetResult:
    ...
    def data_frequency(self) -> Optional[builtins.str]:
        """
...
def get_dataset_output(arn: Optional[pulumi.Input[builtins.str]] = None,
