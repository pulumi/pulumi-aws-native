...
class AccessEntryAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_arn: The ARN of the access policy to add to the access entry.
        """
...
class AccessEntryAccessScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] namespaces: The namespaces to associate with the access scope. Only specify if Type is set to 'namespace'.
        """
...
class ClusterAccessConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] bootstrap_cluster_creator_admin_permissions: Set this value to false to avoid creating a default cluster admin Access Entry using the IAM principal used to create the cluster.
        """
...
class ClusterBlockStorageArgs:
    def __init__(__self__, *,
        ...
        """
        Todo: add description
        :param pulumi.Input[builtins.bool] enabled: Todo: add description
        """
...
class ClusterComputeConfigArgs:
    def __init__(__self__, *,
        ...
        Todo: add description
        :param pulumi.Input[builtins.bool] enabled: Todo: add description
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_pools: Todo: add description
        :param pulumi.Input[builtins.str] node_role_arn: Todo: add description
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ClusterControlPlanePlacementArgs:
    def __init__(__self__, *,
        ...
        """
        Specify the placement group of the control plane machines for your cluster.
        :param pulumi.Input[builtins.str] group_name: Specify the placement group name of the control place machines for your cluster.
        """
...
class ClusterEncryptionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: Specifies the resources to be encrypted. The only supported value is "secrets".
        """
...
class ClusterKubernetesNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_ipv6_cidr: The CIDR block to assign Kubernetes service IP addresses from.
        """
...
class ClusterOutpostConfigArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing the Outpost configuration to use for AWS EKS outpost cluster.
        :param pulumi.Input[builtins.str] control_plane_instance_type: Specify the Instance type of the machines that should be used to create your cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outpost_arns: Specify one or more Arn(s) of Outpost(s) on which you would like to create your cluster.
...
class ClusterProviderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_arn: Amazon Resource Name (ARN) or alias of the KMS key. The KMS key must be symmetric, created in the same region as the cluster, and if the KMS key was created in a different account, the user must have access to the KMS key.
        """
...
class ClusterRemoteNodeNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        Network configuration of nodes run on-premises with EKS Hybrid Nodes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidrs: Specifies the list of remote node CIDRs.
        """
...
class ClusterRemotePodNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        Network configuration of pods run on-premises with EKS Hybrid Nodes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidrs: Specifies the list of remote pod CIDRs.
        """
        pulumi.set(__self__, "cidrs", cidrs)
...
class ClusterResourcesVpcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing the VPC configuration to use for an Amazon EKS cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: Specify subnets for your Amazon EKS nodes. Amazon EKS creates cross-account elastic network interfaces in these subnets to allow communication between your nodes and the Kubernetes control plane.
        :param pulumi.Input[builtins.bool] endpoint_private_access: Set this value to true to enable private access for your cluster's Kubernetes API server endpoint. If you enable private access, Kubernetes API requests from within your cluster's VPC use the private VPC endpoint. The default value for this parameter is false, which disables private access for your Kubernetes API server. If you disable private access and you have nodes or AWS Fargate pods in the cluster, then ensure that publicAccessCidrs includes the necessary CIDR blocks for communication with the nodes or Fargate pods.
        :param pulumi.Input[builtins.bool] endpoint_public_access: Set this value to false to disable public access to your cluster's Kubernetes API server endpoint. If you disable public access, your cluster's Kubernetes API server can only receive requests from within the cluster VPC. The default value for this parameter is true, which enables public access for your Kubernetes API server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_access_cidrs: The CIDR blocks that are allowed access to your cluster's public Kubernetes API server endpoint. Communication to the endpoint from addresses outside of the CIDR blocks that you specify is denied. The default value is 0.0.0.0/0. If you've disabled private endpoint access and you have nodes or AWS Fargate pods in the cluster, then ensure that you specify the necessary CIDR blocks.
...
class ClusterZonalShiftConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The current zonal shift configuration to use for the cluster.
        :param pulumi.Input[builtins.bool] enabled: Set this value to true to enable zonal shift for the cluster.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class FargateProfileLabelArgs:
    def __init__(__self__, *,
        ...
        """
        A key-value pair to associate with a pod.
        :param pulumi.Input[builtins.str] key: The key name of the label.
        :param pulumi.Input[builtins.str] value: The value for the label. 
        """
...
class FargateProfileSelectorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: The Kubernetes `namespace` that the selector should match.
...
class IdentityProviderConfigOidcIdentityProviderConfigArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing an OpenID Connect (OIDC) configuration.
        :param pulumi.Input[builtins.str] client_id: This is also known as audience. The ID for the client application that makes authentication requests to the OpenID identity provider.
        :param pulumi.Input[builtins.str] issuer_url: The URL of the OpenID identity provider that allows the API server to discover public signing keys for verifying tokens.
        :param pulumi.Input[builtins.str] groups_claim: The JWT claim that the provider uses to return your groups.
        :param pulumi.Input[builtins.str] groups_prefix: The prefix that is prepended to group claims to prevent clashes with existing names (such as system: groups).
        ...
        :param pulumi.Input[builtins.str] username_claim: The JSON Web Token (JWT) claim to use as the username. The default is sub, which is expected to be a unique identifier of the end user. You can choose other claims, such as email or name, depending on the OpenID identity provider. Claims other than email are prefixed with the issuer URL to prevent naming clashes with other plug-ins.
        :param pulumi.Input[builtins.str] username_prefix: The prefix that is prepended to username claims to prevent clashes with existing names. If you do not provide this field, and username is a value other than email, the prefix defaults to issuerurl#. You can use the value - to disable all prefixing.
        """
...
class IdentityProviderConfigRequiredClaimArgs:
    def __init__(__self__, *,
        ...
        """
        The key value pairs that describe required claims in the identity token. If set, each claim is verified to be present in the token with a matching value.
        :param pulumi.Input[builtins.str] key: The key of the requiredClaims.
        :param pulumi.Input[builtins.str] value: The value for the requiredClaims.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class NodegroupLaunchTemplateSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing a launch template specification for AWS EKS Nodegroup.
        :param pulumi.Input[builtins.str] id: The ID of the launch template.
               
               You must specify either the launch template ID or the launch template name in the request, but not both. After node group creation, you cannot use a different ID.
        :param pulumi.Input[builtins.str] name: The name of the launch template.
               
               You must specify either the launch template name or the launch template ID in the request, but not both. After node group creation, you cannot use a different name.
        :param pulumi.Input[builtins.str] version: The version number of the launch template to use. If no version is specified, then the template's default version is used. You can use a different version for node group updates.
        """
        if id is not None:
...
class NodegroupNodeRepairConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The node auto repair configuration for node group.
        :param pulumi.Input[builtins.bool] enabled: Set this value to true to enable node auto repair for the node group.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class NodegroupRemoteAccessArgsDict(TypedDict):
        ...
        """
        ec2_ssh_key: pulumi.Input[builtins.str]
        """
        ...
        """
        source_security_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class NodegroupRemoteAccessArgs:
    def __init__(__self__, *,
                 ec2_ssh_key: pulumi.Input[builtins.str],
                 source_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        An object representing a remote access configuration specification for AWS EKS Nodegroup.
        :param pulumi.Input[builtins.str] ec2_ssh_key: The Amazon EC2 SSH key name that provides access for SSH communication with the nodes in the managed node group. For more information, see [Amazon EC2 key pairs and Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html) in the *Amazon Elastic Compute Cloud User Guide for Linux Instances* . For Windows, an Amazon EC2 SSH key is used to obtain the RDP password. For more information, see [Amazon EC2 key pairs and Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-key-pairs.html) in the *Amazon Elastic Compute Cloud User Guide for Windows Instances* .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_security_groups: The security group IDs that are allowed SSH access (port 22) to the nodes. For Windows, the port is 3389. If you specify an Amazon EC2 SSH key but don't specify a source security group when you create a managed node group, then the port on the nodes is opened to the internet ( `0.0.0.0/0` ). For more information, see [Security Groups for Your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) in the *Amazon Virtual Private Cloud User Guide* .
        """
    ...
    def ec2_ssh_key(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon EC2 SSH key name that provides access for SSH communication with the nodes in the managed node group. For more information, see [Amazon EC2 key pairs and Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html) in the *Amazon Elastic Compute Cloud User Guide for Linux Instances* . For Windows, an Amazon EC2 SSH key is used to obtain the RDP password. For more information, see [Amazon EC2 key pairs and Windows instances](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-key-pairs.html) in the *Amazon Elastic Compute Cloud User Guide for Windows Instances* .
        """
    ...
    @ec2_ssh_key.setter
    def ec2_ssh_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ec2_ssh_key", value)

    @property
    @pulumi.getter(name="sourceSecurityGroups")
    def source_security_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The security group IDs that are allowed SSH access (port 22) to the nodes. For Windows, the port is 3389. If you specify an Amazon EC2 SSH key but don't specify a source security group when you create a managed node group, then the port on the nodes is opened to the internet ( `0.0.0.0/0` ). For more information, see [Security Groups for Your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html) in the *Amazon Virtual Private Cloud User Guide* .
        """
    ...
    def source_security_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class NodegroupScalingConfigArgsDict(TypedDict):
        ...
        """
        desired_size: NotRequired[pulumi.Input[builtins.int]]
        """
...
class NodegroupScalingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing a auto scaling group specification for AWS EKS Nodegroup.
        :param pulumi.Input[builtins.int] desired_size: The current number of nodes that the managed node group should maintain.
               ...
               This parameter can be different from `minSize` in some cases, such as when starting with extra hosts for testing. This parameter can also be different when you want to start with an estimated number of needed hosts, but let the Cluster Autoscaler reduce the number if there are too many. When the Cluster Autoscaler is used, the `desiredSize` parameter is altered by the Cluster Autoscaler (but can be out-of-date for short periods of time). the Cluster Autoscaler doesn't scale a managed node group lower than `minSize` or higher than `maxSize` .
        :param pulumi.Input[builtins.int] max_size: The maximum number of nodes that the managed node group can scale out to. For information about the maximum number that you can specify, see [Amazon EKS service quotas](https://docs.aws.amazon.com/eks/latest/userguide/service-quotas.html) in the *Amazon EKS User Guide* .
        :param pulumi.Input[builtins.int] min_size: The minimum number of nodes that the managed node group can scale in to.
        """
...
if not MYPY:
    class NodegroupUpdateConfigArgsDict(TypedDict):
        ...
        """
        max_unavailable_percentage: NotRequired[pulumi.Input[builtins.float]]
        """
...
class NodegroupUpdateConfigArgs:
    def __init__(__self__, *,
                 ...
                 max_unavailable_percentage: Optional[pulumi.Input[builtins.float]] = None,
                 update_strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The node group update configuration.
        :param pulumi.Input[builtins.float] max_unavailable: The maximum number of nodes unavailable at once during a version update. Nodes will be updated in parallel. This value or maxUnavailablePercentage is required to have a value.The maximum number is 100. 
        :param pulumi.Input[builtins.float] max_unavailable_percentage: The maximum percentage of nodes unavailable during a version update. This percentage of nodes will be updated in parallel, up to 100 nodes at once. This value or maxUnavailable is required to have a value.
        :param pulumi.Input[builtins.str] update_strategy: The configuration for the behavior to follow during an node group version update of this managed node group. You choose between two possible strategies for replacing nodes during an UpdateNodegroupVersion action.
        """
    ...
    def max_unavailable_percentage(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum percentage of nodes unavailable during a version update. This percentage of nodes will be updated in parallel, up to 100 nodes at once. This value or maxUnavailable is required to have a value.
        """
    ...
    def max_unavailable_percentage(self, value: Optional[pulumi.Input[builtins.float]]):
