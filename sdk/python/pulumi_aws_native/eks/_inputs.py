...
class CapabilityArgoCdArgsDict(TypedDict):
    ...
    """
    network_access: NotRequired[pulumi.Input[Optional['CapabilityNetworkAccessArgs']]]
    rbac_role_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CapabilityArgoCdRoleMappingArgs']]]]]
    """
...
class CapabilityConfigurationArgsDict(TypedDict):
    ...
    """
    argo_cd: NotRequired[pulumi.Input[Optional['CapabilityArgoCdArgs']]]
...
class ClusterEncryptionConfigArgsDict(TypedDict):
    ...
    """
    provider: NotRequired[pulumi.Input[Optional['ClusterProviderArgs']]]
    """
...
class ClusterKubernetesNetworkConfigArgsDict(TypedDict):
    ...
    """
    elastic_load_balancing: NotRequired[pulumi.Input[Optional['ClusterElasticLoadBalancingArgs']]]
    """
    Todo: add description
    """
...
class ClusterLoggingEnabledTypesArgsDict(TypedDict):
    ...
    """
    enabled_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ClusterLoggingTypeConfigArgs']]]]]
    """
...
class ClusterOutpostConfigArgsDict(TypedDict):
    ...
    """
    control_plane_placement: NotRequired[pulumi.Input[Optional['ClusterControlPlanePlacementArgs']]]
    """
    Specify the placement group of the control plane machines for your cluster.
    """
...
class ClusterRemoteNetworkConfigArgsDict(TypedDict):
    ...
    """
    remote_node_networks: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ClusterRemoteNodeNetworkArgs']]]]]
    """
    Network configuration of nodes run on-premises with EKS Hybrid Nodes.
    """
    remote_pod_networks: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ClusterRemotePodNetworkArgs']]]]]
    """
...
class ClusterStorageConfigArgsDict(TypedDict):
    ...
    Todo: add description
    """
    block_storage: NotRequired[pulumi.Input[Optional['ClusterBlockStorageArgs']]]
    """
    Todo: add description
    """
...
class FargateProfileSelectorArgsDict(TypedDict):
    ...
    """
    labels: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FargateProfileLabelArgs']]]]]
    """
...
class IdentityProviderConfigOidcIdentityProviderConfigArgsDict(TypedDict):
    ...
    """
    required_claims: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IdentityProviderConfigRequiredClaimArgs']]]]]
    """
...
class LoggingArgsDict(TypedDict):
    ...
    """
    cluster_logging: NotRequired[pulumi.Input[Optional['ClusterLoggingEnabledTypesArgs']]]
    """
    The cluster control plane logging configuration for your cluster. 
    """
...
class NodegroupNodeRepairConfigArgsDict(TypedDict):
    ...
    """
    node_repair_config_overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NodegroupNodeRepairConfigOverridesArgs']]]]]
    """
    Specify granular overrides for specific repair actions. These overrides control the repair action and the repair delay time before a node is considered eligible for repair. If you use this, you must specify all the values.
    """
