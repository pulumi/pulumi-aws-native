...
class FargateProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pod_execution_role_arn: The IAM policy arn for pods
        ...
        :param pulumi.Input[builtins.str] fargate_profile_name: Name of FargateProfile
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The IDs of subnets to launch a `Pod` into. A `Pod` running on Fargate isn't assigned a public IP address, so only private subnets (with no direct route to an Internet Gateway) are accepted for this parameter.
...
class FargateProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="fargateProfileName")
    def fargate_profile_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of FargateProfile
        """
        return pulumi.get(self, "fargate_profile_name")
