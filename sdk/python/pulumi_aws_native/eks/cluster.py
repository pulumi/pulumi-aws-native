...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(kubernetes_network_config, ClusterKubernetesNetworkConfigArgs):
            ...
            if not isinstance(logging, LoggingArgs):
                logging = logging or {}
                def _setter(key, value):
                    logging[key] = value
            ...
            if not isinstance(outpost_config, ClusterOutpostConfigArgs):
            ...
            if not isinstance(resources_vpc_config, ClusterResourcesVpcConfigArgs):
