...
class GetAddonResult:
    ...
    def addon_version(self) -> Optional[_builtins.str]:
        """
        Version of Addon
        """
    ...
    def configuration_values(self) -> Optional[_builtins.str]:
        """
    ...
    def service_account_role_arn(self) -> Optional[_builtins.str]:
        """
...
def get_addon(addon_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str addon_name: Name of Addon
    :param _builtins.str cluster_name: Name of Cluster
    """
    __args__ = dict()
