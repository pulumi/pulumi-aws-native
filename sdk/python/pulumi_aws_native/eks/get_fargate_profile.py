...
def get_fargate_profile(cluster_name: Optional[builtins.str] = None,
                        fargate_profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str fargate_profile_name: Name of FargateProfile
    """
    __args__ = dict()
...
def get_fargate_profile_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
