...
class GetClusterResult:
    ...
    def encryption_config_key_arn(self) -> Optional[builtins.str]:
        """
    ...
    def open_id_connect_issuer_url(self) -> Optional[builtins.str]:
        """
...
def get_cluster(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The unique name to give to your cluster.
    """
    __args__ = dict()
    __args__['name'] = name
