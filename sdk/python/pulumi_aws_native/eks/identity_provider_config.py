...
class IdentityProviderConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: The name of the identity provider configuration.
        :param pulumi.Input['IdentityProviderConfigType'] type: The type of the identity provider configuration.
        :param pulumi.Input[builtins.str] identity_provider_config_name: The name of the OIDC provider configuration.
    ...
    def identity_provider_config_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_provider_config_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:eks:IdentityProviderConfig")
class IdentityProviderConfig(pulumi.CustomResource):
    ...
    def identity_provider_config_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="identityProviderConfigName")
    def identity_provider_config_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the OIDC provider configuration.
        """
        return pulumi.get(self, "identity_provider_config_name")
