...
class NetworkPerformanceMetricSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination: The target Region or Availability Zone for the metric to subscribe to.
        :param pulumi.Input[builtins.str] metric: The metric type to subscribe to.
        :param pulumi.Input[builtins.str] source: The starting Region or Availability Zone for metric to subscribe to.
        :param pulumi.Input[builtins.str] statistic: The statistic to subscribe to.
        """
...
class NetworkPerformanceMetricSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def statistic(self) -> pulumi.Output[builtins.str]:
        """
        The statistic to subscribe to.
        """
        return pulumi.get(self, "statistic")
