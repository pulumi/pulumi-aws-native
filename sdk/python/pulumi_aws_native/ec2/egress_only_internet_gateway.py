...
class EgressOnlyInternetGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC for which to create the egress-only internet gateway.
...
class EgressOnlyInternetGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Any tags assigned to the egress only internet gateway.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC for which to create the egress-only internet gateway.
        """
        ...
    @overload
