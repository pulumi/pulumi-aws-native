...
class SubnetCidrBlockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipv6_cidr_block: The IPv6 network range for the subnet, in CIDR notation. The subnet size must use a /64 prefix length
        :param pulumi.Input[builtins.str] ipv6_ipam_pool_id: The ID of an IPv6 Amazon VPC IP Address Manager (IPAM) pool from which to allocate, to get the subnet's CIDR
        :param pulumi.Input[builtins.int] ipv6_netmask_length: The netmask length of the IPv6 CIDR to allocate to the subnet from an IPAM pool
        """
