...
class GetLocalGatewayRouteTableVpcAssociationResult:
    ...
    def local_gateway_route_table_vpc_association_id(self) -> Optional[builtins.str]:
        """
...
def get_local_gateway_route_table_vpc_association(local_gateway_route_table_vpc_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str local_gateway_route_table_vpc_association_id: The ID of the association.
    """
    __args__ = dict()
...
def get_local_gateway_route_table_vpc_association_output(local_gateway_route_table_vpc_association_id: Optional[pulumi.Input[builtins.str]] = None,
