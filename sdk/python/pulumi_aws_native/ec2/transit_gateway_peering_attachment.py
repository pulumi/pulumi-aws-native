...
class TransitGatewayPeeringAttachmentArgs:
    def __init__(__self__, *,
                 peer_account_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] peer_account_id: The ID of the peer account
        :param pulumi.Input[builtins.str] peer_region: Peer Region
        :param pulumi.Input[builtins.str] peer_transit_gateway_id: The ID of the peer transit gateway.
    ...
    def peer_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def peer_account_id(self, value: pulumi.Input[builtins.str]):
