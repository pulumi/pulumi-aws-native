...
def get_placement_group(group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str group_name: The Group Name of Placement Group.
    """
    __args__ = dict()
...
def get_placement_group_output(group_name: Optional[pulumi.Input[builtins.str]] = None,
