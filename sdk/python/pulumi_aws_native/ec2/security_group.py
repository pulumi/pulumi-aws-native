...
class SecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_description: A description for the security group.
        :param pulumi.Input[builtins.str] group_name: The name of the security group.
        ...
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC for the security group.
        """
