...
class LocalGatewayVirtualInterfaceGroupArgs:
    def __init__(__self__, *,
                 ...
                 local_bgp_asn: Optional[pulumi.Input[builtins.int]] = None,
                 local_bgp_asn_extended: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] local_bgp_asn: The Autonomous System Number(ASN) for the local Border Gateway Protocol (BGP)
        :param pulumi.Input[builtins.int] local_bgp_asn_extended: The extended 32-bit ASN for the local BGP configuration
    ...
    def local_bgp_asn(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def local_bgp_asn(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "local_bgp_asn", value)

    @property
    @pulumi.getter(name="localBgpAsnExtended")
    def local_bgp_asn_extended(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def local_bgp_asn_extended(self, value: Optional[pulumi.Input[builtins.int]]):
...
class LocalGatewayVirtualInterfaceGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="localBgpAsn")
    def local_bgp_asn(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Autonomous System Number(ASN) for the local Border Gateway Protocol (BGP)
        """
        return pulumi.get(self, "local_bgp_asn")
    ...
    @property
    @pulumi.getter(name="localBgpAsnExtended")
    def local_bgp_asn_extended(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The extended 32-bit ASN for the local BGP configuration
        """
        return pulumi.get(self, "local_bgp_asn_extended")
    ...
    def local_gateway_virtual_interface_group_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def local_gateway_virtual_interface_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
