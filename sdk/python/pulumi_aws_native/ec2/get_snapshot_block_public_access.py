...
def get_snapshot_block_public_access(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The identifier for the specified AWS account.
    """
    __args__ = dict()
...
def get_snapshot_block_public_access_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
