...
__all__ = ['ClientVpnAuthorizationRule']
...
class ClientVpnAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClientVpnAuthorizationRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClientVpnAuthorizationRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClientVpnAuthorizationRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClientVpnAuthorizationRuleProperties']:
        """
