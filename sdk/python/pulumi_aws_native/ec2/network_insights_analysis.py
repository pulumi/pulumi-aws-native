...
class NetworkInsightsAnalysisArgs:
    ...
    def network_insights_path_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the path.
        """
    ...
    def network_insights_path_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "network_insights_path_id", value)

    @property
    @pulumi.getter(name="additionalAccounts")
    def additional_accounts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "additional_accounts", value)

    @property
    @pulumi.getter(name="filterInArns")
    def filter_in_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
...
class NetworkInsightsAnalysis(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="additionalAccounts")
    def additional_accounts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The member accounts that contain resources that the path can traverse.
        """
        return pulumi.get(self, "additional_accounts")
    ...
    @property
    @pulumi.getter(name="filterInArns")
    def filter_in_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The Amazon Resource Names (ARN) of the resources that the path must traverse.
        """
        return pulumi.get(self, "filter_in_arns")
    ...
    def network_insights_analysis_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def network_insights_analysis_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="networkInsightsPathId")
    def network_insights_path_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the path.
        """
        return pulumi.get(self, "network_insights_path_id")
    ...
    def network_path_found(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def suggested_accounts(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
