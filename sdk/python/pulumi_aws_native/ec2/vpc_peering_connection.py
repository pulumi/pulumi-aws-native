...
class VpcPeeringConnectionArgs:
    def __init__(__self__, *,
                 ...
                 peer_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a VpcPeeringConnection resource.
        :param pulumi.Input[builtins.str] peer_vpc_id: The ID of the VPC with which you are creating the VPC peering connection. You must specify this parameter in the request.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[builtins.str] peer_owner_id: The AWS account ID of the owner of the accepter VPC.
        :param pulumi.Input[builtins.str] peer_region: The Region code for the accepter VPC, if the accepter VPC is located in a Region other than the Region in which you make the request.
        :param pulumi.Input[builtins.str] peer_role_arn: The Amazon Resource Name (ARN) of the VPC peer role for the peering connection in another AWS account.
    ...
    def peer_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpcPeeringConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="peerOwnerId")
    def peer_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AWS account ID of the owner of the accepter VPC.
        """
        return pulumi.get(self, "peer_owner_id")
    ...
    @property
    @pulumi.getter(name="peerRoleArn")
    def peer_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the VPC peer role for the peering connection in another AWS account.
        """
        return pulumi.get(self, "peer_role_arn")
