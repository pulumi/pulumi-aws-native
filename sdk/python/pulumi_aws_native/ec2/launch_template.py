...
class LaunchTemplateArgs:
    def __init__(__self__, *,
                 ...
                 tag_specifications: Optional[pulumi.Input[Sequence[pulumi.Input['LaunchTemplateLaunchTemplateTagSpecificationArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LaunchTemplateLaunchTemplateTagSpecificationArgs']]] tag_specifications: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-tagspecifications
        """
    ...
    def tag_specifications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LaunchTemplateLaunchTemplateTagSpecificationArgs']]]]:
        """
    ...
    def tag_specifications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LaunchTemplateLaunchTemplateTagSpecificationArgs']]]]):
...
class LaunchTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 launch_template_data: Optional[pulumi.Input[pulumi.InputType['LaunchTemplateLaunchTemplateDataArgs']]] = None,
                 launch_template_name: Optional[pulumi.Input[str]] = None,
                 tag_specifications: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LaunchTemplateLaunchTemplateTagSpecificationArgs']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['LaunchTemplateLaunchTemplateDataArgs']] launch_template_data: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-launchtemplatedata
        :param pulumi.Input[str] launch_template_name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-launchtemplatename
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LaunchTemplateLaunchTemplateTagSpecificationArgs']]]] tag_specifications: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-tagspecifications
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="launchTemplateData")
    def launch_template_data(self) -> pulumi.Output[Optional['outputs.LaunchTemplateLaunchTemplateData']]:
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-launchtemplatedata
        """
        return pulumi.get(self, "launch_template_data")
    ...
    @property
    @pulumi.getter(name="tagSpecifications")
    def tag_specifications(self) -> pulumi.Output[Optional[Sequence['outputs.LaunchTemplateLaunchTemplateTagSpecification']]]:
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html#cfn-ec2-launchtemplate-tagspecifications
        """
        return pulumi.get(self, "tag_specifications")
