...
def get_transit_gateway_multicast_group_source(group_ip_address: Optional[builtins.str] = None,
...
def get_transit_gateway_multicast_group_source_output(group_ip_address: Optional[pulumi.Input[builtins.str]] = None,
