...
class CapacityReservationArgs:
    def __init__(__self__, *,
                 ...
                 ephemeral_storage: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_match_criteria: Optional[pulumi.Input[builtins.str]] = None,
                 out_post_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 unused_reservation_billing_owner_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] availability_zone_id: The Availability Zone ID of the Capacity Reservation.
        :param pulumi.Input[builtins.bool] ebs_optimized: Indicates whether the Capacity Reservation supports EBS-optimized instances. This optimization provides dedicated throughput to Amazon EBS and an optimized configuration stack to provide optimal I/O performance. This optimization isn't available with all instance types. Additional usage charges apply when using an EBS- optimized instance.
        ...
        :param pulumi.Input[builtins.str] end_date_type: Indicates the way in which the Capacity Reservation ends. A Capacity Reservation can have one of the following end types:
        ...
        :param pulumi.Input[builtins.str] placement_group_arn: > Not supported for future-dated Capacity Reservations. 
        ...
        :param pulumi.Input[builtins.str] tenancy: Indicates the tenancy of the Capacity Reservation. A Capacity Reservation can have one of the following tenancy settings:
               
               - `default` - The Capacity Reservation is created on hardware that is shared with other AWS accounts .
               - `dedicated` - The Capacity Reservation is created on single-tenant hardware that is dedicated to a single AWS account .
        :param pulumi.Input[builtins.str] unused_reservation_billing_owner_id: The ID of the AWS account to which to assign billing of the unused capacity of the Capacity Reservation. A request will be sent to the specified account. That account must accept the request for the billing to be assigned to their account. For more information, see [Billing assignment for shared Amazon EC2 Capacity Reservations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/assign-billing.html) .
    ...
    def ephemeral_storage(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        *Deprecated.*
        """
    ...
    def ephemeral_storage(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ephemeral_storage", value)

    @property
    @pulumi.getter(name="instanceMatchCriteria")
    def instance_match_criteria(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_match_criteria(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_match_criteria", value)

    @property
    @pulumi.getter(name="outPostArn")
    def out_post_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @out_post_arn.setter
    def out_post_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unused_reservation_billing_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unused_reservation_billing_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CapacityReservation(pulumi.CustomResource):
    ...
    def available_instance_count(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def capacity_reservation_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def capacity_reservation_fleet_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def delivery_preference(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="endDateType")
    def end_date_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates the way in which the Capacity Reservation ends. A Capacity Reservation can have one of the following end types:
    ...
    @property
    @pulumi.getter(name="ephemeralStorage")
    def ephemeral_storage(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        *Deprecated.*
        """
        return pulumi.get(self, "ephemeral_storage")
    ...
    @property
    @pulumi.getter(name="instanceMatchCriteria")
    def instance_match_criteria(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates the type of instance launches that the Capacity Reservation accepts. The options include:
    ...
    @property
    @pulumi.getter(name="outPostArn")
    def out_post_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        > Not supported for future-dated Capacity Reservations. 
    ...
    @property
    @pulumi.getter(name="placementGroupArn")
    def placement_group_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        > Not supported for future-dated Capacity Reservations. 
    ...
    @property
    @pulumi.getter
    def tenancy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates the tenancy of the Capacity Reservation. A Capacity Reservation can have one of the following tenancy settings:
    ...
    @property
    @pulumi.getter(name="unusedReservationBillingOwnerId")
    def unused_reservation_billing_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the AWS account to which to assign billing of the unused capacity of the Capacity Reservation. A request will be sent to the specified account. That account must accept the request for the billing to be assigned to their account. For more information, see [Billing assignment for shared Amazon EC2 Capacity Reservations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/assign-billing.html) .
