...
class CapacityReservationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] availability_zone_id: The Availability Zone ID of the Capacity Reservation.
        ...
        :param pulumi.Input[str] instance_match_criteria: Indicates the type of instance launches that the Capacity Reservation accepts. The options include:
               ...
               Default: `open`
        :param pulumi.Input[str] out_post_arn: > Not supported for future-dated Capacity Reservations. 
               
               The Amazon Resource Name (ARN) of the Outpost on which to create the Capacity Reservation.
        :param pulumi.Input[str] placement_group_arn: > Not supported for future-dated Capacity Reservations. 
        ...
        :param pulumi.Input[str] unused_reservation_billing_owner_id: The ID of the AWS account to which to assign billing of the unused capacity of the Capacity Reservation. A request will be sent to the specified account. That account must accept the request for the billing to be assigned to their account. For more information, see [Billing assignment for shared Amazon EC2 Capacity Reservations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/assign-billing.html) .
