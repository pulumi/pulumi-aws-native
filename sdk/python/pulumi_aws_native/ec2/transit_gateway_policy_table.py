...
__all__ = ['TransitGatewayPolicyTableArgs', 'TransitGatewayPolicyTable']

@pulumi.input_type
class TransitGatewayPolicyTableArgs:
...
@pulumi.type_token("aws-native:ec2:TransitGatewayPolicyTable")
class TransitGatewayPolicyTable(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TransitGatewayPolicyTableArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TransitGatewayPolicyTableArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TransitGatewayPolicyTableArgs.__new__(TransitGatewayPolicyTableArgs)
        ...
        super(TransitGatewayPolicyTable, __self__).__init__(
            'aws-native:ec2:TransitGatewayPolicyTable',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TransitGatewayPolicyTable':
        """
        ...
        __props__.__dict__["transit_gateway_policy_table_id"] = None
        return TransitGatewayPolicyTable(resource_name, opts=opts, __props__=__props__)
