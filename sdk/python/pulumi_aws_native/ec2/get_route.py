...
def get_route(cidr_block: Optional[builtins.str] = None,
    ...
    :param builtins.str cidr_block: The IPv4 CIDR block.
    :param builtins.str route_table_id: The ID of the route table for the route.
    """
    __args__ = dict()
...
def get_route_output(cidr_block: Optional[pulumi.Input[builtins.str]] = None,
