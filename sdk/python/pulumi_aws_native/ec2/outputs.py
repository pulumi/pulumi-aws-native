...
class Ec2FleetPerformanceFactorReferenceRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str instance_family: The instance family to use as a baseline reference.
               ...
               If you specify an unsupported instance family as a value for baseline performance, the API returns an empty response for `API_GetInstanceTypesFromInstanceRequirements` and an exception for `API_CreateFleet` , `API_RequestSpotFleet` , `API_ModifyFleet` , and `API_ModifySpotFleetRequest` .
        """
...
class SpotFleetInstanceNetworkInterfaceSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int secondary_private_ip_address_count: The number of secondary private IPv4 addresses. You can’t specify this parameter and also specify a secondary private IP address using the `PrivateIpAddress` parameter.
