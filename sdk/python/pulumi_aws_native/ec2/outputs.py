...
class CapacityReservationCapacityAllocation(dict):
    ...
    def __init__(__self__, *,
                 allocation_type: Optional[builtins.str] = None,
                 count: Optional[builtins.int] = None):
        """
        :param builtins.str allocation_type: The usage type. `used` indicates that the instance capacity is in use by instances that are running in the Capacity Reservation.
        :param builtins.int count: The amount of instance capacity associated with the usage. For example a value of `4` indicates that instance capacity for 4 instances is currently in use.
        """
    ...
    def allocation_type(self) -> Optional[builtins.str]:
        """
...
class CapacityReservationFleetInstanceTypeSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_platform: Optional[builtins.str] = None,
                 instance_type: Optional[builtins.str] = None,
                 priority: Optional[builtins.int] = None,
                 weight: Optional[builtins.float] = None):
        """
        :param builtins.str availability_zone: The Availability Zone in which the Capacity Reservation Fleet reserves the capacity. A Capacity Reservation Fleet can't span Availability Zones. All instance type specifications that you specify for the Fleet must use the same Availability Zone.
        :param builtins.str availability_zone_id: The ID of the Availability Zone in which the Capacity Reservation Fleet reserves the capacity. A Capacity Reservation Fleet can't span Availability Zones. All instance type specifications that you specify for the Fleet must use the same Availability Zone.
        :param builtins.bool ebs_optimized: Indicates whether the Capacity Reservation Fleet supports EBS-optimized instances types. This optimization provides dedicated throughput to Amazon EBS and an optimized configuration stack to provide optimal I/O performance. This optimization isn't available with all instance types. Additional usage charges apply when using EBS-optimized instance types.
        :param builtins.str instance_platform: The type of operating system for which the Capacity Reservation Fleet reserves capacity.
        :param builtins.str instance_type: The instance type for which the Capacity Reservation Fleet reserves capacity.
        :param builtins.int priority: The priority to assign to the instance type. This value is used to determine which of the instance types specified for the Fleet should be prioritized for use. A lower value indicates a high priority. For more information, see [Instance type priority](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/crfleet-concepts.html#instance-priority) in the *Amazon EC2 User Guide* .
        :param builtins.float weight: The number of capacity units provided by the specified instance type. This value, together with the total target capacity that you specify for the Fleet determine the number of instances for which the Fleet reserves capacity. Both values are based on units that make sense for your workload. For more information, see [Total target capacity](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/crfleet-concepts.html#target-capacity) in the Amazon EC2 User Guide.
    ...
    def instance_platform(self) -> Optional[builtins.str]:
        """
...
class CapacityReservationFleetTagSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_type: The type of resource to tag on creation. Specify `capacity-reservation-fleet` .
...
class CapacityReservationTagSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_type: The type of resource to tag. Specify `capacity-reservation` .
...
class CommitmentInfoProperties(dict):
    ...
    def __init__(__self__, *,
                 commitment_end_date: Optional[builtins.str] = None,
                 committed_instance_count: Optional[builtins.int] = None):
        """
        :param builtins.str commitment_end_date: The date and time at which the commitment duration expires, in the ISO8601 format in the UTC time zone ( `YYYY-MM-DDThh:mm:ss.sssZ` ). You can't decrease the instance count or cancel the Capacity Reservation before this date and time.
        :param builtins.int committed_instance_count: The instance capacity that you committed to when you requested the future-dated Capacity Reservation.
        """
    ...
    def commitment_end_date(self) -> Optional[builtins.str]:
        """
    ...
    def committed_instance_count(self) -> Optional[builtins.int]:
        """
...
class CpuOptionsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The CPU options for the instance.
        :param builtins.int core_count: The number of CPU cores for the instance.
        :param builtins.int threads_per_core: The number of threads per CPU core.
        """
...
class CreditSpecificationProperties(dict):
    ...
    def __init__(__self__, *,
                 cpu_credits: Optional[builtins.str] = None):
        """
        The credit option for CPU usage of the burstable performance instance. Valid values are standard and unlimited.
        :param builtins.str cpu_credits: The credit option for CPU usage of the instance.
    ...
    def cpu_credits(self) -> Optional[builtins.str]:
        """
...
class DestinationOptionsProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hive_compatible_partitions: builtins.bool,
                 per_hour_partition: builtins.bool):
        """
        The destination options.
        :param 'FlowLogDestinationOptionsPropertiesFileFormat' file_format: The format for the flow log. The default is `plain-text` .
        :param builtins.bool hive_compatible_partitions: Indicates whether to use Hive-compatible prefixes for flow logs stored in Amazon S3. The default is `false` .
        :param builtins.bool per_hour_partition: Indicates whether to partition the flow log per hour. This reduces the cost and response time for queries. The default is `false` .
        """
    ...
    def hive_compatible_partitions(self) -> builtins.bool:
        """
    ...
    def per_hour_partition(self) -> builtins.bool:
        """
...
class Ec2FleetAcceleratorCountRequest(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max: The maximum number of accelerators. To specify no maximum limit, omit this parameter. To exclude accelerator-enabled instance types, set `Max` to `0` .
        :param builtins.int min: The minimum number of accelerators. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
...
class Ec2FleetAcceleratorTotalMemoryMiBRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.int] = None):
        """
        :param builtins.int max: The maximum amount of accelerator memory, in MiB. To specify no maximum limit, omit this parameter.
        :param builtins.int min: The minimum amount of accelerator memory, in MiB. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetBaselineEbsBandwidthMbpsRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.int] = None):
        """
        :param builtins.int max: The maximum baseline bandwidth, in Mbps. To specify no maximum limit, omit this parameter.
        :param builtins.int min: The minimum baseline bandwidth, in Mbps. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetCapacityRebalance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 termination_delay: Optional[builtins.int] = None):
        """
        ...
        :param builtins.int termination_delay: The amount of time (in seconds) that Amazon EC2 waits before terminating the old Spot Instance after launching a new replacement Spot Instance.
    ...
    def termination_delay(self) -> Optional[builtins.int]:
        """
...
class Ec2FleetEbsBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool delete_on_termination: Indicates whether the EBS volume is deleted on instance termination. For more information, see [Preserving Amazon EBS volumes on instance termination](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#preserving-volumes-on-termination) in the *Amazon EC2 User Guide* .
        :param builtins.bool encrypted: Indicates whether the encryption state of an EBS volume is changed while being restored from a backing snapshot. The effect of setting the encryption state to `true` depends on the volume origin (new or from a snapshot), starting encryption state, ownership, and whether encryption by default is enabled. For more information, see [Amazon EBS encryption](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-encryption.html#encryption-parameters) in the *Amazon EBS User Guide* .
        ...
        :param builtins.str kms_key_id: Identifier (key ID, key alias, key ARN, or alias ARN) of the customer managed KMS key to use for EBS encryption.
               
               This parameter is only supported on `BlockDeviceMapping` objects called by [RunInstances](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html) , [RequestSpotFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestSpotFleet.html) , and [RequestSpotInstances](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestSpotInstances.html) .
        :param builtins.str snapshot_id: The ID of the snapshot.
        :param builtins.int volume_size: The size of the volume, in GiBs. You must specify either a snapshot ID or a volume size. If you specify a snapshot, the default is the snapshot size. You can specify a volume size that is equal to or larger than the snapshot size.
...
class Ec2FleetFleetLaunchTemplateOverridesRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weighted_capacity: Optional[builtins.float] = None):
        """
        :param builtins.str availability_zone: The Availability Zone in which to launch the instances.
        ...
        :param builtins.str max_price: The maximum price per unit hour that you are willing to pay for a Spot Instance. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.
        ...
        :param builtins.float priority: The priority for the launch template override. The highest priority is launched first.
        ...
        :param builtins.str subnet_id: The IDs of the subnets in which to launch the instances. Separate multiple subnet IDs using commas (for example, `subnet-1234abcdeexample1, subnet-0987cdef6example2` ). A request of type `instant` can have only one subnet ID.
        :param builtins.float weighted_capacity: The number of units provided by the specified instance type. These are the same units that you chose to set the target capacity in terms of instances, or a performance characteristic such as vCPUs, memory, or I/O.
    ...
    def weighted_capacity(self) -> Optional[builtins.float]:
        """
...
class Ec2FleetFleetLaunchTemplateSpecificationRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str version: The launch template version number, `$Latest` , or `$Default` . You must specify a value, otherwise the request fails.
...
class Ec2FleetInstanceRequirementsRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['Ec2FleetInstanceRequirementsRequestCpuManufacturersItem'] cpu_manufacturers: The CPU manufacturers to include.
               ...
               Default: Any manufacturer
        :param Sequence[builtins.str] excluded_instance_types: The instance types to exclude.
        ...
        :param Sequence['Ec2FleetInstanceRequirementsRequestLocalStorageTypesItem'] local_storage_types: The type of local storage that is required.
               ...
               Default: `hdd` and `ssd`
        :param builtins.int max_spot_price_as_percentage_of_optimal_on_demand_price: [Price protection] The price protection threshold for Spot Instances, as a percentage of an identified On-Demand price. The identified On-Demand price is the price of the lowest priced current generation C, M, or R instance type with your specified attributes. If no current generation C, M, or R instance type matches your attributes, then the identified price is from the lowest priced current generation instance types, and failing that, from the lowest priced previous generation instance types that match your attributes. When Amazon EC2 selects instance types with your attributes, it will exclude instance types whose price exceeds your specified threshold.
        ...
        :param 'Ec2FleetNetworkInterfaceCountRequest' network_interface_count: The minimum and maximum number of network interfaces.
               ...
               Default: No minimum or maximum limits
        :param builtins.int on_demand_max_price_percentage_over_lowest_price: [Price protection] The price protection threshold for On-Demand Instances, as a percentage higher than an identified On-Demand price. The identified On-Demand price is the price of the lowest priced current generation C, M, or R instance type with your specified attributes. When Amazon EC2 selects instance types with your attributes, it will exclude instance types whose price exceeds your specified threshold.
               ...
               Default: `20`
        :param builtins.bool require_hibernate_support: Indicates whether instance types must support hibernation for On-Demand Instances.
               
               This parameter is not supported for [GetSpotPlacementScores](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetSpotPlacementScores.html) .
               
               Default: `false`
        :param builtins.int spot_max_price_percentage_over_lowest_price: [Price protection] The price protection threshold for Spot Instances, as a percentage higher than an identified Spot price. The identified Spot price is the Spot price of the lowest priced current generation C, M, or R instance type with your specified attributes. If no current generation C, M, or R instance type matches your attributes, then the identified Spot price is from the lowest priced current generation instance types, and failing that, from the lowest priced previous generation instance types that match your attributes. When Amazon EC2 selects instance types with your attributes, it will exclude instance types whose Spot price exceeds your specified threshold.
...
class Ec2FleetMemoryGiBPerVCpuRequest(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float max: The maximum amount of memory per vCPU, in GiB. To specify no maximum limit, omit this parameter.
        :param builtins.float min: The minimum amount of memory per vCPU, in GiB. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetMemoryMiBRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.int] = None):
        """
        :param builtins.int max: The maximum amount of memory, in MiB. To specify no maximum limit, omit this parameter.
        :param builtins.int min: The minimum amount of memory, in MiB. To specify no minimum limit, specify `0` .
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetNetworkBandwidthGbpsRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.float] = None):
        """
        :param builtins.float max: The maximum amount of network bandwidth, in Gbps. To specify no maximum limit, omit this parameter.
        :param builtins.float min: The minimum amount of network bandwidth, in Gbps. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetNetworkInterfaceCountRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.int] = None):
        """
        :param builtins.int max: The maximum number of network interfaces. To specify no maximum limit, omit this parameter.
        :param builtins.int min: The minimum number of network interfaces. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetOnDemandOptionsRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_total_price: Optional[builtins.str] = None,
                 min_target_capacity: Optional[builtins.int] = None,
                 single_availability_zone: Optional[builtins.bool] = None,
                 single_instance_type: Optional[builtins.bool] = None):
        """
        :param builtins.str allocation_strategy: The strategy that determines the order of the launch template overrides to use in fulfilling On-Demand capacity.
        ...
        :param 'Ec2FleetCapacityReservationOptionsRequest' capacity_reservation_options: The strategy for using unused Capacity Reservations for fulfilling On-Demand capacity.
               ...
               Supported only for fleets of type `instant` .
        :param builtins.str max_total_price: The maximum amount per hour for On-Demand Instances that you're willing to pay.
        ...
        :param builtins.int min_target_capacity: The minimum target capacity for On-Demand Instances in the fleet. If this minimum capacity isn't reached, no instances are launched.
               
               Constraints: Maximum value of `1000` . Supported only for fleets of type `instant` .
               
               At least one of the following must be specified: `SingleAvailabilityZone` | `SingleInstanceType`
        :param builtins.bool single_availability_zone: Indicates that the fleet launches all On-Demand Instances into a single Availability Zone.
               
               Supported only for fleets of type `instant` .
        :param builtins.bool single_instance_type: Indicates that the fleet uses a single instance type to launch all On-Demand Instances in the fleet.
    ...
    def max_total_price(self) -> Optional[builtins.str]:
        """
    ...
    def min_target_capacity(self) -> Optional[builtins.int]:
        """
    ...
    def single_availability_zone(self) -> Optional[builtins.bool]:
        """
    ...
    def single_instance_type(self) -> Optional[builtins.bool]:
        """
...
class Ec2FleetPlacement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 spread_domain: Optional[builtins.str] = None,
                 tenancy: Optional[builtins.str] = None):
        """
        :param builtins.str affinity: The affinity setting for the instance on the Dedicated Host.
        ...
        :param builtins.int partition_number: The number of the partition that the instance is in. Valid only if the placement group strategy is set to `partition` .
               ...
               This parameter is not supported for [CreateFleet](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet) .
        :param builtins.str spread_domain: Reserved for future use.
        :param builtins.str tenancy: The tenancy of the instance. An instance with a tenancy of `dedicated` runs on single-tenant hardware.
    ...
    def spread_domain(self) -> Optional[builtins.str]:
        """
...
class Ec2FleetSpotOptionsRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_pools_to_use_count: Optional[builtins.int] = None,
        ...
        :param builtins.str max_total_price: The maximum amount per hour for Spot Instances that you're willing to pay. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.
        ...
        :param builtins.int min_target_capacity: The minimum target capacity for Spot Instances in the fleet. If this minimum capacity isn't reached, no instances are launched.
               
               Constraints: Maximum value of `1000` . Supported only for fleets of type `instant` .
               
               At least one of the following must be specified: `SingleAvailabilityZone` | `SingleInstanceType`
        :param builtins.bool single_availability_zone: Indicates that the fleet launches all Spot Instances into a single Availability Zone.
               
               Supported only for fleets of type `instant` .
        :param builtins.bool single_instance_type: Indicates that the fleet uses a single instance type to launch all Spot Instances in the fleet.
    ...
    def instance_pools_to_use_count(self) -> Optional[builtins.int]:
        """
...
class Ec2FleetTargetCapacitySpecificationRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 on_demand_target_capacity: Optional[builtins.int] = None,
                 spot_target_capacity: Optional[builtins.int] = None,
                 target_capacity_unit_type: Optional['Ec2FleetTargetCapacitySpecificationRequestTargetCapacityUnitType'] = None):
        """
        :param builtins.int total_target_capacity: The number of units to request, filled using the default target capacity type.
        ...
        :param builtins.int on_demand_target_capacity: The number of On-Demand units to request.
        :param builtins.int spot_target_capacity: The number of Spot units to request.
    ...
    def total_target_capacity(self) -> builtins.int:
        """
    ...
    def on_demand_target_capacity(self) -> Optional[builtins.int]:
        """
    ...
    def spot_target_capacity(self) -> Optional[builtins.int]:
        """
...
class Ec2FleetTotalLocalStorageGbRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.float] = None):
        """
        :param builtins.float max: The maximum amount of total local storage, in GB. To specify no maximum limit, omit this parameter.
        :param builtins.float min: The minimum amount of total local storage, in GB. To specify no minimum limit, omit this parameter.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class Ec2FleetVCpuCountRangeRequest(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.int] = None):
        """
        :param builtins.int max: The maximum number of vCPUs. To specify no maximum limit, omit this parameter.
        :param builtins.int min: The minimum number of vCPUs. To specify no minimum limit, specify `0` .
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class EnclaveOptionsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Indicates whether the instance is enabled for AWS Nitro Enclaves.
        :param builtins.bool enabled: If this parameter is set to true, the instance is enabled for AWS Nitro Enclaves; otherwise, it is not enabled for AWS Nitro Enclaves.
        """
...
class HibernationOptionsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Indicates whether an instance is enabled for hibernation.
        :param builtins.bool configured: If you set this parameter to true, your instance is enabled for hibernation.
        """
...
class InstanceAssociationParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The name of an input parameter that is in the associated SSM document.
        :param Sequence[builtins.str] value: The value of an input parameter.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class InstanceBlockDeviceMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str virtual_name: The virtual device name ( `ephemeral` N). The name must be in the form `ephemeral` *X* where *X* is a number starting from zero (0). For example, an instance type with 2 available instance store volumes can specify mappings for `ephemeral0` and `ephemeral1` . The number of available instance store volumes depends on the instance type. After you connect to the instance, you must mount the volume.
...
class InstanceEbs(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool delete_on_termination: Indicates whether the EBS volume is deleted on instance termination.
        :param builtins.bool encrypted: Indicates whether the volume should be encrypted.
        :param builtins.int iops: The number of I/O operations per second (IOPS). For gp3, io1, and io2 volumes, this represents the number of IOPS that are provisioned for the volume. For gp2 volumes, this represents the baseline performance of the volume and the rate at which the volume accumulates I/O credits for bursting.
        :param builtins.str kms_key_id: The identifier of the AWS Key Management Service (AWS KMS) customer managed CMK to use for Amazon EBS encryption. If KmsKeyId is specified, the encrypted state must be true. If the encrypted state is true but you do not specify KmsKeyId, your AWS managed CMK for EBS is used.
        :param builtins.str snapshot_id: The ID of the snapshot.
        :param builtins.int volume_size: The size of the volume, in GiBs. You must specify either a snapshot ID or a volume size. If you specify a snapshot, the default is the snapshot size. You can specify a volume size that is equal to or larger than the snapshot size.
...
class InstanceEnaSrdSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the ENA Express settings for the network interface that's attached to the instance.
        :param builtins.bool ena_srd_enabled: Specifies whether ENA Express is enabled for the network interface when you launch an instance.
    ...
    def ena_srd_enabled(self) -> Optional[builtins.bool]:
        """
...
class InstanceEnaSrdUdpSpecification(dict):
    ...
    def __init__(__self__, *,
                 ena_srd_udp_enabled: Optional[builtins.bool] = None):
        """
        Contains ENA Express settings for UDP network traffic for the network interface that's attached to the instance.
        :param builtins.bool ena_srd_udp_enabled: Indicates whether UDP traffic uses ENA Express for your instance.
        """
    ...
    def ena_srd_udp_enabled(self) -> Optional[builtins.bool]:
        """
...
class InstanceLaunchTemplateSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str launch_template_id: The ID of the launch template. You must specify the LaunchTemplateName or the LaunchTemplateId, but not both.
        :param builtins.str launch_template_name: The name of the launch template. You must specify the LaunchTemplateName or the LaunchTemplateId, but not both.
...
class InstanceLicenseSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str license_configuration_arn: The Amazon Resource Name (ARN) of the license configuration.
        """
...
class InstanceNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 ...
                 associate_carrier_ip_address: Optional[builtins.bool] = None,
                 associate_public_ip_address: Optional[builtins.bool] = None,
                 delete_on_termination: Optional[builtins.bool] = None,
                 description: Optional[builtins.str] = None,
                 ena_srd_specification: Optional['outputs.InstanceEnaSrdSpecification'] = None,
                 group_set: Optional[Sequence[builtins.str]] = None,
                 ...
                 secondary_private_ip_address_count: Optional[builtins.int] = None,
                 subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str device_index: The position of the network interface in the attachment order. A primary network interface has a device index of 0.
        :param builtins.bool associate_carrier_ip_address: Not currently supported by AWS CloudFormation.
        :param builtins.bool associate_public_ip_address: Indicates whether to assign a public IPv4 address to an instance you launch in a VPC.
        :param builtins.bool delete_on_termination: If set to true, the interface is deleted when the instance is terminated.
        :param builtins.str description: The description of the network interface.
        :param 'InstanceEnaSrdSpecification' ena_srd_specification: Configures ENA Express for UDP network traffic.
        :param Sequence[builtins.str] group_set: The IDs of the security groups for the network interface.
        :param builtins.int ipv6_address_count: A number of IPv6 addresses to assign to the network interface.
        ...
        :param builtins.str private_ip_address: The private IPv4 address of the network interface.
        ...
        :param builtins.int secondary_private_ip_address_count: The number of secondary private IPv4 addresses.
    ...
    def associate_carrier_ip_address(self) -> Optional[builtins.bool]:
        """
    ...
    def associate_public_ip_address(self) -> Optional[builtins.bool]:
        """
...
class InstancePrivateDnsNameOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_resource_name_dns_a_record: Indicates whether to respond to DNS queries for instance hostnames with DNS A records. For more information, see Amazon EC2 instance hostname types in the Amazon Elastic Compute Cloud User Guide.
        :param builtins.bool enable_resource_name_dns_aaaa_record: Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records. For more information, see Amazon EC2 instance hostname types in the Amazon Elastic Compute Cloud User Guide.
...
class InstancePrivateIpAddressSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool primary: Indicates whether the private IPv4 address is the primary private IPv4 address. Only one IPv4 address can be designated as primary.
        :param builtins.str private_ip_address: The private IPv4 addresses.
        """
...
class InstanceSsmAssociation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str document_name: The name of an SSM document to associate with the instance.
...
class InstanceState(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The current state of the instance
        :param builtins.str code: The state of the instance as a 16-bit unsigned integer.
        :param builtins.str name: The current state of the instance.
        """
        if code is not None:
...
class InstanceVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str device: The device name (for example, /dev/sdh or xvdh).
        :param builtins.str volume_id: The ID of the EBS volume. The volume and instance must be within the same Availability Zone.
        """
...
class IpamOperatingRegion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The regions IPAM is enabled for. Allows pools to be created in these regions, as well as enabling monitoring
        :param builtins.str region_name: The name of the region.
        """
...
class IpamOrganizationalUnitExclusion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        If your IPAM is integrated with AWS Organizations and you add an organizational unit (OU) exclusion, IPAM will not manage the IP addresses in accounts in that OU exclusion.
        :param builtins.str organizations_entity_path: An AWS Organizations entity path. Build the path for the OU(s) using AWS Organizations IDs separated by a '/'. Include all child OUs by ending the path with '/*'.
        """
...
class IpamPoolProvisionedCidr(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An address space to be inserted into this pool. All allocations must be made from this address space.
        :param builtins.str cidr: The CIDR provisioned to the IPAM pool. A CIDR is a representation of an IP address and its associated network mask (or netmask) and refers to a range of IP addresses. An IPv4 CIDR example is `10.24.34.0/23` . An IPv6 CIDR example is `2001:DB8::/32` .
        """
...
class IpamPoolSourceResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The resource associated with this pool's space. Depending on the ResourceType, setting a SourceResource changes which space can be provisioned in this pool and which types of resources can receive allocations
        :param builtins.str resource_id: The source resource ID.
        :param builtins.str resource_owner: The source resource owner.
        :param builtins.str resource_region: The source resource Region.
        :param builtins.str resource_type: The source resource type.
        """
...
class LaunchTemplateBlockDeviceMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str no_device: To omit the device from the block device mapping, specify an empty string.
        :param builtins.str virtual_name: The virtual device name (ephemeralN). Instance store volumes are numbered starting from 0. An instance type with 2 available instance store volumes can specify mappings for ephemeral0 and ephemeral1. The number of available instance store volumes depends on the instance type. After you connect to the instance, you must mount the volume.
        """
        if device_name is not None:
            pulumi.set(__self__, "device_name", device_name)
        if ebs is not None:
...
class LaunchTemplateCapacityReservationSpecification(dict):
    ...
    def __init__(__self__, *,
                 capacity_reservation_preference: Optional[builtins.str] = None,
                 capacity_reservation_target: Optional['outputs.LaunchTemplateCapacityReservationTarget'] = None):
        """
        Specifies an instance's Capacity Reservation targeting option. You can specify only one option at a time.
         ``CapacityReservationSpecification`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.str capacity_reservation_preference: Indicates the instance's Capacity Reservation preferences. Possible preferences include:
    ...
    def capacity_reservation_preference(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplateCapacityReservationTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies a target Capacity Reservation.
         ``CapacityReservationTarget`` is a property of the [Amazon EC2 LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html) property type.
        :param builtins.str capacity_reservation_id: The ID of the Capacity Reservation in which to run the instance.
        :param builtins.str capacity_reservation_resource_group_arn: The ARN of the Capacity Reservation resource group in which to run the instance.
        """
...
class LaunchTemplateConnectionTrackingSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A security group connection tracking specification that enables you to set the idle timeout for connection tracking on an Elastic network interface. For more information, see [Connection tracking timeouts](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/security-group-connection-tracking.html#connection-tracking-timeouts) in the *Amazon EC2 User Guide*.
        :param builtins.int tcp_established_timeout: Timeout (in seconds) for idle TCP connections in an established state. Min: 60 seconds. Max: 432000 seconds (5 days). Default: 432000 seconds. Recommended: Less than 432000 seconds.
        :param builtins.int udp_stream_timeout: Timeout (in seconds) for idle UDP flows classified as streams which have seen more than one request-response transaction. Min: 60 seconds. Max: 180 seconds (3 minutes). Default: 180 seconds.
        :param builtins.int udp_timeout: Timeout (in seconds) for idle UDP flows that have seen traffic only in a single direction or a single request-response transaction. Min: 30 seconds. Max: 60 seconds. Default: 30 seconds.
        """
...
class LaunchTemplateCpuOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int core_count: The number of CPU cores for the instance.
        :param builtins.int threads_per_core: The number of threads per CPU core. To disable multithreading for the instance, specify a value of ``1``. Otherwise, specify the default value of ``2``.
        """
...
class LaunchTemplateCreditSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the credit option for CPU usage of a T2, T3, or T3a instance.
         ``CreditSpecification`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.str cpu_credits: The credit option for CPU usage of a T instance.
                Valid values: ``standard`` | ``unlimited``
        """
        if cpu_credits is not None:
            pulumi.set(__self__, "cpu_credits", cpu_credits)
...
class LaunchTemplateData(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_api_termination: Optional[builtins.bool] = None,
                 ebs_optimized: Optional[builtins.bool] = None,
                 ...
                 instance_initiated_shutdown_behavior: Optional[builtins.str] = None,
                 ...
                 instance_type: Optional[builtins.str] = None,
                 kernel_id: Optional[builtins.str] = None,
                 ...
                 ram_disk_id: Optional[builtins.str] = None,
        ...
        :param builtins.bool disable_api_stop: Indicates whether to enable the instance for stop protection. For more information, see [Enable stop protection for your EC2 instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-stop-protection.html) in the *Amazon EC2 User Guide*.
        :param builtins.bool disable_api_termination: Indicates whether termination protection is enabled for the instance. The default is ``false``, which means that you can terminate the instance using the Amazon EC2 console, command line tools, or API. You can enable termination protection when you launch an instance, while the instance is running, or while the instance is stopped.
        :param builtins.bool ebs_optimized: Indicates whether the instance is optimized for Amazon EBS I/O. This optimization provides dedicated throughput to Amazon EBS and an optimized configuration stack to provide optimal Amazon EBS I/O performance. This optimization isn't available with all instance types. Additional usage charges apply when using an EBS-optimized instance.
        ...
        :param builtins.str image_id: The ID of the AMI. Alternatively, you can specify a Systems Manager parameter, which will resolve to an AMI ID on launch.
                Valid formats:
        ...
        :param builtins.str instance_initiated_shutdown_behavior: Indicates whether an instance stops or terminates when you initiate shutdown from the instance (using the operating system command for system shutdown).
                Default: ``stop``
        ...
        :param builtins.str instance_type: The instance type. For more information, see [Amazon EC2 instance types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html) in the *Amazon EC2 User Guide*.
                If you specify ``InstanceType``, you can't specify ``InstanceRequirements``.
        :param builtins.str kernel_id: The ID of the kernel.
                We recommend that you use PV-GRUB instead of kernels and RAM disks. For more information, see [User Provided Kernels](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedkernels.html) in the *Amazon EC2 User Guide*.
        :param builtins.str key_name: The name of the key pair. You can create a key pair using [CreateKeyPair](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateKeyPair.html) or [ImportKeyPair](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ImportKeyPair.html).
        ...
        :param builtins.str ram_disk_id: The ID of the RAM disk.
                 We recommend that you use PV-GRUB instead of kernels and RAM disks. For more information, see [User provided kernels](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedkernels.html) in the *Amazon EC2 User Guide*.
        :param Sequence[builtins.str] security_group_ids: The IDs of the security groups. You can specify the IDs of existing security groups and references to resources created by the stack template.
                If you specify a network interface, you must specify any security groups as part of the network interface instead.
        :param Sequence[builtins.str] security_groups: The names of the security groups. For a nondefault VPC, you must use security group IDs instead.
        ...
        :param builtins.str user_data: The user data to make available to the instance. You must provide base64-encoded text. User data is limited to 16 KB. For more information, see [Run commands when you launch an EC2 instance with user data input](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/user-data.html) in the *Amazon EC2 User Guide*.
    ...
    def disable_api_termination(self) -> Optional[builtins.bool]:
        """
    ...
    def instance_initiated_shutdown_behavior(self) -> Optional[builtins.str]:
        """
    ...
    def kernel_id(self) -> Optional[builtins.str]:
        """
    ...
    def ram_disk_id(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplateEbs(dict):
    ...
    def __init__(__self__, *,
        ...
        Parameters for a block device for an EBS volume in an Amazon EC2 launch template.
         ``Ebs`` is a property of [AWS::EC2::LaunchTemplate BlockDeviceMapping](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-blockdevicemapping.html).
        :param builtins.bool delete_on_termination: Indicates whether the EBS volume is deleted on instance termination.
        :param builtins.bool encrypted: Indicates whether the EBS volume is encrypted. Encrypted volumes can only be attached to instances that support Amazon EBS encryption. If you are creating a volume from a snapshot, you can't specify an encryption value.
        :param builtins.int iops: The number of I/O operations per second (IOPS). For ``gp3``, ``io1``, and ``io2`` volumes, this represents the number of IOPS that are provisioned for the volume. For ``gp2`` volumes, this represents the baseline performance of the volume and the rate at which the volume accumulates I/O credits for bursting.
                The following are the supported values for each volume type:
                 +  ``gp3``: 3,000 - 16,000 IOPS
                 +  ``io1``: 100 - 64,000 IOPS
        ...
        :param builtins.int volume_size: The size of the volume, in GiBs. You must specify either a snapshot ID or a volume size. The following are the supported volumes sizes for each volume type:
                 ...
                 +  ``st1`` and ``sc1``: 125 - 16,384 GiB
                 +  ``standard``: 1 - 1024 GiB
        :param builtins.str volume_type: The volume type. For more information, see [Amazon EBS volume types](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-volume-types.html) in the *Amazon EBS User Guide*.
        """
        if delete_on_termination is not None:
            pulumi.set(__self__, "delete_on_termination", delete_on_termination)
        if encrypted is not None:
...
class LaunchTemplateEnaSrdUdpSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ENA Express is compatible with both TCP and UDP transport protocols. When it's enabled, TCP traffic automatically uses it. However, some UDP-based applications are designed to handle network packets that are out of order, without a need for retransmission, such as live video broadcasting or other near-real-time applications. For UDP traffic, you can specify whether to use ENA Express, based on your application environment needs.
        :param builtins.bool ena_srd_udp_enabled: Indicates whether UDP traffic to and from the instance uses ENA Express. To specify this setting, you must first enable ENA Express.
        """
        if ena_srd_udp_enabled is not None:
            pulumi.set(__self__, "ena_srd_udp_enabled", ena_srd_udp_enabled)
...
class LaunchTemplateHibernationOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies whether your instance is configured for hibernation. This parameter is valid only if the instance meets the [hibernation prerequisites](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Hibernate.html#hibernating-prerequisites). For more information, see [Hibernate Your Instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Hibernate.html) in the *Amazon EC2 User Guide*.
         ``HibernationOptions`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.bool configured: If you set this parameter to ``true``, the instance is enabled for hibernation.
                Default: ``false``
        """
        if configured is not None:
            pulumi.set(__self__, "configured", configured)
...
class LaunchTemplateIamInstanceProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies an IAM instance profile, which is a container for an IAM role for your instance. You can use an IAM role to distribute your AWS credentials to your instances.
         If you are creating the launch template for use with an ASlong group, you can specify either the name or the ARN of the instance profile, but not both.
         ``IamInstanceProfile`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.str arn: The Amazon Resource Name (ARN) of the instance profile.
        :param builtins.str name: The name of the instance profile.
        """
        if arn is not None:
...
class LaunchTemplateInstanceMarketOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the market (purchasing) option for an instance.
         ``InstanceMarketOptions`` is a property of the [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.str market_type: The market type.
...
class LaunchTemplateInstanceRequirements(dict):
    ...
    def __init__(__self__, *,
                 ...
                 accelerator_manufacturers: Optional[Sequence[builtins.str]] = None,
                 accelerator_names: Optional[Sequence[builtins.str]] = None,
                 accelerator_total_memory_mi_b: Optional['outputs.LaunchTemplateAcceleratorTotalMemoryMiB'] = None,
                 accelerator_types: Optional[Sequence[builtins.str]] = None,
                 allowed_instance_types: Optional[Sequence[builtins.str]] = None,
                 bare_metal: Optional[builtins.str] = None,
                 ...
                 cpu_manufacturers: Optional[Sequence[builtins.str]] = None,
                 excluded_instance_types: Optional[Sequence[builtins.str]] = None,
                 instance_generations: Optional[Sequence[builtins.str]] = None,
                 local_storage: Optional[builtins.str] = None,
                 local_storage_types: Optional[Sequence[builtins.str]] = None,
                 max_spot_price_as_percentage_of_optimal_on_demand_price: Optional[builtins.int] = None,
        ...
        :param 'LaunchTemplateAcceleratorCount' accelerator_count: The minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips) on an instance.
                To exclude accelerator-enabled instance types, set ``Max`` to ``0``.
                Default: No minimum or maximum limits
        :param Sequence[builtins.str] accelerator_manufacturers: Indicates whether instance types must have accelerators by specific manufacturers.
                 +  For instance types with AWS devices, specify ``amazon-web-services``.
                 +  For instance types with AMD devices, specify ``amd``.
                 +  For instance types with Habana devices, specify ``habana``.
                 +  For instance types with NVIDIA devices, specify ``nvidia``.
                ...
                Default: Any manufacturer
        :param Sequence[builtins.str] accelerator_names: The accelerators that must be on the instance type.
                 +  For instance types with NVIDIA A10G GPUs, specify ``a10g``.
                 +  For instance types with NVIDIA A100 GPUs, specify ``a100``.
                 +  For instance types with NVIDIA H100 GPUs, specify ``h100``.
                 +  For instance types with AWS Inferentia chips, specify ``inferentia``.
        ...
        :param 'LaunchTemplateAcceleratorTotalMemoryMiB' accelerator_total_memory_mi_b: The minimum and maximum amount of total accelerator memory, in MiB.
                Default: No minimum or maximum limits
        :param Sequence[builtins.str] accelerator_types: The accelerator types that must be on the instance type.
                 +  For instance types with FPGA accelerators, specify ``fpga``.
                 +  For instance types with GPU accelerators, specify ``gpu``.
                 +  For instance types with Inference accelerators, specify ``inference``.
        ...
        :param Sequence[builtins.str] allowed_instance_types: The instance types to apply your specified attributes against. All other instance types are ignored, even if they match your specified attributes.
                ...
                For example, if you specify ``c5*``,Amazon EC2 will allow the entire C5 instance family, which includes all C5a and C5n instance types. If you specify ``m5a.*``, Amazon EC2 will allow all the M5a instance types, but not the M5n instance types.
                 If you specify ``AllowedInstanceTypes``, you can't specify ``ExcludedInstanceTypes``.
                 Default: All instance types
        :param builtins.str bare_metal: Indicates whether bare metal instance types must be included, excluded, or required.
                 +  To include bare metal instance types, specify ``included``.
                 +  To require only bare metal instance types, specify ``required``.
                 +  To exclude bare metal instance types, specify ``excluded``.
        ...
        :param builtins.str burstable_performance: Indicates whether burstable performance T instance types are included, excluded, or required. For more information, see [Burstable performance instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html).
                 +  To include burstable performance instance types, specify ``included``.
                 +  To require only burstable performance instance types, specify ``required``.
                 +  To exclude burstable performance instance types, specify ``excluded``.
                 
                Default: ``excluded``
        :param Sequence[builtins.str] cpu_manufacturers: The CPU manufacturers to include.
                 +  For instance types with Intel CPUs, specify ``intel``.
                 +  For instance types with AMD CPUs, specify ``amd``.
                 +  For instance types with AWS CPUs, specify ``amazon-web-services``.
                 +  For instance types with Apple CPUs, specify ``apple``.
        ...
        :param Sequence[builtins.str] excluded_instance_types: The instance types to exclude.
                ...
                For example, if you specify ``c5*``,Amazon EC2 will exclude the entire C5 instance family, which includes all C5a and C5n instance types. If you specify ``m5a.*``, Amazon EC2 will exclude all the M5a instance types, but not the M5n instance types.
                 If you specify ``ExcludedInstanceTypes``, you can't specify ``AllowedInstanceTypes``.
                 Default: No excluded instance types
        :param Sequence[builtins.str] instance_generations: Indicates whether current or previous generation instance types are included. The current generation instance types are recommended for use. Current generation instance types are typically the latest two to three generations in each instance family. For more information, see [Instance types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html) in the *Amazon EC2 User Guide*.
                For current generation instance types, specify ``current``.
                For previous generation instance types, specify ``previous``.
                Default: Current and previous generation instance types
        :param builtins.str local_storage: Indicates whether instance types with instance store volumes are included, excluded, or required. For more information, [Amazon EC2 instance store](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html) in the *Amazon EC2 User Guide*.
                 +  To include instance types with instance store volumes, specify ``included``.
                 +  To require only instance types with instance store volumes, specify ``required``.
                 +  To exclude instance types with instance store volumes, specify ``excluded``.
                 
                Default: ``included``
        :param Sequence[builtins.str] local_storage_types: The type of local storage that is required.
                 +  For instance types with hard disk drive (HDD) storage, specify ``hdd``.
                 +  For instance types with solid state drive (SSD) storage, specify ``ssd``.
    ...
    @property
    @pulumi.getter(name="acceleratorManufacturers")
    def accelerator_manufacturers(self) -> Optional[Sequence[builtins.str]]:
        """
        Indicates whether instance types must have accelerators by specific manufacturers.
          +  For instance types with AWS devices, specify ``amazon-web-services``.
          +  For instance types with AMD devices, specify ``amd``.
    ...
    @property
    @pulumi.getter(name="acceleratorNames")
    def accelerator_names(self) -> Optional[Sequence[builtins.str]]:
        """
        The accelerators that must be on the instance type.
          +  For instance types with NVIDIA A10G GPUs, specify ``a10g``.
          +  For instance types with NVIDIA A100 GPUs, specify ``a100``.
    ...
    @property
    @pulumi.getter(name="acceleratorTypes")
    def accelerator_types(self) -> Optional[Sequence[builtins.str]]:
        """
        The accelerator types that must be on the instance type.
          +  For instance types with FPGA accelerators, specify ``fpga``.
          +  For instance types with GPU accelerators, specify ``gpu``.
    ...
    @property
    @pulumi.getter(name="bareMetal")
    def bare_metal(self) -> Optional[builtins.str]:
        """
        Indicates whether bare metal instance types must be included, excluded, or required.
          +  To include bare metal instance types, specify ``included``.
          +  To require only bare metal instance types, specify ``required``.
    ...
    @property
    @pulumi.getter(name="cpuManufacturers")
    def cpu_manufacturers(self) -> Optional[Sequence[builtins.str]]:
        """
        The CPU manufacturers to include.
          +  For instance types with Intel CPUs, specify ``intel``.
          +  For instance types with AMD CPUs, specify ``amd``.
    ...
    @property
    @pulumi.getter(name="localStorageTypes")
    def local_storage_types(self) -> Optional[Sequence[builtins.str]]:
        """
        The type of local storage that is required.
          +  For instance types with hard disk drive (HDD) storage, specify ``hdd``.
          +  For instance types with solid state drive (SSD) storage, specify ``ssd``.
...
class LaunchTemplateIpv4PrefixSpecification(dict):
    ...
    def __init__(__self__, *,
                 ipv4_prefix: Optional[builtins.str] = None):
        """
        Specifies an IPv4 prefix for a network interface.
         ``Ipv4PrefixSpecification`` is a property of [AWS::EC2::LaunchTemplate NetworkInterface](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-networkinterface.html).
        :param builtins.str ipv4_prefix: The IPv4 prefix. For information, see [Assigning prefixes to network interfaces](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-prefix-eni.html) in the *Amazon EC2 User Guide*.
        """
    ...
    def ipv4_prefix(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplateIpv6Add(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies an IPv6 address in an Amazon EC2 launch template.
         ``Ipv6Add`` is a property of [AWS::EC2::LaunchTemplate NetworkInterface](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-networkinterface.html).
        :param builtins.str ipv6_address: One or more specific IPv6 addresses from the IPv6 CIDR block range of your subnet. You can't use this option if you're specifying a number of IPv6 addresses.
        """
...
class LaunchTemplateIpv6PrefixSpecification(dict):
    ...
    def __init__(__self__, *,
                 ipv6_prefix: Optional[builtins.str] = None):
        """
        Specifies an IPv6 prefix for a network interface.
         ``Ipv6PrefixSpecification`` is a property of [AWS::EC2::LaunchTemplate NetworkInterface](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-networkinterface.html).
        :param builtins.str ipv6_prefix: The IPv6 prefix.
        """
...
class LaunchTemplateMaintenanceOptions(dict):
    ...
    def __init__(__self__, *,
                 auto_recovery: Optional[builtins.str] = None):
        """
        The maintenance options of your instance.
        :param builtins.str auto_recovery: Disables the automatic recovery behavior of your instance or sets it to default.
        """
    ...
    def auto_recovery(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplateMetadataOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 http_protocol_ipv6: Optional[builtins.str] = None,
                 http_put_response_hop_limit: Optional[builtins.int] = None,
                 http_tokens: Optional[builtins.str] = None,
                 instance_metadata_tags: Optional[builtins.str] = None):
        """
        The metadata options for the instance. For more information, see [Instance metadata and user data](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html) in the *Amazon EC2 User Guide*.
         ``MetadataOptions`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.str http_endpoint: Enables or disables the HTTP metadata endpoint on your instances. If the parameter is not specified, the default state is ``enabled``.
                 If you specify a value of ``disabled``, you will not be able to access your instance metadata.
        :param builtins.str http_protocol_ipv6: Enables or disables the IPv6 endpoint for the instance metadata service.
                Default: ``disabled``
        :param builtins.int http_put_response_hop_limit: The desired HTTP PUT response hop limit for instance metadata requests. The larger the number, the further instance metadata requests can travel.
                Default: ``1``
                Possible values: Integers from 1 to 64
        :param builtins.str http_tokens: Indicates whether IMDSv2 is required.
    ...
    @property
    @pulumi.getter(name="httpProtocolIpv6")
    def http_protocol_ipv6(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="instanceMetadataTags")
    def instance_metadata_tags(self) -> Optional[builtins.str]:
        """
        Set to ``enabled`` to allow access to instance tags from the instance metadata. Set to ``disabled`` to turn off access to instance tags from the instance metadata. For more information, see [View tags for your EC2 instances using instance metadata](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/work-with-tags-in-IMDS.html).
         Default: ``disabled``
        """
...
class LaunchTemplateMonitoring(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies whether detailed monitoring is enabled for an instance. For more information about detailed monitoring, see [Enable or turn off detailed monitoring for your instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-cloudwatch-new.html) in the *User Guide*.
         ``Monitoring`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.bool enabled: Specify ``true`` to enable detailed monitoring. Otherwise, basic monitoring is enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class LaunchTemplateNetworkBandwidthGbps(dict):
    ...
    def __init__(__self__, *,
        ...
        The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps).
          Setting the minimum bandwidth does not guarantee that your instance will achieve the minimum bandwidth. Amazon EC2 will identify instance types that support the specified minimum bandwidth, but the actual bandwidth of your instance might go below the specified minimum at times. For more information, see [Available instance bandwidth](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-network-bandwidth.html#available-instance-bandwidth) in the *Amazon EC2 User Guide*.
        :param builtins.float max: The maximum amount of network bandwidth, in Gbps. To specify no maximum limit, omit this parameter.
        :param builtins.float min: The minimum amount of network bandwidth, in Gbps. If this parameter is not specified, there is no minimum limit.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class LaunchTemplateNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ena_queue_count: Optional[builtins.int] = None,
                 ...
                 ipv4_prefix_count: Optional[builtins.int] = None,
                 ...
                 ipv6_prefix_count: Optional[builtins.int] = None,
                 ...
                 network_interface_id: Optional[builtins.str] = None,
                 primary_ipv6: Optional[builtins.bool] = None,
                 private_ip_address: Optional[builtins.str] = None,
        ...
        Specifies the parameters for a network interface.
         ``NetworkInterface`` is a property of [AWS::EC2::LaunchTemplate LaunchTemplateData](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata.html).
        :param builtins.bool associate_carrier_ip_address: Associates a Carrier IP address with eth0 for a new network interface.
                Use this option when you launch an instance in a Wavelength Zone and want to associate a Carrier IP address with the network interface. For more information about Carrier IP addresses, see [Carrier IP addresses](https://docs.aws.amazon.com/wavelength/latest/developerguide/how-wavelengths-work.html#provider-owned-ip) in the *Developer Guide*.
        :param builtins.bool associate_public_ip_address: Associates a public IPv4 address with eth0 for a new network interface.
        ...
        :param builtins.bool delete_on_termination: Indicates whether the network interface is deleted when the instance is terminated.
        :param builtins.str description: A description for the network interface.
        :param builtins.int device_index: The device index for the network interface attachment. The primary network interface has a device index of 0. If the network interface is of type ``interface``, you must specify a device index.
        ...
        :param builtins.int ena_queue_count: The number of ENA queues to be created with the instance.
        :param 'LaunchTemplateEnaSrdSpecification' ena_srd_specification: The ENA Express configuration for the network interface.
        :param Sequence[builtins.str] groups: The IDs of one or more security groups.
        :param builtins.str interface_type: The type of network interface. To create an Elastic Fabric Adapter (EFA), specify ``efa`` or ``efa``. For more information, see [Elastic Fabric Adapter for AI/ML and HPC workloads on Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html) in the *Amazon EC2 User Guide*.
                If you are not creating an EFA, specify ``interface`` or omit this parameter.
                If you specify ``efa-only``, do not assign any IP addresses to the network interface. EFA-only network interfaces do not support IP addresses.
                Valid values: ``interface`` | ``efa`` | ``efa-only``
        :param builtins.int ipv4_prefix_count: The number of IPv4 prefixes to be automatically assigned to the network interface. You cannot use this option if you use the ``Ipv4Prefix`` option.
        ...
        :param builtins.int ipv6_address_count: The number of IPv6 addresses to assign to a network interface. Amazon EC2 automatically selects the IPv6 addresses from the subnet range. You can't use this option if specifying specific IPv6 addresses.
        ...
        :param builtins.int ipv6_prefix_count: The number of IPv6 prefixes to be automatically assigned to the network interface. You cannot use this option if you use the ``Ipv6Prefix`` option.
        ...
        :param builtins.int network_card_index: The index of the network card. Some instance types support multiple network cards. The primary network interface must be assigned to network card index 0. The default is network card index 0.
        :param builtins.str network_interface_id: The ID of the network interface.
        :param builtins.bool primary_ipv6: The primary IPv6 address of the network interface. When you enable an IPv6 GUA address to be a primary IPv6, the first IPv6 GUA will be made the primary IPv6 address until the instance is terminated or the network interface is detached. For more information about primary IPv6 addresses, see [RunInstances](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html).
        :param builtins.str private_ip_address: The primary private IPv4 address of the network interface.
        :param Sequence['LaunchTemplatePrivateIpAdd'] private_ip_addresses: One or more private IPv4 addresses.
        :param builtins.int secondary_private_ip_address_count: The number of secondary private IPv4 addresses to assign to a network interface.
        :param builtins.str subnet_id: The ID of the subnet for the network interface.
        """
        if associate_carrier_ip_address is not None:
            pulumi.set(__self__, "associate_carrier_ip_address", associate_carrier_ip_address)
        if associate_public_ip_address is not None:
    ...
    def ena_queue_count(self) -> Optional[builtins.int]:
        """
    ...
    def primary_ipv6(self) -> Optional[builtins.bool]:
        """
...
class LaunchTemplateNetworkPerformanceOptions(dict):
    ...
    def __init__(__self__, *,
                 bandwidth_weighting: Optional[builtins.str] = None):
        """
        Contains settings for the network performance options for the instance.
        :param builtins.str bandwidth_weighting: Specify the bandwidth weighting option to boost the associated type of baseline bandwidth, as follows:
    ...
    def bandwidth_weighting(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplatePlacement(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str host_resource_group_arn: The ARN of the host resource group in which to launch the instances. If you specify a host resource group ARN, omit the *Tenancy* parameter or set it to ``host``.
        :param builtins.int partition_number: The number of the partition the instance should launch in. Valid only if the placement group strategy is set to ``partition``.
        :param builtins.str spread_domain: Reserved for future use.
        :param builtins.str tenancy: The tenancy of the instance. An instance with a tenancy of dedicated runs on single-tenant hardware.
        """
        if affinity is not None:
...
class LaunchTemplatePrivateDnsNameOptions(dict):
    ...
    def __init__(__self__, *,
                 enable_resource_name_dns_a_record: Optional[builtins.bool] = None,
                 enable_resource_name_dns_aaaa_record: Optional[builtins.bool] = None,
                 hostname_type: Optional[builtins.str] = None):
        """
        The hostname type for EC2 instances launched into this subnet and how DNS A and AAAA record queries should be handled. For more information, see [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html) in the *User Guide*.
        :param builtins.bool enable_resource_name_dns_a_record: Indicates whether to respond to DNS queries for instance hostnames with DNS A records.
        :param builtins.bool enable_resource_name_dns_aaaa_record: Indicates whether to respond to DNS queries for instance hostnames with DNS AAAA records.
        :param builtins.str hostname_type: The type of hostname for EC2 instances. For IPv4 only subnets, an instance DNS name must be based on the instance IPv4 address. For IPv6 only subnets, an instance DNS name must be based on the instance ID. For dual-stack subnets, you can specify whether DNS names use the instance IPv4 address or the instance ID. For more information, see [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html) in the *User Guide*.
        """
        if enable_resource_name_dns_a_record is not None:
            pulumi.set(__self__, "enable_resource_name_dns_a_record", enable_resource_name_dns_a_record)
        if enable_resource_name_dns_aaaa_record is not None:
    ...
    @property
    @pulumi.getter(name="hostnameType")
    def hostname_type(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplatePrivateIpAdd(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies a secondary private IPv4 address for a network interface.
         ``PrivateIpAdd`` is a property of [AWS::EC2::LaunchTemplate NetworkInterface](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-networkinterface.html).
        :param builtins.bool primary: Indicates whether the private IPv4 address is the primary private IPv4 address. Only one IPv4 address can be designated as primary.
        :param builtins.str private_ip_address: The private IPv4 address.
        """
...
class LaunchTemplateSpotOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_interruption_behavior: Optional[builtins.str] = None,
                 max_price: Optional[builtins.str] = None,
                 spot_instance_type: Optional[builtins.str] = None,
                 valid_until: Optional[builtins.str] = None):
        """
        Specifies options for Spot Instances.
         ``SpotOptions`` is a property of [AWS::EC2::LaunchTemplate InstanceMarketOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-launchtemplatedata-instancemarketoptions.html).
        :param builtins.int block_duration_minutes: Deprecated.
        :param builtins.str instance_interruption_behavior: The behavior when a Spot Instance is interrupted. The default is ``terminate``.
        :param builtins.str max_price: The maximum hourly price you're willing to pay for a Spot Instance. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price. If you do specify this parameter, it must be more than USD $0.001. Specifying a value below USD $0.001 will result in an ``InvalidParameterValue`` error message when the launch template is used to launch an instance.
                 If you specify a maximum price, your Spot Instances will be interrupted more frequently than if you do not specify this parameter.
        :param builtins.str spot_instance_type: The Spot Instance request type.
        ...
        :param builtins.str valid_until: The end date of the request, in UTC format (*YYYY-MM-DD*T*HH:MM:SS*Z). Supported only for persistent requests.
    ...
    @property
    @pulumi.getter(name="instanceInterruptionBehavior")
    def instance_interruption_behavior(self) -> Optional[builtins.str]:
        """
    ...
    def spot_instance_type(self) -> Optional[builtins.str]:
        """
    ...
    def valid_until(self) -> Optional[builtins.str]:
        """
...
class LaunchTemplateTagSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the tags to apply to the launch template during creation.
         To specify the tags for the resources that are created during instance launch, use [AWS::EC2::LaunchTemplate TagSpecification](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-launchtemplate-tagspecification.html).
         ``LaunchTemplateTagSpecification`` is a property of [AWS::EC2::LaunchTemplate](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html).
        :param builtins.str resource_type: The type of resource. To tag a launch template, ``ResourceType`` must be ``launch-template``.
...
class NetworkInsightsAccessScopePacketHeaderStatementRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_prefix_lists: Optional[Sequence[builtins.str]] = None,
                 protocols: Optional[Sequence['NetworkInsightsAccessScopeProtocol']] = None,
                 source_addresses: Optional[Sequence[builtins.str]] = None,
                 source_ports: Optional[Sequence[builtins.str]] = None,
                 source_prefix_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] destination_addresses: The destination addresses.
        :param Sequence[builtins.str] destination_ports: The destination ports.
        :param Sequence[builtins.str] destination_prefix_lists: The destination prefix lists.
        :param Sequence['NetworkInsightsAccessScopeProtocol'] protocols: The protocols.
        :param Sequence[builtins.str] source_addresses: The source addresses.
        :param Sequence[builtins.str] source_ports: The source ports.
        :param Sequence[builtins.str] source_prefix_lists: The source prefix lists.
        """
    ...
    def destination_prefix_lists(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def source_ports(self) -> Optional[Sequence[builtins.str]]:
        """
        The source ports.
        """
    ...
    def source_prefix_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkInsightsAccessScopeResourceStatementRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] resource_types: The resource types.
        :param Sequence[builtins.str] resources: The resources.
        """
...
class NetworkInsightsAnalysisAdditionalDetail(dict):
    ...
    def __init__(__self__, *,
                 additional_detail_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str additional_detail_type: The additional detail code.
        ...
        :param builtins.str service_name: The name of the VPC endpoint service.
        """
    ...
    def additional_detail_type(self) -> Optional[builtins.str]:
        """
...
class NetworkInsightsAnalysisAlternatePathHint(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str component_id: The ID of the component.
        """
...
class NetworkInsightsAnalysisAnalysisAclRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 egress: Optional[builtins.bool] = None,
                 port_range: Optional['outputs.NetworkInsightsAnalysisPortRange'] = None,
                 protocol: Optional[builtins.str] = None,
                 rule_action: Optional[builtins.str] = None,
                 rule_number: Optional[builtins.int] = None):
        """
        :param builtins.str cidr: The IPv4 address range, in CIDR notation.
        :param builtins.bool egress: Indicates whether the rule is an outbound rule.
        :param 'NetworkInsightsAnalysisPortRange' port_range: The range of ports.
        :param builtins.str protocol: The protocol.
        :param builtins.str rule_action: Indicates whether to allow or deny traffic that matches the rule.
        :param builtins.int rule_number: The rule number.
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
    ...
    @property
    @pulumi.getter
    def egress(self) -> Optional[builtins.bool]:
        """
    ...
    def rule_action(self) -> Optional[builtins.str]:
        """
    ...
    def rule_number(self) -> Optional[builtins.int]:
        """
        The rule number.
        """
...
class NetworkInsightsAnalysisAnalysisComponent(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: The Amazon Resource Name (ARN) of the component.
        :param builtins.str id: The ID of the component.
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
        if id is not None:
...
class NetworkInsightsAnalysisAnalysisLoadBalancerListener(dict):
    ...
    def __init__(__self__, *,
                 instance_port: Optional[builtins.int] = None,
                 load_balancer_port: Optional[builtins.int] = None):
        """
        :param builtins.int instance_port: [Classic Load Balancers] The back-end port for the listener.
        :param builtins.int load_balancer_port: The port on which the load balancer is listening.
        """
    ...
    def instance_port(self) -> Optional[builtins.int]:
        """
    ...
    def load_balancer_port(self) -> Optional[builtins.int]:
        """
...
class NetworkInsightsAnalysisAnalysisLoadBalancerTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int port: The port on which the target is listening.
        """
...
class NetworkInsightsAnalysisAnalysisRouteTableRoute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 egress_only_internet_gateway_id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str destination_cidr: The destination IPv4 address, in CIDR notation.
        :param builtins.str destination_prefix_list_id: The prefix of the AWS service.
        :param builtins.str egress_only_internet_gateway_id: The ID of an egress-only internet gateway.
        :param builtins.str gateway_id: The ID of the gateway, such as an internet gateway or virtual private gateway.
        :param builtins.str instance_id: The ID of the instance, such as a NAT instance.
        :param builtins.str nat_gateway_id: The ID of a NAT gateway.
        :param builtins.str network_interface_id: The ID of a network interface.
        :param builtins.str origin: Describes how the route was created. The following are the possible values:
               
               - CreateRouteTable - The route was automatically created when the route table was created.
               - CreateRoute - The route was manually added to the route table.
               - EnableVgwRoutePropagation - The route was propagated by route propagation.
        :param builtins.str state: The state. The following are the possible values:
               
               - active
               - blackhole
        :param builtins.str transit_gateway_id: The ID of a transit gateway.
        :param builtins.str vpc_peering_connection_id: The ID of a VPC peering connection.
        """
    ...
    def egress_only_internet_gateway_id(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_peering_connection_id(self) -> Optional[builtins.str]:
        """
...
class NetworkInsightsAnalysisAnalysisSecurityGroupRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr: The IPv4 address range, in CIDR notation.
        :param builtins.str direction: The direction. The following are the possible values:
               
               - egress
               - ingress
        :param 'NetworkInsightsAnalysisPortRange' port_range: The port range.
        :param builtins.str prefix_list_id: The prefix list ID.
        :param builtins.str protocol: The protocol name.
...
class NetworkInsightsAnalysisExplanation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 component: Optional['outputs.NetworkInsightsAnalysisAnalysisComponent'] = None,
                 component_account: Optional[builtins.str] = None,
                 component_region: Optional[builtins.str] = None,
                 ...
                 explanation_code: Optional[builtins.str] = None,
                 ...
                 load_balancer_listener_port: Optional[builtins.int] = None,
                 ...
                 load_balancer_target_port: Optional[builtins.int] = None,
                 missing_component: Optional[builtins.str] = None,
                 ...
                 packet_field: Optional[builtins.str] = None,
                 port: Optional[builtins.int] = None,
        ...
        :param builtins.str address: The IPv4 address, in CIDR notation.
        :param Sequence[builtins.str] addresses: The IPv4 addresses, in CIDR notation.
        :param 'NetworkInsightsAnalysisAnalysisComponent' attached_to: The resource to which the component is attached.
        :param Sequence[builtins.str] availability_zones: The Availability Zones.
        :param Sequence[builtins.str] cidrs: The CIDR ranges.
        ...
        :param builtins.str component_account: The AWS account for the component.
        :param builtins.str component_region: The Region for the component.
        ...
        :param builtins.str explanation_code: The explanation code.
        ...
        :param builtins.int load_balancer_listener_port: The listener port of the load balancer.
        ...
        :param builtins.int load_balancer_target_port: The target port.
        :param builtins.str missing_component: The missing component.
        ...
        :param builtins.str packet_field: The packet field.
        ...
        :param Sequence[builtins.str] protocols: The protocols.
    ...
    def component_account(self) -> Optional[builtins.str]:
        """
    ...
    def component_region(self) -> Optional[builtins.str]:
        """
    ...
    def explanation_code(self) -> Optional[builtins.str]:
        """
    ...
    def load_balancer_listener_port(self) -> Optional[builtins.int]:
        """
    ...
    def load_balancer_target_port(self) -> Optional[builtins.int]:
        """
        The target port.
        """
    ...
    def missing_component(self) -> Optional[builtins.str]:
        """
    ...
    def packet_field(self) -> Optional[builtins.str]:
        """
        The packet field.
        """
...
class NetworkInsightsAnalysisPathComponent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_table_route: Optional['outputs.NetworkInsightsAnalysisAnalysisRouteTableRoute'] = None,
                 security_group_rule: Optional['outputs.NetworkInsightsAnalysisAnalysisSecurityGroupRule'] = None,
                 sequence_number: Optional[builtins.int] = None,
                 service_name: Optional[builtins.str] = None,
                 source_vpc: Optional['outputs.NetworkInsightsAnalysisAnalysisComponent'] = None,
                 subnet: Optional['outputs.NetworkInsightsAnalysisAnalysisComponent'] = None,
                 transit_gateway: Optional['outputs.NetworkInsightsAnalysisAnalysisComponent'] = None,
        ...
        :param 'NetworkInsightsAnalysisAnalysisRouteTableRoute' route_table_route: The route table route.
        :param 'NetworkInsightsAnalysisAnalysisSecurityGroupRule' security_group_rule: The security group rule.
        :param builtins.int sequence_number: The sequence number.
        :param builtins.str service_name: The name of the VPC endpoint service.
        :param 'NetworkInsightsAnalysisAnalysisComponent' source_vpc: The source VPC.
        :param 'NetworkInsightsAnalysisAnalysisComponent' subnet: The subnet.
        :param 'NetworkInsightsAnalysisAnalysisComponent' transit_gateway: The transit gateway.
    ...
    def sequence_number(self) -> Optional[builtins.int]:
        """
        The sequence number.
        """
...
class NetworkInsightsAnalysisPortRange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int from_: The first port in the range.
        :param builtins.int to: The last port in the range.
        """
...
class NetworkInsightsAnalysisTransitGatewayRouteTableRoute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_type: Optional[builtins.str] = None,
                 route_origin: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None):
        """
        :param builtins.str attachment_id: The ID of the route attachment.
        :param builtins.str destination_cidr: The CIDR block used for destination matches.
        :param builtins.str prefix_list_id: The ID of the prefix list.
        :param builtins.str resource_id: The ID of the resource for the route attachment.
        :param builtins.str resource_type: The resource type for the route attachment.
        :param builtins.str route_origin: The route origin. The following are the possible values:
               
               - static
               - propagated
        :param builtins.str state: The state of the route.
        """
    ...
    def route_origin(self) -> Optional[builtins.str]:
        """
...
class NetworkInsightsPathPathFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str source_address: The source IPv4 address.
...
class NetworkInterfaceInstanceIpv6Address(dict):
    ...
    def __init__(__self__, *,
                 ipv6_address: builtins.str):
        """
        :param builtins.str ipv6_address: An IPv6 address to associate with the network interface.
        """
        pulumi.set(__self__, "ipv6_address", ipv6_address)
...
class NetworkInterfaceIpv6PrefixSpecification(dict):
    ...
    def __init__(__self__, *,
                 ipv6_prefix: builtins.str):
        """
        :param builtins.str ipv6_prefix: The IPv6 prefix. For information, see [Assigning prefixes to Amazon EC2 network interfaces](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-prefix-eni.html) in the *Amazon Elastic Compute Cloud User Guide* .
        """
        pulumi.set(__self__, "ipv6_prefix", ipv6_prefix)
...
class NetworkInterfacePrivateIpAddressSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ip_address: builtins.str):
        """
        :param builtins.bool primary: Sets the private IP address as the primary private address. You can set only one primary private IP address. If you don't specify a primary private IP address, Amazon EC2 automatically assigns a primary private IP address.
        :param builtins.str private_ip_address: The private IP address of the network interface.
        """
        pulumi.set(__self__, "primary", primary)
        pulumi.set(__self__, "private_ip_address", private_ip_address)
...
class OptionsProperties(dict):
    ...
    def __init__(__self__, *,
                 appliance_mode_support: Optional[builtins.str] = None,
                 dns_support: Optional[builtins.str] = None,
                 ipv6_support: Optional[builtins.str] = None,
                 security_group_referencing_support: Optional[builtins.str] = None):
        """
        The options for the transit gateway vpc attachment.
        :param builtins.str appliance_mode_support: Indicates whether to enable Ipv6 Support for Vpc Attachment. Valid Values: enable | disable
        :param builtins.str dns_support: Indicates whether to enable DNS Support for Vpc Attachment. Valid Values: enable | disable
        :param builtins.str ipv6_support: Indicates whether to enable Ipv6 Support for Vpc Attachment. Valid Values: enable | disable
        :param builtins.str security_group_referencing_support: Indicates whether to enable Security Group referencing support for Vpc Attachment. Valid values: enable | disable
        """
    ...
    def appliance_mode_support(self) -> Optional[builtins.str]:
        """
    ...
    def dns_support(self) -> Optional[builtins.str]:
        """
    ...
    def ipv6_support(self) -> Optional[builtins.str]:
        """
        Indicates whether to enable Ipv6 Support for Vpc Attachment. Valid Values: enable | disable
        """
    ...
    def security_group_referencing_support(self) -> Optional[builtins.str]:
        """
...
class PrefixListEntry(dict):
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None):
        """
        :param builtins.str cidr: The CIDR block.
        :param builtins.str description: A description for the entry.
    ...
    def __init__(__self__, *,
        ...
        The hostname type for EC2 instances launched into this subnet and how DNS A and AAAA record queries to the instances should be handled. For more information, see [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html) in the *User Guide*.
         Available options:
          ...
          +  HostnameType (ip-name | resource-name)
        :param builtins.bool enable_resource_name_dns_a_record: Indicates whether to respond to DNS queries for instance hostnames with DNS A records.
        :param builtins.bool enable_resource_name_dns_aaaa_record: Indicates whether to respond to DNS queries for instance hostname with DNS AAAA records.
        :param builtins.str hostname_type: The type of hostname for EC2 instances. For IPv4 only subnets, an instance DNS name must be based on the instance IPv4 address. For IPv6 only subnets, an instance DNS name must be based on the instance ID. For dual-stack subnets, you can specify whether DNS names use the instance IPv4 address or the instance ID.
        """
        if enable_resource_name_dns_a_record is not None:
            pulumi.set(__self__, "enable_resource_name_dns_a_record", enable_resource_name_dns_a_record)
...
class RouteServerPeerBgpOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BGP Options
        :param builtins.int peer_asn: BGP ASN of the Route Server Peer
...
class SecurityGroupEgress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None,
                 destination_prefix_list_id: Optional[builtins.str] = None,
                 destination_security_group_id: Optional[builtins.str] = None,
                 from_port: Optional[builtins.int] = None,
                 to_port: Optional[builtins.int] = None):
        """
        :param builtins.str ip_protocol: The IP protocol name ( `tcp` , `udp` , `icmp` , `icmpv6` ) or number (see [Protocol Numbers](https://docs.aws.amazon.com/http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml) ).
               
               Use `-1` to specify all protocols. When authorizing security group rules, specifying `-1` or a protocol number other than `tcp` , `udp` , `icmp` , or `icmpv6` allows traffic on all ports, regardless of any port range you specify. For `tcp` , `udp` , and `icmp` , you must specify a port range. For `icmpv6` , the port range is optional; if you omit the port range, traffic for all types and codes is allowed.
        :param builtins.str cidr_ip: The IPv4 address range, in CIDR format.
        ...
        :param builtins.str cidr_ipv6: The IPv6 address range, in CIDR format.
               
               You must specify exactly one of the following: `CidrIp` , `CidrIpv6` , `DestinationPrefixListId` , or `DestinationSecurityGroupId` .
               
               For examples of rules that you can add to security groups for specific access scenarios, see [Security group rules for different use cases](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/security-group-rules-reference.html) in the *Amazon EC2 User Guide* .
        :param builtins.str description: A description for the security group rule.
               
               Constraints: Up to 255 characters in length. Allowed characters are a-z, A-Z, 0-9, spaces, and ._-:/()#,@[]+=;{}!$*
        :param builtins.str destination_prefix_list_id: The prefix list IDs for the destination AWS service. This is the AWS service that you want to access through a VPC endpoint from instances associated with the security group.
               
               You must specify exactly one of the following: `CidrIp` , `CidrIpv6` , `DestinationPrefixListId` , or `DestinationSecurityGroupId` .
        :param builtins.str destination_security_group_id: The ID of the destination VPC security group.
               
               You must specify exactly one of the following: `CidrIp` , `CidrIpv6` , `DestinationPrefixListId` , or `DestinationSecurityGroupId` .
        :param builtins.int from_port: If the protocol is TCP or UDP, this is the start of the port range. If the protocol is ICMP or ICMPv6, this is the ICMP type or -1 (all ICMP types).
        :param builtins.int to_port: If the protocol is TCP or UDP, this is the end of the port range. If the protocol is ICMP or ICMPv6, this is the ICMP code or -1 (all ICMP codes). If the start port is -1 (all ICMP types), then the end port must be -1 (all ICMP codes).
        """
    ...
    def destination_security_group_id(self) -> Optional[builtins.str]:
        """
...
class SecurityGroupIngress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None,
                 from_port: Optional[builtins.int] = None,
                 source_prefix_list_id: Optional[builtins.str] = None,
                 source_security_group_id: Optional[builtins.str] = None,
                 source_security_group_name: Optional[builtins.str] = None,
                 source_security_group_owner_id: Optional[builtins.str] = None,
                 to_port: Optional[builtins.int] = None):
        """
        :param builtins.str ip_protocol: The IP protocol name ( `tcp` , `udp` , `icmp` , `icmpv6` ) or number (see [Protocol Numbers](https://docs.aws.amazon.com/http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml) ).
        ...
        :param builtins.str cidr_ipv6: The IPv6 address range, in CIDR format.
               ...
               For examples of rules that you can add to security groups for specific access scenarios, see [Security group rules for different use cases](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/security-group-rules-reference.html) in the *Amazon EC2 User Guide* .
        :param builtins.str description: Updates the description of an ingress (inbound) security group rule. You can replace an existing description, or add a description to a rule that did not have one previously.
               
               Constraints: Up to 255 characters in length. Allowed characters are a-z, A-Z, 0-9, spaces, and ._-:/()#,@[]+=;{}!$*
        :param builtins.int from_port: If the protocol is TCP or UDP, this is the start of the port range. If the protocol is ICMP or ICMPv6, this is the ICMP type or -1 (all ICMP types).
        :param builtins.str source_prefix_list_id: The ID of a prefix list.
        :param builtins.str source_security_group_id: The ID of the security group.
        :param builtins.str source_security_group_name: [Default VPC] The name of the source security group. You must specify either the security group ID or the security group name. You can't specify the group name in combination with an IP address range. Creates rules that grant full ICMP, UDP, and TCP access.
               
               For security groups in a nondefault VPC, you must specify the group ID.
        :param builtins.str source_security_group_owner_id: [nondefault VPC] The AWS account ID for the source security group, if the source security group is in a different account. You can't specify this property with an IP address range. Creates rules that grant full ICMP, UDP, and TCP access.
    ...
    def source_prefix_list_id(self) -> Optional[builtins.str]:
        """
    ...
    def source_security_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def source_security_group_name(self) -> Optional[builtins.str]:
        """
    ...
    def source_security_group_owner_id(self) -> Optional[builtins.str]:
        """
...
class SpotFleetGroupIdentifier(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_id: The ID of the security group.
        """
        pulumi.set(__self__, "group_id", group_id)
...
class SpotFleetInstanceNetworkInterfaceSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.bool associate_public_ip_address: Indicates whether to assign a public IPv4 address to an instance you launch in a VPC. The public IP address can only be assigned to a network interface for eth0, and can only be assigned to a new network interface, not an existing one. You cannot specify more than one network interface in the request. If launching into a default subnet, the default value is `true` .
               
               AWS charges for all public IPv4 addresses, including public IPv4 addresses associated with running instances and Elastic IP addresses. For more information, see the *Public IPv4 Address* tab on the [Amazon VPC pricing page](https://docs.aws.amazon.com/vpc/pricing/) .
        :param builtins.bool delete_on_termination: Indicates whether the network interface is deleted when the instance is terminated.
        :param builtins.str description: The description of the network interface. Applies only if creating a network interface when launching an instance.
        :param builtins.int device_index: The position of the network interface in the attachment order. A primary network interface has a device index of 0.
               
               If you specify a network interface when launching an instance, you must specify the device index.
        :param Sequence[builtins.str] groups: The IDs of the security groups for the network interface. Applies only if creating a network interface when launching an instance.
        :param builtins.int ipv6_address_count: A number of IPv6 addresses to assign to the network interface. Amazon EC2 chooses the IPv6 addresses from the range of the subnet. You cannot specify this option and the option to assign specific IPv6 addresses in the same request. You can specify this option if you've specified a minimum number of instances to launch.
        ...
        :param builtins.int secondary_private_ip_address_count: The number of secondary private IPv4 addresses. You can’t specify this parameter and also specify a secondary private IP address using the `PrivateIpAddress` parameter.
        :param builtins.str subnet_id: The ID of the subnet associated with the network interface.
        """
        if associate_public_ip_address is not None:
            pulumi.set(__self__, "associate_public_ip_address", associate_public_ip_address)
        if delete_on_termination is not None:
...
class SpotFleetLaunchSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ramdisk_id: Optional[builtins.str] = None,
                 ...
                 weighted_capacity: Optional[builtins.float] = None):
        """
        :param builtins.str image_id: The ID of the AMI.
        ...
        :param builtins.bool ebs_optimized: Indicates whether the instances are optimized for EBS I/O. This optimization provides dedicated throughput to Amazon EBS and an optimized configuration stack to provide optimal EBS I/O performance. This optimization isn't available with all instance types. Additional usage charges apply when using an EBS Optimized instance.
        ...
        :param builtins.str ramdisk_id: The ID of the RAM disk. Some kernels require additional drivers at launch. Check the kernel requirements for information about whether you need to specify a RAM disk. To find kernel requirements, refer to the AWS Resource Center and search for the kernel ID.
        :param Sequence['SpotFleetGroupIdentifier'] security_groups: The security groups.
               
               If you specify a network interface, you must specify any security groups as part of the network interface instead of using this parameter.
        :param builtins.str spot_price: The maximum price per unit hour that you are willing to pay for a Spot Instance. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.
               
               > If you specify a maximum price, your instances will be interrupted more frequently than if you do not specify this parameter.
        :param builtins.str subnet_id: The IDs of the subnets in which to launch the instances. To specify multiple subnets, separate them using commas; for example, "subnet-1234abcdeexample1, subnet-0987cdef6example2".
               
               If you specify a network interface, you must specify any subnets as part of the network interface instead of using this parameter.
        :param Sequence['SpotFleetTagSpecification'] tag_specifications: The tags to apply during creation.
        :param builtins.str user_data: The base64-encoded user data that instances use when starting up. User data is limited to 16 KB.
        :param builtins.float weighted_capacity: The number of units provided by the specified instance type. These are the same units that you chose to set the target capacity in terms of instances, or a performance characteristic such as vCPUs, memory, or I/O.
    ...
    @property
    @pulumi.getter(name="ramdiskId")
    def ramdisk_id(self) -> Optional[builtins.str]:
        """
...
class SpotFleetLaunchTemplateOverrides(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str spot_price: The maximum price per unit hour that you are willing to pay for a Spot Instance. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.
               ...
               > If you specify a maximum price, your instances will be interrupted more frequently than if you do not specify this parameter.
        :param builtins.str subnet_id: The ID of the subnet in which to launch the instances.
        :param builtins.float weighted_capacity: The number of units provided by the specified instance type. These are the same units that you chose to set the target capacity in terms of instances, or a performance characteristic such as vCPUs, memory, or I/O.
...
class SpotFleetMonitoring(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Enables monitoring for the instance.
...
class SpotFleetRequestConfigData(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SpotFleetRequestConfigDataAllocationStrategy' allocation_strategy: The strategy that determines how to allocate the target Spot Instance capacity across the Spot Instance pools specified by the Spot Fleet launch configuration. For more information, see [Allocation strategies for Spot Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-allocation-strategy.html) in the *Amazon EC2 User Guide* .
               ...
               Default: `lowestPrice`
        :param builtins.str context: Reserved.
        ...
        :param builtins.int on_demand_target_capacity: The number of On-Demand units to request. You can choose to set the target capacity in terms of instances or a performance characteristic that is important to your application workload, such as vCPUs, memory, or I/O. If the request type is `maintain` , you can specify a target capacity of 0 and add capacity later.
        :param builtins.bool replace_unhealthy_instances: Indicates whether Spot Fleet should replace unhealthy instances.
        ...
        :param builtins.str spot_max_total_price: The maximum amount per hour for Spot Instances that you're willing to pay. You can use the `spotMaxTotalPrice` parameter, the `onDemandMaxTotalPrice` parameter, or both parameters to ensure that your fleet cost does not exceed your budget. If you set a maximum price per hour for the On-Demand Instances and Spot Instances in your request, Spot Fleet will launch instances until it reaches the maximum amount you're willing to pay. When the maximum amount you're willing to pay is reached, the fleet stops launching instances even if it hasn’t met the target capacity.
        ...
        :param 'SpotFleetRequestConfigDataTargetCapacityUnitType' target_capacity_unit_type: The unit for the target capacity. You can specify this parameter only when using attribute-based instance type selection.
               ...
               Default: `units` (the number of instances)
        :param builtins.bool terminate_instances_with_expiration: Indicates whether running Spot Instances are terminated when the Spot Fleet request expires.
        ...
        :param builtins.str valid_from: The start date and time of the request, in UTC format ( *YYYY* - *MM* - *DD* T *HH* : *MM* : *SS* Z). By default, Amazon EC2 starts fulfilling the request immediately.
        :param builtins.str valid_until: The end date and time of the request, in UTC format ( *YYYY* - *MM* - *DD* T *HH* : *MM* : *SS* Z). After the end date and time, no new Spot Instance requests are placed or able to fulfill the request. If no value is specified, the Spot Fleet request remains until you cancel it.
        """
    ...
    def target_capacity(self) -> builtins.int:
        """
    ...
    def on_demand_allocation_strategy(self) -> Optional[builtins.str]:
        """
    ...
    def on_demand_max_total_price(self) -> Optional[builtins.str]:
        """
    ...
    def replace_unhealthy_instances(self) -> Optional[builtins.bool]:
        """
    ...
    def spot_max_total_price(self) -> Optional[builtins.str]:
        """
    ...
    def terminate_instances_with_expiration(self) -> Optional[builtins.bool]:
        """
...
class SpotFleetSpotPlacement(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str group_name: The name of the placement group.
...
class SseSpecificationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration options for customer provided KMS encryption.
        :param builtins.bool customer_managed_key_enabled: Whether to encrypt the policy with the provided key or disable encryption
        :param builtins.str kms_key_arn: KMS Key Arn used to encrypt the group policy
        """
...
class TransitGatewayPeeringAttachmentPeeringAttachmentStatus(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: The status message, if applicable.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class VerifiedAccessEndpointCidrOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The options for cidr type endpoint.
        :param builtins.str cidr: The IP address range, in CIDR notation.
        :param Sequence['VerifiedAccessEndpointPortRange'] port_ranges: The list of port range.
        :param builtins.str protocol: The IP protocol.
        :param Sequence[builtins.str] subnet_ids: The IDs of the subnets.
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
        if port_ranges is not None:
...
class VerifiedAccessEndpointLoadBalancerOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The load balancer details if creating the AWS Verified Access endpoint as load-balancertype.
        :param builtins.str load_balancer_arn: The ARN of the load balancer.
        :param builtins.int port: The IP port number.
        :param Sequence['VerifiedAccessEndpointPortRange'] port_ranges: The list of port range.
        :param builtins.str protocol: The IP protocol.
        :param Sequence[builtins.str] subnet_ids: The IDs of the subnets.
        """
...
class VerifiedAccessEndpointRdsOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int port: The IP port number.
        :param builtins.str protocol: The IP protocol.
        :param builtins.str rds_db_cluster_arn: The ARN of the RDS DB cluster.
        :param builtins.str rds_db_instance_arn: The ARN of the RDS DB instance.
        :param builtins.str rds_db_proxy_arn: The ARN of the RDS DB proxy.
        :param builtins.str rds_endpoint: The RDS endpoint.
        :param Sequence[builtins.str] subnet_ids: The IDs of the subnets.
        """
        if port is not None:
            pulumi.set(__self__, "port", port)
...
class VerifiedAccessInstanceVerifiedAccessLogs(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool include_trust_context: Include claims from trust providers in Verified Access logs.
        ...
        :param builtins.str log_version: Select log version for Verified Access logs.
...
class VerifiedAccessInstanceVerifiedAccessLogsCloudWatchLogsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str log_group: The ID of the CloudWatch Logs log group.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class VerifiedAccessInstanceVerifiedAccessLogsKinesisDataFirehoseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sends Verified Access logs to Kinesis.
        :param builtins.str delivery_stream: The ID of the delivery stream.
        :param builtins.bool enabled: Indicates whether logging is enabled.
        """
...
class VerifiedAccessInstanceVerifiedAccessLogsS3Properties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sends Verified Access logs to Amazon S3.
        :param builtins.str bucket_name: The bucket name.
...
class VerifiedAccessInstanceVerifiedAccessTrustProvider(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Verified Access Trust Provider.
        :param builtins.str description: The description of trust provider.
...
class VerifiedAccessTrustProviderDeviceOptions(dict):
    ...
    def __init__(__self__, *,
                 public_signing_key_url: Optional[builtins.str] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        The options for device identity based trust providers.
        :param builtins.str public_signing_key_url: URL Verified Access will use to verify authenticity of the device tokens.
        :param builtins.str tenant_id: The ID of the tenant application with the device-identity provider.
        """
    ...
    def public_signing_key_url(self) -> Optional[builtins.str]:
        """
...
class VerifiedAccessTrustProviderNativeApplicationOidcOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The OpenID Connect details for an oidc -type, user-identity based trust provider for L4.
        :param builtins.str authorization_endpoint: The OIDC authorization endpoint.
        :param builtins.str client_id: The client identifier.
        :param builtins.str client_secret: The client secret.
        :param builtins.str issuer: The OIDC issuer.
        :param builtins.str public_signing_key_endpoint: The public signing key for endpoint
        :param builtins.str scope: OpenID Connect (OIDC) scopes are used by an application during authentication to authorize access to details of a user. Each scope returns a specific set of user attributes.
        :param builtins.str token_endpoint: The OIDC token endpoint.
        :param builtins.str user_info_endpoint: The OIDC user info endpoint.
        """
...
class VpnConnectionCloudwatchLogOptionsSpecification(dict):
    ...
    def __init__(__self__, *,
                 log_enabled: Optional[builtins.bool] = None,
        ...
        """
        Options for sending VPN tunnel logs to CloudWatch.
        :param builtins.bool log_enabled: Enable or disable VPN tunnel logging feature. Default value is ``False``.
                Valid values: ``True`` | ``False``
        :param builtins.str log_group_arn: The Amazon Resource Name (ARN) of the CloudWatch log group to send logs to.
    ...
    def log_enabled(self) -> Optional[builtins.bool]:
        """
...
class VpnConnectionPhase1dhGroupNumbersRequestListValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a Diffie-Hellman group number for the VPN tunnel for phase 1 IKE negotiations.
        :param builtins.int value: The Diffie-Hellmann group number.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class VpnConnectionVpnTunnelOptionsSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dpd_timeout_seconds: Optional[builtins.int] = None,
                 enable_tunnel_lifecycle_control: Optional[builtins.bool] = None,
                 ...
                 phase1_lifetime_seconds: Optional[builtins.int] = None,
                 ...
                 phase2_lifetime_seconds: Optional[builtins.int] = None,
                 ...
                 rekey_fuzz_percentage: Optional[builtins.int] = None,
                 rekey_margin_time_seconds: Optional[builtins.int] = None,
                 replay_window_size: Optional[builtins.int] = None,
                 startup_action: Optional['VpnConnectionVpnTunnelOptionsSpecificationStartupAction'] = None,
                 tunnel_inside_cidr: Optional[builtins.str] = None,
                 tunnel_inside_ipv6_cidr: Optional[builtins.str] = None):
        """
        The tunnel options for a single VPN tunnel.
        :param 'VpnConnectionVpnTunnelOptionsSpecificationDpdTimeoutAction' dpd_timeout_action: The action to take after DPD timeout occurs. Specify ``restart`` to restart the IKE initiation. Specify ``clear`` to end the IKE session.
                ...
                Default: ``clear``
        :param builtins.int dpd_timeout_seconds: The number of seconds after which a DPD timeout occurs.
                Constraints: A value greater than or equal to 30.
                Default: ``30``
        :param builtins.bool enable_tunnel_lifecycle_control: Turn on or off tunnel endpoint lifecycle control feature.
        ...
        :param builtins.int phase1_lifetime_seconds: The lifetime for phase 1 of the IKE negotiation, in seconds.
        ...
        :param Sequence['VpnConnectionPhase2IntegrityAlgorithmsRequestListValue'] phase2_integrity_algorithms: One or more integrity algorithms that are permitted for the VPN tunnel for phase 2 IKE negotiations.
                Valid values: ``SHA1`` | ``SHA2-256`` | ``SHA2-384`` | ``SHA2-512``
        :param builtins.int phase2_lifetime_seconds: The lifetime for phase 2 of the IKE negotiation, in seconds.
        ...
        :param builtins.str pre_shared_key: The pre-shared key (PSK) to establish initial authentication between the virtual private gateway and customer gateway.
                Constraints: Allowed characters are alphanumeric characters, periods (.), and underscores (_). Must be between 8 and 64 characters in length and cannot start with zero (0).
        :param builtins.int rekey_fuzz_percentage: The percentage of the rekey window (determined by ``RekeyMarginTimeSeconds``) during which the rekey time is randomly selected.
                Constraints: A value between 0 and 100.
                Default: ``100``
        :param builtins.int rekey_margin_time_seconds: The margin time, in seconds, before the phase 2 lifetime expires, during which the AWS side of the VPN connection performs an IKE rekey. The exact time of the rekey is randomly selected based on the value for ``RekeyFuzzPercentage``.
                Constraints: A value between 60 and half of ``Phase2LifetimeSeconds``.
                Default: ``270``
        :param builtins.int replay_window_size: The number of packets in an IKE replay window.
        ...
        :param 'VpnConnectionVpnTunnelOptionsSpecificationStartupAction' startup_action: The action to take when the establishing the tunnel for the VPN connection. By default, your customer gateway device must initiate the IKE negotiation and bring up the tunnel. Specify ``start`` for AWS to initiate the IKE negotiation.
                ...
                Default: ``add``
        :param builtins.str tunnel_inside_cidr: The range of inside IP addresses for the tunnel. Any specified CIDR blocks must be unique across all VPN connections that use the same virtual private gateway. 
                Constraints: A size /30 CIDR block from the ``169.254.0.0/16`` range. The following CIDR blocks are reserved and cannot be used:
                 ...
                 +   ``169.254.5.0/30`` 
                 +   ``169.254.169.252/30``
        :param builtins.str tunnel_inside_ipv6_cidr: The range of inside IPv6 addresses for the tunnel. Any specified CIDR blocks must be unique across all VPN connections that use the same transit gateway.
    ...
    def enable_tunnel_lifecycle_control(self) -> Optional[builtins.bool]:
        """
    ...
    def phase1_lifetime_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def phase2_lifetime_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def rekey_fuzz_percentage(self) -> Optional[builtins.int]:
        """
    ...
    def rekey_margin_time_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def replay_window_size(self) -> Optional[builtins.int]:
        """
    ...
    def tunnel_inside_cidr(self) -> Optional[builtins.str]:
        """
    ...
    def tunnel_inside_ipv6_cidr(self) -> Optional[builtins.str]:
        """
