...
class Ec2FleetPlacement(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str group_name: The name of the placement group that the instance is in. If you specify `GroupName` , you can't specify `GroupId` .
...
class InstanceElasticGpuSpecification(dict):
    def __init__(__self__, *,
                 type: _builtins.str):
        """
        :param _builtins.str type: The type of Elastic Graphics accelerator.
        """
...
class InstanceElasticInferenceAccelerator(dict):
    def __init__(__self__, *,
                 ...
                 count: Optional[_builtins.int] = None):
        """
        :param _builtins.str type: The type of elastic inference accelerator.
        :param _builtins.int count: The number of elastic inference accelerators to attach to the instance.
        """
        pulumi.set(__self__, "type", type)
        if count is not None:
            pulumi.set(__self__, "count", count)
...
class LaunchTemplateElasticInferenceAccelerator(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int count: The number of elastic inference accelerators to attach to the instance. 
                Default: 1
        :param _builtins.str type: The type of elastic inference accelerator. The possible values are eia1.medium, eia1.large, and eia1.xlarge.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if type is not None:
