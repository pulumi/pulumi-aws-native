...
class LocalGatewayRouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] local_gateway_id: The ID of the local gateway.
        :param pulumi.Input[_builtins.str] mode: The mode of the local gateway route table.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags for the local gateway route table.
        """
        ...
    @overload
    def __init__(__self__,
