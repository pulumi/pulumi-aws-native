...
class LocalGatewayRouteTableArgs:
    def __init__(__self__, *,
                 local_gateway_id: pulumi.Input[builtins.str],
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a LocalGatewayRouteTable resource.
        :param pulumi.Input[builtins.str] local_gateway_id: The ID of the local gateway.
        :param pulumi.Input[builtins.str] mode: The mode of the local gateway route table.
    ...
    def local_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def local_gateway_id(self, value: pulumi.Input[builtins.str]):
...
class LocalGatewayRouteTable(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="localGatewayId")
    def local_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the local gateway.
        """
        return pulumi.get(self, "local_gateway_id")
    ...
    def local_gateway_route_table_arn(self) -> pulumi.Output[builtins.str]:
        """
