...
class GetVpcEndpointConnectionNotificationResult:
    ...
    def connection_events(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def connection_notification_arn(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_endpoint_connection_notification_id(self) -> Optional[builtins.str]:
        """
...
def get_vpc_endpoint_connection_notification(vpc_endpoint_connection_notification_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vpc_endpoint_connection_notification_id: VPC Endpoint Connection ID generated by service
    """
    __args__ = dict()
...
def get_vpc_endpoint_connection_notification_output(vpc_endpoint_connection_notification_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetVpcEndpointConnectionNotificationResult(
        ...
        connection_notification_arn=pulumi.get(__response__, 'connection_notification_arn'),
        vpc_endpoint_connection_notification_id=pulumi.get(__response__, 'vpc_endpoint_connection_notification_id')))
