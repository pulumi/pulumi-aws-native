...
class GetVpcEndpointConnectionNotificationResult:
    ...
    def connection_events(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def connection_notification_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def vpc_endpoint_connection_notification_id(self) -> Optional[_builtins.str]:
        """
...
def get_vpc_endpoint_connection_notification(vpc_endpoint_connection_notification_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vpc_endpoint_connection_notification_id: VPC Endpoint Connection ID generated by service
    """
    __args__ = dict()
