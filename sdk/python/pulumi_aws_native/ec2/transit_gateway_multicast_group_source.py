...
class TransitGatewayMulticastGroupSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the transit gateway attachment.
...
class TransitGatewayMulticastGroupSource(pulumi.CustomResource):
    ...
    def group_member(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def group_source(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates that the resource is a transit gateway multicast group member.
        """
