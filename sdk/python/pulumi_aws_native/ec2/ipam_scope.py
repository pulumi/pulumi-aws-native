...
class IpamScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipam_id: The Id of the IPAM this scope is a part of.
        :param pulumi.Input[builtins.str] description: The description of the scope.
