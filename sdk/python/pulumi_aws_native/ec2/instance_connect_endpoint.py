...
class InstanceConnectEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subnet_id: The subnet id of the instance connect endpoint
        :param pulumi.Input[builtins.str] client_token: The client token of the instance connect endpoint.
        :param pulumi.Input[builtins.bool] preserve_client_ip: If true, the address of the instance connect endpoint client is preserved when connecting to the end resource
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The security group IDs of the instance connect endpoint.
...
class InstanceConnectEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="preserveClientIp")
    def preserve_client_ip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the address of the instance connect endpoint client is preserved when connecting to the end resource
        """
        return pulumi.get(self, "preserve_client_ip")
