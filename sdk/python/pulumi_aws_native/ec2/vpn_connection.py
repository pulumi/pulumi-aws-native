...
class VpnConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] customer_gateway_id: The ID of the customer gateway at your end of the VPN connection.
        :param pulumi.Input[builtins.str] type: The type of VPN connection.
        :param pulumi.Input[builtins.bool] enable_acceleration: Indicate whether to enable acceleration for the VPN connection.
                Default: ``false``
        ...
        :param pulumi.Input[builtins.str] remote_ipv6_network_cidr: The IPv6 CIDR on the AWS side of the VPN connection.
                Default: ``::/0``
        :param pulumi.Input[builtins.bool] static_routes_only: Indicates whether the VPN connection uses static routes only. Static routes must be used for devices that don't support BGP.
        ...
        :param pulumi.Input[builtins.str] transit_gateway_id: The ID of the transit gateway associated with the VPN connection.
                You must specify either ``TransitGatewayId`` or ``VpnGatewayId``, but not both.
        :param pulumi.Input[builtins.str] transport_transit_gateway_attachment_id: The transit gateway attachment ID to use for the VPN tunnel.
                Required if ``OutsideIpAddressType`` is set to ``PrivateIpv4``.
        :param pulumi.Input[builtins.str] tunnel_inside_ip_version: Indicate whether the VPN tunnels process IPv4 or IPv6 traffic.
                Default: ``ipv4``
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the virtual private gateway at the AWS side of the VPN connection.
                You must specify either ``TransitGatewayId`` or ``VpnGatewayId``, but not both.
...
class VpnConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="localIpv4NetworkCidr")
    def local_ipv4_network_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv4 CIDR on the customer gateway (on-premises) side of the VPN connection.
         Default: ``0.0.0.0/0``
        """
    ...
    @property
    @pulumi.getter(name="localIpv6NetworkCidr")
    def local_ipv6_network_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv6 CIDR on the customer gateway (on-premises) side of the VPN connection.
         Default: ``::/0``
        """
    ...
    @property
    @pulumi.getter(name="remoteIpv4NetworkCidr")
    def remote_ipv4_network_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv4 CIDR on the AWS side of the VPN connection.
         Default: ``0.0.0.0/0``
        """
    ...
    @property
    @pulumi.getter(name="remoteIpv6NetworkCidr")
    def remote_ipv6_network_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv6 CIDR on the AWS side of the VPN connection.
         Default: ``::/0``
        """
    ...
    @property
    @pulumi.getter(name="staticRoutesOnly")
    def static_routes_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the VPN connection uses static routes only. Static routes must be used for devices that don't support BGP.
         If you are creating a VPN connection for a device that does not support Border Gateway Protocol (BGP), you must specify ``true``.
        """
    ...
    @property
    @pulumi.getter(name="tunnelInsideIpVersion")
    def tunnel_inside_ip_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicate whether the VPN tunnels process IPv4 or IPv6 traffic.
         Default: ``ipv4``
        """
