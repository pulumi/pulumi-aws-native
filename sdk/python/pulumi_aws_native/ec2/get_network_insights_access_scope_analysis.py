...
class GetNetworkInsightsAccessScopeAnalysisResult:
    ...
    def analyzed_eni_count(self) -> Optional[builtins.int]:
        """
    ...
    def network_insights_access_scope_analysis_arn(self) -> Optional[builtins.str]:
        """
    ...
    def network_insights_access_scope_analysis_id(self) -> Optional[builtins.str]:
        """
...
def get_network_insights_access_scope_analysis(network_insights_access_scope_analysis_id: Optional[builtins.str] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkInsightsAccessScopeAnalysisResult:
    """
    Resource schema for AWS::EC2::NetworkInsightsAccessScopeAnalysis


    :param builtins.str network_insights_access_scope_analysis_id: The ID of the Network Access Scope analysis.
    """
    __args__ = dict()
...
def get_network_insights_access_scope_analysis_output(network_insights_access_scope_analysis_id: Optional[pulumi.Input[builtins.str]] = None,
