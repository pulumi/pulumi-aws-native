...
def get_local_gateway_route(destination_cidr_block: Optional[_builtins.str] = None,
    ...
    :param _builtins.str destination_cidr_block: The CIDR block used for destination matches.
