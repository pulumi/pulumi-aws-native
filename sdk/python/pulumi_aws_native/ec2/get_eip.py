...
class GetEipResult:
    ...
    def public_ipv4_pool(self) -> Optional[builtins.str]:
        """
...
def get_eip(allocation_id: Optional[builtins.str] = None,
    ...
    :param builtins.str allocation_id: The ID that AWS assigns to represent the allocation of the address for use with Amazon VPC. This is returned only for VPC elastic IP addresses. For example, `eipalloc-5723d13e` .
    :param builtins.str public_ip: The Elastic IP address.
    """
    __args__ = dict()
...
def get_eip_output(allocation_id: Optional[pulumi.Input[builtins.str]] = None,
