...
class GetTransitGatewayPeeringAttachmentResult:
    ...
    def transit_gateway_attachment_id(self) -> Optional[builtins.str]:
        """
...
def get_transit_gateway_peering_attachment(transit_gateway_attachment_id: Optional[builtins.str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitGatewayPeeringAttachmentResult:
    """
    The AWS::EC2::TransitGatewayPeeringAttachment type


    :param builtins.str transit_gateway_attachment_id: The ID of the transit gateway peering attachment.
    """
    __args__ = dict()
...
def get_transit_gateway_peering_attachment_output(transit_gateway_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
