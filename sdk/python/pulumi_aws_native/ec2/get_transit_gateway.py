...
class GetTransitGatewayResult:
    ...
    def association_default_route_table_id(self) -> Optional[builtins.str]:
        """
    ...
    def auto_accept_shared_attachments(self) -> Optional[builtins.str]:
        """
    ...
    def propagation_default_route_table_id(self) -> Optional[builtins.str]:
        """
    ...
    def transit_gateway_arn(self) -> Optional[builtins.str]:
        return pulumi.get(self, "transit_gateway_arn")

    @property
    @pulumi.getter(name="transitGatewayCidrBlocks")
    def transit_gateway_cidr_blocks(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def vpn_ecmp_support(self) -> Optional[builtins.str]:
        """
...
def get_transit_gateway(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitGatewayResult:
    """
    Resource Type definition for AWS::EC2::TransitGateway


    :param builtins.str id: The ID of the transit gateway.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_transit_gateway_output(id: Optional[pulumi.Input[builtins.str]] = None,
