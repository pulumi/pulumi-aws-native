...
class KeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_name: A unique name for the key pair.
        ...
        :param pulumi.Input['KeyPairKeyType'] key_type: The type of key pair. Note that ED25519 keys are not supported for Windows instances.
                ...
                Default: ``rsa``
        :param pulumi.Input[builtins.str] public_key_material: The public key material. The ``PublicKeyMaterial`` property is used to import a key pair. If this property is not specified, then a new key pair will be created.
...
@pulumi.type_token("aws-native:ec2:KeyPair")
