...
class GetTransitGatewayRouteTableResult:
    ...
    def transit_gateway_route_table_id(self) -> Optional[_builtins.str]:
        """
...
def get_transit_gateway_route_table(transit_gateway_route_table_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str transit_gateway_route_table_id: Transit Gateway Route Table primary identifier
    """
    __args__ = dict()
