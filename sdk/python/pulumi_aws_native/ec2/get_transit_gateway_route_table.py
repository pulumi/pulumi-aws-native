...
class GetTransitGatewayRouteTableResult:
    ...
    def transit_gateway_route_table_id(self) -> Optional[builtins.str]:
        """
...
def get_transit_gateway_route_table(transit_gateway_route_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str transit_gateway_route_table_id: Transit Gateway Route Table primary identifier
    """
    __args__ = dict()
...
def get_transit_gateway_route_table_output(transit_gateway_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
