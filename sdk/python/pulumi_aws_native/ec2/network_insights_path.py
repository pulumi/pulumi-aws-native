...
class NetworkInsightsPathArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source: The ID or ARN of the source. If the resource is in another account, you must specify an ARN.
        :param pulumi.Input[builtins.str] destination: The ID or ARN of the destination. If the resource is in another account, you must specify an ARN.
        :param pulumi.Input[builtins.str] destination_ip: The IP address of the destination.
        :param pulumi.Input[builtins.int] destination_port: The destination port.
        ...
        :param pulumi.Input[builtins.str] source_ip: The IP address of the source.
...
@pulumi.type_token("aws-native:ec2:NetworkInsightsPath")
class NetworkInsightsPath(pulumi.CustomResource):
    ...
    def network_insights_path_arn(self) -> pulumi.Output[builtins.str]:
        """
