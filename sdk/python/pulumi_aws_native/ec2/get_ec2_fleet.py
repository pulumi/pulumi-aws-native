...
def get_ec2_fleet(fleet_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEc2FleetResult:
    """
    Resource Type definition for AWS::EC2::EC2Fleet


    :param builtins.str fleet_id: The ID of the EC2 Fleet.
    """
    __args__ = dict()
...
def get_ec2_fleet_output(fleet_id: Optional[pulumi.Input[builtins.str]] = None,
