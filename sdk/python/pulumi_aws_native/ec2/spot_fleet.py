...
class SpotFleet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spot_fleet_request_config_data: pulumi.Input[Optional[Union['SpotFleetRequestConfigDataArgs', 'SpotFleetRequestConfigDataArgsDict', 'outputs.SpotFleetRequestConfigData']]] = None,
        ...
        :param pulumi.Input[Union['SpotFleetRequestConfigDataArgs', 'SpotFleetRequestConfigDataArgsDict', 'outputs.SpotFleetRequestConfigData']] spot_fleet_request_config_data: Describes the configuration of a Spot Fleet request.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags to specify in SpotFleetRequestConfigData
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["spotFleetRequestConfigData.allocationStrategy", "spotFleetRequestConfigData.iamFleetRole", "spotFleetRequestConfigData.instanceInterruptionBehavior", "spotFleetRequestConfigData.instancePoolsToUseCount", "spotFleetRequestConfigData.launchSpecifications[*]", "spotFleetRequestConfigData.loadBalancersConfig", "spotFleetRequestConfigData.onDemandAllocationStrategy", "spotFleetRequestConfigData.onDemandMaxTotalPrice", "spotFleetRequestConfigData.replaceUnhealthyInstances", "spotFleetRequestConfigData.spotMaintenanceStrategies", "spotFleetRequestConfigData.spotMaxTotalPrice", "spotFleetRequestConfigData.spotPrice", "spotFleetRequestConfigData.tagSpecifications[*]", "spotFleetRequestConfigData.terminateInstancesWithExpiration", "spotFleetRequestConfigData.type", "spotFleetRequestConfigData.validFrom", "spotFleetRequestConfigData.validUntil"])
