...
class TrafficMirrorFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(destination_port_range, TrafficMirrorFilterRuleTrafficMirrorPortRangeArgs):
            ...
            if not isinstance(source_port_range, TrafficMirrorFilterRuleTrafficMirrorPortRangeArgs):
