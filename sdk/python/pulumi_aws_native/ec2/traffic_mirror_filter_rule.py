...
class TrafficMirrorFilterRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TrafficMirrorFilterRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TrafficMirrorFilterRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TrafficMirrorFilterRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TrafficMirrorFilterRuleProperties']:
        """
