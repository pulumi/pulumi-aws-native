...
class VpcEndpointArgs:
    def __init__(__self__, *,
                 ...
                 policy_document: Optional[pulumi.Input[Union[str, Any]]] = None,
        ...
        :param pulumi.Input[Union[str, Any]] policy_document: An endpoint policy, which controls access to the service from the VPC. The default endpoint policy allows full access to the service. Endpoint policies are supported only for gateway and interface endpoints.
    ...
    def policy_document(self) -> Optional[pulumi.Input[Union[str, Any]]]:
        """
    ...
    def policy_document(self, value: Optional[pulumi.Input[Union[str, Any]]]):
