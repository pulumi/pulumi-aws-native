...
class VpcEndpointArgs:
    def __init__(__self__, *,
                 ...
                 dns_options: pulumi.Input[Optional['VpcEndpointDnsOptionsSpecificationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.bool] private_dns_enabled: Indicate whether to associate a private hosted zone with the specified VPC. The private hosted zone contains a record set for the default public DNS name for the service for the Region (for example, ``kinesis.us-east-1.amazonaws.com``), which resolves to the private IP addresses of the endpoint network interfaces in the VPC. This enables you to make requests to the default public DNS name for the service instead of the public DNS names that are automatically generated by the VPC endpoint service.
                To use a private hosted zone, you must set the following VPC attributes to ``true``: ``enableDnsHostnames`` and ``enableDnsSupport``.
                This property is supported only for interface endpoints.
                Default: ``false``
        :param pulumi.Input[_builtins.str] resource_configuration_arn: The Amazon Resource Name (ARN) of the resource configuration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] route_table_ids: The IDs of the route tables. Routing is supported only for gateway endpoints.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: The IDs of the security groups to associate with the endpoint network interfaces. If this parameter is not specified, we use the default security group for the VPC. Security groups are supported only for interface endpoints.
        :param pulumi.Input[_builtins.str] service_name: The name of the endpoint service.
    ...
    def dns_options(self) -> pulumi.Input[Optional['VpcEndpointDnsOptionsSpecificationArgs']]:
        """
    ...
    @dns_options.setter
    def dns_options(self, value: pulumi.Input[Optional['VpcEndpointDnsOptionsSpecificationArgs']]):
        pulumi.set(self, "dns_options", value)

    @_builtins.property
    @pulumi.getter(name="ipAddressType")
    def ip_address_type(self) -> pulumi.Input[Optional['VpcEndpointIpAddressType']]:
        """
    ...
    def ip_address_type(self, value: pulumi.Input[Optional['VpcEndpointIpAddressType']]):
    ...
    def vpc_endpoint_type(self) -> pulumi.Input[Optional['VpcEndpointType']]:
        """
    ...
    def vpc_endpoint_type(self, value: pulumi.Input[Optional['VpcEndpointType']]):
...
class VpcEndpoint(pulumi.CustomResource):
    ...
    def dns_entries(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="routeTableIds")
    def route_table_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The IDs of the route tables. Routing is supported only for gateway endpoints.
        """
        return pulumi.get(self, "route_table_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceRegion")
    def service_region(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Describes a Region.
        """
        return pulumi.get(self, "service_region")
