...
class VPCEndpoint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPCEndpointPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPCEndpointPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPCEndpointAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPCEndpointProperties']:
        """
