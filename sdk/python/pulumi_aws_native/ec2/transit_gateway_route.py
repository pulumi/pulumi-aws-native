...
class TransitGatewayRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] destination_cidr_block: The CIDR range used for destination matches. Routing decisions are based on the most specific match.
        :param pulumi.Input[str] transit_gateway_route_table_id: The ID of transit gateway route table.
        :param pulumi.Input[bool] blackhole: Indicates whether to drop traffic that matches this route.
