...
class TransitGatewayRoute(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TransitGatewayRoutePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TransitGatewayRoutePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TransitGatewayRouteAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TransitGatewayRouteProperties']:
        """
