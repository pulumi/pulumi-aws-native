...
class TransitGatewayRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_cidr_block: The CIDR range used for destination matches. Routing decisions are based on the most specific match.
        :param pulumi.Input[builtins.str] transit_gateway_route_table_id: The ID of transit gateway route table.
        :param pulumi.Input[builtins.bool] blackhole: Indicates whether to drop traffic that matches this route.
        :param pulumi.Input[builtins.str] transit_gateway_attachment_id: The ID of transit gateway attachment.
        """
