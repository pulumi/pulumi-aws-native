...
class SecurityGroupIngressInitArgs:
    def __init__(__self__, *,
                 ...
                 source_prefix_list_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_security_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_security_group_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 to_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a SecurityGroupIngress resource.
        :param pulumi.Input[builtins.str] ip_protocol: The IP protocol name (tcp, udp, icmp, icmpv6) or number (see Protocol Numbers).
               
               [VPC only] Use -1 to specify all protocols. When authorizing security group rules, specifying -1 or a protocol number other than tcp, udp, icmp, or icmpv6 allows traffic on all ports, regardless of any port range you specify. For tcp, udp, and icmp, you must specify a port range. For icmpv6, the port range is optional; if you omit the port range, traffic for all types and codes is allowed.
        :param pulumi.Input[builtins.str] cidr_ip: The IPv4 ranges
        :param pulumi.Input[builtins.str] cidr_ipv6: [VPC only] The IPv6 ranges
        :param pulumi.Input[builtins.str] description: Updates the description of an ingress (inbound) security group rule. You can replace an existing description, or add a description to a rule that did not have one previously
        :param pulumi.Input[builtins.int] from_port: The start of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 type number. A value of -1 indicates all ICMP/ICMPv6 types. If you specify all ICMP/ICMPv6 types, you must specify all codes.
        ...
        :param pulumi.Input[builtins.str] source_prefix_list_id: [EC2-VPC only] The ID of a prefix list.
        :param pulumi.Input[builtins.str] source_security_group_id: The ID of the security group. You must specify either the security group ID or the security group name. For security groups in a nondefault VPC, you must specify the security group ID.
        :param pulumi.Input[builtins.str] source_security_group_name: [EC2-Classic, default VPC] The name of the source security group.
               
               You must specify the GroupName property or the GroupId property. For security groups that are in a VPC, you must use the GroupId property.
        :param pulumi.Input[builtins.str] source_security_group_owner_id: [nondefault VPC] The AWS account ID that owns the source security group. You can't specify this property with an IP address range.
               
               If you specify SourceSecurityGroupName or SourceSecurityGroupId and that security group is owned by a different account than the account creating the stack, you must specify the SourceSecurityGroupOwnerId; otherwise, this property is optional.
        :param pulumi.Input[builtins.int] to_port: The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 code. A value of -1 indicates all ICMP/ICMPv6 codes for the specified ICMP type. If you specify all ICMP/ICMPv6 types, you must specify all codes.
    ...
    def source_prefix_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_prefix_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_security_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_security_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_security_group_name", value)

    @property
    @pulumi.getter(name="sourceSecurityGroupOwnerId")
    def source_security_group_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_security_group_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityGroupIngress(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sourcePrefixListId")
    def source_prefix_list_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [EC2-VPC only] The ID of a prefix list.
        """
        return pulumi.get(self, "source_prefix_list_id")
    ...
    @property
    @pulumi.getter(name="sourceSecurityGroupName")
    def source_security_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [EC2-Classic, default VPC] The name of the source security group.
    ...
    @property
    @pulumi.getter(name="sourceSecurityGroupOwnerId")
    def source_security_group_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        [nondefault VPC] The AWS account ID that owns the source security group. You can't specify this property with an IP address range.
