...
@pulumi.type_token("aws-native:ec2:CarrierGateway")
class CarrierGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags for the carrier gateway.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC.
        """
        ...
    @overload
    ...
    def carrier_gateway_id(self) -> pulumi.Output[_builtins.str]:
        """
