...
class CarrierGateway(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CarrierGatewayPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CarrierGatewayPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CarrierGatewayAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CarrierGatewayProperties']:
        """
