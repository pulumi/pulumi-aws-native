...
class PlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] partition_count: The number of partitions. Valid only when **Strategy** is set to `partition`
        :param pulumi.Input[builtins.str] spread_level: The Spread Level of Placement Group is an enum where it accepts either host or rack when strategy is spread
        :param pulumi.Input[builtins.str] strategy: The placement strategy.
...
class PlacementGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="spreadLevel")
    def spread_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Spread Level of Placement Group is an enum where it accepts either host or rack when strategy is spread
        """
        return pulumi.get(self, "spread_level")
