...
class GetVerifiedAccessGroupResult:
    ...
    def verified_access_group_arn(self) -> Optional[_builtins.str]:
        """
...
def get_verified_access_group(verified_access_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str verified_access_group_id: The ID of the AWS Verified Access group.
    """
    __args__ = dict()
