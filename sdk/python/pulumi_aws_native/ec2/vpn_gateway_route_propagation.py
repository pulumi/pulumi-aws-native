...
class VPNGatewayRoutePropagation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPNGatewayRoutePropagationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPNGatewayRoutePropagationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPNGatewayRoutePropagationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPNGatewayRoutePropagationProperties']:
        """
