...
class VpnGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of VPN connection the virtual private gateway supports.
        :param pulumi.Input[builtins.int] amazon_side_asn: The private Autonomous System Number (ASN) for the Amazon side of a BGP session.
