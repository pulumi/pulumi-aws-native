...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "aws-native:EC2:Host":
                return Host(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:EC2:Instance":
                return Instance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:EC2:InternetGateway":
                return InternetGateway(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:EC2:LaunchTemplate":
            ...
            elif typ == "aws-native:EC2:NatGateway":
                return NatGateway(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:EC2:NetworkAcl":
                return NetworkAcl(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:EC2:NetworkAclEntry":
