...
class CapacityReservationFleetTenancy(_builtins.str, Enum):
    """
...
class Ec2FleetCapacityRebalanceReplacementStrategy(_builtins.str, Enum):
    """
...
class Ec2FleetCapacityReservationOptionsRequestUsageStrategy(_builtins.str, Enum):
    """
...
class Ec2FleetExcessCapacityTerminationPolicy(_builtins.str, Enum):
    """
...
class Ec2FleetInstanceRequirementsRequestAcceleratorManufacturersItem(_builtins.str, Enum):
...
class Ec2FleetInstanceRequirementsRequestAcceleratorNamesItem(_builtins.str, Enum):
    A10G = "a10g"
    A100 = "a100"
    H100 = "h100"
...
class Ec2FleetInstanceRequirementsRequestAcceleratorTypesItem(_builtins.str, Enum):
    GPU = "gpu"
    FPGA = "fpga"
    INFERENCE = "inference"
...
class Ec2FleetInstanceRequirementsRequestBareMetal(_builtins.str, Enum):
    """
...
class Ec2FleetInstanceRequirementsRequestBurstablePerformance(_builtins.str, Enum):
    """
...
class Ec2FleetInstanceRequirementsRequestCpuManufacturersItem(_builtins.str, Enum):
    INTEL = "intel"
    AMD = "amd"
    AMAZON_WEB_SERVICES = "amazon-web-services"
    APPLE = "apple"
...
class Ec2FleetInstanceRequirementsRequestInstanceGenerationsItem(_builtins.str, Enum):
    CURRENT = "current"
    PREVIOUS = "previous"


@pulumi.type_token("aws-native:ec2:Ec2FleetInstanceRequirementsRequestLocalStorage")
class Ec2FleetInstanceRequirementsRequestLocalStorage(_builtins.str, Enum):
    """
...
class Ec2FleetSpotOptionsRequestAllocationStrategy(_builtins.str, Enum):
    """
...
class Ec2FleetSpotOptionsRequestInstanceInterruptionBehavior(_builtins.str, Enum):
    """
...
class Ec2FleetTagSpecificationResourceType(_builtins.str, Enum):
    """
...
class Ec2FleetTargetCapacitySpecificationRequestDefaultTargetCapacityType(_builtins.str, Enum):
    """
...
class Ec2FleetTargetCapacitySpecificationRequestTargetCapacityUnitType(_builtins.str, Enum):
    """
...
class Ec2FleetType(_builtins.str, Enum):
    """
...
class FlowLogDestinationOptionsPropertiesFileFormat(_builtins.str, Enum):
    """
...
class FlowLogLogDestinationType(_builtins.str, Enum):
    """
...
class FlowLogResourceType(_builtins.str, Enum):
    """
...
class FlowLogTrafficType(_builtins.str, Enum):
    """
...
class InstanceAffinity(_builtins.str, Enum):
    """
...
class InstanceMetadataOptionsHttpEndpoint(_builtins.str, Enum):
    """
...
class InstanceMetadataOptionsHttpProtocolIpv6(_builtins.str, Enum):
    """
...
class InstanceMetadataOptionsHttpTokens(_builtins.str, Enum):
    """
...
class InstanceMetadataOptionsInstanceMetadataTags(_builtins.str, Enum):
    """
...
class InstancePrivateDnsNameOptionsHostnameType(_builtins.str, Enum):
    """
...
class IpamMeteredAccount(_builtins.str, Enum):
    """
...
class IpamPoolAwsService(_builtins.str, Enum):
    """
...
class IpamPoolIpamScopeType(_builtins.str, Enum):
    """
...
class IpamPoolPublicIpSource(_builtins.str, Enum):
    """
...
class IpamPoolState(_builtins.str, Enum):
    """
...
class IpamScopeType(_builtins.str, Enum):
    """
    Determines whether this scope contains publicly routable space or space for a private network
    """
    PUBLIC = "public"
...
class KeyPairKeyFormat(_builtins.str, Enum):
    """
...
class KeyPairKeyType(_builtins.str, Enum):
    """
...
class NetworkInsightsAccessScopeAnalysisFindingsFound(_builtins.str, Enum):
    """
...
class NetworkInsightsAccessScopeAnalysisStatus(_builtins.str, Enum):
    """
...
class NetworkInsightsAccessScopeProtocol(_builtins.str, Enum):
    TCP = "tcp"
    UDP = "udp"


@pulumi.type_token("aws-native:ec2:NetworkInsightsAnalysisStatus")
class NetworkInsightsAnalysisStatus(_builtins.str, Enum):
    """
...
class PrefixListAddressFamily(_builtins.str, Enum):
    """
...
class RouteServerPeerBgpOptionsPeerLivenessDetection(_builtins.str, Enum):
    """
...
class RouteServerPersistRoutes(_builtins.str, Enum):
    """
...
class SecurityGroupVpcAssociationState(_builtins.str, Enum):
...
class SnapshotBlockPublicAccessState(_builtins.str, Enum):
    """
...
class SpotFleetInstanceRequirementsRequestAcceleratorNamesItem(_builtins.str, Enum):
    A10G = "a10g"
    A100 = "a100"
    H100 = "h100"
    INFERENTIA = "inferentia"
...
class SpotFleetInstanceRequirementsRequestAcceleratorTypesItem(_builtins.str, Enum):
    GPU = "gpu"
    FPGA = "fpga"
    INFERENCE = "inference"
...
class SpotFleetInstanceRequirementsRequestBareMetal(_builtins.str, Enum):
    """
    Indicates whether bare metal instance types must be included, excluded, or required.
...
class SpotFleetInstanceRequirementsRequestBurstablePerformance(_builtins.str, Enum):
    """
    Indicates whether burstable performance T instance types are included, excluded, or required. For more information, see [Burstable performance instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html) .
...
class SpotFleetInstanceRequirementsRequestCpuManufacturersItem(_builtins.str, Enum):
    INTEL = "intel"
    AMD = "amd"
    AMAZON_WEB_SERVICES = "amazon-web-services"
    APPLE = "apple"
...
class SpotFleetInstanceRequirementsRequestInstanceGenerationsItem(_builtins.str, Enum):
    CURRENT = "current"
    PREVIOUS = "previous"


@pulumi.type_token("aws-native:ec2:SpotFleetInstanceRequirementsRequestLocalStorage")
class SpotFleetInstanceRequirementsRequestLocalStorage(_builtins.str, Enum):
    """
    Indicates whether instance types with instance store volumes are included, excluded, or required. For more information, [Amazon EC2 instance store](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html) in the *Amazon EC2 User Guide* .
...
class SpotFleetInstanceRequirementsRequestLocalStorageTypesItem(_builtins.str, Enum):
    HDD = "hdd"
    SSD = "ssd"


@pulumi.type_token("aws-native:ec2:SpotFleetRequestConfigDataAllocationStrategy")
class SpotFleetRequestConfigDataAllocationStrategy(_builtins.str, Enum):
    """
...
class SpotFleetRequestConfigDataExcessCapacityTerminationPolicy(_builtins.str, Enum):
    """
...
class SpotFleetRequestConfigDataInstanceInterruptionBehavior(_builtins.str, Enum):
    """
...
class SpotFleetRequestConfigDataTargetCapacityUnitType(_builtins.str, Enum):
    """
...
class SpotFleetRequestConfigDataType(_builtins.str, Enum):
    """
...
class SpotFleetSpotCapacityRebalanceReplacementStrategy(_builtins.str, Enum):
    """
    The replacement strategy to use. Only available for fleets of type `maintain` .
...
class SpotFleetSpotPlacementTenancy(_builtins.str, Enum):
    """
...
class SpotFleetTagSpecificationResourceType(_builtins.str, Enum):
    """
...
class VpcBlockPublicAccessOptionsInternetGatewayBlockMode(_builtins.str, Enum):
    """
...
class VpcEndpointDnsOptionsSpecificationDnsRecordIpType(_builtins.str, Enum):
    """
...
class VpcEndpointDnsOptionsSpecificationPrivateDnsOnlyForInboundResolverEndpoint(_builtins.str, Enum):
    """
...
class VpcEndpointIpAddressType(_builtins.str, Enum):
    """
...
class VpcEndpointServiceIpAddressType(_builtins.str, Enum):
    IPV4 = "ipv4"
    IPV6 = "ipv6"
...
class VpnConnectionCloudwatchLogOptionsSpecificationLogOutputFormat(_builtins.str, Enum):
    """
...
class VpnConnectionIkeVersionsRequestListValueValue(_builtins.str, Enum):
    """
    The IKE version.
    """
    IKEV1 = "ikev1"
...
class VpnConnectionPhase1EncryptionAlgorithmsRequestListValueValue(_builtins.str, Enum):
    """
...
class VpnConnectionPhase1IntegrityAlgorithmsRequestListValueValue(_builtins.str, Enum):
    """
...
class VpnConnectionPhase2EncryptionAlgorithmsRequestListValueValue(_builtins.str, Enum):
    """
...
class VpnConnectionPhase2IntegrityAlgorithmsRequestListValueValue(_builtins.str, Enum):
    """
...
class VpnConnectionVpnTunnelOptionsSpecificationDpdTimeoutAction(_builtins.str, Enum):
    """
...
class VpnConnectionVpnTunnelOptionsSpecificationStartupAction(_builtins.str, Enum):
    """
