...
def get_route_table(route_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str route_table_id: The ID of the route table.
    """
    __args__ = dict()
...
def get_route_table_output(route_table_id: Optional[pulumi.Input[builtins.str]] = None,
