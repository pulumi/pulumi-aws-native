...
def get_ipam_scope(ipam_scope_id: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIpamScopeResult:
    """
    Resource Schema of AWS::EC2::IPAMScope Type


    :param builtins.str ipam_scope_id: Id of the IPAM scope.
    """
    __args__ = dict()
...
def get_ipam_scope_output(ipam_scope_id: Optional[pulumi.Input[builtins.str]] = None,
