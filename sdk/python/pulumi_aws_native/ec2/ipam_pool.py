...
class IpamPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address_family: The address family of the address space in this pool. Either IPv4 or IPv6.
        :param pulumi.Input[builtins.str] ipam_scope_id: The Id of the scope this pool is a part of.
        :param pulumi.Input[builtins.int] allocation_default_netmask_length: The default netmask length for allocations made from this pool. This value is used when the netmask length of an allocation isn't specified.
        :param pulumi.Input[builtins.int] allocation_max_netmask_length: The maximum allowed netmask length for allocations made from this pool.
        :param pulumi.Input[builtins.int] allocation_min_netmask_length: The minimum allowed netmask length for allocations made from this pool.
        ...
        :param pulumi.Input[builtins.bool] auto_import: Determines what to do if IPAM discovers resources that haven't been assigned an allocation. If set to true, an allocation will be made automatically.
        ...
        :param pulumi.Input[builtins.str] description: The description of the IPAM pool.
        :param pulumi.Input[builtins.str] locale: The region of this pool. If not set, this will default to "None" which will disable non-custom allocations. If the locale has been specified for the source pool, this value must match.
        ...
        :param pulumi.Input[builtins.bool] publicly_advertisable: Determines whether or not address space from this pool is publicly advertised. Must be set if and only if the pool is IPv6.
        :param pulumi.Input[builtins.str] source_ipam_pool_id: The Id of this pool's source. If set, all space provisioned in this pool must be free space provisioned in the parent pool.
...
class IpamPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allocation_max_netmask_length: Optional[pulumi.Input[builtins.int]] = None,
                 allocation_min_netmask_length: Optional[pulumi.Input[builtins.int]] = None,
                 allocation_resource_tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IpamPoolTagArgs', 'IpamPoolTagArgsDict']]]]] = None,
                 auto_import: Optional[pulumi.Input[builtins.bool]] = None,
                 aws_service: Optional[pulumi.Input['IpamPoolAwsService']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_scope_id: Optional[pulumi.Input[builtins.str]] = None,
                 locale: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IpamPoolProvisionedCidrArgs', 'IpamPoolProvisionedCidrArgsDict']]]]] = None,
                 public_ip_source: Optional[pulumi.Input['IpamPoolPublicIpSource']] = None,
                 publicly_advertisable: Optional[pulumi.Input[builtins.bool]] = None,
                 source_ipam_pool_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_resource: Optional[pulumi.Input[Union['IpamPoolSourceResourceArgs', 'IpamPoolSourceResourceArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["addressFamily", "awsService", "ipamScopeId", "locale", "publicIpSource", "publiclyAdvertisable", "sourceIpamPoolId", "sourceResource"])
    ...
    def ipam_scope_arn(self) -> pulumi.Output[builtins.str]:
        """
