...
def get_vpn_gateway(vpn_gateway_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vpn_gateway_id: The ID of the VPN gateway.
    """
    __args__ = dict()
...
def get_vpn_gateway_output(vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
