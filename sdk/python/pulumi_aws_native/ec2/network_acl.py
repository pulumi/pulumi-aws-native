...
warnings.warn("""NetworkAcl is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class NetworkAcl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpc_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkAcl is deprecated: NetworkAcl is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
