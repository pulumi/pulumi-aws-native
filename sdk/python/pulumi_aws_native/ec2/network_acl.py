...
class NetworkAcl(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NetworkAclPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NetworkAclPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NetworkAclAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NetworkAclProperties']:
        """
