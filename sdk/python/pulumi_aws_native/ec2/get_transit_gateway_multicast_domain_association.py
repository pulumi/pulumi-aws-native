...
def get_transit_gateway_multicast_domain_association(subnet_id: Optional[builtins.str] = None,
    ...
    :param builtins.str subnet_id: The IDs of the subnets to associate with the transit gateway multicast domain.
...
def get_transit_gateway_multicast_domain_association_output(subnet_id: Optional[pulumi.Input[builtins.str]] = None,
