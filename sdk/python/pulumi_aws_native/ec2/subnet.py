...
class SubnetArgs:
    def __init__(__self__, *,
                 ...
                 private_dns_name_options_on_launch: pulumi.Input[Optional['PrivateDnsNameOptionsOnLaunchPropertiesArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] availability_zone: The Availability Zone of the subnet.
                If you update this property, you must also update the ``CidrBlock`` property.
        ...
        :param pulumi.Input[_builtins.bool] enable_dns64: Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet should return synthetic IPv6 addresses for IPv4-only destinations.
        ...
        :param pulumi.Input[_builtins.int] enable_lni_at_device_index: Indicates the device position for local network interfaces in this subnet. For example, ``1`` indicates local network interfaces in this subnet are the secondary network interface (eth1).
        :param pulumi.Input[_builtins.str] ipv4_ipam_pool_id: An IPv4 IPAM pool ID for the subnet.
        :param pulumi.Input[_builtins.int] ipv4_netmask_length: An IPv4 netmask length for the subnet.
        :param pulumi.Input[_builtins.str] ipv6_cidr_block: The IPv6 CIDR block.
                If you specify ``AssignIpv6AddressOnCreation``, you must also specify an IPv6 CIDR block.
        :param pulumi.Input[_builtins.str] ipv6_ipam_pool_id: An IPv6 IPAM pool ID for the subnet.
        :param pulumi.Input[_builtins.bool] ipv6_native: Indicates whether this is an IPv6 only subnet. For more information, see [Subnet basics](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html#subnet-basics) in the *User Guide*.
        :param pulumi.Input[_builtins.int] ipv6_netmask_length: An IPv6 netmask length for the subnet.
        :param pulumi.Input[_builtins.bool] map_public_ip_on_launch: Indicates whether instances launched in this subnet receive a public IPv4 address. The default value is ``false``.
    ...
    def private_dns_name_options_on_launch(self) -> pulumi.Input[Optional['PrivateDnsNameOptionsOnLaunchPropertiesArgs']]:
        """
    ...
    def private_dns_name_options_on_launch(self, value: pulumi.Input[Optional['PrivateDnsNameOptionsOnLaunchPropertiesArgs']]):
...
class Subnet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 map_public_ip_on_launch: pulumi.Input[Optional[_builtins.bool]] = None,
                 outpost_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 private_dns_name_options_on_launch: pulumi.Input[Optional[Union['PrivateDnsNameOptionsOnLaunchPropertiesArgs', 'PrivateDnsNameOptionsOnLaunchPropertiesArgsDict', 'outputs.PrivateDnsNameOptionsOnLaunchProperties']]] = None,
        ...
        :param pulumi.Input[_builtins.bool] map_public_ip_on_launch: Indicates whether instances launched in this subnet receive a public IPv4 address. The default value is ``false``.
                AWS charges for all public IPv4 addresses, including public IPv4 addresses associated with running instances and Elastic IP addresses. For more information, see the *Public IPv4 Address* tab on the [VPC pricing page](https://docs.aws.amazon.com/vpc/pricing/).
        :param pulumi.Input[_builtins.str] outpost_arn: The Amazon Resource Name (ARN) of the Outpost.
        :param pulumi.Input[Union['PrivateDnsNameOptionsOnLaunchPropertiesArgs', 'PrivateDnsNameOptionsOnLaunchPropertiesArgsDict', 'outputs.PrivateDnsNameOptionsOnLaunchProperties']] private_dns_name_options_on_launch: The hostname type for EC2 instances launched into this subnet and how DNS A and AAAA record queries to the instances should be handled. For more information, see [Amazon EC2 instance hostname types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-naming.html) in the *User Guide*.
                Available options:
                 +  EnableResourceNameDnsAAAARecord (true | false)
                 +  EnableResourceNameDnsARecord (true | false)
                 +  HostnameType (ip-name | resource-name)
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Any tags assigned to the subnet.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC the subnet is in.
                If you update this property, you must also update the ``CidrBlock`` property.
        """
        ...
    ...
    def network_acl_association_id(self) -> pulumi.Output[_builtins.str]:
        """
