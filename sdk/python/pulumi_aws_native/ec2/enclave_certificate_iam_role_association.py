...
class EnclaveCertificateIamRoleAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_arn: The Amazon Resource Name (ARN) of the ACM certificate with which to associate the IAM role.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to associate with the ACM certificate. You can associate up to 16 IAM roles with an ACM certificate.
        """
...
class EnclaveCertificateIamRoleAssociation(pulumi.CustomResource):
    ...
    def certificate_s3_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def certificate_s3_object_key(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def encryption_kms_key_id(self) -> pulumi.Output[builtins.str]:
        """
