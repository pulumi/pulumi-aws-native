...
class IpamPoolCidrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: Represents a single IPv4 or IPv6 CIDR
        :param pulumi.Input[builtins.int] netmask_length: The desired netmask length of the provision. If set, IPAM will choose a block of free space with this size and return the CIDR representing it.
        """
