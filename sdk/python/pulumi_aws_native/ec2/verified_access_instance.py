...
class VerifiedAccessInstanceArgs:
    def __init__(__self__, *,
                 cidr_endpoints_custom_sub_domain: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 verified_access_trust_provider_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] cidr_endpoints_custom_sub_domain: Introduce CidrEndpointsCustomSubDomain property to represent the domain (say, ava.my-company.com)
        :param pulumi.Input[builtins.str] description: A description for the AWS Verified Access instance.
        :param pulumi.Input[builtins.bool] fips_enabled: Indicates whether FIPS is enabled
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] verified_access_trust_provider_ids: The IDs of the AWS Verified Access trust providers.
    ...
    def cidr_endpoints_custom_sub_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cidr_endpoints_custom_sub_domain(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def verified_access_trust_provider_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def verified_access_trust_provider_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class VerifiedAccessInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cidrEndpointsCustomSubDomain")
    def cidr_endpoints_custom_sub_domain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Introduce CidrEndpointsCustomSubDomain property to represent the domain (say, ava.my-company.com)
        """
        return pulumi.get(self, "cidr_endpoints_custom_sub_domain")
    ...
    def cidr_endpoints_custom_sub_domain_name_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="verifiedAccessTrustProviderIds")
    def verified_access_trust_provider_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the AWS Verified Access trust providers.
        """
        return pulumi.get(self, "verified_access_trust_provider_ids")
