...
class VerifiedAccessGroupArgs:
    def __init__(__self__, *,
                 verified_access_instance_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] verified_access_instance_id: The ID of the AWS Verified Access instance.
        :param pulumi.Input[builtins.str] description: A description for the AWS Verified Access group.
    ...
    def verified_access_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def verified_access_instance_id(self, value: pulumi.Input[builtins.str]):
...
class VerifiedAccessGroup(pulumi.CustomResource):
    ...
    def verified_access_group_arn(self) -> pulumi.Output[builtins.str]:
        """
