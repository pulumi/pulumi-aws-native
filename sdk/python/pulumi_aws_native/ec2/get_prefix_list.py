...
class GetPrefixListResult:
    ...
    def max_entries(self) -> Optional[builtins.int]:
        """
...
def get_prefix_list(prefix_list_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPrefixListResult:
    """
    Resource schema of AWS::EC2::PrefixList Type


    :param builtins.str prefix_list_id: Id of Prefix List.
    """
    __args__ = dict()
...
def get_prefix_list_output(prefix_list_id: Optional[pulumi.Input[builtins.str]] = None,
