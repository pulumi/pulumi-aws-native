...
def get_transit_gateway_connect(transit_gateway_attachment_id: Optional[builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitGatewayConnectResult:
    """
    The AWS::EC2::TransitGatewayConnect type


    :param builtins.str transit_gateway_attachment_id: The ID of the Connect attachment.
    """
    __args__ = dict()
...
def get_transit_gateway_connect_output(transit_gateway_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
