...
class TransitGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_route_table_association: Enable or disable automatic association with the default association route table. Enabled by default. If `DefaultRouteTableAssociation` is set to enable, AWS Transit Gateway will create the default transit gateway route table.
...
class TransitGateway(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="associationDefaultRouteTableId")
    def association_default_route_table_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the default association route table.
        """
        return pulumi.get(self, "association_default_route_table_id")
    ...
    @_builtins.property
    @pulumi.getter(name="propagationDefaultRouteTableId")
    def propagation_default_route_table_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the default propagation route table.
        """
        return pulumi.get(self, "propagation_default_route_table_id")
