...
class TransitGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] propagation_default_route_table_id: The ID of the default propagation route table.
        :param pulumi.Input[builtins.str] security_group_referencing_support: Enables you to reference a security group across VPCs attached to a transit gateway (TGW). Use this option to simplify security group management and control of instance-to-instance traffic across VPCs that are connected by transit gateway. You can also use this option to migrate from VPC peering (which was the only option that supported security group referencing) to transit gateways (which now also support security group referencing). This option is disabled by default and there are no additional costs to use this feature.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transit_gateway_cidr_blocks: The transit gateway CIDR blocks.
        :param pulumi.Input[builtins.str] vpn_ecmp_support: Enable or disable Equal Cost Multipath Protocol support. Enabled by default.
        """
...
class TransitGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="associationDefaultRouteTableId")
    def association_default_route_table_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the default association route table.
        """
        return pulumi.get(self, "association_default_route_table_id")
    ...
    @property
    @pulumi.getter(name="propagationDefaultRouteTableId")
    def propagation_default_route_table_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the default propagation route table.
        """
        return pulumi.get(self, "propagation_default_route_table_id")
