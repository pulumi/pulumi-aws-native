...
def get_eip_association(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the association.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_eip_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
