...
class HostArgs:
    def __init__(__self__, *,
                 ...
                 host_maintenance: Optional[pulumi.Input[builtins.str]] = None,
                 host_recovery: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone in which to allocate the Dedicated Host.
        :param pulumi.Input[builtins.str] asset_id: The ID of the Outpost hardware asset.
        :param pulumi.Input[builtins.str] auto_placement: Indicates whether the host accepts any untargeted instance launches that match its instance type configuration, or if it only accepts Host tenancy instance launches that specify its unique host ID.
        :param pulumi.Input[builtins.str] host_maintenance: Automatically allocates a new dedicated host and moves your instances on to it if a degradation is detected on your current host.
        :param pulumi.Input[builtins.str] host_recovery: Indicates whether to enable or disable host recovery for the Dedicated Host. Host recovery is disabled by default.
        :param pulumi.Input[builtins.str] instance_family: Specifies the instance family to be supported by the Dedicated Hosts. If you specify an instance family, the Dedicated Hosts support multiple instance types within that instance family.
        :param pulumi.Input[builtins.str] instance_type: Specifies the instance type to be supported by the Dedicated Hosts. If you specify an instance type, the Dedicated Hosts support instances of the specified instance type only.
        :param pulumi.Input[builtins.str] outpost_arn: The Amazon Resource Name (ARN) of the Amazon Web Services Outpost on which to allocate the Dedicated Host.
    ...
    def host_maintenance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_maintenance(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_maintenance", value)

    @property
    @pulumi.getter(name="hostRecovery")
    def host_recovery(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_recovery(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Host(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assetId")
    def asset_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Outpost hardware asset.
        """
        return pulumi.get(self, "asset_id")
    ...
    @property
    @pulumi.getter(name="hostMaintenance")
    def host_maintenance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Automatically allocates a new dedicated host and moves your instances on to it if a degradation is detected on your current host.
        """
        return pulumi.get(self, "host_maintenance")
    ...
    @property
    @pulumi.getter(name="hostRecovery")
    def host_recovery(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether to enable or disable host recovery for the Dedicated Host. Host recovery is disabled by default.
        """
        return pulumi.get(self, "host_recovery")
    ...
    @property
    @pulumi.getter(name="instanceFamily")
    def instance_family(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the instance family to be supported by the Dedicated Hosts. If you specify an instance family, the Dedicated Hosts support multiple instance types within that instance family.
        """
        return pulumi.get(self, "instance_family")
