...
def get_customer_gateway(customer_gateway_id: Optional[builtins.str] = None,
...
def get_customer_gateway_output(customer_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
