...
class IpamAllocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipam_pool_id: Id of the IPAM Pool.
        :param pulumi.Input[builtins.str] cidr: The CIDR you would like to allocate from the IPAM pool. Note the following:
               
               - If there is no DefaultNetmaskLength allocation rule set on the pool, you must specify either the NetmaskLength or the CIDR.
               - If the DefaultNetmaskLength allocation rule is set on the pool, you can specify either the NetmaskLength or the CIDR and the DefaultNetmaskLength allocation rule will be ignored.
               
               Possible values: Any available IPv4 or IPv6 CIDR.
        :param pulumi.Input[builtins.str] description: A description for the allocation.
        :param pulumi.Input[builtins.int] netmask_length: The desired netmask length of the allocation. If set, IPAM will choose a block of free space with this size and return the CIDR representing it.
        """
