...
class LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] local_gateway_route_table_id: The ID of the local gateway route table.
        :param pulumi.Input[builtins.str] local_gateway_virtual_interface_group_id: The ID of the local gateway route table virtual interface group.
...
class LocalGatewayRouteTableVirtualInterfaceGroupAssociation(pulumi.CustomResource):
    ...
    def local_gateway_route_table_virtual_interface_group_association_id(self) -> pulumi.Output[builtins.str]:
        """
