...
class GetNetworkInsightsAccessScopeResult:
    ...
    def network_insights_access_scope_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def network_insights_access_scope_id(self) -> Optional[_builtins.str]:
        """
...
def get_network_insights_access_scope(network_insights_access_scope_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_insights_access_scope_id: The ID of the Network Access Scope.
    """
    __args__ = dict()
