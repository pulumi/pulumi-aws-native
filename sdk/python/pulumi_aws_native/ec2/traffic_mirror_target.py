...
warnings.warn("""TrafficMirrorTarget is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class TrafficMirrorTarget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TrafficMirrorTargetTagArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""TrafficMirrorTarget is deprecated: TrafficMirrorTarget is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
