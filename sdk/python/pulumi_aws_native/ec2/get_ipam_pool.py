...
class GetIpamPoolResult:
    ...
    def allocation_default_netmask_length(self) -> Optional[builtins.int]:
        """
    ...
    def allocation_max_netmask_length(self) -> Optional[builtins.int]:
        """
    ...
    def allocation_min_netmask_length(self) -> Optional[builtins.int]:
        """
    ...
    def auto_import(self) -> Optional[builtins.bool]:
        """
    ...
    def ipam_arn(self) -> Optional[builtins.str]:
        """
    ...
    def ipam_scope_arn(self) -> Optional[builtins.str]:
        """
    ...
    def pool_depth(self) -> Optional[builtins.int]:
        """
...
def get_ipam_pool(ipam_pool_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIpamPoolResult:
    """
    Resource Schema of AWS::EC2::IPAMPool Type


    :param builtins.str ipam_pool_id: Id of the IPAM Pool.
    """
    __args__ = dict()
...
def get_ipam_pool_output(ipam_pool_id: Optional[pulumi.Input[builtins.str]] = None,
