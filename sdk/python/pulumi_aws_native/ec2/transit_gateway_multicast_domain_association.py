...
class TransitGatewayMulticastDomainAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subnet_id: The IDs of the subnets to associate with the transit gateway multicast domain.
...
@pulumi.type_token("aws-native:ec2:TransitGatewayMulticastDomainAssociation")
class TransitGatewayMulticastDomainAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["subnetId", "transitGatewayAttachmentId", "transitGatewayMulticastDomainId"])
