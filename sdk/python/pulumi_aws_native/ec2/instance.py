...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cpu_options, InstanceCpuOptionsArgs):
            ...
            if not isinstance(credit_specification, InstanceCreditSpecificationArgs):
            ...
            if not isinstance(enclave_options, InstanceEnclaveOptionsArgs):
            ...
            if not isinstance(hibernation_options, InstanceHibernationOptionsArgs):
            ...
            if not isinstance(launch_template, InstanceLaunchTemplateSpecificationArgs):
            ...
            if not isinstance(private_dns_name_options, InstancePrivateDnsNameOptionsArgs):
