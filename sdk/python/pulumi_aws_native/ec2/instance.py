...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 propagate_tags_to_volume_on_creation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] additional_info: This property is reserved for internal use. If you use it, the stack fails with this error: Bad property set: [Testing this property] (Service: AmazonEC2; Status Code: 400; Error Code: InvalidParameterCombination; Request ID: 0XXXXXX-49c7-4b40-8bcc-76885dcXXXXX).
        ...
        :param pulumi.Input[builtins.str] host_resource_group_arn: The ARN of the host resource group in which to launch the instances. If you specify a host resource group ARN, omit the Tenancy parameter or set it to host.
        :param pulumi.Input[builtins.str] iam_instance_profile: The IAM instance profile.
        :param pulumi.Input[builtins.str] image_id: The ID of the AMI. An AMI ID is required to launch an instance and must be specified here or in a launch template.
        :param pulumi.Input[builtins.str] instance_initiated_shutdown_behavior: Indicates whether an instance stops or terminates when you initiate shutdown from the instance (using the operating system command for system shutdown).
        :param pulumi.Input[builtins.str] instance_type: The instance type.
        :param pulumi.Input[builtins.int] ipv6_address_count: [EC2-VPC] The number of IPv6 addresses to associate with the primary network interface. Amazon EC2 chooses the IPv6 addresses from the range of your subnet.
        ...
        :param pulumi.Input[builtins.str] kernel_id: The ID of the kernel.
        ...
        :param pulumi.Input[builtins.str] private_ip_address: [EC2-VPC] The primary IPv4 address. You must specify a value from the IPv4 address range of the subnet.
        :param pulumi.Input[builtins.bool] propagate_tags_to_volume_on_creation: Indicates whether to assign the tags from the instance to all of the volumes attached to the instance at launch. If you specify true and you assign tags to the instance, those tags are automatically assigned to all of the volumes that you attach to the instance at launch. If you specify false, those tags are not assigned to the attached volumes.
        :param pulumi.Input[builtins.str] ramdisk_id: The ID of the RAM disk to select.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The IDs of the security groups.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: the names of the security groups. For a nondefault VPC, you must use security group IDs instead.
        :param pulumi.Input[builtins.bool] source_dest_check: Specifies whether to enable an instance launched in a VPC to perform NAT.
        ...
        :param pulumi.Input[builtins.str] subnet_id: [EC2-VPC] The ID of the subnet to launch the instance into.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: The tags to add to the instance.
        :param pulumi.Input[builtins.str] tenancy: The tenancy of the instance (if the instance is running in a VPC). An instance with a tenancy of dedicated runs on single-tenant hardware.
        :param pulumi.Input[builtins.str] user_data: The user data to make available to the instance.
    ...
    def placement_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def placement_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def propagate_tags_to_volume_on_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def propagate_tags_to_volume_on_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hostId")
    def host_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If you specify host for the Affinity property, the ID of a dedicated host that the instance is associated with. If you don't specify an ID, Amazon EC2 launches the instance onto any available, compatible dedicated host in your account.
        """
        return pulumi.get(self, "host_id")
    ...
    @property
    @pulumi.getter(name="hostResourceGroupArn")
    def host_resource_group_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the host resource group in which to launch the instances. If you specify a host resource group ARN, omit the Tenancy parameter or set it to host.
        """
        return pulumi.get(self, "host_resource_group_arn")
    ...
    @property
    @pulumi.getter(name="placementGroupName")
    def placement_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of an existing placement group that you want to launch the instance into (cluster | partition | spread).
        """
        return pulumi.get(self, "placement_group_name")
    ...
    @property
    @pulumi.getter(name="propagateTagsToVolumeOnCreation")
    def propagate_tags_to_volume_on_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to assign the tags from the instance to all of the volumes attached to the instance at launch. If you specify true and you assign tags to the instance, those tags are automatically assigned to all of the volumes that you attach to the instance at launch. If you specify false, those tags are not assigned to the attached volumes.
        """
        return pulumi.get(self, "propagate_tags_to_volume_on_creation")
    ...
    def public_dns_name(self) -> pulumi.Output[builtins.str]:
        """
