...
class TransitGatewayConnectArgs:
    ...
    def transport_transit_gateway_attachment_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def transport_transit_gateway_attachment_id(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("aws-native:ec2:TransitGatewayConnect")
class TransitGatewayConnect(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 options: pulumi.Input[Optional[Union['TransitGatewayConnectOptionsArgs', 'TransitGatewayConnectOptionsArgsDict', 'outputs.TransitGatewayConnectOptions']]] = None,
        ...
        :param pulumi.Input[Union['TransitGatewayConnectOptionsArgs', 'TransitGatewayConnectOptionsArgsDict', 'outputs.TransitGatewayConnectOptions']] options: The Connect attachment options.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags for the attachment.
        :param pulumi.Input[_builtins.str] transport_transit_gateway_attachment_id: The ID of the attachment from which the Connect attachment was created.
        """
        ...
    @overload
    ...
    @_builtins.property
    @pulumi.getter(name="transportTransitGatewayAttachmentId")
    def transport_transit_gateway_attachment_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the attachment from which the Connect attachment was created.
        """
        return pulumi.get(self, "transport_transit_gateway_attachment_id")
