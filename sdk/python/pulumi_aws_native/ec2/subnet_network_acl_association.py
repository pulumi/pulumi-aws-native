...
warnings.warn("""SubnetNetworkAclAssociation is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class SubnetNetworkAclAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SubnetNetworkAclAssociation is deprecated: SubnetNetworkAclAssociation is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
