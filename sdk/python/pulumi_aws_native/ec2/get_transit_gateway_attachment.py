...
def get_transit_gateway_attachment(id: Optional[builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitGatewayAttachmentResult:
    """
    Resource Type definition for AWS::EC2::TransitGatewayAttachment


    :param builtins.str id: The ID of the attachment.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_transit_gateway_attachment_output(id: Optional[pulumi.Input[builtins.str]] = None,
