...
class RouteServerPeerArgs:
    def __init__(__self__, *,
                 ...
                 route_server_endpoint_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] peer_address: IP address of the Route Server Peer
        :param pulumi.Input[str] route_server_endpoint_id: Route Server Endpoint ID
    ...
    def route_server_endpoint_id(self) -> pulumi.Input[str]:
        """
    ...
    def route_server_endpoint_id(self, value: pulumi.Input[str]):
...
class RouteServerPeer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 route_server_endpoint_id: Optional[pulumi.Input[str]] = None,
    ...
    def endpoint_eni_address(self) -> pulumi.Output[str]:
        """
    ...
    def endpoint_eni_id(self) -> pulumi.Output[str]:
        """
    ...
    @property
    @pulumi.getter(name="routeServerEndpointId")
    def route_server_endpoint_id(self) -> pulumi.Output[str]:
        """
        Route Server Endpoint ID
        """
        return pulumi.get(self, "route_server_endpoint_id")
