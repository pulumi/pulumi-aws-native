...
def get_subnet_network_acl_association(association_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str association_id: Returns the value of this object's AssociationId property.
    """
    __args__ = dict()
