...
class GetHostResult:
    ...
    def auto_placement(self) -> Optional[builtins.str]:
        """
    ...
    def host_maintenance(self) -> Optional[builtins.str]:
        """
    ...
    def host_recovery(self) -> Optional[builtins.str]:
        """
...
def get_host(host_id: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHostResult:
    """
    Resource Type definition for AWS::EC2::Host


    :param builtins.str host_id: ID of the host created.
    """
    __args__ = dict()
...
def get_host_output(host_id: Optional[pulumi.Input[builtins.str]] = None,
