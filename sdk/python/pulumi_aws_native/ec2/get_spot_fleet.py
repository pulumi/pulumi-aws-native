...
def get_spot_fleet(id: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSpotFleetResult:
    """
    Resource Type definition for AWS::EC2::SpotFleet


    :param builtins.str id: The ID of the Spot Fleet.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_spot_fleet_output(id: Optional[pulumi.Input[builtins.str]] = None,
