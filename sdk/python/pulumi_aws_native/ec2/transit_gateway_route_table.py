...
warnings.warn("""TransitGatewayRouteTable is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class TransitGatewayRouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 transit_gateway_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TransitGatewayRouteTable is deprecated: TransitGatewayRouteTable is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
