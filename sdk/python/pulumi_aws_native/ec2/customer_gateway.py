...
warnings.warn("""CustomerGateway is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class CustomerGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CustomerGateway is deprecated: CustomerGateway is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
