...
class PrefixListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_entries: Max Entries of Prefix List.
        :param pulumi.Input[builtins.str] prefix_list_name: Name of Prefix List.
...
class PrefixList(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="maxEntries")
    def max_entries(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Max Entries of Prefix List.
        """
        return pulumi.get(self, "max_entries")
