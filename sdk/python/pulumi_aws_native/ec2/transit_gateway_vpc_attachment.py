...
class TransitGatewayVpcAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 add_subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 options: Optional[pulumi.Input['OptionsPropertiesArgs']] = None,
                 remove_subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a TransitGatewayVpcAttachment resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The IDs of the subnets.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] add_subnet_ids: The IDs of one or more subnets to add. You can specify at most one subnet per Availability Zone.
        :param pulumi.Input['OptionsPropertiesArgs'] options: The options for the transit gateway vpc attachment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remove_subnet_ids: The IDs of one or more subnets to remove.
    ...
    def add_subnet_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def add_subnet_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def remove_subnet_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def remove_subnet_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("aws-native:ec2:TransitGatewayVpcAttachment")
class TransitGatewayVpcAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remove_subnet_ids: The IDs of one or more subnets to remove.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The IDs of the subnets.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: The tags for the VPC attachment.
        :param pulumi.Input[builtins.str] transit_gateway_id: The ID of the transit gateway.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        """
        ...
    ...
    @property
    @pulumi.getter(name="addSubnetIds")
    def add_subnet_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of one or more subnets to add. You can specify at most one subnet per Availability Zone.
        """
        return pulumi.get(self, "add_subnet_ids")
    ...
    @property
    @pulumi.getter(name="removeSubnetIds")
    def remove_subnet_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of one or more subnets to remove.
        """
        return pulumi.get(self, "remove_subnet_ids")
