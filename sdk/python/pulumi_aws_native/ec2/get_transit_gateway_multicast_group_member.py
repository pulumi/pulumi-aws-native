...
class GetTransitGatewayMulticastGroupMemberResult:
    ...
    def group_member(self) -> Optional[builtins.bool]:
        """
    ...
    def group_source(self) -> Optional[builtins.bool]:
        """
        Indicates that the resource is a transit gateway multicast group member.
        """
...
def get_transit_gateway_multicast_group_member(group_ip_address: Optional[builtins.str] = None,
    ...
    :param builtins.str network_interface_id: The ID of the transit gateway attachment.
    :param builtins.str transit_gateway_multicast_domain_id: The ID of the transit gateway multicast domain.
    """
    __args__ = dict()
...
def get_transit_gateway_multicast_group_member_output(group_ip_address: Optional[pulumi.Input[builtins.str]] = None,
