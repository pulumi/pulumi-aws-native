...
class LocalGatewayRouteTableVPCAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LocalGatewayRouteTableVPCAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LocalGatewayRouteTableVPCAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LocalGatewayRouteTableVPCAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LocalGatewayRouteTableVPCAssociationProperties']:
        """
