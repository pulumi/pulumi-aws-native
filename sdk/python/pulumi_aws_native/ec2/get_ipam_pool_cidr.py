...
class GetIpamPoolCidrResult:
    ...
    def ipam_pool_cidr_id(self) -> Optional[builtins.str]:
        """
...
def get_ipam_pool_cidr(ipam_pool_cidr_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ipam_pool_cidr_id: Id of the IPAM Pool Cidr.
...
def get_ipam_pool_cidr_output(ipam_pool_cidr_id: Optional[pulumi.Input[builtins.str]] = None,
