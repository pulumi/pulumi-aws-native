...
class NetworkInterfaceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 ena_srd_specification: pulumi.Input[Optional['NetworkInterfaceAttachmentEnaSrdSpecificationArgs']] = None):
        """
    ...
    def ena_srd_specification(self) -> pulumi.Input[Optional['NetworkInterfaceAttachmentEnaSrdSpecificationArgs']]:
        """
    ...
    def ena_srd_specification(self, value: pulumi.Input[Optional['NetworkInterfaceAttachmentEnaSrdSpecificationArgs']]):
...
class NetworkInterfaceAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["deviceIndex", "instanceId", "networkInterfaceId"])
    ...
    @_builtins.property
    @pulumi.getter(name="deleteOnTermination")
    def delete_on_termination(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to delete the network interface when the instance terminates. By default, this value is set to ``true``.
        """
        return pulumi.get(self, "delete_on_termination")
    ...
    @_builtins.property
    @pulumi.getter(name="deviceIndex")
    def device_index(self) -> pulumi.Output[_builtins.str]:
        """
        The network interface's position in the attachment order. For example, the first attached network interface has a ``DeviceIndex`` of 0.
        """
        return pulumi.get(self, "device_index")
    ...
    @_builtins.property
    @pulumi.getter(name="enaQueueCount")
    def ena_queue_count(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of ENA queues created with the instance.
        """
        return pulumi.get(self, "ena_queue_count")
