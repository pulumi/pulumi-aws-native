...
class NetworkAclEntry(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NetworkAclEntryPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NetworkAclEntryPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NetworkAclEntryAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NetworkAclEntryProperties']:
        """
