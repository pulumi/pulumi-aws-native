...
class VerifiedAccessTrustProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] trust_provider_type: Type of trust provider. Possible values: user|device
        :param pulumi.Input[builtins.str] description: A description for the Amazon Web Services Verified Access trust provider.
        ...
        :param pulumi.Input[builtins.str] device_trust_provider_type: The type of device-based trust provider. Possible values: jamf|crowdstrike
        ...
        :param pulumi.Input[builtins.str] user_trust_provider_type: The type of device-based trust provider. Possible values: oidc|iam-identity-center
        """
...
class VerifiedAccessTrustProvider(pulumi.CustomResource):
    ...
    def verified_access_trust_provider_id(self) -> pulumi.Output[builtins.str]:
        """
