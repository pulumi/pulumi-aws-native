...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] availability_zone_id: The ID of the Availability Zone for the volume.
        ...
        :param pulumi.Input[_builtins.str] source_volume_id: The ID of the source volume from which the volume copy was created. Only for volume copies.
