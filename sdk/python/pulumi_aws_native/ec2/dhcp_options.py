...
class DHCPOptions(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DHCPOptionsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DHCPOptionsPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DHCPOptionsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DHCPOptionsProperties']:
        """
