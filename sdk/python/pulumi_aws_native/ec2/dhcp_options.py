...
class DhcpOptionsArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_address_preferred_lease_time: Optional[pulumi.Input[builtins.int]] = None,
                 netbios_name_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 netbios_node_type: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_name: This value is used to complete unqualified DNS hostnames.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_name_servers: The IPv4 addresses of up to four domain name servers, or AmazonProvidedDNS.
        :param pulumi.Input[builtins.int] ipv6_address_preferred_lease_time: The preferred Lease Time for ipV6 address in seconds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] netbios_name_servers: The IPv4 addresses of up to four NetBIOS name servers.
        :param pulumi.Input[builtins.int] netbios_node_type: The NetBIOS node type (1, 2, 4, or 8).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: The IPv4 addresses of up to four Network Time Protocol (NTP) servers.
    ...
    def ipv6_address_preferred_lease_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ipv6_address_preferred_lease_time(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def netbios_node_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def netbios_node_type(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("aws-native:ec2:DhcpOptions")
class DhcpOptions(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ipv6AddressPreferredLeaseTime")
    def ipv6_address_preferred_lease_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The preferred Lease Time for ipV6 address in seconds.
        """
        return pulumi.get(self, "ipv6_address_preferred_lease_time")
    ...
    @property
    @pulumi.getter(name="netbiosNodeType")
    def netbios_node_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The NetBIOS node type (1, 2, 4, or 8).
        """
        return pulumi.get(self, "netbios_node_type")
