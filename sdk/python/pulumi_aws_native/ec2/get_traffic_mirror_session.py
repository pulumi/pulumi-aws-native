...
class GetTrafficMirrorSessionResult:
    ...
    def packet_length(self) -> Optional[builtins.int]:
        """
    ...
    def session_number(self) -> Optional[builtins.int]:
        """
    ...
    def traffic_mirror_target_id(self) -> Optional[builtins.str]:
        """
    ...
    def virtual_network_id(self) -> Optional[builtins.int]:
        """
...
def get_traffic_mirror_session(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of a Traffic Mirror session.
    """
    __args__ = dict()
    __args__['id'] = id
