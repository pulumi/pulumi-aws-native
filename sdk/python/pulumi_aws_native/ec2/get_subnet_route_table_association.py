...
def get_subnet_route_table_association(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the subnet route table association.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_subnet_route_table_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
