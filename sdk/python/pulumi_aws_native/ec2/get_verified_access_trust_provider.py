...
def get_verified_access_trust_provider(verified_access_trust_provider_id: Optional[builtins.str] = None,
    ...
    :param builtins.str verified_access_trust_provider_id: The ID of the Amazon Web Services Verified Access trust provider.
    """
    __args__ = dict()
...
def get_verified_access_trust_provider_output(verified_access_trust_provider_id: Optional[pulumi.Input[builtins.str]] = None,
