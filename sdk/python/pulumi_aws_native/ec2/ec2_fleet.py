...
class Ec2Fleet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(on_demand_options, Ec2FleetOnDemandOptionsRequestArgs):
            ...
            if not isinstance(spot_options, Ec2FleetSpotOptionsRequestArgs):
            ...
            if not isinstance(target_capacity_specification, Ec2FleetTargetCapacitySpecificationRequestArgs):
