...
warnings.warn("""RouteTable is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class RouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpc_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RouteTable is deprecated: RouteTable is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
