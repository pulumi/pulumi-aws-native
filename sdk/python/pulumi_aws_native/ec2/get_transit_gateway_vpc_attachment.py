...
def get_transit_gateway_vpc_attachment(id: Optional[builtins.str] = None,
...
def get_transit_gateway_vpc_attachment_output(id: Optional[pulumi.Input[builtins.str]] = None,
