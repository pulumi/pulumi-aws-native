...
class VerifiedAccessEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attachment_type: The type of attachment used to provide connectivity between the AWS Verified Access endpoint and the application.
        :param pulumi.Input[builtins.str] endpoint_type: The type of AWS Verified Access endpoint. Incoming application requests will be sent to an IP address, load balancer or a network interface depending on the endpoint type specified.The type of AWS Verified Access endpoint. Incoming application requests will be sent to an IP address, load balancer or a network interface depending on the endpoint type specified.
        :param pulumi.Input[builtins.str] verified_access_group_id: The ID of the AWS Verified Access group.
        :param pulumi.Input[builtins.str] application_domain: The DNS name for users to reach your application.
        :param pulumi.Input['VerifiedAccessEndpointCidrOptionsArgs'] cidr_options: The options for cidr type endpoint.
        :param pulumi.Input[builtins.str] description: A description for the AWS Verified Access endpoint.
        :param pulumi.Input[builtins.str] domain_certificate_arn: The ARN of a public TLS/SSL certificate imported into or created with ACM.
        :param pulumi.Input[builtins.str] endpoint_domain_prefix: A custom identifier that gets prepended to a DNS name that is generated for the endpoint.
        ...
        :param pulumi.Input[builtins.str] policy_document: The AWS Verified Access policy document.
        :param pulumi.Input[builtins.bool] policy_enabled: The status of the Verified Access policy.
        :param pulumi.Input['VerifiedAccessEndpointRdsOptionsArgs'] rds_options: The options for rds type endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The IDs of the security groups for the endpoint.
...
class VerifiedAccessEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="policyEnabled")
    def policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The status of the Verified Access policy.
        """
        return pulumi.get(self, "policy_enabled")
    ...
    def verified_access_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
