...
class VerifiedAccessEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(load_balancer_options, VerifiedAccessEndpointLoadBalancerOptionsArgs):
            ...
            if not isinstance(network_interface_options, VerifiedAccessEndpointNetworkInterfaceOptionsArgs):
