...
class VpcCidrBlockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ipv4_ipam_pool_id: The ID of the IPv4 IPAM pool to Associate a CIDR from to a VPC.
        :param pulumi.Input[_builtins.int] ipv4_netmask_length: The netmask length of the IPv4 CIDR you would like to associate from an Amazon VPC IP Address Manager (IPAM) pool.
        :param pulumi.Input[_builtins.str] ipv6_cidr_block: An IPv6 CIDR block from the IPv6 address pool.
        :param pulumi.Input[_builtins.str] ipv6_cidr_block_network_border_group: The name of the location from which we advertise the IPV6 CIDR block.
        :param pulumi.Input[_builtins.str] ipv6_ipam_pool_id: The ID of the IPv6 IPAM pool to Associate a CIDR from to a VPC.
        :param pulumi.Input[_builtins.int] ipv6_netmask_length: The netmask length of the IPv6 CIDR you would like to associate from an Amazon VPC IP Address Manager (IPAM) pool.
        :param pulumi.Input[_builtins.str] ipv6_pool: The ID of an IPv6 address pool from which to allocate the IPv6 CIDR block.
        """
...
class VpcCidrBlock(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="amazonProvidedIpv6CidrBlock")
    def amazon_provided_ipv6_cidr_block(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Requests an Amazon-provided IPv6 CIDR block with a /56 prefix length for the VPC. You cannot specify the range of IPv6 addresses, or the size of the CIDR block.
        """
        return pulumi.get(self, "amazon_provided_ipv6_cidr_block")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6CidrBlockNetworkBorderGroup")
    def ipv6_cidr_block_network_border_group(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the location from which we advertise the IPV6 CIDR block.
        """
        return pulumi.get(self, "ipv6_cidr_block_network_border_group")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6Pool")
    def ipv6_pool(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of an IPv6 address pool from which to allocate the IPv6 CIDR block.
        """
        return pulumi.get(self, "ipv6_pool")
