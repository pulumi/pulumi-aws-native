...
class VPCCidrBlock(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPCCidrBlockPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPCCidrBlockPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPCCidrBlockAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPCCidrBlockProperties']:
        """
