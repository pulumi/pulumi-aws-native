...
class GetLocalGatewayVirtualInterfaceResult:
    ...
    def local_bgp_asn(self) -> Optional[builtins.int]:
        """
    ...
    def local_gateway_virtual_interface_id(self) -> Optional[builtins.str]:
        """
...
def get_local_gateway_virtual_interface(local_gateway_virtual_interface_id: Optional[builtins.str] = None,
    ...
    :param builtins.str local_gateway_virtual_interface_id: The ID of the virtual interface
    """
    __args__ = dict()
...
def get_local_gateway_virtual_interface_output(local_gateway_virtual_interface_id: Optional[pulumi.Input[builtins.str]] = None,
