...
class ClientVpnEndpoint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClientVpnEndpointPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClientVpnEndpointPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClientVpnEndpointAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClientVpnEndpointProperties']:
        """
