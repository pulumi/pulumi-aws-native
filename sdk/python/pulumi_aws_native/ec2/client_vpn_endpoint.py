...
class ClientVpnEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(client_connect_options, ClientVpnEndpointClientConnectOptionsArgs):
            ...
            if not isinstance(client_login_banner_options, ClientVpnEndpointClientLoginBannerOptionsArgs):
            ...
            if not isinstance(connection_log_options, ClientVpnEndpointConnectionLogOptionsArgs):
