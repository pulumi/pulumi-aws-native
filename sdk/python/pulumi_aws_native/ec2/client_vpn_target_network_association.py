...
warnings.warn("""ClientVpnTargetNetworkAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ClientVpnTargetNetworkAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ClientVpnTargetNetworkAssociation is deprecated: ClientVpnTargetNetworkAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
