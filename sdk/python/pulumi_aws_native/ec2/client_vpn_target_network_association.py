...
__all__ = ['ClientVpnTargetNetworkAssociation']
...
class ClientVpnTargetNetworkAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClientVpnTargetNetworkAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClientVpnTargetNetworkAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClientVpnTargetNetworkAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClientVpnTargetNetworkAssociationProperties']:
        """
