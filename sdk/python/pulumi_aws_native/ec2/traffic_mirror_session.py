...
warnings.warn("""TrafficMirrorSession is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class TrafficMirrorSession(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_id: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""TrafficMirrorSession is deprecated: TrafficMirrorSession is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
