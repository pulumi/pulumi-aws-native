...
class GetNetworkInsightsPathResult:
    ...
    def network_insights_path_arn(self) -> Optional[builtins.str]:
        """
    ...
    def network_insights_path_id(self) -> Optional[builtins.str]:
        """
        The ID of the path.
        """
...
def get_network_insights_path(network_insights_path_id: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkInsightsPathResult:
    """
    Resource schema for AWS::EC2::NetworkInsightsPath


    :param builtins.str network_insights_path_id: The ID of the path.
    """
    __args__ = dict()
...
def get_network_insights_path_output(network_insights_path_id: Optional[pulumi.Input[builtins.str]] = None,
