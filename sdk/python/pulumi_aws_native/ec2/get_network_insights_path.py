...
class GetNetworkInsightsPathResult:
    ...
    def network_insights_path_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def network_insights_path_id(self) -> Optional[_builtins.str]:
        """
        The ID of the path.
        """
...
def get_network_insights_path(network_insights_path_id: Optional[_builtins.str] = None,
