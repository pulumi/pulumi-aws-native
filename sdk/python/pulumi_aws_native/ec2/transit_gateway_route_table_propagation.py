...
__all__ = ['TransitGatewayRouteTablePropagation']
...
class TransitGatewayRouteTablePropagation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TransitGatewayRouteTablePropagationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TransitGatewayRouteTablePropagationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TransitGatewayRouteTablePropagationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TransitGatewayRouteTablePropagationProperties']:
        """
