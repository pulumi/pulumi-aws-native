...
class GetConnectorProfileResult:
    ...
    def connector_profile_arn(self) -> Optional[builtins.str]:
        """
...
def get_connector_profile(connector_profile_name: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorProfileResult:
    """
    Resource Type definition for AWS::AppFlow::ConnectorProfile


    :param builtins.str connector_profile_name: The maximum number of items to retrieve in a single batch.
    """
    __args__ = dict()
...
def get_connector_profile_output(connector_profile_name: Optional[pulumi.Input[builtins.str]] = None,
