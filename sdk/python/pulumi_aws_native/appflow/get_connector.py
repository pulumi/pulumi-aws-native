...
class GetConnectorResult:
    ...
    def connector_provisioning_type(self) -> Optional[builtins.str]:
        """
...
def get_connector(connector_label: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorResult:
    """
    Resource schema for AWS::AppFlow::Connector


    :param builtins.str connector_label:  The name of the connector. The name is unique for each ConnectorRegistration in your AWS account.
    """
    __args__ = dict()
...
def get_connector_output(connector_label: Optional[pulumi.Input[builtins.str]] = None,
