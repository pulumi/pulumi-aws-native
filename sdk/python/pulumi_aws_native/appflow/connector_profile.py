...
class ConnectorProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connector_profile_name: The maximum number of items to retrieve in a single batch.
        :param pulumi.Input[builtins.str] kms_arn: The ARN of the AWS Key Management Service (AWS KMS) key that's used to encrypt your function's environment variables. If it's not provided, AWS Lambda uses a default service key.
        """
...
class ConnectorProfile(pulumi.CustomResource):
    ...
    def connector_profile_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="connectorProfileName")
    def connector_profile_name(self) -> pulumi.Output[builtins.str]:
        """
        The maximum number of items to retrieve in a single batch.
        """
        return pulumi.get(self, "connector_profile_name")
    ...
    @property
    @pulumi.getter(name="kmsArn")
    def kms_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the AWS Key Management Service (AWS KMS) key that's used to encrypt your function's environment variables. If it's not provided, AWS Lambda uses a default service key.
        """
        return pulumi.get(self, "kms_arn")
