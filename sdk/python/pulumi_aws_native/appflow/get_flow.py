...
def get_flow(flow_name: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFlowResult:
    """
    Resource schema for AWS::AppFlow::Flow.


    :param builtins.str flow_name: Name of the flow.
    """
    __args__ = dict()
...
def get_flow_output(flow_name: Optional[pulumi.Input[builtins.str]] = None,
