...
class ConnectorLambdaConnectorProvisioningConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains information about the configuration of the lambda which is being registered as the connector.
        :param builtins.str lambda_arn: Lambda ARN of the connector being registered.
        """
...
class ConnectorProfileAmplitudeConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str api_key: A unique alphanumeric identiﬁer used to authenticate a user, developer, or calling program to your API.
...
class ConnectorProfileApiKeyCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str api_key: The API key required for API key authentication.
        :param builtins.str api_secret_key: The API secret key required for API key authentication.
        """
        pulumi.set(__self__, "api_key", api_key)
...
class ConnectorProfileBasicAuthCredentials(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: The password to use to connect to a resource.
        :param builtins.str username: The username to use to connect to a resource.
        """
...
class ConnectorProfileConnectorOAuthRequest(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str redirect_uri: The URL to which the authentication server redirects the browser after authorization has been
               granted.
        """
...
class ConnectorProfileDatadogConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str instance_url: The location of the Datadog resource
        """
...
class ConnectorProfileDynatraceConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the Dynatrace resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileGoogleAnalyticsConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: The identiﬁer for the desired client.
        :param builtins.str client_secret: The client secret used by the oauth client to authenticate to the authorization server.
        :param builtins.str access_token: The credentials used to access protected resources.
        ...
        :param builtins.str refresh_token: The credentials used to acquire new access tokens.
        """
...
class ConnectorProfileInforNexusConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str datakey: The encryption keys used to encrypt data.
        :param builtins.str secret_access_key: The secret key used to sign requests.
        :param builtins.str user_id: The identiﬁer for the user.
        """
...
class ConnectorProfileInforNexusConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the InforNexus resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileMarketoConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the Marketo resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileOAuth2Credentials(dict):
    ...
    def __init__(__self__, *,
                 ...
                 refresh_token: Optional[builtins.str] = None):
        """
        :param builtins.str access_token: The access token used to access the connector on your behalf.
        :param builtins.str client_id: The identifier for the desired client.
        :param builtins.str client_secret: The client secret used by the OAuth client to authenticate to the authorization server.
        :param builtins.str refresh_token: The refresh token used to refresh an expired access token.
        """
        if access_token is not None:
            pulumi.set(__self__, "access_token", access_token)
...
class ConnectorProfileOAuth2Properties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str token_url: The token URL required for OAuth 2.0 authentication.
...
class ConnectorProfileOAuthProperties(dict):
    ...
    def __init__(__self__, *,
                 auth_code_url: Optional[builtins.str] = None,
                 o_auth_scopes: Optional[Sequence[builtins.str]] = None,
                 token_url: Optional[builtins.str] = None):
        """
        ...
        :param Sequence[builtins.str] o_auth_scopes: The OAuth scopes required for OAuth type authentication.
        :param builtins.str token_url: The token url required to fetch access/refresh tokens using authorization code and also to refresh expired access token using refresh token.
        """
    ...
    def auth_code_url(self) -> Optional[builtins.str]:
        """
    ...
    def o_auth_scopes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConnectorProfilePardotConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_token: The credentials used to access protected resources.
        :param builtins.str client_credentials_arn: The client credentials to fetch access token and refresh token.
        :param 'ConnectorProfileConnectorOAuthRequest' connector_o_auth_request: The oauth needed to request security tokens from the connector endpoint.
        :param builtins.str refresh_token: The credentials used to acquire new access tokens.
        """
        if access_token is not None:
...
class ConnectorProfilePardotConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str business_unit_id: The Business unit id of Salesforce Pardot instance to be connected
        :param builtins.str instance_url: The location of the Salesforce Pardot resource
        :param builtins.bool is_sandbox_environment: Indicates whether the connector profile applies to a demo or production environment
        """
...
class ConnectorProfileRedshiftConnectorProfileCredentials(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: The password that corresponds to the username.
...
class ConnectorProfileRedshiftConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_redshift_serverless: Optional[builtins.bool] = None,
                 workgroup_name: Optional[builtins.str] = None):
        """
        :param builtins.str bucket_name: The name of the Amazon S3 bucket associated with Redshift.
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the IAM role.
        :param builtins.str bucket_prefix: The object key for the destination bucket in which Amazon AppFlow will place the ﬁles.
        :param builtins.str cluster_identifier: The unique identifier of the Amazon Redshift cluster.
        :param builtins.str data_api_role_arn: The Amazon Resource Name (ARN) of the IAM role that grants Amazon AppFlow access to the data through the Amazon Redshift Data API.
        :param builtins.str database_name: The name of the Amazon Redshift database that will store the transferred data.
        :param builtins.str database_url: The JDBC URL of the Amazon Redshift cluster.
        :param builtins.bool is_redshift_serverless: If Amazon AppFlow will connect to Amazon Redshift Serverless or Amazon Redshift cluster.
    ...
    def is_redshift_serverless(self) -> Optional[builtins.bool]:
        """
    ...
    def workgroup_name(self) -> Optional[builtins.str]:
        """
...
class ConnectorProfileSalesforceConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str client_credentials_arn: The client credentials to fetch access token and refresh token.
        :param 'ConnectorProfileConnectorOAuthRequest' connector_o_auth_request: The oauth needed to request security tokens from the connector endpoint.
        :param builtins.str jwt_token: The credentials used to access your Salesforce records
...
class ConnectorProfileSalesforceConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: Optional[builtins.str] = None,
                 is_sandbox_environment: Optional[builtins.bool] = None,
                 use_private_link_for_metadata_and_authorization: Optional[builtins.bool] = None):
        """
        :param builtins.str instance_url: The location of the Salesforce resource
        ...
        :param builtins.bool use_private_link_for_metadata_and_authorization: Indicates whether to make Metadata And Authorization calls over Pivate Network
        """
        if instance_url is not None:
            pulumi.set(__self__, "instance_url", instance_url)
        if is_sandbox_environment is not None:
    ...
    def use_private_link_for_metadata_and_authorization(self) -> Optional[builtins.bool]:
        """
...
class ConnectorProfileSapoDataConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 application_host_url: Optional[builtins.str] = None,
                 application_service_path: Optional[builtins.str] = None,
                 client_number: Optional[builtins.str] = None,
                 disable_sso: Optional[builtins.bool] = None,
        ...
        :param builtins.bool disable_sso: If you set this parameter to true, Amazon AppFlow bypasses the single sign-on (SSO) settings in your SAP account when it accesses your SAP OData instance.
        ...
        :param builtins.str private_link_service_name: The SAPOData Private Link service name to be used for private data transfers.
        """
    ...
    def application_host_url(self) -> Optional[builtins.str]:
        """
    ...
    def application_service_path(self) -> Optional[builtins.str]:
        """
    ...
    def client_number(self) -> Optional[builtins.str]:
        """
    ...
    def disable_sso(self) -> Optional[builtins.bool]:
        """
...
class ConnectorProfileServiceNowConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the ServiceNow resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileSlackConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the Slack resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileSnowflakeConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The name of the Amazon S3 bucket associated with Snowﬂake.
        :param builtins.str stage: The name of the Amazon S3 stage that was created while setting up an Amazon S3 stage in the
               Snowﬂake account. This is written in the following format: < Database>< Schema><Stage Name>.
        :param builtins.str warehouse: The name of the Snowﬂake warehouse.
        :param builtins.str account_name: The name of the account.
        :param builtins.str bucket_prefix: The bucket prefix that refers to the Amazon S3 bucket associated with Snowﬂake.
        :param builtins.str private_link_service_name: The Snowﬂake Private Link service name to be used for private data transfers.
        :param builtins.str region: The region of the Snowﬂake account.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
class ConnectorProfileTrendmicroConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str api_secret_key: The Secret Access Key portion of the credentials.
        """
        pulumi.set(__self__, "api_secret_key", api_secret_key)
...
class ConnectorProfileVeevaConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the Veeva resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class ConnectorProfileZendeskConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *,
                 instance_url: builtins.str):
        """
        :param builtins.str instance_url: The location of the Zendesk resource
        """
        pulumi.set(__self__, "instance_url", instance_url)
...
class FlowAmplitudeSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Amplitude flow source.
        """
...
class FlowCustomConnectorDestinationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_name: The entity specified in the custom connector as a destination in the flow.
        :param Mapping[str, builtins.str] custom_properties: The custom properties that are specific to the connector when it's used as a destination in the flow.
        ...
        :param Sequence[builtins.str] id_field_names: List of fields used as ID when performing a write operation.
...
class FlowCustomConnectorSourceProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_name: The entity specified in the custom connector as a source in the flow.
        :param Mapping[str, builtins.str] custom_properties: Custom properties that are required to use the custom connector as a source.
...
class FlowDatadogSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Datadog flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowDestinationFlowConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str api_version: The API version that the destination connector uses.
        :param builtins.str connector_profile_name: Name of destination connector profile
        """
...
class FlowDynatraceSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Dynatrace flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowErrorHandlingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bucket_prefix: Optional[builtins.str] = None,
                 fail_on_first_error: Optional[builtins.bool] = None):
        """
        :param builtins.str bucket_name: Specifies the name of the Amazon S3 bucket.
        :param builtins.str bucket_prefix: Specifies the Amazon S3 bucket prefix.
        :param builtins.bool fail_on_first_error: Specifies if the flow should fail after the first instance of a failure when attempting to place data in the destination.
        """
    ...
    def fail_on_first_error(self) -> Optional[builtins.bool]:
        """
...
class FlowEventBridgeDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_handling_config: Optional['outputs.FlowErrorHandlingConfig'] = None):
        """
        :param builtins.str object: The object specified in the Amazon EventBridge flow destination.
...
class FlowGlueDataCatalog(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Trigger settings of the flow.
        :param builtins.str database_name: A string containing the value for the tag
        :param builtins.str role_arn: A string containing the value for the tag
        :param builtins.str table_prefix: A string containing the value for the tag
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "role_arn", role_arn)
...
class FlowGoogleAnalyticsSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Google Analytics flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowInforNexusSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Infor Nexus flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowLookoutMetricsDestinationProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str object: The object specified in the Amazon Lookout for Metrics flow destination.
        """
...
class FlowMarketoDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_handling_config: Optional['outputs.FlowErrorHandlingConfig'] = None):
        """
        :param builtins.str object: The object specified in the Marketo flow destination.
...
class FlowPardotSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Salesforce Pardot flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowRedshiftDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_handling_config: Optional['outputs.FlowErrorHandlingConfig'] = None):
        """
        :param builtins.str intermediate_bucket_name: The intermediate bucket that Amazon AppFlow uses when moving data into Amazon Redshift.
        :param builtins.str object: The object specified in the Amazon Redshift flow destination.
        :param builtins.str bucket_prefix: The object key for the bucket in which Amazon AppFlow places the destination files.
...
class FlowS3DestinationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The Amazon S3 bucket name in which Amazon AppFlow places the transferred data.
        :param builtins.str bucket_prefix: The object key for the destination bucket in which Amazon AppFlow places the files.
...
class FlowS3OutputFormatConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool preserve_source_data_typing: If your file output format is Parquet, use this parameter to set whether Amazon AppFlow preserves the data types in your source data when it writes the output to Amazon S3.
...
class FlowSalesforceDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_operation_type: Optional['FlowWriteOperationType'] = None):
        """
        :param builtins.str object: The object specified in the Salesforce flow destination.
...
class FlowSapoDataDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_operation_type: Optional['FlowWriteOperationType'] = None):
        """
        :param builtins.str object_path: The object path specified in the SAPOData flow destination.
        :param 'FlowErrorHandlingConfig' error_handling_config: The settings that determine how Amazon AppFlow handles an error when placing data in the destination. For example, this setting would determine if the flow should fail after one insertion error, or continue and attempt to insert every record regardless of the initial failure. `ErrorHandlingConfig` is a part of the destination connector details.
        :param Sequence[builtins.str] id_field_names: List of fields used as ID when performing a write operation.
...
class FlowSapoDataPaginationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SAP Source connector page size
        :param builtins.int max_page_size: The maximum number of records that Amazon AppFlow receives in each page of the response from your SAP application. For transfers of OData records, the maximum page size is 3,000. For transfers of data that comes from an ODP provider, the maximum page size is 10,000.
        """
...
class FlowSapoDataParallelismConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SAP Source connector parallelism factor
        :param builtins.int max_parallelism: The maximum number of processes that Amazon AppFlow runs at the same time when it retrieves your data from your SAP application.
        """
        pulumi.set(__self__, "max_parallelism", max_parallelism)

    @property
    @pulumi.getter(name="maxParallelism")
    def max_parallelism(self) -> builtins.int:
        """
...
class FlowSapoDataSourceProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str object_path: The object path specified in the SAPOData flow source.
...
class FlowScheduledTriggerProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 flow_error_deactivation_threshold: Optional[builtins.int] = None,
                 schedule_end_time: Optional[builtins.float] = None,
                 schedule_offset: Optional[builtins.float] = None,
                 schedule_start_time: Optional[builtins.float] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        Details required for scheduled trigger type
        :param builtins.str schedule_expression: The scheduling expression that determines the rate at which the schedule will run, for example `rate(5minutes)` .
        ...
        :param builtins.int flow_error_deactivation_threshold: Defines how many times a scheduled flow fails consecutively before Amazon AppFlow deactivates it.
        :param builtins.float schedule_end_time: The time at which the scheduled flow ends. The time is formatted as a timestamp that follows the ISO 8601 standard, such as `2022-04-27T13:00:00-07:00` .
        :param builtins.float schedule_offset: Specifies the optional offset that is added to the time interval for a schedule-triggered flow.
        :param builtins.float schedule_start_time: The time at which the scheduled flow starts. The time is formatted as a timestamp that follows the ISO 8601 standard, such as `2022-04-26T13:00:00-07:00` .
        :param builtins.str time_zone: Specifies the time zone used when referring to the dates and times of a scheduled flow, such as `America/New_York` . This time zone is only a descriptive label. It doesn't affect how Amazon AppFlow interprets the timestamps that you specify to schedule the flow.
    ...
    def flow_error_deactivation_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def schedule_offset(self) -> Optional[builtins.float]:
        """
...
class FlowSingularSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Singular flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowSlackSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Slack flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowSnowflakeDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_handling_config: Optional['outputs.FlowErrorHandlingConfig'] = None):
        """
        :param builtins.str intermediate_bucket_name: The intermediate bucket that Amazon AppFlow uses when moving data into Snowflake.
        :param builtins.str object: The object specified in the Snowflake flow destination.
        :param builtins.str bucket_prefix: The object key for the destination bucket in which Amazon AppFlow places the files.
...
class FlowSourceFlowConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str api_version: The API version that the destination connector uses.
        :param builtins.str connector_profile_name: Name of source connector profile
...
class FlowSuccessResponseHandlingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bucket_prefix: Optional[builtins.str] = None):
        """
        :param builtins.str bucket_name: The name of the Amazon S3 bucket.
        :param builtins.str bucket_prefix: The Amazon S3 bucket prefix.
        """
        if bucket_name is not None:
            pulumi.set(__self__, "bucket_name", bucket_name)
        if bucket_prefix is not None:
...
class FlowTask(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] source_fields: Source fields on which particular task will be applied
        ...
        :param builtins.str destination_field: A field value on which source field should be validated
...
class FlowTaskPropertiesObject(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: The task property value.
        """
...
class FlowTrendmicroSourceProperties(dict):
    def __init__(__self__, *,
                 object: builtins.str):
        """
        :param builtins.str object: The object specified in the Trend Micro flow source.
        """
        pulumi.set(__self__, "object", object)
...
class FlowUpsolverDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bucket_prefix: Optional[builtins.str] = None):
        """
        :param builtins.str bucket_name: The Upsolver Amazon S3 bucket name in which Amazon AppFlow places the transferred data.
        ...
        :param builtins.str bucket_prefix: The object key for the destination Upsolver Amazon S3 bucket in which Amazon AppFlow places the files.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
        pulumi.set(__self__, "s3_output_format_config", s3_output_format_config)
        if bucket_prefix is not None:
...
class FlowVeevaSourceProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str object: The object specified in the Veeva flow source.
        :param builtins.str document_type: The document type specified in the Veeva document extract flow.
...
class FlowZendeskDestinationProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_operation_type: Optional['FlowWriteOperationType'] = None):
        """
        :param builtins.str object: The object specified in the Zendesk flow destination.
        :param 'FlowErrorHandlingConfig' error_handling_config: The settings that determine how Amazon AppFlow handles an error when placing data in the destination. For example, this setting would determine if the flow should fail after one insertion error, or continue and attempt to insert every record regardless of the initial failure. `ErrorHandlingConfig` is a part of the destination connector details.
        :param Sequence[builtins.str] id_field_names: List of fields used as ID when performing a write operation.
        :param 'FlowWriteOperationType' write_operation_type: The possible write operations in the destination connector. When this value is not provided, this defaults to the `INSERT` operation.
        """
