...
class ConnectorArgs:
    def __init__(__self__, *,
                 ...
                 connector_provisioning_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] connector_provisioning_type: The provisioning type of the connector. Currently the only supported value is LAMBDA. 
        :param pulumi.Input[builtins.str] connector_label:  The name of the connector. The name is unique for each ConnectorRegistration in your AWS account.
        :param pulumi.Input[builtins.str] description: A description about the connector that's being registered.
        """
    ...
    def connector_provisioning_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connector_provisioning_type(self, value: pulumi.Input[builtins.str]):
...
class Connector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connector_provisioning_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="connectorProvisioningType")
    def connector_provisioning_type(self) -> pulumi.Output[builtins.str]:
        """
        The provisioning type of the connector. Currently the only supported value is LAMBDA. 
        """
        return pulumi.get(self, "connector_provisioning_type")
