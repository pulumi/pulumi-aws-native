...
class GetVirtualClusterResult:
    ...
    def security_configuration_id(self) -> Optional[builtins.str]:
        """
...
def get_virtual_cluster(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualClusterResult:
    """
    Resource Schema of AWS::EMRContainers::VirtualCluster Type


    :param builtins.str id: Id of the virtual cluster.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_virtual_cluster_output(id: Optional[pulumi.Input[builtins.str]] = None,
