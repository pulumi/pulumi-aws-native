...
class VirtualClusterContainerProviderArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The ID of the container cluster
        :param pulumi.Input['VirtualClusterContainerInfoArgs'] info: The information about the container cluster.
        :param pulumi.Input[builtins.str] type: The type of the container provider
        """
...
class VirtualClusterEksInfoArgs:
    def __init__(__self__, *,
                 namespace: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] namespace: The namespaces of the EKS cluster.
