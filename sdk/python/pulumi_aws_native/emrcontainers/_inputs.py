...
class EndpointConfigurationOverridesArgsDict(TypedDict):
    application_configuration: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EndpointEmreksConfigurationArgs']]]]]
    monitoring_configuration: NotRequired[pulumi.Input[Optional['EndpointMonitoringConfigurationArgs']]]
...
class EndpointEmreksConfigurationArgsDict(TypedDict):
    ...
    configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EndpointEmreksConfigurationArgs']]]]]
...
class EndpointMonitoringConfigurationArgsDict(TypedDict):
    cloud_watch_monitoring_configuration: NotRequired[pulumi.Input[Optional['EndpointCloudWatchMonitoringConfigurationArgs']]]
    container_log_rotation_configuration: NotRequired[pulumi.Input[Optional['EndpointContainerLogRotationConfigurationArgs']]]
    persistent_app_ui: NotRequired[pulumi.Input[Optional['EndpointMonitoringConfigurationPersistentAppUi']]]
    s3_monitoring_configuration: NotRequired[pulumi.Input[Optional['EndpointS3MonitoringConfigurationArgs']]]
...
class SecurityConfigurationAtRestEncryptionConfigurationArgsDict(TypedDict):
    ...
    """
    local_disk_encryption_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationLocalDiskEncryptionConfigurationArgs']]]
    s3_encryption_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationS3EncryptionConfigurationArgs']]]
...
class SecurityConfigurationAuthenticationConfigurationArgsDict(TypedDict):
    ...
    """
    iam_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationIamConfigurationArgs']]]
    identity_center_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationIdentityCenterConfigurationArgs']]]
...
class SecurityConfigurationAuthorizationConfigurationArgsDict(TypedDict):
    ...
    """
    lake_formation_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationLakeFormationConfigurationArgs']]]
...
class SecurityConfigurationContainerInfoArgsDict(TypedDict):
    ...
    """
    eks_info: NotRequired[pulumi.Input[Optional['SecurityConfigurationEksInfoArgs']]]
...
class SecurityConfigurationContainerProviderArgsDict(TypedDict):
    ...
    """
    info: NotRequired[pulumi.Input[Optional['SecurityConfigurationContainerInfoArgs']]]
...
class SecurityConfigurationDataArgsDict(TypedDict):
    ...
    """
    authentication_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationAuthenticationConfigurationArgs']]]
    authorization_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationAuthorizationConfigurationArgs']]]
    encryption_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationEncryptionConfigurationArgs']]]
...
class SecurityConfigurationEncryptionConfigurationArgsDict(TypedDict):
    ...
    """
    at_rest_encryption_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationAtRestEncryptionConfigurationArgs']]]
    in_transit_encryption_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationInTransitEncryptionConfigurationArgs']]]
...
class SecurityConfigurationInTransitEncryptionConfigurationArgsDict(TypedDict):
    ...
    """
    tls_certificate_configuration: NotRequired[pulumi.Input[Optional['SecurityConfigurationTlsCertificateConfigurationArgs']]]
...
class SecurityConfigurationLakeFormationConfigurationArgsDict(TypedDict):
    ...
    """
    secure_namespace_info: NotRequired[pulumi.Input[Optional['SecurityConfigurationSecureNamespaceInfoArgs']]]
