...
def get_resolver_config(resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_id: ResourceId
    """
    __args__ = dict()
...
def get_resolver_config_output(resource_id: Optional[pulumi.Input[builtins.str]] = None,
