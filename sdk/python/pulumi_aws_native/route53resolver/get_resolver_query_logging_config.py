...
class GetResolverQueryLoggingConfigResult:
    ...
    def association_count(self) -> Optional[builtins.int]:
        """
        Count
        """
...
def get_resolver_query_logging_config(id: Optional[builtins.str] = None,
...
def get_resolver_query_logging_config_output(id: Optional[pulumi.Input[builtins.str]] = None,
