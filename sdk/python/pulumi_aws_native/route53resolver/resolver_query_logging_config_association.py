...
class ResolverQueryLoggingConfigAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resolver_query_log_config_id: ResolverQueryLogConfigId
        :param pulumi.Input[builtins.str] resource_id: ResourceId
        """
...
class ResolverQueryLoggingConfigAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="resolverQueryLogConfigId")
    def resolver_query_log_config_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ResolverQueryLogConfigId
        """
        return pulumi.get(self, "resolver_query_log_config_id")
