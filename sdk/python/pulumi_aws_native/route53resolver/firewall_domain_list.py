...
class FirewallDomainListArgs:
    def __init__(__self__, *,
                 domain_file_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_file_url: S3 URL to import domains from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: A list of the domain lists that you have defined.
        :param pulumi.Input[builtins.str] name: FirewallDomainListName
    ...
    def domain_file_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_file_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FirewallDomainList(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="domainFileUrl")
    def domain_file_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        S3 URL to import domains from.
        """
        return pulumi.get(self, "domain_file_url")
