...
class GetResolverRuleAssociationResult:
    ...
    def resolver_rule_association_id(self) -> Optional[builtins.str]:
        """
...
def get_resolver_rule_association(resolver_rule_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str resolver_rule_association_id: The ID of the resolver rule association that you want to get information about, such as `rslvr-rrassoc-97242eaf88example` .
    """
    __args__ = dict()
...
def get_resolver_rule_association_output(resolver_rule_association_id: Optional[pulumi.Input[builtins.str]] = None,
