...
class GetFirewallDomainListResult:
    ...
    def creator_request_id(self) -> Optional[_builtins.str]:
        """
    ...
    def managed_owner_name(self) -> Optional[_builtins.str]:
        """
        ServicePrincipal
        """
    ...
    def modification_time(self) -> Optional[_builtins.str]:
        """
        Rfc3339TimeString
        """
...
def get_firewall_domain_list(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ResourceId
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_firewall_domain_list_output(id: Optional[pulumi.Input[_builtins.str]] = None,
