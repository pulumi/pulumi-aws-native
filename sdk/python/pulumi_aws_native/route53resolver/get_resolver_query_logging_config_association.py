...
def get_resolver_query_logging_config_association(id: Optional[builtins.str] = None,
...
def get_resolver_query_logging_config_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
