...
def get_resolver_query_logging_config_association(id: Optional[_builtins.str] = None,
...
def get_resolver_query_logging_config_association_output(id: Optional[pulumi.Input[_builtins.str]] = None,
