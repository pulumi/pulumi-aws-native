...
class ResolverRuleAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] v_pc_id: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverruleassociation.html#cfn-route53resolver-resolverruleassociation-vpcid
