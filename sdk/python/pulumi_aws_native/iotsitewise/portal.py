...
class PortalArgs:
    def __init__(__self__, *,
                 portal_contact_email: pulumi.Input[builtins.str],
                 ...
                 portal_auth_mode: Optional[pulumi.Input[builtins.str]] = None,
                 portal_description: Optional[pulumi.Input[builtins.str]] = None,
                 portal_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] portal_contact_email: The AWS administrator's contact email address.
        :param pulumi.Input[builtins.str] role_arn: The ARN of a service role that allows the portal's users to access your AWS IoT SiteWise resources on your behalf.
        ...
        :param pulumi.Input[builtins.str] notification_sender_email: The email address that sends alarm notifications.
        :param pulumi.Input[builtins.str] portal_auth_mode: The service to use to authenticate users to the portal. Choose from SSO or IAM. You can't change this value after you create a portal.
        :param pulumi.Input[builtins.str] portal_description: A description for the portal.
        :param pulumi.Input[builtins.str] portal_name: A friendly name for the portal.
    ...
    def portal_contact_email(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def portal_contact_email(self, value: pulumi.Input[builtins.str]):
    ...
    def portal_auth_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def portal_auth_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "portal_auth_mode", value)

    @property
    @pulumi.getter(name="portalDescription")
    def portal_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def portal_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "portal_description", value)

    @property
    @pulumi.getter(name="portalName")
    def portal_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @portal_name.setter
    def portal_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Portal(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 notification_sender_email: Optional[pulumi.Input[builtins.str]] = None,
                 portal_auth_mode: Optional[pulumi.Input[builtins.str]] = None,
                 portal_contact_email: Optional[pulumi.Input[builtins.str]] = None,
                 portal_description: Optional[pulumi.Input[builtins.str]] = None,
                 portal_name: Optional[pulumi.Input[builtins.str]] = None,
                 portal_type: Optional[pulumi.Input['PortalType']] = None,
    ...
    def portal_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="portalAuthMode")
    def portal_auth_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The service to use to authenticate users to the portal. Choose from SSO or IAM. You can't change this value after you create a portal.
        """
        return pulumi.get(self, "portal_auth_mode")
    ...
    def portal_client_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="portalContactEmail")
    def portal_contact_email(self) -> pulumi.Output[builtins.str]:
        """
        The AWS administrator's contact email address.
        """
        return pulumi.get(self, "portal_contact_email")
    ...
    @property
    @pulumi.getter(name="portalDescription")
    def portal_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A description for the portal.
        """
        return pulumi.get(self, "portal_description")
    ...
    def portal_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="portalName")
    def portal_name(self) -> pulumi.Output[builtins.str]:
        """
        A friendly name for the portal.
        """
        return pulumi.get(self, "portal_name")
    ...
    def portal_start_url(self) -> pulumi.Output[builtins.str]:
        """
