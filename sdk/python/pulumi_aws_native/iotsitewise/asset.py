...
class AssetArgs:
    def __init__(__self__, *,
                 asset_model_id: pulumi.Input[_builtins.str],
                 asset_description: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_hierarchies: pulumi.Input[Optional[Sequence[pulumi.Input['AssetHierarchyArgs']]]] = None,
                 asset_name: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_properties: pulumi.Input[Optional[Sequence[pulumi.Input['AssetPropertyArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] asset_name: A unique, friendly name for the asset.
    ...
    def asset_model_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def asset_model_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "asset_model_id", value)

    @_builtins.property
    @pulumi.getter(name="assetDescription")
    def asset_description(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def asset_description(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "asset_description", value)

    @_builtins.property
    @pulumi.getter(name="assetExternalId")
    def asset_external_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def asset_external_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "asset_external_id", value)

    @_builtins.property
    @pulumi.getter(name="assetHierarchies")
    def asset_hierarchies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AssetHierarchyArgs']]]]:
        """
    ...
    def asset_hierarchies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AssetHierarchyArgs']]]]):
    ...
    def asset_properties(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AssetPropertyArgs']]]]:
        """
    ...
    def asset_properties(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AssetPropertyArgs']]]]):
...
class Asset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 asset_description: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_hierarchies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AssetHierarchyArgs', 'AssetHierarchyArgsDict', 'outputs.AssetHierarchy']]]]] = None,
                 asset_model_id: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_name: pulumi.Input[Optional[_builtins.str]] = None,
                 asset_properties: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AssetPropertyArgs', 'AssetPropertyArgsDict', 'outputs.AssetProperty']]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] asset_description: A description for the asset
        :param pulumi.Input[_builtins.str] asset_external_id: The External ID of the asset
        :param pulumi.Input[Sequence[pulumi.Input[Union['AssetHierarchyArgs', 'AssetHierarchyArgsDict', 'outputs.AssetHierarchy']]]] asset_hierarchies: A list of asset hierarchies that each contain a `hierarchyId` . A hierarchy specifies allowed parent/child asset relationships.
        :param pulumi.Input[_builtins.str] asset_model_id: The ID of the asset model from which to create the asset.
        :param pulumi.Input[_builtins.str] asset_name: A unique, friendly name for the asset.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AssetPropertyArgs', 'AssetPropertyArgsDict', 'outputs.AssetProperty']]]] asset_properties: The list of asset properties for the asset.
               
               This object doesn't include properties that you define in composite models. You can find composite model properties in the `assetCompositeModels` object.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: A list of key-value pairs that contain metadata for the asset.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def asset_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="assetDescription")
    def asset_description(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A description for the asset
        """
        return pulumi.get(self, "asset_description")
    ...
    @_builtins.property
    @pulumi.getter(name="assetExternalId")
    def asset_external_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The External ID of the asset
        """
        return pulumi.get(self, "asset_external_id")
    ...
    @_builtins.property
    @pulumi.getter(name="assetName")
    def asset_name(self) -> pulumi.Output[_builtins.str]:
        """
        A unique, friendly name for the asset.
        """
        return pulumi.get(self, "asset_name")
