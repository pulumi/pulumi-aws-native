...
class GetDashboardResult:
    ...
    def dashboard_definition(self) -> Optional[builtins.str]:
        """
    ...
    def dashboard_description(self) -> Optional[builtins.str]:
        """
    ...
    def dashboard_name(self) -> Optional[builtins.str]:
        """
...
def get_dashboard(dashboard_id: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDashboardResult:
    """
    Resource schema for AWS::IoTSiteWise::Dashboard


    :param builtins.str dashboard_id: The ID of the dashboard.
    """
    __args__ = dict()
...
def get_dashboard_output(dashboard_id: Optional[pulumi.Input[builtins.str]] = None,
