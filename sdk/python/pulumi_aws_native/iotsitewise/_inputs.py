...
class AccessPolicyIdentityArgsDict(TypedDict):
    ...
    """
    iam_role: NotRequired[pulumi.Input[Optional['AccessPolicyIamRoleArgs']]]
    """
    An IAM role identity.
    """
    iam_user: NotRequired[pulumi.Input[Optional['AccessPolicyIamUserArgs']]]
    """
    An IAM user identity.
    """
    user: NotRequired[pulumi.Input[Optional['AccessPolicyUserArgs']]]
    """
...
class AccessPolicyResourceArgsDict(TypedDict):
    ...
    """
    portal: NotRequired[pulumi.Input[Optional['AccessPolicyPortalArgs']]]
    """
    Identifies an AWS IoT SiteWise Monitor portal.
    """
    project: NotRequired[pulumi.Input[Optional['AccessPolicyProjectArgs']]]
    """
...
class AssetHierarchyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] logical_id: The LogicalID of a hierarchy in the parent asset's model.
        """
    ...
    def child_asset_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the child asset to be associated.
        """
    ...
    def child_asset_id(self, value: pulumi.Input[_builtins.str]):
...
class AssetModelCompositeModelArgsDict(TypedDict):
    ...
    """
    composite_model_properties: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AssetModelPropertyArgs']]]]]
    """
...
class AssetModelCompositeModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description for the asset composite model.
        :param pulumi.Input[_builtins.str] external_id: The External ID of the composite model
        :param pulumi.Input[_builtins.str] id: The Actual ID of the composite model
        :param pulumi.Input[_builtins.str] parent_asset_model_composite_model_external_id: The parent composite model External ID
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] path: The path of the composite model. This is only for derived composite models
        """
...
class AssetModelEnforcedAssetModelInterfacePropertyMappingArgs:
    ...
    def interface_asset_model_property_external_id(self) -> pulumi.Input[_builtins.str]:
        """
        The external ID of the enforced interface property
        """
    ...
    def interface_asset_model_property_external_id(self, value: pulumi.Input[_builtins.str]):
...
class AssetModelEnforcedAssetModelInterfaceRelationshipArgsDict(TypedDict):
    ...
    """
    property_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AssetModelEnforcedAssetModelInterfacePropertyMappingArgs']]]]]
    """
    Contains information about enforced interface property and asset model property
    """
...
class AssetModelExpressionVariableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The friendly name of the variable to be used in the expression.
...
class AssetModelHierarchyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: Customer provided actual ID for hierarchy
        :param pulumi.Input[_builtins.str] logical_id: Customer provided logical ID for hierarchy.
        """
    ...
    def child_asset_model_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the asset model. All assets in this hierarchy must be instances of the child AssetModelId asset model.
        """
    ...
    def child_asset_model_id(self, value: pulumi.Input[_builtins.str]):
...
class AssetModelMetricWindowArgsDict(TypedDict):
    ...
    """
    tumbling: NotRequired[pulumi.Input[Optional['AssetModelTumblingWindowArgs']]]
    """
...
class AssetModelMetricArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] expression: The mathematical expression that defines the metric aggregation function. You can specify up to 10 functions per expression.
...
class AssetModelPropertyTypeArgsDict(TypedDict):
    ...
    """
    attribute: NotRequired[pulumi.Input[Optional['AssetModelAttributeArgs']]]
    """
    ...
    """
    metric: NotRequired[pulumi.Input[Optional['AssetModelMetricArgs']]]
    """
    Specifies an asset metric property. A metric contains a mathematical expression that uses aggregate functions to process all input data points over a time interval and output a single data point, such as to calculate the average hourly temperature.
    """
    transform: NotRequired[pulumi.Input[Optional['AssetModelTransformArgs']]]
    """
...
class AssetModelPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] external_id: The External ID of the Asset Model Property
        :param pulumi.Input[_builtins.str] id: The ID of the Asset Model Property
        :param pulumi.Input[_builtins.str] logical_id: Customer provided Logical ID for property.
        :param pulumi.Input[_builtins.str] unit: The unit of the asset model property, such as Newtons or RPM.
        """
...
class AssetModelTransformArgs:
    def __init__(__self__, *,
                 ...
                 variables: pulumi.Input[Sequence[pulumi.Input['AssetModelExpressionVariableArgs']]]):
        """
        :param pulumi.Input[_builtins.str] expression: The mathematical expression that defines the transformation function. You can specify up to 10 functions per expression.
        :param pulumi.Input[Sequence[pulumi.Input['AssetModelExpressionVariableArgs']]] variables: The list of variables used in the expression.
        """
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "variables", variables)
...
class AssetModelTumblingWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] interval: The time interval for the tumbling window. The interval time must be between 1 minute and 1 week.
               ...
               When AWS IoT SiteWise aggregates data points for metric computations, the start of each interval is exclusive and the end of each interval is inclusive. AWS IoT SiteWise places the computed data point at the end of the interval.
        :param pulumi.Input[_builtins.str] offset: The offset for the tumbling window. The `offset` parameter accepts the following:
...
class AssetModelVariableValueArgsDict(TypedDict):
    ...
    """
    property_path: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AssetModelPropertyPathDefinitionArgs']]]]]
    """
...
class AssetModelVariableValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] hierarchy_logical_id: The `LogicalID` of the hierarchy to query for the `PropertyLogicalID` .
               
               You use a `hierarchyLogicalID` instead of a model ID because you can have several hierarchies using the same model and therefore the same property. For example, you might have separately grouped assets that come from the same asset model. For more information, see [Defining relationships between asset models (hierarchies)](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html) in the *AWS IoT SiteWise User Guide* .
        :param pulumi.Input[_builtins.str] property_external_id: The External ID of the property that is trying to be referenced
        :param pulumi.Input[_builtins.str] property_id: The ID of the property that is trying to be referenced
        :param pulumi.Input[_builtins.str] property_logical_id: The `LogicalID` of the property that is being referenced.
...
class AssetPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] external_id: String-friendly customer provided external ID
        :param pulumi.Input[_builtins.str] id: Customer provided actual UUID for property
        :param pulumi.Input[_builtins.str] logical_id: Customer provided ID for property.
        ...
        :param pulumi.Input[_builtins.str] unit: The unit of measure (such as Newtons or RPM) of the asset property. If you don't specify a value for this parameter, the service uses the value of the assetModelProperty in the asset model.
        """
...
class DatasetKendraSourceDetailArgs:
    def __init__(__self__, *,
                 ...
                 role_arn: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] knowledge_base_arn: The knowledgeBaseArn details for the Kendra dataset source.
        :param pulumi.Input[_builtins.str] role_arn: The roleARN details for the Kendra dataset source.
        """
...
class DatasetSourceDetailArgsDict(TypedDict):
    kendra: NotRequired[pulumi.Input[Optional['DatasetKendraSourceDetailArgs']]]
    """
...
class DatasetSourceArgsDict(TypedDict):
    ...
    """
    source_detail: NotRequired[pulumi.Input[Optional['DatasetSourceDetailArgs']]]
    """
...
class GatewayCapabilitySummaryArgs:
    ...
    def capability_namespace(self) -> pulumi.Input[_builtins.str]:
        """
        The namespace of the capability configuration. For example, if you configure OPC UA sources for an MQTT-enabled gateway, your OPC-UA capability configuration has the namespace `iotsitewise:opcuacollector:3` .
        """
    ...
    def capability_namespace(self, value: pulumi.Input[_builtins.str]):
...
class GatewayGreengrassV2Args:
    ...
    def core_device_thing_name(self) -> pulumi.Input[_builtins.str]:
        """
        The name of the CoreDevice in GreenGrass V2.
        """
    ...
    def core_device_thing_name(self, value: pulumi.Input[_builtins.str]):
...
class GatewayPlatformArgsDict(TypedDict):
    ...
    """
    greengrass_v2: NotRequired[pulumi.Input[Optional['GatewayGreengrassV2Args']]]
    """
    A gateway that runs on AWS IoT Greengrass V2.
    """
    siemens_ie: NotRequired[pulumi.Input[Optional['GatewaySiemensIeArgs']]]
    """
...
class GatewaySiemensIeArgs:
    ...
    def iot_core_thing_name(self) -> pulumi.Input[_builtins.str]:
        """
        The name of the IoT Core Thing.
        """
    ...
    def iot_core_thing_name(self, value: pulumi.Input[_builtins.str]):
...
class PortalTypeEntryArgs:
    ...
    def portal_tools(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        The array of tools associated with the specified portal type. The possible values are `ASSISTANT` and `DASHBOARD` .
        """
    ...
    @portal_tools.setter
    def portal_tools(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
