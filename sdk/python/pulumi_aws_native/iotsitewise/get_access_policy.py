...
class GetAccessPolicyResult:
    ...
    def access_policy_arn(self) -> Optional[builtins.str]:
        """
    ...
    def access_policy_id(self) -> Optional[builtins.str]:
        """
    ...
    def access_policy_permission(self) -> Optional[builtins.str]:
        """
...
def get_access_policy(access_policy_id: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccessPolicyResult:
    """
    Resource schema for AWS::IoTSiteWise::AccessPolicy


    :param builtins.str access_policy_id: The ID of the access policy.
    """
    __args__ = dict()
...
def get_access_policy_output(access_policy_id: Optional[pulumi.Input[builtins.str]] = None,
