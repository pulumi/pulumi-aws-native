...
class DashboardArgs:
    def __init__(__self__, *,
                 dashboard_definition: pulumi.Input[builtins.str],
                 dashboard_description: pulumi.Input[builtins.str],
                 dashboard_name: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a Dashboard resource.
        :param pulumi.Input[builtins.str] dashboard_definition: The dashboard definition specified in a JSON literal.
        :param pulumi.Input[builtins.str] dashboard_description: A description for the dashboard.
        :param pulumi.Input[builtins.str] dashboard_name: A friendly name for the dashboard.
        :param pulumi.Input[builtins.str] project_id: The ID of the project in which to create the dashboard.
    ...
    def dashboard_definition(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dashboard_definition(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dashboard_definition", value)

    @property
    @pulumi.getter(name="dashboardDescription")
    def dashboard_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dashboard_description(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dashboard_description", value)

    @property
    @pulumi.getter(name="dashboardName")
    def dashboard_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class Dashboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dashboard_definition: Optional[pulumi.Input[builtins.str]] = None,
                 dashboard_description: Optional[pulumi.Input[builtins.str]] = None,
                 dashboard_name: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dashboardDefinition")
    def dashboard_definition(self) -> pulumi.Output[builtins.str]:
        """
        The dashboard definition specified in a JSON literal.
        """
        return pulumi.get(self, "dashboard_definition")
    ...
    @property
    @pulumi.getter(name="dashboardDescription")
    def dashboard_description(self) -> pulumi.Output[builtins.str]:
        """
        A description for the dashboard.
        """
        return pulumi.get(self, "dashboard_description")
    ...
    @property
    @pulumi.getter(name="dashboardName")
    def dashboard_name(self) -> pulumi.Output[builtins.str]:
        """
        A friendly name for the dashboard.
        """
        return pulumi.get(self, "dashboard_name")
