...
class GetAssetModelResult:
    ...
    def asset_model_arn(self) -> Optional[builtins.str]:
        """
    ...
    def asset_model_description(self) -> Optional[builtins.str]:
        """
    ...
    def asset_model_external_id(self) -> Optional[builtins.str]:
        """
    ...
    def asset_model_name(self) -> Optional[builtins.str]:
        """
...
def get_asset_model(asset_model_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssetModelResult:
    """
    Resource schema for AWS::IoTSiteWise::AssetModel


    :param builtins.str asset_model_id: The ID of the asset model.
    """
    __args__ = dict()
