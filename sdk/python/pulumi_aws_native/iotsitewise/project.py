...
class ProjectArgs:
    def __init__(__self__, *,
                 portal_id: pulumi.Input[builtins.str],
                 asset_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project_description: Optional[pulumi.Input[builtins.str]] = None,
                 project_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a Project resource.
        :param pulumi.Input[builtins.str] portal_id: The ID of the portal in which to create the project.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] asset_ids: The IDs of the assets to be associated to the project.
        :param pulumi.Input[builtins.str] project_description: A description for the project.
        :param pulumi.Input[builtins.str] project_name: A friendly name for the project.
    ...
    def portal_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @portal_id.setter
    def portal_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "portal_id", value)

    @property
    @pulumi.getter(name="assetIds")
    def asset_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @asset_ids.setter
    def asset_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 asset_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 portal_id: Optional[pulumi.Input[builtins.str]] = None,
                 project_description: Optional[pulumi.Input[builtins.str]] = None,
                 project_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["portalId"])
    ...
    @property
    @pulumi.getter(name="assetIds")
    def asset_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the assets to be associated to the project.
        """
        return pulumi.get(self, "asset_ids")
