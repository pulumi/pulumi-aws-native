...
def get_db_cluster_parameter_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the DB cluster parameter group. If omitted, CloudFormation generates a unique name. The name is stored as lowercase.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_db_cluster_parameter_group_output(name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:docdb:getDbClusterParameterGroup', __args__, opts=opts, typ=GetDbClusterParameterGroupResult)
