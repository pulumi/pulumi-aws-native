...
class DbClusterParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] family: The DB cluster parameter group family name (e.g. docdb5.0).
        :param Any parameters: An object containing key-value pairs of parameters to set for the DB cluster parameter group.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the DB cluster parameter group. If omitted, CloudFormation generates a unique name. The name is stored as lowercase.
...
@pulumi.type_token("aws-native:docdb:DbClusterParameterGroup")
