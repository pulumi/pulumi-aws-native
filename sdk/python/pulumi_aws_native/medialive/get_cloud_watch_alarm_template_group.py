...
def get_cloud_watch_alarm_template_group(identifier: Optional[builtins.str] = None,
...
def get_cloud_watch_alarm_template_group_output(identifier: Optional[pulumi.Input[builtins.str]] = None,
