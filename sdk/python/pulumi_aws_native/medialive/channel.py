...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cdi_input_specification, ChannelCdiInputSpecificationArgs):
            ...
            if not isinstance(encoder_settings, ChannelEncoderSettingsArgs):
            ...
            if not isinstance(input_specification, ChannelInputSpecificationArgs):
            ...
            if not isinstance(maintenance, ChannelMaintenanceCreateSettingsArgs):
            ...
            if not isinstance(vpc, ChannelVpcOutputSettingsArgs):
                vpc = vpc or {}
                def _setter(key, value):
                    vpc[key] = value
