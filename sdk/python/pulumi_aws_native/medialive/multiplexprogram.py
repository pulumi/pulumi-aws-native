...
class MultiplexprogramArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] multiplex_id: The ID of the multiplex that the program belongs to.
        ...
        :param pulumi.Input[builtins.str] program_name: The name of the multiplex program.
        """
...
class Multiplexprogram(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="multiplexId")
    def multiplex_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the multiplex that the program belongs to.
        """
        return pulumi.get(self, "multiplex_id")
