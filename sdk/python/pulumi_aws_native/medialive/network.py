...
class NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The user-specified name of the Network to be created.
...
class Network(pulumi.CustomResource):
    ...
    def associated_cluster_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
