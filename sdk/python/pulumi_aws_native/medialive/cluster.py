...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_role_arn: The IAM role your nodes will use.
        :param pulumi.Input[str] name: The user-specified name of the Cluster to be created.
