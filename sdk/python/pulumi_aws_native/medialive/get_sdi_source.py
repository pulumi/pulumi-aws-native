...
def get_sdi_source_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:medialive:getSdiSource', __args__, opts=opts, typ=GetSdiSourceResult)
    return __ret__.apply(lambda __response__: GetSdiSourceResult(
