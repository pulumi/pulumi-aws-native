...
class ClusterInterfaceMapping(dict):
    ...
    def __init__(__self__, *,
                 logical_interface_name: Optional[builtins.str] = None,
                 network_id: Optional[builtins.str] = None):
        """
        Network mappings for the cluster
        :param builtins.str logical_interface_name: logical interface name, unique in the list
        :param builtins.str network_id: Network Id to be associated with the logical interface name, can be duplicated in list
        """
    ...
    def logical_interface_name(self) -> Optional[builtins.str]:
        """
...
class ClusterNetworkSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        On premises settings which will have the interface network mappings and default Output logical interface
        :param builtins.str default_route: Default value if the customer does not define it in channel Output API
...
class EventBridgeRuleTemplateTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The target to which to send matching events.
        :param builtins.str arn: Target ARNs must be either an SNS topic or CloudWatch log group.
        """
...
class MultiplexOutputDestinationMultiplexMediaConnectOutputDestinationSettingsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Multiplex MediaConnect output destination settings.
        :param builtins.str entitlement_arn: The MediaConnect entitlement ARN available as a Flow source.
        """
...
class MultiplexSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int transport_stream_id: Transport stream ID.
        :param builtins.int maximum_video_buffer_delay_milliseconds: Maximum video buffer delay in milliseconds.
...
class MultiplexprogramMultiplexProgramPacketIdentifiersMap(dict):
    ...
    def __init__(__self__, *,
                 audio_pids: Optional[Sequence[builtins.int]] = None,
                 dvb_sub_pids: Optional[Sequence[builtins.int]] = None,
                 dvb_teletext_pid: Optional[builtins.int] = None,
                 etv_platform_pid: Optional[builtins.int] = None,
                 etv_signal_pid: Optional[builtins.int] = None,
                 klv_data_pids: Optional[Sequence[builtins.int]] = None,
                 pcr_pid: Optional[builtins.int] = None,
                 pmt_pid: Optional[builtins.int] = None,
                 private_metadata_pid: Optional[builtins.int] = None,
                 scte27_pids: Optional[Sequence[builtins.int]] = None,
                 scte35_pid: Optional[builtins.int] = None,
                 timed_metadata_pid: Optional[builtins.int] = None,
                 video_pid: Optional[builtins.int] = None):
        """
        Packet identifiers map for a given Multiplex program.
        """
    ...
    def timed_metadata_pid(self) -> Optional[builtins.int]:
        return pulumi.get(self, "timed_metadata_pid")

    @property
    @pulumi.getter(name="videoPid")
    def video_pid(self) -> Optional[builtins.int]:
...
class MultiplexprogramMultiplexProgramPipelineDetail(dict):
    ...
    def __init__(__self__, *,
                 active_channel_pipeline: Optional[builtins.str] = None,
                 pipeline_id: Optional[builtins.str] = None):
        """
        The current source for one of the pipelines in the multiplex.
        :param builtins.str active_channel_pipeline: Identifies the channel pipeline that is currently active for the pipeline (identified by PipelineId) in the multiplex.
        :param builtins.str pipeline_id: Identifies a specific pipeline in the multiplex.
        """
    ...
    def active_channel_pipeline(self) -> Optional[builtins.str]:
        """
...
class MultiplexprogramMultiplexProgramServiceDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Transport stream service descriptor configuration for the Multiplex program.
        :param builtins.str provider_name: Name of the provider.
...
class NetworkIpPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IP address cidr pool
        :param builtins.str cidr: IP address cidr pool
        """
        if cidr is not None:
...
class NetworkRoute(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr: Ip address cidr
        :param builtins.str gateway: IP address for the route packet paths
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
...
class SignalMapMediaResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The logical name of an AWS media resource.
...
class SignalMapMediaResourceNeighbor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A direct source or destination neighbor to an AWS media resource.
        :param builtins.str arn: The ARN of a resource used in AWS media workflows.
        :param builtins.str name: The logical name of an AWS media resource.
        """
        pulumi.set(__self__, "arn", arn)
        if name is not None:
...
class SignalMapMonitorDeployment(dict):
    ...
    def __init__(__self__, *,
                 ...
                 details_uri: Optional[builtins.str] = None,
        ...
        :param builtins.str details_uri: URI associated with a signal map's monitor deployment.
        :param builtins.str error_message: Error message associated with a failed monitor deployment of a signal map.
        """
    ...
    def details_uri(self) -> Optional[builtins.str]:
        """
...
class SignalMapSuccessfulMonitorDeployment(dict):
    ...
    @property
    @pulumi.getter(name="detailsUri")
    def details_uri(self) -> builtins.str:
        """
        URI associated with a signal map's monitor deployment.
        """
        return pulumi.get(self, "details_uri")
