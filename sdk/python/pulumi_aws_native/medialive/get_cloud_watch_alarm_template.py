...
class GetCloudWatchAlarmTemplateResult:
    ...
    def datapoints_to_alarm(self) -> Optional[_builtins.float]:
        """
    ...
    def evaluation_periods(self) -> Optional[_builtins.float]:
        """
...
def get_cloud_watch_alarm_template(identifier: Optional[_builtins.str] = None,
...
def get_cloud_watch_alarm_template_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,
