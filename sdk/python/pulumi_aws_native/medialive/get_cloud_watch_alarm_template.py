...
class GetCloudWatchAlarmTemplateResult:
    ...
    def datapoints_to_alarm(self) -> Optional[builtins.float]:
        """
    ...
    def evaluation_periods(self) -> Optional[builtins.float]:
        """
...
def get_cloud_watch_alarm_template(identifier: Optional[builtins.str] = None,
...
def get_cloud_watch_alarm_template_output(identifier: Optional[pulumi.Input[builtins.str]] = None,
