...
class CloudWatchAlarmTemplateArgs:
    def __init__(__self__, *,
                 ...
                 evaluation_periods: pulumi.Input[builtins.float],
                 ...
                 datapoints_to_alarm: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.float] evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param pulumi.Input[builtins.str] metric_name: The name of the metric associated with the alarm. Must be compatible with targetResourceType.
        :param pulumi.Input[builtins.float] period: The period, in seconds, over which the specified statistic is applied.
        ...
        :param pulumi.Input[builtins.float] threshold: The threshold value to compare with the specified statistic.
        ...
        :param pulumi.Input[builtins.float] datapoints_to_alarm: The number of datapoints within the evaluation period that must be breaching to trigger the alarm.
        :param pulumi.Input[builtins.str] description: A resource's optional description.
        :param pulumi.Input[builtins.str] group_identifier: A cloudwatch alarm template group's identifier. Can be either be its id or current name.
    ...
    def evaluation_periods(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def evaluation_periods(self, value: pulumi.Input[builtins.float]):
    ...
    def datapoints_to_alarm(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def datapoints_to_alarm(self, value: Optional[pulumi.Input[builtins.float]]):
...
class CloudWatchAlarmTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 datapoints_to_alarm: Optional[pulumi.Input[builtins.float]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 evaluation_periods: Optional[pulumi.Input[builtins.float]] = None,
                 group_identifier: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="datapointsToAlarm")
    def datapoints_to_alarm(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The number of datapoints within the evaluation period that must be breaching to trigger the alarm.
        """
        return pulumi.get(self, "datapoints_to_alarm")
    ...
    @property
    @pulumi.getter(name="evaluationPeriods")
    def evaluation_periods(self) -> pulumi.Output[builtins.float]:
        """
        The number of periods over which data is compared to the specified threshold.
        """
        return pulumi.get(self, "evaluation_periods")
    ...
    @property
    @pulumi.getter(name="groupIdentifier")
    def group_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A cloudwatch alarm template group's identifier. Can be either be its id or current name.
        """
        return pulumi.get(self, "group_identifier")
