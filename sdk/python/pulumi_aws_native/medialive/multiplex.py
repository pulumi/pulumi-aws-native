...
class MultiplexArgs:
    def __init__(__self__, *,
                 ...
                 destinations: pulumi.Input[Optional[Sequence[pulumi.Input['MultiplexOutputDestinationArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def destinations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MultiplexOutputDestinationArgs']]]]:
        """
    ...
    @destinations.setter
    def destinations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MultiplexOutputDestinationArgs']]]]):
