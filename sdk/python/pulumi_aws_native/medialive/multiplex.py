...
class MultiplexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: A list of availability zones for the multiplex.
...
class Multiplex(pulumi.CustomResource):
    ...
    def pipelines_running_count(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def program_count(self) -> pulumi.Output[builtins.int]:
        """
