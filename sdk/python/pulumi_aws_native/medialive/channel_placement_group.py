...
__all__ = ['ChannelPlacementGroupArgs', 'ChannelPlacementGroup']

@pulumi.input_type
class ChannelPlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the cluster the node is on.
        :param pulumi.Input[builtins.str] name: The name of the channel placement group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nodes: List of nodes added to the channel placement group
...
class ChannelPlacementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ChannelPlacementGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ChannelPlacementGroupArgs.__new__(ChannelPlacementGroupArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["clusterId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ChannelPlacementGroup, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ChannelPlacementGroup':
        """
        ...
        return ChannelPlacementGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def state(self) -> pulumi.Output['ChannelPlacementGroupState']:
