...
class ChannelPlacementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_id: The ID of the cluster the node is on.
        :param pulumi.Input[str] name: The name of the channel placement group.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nodes: List of nodes added to the channel placement group
