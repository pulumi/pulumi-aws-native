...
__all__ = [
    ...
    'MultiplexprogramMultiplexStatmuxVideoSettingsArgsDict',
...
class MultiplexprogramMultiplexStatmuxVideoSettingsArgsDict(TypedDict):
    """
...
@pulumi.input_type
class MultiplexprogramMultiplexStatmuxVideoSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] maximum_bitrate: Maximum statmux bitrate.
        :param pulumi.Input[_builtins.int] minimum_bitrate: Minimum statmux bitrate.
        :param pulumi.Input[_builtins.int] priority: The purpose of the priority is to use a combination of the\\nmultiplex rate control algorithm and the QVBR capability of the\\nencoder to prioritize the video quality of some channels in a\\nmultiplex over others.  Channels that have a higher priority will\\nget higher video quality at the expense of the video quality of\\nother channels in the multiplex with lower priority.
        """
...
class MultiplexprogramMultiplexVideoSettingsArgsDict(TypedDict):
    ...
    """
    statmux_settings: NotRequired[pulumi.Input[Optional['MultiplexprogramMultiplexStatmuxVideoSettingsArgsDict']]]
    """
    Statmux rate control settings.
...
class MultiplexprogramMultiplexVideoSettingsArgs:
    def __init__(__self__, *,
                 ...
                 statmux_settings: pulumi.Input[Optional['MultiplexprogramMultiplexStatmuxVideoSettingsArgs']] = None):
        """
        The video configuration for each program in a multiplex.

        :param pulumi.Input[_builtins.int] constant_bitrate: The constant bitrate configuration for the video encode.
               When this field is defined, StatmuxSettings must be undefined.
        :param pulumi.Input['MultiplexprogramMultiplexStatmuxVideoSettingsArgs'] statmux_settings: Statmux rate control settings.
               When this field is defined, ConstantBitrate must be undefined.
        """
    ...
    def statmux_settings(self) -> pulumi.Input[Optional['MultiplexprogramMultiplexStatmuxVideoSettingsArgs']]:
        """
        Statmux rate control settings.
        When this field is defined, ConstantBitrate must be undefined.
        """
    ...
    def statmux_settings(self, value: pulumi.Input[Optional['MultiplexprogramMultiplexStatmuxVideoSettingsArgs']]):
...
class NodeInterfaceMappingArgsDict(TypedDict):
    ...
    """
    network_interface_mode: NotRequired[pulumi.Input[Optional['NodeInterfaceMappingNetworkInterfaceMode']]]
    """
    The network interface mode.
    """
    physical_interface_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class NodeInterfaceMappingArgs:
    def __init__(__self__, *,
                 logical_interface_name: pulumi.Input[Optional[_builtins.str]] = None,
                 network_interface_mode: pulumi.Input[Optional['NodeInterfaceMappingNetworkInterfaceMode']] = None,
                 physical_interface_name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Node interface mapping.
    ...
    def network_interface_mode(self) -> pulumi.Input[Optional['NodeInterfaceMappingNetworkInterfaceMode']]:
        """
        The network interface mode.
        """
    ...
    def network_interface_mode(self, value: pulumi.Input[Optional['NodeInterfaceMappingNetworkInterfaceMode']]):
        pulumi.set(self, "network_interface_mode", value)

    @_builtins.property
    @pulumi.getter(name="physicalInterfaceName")
    def physical_interface_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The physical interface name.
        """
    ...
    def physical_interface_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class NodeSdiSourceMappingArgsDict(TypedDict):
    ...
    SDI source mapping.
    """
    card_number: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The card number.
    """
    channel_number: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The channel number.
    """
    sdi_source: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The SDI source.
    """
...
class NodeSdiSourceMappingArgs:
    def __init__(__self__, *,
                 card_number: pulumi.Input[Optional[_builtins.int]] = None,
                 channel_number: pulumi.Input[Optional[_builtins.int]] = None,
                 sdi_source: pulumi.Input[Optional[_builtins.str]] = None):
        """
        SDI source mapping.
    ...
    def card_number(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The card number.
        """
    ...
    @card_number.setter
    def card_number(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "card_number", value)

    @_builtins.property
    @pulumi.getter(name="channelNumber")
    def channel_number(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The channel number.
        """
    ...
    def channel_number(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "channel_number", value)

    @_builtins.property
    @pulumi.getter(name="sdiSource")
    def sdi_source(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The SDI source.
        """
    ...
    @sdi_source.setter
    def sdi_source(self, value: pulumi.Input[Optional[_builtins.str]]):
