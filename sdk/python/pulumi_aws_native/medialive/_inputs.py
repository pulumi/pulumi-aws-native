...
class ClusterNetworkSettingsArgsDict(TypedDict):
    ...
    """
    interface_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ClusterInterfaceMappingArgs']]]]]
    """
    Network mappings for the cluster
    """
...
class MultiplexOutputDestinationArgsDict(TypedDict):
    ...
    Multiplex MediaConnect output destination settings.
    """
    multiplex_media_connect_output_destination_settings: NotRequired[pulumi.Input[Optional['MultiplexOutputDestinationMultiplexMediaConnectOutputDestinationSettingsPropertiesArgs']]]
    """
    Multiplex MediaConnect output destination settings.
    """
...
class MultiplexprogramMultiplexProgramSettingsArgsDict(TypedDict):
    ...
    """
    service_descriptor: NotRequired[pulumi.Input[Optional['MultiplexprogramMultiplexProgramServiceDescriptorArgs']]]
    """
    Transport stream service descriptor configuration for the Multiplex program.
    """
    video_settings: NotRequired[pulumi.Input[Optional['MultiplexprogramMultiplexVideoSettingsArgs']]]
    """
