...
class InputSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InputSecurityGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InputSecurityGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InputSecurityGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InputSecurityGroupProperties']:
        """
