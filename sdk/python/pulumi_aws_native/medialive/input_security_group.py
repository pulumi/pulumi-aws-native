...
warnings.warn("""InputSecurityGroup is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class InputSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 whitelist_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InputSecurityGroupInputWhitelistRuleCidrArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""InputSecurityGroup is deprecated: InputSecurityGroup is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
