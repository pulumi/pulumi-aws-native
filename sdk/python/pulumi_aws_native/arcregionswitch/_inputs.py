...
class PlanCustomActionLambdaConfigurationArgsDict(TypedDict):
    ...
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanLambdaUngracefulArgs']]]
...
class PlanDocumentDbConfigurationArgsDict(TypedDict):
    ...
    external_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanDocumentDbUngracefulArgs']]]
...
class PlanEc2AsgCapacityIncreaseConfigurationArgsDict(TypedDict):
    ...
    capacity_monitoring_approach: NotRequired[Optional[Any]]
    target_percent: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanEc2UngracefulArgs']]]
...
class PlanEcsCapacityIncreaseConfigurationArgsDict(TypedDict):
    ...
    target_percent: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanEcsUngracefulArgs']]]
...
class PlanEksResourceScalingConfigurationArgsDict(TypedDict):
    ...
    capacity_monitoring_approach: NotRequired[Optional[Any]]
    eks_clusters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlanEksClusterArgs']]]]]
    scaling_resources: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, Any]]]]]]
    target_percent: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanEksResourceScalingUngracefulArgs']]]
...
class PlanGlobalAuroraConfigurationArgsDict(TypedDict):
    ...
    external_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    ungraceful: NotRequired[pulumi.Input[Optional['PlanGlobalAuroraUngracefulArgs']]]
...
class PlanLambdaUngracefulArgsDict(TypedDict):
    behavior: NotRequired[Optional[Any]]
...
class PlanReportConfigurationArgsDict(TypedDict):
    report_output: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlanReportOutputConfigurationPropertiesArgs']]]]]
    """
...
class PlanRoute53HealthCheckConfigurationArgsDict(TypedDict):
    ...
    cross_account_role: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    external_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    record_sets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlanRoute53ResourceRecordSetArgs']]]]]
    timeout_minutes: NotRequired[pulumi.Input[Optional[_builtins.float]]]
...
class PlanStepArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Union['PlanExecutionBlockConfiguration0PropertiesArgs', 'PlanExecutionBlockConfiguration1PropertiesArgs', 'PlanExecutionBlockConfiguration2PropertiesArgs', 'PlanExecutionBlockConfiguration3PropertiesArgs', 'PlanExecutionBlockConfiguration4PropertiesArgs', 'PlanExecutionBlockConfiguration5PropertiesArgs', 'PlanExecutionBlockConfiguration6PropertiesArgs', 'PlanExecutionBlockConfiguration7PropertiesArgs', 'PlanExecutionBlockConfiguration8PropertiesArgs', 'PlanExecutionBlockConfiguration9PropertiesArgs', 'PlanExecutionBlockConfiguration10PropertiesArgs', 'PlanExecutionBlockConfiguration11PropertiesArgs', 'PlanExecutionBlockConfiguration12PropertiesArgs']] execution_block_configuration: The configuration for an execution block in a workflow.
...
class PlanWorkflowArgsDict(TypedDict):
    ...
    """
    steps: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlanStepArgs']]]]]
    """
