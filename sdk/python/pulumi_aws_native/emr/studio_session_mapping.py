...
class StudioSessionMappingArgs:
    def __init__(__self__, *,
                 identity_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] identity_name: The name of the user or group. For more information, see UserName and DisplayName in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.
        ...
        :param pulumi.Input[builtins.str] session_policy_arn: The Amazon Resource Name (ARN) for the session policy that will be applied to the user or group. Session policies refine Studio user permissions without the need to use multiple IAM user roles.
    ...
    def identity_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def identity_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:emr:StudioSessionMapping")
