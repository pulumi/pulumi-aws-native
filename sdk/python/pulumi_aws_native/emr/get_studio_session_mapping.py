...
class GetStudioSessionMappingResult:
    ...
    def session_policy_arn(self) -> Optional[_builtins.str]:
        """
...
def get_studio_session_mapping(identity_name: Optional[_builtins.str] = None,
                               identity_type: Optional['StudioSessionMappingIdentityType'] = None,
                               studio_id: Optional[_builtins.str] = None,
