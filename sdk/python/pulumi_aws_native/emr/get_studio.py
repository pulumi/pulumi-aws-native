...
class GetStudioResult:
    ...
    def default_s3_location(self) -> Optional[builtins.str]:
        """
    ...
    def idp_auth_url(self) -> Optional[builtins.str]:
        """
    ...
    def idp_relay_state_parameter_name(self) -> Optional[builtins.str]:
        """
...
def get_studio(studio_id: Optional[builtins.str] = None,
    ...
    :param builtins.str studio_id: The ID of the EMR Studio.
    """
    __args__ = dict()
