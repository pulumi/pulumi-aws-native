...
class WalWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 wal_workspace_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WalWorkspace resource.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[builtins.str] wal_workspace_name: The name of the emrwal container
        """
        if tags is not None:
    ...
    def wal_workspace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def wal_workspace_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "wal_workspace_name", value)


@pulumi.type_token("aws-native:emr:WalWorkspace")
class WalWorkspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="walWorkspaceName")
    def wal_workspace_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the emrwal container
        """
        return pulumi.get(self, "wal_workspace_name")
