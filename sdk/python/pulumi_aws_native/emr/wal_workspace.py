...
class WalWorkspaceArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if wal_workspace_name is None and 'walWorkspaceName' in kwargs:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['WalWorkspaceTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['WalWorkspaceTagArgs']]]]):
...
class WalWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WalWorkspaceTagArgs']]]]] = None,
                 wal_workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WalWorkspaceTagArgs']]]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[str] wal_workspace_name: The name of the emrwal container
        """
        ...
    @overload
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.WalWorkspaceTag']]]:
        """
        An array of key-value pairs to apply to this resource.
        """
        return pulumi.get(self, "tags")
