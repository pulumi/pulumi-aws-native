...
class SecurityConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SecurityConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SecurityConfigurationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SecurityConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SecurityConfigurationProperties']:
        """
