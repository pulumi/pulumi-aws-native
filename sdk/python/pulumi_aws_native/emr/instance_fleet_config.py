...
warnings.warn("""InstanceFleetConfig is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class InstanceFleetConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_spot_capacity: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""InstanceFleetConfig is deprecated: InstanceFleetConfig is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
