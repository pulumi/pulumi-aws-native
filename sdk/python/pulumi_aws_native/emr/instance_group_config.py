...
class InstanceGroupConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(auto_scaling_policy, InstanceGroupConfigAutoScalingPolicyArgs):
            ...
            if not isinstance(ebs_configuration, InstanceGroupConfigEbsConfigurationArgs):
