...
class StepArgs:
    def __init__(__self__, *,
                 ...
                 job_flow_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Step resource.
        :param pulumi.Input[builtins.str] action_on_failure: This specifies what action to take when the cluster step fails. Possible values are CANCEL_AND_WAIT and CONTINUE.
        ...
        :param pulumi.Input[builtins.str] job_flow_id: A string that uniquely identifies the cluster (job flow).
        :param pulumi.Input[builtins.str] name: The name of the cluster step.
        """
    ...
    def job_flow_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @job_flow_id.setter
    def job_flow_id(self, value: pulumi.Input[builtins.str]):
...
class Step(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 action_on_failure: Optional[pulumi.Input[builtins.str]] = None,
                 hadoop_jar_step: Optional[pulumi.Input[Union['StepHadoopJarStepConfigArgs', 'StepHadoopJarStepConfigArgsDict']]] = None,
                 job_flow_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="actionOnFailure")
    def action_on_failure(self) -> pulumi.Output[builtins.str]:
        """
        This specifies what action to take when the cluster step fails. Possible values are CANCEL_AND_WAIT and CONTINUE.
        """
        return pulumi.get(self, "action_on_failure")
    ...
    @property
    @pulumi.getter(name="jobFlowId")
    def job_flow_id(self) -> pulumi.Output[builtins.str]:
        """
        A string that uniquely identifies the cluster (job flow).
        """
        return pulumi.get(self, "job_flow_id")
