...
class StudioArgs:
    def __init__(__self__, *,
                 ...
                 trusted_identity_propagation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] default_s3_location: The default Amazon S3 location to back up EMR Studio Workspaces and notebook files. A Studio user can select an alternative Amazon S3 location when creating a Workspace.
        :param pulumi.Input[builtins.str] engine_security_group_id: The ID of the Amazon EMR Studio Engine security group. The Engine security group allows inbound network traffic from the Workspace security group, and it must be in the same VPC specified by VpcId.
        :param pulumi.Input[builtins.str] service_role: The IAM role that will be assumed by the Amazon EMR Studio. The service role provides a way for Amazon EMR Studio to interoperate with other AWS services.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of up to 5 subnet IDs to associate with the Studio. The subnets must belong to the VPC specified by VpcId. Studio users can create a Workspace in any of the specified subnets.
        ...
        :param pulumi.Input[builtins.str] workspace_security_group_id: The ID of the Amazon EMR Studio Workspace security group. The Workspace security group allows outbound network traffic to resources in the Engine security group, and it must be in the same VPC specified by VpcId.
        :param pulumi.Input[builtins.str] description: A detailed description of the Studio.
        :param pulumi.Input[builtins.str] encryption_key_arn: The AWS KMS key identifier (ARN) used to encrypt AWS EMR Studio workspace and notebook files when backed up to AWS S3.
        :param pulumi.Input[builtins.str] idc_instance_arn: The ARN of the IAM Identity Center instance to create the Studio application.
        ...
        :param pulumi.Input[builtins.str] idp_auth_url: Your identity provider's authentication endpoint. Amazon EMR Studio redirects federated users to this endpoint for authentication when logging in to a Studio with the Studio URL.
        :param pulumi.Input[builtins.str] idp_relay_state_parameter_name: The name of relay state parameter for external Identity Provider.
        ...
        :param pulumi.Input[builtins.bool] trusted_identity_propagation_enabled: A Boolean indicating whether to enable Trusted identity propagation for the Studio. The default value is false.
        :param pulumi.Input[builtins.str] user_role: The IAM user role that will be assumed by users and groups logged in to a Studio. The permissions attached to this IAM role can be scoped down for each user or group using session policies.
        """
    ...
    def trusted_identity_propagation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def trusted_identity_propagation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Studio(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="idcInstanceArn")
    def idc_instance_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the IAM Identity Center instance to create the Studio application.
        """
        return pulumi.get(self, "idc_instance_arn")
    ...
    @property
    @pulumi.getter(name="trustedIdentityPropagationEnabled")
    def trusted_identity_propagation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A Boolean indicating whether to enable Trusted identity propagation for the Studio. The default value is false.
        """
        return pulumi.get(self, "trusted_identity_propagation_enabled")
