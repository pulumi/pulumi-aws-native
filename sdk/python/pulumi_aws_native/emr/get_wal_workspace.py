...
def get_wal_workspace(wal_workspace_name: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWalWorkspaceResult:
    """
    Resource schema for AWS::EMR::WALWorkspace Type


    :param builtins.str wal_workspace_name: The name of the emrwal container
    """
    __args__ = dict()
...
def get_wal_workspace_output(wal_workspace_name: Optional[pulumi.Input[builtins.str]] = None,
