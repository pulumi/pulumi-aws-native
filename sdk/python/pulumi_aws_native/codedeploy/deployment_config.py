...
class DeploymentConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(minimum_healthy_hosts, DeploymentConfigMinimumHealthyHostsArgs):
            ...
            if not isinstance(traffic_routing_config, DeploymentConfigTrafficRoutingConfigArgs):
