...
class DeploymentConfigMinimumHealthyHosts(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str type: The minimum healthy instance type:
        ...
        :param builtins.int value: The minimum healthy instance value.
        """
...
class DeploymentConfigMinimumHealthyHostsPerZone(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str type: The `type` associated with the `MinimumHealthyHostsPerZone` option.
        :param builtins.int value: The `value` associated with the `MinimumHealthyHostsPerZone` option.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class DeploymentConfigTimeBasedCanary(dict):
    ...
    def __init__(__self__, *,
                 canary_interval: builtins.int,
                 canary_percentage: builtins.int):
        """
        :param builtins.int canary_interval: The number of minutes between the first and second traffic shifts of a `TimeBasedCanary` deployment.
        :param builtins.int canary_percentage: The percentage of traffic to shift in the first increment of a `TimeBasedCanary` deployment.
        """
    ...
    def canary_interval(self) -> builtins.int:
        """
    ...
    def canary_percentage(self) -> builtins.int:
        """
...
class DeploymentConfigTimeBasedLinear(dict):
    ...
    def __init__(__self__, *,
                 linear_interval: builtins.int,
                 linear_percentage: builtins.int):
        """
        :param builtins.int linear_interval: The number of minutes between each incremental traffic shift of a `TimeBasedLinear` deployment.
        :param builtins.int linear_percentage: The percentage of traffic that is shifted at the start of each increment of a `TimeBasedLinear` deployment.
        """
    ...
    def linear_interval(self) -> builtins.int:
        """
    ...
    def linear_percentage(self) -> builtins.int:
        """
...
class DeploymentConfigTrafficRoutingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of traffic shifting ( `TimeBasedCanary` or `TimeBasedLinear` ) used by a deployment configuration.
