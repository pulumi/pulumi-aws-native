...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_name: A name for the application. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the application name.
        :param pulumi.Input[builtins.str] compute_platform: The compute platform that CodeDeploy deploys the application to.
...
@pulumi.type_token("aws-native:codedeploy:Application")
class Application(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="computePlatform")
    def compute_platform(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compute platform that CodeDeploy deploys the application to.
        """
        return pulumi.get(self, "compute_platform")
