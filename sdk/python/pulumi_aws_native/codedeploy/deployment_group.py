...
class DeploymentGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(alarm_configuration, DeploymentGroupAlarmConfigurationArgs):
            ...
            if not isinstance(auto_rollback_configuration, DeploymentGroupAutoRollbackConfigurationArgs):
            ...
            if not isinstance(blue_green_deployment_configuration, DeploymentGroupBlueGreenDeploymentConfigurationArgs):
            ...
            if not isinstance(deployment, DeploymentGroupDeploymentArgs):
            ...
            if not isinstance(deployment_style, DeploymentGroupDeploymentStyleArgs):
            ...
            if not isinstance(ec2_tag_set, DeploymentGroupEc2TagSetArgs):
            ...
            if not isinstance(load_balancer_info, DeploymentGroupLoadBalancerInfoArgs):
            ...
            if not isinstance(on_premises_tag_set, DeploymentGroupOnPremisesTagSetArgs):
