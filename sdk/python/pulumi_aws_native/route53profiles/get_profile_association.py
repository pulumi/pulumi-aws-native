...
def get_profile_association(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Primary Identifier for  Profile Association
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_profile_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
