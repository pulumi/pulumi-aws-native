...
class ProfileAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_id: The ID of the  profile that you associated with the resource that is specified by ResourceId.
        :param pulumi.Input[builtins.str] resource_id: The resource that you associated the  profile with.
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the profile association.
        :param pulumi.Input[builtins.str] name: The name of an association between a  Profile and a VPC.
