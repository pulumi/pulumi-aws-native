...
class ProfileResourceAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] profile_id: The ID of the  profile that you associated the resource to that is specified by ResourceArn.
        :param pulumi.Input[_builtins.str] resource_arn: The arn of the resource that you associated to the  Profile.
        :param pulumi.Input[_builtins.str] name: The name of an association between the  Profile and resource.
        :param pulumi.Input[_builtins.str] resource_properties: A JSON-formatted string with key-value pairs specifying the properties of the associated resource.
        """
...
class ProfileResourceAssociation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="resourceProperties")
    def resource_properties(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A JSON-formatted string with key-value pairs specifying the properties of the associated resource.
        """
        return pulumi.get(self, "resource_properties")
