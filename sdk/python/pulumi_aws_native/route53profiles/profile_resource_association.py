...
class ProfileResourceAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_id: The ID of the  profile that you associated the resource to that is specified by ResourceArn.
        :param pulumi.Input[builtins.str] resource_arn: The arn of the resource that you associated to the  Profile.
        :param pulumi.Input[builtins.str] name: The name of an association between the  Profile and resource.
        :param pulumi.Input[builtins.str] resource_properties: A JSON-formatted string with key-value pairs specifying the properties of the associated resource.
        """
