...
class GetProfileResourceAssociationResult:
    ...
    def resource_properties(self) -> Optional[_builtins.str]:
        """
...
def get_profile_resource_association(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Primary Identifier for  Profile Resource Association
    """
    __args__ = dict()
    __args__['id'] = id
