...
class GetProfileResourceAssociationResult:
    ...
    def resource_properties(self) -> Optional[builtins.str]:
        """
...
def get_profile_resource_association(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Primary Identifier for  Profile Resource Association
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_profile_resource_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
