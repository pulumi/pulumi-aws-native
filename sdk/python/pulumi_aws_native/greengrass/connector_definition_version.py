...
class ConnectorDefinitionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] connector_definition_id: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-connectordefinitionversion.html#cfn-greengrass-connectordefinitionversion-connectordefinitionid
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectorDefinitionVersionConnectorArgs']]]] connectors: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-connectordefinitionversion.html#cfn-greengrass-connectordefinitionversion-connectors
        """
        ...
    @overload
    def __init__(__self__,
