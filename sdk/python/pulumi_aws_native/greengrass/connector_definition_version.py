...
warnings.warn("""ConnectorDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ConnectorDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 connectors: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectorDefinitionVersionConnectorArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectorDefinitionVersion is deprecated: ConnectorDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
