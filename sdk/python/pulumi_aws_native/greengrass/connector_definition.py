...
class ConnectorDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConnectorDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectorDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConnectorDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConnectorDefinitionProperties']:
        """
