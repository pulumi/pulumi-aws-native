...
warnings.warn("""ConnectorDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ConnectorDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ConnectorDefinitionArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Resource Type definition for AWS::Greengrass::ConnectorDefinition
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectorDefinition is deprecated: ConnectorDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
