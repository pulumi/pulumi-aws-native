...
warnings.warn("""ConnectorDefinition is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ConnectorDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            initial_version = _utilities.configure(initial_version, ConnectorDefinitionVersionArgs, True)
