...
__all__ = [
    ...
    'AwaitableGetDeviceDefinitionResult',
    'get_device_definition',
    'get_device_definition_output',
]
...
class AwaitableGetDeviceDefinitionResult(GetDeviceDefinitionResult):
...
def get_device_definition(id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDeviceDefinitionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:greengrass:getDeviceDefinition', __args__, opts=opts, typ=GetDeviceDefinitionResult).value

    return AwaitableGetDeviceDefinitionResult(
        arn=__ret__.arn,
        id=__ret__.id,
