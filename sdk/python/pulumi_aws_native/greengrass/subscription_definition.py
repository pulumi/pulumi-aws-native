...
__all__ = ['SubscriptionDefinitionArgs', 'SubscriptionDefinition']
...
class SubscriptionDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param Any tags: Search the [CloudFormation User Guide](https://docs.aws.amazon.com/cloudformation/) for `AWS::Greengrass::SubscriptionDefinition` for more information about the expected schema for this property.
        """
...
warnings.warn("""SubscriptionDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class SubscriptionDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SubscriptionDefinitionArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Resource Type definition for AWS::Greengrass::SubscriptionDefinition

        :param str resource_name: The name of the resource.
        :param SubscriptionDefinitionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SubscriptionDefinitionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""SubscriptionDefinition is deprecated: SubscriptionDefinition is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        ...
        super(SubscriptionDefinition, __self__).__init__(
            'aws-native:greengrass:SubscriptionDefinition',
            resource_name,
            __props__,
            opts)
