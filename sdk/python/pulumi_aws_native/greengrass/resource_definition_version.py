...
__all__ = ['ResourceDefinitionVersion']
...
class ResourceDefinitionVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResourceDefinitionVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResourceDefinitionVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResourceDefinitionVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResourceDefinitionVersionProperties']:
        """
