...
warnings.warn("""ResourceDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ResourceDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ResourceDefinitionVersionResourceInstanceArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ResourceDefinitionVersion is deprecated: ResourceDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
