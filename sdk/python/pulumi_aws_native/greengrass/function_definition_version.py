...
warnings.warn("""FunctionDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class FunctionDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 functions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FunctionDefinitionVersionFunctionArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FunctionDefinitionVersion is deprecated: FunctionDefinitionVersion is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
