...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param Any tags: Search the [CloudFormation User Guide](https://docs.aws.amazon.com/cloudformation/) for `AWS::Greengrass::Group` for more information about the expected schema for this property.
        """
...
warnings.warn("""Group is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Group(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""Group is deprecated: Group is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
