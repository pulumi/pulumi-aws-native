...
warnings.warn("""CoreDefinitionVersion is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class CoreDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 cores: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreDefinitionVersionCoreArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CoreDefinitionVersion is deprecated: CoreDefinitionVersion is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
