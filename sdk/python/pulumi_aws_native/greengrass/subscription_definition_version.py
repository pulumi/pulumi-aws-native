...
class SubscriptionDefinitionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] subscription_definition_id: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-subscriptiondefinitionversion.html#cfn-greengrass-subscriptiondefinitionversion-subscriptiondefinitionid
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SubscriptionDefinitionVersionSubscriptionArgs']]]] subscriptions: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-subscriptiondefinitionversion.html#cfn-greengrass-subscriptiondefinitionversion-subscriptions
        """
        ...
    @overload
    def __init__(__self__,
