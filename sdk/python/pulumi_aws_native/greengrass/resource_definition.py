...
warnings.warn("""ResourceDefinition is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ResourceDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""ResourceDefinition is deprecated: ResourceDefinition is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
