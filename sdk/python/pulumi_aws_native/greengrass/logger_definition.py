...
class LoggerDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LoggerDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LoggerDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LoggerDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LoggerDefinitionProperties']:
        """
