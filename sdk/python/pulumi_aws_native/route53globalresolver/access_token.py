...
@pulumi.type_token("aws-native:route53globalresolver:AccessToken")
class AccessToken(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["clientToken", "dnsViewId", "expiresAt"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(AccessToken, __self__).__init__(
            'aws-native:route53globalresolver:AccessToken',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['AccessTokenTokenStatus']:
