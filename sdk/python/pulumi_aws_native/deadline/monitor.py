...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] identity_center_region: The AWS region where IAM Identity Center is enabled. Required when Identity Center is in a different region than the monitor.
        ...
        if identity_center_region is not None:
            pulumi.set(__self__, "identity_center_region", identity_center_region)
        if tags is not None:
...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["identity_center_region"] = identity_center_region
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["identityCenterInstanceArn", "identityCenterRegion"])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["identity_center_region"] = None
        __props__.__dict__["monitor_id"] = None
    ...
    @_builtins.property
    @pulumi.getter(name="identityCenterRegion")
    def identity_center_region(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The AWS region where IAM Identity Center is enabled. Required when Identity Center is in a different region than the monitor.
        """
        return pulumi.get(self, "identity_center_region")
