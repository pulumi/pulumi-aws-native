...
class StorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the storage profile summary to update.
               
               > This field can store any content. Escape or encode this content before displaying it on a webpage or any other system that might interpret the content of this field.
        :param pulumi.Input[builtins.str] farm_id: The unique identifier of the farm that contains the storage profile.
...
class StorageProfile(pulumi.CustomResource):
    ...
    def storage_profile_id(self) -> pulumi.Output[builtins.str]:
        """
