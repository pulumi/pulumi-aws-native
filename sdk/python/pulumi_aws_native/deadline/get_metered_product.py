...
def get_metered_product(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the metered product.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_metered_product_output(arn: Optional[pulumi.Input[builtins.str]] = None,
