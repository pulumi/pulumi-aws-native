...
class QueueFleetAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] farm_id: The identifier of the farm that contains the queue and the fleet.
        :param pulumi.Input[builtins.str] fleet_id: The fleet ID.
        :param pulumi.Input[builtins.str] queue_id: The queue ID.
        """
