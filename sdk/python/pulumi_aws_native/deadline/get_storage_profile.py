...
def get_storage_profile(farm_id: Optional[builtins.str] = None,
    ...
    :param builtins.str farm_id: The unique identifier of the farm that contains the storage profile.
    :param builtins.str storage_profile_id: The storage profile ID.
    """
    __args__ = dict()
...
def get_storage_profile_output(farm_id: Optional[pulumi.Input[builtins.str]] = None,
