...
class FleetAmountCapabilityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] min: The minimum amount of fleet worker capability.
        :param pulumi.Input[builtins.str] name: The name of the fleet capability.
        :param pulumi.Input[builtins.float] max: The maximum amount of the fleet worker capability.
        """
        pulumi.set(__self__, "min", min)
        pulumi.set(__self__, "name", name)
        if max is not None:
...
class FleetAttributeCapabilityArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] name: The name of the fleet attribute capability for the worker.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The number of fleet attribute capabilities.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class FleetEc2EbsVolumeArgsDict(TypedDict):
        ...
        size_gi_b: NotRequired[pulumi.Input[builtins.int]]
        throughput_mi_b: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class FleetEc2EbsVolumeArgs:
    def __init__(__self__, *,
                 ...
                 size_gi_b: Optional[pulumi.Input[builtins.int]] = None,
                 throughput_mi_b: Optional[pulumi.Input[builtins.int]] = None):
        if iops is not None:
    ...
    def size_gi_b(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "size_gi_b")

    @size_gi_b.setter
    def size_gi_b(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "size_gi_b", value)

    @property
    @pulumi.getter(name="throughputMiB")
    def throughput_mi_b(self) -> Optional[pulumi.Input[builtins.int]]:
...
if not MYPY:
    class QueueJobAttachmentSettingsArgsDict(TypedDict):
        root_prefix: pulumi.Input[builtins.str]
        """
        The root prefix.
        """
...
class QueueJobAttachmentSettingsArgs:
    def __init__(__self__, *,
                 ...
                 s3_bucket_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] root_prefix: The root prefix.
        :param pulumi.Input[builtins.str] s3_bucket_name: The Amazon S3 bucket name.
        """
    ...
    def root_prefix(self) -> pulumi.Input[builtins.str]:
        """
        The root prefix.
        """
    ...
    @root_prefix.setter
    def root_prefix(self, value: pulumi.Input[builtins.str]):
...
class QueuePosixUserArgs:
    def __init__(__self__, *,
                 ...
                 user: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group: The name of the POSIX user's group.
        :param pulumi.Input[builtins.str] user: The name of the POSIX user.
        """
...
if not MYPY:
    class QueueWindowsUserArgsDict(TypedDict):
        password_arn: pulumi.Input[builtins.str]
        """
...
class QueueWindowsUserArgs:
    def __init__(__self__, *,
                 ...
                 user: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password_arn: The password ARN for the Windows user.
        :param pulumi.Input[builtins.str] user: The user.
        """
    ...
    def password_arn(self) -> pulumi.Input[builtins.str]:
        """
        The password ARN for the Windows user.
        """
    ...
    @password_arn.setter
    def password_arn(self, value: pulumi.Input[builtins.str]):
...
class StorageProfileFileSystemLocationArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input['StorageProfileFileSystemLocationType']):
        """
        :param pulumi.Input[builtins.str] name: The location name.
        :param pulumi.Input[builtins.str] path: The file path.
