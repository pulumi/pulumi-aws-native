...
class FleetAmountCapability(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float min: The minimum amount of fleet worker capability.
        :param builtins.str name: The name of the fleet capability.
        :param builtins.float max: The maximum amount of the fleet worker capability.
        """
        pulumi.set(__self__, "min", min)
        pulumi.set(__self__, "name", name)
        if max is not None:
...
class FleetAttributeCapability(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the fleet attribute capability for the worker.
        :param Sequence[builtins.str] values: The number of fleet attribute capabilities.
        """
        pulumi.set(__self__, "name", name)
...
class FleetEc2EbsVolume(dict):
    ...
    def __init__(__self__, *,
                 ...
                 size_gi_b: Optional[builtins.int] = None,
                 throughput_mi_b: Optional[builtins.int] = None):
        if iops is not None:
    ...
    def size_gi_b(self) -> Optional[builtins.int]:
...
class FleetHostConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str script_body: The text of the script that runs as a worker is starting up that you can use to provide additional configuration for workers in your fleet. The script runs after a worker enters the `STARTING` state and before the worker processes tasks.
        ...
        :param builtins.int script_timeout_seconds: The maximum time that the host configuration can run. If the timeout expires, the worker enters the `NOT RESPONDING` state and shuts down. You are charged for the time that the worker is running the host configuration script.
...
class QueueJobAttachmentSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str root_prefix: The root prefix.
        :param builtins.str s3_bucket_name: The Amazon S3 bucket name.
        """
...
class QueuePosixUser(dict):
    def __init__(__self__, *,
                 ...
                 user: builtins.str):
        """
        :param builtins.str group: The name of the POSIX user's group.
        :param builtins.str user: The name of the POSIX user.
        """
...
class QueueWindowsUser(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user: builtins.str):
        """
        :param builtins.str password_arn: The password ARN for the Windows user.
        :param builtins.str user: The user.
        """
...
class StorageProfileFileSystemLocation(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The location name.
        :param builtins.str path: The file path.
