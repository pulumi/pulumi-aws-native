...
class GetLicenseEndpointResult:
    ...
    def license_endpoint_id(self) -> Optional[builtins.str]:
        """
...
def get_license_endpoint(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the license endpoint.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_license_endpoint_output(arn: Optional[pulumi.Input[builtins.str]] = None,
