...
class QueueEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] template: A JSON or YAML template that describes the processing environment for the queue.
...
class QueueEnvironment(pulumi.CustomResource):
    ...
    def queue_environment_id(self) -> pulumi.Output[_builtins.str]:
        """
