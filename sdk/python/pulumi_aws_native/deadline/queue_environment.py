...
class QueueEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] farm_id: The identifier assigned to the farm that contains the queue.
        :param pulumi.Input[builtins.int] priority: The queue environment's priority.
        :param pulumi.Input[builtins.str] queue_id: The unique identifier of the queue that contains the environment.
        :param pulumi.Input[builtins.str] template: A JSON or YAML template that describes the processing environment for the queue.
...
class QueueEnvironment(pulumi.CustomResource):
    ...
    def queue_environment_id(self) -> pulumi.Output[builtins.str]:
        """
