...
class GetQueueEnvironmentResult:
    ...
    def queue_environment_id(self) -> Optional[_builtins.str]:
        """
...
def get_queue_environment(farm_id: Optional[_builtins.str] = None,
                          queue_environment_id: Optional[_builtins.str] = None,
