...
class FarmArgs:
    def __init__(__self__, *,
                 ...
                 cost_scale_factor: pulumi.Input[Optional[_builtins.float]] = None,
    ...
    def cost_scale_factor(self) -> pulumi.Input[Optional[_builtins.float]]:
        return pulumi.get(self, "cost_scale_factor")

    @cost_scale_factor.setter
    def cost_scale_factor(self, value: pulumi.Input[Optional[_builtins.float]]):
