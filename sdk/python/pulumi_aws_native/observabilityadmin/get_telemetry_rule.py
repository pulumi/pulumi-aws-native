...
def get_telemetry_rule(rule_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_arn: The arn of the telemetry rule
    """
    __args__ = dict()
...
def get_telemetry_rule_output(rule_arn: Optional[pulumi.Input[builtins.str]] = None,
