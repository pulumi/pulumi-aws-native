...
__all__ = ['TelemetryPipelinesArgs', 'TelemetryPipelines']

@pulumi.input_type
class TelemetryPipelinesArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['TelemetryPipelinesTelemetryPipelineConfigurationArgs'],
    ...
    def configuration(self, value: pulumi.Input['TelemetryPipelinesTelemetryPipelineConfigurationArgs']):
...
@pulumi.type_token("aws-native:observabilityadmin:TelemetryPipelines")
class TelemetryPipelines(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[Union['TelemetryPipelinesTelemetryPipelineConfigurationArgs', 'TelemetryPipelinesTelemetryPipelineConfigurationArgsDict']]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TelemetryPipelinesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TelemetryPipelinesArgs.__new__(TelemetryPipelinesArgs)
            ...
            __props__.__dict__["pipeline"] = None
            __props__.__dict__["pipeline_identifier"] = None
            __props__.__dict__["status"] = None
            __props__.__dict__["status_reason"] = None
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["name"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(TelemetryPipelines, __self__).__init__(
            'aws-native:observabilityadmin:TelemetryPipelines',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TelemetryPipelines':
        """
        ...
        return TelemetryPipelines(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def pipeline(self) -> pulumi.Output['outputs.TelemetryPipelinesTelemetryPipeline']:
    ...
    def status_reason(self) -> pulumi.Output['outputs.TelemetryPipelinesTelemetryPipelineStatusReason']:
