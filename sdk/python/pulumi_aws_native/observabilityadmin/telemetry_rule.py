...
class TelemetryRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rule: pulumi.Input[Optional[Union['TelemetryRuleArgs', 'TelemetryRuleArgsDict', 'outputs.TelemetryRule']]] = None,
                 rule_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['TelemetryRuleArgs', 'TelemetryRuleArgsDict', 'outputs.TelemetryRule']] rule: Retrieves the details of a specific telemetry rule in your account.
        :param pulumi.Input[_builtins.str] rule_name: The name of the telemetry rule
    ...
    def region_statuses(self) -> pulumi.Output[Sequence['outputs.TelemetryRuleRegionStatus']]:
        """
