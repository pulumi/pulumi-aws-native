...
__all__ = ['OrganizationTelemetryRuleArgs', 'OrganizationTelemetryRule']

@pulumi.input_type
class OrganizationTelemetryRuleArgs:
    def __init__(__self__, *,
                 rule: pulumi.Input['OrganizationTelemetryRuleTelemetryRuleArgs'],
        ...
        :param pulumi.Input[builtins.str] rule_name: The name of the organization telemetry rule
    ...
    @rule.setter
    def rule(self, value: pulumi.Input['OrganizationTelemetryRuleTelemetryRuleArgs']):
...
@pulumi.type_token("aws-native:observabilityadmin:OrganizationTelemetryRule")
class OrganizationTelemetryRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 rule: Optional[pulumi.Input[Union['OrganizationTelemetryRuleTelemetryRuleArgs', 'OrganizationTelemetryRuleTelemetryRuleArgsDict']]] = None,
                 rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param OrganizationTelemetryRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OrganizationTelemetryRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OrganizationTelemetryRule':
        """
