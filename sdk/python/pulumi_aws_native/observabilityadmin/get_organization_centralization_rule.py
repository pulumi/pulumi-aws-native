...
def get_organization_centralization_rule(rule_arn: Optional[builtins.str] = None,
...
def get_organization_centralization_rule_output(rule_arn: Optional[pulumi.Input[builtins.str]] = None,
