...
def get_discovery(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The 12 digit AWS Account ID for the account.
    """
    __args__ = dict()
...
def get_discovery_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
