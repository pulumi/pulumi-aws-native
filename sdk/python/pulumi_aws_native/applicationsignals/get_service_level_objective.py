...
class GetServiceLevelObjectiveResult:
    ...
    def last_updated_time(self) -> Optional[_builtins.int]:
        """
...
def get_service_level_objective(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The ARN of this SLO.
    """
    __args__ = dict()
    __args__['arn'] = arn
