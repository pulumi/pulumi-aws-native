...
class ServiceLevelObjectiveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description for this SLO. Default is 'No description'
        ...
        :param pulumi.Input[builtins.str] name: The name of this SLO.
