...
def get_grouping_configuration(account_id: Optional[builtins.str] = None,
...
def get_grouping_configuration_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
