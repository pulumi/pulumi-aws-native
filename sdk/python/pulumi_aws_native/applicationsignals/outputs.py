...
class ServiceLevelObjectiveBurnRateConfiguration(dict):
    ...
    def __init__(__self__, *,
                 look_back_window_minutes: builtins.int):
        """
        This object defines the length of the look-back window used to calculate one burn rate metric for this SLO. The burn rate measures how fast the service is consuming the error budget, relative to the attainment goal of the SLO. A burn rate of exactly 1 indicates that the SLO goal will be met exactly.
        For example, if you specify 60 as the number of minutes in the look-back window, the burn rate is calculated as the following:
        burn rate = error rate over the look-back window / (1 - attainment goal percentage)
        :param builtins.int look_back_window_minutes: The number of minutes to use as the look-back window.
        """
        pulumi.set(__self__, "look_back_window_minutes", look_back_window_minutes)

    @property
    @pulumi.getter(name="lookBackWindowMinutes")
    def look_back_window_minutes(self) -> builtins.int:
        """
...
class ServiceLevelObjectiveCalendarInterval(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        If the interval for this service level objective is a calendar interval, this structure contains the interval specifications.
        :param builtins.int duration: Specifies the duration of each calendar interval. For example, if `Duration` is `1` and `DurationUnit` is `MONTH` , each interval is one month, aligned with the calendar.
        :param 'ServiceLevelObjectiveDurationUnit' duration_unit: Specifies the calendar interval unit.
        :param builtins.int start_time: Epoch time in seconds you want the first interval to start. Be sure to choose a time that configures the intervals the way that you want. For example, if you want weekly intervals starting on Mondays at 6 a.m., be sure to specify a start time that is a Monday at 6 a.m.
...
class ServiceLevelObjectiveDependencyConfig(dict):
    ...
    def __init__(__self__, *,
                 dependency_key_attributes: Mapping[str, builtins.str],
                 dependency_operation_name: builtins.str):
        """
        Configuration for identifying a dependency and its operation
        :param Mapping[str, builtins.str] dependency_key_attributes: If this SLO is related to a metric collected by Application Signals, you must use this field to specify which dependency the SLO metric is related to.
        ...
        :param builtins.str dependency_operation_name: When the SLO monitors a specific operation of the dependency, this field specifies the name of that operation in the dependency.
        """
    ...
    def dependency_key_attributes(self) -> Mapping[str, builtins.str]:
        """
...
class ServiceLevelObjectiveDimension(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A dimension is a name/value pair that is part of the identity of a metric. Because dimensions are part of the unique identifier for a metric, whenever you add a unique name/value pair to one of your metrics, you are creating a new variation of that metric. For example, many Amazon EC2 metrics publish `InstanceId` as a dimension name, and the actual instance ID as the value for that dimension. You can assign up to 30 dimensions to a metric.
        :param builtins.str name: The name of the dimension. Dimension names must contain only ASCII characters, must include at least one non-whitespace character, and cannot start with a colon (:). ASCII control characters are not supported as part of dimension names.
        :param builtins.str value: The value of the dimension. Dimension values must contain only ASCII characters and must include at least one non-whitespace character. ASCII control characters are not supported as part of dimension values
        """
...
class ServiceLevelObjectiveExclusionWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This object defines a time exclusion window for this SLO. The time exclusion window is used to exclude breaching data points from affecting attainment rate, error budget, and burn rate metrics.
        :param builtins.str reason: An optional reason for scheduling this time exclusion window. Default is 'No reason'.
        :param builtins.str start_time: The time you want the exclusion window to start at. Note that time exclusion windows can only be scheduled in the future, not the past.
        """
...
class ServiceLevelObjectiveGoal(dict):
    ...
    def __init__(__self__, *,
                 attainment_goal: Optional[builtins.float] = None,
                 interval: Optional['outputs.ServiceLevelObjectiveInterval'] = None,
                 warning_threshold: Optional[builtins.float] = None):
        """
        A structure that contains the attributes that determine the goal of the SLO. This includes the time period for evaluation and the attainment threshold.
        :param builtins.float attainment_goal: The threshold that determines if the goal is being met. An attainment goal is the ratio of good periods that meet the threshold requirements to the total periods within the interval. For example, an attainment goal of 99.9% means that within your interval, you are targeting 99.9% of the periods to be in healthy state.
        ...
        :param builtins.float warning_threshold: The percentage of remaining budget over total budget that you want to get warnings for. If you omit this parameter, the default of 50.0 is used.
        """
    ...
    def attainment_goal(self) -> Optional[builtins.float]:
        """
...
class ServiceLevelObjectiveMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str metric_name: The name of the metric to use.
...
class ServiceLevelObjectiveMetricDataQuery(dict):
    ...
    def __init__(__self__, *,
        ...
        Use this structure to define a metric or metric math expression that you want to use as for a service level objective.
        Each `MetricDataQuery` in the `MetricDataQueries` array specifies either a metric to retrieve, or a metric math expression to be performed on retrieved metrics. A single `MetricDataQueries` array can include as many as 20 `MetricDataQuery` structures in the array. The 20 structures can include as many as 10 structures that contain a `MetricStat` parameter to retrieve a metric, and as many as 10 structures that contain the `Expression` parameter to perform a math expression. Of those Expression structures, exactly one must have true as the value for `ReturnData`. The result of this expression used for the SLO.
        :param builtins.str id: A short name used to tie this object to the results in the response.
        :param builtins.str account_id: The ID of the account where the metrics are located, if this is a cross-account alarm.
        :param builtins.str expression: The math expression to be performed on the returned data.
        ...
        :param builtins.bool return_data: This option indicates whether to return the timestamps and raw data values of this metric.
        """
...
class ServiceLevelObjectiveMetricStat(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A metric to be used directly for the SLO, or to be used in the math expression that will be used for the SLO. Within one MetricDataQuery object, you must specify either Expression or MetricStat but not both.
        :param builtins.int period: The granularity, in seconds, to be used for the metric.
        :param builtins.str stat: The statistic to use for comparison to the threshold. It can be any CloudWatch statistic or extended statistic.
        :param builtins.str unit: If you omit Unit then all data that was collected with any unit is returned, along with the corresponding units that were specified when the data was reported to CloudWatch. If you specify a unit, the operation returns only data that was collected with that unit specified. If you specify a unit that does not match the data collected, the results of the operation are null. CloudWatch does not perform unit conversions.
        """
...
class ServiceLevelObjectiveRecurrenceRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This object defines how often to repeat a time exclusion window.
        :param builtins.str expression: A cron or rate expression denoting how often to repeat this exclusion window.
        """
        pulumi.set(__self__, "expression", expression)
...
class ServiceLevelObjectiveRequestBasedSli(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_threshold: Optional[builtins.float] = None):
        """
        This structure contains information about the performance metric that a request-based SLO monitors.
        ...
        :param builtins.float metric_threshold: The value that the SLI metric is compared to.
        """
    ...
    def metric_threshold(self) -> Optional[builtins.float]:
        """
...
class ServiceLevelObjectiveRequestBasedSliMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_attributes: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param Mapping[str, builtins.str] key_attributes: This is a string-to-string map that contains information about the type of object that this SLO is related to. It can include the following fields.
        ...
        :param builtins.str operation_name: If the SLO monitors a specific operation of the service, this field displays that operation name.
    ...
    def key_attributes(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ServiceLevelObjectiveRollingInterval(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        If the interval is a calendar interval, this structure contains the interval specifications.
        :param builtins.int duration: Specifies the duration of each rolling interval. For example, if `Duration` is `7` and `DurationUnit` is `DAY` , each rolling interval is seven days.
...
class ServiceLevelObjectiveSli(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_threshold: builtins.float,
    ...
    @property
    @pulumi.getter(name="metricThreshold")
    def metric_threshold(self) -> builtins.float:
        """
        The value that the SLI metric is compared to.
        """
        return pulumi.get(self, "metric_threshold")
...
class ServiceLevelObjectiveSliMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        A structure that contains information about the metric that the SLO monitors.
        :param 'ServiceLevelObjectiveDependencyConfig' dependency_config: Identifies the dependency using the `DependencyKeyAttributes` and `DependencyOperationName` .
        :param Mapping[str, builtins.str] key_attributes: If this SLO is related to a metric collected by Application Signals, you must use this field to specify which service the SLO metric is related to. To do so, you must specify at least the `Type` , `Name` , and `Environment` attributes.
        ...
        :param builtins.str operation_name: If the SLO monitors a specific operation of the service, this field displays that operation name.
        :param builtins.int period_seconds: The number of seconds to use as the period for SLO evaluation. Your application's performance is compared to the SLI during each period. For each period, the application is determined to have either achieved or not achieved the necessary performance.
        :param builtins.str statistic: The statistic to use for comparison to the threshold. It can be any CloudWatch statistic or extended statistic
        """
        if dependency_config is not None:
            pulumi.set(__self__, "dependency_config", dependency_config)
        if key_attributes is not None:
