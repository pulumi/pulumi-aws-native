...
if not MYPY:
    class GroupingConfigurationGroupingAttributeDefinitionArgsDict(TypedDict):
        grouping_name: pulumi.Input[builtins.str]
        grouping_source_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        default_grouping_value: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class GroupingConfigurationGroupingAttributeDefinitionArgs:
    def __init__(__self__, *,
                 grouping_name: pulumi.Input[builtins.str],
                 grouping_source_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 default_grouping_value: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def grouping_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "grouping_name")

    @grouping_name.setter
    def grouping_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "grouping_name", value)

    @property
    @pulumi.getter(name="groupingSourceKeys")
    def grouping_source_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "grouping_source_keys")

    @grouping_source_keys.setter
    def grouping_source_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "grouping_source_keys", value)

    @property
    @pulumi.getter(name="defaultGroupingValue")
    def default_grouping_value(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "default_grouping_value")

    @default_grouping_value.setter
    def default_grouping_value(self, value: Optional[pulumi.Input[builtins.str]]):
