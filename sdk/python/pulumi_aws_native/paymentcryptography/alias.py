...
class AliasArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias_name: A friendly name that you can use to refer to a key. The value must begin with `alias/` .
        ...
        :param pulumi.Input[builtins.str] key_arn: The `KeyARN` of the key associated with the alias.
        """
