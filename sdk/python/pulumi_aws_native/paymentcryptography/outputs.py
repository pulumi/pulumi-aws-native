...
class KeyModesOfUse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool decrypt: Speciﬁes whether an AWS Payment Cryptography key can be used to decrypt data.
        :param builtins.bool derive_key: Speciﬁes whether an AWS Payment Cryptography key can be used to derive new keys.
        :param builtins.bool encrypt: Speciﬁes whether an AWS Payment Cryptography key can be used to encrypt data.
        :param builtins.bool generate: Speciﬁes whether an AWS Payment Cryptography key can be used to generate and verify other card and PIN verification keys.
        :param builtins.bool no_restrictions: Speciﬁes whether an AWS Payment Cryptography key has no special restrictions other than the restrictions implied by `KeyUsage` .
        :param builtins.bool sign: Speciﬁes whether an AWS Payment Cryptography key can be used for signing.
        :param builtins.bool verify: Speciﬁes whether an AWS Payment Cryptography key can be used to verify signatures.
        :param builtins.bool wrap: Speciﬁes whether an AWS Payment Cryptography key can be used to wrap other keys.
        """
