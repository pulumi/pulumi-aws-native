...
class KeyModesOfUseArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] decrypt: Speciﬁes whether an AWS Payment Cryptography key can be used to decrypt data.
        :param pulumi.Input[builtins.bool] derive_key: Speciﬁes whether an AWS Payment Cryptography key can be used to derive new keys.
        :param pulumi.Input[builtins.bool] encrypt: Speciﬁes whether an AWS Payment Cryptography key can be used to encrypt data.
        :param pulumi.Input[builtins.bool] generate: Speciﬁes whether an AWS Payment Cryptography key can be used to generate and verify other card and PIN verification keys.
        :param pulumi.Input[builtins.bool] no_restrictions: Speciﬁes whether an AWS Payment Cryptography key has no special restrictions other than the restrictions implied by `KeyUsage` .
        :param pulumi.Input[builtins.bool] sign: Speciﬁes whether an AWS Payment Cryptography key can be used for signing.
        :param pulumi.Input[builtins.bool] verify: Speciﬁes whether an AWS Payment Cryptography key can be used to verify signatures.
        :param pulumi.Input[builtins.bool] wrap: Speciﬁes whether an AWS Payment Cryptography key can be used to wrap other keys.
        """
