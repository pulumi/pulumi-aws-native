...
class KeyModesOfUseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] encrypt: Speciﬁes whether an AWS Payment Cryptography key can be used to encrypt data.
        :param pulumi.Input[_builtins.bool] generate: Speciﬁes whether an AWS Payment Cryptography key can be used to generate and verify other card and PIN verification keys.
        :param pulumi.Input[_builtins.bool] no_restrictions: Speciﬁes whether an AWS Payment Cryptography key has no special restrictions other than the restrictions implied by `KeyUsage` .
        :param pulumi.Input[_builtins.bool] sign: Speciﬁes whether an AWS Payment Cryptography key can be used for signing.
        :param pulumi.Input[_builtins.bool] verify: Speciﬁes whether an AWS Payment Cryptography key can be used to verify signatures.
        :param pulumi.Input[_builtins.bool] wrap: Speciﬁes whether an AWS Payment Cryptography key can be used to wrap other keys.
        """
