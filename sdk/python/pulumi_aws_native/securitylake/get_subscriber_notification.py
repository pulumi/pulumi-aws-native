...
class GetSubscriberNotificationResult:
    ...
    def subscriber_endpoint(self) -> Optional[builtins.str]:
        """
...
def get_subscriber_notification(subscriber_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str subscriber_arn: The ARN for the subscriber
    """
    __args__ = dict()
...
def get_subscriber_notification_output(subscriber_arn: Optional[pulumi.Input[builtins.str]] = None,
