...
def get_data_lake(arn: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataLakeResult:
    """
    Resource Type definition for AWS::SecurityLake::DataLake


    :param builtins.str arn: The Amazon Resource Name (ARN) created by you to provide to the subscriber.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_data_lake_output(arn: Optional[pulumi.Input[builtins.str]] = None,
