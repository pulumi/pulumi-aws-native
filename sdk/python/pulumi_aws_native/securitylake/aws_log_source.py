...
class AwsLogSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accounts: AWS account where you want to collect logs from.
...
@pulumi.type_token("aws-native:securitylake:AwsLogSource")
