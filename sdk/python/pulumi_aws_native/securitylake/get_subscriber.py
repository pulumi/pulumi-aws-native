...
class GetSubscriberResult:
    ...
    def resource_share_arn(self) -> Optional[builtins.str]:
        """
    ...
    def subscriber_arn(self) -> Optional[builtins.str]:
        """
    ...
    def subscriber_description(self) -> Optional[builtins.str]:
        """
    ...
    def subscriber_name(self) -> Optional[builtins.str]:
        """
    ...
    def subscriber_role_arn(self) -> Optional[builtins.str]:
        """
...
def get_subscriber(subscriber_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str subscriber_arn: The Amazon Resource Name (ARN) of the Security Lake subscriber.
    """
    __args__ = dict()
...
def get_subscriber_output(subscriber_arn: Optional[pulumi.Input[builtins.str]] = None,
