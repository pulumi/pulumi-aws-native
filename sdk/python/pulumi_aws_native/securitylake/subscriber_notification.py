...
class SubscriberNotificationArgs:
    ...
    def subscriber_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def subscriber_arn(self, value: pulumi.Input[_builtins.str]):
...
class SubscriberNotification(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 notification_configuration: pulumi.Input[Optional[Union['SubscriberNotificationNotificationConfigurationArgs', 'SubscriberNotificationNotificationConfigurationArgsDict', 'outputs.SubscriberNotificationNotificationConfiguration']]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="subscriberArn")
    def subscriber_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The ARN for the subscriber
        """
        return pulumi.get(self, "subscriber_arn")
