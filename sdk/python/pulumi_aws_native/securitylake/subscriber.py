...
class SubscriberArgs:
    ...
    def data_lake_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def data_lake_arn(self, value: pulumi.Input[_builtins.str]):
...
class Subscriber(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dataLakeArn")
    def data_lake_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The ARN for the data lake.
        """
        return pulumi.get(self, "data_lake_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="subscriberName")
    def subscriber_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of your Security Lake subscriber account.
        """
        return pulumi.get(self, "subscriber_name")
    ...
    def subscriber_role_arn(self) -> pulumi.Output[_builtins.str]:
        """
