...
class DataLakeLifecycleConfigurationArgsDict(TypedDict):
    ...
    """
    expiration: NotRequired[pulumi.Input[Optional['DataLakeExpirationArgs']]]
    """
    Provides data expiration details of the Amazon Security Lake object.
    """
    transitions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DataLakeTransitionsArgs']]]]]
    """
...
class SubscriberNotificationHttpsNotificationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authorization_api_key_value: The key value for the notification subscription.
...
class SubscriberNotificationNotificationConfigurationArgsDict(TypedDict):
    https_notification_configuration: NotRequired[pulumi.Input[Optional['SubscriberNotificationHttpsNotificationConfigurationArgs']]]
    """
    The configurations used for HTTPS subscriber notification.
    """
    sqs_notification_configuration: NotRequired[pulumi.Input[Optional['SubscriberNotificationSqsNotificationConfigurationArgs']]]
    """
...
class SubscriberSourceArgsDict(TypedDict):
    aws_log_source: NotRequired[pulumi.Input[Optional['SubscriberAwsLogSourceArgs']]]
    custom_log_source: NotRequired[pulumi.Input[Optional['SubscriberCustomLogSourceArgs']]]
