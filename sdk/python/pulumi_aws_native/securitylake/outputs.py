...
class DataLakeExpiration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides data expiration details of Amazon Security Lake object.
        :param builtins.int days: The number of days before data expires in the Amazon Security Lake object.
        """
        if days is not None:
...
class DataLakeReplicationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides replication details of Amazon Security Lake object.
        :param Sequence[builtins.str] regions: Specifies one or more centralized rollup Regions. The AWS Region specified in the region parameter of the `CreateDataLake` or `UpdateDataLake` operations contributes data to the rollup Region or Regions specified in this parameter.
...
class DataLakeTransitions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int days: Number of days before data transitions to a different S3 Storage Class in the Amazon Security Lake object.
...
class SubscriberIdentityProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The AWS identity used to access your data.
        :param builtins.str external_id: The external ID used to establish trust relationship with the AWS identity.
...
class SubscriberNotificationHttpsNotificationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str authorization_api_key_name: The key name for the notification subscription.
        :param builtins.str authorization_api_key_value: The key value for the notification subscription.
