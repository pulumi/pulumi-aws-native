...
class DataLakeTransitions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int days: Number of days before data transitions to a different S3 Storage Class in the Amazon Security Lake object.
...
class SubscriberNotificationHttpsNotificationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str authorization_api_key_value: The key value for the notification subscription.
