...
class DataLakeArgs:
    def __init__(__self__, *,
                 encryption_configuration: pulumi.Input[Optional['DataLakeEncryptionConfigurationArgs']] = None,
                 lifecycle_configuration: pulumi.Input[Optional['DataLakeLifecycleConfigurationArgs']] = None,
                 meta_store_manager_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_configuration: pulumi.Input[Optional['DataLakeReplicationConfigurationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] meta_store_manager_role_arn: The Amazon Resource Name (ARN) used to index AWS Glue table partitions that are generated by the ingestion and normalization of AWS log sources and custom sources.
    ...
    def encryption_configuration(self) -> pulumi.Input[Optional['DataLakeEncryptionConfigurationArgs']]:
        """
    ...
    def encryption_configuration(self, value: pulumi.Input[Optional['DataLakeEncryptionConfigurationArgs']]):
        pulumi.set(self, "encryption_configuration", value)

    @_builtins.property
    @pulumi.getter(name="lifecycleConfiguration")
    def lifecycle_configuration(self) -> pulumi.Input[Optional['DataLakeLifecycleConfigurationArgs']]:
        """
        You can customize Security Lake to store data in your preferred AWS Regions for your preferred amount of time. Lifecycle management can help you comply with different compliance requirements. For more details, see [Lifecycle management](https://docs.aws.amazon.com//security-lake/latest/userguide/lifecycle-management.html) in the Amazon Security Lake User Guide.
        """
    ...
    def lifecycle_configuration(self, value: pulumi.Input[Optional['DataLakeLifecycleConfigurationArgs']]):
    ...
    def replication_configuration(self) -> pulumi.Input[Optional['DataLakeReplicationConfigurationArgs']]:
        """
    ...
    def replication_configuration(self, value: pulumi.Input[Optional['DataLakeReplicationConfigurationArgs']]):
...
class DataLake(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 encryption_configuration: pulumi.Input[Optional[Union['DataLakeEncryptionConfigurationArgs', 'DataLakeEncryptionConfigurationArgsDict', 'outputs.DataLakeEncryptionConfiguration']]] = None,
                 lifecycle_configuration: pulumi.Input[Optional[Union['DataLakeLifecycleConfigurationArgs', 'DataLakeLifecycleConfigurationArgsDict', 'outputs.DataLakeLifecycleConfiguration']]] = None,
                 meta_store_manager_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_configuration: pulumi.Input[Optional[Union['DataLakeReplicationConfigurationArgs', 'DataLakeReplicationConfigurationArgsDict', 'outputs.DataLakeReplicationConfiguration']]] = None,
        ...
        :param pulumi.Input[Union['DataLakeEncryptionConfigurationArgs', 'DataLakeEncryptionConfigurationArgsDict', 'outputs.DataLakeEncryptionConfiguration']] encryption_configuration: Provides encryption details of the Amazon Security Lake object.
        :param pulumi.Input[Union['DataLakeLifecycleConfigurationArgs', 'DataLakeLifecycleConfigurationArgsDict', 'outputs.DataLakeLifecycleConfiguration']] lifecycle_configuration: You can customize Security Lake to store data in your preferred AWS Regions for your preferred amount of time. Lifecycle management can help you comply with different compliance requirements. For more details, see [Lifecycle management](https://docs.aws.amazon.com//security-lake/latest/userguide/lifecycle-management.html) in the Amazon Security Lake User Guide.
        :param pulumi.Input[_builtins.str] meta_store_manager_role_arn: The Amazon Resource Name (ARN) used to index AWS Glue table partitions that are generated by the ingestion and normalization of AWS log sources and custom sources.
        :param pulumi.Input[Union['DataLakeReplicationConfigurationArgs', 'DataLakeReplicationConfigurationArgsDict', 'outputs.DataLakeReplicationConfiguration']] replication_configuration: Provides replication details of Amazon Security Lake object.
    ...
    @_builtins.property
    @pulumi.getter(name="metaStoreManagerRoleArn")
    def meta_store_manager_role_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Amazon Resource Name (ARN) used to index AWS Glue table partitions that are generated by the ingestion and normalization of AWS log sources and custom sources.
        """
        return pulumi.get(self, "meta_store_manager_role_arn")
