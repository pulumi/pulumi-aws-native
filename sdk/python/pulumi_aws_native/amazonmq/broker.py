...
class BrokerArgs:
    def __init__(__self__, *,
                 deployment_mode: pulumi.Input[Union['BrokerDeploymentMode', builtins.str]],
                 engine_type: pulumi.Input[Union['BrokerEngineType', builtins.str]],
                 host_instance_type: pulumi.Input[builtins.str],
                 publicly_accessible: pulumi.Input[builtins.bool],
                 authentication_strategy: Optional[pulumi.Input[Union['BrokerAuthenticationStrategy', builtins.str]]] = None,
                 ...
                 data_replication_mode: Optional[pulumi.Input[Union['BrokerDataReplicationMode', builtins.str]]] = None,
                 ...
                 storage_type: Optional[pulumi.Input[Union['BrokerStorageType', builtins.str]]] = None,
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None,
                 users: Optional[pulumi.Input[Sequence[pulumi.Input['BrokerUserArgs']]]] = None):
        """
        The set of arguments for constructing a Broker resource.
        :param pulumi.Input[Union['BrokerDeploymentMode', builtins.str]] deployment_mode: The deployment mode of the broker. Available values:
               
               - `SINGLE_INSTANCE`
               - `ACTIVE_STANDBY_MULTI_AZ`
               - `CLUSTER_MULTI_AZ`
        :param pulumi.Input[Union['BrokerEngineType', builtins.str]] engine_type: The type of broker engine. Currently, Amazon MQ supports `ACTIVEMQ` and `RABBITMQ` .
        :param pulumi.Input[builtins.str] host_instance_type: The broker's instance type.
        :param pulumi.Input[builtins.bool] publicly_accessible: Enables connections from applications outside of the VPC that hosts the broker's subnets.
        :param pulumi.Input[Union['BrokerAuthenticationStrategy', builtins.str]] authentication_strategy: Optional. The authentication strategy used to secure the broker. The default is `SIMPLE` .
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Enables automatic upgrades to new minor versions for brokers, as new broker engine versions are released and supported by Amazon MQ. Automatic upgrades occur during the scheduled maintenance window of the broker or after a manual broker reboot.
        :param pulumi.Input[builtins.str] broker_name: The name of the broker. This value must be unique in your AWS account , 1-50 characters long, must contain only letters, numbers, dashes, and underscores, and must not contain white spaces, brackets, wildcard characters, or special characters.
        ...
        :param pulumi.Input[Union['BrokerDataReplicationMode', builtins.str]] data_replication_mode: Defines whether this broker is a part of a data replication pair.
        :param pulumi.Input[builtins.str] data_replication_primary_broker_arn: The ARN of the primary broker that is used to replicate data from in a data replication pair when creating a replica.
        ...
        :param pulumi.Input[builtins.str] engine_version: The version specified to use. See also EngineVersionCurrent.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: The list of rules (1 minimum, 125 maximum) that authorize connections to brokers.
        :param pulumi.Input[Union['BrokerStorageType', builtins.str]] storage_type: The broker's storage type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The list of groups that define which subnets and IP ranges the broker can use from different Availability Zones. If you specify more than one subnet, the subnets must be in different Availability Zones. Amazon MQ will not be able to create VPC endpoints for your broker with multiple subnets in the same Availability Zone. A SINGLE_INSTANCE deployment requires one subnet (for example, the default subnet). An ACTIVE_STANDBY_MULTI_AZ deployment (ACTIVEMQ) requires two subnets. A CLUSTER_MULTI_AZ deployment (RABBITMQ) has no subnet requirements when deployed with public accessibility, deployment without public accessibility requires at least one subnet.
    ...
    def deployment_mode(self) -> pulumi.Input[Union['BrokerDeploymentMode', builtins.str]]:
        """
    ...
    def deployment_mode(self, value: pulumi.Input[Union['BrokerDeploymentMode', builtins.str]]):
        pulumi.set(self, "deployment_mode", value)

    @property
    @pulumi.getter(name="engineType")
    def engine_type(self) -> pulumi.Input[Union['BrokerEngineType', builtins.str]]:
        """
    ...
    @engine_type.setter
    def engine_type(self, value: pulumi.Input[Union['BrokerEngineType', builtins.str]]):
    ...
    def publicly_accessible(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def publicly_accessible(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "publicly_accessible", value)

    @property
    @pulumi.getter(name="authenticationStrategy")
    def authentication_strategy(self) -> Optional[pulumi.Input[Union['BrokerAuthenticationStrategy', builtins.str]]]:
        """
    ...
    def authentication_strategy(self, value: Optional[pulumi.Input[Union['BrokerAuthenticationStrategy', builtins.str]]]):
    ...
    def data_replication_mode(self) -> Optional[pulumi.Input[Union['BrokerDataReplicationMode', builtins.str]]]:
        """
    ...
    def data_replication_mode(self, value: Optional[pulumi.Input[Union['BrokerDataReplicationMode', builtins.str]]]):
    ...
    def storage_type(self) -> Optional[pulumi.Input[Union['BrokerStorageType', builtins.str]]]:
        """
    ...
    @storage_type.setter
    def storage_type(self, value: Optional[pulumi.Input[Union['BrokerStorageType', builtins.str]]]):
...
class Broker(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_replication_mode: Optional[pulumi.Input[Union['BrokerDataReplicationMode', builtins.str]]] = None,
                 data_replication_primary_broker_arn: Optional[pulumi.Input[builtins.str]] = None,
                 deployment_mode: Optional[pulumi.Input[Union['BrokerDeploymentMode', builtins.str]]] = None,
                 encryption_options: Optional[pulumi.Input[Union['BrokerEncryptionOptionsArgs', 'BrokerEncryptionOptionsArgsDict']]] = None,
                 engine_type: Optional[pulumi.Input[Union['BrokerEngineType', builtins.str]]] = None,
                 engine_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def amqp_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def configuration_revision(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def console_urls(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "console_urls")

    @property
    @pulumi.getter(name="dataReplicationMode")
    def data_replication_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines whether this broker is a part of a data replication pair.
        """
        return pulumi.get(self, "data_replication_mode")
    ...
    def engine_version_current(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def mqtt_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def open_wire_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def stomp_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def wss_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
