...
class BrokerConfigurationIdArgs:
    def __init__(__self__, *,
                 ...
                 revision: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] id: The unique ID that Amazon MQ generates for the configuration.
        :param pulumi.Input[builtins.int] revision: The revision number of the configuration.
        """
...
if not MYPY:
    class BrokerEncryptionOptionsArgsDict(TypedDict):
        use_aws_owned_key: pulumi.Input[builtins.bool]
        """
...
class BrokerEncryptionOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] use_aws_owned_key: Enables the use of an AWS owned CMK using AWS KMS (KMS). Set to `true` by default, if no value is provided, for example, for RabbitMQ brokers.
        :param pulumi.Input[builtins.str] kms_key_id: The customer master key (CMK) to use for the A KMS (KMS). 
               This key is used to encrypt your data at rest. If not provided, Amazon MQ will use a default CMK to encrypt your data.
               The Key ARN is recommended so that drift can be detected,
               but a key ID or key alias will also be accepted for API compatibility reasons.
        """
    ...
    def use_aws_owned_key(self) -> pulumi.Input[builtins.bool]:
        """
        Enables the use of an AWS owned CMK using AWS KMS (KMS). Set to `true` by default, if no value is provided, for example, for RabbitMQ brokers.
        """
    ...
    def use_aws_owned_key(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class BrokerLdapServerMetadataArgsDict(TypedDict):
        ...
        """
        role_base: pulumi.Input[builtins.str]
        """
        The distinguished name of the node in the directory information tree (DIT) to search for roles or groups. For example, `ou=group` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        """
        role_search_matching: pulumi.Input[builtins.str]
        """
        ...
        """
        user_base: pulumi.Input[builtins.str]
        """
        Select a particular subtree of the directory information tree (DIT) to search for user entries. The subtree is specified by a DN, which specifies the base node of the subtree. For example, by setting this option to `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` , the search for user entries is restricted to the subtree beneath `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        """
        user_search_matching: pulumi.Input[builtins.str]
        """
...
class BrokerLdapServerMetadataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hosts: Specifies the location of the LDAP server such as AWS Directory Service for Microsoft Active Directory . Optional failover server.
        :param pulumi.Input[builtins.str] role_base: The distinguished name of the node in the directory information tree (DIT) to search for roles or groups. For example, `ou=group` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        :param pulumi.Input[builtins.str] role_search_matching: The LDAP search filter used to find roles within the roleBase. The distinguished name of the user matched by userSearchMatching is substituted into the `{0}` placeholder in the search filter. The client's username is substituted into the `{1}` placeholder. For example, if you set this option to `(member=uid={1})` for the user janedoe, the search filter becomes `(member=uid=janedoe)` after string substitution. It matches all role entries that have a member attribute equal to `uid=janedoe` under the subtree selected by the `RoleBases` .
        :param pulumi.Input[builtins.str] service_account_username: Service account username. A service account is an account in your LDAP server that has access to initiate a connection. For example, `cn=admin` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        :param pulumi.Input[builtins.str] user_base: Select a particular subtree of the directory information tree (DIT) to search for user entries. The subtree is specified by a DN, which specifies the base node of the subtree. For example, by setting this option to `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` , the search for user entries is restricted to the subtree beneath `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        :param pulumi.Input[builtins.str] user_search_matching: The LDAP search filter used to find users within the `userBase` . The client's username is substituted into the `{0}` placeholder in the search filter. For example, if this option is set to `(uid={0})` and the received username is `janedoe` , the search filter becomes `(uid=janedoe)` after string substitution. It will result in matching an entry like `uid=janedoe` , `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        :param pulumi.Input[builtins.str] role_name: The group name attribute in a role entry whose value is the name of that role. For example, you can specify `cn` for a group entry's common name. If authentication succeeds, then the user is assigned the the value of the `cn` attribute for each role entry that they are a member of.
        :param pulumi.Input[builtins.bool] role_search_subtree: The directory search scope for the role. If set to true, scope is to search the entire subtree.
        :param pulumi.Input[builtins.str] service_account_password: Service account password. A service account is an account in your LDAP server that has access to initiate a connection. For example, `cn=admin` , `dc=corp` , `dc=example` , `dc=com` .
        :param pulumi.Input[builtins.str] user_role_name: The name of the LDAP attribute in the user's directory entry for the user's group membership. In some cases, user roles may be identified by the value of an attribute in the user's directory entry. The `UserRoleName` option allows you to provide the name of this attribute.
        :param pulumi.Input[builtins.bool] user_search_subtree: The directory search scope for the user. If set to true, scope is to search the entire subtree.
        """
    ...
    def role_base(self) -> pulumi.Input[builtins.str]:
        """
        The distinguished name of the node in the directory information tree (DIT) to search for roles or groups. For example, `ou=group` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        """
    ...
    @role_base.setter
    def role_base(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "role_base", value)

    @property
    @pulumi.getter(name="roleSearchMatching")
    def role_search_matching(self) -> pulumi.Input[builtins.str]:
        """
        The LDAP search filter used to find roles within the roleBase. The distinguished name of the user matched by userSearchMatching is substituted into the `{0}` placeholder in the search filter. The client's username is substituted into the `{1}` placeholder. For example, if you set this option to `(member=uid={1})` for the user janedoe, the search filter becomes `(member=uid=janedoe)` after string substitution. It matches all role entries that have a member attribute equal to `uid=janedoe` under the subtree selected by the `RoleBases` .
        """
    ...
    def role_search_matching(self, value: pulumi.Input[builtins.str]):
    ...
    def user_base(self) -> pulumi.Input[builtins.str]:
        """
        Select a particular subtree of the directory information tree (DIT) to search for user entries. The subtree is specified by a DN, which specifies the base node of the subtree. For example, by setting this option to `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` , the search for user entries is restricted to the subtree beneath `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        """
    ...
    @user_base.setter
    def user_base(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "user_base", value)

    @property
    @pulumi.getter(name="userSearchMatching")
    def user_search_matching(self) -> pulumi.Input[builtins.str]:
        """
        The LDAP search filter used to find users within the `userBase` . The client's username is substituted into the `{0}` placeholder in the search filter. For example, if this option is set to `(uid={0})` and the received username is `janedoe` , the search filter becomes `(uid=janedoe)` after string substitution. It will result in matching an entry like `uid=janedoe` , `ou=Users` , `ou=corp` , `dc=corp` , `dc=example` , `dc=com` .
        """
    ...
    def user_search_matching(self, value: pulumi.Input[builtins.str]):
...
class BrokerLogListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] audit: Enables audit logging. Every user management action made using JMX or the ActiveMQ Web Console is logged. Does not apply to RabbitMQ brokers.
        :param pulumi.Input[builtins.bool] general: Enables general logging.
        """
...
if not MYPY:
    class BrokerMaintenanceWindowArgsDict(TypedDict):
        day_of_week: pulumi.Input[Union['BrokerMaintenanceWindowDayOfWeek', builtins.str]]
        """
...
class BrokerMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 time_zone: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Union['BrokerMaintenanceWindowDayOfWeek', builtins.str]] day_of_week: _Allowed Values_: <code>MONDAY</code> | <code>TUESDAY</code> | <code>WEDNESDAY</code> | <code>THURSDAY</code> | <code>FRIDAY</code> | <code>SATURDAY</code> | <code>SUNDAY</code>
        :param pulumi.Input[builtins.str] time_of_day: The time, in 24-hour format, and use only numbers separated by a colon, HH:MM or HH:MM:SS. Example: 13:05.
               When writing YAML this may need to be quoted to prevent a timestamp being read and converted to a number of minutes or seconds.
        :param pulumi.Input[builtins.str] time_zone: The time zone, UTC by default, in either the Country/City format, or the UTC offset format.
        """
    ...
    def day_of_week(self) -> pulumi.Input[Union['BrokerMaintenanceWindowDayOfWeek', builtins.str]]:
        """
        _Allowed Values_: <code>MONDAY</code> | <code>TUESDAY</code> | <code>WEDNESDAY</code> | <code>THURSDAY</code> | <code>FRIDAY</code> | <code>SATURDAY</code> | <code>SUNDAY</code>
        """
    ...
    @day_of_week.setter
    def day_of_week(self, value: pulumi.Input[Union['BrokerMaintenanceWindowDayOfWeek', builtins.str]]):
...
class BrokerUserArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] password: The password of the user. This value must be at least 12 characters long, must contain at least 4 unique characters, and must not contain commas, colons, or equal signs (,:=).
        :param pulumi.Input[builtins.str] username: The username of the broker user. For Amazon MQ for ActiveMQ brokers, this value can contain only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). For Amazon MQ for RabbitMQ brokers, this value can contain only alphanumeric characters, dashes, periods, underscores (- . _). This value must not contain a tilde (~) character. Amazon MQ prohibts using guest as a valid usename. This value must be 2-100 characters long.
               
               > Do not add personally identifiable information (PII) or other confidential or sensitive information in broker usernames. Broker usernames are accessible to other AWS services, including CloudWatch Logs . Broker usernames are not intended to be used for private or sensitive data.
        :param pulumi.Input[builtins.bool] console_access: Enables access to the ActiveMQ web console for the ActiveMQ user. Does not apply to RabbitMQ brokers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: The list of groups (20 maximum) to which the ActiveMQ user belongs. This value can contain only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value must be 2-100 characters long. Does not apply to RabbitMQ brokers.
        :param pulumi.Input[builtins.bool] replication_user: Defines if this user is intended for CRDR replication purposes.
        """
