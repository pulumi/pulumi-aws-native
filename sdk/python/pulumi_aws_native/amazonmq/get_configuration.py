...
def get_configuration(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the Amazon MQ configuration.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_configuration_output(id: Optional[pulumi.Input[builtins.str]] = None,
