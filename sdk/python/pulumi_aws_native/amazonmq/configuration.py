...
class ConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] engine_type: The type of broker engine. Note: Currently, Amazon MQ only supports ACTIVEMQ for creating and editing broker configurations.
        :param pulumi.Input[builtins.str] authentication_strategy: The authentication strategy associated with the configuration. The default is SIMPLE.
        :param pulumi.Input[builtins.str] data: The base64-encoded XML configuration.
        :param pulumi.Input[builtins.str] description: The description of the configuration.
        :param pulumi.Input[builtins.str] engine_version: The version of the broker engine.
...
class Configuration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authenticationStrategy")
    def authentication_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The authentication strategy associated with the configuration. The default is SIMPLE.
        """
        return pulumi.get(self, "authentication_strategy")
