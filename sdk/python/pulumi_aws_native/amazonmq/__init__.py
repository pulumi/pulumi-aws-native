...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "aws-native:AmazonMQ:Broker":
                return Broker(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:AmazonMQ:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:AmazonMQ:ConfigurationAssociation":
    ...
    pulumi.runtime.register_resource_module("aws-native", "AmazonMQ", _module_instance)
