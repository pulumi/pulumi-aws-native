...
class GetBrokerResult:
    ...
    def amqp_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def configuration_revision(self) -> Optional[builtins.str]:
        """
    ...
    def console_urls(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "console_urls")

    @property
    @pulumi.getter(name="dataReplicationMode")
    def data_replication_mode(self) -> Optional[builtins.str]:
        """
    ...
    def engine_version_current(self) -> Optional[builtins.str]:
        """
    ...
    def mqtt_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def open_wire_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def stomp_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def wss_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_broker(id: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBrokerResult:
    """
    Resource type definition for AWS::AmazonMQ::Broker


    :param builtins.str id: Required. The unique ID that Amazon MQ generates for the configuration.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_broker_output(id: Optional[pulumi.Input[builtins.str]] = None,
