...
if not MYPY:
    class CertificateAuthorityAccessMethodArgsDict(TypedDict):
        ...
        """
        access_method_type: NotRequired[pulumi.Input[builtins.str]]
        custom_object_identifier: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class CertificateAuthorityAccessMethodArgs:
    def __init__(__self__, *,
                 access_method_type: Optional[pulumi.Input[builtins.str]] = None,
                 custom_object_identifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        Structure that contains X.509 AccessMethod information. Assign one and ONLY one field.
        """
    ...
    def access_method_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "access_method_type")

    @access_method_type.setter
    def access_method_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_method_type", value)

    @property
    @pulumi.getter(name="customObjectIdentifier")
    def custom_object_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_object_identifier")

    @custom_object_identifier.setter
    def custom_object_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityCrlConfigurationArgsDict(TypedDict):
        ...
        """
        crl_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateAuthorityCrlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 crl_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] crl_type: Specifies the type of CRL. This setting determines the maximum number of certificates that the certificate authority can issue and revoke. For more information, see [AWS Private CA quotas](https://docs.aws.amazon.com/general/latest/gr/pca.html#limits_pca) .
               
               - `COMPLETE` - The default setting. AWS Private CA maintains a single CRL file for all unexpired certificates issued by a CA that have been revoked for any reason. Each certificate that AWS Private CA issues is bound to a specific CRL through the CRL distribution point (CDP) defined in [RFC 5280](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280) .
               - `PARTITIONED` - Compared to complete CRLs, partitioned CRLs dramatically increase the number of certificates your private CA can issue.
               
               > When using partitioned CRLs, you must validate that the CRL's associated issuing distribution point (IDP) URI matches the certiﬁcate's CDP URI to ensure the right CRL has been fetched. AWS Private CA marks the IDP extension as critical, which your client must be able to process.
        :param pulumi.Input[builtins.str] custom_cname: Name inserted into the certificate *CRL Distribution Points* extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public.
               
               > The content of a Canonical Name (CNAME) record must conform to [RFC2396](https://docs.aws.amazon.com/https://www.ietf.org/rfc/rfc2396.txt) restrictions on the use of special characters in URIs. Additionally, the value of the CNAME must not include a protocol prefix such as "http://" or "https://".
        :param pulumi.Input[builtins.str] custom_path: Designates a custom file path in S3 for CRL(s). For example, `http://<CustomName>/<CustomPath>/<CrlPartition_GUID>.crl` .
        :param pulumi.Input[builtins.int] expiration_in_days: Validity period of the CRL in days.
        :param pulumi.Input[builtins.str] s3_bucket_name: Name of the S3 bucket that contains the CRL. If you do not provide a value for the *CustomCname* argument, the name of your S3 bucket is placed into the *CRL Distribution Points* extension of the issued certificate. You can change the name of your bucket by calling the [UpdateCertificateAuthority](https://docs.aws.amazon.com/privateca/latest/APIReference/API_UpdateCertificateAuthority.html) operation. You must specify a [bucket policy](https://docs.aws.amazon.com/privateca/latest/userguide/PcaCreateCa.html#s3-policies) that allows AWS Private CA to write the CRL to your bucket.
               
               > The `S3BucketName` parameter must conform to the [S3 bucket naming rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html) .
        :param pulumi.Input[builtins.str] s3_object_acl: Determines whether the CRL will be publicly readable or privately held in the CRL Amazon S3 bucket. If you choose PUBLIC_READ, the CRL will be accessible over the public internet. If you choose BUCKET_OWNER_FULL_CONTROL, only the owner of the CRL S3 bucket can access the CRL, and your PKI clients may need an alternative method of access.
    ...
    def crl_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of CRL. This setting determines the maximum number of certificates that the certificate authority can issue and revoke. For more information, see [AWS Private CA quotas](https://docs.aws.amazon.com/general/latest/gr/pca.html#limits_pca) .
    ...
    @crl_type.setter
    def crl_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityCrlDistributionPointExtensionConfigurationArgsDict(TypedDict):
        ...
        """
        omit_extension: pulumi.Input[builtins.bool]
        """
...
class CertificateAuthorityCrlDistributionPointExtensionConfigurationArgs:
    ...
    def omit_extension(self) -> pulumi.Input[builtins.bool]:
        """
        Configures whether the CRL Distribution Point extension should be populated with the default URL to the CRL. If set to `true` , then the CDP extension will not be present in any certificates issued by that CA unless otherwise specified through CSR or API passthrough.
    ...
    def omit_extension(self, value: pulumi.Input[builtins.bool]):
...
class CertificateAuthorityCustomAttributeArgs:
    ...
    def object_identifier(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "object_identifier")

    @object_identifier.setter
    def object_identifier(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CertificateAuthorityEdiPartyNameArgsDict(TypedDict):
        ...
        """
        party_name: pulumi.Input[builtins.str]
        name_assigner: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class CertificateAuthorityEdiPartyNameArgs:
    def __init__(__self__, *,
                 party_name: pulumi.Input[builtins.str],
                 name_assigner: Optional[pulumi.Input[builtins.str]] = None):
        """
        Structure that contains X.509 EdiPartyName information.
        """
    ...
    def party_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "party_name")

    @party_name.setter
    def party_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "party_name", value)

    @property
    @pulumi.getter(name="nameAssigner")
    def name_assigner(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "name_assigner")

    @name_assigner.setter
    def name_assigner(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityGeneralNameArgsDict(TypedDict):
        ...
        registered_id: NotRequired[pulumi.Input[builtins.str]]
        rfc822_name: NotRequired[pulumi.Input[builtins.str]]
        uniform_resource_identifier: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class CertificateAuthorityGeneralNameArgs:
    def __init__(__self__, *,
                 ...
                 registered_id: Optional[pulumi.Input[builtins.str]] = None,
                 rfc822_name: Optional[pulumi.Input[builtins.str]] = None,
                 uniform_resource_identifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        Structure that contains X.509 GeneralName information. Assign one and ONLY one field.
        """
    ...
    def registered_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "registered_id")

    @registered_id.setter
    def registered_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "registered_id", value)

    @property
    @pulumi.getter(name="rfc822Name")
    def rfc822_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "rfc822_name")

    @rfc822_name.setter
    def rfc822_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rfc822_name", value)

    @property
    @pulumi.getter(name="uniformResourceIdentifier")
    def uniform_resource_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "uniform_resource_identifier")

    @uniform_resource_identifier.setter
    def uniform_resource_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityKeyUsageArgsDict(TypedDict):
        ...
        """
        crl_sign: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used to sign CRLs.
        """
        data_encipherment: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used to decipher data.
        """
        decipher_only: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used only to decipher data.
        """
        digital_signature: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used for digital signing.
        """
        encipher_only: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used only to encipher data.
        """
        key_agreement: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used in a key-agreement protocol.
        """
        key_cert_sign: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used to sign certificates.
        """
        key_encipherment: NotRequired[pulumi.Input[builtins.bool]]
        """
        Key can be used to encipher data.
        """
        non_repudiation: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CertificateAuthorityKeyUsageArgs:
    def __init__(__self__, *,
                 crl_sign: Optional[pulumi.Input[builtins.bool]] = None,
                 data_encipherment: Optional[pulumi.Input[builtins.bool]] = None,
                 decipher_only: Optional[pulumi.Input[builtins.bool]] = None,
                 digital_signature: Optional[pulumi.Input[builtins.bool]] = None,
                 encipher_only: Optional[pulumi.Input[builtins.bool]] = None,
                 key_agreement: Optional[pulumi.Input[builtins.bool]] = None,
                 key_cert_sign: Optional[pulumi.Input[builtins.bool]] = None,
                 key_encipherment: Optional[pulumi.Input[builtins.bool]] = None,
                 non_repudiation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Structure that contains X.509 KeyUsage information.
        :param pulumi.Input[builtins.bool] crl_sign: Key can be used to sign CRLs.
        :param pulumi.Input[builtins.bool] data_encipherment: Key can be used to decipher data.
        :param pulumi.Input[builtins.bool] decipher_only: Key can be used only to decipher data.
        :param pulumi.Input[builtins.bool] digital_signature: Key can be used for digital signing.
        :param pulumi.Input[builtins.bool] encipher_only: Key can be used only to encipher data.
        :param pulumi.Input[builtins.bool] key_agreement: Key can be used in a key-agreement protocol.
        :param pulumi.Input[builtins.bool] key_cert_sign: Key can be used to sign certificates.
        :param pulumi.Input[builtins.bool] key_encipherment: Key can be used to encipher data.
        :param pulumi.Input[builtins.bool] non_repudiation: Key can be used for non-repudiation.
        """
    ...
    def crl_sign(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used to sign CRLs.
        """
    ...
    @crl_sign.setter
    def crl_sign(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "crl_sign", value)

    @property
    @pulumi.getter(name="dataEncipherment")
    def data_encipherment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used to decipher data.
        """
    ...
    def data_encipherment(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "data_encipherment", value)

    @property
    @pulumi.getter(name="decipherOnly")
    def decipher_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used only to decipher data.
        """
    ...
    def decipher_only(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "decipher_only", value)

    @property
    @pulumi.getter(name="digitalSignature")
    def digital_signature(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used for digital signing.
        """
    ...
    def digital_signature(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "digital_signature", value)

    @property
    @pulumi.getter(name="encipherOnly")
    def encipher_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used only to encipher data.
        """
    ...
    def encipher_only(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "encipher_only", value)

    @property
    @pulumi.getter(name="keyAgreement")
    def key_agreement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used in a key-agreement protocol.
        """
    ...
    def key_agreement(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "key_agreement", value)

    @property
    @pulumi.getter(name="keyCertSign")
    def key_cert_sign(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used to sign certificates.
        """
    ...
    def key_cert_sign(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "key_cert_sign", value)

    @property
    @pulumi.getter(name="keyEncipherment")
    def key_encipherment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used to encipher data.
        """
    ...
    def key_encipherment(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "key_encipherment", value)

    @property
    @pulumi.getter(name="nonRepudiation")
    def non_repudiation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Key can be used for non-repudiation.
        """
    ...
    def non_repudiation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CertificateAuthorityOcspConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Helps to configure online certificate status protocol (OCSP) responder for your certificate authority
        :param pulumi.Input[builtins.bool] enabled: Flag enabling use of the Online Certificate Status Protocol (OCSP) for validating certificate revocation status.
        :param pulumi.Input[builtins.str] ocsp_custom_cname: By default, AWS Private CA injects an Amazon domain into certificates being validated by the Online Certificate Status Protocol (OCSP). A customer can alternatively use this object to define a CNAME specifying a customized OCSP domain.
...
class CertificateCustomAttributeArgs:
    def __init__(__self__, *,
        ...
        """
        Defines the X.500 relative distinguished name (RDN).
        :param pulumi.Input[builtins.str] object_identifier: Specifies the object identifier (OID) of the attribute type of the relative distinguished name (RDN).
        :param pulumi.Input[builtins.str] value: Specifies the attribute value of relative distinguished name (RDN).
        """
        pulumi.set(__self__, "object_identifier", object_identifier)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class CertificateEdiPartyNameArgsDict(TypedDict):
        ...
        """
        name_assigner: pulumi.Input[builtins.str]
        """
...
class CertificateEdiPartyNameArgs:
    def __init__(__self__, *,
        ...
        """
        Describes an Electronic Data Interchange (EDI) entity as described in as defined in [Subject Alternative Name](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280) in RFC 5280.
        :param pulumi.Input[builtins.str] name_assigner: Specifies the name assigner.
        :param pulumi.Input[builtins.str] party_name: Specifies the party name.
        """
        pulumi.set(__self__, "name_assigner", name_assigner)
        pulumi.set(__self__, "party_name", party_name)
    ...
    @property
    @pulumi.getter(name="nameAssigner")
    def name_assigner(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the name assigner.
        """
        return pulumi.get(self, "name_assigner")
    ...
    @name_assigner.setter
    def name_assigner(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "name_assigner", value)
...
if not MYPY:
    class CertificateExtendedKeyUsageArgsDict(TypedDict):
        ...
        """
        extended_key_usage_object_identifier: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies a custom ``ExtendedKeyUsage`` with an object identifier (OID).
        """
        extended_key_usage_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateExtendedKeyUsageArgs:
    def __init__(__self__, *,
                 extended_key_usage_object_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 extended_key_usage_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Specifies additional purposes for which the certified public key may be used other than basic purposes indicated in the ``KeyUsage`` extension.
        :param pulumi.Input[builtins.str] extended_key_usage_object_identifier: Specifies a custom ``ExtendedKeyUsage`` with an object identifier (OID).
        :param pulumi.Input[builtins.str] extended_key_usage_type: Specifies a standard ``ExtendedKeyUsage`` as defined as in [RFC 5280](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.12).
        """
    ...
    def extended_key_usage_object_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies a custom ``ExtendedKeyUsage`` with an object identifier (OID).
        """
    ...
    def extended_key_usage_object_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "extended_key_usage_object_identifier", value)

    @property
    @pulumi.getter(name="extendedKeyUsageType")
    def extended_key_usage_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies a standard ``ExtendedKeyUsage`` as defined as in [RFC 5280](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.12).
        """
    ...
    def extended_key_usage_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateGeneralNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dns_name: Represents ``GeneralName`` as a DNS name.
        :param pulumi.Input['CertificateEdiPartyNameArgs'] edi_party_name: Represents ``GeneralName`` as an ``EdiPartyName`` object.
        :param pulumi.Input[builtins.str] ip_address: Represents ``GeneralName`` as an IPv4 or IPv6 address.
        :param pulumi.Input['CertificateOtherNameArgs'] other_name: Represents ``GeneralName`` using an ``OtherName`` object.
        :param pulumi.Input[builtins.str] registered_id: Represents ``GeneralName`` as an object identifier (OID).
        :param pulumi.Input[builtins.str] rfc822_name: Represents ``GeneralName`` as an [RFC 822](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc822) email address.
        :param pulumi.Input[builtins.str] uniform_resource_identifier: Represents ``GeneralName`` as a URI.
        """
        if directory_name is not None:
            pulumi.set(__self__, "directory_name", directory_name)
        if dns_name is not None:
...
class CertificateOtherNameArgs:
    def __init__(__self__, *,
        ...
        """
        Defines a custom ASN.1 X.400 ``GeneralName`` using an object identifier (OID) and value. The OID must satisfy the regular expression shown below. For more information, see NIST's definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
        :param pulumi.Input[builtins.str] type_id: Specifies an OID.
        :param pulumi.Input[builtins.str] value: Specifies an OID value.
        """
        pulumi.set(__self__, "type_id", type_id)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class CertificatePolicyInformationArgsDict(TypedDict):
        ...
        """
        cert_policy_id: pulumi.Input[builtins.str]
        """
...
class CertificatePolicyInformationArgs:
    def __init__(__self__, *,
        ...
        """
        Defines the X.509 ``CertificatePolicies`` extension.
        :param pulumi.Input[builtins.str] cert_policy_id: Specifies the object identifier (OID) of the certificate policy under which the certificate was issued. For more information, see NIST's definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
    ...
    def cert_policy_id(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the object identifier (OID) of the certificate policy under which the certificate was issued. For more information, see NIST's definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
        """
    ...
    def cert_policy_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CertificatePolicyQualifierInfoArgsDict(TypedDict):
        ...
        """
        policy_qualifier_id: pulumi.Input[builtins.str]
        """
...
class CertificatePolicyQualifierInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Modifies the ``CertPolicyId`` of a ``PolicyInformation`` object with a qualifier. AWS Private CA supports the certification practice statement (CPS) qualifier.
        :param pulumi.Input[builtins.str] policy_qualifier_id: Identifies the qualifier modifying a ``CertPolicyId``.
    ...
    def policy_qualifier_id(self) -> pulumi.Input[builtins.str]:
        """
        Identifies the qualifier modifying a ``CertPolicyId``.
        """
    ...
    def policy_qualifier_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CertificateQualifierArgsDict(TypedDict):
        ...
        """
        cps_uri: pulumi.Input[builtins.str]
        """
...
class CertificateQualifierArgs:
    def __init__(__self__, *,
        ...
        """
        Defines a ``PolicyInformation`` qualifier. AWS Private CA supports the [certification practice statement (CPS) qualifier](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.4) defined in RFC 5280.
        :param pulumi.Input[builtins.str] cps_uri: Contains a pointer to a certification practice statement (CPS) published by the CA.
        """
        pulumi.set(__self__, "cps_uri", cps_uri)

    @property
    @pulumi.getter(name="cpsUri")
    def cps_uri(self) -> pulumi.Input[builtins.str]:
        """
        Contains a pointer to a certification practice statement (CPS) published by the CA.
        """
    ...
    @cps_uri.setter
    def cps_uri(self, value: pulumi.Input[builtins.str]):
...
class CertificateSubjectArgs:
    def __init__(__self__, *,
        ...
        """
        Contains information about the certificate subject. The ``Subject`` field in the certificate identifies the entity that owns or controls the public key in the certificate. The entity can be a user, computer, device, or service. The ``Subject``must contain an X.500 distinguished name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by commas in the certificate.
        :param pulumi.Input[builtins.str] common_name: For CA and end-entity certificates in a private PKI, the common name (CN) can be any string within the length limit.
                Note: In publicly trusted certificates, the common name must be a fully qualified domain name (FQDN) associated with the certificate subject.
        :param pulumi.Input[builtins.str] country: Two-digit code that specifies the country in which the certificate subject located.
        :param pulumi.Input[Sequence[pulumi.Input['CertificateCustomAttributeArgs']]] custom_attributes: Contains a sequence of one or more X.500 relative distinguished names (RDNs), each of which consists of an object identifier (OID) and a value. For more information, see NIST’s definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
                 Custom attributes cannot be used in combination with standard attributes.
        :param pulumi.Input[builtins.str] distinguished_name_qualifier: Disambiguating information for the certificate subject.
        :param pulumi.Input[builtins.str] generation_qualifier: Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third.
        :param pulumi.Input[builtins.str] given_name: First name.
        :param pulumi.Input[builtins.str] initials: Concatenation that typically contains the first letter of the *GivenName*, the first letter of the middle name if one exists, and the first letter of the *Surname*.
        :param pulumi.Input[builtins.str] locality: The locality (such as a city or town) in which the certificate subject is located.
        :param pulumi.Input[builtins.str] organization: Legal name of the organization with which the certificate subject is affiliated.
        :param pulumi.Input[builtins.str] organizational_unit: A subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated.
        :param pulumi.Input[builtins.str] pseudonym: Typically a shortened version of a longer *GivenName*. For example, Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza.
        :param pulumi.Input[builtins.str] serial_number: The certificate serial number.
        :param pulumi.Input[builtins.str] state: State in which the subject of the certificate is located.
        :param pulumi.Input[builtins.str] surname: Family name. In the US and the UK, for example, the surname of an individual is ordered last. In Asian cultures the surname is typically ordered first.
        :param pulumi.Input[builtins.str] title: A title such as Mr. or Ms., which is pre-pended to the name to refer formally to the certificate subject.
        """
        if common_name is not None:
            pulumi.set(__self__, "common_name", common_name)
        if country is not None:
...
class CertificateValidityArgs:
    def __init__(__self__, *,
        ...
        """
        Length of time for which the certificate issued by your private certificate authority (CA), or by the private CA itself, is valid in days, months, or years. You can issue a certificate by calling the ``IssueCertificate`` operation.
        :param pulumi.Input[builtins.str] type: Specifies whether the ``Value`` parameter represents days, months, or years.
        :param pulumi.Input[builtins.float] value: A long integer interpreted according to the value of ``Type``, below.
        """
