...
class CertificateAuthorityCrlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_partition_size_mb: Optional[pulumi.Input[int]] = None,
        ...
        if max_partition_size_mb is not None:
            pulumi.set(__self__, "max_partition_size_mb", max_partition_size_mb)
    ...
    @property
    @pulumi.getter(name="maxPartitionSizeMb")
    def max_partition_size_mb(self) -> Optional[pulumi.Input[int]]:
        return pulumi.get(self, "max_partition_size_mb")

    @max_partition_size_mb.setter
    def max_partition_size_mb(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "max_partition_size_mb", value)
