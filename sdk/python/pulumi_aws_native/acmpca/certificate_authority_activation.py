...
class CertificateAuthorityActivationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: Certificate Authority certificate that will be installed in the Certificate Authority.
        :param pulumi.Input[builtins.str] certificate_authority_arn: Arn of the Certificate Authority.
        :param pulumi.Input[builtins.str] certificate_chain: Certificate chain for the Certificate Authority certificate.
        :param pulumi.Input[builtins.str] status: The status of the Certificate Authority.
        """
...
class CertificateAuthorityActivation(pulumi.CustomResource):
    ...
    def complete_certificate_chain(self) -> pulumi.Output[builtins.str]:
        """
