...
class CertificateAuthority(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(csr_extensions, CertificateAuthorityCsrExtensionsArgs):
            ...
            if not isinstance(revocation_configuration, CertificateAuthorityRevocationConfigurationArgs):
            ...
            if not isinstance(subject, CertificateAuthoritySubjectArgs):
                subject = subject or {}
                def _setter(key, value):
                    subject[key] = value
