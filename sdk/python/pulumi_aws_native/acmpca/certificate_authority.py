...
class CertificateAuthorityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_algorithm: Public key algorithm and size, in bits, of the key pair that your CA creates when it issues a certificate.
        :param pulumi.Input[builtins.str] signing_algorithm: Algorithm your CA uses to sign certificate requests.
        ...
        :param pulumi.Input[builtins.str] type: The type of the certificate authority.
        ...
        :param pulumi.Input[builtins.str] key_storage_security_standard: KeyStorageSecurityStadard defines a cryptographic key management compliance standard used for handling CA keys.
        ...
        :param pulumi.Input[builtins.str] usage_mode: Usage mode of the ceritificate authority.
        """
...
class CertificateAuthority(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="keyStorageSecurityStandard")
    def key_storage_security_standard(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        KeyStorageSecurityStadard defines a cryptographic key management compliance standard used for handling CA keys.
        """
        return pulumi.get(self, "key_storage_security_standard")
    ...
    @property
    @pulumi.getter(name="usageMode")
    def usage_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Usage mode of the ceritificate authority.
        """
        return pulumi.get(self, "usage_mode")
