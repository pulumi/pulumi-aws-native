...
def get_certificate(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the issued certificate.
    :param builtins.str certificate_authority_arn: The Amazon Resource Name (ARN) for the private CA issues the certificate.
    """
    __args__ = dict()
    __args__['arn'] = arn
