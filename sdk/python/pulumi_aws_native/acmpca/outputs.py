...
class CertificateAuthorityAccessMethod(dict):
    ...
    def __init__(__self__, *,
                 access_method_type: Optional[builtins.str] = None,
                 custom_object_identifier: Optional[builtins.str] = None):
        """
        Structure that contains X.509 AccessMethod information. Assign one and ONLY one field.
        """
    ...
    def access_method_type(self) -> Optional[builtins.str]:
        return pulumi.get(self, "access_method_type")

    @property
    @pulumi.getter(name="customObjectIdentifier")
    def custom_object_identifier(self) -> Optional[builtins.str]:
...
class CertificateAuthorityCrlConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crl_type: Optional[builtins.str] = None,
        ...
        :param builtins.str crl_type: Specifies the type of CRL. This setting determines the maximum number of certificates that the certificate authority can issue and revoke. For more information, see [AWS Private CA quotas](https://docs.aws.amazon.com/general/latest/gr/pca.html#limits_pca) .
        ...
        :param builtins.str custom_cname: Name inserted into the certificate *CRL Distribution Points* extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public.
        ...
        :param builtins.str custom_path: Designates a custom file path in S3 for CRL(s). For example, `http://<CustomName>/<CustomPath>/<CrlPartition_GUID>.crl` .
        :param builtins.int expiration_in_days: Validity period of the CRL in days.
        :param builtins.str s3_bucket_name: Name of the S3 bucket that contains the CRL. If you do not provide a value for the *CustomCname* argument, the name of your S3 bucket is placed into the *CRL Distribution Points* extension of the issued certificate. You can change the name of your bucket by calling the [UpdateCertificateAuthority](https://docs.aws.amazon.com/privateca/latest/APIReference/API_UpdateCertificateAuthority.html) operation. You must specify a [bucket policy](https://docs.aws.amazon.com/privateca/latest/userguide/PcaCreateCa.html#s3-policies) that allows AWS Private CA to write the CRL to your bucket.
    ...
    def crl_type(self) -> Optional[builtins.str]:
        """
...
class CertificateAuthorityCrlDistributionPointExtensionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 omit_extension: builtins.bool):
        """
        Configures the default behavior of the CRL Distribution Point extension for certificates issued by your certificate authority
        :param builtins.bool omit_extension: Configures whether the CRL Distribution Point extension should be populated with the default URL to the CRL. If set to `true` , then the CDP extension will not be present in any certificates issued by that CA unless otherwise specified through CSR or API passthrough.
    ...
    def omit_extension(self) -> builtins.bool:
        """
...
class CertificateAuthorityEdiPartyName(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name_assigner: Optional[builtins.str] = None):
        """
        Structure that contains X.509 EdiPartyName information.
        """
    ...
    def name_assigner(self) -> Optional[builtins.str]:
...
class CertificateAuthorityGeneralName(dict):
    ...
    def __init__(__self__, *,
                 ...
                 registered_id: Optional[builtins.str] = None,
                 rfc822_name: Optional[builtins.str] = None,
                 uniform_resource_identifier: Optional[builtins.str] = None):
        """
        Structure that contains X.509 GeneralName information. Assign one and ONLY one field.
        """
    ...
    def registered_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "registered_id")

    @property
    @pulumi.getter(name="rfc822Name")
    def rfc822_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "rfc822_name")

    @property
    @pulumi.getter(name="uniformResourceIdentifier")
    def uniform_resource_identifier(self) -> Optional[builtins.str]:
...
class CertificateAuthorityKeyUsage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_cert_sign: Optional[builtins.bool] = None,
                 key_encipherment: Optional[builtins.bool] = None,
                 non_repudiation: Optional[builtins.bool] = None):
        """
        Structure that contains X.509 KeyUsage information.
        :param builtins.bool crl_sign: Key can be used to sign CRLs.
        :param builtins.bool data_encipherment: Key can be used to decipher data.
        :param builtins.bool decipher_only: Key can be used only to decipher data.
        :param builtins.bool digital_signature: Key can be used for digital signing.
        :param builtins.bool encipher_only: Key can be used only to encipher data.
        :param builtins.bool key_agreement: Key can be used in a key-agreement protocol.
        :param builtins.bool key_cert_sign: Key can be used to sign certificates.
        :param builtins.bool key_encipherment: Key can be used to encipher data.
        :param builtins.bool non_repudiation: Key can be used for non-repudiation.
        """
    ...
    def key_cert_sign(self) -> Optional[builtins.bool]:
        """
    ...
    def non_repudiation(self) -> Optional[builtins.bool]:
        """
...
class CertificateAuthorityOcspConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Helps to configure online certificate status protocol (OCSP) responder for your certificate authority
        :param builtins.bool enabled: Flag enabling use of the Online Certificate Status Protocol (OCSP) for validating certificate revocation status.
        :param builtins.str ocsp_custom_cname: By default, AWS Private CA injects an Amazon domain into certificates being validated by the Online Certificate Status Protocol (OCSP). A customer can alternatively use this object to define a CNAME specifying a customized OCSP domain.
...
class CertificateCustomAttribute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the X.500 relative distinguished name (RDN).
        :param builtins.str object_identifier: Specifies the object identifier (OID) of the attribute type of the relative distinguished name (RDN).
        :param builtins.str value: Specifies the attribute value of relative distinguished name (RDN).
        """
        pulumi.set(__self__, "object_identifier", object_identifier)
        pulumi.set(__self__, "value", value)
...
class CertificateEdiPartyName(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes an Electronic Data Interchange (EDI) entity as described in as defined in [Subject Alternative Name](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280) in RFC 5280.
        :param builtins.str name_assigner: Specifies the name assigner.
        :param builtins.str party_name: Specifies the party name.
        """
        pulumi.set(__self__, "name_assigner", name_assigner)
        pulumi.set(__self__, "party_name", party_name)
...
class CertificateExtendedKeyUsage(dict):
    ...
    def __init__(__self__, *,
                 extended_key_usage_object_identifier: Optional[builtins.str] = None,
                 extended_key_usage_type: Optional[builtins.str] = None):
        """
        Specifies additional purposes for which the certified public key may be used other than basic purposes indicated in the ``KeyUsage`` extension.
        :param builtins.str extended_key_usage_object_identifier: Specifies a custom ``ExtendedKeyUsage`` with an object identifier (OID).
        :param builtins.str extended_key_usage_type: Specifies a standard ``ExtendedKeyUsage`` as defined as in [RFC 5280](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.12).
        """
    ...
    def extended_key_usage_object_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def extended_key_usage_type(self) -> Optional[builtins.str]:
        """
...
class CertificateGeneralName(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str dns_name: Represents ``GeneralName`` as a DNS name.
        :param 'CertificateEdiPartyName' edi_party_name: Represents ``GeneralName`` as an ``EdiPartyName`` object.
        :param builtins.str ip_address: Represents ``GeneralName`` as an IPv4 or IPv6 address.
        :param 'CertificateOtherName' other_name: Represents ``GeneralName`` using an ``OtherName`` object.
        :param builtins.str registered_id: Represents ``GeneralName`` as an object identifier (OID).
        :param builtins.str rfc822_name: Represents ``GeneralName`` as an [RFC 822](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc822) email address.
        :param builtins.str uniform_resource_identifier: Represents ``GeneralName`` as a URI.
        """
        if directory_name is not None:
            pulumi.set(__self__, "directory_name", directory_name)
        if dns_name is not None:
...
class CertificateOtherName(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a custom ASN.1 X.400 ``GeneralName`` using an object identifier (OID) and value. The OID must satisfy the regular expression shown below. For more information, see NIST's definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
        :param builtins.str type_id: Specifies an OID.
        :param builtins.str value: Specifies an OID value.
        """
        pulumi.set(__self__, "type_id", type_id)
        pulumi.set(__self__, "value", value)
...
class CertificatePolicyInformation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the X.509 ``CertificatePolicies`` extension.
        :param builtins.str cert_policy_id: Specifies the object identifier (OID) of the certificate policy under which the certificate was issued. For more information, see NIST's definition of [Object Identifier (OID)](https://docs.aws.amazon.com/https://csrc.nist.gov/glossary/term/Object_Identifier).
...
class CertificatePolicyQualifierInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Modifies the ``CertPolicyId`` of a ``PolicyInformation`` object with a qualifier. AWS Private CA supports the certification practice statement (CPS) qualifier.
        :param builtins.str policy_qualifier_id: Identifies the qualifier modifying a ``CertPolicyId``.
...
class CertificateQualifier(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a ``PolicyInformation`` qualifier. AWS Private CA supports the [certification practice statement (CPS) qualifier](https://docs.aws.amazon.com/https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.4) defined in RFC 5280.
        :param builtins.str cps_uri: Contains a pointer to a certification practice statement (CPS) published by the CA.
        """
...
class CertificateSubject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains information about the certificate subject. The ``Subject`` field in the certificate identifies the entity that owns or controls the public key in the certificate. The entity can be a user, computer, device, or service. The ``Subject``must contain an X.500 distinguished name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by commas in the certificate.
        :param builtins.str common_name: For CA and end-entity certificates in a private PKI, the common name (CN) can be any string within the length limit.
                Note: In publicly trusted certificates, the common name must be a fully qualified domain name (FQDN) associated with the certificate subject.
        :param builtins.str country: Two-digit code that specifies the country in which the certificate subject located.
        ...
        :param builtins.str distinguished_name_qualifier: Disambiguating information for the certificate subject.
        :param builtins.str generation_qualifier: Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third.
        :param builtins.str given_name: First name.
        :param builtins.str initials: Concatenation that typically contains the first letter of the *GivenName*, the first letter of the middle name if one exists, and the first letter of the *Surname*.
        :param builtins.str locality: The locality (such as a city or town) in which the certificate subject is located.
        :param builtins.str organization: Legal name of the organization with which the certificate subject is affiliated.
        :param builtins.str organizational_unit: A subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated.
        :param builtins.str pseudonym: Typically a shortened version of a longer *GivenName*. For example, Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza.
        :param builtins.str serial_number: The certificate serial number.
        :param builtins.str state: State in which the subject of the certificate is located.
        :param builtins.str surname: Family name. In the US and the UK, for example, the surname of an individual is ordered last. In Asian cultures the surname is typically ordered first.
        :param builtins.str title: A title such as Mr. or Ms., which is pre-pended to the name to refer formally to the certificate subject.
        """
        if common_name is not None:
            pulumi.set(__self__, "common_name", common_name)
        if country is not None:
...
class CertificateValidity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Length of time for which the certificate issued by your private certificate authority (CA), or by the private CA itself, is valid in days, months, or years. You can issue a certificate by calling the ``IssueCertificate`` operation.
        :param builtins.str type: Specifies whether the ``Value`` parameter represents days, months, or years.
        :param builtins.float value: A long integer interpreted according to the value of ``Type``, below.
        """
