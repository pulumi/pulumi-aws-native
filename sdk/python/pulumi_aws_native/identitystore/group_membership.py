...
class GroupMembershipArgs:
    ...
    def member_id(self) -> Optional[pulumi.Input['GroupMembershipMemberIdArgs']]:
        """
    ...
    @member_id.setter
    def member_id(self, value: Optional[pulumi.Input['GroupMembershipMemberIdArgs']]):
...
class GroupMembership(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="memberId")
    def member_id(self) -> pulumi.Output[Optional['outputs.GroupMembershipMemberId']]:
        """
        An object containing the identifier of a group member.
        """
        return pulumi.get(self, "member_id")
