...
class BudgetsActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] budget_name: A string that represents the budget name. ":" and "\\" characters aren't allowed.
        :param pulumi.Input['BudgetsActionDefinitionArgs'] definition: Specifies all of the type-specific parameters.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BudgetsActionSubscriberArgs']]] subscribers: A list of subscribers.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] resource_tags: An optional list of tags to associate with the specified budget action. Each tag consists of a key and a value, and each key must be unique for the resource.
        """
...
@pulumi.type_token("aws-native:budgets:BudgetsAction")
class BudgetsAction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 action_threshold: Optional[pulumi.Input[Union['BudgetsActionActionThresholdArgs', 'BudgetsActionActionThresholdArgsDict']]] = None,
                 action_type: Optional[pulumi.Input['BudgetsActionActionType']] = None,
                 approval_model: Optional[pulumi.Input['BudgetsActionApprovalModel']] = None,
                 budget_name: Optional[pulumi.Input[builtins.str]] = None,
                 definition: Optional[pulumi.Input[Union['BudgetsActionDefinitionArgs', 'BudgetsActionDefinitionArgsDict']]] = None,
                 ...
                 subscribers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BudgetsActionSubscriberArgs', 'BudgetsActionSubscriberArgsDict']]]]] = None,
                 __props__=None):
        """
