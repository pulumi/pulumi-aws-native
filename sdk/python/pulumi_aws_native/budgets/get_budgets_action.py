...
def get_budgets_action(action_id: Optional[builtins.str] = None,
                       budget_name: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBudgetsActionResult:
    """
    An example resource schema demonstrating some basic constructs and validation rules.


    :param builtins.str action_id: A system-generated universally unique identifier (UUID) for the action.
    :param builtins.str budget_name: A string that represents the budget name. ":" and "\\" characters aren't allowed.
    """
    __args__ = dict()
...
def get_budgets_action_output(action_id: Optional[pulumi.Input[builtins.str]] = None,
