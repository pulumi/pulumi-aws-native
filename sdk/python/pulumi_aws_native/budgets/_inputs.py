...
class BudgetsActionDefinitionArgsDict(TypedDict):
    iam_action_definition: NotRequired[pulumi.Input[Optional['BudgetsActionIamActionDefinitionArgsDict']]]
    """
    The AWS Identity and Access Management ( IAM ) action definition details.
    """
    scp_action_definition: NotRequired[pulumi.Input[Optional['BudgetsActionScpActionDefinitionArgsDict']]]
    """
    The service control policies (SCP) action definition details.
    """
    ssm_action_definition: NotRequired[pulumi.Input[Optional['BudgetsActionSsmActionDefinitionArgsDict']]]
    """
