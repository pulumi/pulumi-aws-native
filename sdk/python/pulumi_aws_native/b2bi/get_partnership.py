...
class GetPartnershipResult:
    ...
    def partnership_arn(self) -> Optional[builtins.str]:
        """
    ...
    def trading_partner_id(self) -> Optional[builtins.str]:
        """
...
def get_partnership(partnership_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPartnershipResult:
    """
    Definition of AWS::B2BI::Partnership Resource Type


    :param builtins.str partnership_id: Returns the unique, system-generated identifier for a partnership.
    """
    __args__ = dict()
...
def get_partnership_output(partnership_id: Optional[pulumi.Input[builtins.str]] = None,
