...
class GetPartnershipResult:
    ...
    def partnership_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def trading_partner_id(self) -> Optional[_builtins.str]:
        """
...
def get_partnership(partnership_id: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPartnershipResult:
    """
    Definition of AWS::B2BI::Partnership Resource Type


    :param _builtins.str partnership_id: Returns the unique, system-generated identifier for a partnership.
    """
    __args__ = dict()
