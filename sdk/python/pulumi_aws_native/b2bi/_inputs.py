...
class PartnershipCapabilityOptionsArgsDict(TypedDict):
    inbound_edi: NotRequired[pulumi.Input[Optional['PartnershipInboundEdiOptionsArgsDict']]]
    """
    A structure that contains the inbound EDI options for the capability.
    """
    outbound_edi: NotRequired[pulumi.Input[Optional['PartnershipOutboundEdiOptionsPropertiesArgsDict']]]
    """
...
class PartnershipInboundEdiOptionsArgsDict(TypedDict):
    x12: NotRequired[pulumi.Input[Optional['PartnershipX12InboundEdiOptionsArgsDict']]]
    """
...
class PartnershipX12EnvelopeArgsDict(TypedDict):
    common: NotRequired[pulumi.Input[Optional['PartnershipX12OutboundEdiHeadersArgsDict']]]
    wrap_options: NotRequired[pulumi.Input[Optional['PartnershipWrapOptionsArgsDict']]]
...
class PartnershipX12InboundEdiOptionsArgsDict(TypedDict):
    acknowledgment_options: NotRequired[pulumi.Input[Optional['PartnershipX12AcknowledgmentOptionsArgsDict']]]
    """
...
class PartnershipX12OutboundEdiHeadersArgsDict(TypedDict):
    control_numbers: NotRequired[pulumi.Input[Optional['PartnershipX12ControlNumbersArgsDict']]]
    delimiters: NotRequired[pulumi.Input[Optional['PartnershipX12DelimitersArgsDict']]]
    functional_group_headers: NotRequired[pulumi.Input[Optional['PartnershipX12FunctionalGroupHeadersArgsDict']]]
    gs05_time_format: NotRequired[pulumi.Input[Optional['PartnershipX12gs05TimeFormat']]]
    interchange_control_headers: NotRequired[pulumi.Input[Optional['PartnershipX12InterchangeControlHeadersArgsDict']]]
...
class TransformerAdvancedOptionsArgsDict(TypedDict):
    x12: NotRequired[pulumi.Input[Optional['TransformerX12AdvancedOptionsArgsDict']]]
    """
...
class TransformerInputConversionArgsDict(TypedDict):
    ...
    """
    advanced_options: NotRequired[pulumi.Input[Optional['TransformerAdvancedOptionsArgsDict']]]
    """
    ...
    """
    format_options: NotRequired[pulumi.Input[Optional['TransformerFormatOptionsPropertiesArgsDict']]]
    """
...
class TransformerX12AdvancedOptionsArgsDict(TypedDict):
    split_options: NotRequired[pulumi.Input[Optional['TransformerX12SplitOptionsArgsDict']]]
    """
    ...
    """
    validation_options: NotRequired[pulumi.Input[Optional['TransformerX12ValidationOptionsArgsDict']]]
    """
...
class TransformerX12ValidationOptionsArgsDict(TypedDict):
    validation_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['TransformerX12ValidationRule0PropertiesArgsDict', 'TransformerX12ValidationRule1PropertiesArgsDict', 'TransformerX12ValidationRule2PropertiesArgsDict']]]]]]
    """
