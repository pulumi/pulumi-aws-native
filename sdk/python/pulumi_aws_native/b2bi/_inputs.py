...
if not MYPY:
    class CapabilityEdiConfigurationArgsDict(TypedDict):
        ...
        transformer_id: pulumi.Input[builtins.str]
...
class CapabilityEdiConfigurationArgs:
    ...
    def transformer_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "transformer_id")

    @transformer_id.setter
    def transformer_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PartnershipWrapOptionsArgsDict(TypedDict):
        line_length: NotRequired[pulumi.Input[builtins.float]]
...
class PartnershipWrapOptionsArgs:
    def __init__(__self__, *,
                 line_length: Optional[pulumi.Input[builtins.float]] = None,
    ...
    def line_length(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "line_length")

    @line_length.setter
    def line_length(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class PartnershipX12ControlNumbersArgsDict(TypedDict):
        starting_functional_group_control_number: NotRequired[pulumi.Input[builtins.float]]
        starting_interchange_control_number: NotRequired[pulumi.Input[builtins.float]]
        starting_transaction_set_control_number: NotRequired[pulumi.Input[builtins.float]]
elif False:
...
class PartnershipX12ControlNumbersArgs:
    def __init__(__self__, *,
                 starting_functional_group_control_number: Optional[pulumi.Input[builtins.float]] = None,
                 starting_interchange_control_number: Optional[pulumi.Input[builtins.float]] = None,
                 starting_transaction_set_control_number: Optional[pulumi.Input[builtins.float]] = None):
...
class PartnershipX12DelimitersArgs:
    def __init__(__self__, *,
                 component_separator: Optional[pulumi.Input[builtins.str]] = None,
                 data_element_separator: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def component_separator(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "component_separator")

    @component_separator.setter
    def component_separator(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "component_separator", value)

    @property
    @pulumi.getter(name="dataElementSeparator")
    def data_element_separator(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "data_element_separator")

    @data_element_separator.setter
    def data_element_separator(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PartnershipX12FunctionalGroupHeadersArgsDict(TypedDict):
        application_receiver_code: NotRequired[pulumi.Input[builtins.str]]
        application_sender_code: NotRequired[pulumi.Input[builtins.str]]
        responsible_agency_code: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class PartnershipX12FunctionalGroupHeadersArgs:
    def __init__(__self__, *,
                 application_receiver_code: Optional[pulumi.Input[builtins.str]] = None,
                 application_sender_code: Optional[pulumi.Input[builtins.str]] = None,
                 responsible_agency_code: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def application_receiver_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "application_receiver_code")

    @application_receiver_code.setter
    def application_receiver_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_receiver_code", value)

    @property
    @pulumi.getter(name="applicationSenderCode")
    def application_sender_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "application_sender_code")

    @application_sender_code.setter
    def application_sender_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_sender_code", value)

    @property
    @pulumi.getter(name="responsibleAgencyCode")
    def responsible_agency_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "responsible_agency_code")

    @responsible_agency_code.setter
    def responsible_agency_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PartnershipX12InterchangeControlHeadersArgsDict(TypedDict):
        acknowledgment_requested_code: NotRequired[pulumi.Input[builtins.str]]
        receiver_id: NotRequired[pulumi.Input[builtins.str]]
        receiver_id_qualifier: NotRequired[pulumi.Input[builtins.str]]
        repetition_separator: NotRequired[pulumi.Input[builtins.str]]
        sender_id: NotRequired[pulumi.Input[builtins.str]]
        sender_id_qualifier: NotRequired[pulumi.Input[builtins.str]]
        usage_indicator_code: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class PartnershipX12InterchangeControlHeadersArgs:
    def __init__(__self__, *,
                 acknowledgment_requested_code: Optional[pulumi.Input[builtins.str]] = None,
                 receiver_id: Optional[pulumi.Input[builtins.str]] = None,
                 receiver_id_qualifier: Optional[pulumi.Input[builtins.str]] = None,
                 repetition_separator: Optional[pulumi.Input[builtins.str]] = None,
                 sender_id: Optional[pulumi.Input[builtins.str]] = None,
                 sender_id_qualifier: Optional[pulumi.Input[builtins.str]] = None,
                 usage_indicator_code: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def acknowledgment_requested_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "acknowledgment_requested_code")

    @acknowledgment_requested_code.setter
    def acknowledgment_requested_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "acknowledgment_requested_code", value)

    @property
    @pulumi.getter(name="receiverId")
    def receiver_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "receiver_id")

    @receiver_id.setter
    def receiver_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "receiver_id", value)

    @property
    @pulumi.getter(name="receiverIdQualifier")
    def receiver_id_qualifier(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "receiver_id_qualifier")

    @receiver_id_qualifier.setter
    def receiver_id_qualifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "receiver_id_qualifier", value)

    @property
    @pulumi.getter(name="repetitionSeparator")
    def repetition_separator(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "repetition_separator")

    @repetition_separator.setter
    def repetition_separator(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sender_id_qualifier(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sender_id_qualifier")

    @sender_id_qualifier.setter
    def sender_id_qualifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sender_id_qualifier", value)

    @property
    @pulumi.getter(name="usageIndicatorCode")
    def usage_indicator_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "usage_indicator_code")

    @usage_indicator_code.setter
    def usage_indicator_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PartnershipX12OutboundEdiHeadersArgsDict(TypedDict):
        ...
        validate_edi: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class PartnershipX12OutboundEdiHeadersArgs:
    def __init__(__self__, *,
                 ...
                 validate_edi: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def validate_edi(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "validate_edi")

    @validate_edi.setter
    def validate_edi(self, value: Optional[pulumi.Input[builtins.bool]]):
