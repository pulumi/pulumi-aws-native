...
class GetCapabilityResult:
    ...
    def capability_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def capability_id(self) -> Optional[_builtins.str]:
        """
...
def get_capability(capability_id: Optional[_builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCapabilityResult:
    """
    Definition of AWS::B2BI::Capability Resource Type


    :param _builtins.str capability_id: Returns a system-assigned unique identifier for the capability.
    """
    __args__ = dict()
