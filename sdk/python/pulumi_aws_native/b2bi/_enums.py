...
class CapabilityDirection(_builtins.str, Enum):
    INBOUND = "INBOUND"
    OUTBOUND = "OUTBOUND"
...
class CapabilityX12TransactionSet(_builtins.str, Enum):
    X12100 = "X12_100"
    X12101 = "X12_101"
    X12102 = "X12_102"
    X12103 = "X12_103"
...
class PartnershipWrapFormat(_builtins.str, Enum):
    SEGMENT = "SEGMENT"
    ONE_LINE = "ONE_LINE"
...
class PartnershipX12FunctionalAcknowledgment(_builtins.str, Enum):
...
class PartnershipX12TechnicalAcknowledgment(_builtins.str, Enum):
    DO_NOT_GENERATE = "DO_NOT_GENERATE"
    GENERATE_ALL_SEGMENTS = "GENERATE_ALL_SEGMENTS"


@pulumi.type_token("aws-native:b2bi:PartnershipX12gs05TimeFormat")
class PartnershipX12gs05TimeFormat(_builtins.str, Enum):
    HHMM = "HHMM"
    HHMMSS = "HHMMSS"
    HHMMSSDD = "HHMMSSDD"
...
class ProfileLogging(_builtins.str, Enum):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"


@pulumi.type_token("aws-native:b2bi:TransformerElementRequirement")
class TransformerElementRequirement(_builtins.str, Enum):
    OPTIONAL = "OPTIONAL"
    MANDATORY = "MANDATORY"


@pulumi.type_token("aws-native:b2bi:TransformerFileFormat")
class TransformerFileFormat(_builtins.str, Enum):
    XML = "XML"
    JSON = "JSON"
    NOT_USED = "NOT_USED"
...
class TransformerX12Version(_builtins.str, Enum):
    VERSION4010 = "VERSION_4010"
    VERSION4030 = "VERSION_4030"
    VERSION4050 = "VERSION_4050"
    VERSION4060 = "VERSION_4060"
