...
class GetTransformerResult:
    ...
    def mapping_template(self) -> Optional[_builtins.str]:
        """
    ...
    def sample_document(self) -> Optional[_builtins.str]:
        """
        This shape is deprecated: This is a legacy trait. Please use input-conversion or output-conversion.
        """
    ...
    def transformer_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def transformer_id(self) -> Optional[_builtins.str]:
        """
...
def get_transformer(transformer_id: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransformerResult:
    """
    Definition of AWS::B2BI::Transformer Resource Type


    :param _builtins.str transformer_id: The system-assigned unique identifier for the transformer.
    """
    __args__ = dict()
