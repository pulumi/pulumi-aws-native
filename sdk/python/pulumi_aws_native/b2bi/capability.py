...
class CapabilityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The display name of the capability.
...
class Capability(pulumi.CustomResource):
    ...
    def capability_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def capability_id(self) -> pulumi.Output[builtins.str]:
        """
