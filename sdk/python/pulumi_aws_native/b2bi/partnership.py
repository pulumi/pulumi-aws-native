...
class PartnershipArgs:
    def __init__(__self__, *,
                 ...
                 capability_options: pulumi.Input[Optional['PartnershipCapabilityOptionsArgs']] = None,
    ...
    def capability_options(self) -> pulumi.Input[Optional['PartnershipCapabilityOptionsArgs']]:
        """
    ...
    def capability_options(self, value: pulumi.Input[Optional['PartnershipCapabilityOptionsArgs']]):
...
@pulumi.type_token("aws-native:b2bi:Partnership")
class Partnership(pulumi.CustomResource):
    ...
    def partnership_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def partnership_id(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def trading_partner_id(self) -> pulumi.Output[_builtins.str]:
        """
