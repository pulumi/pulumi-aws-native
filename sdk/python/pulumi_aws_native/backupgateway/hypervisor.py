...
class HypervisorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host: The server host of the hypervisor. This can be either an IP address or a fully-qualified domain name (FQDN).
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) of the AWS Key Management Service used to encrypt the hypervisor.
        :param pulumi.Input[builtins.str] log_group_arn: The Amazon Resource Name (ARN) of the group of gateways within the requested log.
        :param pulumi.Input[builtins.str] name: The name of the hypervisor.
        :param pulumi.Input[builtins.str] password: The password for the hypervisor.
        ...
        :param pulumi.Input[builtins.str] username: The username for the hypervisor.
        """
        if host is not None:
...
class Hypervisor(pulumi.CustomResource):
    ...
    def hypervisor_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="logGroupArn")
    def log_group_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the group of gateways within the requested log.
        """
        return pulumi.get(self, "log_group_arn")
