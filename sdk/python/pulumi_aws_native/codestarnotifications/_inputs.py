...
class NotificationRuleTargetArgs:
    def __init__(__self__, *,
                 ...
                 target_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] target_address: The Amazon Resource Name (ARN) of the  topic or  client.
        :param pulumi.Input[builtins.str] target_type: The target type. Can be an Amazon Simple Notification Service topic or  client.
