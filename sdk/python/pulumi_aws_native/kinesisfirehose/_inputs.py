...
if not MYPY:
    class DeliveryStreamAmazonOpenSearchServerlessBufferingHintsArgsDict(TypedDict):
        ...
        """
        size_in_mbs: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeliveryStreamAmazonOpenSearchServerlessBufferingHintsArgs:
    def __init__(__self__, *,
                 ...
                 size_in_mbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 300 (5 minutes).
        :param pulumi.Input[builtins.int] size_in_mbs: Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 5.
    ...
    def size_in_mbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 5.
    ...
    @size_in_mbs.setter
    def size_in_mbs(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class DeliveryStreamAmazonOpenSearchServerlessDestinationConfigurationArgsDict(TypedDict):
        ...
        collection_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeliveryStreamAmazonOpenSearchServerlessDestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be assumed by Firehose for calling the Serverless offering for Amazon OpenSearch Service Configuration API and for indexing documents.
...
class DeliveryStreamAmazonOpenSearchServerlessRetryOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: After an initial failure to deliver to the Serverless offering for Amazon OpenSearch Service, the total amount of time during which Firehose retries delivery (including the first attempt). After this time has elapsed, the failed documents are written to Amazon S3. Default value is 300 seconds (5 minutes). A value of 0 (zero) results in no retries.
        """
...
class DeliveryStreamAmazonopensearchserviceBufferingHintsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 300 (5 minutes).
        :param pulumi.Input[builtins.int] size_in_mbs: Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 5. We recommend setting this parameter to a value greater than the amount of data you typically ingest into the delivery stream in 10 seconds. For example, if you typically ingest data at 1 MB/sec, the value should be 10 MB or higher.
        """
        if interval_in_seconds is not None:
            pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
        if size_in_mbs is not None:
...
class DeliveryStreamAmazonopensearchserviceDestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 vpc_configuration: Optional[pulumi.Input['DeliveryStreamVpcConfigurationArgs']] = None):
        """
        :param pulumi.Input[builtins.str] index_name: The Amazon OpenSearch Service index name.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be assumed by Kinesis Data Firehose for calling the Amazon OpenSearch Service Configuration API and for indexing documents.
        ...
        :param pulumi.Input[builtins.str] cluster_endpoint: The endpoint to use when communicating with the cluster. Specify either this ClusterEndpoint or the DomainARN field.
        ...
        :param pulumi.Input[builtins.str] domain_arn: The ARN of the Amazon OpenSearch Service domain.
        ...
        :param pulumi.Input[builtins.str] type_name: The Amazon OpenSearch Service type name.
...
class DeliveryStreamAmazonopensearchserviceRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: After an initial failure to deliver to Amazon OpenSearch Service, the total amount of time during which Kinesis Data Firehose retries delivery (including the first attempt). After this time has elapsed, the failed documents are written to Amazon S3. Default value is 300 seconds (5 minutes). A value of 0 (zero) results in no retries.
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamBufferingHintsArgs:
    def __init__(__self__, *,
                 ...
                 size_in_mbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: The length of time, in seconds, that Kinesis Data Firehose buffers incoming data before delivering it to the destination. For valid values, see the `IntervalInSeconds` content for the [BufferingHints](https://docs.aws.amazon.com/firehose/latest/APIReference/API_BufferingHints.html) data type in the *Amazon Kinesis Data Firehose API Reference* .
        :param pulumi.Input[builtins.int] size_in_mbs: The size of the buffer, in MBs, that Kinesis Data Firehose uses for incoming data before delivering it to the destination. For valid values, see the `SizeInMBs` content for the [BufferingHints](https://docs.aws.amazon.com/firehose/latest/APIReference/API_BufferingHints.html) data type in the *Amazon Kinesis Data Firehose API Reference* .
        """
        if interval_in_seconds is not None:
            pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
        if size_in_mbs is not None:
...
if not MYPY:
    class DeliveryStreamCatalogConfigurationArgsDict(TypedDict):
        catalog_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeliveryStreamCatalogConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] warehouse_location: The warehouse location for Apache Iceberg tables. You must configure this when schema evolution and table creation is enabled.
    ...
    def catalog_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Glue catalog ARN identifier of the destination Apache Iceberg Tables. You must specify the ARN in the format `arn:aws:glue:region:account-id:catalog` .
        """
...
class DeliveryStreamCloudWatchLoggingOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether CloudWatch Logs logging is enabled.
        :param pulumi.Input[builtins.str] log_group_name: The name of the CloudWatch Logs log group that contains the log stream that Kinesis Data Firehose will use.
               
               Conditional. If you enable logging, you must specify this property.
        :param pulumi.Input[builtins.str] log_stream_name: The name of the CloudWatch Logs log stream that Kinesis Data Firehose uses to send logs about data delivery.
...
class DeliveryStreamCopyCommandArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] data_table_name: The name of the target table. The table must already exist in the database.
        :param pulumi.Input[builtins.str] copy_options: Parameters to use with the Amazon Redshift `COPY` command. For examples, see the `CopyOptions` content for the [CopyCommand](https://docs.aws.amazon.com/firehose/latest/APIReference/API_CopyCommand.html) data type in the *Amazon Kinesis Data Firehose API Reference* .
        :param pulumi.Input[builtins.str] data_table_columns: A comma-separated list of column names.
        """
...
if not MYPY:
    class DeliveryStreamDatabaseSourceConfigurationArgsDict(TypedDict):
        ...
        Amazon Data Firehose is in preview release and is subject to change.
        """
        snapshot_watermark_table: pulumi.Input[builtins.str]
        """
        ...
        public_certificate: NotRequired[pulumi.Input[builtins.str]]
        ...
        Amazon Data Firehose is in preview release and is subject to change.
        """
        surrogate_keys: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DeliveryStreamDatabaseSourceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 surrogate_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input['DeliveryStreamDatabasesArgs'] databases: The list of database patterns in source database endpoint for Firehose to read from.
               ...
               Amazon Data Firehose is in preview release and is subject to change.
        :param pulumi.Input[builtins.str] endpoint: The endpoint of the database server.
               
               Amazon Data Firehose is in preview release and is subject to change.
        :param pulumi.Input[builtins.int] port: The port of the database. This can be one of the following values.
               
               - 3306 for MySQL database type
               - 5432 for PostgreSQL database type
               
               Amazon Data Firehose is in preview release and is subject to change.
        :param pulumi.Input[builtins.str] snapshot_watermark_table: The fully qualified name of the table in source database endpoint that Firehose uses to track snapshot progress.
        ...
        :param pulumi.Input['DeliveryStreamDatabaseSourceConfigurationSslMode'] ssl_mode: The mode to enable or disable SSL when Firehose connects to the database endpoint.
               ...
               Amazon Data Firehose is in preview release and is subject to change.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] surrogate_keys: The optional list of table and column names used as unique key columns when taking snapshot if the tables don’t have primary keys configured.
    ...
    def snapshot_watermark_table(self) -> pulumi.Input[builtins.str]:
        """
        The fully qualified name of the table in source database endpoint that Firehose uses to track snapshot progress.
    ...
    def snapshot_watermark_table(self, value: pulumi.Input[builtins.str]):
    ...
    def surrogate_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The optional list of table and column names used as unique key columns when taking snapshot if the tables don’t have primary keys configured.
    ...
    def surrogate_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DeliveryStreamDatabaseSourceVpcConfigurationArgs:
    def __init__(__self__, *,
                 vpc_endpoint_service_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] vpc_endpoint_service_name: The VPC endpoint service name which Firehose uses to create a PrivateLink to the database. The endpoint service must have the Firehose service principle `firehose.amazonaws.com` as an allowed principal on the VPC endpoint service. The VPC endpoint service name is a string that looks like `com.amazonaws.vpce.<region>.<vpc-endpoint-service-id>` .
...
class DeliveryStreamDestinationTableConfigurationArgs:
    ...
    def destination_database_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "destination_database_name")

    @destination_database_name.setter
    def destination_database_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_database_name", value)

    @property
    @pulumi.getter(name="destinationTableName")
    def destination_table_name(self) -> pulumi.Input[builtins.str]:
...
if not MYPY:
    class DeliveryStreamDirectPutSourceConfigurationArgsDict(TypedDict):
        throughput_hint_in_mbs: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeliveryStreamDirectPutSourceConfigurationArgs:
    def __init__(__self__, *,
                 throughput_hint_in_mbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] throughput_hint_in_mbs: The value that you configure for this parameter is for information purpose only and does not affect Firehose delivery throughput limit. You can use the [Firehose Limits form](https://docs.aws.amazon.com/https://support.console.aws.amazon.com/support/home#/case/create%3FissueType=service-limit-increase%26limitType=kinesis-firehose-limits) to request a throughput limit increase.
        """
    ...
    def throughput_hint_in_mbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The value that you configure for this parameter is for information purpose only and does not affect Firehose delivery throughput limit. You can use the [Firehose Limits form](https://docs.aws.amazon.com/https://support.console.aws.amazon.com/support/home#/case/create%3FissueType=service-limit-increase%26limitType=kinesis-firehose-limits) to request a throughput limit increase.
        """
    ...
    def throughput_hint_in_mbs(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeliveryStreamDynamicPartitioningConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether dynamic partitioning is enabled for this Kinesis Data Firehose delivery stream.
...
class DeliveryStreamElasticsearchDestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 vpc_configuration: Optional[pulumi.Input['DeliveryStreamVpcConfigurationArgs']] = None):
        """
        :param pulumi.Input[builtins.str] index_name: The name of the Elasticsearch index to which Kinesis Data Firehose adds data for indexing.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be assumed by Kinesis Data Firehose for calling the Amazon ES Configuration API and for indexing documents. For more information, see [Controlling Access with Amazon Kinesis Data Firehose](https://docs.aws.amazon.com/firehose/latest/dev/controlling-access.html) .
        ...
        :param pulumi.Input[builtins.str] cluster_endpoint: The endpoint to use when communicating with the cluster. Specify either this `ClusterEndpoint` or the `DomainARN` field.
        :param pulumi.Input['DeliveryStreamDocumentIdOptionsArgs'] document_id_options: Indicates the method for setting up document ID. The supported methods are Firehose generated document ID and OpenSearch Service generated document ID.
        :param pulumi.Input[builtins.str] domain_arn: The ARN of the Amazon ES domain. The IAM role must have permissions for `DescribeElasticsearchDomain` , `DescribeElasticsearchDomains` , and `DescribeElasticsearchDomainConfig` after assuming the role specified in *RoleARN* .
        ...
        :param pulumi.Input[builtins.str] type_name: The Elasticsearch type name that Amazon ES adds to documents when indexing data.
...
class DeliveryStreamElasticsearchRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: After an initial failure to deliver to Amazon ES, the total amount of time during which Kinesis Data Firehose re-attempts delivery (including the first attempt). If Kinesis Data Firehose can't deliver the data within the specified time, it writes the data to the backup S3 bucket. For valid values, see the `DurationInSeconds` content for the [ElasticsearchRetryOptions](https://docs.aws.amazon.com/firehose/latest/APIReference/API_ElasticsearchRetryOptions.html) data type in the *Amazon Kinesis Data Firehose API Reference* .
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamEncryptionConfigurationInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DeliveryStreamEncryptionConfigurationInputKeyType'] key_type: Indicates the type of customer master key (CMK) to use for encryption. The default setting is `AWS_OWNED_CMK` . For more information about CMKs, see [Customer Master Keys (CMKs)](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#master_keys) .
               ...
               > To encrypt your delivery stream, use symmetric CMKs. Kinesis Data Firehose doesn't support asymmetric CMKs. For information about symmetric and asymmetric CMKs, see [About Symmetric and Asymmetric CMKs](https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-concepts.html) in the AWS Key Management Service developer guide.
        :param pulumi.Input[builtins.str] key_arn: If you set `KeyType` to `CUSTOMER_MANAGED_CMK` , you must specify the Amazon Resource Name (ARN) of the CMK. If you set `KeyType` to `AWS _OWNED_CMK` , Firehose uses a service-account CMK.
        """
...
class DeliveryStreamExtendedS3DestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_arn: The Amazon Resource Name (ARN) of the Amazon S3 bucket. For constraints, see [ExtendedS3DestinationConfiguration](https://docs.aws.amazon.com/firehose/latest/APIReference/API_ExtendedS3DestinationConfiguration.html) in the *Amazon Kinesis Data Firehose API Reference* .
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the AWS credentials. For constraints, see [ExtendedS3DestinationConfiguration](https://docs.aws.amazon.com/firehose/latest/APIReference/API_ExtendedS3DestinationConfiguration.html) in the *Amazon Kinesis Data Firehose API Reference* .
        ...
        :param pulumi.Input[builtins.str] custom_time_zone: The time zone you prefer. UTC is the default.
        ...
        :param pulumi.Input[builtins.str] error_output_prefix: A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see [Custom Prefixes for Amazon S3 Objects](https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html) .
        :param pulumi.Input[builtins.str] file_extension: Specify a file extension. It will override the default file extension
        :param pulumi.Input[builtins.str] prefix: The `YYYY/MM/DD/HH` time format prefix is automatically used for delivered Amazon S3 files. For more information, see [ExtendedS3DestinationConfiguration](https://docs.aws.amazon.com/firehose/latest/APIReference/API_ExtendedS3DestinationConfiguration.html) in the *Amazon Kinesis Data Firehose API Reference* .
        :param pulumi.Input['DeliveryStreamProcessingConfigurationArgs'] processing_configuration: The data processing configuration for the Kinesis Data Firehose delivery stream.
...
class DeliveryStreamHiveJsonSerDeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] timestamp_formats: Indicates how you want Firehose to parse the date and timestamps that may be present in your input data JSON. To specify these format strings, follow the pattern syntax of JodaTime's DateTimeFormat format strings. For more information, see [Class DateTimeFormat](https://docs.aws.amazon.com/https://www.joda.org/joda-time/apidocs/org/joda/time/format/DateTimeFormat.html) . You can also use the special value `millis` to parse timestamps in epoch milliseconds. If you don't specify a format, Firehose uses `java.sql.Timestamp::valueOf` by default.
        """
...
class DeliveryStreamHttpEndpointCommonAttributeArgs:
    def __init__(__self__, *,
                 ...
                 attribute_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] attribute_name: The name of the HTTP endpoint common attribute.
        :param pulumi.Input[builtins.str] attribute_value: The value of the HTTP endpoint common attribute.
        """
...
class DeliveryStreamHttpEndpointConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] url: The URL of the HTTP endpoint selected as the destination.
        ...
        :param pulumi.Input[builtins.str] name: The name of the HTTP endpoint selected as the destination.
        """
...
if not MYPY:
    class DeliveryStreamIcebergDestinationConfigurationArgsDict(TypedDict):
        ...
        """
        s3_configuration: pulumi.Input['DeliveryStreamS3DestinationConfigurationArgsDict']
        append_only: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeliveryStreamIcebergDestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 role_arn: pulumi.Input[builtins.str],
                 s3_configuration: pulumi.Input['DeliveryStreamS3DestinationConfigurationArgs'],
                 append_only: Optional[pulumi.Input[builtins.bool]] = None,
                 buffering_hints: Optional[pulumi.Input['DeliveryStreamBufferingHintsArgs']] = None,
                 cloud_watch_logging_options: Optional[pulumi.Input['DeliveryStreamCloudWatchLoggingOptionsArgs']] = None,
        ...
        :param pulumi.Input[builtins.bool] append_only: Describes whether all incoming data for this delivery stream will be append only (inserts only and not for updates and deletes) for Iceberg delivery. This feature is only applicable for Apache Iceberg Tables.
    ...
    def append_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Describes whether all incoming data for this delivery stream will be append only (inserts only and not for updates and deletes) for Iceberg delivery. This feature is only applicable for Apache Iceberg Tables.
    ...
    @append_only.setter
    def append_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeliveryStreamKinesisStreamSourceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 role_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kinesis_stream_arn: The ARN of the source Kinesis data stream.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the role that provides access to the source Kinesis data stream.
        """
...
if not MYPY:
    class DeliveryStreamKmsEncryptionConfigArgsDict(TypedDict):
        awskms_key_arn: pulumi.Input[builtins.str]
        """
...
class DeliveryStreamKmsEncryptionConfigArgs:
    def __init__(__self__, *,
                 awskms_key_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] awskms_key_arn: The Amazon Resource Name (ARN) of the AWS KMS encryption key that Amazon S3 uses to encrypt data delivered by the Kinesis Data Firehose stream. The key must belong to the same region as the destination S3 bucket.
        """
        pulumi.set(__self__, "awskms_key_arn", awskms_key_arn)

    @property
    @pulumi.getter(name="awskmsKeyArn")
    def awskms_key_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the AWS KMS encryption key that Amazon S3 uses to encrypt data delivered by the Kinesis Data Firehose stream. The key must belong to the same region as the destination S3 bucket.
        """
    ...
    def awskms_key_arn(self, value: pulumi.Input[builtins.str]):
...
class DeliveryStreamMskSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] read_from_timestamp: The start date and time in UTC for the offset position within your MSK topic from where Firehose begins to read. By default, this is set to timestamp when Firehose becomes Active.
...
class DeliveryStreamOpenXJsonSerDeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] case_insensitive: When set to `true` , which is the default, Firehose converts JSON keys to lowercase before deserializing them.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] column_to_json_key_mappings: Maps column names to JSON keys that aren't identical to the column names. This is useful when the JSON contains keys that are Hive keywords. For example, `timestamp` is a Hive keyword. If you have a JSON key named `timestamp` , set this parameter to `{"ts": "timestamp"}` to map this key to a column named `ts` .
        :param pulumi.Input[builtins.bool] convert_dots_in_json_keys_to_underscores: When set to `true` , specifies that the names of the keys include dots and that you want Firehose to replace them with underscores. This is useful because Apache Hive does not allow dots in column names. For example, if the JSON contains a key whose name is "a.b", you can define the column name to be "a_b" when using this option.
...
class DeliveryStreamOrcSerDeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] block_size_bytes: The Hadoop Distributed File System (HDFS) block size. This is useful if you intend to copy the data from Amazon S3 to HDFS before querying. The default is 256 MiB and the minimum is 64 MiB. Firehose uses this value for padding calculations.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] bloom_filter_columns: The column names for which you want Firehose to create bloom filters. The default is `null` .
        ...
        :param pulumi.Input[builtins.float] padding_tolerance: A number between 0 and 1 that defines the tolerance for block padding as a decimal fraction of stripe size. The default value is 0.05, which means 5 percent of stripe size.
               
               For the default values of 64 MiB ORC stripes and 256 MiB HDFS blocks, the default block padding tolerance of 5 percent reserves a maximum of 3.2 MiB for padding within the 256 MiB block. In such a case, if the available size within the block is more than 3.2 MiB, a new, smaller stripe is inserted to fit within that space. This ensures that no stripe crosses block boundaries and causes remote reads within a node-local task.
               
               Kinesis Data Firehose ignores this parameter when `EnablePadding` is `false` .
        :param pulumi.Input[builtins.int] row_index_stride: The number of rows between index entries. The default is 10,000 and the minimum is 1,000.
...
class DeliveryStreamProcessingConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether data processing is enabled (true) or disabled (false).
...
class DeliveryStreamProcessorParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_name: The name of the parameter. Currently the following default values are supported: 3 for `NumberOfRetries` and 60 for the `BufferIntervalInSeconds` . The `BufferSizeInMBs` ranges between 0.2 MB and up to 3MB. The default buffering hint is 1MB for all destinations, except Splunk. For Splunk, the default buffering hint is 256 KB.
...
class DeliveryStreamRedshiftDestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cluster_jdbcurl: The connection string that Kinesis Data Firehose uses to connect to the Amazon Redshift cluster.
        ...
        :param pulumi.Input[builtins.str] role_arn: The ARN of the AWS Identity and Access Management (IAM) role that grants Kinesis Data Firehose access to your Amazon S3 bucket and AWS KMS (if you enable data encryption). For more information, see [Grant Kinesis Data Firehose Access to an Amazon Redshift Destination](https://docs.aws.amazon.com/firehose/latest/dev/controlling-access.html#using-iam-rs) in the *Amazon Kinesis Data Firehose Developer Guide* .
        ...
        :param pulumi.Input[builtins.str] password: The password for the Amazon Redshift user that you specified in the `Username` property.
        :param pulumi.Input['DeliveryStreamProcessingConfigurationArgs'] processing_configuration: The data processing configuration for the Kinesis Data Firehose delivery stream.
        ...
        :param pulumi.Input[builtins.str] username: The Amazon Redshift user that has permission to access the Amazon Redshift cluster. This user must have `INSERT` privileges for copying data from the Amazon S3 bucket to the cluster.
        """
...
class DeliveryStreamRedshiftRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: The length of time during which Firehose retries delivery after a failure, starting from the initial request and including the first attempt. The default value is 3600 seconds (60 minutes). Firehose does not retry if the value of `DurationInSeconds` is 0 (zero) or if the first delivery attempt takes longer than the current value.
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: The total amount of time that Kinesis Data Firehose spends on retries. This duration starts after the initial attempt to send data to the custom destination via HTTPS endpoint fails. It doesn't include the periods during which Kinesis Data Firehose waits for acknowledgment from the specified destination after each attempt.
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamS3DestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket_arn: The Amazon Resource Name (ARN) of the Amazon S3 bucket to send data to.
        :param pulumi.Input[builtins.str] role_arn: The ARN of an AWS Identity and Access Management (IAM) role that grants Kinesis Data Firehose access to your Amazon S3 bucket and AWS KMS (if you enable data encryption). For more information, see [Grant Kinesis Data Firehose Access to an Amazon S3 Destination](https://docs.aws.amazon.com/firehose/latest/dev/controlling-access.html#using-iam-s3) in the *Amazon Kinesis Data Firehose Developer Guide* .
        ...
        :param pulumi.Input[builtins.str] error_output_prefix: A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see [Custom Prefixes for Amazon S3 Objects](https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html) .
        :param pulumi.Input[builtins.str] prefix: A prefix that Kinesis Data Firehose adds to the files that it delivers to the Amazon S3 bucket. The prefix helps you identify the files that Kinesis Data Firehose delivered.
        """
        pulumi.set(__self__, "bucket_arn", bucket_arn)
        pulumi.set(__self__, "role_arn", role_arn)
        if buffering_hints is not None:
...
class DeliveryStreamSchemaConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The role that Firehose can use to access AWS Glue. This role must be in the same account you use for Firehose. Cross-account roles aren't allowed.
        ...
        :param pulumi.Input[builtins.str] table_name: Specifies the AWS Glue table that contains the column information that constitutes your data schema.
               ...
               > If the `SchemaConfiguration` request parameter is used as part of invoking the `CreateDeliveryStream` API, then the `TableName` property is required and its value must be specified.
        :param pulumi.Input[builtins.str] version_id: Specifies the table version for the output data schema. If you don't specify this version ID, or if you set it to `LATEST` , Firehose uses the most recent version. This means that any updates to the table are automatically picked up.
        """
...
class DeliveryStreamSchemaEvolutionConfigurationArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Specify whether you want to enable schema evolution.
...
class DeliveryStreamSecretsManagerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: Specifies the role that Firehose assumes when calling the Secrets Manager API operation. When you provide the role, it overrides any destination specific role defined in the destination configuration. If you do not provide the then we use the destination specific role. This parameter is required for Splunk.
        :param pulumi.Input[builtins.str] secret_arn: The ARN of the secret that stores your credentials. It must be in the same region as the Firehose stream and the role. The secret ARN can reside in a different account than the Firehose stream and role as Firehose supports cross-account secret access. This parameter is required when *Enabled* is set to `True` .
        """
        pulumi.set(__self__, "enabled", enabled)
        if role_arn is not None:
            pulumi.set(__self__, "role_arn", role_arn)
...
class DeliveryStreamSnowflakeBufferingHintsArgs:
    def __init__(__self__, *,
                 ...
                 size_in_mbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 0.
        :param pulumi.Input[builtins.int] size_in_mbs: Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 128.
        """
        if interval_in_seconds is not None:
            pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
        if size_in_mbs is not None:
...
if not MYPY:
    class DeliveryStreamSnowflakeDestinationConfigurationArgsDict(TypedDict):
        ...
        """
        meta_data_column_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeliveryStreamSnowflakeDestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 meta_data_column_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] account_url: URL for accessing your Snowflake account. This URL must include your [account identifier](https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/admin-account-identifier) . Note that the protocol (https://) and port number are optional.
        :param pulumi.Input[builtins.str] database: All data in Snowflake is maintained in databases.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the Snowflake role
        :param pulumi.Input[builtins.str] schema: Each database consists of one or more schemas, which are logical groupings of database objects, such as tables and views
        :param pulumi.Input[builtins.str] table: All data in Snowflake is stored in database tables, logically structured as collections of columns and rows.
        ...
        :param pulumi.Input[builtins.str] content_column_name: The name of the record content column.
        ...
        :param pulumi.Input[builtins.str] key_passphrase: Passphrase to decrypt the private key when the key is encrypted. For information, see [Using Key Pair Authentication & Key Rotation](https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/data-load-snowpipe-streaming-configuration#using-key-pair-authentication-key-rotation) .
        :param pulumi.Input[builtins.str] meta_data_column_name: Specify a column name in the table, where the metadata information has to be loaded. When you enable this field, you will see the following column in the snowflake table, which differs based on the source type.
               ...
               `"kinesisStreamName" : "streamname", "kinesisShardId" : "Id", "kinesisPartitionKey" : "key", "kinesisSequenceNumber" : "1234", "subsequenceNumber" : "2334", "IngestionTime" : "timestamp" }`
        :param pulumi.Input[builtins.str] private_key: The private key used to encrypt your Snowflake client. For information, see [Using Key Pair Authentication & Key Rotation](https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/data-load-snowpipe-streaming-configuration#using-key-pair-authentication-key-rotation) .
        ...
        :param pulumi.Input[builtins.str] user: User login name for the Snowflake account.
        """
    ...
    def meta_data_column_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify a column name in the table, where the metadata information has to be loaded. When you enable this field, you will see the following column in the snowflake table, which differs based on the source type.
    ...
    def meta_data_column_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeliveryStreamSnowflakeRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: the time period where Firehose will retry sending data to the chosen HTTP endpoint.
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamSnowflakeRoleConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Enable Snowflake role
        :param pulumi.Input[builtins.str] snowflake_role: The Snowflake role you wish to configure
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class DeliveryStreamSnowflakeVpcConfigurationArgs:
    def __init__(__self__, *,
                 private_link_vpce_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] private_link_vpce_id: The VPCE ID for Firehose to privately connect with Snowflake. The ID format is com.amazonaws.vpce.[region].vpce-svc-<[id]>. For more information, see [Amazon PrivateLink & Snowflake](https://docs.aws.amazon.com/https://docs.snowflake.com/en/user-guide/admin-security-privatelink)
        """
...
class DeliveryStreamSplunkBufferingHintsArgs:
    def __init__(__self__, *,
                 ...
                 size_in_mbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 60 (1 minute).
        :param pulumi.Input[builtins.int] size_in_mbs: Buffer incoming data to the specified size, in MBs, before delivering it to the destination. The default value is 5.
        """
        if interval_in_seconds is not None:
            pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
...
if not MYPY:
    class DeliveryStreamSplunkDestinationConfigurationArgsDict(TypedDict):
        ...
        The Amazon CloudWatch logging options for your Firehose stream.
        """
        hec_acknowledgment_timeout_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeliveryStreamSplunkDestinationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 cloud_watch_logging_options: Optional[pulumi.Input['DeliveryStreamCloudWatchLoggingOptionsArgs']] = None,
                 hec_acknowledgment_timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 secrets_manager_configuration: Optional[pulumi.Input['DeliveryStreamSecretsManagerConfigurationArgs']] = None):
        """
        :param pulumi.Input[builtins.str] hec_endpoint: The HTTP Event Collector (HEC) endpoint to which Firehose sends your data.
        ...
        :param pulumi.Input['DeliveryStreamCloudWatchLoggingOptionsArgs'] cloud_watch_logging_options: The Amazon CloudWatch logging options for your Firehose stream.
        :param pulumi.Input[builtins.int] hec_acknowledgment_timeout_in_seconds: The amount of time that Firehose waits to receive an acknowledgment from Splunk after it sends it data. At the end of the timeout period, Firehose either tries to send the data again or considers it an error, based on your retry settings.
        :param pulumi.Input[builtins.str] hec_token: This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.
    ...
    def hec_acknowledgment_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of time that Firehose waits to receive an acknowledgment from Splunk after it sends it data. At the end of the timeout period, Firehose either tries to send the data again or considers it an error, based on your retry settings.
        """
    ...
    def hec_acknowledgment_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeliveryStreamSplunkRetryOptionsArgs:
    def __init__(__self__, *,
                 duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: The total amount of time that Firehose spends on retries. This duration starts after the initial attempt to send data to Splunk fails. It doesn't include the periods during which Firehose waits for acknowledgment from Splunk after each attempt.
        """
        if duration_in_seconds is not None:
            pulumi.set(__self__, "duration_in_seconds", duration_in_seconds)
...
class DeliveryStreamTableCreationConfigurationArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Specify whether you want to enable automatic table creation.
...
class DeliveryStreamVpcConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM role that you want the delivery stream to use to create endpoints in the destination VPC. You can use your existing Kinesis Data Firehose delivery role or you can specify a new role. In either case, make sure that the role trusts the Kinesis Data Firehose service principal and that it grants the following permissions:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The IDs of the subnets that Kinesis Data Firehose uses to create ENIs in the VPC of the Amazon ES destination. Make sure that the routing tables and inbound and outbound rules allow traffic to flow from the subnets whose IDs are specified here to the subnets that have the destination Amazon ES endpoints. Kinesis Data Firehose creates at least one ENI in each of the subnets that are specified here. Do not delete or modify these ENIs.
