...
class DeliveryStreamArgs:
    def __init__(__self__, *,
                 ...
                 delivery_stream_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] delivery_stream_name: The name of the Firehose stream.
    ...
    def delivery_stream_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_stream_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeliveryStream(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deliveryStreamName")
    def delivery_stream_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Firehose stream.
        """
        return pulumi.get(self, "delivery_stream_name")
