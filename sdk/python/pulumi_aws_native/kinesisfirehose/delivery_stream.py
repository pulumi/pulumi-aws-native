...
class DeliveryStream(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(amazon_open_search_serverless_destination_configuration, DeliveryStreamAmazonOpenSearchServerlessDestinationConfigurationArgs):
            ...
            if not isinstance(amazonopensearchservice_destination_configuration, DeliveryStreamAmazonopensearchserviceDestinationConfigurationArgs):
            ...
            if not isinstance(delivery_stream_encryption_configuration_input, DeliveryStreamEncryptionConfigurationInputArgs):
            ...
            if not isinstance(elasticsearch_destination_configuration, DeliveryStreamElasticsearchDestinationConfigurationArgs):
            ...
            if not isinstance(extended_s3_destination_configuration, DeliveryStreamExtendedS3DestinationConfigurationArgs):
            ...
            if not isinstance(http_endpoint_destination_configuration, DeliveryStreamHttpEndpointDestinationConfigurationArgs):
            ...
            if not isinstance(kinesis_stream_source_configuration, DeliveryStreamKinesisStreamSourceConfigurationArgs):
            ...
            if not isinstance(redshift_destination_configuration, DeliveryStreamRedshiftDestinationConfigurationArgs):
            ...
            if not isinstance(s3_destination_configuration, DeliveryStreamS3DestinationConfigurationArgs):
            ...
            if not isinstance(splunk_destination_configuration, DeliveryStreamSplunkDestinationConfigurationArgs):
