...
class Memory(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 namespace_keys: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MemoryNamespaceKeyEntryArgs', 'MemoryNamespaceKeyEntryArgsDict', 'outputs.MemoryNamespaceKeyEntry']]]]] = None,
