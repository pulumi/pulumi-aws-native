...
def get_gateway_target(gateway_identifier: Optional[builtins.str] = None,
...
def get_gateway_target_output(gateway_identifier: Optional[pulumi.Input[builtins.str]] = None,
