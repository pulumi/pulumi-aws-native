...
class GetGatewayResult:
    ...
    def gateway_arn(self) -> Optional[builtins.str]:
        return pulumi.get(self, "gateway_arn")

    @property
    @pulumi.getter(name="gatewayIdentifier")
    def gateway_identifier(self) -> Optional[builtins.str]:
        return pulumi.get(self, "gateway_identifier")

    @property
    @pulumi.getter(name="gatewayUrl")
    def gateway_url(self) -> Optional[builtins.str]:
...
def get_gateway(gateway_identifier: Optional[builtins.str] = None,
...
def get_gateway_output(gateway_identifier: Optional[pulumi.Input[builtins.str]] = None,
