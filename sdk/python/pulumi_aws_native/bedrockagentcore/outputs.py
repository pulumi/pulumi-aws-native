...
class MemoryCustomMemoryStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 strategy_id: Optional[builtins.str] = None,
                 type: Optional['MemoryCustomMemoryStrategyType'] = None,
                 updated_at: Optional[builtins.str] = None):
        """
        :param builtins.str created_at: Creation timestamp of the memory strategy
        :param 'MemoryCustomMemoryStrategyStatus' status: Status of the memory strategy
        :param builtins.str strategy_id: Unique identifier for the memory strategy
        :param 'MemoryCustomMemoryStrategyType' type: Type of memory strategy
        :param builtins.str updated_at: Last update timestamp of the memory strategy
        """
        pulumi.set(__self__, "name", name)
    ...
    def strategy_id(self) -> Optional[builtins.str]:
        """
...
class MemoryInvocationConfigurationInput(dict):
    ...
    def __init__(__self__, *,
                 payload_delivery_bucket_name: Optional[builtins.str] = None,
    ...
    def payload_delivery_bucket_name(self) -> Optional[builtins.str]:
...
class MemorySelfManagedConfiguration(dict):
    ...
    def __init__(__self__, *,
                 historical_context_window_size: Optional[builtins.int] = None,
    ...
    def historical_context_window_size(self) -> Optional[builtins.int]:
...
class MemoryTimeBasedTriggerInput(dict):
    ...
    def __init__(__self__, *,
                 idle_session_timeout: Optional[builtins.int] = None):
    ...
    def idle_session_timeout(self) -> Optional[builtins.int]:
...
class MemoryTokenBasedTriggerInput(dict):
    ...
    def __init__(__self__, *,
                 token_count: Optional[builtins.int] = None):
        if token_count is not None:
            pulumi.set(__self__, "token_count", token_count)

    @property
    @pulumi.getter(name="tokenCount")
    def token_count(self) -> Optional[builtins.int]:
