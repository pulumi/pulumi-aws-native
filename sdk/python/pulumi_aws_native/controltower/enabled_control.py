...
class EnabledControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] control_identifier: Arn of the control.
        :param pulumi.Input[builtins.str] target_identifier: Arn for Organizational unit to which the control needs to be applied
    ...
    def control_identifier(self) -> pulumi.Input[builtins.str]:
        """
        Arn of the control.
        """
    ...
    def control_identifier(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:controltower:EnabledControl")
class EnabledControl(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="controlIdentifier")
    def control_identifier(self) -> pulumi.Output[builtins.str]:
        """
        Arn of the control.
        """
        return pulumi.get(self, "control_identifier")
