...
class GetEnabledBaselineResult:
    ...
    def baseline_version(self) -> Optional[_builtins.str]:
        """
    ...
    def enabled_baseline_identifier(self) -> Optional[_builtins.str]:
...
def get_enabled_baseline(enabled_baseline_identifier: Optional[_builtins.str] = None,
...
def get_enabled_baseline_output(enabled_baseline_identifier: Optional[pulumi.Input[_builtins.str]] = None,
