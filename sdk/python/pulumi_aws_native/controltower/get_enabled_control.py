...
def get_enabled_control(control_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str control_identifier: Arn of the control.
    :param builtins.str target_identifier: Arn for Organizational unit to which the control needs to be applied
    """
    __args__ = dict()
...
def get_enabled_control_output(control_identifier: Optional[pulumi.Input[builtins.str]] = None,
