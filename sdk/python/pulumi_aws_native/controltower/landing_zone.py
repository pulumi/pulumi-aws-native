...
class LandingZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] version: The landing zone's current deployed version.
...
@pulumi.type_token("aws-native:controltower:LandingZone")
class LandingZone(pulumi.CustomResource):
    ...
    def landing_zone_identifier(self) -> pulumi.Output[builtins.str]:
        """
