...
class GetLandingZoneResult:
    ...
    def landing_zone_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def latest_available_version(self) -> Optional[builtins.str]:
        """
...
def get_landing_zone(landing_zone_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str landing_zone_identifier: The unique identifier of the landing zone.
    """
    __args__ = dict()
...
def get_landing_zone_output(landing_zone_identifier: Optional[pulumi.Input[builtins.str]] = None,
