...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 parent_target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Deployment resource.
        :param pulumi.Input[builtins.str] target_arn: The ARN of the target AWS IoT thing or thing group.
        ...
        :param pulumi.Input[builtins.str] parent_target_arn: The parent deployment's [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) for a subdeployment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Application-specific metadata to attach to the deployment. You can use tags in IAM policies to control access to AWS IoT Greengrass resources. You can also use tags to categorize your resources. For more information, see [Tag your AWS IoT Greengrass Version 2 resources](https://docs.aws.amazon.com/greengrass/v2/developerguide/tag-resources.html) in the *AWS IoT Greengrass V2 Developer Guide* .
    ...
    def parent_target_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_target_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Deployment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="parentTargetArn")
    def parent_target_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The parent deployment's [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) for a subdeployment.
        """
        return pulumi.get(self, "parent_target_arn")
