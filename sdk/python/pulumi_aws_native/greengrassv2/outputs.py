...
class ComponentVersionComponentDependencyRequirement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 version_requirement: Optional[_builtins.str] = None):
    ...
    def version_requirement(self) -> Optional[_builtins.str]:
...
class ComponentVersionLambdaContainerParams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 memory_size_in_kb: Optional[_builtins.int] = None,
                 mount_ro_sysfs: Optional[_builtins.bool] = None,
        ...
        :param _builtins.int memory_size_in_kb: The memory size of the container, expressed in kilobytes.
               
               Default: `16384` (16 MB)
        :param _builtins.bool mount_ro_sysfs: Whether or not the container can read information from the device's `/sys` folder.
    ...
    def memory_size_in_kb(self) -> Optional[_builtins.int]:
        """
    ...
    def mount_ro_sysfs(self) -> Optional[_builtins.bool]:
        """
...
class ComponentVersionLambdaDeviceMount(dict):
    ...
    def __init__(__self__, *,
                 add_group_owner: Optional[_builtins.bool] = None,
                 path: Optional[_builtins.str] = None,
                 permission: Optional['ComponentVersionLambdaFilesystemPermission'] = None):
        """
        :param _builtins.bool add_group_owner: Whether or not to add the component's system user as an owner of the device.
               
               Default: `false`
        :param _builtins.str path: The mount path for the device in the file system.
    ...
    def add_group_owner(self) -> Optional[_builtins.bool]:
        """
...
class ComponentVersionLambdaEventSource(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str topic: The topic to which to subscribe to receive event messages.
...
class ComponentVersionLambdaExecutionParameters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exec_args: Optional[Sequence[_builtins.str]] = None,
                 ...
                 max_idle_time_in_seconds: Optional[_builtins.int] = None,
                 max_instances_count: Optional[_builtins.int] = None,
                 max_queue_size: Optional[_builtins.int] = None,
                 pinned: Optional[_builtins.bool] = None,
                 status_timeout_in_seconds: Optional[_builtins.int] = None,
                 timeout_in_seconds: Optional[_builtins.int] = None):
        """
        :param Mapping[str, _builtins.str] environment_variables: The map of environment variables that are available to the Lambda function when it runs.
        ...
        :param Sequence[_builtins.str] exec_args: The list of arguments to pass to the Lambda function when it runs.
        ...
        :param _builtins.int max_idle_time_in_seconds: The maximum amount of time in seconds that a non-pinned Lambda function can idle before the AWS IoT Greengrass Core software stops its process.
        :param _builtins.int max_instances_count: The maximum number of instances that a non-pinned Lambda function can run at the same time.
        :param _builtins.int max_queue_size: The maximum size of the message queue for the Lambda function component. The AWS IoT Greengrass core device stores messages in a FIFO (first-in-first-out) queue until it can run the Lambda function to consume each message.
        :param _builtins.bool pinned: Whether or not the Lambda function is pinned, or long-lived.
               ...
               Default: `true`
        :param _builtins.int status_timeout_in_seconds: The interval in seconds at which a pinned (also known as long-lived) Lambda function component sends status updates to the Lambda manager component.
        :param _builtins.int timeout_in_seconds: The maximum amount of time in seconds that the Lambda function can process a work item.
        """
    ...
    def exec_args(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def max_idle_time_in_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def max_instances_count(self) -> Optional[_builtins.int]:
        """
    ...
    def max_queue_size(self) -> Optional[_builtins.int]:
        """
    ...
    def status_timeout_in_seconds(self) -> Optional[_builtins.int]:
        """
...
class ComponentVersionLambdaFunctionRecipeSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str component_version: The version of the component.
               
               Defaults to the version of the Lambda function as a semantic version. For example, if your function version is `3` , the component version becomes `3.0.0` .
        :param _builtins.str lambda_arn: The ARN of the Lambda function. The ARN must include the version of the function to import. You can't use version aliases like `$LATEST` .
        """
...
class ComponentVersionLambdaVolumeMount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool add_group_owner: Whether or not to add the AWS IoT Greengrass user group as an owner of the volume.
               
               Default: `false`
        :param _builtins.str destination_path: The path to the logical volume in the file system.
        :param 'ComponentVersionLambdaFilesystemPermission' permission: The permission to access the volume: read/only ( `ro` ) or read/write ( `rw` ).
               ...
               Default: `ro`
        :param _builtins.str source_path: The path to the physical volume in the file system.
        """
        if add_group_owner is not None:
            pulumi.set(__self__, "add_group_owner", add_group_owner)
...
class DeploymentComponentConfigurationUpdate(dict):
    def __init__(__self__, *,
                 merge: Optional[_builtins.str] = None,
                 reset: Optional[Sequence[_builtins.str]] = None):
    ...
    @_builtins.property
    @pulumi.getter
    def merge(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "merge")

    @_builtins.property
    @pulumi.getter
    def reset(self) -> Optional[Sequence[_builtins.str]]:
...
class DeploymentComponentRunWith(dict):
    ...
    def __init__(__self__, *,
                 posix_user: Optional[_builtins.str] = None,
                 system_resource_limits: Optional['outputs.DeploymentSystemResourceLimits'] = None,
                 windows_user: Optional[_builtins.str] = None):
    ...
    def posix_user(self) -> Optional[_builtins.str]:
    ...
    def windows_user(self) -> Optional[_builtins.str]:
...
class DeploymentComponentUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int timeout_in_seconds: The amount of time in seconds that each component on a device has to report that it's safe to update. If the component waits for longer than this timeout, then the deployment proceeds on the device.
...
class DeploymentConfigurationValidationPolicy(dict):
    ...
    def __init__(__self__, *,
                 timeout_in_seconds: Optional[_builtins.int] = None):
        """
        :param _builtins.int timeout_in_seconds: The amount of time in seconds that a component can validate its configuration updates. If the validation time exceeds this timeout, then the deployment proceeds for the device.
...
class DeploymentIoTJobAbortCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int min_number_of_executed_things: The minimum number of things that receive the configuration before the job can cancel.
        :param _builtins.float threshold_percentage: The minimum percentage of `failureType` failures that occur before the job can cancel.
...
class DeploymentIoTJobExecutionsRolloutConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int maximum_per_minute: The maximum number of devices that receive a pending job notification, per minute.
        """
...
class DeploymentIoTJobExponentialRolloutRate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int base_rate_per_minute: The minimum number of devices that receive a pending job notification, per minute, when the job starts. This parameter defines the initial rollout rate of the job.
        :param _builtins.float increment_factor: The exponential factor to increase the rollout rate for the job.
...
class DeploymentIoTJobTimeoutConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int in_progress_timeout_in_minutes: The amount of time, in minutes, that devices have to complete the job. The timer starts when the job status is set to `IN_PROGRESS` . If the job status doesn't change to a terminal state before the time expires, then the job status is set to `TIMED_OUT` .
