...
class ComponentVersionLambdaContainerParamsArgsDict(TypedDict):
    devices: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComponentVersionLambdaDeviceMountArgsDict']]]]]
    """
    ...
    Default: `false`
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComponentVersionLambdaVolumeMountArgsDict']]]]]
    """
...
class ComponentVersionLambdaContainerParamsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] memory_size_in_kb: The memory size of the container, expressed in kilobytes.
               ...
               Default: `16384` (16 MB)
        :param pulumi.Input[_builtins.bool] mount_ro_sysfs: Whether or not the container can read information from the device's `/sys` folder.
...
class ComponentVersionLambdaDeviceMountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] add_group_owner: Whether or not to add the component's system user as an owner of the device.
               ...
               Default: `false`
        :param pulumi.Input[_builtins.str] path: The mount path for the device in the file system.
...
class ComponentVersionLambdaExecutionParametersArgsDict(TypedDict):
    ...
    """
    event_sources: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComponentVersionLambdaEventSourceArgsDict']]]]]
    """
    ...
    Default: `json`
    """
    linux_process_params: NotRequired[pulumi.Input[Optional['ComponentVersionLambdaLinuxProcessParamsArgsDict']]]
    """
...
class ComponentVersionLambdaExecutionParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] exec_args: The list of arguments to pass to the Lambda function when it runs.
        ...
        :param pulumi.Input[_builtins.int] max_idle_time_in_seconds: The maximum amount of time in seconds that a non-pinned Lambda function can idle before the AWS IoT Greengrass Core software stops its process.
        :param pulumi.Input[_builtins.int] max_instances_count: The maximum number of instances that a non-pinned Lambda function can run at the same time.
        :param pulumi.Input[_builtins.int] max_queue_size: The maximum size of the message queue for the Lambda function component. The AWS IoT Greengrass core device stores messages in a FIFO (first-in-first-out) queue until it can run the Lambda function to consume each message.
        :param pulumi.Input[_builtins.bool] pinned: Whether or not the Lambda function is pinned, or long-lived.
               
               - A pinned Lambda function starts when the AWS IoT Greengrass Core starts and keeps running in its own container.
               - A non-pinned Lambda function starts only when it receives a work item and exists after it idles for `maxIdleTimeInSeconds` . If the function has multiple work items, the AWS IoT Greengrass Core software creates multiple instances of the function.
               
               Default: `true`
        :param pulumi.Input[_builtins.int] status_timeout_in_seconds: The interval in seconds at which a pinned (also known as long-lived) Lambda function component sends status updates to the Lambda manager component.
        :param pulumi.Input[_builtins.int] timeout_in_seconds: The maximum amount of time in seconds that the Lambda function can process a work item.
        """
...
class ComponentVersionLambdaFunctionRecipeSourceArgsDict(TypedDict):
    component_dependencies: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['ComponentVersionComponentDependencyRequirementArgsDict']]]]]
    """
    The component versions on which this Lambda function component depends.
    """
    component_lambda_parameters: NotRequired[pulumi.Input[Optional['ComponentVersionLambdaExecutionParametersArgsDict']]]
    """
    ...
    """
    component_platforms: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ComponentVersionComponentPlatformArgsDict']]]]]
    """
...
class ComponentVersionLambdaFunctionRecipeSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] component_version: The version of the component.
               
               Defaults to the version of the Lambda function as a semantic version. For example, if your function version is `3` , the component version becomes `3.0.0` .
        :param pulumi.Input[_builtins.str] lambda_arn: The ARN of the Lambda function. The ARN must include the version of the function to import. You can't use version aliases like `$LATEST` .
        """
...
class ComponentVersionLambdaLinuxProcessParamsArgsDict(TypedDict):
    container_params: NotRequired[pulumi.Input[Optional['ComponentVersionLambdaContainerParamsArgsDict']]]
    """
...
class ComponentVersionLambdaVolumeMountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] add_group_owner: Whether or not to add the AWS IoT Greengrass user group as an owner of the volume.
               ...
               Default: `false`
        :param pulumi.Input[_builtins.str] destination_path: The path to the logical volume in the file system.
        :param pulumi.Input['ComponentVersionLambdaFilesystemPermission'] permission: The permission to access the volume: read/only ( `ro` ) or read/write ( `rw` ).
               ...
               Default: `ro`
        :param pulumi.Input[_builtins.str] source_path: The path to the physical volume in the file system.
        """
        if add_group_owner is not None:
            pulumi.set(__self__, "add_group_owner", add_group_owner)
...
class DeploymentComponentDeploymentSpecificationArgsDict(TypedDict):
    component_version: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    configuration_update: NotRequired[pulumi.Input[Optional['DeploymentComponentConfigurationUpdateArgsDict']]]
    run_with: NotRequired[pulumi.Input[Optional['DeploymentComponentRunWithArgsDict']]]
...
class DeploymentComponentRunWithArgsDict(TypedDict):
    ...
    system_resource_limits: NotRequired[pulumi.Input[Optional['DeploymentSystemResourceLimitsArgsDict']]]
...
class DeploymentComponentUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DeploymentComponentUpdatePolicyAction'] action: Whether or not to notify components and wait for components to become safe to update. Choose from the following options:
               ...
               Default: `NOTIFY_COMPONENTS`
        :param pulumi.Input[_builtins.int] timeout_in_seconds: The amount of time in seconds that each component on a device has to report that it's safe to update. If the component waits for longer than this timeout, then the deployment proceeds on the device.
...
class DeploymentIoTJobAbortCriteriaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_number_of_executed_things: The minimum number of things that receive the configuration before the job can cancel.
        :param pulumi.Input[_builtins.float] threshold_percentage: The minimum percentage of `failureType` failures that occur before the job can cancel.
...
class DeploymentIoTJobConfigurationArgsDict(TypedDict):
    abort_config: NotRequired[pulumi.Input[Optional['DeploymentIoTJobAbortConfigArgsDict']]]
    """
    The stop configuration for the job. This configuration defines when and how to stop a job rollout.
    """
    job_executions_rollout_config: NotRequired[pulumi.Input[Optional['DeploymentIoTJobExecutionsRolloutConfigArgsDict']]]
    """
    The rollout configuration for the job. This configuration defines the rate at which the job rolls out to the fleet of target devices.
    """
    timeout_config: NotRequired[pulumi.Input[Optional['DeploymentIoTJobTimeoutConfigArgsDict']]]
    """
...
class DeploymentIoTJobExecutionsRolloutConfigArgsDict(TypedDict):
    exponential_rate: NotRequired[pulumi.Input[Optional['DeploymentIoTJobExponentialRolloutRateArgsDict']]]
    """
...
class DeploymentIoTJobExponentialRolloutRateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] base_rate_per_minute: The minimum number of devices that receive a pending job notification, per minute, when the job starts. This parameter defines the initial rollout rate of the job.
        :param pulumi.Input[_builtins.float] increment_factor: The exponential factor to increase the rollout rate for the job.
...
class DeploymentPoliciesArgsDict(TypedDict):
    component_update_policy: NotRequired[pulumi.Input[Optional['DeploymentComponentUpdatePolicyArgsDict']]]
    """
    The component update policy for the configuration deployment. This policy defines when it's safe to deploy the configuration to devices.
    """
    configuration_validation_policy: NotRequired[pulumi.Input[Optional['DeploymentConfigurationValidationPolicyArgsDict']]]
    """
