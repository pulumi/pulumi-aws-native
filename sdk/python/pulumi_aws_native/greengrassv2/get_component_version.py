...
def get_component_version(arn: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComponentVersionResult:
    """
    Resource for Greengrass component version.


    :param builtins.str arn: The ARN of the component version.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_component_version_output(arn: Optional[pulumi.Input[builtins.str]] = None,
