...
__all__ = [
    'GetTransitVirtualInterfaceResult',
    'AwaitableGetTransitVirtualInterfaceResult',
    'get_transit_virtual_interface',
    'get_transit_virtual_interface_output',
]
...
class GetTransitVirtualInterfaceResult:
    ...
    def bgp_peers(self) -> Optional[Sequence['outputs.TransitVirtualInterfaceBgpPeer']]:
        """
...
class AwaitableGetTransitVirtualInterfaceResult(GetTransitVirtualInterfaceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTransitVirtualInterfaceResult(
...
def get_transit_virtual_interface(virtual_interface_arn: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitVirtualInterfaceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:directconnect:getTransitVirtualInterface', __args__, opts=opts, typ=GetTransitVirtualInterfaceResult).value

    return AwaitableGetTransitVirtualInterfaceResult(
...
def get_transit_virtual_interface_output(virtual_interface_arn: Optional[pulumi.Input[_builtins.str]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTransitVirtualInterfaceResult]:
    """
    Resource Type definition for AWS::DirectConnect::TransitVirtualInterface
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:directconnect:getTransitVirtualInterface', __args__, opts=opts, typ=GetTransitVirtualInterfaceResult)
    return __ret__.apply(lambda __response__: GetTransitVirtualInterfaceResult(
