...
class PrivateVirtualInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 allocate_private_virtual_interface_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 virtual_gateway_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def allocate_private_virtual_interface_role_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def allocate_private_virtual_interface_role_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def virtual_gateway_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def virtual_gateway_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class PrivateVirtualInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allocate_private_virtual_interface_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 bgp_peers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PrivateVirtualInterfaceBgpPeerArgs', 'PrivateVirtualInterfaceBgpPeerArgsDict', 'outputs.PrivateVirtualInterfaceBgpPeer']]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] allocate_private_virtual_interface_role_arn: The Amazon Resource Name (ARN) of the role to allocate the private virtual interface. Needs directconnect:AllocatePrivateVirtualInterface permissions and tag permissions if applicable.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PrivateVirtualInterfaceBgpPeerArgs', 'PrivateVirtualInterfaceBgpPeerArgsDict', 'outputs.PrivateVirtualInterfaceBgpPeer']]]] bgp_peers: The BGP peers configured on this virtual interface.
        :param pulumi.Input[_builtins.str] connection_id: The ID or ARN of the connection or LAG.
        :param pulumi.Input[_builtins.str] direct_connect_gateway_id: The ID or ARN of the Direct Connect gateway.
        :param pulumi.Input[_builtins.bool] enable_site_link: Indicates whether to enable or disable SiteLink.
        :param pulumi.Input[_builtins.int] mtu: The maximum transmission unit (MTU), in bytes. The supported values are 1500 and 9001. The default value is 1500.
