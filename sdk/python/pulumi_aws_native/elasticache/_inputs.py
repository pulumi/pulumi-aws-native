...
class CacheClusterDestinationDetailsArgsDict(TypedDict):
    cloud_watch_logs_details: NotRequired[pulumi.Input[Optional['CacheClusterCloudWatchLogsDestinationDetailsArgs']]]
    """
    The configuration details of the CloudWatch Logs destination
    """
    kinesis_firehose_details: NotRequired[pulumi.Input[Optional['CacheClusterKinesisFirehoseDestinationDetailsArgs']]]
    """
