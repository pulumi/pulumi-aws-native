...
if not MYPY:
    class GlobalReplicationGroupMemberArgsDict(TypedDict):
        replication_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Regionally unique identifier for the member i.e. ReplicationGroupId.
        """
        replication_group_region: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GlobalReplicationGroupMemberArgs:
    def __init__(__self__, *,
                 ...
                 replication_group_region: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input['GlobalReplicationGroupMemberRole']] = None):
        """
        :param pulumi.Input[builtins.str] replication_group_id: Regionally unique identifier for the member i.e. ReplicationGroupId.
        :param pulumi.Input[builtins.str] replication_group_region: The AWS region of the Global Datastore member.
    ...
    def replication_group_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The AWS region of the Global Datastore member.
        """
    ...
    def replication_group_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GlobalReplicationGroupRegionalConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] replication_group_id: The replication group id of the Global Datastore member.
        :param pulumi.Input[builtins.str] replication_group_region: The AWS region of the Global Datastore member.
...
if not MYPY:
    class GlobalReplicationGroupReshardingConfigurationArgsDict(TypedDict):
        ...
        """
        preferred_availability_zones: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class GlobalReplicationGroupReshardingConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] node_group_id: Unique identifier for the Node Group. This is either auto-generated by ElastiCache (4-digit id) or a user supplied id.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] preferred_availability_zones: A list of preferred availability zones for the nodes of new node groups.
        """
...
class ServerlessCacheDataStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] maximum: The maximum cached data capacity of the Serverless Cache.
        :param pulumi.Input[builtins.int] minimum: The minimum cached data capacity of the Serverless Cache.
        """
...
class ServerlessCacheEcpuPerSecondArgs:
    def __init__(__self__, *,
        ...
        """
        The ECPU per second of the Serverless Cache.
        :param pulumi.Input[builtins.int] maximum: The maximum ECPU per second of the Serverless Cache.
        :param pulumi.Input[builtins.int] minimum: The minimum ECPU per second of the Serverless Cache.
        """
        if maximum is not None:
            pulumi.set(__self__, "maximum", maximum)
        if minimum is not None:
...
class ServerlessCacheEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        The address and the port.
        :param pulumi.Input[builtins.str] address: Endpoint address.
        :param pulumi.Input[builtins.str] port: Endpoint port.
        """
