...
class GlobalReplicationGroupMember(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replication_group_region: Optional[builtins.str] = None,
                 role: Optional['GlobalReplicationGroupMemberRole'] = None):
        """
        :param builtins.str replication_group_id: Regionally unique identifier for the member i.e. ReplicationGroupId.
        :param builtins.str replication_group_region: The AWS region of the Global Datastore member.
    ...
    def replication_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def replication_group_region(self) -> Optional[builtins.str]:
        """
...
class GlobalReplicationGroupRegionalConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str replication_group_id: The replication group id of the Global Datastore member.
        :param builtins.str replication_group_region: The AWS region of the Global Datastore member.
...
class GlobalReplicationGroupReshardingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preferred_availability_zones: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str node_group_id: Unique identifier for the Node Group. This is either auto-generated by ElastiCache (4-digit id) or a user supplied id.
        :param Sequence[builtins.str] preferred_availability_zones: A list of preferred availability zones for the nodes of new node groups.
        """
    ...
    def preferred_availability_zones(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ServerlessCacheDataStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int maximum: The maximum cached data capacity of the Serverless Cache.
        :param builtins.int minimum: The minimum cached data capacity of the Serverless Cache.
        """
...
class ServerlessCacheEcpuPerSecond(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The ECPU per second of the Serverless Cache.
        :param builtins.int maximum: The maximum ECPU per second of the Serverless Cache.
        :param builtins.int minimum: The minimum ECPU per second of the Serverless Cache.
        """
        if maximum is not None:
            pulumi.set(__self__, "maximum", maximum)
        if minimum is not None:
...
class ServerlessCacheEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The address and the port.
        :param builtins.str address: Endpoint address.
        :param builtins.str port: Endpoint port.
        """
