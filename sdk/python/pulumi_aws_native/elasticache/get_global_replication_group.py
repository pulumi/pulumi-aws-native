...
class GetGlobalReplicationGroupResult:
    ...
    def global_replication_group_description(self) -> Optional[_builtins.str]:
        """
    ...
    def global_replication_group_id(self) -> Optional[_builtins.str]:
        """
...
def get_global_replication_group(global_replication_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str global_replication_group_id: The name of the Global Datastore, it is generated by ElastiCache adding a prefix to GlobalReplicationGroupIdSuffix.
    """
    __args__ = dict()
