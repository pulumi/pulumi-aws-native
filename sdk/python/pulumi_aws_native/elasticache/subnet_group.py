...
class SubnetGroupArgs:
    def __init__(__self__, *,
                 ...
                 cache_subnet_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a SubnetGroup resource.
        :param pulumi.Input[builtins.str] description: The description for the cache subnet group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The EC2 subnet IDs for the cache subnet group.
        :param pulumi.Input[builtins.str] cache_subnet_group_name: The name for the cache subnet group. This value is stored as a lowercase string.
    ...
    def cache_subnet_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cache_subnet_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SubnetGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cacheSubnetGroupName")
    def cache_subnet_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name for the cache subnet group. This value is stored as a lowercase string.
        """
        return pulumi.get(self, "cache_subnet_group_name")
