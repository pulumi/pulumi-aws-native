...
def get_cache_cluster(id: Optional[str] = None,
    ...
    return AwaitableGetCacheClusterResult(
        ...
        configuration_endpoint_port=pulumi.get(__ret__, 'configuration_endpoint_port'),
        ...
        preferred_availability_zone=pulumi.get(__ret__, 'preferred_availability_zone'),
        ...
        redis_endpoint_address=pulumi.get(__ret__, 'redis_endpoint_address'),
        redis_endpoint_port=pulumi.get(__ret__, 'redis_endpoint_port'),
