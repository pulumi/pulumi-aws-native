...
class ServerlessCacheArgs:
    def __init__(__self__, *,
                 ...
                 serverless_cache_name: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_arns_to_restore: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] engine: The engine name of the Serverless Cache.
        :param pulumi.Input['ServerlessCacheCacheUsageLimitsArgs'] cache_usage_limits: The cache usage limit for the serverless cache.
        :param pulumi.Input[builtins.str] daily_snapshot_time: The daily time range (in UTC) during which the service takes automatic snapshot of the Serverless Cache.
        :param pulumi.Input[builtins.str] description: The description of the Serverless Cache.
        ...
        :param pulumi.Input[builtins.str] final_snapshot_name: The final snapshot name which is taken before Serverless Cache is deleted.
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the KMS key used to encrypt the cluster.
        :param pulumi.Input[builtins.str] major_engine_version: The major engine version of the Serverless Cache.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: One or more Amazon VPC security groups associated with this Serverless Cache.
        :param pulumi.Input[builtins.str] serverless_cache_name: The name of the Serverless Cache. This value must be unique.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] snapshot_arns_to_restore: The ARN's of snapshot to restore Serverless Cache.
        :param pulumi.Input[builtins.int] snapshot_retention_limit: The snapshot retention limit of the Serverless Cache.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The subnet id's of the Serverless Cache.
    ...
    def serverless_cache_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def serverless_cache_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "serverless_cache_name", value)

    @property
    @pulumi.getter(name="snapshotArnsToRestore")
    def snapshot_arns_to_restore(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def snapshot_arns_to_restore(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ServerlessCache(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dailySnapshotTime")
    def daily_snapshot_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The daily time range (in UTC) during which the service takes automatic snapshot of the Serverless Cache.
        """
        return pulumi.get(self, "daily_snapshot_time")
    ...
    @property
    @pulumi.getter(name="majorEngineVersion")
    def major_engine_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The major engine version of the Serverless Cache.
        """
        return pulumi.get(self, "major_engine_version")
    ...
    @property
    @pulumi.getter(name="serverlessCacheName")
    def serverless_cache_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Serverless Cache. This value must be unique.
        """
        return pulumi.get(self, "serverless_cache_name")
    ...
    @property
    @pulumi.getter(name="snapshotArnsToRestore")
    def snapshot_arns_to_restore(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ARN's of snapshot to restore Serverless Cache.
        """
        return pulumi.get(self, "snapshot_arns_to_restore")
