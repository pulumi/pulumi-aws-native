...
class ParameterGroupArgs:
    def __init__(__self__, *,
                 cache_parameter_group_family: pulumi.Input[builtins.str],
                 description: pulumi.Input[builtins.str],
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a ParameterGroup resource.
        :param pulumi.Input[builtins.str] cache_parameter_group_family: The name of the cache parameter group family that this cache parameter group is compatible with.
        :param pulumi.Input[builtins.str] description: The description for this cache parameter group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A comma-delimited list of parameter name/value pairs. For more information see ModifyCacheParameterGroup in the Amazon ElastiCache API Reference Guide.
    ...
    def cache_parameter_group_family(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cache_parameter_group_family(self, value: pulumi.Input[builtins.str]):
...
class ParameterGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cache_parameter_group_family: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="cacheParameterGroupFamily")
    def cache_parameter_group_family(self) -> pulumi.Output[builtins.str]:
        """
        The name of the cache parameter group family that this cache parameter group is compatible with.
        """
        return pulumi.get(self, "cache_parameter_group_family")
    ...
    def cache_parameter_group_name(self) -> pulumi.Output[builtins.str]:
        """
