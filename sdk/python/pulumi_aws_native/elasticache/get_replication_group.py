...
def get_replication_group(replication_group_id: Optional[str] = None,
    ...
    return AwaitableGetReplicationGroupResult(
        ...
        configuration_end_point_address=pulumi.get(__ret__, 'configuration_end_point_address'),
        configuration_end_point_port=pulumi.get(__ret__, 'configuration_end_point_port'),
        ...
        node_group_configuration=pulumi.get(__ret__, 'node_group_configuration'),
        ...
        primary_end_point_address=pulumi.get(__ret__, 'primary_end_point_address'),
        primary_end_point_port=pulumi.get(__ret__, 'primary_end_point_port'),
        read_end_point_addresses=pulumi.get(__ret__, 'read_end_point_addresses'),
        read_end_point_addresses_list=pulumi.get(__ret__, 'read_end_point_addresses_list'),
        read_end_point_ports=pulumi.get(__ret__, 'read_end_point_ports'),
        read_end_point_ports_list=pulumi.get(__ret__, 'read_end_point_ports_list'),
        reader_end_point_address=pulumi.get(__ret__, 'reader_end_point_address'),
        reader_end_point_port=pulumi.get(__ret__, 'reader_end_point_port'),
