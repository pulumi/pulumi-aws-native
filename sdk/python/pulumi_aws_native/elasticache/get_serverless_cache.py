...
class GetServerlessCacheResult:
    ...
    def daily_snapshot_time(self) -> Optional[_builtins.str]:
        """
    ...
    def full_engine_version(self) -> Optional[_builtins.str]:
        """
...
def get_serverless_cache(serverless_cache_name: Optional[_builtins.str] = None,
