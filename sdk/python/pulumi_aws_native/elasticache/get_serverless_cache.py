...
class GetServerlessCacheResult:
    ...
    def daily_snapshot_time(self) -> Optional[builtins.str]:
        """
    ...
    def full_engine_version(self) -> Optional[builtins.str]:
        """
    ...
    def major_engine_version(self) -> Optional[builtins.str]:
        """
...
def get_serverless_cache(serverless_cache_name: Optional[builtins.str] = None,
    ...
    :param builtins.str serverless_cache_name: The name of the Serverless Cache. This value must be unique.
    """
    __args__ = dict()
...
def get_serverless_cache_output(serverless_cache_name: Optional[pulumi.Input[builtins.str]] = None,
