...
class InvestigationGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A name for the investigation group.
...
class InvestigationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['InvestigationGroupEncryptionConfigMapArgs', 'InvestigationGroupEncryptionConfigMapArgsDict']] encryption_config: Use this property to specify a customer managed AWS KMS key to encrypt your investigation data. If you omit this property, Amazon Q Developer operational investigations will use an AWS key to encrypt the data. For more information, see [Encryption of investigation data](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-Security.html#Investigations-KMS) .
        :param pulumi.Input[builtins.str] investigation_group_policy: Investigation Group policy
        :param pulumi.Input[builtins.bool] is_cloud_trail_event_history_enabled: Flag to enable cloud trail history
        :param pulumi.Input[builtins.str] name: A name for the investigation group.
        :param pulumi.Input[builtins.int] retention_in_days: The number of days to retain the investigation group
