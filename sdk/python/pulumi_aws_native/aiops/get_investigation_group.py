...
class GetInvestigationGroupResult:
    def __init__(__self__, arn=None, chatbot_notification_channels=None, created_at=None, created_by=None, encryption_config=None, investigation_group_policy=None, is_cloud_trail_event_history_enabled=None, last_modified_at=None, last_modified_by=None, role_arn=None, tag_key_boundaries=None, tags=None):
