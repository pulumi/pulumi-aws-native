...
class RulesetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_arn: Arn of the target resource (dataset) to apply the ruleset to
        :param pulumi.Input[builtins.str] description: Description of the Ruleset
