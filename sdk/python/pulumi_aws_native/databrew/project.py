...
class ProjectArgs:
    def __init__(__self__, *,
                 ...
                 sample: pulumi.Input[Optional['ProjectSampleArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> pulumi.Input[Optional['ProjectSampleArgs']]:
        """
        Sample
        """
    ...
    @sample.setter
    def sample(self, value: pulumi.Input[Optional['ProjectSampleArgs']]):
