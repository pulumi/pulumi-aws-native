...
class DatasetDataCatalogInputDefinitionArgsDict(TypedDict):
    ...
    Table name
    """
    temp_directory: NotRequired[pulumi.Input[Optional['DatasetS3LocationArgsDict']]]
    """
...
class DatasetFormatOptionsArgsDict(TypedDict):
    ...
    """
    csv: NotRequired[pulumi.Input[Optional['DatasetCsvOptionsArgsDict']]]
    """
    Options that define how CSV input is to be interpreted by DataBrew.
    """
    excel: NotRequired[pulumi.Input[Optional['DatasetExcelOptionsArgsDict']]]
    """
    Options that define how Excel input is to be interpreted by DataBrew.
    """
    json: NotRequired[pulumi.Input[Optional['DatasetJsonOptionsArgsDict']]]
    """
...
class DatasetInputArgsDict(TypedDict):
    ...
    Input
    """
    data_catalog_input_definition: NotRequired[pulumi.Input[Optional['DatasetDataCatalogInputDefinitionArgsDict']]]
    """
    The AWS Glue Data Catalog parameters for the data.
    """
    database_input_definition: NotRequired[pulumi.Input[Optional['DatasetDatabaseInputDefinitionArgsDict']]]
    """
    Connection information for dataset input files stored in a database.
    """
    metadata: NotRequired[pulumi.Input[Optional['DatasetMetadataArgsDict']]]
    """
    Contains additional resource information needed for specific datasets.
    """
    s3_input_definition: NotRequired[pulumi.Input[Optional['DatasetS3LocationArgsDict']]]
    """
...
class DatasetParameterArgsDict(TypedDict):
    ...
    """
    datetime_options: NotRequired[pulumi.Input[Optional['DatasetDatetimeOptionsArgsDict']]]
    """
    Additional parameter options such as a format and a timezone. Required for datetime parameters.
    """
    filter: NotRequired[pulumi.Input[Optional['DatasetFilterExpressionArgsDict']]]
    """
...
class DatasetPathOptionsArgsDict(TypedDict):
    ...
    """
    files_limit: NotRequired[pulumi.Input[Optional['DatasetFilesLimitArgsDict']]]
    """
    If provided, this structure imposes a limit on a number of files that should be selected.
    """
    last_modified_date_condition: NotRequired[pulumi.Input[Optional['DatasetFilterExpressionArgsDict']]]
    """
    If provided, this structure defines a date range for matching Amazon S3 objects based on their LastModifiedDate attribute in Amazon S3 .
    """
    parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatasetPathParameterArgsDict']]]]]
    """
...
class JobColumnStatisticsConfigurationArgsDict(TypedDict):
    ...
    """
    selectors: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobColumnSelectorArgsDict']]]]]
    """
...
class JobDataCatalogOutputArgsDict(TypedDict):
    ...
    """
    database_options: NotRequired[pulumi.Input[Optional['JobDatabaseTableOutputOptionsArgsDict']]]
    """
    ...
    """
    s3_options: NotRequired[pulumi.Input[Optional['JobS3TableOutputOptionsArgsDict']]]
    """
...
class JobDatabaseTableOutputOptionsArgsDict(TypedDict):
    ...
    """
    temp_directory: NotRequired[pulumi.Input[Optional['JobS3LocationArgsDict']]]
    """
...
class JobEntityDetectorConfigurationArgsDict(TypedDict):
    ...
    """
    allowed_statistics: NotRequired[pulumi.Input[Optional['JobAllowedStatisticsArgsDict']]]
    """
...
class JobOutputArgsDict(TypedDict):
    ...
    """
    format_options: NotRequired[pulumi.Input[Optional['JobOutputFormatOptionsArgsDict']]]
    """
...
class JobOutputFormatOptionsArgsDict(TypedDict):
    ...
    """
    csv: NotRequired[pulumi.Input[Optional['JobCsvOutputOptionsArgsDict']]]
    """
...
class JobProfileConfigurationArgsDict(TypedDict):
    column_statistics_configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobColumnStatisticsConfigurationArgsDict']]]]]
    """
    List of configurations for column evaluations. ColumnStatisticsConfigurations are used to select evaluations and override parameters of evaluations for particular columns. When ColumnStatisticsConfigurations is undefined, the profile job will profile all supported columns and run all supported evaluations.
    """
    dataset_statistics_configuration: NotRequired[pulumi.Input[Optional['JobStatisticsConfigurationArgsDict']]]
    """
    Configuration for inter-column evaluations. Configuration can be used to select evaluations and override parameters of evaluations. When configuration is undefined, the profile job will run all supported inter-column evaluations.
    """
    entity_detector_configuration: NotRequired[pulumi.Input[Optional['JobEntityDetectorConfigurationArgsDict']]]
    """
    Configuration of entity detection for a profile job. When undefined, entity detection is disabled.
    """
    profile_columns: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobColumnSelectorArgsDict']]]]]
    """
...
class JobStatisticOverrideArgs:
    def __init__(__self__, *,
                 ...
                 statistic: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map that includes overrides of an evaluation’s parameters.
...
class JobStatisticsConfigurationArgsDict(TypedDict):
    ...
    """
    overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['JobStatisticOverrideArgsDict']]]]]
    """
...
class RecipeActionArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional[Union['RecipeParametersArgsDict', Mapping[str, pulumi.Input[_builtins.str]]]]]]
    """
...
class RecipeDataCatalogInputDefinitionArgsDict(TypedDict):
    ...
    Table name
    """
    temp_directory: NotRequired[pulumi.Input[Optional['RecipeS3LocationArgsDict']]]
...
class RecipeParametersArgsDict(TypedDict):
    ...
    input: NotRequired[pulumi.Input[Optional['RecipeParametersInputPropertiesArgsDict']]]
    """
    Input
    """
    ...
    secondary_inputs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RecipeSecondaryInputArgsDict']]]]]
    sheet_indexes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]]
    sheet_names: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
...
class RecipeParametersInputPropertiesArgsDict(TypedDict):
    ...
    Input
    """
    data_catalog_input_definition: NotRequired[pulumi.Input[Optional['RecipeDataCatalogInputDefinitionArgsDict']]]
    s3_input_definition: NotRequired[pulumi.Input[Optional['RecipeS3LocationArgsDict']]]
...
class RecipeStepArgsDict(TypedDict):
    ...
    """
    condition_expressions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RecipeConditionExpressionArgsDict']]]]]
    """
    Condition expressions applied to the step action
    """
...
class RulesetRuleArgsDict(TypedDict):
    ...
    Name of the rule
    """
    column_selectors: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RulesetColumnSelectorArgsDict']]]]]
    """
    ...
    """
    substitution_map: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RulesetSubstitutionValueArgsDict']]]]]
    """
    The map of substitution variable names to their values used in a check expression. Variable names should start with a ':' (colon). Variable values can either be actual values or column names. To differentiate between the two, column names should be enclosed in backticks, for example, `":col1": "`Column A`".`
    """
    threshold: NotRequired[pulumi.Input[Optional['RulesetThresholdArgsDict']]]
    """
