...
class Dataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(format_options, DatasetFormatOptionsArgs):
            ...
            if not isinstance(input, DatasetInputArgs):
                input = input or {}
                def _setter(key, value):
                    input[key] = value
            ...
            if not isinstance(path_options, DatasetPathOptionsArgs):
