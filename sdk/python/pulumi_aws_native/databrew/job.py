...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['JobDataCatalogOutputArgs']]] data_catalog_outputs: Represents options that specify how and where in the AWS Glue Data Catalog DataBrew writes the output generated by recipe jobs.
        :param pulumi.Input[Sequence[pulumi.Input['JobDatabaseOutputArgs']]] database_outputs: Represents a JDBC database output object which defines the output destination for a DataBrew recipe job to write into.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['JobOutputArgs']]] outputs: Represents options that specify how and where in Amazon S3 DataBrew writes the output generated by recipe jobs or profile jobs.
        ...
        :param pulumi.Input['JobRecipeArgs'] recipe: Represents one or more actions to be performed on a DataBrew dataset.
...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['JobDataCatalogOutputArgs']]]] data_catalog_outputs: Represents options that specify how and where in the AWS Glue Data Catalog DataBrew writes the output generated by recipe jobs.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['JobDatabaseOutputArgs']]]] database_outputs: Represents a JDBC database output object which defines the output destination for a DataBrew recipe job to write into.
        :param pulumi.Input[str] dataset_name: Dataset name
        :param pulumi.Input[str] encryption_key_arn: Encryption Key Arn
        :param pulumi.Input['JobEncryptionMode'] encryption_mode: Encryption mode
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['JobOutputArgs']]]] outputs: Represents options that specify how and where in Amazon S3 DataBrew writes the output generated by recipe jobs or profile jobs.
        :param pulumi.Input[pulumi.InputType['JobProfileConfigurationArgs']] profile_configuration: Profile Job configuration
        :param pulumi.Input[str] project_name: Project name
        :param pulumi.Input[pulumi.InputType['JobRecipeArgs']] recipe: Represents one or more actions to be performed on a DataBrew dataset.
        :param pulumi.Input[str] role_arn: Role arn
