...
class ScheduleArgs:
    ...
    def job_names(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @job_names.setter
    def job_names(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
