...
class DatasetCsvOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 header_row: Optional[builtins.bool] = None):
        """
        Csv options
        :param builtins.str delimiter: A single character that specifies the delimiter being used in the CSV file.
        :param builtins.bool header_row: A variable that specifies whether the first row in the file is parsed as the header. If this value is false, column names are auto-generated.
        """
    ...
    def header_row(self) -> Optional[builtins.bool]:
        """
...
class DatasetDatabaseInputDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 database_table_name: Optional[builtins.str] = None,
                 query_string: Optional[builtins.str] = None,
                 temp_directory: Optional['outputs.DatasetS3Location'] = None):
        """
        :param builtins.str glue_connection_name: Glue connection name
        :param builtins.str database_table_name: Database table name
        :param builtins.str query_string: Custom SQL to run against the provided AWS Glue connection. This SQL will be used as the input for DataBrew projects and jobs.
        :param 'DatasetS3Location' temp_directory: An Amazon location that AWS Glue Data Catalog can use as a temporary directory.
        """
    ...
    def database_table_name(self) -> Optional[builtins.str]:
        """
        Database table name
        """
...
class DatasetDatetimeOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 timezone_offset: Optional[builtins.str] = None):
        """
        :param builtins.str format: Date/time format of a date parameter
        :param builtins.str locale_code: Locale code for a date parameter
        :param builtins.str timezone_offset: Timezone offset
        """
    ...
    def locale_code(self) -> Optional[builtins.str]:
        """
    ...
    def timezone_offset(self) -> Optional[builtins.str]:
        """
        Timezone offset
        """
...
class DatasetExcelOptions(dict):
    ...
    def __init__(__self__, *,
                 header_row: Optional[builtins.bool] = None,
                 sheet_indexes: Optional[Sequence[builtins.int]] = None,
                 sheet_names: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool header_row: A variable that specifies whether the first row in the file is parsed as the header. If this value is false, column names are auto-generated.
        :param Sequence[builtins.int] sheet_indexes: One or more sheet numbers in the Excel file that will be included in the dataset.
        :param Sequence[builtins.str] sheet_names: One or more named sheets in the Excel file that will be included in the dataset.
        """
        if header_row is not None:
            pulumi.set(__self__, "header_row", header_row)
    ...
    def sheet_indexes(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def sheet_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DatasetFilesLimit(dict):
    ...
    def max_files(self) -> builtins.int:
        """
...
class DatasetFilterExpression(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expression: Filtering expression for a parameter
...
class DatasetFilterValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A key-value pair to associate expression variable names with their values
        :param builtins.str value: The value to be associated with the substitution variable.
        :param builtins.str value_reference: Variable name
        """
...
class DatasetJsonOptions(dict):
    ...
    def __init__(__self__, *,
                 multi_line: Optional[builtins.bool] = None):
        """
        Json options
        :param builtins.bool multi_line: A value that specifies whether JSON input contains embedded new line characters.
        """
    ...
    def multi_line(self) -> Optional[builtins.bool]:
        """
...
class DatasetMetadata(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source_arn: Arn of the source of the dataset. For e.g.: AppFlow Flow ARN.
        """
...
class DatasetParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 create_column: Optional[builtins.bool] = None,
                 datetime_options: Optional['outputs.DatasetDatetimeOptions'] = None,
                 filter: Optional['outputs.DatasetFilterExpression'] = None):
        """
        :param builtins.str name: The name of the parameter that is used in the dataset's Amazon S3 path.
        :param 'DatasetParameterType' type: Parameter type
        :param builtins.bool create_column: Add the value of this parameter as a column in a dataset.
    ...
    def create_column(self) -> Optional[builtins.bool]:
        """
...
class DatasetPathParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str path_parameter_name: The name of the path parameter.
        """
...
class DatasetS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Input location
        :param builtins.str bucket: The Amazon S3 bucket name.
        :param builtins.str bucket_owner: The AWS account ID of the bucket owner.
        :param builtins.str key: The unique name of the object in the bucket.
        """
...
class JobAllowedStatistics(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] statistics: One or more column statistics to allow for columns that contain detected entities.
        """
...
class JobColumnSelector(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of a column from a dataset.
        :param builtins.str regex: A regular expression for selecting a column from a dataset.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class JobCsvOutputOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output Csv options
        :param builtins.str delimiter: A single character that specifies the delimiter used to create CSV job output.
        """
        if delimiter is not None:
            pulumi.set(__self__, "delimiter", delimiter)
...
class JobDataCatalogOutput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_name: The name of a database in the Data Catalog.
        :param builtins.str table_name: The name of a table in the Data Catalog.
        :param builtins.str catalog_id: The unique identifier of the AWS account that holds the Data Catalog that stores the data.
        ...
        :param builtins.bool overwrite: A value that, if true, means that any data in the location specified for output is overwritten with new output. Not supported with DatabaseOptions.
...
class JobDatabaseTableOutputOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str table_name: A prefix for the name of a table DataBrew will create in the database.
...
class JobEntityDetectorConfiguration(dict):
    ...
    def __init__(__self__, *,
                 entity_types: Sequence[builtins.str],
                 allowed_statistics: Optional['outputs.JobAllowedStatistics'] = None):
        """
        :param Sequence[builtins.str] entity_types: Entity types to detect. Can be any of the following:
...
class JobOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_output_files: Optional[builtins.int] = None,
                 overwrite: Optional[builtins.bool] = None,
                 partition_columns: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param builtins.int max_output_files: The maximum number of files to be generated by the job and written to the output folder.
        :param builtins.bool overwrite: A value that, if true, means that any data in the location specified for output is overwritten with new output.
        :param Sequence[builtins.str] partition_columns: The names of one or more partition columns for the output of the job.
        """
    ...
    def max_output_files(self) -> Optional[builtins.int]:
        """
    ...
    def partition_columns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class JobRecipe(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Recipe name
        :param builtins.str version: Recipe version
        """
        pulumi.set(__self__, "name", name)
...
class JobSample(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int size: The `Size` parameter is only required when the mode is CUSTOM_ROWS. The profile job is run on the specified number of rows. The maximum value for size is Long.MAX_VALUE.
...
class JobStatisticOverride(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] parameters: A map that includes overrides of an evaluation’s parameters.
        :param builtins.str statistic: The name of an evaluation
        """
        pulumi.set(__self__, "parameters", parameters)
...
class JobStatisticsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 included_statistics: Optional[Sequence[builtins.str]] = None,
                 overrides: Optional[Sequence['outputs.JobStatisticOverride']] = None):
        """
        :param Sequence[builtins.str] included_statistics: List of included evaluations. When the list is undefined, all supported evaluations will be included.
    ...
    def included_statistics(self) -> Optional[Sequence[builtins.str]]:
        """
...
class JobValidationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration to attach Rulesets to the job
        :param builtins.str ruleset_arn: Arn of the Ruleset
...
class ProjectSample(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int size: Sample size
        """
        pulumi.set(__self__, "type", type)
        if size is not None:
            pulumi.set(__self__, "size", size)
...
class RecipeAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operation: Step action operation
        :param Union['RecipeParameters', Mapping[str, builtins.str]] parameters: Contextual parameters for the transformation.
        """
...
class RecipeConditionExpression(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Condition expressions applied to the step action
        :param builtins.str condition: Input condition to be applied to the target column
        :param builtins.str target_column: Name of the target column
        :param builtins.str value: Value of the condition
        """
...
class RecipeParameters(dict):
    ...
    def __init__(__self__, *,
                 aggregate_function: Optional[builtins.str] = None,
                 base: Optional[builtins.str] = None,
                 case_statement: Optional[builtins.str] = None,
                 category_map: Optional[builtins.str] = None,
                 chars_to_remove: Optional[builtins.str] = None,
                 collapse_consecutive_whitespace: Optional[builtins.str] = None,
                 column_data_type: Optional[builtins.str] = None,
                 column_range: Optional[builtins.str] = None,
                 count: Optional[builtins.str] = None,
                 custom_characters: Optional[builtins.str] = None,
                 custom_stop_words: Optional[builtins.str] = None,
                 custom_value: Optional[builtins.str] = None,
                 datasets_columns: Optional[builtins.str] = None,
                 date_add_value: Optional[builtins.str] = None,
                 date_time_format: Optional[builtins.str] = None,
                 date_time_parameters: Optional[builtins.str] = None,
                 delete_other_rows: Optional[builtins.str] = None,
                 delimiter: Optional[builtins.str] = None,
                 end_pattern: Optional[builtins.str] = None,
                 end_position: Optional[builtins.str] = None,
                 end_value: Optional[builtins.str] = None,
                 expand_contractions: Optional[builtins.str] = None,
                 exponent: Optional[builtins.str] = None,
                 false_string: Optional[builtins.str] = None,
                 group_by_agg_function_options: Optional[builtins.str] = None,
                 group_by_columns: Optional[builtins.str] = None,
                 hidden_columns: Optional[builtins.str] = None,
                 ignore_case: Optional[builtins.str] = None,
                 include_in_split: Optional[builtins.str] = None,
                 input: Optional['outputs.RecipeParametersInputProperties'] = None,
                 interval: Optional[builtins.str] = None,
                 is_text: Optional[builtins.str] = None,
                 join_keys: Optional[builtins.str] = None,
                 join_type: Optional[builtins.str] = None,
                 left_columns: Optional[builtins.str] = None,
                 limit: Optional[builtins.str] = None,
                 lower_bound: Optional[builtins.str] = None,
                 map_type: Optional[builtins.str] = None,
                 mode_type: Optional[builtins.str] = None,
                 multi_line: Optional[builtins.bool] = None,
                 num_rows: Optional[builtins.str] = None,
                 num_rows_after: Optional[builtins.str] = None,
                 num_rows_before: Optional[builtins.str] = None,
                 order_by_column: Optional[builtins.str] = None,
                 order_by_columns: Optional[builtins.str] = None,
                 other: Optional[builtins.str] = None,
                 pattern: Optional[builtins.str] = None,
                 pattern_option1: Optional[builtins.str] = None,
                 pattern_option2: Optional[builtins.str] = None,
                 pattern_options: Optional[builtins.str] = None,
                 period: Optional[builtins.str] = None,
                 position: Optional[builtins.str] = None,
                 remove_all_punctuation: Optional[builtins.str] = None,
                 remove_all_quotes: Optional[builtins.str] = None,
                 remove_all_whitespace: Optional[builtins.str] = None,
                 remove_custom_characters: Optional[builtins.str] = None,
                 remove_custom_value: Optional[builtins.str] = None,
                 remove_leading_and_trailing_punctuation: Optional[builtins.str] = None,
                 remove_leading_and_trailing_quotes: Optional[builtins.str] = None,
                 remove_leading_and_trailing_whitespace: Optional[builtins.str] = None,
                 remove_letters: Optional[builtins.str] = None,
                 remove_numbers: Optional[builtins.str] = None,
                 remove_source_column: Optional[builtins.str] = None,
                 remove_special_characters: Optional[builtins.str] = None,
                 right_columns: Optional[builtins.str] = None,
                 sample_size: Optional[builtins.str] = None,
                 sample_type: Optional[builtins.str] = None,
                 second_input: Optional[builtins.str] = None,
                 secondary_inputs: Optional[Sequence['outputs.RecipeSecondaryInput']] = None,
                 sheet_indexes: Optional[Sequence[builtins.int]] = None,
                 sheet_names: Optional[Sequence[builtins.str]] = None,
                 source_column: Optional[builtins.str] = None,
                 source_column1: Optional[builtins.str] = None,
                 source_column2: Optional[builtins.str] = None,
                 source_columns: Optional[builtins.str] = None,
                 start_column_index: Optional[builtins.str] = None,
                 start_pattern: Optional[builtins.str] = None,
                 start_position: Optional[builtins.str] = None,
                 start_value: Optional[builtins.str] = None,
                 stemming_mode: Optional[builtins.str] = None,
                 step_count: Optional[builtins.str] = None,
                 step_index: Optional[builtins.str] = None,
                 stop_words_mode: Optional[builtins.str] = None,
                 strategy: Optional[builtins.str] = None,
                 target_column: Optional[builtins.str] = None,
                 target_column_names: Optional[builtins.str] = None,
                 target_date_format: Optional[builtins.str] = None,
                 target_index: Optional[builtins.str] = None,
                 time_zone: Optional[builtins.str] = None,
                 tokenizer_pattern: Optional[builtins.str] = None,
                 true_string: Optional[builtins.str] = None,
                 udf_lang: Optional[builtins.str] = None,
                 units: Optional[builtins.str] = None,
                 unpivot_column: Optional[builtins.str] = None,
                 upper_bound: Optional[builtins.str] = None,
                 use_new_data_frame: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None,
                 value1: Optional[builtins.str] = None,
                 value2: Optional[builtins.str] = None,
                 value_column: Optional[builtins.str] = None,
                 view_frame: Optional[builtins.str] = None):
        """
    ...
    def map_type(self) -> Optional[builtins.str]:
        return pulumi.get(self, "map_type")

    @property
    @pulumi.getter(name="modeType")
    def mode_type(self) -> Optional[builtins.str]:
    ...
    def tokenizer_pattern(self) -> Optional[builtins.str]:
        return pulumi.get(self, "tokenizer_pattern")

    @property
    @pulumi.getter(name="trueString")
    def true_string(self) -> Optional[builtins.str]:
        return pulumi.get(self, "true_string")

    @property
    @pulumi.getter(name="udfLang")
    def udf_lang(self) -> Optional[builtins.str]:
    ...
    def unpivot_column(self) -> Optional[builtins.str]:
    ...
    def use_new_data_frame(self) -> Optional[builtins.str]:
    ...
    @property
    @pulumi.getter
    def value1(self) -> Optional[builtins.str]:
        return pulumi.get(self, "value1")

    @property
    @pulumi.getter
    def value2(self) -> Optional[builtins.str]:
    ...
    def view_frame(self) -> Optional[builtins.str]:
...
class RulesetRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Data quality rule for a target resource (dataset)
        :param builtins.str check_expression: The expression which includes column references, condition names followed by variable references, possibly grouped and combined with other conditions. For example, `(:col1 starts_with :prefix1 or :col1 starts_with :prefix2) and (:col1 ends_with :suffix1 or :col1 ends_with :suffix2)` . Column and value references are substitution variables that should start with the ':' symbol. Depending on the context, substitution variables' values can be either an actual value or a column name. These values are defined in the SubstitutionMap. If a CheckExpression starts with a column reference, then ColumnSelectors in the rule should be null. If ColumnSelectors has been defined, then there should be no columnn reference in the left side of a condition, for example, `is_between :val1 and :val2` .
        ...
        :param builtins.bool disabled: A value that specifies whether the rule is disabled. Once a rule is disabled, a profile job will not validate it during a job run. Default value is false.
...
class RulesetSubstitutionValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A key-value pair to associate expression's substitution variable names with their values
        :param builtins.str value: Value or column name
        :param builtins.str value_reference: Variable name
        """
        pulumi.set(__self__, "value", value)
        pulumi.set(__self__, "value_reference", value_reference)
...
class RulesetThreshold(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float value: The value of a threshold.
