...
def get_transformer(log_group_identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str log_group_identifier: Existing log group that you want to associate with this transformer.
    """
    __args__ = dict()
