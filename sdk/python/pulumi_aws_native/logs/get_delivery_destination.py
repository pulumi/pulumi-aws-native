...
def get_delivery_destination(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this delivery destination.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_delivery_destination_output(name: Optional[pulumi.Input[builtins.str]] = None,
