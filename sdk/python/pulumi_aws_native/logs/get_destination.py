...
class GetDestinationResult:
    ...
    def destination_policy(self) -> Optional[builtins.str]:
        """
...
def get_destination(destination_name: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDestinationResult:
    """
    The AWS::Logs::Destination resource specifies a CloudWatch Logs destination. A destination encapsulates a physical resource (such as an Amazon Kinesis data stream) and enables you to subscribe that resource to a stream of log events.


    :param builtins.str destination_name: The name of the destination resource
    """
    __args__ = dict()
