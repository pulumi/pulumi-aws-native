...
class LogAnomalyDetectorArgs:
    def __init__(__self__, *,
                 ...
                 anomaly_visibility_time: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 log_group_arn_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a LogAnomalyDetector resource.
        :param pulumi.Input[builtins.str] account_id: Account ID for owner of detector
        :param pulumi.Input[builtins.float] anomaly_visibility_time: The number of days to have visibility on an anomaly. After this time period has elapsed for an anomaly, it will be automatically baselined and the anomaly detector will treat new occurrences of a similar anomaly as normal. Therefore, if you do not correct the cause of an anomaly during the time period specified in `AnomalyVisibilityTime` , it will be considered normal going forward and will not be detected as an anomaly.
        :param pulumi.Input[builtins.str] detector_name: Name of detector
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The Amazon Resource Name (ARN) of the CMK to use when encrypting log data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_group_arn_list: List of Arns for the given log group
        """
    ...
    def anomaly_visibility_time(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def anomaly_visibility_time(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def log_group_arn_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def log_group_arn_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LogAnomalyDetector(pulumi.CustomResource):
    ...
    def anomaly_detector_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def anomaly_detector_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="anomalyVisibilityTime")
    def anomaly_visibility_time(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The number of days to have visibility on an anomaly. After this time period has elapsed for an anomaly, it will be automatically baselined and the anomaly detector will treat new occurrences of a similar anomaly as normal. Therefore, if you do not correct the cause of an anomaly during the time period specified in `AnomalyVisibilityTime` , it will be considered normal going forward and will not be detected as an anomaly.
        """
        return pulumi.get(self, "anomaly_visibility_time")
    ...
    def creation_time_stamp(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def last_modified_time_stamp(self) -> pulumi.Output[builtins.float]:
        """
    ...
    @property
    @pulumi.getter(name="logGroupArnList")
    def log_group_arn_list(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of Arns for the given log group
        """
        return pulumi.get(self, "log_group_arn_list")
