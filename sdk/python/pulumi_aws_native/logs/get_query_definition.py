...
class GetQueryDefinitionResult:
    ...
    def log_group_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def query_definition_id(self) -> Optional[builtins.str]:
        """
...
def get_query_definition(query_definition_id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQueryDefinitionResult:
    """
    The resource schema for AWSLogs QueryDefinition


    :param builtins.str query_definition_id: Unique identifier of a query definition
    """
    __args__ = dict()
...
def get_query_definition_output(query_definition_id: Optional[pulumi.Input[builtins.str]] = None,
