...
class SubscriptionFilter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SubscriptionFilterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SubscriptionFilterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SubscriptionFilterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SubscriptionFilterProperties']:
        """
