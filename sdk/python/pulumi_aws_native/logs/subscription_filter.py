...
class SubscriptionFilterArgs:
    def __init__(__self__, *,
                 ...
                 emit_system_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 field_selection_criteria: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination_arn: The Amazon Resource Name (ARN) of the destination.
        ...
        :param pulumi.Input[builtins.str] log_group_name: The log group to associate with the subscription filter. All log events that are uploaded to this log group are filtered and delivered to the specified AWS resource if the filter pattern matches the log events.
        :param pulumi.Input[builtins.bool] apply_on_transformed_logs: This parameter is valid only for log groups that have an active log transformer. For more information about log transformers, see [PutTransformer](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutTransformer.html).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] emit_system_fields: The list of system fields that are included in the log events sent to the subscription destination. Returns the `emitSystemFields` value if it was specified when the subscription filter was created.
        :param pulumi.Input[builtins.str] field_selection_criteria: The filter expression that specifies which log events are processed by this subscription filter based on system fields. Returns the `fieldSelectionCriteria` value if it was specified when the subscription filter was created.
        :param pulumi.Input[builtins.str] filter_name: The name of the subscription filter.
        :param pulumi.Input[builtins.str] role_arn: The ARN of an IAM role that grants CWL permissions to deliver ingested log events to the destination stream. You don't need to provide the ARN when you are working with a logical destination for cross-account delivery.
        """
    ...
    def emit_system_fields(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def emit_system_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "emit_system_fields", value)

    @property
    @pulumi.getter(name="fieldSelectionCriteria")
    def field_selection_criteria(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def field_selection_criteria(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SubscriptionFilter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="applyOnTransformedLogs")
    def apply_on_transformed_logs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This parameter is valid only for log groups that have an active log transformer. For more information about log transformers, see [PutTransformer](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutTransformer.html).
         If this value is ``true``, the subscription filter is applied on the transformed version of the log events instead of the original ingested log events.
        """
    ...
    @property
    @pulumi.getter(name="emitSystemFields")
    def emit_system_fields(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of system fields that are included in the log events sent to the subscription destination. Returns the `emitSystemFields` value if it was specified when the subscription filter was created.
        """
        return pulumi.get(self, "emit_system_fields")
    ...
    @property
    @pulumi.getter(name="fieldSelectionCriteria")
    def field_selection_criteria(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The filter expression that specifies which log events are processed by this subscription filter based on system fields. Returns the `fieldSelectionCriteria` value if it was specified when the subscription filter was created.
        """
        return pulumi.get(self, "field_selection_criteria")
