...
class GetSubscriptionFilterResult:
    ...
    def emit_system_fields(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def field_selection_criteria(self) -> Optional[builtins.str]:
        """
...
def get_subscription_filter(filter_name: Optional[builtins.str] = None,
    ...
    :param builtins.str filter_name: The name of the subscription filter.
    :param builtins.str log_group_name: The log group to associate with the subscription filter. All log events that are uploaded to this log group are filtered and delivered to the specified AWS resource if the filter pattern matches the log events.
    """
    __args__ = dict()
...
def get_subscription_filter_output(filter_name: Optional[pulumi.Input[builtins.str]] = None,
