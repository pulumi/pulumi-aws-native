...
class LogStreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_group_name: The name of the log group where the log stream is created.
        :param pulumi.Input[builtins.str] log_stream_name: The name of the log stream. The name must be unique wihtin the log group.
        """
...
@pulumi.type_token("aws-native:logs:LogStream")
class LogStream(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["logGroupName", "logStreamName"])
    ...
    @property
    @pulumi.getter(name="logStreamName")
    def log_stream_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the log stream. The name must be unique wihtin the log group.
        """
        return pulumi.get(self, "log_stream_name")
