...
class IntegrationOpenSearchResourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str kms_key_arn: To have the vended dashboard data encrypted with AWS  instead of the CloudWatch Logs default encryption method, specify the ARN of the AWS  key that you want to use.
