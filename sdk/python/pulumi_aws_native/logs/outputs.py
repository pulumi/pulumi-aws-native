...
@pulumi.output_type
class DeliveryDestinationTag(dict):
    """
...
class DeliverySourceTag(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A key-value pair to associate with a resource.
        :param str key: The key name of the tag. You can specify a value that is 1 to 128 Unicode
        :param str value: The value for the tag. You can specify a value that is 0 to 256 Unicode
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
