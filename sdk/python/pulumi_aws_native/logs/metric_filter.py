...
class MetricFilterArgs:
    def __init__(__self__, *,
                 ...
                 emit_system_field_dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] filter_pattern: A filter pattern for extracting metric data out of ingested log events. For more information, see [Filter and Pattern Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/FilterAndPatternSyntax.html).
        :param pulumi.Input[builtins.str] log_group_name: The name of an existing log group that you want to associate with this metric filter.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] emit_system_field_dimensions: The list of system fields that are emitted as additional dimensions in the generated metrics. Returns the `emitSystemFieldDimensions` value if it was specified when the metric filter was created.
        :param pulumi.Input[builtins.str] field_selection_criteria: The filter expression that specifies which log events are processed by this metric filter based on system fields. Returns the `fieldSelectionCriteria` value if it was specified when the metric filter was created.
        :param pulumi.Input[builtins.str] filter_name: The name of the metric filter.
        """
    ...
    def emit_system_field_dimensions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def emit_system_field_dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class MetricFilter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="emitSystemFieldDimensions")
    def emit_system_field_dimensions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of system fields that are emitted as additional dimensions in the generated metrics. Returns the `emitSystemFieldDimensions` value if it was specified when the metric filter was created.
        """
        return pulumi.get(self, "emit_system_field_dimensions")
