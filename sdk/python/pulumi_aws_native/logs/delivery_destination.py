...
class DeliveryDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] delivery_destination_type: Displays whether this delivery destination is CloudWatch Logs, Amazon S3, Kinesis Data Firehose, or XRay.
        :param pulumi.Input[builtins.str] destination_resource_arn: The ARN of the Amazon Web Services destination that this delivery destination represents. That Amazon Web Services destination can be a log group in CloudWatch Logs, an Amazon S3 bucket, or a delivery stream in Firehose.
        :param pulumi.Input[builtins.str] name: The name of this delivery destination.
        :param pulumi.Input[builtins.str] output_format: The format of the logs that are sent to this delivery destination.
    ...
    def destination_resource_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def destination_resource_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:logs:DeliveryDestination")
class DeliveryDestination(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deliveryDestinationType")
    def delivery_destination_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Displays whether this delivery destination is CloudWatch Logs, Amazon S3, Kinesis Data Firehose, or XRay.
        """
        return pulumi.get(self, "delivery_destination_type")
    ...
    @property
    @pulumi.getter(name="destinationResourceArn")
    def destination_resource_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the Amazon Web Services destination that this delivery destination represents. That Amazon Web Services destination can be a log group in CloudWatch Logs, an Amazon S3 bucket, or a delivery stream in Firehose.
        """
        return pulumi.get(self, "destination_resource_arn")
