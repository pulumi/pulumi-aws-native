...
if not MYPY:
    class IntegrationOpenSearchResourceConfigArgsDict(TypedDict):
        dashboard_viewer_principals: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        data_source_role_arn: pulumi.Input[builtins.str]
        """
...
class IntegrationOpenSearchResourceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dashboard_viewer_principals: Specify the ARNs of IAM roles and IAM users who you want to grant permission to for viewing the dashboards.
               
               > In addition to specifying these users here, you must also grant them the *CloudWatchOpenSearchDashboardAccess* IAM policy. For more information, see [IAM policies for users](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/OpenSearch-Dashboards-UserRoles.html) .
        :param pulumi.Input[builtins.str] data_source_role_arn: Specify the ARN of an IAM role that CloudWatch Logs will use to create the integration. This role must have the permissions necessary to access the OpenSearch Service collection to be able to create the dashboards. For more information about the permissions needed, see [Permissions that the integration needs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/OpenSearch-Dashboards-CreateRole.html) in the CloudWatch Logs User Guide.
        :param pulumi.Input[builtins.str] application_arn: If you want to use an existing OpenSearch Service application for your integration with OpenSearch Service, specify it here. If you omit this, a new application will be created.
        :param pulumi.Input[builtins.str] kms_key_arn: To have the vended dashboard data encrypted with AWS KMS instead of the CloudWatch Logs default encryption method, specify the ARN of the AWS KMS key that you want to use.
        :param pulumi.Input[builtins.int] retention_days: Specify how many days that you want the data derived by OpenSearch Service to be retained in the index that the dashboard refers to. This also sets the maximum time period that you can choose when viewing data in the dashboard. Choosing a longer time frame will incur additional costs.
        """
    ...
    def dashboard_viewer_principals(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specify the ARNs of IAM roles and IAM users who you want to grant permission to for viewing the dashboards.
    ...
    def dashboard_viewer_principals(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "dashboard_viewer_principals", value)

    @property
    @pulumi.getter(name="dataSourceRoleArn")
    def data_source_role_arn(self) -> pulumi.Input[builtins.str]:
        """
        Specify the ARN of an IAM role that CloudWatch Logs will use to create the integration. This role must have the permissions necessary to access the OpenSearch Service collection to be able to create the dashboards. For more information about the permissions needed, see [Permissions that the integration needs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/OpenSearch-Dashboards-CreateRole.html) in the CloudWatch Logs User Guide.
        """
    ...
    def data_source_role_arn(self, value: pulumi.Input[builtins.str]):
...
class MetricFilterDimensionArgs:
    def __init__(__self__, *,
        ...
        Specifies the CW metric dimensions to publish with this metric.
         ...
         To help prevent accidental high charges, Amazon disables a metric filter if it generates 1000 different name/value pairs for the dimensions that you have specified within a certain amount of time.
         You can also set up a billing alarm to alert you if your charges are higher than expected. For more information, see [Creating a Billing Alarm to Monitor Your Estimated Charges](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/monitor_estimated_charges_with_cloudwatch.html).
        :param pulumi.Input[builtins.str] key: The name for the CW metric dimension that the metric filter creates.
                Dimension names must contain only ASCII characters, must include at least one non-whitespace character, and cannot start with a colon (:).
        :param pulumi.Input[builtins.str] value: The log event field that will contain the value for this dimension. This dimension will only be published for a metric if the value is found in the log event. For example, ``$.eventType`` for JSON log events, or ``$server`` for space-delimited log events.
        """
...
if not MYPY:
    class MetricFilterMetricTransformationArgsDict(TypedDict):
        ...
        """
        default_value: NotRequired[pulumi.Input[builtins.float]]
        """
...
class MetricFilterMetricTransformationArgs:
    def __init__(__self__, *,
        ...
        """
        ``MetricTransformation`` is a property of the ``AWS::Logs::MetricFilter`` resource that describes how to transform log streams into a CloudWatch metric.
        :param pulumi.Input[builtins.str] metric_name: The name of the CloudWatch metric.
        :param pulumi.Input[builtins.str] metric_namespace: A custom namespace to contain your metric in CloudWatch. Use namespaces to group together metrics that are similar. For more information, see [Namespaces](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch_concepts.html#Namespace).
        :param pulumi.Input[builtins.str] metric_value: The value that is published to the CloudWatch metric. For example, if you're counting the occurrences of a particular term like ``Error``, specify 1 for the metric value. If you're counting the number of bytes transferred, reference the value that is in the log event by using $. followed by the name of the field that you specified in the filter pattern, such as ``$.size``.
        :param pulumi.Input[builtins.float] default_value: (Optional) The value to emit when a filter pattern does not match a log event. This value can be null.
...
if not MYPY:
    class TransformerAddKeyEntryArgsDict(TypedDict):
        ...
        """
        overwrite_if_exists: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class TransformerAddKeyEntryArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[builtins.str],
                 value: pulumi.Input[builtins.str],
                 overwrite_if_exists: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] key: The key of the new entry to be added to the log event
        :param pulumi.Input[builtins.str] value: The value of the new entry to be added to the log event
        :param pulumi.Input[builtins.bool] overwrite_if_exists: Specifies whether to overwrite the value if the key already exists in the log event. If you omit this, the default is `false` .
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
    ...
    def overwrite_if_exists(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to overwrite the value if the key already exists in the log event. If you omit this, the default is `false` .
        """
    ...
    def overwrite_if_exists(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TransformerParseCloudfrontArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source: Omit this parameter and the whole log message will be processed by this processor. No other value than `@message` is allowed for `source` .
        """
...
class TransformerParseToOcsfArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source: The path to the field in the log event that you want to parse. If you omit this value, the whole log message is parsed.
        """
...
if not MYPY:
    class TransformerProcessorDateTimeConverterPropertiesArgsDict(TypedDict):
        ...
        """
        match_patterns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        source: pulumi.Input[builtins.str]
        target: pulumi.Input[builtins.str]
        locale: NotRequired[pulumi.Input[builtins.str]]
        source_timezone: NotRequired[pulumi.Input[builtins.str]]
        target_format: NotRequired[pulumi.Input[builtins.str]]
        target_timezone: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TransformerProcessorDateTimeConverterPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 source_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 target_format: Optional[pulumi.Input[builtins.str]] = None,
                 target_timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        Use this parameter to include the [datetimeConverter](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatch-Logs-Transformation-Processors.html#CloudWatch-Logs-Transformation-datetimeConverter) processor in your transformer.
        """
    ...
    def match_patterns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "match_patterns")

    @match_patterns.setter
    def match_patterns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def source_timezone(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "source_timezone")

    @source_timezone.setter
    def source_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_timezone", value)

    @property
    @pulumi.getter(name="targetFormat")
    def target_format(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "target_format")

    @target_format.setter
    def target_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_format", value)

    @property
    @pulumi.getter(name="targetTimezone")
    def target_timezone(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "target_timezone")

    @target_timezone.setter
    def target_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TransformerProcessorDeleteKeysPropertiesArgsDict(TypedDict):
        ...
        """
        with_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
elif False:
...
class TransformerProcessorDeleteKeysPropertiesArgs:
    ...
    def with_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "with_keys")

    @with_keys.setter
    def with_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class TransformerProcessorListToMapPropertiesArgsDict(TypedDict):
        ...
        key: pulumi.Input[builtins.str]
        source: pulumi.Input[builtins.str]
        flatten: NotRequired[pulumi.Input[builtins.bool]]
...
class TransformerProcessorListToMapPropertiesArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[builtins.str],
                 source: pulumi.Input[builtins.str],
                 flatten: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter
    def flatten(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "flatten")

    @flatten.setter
    def flatten(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class TransformerProcessorParseKeyValuePropertiesArgsDict(TypedDict):
        ...
        key_value_delimiter: NotRequired[pulumi.Input[builtins.str]]
        non_match_value: NotRequired[pulumi.Input[builtins.str]]
        overwrite_if_exists: NotRequired[pulumi.Input[builtins.bool]]
        source: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TransformerProcessorParseKeyValuePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 key_value_delimiter: Optional[pulumi.Input[builtins.str]] = None,
                 non_match_value: Optional[pulumi.Input[builtins.str]] = None,
                 overwrite_if_exists: Optional[pulumi.Input[builtins.bool]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        Use this parameter to include the [parseKeyValue](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatch-Logs-Transformation-Processors.html#CloudWatch-Logs-Transformation-parseKeyValue) processor in your transformer.
    ...
    def key_value_delimiter(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "key_value_delimiter")

    @key_value_delimiter.setter
    def key_value_delimiter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_value_delimiter", value)

    @property
    @pulumi.getter(name="nonMatchValue")
    def non_match_value(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "non_match_value")

    @non_match_value.setter
    def non_match_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransformerProcessorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TransformerParseRoute53Args'] parse_route53: Use this parameter to include the [parseRoute53](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatch-Logs-Transformation-Processors.html#CloudWatch-Logs-Transformation-parseRoute53) processor in your transformer.
               ...
               If you use this processor, it must be the first processor in your transformer.
        :param pulumi.Input['TransformerParseToOcsfArgs'] parse_to_ocsf: Use this processor to convert logs into Open Cybersecurity Schema Framework (OCSF) format
...
if not MYPY:
    class TransformerRenameKeyEntryArgsDict(TypedDict):
        key: pulumi.Input[builtins.str]
        rename_to: pulumi.Input[builtins.str]
        overwrite_if_exists: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class TransformerRenameKeyEntryArgs:
    ...
    def rename_to(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "rename_to")

    @rename_to.setter
    def rename_to(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TransformerSplitStringEntryArgsDict(TypedDict):
        delimiter: pulumi.Input[builtins.str]
        source: pulumi.Input[builtins.str]
elif False:
...
class TransformerSplitStringEntryArgs:
    ...
    @property
    @pulumi.getter
    def delimiter(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "delimiter")

    @delimiter.setter
    def delimiter(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "delimiter", value)
