...
class DeliverySourceArgs:
    def __init__(__self__, *,
                 delivery_source_configuration: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def delivery_source_configuration(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
    ...
    def delivery_source_configuration(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
@pulumi.type_token("aws-native:logs:DeliverySource")
class DeliverySource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] name: The unique name of the Log source.
        :param pulumi.Input[_builtins.str] resource_arn: The ARN of the resource that will be sending the logs.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags that have been assigned to this delivery source.
        """
        ...
    @overload
    def __init__(__self__,
