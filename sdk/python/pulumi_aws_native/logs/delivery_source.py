...
class DeliverySourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_type: The type of logs being delivered. Only mandatory when the resourceArn could match more than one. In such a case, the error message will contain all the possible options.
        :param pulumi.Input[builtins.str] name: The unique name of the Log source.
        :param pulumi.Input[builtins.str] resource_arn: The ARN of the resource that will be sending the logs.
...
class DeliverySource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="logType")
    def log_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of logs being delivered. Only mandatory when the resourceArn could match more than one. In such a case, the error message will contain all the possible options.
        """
        return pulumi.get(self, "log_type")
    ...
    @property
    @pulumi.getter(name="resourceArn")
    def resource_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the resource that will be sending the logs.
        """
        return pulumi.get(self, "resource_arn")
    ...
    def resource_arns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
