...
def get_log_group(log_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str log_group_name: The name of the log group. If you don't specify a name, CFNlong generates a unique ID for the log group.
    """
    __args__ = dict()
