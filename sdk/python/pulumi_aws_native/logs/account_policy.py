...
class AccountPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_name: The name of the account policy
        :param pulumi.Input['AccountPolicyScope'] scope: Scope for policy application
        :param pulumi.Input[_builtins.str] selection_criteria: Log group  selection criteria to apply policy only to a subset of log groups. SelectionCriteria string can be up to 25KB and cloudwatchlogs determines the length of selectionCriteria by using its UTF-8 bytes
        """
