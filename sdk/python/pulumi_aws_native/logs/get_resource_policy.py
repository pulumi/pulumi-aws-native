...
def get_resource_policy(policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_name: A name for resource policy
    """
    __args__ = dict()
...
def get_resource_policy_output(policy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:logs:getResourcePolicy', __args__, opts=opts, typ=GetResourcePolicyResult)
