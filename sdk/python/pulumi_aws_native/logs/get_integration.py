...
def get_integration(integration_name: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIntegrationResult:
    """
    Resource Schema for Logs Integration Resource


    :param builtins.str integration_name: User provided identifier for integration, unique to the user account.
    """
    __args__ = dict()
...
def get_integration_output(integration_name: Optional[pulumi.Input[builtins.str]] = None,
