...
def get_integration(integration_name: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIntegrationResult:
    """
    Resource Schema for Logs Integration Resource


    :param _builtins.str integration_name: User provided identifier for integration, unique to the user account.
    """
    __args__ = dict()
