...
class DbClusterArgs:
    def __init__(__self__, *,
                 ...
                 db_port: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 iam_auth_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Provides the list of EC2 Availability Zones that instances in the DB cluster can be created in.
        :param pulumi.Input[builtins.int] backup_retention_period: Specifies the number of days for which automatic DB snapshots are retained.
        :param pulumi.Input[builtins.bool] copy_tags_to_snapshot: A value that indicates whether to copy all tags from the DB cluster to snapshots of the DB cluster. The default behaviour is not to copy them.
        :param pulumi.Input[builtins.str] db_cluster_identifier: The DB cluster identifier. Contains a user-supplied DB cluster identifier. This identifier is the unique key that identifies a DB cluster stored as a lowercase string.
        :param pulumi.Input[builtins.str] db_cluster_parameter_group_name: Provides the name of the DB cluster parameter group.
        :param pulumi.Input[builtins.str] db_instance_parameter_group_name: The name of the DB parameter group to apply to all instances of the DB cluster. Used only in case of a major EngineVersion upgrade request.
        :param pulumi.Input[builtins.int] db_port: The port number on which the DB instances in the DB cluster accept connections. 
               
               If not specified, the default port used is `8182`. 
               
               Note: `Port` property will soon be deprecated from this resource. Please update existing templates to rename it with new property `DBPort` having same functionalities.
        :param pulumi.Input[builtins.str] db_subnet_group_name: Specifies information on the subnet group associated with the DB cluster, including the name, description, and subnets in the subnet group.
        :param pulumi.Input[builtins.bool] deletion_protection: Indicates whether or not the DB cluster has deletion protection enabled. The database can't be deleted when deletion protection is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enable_cloudwatch_logs_exports: Specifies a list of log types that are enabled for export to CloudWatch Logs.
        :param pulumi.Input[builtins.str] engine_version: Indicates the database engine version.
        :param pulumi.Input[builtins.bool] iam_auth_enabled: True if mapping of Amazon Identity and Access Management (IAM) accounts to database accounts is enabled, and otherwise false.
        ...
        :param pulumi.Input[builtins.str] preferred_backup_window: Specifies the daily time range during which automated backups are created if automated backups are enabled, as determined by the BackupRetentionPeriod.
        ...
        :param pulumi.Input[builtins.str] restore_to_time: Creates a new DB cluster from a DB snapshot or DB cluster snapshot.
               
               If a DB snapshot is specified, the target DB cluster is created from the source DB snapshot with a default configuration and default security group.
               
               If a DB cluster snapshot is specified, the target DB cluster is created from the source DB cluster restore point with the same configuration as the original source DB cluster, except that the new DB cluster is created with the default security group.
        :param pulumi.Input[builtins.str] restore_type: Creates a new DB cluster from a DB snapshot or DB cluster snapshot.
        ...
        :param pulumi.Input[builtins.str] snapshot_identifier: Specifies the identifier for a DB cluster snapshot. Must match the identifier of an existing snapshot.
               
               After you restore a DB cluster using a SnapshotIdentifier, you must specify the same SnapshotIdentifier for any future updates to the DB cluster. When you specify this property for an update, the DB cluster is not restored from the snapshot again, and the data in the database is not changed.
               
               However, if you don't specify the SnapshotIdentifier, an empty DB cluster is created, and the original DB cluster is deleted. If you specify a property that is different from the previous snapshot restore property, the DB cluster is restored from the snapshot specified by the SnapshotIdentifier, and the original DB cluster is deleted.
        :param pulumi.Input[builtins.str] source_db_cluster_identifier: Creates a new DB cluster from a DB snapshot or DB cluster snapshot.
        ...
        :param pulumi.Input[builtins.bool] use_latest_restorable_time: Creates a new DB cluster from a DB snapshot or DB cluster snapshot.
               
               If a DB snapshot is specified, the target DB cluster is created from the source DB snapshot with a default configuration and default security group.
               
               If a DB cluster snapshot is specified, the target DB cluster is created from the source DB cluster restore point with the same configuration as the original source DB cluster, except that the new DB cluster is created with the default security group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_security_group_ids: Provides a list of VPC security groups that the DB cluster belongs to.
        """
    ...
    def db_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @db_port.setter
    def db_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def iam_auth_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def iam_auth_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DbCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dbPort")
    def db_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port number on which the DB instances in the DB cluster accept connections. 
    ...
    @property
    @pulumi.getter(name="iamAuthEnabled")
    def iam_auth_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if mapping of Amazon Identity and Access Management (IAM) accounts to database accounts is enabled, and otherwise false.
        """
        return pulumi.get(self, "iam_auth_enabled")
