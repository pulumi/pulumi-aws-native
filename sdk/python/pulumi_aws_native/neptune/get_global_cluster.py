...
class GetGlobalClusterResult:
    def __init__(__self__, deletion_protection=None, engine_version=None, tags=None):
...
def get_global_cluster(global_cluster_identifier: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:neptune:getGlobalCluster', __args__, opts=opts, typ=GetGlobalClusterResult).value
...
def get_global_cluster_output(global_cluster_identifier: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:neptune:getGlobalCluster', __args__, opts=opts, typ=GetGlobalClusterResult)
