...
warnings.warn("""Dataset is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Dataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 versioning_configuration: Optional[pulumi.Input[pulumi.InputType['DatasetVersioningConfigurationArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Dataset is deprecated: Dataset is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
