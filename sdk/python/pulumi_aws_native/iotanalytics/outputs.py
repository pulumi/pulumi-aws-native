...
class ChannelRetentionPeriod(dict):
    ...
    def __init__(__self__, *,
                 number_of_days: Optional[_builtins.int] = None,
                 unlimited: Optional[_builtins.bool] = None):
        """
        :param _builtins.int number_of_days: The number of days that message data is kept. The `unlimited` parameter must be false.
        :param _builtins.bool unlimited: If true, message data is kept indefinitely.
        """
    ...
    def number_of_days(self) -> Optional[_builtins.int]:
        """
...
class DatasetAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action_name: The name of the data set action by which data set contents are automatically created.
...
class DatasetContainerAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str execution_role_arn: The ARN of the role which gives permission to the system to access needed resources in order to run the "containerAction". This includes, at minimum, permission to retrieve the data set contents which are the input to the containerized application.
        :param _builtins.str image: The ARN of the Docker container stored in your account. The Docker container contains an application and needed support libraries and is used to generate data set contents.
...
class DatasetContentDeliveryRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str entry_name: The name of the dataset content delivery rules entry.
        """
...
class DatasetContentVersionValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dataset_name: The name of the dataset whose latest contents are used as input to the notebook or application.
        """
...
class DatasetDeltaTime(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_expression: _builtins.str):
        """
        :param _builtins.int offset_seconds: The number of seconds of estimated in-flight lag time of message data. When you create dataset contents using message data from a specified timeframe, some message data might still be in flight when processing begins, and so do not arrive in time to be processed. Use this field to make allowances for the in flight time of your message data, so that data not processed from a previous timeframe is included with the next timeframe. Otherwise, missed message data would be excluded from processing during the next timeframe too, because its timestamp places it within the previous timeframe.
        :param _builtins.str time_expression: An expression by which the time of the message data might be determined. This can be the name of a timestamp field or a SQL expression that is used to derive the time the message data was generated.
        """
    ...
    def offset_seconds(self) -> _builtins.int:
        """
    ...
    def time_expression(self) -> _builtins.str:
        """
...
class DatasetGlueConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str database_name: The name of the database in your AWS Glue Data Catalog in which the table is located. An AWS Glue Data Catalog database contains metadata tables.
        :param _builtins.str table_name: The name of the table in your AWS Glue Data Catalog that is used to perform the ETL operations. An AWS Glue Data Catalog table contains partitioned data and descriptions of data sources and targets.
        """
...
class DatasetLateDataRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str rule_name: The name of the late data rule.
        """
...
class DatasetOutputFileUriValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str file_name: The URI of the location where dataset contents are stored, usually the URI of a file in an S3 bucket.
        """
...
class DatasetQueryAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str sql_query: An "SqlQueryDatasetAction" object that uses an SQL query to automatically create data set contents.
...
class DatasetResourceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int volume_size_in_gb: The size, in GB, of the persistent storage available to the resource instance used to execute the `containerAction` (min: 1, max: 50).
        """
...
class DatasetS3DestinationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket: The name of the S3 bucket to which dataset contents are delivered.
        :param _builtins.str key: The key of the dataset contents object in an S3 bucket. Each object has a key that is a unique identifier. Each object has exactly one key.
...
class DatasetSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str schedule_expression: The expression that defines when to trigger an update. For more information, see [Schedule Expressions for Rules](https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html) in the Amazon CloudWatch documentation.
        """
...
class DatasetTriggeringDataset(dict):
    ...
    def __init__(__self__, *,
                 dataset_name: _builtins.str):
        """
        :param _builtins.str dataset_name: The name of the data set whose content generation triggers the new data set content generation.
        """
        pulumi.set(__self__, "dataset_name", dataset_name)
...
class DatasetVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float double_value: The value of the variable as a double (numeric).
        ...
        :param _builtins.str string_value: The value of the variable as a string.
        """
...
class DatasetVersioningConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unlimited: Optional[_builtins.bool] = None):
        """
        :param _builtins.int max_versions: How many versions of dataset contents are kept. The `unlimited` parameter must be `false` .
        :param _builtins.bool unlimited: If true, unlimited versions of dataset contents are kept.
        """
...
class DatastoreColumn(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of data. For more information about the supported data types, see [Common data types](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-common.html) in the *AWS Glue Developer Guide* .
        """
...
class DatastoreTimestampPartition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str attribute_name: The attribute name of the partition defined by a timestamp.
        :param _builtins.str timestamp_format: The timestamp format of a partition defined by a timestamp. The default format is seconds since epoch (January 1, 1970 at midnight UTC time).
        """
...
class Partition(dict):
    ...
    def __init__(__self__, *,
                 attribute_name: _builtins.str):
        """
        :param _builtins.str attribute_name: The name of the attribute that defines a partition dimension.
        """
        pulumi.set(__self__, "attribute_name", attribute_name)
...
class PipelineAddAttributes(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] attributes: A list of 1-50 "AttributeNameMapping" objects that map an existing attribute to a new attribute.
               
               > The existing attributes remain in the message, so if you want to remove the originals, use "RemoveAttributeActivity".
        :param _builtins.str name: The name of the 'addAttributes' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
...
class PipelineChannel(dict):
    ...
    def __init__(__self__, *,
                 ...
                 next: Optional[_builtins.str] = None):
        """
        :param _builtins.str channel_name: The name of the channel from which the messages are processed.
        :param _builtins.str name: The name of the 'channel' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
...
class PipelineDatastore(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str datastore_name: The name of the data store where processed messages are stored.
        :param _builtins.str name: The name of the datastore activity.
        """
...
class PipelineDeviceRegistryEnrich(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str,
                 role_arn: _builtins.str,
                 thing_name: _builtins.str,
                 next: Optional[_builtins.str] = None):
        """
        :param _builtins.str attribute: The name of the attribute that is added to the message.
        :param _builtins.str name: The name of the 'deviceRegistryEnrich' activity.
        :param _builtins.str role_arn: The ARN of the role that allows access to the device's registry information.
        :param _builtins.str thing_name: The name of the IoT device whose registry information is added to the message.
        :param _builtins.str next: The next activity in the pipeline.
        """
    ...
    def thing_name(self) -> _builtins.str:
        """
...
class PipelineDeviceShadowEnrich(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str attribute: The name of the attribute that is added to the message.
        :param _builtins.str name: The name of the 'deviceShadowEnrich' activity.
        :param _builtins.str role_arn: The ARN of the role that allows access to the device's shadow.
        :param _builtins.str thing_name: The name of the IoT device whose shadow information is added to the message.
        :param _builtins.str next: The next activity in the pipeline.
        """
        pulumi.set(__self__, "attribute", attribute)
        pulumi.set(__self__, "name", name)
...
class PipelineFilter(dict):
    def __init__(__self__, *,
                 ...
                 next: Optional[_builtins.str] = None):
        """
        :param _builtins.str filter: An expression that looks like an SQL WHERE clause that must return a Boolean value.
        :param _builtins.str name: The name of the 'filter' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
        pulumi.set(__self__, "filter", filter)
        pulumi.set(__self__, "name", name)
...
class PipelineLambda(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lambda_name: _builtins.str,
                 name: _builtins.str,
                 next: Optional[_builtins.str] = None):
        """
        :param _builtins.int batch_size: The number of messages passed to the Lambda function for processing.
               
               The AWS Lambda function must be able to process all of these messages within five minutes, which is the maximum timeout duration for Lambda functions.
        :param _builtins.str lambda_name: The name of the Lambda function that is run on the message.
        :param _builtins.str name: The name of the 'lambda' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
    ...
    def lambda_name(self) -> _builtins.str:
        """
...
class PipelineMath(dict):
    def __init__(__self__, *,
                 ...
                 next: Optional[_builtins.str] = None):
        """
        :param _builtins.str attribute: The name of the attribute that contains the result of the math operation.
        :param _builtins.str math: An expression that uses one or more existing attributes and must return an integer value.
        :param _builtins.str name: The name of the 'math' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
        pulumi.set(__self__, "attribute", attribute)
        pulumi.set(__self__, "math", math)
...
class PipelineRemoveAttributes(dict):
    def __init__(__self__, *,
                 ...
                 next: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] attributes: A list of 1-50 attributes to remove from the message.
        :param _builtins.str name: The name of the 'removeAttributes' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
        pulumi.set(__self__, "attributes", attributes)
        pulumi.set(__self__, "name", name)
...
class PipelineSelectAttributes(dict):
    def __init__(__self__, *,
                 ...
                 next: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] attributes: A list of the attributes to select from the message.
        :param _builtins.str name: The name of the 'selectAttributes' activity.
        :param _builtins.str next: The next activity in the pipeline.
        """
        pulumi.set(__self__, "attributes", attributes)
        pulumi.set(__self__, "name", name)
