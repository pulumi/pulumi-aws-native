...
class ChannelStorageArgsDict(TypedDict):
    customer_managed_s3: NotRequired[pulumi.Input[Optional['ChannelCustomerManagedS3Args']]]
    """
    Used to store channel data in an S3 bucket that you manage. If customer managed storage is selected, the `retentionPeriod` parameter is ignored. You can't change the choice of S3 storage after the data store is created.
    """
    service_managed_s3: NotRequired[pulumi.Input[Optional['ChannelServiceManagedS3Args']]]
    """
...
class DatasetActionArgsDict(TypedDict):
    ...
    """
    container_action: NotRequired[pulumi.Input[Optional['DatasetContainerActionArgs']]]
    """
    Information which allows the system to run a containerized application in order to create the data set contents. The application must be in a Docker container along with any needed support libraries.
    """
    query_action: NotRequired[pulumi.Input[Optional['DatasetQueryActionArgs']]]
    """
...
class DatasetContainerActionArgsDict(TypedDict):
    ...
    """
    variables: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatasetVariableArgs']]]]]
    """
...
class DatasetContentDeliveryRuleDestinationArgsDict(TypedDict):
    iot_events_destination_configuration: NotRequired[pulumi.Input[Optional['DatasetIotEventsDestinationConfigurationArgs']]]
    """
    Configuration information for delivery of dataset contents to AWS IoT Events .
    """
    s3_destination_configuration: NotRequired[pulumi.Input[Optional['DatasetS3DestinationConfigurationArgs']]]
    """
...
class DatasetFilterArgsDict(TypedDict):
    delta_time: NotRequired[pulumi.Input[Optional['DatasetDeltaTimeArgs']]]
    """
...
class DatasetIotEventsDestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_arn: The ARN of the role that grants ITA permission to deliver dataset contents to an AWS IoT Events input.
        """
...
class DatasetLateDataRuleConfigurationArgsDict(TypedDict):
    delta_time_session_window_configuration: NotRequired[pulumi.Input[Optional['DatasetDeltaTimeSessionWindowConfigurationArgs']]]
    """
...
class DatasetQueryActionArgsDict(TypedDict):
    ...
    An "SqlQueryDatasetAction" object that uses an SQL query to automatically create data set contents.
    """
    filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatasetFilterArgs']]]]]
    """
...
class DatasetS3DestinationConfigurationArgsDict(TypedDict):
    ...
    """
    glue_configuration: NotRequired[pulumi.Input[Optional['DatasetGlueConfigurationArgs']]]
    """
...
class DatasetS3DestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key: The key of the dataset contents object in an S3 bucket. Each object has a key that is a unique identifier. Each object has exactly one key.
               ...
               > If you don't use `!{iotanalytics:versionId}` to specify the key, you might get duplicate keys. For example, you might have two dataset contents with the same `scheduleTime` but different `versionId` s. This means that one dataset content overwrites the other.
        :param pulumi.Input[_builtins.str] role_arn: The ARN of the role that grants ITA permission to interact with your Amazon S3 and AWS Glue resources.
...
class DatasetTriggerArgsDict(TypedDict):
    schedule: NotRequired[pulumi.Input[Optional['DatasetScheduleArgs']]]
    """
    The "Schedule" when the trigger is initiated.
    """
    triggering_dataset: NotRequired[pulumi.Input[Optional['DatasetTriggeringDatasetArgs']]]
    """
...
class DatasetVariableArgsDict(TypedDict):
    ...
    """
    dataset_content_version_value: NotRequired[pulumi.Input[Optional['DatasetContentVersionValueArgs']]]
    """
    ...
    """
    output_file_uri_value: NotRequired[pulumi.Input[Optional['DatasetOutputFileUriValueArgs']]]
    """
...
class DatastoreFileFormatConfigurationArgsDict(TypedDict):
    json_configuration: NotRequired[pulumi.Input[Optional['DatastoreJsonConfigurationArgs']]]
    """
    Contains the configuration information of the JSON format.
    """
    parquet_configuration: NotRequired[pulumi.Input[Optional['DatastoreParquetConfigurationArgs']]]
    """
...
class DatastoreIotSiteWiseMultiLayerStorageArgsDict(TypedDict):
    customer_managed_s3_storage: NotRequired[pulumi.Input[Optional['DatastoreCustomerManagedS3StorageArgs']]]
    """
...
class DatastoreParquetConfigurationArgsDict(TypedDict):
    schema_definition: NotRequired[pulumi.Input[Optional['DatastoreSchemaDefinitionArgs']]]
    """
...
class DatastorePartitionsArgsDict(TypedDict):
    partitions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatastorePartitionArgs']]]]]
    """
...
class DatastorePartitionArgsDict(TypedDict):
    partition: NotRequired[pulumi.Input[Optional['PartitionArgs']]]
    """
    A partition dimension defined by an attribute.
    """
    timestamp_partition: NotRequired[pulumi.Input[Optional['DatastoreTimestampPartitionArgs']]]
    """
...
class DatastoreSchemaDefinitionArgsDict(TypedDict):
    columns: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatastoreColumnArgs']]]]]
    """
...
class DatastoreStorageArgsDict(TypedDict):
    customer_managed_s3: NotRequired[pulumi.Input[Optional['DatastoreCustomerManagedS3Args']]]
    """
    ...
    """
    iot_site_wise_multi_layer_storage: NotRequired[pulumi.Input[Optional['DatastoreIotSiteWiseMultiLayerStorageArgs']]]
    """
    ...
    """
    service_managed_s3: NotRequired[pulumi.Input[Optional['DatastoreServiceManagedS3Args']]]
    """
...
class DatastoreStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DatastoreServiceManagedS3Args'] service_managed_s3: Use this to store data store data in an S3 bucket managed by the  service. The choice of service-managed or customer-managed S3 storage cannot be changed after creation of the data store.
        """
        if customer_managed_s3 is not None:
            pulumi.set(__self__, "customer_managed_s3", customer_managed_s3)
...
class PipelineActivityArgsDict(TypedDict):
    add_attributes: NotRequired[pulumi.Input[Optional['PipelineAddAttributesArgs']]]
    """
    Adds other attributes based on existing attributes in the message.
    """
    channel: NotRequired[pulumi.Input[Optional['PipelineChannelArgs']]]
    """
    Determines the source of the messages to be processed.
    """
    datastore: NotRequired[pulumi.Input[Optional['PipelineDatastoreArgs']]]
    """
    Specifies where to store the processed message data.
    """
    device_registry_enrich: NotRequired[pulumi.Input[Optional['PipelineDeviceRegistryEnrichArgs']]]
    """
    Adds data from the AWS IoT device registry to your message.
    """
    device_shadow_enrich: NotRequired[pulumi.Input[Optional['PipelineDeviceShadowEnrichArgs']]]
    """
    Adds information from the AWS IoT Device Shadows service to a message.
    """
    filter: NotRequired[pulumi.Input[Optional['PipelineFilterArgs']]]
    """
    Filters a message based on its attributes.
    """
    lambda_: NotRequired[pulumi.Input[Optional['PipelineLambdaArgs']]]
    """
    Runs a Lambda function to modify the message.
    """
    math: NotRequired[pulumi.Input[Optional['PipelineMathArgs']]]
    """
    Computes an arithmetic expression using the message's attributes and adds it to the message.
    """
    remove_attributes: NotRequired[pulumi.Input[Optional['PipelineRemoveAttributesArgs']]]
    """
    Removes attributes from a message.
    """
    select_attributes: NotRequired[pulumi.Input[Optional['PipelineSelectAttributesArgs']]]
    """
