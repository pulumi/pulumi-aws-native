...
def get_resource_policy(resource_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_arn: The ARN of the AWS Kinesis resource to which the policy applies.
    """
    __args__ = dict()
    __args__['resourceArn'] = resource_arn
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('aws-native:kinesis:getResourcePolicy', __args__, opts=opts, typ=GetResourcePolicyResult).value
...
def get_resource_policy_output(resource_arn: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:kinesis:getResourcePolicy', __args__, opts=opts, typ=GetResourcePolicyResult)
