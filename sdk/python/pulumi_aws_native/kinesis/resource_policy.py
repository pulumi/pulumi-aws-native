...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_arn: The ARN of the AWS Kinesis resource to which the policy applies.
...
@pulumi.type_token("aws-native:kinesis:ResourcePolicy")
