...
class GetApplicationResult:
    ...
    def app_block_arn(self) -> Optional[builtins.str]:
        """
    ...
    def launch_parameters(self) -> Optional[builtins.str]:
        """
    ...
    def launch_path(self) -> Optional[builtins.str]:
        """
...
def get_application(arn: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplicationResult:
    """
    Resource Type definition for AWS::AppStream::Application


    :param builtins.str arn: The ARN of the application.
    """
    __args__ = dict()
    __args__['arn'] = arn
