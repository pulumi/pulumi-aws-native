...
class EntitlementArgs:
    ...
    def app_visibility(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def app_visibility(self, value: pulumi.Input[_builtins.str]):
...
class Entitlement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="appVisibility")
    def app_visibility(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether to entitle all apps or only selected apps.
        """
        return pulumi.get(self, "app_visibility")
