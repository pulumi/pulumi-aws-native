...
class GetImageBuilderResult:
    ...
    def appstream_agent_version(self) -> Optional[_builtins.str]:
        """
    ...
    def enable_default_internet_access(self) -> Optional[_builtins.bool]:
        """
    ...
    def streaming_url(self) -> Optional[_builtins.str]:
        """
...
def get_image_builder(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: A unique name for the image builder.
    """
    __args__ = dict()
    __args__['name'] = name
