...
class GetImageBuilderResult:
    ...
    def appstream_agent_version(self) -> Optional[builtins.str]:
        """
    ...
    def enable_default_internet_access(self) -> Optional[builtins.bool]:
        """
    ...
    def streaming_url(self) -> Optional[builtins.str]:
        """
...
def get_image_builder(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A unique name for the image builder.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_image_builder_output(name: Optional[pulumi.Input[builtins.str]] = None,
