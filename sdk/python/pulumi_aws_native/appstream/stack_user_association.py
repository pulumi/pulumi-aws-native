...
warnings.warn("""StackUserAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class StackUserAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StackUserAssociation is deprecated: StackUserAssociation is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
