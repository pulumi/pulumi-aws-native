...
class Stack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(application_settings, StackApplicationSettingsArgs):
            ...
            if not isinstance(streaming_experience_settings, StackStreamingExperienceSettingsArgs):
