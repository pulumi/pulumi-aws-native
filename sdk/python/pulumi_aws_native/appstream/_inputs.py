...
if not MYPY:
    class AppBlockBuilderAccessEndpointArgsDict(TypedDict):
        ...
        """
        vpce_id: pulumi.Input[builtins.str]
        """
...
class AppBlockBuilderAccessEndpointArgs:
    def __init__(__self__, *,
                 ...
                 vpce_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] endpoint_type: The type of interface endpoint.
        :param pulumi.Input[builtins.str] vpce_id: The identifier (ID) of the VPC in which the interface endpoint is used.
        """
    ...
    def vpce_id(self) -> pulumi.Input[builtins.str]:
        """
        The identifier (ID) of the VPC in which the interface endpoint is used.
        """
    ...
    @vpce_id.setter
    def vpce_id(self, value: pulumi.Input[builtins.str]):
...
class AppBlockBuilderVpcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The identifiers of the security groups for the fleet or image builder.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The identifiers of the subnets to which a network interface is attached from the fleet instance or image builder instance. Fleet instances use one or more subnets. Image builder instances use one subnet.
        """
...
class AppBlockS3LocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_bucket: The S3 bucket of the app block.
        :param pulumi.Input[builtins.str] s3_key: The S3 key of the S3 object of the virtual hard disk.
...
if not MYPY:
    class AppBlockScriptDetailsArgsDict(TypedDict):
        ...
        """
        executable_parameters: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppBlockScriptDetailsArgs:
    def __init__(__self__, *,
                 ...
                 timeout_in_seconds: pulumi.Input[builtins.int],
                 executable_parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] executable_path: The run path for the script.
        :param pulumi.Input['AppBlockS3LocationArgs'] script_s3_location: The S3 object location of the script.
        :param pulumi.Input[builtins.int] timeout_in_seconds: The run timeout, in seconds, for the script.
        :param pulumi.Input[builtins.str] executable_parameters: The parameters used in the run path for the script.
        """
    ...
    def executable_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The parameters used in the run path for the script.
        """
    ...
    def executable_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationS3LocationArgs:
    def __init__(__self__, *,
                 ...
                 s3_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] s3_bucket: The S3 bucket of the S3 object.
        :param pulumi.Input[builtins.str] s3_key: The S3 key of the S3 object.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_key", s3_key)
...
class DirectoryConfigCertificateBasedAuthPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_authority_arn: The ARN of the AWS Certificate Manager Private CA resource.
        :param pulumi.Input[builtins.str] status: The status of the certificate-based authentication properties. Fallback is turned on by default when certificate-based authentication is *Enabled* . Fallback allows users to log in using their AD domain password if certificate-based authentication is unsuccessful, or to unlock a desktop lock screen. *Enabled_no_directory_login_fallback* enables certificate-based authentication, but does not allow users to log in using their AD domain password. Users will be disconnected to re-authenticate using certificates.
        """
...
class DirectoryConfigServiceAccountCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 account_password: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] account_name: The user name of the account. This account must have the following privileges: create computer objects, join computers to the domain, and change/reset the password on descendant computer objects for the organizational units specified.
...
class EntitlementAttributeArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: A supported AWS IAM SAML PrincipalTag attribute that is matched to a value when a user identity federates to an AppStream 2.0 SAML application.
               ...
               - costCenter
               - userType
        :param pulumi.Input[builtins.str] value: A value that is matched to a supported SAML attribute name when a user identity federates to an AppStream 2.0 SAML application.
        """
...
class ImageBuilderDomainJoinInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organizational_unit_distinguished_name: The distinguished name of the organizational unit for computer accounts.
        """
...
class ImageBuilderVpcConfigArgs:
    def __init__(__self__, *,
                 ...
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The identifiers of the security groups for the image builder.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The identifier of the subnet to which a network interface is attached from the image builder instance. An image builder instance can use one subnet.
        """
        if security_group_ids is not None:
            pulumi.set(__self__, "security_group_ids", security_group_ids)
        if subnet_ids is not None:
