...
class ApplicationArgs:
    def __init__(__self__, *,
                 app_block_arn: pulumi.Input[builtins.str],
                 icon_s3_location: pulumi.Input['ApplicationS3LocationArgs'],
                 instance_families: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 launch_path: pulumi.Input[builtins.str],
                 platforms: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 attributes_to_delete: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 launch_parameters: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_block_arn: The app block ARN with which the application should be associated.
        :param pulumi.Input['ApplicationS3LocationArgs'] icon_s3_location: The icon S3 location of the application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_families: The instance families the application supports.
               
               *Allowed Values* : `GENERAL_PURPOSE` | `GRAPHICS_G4`
        :param pulumi.Input[builtins.str] launch_path: The launch path of the application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] platforms: The platforms the application supports.
               
               *Allowed Values* : `WINDOWS_SERVER_2019` | `AMAZON_LINUX2`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attributes_to_delete: A list of attributes to delete from an application.
        :param pulumi.Input[builtins.str] description: The description of the application.
        :param pulumi.Input[builtins.str] display_name: The display name of the application. This name is visible to users in the application catalog.
        :param pulumi.Input[builtins.str] launch_parameters: The launch parameters of the application.
        :param pulumi.Input[builtins.str] name: The name of the application. This name is visible to users when a name is not specified in the DisplayName property.
        ...
        :param pulumi.Input[builtins.str] working_directory: The working directory of the application.
        """
    ...
    def app_block_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def app_block_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def instance_families(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def instance_families(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def attributes_to_delete(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def attributes_to_delete(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def launch_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def launch_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 app_block_arn: Optional[pulumi.Input[builtins.str]] = None,
                 attributes_to_delete: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 icon_s3_location: Optional[pulumi.Input[Union['ApplicationS3LocationArgs', 'ApplicationS3LocationArgsDict']]] = None,
                 instance_families: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 launch_parameters: Optional[pulumi.Input[builtins.str]] = None,
                 launch_path: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="appBlockArn")
    def app_block_arn(self) -> pulumi.Output[builtins.str]:
        """
        The app block ARN with which the application should be associated.
        """
        return pulumi.get(self, "app_block_arn")
    ...
    @property
    @pulumi.getter(name="attributesToDelete")
    def attributes_to_delete(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of attributes to delete from an application.
        """
        return pulumi.get(self, "attributes_to_delete")
    ...
    @property
    @pulumi.getter(name="instanceFamilies")
    def instance_families(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The instance families the application supports.
    ...
    @property
    @pulumi.getter(name="launchParameters")
    def launch_parameters(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The launch parameters of the application.
        """
        return pulumi.get(self, "launch_parameters")
    ...
    @property
    @pulumi.getter(name="launchPath")
    def launch_path(self) -> pulumi.Output[builtins.str]:
        """
        The launch path of the application.
        """
        return pulumi.get(self, "launch_path")
