...
def get_fleet(id: Optional[str] = None,
    ...
    return AwaitableGetFleetResult(
        compute_capacity=pulumi.get(__ret__, 'compute_capacity'),
        description=pulumi.get(__ret__, 'description'),
        disconnect_timeout_in_seconds=pulumi.get(__ret__, 'disconnect_timeout_in_seconds'),
        ...
        idle_disconnect_timeout_in_seconds=pulumi.get(__ret__, 'idle_disconnect_timeout_in_seconds'),
        ...
        stream_view=pulumi.get(__ret__, 'stream_view'),
        tags=pulumi.get(__ret__, 'tags'),
        usb_device_filter_strings=pulumi.get(__ret__, 'usb_device_filter_strings'),
