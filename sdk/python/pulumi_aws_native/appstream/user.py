...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authentication_type: The authentication type for the user.
        :param pulumi.Input[_builtins.str] first_name: The first name, or given name, of the user.
        :param pulumi.Input[_builtins.str] last_name: The last name, or surname, of the user.
        :param pulumi.Input[_builtins.str] message_action: The action to take for the welcome email that is sent to a user after the user is created in the user pool. If you specify SUPPRESS, no email is sent. If you specify RESEND, do not specify the first name or last name of the user. If the value is null, the email is sent.
        :param pulumi.Input[_builtins.str] user_name: The email address of the user.
        """
...
@pulumi.type_token("aws-native:appstream:User")
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["authenticationType", "firstName", "lastName", "messageAction", "userName"])
