...
class AppBlockBuilderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] app_block_arns: The ARN of the app block.
               ...
               *Maximum* : `1`
        :param pulumi.Input[_builtins.str] description: The description of the app block builder.
        :param pulumi.Input[_builtins.str] display_name: The display name of the app block builder.
        :param pulumi.Input[_builtins.bool] enable_default_internet_access: Indicates whether default internet access is enabled for the app block builder.
        :param pulumi.Input[_builtins.str] iam_role_arn: The ARN of the IAM role that is applied to the app block builder.
        :param pulumi.Input[_builtins.str] name: The name of the app block builder.
...
class AppBlockBuilder(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="appBlockArns")
    def app_block_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The ARN of the app block.
