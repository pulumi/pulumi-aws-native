...
class ApplicationEntitlementAssociationArgs:
    def __init__(__self__, *,
                 ...
                 entitlement_name: pulumi.Input[_builtins.str],
    ...
    def entitlement_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def entitlement_name(self, value: pulumi.Input[_builtins.str]):
...
class ApplicationEntitlementAssociation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="entitlementName")
    def entitlement_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the entitlement.
        """
        return pulumi.get(self, "entitlement_name")
