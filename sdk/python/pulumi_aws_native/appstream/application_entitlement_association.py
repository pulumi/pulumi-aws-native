...
class ApplicationEntitlementAssociationArgs:
    def __init__(__self__, *,
                 ...
                 entitlement_name: pulumi.Input[builtins.str],
                 stack_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ApplicationEntitlementAssociation resource.
        :param pulumi.Input[builtins.str] application_identifier: The identifier of the application.
        :param pulumi.Input[builtins.str] entitlement_name: The name of the entitlement.
    ...
    def entitlement_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def entitlement_name(self, value: pulumi.Input[builtins.str]):
...
class ApplicationEntitlementAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 entitlement_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["applicationIdentifier", "entitlementName", "stackName"])
    ...
    @property
    @pulumi.getter(name="entitlementName")
    def entitlement_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the entitlement.
        """
        return pulumi.get(self, "entitlement_name")
