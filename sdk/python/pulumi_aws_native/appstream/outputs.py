...
class AppBlockBuilderAccessEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str endpoint_type: The type of interface endpoint.
        :param builtins.str vpce_id: The identifier (ID) of the VPC in which the interface endpoint is used.
        """
...
class AppBlockBuilderVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: The identifiers of the security groups for the fleet or image builder.
        :param Sequence[builtins.str] subnet_ids: The identifiers of the subnets to which a network interface is attached from the fleet instance or image builder instance. Fleet instances use one or more subnets. Image builder instances use one subnet.
        """
...
class AppBlockS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_bucket: The S3 bucket of the app block.
        :param builtins.str s3_key: The S3 key of the S3 object of the virtual hard disk.
...
class AppBlockScriptDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 executable_parameters: Optional[builtins.str] = None):
        """
        :param builtins.str executable_path: The run path for the script.
        :param 'AppBlockS3Location' script_s3_location: The S3 object location of the script.
        :param builtins.int timeout_in_seconds: The run timeout, in seconds, for the script.
        :param builtins.str executable_parameters: The parameters used in the run path for the script.
        """
    ...
    def executable_parameters(self) -> Optional[builtins.str]:
        """
...
class ApplicationS3Location(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_key: builtins.str):
        """
        :param builtins.str s3_bucket: The S3 bucket of the S3 object.
        :param builtins.str s3_key: The S3 key of the S3 object.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_key", s3_key)
...
class DirectoryConfigCertificateBasedAuthProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_authority_arn: The ARN of the AWS Certificate Manager Private CA resource.
        :param builtins.str status: The status of the certificate-based authentication properties. Fallback is turned on by default when certificate-based authentication is *Enabled* . Fallback allows users to log in using their AD domain password if certificate-based authentication is unsuccessful, or to unlock a desktop lock screen. *Enabled_no_directory_login_fallback* enables certificate-based authentication, but does not allow users to log in using their AD domain password. Users will be disconnected to re-authenticate using certificates.
        """
...
class DirectoryConfigServiceAccountCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_name: The user name of the account. This account must have the following privileges: create computer objects, join computers to the domain, and change/reset the password on descendant computer objects for the organizational units specified.
        :param builtins.str account_password: The password for the account.
        """
...
class EntitlementAttribute(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: A supported AWS IAM SAML PrincipalTag attribute that is matched to a value when a user identity federates to an AppStream 2.0 SAML application.
               ...
               - costCenter
               - userType
        :param builtins.str value: A value that is matched to a supported SAML attribute name when a user identity federates to an AppStream 2.0 SAML application.
        """
...
class ImageBuilderDomainJoinInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str directory_name: The fully qualified name of the directory (for example, corp.example.com).
        :param builtins.str organizational_unit_distinguished_name: The distinguished name of the organizational unit for computer accounts.
        """
...
class ImageBuilderVpcConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnet_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] security_group_ids: The identifiers of the security groups for the image builder.
        :param Sequence[builtins.str] subnet_ids: The identifier of the subnet to which a network interface is attached from the image builder instance. An image builder instance can use one subnet.
        """
        if security_group_ids is not None:
            pulumi.set(__self__, "security_group_ids", security_group_ids)
        if subnet_ids is not None:
