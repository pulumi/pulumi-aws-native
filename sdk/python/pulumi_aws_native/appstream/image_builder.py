...
class ImageBuilderArgs:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ImageBuilderTagArgs']]]]:
        return pulumi.get(self, "tags")

    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ImageBuilderTagArgs']]]]):
...
class ImageBuilder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(domain_join_info, ImageBuilderDomainJoinInfoArgs):
            ...
            if not isinstance(vpc_config, ImageBuilderVpcConfigArgs):
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.ImageBuilderTag']]]:
        return pulumi.get(self, "tags")
