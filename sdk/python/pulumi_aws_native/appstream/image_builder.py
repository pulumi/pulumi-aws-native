...
class ImageBuilderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: The instance type to use when launching the image builder. The following instance types are available:
        ...
        :param pulumi.Input[builtins.str] display_name: The image builder name to display.
        ...
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role that is applied to the image builder. To assume a role, the image builder calls the AWS Security Token Service `AssumeRole` API operation and passes the ARN of the role to use. The operation creates a new session with temporary credentials. AppStream 2.0 retrieves the temporary credentials and creates the *appstream_machine_role* credential profile on the instance.
               
               For more information, see [Using an IAM Role to Grant Permissions to Applications and Scripts Running on AppStream 2.0 Streaming Instances](https://docs.aws.amazon.com/appstream2/latest/developerguide/using-iam-roles-to-grant-permissions-to-applications-scripts-streaming-instances.html) in the *Amazon AppStream 2.0 Administration Guide* .
        :param pulumi.Input[builtins.str] image_arn: The ARN of the public, private, or shared image to use.
        :param pulumi.Input[builtins.str] image_name: The name of the image used to create the image builder.
...
class ImageBuilder(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appstreamAgentVersion")
    def appstream_agent_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the AppStream 2.0 agent to use for this image builder. To use the latest version of the AppStream 2.0 agent, specify [LATEST].
        """
        return pulumi.get(self, "appstream_agent_version")
    ...
    @property
    @pulumi.getter(name="imageArn")
    def image_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the public, private, or shared image to use.
        """
        return pulumi.get(self, "image_arn")
    ...
    def streaming_url(self) -> pulumi.Output[builtins.str]:
        """
