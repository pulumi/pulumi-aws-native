...
class DirectoryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(certificate_based_auth_properties, DirectoryConfigCertificateBasedAuthPropertiesArgs):
            ...
            if not isinstance(service_account_credentials, DirectoryConfigServiceAccountCredentialsArgs):
