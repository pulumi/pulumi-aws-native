...
class UserPoolDomainCustomDomainConfigType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_arn: The Amazon Resource Name (ARN) of an Certificate Manager SSL certificate. You use this certificate for the subdomain of your custom domain.
        """
...
class UserPoolRiskConfigurationAttachmentNotifyConfigurationType(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str reply_to: The reply-to email address of an email template. Can be an email address in the format `admin@example.com` or `Administrator <admin@example.com>` .
        """
        pulumi.set(__self__, "source_arn", source_arn)
