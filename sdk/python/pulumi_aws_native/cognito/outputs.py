...
class IdentityPoolCognitoIdentityProvider(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str client_id: The client ID for the Amazon Cognito user pool.
        :param _builtins.str provider_name: The provider name for an Amazon Cognito user pool. For example: `cognito-idp.us-east-2.amazonaws.com/us-east-2_123456789` .
        :param _builtins.bool server_side_token_check: TRUE if server-side token validation is enabled for the identity provider’s token.
...
class IdentityPoolCognitoStreams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 streaming_status: Optional[_builtins.str] = None):
        """
        :param _builtins.str role_arn: The Amazon Resource Name (ARN) of the role Amazon Cognito can assume to publish to the stream. This role must grant access to Amazon Cognito (cognito-sync) to invoke `PutRecord` on your Amazon Cognito stream.
        :param _builtins.str stream_name: The name of the Amazon Cognito stream to receive updates. This stream must be in the developer's account and in the same Region as the identity pool.
        :param _builtins.str streaming_status: Status of the Amazon Cognito streams. Valid values are: `ENABLED` or `DISABLED` .
        """
    ...
    def streaming_status(self) -> Optional[_builtins.str]:
        """
...
class IdentityPoolPushSync(dict):
    ...
    def __init__(__self__, *,
                 application_arns: Optional[Sequence[_builtins.str]] = None,
                 role_arn: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] application_arns: The ARNs of the Amazon SNS platform applications that could be used by clients.
        :param _builtins.str role_arn: An IAM role configured to allow Amazon Cognito to call Amazon SNS on behalf of the developer.
        """
    ...
    def application_arns(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class UserPoolAddOns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 advanced_security_mode: Optional[_builtins.str] = None):
        """
        ...
        :param _builtins.str advanced_security_mode: The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.
        """
    ...
    def advanced_security_mode(self) -> Optional[_builtins.str]:
        """
...
class UserPoolAdminCreateUserConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unused_account_validity_days: Optional[_builtins.int] = None):
        """
        :param _builtins.bool allow_admin_create_user_only: The setting for allowing self-service sign-up. When `true` , only administrators can create new user profiles. When `false` , users can register themselves and create a new user profile with the `SignUp` operation.
        ...
        :param _builtins.int unused_account_validity_days: This parameter is no longer in use.
    ...
    def unused_account_validity_days(self) -> Optional[_builtins.int]:
        """
...
class UserPoolAdvancedSecurityAdditionalFlows(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str custom_auth_mode: The operating mode of threat protection in custom authentication with [Custom authentication challenge Lambda triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        """
...
class UserPoolClientAnalyticsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str application_arn: The Amazon Resource Name (ARN) of an Amazon Pinpoint project that you want to connect to your user pool app client. Amazon Cognito publishes events to the Amazon Pinpoint project that `ApplicationArn` declares. You can also configure your application to pass an endpoint ID in the `AnalyticsMetadata` parameter of sign-in operations. The endpoint ID is information about the destination for push notifications
        :param _builtins.str application_id: Your Amazon Pinpoint project ID.
        :param _builtins.str external_id: The [external ID](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html) of the role that Amazon Cognito assumes to send analytics data to Amazon Pinpoint.
        :param _builtins.str role_arn: The ARN of an AWS Identity and Access Management role that has the permissions required for Amazon Cognito to publish events to Amazon Pinpoint analytics.
        :param _builtins.bool user_data_shared: If `UserDataShared` is `true` , Amazon Cognito includes user data in the events that it publishes to Amazon Pinpoint analytics.
        """
...
class UserPoolClientRefreshTokenRotation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int retry_grace_period_seconds: When you request a token refresh with `GetTokensFromRefreshToken` , the original refresh token that you're rotating out can remain valid for a period of time of up to 60 seconds. This allows for client-side retries. When `RetryGracePeriodSeconds` is `0` , the grace period is disabled and a successful request immediately invalidates the submitted refresh token.
        """
...
class UserPoolClientTokenValidityUnits(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str access_token: A time unit for the value that you set in the `AccessTokenValidity` parameter. The default `AccessTokenValidity` time unit is `hours` . `AccessTokenValidity` duration can range from five minutes to one day.
        :param _builtins.str id_token: A time unit for the value that you set in the `IdTokenValidity` parameter. The default `IdTokenValidity` time unit is `hours` . `IdTokenValidity` duration can range from five minutes to one day.
        :param _builtins.str refresh_token: A time unit for the value that you set in the `RefreshTokenValidity` parameter. The default `RefreshTokenValidity` time unit is `days` . `RefreshTokenValidity` duration can range from 60 minutes to 10 years.
        """
...
class UserPoolCustomEmailSender(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str lambda_arn: The Amazon Resource Name (ARN) of the function that you want to assign to your Lambda trigger.
        :param _builtins.str lambda_version: The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.
...
class UserPoolDeviceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool challenge_required_on_new_device: When true, a remembered device can sign in with device authentication instead of SMS and time-based one-time password (TOTP) factors for multi-factor authentication (MFA).
               
               > Whether or not `ChallengeRequiredOnNewDevice` is true, users who sign in with devices that have not been confirmed or remembered must still provide a second factor in a user pool that requires MFA.
        :param _builtins.bool device_only_remembered_on_user_prompt: When true, Amazon Cognito doesn't automatically remember a user's device when your app sends a `ConfirmDevice` API request. In your app, create a prompt for your user to choose whether they want to remember their device. Return the user's choice in an `UpdateDeviceStatus` API request.
...
class UserPoolDomainCustomDomainConfigType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str certificate_arn: The Amazon Resource Name (ARN) of an AWS Certificate Manager SSL certificate. You use this certificate for the subdomain of your custom domain.
        """
...
class UserPoolEmailConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str configuration_set: The set of configuration rules that can be applied to emails sent using Amazon Simple Email Service. A configuration set is applied to an email by including a reference to the configuration set in the headers of the email. Once applied, all of the rules in that configuration set are applied to the email. Configuration sets can be used to apply the following types of rules to emails:
        ...
        :param _builtins.str email_sending_account: Specifies whether Amazon Cognito uses its built-in functionality to send your users email messages, or uses your Amazon Simple Email Service email configuration. Specify one of the following values:
        ...
        :param _builtins.str from_: Either the sender’s email address or the sender’s name with their email address. For example, `testuser@example.com` or `Test User <testuser@example.com>` . This address appears before the body of the email.
        :param _builtins.str reply_to_email_address: The destination to which the receiver of the email should reply.
        :param _builtins.str source_arn: The ARN of a verified email address or an address from a verified domain in Amazon SES. You can set a `SourceArn` email from a verified domain only with an API request. You can set a verified email address, but not an address in a verified domain, in the Amazon Cognito console. Amazon Cognito uses the email address that you provide in one of the following ways, depending on the value that you specify for the `EmailSendingAccount` parameter:
...
class UserPoolInviteMessageTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str email_message: The message template for email messages. EmailMessage is allowed only if [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is DEVELOPER.
        :param _builtins.str email_subject: The subject line for email messages. EmailSubject is allowed only if [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is DEVELOPER.
        :param _builtins.str sms_message: The message template for SMS messages.
        """
...
class UserPoolLambdaConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str create_auth_challenge: The configuration of a create auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        ...
        :param _builtins.str define_auth_challenge: The configuration of a define auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        :param _builtins.str kms_key_id: The ARN of an [KMS key](https://docs.aws.amazon.com//kms/latest/developerguide/concepts.html#master_keys) . Amazon Cognito uses the key to encrypt codes and temporary passwords sent to custom sender Lambda triggers.
        :param _builtins.str post_authentication: The configuration of a [post authentication Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-post-authentication.html) in a user pool. This trigger can take custom actions after a user signs in.
        :param _builtins.str post_confirmation: The configuration of a [post confirmation Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-post-confirmation.html) in a user pool. This trigger can take custom actions after a user confirms their user account and their email address or phone number.
        :param _builtins.str pre_authentication: The configuration of a [pre authentication trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-authentication.html) in a user pool. This trigger can evaluate and modify user sign-in events.
        :param _builtins.str pre_sign_up: The configuration of a [pre sign-up Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-sign-up.html) in a user pool. This trigger evaluates new users and can bypass confirmation, [link a federated user profile](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-identity-federation-consolidate-users.html) , or block sign-up requests.
        :param _builtins.str pre_token_generation: The legacy configuration of a [pre token generation Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html) in a user pool.
        ...
        :param _builtins.str user_migration: The configuration of a [migrate user Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-migrate-user.html) in a user pool. This trigger can create user profiles when users sign in or attempt to reset their password with credentials that don't exist yet.
        :param _builtins.str verify_auth_challenge_response: The configuration of a verify auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        """
...
class UserPoolNumberAttributeConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str max_value: The maximum length of a number attribute value. Must be a number less than or equal to `2^1023` , represented as a string with a length of 131072 characters or fewer.
        :param _builtins.str min_value: The minimum value of an attribute that is of the number data type.
        """
...
class UserPoolPasswordPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int minimum_length: The minimum length of the password in the policy that you have set. This value can't be less than 6.
        :param _builtins.int password_history_size: The number of previous passwords that you want Amazon Cognito to restrict each user from reusing. Users can't set a password that matches any of `n` previous passwords, where `n` is the value of `PasswordHistorySize` .
        :param _builtins.bool require_lowercase: The requirement in a password policy that users must include at least one lowercase letter in their password.
        :param _builtins.bool require_numbers: The requirement in a password policy that users must include at least one number in their password.
        :param _builtins.bool require_symbols: The requirement in a password policy that users must include at least one symbol in their password.
        :param _builtins.bool require_uppercase: The requirement in a password policy that users must include at least one uppercase letter in their password.
        :param _builtins.int temporary_password_validity_days: The number of days a temporary password is valid in the password policy. If the user doesn't sign in during this time, an administrator must reset their password. Defaults to `7` . If you submit a value of `0` , Amazon Cognito treats it as a null value and sets `TemporaryPasswordValidityDays` to its default value.
...
class UserPoolRecoveryOption(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The recovery method that this object sets a recovery option for.
        :param _builtins.int priority: Your priority preference for using the specified attribute in account recovery. The highest priority is `1` .
        """
        if name is not None:
...
class UserPoolRiskConfigurationAttachmentAccountTakeoverActionType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str event_action: The action to take for the attempted account takeover action for the associated risk level. Valid values are as follows:
        ...
        :param _builtins.bool notify: Determines whether Amazon Cognito sends a user a notification message when your user pools assesses a user's session at the associated risk level.
        """
...
class UserPoolRiskConfigurationAttachmentCompromisedCredentialsActionsType(dict):
    ...
    def __init__(__self__, *,
                 event_action: _builtins.str):
        """
        :param _builtins.str event_action: The action that Amazon Cognito takes when it detects compromised credentials.
        """
        pulumi.set(__self__, "event_action", event_action)
...
class UserPoolRiskConfigurationAttachmentCompromisedCredentialsRiskConfigurationType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 event_filter: Optional[Sequence[_builtins.str]] = None):
        """
        ...
        :param Sequence[_builtins.str] event_filter: Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.
        """
        pulumi.set(__self__, "actions", actions)
    ...
    def event_filter(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class UserPoolRiskConfigurationAttachmentNotifyConfigurationType(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str from_: The email address that sends the email message. The address must be either individually verified with Amazon Simple Email Service, or from a domain that has been verified with Amazon SES.
        ...
        :param _builtins.str reply_to: The reply-to email address of an email template. Can be an email address in the format `admin@example.com` or `Administrator <admin@example.com>` .
        """
        pulumi.set(__self__, "source_arn", source_arn)
...
class UserPoolRiskConfigurationAttachmentNotifyEmailType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 text_body: Optional[_builtins.str] = None):
        """
        :param _builtins.str subject: The subject of the threat protection email notification.
        :param _builtins.str html_body: The body of an email notification formatted in HTML. Choose an `HtmlBody` or a `TextBody` to send an HTML-formatted or plaintext message, respectively.
        :param _builtins.str text_body: The body of an email notification formatted in plaintext. Choose an `HtmlBody` or a `TextBody` to send an HTML-formatted or plaintext message, respectively.
        """
    ...
    def text_body(self) -> Optional[_builtins.str]:
        """
...
class UserPoolRiskConfigurationAttachmentRiskExceptionConfigurationType(dict):
    ...
    def __init__(__self__, *,
                 blocked_ip_range_list: Optional[Sequence[_builtins.str]] = None,
                 skipped_ip_range_list: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] blocked_ip_range_list: An always-block IP address list. Overrides the risk decision and always blocks authentication requests. This parameter is displayed and set in CIDR notation.
        :param Sequence[_builtins.str] skipped_ip_range_list: An always-allow IP address list. Risk detection isn't performed on the IP addresses in this range list. This parameter is displayed and set in CIDR notation.
        """
    ...
    def blocked_ip_range_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def skipped_ip_range_list(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class UserPoolSchemaAttribute(dict):
    ...
    def __init__(__self__, *,
                 attribute_data_type: Optional[_builtins.str] = None,
        ...
        :param _builtins.str name: The name of your user pool attribute. When you create or update a user pool, adding a schema attribute creates a custom or developer-only attribute. When you add an attribute with a `Name` value of `MyAttribute` , Amazon Cognito creates the custom attribute `custom:MyAttribute` . When `DeveloperOnlyAttribute` is `true` , Amazon Cognito creates your attribute as `dev:MyAttribute` . In an operation that describes a user pool, Amazon Cognito returns this value as `value` for standard attributes, `custom:value` for custom attributes, and `dev:value` for developer-only attributes..
        ...
        :param _builtins.bool required: Specifies whether a user pool attribute is required. If the attribute is required and the user doesn't provide a value, registration or sign-in will fail.
    ...
    def attribute_data_type(self) -> Optional[_builtins.str]:
        """
...
class UserPoolSignInPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] allowed_first_auth_factors: The sign-in methods that a user pool supports as the first factor. You can permit users to start authentication with a standard username and password, or with other one-time password and hardware factors.
...
class UserPoolSmsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sns_caller_arn: The Amazon Resource Name (ARN) of the Amazon SNS caller. This is the ARN of the IAM role in your AWS account that Amazon Cognito will use to send SMS messages. SMS messages are subject to a [spending limit](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html) .
        :param _builtins.str sns_region: The AWS Region to use with Amazon SNS integration. You can choose the same Region as your user pool, or a supported *Legacy Amazon SNS alternate Region* .
...
class UserPoolStringAttributeConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str max_length: The maximum length of a string attribute value. Must be a number less than or equal to `2^1023` , represented as a string with a length of 131072 characters or fewer.
        :param _builtins.str min_length: The minimum length of a string attribute value.
        """
...
class UserPoolUserAttributeUpdateSettings(dict):
    ...
    def __init__(__self__, *,
                 attributes_require_verification_before_update: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] attributes_require_verification_before_update: Requires that your user verifies their email address, phone number, or both before Amazon Cognito updates the value of that attribute. When you update a user attribute that has this option activated, Amazon Cognito sends a verification message to the new phone number or email address. Amazon Cognito doesn’t change the value of the attribute until your user responds to the verification message and confirms the new value.
    ...
    def attributes_require_verification_before_update(self) -> Sequence[_builtins.str]:
        """
...
class UserPoolUsernameConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool case_sensitive: Specifies whether user name case sensitivity will be applied for all users in the user pool through Amazon Cognito APIs. For most use cases, set case sensitivity to `False` (case insensitive) as a best practice. When usernames and email addresses are case insensitive, users can sign in as the same user when they enter a different capitalization of their user name.
...
class UserPoolVerificationMessageTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sms_message: Optional[_builtins.str] = None):
        """
        :param _builtins.str default_email_option: The configuration of verification emails to contain a clickable link or a verification code.
        ...
        :param _builtins.str email_message: The template for email messages that Amazon Cognito sends to your users. You can set an `EmailMessage` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param _builtins.str email_message_by_link: The email message template for sending a confirmation link to the user. You can set an `EmailMessageByLink` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param _builtins.str email_subject: The subject line for the email message template. You can set an `EmailSubject` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param _builtins.str email_subject_by_link: The subject line for the email message template for sending a confirmation link to the user. You can set an `EmailSubjectByLink` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param _builtins.str sms_message: The template for SMS messages that Amazon Cognito sends to your users.
        """
