...
class UserPoolRiskConfigurationAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: The app client where this configuration is applied. When this parameter isn't present, the risk configuration applies to all user pool app clients that don't have client-level settings.
        :param pulumi.Input[builtins.str] user_pool_id: The ID of the user pool that has the risk configuration applied.
