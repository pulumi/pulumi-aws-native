...
class UserPoolRiskConfigurationAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(account_takeover_risk_configuration, UserPoolRiskConfigurationAttachmentAccountTakeoverRiskConfigurationTypeArgs):
            ...
            if not isinstance(compromised_credentials_risk_configuration, UserPoolRiskConfigurationAttachmentCompromisedCredentialsRiskConfigurationTypeArgs):
            ...
            if not isinstance(risk_exception_configuration, UserPoolRiskConfigurationAttachmentRiskExceptionConfigurationTypeArgs):
