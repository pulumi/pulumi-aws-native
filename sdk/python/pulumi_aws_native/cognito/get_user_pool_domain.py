...
class GetUserPoolDomainResult:
    ...
    def cloud_front_distribution(self) -> Optional[builtins.str]:
        """
...
def get_user_pool_domain(domain: Optional[builtins.str] = None,
    ...
    :param builtins.str domain: The name of the domain that you want to update. For custom domains, this is the fully-qualified domain name, for example `auth.example.com` . For prefix domains, this is the prefix alone, such as `myprefix` .
    :param builtins.str user_pool_id: The ID of the user pool that is associated with the domain you're updating.
    """
    __args__ = dict()
...
def get_user_pool_domain_output(domain: Optional[pulumi.Input[builtins.str]] = None,
