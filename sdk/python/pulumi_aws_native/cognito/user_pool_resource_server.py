...
__all__ = ['UserPoolResourceServer']
...
class UserPoolResourceServer(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolResourceServerPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolResourceServerPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolResourceServerAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolResourceServerProperties']:
        """
