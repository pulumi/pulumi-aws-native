...
class UserPoolResourceServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identifier: A unique resource server identifier for the resource server. The identifier can be an API friendly name like `solar-system-data` . You can also set an API URL like `https://solar-system-data-api.example.com` as your identifier.
               
               Amazon Cognito represents scopes in the access token in the format `$resource-server-identifier/$scope` . Longer scope-identifier strings increase the size of your access tokens.
        :param pulumi.Input[builtins.str] user_pool_id: The ID of the user pool where you want to create a resource server.
        :param pulumi.Input[builtins.str] name: A friendly name for the resource server.
