...
class UserPoolClient(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(analytics_configuration, UserPoolClientAnalyticsConfigurationArgs):
            ...
            if not isinstance(token_validity_units, UserPoolClientTokenValidityUnitsArgs):
