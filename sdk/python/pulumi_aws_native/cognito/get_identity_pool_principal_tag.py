...
class GetIdentityPoolPrincipalTagResult:
    ...
    def use_defaults(self) -> Optional[_builtins.bool]:
        """
...
def get_identity_pool_principal_tag(identity_pool_id: Optional[_builtins.str] = None,
                                    identity_provider_name: Optional[_builtins.str] = None,
