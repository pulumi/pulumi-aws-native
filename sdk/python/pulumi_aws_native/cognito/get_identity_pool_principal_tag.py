...
class GetIdentityPoolPrincipalTagResult:
    ...
    def use_defaults(self) -> Optional[builtins.bool]:
        """
...
def get_identity_pool_principal_tag(identity_pool_id: Optional[builtins.str] = None,
                                    identity_provider_name: Optional[builtins.str] = None,
    ...
    :param builtins.str identity_pool_id: The identity pool that you want to associate with this principal tag map.
    :param builtins.str identity_provider_name: The identity pool identity provider (IdP) that you want to associate with this principal tag map.
    """
    __args__ = dict()
...
def get_identity_pool_principal_tag_output(identity_pool_id: Optional[pulumi.Input[builtins.str]] = None,
