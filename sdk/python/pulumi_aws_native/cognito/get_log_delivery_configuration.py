...
def get_log_delivery_configuration(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: A user pool ID, for example `us-east-1_EXAMPLE` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_log_delivery_configuration_output(id: Optional[pulumi.Input[builtins.str]] = None,
