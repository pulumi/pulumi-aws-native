...
class GetIdentityPoolRoleAttachmentResult:
    ...
    @property
    @pulumi.getter
    def roles(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_identity_pool_role_attachment(id: Optional[builtins.str] = None,
...
def get_identity_pool_role_attachment_output(id: Optional[pulumi.Input[builtins.str]] = None,
