...
class IdentityPoolRoleAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identity_pool_id: An identity pool ID in the format `REGION:GUID` .
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] roles: The map of the roles associated with this pool. For a given role, the key is either "authenticated" or "unauthenticated". The value is the role ARN.
        """
...
class IdentityPoolRoleAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def roles(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The map of the roles associated with this pool. For a given role, the key is either "authenticated" or "unauthenticated". The value is the role ARN.
        """
        return pulumi.get(self, "roles")
