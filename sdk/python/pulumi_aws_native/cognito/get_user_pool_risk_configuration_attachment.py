...
def get_user_pool_risk_configuration_attachment(client_id: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: The app client where this configuration is applied. When this parameter isn't present, the risk configuration applies to all user pool app clients that don't have client-level settings.
    :param builtins.str user_pool_id: The ID of the user pool that has the risk configuration applied.
    """
    __args__ = dict()
...
def get_user_pool_risk_configuration_attachment_output(client_id: Optional[pulumi.Input[builtins.str]] = None,
