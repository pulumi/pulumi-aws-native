...
class GetUserPoolIdentityProviderResult:
    ...
    def attribute_mapping(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def idp_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def provider_details(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_user_pool_identity_provider(provider_name: Optional[builtins.str] = None,
    ...
    :param builtins.str provider_name: The name that you want to assign to the IdP. You can pass the identity provider name in the `identity_provider` query parameter of requests to the [Authorize endpoint](https://docs.aws.amazon.com/cognito/latest/developerguide/authorization-endpoint.html) to silently redirect to sign-in with the associated IdP.
    :param builtins.str user_pool_id: The Id of the user pool where you want to create an IdP.
    """
    __args__ = dict()
...
def get_user_pool_identity_provider_output(provider_name: Optional[pulumi.Input[builtins.str]] = None,
