...
class GetUserPoolIdentityProviderResult:
    ...
    def attribute_mapping(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def idp_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def provider_details(self) -> Optional[Mapping[str, _builtins.str]]:
        """
...
def get_user_pool_identity_provider(provider_name: Optional[_builtins.str] = None,
