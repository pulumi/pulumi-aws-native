...
class IdentityPoolCognitoIdentityProviderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] client_id: The client ID for the Amazon Cognito user pool.
        :param pulumi.Input[builtins.str] provider_name: The provider name for an Amazon Cognito user pool. For example: `cognito-idp.us-east-2.amazonaws.com/us-east-2_123456789` .
        :param pulumi.Input[builtins.bool] server_side_token_check: TRUE if server-side token validation is enabled for the identity provider’s token.
...
if not MYPY:
    class IdentityPoolCognitoStreamsArgsDict(TypedDict):
        ...
        """
        streaming_status: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IdentityPoolCognitoStreamsArgs:
    def __init__(__self__, *,
                 ...
                 streaming_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the role Amazon Cognito can assume to publish to the stream. This role must grant access to Amazon Cognito (cognito-sync) to invoke `PutRecord` on your Amazon Cognito stream.
        :param pulumi.Input[builtins.str] stream_name: The name of the Amazon Cognito stream to receive updates. This stream must be in the developer's account and in the same Region as the identity pool.
        :param pulumi.Input[builtins.str] streaming_status: Status of the Amazon Cognito streams. Valid values are: `ENABLED` or `DISABLED` .
        """
    ...
    def streaming_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Status of the Amazon Cognito streams. Valid values are: `ENABLED` or `DISABLED` .
        """
    ...
    def streaming_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "streaming_status", value)


if not MYPY:
    class IdentityPoolPushSyncArgsDict(TypedDict):
        application_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IdentityPoolPushSyncArgs:
    def __init__(__self__, *,
                 application_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_arns: The ARNs of the Amazon SNS platform applications that could be used by clients.
        :param pulumi.Input[builtins.str] role_arn: An IAM role configured to allow Amazon Cognito to call Amazon SNS on behalf of the developer.
        """
    ...
    def application_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The ARNs of the Amazon SNS platform applications that could be used by clients.
        """
    ...
    def application_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class LogDeliveryConfigurationLogConfigurationArgsDict(TypedDict):
        ...
        event_source: NotRequired[pulumi.Input[builtins.str]]
...
if not MYPY:
    class ManagedLoginBrandingAssetTypeArgsDict(TypedDict):
        ...
        bytes: NotRequired[pulumi.Input[builtins.str]]
...
class ManagedLoginBrandingAssetTypeArgs:
    def __init__(__self__, *,
                 ...
                 color_mode: pulumi.Input['ManagedLoginBrandingColorModeType'],
                 extension: pulumi.Input['ManagedLoginBrandingExtensionType'],
                 bytes: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bytes")

    @bytes.setter
    def bytes(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class UserPoolAddOnsArgsDict(TypedDict):
        ...
        """
        advanced_security_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPoolAddOnsArgs:
    def __init__(__self__, *,
                 ...
                 advanced_security_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] advanced_security_mode: The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.
        """
    ...
    def advanced_security_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The operating mode of threat protection for standard authentication types in your user pool, including username-password and secure remote password (SRP) authentication.
        """
    ...
    def advanced_security_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class UserPoolAdminCreateUserConfigArgsDict(TypedDict):
        ...
        """
        unused_account_validity_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class UserPoolAdminCreateUserConfigArgs:
    def __init__(__self__, *,
                 ...
                 unused_account_validity_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_admin_create_user_only: The setting for allowing self-service sign-up. When `true` , only administrators can create new user profiles. When `false` , users can register themselves and create a new user profile with the `SignUp` operation.
        :param pulumi.Input['UserPoolInviteMessageTemplateArgs'] invite_message_template: The template for the welcome message to new users. This template must include the `{####}` temporary password placeholder if you are creating users with passwords. If your users don't have passwords, you can omit the placeholder.
               ...
               See also [Customizing User Invitation Messages](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pool-settings-message-customizations.html#cognito-user-pool-settings-user-invitation-message-customization) .
        :param pulumi.Input[builtins.int] unused_account_validity_days: This parameter is no longer in use.
    ...
    def unused_account_validity_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This parameter is no longer in use.
    ...
    def unused_account_validity_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class UserPoolAdvancedSecurityAdditionalFlowsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] custom_auth_mode: The operating mode of threat protection in custom authentication with [Custom authentication challenge Lambda triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        """
...
class UserPoolClientAnalyticsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] application_arn: The Amazon Resource Name (ARN) of an Amazon Pinpoint project that you want to connect to your user pool app client. Amazon Cognito publishes events to the Amazon Pinpoint project that `ApplicationArn` declares. You can also configure your application to pass an endpoint ID in the `AnalyticsMetadata` parameter of sign-in operations. The endpoint ID is information about the destination for push notifications
        :param pulumi.Input[builtins.str] application_id: Your Amazon Pinpoint project ID.
        :param pulumi.Input[builtins.str] external_id: The [external ID](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html) of the role that Amazon Cognito assumes to send analytics data to Amazon Pinpoint.
        :param pulumi.Input[builtins.str] role_arn: The ARN of an AWS Identity and Access Management role that has the permissions required for Amazon Cognito to publish events to Amazon Pinpoint analytics.
        :param pulumi.Input[builtins.bool] user_data_shared: If `UserDataShared` is `true` , Amazon Cognito includes user data in the events that it publishes to Amazon Pinpoint analytics.
        """
...
class UserPoolClientTokenValidityUnitsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_token: A time unit for the value that you set in the `AccessTokenValidity` parameter. The default `AccessTokenValidity` time unit is `hours` . `AccessTokenValidity` duration can range from five minutes to one day.
        :param pulumi.Input[builtins.str] id_token: A time unit for the value that you set in the `IdTokenValidity` parameter. The default `IdTokenValidity` time unit is `hours` . `IdTokenValidity` duration can range from five minutes to one day.
        :param pulumi.Input[builtins.str] refresh_token: A time unit for the value that you set in the `RefreshTokenValidity` parameter. The default `RefreshTokenValidity` time unit is `days` . `RefreshTokenValidity` duration can range from 60 minutes to 10 years.
        """
...
if not MYPY:
    class UserPoolCustomEmailSenderArgsDict(TypedDict):
        ...
        """
        lambda_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPoolCustomEmailSenderArgs:
    def __init__(__self__, *,
                 ...
                 lambda_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] lambda_arn: The Amazon Resource Name (ARN) of the function that you want to assign to your Lambda trigger.
        :param pulumi.Input[builtins.str] lambda_version: The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.
    ...
    def lambda_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user pool trigger version of the request that Amazon Cognito sends to your Lambda function. Higher-numbered versions add fields that support new features.
    ...
    def lambda_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserPoolDeviceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] challenge_required_on_new_device: When true, a remembered device can sign in with device authentication instead of SMS and time-based one-time password (TOTP) factors for multi-factor authentication (MFA).
               
               > Whether or not `ChallengeRequiredOnNewDevice` is true, users who sign in with devices that have not been confirmed or remembered must still provide a second factor in a user pool that requires MFA.
        :param pulumi.Input[builtins.bool] device_only_remembered_on_user_prompt: When true, Amazon Cognito doesn't automatically remember a user's device when your app sends a `ConfirmDevice` API request. In your app, create a prompt for your user to choose whether they want to remember their device. Return the user's choice in an `UpdateDeviceStatus` API request.
...
class UserPoolEmailConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] configuration_set: The set of configuration rules that can be applied to emails sent using Amazon Simple Email Service. A configuration set is applied to an email by including a reference to the configuration set in the headers of the email. Once applied, all of the rules in that configuration set are applied to the email. Configuration sets can be used to apply the following types of rules to emails:
               
               - **Event publishing** - Amazon Simple Email Service can track the number of send, delivery, open, click, bounce, and complaint events for each email sent. Use event publishing to send information about these events to other AWS services such as and Amazon CloudWatch
               - **IP pool management** - When leasing dedicated IP addresses with Amazon Simple Email Service, you can create groups of IP addresses, called dedicated IP pools. You can then associate the dedicated IP pools with configuration sets.
        :param pulumi.Input[builtins.str] email_sending_account: Specifies whether Amazon Cognito uses its built-in functionality to send your users email messages, or uses your Amazon Simple Email Service email configuration. Specify one of the following values:
               ...
               Before Amazon Cognito can email your users, it requires additional permissions to call Amazon SES on your behalf. When you update your user pool with this option, Amazon Cognito creates a *service-linked role* , which is a type of role in your AWS account . This role contains the permissions that allow you to access Amazon SES and send email messages from your email address. For more information about the service-linked role that Amazon Cognito creates, see [Using Service-Linked Roles for Amazon Cognito](https://docs.aws.amazon.com/cognito/latest/developerguide/using-service-linked-roles.html) in the *Amazon Cognito Developer Guide* .
        :param pulumi.Input[builtins.str] from_: Either the sender’s email address or the sender’s name with their email address. For example, `testuser@example.com` or `Test User <testuser@example.com>` . This address appears before the body of the email.
        :param pulumi.Input[builtins.str] reply_to_email_address: The destination to which the receiver of the email should reply.
        :param pulumi.Input[builtins.str] source_arn: The ARN of a verified email address or an address from a verified domain in Amazon SES. You can set a `SourceArn` email from a verified domain only with an API request. You can set a verified email address, but not an address in a verified domain, in the Amazon Cognito console. Amazon Cognito uses the email address that you provide in one of the following ways, depending on the value that you specify for the `EmailSendingAccount` parameter:
...
class UserPoolInviteMessageTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] email_message: The message template for email messages. EmailMessage is allowed only if [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is DEVELOPER.
        :param pulumi.Input[builtins.str] email_subject: The subject line for email messages. EmailSubject is allowed only if [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is DEVELOPER.
        :param pulumi.Input[builtins.str] sms_message: The message template for SMS messages.
        """
...
class UserPoolLambdaConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] create_auth_challenge: The configuration of a create auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        ...
        :param pulumi.Input[builtins.str] custom_message: A custom message Lambda trigger. This trigger is an opportunity to customize all SMS and email messages from your user pool. When a custom message trigger is active, your user pool routes all messages to a Lambda function that returns a runtime-customized message subject and body for your user pool to deliver to a user.
        ...
        :param pulumi.Input[builtins.str] define_auth_challenge: The configuration of a define auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of an [KMS key](https://docs.aws.amazon.com//kms/latest/developerguide/concepts.html#master_keys) . Amazon Cognito uses the key to encrypt codes and temporary passwords sent to custom sender Lambda triggers.
        :param pulumi.Input[builtins.str] post_authentication: The configuration of a [post authentication Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-post-authentication.html) in a user pool. This trigger can take custom actions after a user signs in.
        :param pulumi.Input[builtins.str] post_confirmation: The configuration of a [post confirmation Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-post-confirmation.html) in a user pool. This trigger can take custom actions after a user confirms their user account and their email address or phone number.
        :param pulumi.Input[builtins.str] pre_authentication: The configuration of a [pre authentication trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-authentication.html) in a user pool. This trigger can evaluate and modify user sign-in events.
        :param pulumi.Input[builtins.str] pre_sign_up: The configuration of a [pre sign-up Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-sign-up.html) in a user pool. This trigger evaluates new users and can bypass confirmation, [link a federated user profile](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-identity-federation-consolidate-users.html) , or block sign-up requests.
        :param pulumi.Input[builtins.str] pre_token_generation: The legacy configuration of a [pre token generation Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-pre-token-generation.html) in a user pool.
        ...
        :param pulumi.Input[builtins.str] user_migration: The configuration of a [migrate user Lambda trigger](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-migrate-user.html) in a user pool. This trigger can create user profiles when users sign in or attempt to reset their password with credentials that don't exist yet.
        :param pulumi.Input[builtins.str] verify_auth_challenge_response: The configuration of a verify auth challenge Lambda trigger, one of three triggers in the sequence of the [custom authentication challenge triggers](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-lambda-challenge.html) .
        """
...
class UserPoolNumberAttributeConstraintsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] max_value: The maximum length of a number attribute value. Must be a number less than or equal to `2^1023` , represented as a string with a length of 131072 characters or fewer.
        :param pulumi.Input[builtins.str] min_value: The minimum value of an attribute that is of the number data type.
        """
...
class UserPoolPasswordPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] minimum_length: The minimum length of the password in the policy that you have set. This value can't be less than 6.
        :param pulumi.Input[builtins.int] password_history_size: The number of previous passwords that you want Amazon Cognito to restrict each user from reusing. Users can't set a password that matches any of `n` previous passwords, where `n` is the value of `PasswordHistorySize` .
        :param pulumi.Input[builtins.bool] require_lowercase: The requirement in a password policy that users must include at least one lowercase letter in their password.
        :param pulumi.Input[builtins.bool] require_numbers: The requirement in a password policy that users must include at least one number in their password.
        :param pulumi.Input[builtins.bool] require_symbols: The requirement in a password policy that users must include at least one symbol in their password.
        :param pulumi.Input[builtins.bool] require_uppercase: The requirement in a password policy that users must include at least one uppercase letter in their password.
        :param pulumi.Input[builtins.int] temporary_password_validity_days: The number of days a temporary password is valid in the password policy. If the user doesn't sign in during this time, an administrator must reset their password. Defaults to `7` . If you submit a value of `0` , Amazon Cognito treats it as a null value and sets `TemporaryPasswordValidityDays` to its default value.
...
class UserPoolRecoveryOptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The recovery method that this object sets a recovery option for.
        :param pulumi.Input[builtins.int] priority: Your priority preference for using the specified attribute in account recovery. The highest priority is `1` .
        """
        if name is not None:
...
class UserPoolRiskConfigurationAttachmentAccountTakeoverActionTypeArgs:
    def __init__(__self__, *,
                 ...
                 notify: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] event_action: The action to take for the attempted account takeover action for the associated risk level. Valid values are as follows:
               
               - `BLOCK` : Block the request.
               - `MFA_IF_CONFIGURED` : Present an MFA challenge if possible. MFA is possible if the user pool has active MFA methods that the user can set up. For example, if the user pool only supports SMS message MFA but the user doesn't have a phone number attribute, MFA setup isn't possible. If MFA setup isn't possible, allow the request.
               - `MFA_REQUIRED` : Present an MFA challenge if possible. Block the request if a user hasn't set up MFA. To sign in with required MFA, users must have an email address or phone number attribute, or a registered TOTP factor.
               - `NO_ACTION` : Take no action. Permit sign-in.
        :param pulumi.Input[builtins.bool] notify: Determines whether Amazon Cognito sends a user a notification message when your user pools assesses a user's session at the associated risk level.
        """
...
class UserPoolRiskConfigurationAttachmentCompromisedCredentialsActionsTypeArgs:
    def __init__(__self__, *,
                 event_action: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] event_action: The action that Amazon Cognito takes when it detects compromised credentials.
        """
        pulumi.set(__self__, "event_action", event_action)
...
if not MYPY:
    class UserPoolRiskConfigurationAttachmentCompromisedCredentialsRiskConfigurationTypeArgsDict(TypedDict):
        ...
        """
        event_filter: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class UserPoolRiskConfigurationAttachmentCompromisedCredentialsRiskConfigurationTypeArgs:
    def __init__(__self__, *,
                 ...
                 event_filter: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_filter: Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.
        """
        pulumi.set(__self__, "actions", actions)
    ...
    def event_filter(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Settings for the sign-in activity where you want to configure compromised-credentials actions. Defaults to all events.
        """
    ...
    @event_filter.setter
    def event_filter(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class UserPoolRiskConfigurationAttachmentNotifyEmailTypeArgsDict(TypedDict):
        ...
        """
        text_body: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPoolRiskConfigurationAttachmentNotifyEmailTypeArgs:
    def __init__(__self__, *,
                 ...
                 text_body: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] subject: The subject of the threat protection email notification.
        :param pulumi.Input[builtins.str] html_body: The body of an email notification formatted in HTML. Choose an `HtmlBody` or a `TextBody` to send an HTML-formatted or plaintext message, respectively.
        :param pulumi.Input[builtins.str] text_body: The body of an email notification formatted in plaintext. Choose an `HtmlBody` or a `TextBody` to send an HTML-formatted or plaintext message, respectively.
        """
    ...
    def text_body(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The body of an email notification formatted in plaintext. Choose an `HtmlBody` or a `TextBody` to send an HTML-formatted or plaintext message, respectively.
        """
    ...
    @text_body.setter
    def text_body(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "text_body", value)


if not MYPY:
    class UserPoolRiskConfigurationAttachmentRiskExceptionConfigurationTypeArgsDict(TypedDict):
        blocked_ip_range_list: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        skipped_ip_range_list: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class UserPoolRiskConfigurationAttachmentRiskExceptionConfigurationTypeArgs:
    def __init__(__self__, *,
                 blocked_ip_range_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 skipped_ip_range_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] blocked_ip_range_list: An always-block IP address list. Overrides the risk decision and always blocks authentication requests. This parameter is displayed and set in CIDR notation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] skipped_ip_range_list: An always-allow IP address list. Risk detection isn't performed on the IP addresses in this range list. This parameter is displayed and set in CIDR notation.
        """
    ...
    def blocked_ip_range_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An always-block IP address list. Overrides the risk decision and always blocks authentication requests. This parameter is displayed and set in CIDR notation.
        """
    ...
    def blocked_ip_range_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "blocked_ip_range_list", value)

    @property
    @pulumi.getter(name="skippedIpRangeList")
    def skipped_ip_range_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An always-allow IP address list. Risk detection isn't performed on the IP addresses in this range list. This parameter is displayed and set in CIDR notation.
        """
    ...
    def skipped_ip_range_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "skipped_ip_range_list", value)


if not MYPY:
    class UserPoolSchemaAttributeArgsDict(TypedDict):
        attribute_data_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPoolSchemaAttributeArgs:
    def __init__(__self__, *,
                 attribute_data_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] attribute_data_type: The data format of the values for your attribute. When you choose an `AttributeDataType` , Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example `"custom:isMember" : "true"` or `"custom:YearsAsMember" : "12"` .
        :param pulumi.Input[builtins.bool] developer_only_attribute: > You should use [WriteAttributes](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_UserPoolClientType.html#CognitoUserPools-Type-UserPoolClientType-WriteAttributes) in the user pool client to control how attributes can be mutated for new use cases instead of using `DeveloperOnlyAttribute` . 
               
               Specifies whether the attribute type is developer only. This attribute can only be modified by an administrator. Users won't be able to modify this attribute using their access token. For example, `DeveloperOnlyAttribute` can be modified using AdminUpdateUserAttributes but can't be updated using UpdateUserAttributes.
        :param pulumi.Input[builtins.bool] mutable: Specifies whether the value of the attribute can be changed.
               
               Any user pool attribute whose value you map from an IdP attribute must be mutable, with a parameter value of `true` . Amazon Cognito updates mapped attributes when users sign in to your application through an IdP. If an attribute is immutable, Amazon Cognito throws an error when it attempts to update the attribute. For more information, see [Specifying Identity Provider Attribute Mappings for Your User Pool](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-specifying-attribute-mapping.html) .
        :param pulumi.Input[builtins.str] name: The name of your user pool attribute. When you create or update a user pool, adding a schema attribute creates a custom or developer-only attribute. When you add an attribute with a `Name` value of `MyAttribute` , Amazon Cognito creates the custom attribute `custom:MyAttribute` . When `DeveloperOnlyAttribute` is `true` , Amazon Cognito creates your attribute as `dev:MyAttribute` . In an operation that describes a user pool, Amazon Cognito returns this value as `value` for standard attributes, `custom:value` for custom attributes, and `dev:value` for developer-only attributes..
        ...
        :param pulumi.Input[builtins.bool] required: Specifies whether a user pool attribute is required. If the attribute is required and the user doesn't provide a value, registration or sign-in will fail.
    ...
    def attribute_data_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The data format of the values for your attribute. When you choose an `AttributeDataType` , Amazon Cognito validates the input against the data type. A custom attribute value in your user's ID token is always a string, for example `"custom:isMember" : "true"` or `"custom:YearsAsMember" : "12"` .
        """
    ...
    def attribute_data_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserPoolSignInPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_first_auth_factors: The sign-in methods that a user pool supports as the first factor. You can permit users to start authentication with a standard username and password, or with other one-time password and hardware factors.
...
if not MYPY:
    class UserPoolSmsConfigurationArgsDict(TypedDict):
        ...
        """
        sns_caller_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPoolSmsConfigurationArgs:
    def __init__(__self__, *,
                 external_id: Optional[pulumi.Input[builtins.str]] = None,
                 sns_caller_arn: Optional[pulumi.Input[builtins.str]] = None,
                 sns_region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] external_id: The external ID provides additional security for your IAM role. You can use an `ExternalId` with the IAM role that you use with Amazon SNS to send SMS messages for your user pool. If you provide an `ExternalId` , your Amazon Cognito user pool includes it in the request to assume your IAM role. You can configure the role trust policy to require that Amazon Cognito, and any principal, provide the `ExternalID` . If you use the Amazon Cognito Management Console to create a role for SMS multi-factor authentication (MFA), Amazon Cognito creates a role with the required permissions and a trust policy that demonstrates use of the `ExternalId` .
               
               For more information about the `ExternalId` of a role, see [How to use an external ID when granting access to your AWS resources to a third party](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html) .
        :param pulumi.Input[builtins.str] sns_caller_arn: The Amazon Resource Name (ARN) of the Amazon SNS caller. This is the ARN of the IAM role in your AWS account that Amazon Cognito will use to send SMS messages. SMS messages are subject to a [spending limit](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html) .
        :param pulumi.Input[builtins.str] sns_region: The AWS Region to use with Amazon SNS integration. You can choose the same Region as your user pool, or a supported *Legacy Amazon SNS alternate Region* .
    ...
    def sns_caller_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Amazon SNS caller. This is the ARN of the IAM role in your AWS account that Amazon Cognito will use to send SMS messages. SMS messages are subject to a [spending limit](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html) .
        """
    ...
    def sns_caller_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserPoolStringAttributeConstraintsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] max_length: The maximum length of a string attribute value. Must be a number less than or equal to `2^1023` , represented as a string with a length of 131072 characters or fewer.
        :param pulumi.Input[builtins.str] min_length: The minimum length of a string attribute value.
        """
...
if not MYPY:
    class UserPoolUserAttributeUpdateSettingsArgsDict(TypedDict):
        attributes_require_verification_before_update: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class UserPoolUserAttributeUpdateSettingsArgs:
    def __init__(__self__, *,
                 attributes_require_verification_before_update: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attributes_require_verification_before_update: Requires that your user verifies their email address, phone number, or both before Amazon Cognito updates the value of that attribute. When you update a user attribute that has this option activated, Amazon Cognito sends a verification message to the new phone number or email address. Amazon Cognito doesn’t change the value of the attribute until your user responds to the verification message and confirms the new value.
    ...
    def attributes_require_verification_before_update(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Requires that your user verifies their email address, phone number, or both before Amazon Cognito updates the value of that attribute. When you update a user attribute that has this option activated, Amazon Cognito sends a verification message to the new phone number or email address. Amazon Cognito doesn’t change the value of the attribute until your user responds to the verification message and confirms the new value.
    ...
    def attributes_require_verification_before_update(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class UserPoolUsernameConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] case_sensitive: Specifies whether user name case sensitivity will be applied for all users in the user pool through Amazon Cognito APIs. For most use cases, set case sensitivity to `False` (case insensitive) as a best practice. When usernames and email addresses are case insensitive, users can sign in as the same user when they enter a different capitalization of their user name.
...
class UserPoolVerificationMessageTemplateArgs:
    def __init__(__self__, *,
                 ...
                 sms_message: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] default_email_option: The configuration of verification emails to contain a clickable link or a verification code.
               
               For link, your template body must contain link text in the format `{##Click here##}` . "Click here" in the example is a customizable string. For code, your template body must contain a code placeholder in the format `{####}` .
        :param pulumi.Input[builtins.str] email_message: The template for email messages that Amazon Cognito sends to your users. You can set an `EmailMessage` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param pulumi.Input[builtins.str] email_message_by_link: The email message template for sending a confirmation link to the user. You can set an `EmailMessageByLink` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param pulumi.Input[builtins.str] email_subject: The subject line for the email message template. You can set an `EmailSubject` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param pulumi.Input[builtins.str] email_subject_by_link: The subject line for the email message template for sending a confirmation link to the user. You can set an `EmailSubjectByLink` template only if the value of [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` . When your [EmailSendingAccount](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_EmailConfigurationType.html#CognitoUserPools-Type-EmailConfigurationType-EmailSendingAccount) is `DEVELOPER` , your user pool sends email messages with your own Amazon SES configuration.
        :param pulumi.Input[builtins.str] sms_message: The template for SMS messages that Amazon Cognito sends to your users.
        """
