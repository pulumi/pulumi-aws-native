...
class UserPoolClientAnalyticsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] application_arn: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpoolclient-analyticsconfiguration.html#cfn-cognito-userpoolclient-analyticsconfiguration-applicationarn
...
class UserPoolInviteMessageTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] s_ms_message: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-invitemessagetemplate.html#cfn-cognito-userpool-invitemessagetemplate-smsmessage
        """
...
class UserPoolLambdaConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] k_ms_key_id: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-lambdaconfig.html#cfn-cognito-userpool-lambdaconfig-kmskeyid
