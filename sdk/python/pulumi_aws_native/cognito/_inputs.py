...
class UserPoolDomainCustomDomainConfigTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] certificate_arn: The Amazon Resource Name (ARN) of an AWS Certificate Manager SSL certificate. You use this certificate for the subdomain of your custom domain.
        """
...
class UserPoolRiskConfigurationAttachmentNotifyConfigurationTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reply_to: The reply-to email address of an email template.
        """
        pulumi.set(__self__, "source_arn", source_arn)
