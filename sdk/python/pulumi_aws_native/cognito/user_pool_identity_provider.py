...
class UserPoolIdentityProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] provider_type: The type of IdP that you want to add. Amazon Cognito supports OIDC, SAML 2.0, Login With Amazon, Sign In With Apple, Google, and Facebook IdPs.
        :param pulumi.Input[_builtins.str] user_pool_id: The Id of the user pool where you want to create an IdP.
