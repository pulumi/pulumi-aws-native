...
class UserPoolArgs:
    def __init__(__self__, *,
                 ...
                 email_authentication_message: Optional[pulumi.Input[builtins.str]] = None,
                 email_authentication_subject: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 enabled_mfas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 user_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_pool_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 web_authn_relying_party_id: Optional[pulumi.Input[builtins.str]] = None,
                 web_authn_user_verification: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] email_verification_message: This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        :param pulumi.Input[builtins.str] email_verification_subject: This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_mfas: Set enabled MFA options on a specified user pool. To disable all MFAs after it has been enabled, set `MfaConfiguration` to `OFF` and remove EnabledMfas. MFAs can only be all disabled if `MfaConfiguration` is `OFF` . After you enable `SMS_MFA` , you can only disable it by setting `MfaConfiguration` to `OFF` . Can be one of the following values:
        ...
        :param pulumi.Input[builtins.str] mfa_configuration: Displays the state of multi-factor authentication (MFA) as on, off, or optional. When `ON` , all users must set up MFA before they can sign in. When `OPTIONAL` , your application must make a client-side determination of whether a user wants to register an MFA device. For user pools with adaptive authentication with threat protection, choose `OPTIONAL` .
        ...
        :param pulumi.Input[builtins.str] sms_authentication_message: The contents of the SMS authentication message.
        ...
        :param pulumi.Input[builtins.str] sms_verification_message: This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        ...
        :param pulumi.Input[builtins.str] user_pool_name: A friendly name for your user pool.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_pool_tags: The tag keys and values to assign to the user pool. A tag is a label that you can use to categorize and manage user pools in different ways, such as by purpose, owner, environment, or other criteria.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] username_attributes: Specifies whether a user can use an email address or phone number as a username when they sign up.
        ...
        :param pulumi.Input[builtins.str] web_authn_relying_party_id: Sets or displays the authentication domain, typically your user pool domain, that passkey providers must use as a relying party (RP) in their configuration.
    ...
    def email_authentication_message(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "email_authentication_message")

    @email_authentication_message.setter
    def email_authentication_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_authentication_message", value)

    @property
    @pulumi.getter(name="emailAuthenticationSubject")
    def email_authentication_subject(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "email_authentication_subject")

    @email_authentication_subject.setter
    def email_authentication_subject(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enabled_mfas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @enabled_mfas.setter
    def enabled_mfas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def user_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_pool_name", value)

    @property
    @pulumi.getter(name="userPoolTags")
    def user_pool_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_pool_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def web_authn_relying_party_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def web_authn_relying_party_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "web_authn_relying_party_id", value)

    @property
    @pulumi.getter(name="webAuthnUserVerification")
    def web_authn_user_verification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When `required` , users can only register and sign in users with passkeys that are capable of [user verification](https://docs.aws.amazon.com/https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement) . When `preferred` , your user pool doesn't require the use of authenticators with user verification but encourages it.
        """
    ...
    def web_authn_user_verification(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserPool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="emailAuthenticationMessage")
    def email_authentication_message(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "email_authentication_message")

    @property
    @pulumi.getter(name="emailAuthenticationSubject")
    def email_authentication_subject(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "email_authentication_subject")
    ...
    @property
    @pulumi.getter(name="emailVerificationMessage")
    def email_verification_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        """
        return pulumi.get(self, "email_verification_message")
    ...
    @property
    @pulumi.getter(name="emailVerificationSubject")
    def email_verification_subject(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        """
        return pulumi.get(self, "email_verification_subject")
    ...
    @property
    @pulumi.getter(name="enabledMfas")
    def enabled_mfas(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set enabled MFA options on a specified user pool. To disable all MFAs after it has been enabled, set `MfaConfiguration` to `OFF` and remove EnabledMfas. MFAs can only be all disabled if `MfaConfiguration` is `OFF` . After you enable `SMS_MFA` , you can only disable it by setting `MfaConfiguration` to `OFF` . Can be one of the following values:
    ...
    def provider_url(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="smsVerificationMessage")
    def sms_verification_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is no longer used. See [VerificationMessageTemplateType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-verificationmessagetemplate.html) .
        """
        return pulumi.get(self, "sms_verification_message")
    ...
    @property
    @pulumi.getter(name="userPoolName")
    def user_pool_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A friendly name for your user pool.
        """
        return pulumi.get(self, "user_pool_name")
    ...
    @property
    @pulumi.getter(name="userPoolTags")
    def user_pool_tags(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The tag keys and values to assign to the user pool. A tag is a label that you can use to categorize and manage user pools in different ways, such as by purpose, owner, environment, or other criteria.
        """
        return pulumi.get(self, "user_pool_tags")
    ...
    @property
    @pulumi.getter(name="webAuthnRelyingPartyId")
    def web_authn_relying_party_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Sets or displays the authentication domain, typically your user pool domain, that passkey providers must use as a relying party (RP) in their configuration.
    ...
    @property
    @pulumi.getter(name="webAuthnUserVerification")
    def web_authn_user_verification(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When `required` , users can only register and sign in users with passkeys that are capable of [user verification](https://docs.aws.amazon.com/https://www.w3.org/TR/webauthn-2/#enum-userVerificationRequirement) . When `preferred` , your user pool doesn't require the use of authenticators with user verification but encourages it.
        """
        return pulumi.get(self, "web_authn_user_verification")
