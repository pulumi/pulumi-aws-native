...
__all__ = ['UserPoolUserToGroupAttachment']
...
class UserPoolUserToGroupAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolUserToGroupAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolUserToGroupAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolUserToGroupAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolUserToGroupAttachmentProperties']:
        """
