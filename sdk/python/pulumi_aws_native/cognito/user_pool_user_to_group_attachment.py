...
class UserPoolUserToGroupAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_name: The name of the group that you want to add your user to.
        :param pulumi.Input[builtins.str] user_pool_id: The ID of the user pool that contains the group that you want to add the user to.
        :param pulumi.Input[builtins.str] username: The user's username.
        """
