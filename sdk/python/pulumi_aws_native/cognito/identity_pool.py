...
class IdentityPool(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['IdentityPoolPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['IdentityPoolPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.IdentityPoolAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.IdentityPoolProperties']:
        """
