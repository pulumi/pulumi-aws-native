...
class IdentityPoolArgs:
    def __init__(__self__, *,
                 allow_unauthenticated_identities: pulumi.Input[builtins.bool],
                 ...
                 open_id_connect_provider_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_unauthenticated_identities: Specifies whether the identity pool supports unauthenticated logins.
        :param pulumi.Input[builtins.bool] allow_classic_flow: Enables the Basic (Classic) authentication flow.
        ...
        :param pulumi.Input[builtins.str] developer_provider_name: The "domain" Amazon Cognito uses when referencing your users. This name acts as a placeholder that allows your backend and the Amazon Cognito service to communicate about the developer provider. For the `DeveloperProviderName` , you can use letters and periods (.), underscores (_), and dashes (-).
               
               *Minimum length* : 1
               
               *Maximum length* : 100
        :param pulumi.Input[builtins.str] identity_pool_name: The name of your Amazon Cognito identity pool.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] open_id_connect_provider_arns: The Amazon Resource Names (ARNs) of the OpenID connect providers.
        :param pulumi.Input['IdentityPoolPushSyncArgs'] push_sync: The configuration options to be applied to the identity pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] saml_provider_arns: The Amazon Resource Names (ARNs) of the Security Assertion Markup Language (SAML) providers.
    ...
    def allow_unauthenticated_identities(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def allow_unauthenticated_identities(self, value: pulumi.Input[builtins.bool]):
    ...
    def open_id_connect_provider_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def open_id_connect_provider_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IdentityPool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowUnauthenticatedIdentities")
    def allow_unauthenticated_identities(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the identity pool supports unauthenticated logins.
        """
        return pulumi.get(self, "allow_unauthenticated_identities")
    ...
    @property
    @pulumi.getter(name="identityPoolName")
    def identity_pool_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of your Amazon Cognito identity pool.
    ...
    @property
    @pulumi.getter(name="openIdConnectProviderArns")
    def open_id_connect_provider_arns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The Amazon Resource Names (ARNs) of the OpenID connect providers.
        """
        return pulumi.get(self, "open_id_connect_provider_arns")
