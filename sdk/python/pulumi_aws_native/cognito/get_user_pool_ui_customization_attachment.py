...
class GetUserPoolUiCustomizationAttachmentResult:
    ...
    @property
    @pulumi.getter
    def css(self) -> Optional[builtins.str]:
        """
...
def get_user_pool_ui_customization_attachment(client_id: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: The app client ID for your UI customization. When this value isn't present, the customization applies to all user pool app clients that don't have client-level settings..
    :param builtins.str user_pool_id: The ID of the user pool where you want to apply branding to the classic hosted UI.
    """
    __args__ = dict()
...
def get_user_pool_ui_customization_attachment_output(client_id: Optional[pulumi.Input[builtins.str]] = None,
