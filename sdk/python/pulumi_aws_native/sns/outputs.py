...
class TopicLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failure_feedback_role_arn: Optional[builtins.str] = None,
                 success_feedback_role_arn: Optional[builtins.str] = None,
                 success_feedback_sample_rate: Optional[builtins.str] = None):
        """
        The ``LoggingConfig`` property type specifies the ``Delivery`` status logging configuration for an [AWS::SNS::Topic](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html).
        ...
        :param builtins.str failure_feedback_role_arn: The IAM role ARN to be used when logging failed message deliveries in Amazon CloudWatch.
        :param builtins.str success_feedback_role_arn: The IAM role ARN to be used when logging successful message deliveries in Amazon CloudWatch.
        :param builtins.str success_feedback_sample_rate: The percentage of successful message deliveries to be logged in Amazon CloudWatch. Valid percentage values range from 0 to 100.
        """
    ...
    def failure_feedback_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def success_feedback_role_arn(self) -> Optional[builtins.str]:
        """
    ...
    def success_feedback_sample_rate(self) -> Optional[builtins.str]:
        """
...
class TopicSubscription(dict):
    ...
    def __init__(__self__, *,
        ...
        ``Subscription`` is an embedded property that describes the subscription endpoints of an SNS topic.
          For full control over subscription behavior (for example, delivery policy, filtering, raw message delivery, and cross-region subscriptions), use the [AWS::SNS::Subscription](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-subscription.html) resource.
        :param builtins.str endpoint: The endpoint that receives notifications from the SNS topic. The endpoint value depends on the protocol that you specify. For more information, see the ``Endpoint`` parameter of the ``Subscribe`` action in the *API Reference*.
        :param builtins.str protocol: The subscription's protocol. For more information, see the ``Protocol`` parameter of the ``Subscribe`` action in the *API Reference*.
        """
