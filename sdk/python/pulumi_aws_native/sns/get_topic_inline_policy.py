...
def get_topic_inline_policy(topic_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTopicInlinePolicyResult:
    """
    Schema for AWS::SNS::TopicInlinePolicy


    :param builtins.str topic_arn: The Amazon Resource Name (ARN) of the topic to which you want to add the policy.
    """
    __args__ = dict()
...
def get_topic_inline_policy_output(topic_arn: Optional[pulumi.Input[builtins.str]] = None,
