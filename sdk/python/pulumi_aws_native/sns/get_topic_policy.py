...
def get_topic_policy(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The provider-assigned unique ID for this managed resource.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_topic_policy_output(id: Optional[pulumi.Input[_builtins.str]] = None,
