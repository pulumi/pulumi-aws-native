...
class GetRoomResult:
    ...
    def logging_configuration_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def maximum_message_length(self) -> Optional[builtins.int]:
        """
    ...
    def maximum_message_rate_per_second(self) -> Optional[builtins.int]:
        """
...
def get_room(arn: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRoomResult:
    """
    Resource type definition for AWS::IVSChat::Room.


    :param builtins.str arn: Room ARN is automatically generated on creation and assigned as the unique identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_room_output(arn: Optional[pulumi.Input[builtins.str]] = None,
