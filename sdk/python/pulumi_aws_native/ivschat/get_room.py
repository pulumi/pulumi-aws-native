...
class GetRoomResult:
    ...
    def logging_configuration_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def maximum_message_length(self) -> Optional[_builtins.int]:
        """
    ...
    def maximum_message_rate_per_second(self) -> Optional[_builtins.int]:
        """
...
def get_room(arn: Optional[_builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRoomResult:
    """
    Resource type definition for AWS::IVSChat::Room.


    :param _builtins.str arn: Room ARN is automatically generated on creation and assigned as the unique identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
