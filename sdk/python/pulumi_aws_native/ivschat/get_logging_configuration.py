...
def get_logging_configuration(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: LoggingConfiguration ARN is automatically generated on creation and assigned as the unique identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_logging_configuration_output(arn: Optional[pulumi.Input[builtins.str]] = None,
