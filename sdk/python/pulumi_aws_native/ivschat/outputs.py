...
class LoggingConfigurationCloudWatchLogsDestinationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CloudWatch destination configuration for IVS Chat logging.
        :param builtins.str log_group_name: Name of the Amazon CloudWatch Logs log group where chat activity will be logged.
        """
...
class RoomMessageReviewHandler(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str uri: Identifier of the message review handler.
        """
