...
class LoggingConfigurationCloudWatchLogsDestinationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        CloudWatch destination configuration for IVS Chat logging.
        :param pulumi.Input[builtins.str] log_group_name: Name of the Amazon CloudWatch Logs log group where chat activity will be logged.
        """
...
class RoomMessageReviewHandlerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] uri: Identifier of the message review handler.
        """
