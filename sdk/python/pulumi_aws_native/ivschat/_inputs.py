...
class LoggingConfigurationDestinationConfigurationArgsDict(TypedDict):
    ...
    """
    cloud_watch_logs: NotRequired[pulumi.Input[Optional['LoggingConfigurationCloudWatchLogsDestinationConfigurationArgsDict']]]
    """
    An Amazon CloudWatch Logs destination configuration where chat activity will be logged.
    """
    firehose: NotRequired[pulumi.Input[Optional['LoggingConfigurationFirehoseDestinationConfigurationArgsDict']]]
    """
    An Amazon Kinesis Data Firehose destination configuration where chat activity will be logged.
    """
    s3: NotRequired[pulumi.Input[Optional['LoggingConfigurationS3DestinationConfigurationArgsDict']]]
    """
