...
def get_instance_access_control_attribute_configuration(instance_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_arn: The ARN of the AWS SSO instance under which the operation will be executed.
    """
    __args__ = dict()
...
def get_instance_access_control_attribute_configuration_output(instance_arn: Optional[pulumi.Input[builtins.str]] = None,
