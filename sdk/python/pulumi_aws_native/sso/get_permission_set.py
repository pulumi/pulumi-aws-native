...
class GetPermissionSetResult:
    ...
    def managed_policies(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def permission_set_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def relay_state_type(self) -> Optional[_builtins.str]:
        """
...
def get_permission_set(instance_arn: Optional[_builtins.str] = None,
                       permission_set_arn: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPermissionSetResult:
    """
    Resource Type definition for SSO PermissionSet


    :param _builtins.str instance_arn: The sso instance arn that the permission set is owned.
    :param _builtins.str permission_set_arn: The permission set that the policy will be attached to
    """
    __args__ = dict()
