...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] name: The name you want to assign to this Identity Center (SSO) Instance
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Specifies tags to be attached to the instance of IAM Identity Center.
        """
        ...
    @overload
    def __init__(__self__,
