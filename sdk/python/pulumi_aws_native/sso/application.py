...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_provider_arn: The ARN of the application provider under which the operation will run
        :param pulumi.Input[builtins.str] instance_arn: The ARN of the instance of IAM Identity Center under which the operation will run
        :param pulumi.Input[builtins.str] description: The description information for the Identity Center (SSO) Application
        :param pulumi.Input[builtins.str] name: The name you want to assign to this Identity Center (SSO) Application
...
@pulumi.type_token("aws-native:sso:Application")
