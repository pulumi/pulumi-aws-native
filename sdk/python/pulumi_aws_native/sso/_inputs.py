...
class ApplicationPortalOptionsConfigurationArgsDict(TypedDict):
    ...
    """
    sign_in_options: NotRequired[pulumi.Input[Optional['ApplicationSignInOptionsArgsDict']]]
    """
...
class InstanceAccessControlAttributeConfigurationAccessControlAttributeValueArgsDict(TypedDict):
    source: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
...
class InstanceAccessControlAttributeConfigurationAccessControlAttributeValueArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def source(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "source")

    @source.setter
    def source(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class PermissionSetPermissionsBoundaryArgsDict(TypedDict):
    customer_managed_policy_reference: NotRequired[pulumi.Input[Optional['PermissionSetCustomerManagedPolicyReferenceArgsDict']]]
    """
