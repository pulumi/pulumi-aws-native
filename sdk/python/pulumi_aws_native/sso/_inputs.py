...
class ApplicationSignInOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_url: The URL that accepts authentication requests for an application, this is a required parameter if the Origin parameter is APPLICATION
        """
...
if not MYPY:
    class InstanceAccessControlAttributeConfigurationAccessControlAttributeValueArgsDict(TypedDict):
        source: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
elif False:
...
class InstanceAccessControlAttributeConfigurationAccessControlAttributeValueArgs:
    ...
    @property
    @pulumi.getter
    def source(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "source")

    @source.setter
    def source(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class PermissionSetCustomerManagedPolicyReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the IAM policy that you have configured in each account where you want to deploy your permission set.
        :param pulumi.Input[builtins.str] path: The path to the IAM policy that you have configured in each account where you want to deploy your permission set. The default is `/` . For more information, see [Friendly names and paths](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-friendly-names) in the *IAM User Guide* .
        """
...
class PermissionSetPermissionsBoundaryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_policy_arn: The AWS managed policy ARN that you want to attach to a permission set as a permissions boundary.
        """
