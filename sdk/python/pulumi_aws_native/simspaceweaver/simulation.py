...
class SimulationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] maximum_duration: The maximum running time of the simulation.
        :param pulumi.Input[builtins.str] name: The name of the simulation.
...
class Simulation(pulumi.CustomResource):
    ...
    def describe_payload(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maximumDuration")
    def maximum_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum running time of the simulation.
        """
        return pulumi.get(self, "maximum_duration")
