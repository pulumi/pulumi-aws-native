...
class SimulationS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The Schema S3 bucket name.
        :param builtins.str object_key: This is the schema S3 object key, which includes the full path of "folders" from the bucket root to the schema.
        """
