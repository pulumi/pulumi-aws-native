...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] home_directory_type: The type of landing directory (folder) that you want your users' home directory to be when they log in to the server. If you set it to `PATH` , the user will see the absolute Amazon S3 bucket or Amazon EFS path as is in their file transfer protocol clients. If you set it to `LOGICAL` , you need to provide mappings in the `HomeDirectoryMappings` for how you want to make Amazon S3 or Amazon EFS paths visible to your users.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['UserSshPublicKeyArgs']]] ssh_public_keys: Specifies the public key portion of the Secure Shell (SSH) keys stored for the described user.
...
class User(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ssh_public_keys: Optional[pulumi.Input[Sequence[pulumi.Input[Union['UserSshPublicKeyArgs', 'UserSshPublicKeyArgsDict']]]]] = None,
        ...
        :param pulumi.Input[str] role: The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that controls your users' access to your Amazon S3 bucket or Amazon EFS file system. The policies attached to this role determine the level of access that you want to provide your users when transferring files into and out of your Amazon S3 bucket or Amazon EFS file system. The IAM role should also contain a trust relationship that allows the server to access your resources when servicing your users' transfer requests.
        :param pulumi.Input[str] server_id: A system-assigned unique identifier for a server instance. This is the specific server that you added your user to.
        :param pulumi.Input[Sequence[pulumi.Input[Union['UserSshPublicKeyArgs', 'UserSshPublicKeyArgsDict']]]] ssh_public_keys: Specifies the public key portion of the Secure Shell (SSH) keys stored for the described user.
