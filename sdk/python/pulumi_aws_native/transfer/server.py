...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate: The Amazon Resource Name (ARN) of the AWS Certificate Manager (ACM) certificate. Required when `Protocols` is set to `FTPS` .
