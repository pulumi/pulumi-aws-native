...
class ProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] as2_id: AS2 identifier agreed with a trading partner.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] certificate_ids: List of the certificate IDs associated with this profile to be used for encryption and signing of AS2 messages.
