...
class As2ConfigPropertiesArgsDict(TypedDict):
    ...
    """
    async_mdn_config: NotRequired[pulumi.Input[Optional['ConnectorAsyncMdnConfigArgs']]]
    """
...
class ServerWorkflowDetailsArgsDict(TypedDict):
    on_partial_upload: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServerWorkflowDetailArgs']]]]]
    """
    ...
    """
    on_upload: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServerWorkflowDetailArgs']]]]]
    """
...
class WebAppEndpointDetailsArgsDict(TypedDict):
    vpc: NotRequired[pulumi.Input[Optional['WebAppVpcArgs']]]
...
class WorkflowInputFileLocationArgsDict(TypedDict):
    ...
    """
    efs_file_location: NotRequired[pulumi.Input[Optional['WorkflowEfsInputFileLocationArgs']]]
    s3_file_location: NotRequired[pulumi.Input[Optional['WorkflowS3InputFileLocationArgs']]]
...
class WorkflowStepCopyStepDetailsPropertiesArgsDict(TypedDict):
    ...
    """
    destination_file_location: NotRequired[pulumi.Input[Optional['WorkflowS3FileLocationArgs']]]
...
class WorkflowStepTagStepDetailsPropertiesArgsDict(TypedDict):
    ...
    Specifies which file to use as input to the workflow step.
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkflowS3TagArgs']]]]]
    """
...
class WorkflowStepArgsDict(TypedDict):
    ...
    """
    copy_step_details: NotRequired[pulumi.Input[Optional['WorkflowStepCopyStepDetailsPropertiesArgs']]]
    """
    Details for a step that performs a file copy.
    """
    custom_step_details: NotRequired[pulumi.Input[Optional['WorkflowStepCustomStepDetailsPropertiesArgs']]]
    """
    Details for a step that invokes a lambda function.
    """
    decrypt_step_details: NotRequired[pulumi.Input[Optional['WorkflowStepDecryptStepDetailsPropertiesArgs']]]
    """
    Details for a step that performs a file decryption.
    """
    delete_step_details: NotRequired[pulumi.Input[Optional['WorkflowStepDeleteStepDetailsPropertiesArgs']]]
    """
    Details for a step that deletes the file.
    """
    tag_step_details: NotRequired[pulumi.Input[Optional['WorkflowStepTagStepDetailsPropertiesArgs']]]
    """
    Details for a step that creates one or more tags.
    """
