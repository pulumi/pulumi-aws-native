...
class UserHomeDirectoryMapEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: Specifies the type of mapping. Set the type to `FILE` if you want the mapping to point to a file, or `DIRECTORY` for the directory to point to a directory.
...
if not MYPY:
    class UserSshPublicKeyArgsDict(TypedDict):
        pass
elif False:
    UserSshPublicKeyArgsDict: TypeAlias = Mapping[str, Any]
