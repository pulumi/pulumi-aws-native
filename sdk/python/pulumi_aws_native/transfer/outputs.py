...
class UserHomeDirectoryMapEntry(dict):
    def __init__(__self__, *,
        ...
        :param str type: Specifies the type of mapping. Set the type to `FILE` if you want the mapping to point to a file, or `DIRECTORY` for the directory to point to a directory.
