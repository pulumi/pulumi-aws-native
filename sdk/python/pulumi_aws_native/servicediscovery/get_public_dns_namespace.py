...
def get_public_dns_namespace(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the public namespace.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_public_dns_namespace_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPublicDnsNamespaceResult]:
    """
    Resource Type definition for AWS::ServiceDiscovery::PublicDnsNamespace
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:servicediscovery:getPublicDnsNamespace', __args__, opts=opts, typ=GetPublicDnsNamespaceResult)
    return __ret__.apply(lambda __response__: GetPublicDnsNamespaceResult(
