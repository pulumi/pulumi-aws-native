...
class PrivateDnsNamespace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['PrivateDnsNamespacePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PrivateDnsNamespaceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PrivateDnsNamespaceProperties']:
        """
