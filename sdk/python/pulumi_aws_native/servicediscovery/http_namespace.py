...
class HttpNamespace(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['HttpNamespacePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['HttpNamespacePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.HttpNamespaceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.HttpNamespaceProperties']:
        """
