...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(dns_config, ServiceDnsConfigArgs):
                dns_config = dns_config or {}
                def _setter(key, value):
                    dns_config[key] = value
                ServiceDnsConfigArgs._configure(_setter, **dns_config)
            __props__.__dict__["dns_config"] = dns_config
            if not isinstance(health_check_config, ServiceHealthCheckConfigArgs):
            ...
            if not isinstance(health_check_custom_config, ServiceHealthCheckCustomConfigArgs):
