...
class GetVpcAttachmentResult:
    ...
    def subnet_arns(self) -> Optional[Sequence[builtins.str]]:
        """
        Subnet Arn list
        """
...
def get_vpc_attachment_output(attachment_id: Optional[pulumi.Input[builtins.str]] = None,
