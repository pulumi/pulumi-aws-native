...
class ConnectAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] core_network_id: ID of the CoreNetwork that the attachment will be attached to.
        :param pulumi.Input[builtins.str] edge_location: Edge location of the attachment.
        :param pulumi.Input['ConnectAttachmentOptionsArgs'] options: Protocol options for connect attachment
        :param pulumi.Input[builtins.str] transport_attachment_id: Id of transport attachment
