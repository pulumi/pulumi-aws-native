...
class GetSiteToSiteVpnAttachmentResult:
    ...
    def proposed_network_function_group_change(self) -> Optional['outputs.SiteToSiteVpnAttachmentProposedNetworkFunctionGroupChange']:
        """
...
def get_site_to_site_vpn_attachment(attachment_id: Optional[builtins.str] = None,
...
def get_site_to_site_vpn_attachment_output(attachment_id: Optional[pulumi.Input[builtins.str]] = None,
