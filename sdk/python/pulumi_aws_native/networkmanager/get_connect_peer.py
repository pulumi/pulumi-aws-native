...
class GetConnectPeerResult:
    ...
    def connect_peer_id(self) -> Optional[builtins.str]:
        """
...
def get_connect_peer(connect_peer_id: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectPeerResult:
    """
    AWS::NetworkManager::ConnectPeer Resource Type Definition.


    :param builtins.str connect_peer_id: The ID of the Connect peer.
    """
    __args__ = dict()
