...
__all__ = [
    ...
    'AwaitableGetTransitGatewayRouteTableAttachmentResult',
    'get_transit_gateway_route_table_attachment',
    'get_transit_gateway_route_table_attachment_output',
]

@pulumi.output_type
class GetTransitGatewayRouteTableAttachmentResult:
    def __init__(__self__, attachment_id=None, attachment_policy_rule_number=None, attachment_type=None, core_network_arn=None, core_network_id=None, created_at=None, edge_location=None, last_modification_errors=None, network_function_group_name=None, owner_account_id=None, proposed_network_function_group_change=None, proposed_segment_change=None, resource_arn=None, segment_name=None, state=None, tags=None, updated_at=None):
    ...
    def core_network_id(self) -> Optional[builtins.str]:
        """
    ...
    def proposed_segment_change(self) -> Optional['outputs.TransitGatewayRouteTableAttachmentProposedSegmentChange']:
        """
...
class AwaitableGetTransitGatewayRouteTableAttachmentResult(GetTransitGatewayRouteTableAttachmentResult):
...
def get_transit_gateway_route_table_attachment(attachment_id: Optional[builtins.str] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransitGatewayRouteTableAttachmentResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:networkmanager:getTransitGatewayRouteTableAttachment', __args__, opts=opts, typ=GetTransitGatewayRouteTableAttachmentResult).value

    return AwaitableGetTransitGatewayRouteTableAttachmentResult(
...
def get_transit_gateway_route_table_attachment_output(attachment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:networkmanager:getTransitGatewayRouteTableAttachment', __args__, opts=opts, typ=GetTransitGatewayRouteTableAttachmentResult)
    return __ret__.apply(lambda __response__: GetTransitGatewayRouteTableAttachmentResult(
