...
def get_direct_connect_gateway_attachment(attachment_id: Optional[builtins.str] = None,
...
def get_direct_connect_gateway_attachment_output(attachment_id: Optional[pulumi.Input[builtins.str]] = None,
