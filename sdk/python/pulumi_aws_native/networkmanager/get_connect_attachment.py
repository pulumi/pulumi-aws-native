...
class GetConnectAttachmentResult:
    ...
    def attachment_policy_rule_number(self) -> Optional[builtins.int]:
        """
    ...
    def core_network_arn(self) -> Optional[builtins.str]:
        """
    ...
    def network_function_group_name(self) -> Optional[builtins.str]:
        """
...
def get_connect_attachment(attachment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str attachment_id: The ID of the attachment.
    """
    __args__ = dict()
...
def get_connect_attachment_output(attachment_id: Optional[pulumi.Input[builtins.str]] = None,
