...
class DeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the device.
        :param pulumi.Input['DeviceLocationArgs'] location: The site location.
        :param pulumi.Input[builtins.str] model: The device model
        :param pulumi.Input[builtins.str] serial_number: The device serial number.
        :param pulumi.Input[builtins.str] site_id: The site ID.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: The tags for the device.
        :param pulumi.Input[builtins.str] type: The device type.
        :param pulumi.Input[builtins.str] vendor: The device vendor.
        """
...
class Device(pulumi.CustomResource):
    ...
    def device_arn(self) -> pulumi.Output[builtins.str]:
        """
