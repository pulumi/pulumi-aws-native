...
class TransitGatewayRegistrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_gateway_arn: The Amazon Resource Name (ARN) of the transit gateway.
        """
...
@pulumi.type_token("aws-native:networkmanager:TransitGatewayRegistration")
