...
class ConnectPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connect_attachment_id: The ID of the attachment to connect.
        :param pulumi.Input[builtins.str] peer_address: The IP address of the Connect peer.
        :param pulumi.Input['ConnectPeerBgpOptionsArgs'] bgp_options: Bgp options for connect peer.
        :param pulumi.Input[builtins.str] core_network_address: The IP address of a core network.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inside_cidr_blocks: The inside IP addresses used for a Connect peer configuration.
        :param pulumi.Input[builtins.str] subnet_arn: The subnet ARN for the connect peer.
