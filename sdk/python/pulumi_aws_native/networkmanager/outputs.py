...
class ConnectAttachmentProposedSegmentChange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ConnectAttachmentProposedSegmentChange._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class ConnectAttachmentTag(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ConnectAttachmentTag._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            value=value,
        )
...
class ConnectPeerBgpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ConnectPeerBgpConfiguration._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class SiteToSiteVpnAttachmentProposedSegmentChange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SiteToSiteVpnAttachmentProposedSegmentChange._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attachment_policy_rule_number=attachment_policy_rule_number,
            segment_name=segment_name,
            tags=tags,
...
class SiteToSiteVpnAttachmentTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str value: The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
        SiteToSiteVpnAttachmentTag._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            value=value,
        )
...
class TransitGatewayPeeringTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str value: The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
        TransitGatewayPeeringTag._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            value=value,
        )
...
class TransitGatewayRouteTableAttachmentProposedSegmentChange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        TransitGatewayRouteTableAttachmentProposedSegmentChange._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attachment_policy_rule_number=attachment_policy_rule_number,
            segment_name=segment_name,
            tags=tags,
...
class TransitGatewayRouteTableAttachmentTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str value: The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
        TransitGatewayRouteTableAttachmentTag._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            key=key,
            value=value,
        )
...
class VpcAttachmentProposedSegmentChange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VpcAttachmentProposedSegmentChange._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attachment_policy_rule_number=attachment_policy_rule_number,
            segment_name=segment_name,
            tags=tags,
...
class VpcAttachmentVpcOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VpcAttachmentVpcOptions._configure(
            lambda key, value: pulumi.set(__self__, key, value),
