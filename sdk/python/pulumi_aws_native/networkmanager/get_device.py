...
class GetDeviceResult:
    ...
    def device_arn(self) -> Optional[builtins.str]:
        """
...
def get_device(device_id: Optional[builtins.str] = None,
    ...
    :param builtins.str device_id: The ID of the device.
    :param builtins.str global_network_id: The ID of the global network.
    """
    __args__ = dict()
