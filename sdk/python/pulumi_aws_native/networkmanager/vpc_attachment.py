...
warnings.warn("""VpcAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class VpcAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpc_arn: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VpcAttachment is deprecated: VpcAttachment is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
