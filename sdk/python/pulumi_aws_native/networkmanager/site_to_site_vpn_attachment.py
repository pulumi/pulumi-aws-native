...
class SiteToSiteVpnAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] core_network_id: The ID of a core network where you're creating a site-to-site VPN attachment.
        :param pulumi.Input[builtins.str] vpn_connection_arn: The ARN of the site-to-site VPN attachment.
        :param pulumi.Input[builtins.str] network_function_group_name: The name of the network function group attachment.
    ...
    def vpn_connection_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpn_connection_arn(self, value: pulumi.Input[builtins.str]):
...
class SiteToSiteVpnAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="networkFunctionGroupName")
    def network_function_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the network function group attachment.
        """
        return pulumi.get(self, "network_function_group_name")
    ...
    @property
    @pulumi.getter(name="vpnConnectionArn")
    def vpn_connection_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the site-to-site VPN attachment.
        """
        return pulumi.get(self, "vpn_connection_arn")
