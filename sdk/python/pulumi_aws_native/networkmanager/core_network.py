...
class CoreNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] global_network_id: The ID of the global network that your core network is a part of.
        :param pulumi.Input[builtins.str] description: The description of core network
