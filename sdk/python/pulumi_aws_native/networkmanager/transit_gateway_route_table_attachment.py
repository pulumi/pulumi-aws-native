...
class TransitGatewayRouteTableAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] peering_id: The Id of peering between transit gateway and core network.
        :param pulumi.Input[builtins.str] transit_gateway_route_table_arn: The Arn of transit gateway route table.
...
class TransitGatewayRouteTableAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["peeringId", "transitGatewayRouteTableArn"])
