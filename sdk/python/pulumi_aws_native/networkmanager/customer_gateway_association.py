...
class CustomerGatewayAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CustomerGatewayAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CustomerGatewayAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CustomerGatewayAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CustomerGatewayAssociationProperties']:
        """
