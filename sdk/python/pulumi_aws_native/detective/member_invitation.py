...
class MemberInvitationArgs:
    def __init__(__self__, *,
                 ...
                 member_email_address: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] graph_arn: The ARN of the graph to which the member account will be invited
        :param pulumi.Input[builtins.str] member_email_address: The root email address for the account to be invited, for validation. Updating this field has no effect.
        :param pulumi.Input[builtins.str] member_id: The AWS account ID to be invited to join the graph as a member
        :param pulumi.Input[builtins.bool] disable_email_notification: When set to true, invitation emails are not sent to the member accounts. Member accounts must still accept the invitation before they are added to the behavior graph. Updating this field has no effect.
        :param pulumi.Input[builtins.str] message: A message to be included in the email invitation sent to the invited account. Updating this field has no effect.
        """
    ...
    def member_email_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def member_email_address(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:detective:MemberInvitation")
class MemberInvitation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 member_email_address: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="memberEmailAddress")
    def member_email_address(self) -> pulumi.Output[builtins.str]:
        """
        The root email address for the account to be invited, for validation. Updating this field has no effect.
        """
        return pulumi.get(self, "member_email_address")
