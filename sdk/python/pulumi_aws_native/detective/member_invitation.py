...
class MemberInvitationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] message: A message to be included in the email invitation sent to the invited account. Updating this field has no effect.
        """
    ...
    def member_email_address(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def member_email_address(self, value: pulumi.Input[_builtins.str]):
...
class MemberInvitation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="memberEmailAddress")
    def member_email_address(self) -> pulumi.Output[_builtins.str]:
        """
        The root email address for the account to be invited, for validation. Updating this field has no effect.
        """
        return pulumi.get(self, "member_email_address")
