...
class OrganizationAdminArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The account ID of the account that should be registered as your Organization's delegated administrator for Detective
        """
