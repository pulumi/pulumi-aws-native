...
class GetMemberInvitationResult:
    ...
    def member_email_address(self) -> Optional[builtins.str]:
        """
...
def get_member_invitation(graph_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str graph_arn: The ARN of the graph to which the member account will be invited
    :param builtins.str member_id: The AWS account ID to be invited to join the graph as a member
    """
    __args__ = dict()
...
def get_member_invitation_output(graph_arn: Optional[pulumi.Input[builtins.str]] = None,
