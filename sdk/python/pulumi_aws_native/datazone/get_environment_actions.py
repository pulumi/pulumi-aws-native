...
def get_environment_actions(domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str environment_id: The identifier of the Amazon DataZone environment in which the action is taking place
    :param builtins.str id: The ID of the Amazon DataZone environment action.
    """
    __args__ = dict()
...
def get_environment_actions_output(domain_id: Optional[pulumi.Input[builtins.str]] = None,
