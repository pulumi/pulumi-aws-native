...
class DataSourceArgs:
    def __init__(__self__, *,
                 ...
                 connection_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 publish_on_import: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_identifier: The ID of the Amazon DataZone domain where the data source is created.
        :param pulumi.Input[builtins.str] project_identifier: The identifier of the Amazon DataZone project in which you want to add the data source.
        ...
        :param pulumi.Input[builtins.str] connection_identifier: The unique identifier of a connection used to fetch relevant parameters from connection during Datasource run
        ...
        :param pulumi.Input[builtins.str] environment_identifier: The unique identifier of the Amazon DataZone environment to which the data source publishes assets.
        :param pulumi.Input[builtins.str] name: The name of the data source.
        :param pulumi.Input[builtins.bool] publish_on_import: Specifies whether the assets that this data source creates in the inventory are to be also automatically published to the catalog.
    ...
    def connection_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def publish_on_import(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_on_import(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DataSource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectionIdentifier")
    def connection_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique identifier of a connection used to fetch relevant parameters from connection during Datasource run
        """
        return pulumi.get(self, "connection_identifier")
    ...
    def last_run_asset_count(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def last_run_at(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="publishOnImport")
    def publish_on_import(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the assets that this data source creates in the inventory are to be also automatically published to the catalog.
        """
        return pulumi.get(self, "publish_on_import")
