...
def get_environment_profile(domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_id: The ID of the Amazon DataZone domain in which this environment profile is created.
    :param _builtins.str id: The ID of this Amazon DataZone environment profile.
    """
    __args__ = dict()
