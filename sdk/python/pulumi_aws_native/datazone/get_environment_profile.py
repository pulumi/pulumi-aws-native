...
def get_environment_profile(domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_id: The ID of the Amazon DataZone domain in which this environment profile is created.
    :param builtins.str id: The ID of this Amazon DataZone environment profile.
    """
    __args__ = dict()
...
def get_environment_profile_output(domain_id: Optional[pulumi.Input[builtins.str]] = None,
