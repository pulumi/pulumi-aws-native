...
class EnvironmentBlueprintConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_identifier: The identifier of the Amazon DataZone domain in which an environment blueprint exists.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_regions: The enabled AWS Regions specified in a blueprint configuration.
