...
def get_group_profile(domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_id: The identifier of the Amazon DataZone domain in which the group profile is created.
    :param _builtins.str id: The ID of the Amazon DataZone group profile.
    """
    __args__ = dict()
...
def get_group_profile_output(domain_id: pulumi.Input[Optional[_builtins.str]] = None,
