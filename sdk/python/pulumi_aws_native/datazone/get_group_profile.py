...
def get_group_profile(domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_id: The identifier of the Amazon DataZone domain in which the group profile is created.
    :param builtins.str id: The ID of the Amazon DataZone group profile.
    """
    __args__ = dict()
...
def get_group_profile_output(domain_id: Optional[pulumi.Input[builtins.str]] = None,
