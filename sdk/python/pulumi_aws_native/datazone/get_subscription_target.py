...
class GetSubscriptionTargetResult:
    ...
    def applicable_asset_types(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def authorized_principals(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def manage_access_role(self) -> Optional[_builtins.str]:
        """
...
def get_subscription_target(domain_id: Optional[_builtins.str] = None,
