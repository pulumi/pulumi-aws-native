...
class GetDomainResult:
    def __init__(__self__, arn=None, created_at=None, description=None, domain_execution_role=None, id=None, last_updated_at=None, managed_account_id=None, name=None, portal_url=None, service_role=None, single_sign_on=None, status=None, tags=None):
    ...
    def domain_execution_role(self) -> Optional[builtins.str]:
        """
    ...
    def managed_account_id(self) -> Optional[builtins.str]:
        """
    ...
    def portal_url(self) -> Optional[builtins.str]:
        """
...
def get_domain(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The id of the Amazon DataZone domain.
    """
    __args__ = dict()
    __args__['id'] = id
