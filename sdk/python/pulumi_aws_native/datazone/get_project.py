...
def get_project(domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_id: The identifier of the Amazon DataZone domain in which the project was created.
    :param builtins.str id: The ID of the Amazon DataZone project.
    """
    __args__ = dict()
