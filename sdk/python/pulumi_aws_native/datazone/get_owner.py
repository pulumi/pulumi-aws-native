...
class GetOwnerResult:
    ...
    def owner_identifier(self) -> Optional[builtins.str]:
        """
...
def get_owner(domain_identifier: Optional[builtins.str] = None,
              entity_identifier: Optional[builtins.str] = None,
              entity_type: Optional['OwnerEntityType'] = None,
              owner_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_identifier: The ID of the domain in which you want to add the entity owner.
    :param builtins.str entity_identifier: The ID of the entity to which you want to add an owner.
    :param 'OwnerEntityType' entity_type: The type of an entity.
    :param builtins.str owner_identifier: The ID of the entity to which you want to add an owner.
...
def get_owner_output(domain_identifier: Optional[pulumi.Input[builtins.str]] = None,
                     entity_identifier: Optional[pulumi.Input[builtins.str]] = None,
                     entity_type: Optional[pulumi.Input['OwnerEntityType']] = None,
                     owner_identifier: Optional[pulumi.Input[builtins.str]] = None,
