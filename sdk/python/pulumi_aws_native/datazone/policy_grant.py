...
class PolicyGrant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 detail: pulumi.Input[Optional[Union[Union['PolicyGrantDetail0PropertiesArgs', 'PolicyGrantDetail0PropertiesArgsDict', 'outputs.PolicyGrantDetail0Properties'], Union['PolicyGrantDetail1PropertiesArgs', 'PolicyGrantDetail1PropertiesArgsDict', 'outputs.PolicyGrantDetail1Properties'], Union['PolicyGrantDetail2PropertiesArgs', 'PolicyGrantDetail2PropertiesArgsDict', 'outputs.PolicyGrantDetail2Properties'], Union['PolicyGrantDetail3PropertiesArgs', 'PolicyGrantDetail3PropertiesArgsDict', 'outputs.PolicyGrantDetail3Properties'], Union['PolicyGrantDetail4PropertiesArgs', 'PolicyGrantDetail4PropertiesArgsDict', 'outputs.PolicyGrantDetail4Properties'], Union['PolicyGrantDetail5PropertiesArgs', 'PolicyGrantDetail5PropertiesArgsDict', 'outputs.PolicyGrantDetail5Properties'], Union['PolicyGrantDetail6PropertiesArgs', 'PolicyGrantDetail6PropertiesArgsDict', 'outputs.PolicyGrantDetail6Properties'], Union['PolicyGrantDetail7PropertiesArgs', 'PolicyGrantDetail7PropertiesArgsDict', 'outputs.PolicyGrantDetail7Properties'], Union['PolicyGrantDetail8PropertiesArgs', 'PolicyGrantDetail8PropertiesArgsDict', 'outputs.PolicyGrantDetail8Properties'], Union['PolicyGrantDetail9PropertiesArgs', 'PolicyGrantDetail9PropertiesArgsDict', 'outputs.PolicyGrantDetail9Properties'], Union['PolicyGrantDetail10PropertiesArgs', 'PolicyGrantDetail10PropertiesArgsDict', 'outputs.PolicyGrantDetail10Properties'], Union['PolicyGrantDetail11PropertiesArgs', 'PolicyGrantDetail11PropertiesArgsDict', 'outputs.PolicyGrantDetail11Properties'], Union['PolicyGrantDetail12PropertiesArgs', 'PolicyGrantDetail12PropertiesArgsDict', 'outputs.PolicyGrantDetail12Properties']]]] = None,
                 ...
                 principal: pulumi.Input[Optional[Union[Union['PolicyGrantPrincipal0PropertiesArgs', 'PolicyGrantPrincipal0PropertiesArgsDict', 'outputs.PolicyGrantPrincipal0Properties'], Union['PolicyGrantPrincipal1PropertiesArgs', 'PolicyGrantPrincipal1PropertiesArgsDict', 'outputs.PolicyGrantPrincipal1Properties'], Union['PolicyGrantPrincipal2PropertiesArgs', 'PolicyGrantPrincipal2PropertiesArgsDict', 'outputs.PolicyGrantPrincipal2Properties'], Union['PolicyGrantPrincipal3PropertiesArgs', 'PolicyGrantPrincipal3PropertiesArgsDict', 'outputs.PolicyGrantPrincipal3Properties']]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union[Union['PolicyGrantDetail0PropertiesArgs', 'PolicyGrantDetail0PropertiesArgsDict', 'outputs.PolicyGrantDetail0Properties'], Union['PolicyGrantDetail1PropertiesArgs', 'PolicyGrantDetail1PropertiesArgsDict', 'outputs.PolicyGrantDetail1Properties'], Union['PolicyGrantDetail2PropertiesArgs', 'PolicyGrantDetail2PropertiesArgsDict', 'outputs.PolicyGrantDetail2Properties'], Union['PolicyGrantDetail3PropertiesArgs', 'PolicyGrantDetail3PropertiesArgsDict', 'outputs.PolicyGrantDetail3Properties'], Union['PolicyGrantDetail4PropertiesArgs', 'PolicyGrantDetail4PropertiesArgsDict', 'outputs.PolicyGrantDetail4Properties'], Union['PolicyGrantDetail5PropertiesArgs', 'PolicyGrantDetail5PropertiesArgsDict', 'outputs.PolicyGrantDetail5Properties'], Union['PolicyGrantDetail6PropertiesArgs', 'PolicyGrantDetail6PropertiesArgsDict', 'outputs.PolicyGrantDetail6Properties'], Union['PolicyGrantDetail7PropertiesArgs', 'PolicyGrantDetail7PropertiesArgsDict', 'outputs.PolicyGrantDetail7Properties'], Union['PolicyGrantDetail8PropertiesArgs', 'PolicyGrantDetail8PropertiesArgsDict', 'outputs.PolicyGrantDetail8Properties'], Union['PolicyGrantDetail9PropertiesArgs', 'PolicyGrantDetail9PropertiesArgsDict', 'outputs.PolicyGrantDetail9Properties'], Union['PolicyGrantDetail10PropertiesArgs', 'PolicyGrantDetail10PropertiesArgsDict', 'outputs.PolicyGrantDetail10Properties'], Union['PolicyGrantDetail11PropertiesArgs', 'PolicyGrantDetail11PropertiesArgsDict', 'outputs.PolicyGrantDetail11Properties'], Union['PolicyGrantDetail12PropertiesArgs', 'PolicyGrantDetail12PropertiesArgsDict', 'outputs.PolicyGrantDetail12Properties']]] detail: The details of the policy grant member.
        :param pulumi.Input[_builtins.str] domain_identifier: The ID of the domain where you want to add a policy grant.
        :param pulumi.Input[_builtins.str] entity_identifier: The ID of the entity (resource) to which you want to add a policy grant.
        :param pulumi.Input['PolicyGrantTargetEntityType'] entity_type: The type of entity (resource) to which the grant is added.
        :param pulumi.Input['PolicyGrantManagedPolicyType'] policy_type: The type of policy that you want to grant.
        :param pulumi.Input[Union[Union['PolicyGrantPrincipal0PropertiesArgs', 'PolicyGrantPrincipal0PropertiesArgsDict', 'outputs.PolicyGrantPrincipal0Properties'], Union['PolicyGrantPrincipal1PropertiesArgs', 'PolicyGrantPrincipal1PropertiesArgsDict', 'outputs.PolicyGrantPrincipal1Properties'], Union['PolicyGrantPrincipal2PropertiesArgs', 'PolicyGrantPrincipal2PropertiesArgsDict', 'outputs.PolicyGrantPrincipal2Properties'], Union['PolicyGrantPrincipal3PropertiesArgs', 'PolicyGrantPrincipal3PropertiesArgsDict', 'outputs.PolicyGrantPrincipal3Properties']]] principal: The principal of the policy grant member.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @_builtins.property
    @pulumi.getter
    def detail(self) -> pulumi.Output[Optional[Union['outputs.PolicyGrantDetail0Properties', 'outputs.PolicyGrantDetail1Properties', 'outputs.PolicyGrantDetail2Properties', 'outputs.PolicyGrantDetail3Properties', 'outputs.PolicyGrantDetail4Properties', 'outputs.PolicyGrantDetail5Properties', 'outputs.PolicyGrantDetail6Properties', 'outputs.PolicyGrantDetail7Properties', 'outputs.PolicyGrantDetail8Properties', 'outputs.PolicyGrantDetail9Properties', 'outputs.PolicyGrantDetail10Properties', 'outputs.PolicyGrantDetail11Properties', 'outputs.PolicyGrantDetail12Properties']]]:
        """
        The details of the policy grant member.
        """
        return pulumi.get(self, "detail")
    ...
    @_builtins.property
    @pulumi.getter
    def principal(self) -> pulumi.Output[Optional[Union['outputs.PolicyGrantPrincipal0Properties', 'outputs.PolicyGrantPrincipal1Properties', 'outputs.PolicyGrantPrincipal2Properties', 'outputs.PolicyGrantPrincipal3Properties']]]:
        """
        The principal of the policy grant member.
        """
        return pulumi.get(self, "principal")
