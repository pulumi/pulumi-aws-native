...
class EnvironmentProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The AWS account in which the Amazon DataZone environment is created.
        :param pulumi.Input[builtins.str] aws_account_region: The AWS region in which this environment profile is created.
        :param pulumi.Input[builtins.str] domain_identifier: The ID of the Amazon DataZone domain in which this environment profile is created.
        :param pulumi.Input[builtins.str] environment_blueprint_identifier: The ID of the blueprint with which this environment profile is created.
        :param pulumi.Input[builtins.str] project_identifier: The identifier of the project in which to create the environment profile.
        :param pulumi.Input[builtins.str] description: The description of this Amazon DataZone environment profile.
        :param pulumi.Input[builtins.str] name: The name of this Amazon DataZone environment profile.
