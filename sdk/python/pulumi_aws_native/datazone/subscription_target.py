...
class SubscriptionTargetArgs:
    def __init__(__self__, *,
                 applicable_asset_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 authorized_principals: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 manage_access_role: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applicable_asset_types: The asset types that can be included in the subscription target.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorized_principals: The authorized principals of the subscription target.
        :param pulumi.Input[builtins.str] domain_identifier: The ID of the Amazon DataZone domain in which subscription target would be created.
        :param pulumi.Input[builtins.str] environment_identifier: The ID of the environment in which subscription target would be created.
        ...
        :param pulumi.Input[builtins.str] type: The type of the subscription target.
        :param pulumi.Input[builtins.str] manage_access_role: The manage access role that is used to create the subscription target.
        :param pulumi.Input[builtins.str] name: The name of the subscription target.
        :param pulumi.Input[builtins.str] provider: The provider of the subscription target.
        """
    ...
    def applicable_asset_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def applicable_asset_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "applicable_asset_types", value)

    @property
    @pulumi.getter(name="authorizedPrincipals")
    def authorized_principals(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def authorized_principals(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def manage_access_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def manage_access_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SubscriptionTarget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 applicable_asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 authorized_principals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="applicableAssetTypes")
    def applicable_asset_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The asset types that can be included in the subscription target.
        """
        return pulumi.get(self, "applicable_asset_types")
    ...
    @property
    @pulumi.getter(name="authorizedPrincipals")
    def authorized_principals(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The authorized principals of the subscription target.
        """
        return pulumi.get(self, "authorized_principals")
    ...
    @property
    @pulumi.getter(name="manageAccessRole")
    def manage_access_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The manage access role that is used to create the subscription target.
        """
        return pulumi.get(self, "manage_access_role")
