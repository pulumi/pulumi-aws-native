...
class GetFormTypeResult:
    ...
    def form_type_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def owning_project_id(self) -> Optional[builtins.str]:
        """
    ...
    def owning_project_identifier(self) -> Optional[builtins.str]:
        """
...
def get_form_type(domain_identifier: Optional[builtins.str] = None,
                  form_type_identifier: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFormTypeResult:
    """
    Create and manage form types in Amazon Datazone


    :param builtins.str domain_identifier: The ID of the Amazon DataZone domain in which this metadata form type is created.
    :param builtins.str form_type_identifier: The ID of this Amazon DataZone metadata form type.
    """
    __args__ = dict()
...
def get_form_type_output(domain_identifier: Optional[pulumi.Input[builtins.str]] = None,
                         form_type_identifier: Optional[pulumi.Input[builtins.str]] = None,
