...
class GetEnvironmentBlueprintConfigurationResult:
    ...
    def enabled_regions(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def manage_access_role_arn(self) -> Optional[_builtins.str]:
        """
...
def get_environment_blueprint_configuration(domain_id: Optional[_builtins.str] = None,
                                            environment_blueprint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_id: The identifier of the Amazon DataZone domain in which an environment blueprint exists.
    :param _builtins.str environment_blueprint_id: The identifier of the environment blueprint. This identifier should be used when creating environment profiles.
    """
    __args__ = dict()
