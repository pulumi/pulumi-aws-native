...
warnings.warn("""Member is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Member(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 network_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Member is deprecated: Member is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
