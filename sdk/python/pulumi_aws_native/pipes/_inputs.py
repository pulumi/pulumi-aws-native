...
class PipeAwsVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: Specifies the subnets associated with the task. These subnets must all be in the same VPC. You can specify as many as 16 subnets.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: Specifies the security groups associated with the task. These security groups must all be in the same VPC. You can specify as many as five security groups. If you do not specify a security group, the default security group for the VPC is used.
        """
...
class PipeBatchArrayPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size: The size of the array, if this is an array batch job.
        """
        if size is not None:
...
class PipeBatchContainerOverridesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command: The command to send to the container that overrides the default command from the Docker image or the task definition.
        :param pulumi.Input[Sequence[pulumi.Input['PipeBatchEnvironmentVariableArgs']]] environment: The environment variables to send to the container. You can add new environment variables, which are added to the container at launch, or you can override the existing environment variables from the Docker image or the task definition.
               ...
               > Environment variables cannot start with " `AWS Batch` ". This naming convention is reserved for variables that AWS Batch sets.
        :param pulumi.Input[builtins.str] instance_type: The instance type to use for a multi-node parallel job.
...
class PipeBatchResourceRequirementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The quantity of the specified resource to reserve for the container. The values vary based on the `type` specified.
...
class PipeBatchRetryStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] attempts: The number of times to move a job to the `RUNNABLE` status. If the value of `attempts` is greater than one, the job is retried on failure the same number of attempts as the value.
        """
...
class PipeCloudwatchLogsLogDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] log_group_arn: The AWS Resource Name (ARN) for the CloudWatch log group to which EventBridge sends the log records.
        """
...
class PipeDeadLetterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: The ARN of the specified target for the dead-letter queue.
...
class PipeDimensionMappingArgs:
    def __init__(__self__, *,
                 ...
                 dimension_value_type: pulumi.Input['PipeDimensionValueType']):
        """
        :param pulumi.Input[builtins.str] dimension_name: The metadata attributes of the time series. For example, the name and Availability Zone of an Amazon EC2 instance or the name of the manufacturer of a wind turbine are dimensions.
        :param pulumi.Input[builtins.str] dimension_value: Dynamic path to the dimension value in the source event.
...
class PipeEcsContainerOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command: The command to send to the container that overrides the default command from the Docker image or the task definition. You must also specify a container name.
        ...
        :param pulumi.Input[builtins.str] name: The name of the container that receives the override. This parameter is required if any override is specified.
...
if not MYPY:
    class PipeEcsEphemeralStorageArgsDict(TypedDict):
        size_in_gi_b: pulumi.Input[builtins.int]
        """
...
class PipeEcsEphemeralStorageArgs:
    ...
    def size_in_gi_b(self) -> pulumi.Input[builtins.int]:
        """
        The total amount, in GiB, of ephemeral storage to set for the task. The minimum supported value is `21` GiB and the maximum supported value is `200` GiB.
        """
    ...
    @size_in_gi_b.setter
    def size_in_gi_b(self, value: pulumi.Input[builtins.int]):
...
class PipeEcsTaskOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cpu: The cpu override for the task.
        :param pulumi.Input['PipeEcsEphemeralStorageArgs'] ephemeral_storage: The ephemeral storage setting override for the task.
               ...
               > - Linux platform version `1.4.0` or later.
               > - Windows platform version `1.0.0` or later.
        :param pulumi.Input[builtins.str] execution_role_arn: The Amazon Resource Name (ARN) of the task execution IAM role override for the task. For more information, see [Amazon ECS task execution IAM role](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_execution_IAM_role.html) in the *Amazon Elastic Container Service Developer Guide* .
        ...
        :param pulumi.Input[builtins.str] memory: The memory override for the task.
        :param pulumi.Input[builtins.str] task_role_arn: The Amazon Resource Name (ARN) of the IAM role that containers in this task can assume. All containers in this task are granted the permissions that are specified in this role. For more information, see [IAM Role for Tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-iam-roles.html) in the *Amazon Elastic Container Service Developer Guide* .
        """
...
class PipeEnrichmentHttpParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] header_parameters: The headers that need to be sent as part of request invoking the API Gateway REST API or EventBridge ApiDestination.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] path_parameter_values: The path parameter values to be used to populate API Gateway REST API or EventBridge ApiDestination path wildcards ("*").
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] query_string_parameters: The query string keys/values that need to be sent as part of request invoking the API Gateway REST API or EventBridge ApiDestination.
        """
...
class PipeFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] pattern: The event pattern.
        """
...
if not MYPY:
    class PipeFirehoseLogDestinationArgsDict(TypedDict):
        delivery_stream_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeFirehoseLogDestinationArgs:
    def __init__(__self__, *,
                 delivery_stream_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] delivery_stream_arn: The Amazon Resource Name (ARN) of the Firehose delivery stream to which EventBridge delivers the pipe log records.
        """
    ...
    def delivery_stream_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Firehose delivery stream to which EventBridge delivers the pipe log records.
        """
    ...
    def delivery_stream_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PipeMqBrokerAccessCredentialsPropertiesArgs:
    def __init__(__self__, *,
                 basic_auth: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] basic_auth: Optional SecretManager ARN which stores the database credentials
        """
...
if not MYPY:
    class PipeMskAccessCredentials0PropertiesArgsDict(TypedDict):
        sasl_scram512_auth: pulumi.Input[builtins.str]
        """
        Optional SecretManager ARN which stores the database credentials
        """
elif False:
...
class PipeMskAccessCredentials0PropertiesArgs:
    def __init__(__self__, *,
                 sasl_scram512_auth: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] sasl_scram512_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "sasl_scram512_auth", sasl_scram512_auth)

    @property
    @pulumi.getter(name="saslScram512Auth")
    def sasl_scram512_auth(self) -> pulumi.Input[builtins.str]:
        """
        Optional SecretManager ARN which stores the database credentials
        """
    ...
    def sasl_scram512_auth(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sasl_scram512_auth", value)


if not MYPY:
    class PipeMskAccessCredentials1PropertiesArgsDict(TypedDict):
        client_certificate_tls_auth: pulumi.Input[builtins.str]
        """
        Optional SecretManager ARN which stores the database credentials
        """
elif False:
...
class PipeMskAccessCredentials1PropertiesArgs:
    def __init__(__self__, *,
                 client_certificate_tls_auth: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_certificate_tls_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "client_certificate_tls_auth", client_certificate_tls_auth)

    @property
    @pulumi.getter(name="clientCertificateTlsAuth")
    def client_certificate_tls_auth(self) -> pulumi.Input[builtins.str]:
        """
        Optional SecretManager ARN which stores the database credentials
        """
    ...
    def client_certificate_tls_auth(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "client_certificate_tls_auth", value)


if not MYPY:
    class PipeMultiMeasureAttributeMappingArgsDict(TypedDict):
        measure_value: pulumi.Input[builtins.str]
        """
        ...
        """
        multi_measure_attribute_name: pulumi.Input[builtins.str]
        """
...
class PipeMultiMeasureAttributeMappingArgs:
    def __init__(__self__, *,
                 ...
                 multi_measure_attribute_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] measure_value: Dynamic path to the measurement attribute in the source event.
        :param pulumi.Input['PipeMeasureValueType'] measure_value_type: Data type of the measurement attribute in the source event.
        :param pulumi.Input[builtins.str] multi_measure_attribute_name: Target measure name to be used.
        """
    ...
    def measure_value(self) -> pulumi.Input[builtins.str]:
        """
        Dynamic path to the measurement attribute in the source event.
        """
    ...
    def measure_value(self, value: pulumi.Input[builtins.str]):
    ...
    def multi_measure_attribute_name(self) -> pulumi.Input[builtins.str]:
        """
        Target measure name to be used.
        """
    ...
    def multi_measure_attribute_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PipeMultiMeasureMappingArgsDict(TypedDict):
        ...
        """
        multi_measure_name: pulumi.Input[builtins.str]
        """
...
class PipeMultiMeasureMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] multi_measure_name: The name of the multiple measurements per record (multi-measure).
        """
    ...
    def multi_measure_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the multiple measurements per record (multi-measure).
        """
    ...
    def multi_measure_name(self, value: pulumi.Input[builtins.str]):
...
class PipeS3LogDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: The name of the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param pulumi.Input[builtins.str] bucket_owner: The AWS account that owns the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param pulumi.Input['PipeS3OutputFormat'] output_format: The format EventBridge uses for the log records.
               
               EventBridge currently only supports `json` formatting.
        :param pulumi.Input[builtins.str] prefix: The prefix text with which to begin Amazon S3 log object names.
...
if not MYPY:
    class PipeSelfManagedKafkaAccessConfigurationCredentials2PropertiesArgsDict(TypedDict):
        sasl_scram256_auth: pulumi.Input[builtins.str]
        """
        Optional SecretManager ARN which stores the database credentials
        """
elif False:
...
class PipeSelfManagedKafkaAccessConfigurationCredentials2PropertiesArgs:
    def __init__(__self__, *,
                 sasl_scram256_auth: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] sasl_scram256_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "sasl_scram256_auth", sasl_scram256_auth)

    @property
    @pulumi.getter(name="saslScram256Auth")
    def sasl_scram256_auth(self) -> pulumi.Input[builtins.str]:
        """
        Optional SecretManager ARN which stores the database credentials
        """
    ...
    def sasl_scram256_auth(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PipeSelfManagedKafkaAccessConfigurationVpcArgsDict(TypedDict):
        security_group: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PipeSelfManagedKafkaAccessConfigurationVpcArgs:
    def __init__(__self__, *,
                 security_group: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 subnets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group: List of SecurityGroupId.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: List of SubnetId.
        """
    ...
    def security_group(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of SecurityGroupId.
        """
    ...
    def security_group(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class PipeSingleMeasureMappingArgsDict(TypedDict):
        measure_name: pulumi.Input[builtins.str]
        """
...
class PipeSingleMeasureMappingArgs:
    def __init__(__self__, *,
                 ...
                 measure_value_type: pulumi.Input['PipeMeasureValueType']):
        """
        :param pulumi.Input[builtins.str] measure_name: Target measure name for the measurement attribute in the Timestream table.
        :param pulumi.Input[builtins.str] measure_value: Dynamic path of the source field to map to the measure in the record.
    ...
    def measure_name(self) -> pulumi.Input[builtins.str]:
        """
        Target measure name for the measurement attribute in the Timestream table.
        """
    ...
    @measure_name.setter
    def measure_name(self, value: pulumi.Input[builtins.str]):
...
class PipeSourceActiveMqBrokerParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] queue_name: The name of the destination queue to consume.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch.
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        """
...
class PipeSourceDynamoDbStreamParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param pulumi.Input[builtins.int] maximum_record_age_in_seconds: Discard records older than the specified age. The default value is -1, which sets the maximum age to infinite. When the value is set to infinite, EventBridge never discards old records.
        ...
        :param pulumi.Input[builtins.int] parallelization_factor: The number of batches to process concurrently from each shard. The default value is 1.
        """
...
class PipeSourceManagedStreamingKafkaParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: The name of the topic that the pipe will read from.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch.
        :param pulumi.Input[builtins.str] consumer_group_id: The name of the destination queue to consume.
...
class PipeSourceRabbitMqBrokerParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch.
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param pulumi.Input[builtins.str] virtual_host: The name of the virtual host associated with the source broker.
        """
        pulumi.set(__self__, "credentials", credentials)
        pulumi.set(__self__, "queue_name", queue_name)
        if batch_size is not None:
...
class PipeSourceSelfManagedKafkaParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: The name of the topic that the pipe will read from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_bootstrap_servers: An array of server URLs.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch.
        :param pulumi.Input[builtins.str] consumer_group_id: The name of the destination queue to consume.
        :param pulumi.Input[Union['PipeSelfManagedKafkaAccessConfigurationCredentials0PropertiesArgs', 'PipeSelfManagedKafkaAccessConfigurationCredentials1PropertiesArgs', 'PipeSelfManagedKafkaAccessConfigurationCredentials2PropertiesArgs', 'PipeSelfManagedKafkaAccessConfigurationCredentials3PropertiesArgs']] credentials: The credentials needed to access the resource.
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param pulumi.Input[builtins.str] server_root_ca_certificate: Optional SecretManager ARN which stores the database credentials
...
class PipeTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key of the key-value pair.
        :param pulumi.Input[builtins.str] value: The value of the key-value pair.
        """
...
class PipeTargetBatchJobParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_name: The name of the job. It can be up to 128 letters long. The first character must be alphanumeric, can contain uppercase and lowercase letters, numbers, hyphens (-), and underscores (_).
...
class PipeTargetCloudWatchLogsParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] timestamp: A [dynamic path parameter](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-event-target.html) to a field in the payload containing the time the event occurred, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC.
...
class PipeTargetEcsTaskParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PipeCapacityProviderStrategyItemArgs']]] capacity_provider_strategy: The capacity provider strategy to use for the task.
               ...
               If a `capacityProviderStrategy` is specified, the `launchType` parameter must be omitted. If no `capacityProviderStrategy` or launchType is specified, the `defaultCapacityProviderStrategy` for the cluster is used.
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task. For more information, see [Tagging Your Amazon ECS Resources](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html) in the Amazon Elastic Container Service Developer Guide.
        ...
        :param pulumi.Input[builtins.str] reference_id: The reference ID to use for the task.
...
class PipeTargetEventBridgeEventBusParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: AWS resources, identified by Amazon Resource Name (ARN), which the event primarily concerns. Any number, including zero, may be present.
        :param pulumi.Input[builtins.str] source: The source of the event.
        :param pulumi.Input[builtins.str] time: The time stamp of the event, per [RFC3339](https://docs.aws.amazon.com/https://www.rfc-editor.org/rfc/rfc3339.txt) . If no time stamp is provided, the time stamp of the [PutEvents](https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_PutEvents.html) call is used.
        """
...
class PipeTargetRedshiftDataParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] database: Redshift Database
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sqls: A list of SQLs.
        :param pulumi.Input[builtins.str] db_user: Database user name
        :param pulumi.Input[builtins.str] secret_manager_arn: Optional SecretManager ARN which stores the database credentials
        :param pulumi.Input[builtins.str] statement_name: A name for Redshift DataAPI statement which can be used as filter of ListStatement.
...
class PipeTargetSqsQueueParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] message_deduplication_id: This parameter applies only to FIFO (first-in-first-out) queues.
...
if not MYPY:
    class PipeTargetTimestreamParametersArgsDict(TypedDict):
        ...
        """
        time_value: pulumi.Input[builtins.str]
        """
        Dynamic path to the source data field that represents the time value for your data.
        """
        version_value: pulumi.Input[builtins.str]
        """
...
class PipeTargetTimestreamParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PipeDimensionMappingArgs']]] dimension_mappings: Map source data to dimensions in the target Timestream for LiveAnalytics table.
               ...
               For more information, see [Amazon Timestream for LiveAnalytics concepts](https://docs.aws.amazon.com/timestream/latest/developerguide/concepts.html)
        :param pulumi.Input[builtins.str] time_value: Dynamic path to the source data field that represents the time value for your data.
        :param pulumi.Input[builtins.str] version_value: 64 bit version value or source data field that represents the version value for your data.
        ...
        :param pulumi.Input['PipeTimeFieldType'] time_field_type: The type of time value used.
               ...
               The default is `EPOCH` .
        :param pulumi.Input[builtins.str] timestamp_format: How to format the timestamps. For example, `yyyy-MM-dd'T'HH:mm:ss'Z'` .
    ...
    def time_value(self) -> pulumi.Input[builtins.str]:
        """
        Dynamic path to the source data field that represents the time value for your data.
        """
    ...
    @time_value.setter
    def time_value(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "time_value", value)

    @property
    @pulumi.getter(name="versionValue")
    def version_value(self) -> pulumi.Input[builtins.str]:
        """
        64 bit version value or source data field that represents the version value for your data.
    ...
    def version_value(self, value: pulumi.Input[builtins.str]):
