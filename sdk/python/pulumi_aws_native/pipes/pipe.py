...
class Pipe(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(enrichment_parameters, PipeEnrichmentParametersArgs):
            ...
            if not isinstance(source_parameters, PipeSourceParametersArgs):
            ...
            if not isinstance(tags, PipeTagMapArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
            ...
            if not isinstance(target_parameters, PipeTargetParametersArgs):
