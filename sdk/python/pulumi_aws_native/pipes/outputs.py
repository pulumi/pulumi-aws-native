...
class PipeBatchArrayProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int size: The size of the array, if this is an array batch job.
        """
        if size is not None:
...
class PipeBatchContainerOverrides(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] command: The command to send to the container that overrides the default command from the Docker image or the task definition.
...
class PipeBatchRetryStrategy(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int attempts: The number of times to move a job to the `RUNNABLE` status. If the value of `attempts` is greater than one, the job is retried on failure the same number of attempts as the value.
        """
...
class PipeCloudwatchLogsLogDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str log_group_arn: The AWS Resource Name (ARN) for the CloudWatch log group to which EventBridge sends the log records.
        """
...
class PipeDeadLetterConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str arn: The ARN of the specified target for the dead-letter queue.
...
class PipeDimensionMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dimension_name: The metadata attributes of the time series. For example, the name and Availability Zone of an Amazon EC2 instance or the name of the manufacturer of a wind turbine are dimensions.
        :param _builtins.str dimension_value: Dynamic path to the dimension value in the source event.
...
class PipeEcsContainerOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] command: The command to send to the container that overrides the default command from the Docker image or the task definition. You must also specify a container name.
...
class PipeEcsTaskOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str execution_role_arn: The Amazon Resource Name (ARN) of the task execution IAM role override for the task. For more information, see [Amazon ECS task execution IAM role](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_execution_IAM_role.html) in the *Amazon Elastic Container Service Developer Guide* .
        ...
        :param _builtins.str task_role_arn: The Amazon Resource Name (ARN) of the IAM role that containers in this task can assume. All containers in this task are granted the permissions that are specified in this role. For more information, see [IAM Role for Tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-iam-roles.html) in the *Amazon Elastic Container Service Developer Guide* .
        """
...
class PipeEnrichmentHttpParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] header_parameters: The headers that need to be sent as part of request invoking the API Gateway REST API or EventBridge ApiDestination.
        :param Sequence[_builtins.str] path_parameter_values: The path parameter values to be used to populate API Gateway REST API or EventBridge ApiDestination path wildcards ("*").
        :param Mapping[str, _builtins.str] query_string_parameters: The query string keys/values that need to be sent as part of request invoking the API Gateway REST API or EventBridge ApiDestination.
        """
...
class PipeEnrichmentParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str input_template: Valid JSON text passed to the enrichment. In this case, nothing from the event itself is passed to the enrichment. For more information, see [The JavaScript Object Notation (JSON) Data Interchange Format](https://docs.aws.amazon.com/http://www.rfc-editor.org/rfc/rfc7159.txt) .
...
class PipeFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str pattern: The event pattern.
        """
...
class PipeFirehoseLogDestination(dict):
    ...
    def __init__(__self__, *,
                 delivery_stream_arn: Optional[_builtins.str] = None):
        """
        :param _builtins.str delivery_stream_arn: The Amazon Resource Name (ARN) of the Firehose delivery stream to which EventBridge delivers the pipe log records.
        """
    ...
    def delivery_stream_arn(self) -> Optional[_builtins.str]:
        """
...
class PipeMqBrokerAccessCredentialsProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str basic_auth: Optional SecretManager ARN which stores the database credentials
        """
...
class PipeMskAccessCredentials0Properties(dict):
    ...
    def __init__(__self__, *,
                 sasl_scram512_auth: _builtins.str):
        """
        :param _builtins.str sasl_scram512_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "sasl_scram512_auth", sasl_scram512_auth)

    @_builtins.property
    @pulumi.getter(name="saslScram512Auth")
    def sasl_scram512_auth(self) -> _builtins.str:
        """
        Optional SecretManager ARN which stores the database credentials
        """
...
class PipeMskAccessCredentials1Properties(dict):
    ...
    def __init__(__self__, *,
                 client_certificate_tls_auth: _builtins.str):
        """
        :param _builtins.str client_certificate_tls_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "client_certificate_tls_auth", client_certificate_tls_auth)

    @_builtins.property
    @pulumi.getter(name="clientCertificateTlsAuth")
    def client_certificate_tls_auth(self) -> _builtins.str:
        """
        Optional SecretManager ARN which stores the database credentials
        """
...
class PipeMultiMeasureAttributeMapping(dict):
    ...
    def __init__(__self__, *,
                 measure_value: _builtins.str,
                 measure_value_type: 'PipeMeasureValueType',
                 multi_measure_attribute_name: _builtins.str):
        """
        :param _builtins.str measure_value: Dynamic path to the measurement attribute in the source event.
        :param 'PipeMeasureValueType' measure_value_type: Data type of the measurement attribute in the source event.
        :param _builtins.str multi_measure_attribute_name: Target measure name to be used.
        """
    ...
    def measure_value(self) -> _builtins.str:
        """
    ...
    def multi_measure_attribute_name(self) -> _builtins.str:
        """
...
class PipeMultiMeasureMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 multi_measure_name: _builtins.str):
        """
        ...
        :param _builtins.str multi_measure_name: The name of the multiple measurements per record (multi-measure).
        """
    ...
    def multi_measure_name(self) -> _builtins.str:
        """
...
class PipeS3LogDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket_name: The name of the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param _builtins.str bucket_owner: The AWS account that owns the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        ...
        :param _builtins.str prefix: The prefix text with which to begin Amazon S3 log object names.
...
class PipeSelfManagedKafkaAccessConfigurationCredentials2Properties(dict):
    ...
    def __init__(__self__, *,
                 sasl_scram256_auth: _builtins.str):
        """
        :param _builtins.str sasl_scram256_auth: Optional SecretManager ARN which stores the database credentials
        """
        pulumi.set(__self__, "sasl_scram256_auth", sasl_scram256_auth)

    @_builtins.property
    @pulumi.getter(name="saslScram256Auth")
    def sasl_scram256_auth(self) -> _builtins.str:
        """
        Optional SecretManager ARN which stores the database credentials
        """
...
class PipeSelfManagedKafkaAccessConfigurationVpc(dict):
    ...
    def __init__(__self__, *,
                 security_group: Optional[Sequence[_builtins.str]] = None,
                 subnets: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] security_group: List of SecurityGroupId.
        :param Sequence[_builtins.str] subnets: List of SubnetId.
        """
    ...
    def security_group(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class PipeSingleMeasureMapping(dict):
    ...
    def __init__(__self__, *,
                 measure_name: _builtins.str,
                 measure_value: _builtins.str,
                 measure_value_type: 'PipeMeasureValueType'):
        """
        :param _builtins.str measure_name: Target measure name for the measurement attribute in the Timestream table.
        :param _builtins.str measure_value: Dynamic path of the source field to map to the measure in the record.
    ...
    def measure_name(self) -> _builtins.str:
        """
...
class PipeSourceActiveMqBrokerParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str queue_name: The name of the destination queue to consume.
        :param _builtins.int batch_size: The maximum number of records to include in each batch.
        :param _builtins.int maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        """
...
class PipeSourceDynamoDbStreamParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param _builtins.int maximum_record_age_in_seconds: Discard records older than the specified age. The default value is -1, which sets the maximum age to infinite. When the value is set to infinite, EventBridge never discards old records.
        :param _builtins.int maximum_retry_attempts: Discard records after the specified number of retries. The default value is -1, which sets the maximum number of retries to infinite. When MaximumRetryAttempts is infinite, EventBridge retries failed records until the record expires in the event source.
        ...
        :param _builtins.int parallelization_factor: The number of batches to process concurrently from each shard. The default value is 1.
        """
...
class PipeSourceManagedStreamingKafkaParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str topic_name: The name of the topic that the pipe will read from.
        :param _builtins.int batch_size: The maximum number of records to include in each batch.
        :param _builtins.str consumer_group_id: The name of the destination queue to consume.
...
class PipeSourceRabbitMqBrokerParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int batch_size: The maximum number of records to include in each batch.
        :param _builtins.int maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param _builtins.str virtual_host: The name of the virtual host associated with the source broker.
        """
        pulumi.set(__self__, "credentials", credentials)
        pulumi.set(__self__, "queue_name", queue_name)
        if batch_size is not None:
...
class PipeSourceSelfManagedKafkaParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str topic_name: The name of the topic that the pipe will read from.
        :param Sequence[_builtins.str] additional_bootstrap_servers: An array of server URLs.
        :param _builtins.int batch_size: The maximum number of records to include in each batch.
        :param _builtins.str consumer_group_id: The name of the destination queue to consume.
        ...
        :param _builtins.int maximum_batching_window_in_seconds: The maximum length of a time to wait for events.
        :param _builtins.str server_root_ca_certificate: Optional SecretManager ARN which stores the database credentials
...
class PipeTag(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str key: The key of the key-value pair.
        :param _builtins.str value: The value of the key-value pair.
        """
...
class PipeTargetBatchJobParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str job_name: The name of the job. It can be up to 128 letters long. The first character must be alphanumeric, can contain uppercase and lowercase letters, numbers, hyphens (-), and underscores (_).
...
class PipeTargetCloudWatchLogsParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str timestamp: A [dynamic path parameter](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-event-target.html) to a field in the payload containing the time the event occurred, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC.
...
class PipeTargetEventBridgeEventBusParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] resources: AWS resources, identified by Amazon Resource Name (ARN), which the event primarily concerns. Any number, including zero, may be present.
        :param _builtins.str source: The source of the event.
        :param _builtins.str time: The time stamp of the event, per [RFC3339](https://docs.aws.amazon.com/https://www.rfc-editor.org/rfc/rfc3339.txt) . If no time stamp is provided, the time stamp of the [PutEvents](https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_PutEvents.html) call is used.
        """
...
class PipeTargetParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str input_template: Valid JSON text passed to the target. In this case, nothing from the event itself is passed to the target. For more information, see [The JavaScript Object Notation (JSON) Data Interchange Format](https://docs.aws.amazon.com/http://www.rfc-editor.org/rfc/rfc7159.txt) .
...
class PipeTargetRedshiftDataParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str database: Redshift Database
        :param Sequence[_builtins.str] sqls: A list of SQLs.
        :param _builtins.str db_user: Database user name
        :param _builtins.str secret_manager_arn: Optional SecretManager ARN which stores the database credentials
        :param _builtins.str statement_name: A name for Redshift DataAPI statement which can be used as filter of ListStatement.
...
class PipeTargetSqsQueueParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str message_deduplication_id: This parameter applies only to FIFO (first-in-first-out) queues.
...
class PipeTargetTimestreamParameters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_value: _builtins.str,
                 version_value: _builtins.str,
        ...
        :param _builtins.str time_value: Dynamic path to the source data field that represents the time value for your data.
        :param _builtins.str version_value: 64 bit version value or source data field that represents the version value for your data.
        ...
        :param _builtins.str timestamp_format: How to format the timestamps. For example, `yyyy-MM-dd'T'HH:mm:ss'Z'` .
    ...
    def time_value(self) -> _builtins.str:
        """
    ...
    def version_value(self) -> _builtins.str:
        """
