...
class ConfigurationSetDashboardOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Dashboard feature.
        :param builtins.str engagement_metrics: Whether emails sent with this configuration set have engagement tracking enabled.
        """
...
class ConfigurationSetDeliveryOptions(dict):
    ...
    def __init__(__self__, *,
                 max_delivery_seconds: Optional[builtins.float] = None,
                 sending_pool_name: Optional[builtins.str] = None,
                 tls_policy: Optional[builtins.str] = None):
        """
        An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
        :param builtins.float max_delivery_seconds: Specifies the maximum time until which SES will retry sending emails
        :param builtins.str sending_pool_name: The name of the dedicated IP pool to associate with the configuration set.
        :param builtins.str tls_policy: Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is Require , messages are only delivered if a TLS connection can be established. If the value is Optional , messages can be delivered in plain text if a TLS connection can't be established.
        """
    ...
    def max_delivery_seconds(self) -> Optional[builtins.float]:
        """
...
class ConfigurationSetEventDestinationDimensionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A list of dimensions upon which to categorize your emails when you publish email sending events to Amazon CloudWatch.
        :param builtins.str default_dimension_value: The default value of the dimension that is published to Amazon CloudWatch if you do not provide the value of the dimension when you send an email.
        :param builtins.str dimension_name: The name of an Amazon CloudWatch dimension associated with an email sending metric.
        :param builtins.str dimension_value_source: The place where Amazon SES finds the value of a dimension to publish to Amazon CloudWatch. To use the message tags that you specify using an X-SES-MESSAGE-TAGS header or a parameter to the SendEmail/SendRawEmail API, specify messageTag. To use your own email headers, specify emailHeader. To put a custom tag on any link included in your email, specify linkTag.
        """
...
class ConfigurationSetEventDestinationEventDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] matching_event_types: The type of email sending events, send, reject, bounce, complaint, delivery, open, click, renderingFailure, deliveryDelay, and subscription.
        ...
        :param builtins.bool enabled: Sets whether Amazon SES publishes events to this destination when you send an email with the associated configuration set. Set to true to enable publishing to this destination; set to false to prevent publishing to this destination. The default value is false.   
        ...
        :param builtins.str name: The name of the event destination set.
...
class ConfigurationSetEventDestinationKinesisFirehoseDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object that contains the delivery stream ARN and the IAM role ARN associated with an Amazon Kinesis Firehose event destination.
        :param builtins.str delivery_stream_arn: The ARN of the Amazon Kinesis Firehose stream that email sending events should be published to.
        :param builtins.str iam_role_arn: The ARN of the IAM role under which Amazon SES publishes email sending events to the Amazon Kinesis Firehose stream.
        """
...
class ConfigurationSetEventDestinationSnsDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object that contains SNS topic ARN associated event destination.
        :param builtins.str topic_arn: The ARN of the Amazon SNS topic for email sending events. You can find the ARN of a topic by using the [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html) Amazon SNS operation.
...
class ConfigurationSetGuardianOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Guardian feature.
        :param builtins.str optimized_shared_delivery: Whether emails sent with this configuration set have optimized delivery algorithm enabled.
        """
...
class ConfigurationSetTrackingOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str https_policy: The https policy to use for tracking open and click events.
        """
...
class ContactListTopic(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_subscription_status: The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.
        :param builtins.str display_name: The display name of the topic.
...
class EmailIdentityConfigurationSetAttributes(dict):
    ...
    def __init__(__self__, *,
                 configuration_set_name: Optional[builtins.str] = None):
        """
        Used to associate a configuration set with an email identity.
        :param builtins.str configuration_set_name: The configuration set to use by default when sending from this identity. Note that any configuration set defined in the email sending request takes precedence.
        """
    ...
    def configuration_set_name(self) -> Optional[builtins.str]:
        """
...
class EmailIdentityDkimAttributes(dict):
    ...
    def __init__(__self__, *,
                 signing_enabled: Optional[builtins.bool] = None):
        """
        Used to enable or disable DKIM authentication for an email identity.
        :param builtins.bool signing_enabled: Sets the DKIM signing configuration for the identity. When you set this value true, then the messages that are sent from the identity are signed using DKIM. If you set this value to false, your messages are sent without DKIM signing.
        """
    ...
    def signing_enabled(self) -> Optional[builtins.bool]:
        """
...
class EmailIdentityFeedbackAttributes(dict):
    ...
    def __init__(__self__, *,
                 email_forwarding_enabled: Optional[builtins.bool] = None):
        """
        Used to enable or disable feedback forwarding for an identity.
        :param builtins.bool email_forwarding_enabled: If the value is true, you receive email notifications when bounce or complaint events occur
        """
    ...
    def email_forwarding_enabled(self) -> Optional[builtins.bool]:
        """
...
class EmailIdentityMailFromAttributes(dict):
    ...
    def __init__(__self__, *,
                 behavior_on_mx_failure: Optional[builtins.str] = None,
                 mail_from_domain: Optional[builtins.str] = None):
        """
        Used to enable or disable the custom Mail-From domain configuration for an email identity.
        :param builtins.str behavior_on_mx_failure: The action to take if the required MX record isn't found when you send an email. When you set this value to UseDefaultValue , the mail is sent using amazonses.com as the MAIL FROM domain. When you set this value to RejectMessage , the Amazon SES API v2 returns a MailFromDomainNotVerified error, and doesn't attempt to deliver the email.
        :param builtins.str mail_from_domain: The custom MAIL FROM domain that you want the verified identity to use
        """
    ...
    def behavior_on_mx_failure(self) -> Optional[builtins.str]:
        """
    ...
    def mail_from_domain(self) -> Optional[builtins.str]:
        """
...
class MailManagerRuleSetReplaceRecipientAction(dict):
    ...
    def __init__(__self__, *,
                 replace_with: Optional[Sequence[builtins.str]] = None):
        if replace_with is not None:
            pulumi.set(__self__, "replace_with", replace_with)

    @property
    @pulumi.getter(name="replaceWith")
    def replace_with(self) -> Optional[Sequence[builtins.str]]:
...
class MailManagerRuleSetS3Action(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_sse_kms_key_id: Optional[builtins.str] = None):
        pulumi.set(__self__, "role_arn", role_arn)
    ...
    def s3_sse_kms_key_id(self) -> Optional[builtins.str]:
...
class Template(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The content of the email, composed of a subject line, an HTML part, and a text-only part
        :param builtins.str subject_part: The subject line of the email.
        :param builtins.str html_part: The HTML body of the email.
        :param builtins.str template_name: The name of the template.
        :param builtins.str text_part: The email body that is visible to recipients whose email clients do not display HTML content.
        """
...
class VdmAttributesDashboardAttributes(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Dashboard feature.
        :param builtins.str engagement_metrics: Whether emails sent from this account have engagement tracking enabled.
        """
...
class VdmAttributesGuardianAttributes(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Guardian feature.
        :param builtins.str optimized_shared_delivery: Whether emails sent from this account have optimized delivery algorithm enabled.
        """
