...
class ReceiptFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ReceiptFilterFilterArgs'] filter: A data structure that describes the IP address filter to create, which consists of a name, an IP address range, and whether to allow or block mail from it.
        """
...
@pulumi.type_token("aws-native:ses:ReceiptFilter")
