...
class ReceiptRuleSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ReceiptRuleSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ReceiptRuleSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ReceiptRuleSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ReceiptRuleSetProperties']:
        """
