...
class GetMailManagerRelayResult:
    ...
    def relay_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def server_port(self) -> Optional[_builtins.float]:
        """
...
def get_mail_manager_relay(relay_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str relay_id: The unique relay identifier.
    """
    __args__ = dict()
