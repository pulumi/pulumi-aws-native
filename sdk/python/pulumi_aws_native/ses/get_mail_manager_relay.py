...
class GetMailManagerRelayResult:
    ...
    def relay_arn(self) -> Optional[builtins.str]:
        """
    ...
    def relay_id(self) -> Optional[builtins.str]:
        """
    ...
    def server_port(self) -> Optional[builtins.float]:
        """
...
def get_mail_manager_relay(relay_id: Optional[builtins.str] = None,
    ...
    :param builtins.str relay_id: The unique relay identifier.
    """
    __args__ = dict()
...
def get_mail_manager_relay_output(relay_id: Optional[pulumi.Input[builtins.str]] = None,
