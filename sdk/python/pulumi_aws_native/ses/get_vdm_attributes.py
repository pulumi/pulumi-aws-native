...
class GetVdmAttributesResult:
    ...
    def vdm_attributes_resource_id(self) -> Optional[_builtins.str]:
        """
...
def get_vdm_attributes(vdm_attributes_resource_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vdm_attributes_resource_id: Unique identifier for this resource
    """
    __args__ = dict()
