...
class MailManagerTrafficPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="maxMessageSizeBytes")
    def max_message_size_bytes(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The maximum message size in bytes of email which is allowed in by this traffic policy—anything larger will be blocked.
        """
        return pulumi.get(self, "max_message_size_bytes")
    ...
    def traffic_policy_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="trafficPolicyName")
    def traffic_policy_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the policy.
