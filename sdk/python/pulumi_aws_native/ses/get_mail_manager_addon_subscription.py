...
class GetMailManagerAddonSubscriptionResult:
    ...
    def addon_subscription_arn(self) -> Optional[builtins.str]:
        """
    ...
    def addon_subscription_id(self) -> Optional[builtins.str]:
        """
...
def get_mail_manager_addon_subscription(addon_subscription_id: Optional[builtins.str] = None,
    ...
    :param builtins.str addon_subscription_id: The unique ID of the Add On subscription.
    """
    __args__ = dict()
...
def get_mail_manager_addon_subscription_output(addon_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
