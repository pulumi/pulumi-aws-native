...
class GetMailManagerAddonSubscriptionResult:
    ...
    def addon_subscription_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def addon_subscription_id(self) -> Optional[_builtins.str]:
        """
...
def get_mail_manager_addon_subscription(addon_subscription_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str addon_subscription_id: The unique ID of the Add On subscription.
    """
    __args__ = dict()
...
def get_mail_manager_addon_subscription_output(addon_subscription_id: Optional[pulumi.Input[_builtins.str]] = None,
