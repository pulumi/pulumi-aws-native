...
class MailManagerArchiveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] archive_name: A unique name for the new archive.
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) of the KMS key for encrypting emails in the archive.
...
class MailManagerArchive(pulumi.CustomResource):
    ...
    def archive_arn(self) -> pulumi.Output[builtins.str]:
        """
