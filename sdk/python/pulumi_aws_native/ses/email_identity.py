...
class EmailIdentity(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(configuration_set_attributes, EmailIdentityConfigurationSetAttributesArgs):
            ...
            if not isinstance(dkim_attributes, EmailIdentityDkimAttributesArgs):
            ...
            if not isinstance(dkim_signing_attributes, EmailIdentityDkimSigningAttributesArgs):
            ...
            if not isinstance(feedback_attributes, EmailIdentityFeedbackAttributesArgs):
            ...
            if not isinstance(mail_from_attributes, EmailIdentityMailFromAttributesArgs):
