...
class GetMailManagerAddonInstanceResult:
    ...
    def addon_instance_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def addon_instance_id(self) -> Optional[_builtins.str]:
        """
...
def get_mail_manager_addon_instance(addon_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str addon_instance_id: The unique ID of the Add On instance.
    """
    __args__ = dict()
...
def get_mail_manager_addon_instance_output(addon_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
