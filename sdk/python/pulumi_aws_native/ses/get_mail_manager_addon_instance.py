...
class GetMailManagerAddonInstanceResult:
    ...
    def addon_instance_arn(self) -> Optional[builtins.str]:
        """
    ...
    def addon_instance_id(self) -> Optional[builtins.str]:
        """
    ...
    def addon_name(self) -> Optional[builtins.str]:
        """
...
def get_mail_manager_addon_instance(addon_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str addon_instance_id: The unique ID of the Add On instance.
    """
    __args__ = dict()
...
def get_mail_manager_addon_instance_output(addon_instance_id: Optional[pulumi.Input[builtins.str]] = None,
