...
class MailManagerRelayArgs:
    def __init__(__self__, *,
                 ...
                 server_port: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.str] server_name: The destination relay server address.
        :param pulumi.Input[builtins.float] server_port: The destination relay server port.
        :param pulumi.Input[builtins.str] relay_name: The unique relay name.
    ...
    def server_port(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @server_port.setter
    def server_port(self, value: pulumi.Input[builtins.float]):
...
@pulumi.type_token("aws-native:ses:MailManagerRelay")
class MailManagerRelay(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 server_port: Optional[pulumi.Input[builtins.float]] = None,
    ...
    def relay_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="serverPort")
    def server_port(self) -> pulumi.Output[builtins.float]:
        """
        The destination relay server port.
        """
        return pulumi.get(self, "server_port")
