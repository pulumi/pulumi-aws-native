...
if not MYPY:
    class ConfigurationSetDashboardOptionsArgsDict(TypedDict):
        ...
        """
        engagement_metrics: pulumi.Input[builtins.str]
        """
...
class ConfigurationSetDashboardOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Dashboard feature.
        :param pulumi.Input[builtins.str] engagement_metrics: Whether emails sent with this configuration set have engagement tracking enabled.
        """
        pulumi.set(__self__, "engagement_metrics", engagement_metrics)

    @property
    @pulumi.getter(name="engagementMetrics")
    def engagement_metrics(self) -> pulumi.Input[builtins.str]:
        """
        Whether emails sent with this configuration set have engagement tracking enabled.
        """
    ...
    def engagement_metrics(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ConfigurationSetDeliveryOptionsArgsDict(TypedDict):
        ...
        """
        max_delivery_seconds: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ConfigurationSetDeliveryOptionsArgs:
    def __init__(__self__, *,
                 max_delivery_seconds: Optional[pulumi.Input[builtins.float]] = None,
                 sending_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 tls_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
        :param pulumi.Input[builtins.float] max_delivery_seconds: Specifies the maximum time until which SES will retry sending emails
        ...
        :param pulumi.Input[builtins.str] tls_policy: Specifies whether messages that use the configuration set are required to use Transport Layer Security (TLS). If the value is Require , messages are only delivered if a TLS connection can be established. If the value is Optional , messages can be delivered in plain text if a TLS connection can't be established.
        """
    ...
    def max_delivery_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies the maximum time until which SES will retry sending emails
        """
    ...
    def max_delivery_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ConfigurationSetEventDestinationDimensionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        A list of dimensions upon which to categorize your emails when you publish email sending events to Amazon CloudWatch.
        :param pulumi.Input[builtins.str] default_dimension_value: The default value of the dimension that is published to Amazon CloudWatch if you do not provide the value of the dimension when you send an email.
        ...
        :param pulumi.Input[builtins.str] dimension_value_source: The place where Amazon SES finds the value of a dimension to publish to Amazon CloudWatch. To use the message tags that you specify using an X-SES-MESSAGE-TAGS header or a parameter to the SendEmail/SendRawEmail API, specify messageTag. To use your own email headers, specify emailHeader. To put a custom tag on any link included in your email, specify linkTag.
        """
...
class ConfigurationSetEventDestinationEventDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matching_event_types: The type of email sending events, send, reject, bounce, complaint, delivery, open, click, renderingFailure, deliveryDelay, and subscription.
        ...
        :param pulumi.Input[builtins.bool] enabled: Sets whether Amazon SES publishes events to this destination when you send an email with the associated configuration set. Set to true to enable publishing to this destination; set to false to prevent publishing to this destination. The default value is false.   
        ...
        :param pulumi.Input[builtins.str] name: The name of the event destination set.
...
class ConfigurationSetEventDestinationKinesisFirehoseDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        An object that contains the delivery stream ARN and the IAM role ARN associated with an Amazon Kinesis Firehose event destination.
        :param pulumi.Input[builtins.str] delivery_stream_arn: The ARN of the Amazon Kinesis Firehose stream that email sending events should be published to.
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role under which Amazon SES publishes email sending events to the Amazon Kinesis Firehose stream.
        """
...
class ConfigurationSetEventDestinationSnsDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        An object that contains SNS topic ARN associated event destination.
        :param pulumi.Input[builtins.str] topic_arn: The ARN of the Amazon SNS topic for email sending events. You can find the ARN of a topic by using the [ListTopics](https://docs.aws.amazon.com/sns/latest/api/API_ListTopics.html) Amazon SNS operation.
...
if not MYPY:
    class ConfigurationSetGuardianOptionsArgsDict(TypedDict):
        ...
        """
        optimized_shared_delivery: pulumi.Input[builtins.str]
        """
...
class ConfigurationSetGuardianOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Guardian feature.
        :param pulumi.Input[builtins.str] optimized_shared_delivery: Whether emails sent with this configuration set have optimized delivery algorithm enabled.
        """
        pulumi.set(__self__, "optimized_shared_delivery", optimized_shared_delivery)

    @property
    @pulumi.getter(name="optimizedSharedDelivery")
    def optimized_shared_delivery(self) -> pulumi.Input[builtins.str]:
        """
        Whether emails sent with this configuration set have optimized delivery algorithm enabled.
        """
    ...
    def optimized_shared_delivery(self, value: pulumi.Input[builtins.str]):
...
class ConfigurationSetSuppressionOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        An object that contains information about the suppression list preferences for your account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] suppressed_reasons: A list that contains the reasons that email addresses are automatically added to the suppression list for your account.
        """
...
class ConfigurationSetTrackingOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] https_policy: The https policy to use for tracking open and click events.
        """
...
class ContactListTopicArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_subscription_status: The default subscription status to be applied to a contact if the contact has not noted their preference for subscribing to a topic.
        :param pulumi.Input[builtins.str] display_name: The display name of the topic.
        :param pulumi.Input[builtins.str] topic_name: The name of the topic.
...
if not MYPY:
    class EmailIdentityConfigurationSetAttributesArgsDict(TypedDict):
        ...
        """
        configuration_set_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
if not MYPY:
    class EmailIdentityDkimAttributesArgsDict(TypedDict):
        ...
        """
        signing_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EmailIdentityDkimAttributesArgs:
    def __init__(__self__, *,
                 signing_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Used to enable or disable DKIM authentication for an email identity.
        :param pulumi.Input[builtins.bool] signing_enabled: Sets the DKIM signing configuration for the identity. When you set this value true, then the messages that are sent from the identity are signed using DKIM. If you set this value to false, your messages are sent without DKIM signing.
        """
    ...
    def signing_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Sets the DKIM signing configuration for the identity. When you set this value true, then the messages that are sent from the identity are signed using DKIM. If you set this value to false, your messages are sent without DKIM signing.
        """
    ...
    def signing_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EmailIdentityDkimSigningAttributesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] next_signing_key_length: [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.
        """
...
if not MYPY:
    class EmailIdentityFeedbackAttributesArgsDict(TypedDict):
        ...
        """
        email_forwarding_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EmailIdentityFeedbackAttributesArgs:
    def __init__(__self__, *,
        ...
        """
        Used to enable or disable feedback forwarding for an identity.
        :param pulumi.Input[builtins.bool] email_forwarding_enabled: If the value is true, you receive email notifications when bounce or complaint events occur
        """
...
if not MYPY:
    class EmailIdentityMailFromAttributesArgsDict(TypedDict):
        ...
        """
        behavior_on_mx_failure: NotRequired[pulumi.Input[builtins.str]]
        """
        The action to take if the required MX record isn't found when you send an email. When you set this value to UseDefaultValue , the mail is sent using amazonses.com as the MAIL FROM domain. When you set this value to RejectMessage , the Amazon SES API v2 returns a MailFromDomainNotVerified error, and doesn't attempt to deliver the email.
        """
        mail_from_domain: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EmailIdentityMailFromAttributesArgs:
    def __init__(__self__, *,
        ...
        """
        Used to enable or disable the custom Mail-From domain configuration for an email identity.
        :param pulumi.Input[builtins.str] behavior_on_mx_failure: The action to take if the required MX record isn't found when you send an email. When you set this value to UseDefaultValue , the mail is sent using amazonses.com as the MAIL FROM domain. When you set this value to RejectMessage , the Amazon SES API v2 returns a MailFromDomainNotVerified error, and doesn't attempt to deliver the email.
        :param pulumi.Input[builtins.str] mail_from_domain: The custom MAIL FROM domain that you want the verified identity to use
        """
...
if not MYPY:
    class MailManagerIngressPointIngressPointConfiguration0PropertiesArgsDict(TypedDict):
        smtp_password: pulumi.Input[builtins.str]
elif False:
...
class MailManagerIngressPointIngressPointConfiguration0PropertiesArgs:
    ...
    def smtp_password(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "smtp_password")

    @smtp_password.setter
    def smtp_password(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MailManagerRuleSetAnalysisArgsDict(TypedDict):
        ...
        result_field: pulumi.Input[builtins.str]
elif False:
...
class MailManagerRuleSetAnalysisArgs:
    ...
    def result_field(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "result_field")

    @result_field.setter
    def result_field(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "result_field", value)


if not MYPY:
    class MailManagerRuleSetArchiveActionArgsDict(TypedDict):
        target_archive: pulumi.Input[builtins.str]
...
class MailManagerRuleSetArchiveActionArgs:
    ...
    def target_archive(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "target_archive")

    @target_archive.setter
    def target_archive(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MailManagerRuleSetDeliverToMailboxActionArgsDict(TypedDict):
        mailbox_arn: pulumi.Input[builtins.str]
...
class MailManagerRuleSetDeliverToMailboxActionArgs:
    ...
    def mailbox_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "mailbox_arn")

    @mailbox_arn.setter
    def mailbox_arn(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MailManagerRuleSetRelayActionArgsDict(TypedDict):
        relay: pulumi.Input[builtins.str]
        action_failure_policy: NotRequired[pulumi.Input['MailManagerRuleSetActionFailurePolicy']]
...
class MailManagerRuleSetRelayActionArgs:
    ...
    @property
    @pulumi.getter
    def relay(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "relay")

    @relay.setter
    def relay(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MailManagerRuleSetReplaceRecipientActionArgsDict(TypedDict):
        replace_with: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class MailManagerRuleSetReplaceRecipientActionArgs:
    def __init__(__self__, *,
                 replace_with: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        if replace_with is not None:
            pulumi.set(__self__, "replace_with", replace_with)

    @property
    @pulumi.getter(name="replaceWith")
    def replace_with(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "replace_with")

    @replace_with.setter
    def replace_with(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class MailManagerRuleSetRuleIsInAddressListArgsDict(TypedDict):
        address_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
...
class MailManagerRuleSetRuleIsInAddressListArgs:
    ...
    def address_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "address_lists")

    @address_lists.setter
    def address_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class MailManagerRuleSetRuleStringToEvaluate1PropertiesArgsDict(TypedDict):
        mime_header_attribute: pulumi.Input[builtins.str]
elif False:
...
class MailManagerRuleSetRuleStringToEvaluate1PropertiesArgs:
    ...
    def mime_header_attribute(self) -> pulumi.Input[builtins.str]:
...
if not MYPY:
    class MailManagerRuleSetS3ActionArgsDict(TypedDict):
        ...
        s3_sse_kms_key_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class MailManagerRuleSetS3ActionArgs:
    def __init__(__self__, *,
                 ...
                 s3_sse_kms_key_id: Optional[pulumi.Input[builtins.str]] = None):
        pulumi.set(__self__, "role_arn", role_arn)
    ...
    def s3_sse_kms_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "s3_sse_kms_key_id")

    @s3_sse_kms_key_id.setter
    def s3_sse_kms_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TemplateArgsDict(TypedDict):
        ...
        """
        subject_part: pulumi.Input[builtins.str]
        """
...
class TemplateArgs:
    def __init__(__self__, *,
        ...
        """
        The content of the email, composed of a subject line, an HTML part, and a text-only part
        :param pulumi.Input[builtins.str] subject_part: The subject line of the email.
        :param pulumi.Input[builtins.str] html_part: The HTML body of the email.
        :param pulumi.Input[builtins.str] template_name: The name of the template.
        :param pulumi.Input[builtins.str] text_part: The email body that is visible to recipients whose email clients do not display HTML content.
        """
    ...
    def subject_part(self) -> pulumi.Input[builtins.str]:
        """
        The subject line of the email.
        """
    ...
    @subject_part.setter
    def subject_part(self, value: pulumi.Input[builtins.str]):
...
class VdmAttributesDashboardAttributesArgs:
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Dashboard feature.
        :param pulumi.Input[builtins.str] engagement_metrics: Whether emails sent from this account have engagement tracking enabled.
        """
...
class VdmAttributesGuardianAttributesArgs:
    def __init__(__self__, *,
        ...
        """
        Preferences regarding the Guardian feature.
        :param pulumi.Input[builtins.str] optimized_shared_delivery: Whether emails sent from this account have optimized delivery algorithm enabled.
        """
