...
def get_configuration_set_event_destination(id: Optional[builtins.str] = None,
...
def get_configuration_set_event_destination_output(id: Optional[pulumi.Input[builtins.str]] = None,
