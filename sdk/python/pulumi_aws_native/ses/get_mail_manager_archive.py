...
class GetMailManagerArchiveResult:
    ...
    def archive_id(self) -> Optional[_builtins.str]:
        """
    ...
    def archive_name(self) -> Optional[_builtins.str]:
        """
...
def get_mail_manager_archive(archive_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str archive_id: The unique identifier of the archive.
    """
    __args__ = dict()
