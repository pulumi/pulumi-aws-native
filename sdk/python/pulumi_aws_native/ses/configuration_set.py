...
class ConfigurationSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConfigurationSetReputationOptionsArgs'] reputation_options: Contains information about the reputation settings for a configuration set.
        :param pulumi.Input['ConfigurationSetSendingOptionsArgs'] sending_options: Used to enable or disable email sending for messages that use this configuration set in the current AWS Region.
        ...
        :param pulumi.Input['ConfigurationSetTrackingOptionsArgs'] tracking_options: A domain that is used to redirect email recipients to an Amazon SES-operated domain. This domain captures open and click events generated by Amazon SES emails.
        ...
        :param pulumi.Input['ConfigurationSetVdmOptionsArgs'] vdm_options: The Virtual Deliverability Manager (VDM) options that apply to a configuration set.
        """
...
class ConfigurationSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: The name of the configuration set.
        :param pulumi.Input[pulumi.InputType['ConfigurationSetReputationOptionsArgs']] reputation_options: Contains information about the reputation settings for a configuration set.
        :param pulumi.Input[pulumi.InputType['ConfigurationSetSendingOptionsArgs']] sending_options: Used to enable or disable email sending for messages that use this configuration set in the current AWS Region.
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationSetTrackingOptionsArgs']] tracking_options: A domain that is used to redirect email recipients to an Amazon SES-operated domain. This domain captures open and click events generated by Amazon SES emails.
               
               For more information, see [Configuring Custom Domains to Handle Open and Click Tracking](https://docs.aws.amazon.com/ses/latest/dg/configure-custom-open-click-domains.html) in the *Amazon SES Developer Guide* .
        :param pulumi.Input[pulumi.InputType['ConfigurationSetVdmOptionsArgs']] vdm_options: The Virtual Deliverability Manager (VDM) options that apply to a configuration set.
        """
        ...
    @overload
    def __init__(__self__,
