...
def get_contact_list(contact_list_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContactListResult:
    """
    Resource schema for AWS::SES::ContactList.


    :param builtins.str contact_list_name: The name of the contact list.
    """
    __args__ = dict()
...
def get_contact_list_output(contact_list_name: Optional[pulumi.Input[builtins.str]] = None,
