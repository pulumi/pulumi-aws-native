...
def get_workflow(arn: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkflowResult:
    """
    Resource schema for AWS::ImageBuilder::Workflow


    :param builtins.str arn: The Amazon Resource Name (ARN) of the workflow.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_workflow_output(arn: Optional[pulumi.Input[builtins.str]] = None,
