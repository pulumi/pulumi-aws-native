...
class InfrastructureConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(instance_metadata_options, InfrastructureConfigurationInstanceMetadataOptionsArgs):
            ...
            if not isinstance(logging, InfrastructureConfigurationLoggingArgs):
                logging = logging or {}
                def _setter(key, value):
                    logging[key] = value
