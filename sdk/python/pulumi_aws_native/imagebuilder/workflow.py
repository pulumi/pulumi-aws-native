...
class WorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] data: The data of the workflow.
        :param pulumi.Input[_builtins.str] description: The description of the workflow.
        :param pulumi.Input[_builtins.str] kms_key_id: The KMS key identifier used to encrypt the workflow.
        :param pulumi.Input[_builtins.str] name: The name of the workflow.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The tags associated with the workflow.
        :param pulumi.Input[_builtins.str] uri: The uri of the workflow.
        """
