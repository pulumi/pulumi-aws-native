...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "aws-native:ImageBuilder:Component":
                return Component(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:ImageBuilder:DistributionConfiguration":
                return DistributionConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:ImageBuilder:Image":
                return Image(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:ImageBuilder:ImagePipeline":
                return ImagePipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:ImageBuilder:ImageRecipe":
                return ImageRecipe(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:ImageBuilder:InfrastructureConfiguration":
    ...
    pulumi.runtime.register_resource_module("aws-native", "ImageBuilder", _module_instance)
