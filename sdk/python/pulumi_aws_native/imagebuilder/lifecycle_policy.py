...
class LifecyclePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] execution_role: The execution role of the lifecycle policy.
        ...
        :param pulumi.Input[builtins.str] description: The description of the lifecycle policy.
        :param pulumi.Input[builtins.str] name: The name of the lifecycle policy.
        :param pulumi.Input['LifecyclePolicyStatus'] status: The status of the lifecycle policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags associated with the lifecycle policy.
        """
