...
class ContainerRecipeComponentConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration details of the component.
        :param pulumi.Input[builtins.str] component_arn: The Amazon Resource Name (ARN) of the component.
...
class ContainerRecipeComponentParameterArgs:
    def __init__(__self__, *,
        ...
        """
        Contains a key/value pair that sets the named component parameter.
        :param pulumi.Input[builtins.str] name: The name of the component parameter to set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] value: Sets the value for the named component parameter.
        """
...
class ContainerRecipeEbsInstanceBlockDeviceSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        Amazon EBS-specific block device mapping specifications. 
        :param pulumi.Input[builtins.bool] delete_on_termination: Use to configure delete on termination of the associated device.
        :param pulumi.Input[builtins.bool] encrypted: Use to configure device encryption.
        :param pulumi.Input[builtins.int] iops: Use to configure device IOPS.
        :param pulumi.Input[builtins.str] kms_key_id: Use to configure the KMS key to use when encrypting the device.
        :param pulumi.Input[builtins.str] snapshot_id: The snapshot that defines the device contents.
        :param pulumi.Input[builtins.int] throughput: For GP3 volumes only - The throughput in MiB/s that the volume supports.
        :param pulumi.Input[builtins.int] volume_size: Use to override the device's volume size.
...
class ContainerRecipeInstanceBlockDeviceMappingArgs:
    def __init__(__self__, *,
        ...
        """
        Defines block device mappings for the instance used to configure your image. 
        :param pulumi.Input[builtins.str] device_name: The device to which these mappings apply.
        ...
        :param pulumi.Input[builtins.str] no_device: Use to remove a mapping from the parent image.
        :param pulumi.Input[builtins.str] virtual_name: Use to manage instance ephemeral devices.
        """
...
class DistributionConfigurationAmiDistributionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The specific AMI settings (for example, launch permissions, AMI tags).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] ami_tags: The tags to apply to AMIs distributed to this Region.
        :param pulumi.Input[builtins.str] description: The description of the AMI distribution configuration.
        :param pulumi.Input[builtins.str] kms_key_id: The KMS key identifier used to encrypt the distributed image.
        ...
        :param pulumi.Input[builtins.str] name: The name of the AMI distribution configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_account_ids: The ID of accounts to which you want to distribute an image.
        """
...
class DistributionConfigurationContainerDistributionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Container distribution settings for encryption, licensing, and sharing in a specific Region.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_tags: Tags that are attached to the container distribution configuration.
        :param pulumi.Input[builtins.str] description: The description of the container distribution configuration.
...
class DistributionConfigurationLaunchPermissionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Launch permissions can be used to configure which AWS accounts can use the AMI to launch instances.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organization_arns: The ARN for an Amazon Web Services Organization that you want to share your AMI with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organizational_unit_arns: The ARN for an Organizations organizational unit (OU) that you want to share your AMI with.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_groups: The name of the group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_ids: The AWS account ID.
        """
...
if not MYPY:
    class DistributionConfigurationLaunchTemplateConfigurationArgsDict(TypedDict):
        ...
        """
        set_default_version: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DistributionConfigurationLaunchTemplateConfigurationArgs:
    def __init__(__self__, *,
                 account_id: Optional[pulumi.Input[builtins.str]] = None,
                 launch_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 set_default_version: Optional[pulumi.Input[builtins.bool]] = None):
        """
        launchTemplateConfiguration settings that apply to image distribution.
        :param pulumi.Input[builtins.str] account_id: The account ID that this configuration applies to.
        :param pulumi.Input[builtins.str] launch_template_id: Identifies the EC2 launch template to use.
        :param pulumi.Input[builtins.bool] set_default_version: Set the specified EC2 launch template as the default launch template for the specified account.
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
        if launch_template_id is not None:
    ...
    def set_default_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set the specified EC2 launch template as the default launch template for the specified account.
        """
...
class DistributionConfigurationTargetContainerRepositoryArgs:
    def __init__(__self__, *,
        ...
        """
        The destination repository for the container image.
        :param pulumi.Input[builtins.str] repository_name: The repository name of target container repository.
...
class ImageEcrConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Settings for Image Builder to configure the ECR repository and output container images that are scanned.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_tags: Tags for Image Builder to apply the output container image that is scanned. Tags can help you identify and manage your scanned images.
        :param pulumi.Input[builtins.str] repository_name: The name of the container repository that Amazon Inspector scans to identify findings for your container images. The name includes the path for the repository location. If you don’t provide this information, Image Builder creates a repository in your account named image-builder-image-scanning-repository to use for vulnerability scans for your output container images.
        """
        if container_tags is not None:
            pulumi.set(__self__, "container_tags", container_tags)
        if repository_name is not None:
...
class ImagePipelineImageScanningConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] image_scanning_enabled: This sets whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image.
        """
...
class ImagePipelineImageTestsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Image tests configuration.
        :param pulumi.Input[builtins.bool] image_tests_enabled: Defines if tests should be executed when building this image.
        :param pulumi.Input[builtins.int] timeout_minutes: The maximum time in minutes that tests are permitted to run.
        """
...
if not MYPY:
    class ImagePipelineWorkflowConfigurationArgsDict(TypedDict):
        ...
        """
        workflow_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImagePipelineWorkflowConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 workflow_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The workflow configuration of the image
        ...
        :param pulumi.Input[builtins.str] parallel_group: The parallel group name
        ...
        :param pulumi.Input[builtins.str] workflow_arn: The Amazon Resource Name (ARN) of the workflow
        """
    ...
    def workflow_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the workflow
        """
    ...
    @workflow_arn.setter
    def workflow_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ImagePipelineWorkflowParameterArgs:
    def __init__(__self__, *,
        ...
        """
        A parameter associated with the workflow
        :param pulumi.Input[builtins.str] name: The name of the workflow parameter to set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] value: Sets the value for the named workflow parameter.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
if not MYPY:
    class ImageRecipeAdditionalInstanceConfigurationArgsDict(TypedDict):
        ...
        """
        user_data_override: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImageRecipeAdditionalInstanceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 user_data_override: Optional[pulumi.Input[builtins.str]] = None):
        """
        Specify additional settings and launch scripts for your build instances.
        ...
        :param pulumi.Input[builtins.str] user_data_override: Use this property to provide commands or a command script to run when you launch your build instance.
        """
    ...
    def user_data_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Use this property to provide commands or a command script to run when you launch your build instance.
        """
    ...
    def user_data_override(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ImageRecipeSystemsManagerAgentArgsDict(TypedDict):
        ...
        Contains settings for the SSM agent on your build instance.
        """
        uninstall_after_build: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ImageRecipeSystemsManagerAgentArgs:
    def __init__(__self__, *,
                 uninstall_after_build: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Contains settings for the SSM agent on your build instance.
        :param pulumi.Input[builtins.bool] uninstall_after_build: Controls whether the SSM agent is removed from your final build image, prior to creating the new AMI. If this is set to true, then the agent is removed from the final image. If it's set to false, then the agent is left in, so that it is included in the new AMI. The default value is false.
        """
    ...
    def uninstall_after_build(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Controls whether the SSM agent is removed from your final build image, prior to creating the new AMI. If this is set to true, then the agent is removed from the final image. If it's set to false, then the agent is left in, so that it is included in the new AMI. The default value is false.
        """
    ...
    def uninstall_after_build(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ImageTestsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The image tests configuration used when creating this image.
        :param pulumi.Input[builtins.bool] image_tests_enabled: ImageTestsEnabled
        :param pulumi.Input[builtins.int] timeout_minutes: TimeoutMinutes
        """
        if image_tests_enabled is not None:
            pulumi.set(__self__, "image_tests_enabled", image_tests_enabled)
        if timeout_minutes is not None:
...
class InfrastructureConfigurationInstanceMetadataOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        The instance metadata option settings for the infrastructure configuration.
        :param pulumi.Input[builtins.int] http_put_response_hop_limit: Limit the number of hops that an instance metadata request can traverse to reach its destination.
...
class InfrastructureConfigurationPlacementArgs:
    def __init__(__self__, *,
        ...
        """
        The placement options
        :param pulumi.Input[builtins.str] availability_zone: AvailabilityZone
        :param pulumi.Input[builtins.str] host_id: HostId
        :param pulumi.Input[builtins.str] host_resource_group_arn: HostResourceGroupArn
...
class InfrastructureConfigurationS3LogsArgs:
    def __init__(__self__, *,
        ...
        """
        The S3 path in which to store the logs.
        :param pulumi.Input[builtins.str] s3_bucket_name: S3BucketName
        :param pulumi.Input[builtins.str] s3_key_prefix: S3KeyPrefix
        """
...
class LifecyclePolicyAmiExclusionRulesArgs:
    def __init__(__self__, *,
        ...
        """
        The AMI exclusion rules for the policy detail.
        :param pulumi.Input[builtins.bool] is_public: Use to apply lifecycle policy actions on whether the AMI is public.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Use to apply lifecycle policy actions on AMIs distributed to a set of regions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] shared_accounts: Use to apply lifecycle policy actions on AMIs shared with a set of regions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: The AMIs to select by tag.
        """
...
class LifecyclePolicyExclusionRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: The Image Builder tags to filter on.
        """
        if amis is not None:
...
class LifecyclePolicyFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] value: The filter value.
        :param pulumi.Input[builtins.int] retain_at_least: The minimum number of Image Builder resources to retain.
...
class LifecyclePolicyIncludeResourcesArgs:
    def __init__(__self__, *,
        ...
        """
        The included resources of the policy detail.
        :param pulumi.Input[builtins.bool] amis: Use to configure lifecycle actions on AMIs.
        :param pulumi.Input[builtins.bool] containers: Use to configure lifecycle actions on containers.
        :param pulumi.Input[builtins.bool] snapshots: Use to configure lifecycle actions on snapshots.
        """
        if amis is not None:
            pulumi.set(__self__, "amis", amis)
...
class LifecyclePolicyLastLaunchedArgs:
    def __init__(__self__, *,
        ...
        The last launched time of a resource.
        :param pulumi.Input['LifecyclePolicyTimeUnit'] unit: The value's time unit.
        :param pulumi.Input[builtins.int] value: The last launched value.
        """
        pulumi.set(__self__, "unit", unit)
        pulumi.set(__self__, "value", value)
...
class LifecyclePolicyRecipeSelectionArgs:
    def __init__(__self__, *,
        ...
        """
        The recipe to apply the lifecycle policy for.
        :param pulumi.Input[builtins.str] name: The recipe name.
        :param pulumi.Input[builtins.str] semantic_version: The recipe version.
        """
        pulumi.set(__self__, "name", name)
...
class LifecyclePolicyResourceSelectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: The Image Builder resources to select by tag.
        """
