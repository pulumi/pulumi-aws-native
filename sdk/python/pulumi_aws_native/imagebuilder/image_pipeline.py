...
class ImagePipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(image_scanning_configuration, ImagePipelineImageScanningConfigurationArgs):
            ...
            if not isinstance(image_tests_configuration, ImagePipelineImageTestsConfigurationArgs):
            ...
            if not isinstance(schedule, ImagePipelineScheduleArgs):
