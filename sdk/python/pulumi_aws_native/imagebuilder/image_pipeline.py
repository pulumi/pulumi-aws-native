...
class ImagePipeline(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ImagePipelinePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ImagePipelinePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ImagePipelineAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ImagePipelineProperties']:
        """
