...
class ImageRecipeArgs:
    ...
    def ami_watermarks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def ami_watermarks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
