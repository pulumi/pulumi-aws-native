...
class ComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] change_description: The change description of the component.
        :param pulumi.Input[builtins.str] data: The data of the component.
        :param pulumi.Input[builtins.str] description: The description of the component.
        :param pulumi.Input[builtins.str] kms_key_id: The KMS key identifier used to encrypt the component.
        :param pulumi.Input[builtins.str] name: The name of the component.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_os_versions: The operating system (OS) version supported by the component.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags associated with the component.
        :param pulumi.Input[builtins.str] uri: The uri of the component.
        """
