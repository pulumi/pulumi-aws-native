...
class GetImagePipelineResult:
    ...
    def container_recipe_arn(self) -> Optional[builtins.str]:
        """
    ...
    def distribution_configuration_arn(self) -> Optional[builtins.str]:
        """
    ...
    def enhanced_image_metadata_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def image_recipe_arn(self) -> Optional[builtins.str]:
        """
    ...
    def infrastructure_configuration_arn(self) -> Optional[builtins.str]:
        """
...
def get_image_pipeline(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) of the image pipeline.
    """
    __args__ = dict()
    __args__['arn'] = arn
