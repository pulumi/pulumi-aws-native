...
class DistributionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the distribution configuration.
        :param pulumi.Input[builtins.str] name: The name of the distribution configuration.
