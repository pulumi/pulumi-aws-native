...
class GroupQuery(dict):
    ...
    def __init__(__self__, *,
                 ...
                 stack_identifier: Optional[builtins.str] = None,
        ...
        :param builtins.str stack_identifier: Specifies the ARN of a CloudFormation stack. All supported resources of the CloudFormation stack are members of the resource group. If you don't specify an ARN, this parameter defaults to the current stack that you are defining, which means that all the resources of the current stack are grouped.
    ...
    def stack_identifier(self) -> Optional[builtins.str]:
        """
...
class GroupTagFilter(dict):
    def __init__(__self__, *,
                 ...
                 values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str key: A string that defines a tag key. Only resources in the account that are tagged with a specified tag key are members of the tag-based resource group.
        ...
        :param Sequence[builtins.str] values: A list of tag values that can be included in the tag-based resource group. This is optional. If you don't specify a value or values for a key, then an AWS resource with any value for that key is a member.
        """
        if key is not None:
