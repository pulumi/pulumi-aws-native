...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the resource group
        :param pulumi.Input[builtins.str] name: The name of the resource group
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: A list of the Amazon Resource Names (ARNs) of AWS resources that you want to add to the specified group.
