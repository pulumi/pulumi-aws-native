...
if not MYPY:
    class GroupQueryArgsDict(TypedDict):
        ...
        """
        stack_identifier: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupTagFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] key: A string that defines a tag key. Only resources in the account that are tagged with a specified tag key are members of the tag-based resource group.
               
               This field is required when the `ResourceQuery` structure's `Type` property is `TAG_FILTERS_1_0` . You must specify at least one tag key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of tag values that can be included in the tag-based resource group. This is optional. If you don't specify a value or values for a key, then an AWS resource with any value for that key is a member.
        """
        if key is not None:
