...
if not MYPY:
    class ApplicationExternalUrlConfigArgsDict(TypedDict):
        access_url: pulumi.Input[builtins.str]
        """
        The URL to access the application.
        """
        approved_origins: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ApplicationExternalUrlConfigArgs:
    def __init__(__self__, *,
                 access_url: pulumi.Input[builtins.str],
                 approved_origins: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] access_url: The URL to access the application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] approved_origins: Additional URLs to allow list if different than the access URL.
        """
    ...
    def access_url(self) -> pulumi.Input[builtins.str]:
        """
        The URL to access the application.
        """
    ...
    @access_url.setter
    def access_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "access_url", value)

    @property
    @pulumi.getter(name="approvedOrigins")
    def approved_origins(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Additional URLs to allow list if different than the access URL.
        """
...
if not MYPY:
    class DataIntegrationFileConfigurationArgsDict(TypedDict):
        ...
        """
        folders: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Identifiers for the source folders to pull all files from recursively.
        """
        filters: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]
        """
...
class DataIntegrationFileConfigurationArgs:
    def __init__(__self__, *,
                 folders: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 filters: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None):
        """
        The configuration for what files should be pulled from the source.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] folders: Identifiers for the source folders to pull all files from recursively.
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] filters: Restrictions for what files should be pulled from the source.
        """
    ...
    @property
    @pulumi.getter
    def folders(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Identifiers for the source folders to pull all files from recursively.
        """
    ...
    @folders.setter
    def folders(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "folders", value)

    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]:
        """
        Restrictions for what files should be pulled from the source.
        """
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]):
...
if not MYPY:
    class DataIntegrationScheduleConfigArgsDict(TypedDict):
        ...
        """
        first_execution_from: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DataIntegrationScheduleConfigArgs:
    def __init__(__self__, *,
                 schedule_expression: pulumi.Input[builtins.str],
                 first_execution_from: Optional[pulumi.Input[builtins.str]] = None,
                 object: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] schedule_expression: How often the data should be pulled from data source.
        :param pulumi.Input[builtins.str] first_execution_from: The start date for objects to import in the first flow run. Epoch or ISO timestamp format is supported.
        :param pulumi.Input[builtins.str] object: The name of the object to pull from the data source.
        """
    ...
    def first_execution_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The start date for objects to import in the first flow run. Epoch or ISO timestamp format is supported.
        """
    ...
    def first_execution_from(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventIntegrationEventFilterArgs:
    def __init__(__self__, *,
                 source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] source: The source of the events.
        """
