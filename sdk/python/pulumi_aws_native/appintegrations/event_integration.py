...
class EventIntegrationArgs:
    def __init__(__self__, *,
                 event_bridge_bus: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] event_bridge_bus: The Amazon Eventbridge bus for the event integration.
        ...
        :param pulumi.Input[builtins.str] description: The event integration description.
        :param pulumi.Input[builtins.str] name: The name of the event integration.
    ...
    def event_bridge_bus(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_bridge_bus(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:appintegrations:EventIntegration")
class EventIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 event_bridge_bus: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The event integration description.
        :param pulumi.Input[builtins.str] event_bridge_bus: The Amazon Eventbridge bus for the event integration.
        :param pulumi.Input[Union['EventIntegrationEventFilterArgs', 'EventIntegrationEventFilterArgsDict']] event_filter: The EventFilter (source) associated with the event integration.
        :param pulumi.Input[builtins.str] name: The name of the event integration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: The tags (keys and values) associated with the event integration.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["eventBridgeBus", "eventFilter", "name"])
    ...
    @property
    @pulumi.getter(name="eventBridgeBus")
    def event_bridge_bus(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Eventbridge bus for the event integration.
        """
        return pulumi.get(self, "event_bridge_bus")
    ...
    def event_integration_arn(self) -> pulumi.Output[builtins.str]:
        """
