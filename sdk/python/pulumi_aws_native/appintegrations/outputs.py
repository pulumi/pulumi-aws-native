...
class ApplicationExternalUrlConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 approved_origins: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str access_url: The URL to access the application.
        :param Sequence[builtins.str] approved_origins: Additional URLs to allow list if different than the access URL.
        """
    ...
    def approved_origins(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DataIntegrationFileConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 filters: Optional[Mapping[str, Sequence[builtins.str]]] = None):
        """
        The configuration for what files should be pulled from the source.
        :param Sequence[builtins.str] folders: Identifiers for the source folders to pull all files from recursively.
        :param Mapping[str, Sequence[builtins.str]] filters: Restrictions for what files should be pulled from the source.
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Mapping[str, Sequence[builtins.str]]]:
        """
...
class DataIntegrationScheduleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str schedule_expression: How often the data should be pulled from data source.
        :param builtins.str first_execution_from: The start date for objects to import in the first flow run. Epoch or ISO timestamp format is supported.
        :param builtins.str object: The name of the object to pull from the data source.
        """
