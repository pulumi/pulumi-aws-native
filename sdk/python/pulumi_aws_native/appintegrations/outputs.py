...
class ApplicationExternalUrlConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 approved_origins: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str access_url: The URL to access the application.
        :param Sequence[_builtins.str] approved_origins: Additional URLs to allow list if different than the access URL.
        """
    ...
    def approved_origins(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ApplicationIframeConfig(dict):
    def __init__(__self__, *,
                 ...
                 sandbox: Optional[Sequence[_builtins.str]] = None):
    ...
    @_builtins.property
    @pulumi.getter
    def sandbox(self) -> Optional[Sequence[_builtins.str]]:
...
class DataIntegrationFileConfiguration(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Mapping[str, Sequence[_builtins.str]]]:
        """
...
class DataIntegrationScheduleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str schedule_expression: How often the data should be pulled from data source.
        :param _builtins.str first_execution_from: The start date for objects to import in the first flow run. Epoch or ISO timestamp format is supported.
        :param _builtins.str object: The name of the object to pull from the data source.
        """
