...
class GetDataIntegrationResult:
    ...
    def data_integration_arn(self) -> Optional[_builtins.str]:
        """
...
def get_data_integration(id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataIntegrationResult:
    """
    Resource Type definition for AWS::AppIntegrations::DataIntegration


    :param _builtins.str id: The unique identifer of the data integration.
    """
    __args__ = dict()
    __args__['id'] = id
