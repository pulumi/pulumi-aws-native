...
class Canary(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(artifact_config, CanaryArtifactConfigArgs):
            ...
            if not isinstance(code, CanaryCodeArgs):
                code = code or {}
                def _setter(key, value):
                    code[key] = value
            ...
            if not isinstance(run_config, CanaryRunConfigArgs):
            ...
            if not isinstance(schedule, CanaryScheduleArgs):
            ...
            if not isinstance(visual_reference, CanaryVisualReferenceArgs):
            ...
            if not isinstance(vpc_config, CanaryVpcConfigArgs):
