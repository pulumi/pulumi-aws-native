...
class CanaryArgs:
    def __init__(__self__, *,
                 ...
                 start_canary_after_creation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] start_canary_after_creation: Runs canary if set to True. Default is False
    ...
    def delete_lambda_resources_on_canary_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def start_canary_after_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def start_canary_after_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Canary(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deleteLambdaResourcesOnCanaryDeletion")
    def delete_lambda_resources_on_canary_deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deletes associated lambda resources created by Synthetics if set to True. Default is False
        """
        return pulumi.get(self, "delete_lambda_resources_on_canary_deletion")
    ...
    @property
    @pulumi.getter(name="startCanaryAfterCreation")
    def start_canary_after_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Runs canary if set to True. Default is False
        """
        return pulumi.get(self, "start_canary_after_creation")
