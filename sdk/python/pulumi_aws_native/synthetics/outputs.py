...
__all__ = [
    ...
    'CanaryDependency',
    'CanaryReplica',
    'CanaryReplicaReplicationStatus',
    'CanaryRetryConfig',
    'CanaryRunConfig',
    'CanaryS3Encryption',
    'CanarySchedule',
...
class CanaryBaseScreenshot(dict):
    ...
    def __init__(__self__, *,
                 screenshot_name: _builtins.str,
                 ignore_coordinates: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str screenshot_name: Name of the screenshot to be used as base reference for visual testing
        :param Sequence[_builtins.str] ignore_coordinates: List of coordinates of rectangles to be ignored during visual testing
        """
    ...
    def screenshot_name(self) -> _builtins.str:
        """
    ...
    def ignore_coordinates(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class CanaryCode(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def dependencies(self) -> Optional[Sequence['outputs.CanaryDependency']]:
        """
    ...
    def source_location_arn(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class CanaryDependency(dict):
    def __init__(__self__, *,
                 reference: _builtins.str,
                 type: Optional['CanaryDependencyType'] = None):
        """
        :param _builtins.str reference: ARN of the Lambda layer
        :param 'CanaryDependencyType' type: Type of dependency
        """
    ...
    @_builtins.property
    @pulumi.getter
    def type(self) -> Optional['CanaryDependencyType']:
        """
        Type of dependency
        """
...
class CanaryReplica(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "resourcesToReplicateTags":
            suggest = "resources_to_replicate_tags"
        elif key == "vpcConfig":
            suggest = "vpc_config"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CanaryReplica. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CanaryReplica.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 canary_state: Optional[_builtins.str] = None,
                 kms_key_arn: Optional[_builtins.str] = None,
                 last_modified: Optional[_builtins.float] = None,
                 replication_status: Optional['outputs.CanaryReplicaReplicationStatus'] = None,
                 resources_to_replicate_tags: Optional[Sequence['CanaryResourceToTag']] = None,
                 tags: Optional[Sequence['outputs.CanaryTag']] = None,
                 vpc_config: Optional['outputs.CanaryVpcConfig'] = None):
        """
        Configuration and status for a replica location in a multi-location canary

        :param _builtins.str location: AWS region for the replica (e.g., us-east-1)
        :param _builtins.str canary_state: State of the replica canary (CREATING, READY, RUNNING, etc.)
        :param _builtins.str kms_key_arn: ARN of the KMS key used to encrypt the replica canary's Lambda function environment variables
        :param _builtins.float last_modified: Last modified timestamp of the replica
        :param 'CanaryReplicaReplicationStatus' replication_status: Replication status for this replica
        :param Sequence['CanaryResourceToTag'] resources_to_replicate_tags: Resources to replicate tags to for this replica (e.g., lambda-function)
        :param Sequence['CanaryTag'] tags: Tags to apply to this replica canary and optionally its Lambda function
        :param 'CanaryVpcConfig' vpc_config: VPC configuration for this replica location
        """
    ...
    def canary_state(self) -> Optional[_builtins.str]:
        """
    ...
    def last_modified(self) -> Optional[_builtins.float]:
        """
    ...
    def replication_status(self) -> Optional['outputs.CanaryReplicaReplicationStatus']:
        """
    ...
    def resources_to_replicate_tags(self) -> Optional[Sequence['CanaryResourceToTag']]:
        """
...
@pulumi.output_type
class CanaryReplicaReplicationStatus(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str state: Replication state: InProgress, InSync, or Inconsistent
        """
...
class CanaryRetryConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_retries: maximum times the canary will be retried upon the scheduled run failure
        """
...
class CanaryRunConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool active_tracing: Enable active tracing if set to true
        :param Mapping[str, _builtins.str] environment_variables: Environment variable key-value pairs.
        :param _builtins.int ephemeral_storage: Provide ephemeralStorage available for canary in MB
        :param _builtins.int memory_in_mb: Provide maximum memory available for canary in MB
        :param _builtins.int timeout_in_seconds: Provide maximum canary timeout per run in seconds
        """
...
class CanaryS3Encryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_arn: Optional[_builtins.str] = None):
        """
        :param _builtins.str encryption_mode: Encryption mode for encrypting artifacts when uploading to S3. Valid values: SSE_S3 and SSE_KMS.
        :param _builtins.str kms_key_arn: KMS key Arn for encrypting artifacts when uploading to S3. You must specify KMS key Arn for SSE_KMS encryption mode only.
        """
...
class CanarySchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 duration_in_seconds: Optional[_builtins.str] = None,
                 retry_config: Optional['outputs.CanaryRetryConfig'] = None):
        """
        :param _builtins.str expression: A `rate` expression or a `cron` expression that defines how often the canary is to run.
        ...
        :param _builtins.str duration_in_seconds: How long, in seconds, for the canary to continue making regular runs according to the schedule in the `Expression` value. If you specify 0, the canary continues making runs until you stop it. If you omit this field, the default of 0 is used.
    ...
    def duration_in_seconds(self) -> Optional[_builtins.str]:
        """
...
class CanaryTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str value: The value for the tag. You can specify a value that is 1 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
        """
...
class CanaryVisualReference(dict):
    ...
    def __init__(__self__, *,
                 base_canary_run_id: _builtins.str,
    ...
    def base_canary_run_id(self) -> _builtins.str:
        """
...
class CanaryVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] security_group_ids: The IDs of the security groups for this canary.
        :param Sequence[_builtins.str] subnet_ids: The IDs of the subnets where this canary is to run.
        :param _builtins.bool ipv6_allowed_for_dual_stack: Allow outbound IPv6 traffic on VPC canaries that are connected to dual-stack subnets if set to true
        :param _builtins.str vpc_id: The ID of the VPC where this canary is to run.
        """
