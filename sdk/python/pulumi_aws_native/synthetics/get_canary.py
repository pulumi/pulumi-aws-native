...
class GetCanaryResult:
    ...
    def artifact_s3_location(self) -> Optional[builtins.str]:
        """
    ...
    def failure_retention_period(self) -> Optional[builtins.int]:
        """
    ...
    def success_retention_period(self) -> Optional[builtins.int]:
        """
...
def get_canary(name: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCanaryResult:
    """
    Resource Type definition for AWS::Synthetics::Canary


    :param builtins.str name: Name of the canary.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_canary_output(name: Optional[pulumi.Input[builtins.str]] = None,
