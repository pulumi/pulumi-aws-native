...
class CanaryArtifactConfigArgsDict(TypedDict):
    s3_encryption: NotRequired[pulumi.Input[Optional['CanaryS3EncryptionArgs']]]
    """
...
class CanaryCodeArgsDict(TypedDict):
    ...
    """
    dependencies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CanaryDependencyArgs']]]]]
    """
...
class CanaryScheduleArgsDict(TypedDict):
    ...
    """
    retry_config: NotRequired[pulumi.Input[Optional['CanaryRetryConfigArgs']]]
    """
...
class CanaryVisualReferenceArgsDict(TypedDict):
    ...
    """
    base_screenshots: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CanaryBaseScreenshotArgs']]]]]
    """
