...
if not MYPY:
    class CanaryBaseScreenshotArgsDict(TypedDict):
        screenshot_name: pulumi.Input[builtins.str]
        """
        Name of the screenshot to be used as base reference for visual testing
        """
        ignore_coordinates: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CanaryBaseScreenshotArgs:
    def __init__(__self__, *,
                 screenshot_name: pulumi.Input[builtins.str],
                 ignore_coordinates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] screenshot_name: Name of the screenshot to be used as base reference for visual testing
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignore_coordinates: List of coordinates of rectangles to be ignored during visual testing
        """
    ...
    def screenshot_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the screenshot to be used as base reference for visual testing
        """
    ...
    def screenshot_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "screenshot_name", value)

    @property
    @pulumi.getter(name="ignoreCoordinates")
    def ignore_coordinates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of coordinates of rectangles to be ignored during visual testing
        """
...
if not MYPY:
    class CanaryCodeArgsDict(TypedDict):
        ...
        """
        source_location_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CanaryS3EncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] encryption_mode: Encryption mode for encrypting artifacts when uploading to S3. Valid values: SSE_S3 and SSE_KMS.
        :param pulumi.Input[builtins.str] kms_key_arn: KMS key Arn for encrypting artifacts when uploading to S3. You must specify KMS key Arn for SSE_KMS encryption mode only.
        """
...
if not MYPY:
    class CanaryScheduleArgsDict(TypedDict):
        ...
        """
        duration_in_seconds: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CanaryScheduleArgs:
    ...
    def duration_in_seconds(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How long, in seconds, for the canary to continue making regular runs according to the schedule in the `Expression` value. If you specify 0, the canary continues making runs until you stop it. If you omit this field, the default of 0 is used.
        """
...
class CanaryVisualReferenceArgs:
    ...
    def base_canary_run_id(self) -> pulumi.Input[builtins.str]:
        """
        Canary run id to be used as base reference for visual testing
        """
    ...
    def base_canary_run_id(self, value: pulumi.Input[builtins.str]):
...
class CanaryVpcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The IDs of the security groups for this canary.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The IDs of the subnets where this canary is to run.
        :param pulumi.Input[builtins.bool] ipv6_allowed_for_dual_stack: Allow outbound IPv6 traffic on VPC canaries that are connected to dual-stack subnets if set to true
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC where this canary is to run.
        """
