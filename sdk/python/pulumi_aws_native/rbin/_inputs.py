...
if not MYPY:
    class RuleResourceTagArgsDict(TypedDict):
        ...
        """
        resource_tag_value: pulumi.Input[builtins.str]
        """
...
class RuleResourceTagArgs:
    def __init__(__self__, *,
        ...
        """
        The resource tag of the rule.
        :param pulumi.Input[builtins.str] resource_tag_key: The tag key of the resource.
        :param pulumi.Input[builtins.str] resource_tag_value: The tag value of the resource
        """
    ...
    def resource_tag_value(self) -> pulumi.Input[builtins.str]:
        """
        The tag value of the resource
        """
    ...
    def resource_tag_value(self, value: pulumi.Input[builtins.str]):
...
class RuleRetentionPeriodArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] retention_period_value: The retention period value of the rule.
        """
...
if not MYPY:
    class RuleUnlockDelayArgsDict(TypedDict):
        ...
        """
        unlock_delay_value: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RuleUnlockDelayArgs:
    def __init__(__self__, *,
                 ...
                 unlock_delay_value: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    def unlock_delay_value(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The unlock delay period, measured in the unit specified for UnlockDelayUnit.
        """
    ...
    def unlock_delay_value(self, value: Optional[pulumi.Input[builtins.int]]):
