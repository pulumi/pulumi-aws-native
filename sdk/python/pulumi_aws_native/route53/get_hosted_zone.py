...
def get_hosted_zone(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID that Amazon Route 53 assigned to the hosted zone when you created it.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_hosted_zone_output(id: Optional[pulumi.Input[builtins.str]] = None,
