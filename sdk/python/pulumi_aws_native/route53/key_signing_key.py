...
class KeySigningKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hosted_zone_id: The unique string (ID) used to identify a hosted zone.
        :param pulumi.Input[builtins.str] key_management_service_arn: The Amazon resource name (ARN) for a customer managed key (CMK) in AWS Key Management Service (KMS). The KeyManagementServiceArn must be unique for each key signing key (KSK) in a single hosted zone.
        ...
        :param pulumi.Input[builtins.str] name: An alphanumeric string used to identify a key signing key (KSK). Name must be unique for each key signing key in the same hosted zone.
        """
...
class KeySigningKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["hostedZoneId", "keyManagementServiceArn", "name"])
