...
class KeySigningKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: An alphanumeric string used to identify a key signing key (KSK). Name must be unique for each key signing key in the same hosted zone.
        """
