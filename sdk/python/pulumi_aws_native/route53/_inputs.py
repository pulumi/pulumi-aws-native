...
if not MYPY:
    class CidrCollectionLocationArgsDict(TypedDict):
        cidr_list: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class CidrCollectionLocationArgs:
    def __init__(__self__, *,
                 ...
                 location_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidr_list: A list of CIDR blocks.
        :param pulumi.Input[builtins.str] location_name: The name of the location that is associated with the CIDR collection.
        """
    ...
    def cidr_list(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of CIDR blocks.
        """
    ...
    @cidr_list.setter
    def cidr_list(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class HealthCheckAlarmIdentifierArgs:
    def __init__(__self__, *,
        ...
        """
        A complex type that identifies the CloudWatch alarm that you want Amazon Route 53 health checkers to use to determine whether the specified health check is healthy.
        :param pulumi.Input[builtins.str] name: The name of the CloudWatch alarm that you want Amazon Route 53 health checkers to use to determine whether this health check is healthy.
        :param pulumi.Input[builtins.str] region: For the CloudWatch alarm that you want Route 53 health checkers to use to determine whether this health check is healthy, the region that the alarm was created in.
        """
...
if not MYPY:
    class HealthCheckConfigPropertiesArgsDict(TypedDict):
        ...
        A complex type that identifies the CloudWatch alarm that you want Amazon Route 53 health checkers to use to determine whether the specified health check is healthy.
        """
        child_health_checks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        (CALCULATED Health Checks Only) A complex type that contains one `ChildHealthCheck` element for each health check that you want to associate with a `CALCULATED` health check.
        """
        enable_sni: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        *If you don't specify a value for `IPAddress`* :
        ...
        """
        health_threshold: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        inverted: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        measure_latency: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        request_interval: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        routing_control_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        search_string: NotRequired[pulumi.Input[builtins.str]]
        """
...
class HealthCheckConfigPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 child_health_checks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] child_health_checks: (CALCULATED Health Checks Only) A complex type that contains one `ChildHealthCheck` element for each health check that you want to associate with a `CALCULATED` health check.
        :param pulumi.Input[builtins.bool] enable_sni: Specify whether you want Amazon Route 53 to send the value of `FullyQualifiedDomainName` to the endpoint in the `client_hello` message during TLS negotiation. This allows the endpoint to respond to `HTTPS` health check requests with the applicable SSL/TLS certificate.
               
               Some endpoints require that `HTTPS` requests include the host name in the `client_hello` message. If you don't enable SNI, the status of the health check will be `SSL alert handshake_failure` . A health check can also have that status for other reasons. If SNI is enabled and you're still getting the error, check the SSL/TLS configuration on your endpoint and confirm that your certificate is valid.
               
               The SSL/TLS certificate on your endpoint includes a domain name in the `Common Name` field and possibly several more in the `Subject Alternative Names` field. One of the domain names in the certificate should match the value that you specify for `FullyQualifiedDomainName` . If the endpoint responds to the `client_hello` message with a certificate that does not include the domain name that you specified in `FullyQualifiedDomainName` , a health checker will retry the handshake. In the second attempt, the health checker will omit `FullyQualifiedDomainName` from the `client_hello` message.
        :param pulumi.Input[builtins.int] failure_threshold: The number of consecutive health checks that an endpoint must pass or fail for Amazon Route 53 to change the current status of the endpoint from unhealthy to healthy or vice versa. For more information, see [How Amazon Route 53 Determines Whether an Endpoint Is Healthy](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html) in the *Amazon Route 53 Developer Guide* .
               
               If you don't specify a value for `FailureThreshold` , the default value is three health checks.
        :param pulumi.Input[builtins.str] fully_qualified_domain_name: Amazon Route 53 behavior depends on whether you specify a value for `IPAddress` .
               ...
               *If you don't specify a value for `IPAddress`* :
               ...
               In addition, if the value that you specify for `Type` is `HTTP` , `HTTPS` , `HTTP_STR_MATCH` , or `HTTPS_STR_MATCH` , Route 53 passes the value of `FullyQualifiedDomainName` in the `Host` header, as it does when you specify a value for `IPAddress` . If the value of `Type` is `TCP` , Route 53 doesn't pass a `Host` header.
        :param pulumi.Input[builtins.int] health_threshold: The number of child health checks that are associated with a `CALCULATED` health check that Amazon Route 53 must consider healthy for the `CALCULATED` health check to be considered healthy. To specify the child health checks that you want to associate with a `CALCULATED` health check, use the [ChildHealthChecks](https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-ChildHealthChecks) element.
        ...
        :param pulumi.Input['HealthCheckConfigPropertiesInsufficientDataHealthStatus'] insufficient_data_health_status: When CloudWatch has insufficient data about the metric to determine the alarm state, the status that you want Amazon Route 53 to assign to the health check:
               ...
               - `Unhealthy` : Route 53 considers the health check to be unhealthy.
               - `LastKnownStatus` : Route 53 uses the status of the health check from the last time that CloudWatch had sufficient data to determine the alarm state. For new health checks that have no last known status, the default status for the health check is healthy.
        :param pulumi.Input[builtins.bool] inverted: Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.
        :param pulumi.Input[builtins.str] ip_address: The IPv4 or IPv6 IP address of the endpoint that you want Amazon Route 53 to perform health checks on. If you don't specify a value for `IPAddress` , Route 53 sends a DNS request to resolve the domain name that you specify in `FullyQualifiedDomainName` at the interval that you specify in `RequestInterval` . Using an IP address returned by DNS, Route 53 then checks the health of the endpoint.
               ...
               When the value of `Type` is `CALCULATED` or `CLOUDWATCH_METRIC` , omit `IPAddress` .
        :param pulumi.Input[builtins.bool] measure_latency: Specify whether you want Amazon Route 53 to measure the latency between health checkers in multiple AWS regions and your endpoint, and to display CloudWatch latency graphs on the *Health Checks* page in the Route 53 console.
               
               > You can't change the value of `MeasureLatency` after you create a health check.
        :param pulumi.Input[builtins.int] port: The port on the endpoint that you want Amazon Route 53 to perform health checks on.
               
               > Don't specify a value for `Port` when you specify a value for [Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-healthcheck-healthcheckconfig.html#cfn-route53-healthcheck-healthcheckconfig-type) of `CLOUDWATCH_METRIC` or `CALCULATED` .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: A complex type that contains one `Region` element for each region from which you want Amazon Route 53 health checkers to check the specified endpoint.
               
               If you don't specify any regions, Route 53 health checkers automatically performs checks from all of the regions that are listed under *Valid Values* .
               
               If you update a health check to remove a region that has been performing health checks, Route 53 will briefly continue to perform checks from that region to ensure that some health checkers are always checking the endpoint (for example, if you replace three regions with four different regions).
        :param pulumi.Input[builtins.int] request_interval: The number of seconds between the time that Amazon Route 53 gets a response from your endpoint and the time that it sends the next health check request. Each Route 53 health checker makes requests at this interval.
               
               > You can't change the value of `RequestInterval` after you create a health check. 
               
               If you don't specify a value for `RequestInterval` , the default value is `30` seconds.
        :param pulumi.Input[builtins.str] resource_path: The path, if any, that you want Amazon Route 53 to request when performing health checks. The path can be any value for which your endpoint will return an HTTP status code of 2xx or 3xx when the endpoint is healthy, for example, the file /docs/route53-health-check.html. You can also include query string parameters, for example, `/welcome.html?language=jp&login=y` .
        :param pulumi.Input[builtins.str] routing_control_arn: The Amazon Resource Name (ARN) for the Route 53 Application Recovery Controller routing control.
               
               For more information about Route 53 Application Recovery Controller, see [Route 53 Application Recovery Controller Developer Guide.](https://docs.aws.amazon.com/r53recovery/latest/dg/what-is-route-53-recovery.html) .
        :param pulumi.Input[builtins.str] search_string: If the value of Type is `HTTP_STR_MATCH` or `HTTPS_STR_MATCH` , the string that you want Amazon Route 53 to search for in the response body from the specified resource. If the string appears in the response body, Route 53 considers the resource healthy.
    ...
    def child_health_checks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (CALCULATED Health Checks Only) A complex type that contains one `ChildHealthCheck` element for each health check that you want to associate with a `CALCULATED` health check.
        """
    ...
    def child_health_checks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def health_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of child health checks that are associated with a `CALCULATED` health check that Amazon Route 53 must consider healthy for the `CALCULATED` health check to be considered healthy. To specify the child health checks that you want to associate with a `CALCULATED` health check, use the [ChildHealthChecks](https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-ChildHealthChecks) element.
    ...
    def health_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def inverted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.
        """
    ...
    @inverted.setter
    def inverted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HostedZoneConfigArgs:
    def __init__(__self__, *,
        ...
        """
        A complex type that contains an optional comment about your hosted zone. If you don't want to specify a comment, omit both the ``HostedZoneConfig`` and ``Comment`` elements.
        :param pulumi.Input[builtins.str] comment: Any comments that you want to include about the hosted zone.
        """
...
if not MYPY:
    class HostedZoneQueryLoggingConfigArgsDict(TypedDict):
        ...
        """
        cloud_watch_logs_log_group_arn: pulumi.Input[builtins.str]
        """
...
class HostedZoneQueryLoggingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        A complex type that contains information about a configuration for DNS query logging.
        :param pulumi.Input[builtins.str] cloud_watch_logs_log_group_arn: The Amazon Resource Name (ARN) of the CloudWatch Logs log group that Amazon Route 53 is publishing logs to.
        """
    ...
    def cloud_watch_logs_log_group_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the CloudWatch Logs log group that Amazon Route 53 is publishing logs to.
        """
    ...
    def cloud_watch_logs_log_group_arn(self, value: pulumi.Input[builtins.str]):
...
class HostedZoneVpcArgs:
    def __init__(__self__, *,
        ...
        *Private hosted zones only:* A complex type that contains information about an Amazon VPC. Route 53 Resolver uses the records in the private hosted zone to route traffic in that VPC. 
          For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.
        :param pulumi.Input[builtins.str] vpc_id: *Private hosted zones only:* The ID of an Amazon VPC.
                 For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.
        :param pulumi.Input[builtins.str] vpc_region: *Private hosted zones only:* The region that an Amazon VPC was created in.
                 For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.
        """
