...
def get_cidr_collection(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: UUID of the CIDR collection.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_cidr_collection_output(id: Optional[pulumi.Input[builtins.str]] = None,
