...
class CidrCollectionLocation(dict):
    ...
    def __init__(__self__, *,
                 cidr_list: Sequence[_builtins.str],
                 location_name: _builtins.str):
        """
        :param Sequence[_builtins.str] cidr_list: A list of CIDR blocks.
        :param _builtins.str location_name: The name of the location that is associated with the CIDR collection.
        """
    ...
    def cidr_list(self) -> Sequence[_builtins.str]:
        """
...
class HealthCheckAlarmIdentifier(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the CloudWatch alarm that you want Amazon Route 53 health checkers to use to determine whether this health check is healthy.
        :param _builtins.str region: For the CloudWatch alarm that you want Route 53 health checkers to use to determine whether this health check is healthy, the region that the alarm was created in.
        """
...
class HealthCheckConfigProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 child_health_checks: Optional[Sequence[_builtins.str]] = None,
                 enable_sni: Optional[_builtins.bool] = None,
                 failure_threshold: Optional[_builtins.int] = None,
                 fully_qualified_domain_name: Optional[_builtins.str] = None,
                 health_threshold: Optional[_builtins.int] = None,
                 insufficient_data_health_status: Optional['HealthCheckConfigPropertiesInsufficientDataHealthStatus'] = None,
                 inverted: Optional[_builtins.bool] = None,
                 ip_address: Optional[_builtins.str] = None,
                 measure_latency: Optional[_builtins.bool] = None,
                 port: Optional[_builtins.int] = None,
                 regions: Optional[Sequence[_builtins.str]] = None,
                 request_interval: Optional[_builtins.int] = None,
                 resource_path: Optional[_builtins.str] = None,
                 routing_control_arn: Optional[_builtins.str] = None,
        ...
        :param Sequence[_builtins.str] child_health_checks: (CALCULATED Health Checks Only) A complex type that contains one `ChildHealthCheck` element for each health check that you want to associate with a `CALCULATED` health check.
        :param _builtins.bool enable_sni: Specify whether you want Amazon Route 53 to send the value of `FullyQualifiedDomainName` to the endpoint in the `client_hello` message during TLS negotiation. This allows the endpoint to respond to `HTTPS` health check requests with the applicable SSL/TLS certificate.
        ...
        :param _builtins.bool inverted: Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.
        :param _builtins.str ip_address: The IPv4 or IPv6 IP address of the endpoint that you want Amazon Route 53 to perform health checks on. If you don't specify a value for `IPAddress` , Route 53 sends a DNS request to resolve the domain name that you specify in `FullyQualifiedDomainName` at the interval that you specify in `RequestInterval` . Using an IP address returned by DNS, Route 53 then checks the health of the endpoint.
        ...
        :param Sequence[_builtins.str] regions: A complex type that contains one `Region` element for each region from which you want Amazon Route 53 health checkers to check the specified endpoint.
        ...
        :param _builtins.str routing_control_arn: The Amazon Resource Name (ARN) for the Route 53 Application Recovery Controller routing control.
        ...
        :param _builtins.str search_string: If the value of Type is `HTTP_STR_MATCH` or `HTTPS_STR_MATCH` , the string that you want Amazon Route 53 to search for in the response body from the specified resource. If the string appears in the response body, Route 53 considers the resource healthy.
    ...
    def child_health_checks(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def enable_sni(self) -> Optional[_builtins.bool]:
        """
    ...
    def health_threshold(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def inverted(self) -> Optional[_builtins.bool]:
        """
    ...
    def measure_latency(self) -> Optional[_builtins.bool]:
        """
...
class HostedZoneQueryLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 cloud_watch_logs_log_group_arn: _builtins.str):
        """
        A complex type that contains information about a configuration for DNS query logging.
    ...
    def cloud_watch_logs_log_group_arn(self) -> _builtins.str:
        """
    ...
    def __init__(__self__, *,
        ...
        *Private hosted zones only:* A complex type that contains information about an Amazon VPC. Route 53 Resolver uses the records in the private hosted zone to route traffic in that VPC.
        ...
        :param _builtins.str vpc_id: *Private hosted zones only:* The ID of an Amazon VPC.
                 For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.
        :param _builtins.str vpc_region: *Private hosted zones only:* The region that an Amazon VPC was created in.
                 For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.
        """
...
class RecordSetAliasTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dns_name: The value that you specify depends on where you want to route queries.
        :param _builtins.str hosted_zone_id: The value used depends on where you want to route traffic.
        :param _builtins.bool evaluate_target_health: When EvaluateTargetHealth is true, an alias resource record set inherits the health of the referenced AWS resource, such as an ELB load balancer or another resource record set in the hosted zone.
        """
...
class RecordSetGeoLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str continent_code: For geolocation resource record sets, a two-letter abbreviation that identifies a continent.
        :param _builtins.str country_code: For geolocation resource record sets, the two-letter code for a country.
        :param _builtins.str subdivision_code: For geolocation resource record sets, the two-letter code for a state of the United States.
        """
