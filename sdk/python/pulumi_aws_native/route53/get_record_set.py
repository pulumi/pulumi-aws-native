...
def get_record_set(hosted_zone_id: Optional[str] = None,
    ...
    :param str hosted_zone_id: The ID of the hosted zone that you want to create records in.
    :param str name: The name of the record that you want to create, update, or delete.
...
def get_record_set_output(hosted_zone_id: Optional[pulumi.Input[str]] = None,
