...
class GetRecordSetResult:
    def __init__(__self__, alias_target=None, cidr_routing_config=None, failover=None, geo_location=None, health_check_id=None, multi_value_answer=None, name=None, region=None, resource_records=None, set_identifier=None, ttl=None, type=None, weight=None):
    ...
    @_builtins.property
    @pulumi.getter
    def failover(self) -> Optional['RecordSetFailover']:
        """
    ...
    def resource_records(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_record_set(hosted_zone_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hosted_zone_id: The ID of the hosted zone that you want to create records in.
    :param _builtins.str name: The name of the record that you want to create, update, or delete.
    ...
    __args__['name'] = name
    __args__['setIdentifier'] = set_identifier
    __args__['type'] = type
...
def get_record_set_output(hosted_zone_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:route53:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
    return __ret__.apply(lambda __response__: GetRecordSetResult(
        alias_target=pulumi.get(__response__, 'alias_target'),
        cidr_routing_config=pulumi.get(__response__, 'cidr_routing_config'),
        failover=pulumi.get(__response__, 'failover'),
        geo_location=pulumi.get(__response__, 'geo_location'),
        health_check_id=pulumi.get(__response__, 'health_check_id'),
        multi_value_answer=pulumi.get(__response__, 'multi_value_answer'),
        name=pulumi.get(__response__, 'name'),
        region=pulumi.get(__response__, 'region'),
        resource_records=pulumi.get(__response__, 'resource_records'),
        set_identifier=pulumi.get(__response__, 'set_identifier'),
