...
class RecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(alias_target, RecordSetAliasTargetArgs):
            ...
            if not isinstance(cidr_routing_config, RecordSetCidrRoutingConfigArgs):
            ...
            if not isinstance(geo_location, RecordSetGeoLocationArgs):
