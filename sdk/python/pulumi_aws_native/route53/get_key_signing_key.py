...
def get_key_signing_key(hosted_zone_id: Optional[builtins.str] = None,
    ...
    :param builtins.str hosted_zone_id: The unique string (ID) used to identify a hosted zone.
    :param builtins.str name: An alphanumeric string used to identify a key signing key (KSK). Name must be unique for each key signing key in the same hosted zone.
    """
    __args__ = dict()
...
def get_key_signing_key_output(hosted_zone_id: Optional[pulumi.Input[builtins.str]] = None,
