...
def get_health_check(health_check_id: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthCheckResult:
    """
    Resource schema for AWS::Route53::HealthCheck.


    :param builtins.str health_check_id: The identifier that Amazon Route 53 assigned to the health check when you created it. When you add or update a resource record set, you use this value to specify which health check to use. The value can be up to 64 characters long.
    """
    __args__ = dict()
...
def get_health_check_output(health_check_id: Optional[pulumi.Input[builtins.str]] = None,
