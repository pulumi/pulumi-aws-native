...
warnings.warn("""RecordSetGroup is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class RecordSetGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 record_sets: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RecordSetGroupRecordSetArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""RecordSetGroup is deprecated: RecordSetGroup is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
