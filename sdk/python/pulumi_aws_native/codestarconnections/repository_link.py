...
class RepositoryLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_arn: The Amazon Resource Name (ARN) of the CodeStarConnection. The ARN is used as the connection reference when the connection is shared between AWS services.
        :param pulumi.Input[builtins.str] owner_id: the ID of the entity that owns the repository.
        :param pulumi.Input[builtins.str] repository_name: The repository for which the link is being created.
        :param pulumi.Input[builtins.str] encryption_key_arn: The ARN of the KMS key that the customer can optionally specify to use to encrypt RepositoryLink properties. If not specified, a default key will be used.
...
class RepositoryLink(pulumi.CustomResource):
    ...
    def repository_link_arn(self) -> pulumi.Output[builtins.str]:
        """
