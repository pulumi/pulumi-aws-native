...
def get_sync_configuration(resource_name: Optional[builtins.str] = None,
                           sync_type: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_name: The name of the resource that is being synchronized to the repository.
    :param builtins.str sync_type: The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
    """
    __args__ = dict()
...
def get_sync_configuration_output(resource_name: Optional[pulumi.Input[builtins.str]] = None,
