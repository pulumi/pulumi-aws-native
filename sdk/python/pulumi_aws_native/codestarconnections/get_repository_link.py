...
class GetRepositoryLinkResult:
    ...
    def repository_link_arn(self) -> Optional[builtins.str]:
        """
    ...
    def repository_link_id(self) -> Optional[builtins.str]:
        """
...
def get_repository_link(repository_link_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str repository_link_arn: A unique Amazon Resource Name (ARN) to designate the repository link.
    """
    __args__ = dict()
...
def get_repository_link_output(repository_link_arn: Optional[pulumi.Input[builtins.str]] = None,
