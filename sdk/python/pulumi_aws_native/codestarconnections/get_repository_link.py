...
class GetRepositoryLinkResult:
    ...
    def repository_link_arn(self) -> Optional[_builtins.str]:
        """
...
def get_repository_link(repository_link_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str repository_link_arn: A unique Amazon Resource Name (ARN) to designate the repository link.
    """
    __args__ = dict()
