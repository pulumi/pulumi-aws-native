...
class SyncConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 config_file: pulumi.Input[builtins.str],
                 repository_link_id: pulumi.Input[builtins.str],
                 resource_name: pulumi.Input[builtins.str],
                 role_arn: pulumi.Input[builtins.str],
                 sync_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] branch: The name of the branch of the repository from which resources are to be synchronized,
        :param pulumi.Input[builtins.str] config_file: The source provider repository path of the sync configuration file of the respective SyncType.
        :param pulumi.Input[builtins.str] repository_link_id: A UUID that uniquely identifies the RepositoryLink that the SyncConfig is associated with.
        :param pulumi.Input[builtins.str] resource_name: The name of the resource that is being synchronized to the repository.
        :param pulumi.Input[builtins.str] role_arn: The IAM Role that allows AWS to update CloudFormation stacks based on content in the specified repository.
        :param pulumi.Input[builtins.str] sync_type: The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
    ...
    def config_file(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @config_file.setter
    def config_file(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "config_file", value)

    @property
    @pulumi.getter(name="repositoryLinkId")
    def repository_link_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def repository_link_id(self, value: pulumi.Input[builtins.str]):
    ...
    def sync_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sync_type.setter
    def sync_type(self, value: pulumi.Input[builtins.str]):
...
class SyncConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 publish_deployment_status: Optional[pulumi.Input['SyncConfigurationPublishDeploymentStatus']] = None,
                 repository_link_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_name_: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 sync_type: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_resource_update_on: Optional[pulumi.Input['SyncConfigurationTriggerResourceUpdateOn']] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input['SyncConfigurationPublishDeploymentStatus'] publish_deployment_status: Whether to enable or disable publishing of deployment status to source providers.
        :param pulumi.Input[builtins.str] repository_link_id: A UUID that uniquely identifies the RepositoryLink that the SyncConfig is associated with.
        :param pulumi.Input[builtins.str] resource_name_: The name of the resource that is being synchronized to the repository.
        :param pulumi.Input[builtins.str] role_arn: The IAM Role that allows AWS to update CloudFormation stacks based on content in the specified repository.
        :param pulumi.Input[builtins.str] sync_type: The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
        :param pulumi.Input['SyncConfigurationTriggerResourceUpdateOn'] trigger_resource_update_on: When to trigger Git sync to begin the stack update.
        """
    ...
    @property
    @pulumi.getter(name="configFile")
    def config_file(self) -> pulumi.Output[builtins.str]:
        """
        The source provider repository path of the sync configuration file of the respective SyncType.
        """
        return pulumi.get(self, "config_file")
    ...
    @property
    @pulumi.getter(name="repositoryLinkId")
    def repository_link_id(self) -> pulumi.Output[builtins.str]:
        """
        A UUID that uniquely identifies the RepositoryLink that the SyncConfig is associated with.
        """
        return pulumi.get(self, "repository_link_id")
    ...
    @property
    @pulumi.getter(name="syncType")
    def sync_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
        """
        return pulumi.get(self, "sync_type")
