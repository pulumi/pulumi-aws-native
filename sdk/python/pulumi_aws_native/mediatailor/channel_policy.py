...
class ChannelPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] channel_name: The name of the channel associated with this Channel Policy.
...
@pulumi.type_token("aws-native:mediatailor:ChannelPolicy")
