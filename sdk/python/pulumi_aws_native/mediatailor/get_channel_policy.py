...
def get_channel_policy(channel_name: Optional[builtins.str] = None,
    ...
    :param builtins.str channel_name: The name of the channel associated with this Channel Policy.
    """
    __args__ = dict()
...
def get_channel_policy_output(channel_name: Optional[pulumi.Input[builtins.str]] = None,
