...
class ChannelRequestOutputItemArgsDict(TypedDict):
    ...
    """
    dash_playlist_settings: NotRequired[pulumi.Input[Optional['ChannelDashPlaylistSettingsArgs']]]
    """
    DASH manifest configuration parameters.
    """
    hls_playlist_settings: NotRequired[pulumi.Input[Optional['ChannelHlsPlaylistSettingsArgs']]]
    """
...
class PlaybackConfigurationLogConfigurationArgsDict(TypedDict):
    ...
    """
    ads_interaction_log: NotRequired[pulumi.Input[Optional['PlaybackConfigurationAdsInteractionLogArgs']]]
    """
    ...
    """
    manifest_service_interaction_log: NotRequired[pulumi.Input[Optional['PlaybackConfigurationManifestServiceInteractionLogArgs']]]
    """
...
class PlaybackConfigurationManifestProcessingRulesArgsDict(TypedDict):
    ...
    """
    ad_marker_passthrough: NotRequired[pulumi.Input[Optional['PlaybackConfigurationAdMarkerPassthroughArgs']]]
    """
    For HLS, when set to true, MediaTailor passes through EXT-X-CUE-IN, EXT-X-CUE-OUT, and EXT-X-SPLICEPOINT-SCTE35 ad markers from the origin manifest to the MediaTailor personalized manifest. No logic is applied to these ad markers. For example, if EXT-X-CUE-OUT has a value of 60, but no ads are filled for that ad break, MediaTailor will not set the value to 0.
    """
...
class SourceLocationAccessConfigurationArgsDict(TypedDict):
    ...
    """
    secrets_manager_access_token_configuration: NotRequired[pulumi.Input[Optional['SourceLocationSecretsManagerAccessTokenConfigurationArgs']]]
    """
