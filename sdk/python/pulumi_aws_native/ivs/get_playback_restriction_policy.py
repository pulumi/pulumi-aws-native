...
class GetPlaybackRestrictionPolicyResult:
    ...
    def allowed_countries(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enable_strict_origin_enforcement(self) -> Optional[builtins.bool]:
        """
...
def get_playback_restriction_policy(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Playback-restriction-policy identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_playback_restriction_policy_output(arn: Optional[pulumi.Input[builtins.str]] = None,
