...
class RecordingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(destination_configuration, RecordingConfigurationDestinationConfigurationArgs):
            ...
            if not isinstance(rendition_configuration, RecordingConfigurationRenditionConfigurationArgs):
            ...
            if not isinstance(thumbnail_configuration, RecordingConfigurationThumbnailConfigurationArgs):
