...
class PlaybackRestrictionPolicyArgs:
    def __init__(__self__, *,
                 allowed_countries: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 allowed_origins: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 enable_strict_origin_enforcement: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Playback-restriction-policy name.
    ...
    def allowed_countries(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def allowed_countries(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def enable_strict_origin_enforcement(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_strict_origin_enforcement(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class PlaybackRestrictionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allowed_countries: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="allowedCountries")
    def allowed_countries(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of country codes that control geoblocking restriction. Allowed values are the officially assigned ISO 3166-1 alpha-2 codes. Default: All countries (an empty array).
        """
        return pulumi.get(self, "allowed_countries")
    ...
    @_builtins.property
    @pulumi.getter(name="enableStrictOriginEnforcement")
    def enable_strict_origin_enforcement(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether channel playback is constrained by origin site.
        """
        return pulumi.get(self, "enable_strict_origin_enforcement")
