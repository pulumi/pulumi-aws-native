...
class PlaybackRestrictionPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_countries: A list of country codes that control geoblocking restriction. Allowed values are the officially assigned ISO 3166-1 alpha-2 codes. Default: All countries (an empty array).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: A list of origin sites that control CORS restriction. Allowed values are the same as valid values of the Origin header defined at https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Origin
        :param pulumi.Input[builtins.bool] enable_strict_origin_enforcement: Whether channel playback is constrained by origin site.
    ...
    def enable_strict_origin_enforcement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_strict_origin_enforcement(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("aws-native:ivs:PlaybackRestrictionPolicy")
class PlaybackRestrictionPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableStrictOriginEnforcement")
    def enable_strict_origin_enforcement(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether channel playback is constrained by origin site.
        """
        return pulumi.get(self, "enable_strict_origin_enforcement")
