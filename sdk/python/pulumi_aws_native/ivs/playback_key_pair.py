...
class PlaybackKeyPair(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PlaybackKeyPairPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PlaybackKeyPairPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PlaybackKeyPairAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PlaybackKeyPairProperties']:
        """
