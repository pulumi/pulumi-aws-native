...
class PlaybackKeyPairArgs:
    def __init__(__self__, *,
                 ...
                 public_key_material: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a PlaybackKeyPair resource.
        :param pulumi.Input[builtins.str] name: An arbitrary string (a nickname) assigned to a playback key pair that helps the customer identify that resource. The value does not need to be unique.
        :param pulumi.Input[builtins.str] public_key_material: The public portion of a customer-generated key pair. This field is required to create the AWS::IVS::PlaybackKeyPair resource.
    ...
    def public_key_material(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_material(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PlaybackKeyPair(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="publicKeyMaterial")
    def public_key_material(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The public portion of a customer-generated key pair. This field is required to create the AWS::IVS::PlaybackKeyPair resource.
        """
        return pulumi.get(self, "public_key_material")
