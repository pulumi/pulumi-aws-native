...
class RecordingConfigurationDestinationConfigurationArgsDict(TypedDict):
    ...
    """
    s3: NotRequired[pulumi.Input[Optional['RecordingConfigurationS3DestinationConfigurationArgs']]]
    """
...
class StageAutoParticipantRecordingConfigurationArgsDict(TypedDict):
    ...
    """
    hls_configuration: NotRequired[pulumi.Input[Optional['StageHlsConfigurationArgs']]]
    """
    ...
    """
    thumbnail_configuration: NotRequired[pulumi.Input[Optional['StageThumbnailConfigurationArgs']]]
    """
...
class StageHlsConfigurationArgsDict(TypedDict):
    ...
    HLS configuration object for individual participant recording.
    """
    participant_recording_hls_configuration: NotRequired[pulumi.Input[Optional['StageParticipantRecordingHlsConfigurationArgs']]]
    """
...
class StageThumbnailConfigurationArgsDict(TypedDict):
    ...
    A complex type that allows you to enable/disable the recording of thumbnails for individual participant recording and modify the interval at which thumbnails are generated for the live session.
    """
    participant_thumbnail_configuration: NotRequired[pulumi.Input[Optional['StageThumbnailConfigurationParticipantThumbnailConfigurationPropertiesArgs']]]
    """
    An object representing a configuration of thumbnails for recorded video from an individual participant.
    """
