...
class PublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the public key to be imported. The value does not need to be unique.
        :param pulumi.Input[builtins.str] public_key_material: The public portion of a customer-generated key pair. This field is required to create the AWS::IVS::PublicKey resource.
