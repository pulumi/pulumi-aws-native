...
def get_playback_key_pair(arn: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPlaybackKeyPairResult:
    """
    Resource Type definition for AWS::IVS::PlaybackKeyPair


    :param builtins.str arn: Key-pair identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_playback_key_pair_output(arn: Optional[pulumi.Input[builtins.str]] = None,
