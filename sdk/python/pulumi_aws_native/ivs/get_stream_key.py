...
def get_stream_key(arn: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamKeyResult:
    """
    Resource Type definition for AWS::IVS::StreamKey


    :param builtins.str arn: Stream Key ARN is automatically generated on creation and assigned as the unique identifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_stream_key_output(arn: Optional[pulumi.Input[builtins.str]] = None,
