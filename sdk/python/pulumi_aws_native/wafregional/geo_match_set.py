...
warnings.warn("""GeoMatchSet is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class GeoMatchSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GeoMatchSet is deprecated: GeoMatchSet is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
