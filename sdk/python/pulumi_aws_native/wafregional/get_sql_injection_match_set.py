...
def get_sql_injection_match_set(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:wafregional:getSqlInjectionMatchSet', __args__, opts=opts, typ=GetSqlInjectionMatchSetResult).value
...
def get_sql_injection_match_set_output(id: Optional[pulumi.Input[Optional[str]]] = None,
