...
if not MYPY:
    class ApplicationInstanceManifestOverridesPayloadArgsDict(TypedDict):
        ...
        """
        payload_data: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationInstanceManifestOverridesPayloadArgs:
    def __init__(__self__, *,
                 payload_data: Optional[pulumi.Input[builtins.str]] = None):
        """
        Parameter overrides for an application instance. This is a JSON document that has a single key (``PayloadData``) where the value is an escaped string representation of the overrides document.
        :param pulumi.Input[builtins.str] payload_data: The overrides document.
        """
    ...
    def payload_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The overrides document.
        """
    ...
    @payload_data.setter
    def payload_data(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationInstanceManifestPayloadArgs:
    def __init__(__self__, *,
        ...
        """
        A application verion's manifest file. This is a JSON document that has a single key (``PayloadData``) where the value is an escaped string representation of the application manifest (``graph.json``). This file is located in the ``graphs`` folder in your application source.
        :param pulumi.Input[builtins.str] payload_data: The application manifest.
        """
        if payload_data is not None:
            pulumi.set(__self__, "payload_data", payload_data)
...
if not MYPY:
    class PackageStorageLocationArgsDict(TypedDict):
        ...
        A storage location.
        """
        binary_prefix_location: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        generated_prefix_location: NotRequired[pulumi.Input[builtins.str]]
        """
        The location's generated prefix.
        """
        manifest_prefix_location: NotRequired[pulumi.Input[builtins.str]]
        """
        The location's manifest prefix.
        """
        repo_prefix_location: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PackageStorageLocationArgs:
    def __init__(__self__, *,
                 binary_prefix_location: Optional[pulumi.Input[builtins.str]] = None,
                 bucket: Optional[pulumi.Input[builtins.str]] = None,
                 generated_prefix_location: Optional[pulumi.Input[builtins.str]] = None,
                 manifest_prefix_location: Optional[pulumi.Input[builtins.str]] = None,
                 repo_prefix_location: Optional[pulumi.Input[builtins.str]] = None):
        """
        A storage location.
        :param pulumi.Input[builtins.str] binary_prefix_location: The location's binary prefix.
        :param pulumi.Input[builtins.str] bucket: The location's bucket.
        :param pulumi.Input[builtins.str] generated_prefix_location: The location's generated prefix.
        :param pulumi.Input[builtins.str] manifest_prefix_location: The location's manifest prefix.
        :param pulumi.Input[builtins.str] repo_prefix_location: The location's repo prefix.
        """
    ...
    def binary_prefix_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location's binary prefix.
        """
    ...
    def binary_prefix_location(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def generated_prefix_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location's generated prefix.
        """
    ...
    def generated_prefix_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "generated_prefix_location", value)

    @property
    @pulumi.getter(name="manifestPrefixLocation")
    def manifest_prefix_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location's manifest prefix.
        """
    ...
    def manifest_prefix_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "manifest_prefix_location", value)

    @property
    @pulumi.getter(name="repoPrefixLocation")
    def repo_prefix_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location's repo prefix.
        """
    ...
    def repo_prefix_location(self, value: Optional[pulumi.Input[builtins.str]]):
