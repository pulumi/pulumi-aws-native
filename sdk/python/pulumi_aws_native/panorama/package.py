...
class PackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] package_name: A name for the package.
...
class Package(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 package_name: Optional[pulumi.Input[builtins.str]] = None,
                 storage_location: Optional[pulumi.Input[Union['PackageStorageLocationArgs', 'PackageStorageLocationArgsDict']]] = None,
