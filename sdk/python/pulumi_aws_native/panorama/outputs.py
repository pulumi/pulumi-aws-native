...
class ApplicationInstanceManifestOverridesPayload(dict):
    ...
    def __init__(__self__, *,
                 payload_data: Optional[builtins.str] = None):
        """
        Parameter overrides for an application instance. This is a JSON document that has a single key (``PayloadData``) where the value is an escaped string representation of the overrides document.
        :param builtins.str payload_data: The overrides document.
        """
    ...
    def payload_data(self) -> Optional[builtins.str]:
        """
...
class ApplicationInstanceManifestPayload(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A application verion's manifest file. This is a JSON document that has a single key (``PayloadData``) where the value is an escaped string representation of the application manifest (``graph.json``). This file is located in the ``graphs`` folder in your application source.
        :param builtins.str payload_data: The application manifest.
        """
        if payload_data is not None:
            pulumi.set(__self__, "payload_data", payload_data)
...
class PackageStorageLocation(dict):
    ...
    def __init__(__self__, *,
                 binary_prefix_location: Optional[builtins.str] = None,
                 bucket: Optional[builtins.str] = None,
                 generated_prefix_location: Optional[builtins.str] = None,
                 manifest_prefix_location: Optional[builtins.str] = None,
                 repo_prefix_location: Optional[builtins.str] = None):
        """
        A storage location.
        :param builtins.str binary_prefix_location: The location's binary prefix.
        :param builtins.str bucket: The location's bucket.
        :param builtins.str generated_prefix_location: The location's generated prefix.
        :param builtins.str manifest_prefix_location: The location's manifest prefix.
        :param builtins.str repo_prefix_location: The location's repo prefix.
        """
    ...
    def binary_prefix_location(self) -> Optional[builtins.str]:
        """
    ...
    def generated_prefix_location(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_prefix_location(self) -> Optional[builtins.str]:
        """
    ...
    def repo_prefix_location(self) -> Optional[builtins.str]:
        """
