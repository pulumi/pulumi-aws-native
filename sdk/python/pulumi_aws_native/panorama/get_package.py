...
def get_package(package_id: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPackageResult:
    """
    Creates a package and storage location in an Amazon S3 access point.


    :param builtins.str package_id: The package's ID.
    """
    __args__ = dict()
...
def get_package_output(package_id: Optional[pulumi.Input[builtins.str]] = None,
