...
class ApplicationInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(manifest_overrides_payload, ApplicationInstanceManifestOverridesPayloadArgs):
            ...
            if not isinstance(manifest_payload, ApplicationInstanceManifestPayloadArgs):
