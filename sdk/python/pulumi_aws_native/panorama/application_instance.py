...
class ApplicationInstanceArgs:
    def __init__(__self__, *,
                 default_runtime_context_device: pulumi.Input[_builtins.str],
                 manifest_payload: pulumi.Input['ApplicationInstanceManifestPayloadArgs'],
                 application_instance_id_to_replace: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 manifest_overrides_payload: pulumi.Input[Optional['ApplicationInstanceManifestOverridesPayloadArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 runtime_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: A description for the application instance.
        ...
        :param pulumi.Input[_builtins.str] name: A name for the application instance.
        :param pulumi.Input[_builtins.str] runtime_role_arn: The ARN of a runtime role for the application instance.
    ...
    def default_runtime_context_device(self) -> pulumi.Input[_builtins.str]:
        """
        The device's ID.
        """
    ...
    def default_runtime_context_device(self, value: pulumi.Input[_builtins.str]):
    ...
    def application_instance_id_to_replace(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def application_instance_id_to_replace(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def manifest_overrides_payload(self) -> pulumi.Input[Optional['ApplicationInstanceManifestOverridesPayloadArgs']]:
        """
    ...
    def manifest_overrides_payload(self, value: pulumi.Input[Optional['ApplicationInstanceManifestOverridesPayloadArgs']]):
    ...
    def runtime_role_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def runtime_role_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ApplicationInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 application_instance_id_to_replace: pulumi.Input[Optional[_builtins.str]] = None,
                 default_runtime_context_device: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 manifest_overrides_payload: pulumi.Input[Optional[Union['ApplicationInstanceManifestOverridesPayloadArgs', 'ApplicationInstanceManifestOverridesPayloadArgsDict', 'outputs.ApplicationInstanceManifestOverridesPayload']]] = None,
                 manifest_payload: pulumi.Input[Optional[Union['ApplicationInstanceManifestPayloadArgs', 'ApplicationInstanceManifestPayloadArgsDict', 'outputs.ApplicationInstanceManifestPayload']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 runtime_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] default_runtime_context_device: The device's ID.
        :param pulumi.Input[_builtins.str] description: A description for the application instance.
        :param pulumi.Input[Union['ApplicationInstanceManifestOverridesPayloadArgs', 'ApplicationInstanceManifestOverridesPayloadArgsDict', 'outputs.ApplicationInstanceManifestOverridesPayload']] manifest_overrides_payload: Setting overrides for the application manifest.
        :param pulumi.Input[Union['ApplicationInstanceManifestPayloadArgs', 'ApplicationInstanceManifestPayloadArgsDict', 'outputs.ApplicationInstanceManifestPayload']] manifest_payload: The application's manifest document.
        :param pulumi.Input[_builtins.str] name: A name for the application instance.
        :param pulumi.Input[_builtins.str] runtime_role_arn: The ARN of a runtime role for the application instance.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Tags for the application instance.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["applicationInstanceIdToReplace", "defaultRuntimeContextDevice", "description", "manifestOverridesPayload", "manifestPayload", "name", "runtimeRoleArn"])
    ...
    @_builtins.property
    @pulumi.getter(name="applicationInstanceIdToReplace")
    def application_instance_id_to_replace(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of an application instance to replace with the new instance.
        """
        return pulumi.get(self, "application_instance_id_to_replace")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultRuntimeContextDevice")
    def default_runtime_context_device(self) -> pulumi.Output[_builtins.str]:
        """
        The device's ID.
        """
        return pulumi.get(self, "default_runtime_context_device")
    ...
    def default_runtime_context_device_name(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="runtimeRoleArn")
    def runtime_role_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of a runtime role for the application instance.
        """
        return pulumi.get(self, "runtime_role_arn")
