...
class Fleet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(anywhere_configuration, FleetAnywhereConfigurationArgs):
            ...
            if not isinstance(certificate_configuration, FleetCertificateConfigurationArgs):
            ...
            if not isinstance(resource_creation_limit_policy, FleetResourceCreationLimitPolicyArgs):
            ...
            if not isinstance(runtime_configuration, FleetRuntimeConfigurationArgs):
