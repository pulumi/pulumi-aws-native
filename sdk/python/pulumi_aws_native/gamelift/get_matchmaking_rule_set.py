...
def get_matchmaking_rule_set(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A unique identifier for the matchmaking rule set.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_matchmaking_rule_set_output(name: Optional[pulumi.Input[builtins.str]] = None,
