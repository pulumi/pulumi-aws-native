...
class MatchmakingRuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule_set_body: A collection of matchmaking rules, formatted as a JSON string.
        :param pulumi.Input[builtins.str] name: A unique identifier for the matchmaking rule set.
