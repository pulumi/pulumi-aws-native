...
class AliasArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A human-readable description of the alias.
        :param pulumi.Input[builtins.str] name: A descriptive label that is associated with an alias. Alias names do not need to be unique.
