...
class ScriptArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A descriptive label that is associated with a script. Script names do not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: An array of key-value pairs to apply to this resource.
        :param pulumi.Input[builtins.str] version: The version that is associated with a script. Version strings do not need to be unique.
        """
...
class Script(pulumi.CustomResource):
    ...
    def size_on_disk(self) -> pulumi.Output[builtins.int]:
        """
