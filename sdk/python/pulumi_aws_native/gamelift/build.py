...
class BuildArgs:
    def __init__(__self__, *,
                 ...
                 server_sdk_version: Optional[pulumi.Input[builtins.str]] = None,
                 storage_location: Optional[pulumi.Input['BuildStorageLocationArgs']] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Build resource.
        :param pulumi.Input[builtins.str] name: A descriptive label that is associated with a build. Build names do not need to be unique.
        ...
        :param pulumi.Input[builtins.str] server_sdk_version: A server SDK version you used when integrating your game server build with Amazon GameLift. By default Amazon GameLift sets this value to 4.0.2.
        ...
        :param pulumi.Input[builtins.str] version: Version information that is associated with this build. Version strings do not need to be unique.
        """
        if name is not None:
    ...
    def server_sdk_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_sdk_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Build(pulumi.CustomResource):
    ...
    def build_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="serverSdkVersion")
    def server_sdk_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A server SDK version you used when integrating your game server build with Amazon GameLift. By default Amazon GameLift sets this value to 4.0.2.
        """
        return pulumi.get(self, "server_sdk_version")
