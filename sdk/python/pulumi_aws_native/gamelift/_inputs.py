...
class ContainerFleetLocationCapacityArgsDict(TypedDict):
    ...
    """
    managed_capacity_configuration: NotRequired[pulumi.Input[Optional['ContainerFleetManagedCapacityConfigurationArgs']]]
    """
...
class ContainerFleetLocationConfigurationArgsDict(TypedDict):
    ...
    """
    location_capacity: NotRequired[pulumi.Input[Optional['ContainerFleetLocationCapacityArgs']]]
...
class ContainerFleetScalingPolicyArgsDict(TypedDict):
    ...
    """
    target_configuration: NotRequired[pulumi.Input[Optional['ContainerFleetTargetConfigurationArgs']]]
    """
...
class ContainerGroupDefinitionGameServerContainerDefinitionArgsDict(TypedDict):
    ...
    """
    depends_on: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContainerGroupDefinitionContainerDependencyArgs']]]]]
    """
    ...
    """
    environment_override: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContainerGroupDefinitionContainerEnvironmentArgs']]]]]
    """
    The environment variables to pass to a container.
    """
    mount_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContainerGroupDefinitionContainerMountPointArgs']]]]]
    """
    A list of mount point configurations to be used in a container.
    """
    port_configuration: NotRequired[pulumi.Input[Optional['ContainerGroupDefinitionPortConfigurationArgs']]]
    """
...
class ContainerGroupDefinitionSupportContainerDefinitionArgsDict(TypedDict):
    ...
    """
    health_check: NotRequired[pulumi.Input[Optional['ContainerGroupDefinitionContainerHealthCheckArgs']]]
    """
...
class FleetLocationCapacityArgsDict(TypedDict):
    ...
    """
    managed_capacity_configuration: NotRequired[pulumi.Input[Optional['FleetManagedCapacityConfigurationArgs']]]
    """
    Configuration options for Amazon GameLift Servers-managed capacity behavior.
    """
    min_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
...
class FleetLocationConfigurationArgsDict(TypedDict):
    ...
    An AWS Region code, such as `us-west-2` . For a list of supported Regions and Local Zones, see [Amazon GameLift Servers service locations](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-regions.html) for managed hosting.
    """
    location_capacity: NotRequired[pulumi.Input[Optional['FleetLocationCapacityArgs']]]
    """
...
class FleetRuntimeConfigurationArgsDict(TypedDict):
    ...
    """
    server_processes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FleetServerProcessArgs']]]]]
    """
...
class FleetScalingPolicyArgsDict(TypedDict):
    ...
    """
    target_configuration: NotRequired[pulumi.Input[Optional['FleetTargetConfigurationArgs']]]
    """
    An object that contains settings for a target-based scaling policy.
    """
    threshold: NotRequired[pulumi.Input[Optional[_builtins.float]]]
