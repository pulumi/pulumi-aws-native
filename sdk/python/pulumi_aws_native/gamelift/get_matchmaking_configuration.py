...
class GetMatchmakingConfigurationResult:
    ...
    def acceptance_required(self) -> Optional[builtins.bool]:
        """
    ...
    def acceptance_timeout_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def additional_player_count(self) -> Optional[builtins.int]:
        """
    ...
    def game_session_data(self) -> Optional[builtins.str]:
        """
    ...
    def game_session_queue_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def request_timeout_seconds(self) -> Optional[builtins.int]:
        """
...
def get_matchmaking_configuration(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A unique identifier for the matchmaking configuration.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_matchmaking_configuration_output(name: Optional[pulumi.Input[builtins.str]] = None,
