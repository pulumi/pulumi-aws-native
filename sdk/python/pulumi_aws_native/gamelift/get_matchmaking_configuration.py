...
class GetMatchmakingConfigurationResult:
    ...
    def acceptance_timeout_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def additional_player_count(self) -> Optional[_builtins.int]:
        """
    ...
    def game_session_data(self) -> Optional[_builtins.str]:
        """
    ...
    def game_session_queue_arns(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def request_timeout_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def rule_set_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def rule_set_name(self) -> Optional[_builtins.str]:
        """
...
def get_matchmaking_configuration(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: A unique identifier for the matchmaking configuration.
    """
    __args__ = dict()
    __args__['name'] = name
