...
class MatchmakingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] acceptance_timeout_seconds: The length of time (in seconds) to wait for players to accept a proposed match, if acceptance is required.
        :param pulumi.Input[_builtins.int] additional_player_count: The number of player slots in a match to keep open for future players.
        ...
        :param pulumi.Input[_builtins.str] creation_time: A time stamp indicating when this data object was created.
        ...
        :param pulumi.Input[_builtins.str] notification_target: An SNS topic ARN that is set up to receive matchmaking notifications.
    ...
    def request_timeout_seconds(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def request_timeout_seconds(self, value: pulumi.Input[_builtins.int]):
...
class MatchmakingConfiguration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="acceptanceTimeoutSeconds")
    def acceptance_timeout_seconds(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The length of time (in seconds) to wait for players to accept a proposed match, if acceptance is required.
        """
        return pulumi.get(self, "acceptance_timeout_seconds")
    ...
    @_builtins.property
    @pulumi.getter(name="additionalPlayerCount")
    def additional_player_count(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of player slots in a match to keep open for future players.
        """
        return pulumi.get(self, "additional_player_count")
    ...
    @_builtins.property
    @pulumi.getter(name="gameSessionData")
    def game_session_data(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A set of custom game session properties, formatted as a single string value.
        """
        return pulumi.get(self, "game_session_data")
    ...
    @_builtins.property
    @pulumi.getter(name="gameSessionQueueArns")
    def game_session_queue_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The Amazon Resource Name (ARN) that is assigned to a Amazon GameLift game session queue resource and uniquely identifies it.
        """
        return pulumi.get(self, "game_session_queue_arns")
    ...
    @_builtins.property
    @pulumi.getter(name="requestTimeoutSeconds")
    def request_timeout_seconds(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum duration, in seconds, that a matchmaking ticket can remain in process before timing out.
        """
        return pulumi.get(self, "request_timeout_seconds")
    ...
    @_builtins.property
    @pulumi.getter(name="ruleSetArn")
    def rule_set_arn(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Amazon Resource Name (ARN) associated with the GameLift matchmaking rule set resource that this configuration uses.
        """
        return pulumi.get(self, "rule_set_arn")
