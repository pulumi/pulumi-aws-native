...
class GetScriptResult:
    ...
    def size_on_disk(self) -> Optional[builtins.int]:
        """
...
def get_script(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: A unique identifier for the Realtime script
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_script_output(id: Optional[pulumi.Input[builtins.str]] = None,
