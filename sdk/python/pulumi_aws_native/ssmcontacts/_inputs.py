...
if not MYPY:
    class ContactChannelTargetInfoArgsDict(TypedDict):
        ...
        """
        retry_interval_in_minutes: pulumi.Input[builtins.int]
        """
...
class ContactChannelTargetInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the contact channel that SSM Incident Manager uses to engage the contact.
        :param pulumi.Input[builtins.str] channel_id: The Amazon Resource Name (ARN) of the contact channel.
        :param pulumi.Input[builtins.int] retry_interval_in_minutes: The number of minutes to wait to retry sending engagement in the case the engagement initially fails.
        """
    ...
    def retry_interval_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
        The number of minutes to wait to retry sending engagement in the case the engagement initially fails.
        """
    ...
    def retry_interval_in_minutes(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ContactStageArgsDict(TypedDict):
        ...
        """
        rotation_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ContactStageArgs:
    def __init__(__self__, *,
        ...
        """
        A set amount of time that an escalation plan or engagement plan engages the specified contacts or contact methods.
        :param pulumi.Input[builtins.int] duration_in_minutes: The time to wait until beginning the next stage.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rotation_ids: List of Rotation Ids to associate with Contact
...
class RotationCoverageTimeArgs:
    def __init__(__self__, *,
        ...
        """
        StartTime and EndTime for the Shift
        :param pulumi.Input[builtins.str] end_time: Information about when an on-call rotation shift ends.
        :param pulumi.Input[builtins.str] start_time: Information about when an on-call rotation shift begins.
        """
...
if not MYPY:
    class RotationMonthlySettingArgsDict(TypedDict):
        ...
        """
        hand_off_time: pulumi.Input[builtins.str]
        """
...
class RotationMonthlySettingArgs:
    def __init__(__self__, *,
        ...
        """
        DayOfWeek for Month and HandOff Time for Monthly Recurring Rotation.
        :param pulumi.Input[builtins.int] day_of_month: The day of the month when monthly recurring on-call rotations begin.
        :param pulumi.Input[builtins.str] hand_off_time: The time of day when a monthly recurring on-call shift rotation begins.
        """
    ...
    def hand_off_time(self) -> pulumi.Input[builtins.str]:
        """
        The time of day when a monthly recurring on-call shift rotation begins.
        """
    ...
    def hand_off_time(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class RotationRecurrenceSettingsArgsDict(TypedDict):
        ...
        """
        daily_settings: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        number_of_on_calls: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of Oncalls per shift.
        """
        recurrence_multiplier: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RotationRecurrenceSettingsArgs:
    def __init__(__self__, *,
                 daily_settings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 monthly_settings: Optional[pulumi.Input[Sequence[pulumi.Input['RotationMonthlySettingArgs']]]] = None,
                 number_of_on_calls: Optional[pulumi.Input[builtins.int]] = None,
                 recurrence_multiplier: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        Information about when an on-call rotation is in effect and how long the rotation period lasts.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] daily_settings: Information about on-call rotations that recur daily.
        ...
        :param pulumi.Input[builtins.int] number_of_on_calls: Number of Oncalls per shift.
        :param pulumi.Input[builtins.int] recurrence_multiplier: The number of days, weeks, or months a single rotation lasts.
    ...
    def daily_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Information about on-call rotations that recur daily.
        """
    ...
    def daily_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def number_of_on_calls(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of Oncalls per shift.
        """
    ...
    def number_of_on_calls(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_on_calls", value)

    @property
    @pulumi.getter(name="recurrenceMultiplier")
    def recurrence_multiplier(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of days, weeks, or months a single rotation lasts.
        """
    ...
    def recurrence_multiplier(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RotationWeeklySettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hand_off_time: The time of day when a weekly recurring on-call shift rotation begins.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
        pulumi.set(__self__, "hand_off_time", hand_off_time)
