...
class ContactChannelTargetInfoArgs:
    ...
    def retry_interval_in_minutes(self) -> pulumi.Input[_builtins.int]:
        """
        The number of minutes to wait to retry sending engagement in the case the engagement initially fails.
        """
    ...
    def retry_interval_in_minutes(self, value: pulumi.Input[_builtins.int]):
...
class ContactStageArgsDict(TypedDict):
    ...
    """
    targets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ContactTargetsArgsDict']]]]]
    """
...
class ContactTargetsArgsDict(TypedDict):
    ...
    The contacts or contact methods that the escalation plan or engagement plan is engaging.
    """
    channel_target_info: NotRequired[pulumi.Input[Optional['ContactChannelTargetInfoArgsDict']]]
    """
    Information about the contact channel that Incident Manager engages.
    """
    contact_target_info: NotRequired[pulumi.Input[Optional['ContactTargetInfoArgsDict']]]
    """
...
class PlanStageArgsDict(TypedDict):
    ...
    The time to wait until beginning the next stage.
    """
    targets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlanTargetsArgsDict']]]]]
    """
    The contacts or contact methods that the escalation plan or engagement plan is engaging.
    """
...
class PlanTargetsArgsDict(TypedDict):
    ...
    The contacts or contact methods that the escalation plan or engagement plan is engaging.
    """
    channel_target_info: NotRequired[pulumi.Input[Optional['PlanChannelTargetInfoArgsDict']]]
    """
    Information about the contact channel that Incident Manager engages.
    """
    contact_target_info: NotRequired[pulumi.Input[Optional['PlanContactTargetInfoArgsDict']]]
    """
...
class RotationMonthlySettingArgs:
    ...
    def hand_off_time(self) -> pulumi.Input[_builtins.str]:
        """
        The time of day when a monthly recurring on-call shift rotation begins.
        """
    ...
    def hand_off_time(self, value: pulumi.Input[_builtins.str]):
...
class RotationRecurrenceSettingsArgsDict(TypedDict):
    ...
    """
    monthly_settings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RotationMonthlySettingArgsDict']]]]]
    """
    ...
    """
    shift_coverages: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RotationShiftCoverageArgsDict']]]]]
    """
    Information about the days of the week included in on-call rotation coverage.
    """
    weekly_settings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RotationWeeklySettingArgsDict']]]]]
    """
...
class RotationRecurrenceSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] recurrence_multiplier: The number of days, weeks, or months a single rotation lasts.
