...
class RotationArgs:
    def __init__(__self__, *,
                 contact_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_ids: Members of the rotation
        ...
        :param pulumi.Input[builtins.str] start_time: Start time of the first shift of Oncall Schedule
        :param pulumi.Input[builtins.str] time_zone_id: TimeZone Identifier for the Oncall Schedule
        :param pulumi.Input[builtins.str] name: Name of the Rotation
    ...
    def contact_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @contact_ids.setter
    def contact_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class Rotation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contactIds")
    def contact_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Members of the rotation
        """
        return pulumi.get(self, "contact_ids")
