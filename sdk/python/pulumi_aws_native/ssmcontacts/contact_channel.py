...
class ContactChannelArgs:
    def __init__(__self__, *,
                 channel_address: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 defer_activation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ContactChannel resource.
        :param pulumi.Input[builtins.str] channel_address: The details that SSM Incident Manager uses when trying to engage the contact channel.
        :param pulumi.Input[builtins.str] channel_name: The device name. String of 6 to 50 alphabetical, numeric, dash, and underscore characters.
        ...
        :param pulumi.Input[builtins.str] contact_id: ARN of the contact resource
        :param pulumi.Input[builtins.bool] defer_activation: If you want to activate the channel at a later time, you can choose to defer activation. SSM Incident Manager can't engage your contact channel until it has been activated.
        """
    ...
    def channel_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def channel_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def defer_activation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def defer_activation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ContactChannel(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="channelAddress")
    def channel_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The details that SSM Incident Manager uses when trying to engage the contact channel.
        """
        return pulumi.get(self, "channel_address")
    ...
    @property
    @pulumi.getter(name="contactId")
    def contact_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARN of the contact resource
        """
        return pulumi.get(self, "contact_id")
    ...
    @property
    @pulumi.getter(name="deferActivation")
    def defer_activation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If you want to activate the channel at a later time, you can choose to defer activation. SSM Incident Manager can't engage your contact channel until it has been activated.
        """
        return pulumi.get(self, "defer_activation")
