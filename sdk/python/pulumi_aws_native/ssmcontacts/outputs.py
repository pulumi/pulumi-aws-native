...
class ContactChannelTargetInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about the contact channel that SSM Incident Manager uses to engage the contact.
        :param builtins.str channel_id: The Amazon Resource Name (ARN) of the contact channel.
        :param builtins.int retry_interval_in_minutes: The number of minutes to wait to retry sending engagement in the case the engagement initially fails.
        """
...
class ContactStage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rotation_ids: Optional[Sequence[builtins.str]] = None,
                 targets: Optional[Sequence['outputs.ContactTargets']] = None):
        """
        A set amount of time that an escalation plan or engagement plan engages the specified contacts or contact methods.
        :param builtins.int duration_in_minutes: The time to wait until beginning the next stage.
        :param Sequence[builtins.str] rotation_ids: List of Rotation Ids to associate with Contact
    ...
    def rotation_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RotationCoverageTime(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        StartTime and EndTime for the Shift
        :param builtins.str end_time: Information about when an on-call rotation shift ends.
        :param builtins.str start_time: Information about when an on-call rotation shift begins.
        """
...
class RotationMonthlySetting(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DayOfWeek for Month and HandOff Time for Monthly Recurring Rotation.
        :param builtins.int day_of_month: The day of the month when monthly recurring on-call rotations begin.
        :param builtins.str hand_off_time: The time of day when a monthly recurring on-call shift rotation begins.
        """
...
class RotationRecurrenceSettings(dict):
    ...
    def __init__(__self__, *,
                 daily_settings: Optional[Sequence[builtins.str]] = None,
                 monthly_settings: Optional[Sequence['outputs.RotationMonthlySetting']] = None,
                 number_of_on_calls: Optional[builtins.int] = None,
                 recurrence_multiplier: Optional[builtins.int] = None,
        ...
        """
        Information about when an on-call rotation is in effect and how long the rotation period lasts.
        :param Sequence[builtins.str] daily_settings: Information about on-call rotations that recur daily.
        :param Sequence['RotationMonthlySetting'] monthly_settings: Information about on-call rotations that recur monthly.
        :param builtins.int number_of_on_calls: Number of Oncalls per shift.
        :param builtins.int recurrence_multiplier: The number of days, weeks, or months a single rotation lasts.
    ...
    def daily_settings(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def number_of_on_calls(self) -> Optional[builtins.int]:
        """
    ...
    def recurrence_multiplier(self) -> Optional[builtins.int]:
        """
...
class RotationWeeklySetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str hand_off_time: The time of day when a weekly recurring on-call shift rotation begins.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
        pulumi.set(__self__, "hand_off_time", hand_off_time)
