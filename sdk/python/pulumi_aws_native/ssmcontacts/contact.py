...
class ContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Name of the contact. String value with 3 to 256 characters. Only alphabetical, space, numeric characters, dash, or underscore allowed.
