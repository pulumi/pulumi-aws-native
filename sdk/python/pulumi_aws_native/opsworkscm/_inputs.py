...
if not MYPY:
    ...
    ServerEngineAttributeArgsDict: TypeAlias = Mapping[str, Any]
...
class ServerEngineAttributeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the engine attribute.
               ...
               *Attribute names for Puppet Enterprise servers:*
               ...
               - `PUPPET_R10K_REMOTE`
               - `PUPPET_R10K_PRIVATE_KEY`
        :param pulumi.Input[builtins.str] value: The value of the engine attribute.
