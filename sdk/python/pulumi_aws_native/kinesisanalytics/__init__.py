...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "aws-native:KinesisAnalytics:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:KinesisAnalytics:ApplicationOutput":
                return ApplicationOutput(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:KinesisAnalytics:ApplicationReferenceDataSource":
    ...
    pulumi.runtime.register_resource_module("aws-native", "KinesisAnalytics", _module_instance)
