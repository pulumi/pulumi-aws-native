...
class ApplicationMappingParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ApplicationCSVMappingParametersArgs'] c_sv_mapping_parameters: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-mappingparameters.html#cfn-kinesisanalytics-application-mappingparameters-csvmappingparameters
        :param pulumi.Input['ApplicationJSONMappingParametersArgs'] j_son_mapping_parameters: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-application-mappingparameters.html#cfn-kinesisanalytics-application-mappingparameters-jsonmappingparameters
        """
...
class ApplicationReferenceDataSourceMappingParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ApplicationReferenceDataSourceCSVMappingParametersArgs'] c_sv_mapping_parameters: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-applicationreferencedatasource-mappingparameters.html#cfn-kinesisanalytics-applicationreferencedatasource-mappingparameters-csvmappingparameters
        :param pulumi.Input['ApplicationReferenceDataSourceJSONMappingParametersArgs'] j_son_mapping_parameters: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalytics-applicationreferencedatasource-mappingparameters.html#cfn-kinesisanalytics-applicationreferencedatasource-mappingparameters-jsonmappingparameters
        """
        if c_sv_mapping_parameters is not None:
            pulumi.set(__self__, "c_sv_mapping_parameters", c_sv_mapping_parameters)
        if j_son_mapping_parameters is not None:
