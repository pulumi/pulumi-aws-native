...
def get_application_output_resource(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:kinesisanalytics:getApplicationOutputResource', __args__, opts=opts, typ=GetApplicationOutputResourceResult).value
...
def get_application_output_resource_output(id: Optional[pulumi.Input[Optional[str]]] = None,
