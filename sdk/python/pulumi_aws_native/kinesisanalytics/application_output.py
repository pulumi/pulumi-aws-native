...
class ApplicationOutput(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApplicationOutputPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApplicationOutputPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApplicationOutputAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApplicationOutputProperties']:
        """
