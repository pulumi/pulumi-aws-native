...
@pulumi.type_token("aws-native:redshift:SnapshotCopyGrant")
class SnapshotCopyGrant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["kmsKeyId", "snapshotCopyGrantName"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(SnapshotCopyGrant, __self__).__init__(
            'aws-native:redshift:SnapshotCopyGrant',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SnapshotCopyGrant':
        """
