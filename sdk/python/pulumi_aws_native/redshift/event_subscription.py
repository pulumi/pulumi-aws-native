...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: A boolean value; set to true to activate the subscription, and set to false to create the subscription but not activate it.
        ...
        :param pulumi.Input[builtins.str] sns_topic_arn: The Amazon Resource Name (ARN) of the Amazon SNS topic used to transmit the event notifications.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_ids: A list of one or more identifiers of Amazon Redshift source objects.
        :param pulumi.Input['EventSubscriptionSourceType'] source_type: The type of source that will be generating the events.
        :param pulumi.Input[builtins.str] subscription_name: The name of the Amazon Redshift event notification subscription
...
@pulumi.type_token("aws-native:redshift:EventSubscription")
class EventSubscription(pulumi.CustomResource):
    ...
    def cust_subscription_id(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Amazon Redshift event notification subscription.
        """
    ...
    def event_categories_list(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def source_ids_list(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def subscription_creation_time(self) -> pulumi.Output[builtins.str]:
        """
