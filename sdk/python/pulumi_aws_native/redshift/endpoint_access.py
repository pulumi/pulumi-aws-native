...
class EndpointAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subnet_group_name: The subnet group name where Amazon Redshift chooses to deploy the endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_security_group_ids: A list of vpc security group ids to apply to the created endpoint access.
        :param pulumi.Input[builtins.str] resource_owner: The AWS account ID of the owner of the cluster.
        """
...
class EndpointAccess(pulumi.CustomResource):
    ...
    def endpoint_create_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def endpoint_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="resourceOwner")
    def resource_owner(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AWS account ID of the owner of the cluster.
        """
        return pulumi.get(self, "resource_owner")
