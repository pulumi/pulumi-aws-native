...
class GetEndpointAuthorizationResult:
    ...
    def allowed_all_vpcs(self) -> Optional[builtins.bool]:
        """
    ...
    def authorize_time(self) -> Optional[builtins.str]:
        """
    ...
    def cluster_status(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def grantor(self) -> Optional[builtins.str]:
        """
...
def get_endpoint_authorization(account: Optional[builtins.str] = None,
    ...
    :param builtins.str account: The target AWS account ID to grant or revoke access for.
    :param builtins.str cluster_identifier: The cluster identifier.
    """
    __args__ = dict()
...
def get_endpoint_authorization_output(account: Optional[pulumi.Input[builtins.str]] = None,
