...
class GetScheduledActionResult:
    ...
    def next_invocations(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def scheduled_action_description(self) -> Optional[builtins.str]:
        """
...
def get_scheduled_action(scheduled_action_name: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScheduledActionResult:
    """
    The `AWS::Redshift::ScheduledAction` resource creates an Amazon Redshift Scheduled Action.


    :param builtins.str scheduled_action_name: The name of the scheduled action. The name must be unique within an account.
    """
    __args__ = dict()
...
def get_scheduled_action_output(scheduled_action_name: Optional[pulumi.Input[builtins.str]] = None,
