...
class GetScheduledActionResult:
    ...
    def next_invocations(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def scheduled_action_description(self) -> Optional[_builtins.str]:
        """
...
def get_scheduled_action(scheduled_action_name: Optional[_builtins.str] = None,
