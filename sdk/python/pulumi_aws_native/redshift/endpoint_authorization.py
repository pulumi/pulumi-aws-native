...
class EndpointAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account: The target AWS account ID to grant or revoke access for.
        :param pulumi.Input[builtins.str] cluster_identifier: The cluster identifier.
        :param pulumi.Input[builtins.bool] force:  Indicates whether to force the revoke action. If true, the Redshift-managed VPC endpoints associated with the endpoint authorization are also deleted.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ids: The virtual private cloud (VPC) identifiers to grant or revoke access to.
        """
...
class EndpointAuthorization(pulumi.CustomResource):
    ...
    def allowed_vpcs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def authorize_time(self) -> pulumi.Output[builtins.str]:
        """
