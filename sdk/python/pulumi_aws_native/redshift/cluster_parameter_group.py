...
class ClusterParameterGroupArgs:
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterParameterGroupTagArgs']]]]):
        pulumi.set(self, "tags", value)


warnings.warn("""ClusterParameterGroup is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
