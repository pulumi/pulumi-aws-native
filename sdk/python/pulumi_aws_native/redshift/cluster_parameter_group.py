...
class ClusterParameterGroupArgs:
    def __init__(__self__, *,
                 ...
                 parameter_group_family: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] parameter_group_family: The Amazon Redshift engine version to which the cluster parameter group applies. The cluster engine version determines the set of parameters.
        :param pulumi.Input[builtins.str] parameter_group_name: The name of the cluster parameter group.
    ...
    def parameter_group_family(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parameter_group_family(self, value: pulumi.Input[builtins.str]):
...
class ClusterParameterGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 parameter_group_family: Optional[pulumi.Input[builtins.str]] = None,
                 parameter_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] parameter_group_family: The Amazon Redshift engine version to which the cluster parameter group applies. The cluster engine version determines the set of parameters.
        :param pulumi.Input[builtins.str] parameter_group_name: The name of the cluster parameter group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterParameterGroupParameterArgs', 'ClusterParameterGroupParameterArgsDict']]]] parameters: An array of parameters to be modified. A maximum of 20 parameters can be modified in a single request.
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["description", "parameterGroupFamily", "parameterGroupName"])
    ...
    @property
    @pulumi.getter(name="parameterGroupFamily")
    def parameter_group_family(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Redshift engine version to which the cluster parameter group applies. The cluster engine version determines the set of parameters.
        """
        return pulumi.get(self, "parameter_group_family")
