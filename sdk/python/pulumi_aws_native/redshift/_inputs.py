...
class ClusterEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: The DNS address of the cluster. This property is read only.
        :param pulumi.Input[builtins.str] port: The port that the database engine is listening on. This property is read only.
        """
...
class ClusterLoggingPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: The name of an existing S3 bucket where the log files are to be stored.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_exports: The collection of exported log types. Possible values are `connectionlog` , `useractivitylog` , and `userlog` .
...
class ClusterParameterGroupParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_name: The name of the parameter.
        :param pulumi.Input[builtins.str] parameter_value: The value of the parameter. If `ParameterName` is `wlm_json_configuration`, then the maximum size of `ParameterValue` is 8000 characters.
        """
