...
class ScheduledActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schedule: The schedule in `at( )` or `cron( )` format.
...
@pulumi.type_token("aws-native:redshift:ScheduledAction")
class ScheduledAction(pulumi.CustomResource):
    ...
    def next_invocations(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="scheduledActionDescription")
    def scheduled_action_description(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The description of the scheduled action.
        """
        return pulumi.get(self, "scheduled_action_description")
