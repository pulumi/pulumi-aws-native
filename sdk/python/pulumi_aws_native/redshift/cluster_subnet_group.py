...
class ClusterSubnetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the parameter group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The list of VPC subnet IDs
