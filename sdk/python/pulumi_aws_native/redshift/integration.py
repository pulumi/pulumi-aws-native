...
class IntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_arn: The Amazon Resource Name (ARN) of the Redshift data warehouse to use as the target for replication
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: The encryption context for the integration. For more information, see [Encryption context](https://docs.aws.amazon.com/) in the *AWS Key Management Service Developer Guide* .
        :param pulumi.Input[builtins.str] integration_name: The name of the integration.
        :param pulumi.Input[builtins.str] kms_key_id: An KMS key identifier for the key to use to encrypt the integration. If you don't specify an encryption key, the default AWS owned KMS key is used.
