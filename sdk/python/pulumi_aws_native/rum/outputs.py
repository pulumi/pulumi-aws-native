...
class AppMonitorConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_x_ray: Optional[builtins.bool] = None,
        ...
        """
        AppMonitor configuration
        :param builtins.bool allow_cookies: If you set this to true, the RUM web client sets two cookies, a session cookie and a user cookie. The cookies allow the RUM web client to collect data relating to the number of users an application has and the behavior of the application across a sequence of events. Cookies are stored in the top-level domain of the current page.
        :param builtins.bool enable_x_ray: If you set this to true, RUM enables xray tracing for the user sessions that RUM samples. RUM adds an xray trace header to allowed HTTP requests. It also records an xray segment for allowed HTTP requests. You can see traces and segments from these user sessions in the xray console and the CW ServiceLens console.
        :param Sequence[builtins.str] excluded_pages: A list of URLs in your website or application to exclude from RUM data collection. You can't include both ExcludedPages and IncludedPages in the same operation.
        :param Sequence[builtins.str] favorite_pages: A list of pages in the RUM console that are to be displayed with a favorite icon.
        :param builtins.str guest_role_arn: The ARN of the guest IAM role that is attached to the identity pool that is used to authorize the sending of data to RUM.
        :param builtins.str identity_pool_id: The ID of the identity pool that is used to authorize the sending of data to RUM.
        :param Sequence[builtins.str] included_pages: If this app monitor is to collect data from only certain pages in your application, this structure lists those pages. You can't include both ExcludedPages and IncludedPages in the same operation.
        ...
        :param builtins.float session_sample_rate: Specifies the percentage of user sessions to use for RUM data collection. Choosing a higher percentage gives you more data but also incurs more costs. The number you specify is the percentage of user sessions that will be used. If you omit this parameter, the default of 10 is used.
    ...
    def enable_x_ray(self) -> Optional[builtins.bool]:
        """
...
class AppMonitorMetricDefinition(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 dimension_keys: Optional[Mapping[str, builtins.str]] = None,
        ...
        """
        A single metric definition
        :param builtins.str name: The name for the metric that is defined in this structure. For extended metrics, valid values are the following:
               ...
               SessionCount
        :param Mapping[str, builtins.str] dimension_keys: Use this field only if you are sending the metric to CloudWatch.
        ...
        :param builtins.str event_pattern: The pattern that defines the metric, specified as a JSON object. RUM checks events that happen in a user's session against the pattern, and events that match the pattern are sent to the metric destination.
        ...
        :param builtins.str namespace: The namespace used by CloudWatch Metrics for the metric that is defined in this structure
        :param builtins.str unit_label: The CloudWatch metric unit to use for this metric. If you omit this field, the metric is recorded with no unit.
        :param builtins.str value_key: The field within the event object that the metric value is sourced from.
    ...
    def dimension_keys(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class AppMonitorMetricDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str destination_arn: Use this parameter only if Destination is Evidently. This parameter specifies the ARN of the Evidently experiment that will receive the extended metrics.
        :param builtins.str iam_role_arn: This parameter is required if Destination is Evidently. If Destination is CloudWatch, do not use this parameter.
...
class AppMonitorResourcePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 policy_revision_id: Optional[builtins.str] = None):
        """
        A structure that defines resource policy attached to your app monitor.
        :param builtins.str policy_document: The JSON to use as the resource policy. The document can be up to 4 KB in size. 
        :param builtins.str policy_revision_id: A string value that you can use to conditionally update your policy. You can provide the revision ID of your existing policy to make mutating requests against that policy. 
    ...
    def policy_revision_id(self) -> Optional[builtins.str]:
        """
