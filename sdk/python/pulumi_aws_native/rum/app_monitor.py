...
class AppMonitorArgs:
    def __init__(__self__, *,
                 ...
                 domain_list: Optional[pulumi.Input[Sequence[Any]]] = None,
        ...
        :param pulumi.Input[Sequence[Any]] domain_list: The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
    ...
    def domain_list(self) -> Optional[pulumi.Input[Sequence[Any]]]:
        """
    ...
    @domain_list.setter
    def domain_list(self, value: Optional[pulumi.Input[Sequence[Any]]]):
...
class AppMonitor(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="domainList")
    def domain_list(self) -> pulumi.Output[Optional[Sequence[Any]]]:
        """
        The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        """
        return pulumi.get(self, "domain_list")
