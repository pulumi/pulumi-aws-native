...
class AppMonitorArgs:
    def __init__(__self__, *,
                 ...
                 domain_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] domain: The top-level internet domain name for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_list: The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        :param pulumi.Input[builtins.str] name: A name for the app monitor
    ...
    def domain_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @domain_list.setter
    def domain_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AppMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.bool] cw_log_enabled: Data collected by RUM is kept by RUM for 30 days and then deleted. This parameter specifies whether RUM sends a copy of this telemetry data to CWLlong in your account. This enables you to keep the telemetry data for more than 30 days, but it does incur CWLlong charges. If you omit this parameter, the default is false
        :param pulumi.Input[Union['AppMonitorDeobfuscationConfigurationArgs', 'AppMonitorDeobfuscationConfigurationArgsDict']] deobfuscation_configuration: A structure that contains the configuration for how an app monitor can deobfuscate stack traces.
        :param pulumi.Input[builtins.str] domain: The top-level internet domain name for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_list: The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        :param pulumi.Input[builtins.str] name: A name for the app monitor
    ...
    @property
    @pulumi.getter(name="domainList")
    def domain_list(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The top-level internet domain names for which your application has administrative authority. The CreateAppMonitor requires either the domain or the domain list.
        """
        return pulumi.get(self, "domain_list")
