...
if not MYPY:
    class AppMonitorConfigurationArgsDict(TypedDict):
        ...
        """
        enable_x_ray: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AppMonitorConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 enable_x_ray: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        AppMonitor configuration
        :param pulumi.Input[builtins.bool] allow_cookies: If you set this to true, the RUM web client sets two cookies, a session cookie and a user cookie. The cookies allow the RUM web client to collect data relating to the number of users an application has and the behavior of the application across a sequence of events. Cookies are stored in the top-level domain of the current page.
        :param pulumi.Input[builtins.bool] enable_x_ray: If you set this to true, RUM enables xray tracing for the user sessions that RUM samples. RUM adds an xray trace header to allowed HTTP requests. It also records an xray segment for allowed HTTP requests. You can see traces and segments from these user sessions in the xray console and the CW ServiceLens console.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_pages: A list of URLs in your website or application to exclude from RUM data collection. You can't include both ExcludedPages and IncludedPages in the same operation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] favorite_pages: A list of pages in the RUM console that are to be displayed with a favorite icon.
        :param pulumi.Input[builtins.str] guest_role_arn: The ARN of the guest IAM role that is attached to the identity pool that is used to authorize the sending of data to RUM.
        :param pulumi.Input[builtins.str] identity_pool_id: The ID of the identity pool that is used to authorize the sending of data to RUM.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_pages: If this app monitor is to collect data from only certain pages in your application, this structure lists those pages. You can't include both ExcludedPages and IncludedPages in the same operation.
        ...
        :param pulumi.Input[builtins.float] session_sample_rate: Specifies the percentage of user sessions to use for RUM data collection. Choosing a higher percentage gives you more data but also incurs more costs. The number you specify is the percentage of user sessions that will be used. If you omit this parameter, the default of 10 is used.
    ...
    def enable_x_ray(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If you set this to true, RUM enables xray tracing for the user sessions that RUM samples. RUM adds an xray trace header to allowed HTTP requests. It also records an xray segment for allowed HTTP requests. You can see traces and segments from these user sessions in the xray console and the CW ServiceLens console.
        """
    ...
    @enable_x_ray.setter
    def enable_x_ray(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AppMonitorMetricDefinitionArgsDict(TypedDict):
        ...
        SessionCount
        """
        dimension_keys: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        value_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppMonitorMetricDefinitionArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 dimension_keys: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 event_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 unit_label: Optional[pulumi.Input[builtins.str]] = None,
                 value_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        A single metric definition
        :param pulumi.Input[builtins.str] name: The name for the metric that is defined in this structure. For extended metrics, valid values are the following:
               ...
               SessionCount
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] dimension_keys: Use this field only if you are sending the metric to CloudWatch.
               ...
               All dimensions listed in this field must also be included in EventPattern.
        :param pulumi.Input[builtins.str] event_pattern: The pattern that defines the metric, specified as a JSON object. RUM checks events that happen in a user's session against the pattern, and events that match the pattern are sent to the metric destination.
               ...
               If the metrics destination' is CloudWatch and the event also matches a value in DimensionKeys, then the metric is published with the specified dimensions.
        :param pulumi.Input[builtins.str] namespace: The namespace used by CloudWatch Metrics for the metric that is defined in this structure
        :param pulumi.Input[builtins.str] unit_label: The CloudWatch metric unit to use for this metric. If you omit this field, the metric is recorded with no unit.
        :param pulumi.Input[builtins.str] value_key: The field within the event object that the metric value is sourced from.
    ...
    def dimension_keys(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Use this field only if you are sending the metric to CloudWatch.
    ...
    def dimension_keys(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def value_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The field within the event object that the metric value is sourced from.
    ...
    @value_key.setter
    def value_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AppMonitorResourcePolicyArgsDict(TypedDict):
        ...
        """
        policy_revision_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppMonitorResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        A structure that defines resource policy attached to your app monitor.
        :param pulumi.Input[builtins.str] policy_document: The JSON to use as the resource policy. The document can be up to 4 KB in size. 
        :param pulumi.Input[builtins.str] policy_revision_id: A string value that you can use to conditionally update your policy. You can provide the revision ID of your existing policy to make mutating requests against that policy. 
