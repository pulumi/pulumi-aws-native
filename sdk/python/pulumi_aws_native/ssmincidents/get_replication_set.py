...
class GetReplicationSetResult:
    ...
    def deletion_protected(self) -> Optional[builtins.bool]:
        """
...
def get_replication_set(arn: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReplicationSetResult:
    """
    Resource type definition for AWS::SSMIncidents::ReplicationSet


    :param builtins.str arn: The ARN of the ReplicationSet.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_replication_set_output(arn: Optional[pulumi.Input[builtins.str]] = None,
