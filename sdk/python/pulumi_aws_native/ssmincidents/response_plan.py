...
class ResponsePlanArgs:
    ...
    def _configure(
        ...
        if chat_channel is not None:
            _setter("chat_channel", chat_channel)
...
class ResponsePlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(chat_channel, ResponsePlanChatChannelArgs):
            ...
            if not isinstance(incident_template, ResponsePlanIncidentTemplateArgs):
