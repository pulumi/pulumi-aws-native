...
class ResponsePlanArgs:
    def __init__(__self__, *,
                 ...
                 engagements: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the response plan.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] engagements: The list of engagements to use.
    ...
    @engagements.setter
    def engagements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
