...
if not MYPY:
    class ReplicationSetRegionConfigurationArgsDict(TypedDict):
        ...
        """
        sse_kms_key_id: pulumi.Input[builtins.str]
        """
...
class ReplicationSetRegionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The ReplicationSet regional configuration.
        :param pulumi.Input[builtins.str] sse_kms_key_id: The AWS Key Management Service key ID or Key Alias to use to encrypt your replication set.
        """
        pulumi.set(__self__, "sse_kms_key_id", sse_kms_key_id)

    @property
    @pulumi.getter(name="sseKmsKeyId")
    def sse_kms_key_id(self) -> pulumi.Input[builtins.str]:
        """
        The AWS Key Management Service key ID or Key Alias to use to encrypt your replication set.
        """
    ...
    def sse_kms_key_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ResponsePlanChatChannelArgsDict(TypedDict):
        ...
        """
        chatbot_sns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ResponsePlanChatChannelArgs:
    def __init__(__self__, *,
                 chatbot_sns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The chat channel configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] chatbot_sns: The Amazon SNS targets that AWS Chatbot uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel by using the Amazon SNS topics
        """
    ...
    def chatbot_sns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The Amazon SNS targets that AWS Chatbot uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel by using the Amazon SNS topics
        """
    ...
    @chatbot_sns.setter
    def chatbot_sns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ResponsePlanDynamicSsmParameterArgs:
    def __init__(__self__, *,
        ...
        """
        A parameter with a dynamic value to set when starting the SSM automation document.
        :param pulumi.Input[builtins.str] key: The key parameter to use when running the Systems Manager Automation runbook.
...
class ResponsePlanIncidentTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        The incident template configuration.
        :param pulumi.Input[builtins.int] impact: The impact value.
        :param pulumi.Input[builtins.str] title: The title string.
        :param pulumi.Input[builtins.str] dedupe_string: The deduplication string.
        ...
        :param pulumi.Input[builtins.str] summary: The summary string.
        """
...
class ResponsePlanNotificationTargetItemArgs:
    def __init__(__self__, *,
        ...
        """
        A notification target.
        :param pulumi.Input[builtins.str] sns_topic_arn: The Amazon Resource Name (ARN) of the Amazon SNS topic.
        """
...
class ResponsePlanPagerDutyConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_id: The AWS secrets manager secretId storing the pagerDuty token.
        """
...
class ResponsePlanPagerDutyIncidentConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The pagerDuty incident configuration.
        :param pulumi.Input[builtins.str] service_id: The pagerDuty serviceId.
        """
...
class ResponsePlanSsmAutomationArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration to use when starting the SSM automation document.
        :param pulumi.Input[builtins.str] document_name: The document name to use when starting the SSM automation document.
        :param pulumi.Input[builtins.str] role_arn: The role ARN to use when starting the SSM automation document.
        :param pulumi.Input[builtins.str] document_version: The version of the document to use when starting the SSM automation document.
...
class ResponsePlanSsmParameterArgs:
    def __init__(__self__, *,
        ...
        """
        A parameter to set when starting the SSM automation document.
        :param pulumi.Input[builtins.str] key: The key parameter to use when running the Automation runbook.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The value parameter to use when running the Automation runbook.
        """
        pulumi.set(__self__, "key", key)
