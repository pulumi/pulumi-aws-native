...
class ReplicationSetRegionConfigurationArgs:
    ...
    def sse_kms_key_id(self) -> pulumi.Input[_builtins.str]:
        """
        The AWS Key Management Service key ID or Key Alias to use to encrypt your replication set.
        """
    ...
    def sse_kms_key_id(self, value: pulumi.Input[_builtins.str]):
...
class ReplicationSetReplicationRegionArgsDict(TypedDict):
    ...
    The ReplicationSet regional configuration.
    """
    region_configuration: NotRequired[pulumi.Input[Optional['ReplicationSetRegionConfigurationArgsDict']]]
...
class ResponsePlanActionArgsDict(TypedDict):
    ...
    """
    ssm_automation: NotRequired[pulumi.Input[Optional['ResponsePlanSsmAutomationArgsDict']]]
    """
...
class ResponsePlanIncidentTemplateArgsDict(TypedDict):
    ...
    """
    incident_tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ResponsePlanTagArgsDict']]]]]
    """
    Tags that get applied to incidents created by the StartIncident API action.
    """
    notification_targets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ResponsePlanNotificationTargetItemArgsDict']]]]]
    """
...
class ResponsePlanIncidentTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] summary: The summary string.
        """
...
class ResponsePlanIntegrationArgsDict(TypedDict):
    pager_duty_configuration: NotRequired[pulumi.Input[Optional['ResponsePlanPagerDutyConfigurationArgsDict']]]
    """
...
class ResponsePlanSsmAutomationArgsDict(TypedDict):
    ...
    """
    dynamic_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ResponsePlanDynamicSsmParameterArgsDict']]]]]
    """
    The parameters with dynamic values to set when starting the SSM automation document.
    """
    parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ResponsePlanSsmParameterArgsDict']]]]]
    """
