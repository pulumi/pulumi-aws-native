...
class ReplicationSetRegionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The ReplicationSet regional configuration.
        :param builtins.str sse_kms_key_id: The AWS Key Management Service key ID or Key Alias to use to encrypt your replication set.
        """
...
class ResponsePlanChatChannel(dict):
    ...
    def __init__(__self__, *,
                 chatbot_sns: Optional[Sequence[builtins.str]] = None):
        """
        The chat channel configuration.
        :param Sequence[builtins.str] chatbot_sns: The Amazon SNS targets that AWS Chatbot uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel by using the Amazon SNS topics
        """
    ...
    def chatbot_sns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResponsePlanDynamicSsmParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A parameter with a dynamic value to set when starting the SSM automation document.
        :param builtins.str key: The key parameter to use when running the Systems Manager Automation runbook.
...
class ResponsePlanIncidentTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The incident template configuration.
        :param builtins.int impact: The impact value.
        :param builtins.str title: The title string.
        :param builtins.str dedupe_string: The deduplication string.
        ...
        :param builtins.str summary: The summary string.
        """
...
class ResponsePlanNotificationTargetItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A notification target.
        :param builtins.str sns_topic_arn: The Amazon Resource Name (ARN) of the Amazon SNS topic.
        """
...
class ResponsePlanPagerDutyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_id: The AWS secrets manager secretId storing the pagerDuty token.
        """
...
class ResponsePlanPagerDutyIncidentConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The pagerDuty incident configuration.
        :param builtins.str service_id: The pagerDuty serviceId.
        """
...
class ResponsePlanSsmAutomation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration to use when starting the SSM automation document.
        :param builtins.str document_name: The document name to use when starting the SSM automation document.
        :param builtins.str role_arn: The role ARN to use when starting the SSM automation document.
        :param builtins.str document_version: The version of the document to use when starting the SSM automation document.
...
class ResponsePlanSsmParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A parameter to set when starting the SSM automation document.
        :param builtins.str key: The key parameter to use when running the Automation runbook.
        :param Sequence[builtins.str] values: The value parameter to use when running the Automation runbook.
        """
        pulumi.set(__self__, "key", key)
