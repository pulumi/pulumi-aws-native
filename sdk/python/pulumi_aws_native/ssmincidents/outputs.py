...
class ResponsePlanChatChannel(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The chat channel configuration.
        :param Sequence[builtins.str] chatbot_sns: The Amazon SNS targets that  uses to notify the chat channel of updates to an incident. You can also make updates to the incident through the chat channel by using the Amazon SNS topics
        """
