...
def get_guardrail_version(guardrail_id: Optional[builtins.str] = None,
    ...
    :param builtins.str guardrail_id: Unique id for the guardrail
    :param builtins.str version: Guardrail version
    """
    __args__ = dict()
...
def get_guardrail_version_output(guardrail_id: Optional[pulumi.Input[builtins.str]] = None,
