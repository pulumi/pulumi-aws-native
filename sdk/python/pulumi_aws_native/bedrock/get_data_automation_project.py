...
def get_data_automation_project(project_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str project_arn: ARN of a DataAutomationProject
    """
    __args__ = dict()
...
def get_data_automation_project_output(project_arn: Optional[pulumi.Input[builtins.str]] = None,
