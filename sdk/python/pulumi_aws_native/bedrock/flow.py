...
class FlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] execution_role_arn: ARN of a IAM role
        ...
        :param pulumi.Input[builtins.str] definition_string: A JSON string containing a Definition with the same schema as the Definition property of this resource
        ...
        :param pulumi.Input[builtins.str] name: Name for the flow
