...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param Any policy_document: The IAM policy document defining access permissions for the guardrail and guardrail profile resources
        ...
        :param pulumi.Input[_builtins.str] resource_arn: The ARN of the Bedrock Guardrail or Guardrail Profile resource
        """
...
@pulumi.type_token("aws-native:bedrock:ResourcePolicy")
class ResourcePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ResourcePolicy, __self__).__init__(
            'aws-native:bedrock:ResourcePolicy',
            resource_name,
            __props__,
            opts)
