...
def get_prompt(arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPromptResult:
    """
    Definition of AWS::Bedrock::Prompt Resource Type


    :param builtins.str arn: ARN of a prompt resource possibly with a version
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_prompt_output(arn: Optional[pulumi.Input[builtins.str]] = None,
