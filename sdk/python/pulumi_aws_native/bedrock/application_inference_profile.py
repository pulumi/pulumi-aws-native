...
@pulumi.type_token("aws-native:bedrock:ApplicationInferenceProfile")
class ApplicationInferenceProfile(pulumi.CustomResource):
    ...
    def inference_profile_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def inference_profile_id(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def inference_profile_identifier(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="inferenceProfileName")
    def inference_profile_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the inference profile.
        """
        return pulumi.get(self, "inference_profile_name")
