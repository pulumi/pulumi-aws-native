...
if not MYPY:
    class AgentActionGroupExecutor0PropertiesArgsDict(TypedDict):
        ...
        """
        lambda_: pulumi.Input[builtins.str]
        """
        ARN of a Lambda.
        """
elif False:
...
class AgentActionGroupExecutor0PropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Type of Executors for an Action Group
        :param pulumi.Input[builtins.str] lambda_: ARN of a Lambda.
        """
        pulumi.set(__self__, "lambda_", lambda_)

    @property
    @pulumi.getter(name="lambda")
    def lambda_(self) -> pulumi.Input[builtins.str]:
        """
        ARN of a Lambda.
        """
    ...
    @lambda_.setter
    def lambda_(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AgentActionGroupArgsDict(TypedDict):
        ...
        """
        skip_resource_in_use_check_on_delete: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AgentActionGroupArgs:
    def __init__(__self__, *,
                 ...
                 skip_resource_in_use_check_on_delete: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Contains the information of an Agent Action Group
        ...
        :param pulumi.Input[builtins.str] description: Description of action group
        ...
        :param pulumi.Input['AgentActionGroupSignature'] parent_action_group_signature: If this field is set as `AMAZON.UserInput` , the agent can request the user for additional information when trying to complete a task. The `description` , `apiSchema` , and `actionGroupExecutor` fields must be blank for this action group.
               ...
               During orchestration, if the agent determines that it needs to invoke an API in an action group, but doesn't have enough information to complete the API request, it will invoke this action group instead and return an [Observation](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent-runtime_Observation.html) reprompting the user for more information.
        :param pulumi.Input[builtins.bool] skip_resource_in_use_check_on_delete: Specifies whether to allow deleting action group while it is in use.
        """
    ...
    def skip_resource_in_use_check_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to allow deleting action group while it is in use.
        """
    ...
    def skip_resource_in_use_check_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AgentAliasRoutingConfigurationListItemArgs:
    def __init__(__self__, *,
        ...
        """
        Details about the routing configuration for an Agent alias.
        :param pulumi.Input[builtins.str] agent_version: Agent Version.
        """
...
class AgentApiSchema1PropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Contains information about the API Schema for the Action Group
        :param pulumi.Input[builtins.str] payload: String OpenAPI Payload
        """
...
if not MYPY:
    class AgentCollaboratorAgentDescriptorPropertiesArgsDict(TypedDict):
        ...
        """
        alias_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AgentCollaboratorAgentDescriptorPropertiesArgs:
    def __init__(__self__, *,
                 alias_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Agent descriptor for agent collaborator
        :param pulumi.Input[builtins.str] alias_arn: Alias ARN for agent descriptor
        """
    ...
    def alias_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alias ARN for agent descriptor
        """
    ...
    @alias_arn.setter
    def alias_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AgentCollaboratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] collaboration_instruction: Agent collaborator instruction
        :param pulumi.Input[builtins.str] collaborator_name: Agent collaborator name
...
class AgentFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of function
...
if not MYPY:
    class AgentGuardrailConfigurationArgsDict(TypedDict):
        ...
        """
        guardrail_identifier: NotRequired[pulumi.Input[builtins.str]]
        """
        Identifier for the guardrail, could be the id or the arn
        """
        guardrail_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AgentGuardrailConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 guardrail_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Configuration for a guardrail.
        :param pulumi.Input[builtins.str] guardrail_identifier: Identifier for the guardrail, could be the id or the arn
    ...
    def guardrail_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier for the guardrail, could be the id or the arn
        """
    ...
    def guardrail_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guardrail_identifier", value)

    @property
    @pulumi.getter(name="guardrailVersion")
    def guardrail_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version of the guardrail
        """
    ...
    def guardrail_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AgentInferenceConfigurationArgsDict(TypedDict):
        ...
        """
        maximum_length: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        top_k: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AgentInferenceConfigurationArgs:
    def __init__(__self__, *,
                 maximum_length: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 top_k: Optional[pulumi.Input[builtins.float]] = None,
                 top_p: Optional[pulumi.Input[builtins.float]] = None):
        """
        Configuration for inference in prompt configuration
        :param pulumi.Input[builtins.float] maximum_length: Maximum length of output
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stop_sequences: List of stop sequences
        :param pulumi.Input[builtins.float] temperature: Controls randomness, higher values increase diversity
        :param pulumi.Input[builtins.float] top_k: Sample from the k most likely next tokens
        :param pulumi.Input[builtins.float] top_p: Cumulative probability cutoff for token selection
        """
    ...
    def maximum_length(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Maximum length of output
        """
    ...
    def maximum_length(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def top_k(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Sample from the k most likely next tokens
        """
    ...
    @top_k.setter
    def top_k(self, value: Optional[pulumi.Input[builtins.float]]):
...
class AgentKnowledgeBaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] knowledge_base_id: Identifier for a resource.
...
if not MYPY:
    class AgentMemoryConfigurationArgsDict(TypedDict):
        ...
        """
        storage_days: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AgentMemoryConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 storage_days: Optional[pulumi.Input[builtins.float]] = None):
        """
        Configuration for memory storage
        ...
        :param pulumi.Input[builtins.float] storage_days: Maximum number of days to store session details
        """
    ...
    def storage_days(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Maximum number of days to store session details
        """
    ...
    @storage_days.setter
    def storage_days(self, value: Optional[pulumi.Input[builtins.float]]):
...
class AgentParameterDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of function parameter.
        :param pulumi.Input[builtins.bool] required: Information about if a parameter is required for function call. Default to false.
        """
...
if not MYPY:
    class AgentPromptConfigurationArgsDict(TypedDict):
        ...
        """
        base_prompt_template: NotRequired[pulumi.Input[builtins.str]]
        """
        Base Prompt Template.
        """
        foundation_model: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AgentPromptConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 base_prompt_template: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['AgentAdditionalModelRequestFieldsArgs'] additional_model_request_fields: If the Converse or ConverseStream operations support the model, `additionalModelRequestFields` contains additional inference parameters, beyond the base set of inference parameters in the `inferenceConfiguration` field.
               ...
               For more information, see [Inference request parameters and response fields for foundation models](https://docs.aws.amazon.com/bedrock/latest/userguide/model-parameters.html) .
        :param pulumi.Input[builtins.str] base_prompt_template: Base Prompt Template.
        :param pulumi.Input[builtins.str] foundation_model: The agent's foundation model.
    ...
    def base_prompt_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Base Prompt Template.
        """
    ...
    def base_prompt_template(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AgentPromptOverrideConfigurationArgsDict(TypedDict):
        ...
        """
        override_lambda: NotRequired[pulumi.Input[builtins.str]]
        """
        ARN of a Lambda.
        """
elif False:
...
class AgentPromptOverrideConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 override_lambda: Optional[pulumi.Input[builtins.str]] = None):
        """
        Configuration for prompt override.
        ...
        :param pulumi.Input[builtins.str] override_lambda: ARN of a Lambda.
        """
    ...
    def override_lambda(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of a Lambda.
        """
    ...
    def override_lambda(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AgentS3IdentifierArgs:
    def __init__(__self__, *,
        ...
        """
        The identifier for the S3 resource.
        :param pulumi.Input[builtins.str] s3_bucket_name: A bucket in S3.
        :param pulumi.Input[builtins.str] s3_object_key: A object key in S3.
        """
...
if not MYPY:
    class AgentSessionSummaryConfigurationArgsDict(TypedDict):
        ...
        """
        max_recent_sessions: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AgentSessionSummaryConfigurationArgs:
    def __init__(__self__, *,
                 max_recent_sessions: Optional[pulumi.Input[builtins.float]] = None):
        """
        Configuration for Session Summarization
        :param pulumi.Input[builtins.float] max_recent_sessions: Maximum number of Sessions to Summarize
        """
    ...
    def max_recent_sessions(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Maximum number of Sessions to Summarize
        """
    ...
    def max_recent_sessions(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ApplicationInferenceProfileInferenceProfileModelSourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Various ways to encode a list of models in a CreateInferenceProfile request
        :param pulumi.Input[builtins.str] copy_from: Source arns for a custom inference profile to copy its regional load balancing config from. This
               can either be a foundation model or predefined inference profile ARN.
        """
...
if not MYPY:
    class DataAutomationProjectBlueprintItemArgsDict(TypedDict):
        blueprint_arn: pulumi.Input[builtins.str]
        """
        ARN of a Blueprint
        """
        ...
        """
        blueprint_version: NotRequired[pulumi.Input[builtins.str]]
        """
        Blueprint Version
        """
elif False:
...
class DataAutomationProjectBlueprintItemArgs:
    def __init__(__self__, *,
                 ...
                 blueprint_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] blueprint_arn: ARN of a Blueprint
        :param pulumi.Input['DataAutomationProjectBlueprintStage'] blueprint_stage: The blueprint's stage.
        :param pulumi.Input[builtins.str] blueprint_version: Blueprint Version
        """
    ...
    def blueprint_arn(self) -> pulumi.Input[builtins.str]:
        """
        ARN of a Blueprint
        """
    ...
    def blueprint_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def blueprint_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Blueprint Version
        """
...
class DataSourceBedrockFoundationModelConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Settings for a foundation model used to parse documents for a data source.
        :param pulumi.Input[builtins.str] model_arn: The ARN of the foundation model to use for parsing.
        :param pulumi.Input['DataSourceParsingModality'] parsing_modality: Specifies whether to enable parsing of multimodal data, including both text and/or images.
...
class DataSourceBedrockFoundationModelContextEnrichmentConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model_arn: The Amazon Resource Name (ARN) of the model used to create vector embeddings for the knowledge base.
        """
...
class DataSourceConfluenceSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] credentials_secret_arn: The Amazon Resource Name of an AWS Secrets Manager secret that stores your authentication credentials for your Confluence instance URL. For more information on the key-value pairs that must be included in your secret, depending on your authentication type, see Confluence connection configuration.
        ...
        :param pulumi.Input[builtins.str] host_url: The Confluence host URL or instance URL.
        """
...
class DataSourceFixedSizeChunkingConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configurations for when you choose fixed-size chunking. If you set the chunkingStrategy as NONE, exclude this field.
        :param pulumi.Input[builtins.int] max_tokens: The maximum number of tokens to include in a chunk.
        :param pulumi.Input[builtins.int] overlap_percentage: The percentage of overlap between adjacent chunks of a data source.
        """
...
class DataSourceParsingPromptArgs:
    def __init__(__self__, *,
        ...
        """
        Instructions for interpreting the contents of a document.
        :param pulumi.Input[builtins.str] parsing_prompt_text: Instructions for interpreting the contents of a document.
        """
...
class DataSourceS3DataSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration information to connect to Amazon S3 as your data source.
        :param pulumi.Input[builtins.str] bucket_arn: The ARN of the bucket that contains the data source.
        :param pulumi.Input[builtins.str] bucket_owner_account_id: The account ID for the owner of the S3 bucket.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_prefixes: A list of S3 prefixes that define the object containing the data sources.
        """
...
class DataSourceS3LocationArgs:
    def __init__(__self__, *,
        ...
        """
        An Amazon S3 location.
        :param pulumi.Input[builtins.str] uri: The location's URI
        """
...
class DataSourceSalesforceSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] credentials_secret_arn: The Amazon Resource Name of an AWS Secrets Manager secret that stores your authentication credentials for your Salesforce instance URL. For more information on the key-value pairs that must be included in your secret, depending on your authentication type, see Salesforce connection configuration.
        :param pulumi.Input[builtins.str] host_url: The Salesforce host URL or instance URL.
        """
        pulumi.set(__self__, "auth_type", auth_type)
        pulumi.set(__self__, "credentials_secret_arn", credentials_secret_arn)
        pulumi.set(__self__, "host_url", host_url)
...
class DataSourceSeedUrlArgs:
    def __init__(__self__, *,
        ...
        """
        A seed url object.
        :param pulumi.Input[builtins.str] url: A web url.
        """
...
class DataSourceSemanticChunkingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_tokens: The maximum number of tokens that a chunk can contain.
        """
...
class DataSourceServerSideEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains details about the server-side encryption for the data source.
        :param pulumi.Input[builtins.str] kms_key_arn: The ARN of the AWS KMS key used to encrypt the resource.
        """
...
class DataSourceSharePointSourceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] credentials_secret_arn: The Amazon Resource Name of an AWS Secrets Manager secret that stores your authentication credentials for your SharePoint site/sites. For more information on the key-value pairs that must be included in your secret, depending on your authentication type, see SharePoint connection configuration.
...
class DataSourceTransformationLambdaConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        A Lambda function that processes documents.
        :param pulumi.Input[builtins.str] lambda_arn: The function's ARN identifier.
        """
...
if not MYPY:
    class DataSourceWebCrawlerConfigurationArgsDict(TypedDict):
        ...
        """
        user_agent_header: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DataSourceWebCrawlerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 user_agent_header: Optional[pulumi.Input[builtins.str]] = None):
        """
        Configuration for the web crawler.
        :param pulumi.Input['DataSourceWebCrawlerLimitsArgs'] crawler_limits: The configuration of crawl limits for the web URLs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusion_filters: A list of one or more exclusion regular expression patterns to exclude certain URLs. If you specify an inclusion and exclusion filter/pattern and both match a URL, the exclusion filter takes precedence and the web content of the URL isn’t crawled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_filters: A list of one or more inclusion regular expression patterns to include certain URLs. If you specify an inclusion and exclusion filter/pattern and both match a URL, the exclusion filter takes precedence and the web content of the URL isn’t crawled.
        :param pulumi.Input['DataSourceWebScopeType'] scope: The scope of what is crawled for your URLs.
               
               You can choose to crawl only web pages that belong to the same host or primary domain. For example, only web pages that contain the seed URL "https://docs.aws.amazon.com/bedrock/latest/userguide/" and no other domains. You can choose to include sub domains in addition to the host or primary domain. For example, web pages that contain "aws.amazon.com" can also include sub domain "docs.aws.amazon.com".
        :param pulumi.Input[builtins.str] user_agent: The suffix that will be included in the user agent header.
        :param pulumi.Input[builtins.str] user_agent_header: The full user agent header, including UUID and suffix.
        """
    ...
    def user_agent_header(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The full user agent header, including UUID and suffix.
        """
    ...
    def user_agent_header(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataSourceWebCrawlerLimitsArgs:
    def __init__(__self__, *,
        ...
        """
        Limit settings for the web crawler.
        :param pulumi.Input[builtins.int] max_pages: Maximum number of pages the crawler can crawl.
        :param pulumi.Input[builtins.int] rate_limit: Rate of web URLs retrieved per minute.
        """
...
class FlowAgentFlowNodeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Agent flow node configuration
        :param pulumi.Input[builtins.str] agent_alias_arn: Arn representation of the Agent Alias.
        """
...
if not MYPY:
    class FlowAliasRoutingConfigurationListItemArgsDict(TypedDict):
        ...
        """
        flow_version: NotRequired[pulumi.Input[builtins.str]]
        """
        Version.
        """
elif False:
...
class FlowAliasRoutingConfigurationListItemArgs:
    def __init__(__self__, *,
                 flow_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Details about the routing configuration for a Flow alias.
        :param pulumi.Input[builtins.str] flow_version: Version.
        """
    ...
    def flow_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version.
        """
    ...
    @flow_version.setter
    def flow_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowConditionalConnectionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Conditional connection configuration
        :param pulumi.Input[builtins.str] condition: Name of a condition in a flow
        """
...
class FlowConditionArgs:
    def __init__(__self__, *,
        ...
        """
        Condition branch for a condition node
        :param pulumi.Input[builtins.str] name: Name of a condition in a flow
        :param pulumi.Input[builtins.str] expression: Expression for a condition in a flow
        """
        pulumi.set(__self__, "name", name)
...
class FlowConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        Flow connection
        :param pulumi.Input[builtins.str] name: Name of a connection in a flow
        :param pulumi.Input[builtins.str] source: Name of a node in a flow
        :param pulumi.Input[builtins.str] target: Name of a node in a flow
...
class FlowDataConnectionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Data connection configuration
        :param pulumi.Input[builtins.str] source_output: Name of a node output in a flow
        :param pulumi.Input[builtins.str] target_input: Name of a node input in a flow
        """
...
class FlowLambdaFunctionFlowNodeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Lambda function flow node configuration
        :param pulumi.Input[builtins.str] lambda_arn: ARN of a Lambda.
        """
        pulumi.set(__self__, "lambda_arn", lambda_arn)
...
class FlowLexFlowNodeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Lex flow node configuration
        :param pulumi.Input[builtins.str] bot_alias_arn: ARN of a Lex bot alias
        :param pulumi.Input[builtins.str] locale_id: Lex bot locale id
        """
...
class FlowNodeOutputArgs:
    def __init__(__self__, *,
        ...
        """
        Output of a node in a flow
        :param pulumi.Input[builtins.str] name: Name of a node output in a flow
...
class FlowPromptInputVariableArgs:
    def __init__(__self__, *,
        ...
        """
        Input variable
        :param pulumi.Input[builtins.str] name: Name for an input variable
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
if not MYPY:
    class FlowPromptModelInferenceConfigurationArgsDict(TypedDict):
        ...
        """
        max_tokens: NotRequired[pulumi.Input[builtins.float]]
        """
        Maximum length of output
        """
        stop_sequences: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
...
class FlowPromptModelInferenceConfigurationArgs:
    def __init__(__self__, *,
                 max_tokens: Optional[pulumi.Input[builtins.float]] = None,
                 stop_sequences: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 temperature: Optional[pulumi.Input[builtins.float]] = None,
                 top_p: Optional[pulumi.Input[builtins.float]] = None):
        """
        Prompt model inference configuration
        :param pulumi.Input[builtins.float] max_tokens: Maximum length of output
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stop_sequences: List of stop sequences
        :param pulumi.Input[builtins.float] temperature: Controls randomness, higher values increase diversity
        :param pulumi.Input[builtins.float] top_p: Cumulative probability cutoff for token selection
        """
    ...
    @property
    @pulumi.getter(name="maxTokens")
    def max_tokens(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Maximum length of output
        """
        return pulumi.get(self, "max_tokens")
    ...
    @max_tokens.setter
    def max_tokens(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_tokens", value)
...
class FlowRetrievalFlowNodeS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        s3 Retrieval configuration for Retrieval node
        :param pulumi.Input[builtins.str] bucket_name: bucket name of an s3 that will be used for Retrieval flow node configuration
        """
...
class FlowS3LocationArgs:
    def __init__(__self__, *,
        ...
        """
        A bucket, key and optional version pointing to an S3 object containing a UTF-8 encoded JSON string Definition with the same schema as the Definition property of this resource
        :param pulumi.Input[builtins.str] bucket: A bucket in S3
        :param pulumi.Input[builtins.str] key: A object key in S3
        :param pulumi.Input[builtins.str] version: The version of the the S3 object to use
        """
...
class FlowStorageFlowNodeS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        s3 storage configuration for storage node
        :param pulumi.Input[builtins.str] bucket_name: bucket name of an s3 that will be used for storage flow node configuration
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
class FlowTextPromptTemplateConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for text prompt template
        :param pulumi.Input[builtins.str] text: Prompt content for String prompt template
...
class GuardrailContentFilterConfigArgs:
    def __init__(__self__, *,
                 ...
                 input_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 output_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def input_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def output_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class KnowledgeBaseBedrockEmbeddingModelConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The vector configuration details for the Bedrock embeddings model.
        :param pulumi.Input[builtins.int] dimensions: The dimensions details for the vector configuration used on the Bedrock embeddings model.
...
if not MYPY:
    class KnowledgeBaseCuratedQueryArgsDict(TypedDict):
        ...
        """
        natural_language: pulumi.Input[builtins.str]
...
class KnowledgeBaseCuratedQueryArgs:
    ...
    def natural_language(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "natural_language")

    @natural_language.setter
    def natural_language(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class KnowledgeBaseKendraKnowledgeBaseConfigurationArgsDict(TypedDict):
        ...
        """
        kendra_index_arn: pulumi.Input[builtins.str]
        """
...
class KnowledgeBaseKendraKnowledgeBaseConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configurations for a Kendra knowledge base
        :param pulumi.Input[builtins.str] kendra_index_arn: The ARN of the Amazon Kendra index.
        """
        pulumi.set(__self__, "kendra_index_arn", kendra_index_arn)

    @property
    @pulumi.getter(name="kendraIndexArn")
    def kendra_index_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the Amazon Kendra index.
        """
    ...
    def kendra_index_arn(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class KnowledgeBaseMongoDbAtlasConfigurationArgsDict(TypedDict):
        ...
        """
        endpoint_service_name: NotRequired[pulumi.Input[builtins.str]]
        """
        MongoDB Atlas endpoint service name.
        """
        text_index_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KnowledgeBaseMongoDbAtlasConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 text_index_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Contains the storage configuration of the knowledge base in MongoDb Atlas Cloud.
        :param pulumi.Input[builtins.str] collection_name: Name of the collection within MongoDB Atlas.
        :param pulumi.Input[builtins.str] credentials_secret_arn: The ARN of the secret that you created in AWS Secrets Manager that is linked to your Amazon Mongo database.
        :param pulumi.Input[builtins.str] database_name: Name of the database within MongoDB Atlas.
        :param pulumi.Input[builtins.str] endpoint: MongoDB Atlas endpoint.
        ...
        :param pulumi.Input[builtins.str] vector_index_name: Name of a MongoDB Atlas index.
        :param pulumi.Input[builtins.str] endpoint_service_name: MongoDB Atlas endpoint service name.
        :param pulumi.Input[builtins.str] text_index_name: Name of a MongoDB Atlas text index.
        """
    ...
    def text_index_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of a MongoDB Atlas text index.
        """
    ...
    def text_index_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KnowledgeBaseMongoDbAtlasFieldMappingArgs:
    def __init__(__self__, *,
        ...
        """
        Contains the names of the fields to which to map information about the vector store.
        :param pulumi.Input[builtins.str] metadata_field: The name of the field in which Amazon Bedrock stores metadata about the vector store.
        :param pulumi.Input[builtins.str] text_field: The name of the field in which Amazon Bedrock stores the raw text from your data. The text is split according to the chunking strategy you choose.
        :param pulumi.Input[builtins.str] vector_field: The name of the field in which Amazon Bedrock stores the vector embeddings for your data sources.
        """
...
class KnowledgeBaseNeptuneAnalyticsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] graph_arn: ARN for Neptune Analytics graph database.
        """
        pulumi.set(__self__, "field_mapping", field_mapping)
...
if not MYPY:
    class KnowledgeBaseOpenSearchManagedClusterConfigurationArgsDict(TypedDict):
        ...
        """
        domain_endpoint: pulumi.Input[builtins.str]
        """
...
class KnowledgeBaseOpenSearchManagedClusterConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains the storage configuration of the knowledge base in Amazon OpenSearch Service.
        :param pulumi.Input[builtins.str] domain_arn: The Amazon Resource Name (ARN) of the OpenSearch domain.
        :param pulumi.Input[builtins.str] domain_endpoint: The endpoint URL the OpenSearch domain.
        ...
        :param pulumi.Input[builtins.str] vector_index_name: The name of the vector store.
        """
    ...
    def domain_endpoint(self) -> pulumi.Input[builtins.str]:
        """
        The endpoint URL the OpenSearch domain.
        """
    ...
    def domain_endpoint(self, value: pulumi.Input[builtins.str]):
...
class KnowledgeBaseOpenSearchServerlessConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains the storage configuration of the knowledge base in Amazon OpenSearch Service.
        :param pulumi.Input[builtins.str] collection_arn: The ARN of the OpenSearch Service vector store.
...
class KnowledgeBasePineconeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains the storage configuration of the knowledge base in Pinecone.
        :param pulumi.Input[builtins.str] connection_string: The endpoint URL for your index management page.
        :param pulumi.Input[builtins.str] credentials_secret_arn: The ARN of the secret that you created in AWS Secrets Manager that is linked to your Pinecone API key.
        ...
        :param pulumi.Input[builtins.str] namespace: The namespace to be used to write new data to your database.
        """
...
if not MYPY:
    class KnowledgeBaseQueryGenerationConfigurationArgsDict(TypedDict):
        ...
        """
        execution_timeout_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class KnowledgeBaseQueryGenerationConfigurationArgs:
    def __init__(__self__, *,
                 execution_timeout_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 generation_context: Optional[pulumi.Input['KnowledgeBaseQueryGenerationContextArgs']] = None):
        """
        Configurations for generating Redshift engine queries
        :param pulumi.Input[builtins.int] execution_timeout_seconds: The time after which query generation will time out.
    ...
    def execution_timeout_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The time after which query generation will time out.
        """
    ...
    def execution_timeout_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class KnowledgeBaseRdsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains details about the storage configuration of the knowledge base in Amazon RDS. For more information, see Create a vector index in Amazon RDS.
        :param pulumi.Input[builtins.str] credentials_secret_arn: The ARN of the secret that you created in AWS Secrets Manager that is linked to your Amazon RDS database.
        :param pulumi.Input[builtins.str] database_name: The name of your Amazon RDS database.
        ...
        :param pulumi.Input[builtins.str] resource_arn: The ARN of the vector store.
...
if not MYPY:
    class KnowledgeBaseRdsFieldMappingArgsDict(TypedDict):
        ...
        The name of the field in which Amazon Bedrock stores the vector embeddings for your data sources.
        """
        custom_metadata_field: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KnowledgeBaseRdsFieldMappingArgs:
    def __init__(__self__, *,
                 ...
                 text_field: pulumi.Input[builtins.str],
                 vector_field: pulumi.Input[builtins.str],
                 custom_metadata_field: Optional[pulumi.Input[builtins.str]] = None):
        """
        Contains the names of the fields to which to map information about the vector store.
        :param pulumi.Input[builtins.str] metadata_field: The name of the field in which Amazon Bedrock stores metadata about the vector store.
        :param pulumi.Input[builtins.str] primary_key_field: The name of the field in which Amazon Bedrock stores the ID for each entry.
        :param pulumi.Input[builtins.str] text_field: The name of the field in which Amazon Bedrock stores the raw text from your data. The text is split according to the chunking strategy you choose.
        :param pulumi.Input[builtins.str] vector_field: The name of the field in which Amazon Bedrock stores the vector embeddings for your data sources.
        :param pulumi.Input[builtins.str] custom_metadata_field: The name of the field in which Amazon Bedrock stores custom metadata about the vector store.
        """
        pulumi.set(__self__, "metadata_field", metadata_field)
    ...
    def custom_metadata_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the field in which Amazon Bedrock stores custom metadata about the vector store.
        """
    ...
    def custom_metadata_field(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class KnowledgeBaseRedshiftProvisionedAuthConfigurationArgsDict(TypedDict):
        ...
        """
        database_user: NotRequired[pulumi.Input[builtins.str]]
        """
        Redshift database user
        """
        username_password_secret_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KnowledgeBaseRedshiftProvisionedAuthConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 username_password_secret_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        Configurations for Redshift query engine provisioned auth setup
        :param pulumi.Input['KnowledgeBaseRedshiftProvisionedAuthType'] type: The type of authentication to use.
        :param pulumi.Input[builtins.str] database_user: Redshift database user
        :param pulumi.Input[builtins.str] username_password_secret_arn: The ARN of an Secrets Manager secret for authentication.
        """
        pulumi.set(__self__, "type", type)
    ...
    def username_password_secret_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of an Secrets Manager secret for authentication.
        """
    ...
    def username_password_secret_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KnowledgeBaseRedshiftProvisionedConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_identifier: The ID of the Amazon Redshift cluster.
        """
...
if not MYPY:
    class KnowledgeBaseRedshiftServerlessConfigurationArgsDict(TypedDict):
        ...
        """
        workgroup_arn: pulumi.Input[builtins.str]
        """
...
class KnowledgeBaseRedshiftServerlessConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] workgroup_arn: The ARN of the Amazon Redshift workgroup.
        """
        pulumi.set(__self__, "auth_configuration", auth_configuration)
    ...
    def workgroup_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the Amazon Redshift workgroup.
        """
    ...
    def workgroup_arn(self, value: pulumi.Input[builtins.str]):
...
class KnowledgeBaseVectorKnowledgeBaseConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Contains details about the model used to create vector embeddings for the knowledge base.
        :param pulumi.Input[builtins.str] embedding_model_arn: The ARN of the model used to create vector embeddings for the knowledge base.
...
class PromptAgentResourceArgs:
    def __init__(__self__, *,
        ...
        """
        Target Agent to invoke with Prompt
        :param pulumi.Input[builtins.str] agent_identifier: Arn representation of the Agent Alias.
        """
...
class PromptContentBlock0PropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for chat prompt template
        :param pulumi.Input[builtins.str] text: Configuration for chat prompt template
        """
        pulumi.set(__self__, "text", text)
...
class PromptSpecificToolChoiceArgs:
    def __init__(__self__, *,
        ...
        """
        Specific Tool choice
        :param pulumi.Input[builtins.str] name: Tool name
        """
        pulumi.set(__self__, "name", name)
...
class PromptVariantArgs:
    def __init__(__self__, *,
        ...
        """
        Prompt variant
        :param pulumi.Input[builtins.str] name: Name for a variant.
