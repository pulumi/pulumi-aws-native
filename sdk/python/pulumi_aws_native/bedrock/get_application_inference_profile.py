...
class GetApplicationInferenceProfileResult:
    ...
    def inference_profile_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def inference_profile_id(self) -> Optional[_builtins.str]:
        """
    ...
    def inference_profile_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_application_inference_profile(inference_profile_identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str inference_profile_identifier: Inference profile identifier. Supports both system-defined inference profile ids, and inference profile ARNs.
    """
    __args__ = dict()
...
def get_application_inference_profile_output(inference_profile_identifier: Optional[pulumi.Input[_builtins.str]] = None,
