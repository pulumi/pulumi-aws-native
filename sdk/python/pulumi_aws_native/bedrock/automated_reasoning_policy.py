...
class AutomatedReasoningPolicyArgs:
    def __init__(__self__, *,
                 ...
                 policy_definition: pulumi.Input[Optional['AutomatedReasoningPolicyPolicyDefinitionArgs']] = None,
    ...
    def policy_definition(self) -> pulumi.Input[Optional['AutomatedReasoningPolicyPolicyDefinitionArgs']]:
        """
    ...
    def policy_definition(self, value: pulumi.Input[Optional['AutomatedReasoningPolicyPolicyDefinitionArgs']]):
...
class AutomatedReasoningPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kms_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_definition: pulumi.Input[Optional[Union['AutomatedReasoningPolicyPolicyDefinitionArgs', 'AutomatedReasoningPolicyPolicyDefinitionArgsDict', 'outputs.AutomatedReasoningPolicyPolicyDefinition']]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: The description of the policy.
        :param pulumi.Input[_builtins.str] name: The name of the policy.
        :param pulumi.Input[Union['AutomatedReasoningPolicyPolicyDefinitionArgs', 'AutomatedReasoningPolicyPolicyDefinitionArgsDict', 'outputs.AutomatedReasoningPolicyPolicyDefinition']] policy_definition: The complete policy definition generated by the build workflow, containing all rules, variables, and custom types extracted from the source documents.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags associated with the Automated Reasoning policy.
        """
        ...
    @overload
    def __init__(__self__,
