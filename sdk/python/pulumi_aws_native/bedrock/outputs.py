...
class DataAutomationProjectBlueprintItem(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str blueprint_version: Blueprint Version
        """
    ...
    def blueprint_version(self) -> Optional[str]:
        """
        Blueprint Version
        """
...
class DataSourceBedrockFoundationModelContextEnrichmentConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str model_arn: The Amazon Resource Name (ARN) of the foundation model used for context enrichment.
        """
