...
def get_automated_reasoning_policy(policy_arn: Optional[builtins.str] = None,
...
def get_automated_reasoning_policy_output(policy_arn: Optional[pulumi.Input[builtins.str]] = None,
