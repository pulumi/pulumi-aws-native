...
class AnnotationStore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(reference, AnnotationStoreReferenceItemArgs):
                reference = reference or {}
                def _setter(key, value):
                    reference[key] = value
                AnnotationStoreReferenceItemArgs._configure(_setter, **reference)
            __props__.__dict__["reference"] = reference
            if not isinstance(sse_config, AnnotationStoreSseConfigArgs):
            ...
            if not isinstance(store_options, AnnotationStoreStoreOptionsPropertiesArgs):
            ...
            if not isinstance(tags, AnnotationStoreTagMapArgs):
                tags = tags or {}
                def _setter(key, value):
                    tags[key] = value
