...
class GetReferenceStoreResult:
    ...
    def reference_store_id(self) -> Optional[builtins.str]:
        """
        The store's ID.
        """
...
def get_reference_store(reference_store_id: Optional[builtins.str] = None,
    ...
    :param builtins.str reference_store_id: The store's ID.
    """
    __args__ = dict()
...
def get_reference_store_output(reference_store_id: Optional[pulumi.Input[builtins.str]] = None,
