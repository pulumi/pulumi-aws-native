...
class ReferenceStoreArgs:
    def __init__(__self__, *,
                 ...
                 sse_config: pulumi.Input[Optional['ReferenceStoreSseConfigArgs']] = None,
    ...
    def sse_config(self) -> pulumi.Input[Optional['ReferenceStoreSseConfigArgs']]:
        """
    ...
    @sse_config.setter
    def sse_config(self, value: pulumi.Input[Optional['ReferenceStoreSseConfigArgs']]):
...
class ReferenceStore(pulumi.CustomResource):
    ...
    def reference_store_id(self) -> pulumi.Output[_builtins.str]:
        """
        The store's ID.
        """
