...
def get_annotation_store(name: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnnotationStoreResult:
    """
    Definition of AWS::Omics::AnnotationStore Resource Type


    :param builtins.str name: The name of the Annotation Store.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_annotation_store_output(name: Optional[pulumi.Input[builtins.str]] = None,
