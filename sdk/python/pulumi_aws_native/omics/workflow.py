...
class WorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] storage_capacity: The default static storage capacity (in gibibytes) for runs that use this workflow or workflow version.
