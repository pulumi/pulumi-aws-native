...
class ConfigurationRunConfigurationsArgsDict(TypedDict):
    vpc_config: NotRequired[pulumi.Input[Optional['ConfigurationVpcConfigArgs']]]
...
class WorkflowContainerRegistryMapArgsDict(TypedDict):
    image_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkflowImageMappingArgs']]]]]
    """
    Image mappings specify path mappings between the ECR private repository and their corresponding external repositories.
    """
    registry_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkflowRegistryMappingArgs']]]]]
    """
...
class WorkflowDefinitionRepositoryArgsDict(TypedDict):
    ...
    """
    source_reference: NotRequired[pulumi.Input[Optional['WorkflowSourceReferenceArgs']]]
    """
...
class WorkflowVersionContainerRegistryMapArgsDict(TypedDict):
    image_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkflowVersionImageMappingArgs']]]]]
    """
    Image mappings specify path mappings between the ECR private repository and their corresponding external repositories.
    """
    registry_mappings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkflowVersionRegistryMappingArgs']]]]]
    """
    Mapping that provides the ECR repository path where upstream container images are pulled and synchronized.
    """
...
class WorkflowVersionDefinitionRepositoryArgsDict(TypedDict):
    ...
    The full repository identifier, including the repository owner and name. For example, 'repository-owner/repository-name'.
    """
    source_reference: NotRequired[pulumi.Input[Optional['WorkflowVersionSourceReferenceArgs']]]
    """
    The source reference for the repository, such as a branch name, tag, or commit ID.
    """
