...
if not MYPY:
    class AccountExpiryEventsConfigurationArgsDict(TypedDict):
        days_before_expiry: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AccountExpiryEventsConfigurationArgs:
    def __init__(__self__, *,
                 days_before_expiry: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] days_before_expiry: This option specifies the number of days prior to certificate expiration when ACM starts generating `EventBridge` events. ACM sends one event per day per certificate until the certificate expires. By default, accounts receive events starting 45 days before certificate expiration.
        """
    ...
    def days_before_expiry(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This option specifies the number of days prior to certificate expiration when ACM starts generating `EventBridge` events. ACM sends one event per day per certificate until the certificate expires. By default, accounts receive events starting 45 days before certificate expiration.
        """
    ...
    def days_before_expiry(self, value: Optional[pulumi.Input[builtins.int]]):
