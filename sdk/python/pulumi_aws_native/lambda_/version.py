...
class VersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] code_sha256: Only publish a version if the hash value matches the value that's specified. Use this option to avoid publishing a version if the function code has changed since you last updated it. Updates are not supported for this property.
        :param pulumi.Input[builtins.str] description: A description for the version to override the description in the function configuration. Updates are not supported for this property.
...
class Version(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="codeSha256")
    def code_sha256(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Only publish a version if the hash value matches the value that's specified. Use this option to avoid publishing a version if the function code has changed since you last updated it. Updates are not supported for this property.
        """
        return pulumi.get(self, "code_sha256")
