...
class LayerVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_architectures: A list of compatible instruction set architectures.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_runtimes: A list of compatible function runtimes. Used for filtering with ListLayers and ListLayerVersions.
        :param pulumi.Input[builtins.str] description: The description of the version.
        :param pulumi.Input[builtins.str] layer_name: The name or Amazon Resource Name (ARN) of the layer.
        :param pulumi.Input[builtins.str] license_info: The layer's software license.
        """
...
class LayerVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="layerName")
    def layer_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name or Amazon Resource Name (ARN) of the layer.
        """
        return pulumi.get(self, "layer_name")
