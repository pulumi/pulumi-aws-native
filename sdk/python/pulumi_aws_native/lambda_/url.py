...
class UrlArgs:
    def __init__(__self__, *,
                 ...
                 target_function_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] target_function_arn: The Amazon Resource Name (ARN) of the function associated with the Function URL.
        ...
        :param pulumi.Input[builtins.str] qualifier: The alias qualifier for the target function. If TargetFunctionArn is unqualified then Qualifier must be passed.
        """
    ...
    def target_function_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_function_arn(self, value: pulumi.Input[builtins.str]):
...
class Url(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 invoke_mode: Optional[pulumi.Input['UrlInvokeMode']] = None,
                 qualifier: Optional[pulumi.Input[builtins.str]] = None,
                 target_function_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="targetFunctionArn")
    def target_function_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the function associated with the Function URL.
        """
        return pulumi.get(self, "target_function_arn")
