...
class UrlArgs:
    ...
    def target_function_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def target_function_arn(self, value: pulumi.Input[_builtins.str]):
...
class Url(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="targetFunctionArn")
    def target_function_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The Amazon Resource Name (ARN) of the function associated with the Function URL.
        """
        return pulumi.get(self, "target_function_arn")
