...
class CodeSigningConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(allowed_publishers, CodeSigningConfigAllowedPublishersArgs):
            ...
            if not isinstance(code_signing_policies, CodeSigningConfigCodeSigningPoliciesArgs):
