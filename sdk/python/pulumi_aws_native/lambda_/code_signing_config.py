...
class CodeSigningConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the CodeSigningConfig
...
class CodeSigningConfig(pulumi.CustomResource):
    ...
    def code_signing_config_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def code_signing_config_id(self) -> pulumi.Output[builtins.str]:
        """
