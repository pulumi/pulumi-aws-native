...
class EventInvokeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] maximum_event_age_in_seconds: The maximum age of a request that Lambda sends to a function for processing.
        :param pulumi.Input[_builtins.int] maximum_retry_attempts: The maximum number of times to retry when the function returns an error.
        """
