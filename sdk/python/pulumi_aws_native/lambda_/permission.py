...
class PermissionArgs:
    def __init__(__self__, *,
                 ...
                 function_url_auth_type: pulumi.Input[Optional['PermissionFunctionUrlAuthType']] = None,
        ...
        :param pulumi.Input[_builtins.str] action: The action that the principal can use on the function. For example, ``lambda:InvokeFunction`` or ``lambda:GetFunction``.
        :param pulumi.Input[_builtins.str] function_name: The name or ARN of the Lambda function, version, or alias.
                 **Name formats**
        ...
        :param pulumi.Input['PermissionFunctionUrlAuthType'] function_url_auth_type: The type of authentication that your function URL uses. Set to ``AWS_IAM`` if you want to restrict access to authenticated users only. Set to ``NONE`` if you want to bypass IAM authentication to create a public endpoint. For more information, see [Control access to Lambda function URLs](https://docs.aws.amazon.com/lambda/latest/dg/urls-auth.html).
        :param pulumi.Input[_builtins.bool] invoked_via_function_url: Indicates whether the permission applies when the function is invoked through a function URL.
    ...
    def function_url_auth_type(self) -> pulumi.Input[Optional['PermissionFunctionUrlAuthType']]:
        """
    ...
    def function_url_auth_type(self, value: pulumi.Input[Optional['PermissionFunctionUrlAuthType']]):
