...
def get_alias(alias_arn: Optional[_builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAliasResult:
    """
    Resource Type definition for AWS::Lambda::Alias


    :param _builtins.str alias_arn: Lambda Alias ARN generated by the service.
    """
    __args__ = dict()
...
def get_alias_output(alias_arn: Optional[pulumi.Input[_builtins.str]] = None,
