...
class GetAliasResult:
    ...
    def alias_arn(self) -> Optional[builtins.str]:
        """
...
def get_alias(alias_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAliasResult:
    """
    Resource Type definition for AWS::Lambda::Alias


    :param builtins.str alias_arn: Lambda Alias ARN generated by the service.
    """
    __args__ = dict()
...
def get_alias_output(alias_arn: Optional[pulumi.Input[builtins.str]] = None,
