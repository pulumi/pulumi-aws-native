...
class AliasRoutingConfigurationArgsDict(TypedDict):
    ...
    """
    additional_version_weights: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AliasVersionWeightArgs']]]]]
    """
...
class CapacityProviderInstanceRequirementsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_instance_types: A list of EC2 instance types that the capacity provider is allowed to use. If not specified, all compatible instance types are allowed.
        :param pulumi.Input[Sequence[pulumi.Input['CapacityProviderArchitecture']]] architectures: A list of supported CPU architectures for compute instances. Valid values include ``x86_64`` and ``arm64``.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] excluded_instance_types: A list of EC2 instance types that the capacity provider should not use, even if they meet other requirements.
        """
...
class CapacityProviderPermissionsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] capacity_provider_operator_role_arn: The ARN of the IAM role that the capacity provider uses to manage compute instances and other AWS resources.
        """
...
class CapacityProviderScalingConfigArgsDict(TypedDict):
    ...
    """
    scaling_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CapacityProviderTargetTrackingScalingPolicyArgs']]]]]
    """
...
class CapacityProviderScalingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_v_cpu_count: The maximum number of vCPUs that the capacity provider can provision across all compute instances.
...
class CapacityProviderTargetTrackingScalingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] target_value: The target value for the metric that the scaling policy attempts to maintain through scaling actions.
        """
...
class CapacityProviderVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: A list of security group IDs that control network access for compute instances managed by the capacity provider.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: A list of subnet IDs where the capacity provider launches compute instances.
        """
...
class EventInvokeConfigDestinationConfigArgsDict(TypedDict):
    ...
    """
    on_failure: NotRequired[pulumi.Input[Optional['EventInvokeConfigOnFailureArgs']]]
    """
    The destination configuration for failed invocations.

    > When using an Amazon SQS queue as a destination, FIFO queues cannot be used.
    """
    on_success: NotRequired[pulumi.Input[Optional['EventInvokeConfigOnSuccessArgs']]]
    """
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigArgsDict(TypedDict):
    ...
    """
    schema_registry_config: NotRequired[pulumi.Input[Optional['EventSourceMappingSchemaRegistryConfigArgs']]]
    """
...
class EventSourceMappingDestinationConfigArgsDict(TypedDict):
    ...
    """
    on_failure: NotRequired[pulumi.Input[Optional['EventSourceMappingOnFailureArgs']]]
    """
    The destination configuration for failed invocations.
    """
...
class EventSourceMappingFilterCriteriaArgsDict(TypedDict):
    ...
    """
    filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EventSourceMappingFilterArgs']]]]]
    """
    A list of filters.
    """
...
class EventSourceMappingSchemaRegistryConfigArgsDict(TypedDict):
    ...
    Specific configuration settings for a Kafka schema registry.
    """
    access_configs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EventSourceMappingSchemaRegistryAccessConfigArgs']]]]]
    """
    ...
    """
    schema_validation_configs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EventSourceMappingSchemaValidationConfigArgs']]]]]
    """
...
class EventSourceMappingSelfManagedEventSourceArgsDict(TypedDict):
    ...
    """
    endpoints: NotRequired[pulumi.Input[Optional['EventSourceMappingEndpointsArgs']]]
    """
    The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
    """
