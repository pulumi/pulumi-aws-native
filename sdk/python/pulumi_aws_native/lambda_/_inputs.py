...
class AliasProvisionedConcurrencyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        A provisioned concurrency configuration for a function's alias.
        :param pulumi.Input[builtins.int] provisioned_concurrent_executions: The amount of provisioned concurrency to allocate for the alias.
        """
    ...
    def provisioned_concurrent_executions(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class AliasVersionWeightArgsDict(TypedDict):
        ...
        """
        function_weight: pulumi.Input[builtins.float]
        """
...
class AliasVersionWeightArgs:
    def __init__(__self__, *,
        ...
        """
        The traffic-shifting configuration of a Lambda function alias.
        :param pulumi.Input[builtins.str] function_version: The qualifier of the second version.
        :param pulumi.Input[builtins.float] function_weight: The percentage of traffic that the alias routes to the second version.
        """
    ...
    def function_weight(self) -> pulumi.Input[builtins.float]:
        """
        The percentage of traffic that the alias routes to the second version.
        """
    ...
    def function_weight(self, value: pulumi.Input[builtins.float]):
...
class CodeSigningConfigAllowedPublishersArgs:
    def __init__(__self__, *,
        ...
        """
        When the CodeSigningConfig is later on attached to a function, the function code will be expected to be signed by profiles from this list
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] signing_profile_version_arns: List of Signing profile version Arns
        """
...
if not MYPY:
    class EventSourceMappingEndpointsArgsDict(TypedDict):
        ...
        """
        kafka_bootstrap_servers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        """
elif False:
...
class EventSourceMappingEndpointsArgs:
    def __init__(__self__, *,
                 kafka_bootstrap_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] kafka_bootstrap_servers: The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        """
    ...
    def kafka_bootstrap_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        """
    ...
    def kafka_bootstrap_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class EventSourceMappingFilterArgs:
    def __init__(__self__, *,
        ...
        """
        A structure within a ``FilterCriteria`` object that defines an event filtering pattern.
        :param pulumi.Input[builtins.str] pattern: A filter pattern. For more information on the syntax of a filter pattern, see [Filter rule syntax](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html#filtering-syntax).
        """
...
class EventSourceMappingProvisionedPollerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The [provisioned mode](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode) configuration for the event source. Use provisioned mode to customize the minimum and maximum number of event pollers for your event source.
        :param pulumi.Input[builtins.int] maximum_pollers: The maximum number of event pollers this event source can scale up to.
        :param pulumi.Input[builtins.int] minimum_pollers: The minimum number of event pollers this event source can scale down to.
        """
...
class EventSourceMappingScalingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        (Amazon SQS only) The scaling configuration for the event source. To remove the configuration, pass an empty value.
        :param pulumi.Input[builtins.int] maximum_concurrency: Limits the number of concurrent instances that the SQS event source can invoke.
        """
...
if not MYPY:
    class FunctionCodeArgsDict(TypedDict):
        ...
        """
        source_kms_key_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FunctionCodeArgs:
    def __init__(__self__, *,
                 ...
                 source_kms_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 zip_file: Optional[pulumi.Input[builtins.str]] = None):
        """
        The [deployment package](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-package.html) for a Lambda function. To deploy a function defined as a container image, you specify the location of a container image in the Amazon ECR registry. For a .zip file deployment package, you can specify the location of an object in Amazon S3. For Node.js and Python functions, you can specify the function code inline in the template.
          When you specify source code inline for a Node.js function, the ``index`` file that CFN creates uses the extension ``.js``. This means that LAM treats the file as a CommonJS module. ES modules aren't supported for inline functions.
          Changes to a deployment package in Amazon S3 or a container image in ECR are not detected automatically during stack updates. To update the function code, change the object key or version in the template.
        :param pulumi.Input[builtins.str] image_uri: URI of a [container image](https://docs.aws.amazon.com/lambda/latest/dg/lambda-images.html) in the Amazon ECR registry.
        :param pulumi.Input[builtins.str] s3_bucket: An Amazon S3 bucket in the same AWS-Region as your function. The bucket can be in a different AWS-account.
        :param pulumi.Input[builtins.str] s3_key: The Amazon S3 key of the deployment package.
        :param pulumi.Input[builtins.str] s3_object_version: For versioned objects, the version of the deployment package object to use.
        :param pulumi.Input[builtins.str] source_kms_key_arn: The ARN of the KMSlong (KMS) customer managed key that's used to encrypt your function's .zip deployment package. If you don't provide a customer managed key, Lambda uses an [owned key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-owned-cmk).
        :param pulumi.Input[builtins.str] zip_file: (Node.js and Python) The source code of your Lambda function. If you include your function source inline with this parameter, CFN places it in a file named ``index`` and zips it to create a [deployment package](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-package.html). This zip file cannot exceed 4MB. For the ``Handler`` property, the first part of the handler identifier must be ``index``. For example, ``index.handler``.
                 When you specify source code inline for a Node.js function, the ``index`` file that CFN creates uses the extension ``.js``. This means that LAM treats the file as a CommonJS module. ES modules aren't supported for inline functions.
                  For JSON, you must escape quotes and special characters such as newline (``\\n``) with a backslash.
                If you specify a function that interacts with an AWS CloudFormation custom resource, you don't have to write your own functions to send responses to the custom resource that invoked the function. AWS CloudFormation provides a response module ([cfn-response](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cfn-lambda-function-code-cfnresponsemodule.html)) that simplifies sending responses. See [Using Lambda with CloudFormation](https://docs.aws.amazon.com/lambda/latest/dg/services-cloudformation.html) for details.
        """
    ...
    def source_kms_key_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the KMSlong (KMS) customer managed key that's used to encrypt your function's .zip deployment package. If you don't provide a customer managed key, Lambda uses an [owned key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-owned-cmk).
        """
    ...
    def source_kms_key_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FunctionDeadLetterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The [dead-letter queue](https://docs.aws.amazon.com/lambda/latest/dg/invocation-async-retain-records.html#invocation-dlq) for failed asynchronous invocations.
        :param pulumi.Input[builtins.str] target_arn: The Amazon Resource Name (ARN) of an Amazon SQS queue or Amazon SNS topic.
        """
...
class FunctionEnvironmentArgs:
    def __init__(__self__, *,
        ...
        """
        A function's environment variable settings. You can use environment variables to adjust your function's behavior without updating code. An environment variable is a pair of strings that are stored in a function's version-specific configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: Environment variable key-value pairs. For more information, see [Using Lambda environment variables](https://docs.aws.amazon.com/lambda/latest/dg/configuration-envvars.html).
                If the value of the environment variable is a time or a duration, enclose the value in quotes.
        """
...
class FunctionEphemeralStorageArgs:
    def __init__(__self__, *,
        ...
        """
        The size of the function's ``/tmp`` directory in MB. The default value is 512, but it can be any whole number between 512 and 10,240 MB.
        :param pulumi.Input[builtins.int] size: The size of the function's ``/tmp`` directory.
        """
...
class FunctionFileSystemConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Details about the connection between a Lambda function and an [Amazon EFS file system](https://docs.aws.amazon.com/lambda/latest/dg/configuration-filesystem.html).
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Amazon EFS access point that provides access to the file system.
        :param pulumi.Input[builtins.str] local_mount_path: The path where the function can access the file system, starting with ``/mnt/``.
        """
...
class FunctionImageConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration values that override the container image Dockerfile settings. For more information, see [Container image settings](https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command: Specifies parameters that you want to pass in with ENTRYPOINT. You can specify a maximum of 1,500 parameters in the list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entry_point: Specifies the entry point to their application, which is typically the location of the runtime executable. You can specify a maximum of 1,500 string entries in the list.
        :param pulumi.Input[builtins.str] working_directory: Specifies the working directory. The length of the directory string cannot exceed 1,000 characters.
        """
...
class FunctionLoggingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_group: The name of the Amazon CloudWatch log group the function sends logs to. By default, Lambda functions send logs to a default log group named ``/aws/lambda/<function name>``. To use a different log group, enter an existing log group or enter a new log group name.
...
if not MYPY:
    class FunctionRuntimeManagementConfigArgsDict(TypedDict):
        ...
        """
        runtime_version_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FunctionRuntimeManagementConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FunctionRuntimeManagementConfigUpdateRuntimeOn'] update_runtime_on: Specify the runtime update mode.
                ...
                *Valid Values*: ``Auto`` | ``FunctionUpdate`` | ``Manual``
        :param pulumi.Input[builtins.str] runtime_version_arn: The ARN of the runtime version you want the function to use.
                 This is only required if you're using the *Manual* runtime update mode.
        """
...
class FunctionVpcConfigArgs:
    def __init__(__self__, *,
        ...
        The VPC security groups and subnets that are attached to a Lambda function. When you connect a function to a VPC, Lambda creates an elastic network interface for each combination of security group and subnet in the function's VPC configuration. The function can only access resources and the internet through that VPC. For more information, see [VPC Settings](https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html).
          When you delete a function, CFN monitors the state of its network interfaces and waits for Lambda to delete them before proceeding. If the VPC is defined in the same stack, the network interfaces need to be deleted by Lambda before CFN can delete the VPC's resources.
         To monitor network interfaces, CFN needs the ``ec2:DescribeNetworkInterfaces`` permission. It obtains this from the user or role that modifies the stack. If you don't provide this permission, CFN does not wait for network interfaces to be deleted.
        :param pulumi.Input[builtins.bool] ipv6_allowed_for_dual_stack: Allows outbound IPv6 traffic on VPC functions that are connected to dual-stack subnets.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of VPC security group IDs.
...
class LayerVersionContentArgs:
    def __init__(__self__, *,
                 ...
                 s3_object_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_bucket: The Amazon S3 bucket of the layer archive.
        :param pulumi.Input[builtins.str] s3_key: The Amazon S3 key of the layer archive.
        :param pulumi.Input[builtins.str] s3_object_version: For versioned objects, the version of the layer archive object to use.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_key", s3_key)
        if s3_object_version is not None:
...
class UrlCorsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] allow_credentials: Specifies whether credentials are included in the CORS request.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_headers: Represents a collection of allowed headers.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_origins: Represents a collection of allowed origins.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: Represents a collection of exposed headers.
        :param pulumi.Input[builtins.int] max_age: The maximum amount of time, in seconds, that browsers can cache results of a preflight request. By default, this is set to `0` , which means the browser will not cache results.
        """
...
class VersionProvisionedConcurrencyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        A provisioned concurrency configuration for a function's version.
        :param pulumi.Input[builtins.int] provisioned_concurrent_executions: The amount of provisioned concurrency to allocate for the version.
        """
        pulumi.set(__self__, "provisioned_concurrent_executions", provisioned_concurrent_executions)
...
if not MYPY:
    class VersionRuntimePolicyArgsDict(TypedDict):
        ...
        """
        update_runtime_on: pulumi.Input[builtins.str]
        """
...
class VersionRuntimePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        Runtime Management Config of a function.
        :param pulumi.Input[builtins.str] update_runtime_on: The runtime update mode.
        :param pulumi.Input[builtins.str] runtime_version_arn: The ARN of the runtime the function is configured to use. If the runtime update mode is manual, the ARN is returned, otherwise null is returned.
        """
        pulumi.set(__self__, "update_runtime_on", update_runtime_on)
        if runtime_version_arn is not None:
            pulumi.set(__self__, "runtime_version_arn", runtime_version_arn)
    ...
    @property
    @pulumi.getter(name="updateRuntimeOn")
    def update_runtime_on(self) -> pulumi.Input[builtins.str]:
        """
        The runtime update mode.
        """
        return pulumi.get(self, "update_runtime_on")
    ...
    @update_runtime_on.setter
    def update_runtime_on(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "update_runtime_on", value)
