...
def get_version(function_arn: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVersionResult:
    """
    Resource Type definition for AWS::Lambda::Version


    :param builtins.str function_arn: The ARN of the version.
    """
    __args__ = dict()
...
def get_version_output(function_arn: Optional[pulumi.Input[builtins.str]] = None,
