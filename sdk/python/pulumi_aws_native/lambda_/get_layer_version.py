...
class GetLayerVersionResult:
    ...
    def layer_version_arn(self) -> Optional[builtins.str]:
        """
...
def get_layer_version(layer_version_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLayerVersionResult:
    """
    Resource Type definition for AWS::Lambda::LayerVersion


    :param builtins.str layer_version_arn: The ARN of the layer version.
    """
    __args__ = dict()
...
def get_layer_version_output(layer_version_arn: Optional[pulumi.Input[builtins.str]] = None,
