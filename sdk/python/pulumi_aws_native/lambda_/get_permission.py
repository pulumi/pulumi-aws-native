...
def get_permission(function_name: Optional[builtins.str] = None,
    ...
    :param builtins.str function_name: The name or ARN of the Lambda function, version, or alias.
             **Name formats**
...
def get_permission_output(function_name: Optional[pulumi.Input[builtins.str]] = None,
