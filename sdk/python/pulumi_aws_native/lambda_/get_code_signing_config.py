...
class GetCodeSigningConfigResult:
    ...
    def code_signing_config_arn(self) -> Optional[builtins.str]:
        """
    ...
    def code_signing_config_id(self) -> Optional[builtins.str]:
        """
...
def get_code_signing_config(code_signing_config_arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCodeSigningConfigResult:
    """
    Resource Type definition for AWS::Lambda::CodeSigningConfig.


    :param builtins.str code_signing_config_arn: A unique Arn for CodeSigningConfig resource
    """
    __args__ = dict()
...
def get_code_signing_config_output(code_signing_config_arn: Optional[pulumi.Input[builtins.str]] = None,
