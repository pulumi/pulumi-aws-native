...
class GetUrlResult:
    ...
    def function_url(self) -> Optional[builtins.str]:
        """
...
def get_url(function_arn: Optional[builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUrlResult:
    """
    Resource Type definition for AWS::Lambda::Url


    :param builtins.str function_arn: The full Amazon Resource Name (ARN) of the function associated with the Function URL.
    """
    __args__ = dict()
...
def get_url_output(function_arn: Optional[pulumi.Input[builtins.str]] = None,
