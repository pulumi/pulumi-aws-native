...
class AliasProvisionedConcurrencyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A provisioned concurrency configuration for a function's alias.
        :param builtins.int provisioned_concurrent_executions: The amount of provisioned concurrency to allocate for the alias.
        """
    ...
    def provisioned_concurrent_executions(self) -> builtins.int:
        """
...
class AliasVersionWeight(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The traffic-shifting configuration of a Lambda function alias.
        :param builtins.str function_version: The qualifier of the second version.
        :param builtins.float function_weight: The percentage of traffic that the alias routes to the second version.
        """
    ...
    def function_weight(self) -> builtins.float:
        """
...
class CodeSigningConfigAllowedPublishers(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        When the CodeSigningConfig is later on attached to a function, the function code will be expected to be signed by profiles from this list
        :param Sequence[builtins.str] signing_profile_version_arns: List of Signing profile version Arns
        """
...
class EventInvokeConfigOnFailure(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The destination configuration for failed invocations.
        :param builtins.str destination: The Amazon Resource Name (ARN) of the destination resource.
        """
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specific configuration settings for an Amazon Managed Streaming for Apache Kafka (Amazon MSK) event source.
        :param builtins.str consumer_group_id: The identifier for the Kafka consumer group to join. The consumer group ID must be unique among all your Kafka event sources. After creating a Kafka event source mapping with the consumer group ID specified, you cannot update this value. For more information, see [Customizable consumer group ID](https://docs.aws.amazon.com/lambda/latest/dg/with-msk.html#services-msk-consumer-group-id).
        """
...
class EventSourceMappingEndpoints(dict):
    ...
    def __init__(__self__, *,
                 kafka_bootstrap_servers: Optional[Sequence[builtins.str]] = None):
        """
        The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        :param Sequence[builtins.str] kafka_bootstrap_servers: The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        """
    ...
    def kafka_bootstrap_servers(self) -> Optional[Sequence[builtins.str]]:
        """
        The list of bootstrap servers for your Kafka brokers in the following format: ``"KafkaBootstrapServers": ["abc.xyz.com:xxxx","abc2.xyz.com:xxxx"]``.
        """
...
class EventSourceMappingFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A structure within a ``FilterCriteria`` object that defines an event filtering pattern.
        :param builtins.str pattern: A filter pattern. For more information on the syntax of a filter pattern, see [Filter rule syntax](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventfiltering.html#filtering-syntax).
        """
...
class EventSourceMappingProvisionedPollerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The [provisioned mode](https://docs.aws.amazon.com/lambda/latest/dg/invocation-eventsourcemapping.html#invocation-eventsourcemapping-provisioned-mode) configuration for the event source. Use provisioned mode to customize the minimum and maximum number of event pollers for your event source.
        :param builtins.int maximum_pollers: The maximum number of event pollers this event source can scale up to.
        :param builtins.int minimum_pollers: The minimum number of event pollers this event source can scale down to.
        """
...
class EventSourceMappingScalingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        (Amazon SQS only) The scaling configuration for the event source. To remove the configuration, pass an empty value.
        :param builtins.int maximum_concurrency: Limits the number of concurrent instances that the SQS event source can invoke.
        """
...
class EventSourceMappingSchemaValidationConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param 'EventSourceMappingSchemaValidationConfigAttribute' attribute: The attribute you want your schema registry to validate and filter for.
        """
...
class EventSourceMappingSourceAccessConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str uri: The value for your chosen configuration in ``Type``. For example: ``"URI": "arn:aws:secretsmanager:us-east-1:01234567890:secret:MyBrokerSecretName"``.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if uri is not None:
...
class FunctionCode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_kms_key_arn: Optional[builtins.str] = None,
                 zip_file: Optional[builtins.str] = None):
        """
        The [deployment package](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-package.html) for a Lambda function. To deploy a function defined as a container image, you specify the location of a container image in the Amazon ECR registry. For a .zip file deployment package, you can specify the location of an object in Amazon S3. For Node.js and Python functions, you can specify the function code inline in the template.
          When you specify source code inline for a Node.js function, the ``index`` file that CFN creates uses the extension ``.js``. This means that LAM treats the file as a CommonJS module. ES modules aren't supported for inline functions.
          Changes to a deployment package in Amazon S3 or a container image in ECR are not detected automatically during stack updates. To update the function code, change the object key or version in the template.
        :param builtins.str image_uri: URI of a [container image](https://docs.aws.amazon.com/lambda/latest/dg/lambda-images.html) in the Amazon ECR registry.
        :param builtins.str s3_bucket: An Amazon S3 bucket in the same AWS-Region as your function. The bucket can be in a different AWS-account.
        :param builtins.str s3_key: The Amazon S3 key of the deployment package.
        :param builtins.str s3_object_version: For versioned objects, the version of the deployment package object to use.
        :param builtins.str source_kms_key_arn: The ARN of the KMSlong (KMS) customer managed key that's used to encrypt your function's .zip deployment package. If you don't provide a customer managed key, Lambda uses an [owned key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-owned-cmk).
        :param builtins.str zip_file: (Node.js and Python) The source code of your Lambda function. If you include your function source inline with this parameter, CFN places it in a file named ``index`` and zips it to create a [deployment package](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-package.html). This zip file cannot exceed 4MB. For the ``Handler`` property, the first part of the handler identifier must be ``index``. For example, ``index.handler``.
                 When you specify source code inline for a Node.js function, the ``index`` file that CFN creates uses the extension ``.js``. This means that LAM treats the file as a CommonJS module. ES modules aren't supported for inline functions.
    ...
    def source_kms_key_arn(self) -> Optional[builtins.str]:
        """
...
class FunctionDeadLetterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The [dead-letter queue](https://docs.aws.amazon.com/lambda/latest/dg/invocation-async-retain-records.html#invocation-dlq) for failed asynchronous invocations.
        :param builtins.str target_arn: The Amazon Resource Name (ARN) of an Amazon SQS queue or Amazon SNS topic.
        """
...
class FunctionEnvironment(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A function's environment variable settings. You can use environment variables to adjust your function's behavior without updating code. An environment variable is a pair of strings that are stored in a function's version-specific configuration.
        :param Mapping[str, builtins.str] variables: Environment variable key-value pairs. For more information, see [Using Lambda environment variables](https://docs.aws.amazon.com/lambda/latest/dg/configuration-envvars.html).
...
class FunctionEphemeralStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The size of the function's ``/tmp`` directory in MB. The default value is 512, but it can be any whole number between 512 and 10,240 MB.
        :param builtins.int size: The size of the function's ``/tmp`` directory.
        """
...
class FunctionFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about the connection between a Lambda function and an [Amazon EFS file system](https://docs.aws.amazon.com/lambda/latest/dg/configuration-filesystem.html).
        :param builtins.str arn: The Amazon Resource Name (ARN) of the Amazon EFS access point that provides access to the file system.
        :param builtins.str local_mount_path: The path where the function can access the file system, starting with ``/mnt/``.
        """
...
class FunctionImageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration values that override the container image Dockerfile settings. For more information, see [Container image settings](https://docs.aws.amazon.com/lambda/latest/dg/images-create.html#images-parms).
        :param Sequence[builtins.str] command: Specifies parameters that you want to pass in with ENTRYPOINT. You can specify a maximum of 1,500 parameters in the list.
        :param Sequence[builtins.str] entry_point: Specifies the entry point to their application, which is typically the location of the runtime executable. You can specify a maximum of 1,500 string entries in the list.
        :param builtins.str working_directory: Specifies the working directory. The length of the directory string cannot exceed 1,000 characters.
        """
...
class FunctionLoggingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str log_group: The name of the Amazon CloudWatch log group the function sends logs to. By default, Lambda functions send logs to a default log group named ``/aws/lambda/<function name>``. To use a different log group, enter an existing log group or enter a new log group name.
...
class FunctionRuntimeManagementConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 runtime_version_arn: Optional[builtins.str] = None):
        """
        Sets the runtime management configuration for a function's version. For more information, see [Runtime updates](https://docs.aws.amazon.com/lambda/latest/dg/runtimes-update.html).
        ...
        :param builtins.str runtime_version_arn: The ARN of the runtime version you want the function to use.
    ...
    def runtime_version_arn(self) -> Optional[builtins.str]:
        """
...
class FunctionVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        The VPC security groups and subnets that are attached to a Lambda function. When you connect a function to a VPC, Lambda creates an elastic network interface for each combination of security group and subnet in the function's VPC configuration. The function can only access resources and the internet through that VPC. For more information, see [VPC Settings](https://docs.aws.amazon.com/lambda/latest/dg/configuration-vpc.html).
          When you delete a function, CFN monitors the state of its network interfaces and waits for Lambda to delete them before proceeding. If the VPC is defined in the same stack, the network interfaces need to be deleted by Lambda before CFN can delete the VPC's resources.
         To monitor network interfaces, CFN needs the ``ec2:DescribeNetworkInterfaces`` permission. It obtains this from the user or role that modifies the stack. If you don't provide this permission, CFN does not wait for network interfaces to be deleted.
        :param builtins.bool ipv6_allowed_for_dual_stack: Allows outbound IPv6 traffic on VPC functions that are connected to dual-stack subnets.
        :param Sequence[builtins.str] security_group_ids: A list of VPC security group IDs.
        :param Sequence[builtins.str] subnet_ids: A list of VPC subnet IDs.
        """
...
class LayerVersionContent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_object_version: Optional[builtins.str] = None):
        """
        :param builtins.str s3_bucket: The Amazon S3 bucket of the layer archive.
        :param builtins.str s3_key: The Amazon S3 key of the layer archive.
        :param builtins.str s3_object_version: For versioned objects, the version of the layer archive object to use.
        """
        pulumi.set(__self__, "s3_bucket", s3_bucket)
        pulumi.set(__self__, "s3_key", s3_key)
        if s3_object_version is not None:
...
class UrlCors(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_credentials: Specifies whether credentials are included in the CORS request.
        :param Sequence[builtins.str] allow_headers: Represents a collection of allowed headers.
        :param Sequence['UrlAllowMethodsItem'] allow_methods: Represents a collection of allowed HTTP methods.
        :param Sequence[builtins.str] allow_origins: Represents a collection of allowed origins.
        :param Sequence[builtins.str] expose_headers: Represents a collection of exposed headers.
        :param builtins.int max_age: The maximum amount of time, in seconds, that browsers can cache results of a preflight request. By default, this is set to `0` , which means the browser will not cache results.
        """
...
class VersionProvisionedConcurrencyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A provisioned concurrency configuration for a function's version.
        :param builtins.int provisioned_concurrent_executions: The amount of provisioned concurrency to allocate for the version.
        """
        pulumi.set(__self__, "provisioned_concurrent_executions", provisioned_concurrent_executions)
...
class VersionRuntimePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Runtime Management Config of a function.
        :param builtins.str update_runtime_on: The runtime update mode.
        :param builtins.str runtime_version_arn: The ARN of the runtime the function is configured to use. If the runtime update mode is manual, the ARN is returned, otherwise null is returned.
        """
        pulumi.set(__self__, "update_runtime_on", update_runtime_on)
        if runtime_version_arn is not None:
            pulumi.set(__self__, "runtime_version_arn", runtime_version_arn)
