...
__all__ = [
    ...
    'Hooks',
    'LayerVersionContent',
    'MicrovmImageCloudWatchLogging',
    'MicrovmImageCodeArtifact',
    'MicrovmImageCpuConfiguration',
    'MicrovmImageEnvironmentVariable',
    'MicrovmImageHooks',
    'MicrovmImageLogging',
    'MicrovmImageMicrovmHooks',
...
class CapacityProviderLoggingConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderLoggingConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderLoggingConfig.__key_warning(key)
        return super().__getitem__(key)
...
class CapacityProviderScalingConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderScalingConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderScalingConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 max_v_cpu_count: Optional[_builtins.int] = None,
    ...
    def scaling_mode(self) -> Optional['CapacityProviderScalingMode']:
        """
    ...
    def scaling_policies(self) -> Optional[Sequence['outputs.CapacityProviderTargetTrackingScalingPolicy']]:
        """
...
class CapacityProviderTargetTrackingScalingPolicy(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderTargetTrackingScalingPolicy. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderTargetTrackingScalingPolicy.__key_warning(key)
        return super().__getitem__(key)
    ...
    def predefined_metric_type(self) -> 'CapacityProviderPredefinedMetricType':
        """
...
class CapacityProviderTelemetryConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityProviderTelemetryConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityProviderTelemetryConfig.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class EventSourceMappingLoggingConfig(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "systemLogLevel":
            suggest = "system_log_level"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EventSourceMappingLoggingConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EventSourceMappingLoggingConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 system_log_level: Optional['EventSourceMappingLoggingConfigSystemLogLevel'] = None):
        """
        The function's Amazon CloudWatch Logs configuration settings.

        :param 'EventSourceMappingLoggingConfigSystemLogLevel' system_log_level: Set this property to filter the system logs for your function that Lambda sends to CloudWatch. Lambda only sends system logs at the selected level of detail and lower, where ``DEBUG`` is the highest level and ``WARN`` is the lowest.
        """
        if system_log_level is not None:
            pulumi.set(__self__, "system_log_level", system_log_level)
    ...
    @_builtins.property
    @pulumi.getter(name="systemLogLevel")
    def system_log_level(self) -> Optional['EventSourceMappingLoggingConfigSystemLogLevel']:
        """
...
class FunctionCapacityProviderConfig(dict):
    ...
    def __init__(__self__, *,
                 lambda_managed_instances_capacity_provider_config: 'outputs.FunctionLambdaManagedInstancesCapacityProviderConfig'):
        """
        Configuration for the capacity provider that manages compute resources for Lambda functions.

        :param 'FunctionLambdaManagedInstancesCapacityProviderConfig' lambda_managed_instances_capacity_provider_config: Configuration for Lambda-managed instances used by the capacity provider.
        """
    ...
    def lambda_managed_instances_capacity_provider_config(self) -> 'outputs.FunctionLambdaManagedInstancesCapacityProviderConfig':
        """
...
class FunctionCode(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'FunctionCodeS3ObjectStorageMode' s3_object_storage_mode: Specifies the storage mode for the deployment package. Use ``COPY`` to store the package in LAMlong-managed storage. Use ``REFERENCE`` to read the package directly from the Amazon S3 bucket. If omitted, the default is ``COPY``.
...
class FunctionDurableConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int execution_timeout: The maximum time (in seconds) that a durable execution can run before timing out. This timeout applies to the entire durable execution, not individual function invocations.
        :param _builtins.str kms_key_arn: The ARN of the KMSlong (KMS) customer managed key that is used to encrypt your durable execution's payload data, including input, output, and error payloads.
...
@pulumi.output_type
class FunctionLambdaManagedInstancesCapacityProviderConfig(dict):
    """
    Configuration for Lambda-managed instances used by the capacity provider.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if key == "capacityProviderArn":
            ...
            suggest = "execution_environment_memory_gi_b_per_v_cpu"
        elif key == "perExecutionEnvironmentMaxConcurrency":
            suggest = "per_execution_environment_max_concurrency"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FunctionLambdaManagedInstancesCapacityProviderConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FunctionLambdaManagedInstancesCapacityProviderConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 execution_environment_memory_gi_b_per_v_cpu: Optional[_builtins.float] = None,
                 per_execution_environment_max_concurrency: Optional[_builtins.int] = None):
        """
        Configuration for Lambda-managed instances used by the capacity provider.

        :param _builtins.str capacity_provider_arn: The Amazon Resource Name (ARN) of the capacity provider.
        :param _builtins.float execution_environment_memory_gi_b_per_v_cpu: The amount of memory in GiB allocated per vCPU for execution environments.
        :param _builtins.int per_execution_environment_max_concurrency: The maximum number of concurrent executions that can run on each execution environment.
        """
    ...
    def execution_environment_memory_gi_b_per_v_cpu(self) -> Optional[_builtins.float]:
        """
...
@pulumi.output_type
class FunctionScalingConfig(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FunctionScalingConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FunctionScalingConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int max_execution_environments: The maximum number of execution environments that can be provisioned for the function.
        :param _builtins.int min_execution_environments: The minimum number of execution environments to maintain for the function.
        """
...
class FunctionTenancyConfig(dict):
    ...
    def __init__(__self__, *,
                 tenant_isolation_mode: 'FunctionTenancyConfigTenantIsolationMode'):
        """
        Specifies the tenant isolation mode configuration for a Lambda function. This allows you to configure specific tenant isolation strategies for your function invocations. Tenant isolation configuration cannot be modified after function creation.

        :param 'FunctionTenancyConfigTenantIsolationMode' tenant_isolation_mode: Tenant isolation mode allows for invocation to be sent to a corresponding execution environment dedicated to a specific tenant ID.
        """
        pulumi.set(__self__, "tenant_isolation_mode", tenant_isolation_mode)

    @_builtins.property
    @pulumi.getter(name="tenantIsolationMode")
    def tenant_isolation_mode(self) -> 'FunctionTenancyConfigTenantIsolationMode':
        """
...
class Hooks(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "microvmHooks":
            suggest = "microvm_hooks"
        elif key == "microvmImageHooks":
            suggest = "microvm_image_hooks"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Hooks. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Hooks.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 microvm_hooks: Optional['outputs.MicrovmImageMicrovmHooks'] = None,
                 microvm_image_hooks: Optional['outputs.MicrovmImageHooks'] = None,
    ...
    def microvm_hooks(self) -> Optional['outputs.MicrovmImageMicrovmHooks']:
        return pulumi.get(self, "microvm_hooks")

    @_builtins.property
    @pulumi.getter(name="microvmImageHooks")
    def microvm_image_hooks(self) -> Optional['outputs.MicrovmImageHooks']:
...
class LayerVersionContent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_object_storage_mode: Optional['LayerVersionContentS3ObjectStorageMode'] = None,
                 s3_object_version: Optional[_builtins.str] = None):
        """
        ...
        :param 'LayerVersionContentS3ObjectStorageMode' s3_object_storage_mode: Specifies whether Lambda should copy the deployment package to its internal storage (COPY) or reference it directly from your S3 bucket (REFERENCE).
    ...
    @_builtins.property
    @pulumi.getter(name="s3ObjectStorageMode")
    def s3_object_storage_mode(self) -> Optional['LayerVersionContentS3ObjectStorageMode']:
        """
...
@pulumi.output_type
class MicrovmImageCloudWatchLogging(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "logGroup":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MicrovmImageCloudWatchLogging. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MicrovmImageCloudWatchLogging.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class MicrovmImageCodeArtifact(dict):
    def __init__(__self__, *,
                 uri: _builtins.str):
        pulumi.set(__self__, "uri", uri)
...
@pulumi.output_type
class MicrovmImageCpuConfiguration(dict):
    def __init__(__self__, *,
                 architecture: 'MicrovmImageCpuConfigurationArchitecture'):
        pulumi.set(__self__, "architecture", architecture)

    @_builtins.property
    @pulumi.getter
    def architecture(self) -> 'MicrovmImageCpuConfigurationArchitecture':
        return pulumi.get(self, "architecture")


@pulumi.output_type
class MicrovmImageEnvironmentVariable(dict):
    def __init__(__self__, *,
                 key: _builtins.str,
                 value: _builtins.str):
        pulumi.set(__self__, "key", key)
...
@pulumi.output_type
class MicrovmImageHooks(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "readyTimeoutInSeconds":
            suggest = "ready_timeout_in_seconds"
        elif key == "validateTimeoutInSeconds":
            suggest = "validate_timeout_in_seconds"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MicrovmImageHooks. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MicrovmImageHooks.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ready: Optional['MicrovmImageHookState'] = None,
                 ready_timeout_in_seconds: Optional[_builtins.int] = None,
                 validate: Optional['MicrovmImageHookState'] = None,
                 validate_timeout_in_seconds: Optional[_builtins.int] = None):
    ...
    @_builtins.property
    @pulumi.getter
    def ready(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "ready")

    @_builtins.property
    @pulumi.getter(name="readyTimeoutInSeconds")
    def ready_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "ready_timeout_in_seconds")

    @_builtins.property
    @pulumi.getter
    def validate(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "validate")

    @_builtins.property
    @pulumi.getter(name="validateTimeoutInSeconds")
    def validate_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "validate_timeout_in_seconds")


@pulumi.output_type
class MicrovmImageLogging(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "cloudWatch":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MicrovmImageLogging. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MicrovmImageLogging.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 cloud_watch: Optional['outputs.MicrovmImageCloudWatchLogging'] = None,
    ...
    def cloud_watch(self) -> Optional['outputs.MicrovmImageCloudWatchLogging']:
...
@pulumi.output_type
class MicrovmImageMicrovmHooks(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "resumeTimeoutInSeconds":
            suggest = "resume_timeout_in_seconds"
        elif key == "runTimeoutInSeconds":
            suggest = "run_timeout_in_seconds"
        elif key == "suspendTimeoutInSeconds":
            suggest = "suspend_timeout_in_seconds"
        elif key == "terminateTimeoutInSeconds":
            suggest = "terminate_timeout_in_seconds"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MicrovmImageMicrovmHooks. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MicrovmImageMicrovmHooks.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 resume: Optional['MicrovmImageHookState'] = None,
                 resume_timeout_in_seconds: Optional[_builtins.int] = None,
                 run: Optional['MicrovmImageHookState'] = None,
                 run_timeout_in_seconds: Optional[_builtins.int] = None,
                 suspend: Optional['MicrovmImageHookState'] = None,
                 suspend_timeout_in_seconds: Optional[_builtins.int] = None,
                 terminate: Optional['MicrovmImageHookState'] = None,
                 terminate_timeout_in_seconds: Optional[_builtins.int] = None):
    ...
    @_builtins.property
    @pulumi.getter
    def resume(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "resume")

    @_builtins.property
    @pulumi.getter(name="resumeTimeoutInSeconds")
    def resume_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "resume_timeout_in_seconds")

    @_builtins.property
    @pulumi.getter
    def run(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "run")

    @_builtins.property
    @pulumi.getter(name="runTimeoutInSeconds")
    def run_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "run_timeout_in_seconds")

    @_builtins.property
    @pulumi.getter
    def suspend(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "suspend")

    @_builtins.property
    @pulumi.getter(name="suspendTimeoutInSeconds")
    def suspend_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "suspend_timeout_in_seconds")

    @_builtins.property
    @pulumi.getter
    def terminate(self) -> Optional['MicrovmImageHookState']:
        return pulumi.get(self, "terminate")

    @_builtins.property
    @pulumi.getter(name="terminateTimeoutInSeconds")
    def terminate_timeout_in_seconds(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "terminate_timeout_in_seconds")


@pulumi.output_type
class MicrovmImageResources(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "minimumMemoryInMiB":
            suggest = "minimum_memory_in_mi_b"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MicrovmImageResources. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MicrovmImageResources.__key_warning(key)
        return super().__getitem__(key)
...
class NetworkConnectorConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in NetworkConnectorConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        NetworkConnectorConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 vpc_egress_configuration: 'outputs.NetworkConnectorVpcEgressConfiguration'):
        """
        The network configuration for the connector. Specify a VpcEgressConfiguration to enable outbound traffic routing through your VPC.
        """
    ...
    def vpc_egress_configuration(self) -> 'outputs.NetworkConnectorVpcEgressConfiguration':
        return pulumi.get(self, "vpc_egress_configuration")


@pulumi.output_type
class NetworkConnectorVpcEgressConfiguration(dict):
    """
    ...
    def __getitem__(self, key: str) -> Any:
        NetworkConnectorVpcEgressConfiguration.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class VersionFunctionScalingConfig(dict):
    """
    Configuration that defines the scaling behavior for a Lambda Managed Instances function, including the minimum and maximum number of execution environments that can be provisioned.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VersionFunctionScalingConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VersionFunctionScalingConfig.__key_warning(key)
        return super().__getitem__(key)
