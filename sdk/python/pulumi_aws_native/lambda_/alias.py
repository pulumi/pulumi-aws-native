...
class Alias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(provisioned_concurrency_config, AliasProvisionedConcurrencyConfigurationArgs):
            ...
            if not isinstance(routing_config, AliasRoutingConfigurationArgs):
