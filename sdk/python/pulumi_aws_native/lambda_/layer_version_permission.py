...
class LayerVersionPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] organization_id: With the principal set to *, grant permission to all accounts in the specified organization.
        """
    ...
    def layer_version_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def layer_version_arn(self, value: pulumi.Input[_builtins.str]):
