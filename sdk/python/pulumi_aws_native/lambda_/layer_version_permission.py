...
class LayerVersionPermissionArgs:
    def __init__(__self__, *,
                 ...
                 layer_version_arn: pulumi.Input[builtins.str],
                 principal: pulumi.Input[builtins.str],
                 organization_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LayerVersionPermission resource.
        :param pulumi.Input[builtins.str] action: The API action that grants access to the layer.
        :param pulumi.Input[builtins.str] layer_version_arn: The name or Amazon Resource Name (ARN) of the layer.
        :param pulumi.Input[builtins.str] principal: An account ID, or * to grant layer usage permission to all accounts in an organization, or all AWS accounts (if organizationId is not specified).
        :param pulumi.Input[builtins.str] organization_id: With the principal set to *, grant permission to all accounts in the specified organization.
        """
    ...
    def layer_version_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def layer_version_arn(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:lambda:LayerVersionPermission")
class LayerVersionPermission(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["action", "layerVersionArn", "organizationId", "principal"])
