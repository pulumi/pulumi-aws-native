...
class GetFunctionResult:
    ...
    @property
    @pulumi.getter
    def layers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def reserved_concurrent_executions(self) -> Optional[builtins.int]:
        """
...
def get_function(function_name: Optional[builtins.str] = None,
    ...
    :param builtins.str function_name: The name of the Lambda function, up to 64 characters in length. If you don't specify a name, CFN generates one.
