...
class ExperimentArgs:
    def __init__(__self__, *,
                 ...
                 remove_segment: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] project: The name or the ARN of the project where this experiment is to be created.
        ...
        :param pulumi.Input[builtins.str] description: An optional description of the experiment.
        :param pulumi.Input[builtins.str] name: A name for the new experiment.
        :param pulumi.Input[builtins.str] randomization_salt: When Evidently assigns a particular user session to an experiment, it must use a randomization ID to determine which variation the user session is served. This randomization ID is a combination of the entity ID and `randomizationSalt` . If you omit `randomizationSalt` , Evidently uses the experiment name as the `randomizationSalt` .
        :param pulumi.Input[builtins.bool] remove_segment: Set this to `true` to remove the segment that is associated with this experiment. You can't use this parameter if the experiment is currently running.
        :param pulumi.Input['ExperimentRunningStatusObjectArgs'] running_status: Start Experiment. Default is False
        :param pulumi.Input[builtins.int] sampling_rate: The portion of the available audience that you want to allocate to this experiment, in thousandths of a percent. The available audience is the total audience minus the audience that you have allocated to overrides or current launches of this feature.
               
               This is represented in thousandths of a percent. For example, specify 10,000 to allocate 10% of the available audience.
        :param pulumi.Input[builtins.str] segment: Specifies an audience *segment* to use in the experiment. When a segment is used in an experiment, only user sessions that match the segment pattern are used in the experiment.
    ...
    def remove_segment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remove_segment(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Experiment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="removeSegment")
    def remove_segment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set this to `true` to remove the segment that is associated with this experiment. You can't use this parameter if the experiment is currently running.
        """
        return pulumi.get(self, "remove_segment")
    ...
    @property
    @pulumi.getter
    def segment(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies an audience *segment* to use in the experiment. When a segment is used in an experiment, only user sessions that match the segment pattern are used in the experiment.
