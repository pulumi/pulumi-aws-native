...
class GetFeatureResult:
    ...
    def default_variation(self) -> Optional[builtins.str]:
        """
...
def get_feature(arn: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFeatureResult:
    """
    Resource Type definition for AWS::Evidently::Feature.


    :param builtins.str arn: The ARN of the feature. For example, `arn:aws:evidently:us-west-2:0123455678912:project/myProject/feature/myFeature` .
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_feature_output(arn: Optional[pulumi.Input[builtins.str]] = None,
