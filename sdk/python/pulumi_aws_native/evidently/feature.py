...
class FeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_variation: The name of the variation to use as the default variation. The default variation is served to users who are not allocated to any ongoing launches or experiments of this feature.
               
               This variation must also be listed in the `Variations` structure.
               
               If you omit `DefaultVariation` , the first variation listed in the `Variations` structure is used as the default variation.
        :param pulumi.Input[builtins.str] description: An optional description of the feature.
        ...
        :param pulumi.Input[builtins.str] name: The name for the feature. It can include up to 127 characters.
...
class Feature(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultVariation")
    def default_variation(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the variation to use as the default variation. The default variation is served to users who are not allocated to any ongoing launches or experiments of this feature.
