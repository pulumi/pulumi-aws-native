...
def get_segment(arn: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSegmentResult:
    """
    Resource Type definition for AWS::Evidently::Segment


    :param builtins.str arn: The ARN of the segment. For example, `arn:aws:evidently:us-west-2:123456789012:segment/australiaSegment`
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_segment_output(arn: Optional[pulumi.Input[builtins.str]] = None,
