...
def get_launch(arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLaunchResult:
    """
    Resource Type definition for AWS::Evidently::Launch.


    :param builtins.str arn: The ARN of the launch. For example, `arn:aws:evidently:us-west-2:0123455678912:project/myProject/launch/myLaunch`
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_launch_output(arn: Optional[pulumi.Input[builtins.str]] = None,
