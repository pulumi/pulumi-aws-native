...
class ExperimentMetricGoalObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value_key: The JSON path to reference the numerical metric value in the event.
        :param pulumi.Input[_builtins.str] event_pattern: Event patterns have the same structure as the events they match. Rules use event patterns to select events. An event pattern either matches an event or it doesn't.
        :param pulumi.Input[_builtins.str] unit_label: A label for the units that the metric is measuring.
        """
...
class ExperimentOnlineAbConfigObjectArgsDict(TypedDict):
    ...
    """
    treatment_weights: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ExperimentTreatmentToWeightArgs']]]]]
    """
...
class ExperimentRunningStatusObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reason: Reason is a required input for stopping the experiment
        :param pulumi.Input[_builtins.str] status: Provide START or STOP action to apply on an experiment
        """
...
class ExperimentTreatmentObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] variation: The name of the variation to use for this treatment.
        :param pulumi.Input[_builtins.str] description: The description of the treatment.
        """
    ...
    def treatment_name(self) -> pulumi.Input[_builtins.str]:
        """
        A name for this treatment. It can include up to 127 characters.
        """
    ...
    def treatment_name(self, value: pulumi.Input[_builtins.str]):
...
class ExperimentTreatmentToWeightArgs:
    def __init__(__self__, *,
                 ...
                 treatment: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] split_weight: The portion of experiment traffic to allocate to this treatment. Specify the traffic portion in thousandths of a percent, so 20,000 allocated to a treatment would allocate 20% of the experiment traffic to that treatment.
        :param pulumi.Input[_builtins.str] treatment: The name of the treatment.
        """
    ...
    def split_weight(self) -> pulumi.Input[_builtins.int]:
        """
        The portion of experiment traffic to allocate to this treatment. Specify the traffic portion in thousandths of a percent, so 20,000 allocated to a treatment would allocate 20% of the experiment traffic to that treatment.
        """
    ...
    @split_weight.setter
    def split_weight(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "split_weight", value)

    @_builtins.property
    @pulumi.getter
    def treatment(self) -> pulumi.Input[_builtins.str]:
        """
        The name of the treatment.
        """
    ...
    @treatment.setter
    def treatment(self, value: pulumi.Input[_builtins.str]):
...
class FeatureVariationObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] long_value: The value assigned to this variation, if the variation type is a long.
        :param pulumi.Input[_builtins.str] string_value: The value assigned to this variation, if the variation type is a string.
        :param pulumi.Input[_builtins.str] variation_name: A name for the variation. It can include up to 127 characters.
        """
...
class LaunchExecutionStatusObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reason: Provide a reason for stopping the launch. Defaults to empty if not provided.
        """
        pulumi.set(__self__, "status", status)
        if desired_state is not None:
            pulumi.set(__self__, "desired_state", desired_state)
...
class LaunchGroupObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] variation: The feature variation to use for this launch group.
        :param pulumi.Input[_builtins.str] description: A description of the launch group.
        """
        pulumi.set(__self__, "feature", feature)
...
class LaunchGroupToWeightArgs:
    def __init__(__self__, *,
                 ...
                 split_weight: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] group_name: The name of the launch group. It can include up to 127 characters.
        :param pulumi.Input[_builtins.int] split_weight: The portion of launch traffic to allocate to this launch group.
...
class LaunchSegmentOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] evaluation_order: A number indicating the order to use to evaluate segment overrides, if there are more than one. Segment overrides with lower numbers are evaluated first.
        :param pulumi.Input[_builtins.str] segment: The ARN of the segment to use for this override.
...
class LaunchStepConfigArgsDict(TypedDict):
    ...
    """
    segment_overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LaunchSegmentOverrideArgs']]]]]
    """
...
class ProjectAppConfigResourceObjectArgs:
    def __init__(__self__, *,
                 ...
                 environment_id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] application_id: The ID of the AWS AppConfig application to use for client-side evaluation.
        :param pulumi.Input[_builtins.str] environment_id: The ID of the AWS AppConfig environment to use for client-side evaluation.
        """
...
class ProjectDataDeliveryObjectArgsDict(TypedDict):
    ...
    """
    s3: NotRequired[pulumi.Input[Optional['ProjectS3DestinationArgs']]]
    """
