...
class GetExperimentResult:
    ...
    def randomization_salt(self) -> Optional[builtins.str]:
        """
    ...
    def remove_segment(self) -> Optional[builtins.bool]:
        """
...
def get_experiment(arn: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetExperimentResult:
    """
    Resource Type definition for AWS::Evidently::Experiment.


    :param builtins.str arn: The ARN of the experiment. For example, `arn:aws:evidently:us-west-2:0123455678912:project/myProject/experiment/myExperiment`
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_experiment_output(arn: Optional[pulumi.Input[builtins.str]] = None,
