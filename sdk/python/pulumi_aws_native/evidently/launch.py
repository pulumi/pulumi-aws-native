...
class LaunchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The name or ARN of the project that you want to create the launch in.
        ...
        :param pulumi.Input[builtins.str] description: An optional description for the launch.
        ...
        :param pulumi.Input[builtins.str] name: The name for the launch. It can include up to 127 characters.
