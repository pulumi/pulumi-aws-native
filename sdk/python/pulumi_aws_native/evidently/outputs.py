...
class ExperimentMetricGoalObject(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str entity_id_key: The JSON path to reference the entity id in the event.
        :param _builtins.str metric_name: A name for the metric. It can include up to 255 characters.
        :param _builtins.str value_key: The JSON path to reference the numerical metric value in the event.
        :param _builtins.str event_pattern: Event patterns have the same structure as the events they match. Rules use event patterns to select events. An event pattern either matches an event or it doesn't.
        :param _builtins.str unit_label: A label for the units that the metric is measuring.
        """
...
class ExperimentOnlineAbConfigObject(dict):
    ...
    def __init__(__self__, *,
                 control_treatment_name: Optional[_builtins.str] = None,
                 treatment_weights: Optional[Sequence['outputs.ExperimentTreatmentToWeight']] = None):
        """
        :param _builtins.str control_treatment_name: The name of the variation that is to be the default variation that the other variations are compared to.
    ...
    def control_treatment_name(self) -> Optional[_builtins.str]:
        """
...
class ExperimentRunningStatusObject(dict):
    ...
    def __init__(__self__, *,
                 analysis_complete_time: Optional[_builtins.str] = None,
                 desired_state: Optional[_builtins.str] = None,
                 reason: Optional[_builtins.str] = None,
                 status: Optional[_builtins.str] = None):
        """
        :param _builtins.str analysis_complete_time: Provide the analysis Completion time for an experiment
        :param _builtins.str desired_state: Provide CANCELLED or COMPLETED desired state when stopping an experiment
        :param _builtins.str reason: Reason is a required input for stopping the experiment
        :param _builtins.str status: Provide START or STOP action to apply on an experiment
        """
    ...
    def analysis_complete_time(self) -> Optional[_builtins.str]:
        """
...
class ExperimentTreatmentObject(dict):
    ...
    def __init__(__self__, *,
                 ...
                 treatment_name: _builtins.str,
                 variation: _builtins.str,
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str feature: The name of the feature for this experiment.
        :param _builtins.str treatment_name: A name for this treatment. It can include up to 127 characters.
        :param _builtins.str variation: The name of the variation to use for this treatment.
        :param _builtins.str description: The description of the treatment.
        """
    ...
    def treatment_name(self) -> _builtins.str:
        """
...
class ExperimentTreatmentToWeight(dict):
    ...
    def __init__(__self__, *,
                 split_weight: _builtins.int,
                 treatment: _builtins.str):
        """
        :param _builtins.int split_weight: The portion of experiment traffic to allocate to this treatment. Specify the traffic portion in thousandths of a percent, so 20,000 allocated to a treatment would allocate 20% of the experiment traffic to that treatment.
        :param _builtins.str treatment: The name of the treatment.
        """
    ...
    def split_weight(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def treatment(self) -> _builtins.str:
        """
...
class FeatureEntityOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str entity_id: The entity ID to be served the variation specified in `Variation` .
        :param _builtins.str variation: The name of the variation to serve to the user session that matches the `EntityId` .
        """
...
class FeatureVariationObject(dict):
    ...
    def __init__(__self__, *,
                 ...
                 variation_name: Optional[_builtins.str] = None):
        """
        :param _builtins.bool boolean_value: The value assigned to this variation, if the variation type is boolean.
        :param _builtins.float double_value: The value assigned to this variation, if the variation type is a double.
        :param _builtins.float long_value: The value assigned to this variation, if the variation type is a long.
        :param _builtins.str string_value: The value assigned to this variation, if the variation type is a string.
        :param _builtins.str variation_name: A name for the variation. It can include up to 127 characters.
        """
    ...
    def variation_name(self) -> Optional[_builtins.str]:
        """
...
class LaunchExecutionStatusObject(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reason: Optional[_builtins.str] = None):
        """
        :param _builtins.str status: Provide START or STOP action to apply on a launch
        :param _builtins.str desired_state: Provide CANCELLED or COMPLETED as the launch desired state. Defaults to Completed if not provided.
        :param _builtins.str reason: Provide a reason for stopping the launch. Defaults to empty if not provided.
        """
        pulumi.set(__self__, "status", status)
        if desired_state is not None:
            pulumi.set(__self__, "desired_state", desired_state)
...
class LaunchGroupObject(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str feature: The feature that this launch is using.
        :param _builtins.str group_name: A name for this launch group. It can include up to 127 characters.
        :param _builtins.str variation: The feature variation to use for this launch group.
        :param _builtins.str description: A description of the launch group.
        """
        pulumi.set(__self__, "feature", feature)
...
class LaunchGroupToWeight(dict):
    ...
    def __init__(__self__, *,
                 ...
                 split_weight: _builtins.int):
        """
        :param _builtins.str group_name: The name of the launch group. It can include up to 127 characters.
        :param _builtins.int split_weight: The portion of launch traffic to allocate to this launch group.
...
class LaunchSegmentOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int evaluation_order: A number indicating the order to use to evaluate segment overrides, if there are more than one. Segment overrides with lower numbers are evaluated first.
        :param _builtins.str segment: The ARN of the segment to use for this override.
...
class LaunchStepConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_time: The date and time to start this step of the launch. Use UTC format, `yyyy-MM-ddTHH:mm:ssZ` . For example, `2025-11-25T23:59:59Z`
...
class ProjectAppConfigResourceObject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str application_id: The ID of the AWS AppConfig application to use for client-side evaluation.
        :param _builtins.str environment_id: The ID of the AWS AppConfig environment to use for client-side evaluation.
        """
...
class ProjectS3Destination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket_name: The name of the bucket in which Evidently stores evaluation events.
        :param _builtins.str prefix: The bucket prefix in which Evidently stores evaluation events.
        """
