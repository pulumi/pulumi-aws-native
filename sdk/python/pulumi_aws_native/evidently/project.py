...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description of the project.
        :param pulumi.Input[builtins.str] name: The name for the project. It can include up to 127 characters.
...
class Project(pulumi.CustomResource):
    ...
    pulumi_type = "aws-native:evidently:Project"
