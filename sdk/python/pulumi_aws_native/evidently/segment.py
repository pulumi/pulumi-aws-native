...
class SegmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description for this segment.
        :param pulumi.Input[builtins.str] name: A name for the segment.
        :param pulumi.Input[builtins.str] pattern: The pattern to use for the segment. For more information about pattern syntax, see [Segment rule pattern syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Evidently-segments.html#CloudWatch-Evidently-segments-syntax) .
