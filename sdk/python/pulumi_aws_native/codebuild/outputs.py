...
class ReportGroupReportExportConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ReportGroupS3ReportExportConfig' s3_destination: A `S3ReportExportConfig` object that contains information about the S3 bucket where the run of a report is exported.
        """
