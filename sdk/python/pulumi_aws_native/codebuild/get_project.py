...
def get_project(id: Optional[str] = None,
    ...
    return AwaitableGetProjectResult(
        ...
        badge_enabled=__ret__.badge_enabled,
        build_batch_config=__ret__.build_batch_config,
        cache=__ret__.cache,
        concurrent_build_limit=__ret__.concurrent_build_limit,
        description=__ret__.description,
        encryption_key=__ret__.encryption_key,
        environment=__ret__.environment,
        file_system_locations=__ret__.file_system_locations,
        id=__ret__.id,
        logs_config=__ret__.logs_config,
        queued_timeout_in_minutes=__ret__.queued_timeout_in_minutes,
        resource_access_role=__ret__.resource_access_role,
        secondary_artifacts=__ret__.secondary_artifacts,
        secondary_source_versions=__ret__.secondary_source_versions,
        secondary_sources=__ret__.secondary_sources,
        service_role=__ret__.service_role,
        source=__ret__.source,
        source_version=__ret__.source_version,
        tags=__ret__.tags,
