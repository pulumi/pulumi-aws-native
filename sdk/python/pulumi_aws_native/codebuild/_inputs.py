...
if not MYPY:
    class FleetProxyRuleArgsDict(TypedDict):
        ...
        """
        entities: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class FleetProxyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entities: The destination of the proxy rule.
...
class FleetScalingConfigurationInputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_capacity: The maximum number of instances in the ﬂeet when auto-scaling.
...
class FleetTargetTrackingScalingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] target_value: The value of `metricType` when to start scaling.
        """
