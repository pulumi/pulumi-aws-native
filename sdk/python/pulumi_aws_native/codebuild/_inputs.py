...
class ReportGroupS3ReportExportConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bucket_owner: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-codebuild-reportgroup-s3reportexportconfig.html#cfn-codebuild-reportgroup-s3reportexportconfig-bucketowner
