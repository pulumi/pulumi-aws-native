...
class ReportGroupArgs:
    ...
    def _configure(
        ...
        if delete_reports is not None:
            _setter("delete_reports", delete_reports)
        if name is not None:
            _setter("name", name)
        if tags is not None:
            _setter("tags", tags)
...
warnings.warn("""ReportGroup is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ReportGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ReportGroupArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(export_config, ReportGroupReportExportConfigArgs):
