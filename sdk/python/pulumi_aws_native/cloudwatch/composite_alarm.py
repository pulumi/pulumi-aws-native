...
class CompositeAlarmArgs:
    def __init__(__self__, *,
                 alarm_rule: pulumi.Input[builtins.str],
                 actions_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 actions_suppressor: Optional[pulumi.Input[builtins.str]] = None,
                 actions_suppressor_extension_period: Optional[pulumi.Input[builtins.int]] = None,
                 actions_suppressor_wait_period: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] alarm_rule: Expression which aggregates the state of other Alarms (Metric or Composite Alarms)
        :param pulumi.Input[builtins.bool] actions_enabled: Indicates whether actions should be executed during any changes to the alarm state. The default is TRUE.
        :param pulumi.Input[builtins.str] actions_suppressor: Actions will be suppressed if the suppressor alarm is in the ALARM state. ActionsSuppressor can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm. 
        :param pulumi.Input[builtins.int] actions_suppressor_extension_period: Actions will be suppressed if WaitPeriod is active. The length of time that actions are suppressed is in seconds.
        :param pulumi.Input[builtins.int] actions_suppressor_wait_period: Actions will be suppressed if ExtensionPeriod is active. The length of time that actions are suppressed is in seconds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alarm_actions: The list of actions to execute when this alarm transitions into an ALARM state from any other state. Specify each action as an Amazon Resource Name (ARN).
        :param pulumi.Input[builtins.str] alarm_description: The description of the alarm
        :param pulumi.Input[builtins.str] alarm_name: The name of the Composite Alarm
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] insufficient_data_actions: The actions to execute when this alarm transitions to the INSUFFICIENT_DATA state from any other state. Each action is specified as an Amazon Resource Name (ARN).
    ...
    def alarm_rule(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @alarm_rule.setter
    def alarm_rule(self, value: pulumi.Input[builtins.str]):
    ...
    def actions_suppressor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def actions_suppressor(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "actions_suppressor", value)

    @property
    @pulumi.getter(name="actionsSuppressorExtensionPeriod")
    def actions_suppressor_extension_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def actions_suppressor_extension_period(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "actions_suppressor_extension_period", value)

    @property
    @pulumi.getter(name="actionsSuppressorWaitPeriod")
    def actions_suppressor_wait_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def actions_suppressor_wait_period(self, value: Optional[pulumi.Input[builtins.int]]):
...
class CompositeAlarm(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="actionsSuppressor")
    def actions_suppressor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Actions will be suppressed if the suppressor alarm is in the ALARM state. ActionsSuppressor can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm. 
        """
        return pulumi.get(self, "actions_suppressor")
    ...
    @property
    @pulumi.getter(name="actionsSuppressorExtensionPeriod")
    def actions_suppressor_extension_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Actions will be suppressed if WaitPeriod is active. The length of time that actions are suppressed is in seconds.
        """
        return pulumi.get(self, "actions_suppressor_extension_period")
    ...
    @property
    @pulumi.getter(name="actionsSuppressorWaitPeriod")
    def actions_suppressor_wait_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Actions will be suppressed if ExtensionPeriod is active. The length of time that actions are suppressed is in seconds.
        """
        return pulumi.get(self, "actions_suppressor_wait_period")
    ...
    @property
    @pulumi.getter(name="alarmName")
    def alarm_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Composite Alarm
        """
        return pulumi.get(self, "alarm_name")
    ...
    @property
    @pulumi.getter(name="alarmRule")
    def alarm_rule(self) -> pulumi.Output[builtins.str]:
        """
        Expression which aggregates the state of other Alarms (Metric or Composite Alarms)
        """
        return pulumi.get(self, "alarm_rule")
