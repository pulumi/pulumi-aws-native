...
class GetCompositeAlarmResult:
    ...
    def actions_suppressor_extension_period(self) -> Optional[_builtins.int]:
        """
    ...
    def actions_suppressor_wait_period(self) -> Optional[_builtins.int]:
        """
    ...
    def alarm_rule(self) -> Optional[_builtins.str]:
        """
...
def get_composite_alarm(alarm_name: Optional[_builtins.str] = None,
