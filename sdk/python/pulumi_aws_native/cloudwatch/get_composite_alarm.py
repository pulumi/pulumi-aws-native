...
class GetCompositeAlarmResult:
    ...
    def actions_suppressor(self) -> Optional[builtins.str]:
        """
    ...
    def actions_suppressor_extension_period(self) -> Optional[builtins.int]:
        """
    ...
    def actions_suppressor_wait_period(self) -> Optional[builtins.int]:
        """
    ...
    def alarm_rule(self) -> Optional[builtins.str]:
        """
...
def get_composite_alarm(alarm_name: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCompositeAlarmResult:
    """
    The AWS::CloudWatch::CompositeAlarm type specifies an alarm which aggregates the states of other Alarms (Metric or Composite Alarms) as defined by the AlarmRule expression


    :param builtins.str alarm_name: The name of the Composite Alarm
    """
    __args__ = dict()
...
def get_composite_alarm_output(alarm_name: Optional[pulumi.Input[builtins.str]] = None,
