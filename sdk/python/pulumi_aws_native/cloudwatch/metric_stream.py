...
class MetricStreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] firehose_arn: The ARN of the Kinesis Firehose where to stream the data.
        ...
        :param pulumi.Input[builtins.bool] include_linked_accounts_metrics: If you are creating a metric stream in a monitoring account, specify true to include metrics from source accounts that are linked to this monitoring account, in the metric stream. The default is false.
        :param pulumi.Input[builtins.str] name: Name of the metric stream.
        :param pulumi.Input[builtins.str] output_format: The output format of the data streamed to the Kinesis Firehose.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the role that provides access to the Kinesis Firehose.
...
class MetricStream(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="firehoseArn")
    def firehose_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the Kinesis Firehose where to stream the data.
        """
        return pulumi.get(self, "firehose_arn")
