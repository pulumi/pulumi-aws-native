...
class GetMetricStreamResult:
    ...
    def firehose_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def include_linked_accounts_metrics(self) -> Optional[_builtins.bool]:
        """
...
def get_metric_stream(name: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetricStreamResult:
    """
    Resource Type definition for Metric Stream


    :param _builtins.str name: Name of the metric stream.
    """
    __args__ = dict()
    __args__['name'] = name
