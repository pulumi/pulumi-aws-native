...
class GetMetricStreamResult:
    ...
    def firehose_arn(self) -> Optional[builtins.str]:
        """
    ...
    def include_linked_accounts_metrics(self) -> Optional[builtins.bool]:
        """
    ...
    def last_update_date(self) -> Optional[builtins.str]:
        """
...
def get_metric_stream(name: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMetricStreamResult:
    """
    Resource Type definition for Metric Stream


    :param builtins.str name: Name of the metric stream.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_metric_stream_output(name: Optional[pulumi.Input[builtins.str]] = None,
