...
warnings.warn("""AnomalyDetector is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class AnomalyDetector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 stat: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AnomalyDetector is deprecated: AnomalyDetector is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
