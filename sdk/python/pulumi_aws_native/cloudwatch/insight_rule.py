...
class InsightRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InsightRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InsightRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InsightRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InsightRuleProperties']:
        """
