...
warnings.warn("""InsightRule is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class InsightRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[pulumi.InputType['InsightRuleTagsArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""InsightRule is deprecated: InsightRule is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
