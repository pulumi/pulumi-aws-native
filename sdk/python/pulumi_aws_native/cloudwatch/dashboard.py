...
class DashboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dashboard_body: The detailed information about the dashboard in JSON format, including the widgets to include and their location on the dashboard
        :param pulumi.Input[builtins.str] dashboard_name: The name of the dashboard. The name must be between 1 and 255 characters. If you do not specify a name, one will be generated automatically.
        """
    ...
    def dashboard_body(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dashboard_body(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:cloudwatch:Dashboard")
class Dashboard(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dashboardBody")
    def dashboard_body(self) -> pulumi.Output[builtins.str]:
        """
        The detailed information about the dashboard in JSON format, including the widgets to include and their location on the dashboard
        """
        return pulumi.get(self, "dashboard_body")
    ...
    @property
    @pulumi.getter(name="dashboardName")
    def dashboard_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the dashboard. The name must be between 1 and 255 characters. If you do not specify a name, one will be generated automatically.
        """
        return pulumi.get(self, "dashboard_name")
