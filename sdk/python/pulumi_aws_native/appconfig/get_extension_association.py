...
class GetExtensionAssociationResult:
    ...
    def extension_arn(self) -> Optional[builtins.str]:
        """
        The ARN of the extension defined in the association.
        """
...
def get_extension_association(id: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetExtensionAssociationResult:
    """
    An example resource schema demonstrating some basic constructs and validation rules.


    :param builtins.str id: The system-generated ID for the association.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_extension_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
