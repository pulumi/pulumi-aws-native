...
@pulumi.output_type
class ExperimentRunTreatmentOverrides(dict):
    """
    Treatment overrides for specific entities.
    """
    def __init__(__self__, *,
                 inline: Optional[Mapping[str, _builtins.str]] = None):
        """
        Treatment overrides for specific entities.

        :param Mapping[str, _builtins.str] inline: Map of entity ID to treatment key (t1, t2, ..., or c for control).
        """
    ...
    @_builtins.property
    @pulumi.getter
    def inline(self) -> Optional[Mapping[str, _builtins.str]]:
        """
