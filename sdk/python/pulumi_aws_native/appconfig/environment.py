...
class EnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description of the environment.
        ...
        :param pulumi.Input[builtins.str] name: A name for the environment.
...
@pulumi.type_token("aws-native:appconfig:Environment")
