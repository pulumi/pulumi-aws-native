...
class DeploymentStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] deployment_duration_in_minutes: Total amount of time for a deployment to last.
        :param pulumi.Input[float] growth_factor: The percentage of targets to receive a deployed configuration during each interval.
        ...
        :param pulumi.Input[str] description: A description of the deployment strategy.
        :param pulumi.Input[float] final_bake_time_in_minutes: Specifies the amount of time AWS AppConfig monitors for Amazon CloudWatch alarms after the configuration has been deployed to 100% of its targets, before considering the deployment to be complete. If an alarm is triggered during this time, AWS AppConfig rolls back the deployment. You must configure permissions for AWS AppConfig to roll back based on CloudWatch alarms. For more information, see Configuring permissions for rollback based on Amazon CloudWatch alarms in the AWS AppConfig User Guide.
        ...
        :param pulumi.Input[str] name: A name for the deployment strategy.
