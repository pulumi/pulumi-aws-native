...
class DeploymentStrategy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeploymentStrategyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeploymentStrategyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeploymentStrategyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeploymentStrategyProperties']:
        """
