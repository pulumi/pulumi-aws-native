...
class GetDeploymentResult:
    ...
    def deployment_number(self) -> Optional[_builtins.str]:
        """
...
def get_deployment(application_id: Optional[_builtins.str] = None,
                   deployment_number: Optional[_builtins.str] = None,
    ...
    :param _builtins.str deployment_number: The sequence number of the deployment.
