...
class ConfigurationProfileArgs:
    def __init__(__self__, *,
                 ...
                 location_uri: pulumi.Input[builtins.str],
                 ...
                 retrieval_role_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] location_uri: A URI to locate the configuration. You can specify the AWS AppConfig hosted configuration store, Systems Manager (SSM) document, an SSM Parameter Store parameter, or an Amazon S3 object.
        ...
        :param pulumi.Input[builtins.str] description: A description of the configuration profile.
        ...
        :param pulumi.Input[builtins.str] name: A name for the configuration profile.
        :param pulumi.Input[builtins.str] retrieval_role_arn: The ARN of an IAM role with permission to access the configuration at the specified LocationUri.
        ...
        :param pulumi.Input[builtins.str] type: The type of configurations contained in the profile. When calling this API, enter one of the following values for Type: AWS.AppConfig.FeatureFlags, AWS.Freeform
    ...
    def location_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @location_uri.setter
    def location_uri(self, value: pulumi.Input[builtins.str]):
    ...
    def retrieval_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def retrieval_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="retrievalRoleArn")
    def retrieval_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of an IAM role with permission to access the configuration at the specified LocationUri.
        """
        return pulumi.get(self, "retrieval_role_arn")
