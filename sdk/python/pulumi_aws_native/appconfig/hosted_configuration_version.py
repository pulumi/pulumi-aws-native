...
__all__ = ['HostedConfigurationVersion']
...
class HostedConfigurationVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['HostedConfigurationVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['HostedConfigurationVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.HostedConfigurationVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.HostedConfigurationVersionProperties']:
        """
