...
class HostedConfigurationVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_type: A standard MIME type describing the format of the configuration content.
        :param pulumi.Input[_builtins.str] description: A description of the hosted configuration version.
        :param pulumi.Input[_builtins.int] latest_version_number: An optional locking token used to prevent race conditions from overwriting configuration updates when creating a new version. To ensure your data is not overwritten when creating multiple hosted configuration versions in rapid succession, specify the version number of the latest hosted configuration version.
        :param pulumi.Input[_builtins.str] version_label: A user-defined label for an AWS AppConfig hosted configuration version.
        """
...
class HostedConfigurationVersion(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="latestVersionNumber")
    def latest_version_number(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        An optional locking token used to prevent race conditions from overwriting configuration updates when creating a new version. To ensure your data is not overwritten when creating multiple hosted configuration versions in rapid succession, specify the version number of the latest hosted configuration version.
        """
        return pulumi.get(self, "latest_version_number")
