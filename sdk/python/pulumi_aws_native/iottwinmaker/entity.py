...
class EntityArgs:
    def __init__(__self__, *,
                 ...
                 parent_entity_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the entity.
        :param pulumi.Input[builtins.str] entity_id: The ID of the entity.
        :param pulumi.Input[builtins.str] entity_name: The name of the entity.
        :param pulumi.Input[builtins.str] parent_entity_id: The ID of the parent entity.
    ...
    def parent_entity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_entity_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Entity(pulumi.CustomResource):
    ...
    def has_child_entities(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="parentEntityId")
    def parent_entity_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the parent entity.
        """
        return pulumi.get(self, "parent_entity_id")
