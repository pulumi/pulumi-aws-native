...
class GetSceneResult:
    ...
    def generated_scene_metadata(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def scene_metadata(self) -> Optional[Mapping[str, _builtins.str]]:
        """
...
def get_scene(scene_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scene_id: The ID of the scene.
    :param _builtins.str workspace_id: The ID of the scene.
    """
    __args__ = dict()
