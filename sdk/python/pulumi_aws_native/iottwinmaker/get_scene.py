...
class GetSceneResult:
    ...
    def generated_scene_metadata(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def scene_metadata(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_scene(scene_id: Optional[builtins.str] = None,
    ...
    :param builtins.str scene_id: The ID of the scene.
    :param builtins.str workspace_id: The ID of the scene.
    """
    __args__ = dict()
...
def get_scene_output(scene_id: Optional[pulumi.Input[builtins.str]] = None,
