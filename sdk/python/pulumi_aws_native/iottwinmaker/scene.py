...
class SceneArgs:
    def __init__(__self__, *,
                 content_location: pulumi.Input[builtins.str],
                 scene_id: pulumi.Input[builtins.str],
                 ...
                 scene_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Scene resource.
        :param pulumi.Input[builtins.str] content_location: The relative path that specifies the location of the content definition file.
        :param pulumi.Input[builtins.str] scene_id: The ID of the scene.
        :param pulumi.Input[builtins.str] workspace_id: The ID of the scene.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] capabilities: A list of capabilities that the scene uses to render.
        :param pulumi.Input[builtins.str] description: The description of the scene.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] scene_metadata: A key-value pair of scene metadata for the scene.
    ...
    def content_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def content_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "content_location", value)

    @property
    @pulumi.getter(name="sceneId")
    def scene_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the scene.
        """
    ...
    @scene_id.setter
    def scene_id(self, value: pulumi.Input[builtins.str]):
    ...
    def scene_metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def scene_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class Scene(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 scene_id: Optional[pulumi.Input[builtins.str]] = None,
                 scene_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="contentLocation")
    def content_location(self) -> pulumi.Output[builtins.str]:
        """
        The relative path that specifies the location of the content definition file.
        """
        return pulumi.get(self, "content_location")
    ...
    def generated_scene_metadata(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="sceneId")
    def scene_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the scene.
        """
        return pulumi.get(self, "scene_id")
    ...
    @property
    @pulumi.getter(name="sceneMetadata")
    def scene_metadata(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        A key-value pair of scene metadata for the scene.
        """
        return pulumi.get(self, "scene_metadata")
