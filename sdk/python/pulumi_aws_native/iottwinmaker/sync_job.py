...
class SyncJobArgs:
    def __init__(__self__, *,
                 sync_role: pulumi.Input[builtins.str],
                 sync_source: pulumi.Input[builtins.str],
                 workspace_id: pulumi.Input[builtins.str],
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SyncJob resource.
        :param pulumi.Input[builtins.str] sync_role: The IAM Role that execute SyncJob.
        :param pulumi.Input[builtins.str] sync_source: The source of the SyncJob.
    ...
    def sync_role(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sync_role.setter
    def sync_role(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sync_role", value)

    @property
    @pulumi.getter(name="syncSource")
    def sync_source(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sync_source.setter
    def sync_source(self, value: pulumi.Input[builtins.str]):
...
class SyncJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sync_source: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="syncRole")
    def sync_role(self) -> pulumi.Output[builtins.str]:
        """
        The IAM Role that execute SyncJob.
        """
        return pulumi.get(self, "sync_role")
    ...
    @property
    @pulumi.getter(name="syncSource")
    def sync_source(self) -> pulumi.Output[builtins.str]:
        """
        The source of the SyncJob.
        """
        return pulumi.get(self, "sync_source")
