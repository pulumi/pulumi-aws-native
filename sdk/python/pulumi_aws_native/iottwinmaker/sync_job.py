...
class SyncJobArgs:
    ...
    def sync_role(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @sync_role.setter
    def sync_role(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "sync_role", value)

    @_builtins.property
    @pulumi.getter(name="syncSource")
    def sync_source(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @sync_source.setter
    def sync_source(self, value: pulumi.Input[_builtins.str]):
...
class SyncJob(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="syncRole")
    def sync_role(self) -> pulumi.Output[_builtins.str]:
        """
        The IAM Role that execute SyncJob.
        """
        return pulumi.get(self, "sync_role")
    ...
    @_builtins.property
    @pulumi.getter(name="syncSource")
    def sync_source(self) -> pulumi.Output[_builtins.str]:
        """
        The source of the SyncJob.
        """
        return pulumi.get(self, "sync_source")
