...
class GetComponentTypeResult:
    ...
    def extends_from(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def is_abstract(self) -> Optional[builtins.bool]:
        """
    ...
    def is_schema_initialized(self) -> Optional[builtins.bool]:
        """
    ...
    def is_singleton(self) -> Optional[builtins.bool]:
        """
...
def get_component_type(component_type_id: Optional[builtins.str] = None,
    ...
    :param builtins.str workspace_id: The ID of the workspace that contains the component type.
    """
    __args__ = dict()
...
def get_component_type_output(component_type_id: Optional[pulumi.Input[builtins.str]] = None,
