...
class Discoverer(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DiscovererPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DiscovererPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DiscovererAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DiscovererProperties']:
        """
