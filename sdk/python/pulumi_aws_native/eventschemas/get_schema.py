...
class GetSchemaResult:
    ...
    def version_created_date(self) -> Optional[builtins.str]:
        """
...
def get_schema(schema_arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaResult:
    """
    Resource Type definition for AWS::EventSchemas::Schema


    :param builtins.str schema_arn: The ARN of the schema.
    """
    __args__ = dict()
...
def get_schema_output(schema_arn: Optional[pulumi.Input[builtins.str]] = None,
