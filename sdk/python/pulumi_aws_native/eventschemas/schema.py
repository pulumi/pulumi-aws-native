...
class SchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: The source of the schema definition.
        :param pulumi.Input[builtins.str] registry_name: The name of the schema registry.
        :param pulumi.Input[builtins.str] type: The type of schema. Valid types include OpenApi3 and JSONSchemaDraft4.
