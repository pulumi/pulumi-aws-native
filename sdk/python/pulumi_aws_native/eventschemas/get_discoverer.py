...
class GetDiscovererResult:
    ...
    def cross_account(self) -> Optional[builtins.bool]:
        """
    ...
    def discoverer_arn(self) -> Optional[builtins.str]:
        """
    ...
    def discoverer_id(self) -> Optional[builtins.str]:
        """
...
def get_discoverer(discoverer_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str discoverer_arn: The ARN of the discoverer.
    """
    __args__ = dict()
...
def get_discoverer_output(discoverer_arn: Optional[pulumi.Input[builtins.str]] = None,
