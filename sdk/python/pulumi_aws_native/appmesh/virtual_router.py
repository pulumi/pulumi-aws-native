...
class VirtualRouter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VirtualRouterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VirtualRouterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VirtualRouterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VirtualRouterProperties']:
        """
