...
class GetGatewayRouteResult:
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional['outputs.GatewayRouteSpec']:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GatewayRouteTag']]:
...
def get_gateway_route(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('aws-native:appmesh:getGatewayRoute', __args__, opts=opts, typ=GetGatewayRouteResult).value
