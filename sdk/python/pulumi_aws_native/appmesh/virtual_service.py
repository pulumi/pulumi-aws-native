...
class VirtualServiceArgs:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['VirtualServiceTagArgs']]]]:
...
warnings.warn("""VirtualService is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class VirtualService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.VirtualServiceTag']]]:
        return pulumi.get(self, "tags")
