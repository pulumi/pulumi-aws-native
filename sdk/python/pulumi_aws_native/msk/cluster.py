...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(broker_node_group_info, ClusterBrokerNodeGroupInfoArgs):
            ...
            if not isinstance(client_authentication, ClusterClientAuthenticationArgs):
            ...
            if not isinstance(configuration_info, ClusterConfigurationInfoArgs):
            ...
            if not isinstance(encryption_info, ClusterEncryptionInfoArgs):
            ...
            if not isinstance(logging_info, ClusterLoggingInfoArgs):
            ...
            if not isinstance(open_monitoring, ClusterOpenMonitoringArgs):
