...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 kafka_version: pulumi.Input[builtins.str],
                 number_of_broker_nodes: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] kafka_version: The version of Apache Kafka. You can use Amazon MSK to create clusters that use [supported Apache Kafka versions](https://docs.aws.amazon.com/msk/latest/developerguide/supported-kafka-versions.html) .
        :param pulumi.Input[builtins.int] number_of_broker_nodes: The number of broker nodes in the cluster.
        ...
        :param pulumi.Input[builtins.str] current_version: The current version of the MSK cluster
    ...
    def kafka_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def kafka_version(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "kafka_version", value)

    @property
    @pulumi.getter(name="numberOfBrokerNodes")
    def number_of_broker_nodes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def number_of_broker_nodes(self, value: pulumi.Input[builtins.int]):
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="kafkaVersion")
    def kafka_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of Apache Kafka. You can use Amazon MSK to create clusters that use [supported Apache Kafka versions](https://docs.aws.amazon.com/msk/latest/developerguide/supported-kafka-versions.html) .
        """
        return pulumi.get(self, "kafka_version")
    ...
    @property
    @pulumi.getter(name="numberOfBrokerNodes")
    def number_of_broker_nodes(self) -> pulumi.Output[builtins.int]:
        """
        The number of broker nodes in the cluster.
        """
        return pulumi.get(self, "number_of_broker_nodes")
