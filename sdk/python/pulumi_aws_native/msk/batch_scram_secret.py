...
class BatchScramSecretArgs:
    def __init__(__self__, *,
                 ...
                 secret_arn_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] secret_arn_list: List of Amazon Resource Name (ARN)s of Secrets Manager secrets.
        """
    ...
    def secret_arn_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def secret_arn_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BatchScramSecret(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="secretArnList")
    def secret_arn_list(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of Amazon Resource Name (ARN)s of Secrets Manager secrets.
        """
        return pulumi.get(self, "secret_arn_list")
