...
class GetReplicatorResult:
    ...
    def replicator_arn(self) -> Optional[builtins.str]:
        """
...
def get_replicator(replicator_arn: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReplicatorResult:
    """
    Resource Type definition for AWS::MSK::Replicator


    :param builtins.str replicator_arn: Amazon Resource Name for the created replicator.
    """
    __args__ = dict()
...
def get_replicator_output(replicator_arn: Optional[pulumi.Input[builtins.str]] = None,
