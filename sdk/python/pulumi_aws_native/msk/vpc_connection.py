...
class VpcConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_cluster_arn: The Amazon Resource Name (ARN) of the target cluster
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID of the remote client.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: An arbitrary set of tags (key-value pairs) you specify while creating the VPC connection.
        """
