...
@pulumi.output_type
class ConfigurationRevision(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "creationTime":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ConfigurationRevision. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ConfigurationRevision.__key_warning(key)
        return super().__getitem__(key)
