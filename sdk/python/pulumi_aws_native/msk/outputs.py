...
class ClusterBrokerNodeGroupInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str instance_type: The type of Amazon EC2 instances to use for brokers. Depending on the [broker type](https://docs.aws.amazon.com/msk/latest/developerguide/broker-instance-types.html) , Amazon MSK supports the following broker sizes:
