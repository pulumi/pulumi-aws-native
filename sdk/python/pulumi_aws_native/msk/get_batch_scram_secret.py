...
class GetBatchScramSecretResult:
    ...
    def secret_arn_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_batch_scram_secret(cluster_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_arn: The Amazon Resource Name (ARN) that uniquely identifies the cluster.
    """
    __args__ = dict()
...
def get_batch_scram_secret_output(cluster_arn: Optional[pulumi.Input[builtins.str]] = None,
