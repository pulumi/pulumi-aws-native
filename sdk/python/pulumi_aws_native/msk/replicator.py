...
class ReplicatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_execution_role_arn: The Amazon Resource Name (ARN) of the IAM role used by the replicator to access external resources.
...
class Replicator(pulumi.CustomResource):
    ...
    def replicator_arn(self) -> pulumi.Output[builtins.str]:
        """
