...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_arn: The ARN of the AWS CloudTrail resource to which the policy applies.
...
@pulumi.type_token("aws-native:cloudtrail:ResourcePolicy")
