...
class ChannelDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        The resource that receives events arriving from a channel.
        :param pulumi.Input[builtins.str] location: The ARN of a resource that receives events from a channel.
...
class DashboardRefreshScheduleFrequencyPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] value: The frequency value.
        """
...
class DashboardRefreshScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_of_day: StartTime of the automatic schedule refresh.
        """
...
if not MYPY:
    class DashboardWidgetArgsDict(TypedDict):
        ...
        """
        query_parameters: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The placeholder keys in the QueryStatement. For example: $StartTime$, $EndTime$, $Period$.
        """
        view_properties: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class DashboardWidgetArgs:
    def __init__(__self__, *,
                 query_statement: pulumi.Input[builtins.str],
                 query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 view_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The dashboard widget
        :param pulumi.Input[builtins.str] query_statement: The SQL query statement on one or more event data stores.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_parameters: The placeholder keys in the QueryStatement. For example: $StartTime$, $EndTime$, $Period$.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] view_properties: The view properties of the widget.
        """
    ...
    def query_parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The placeholder keys in the QueryStatement. For example: $StartTime$, $EndTime$, $Period$.
        """
    ...
    def query_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "query_parameters", value)

    @property
    @pulumi.getter(name="viewProperties")
    def view_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The view properties of the widget.
        """
    ...
    def view_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class EventDataStoreAdvancedEventSelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: An optional, descriptive name for an advanced event selector, such as "Log data events for only two S3 buckets".
        """
...
if not MYPY:
    class EventDataStoreAdvancedFieldSelectorArgsDict(TypedDict):
        ...
        """
        ends_with: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        not_ends_with: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        not_starts_with: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        An operator that excludes events that match the first few characters of the event record field specified as the value of Field.
        """
        starts_with: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class EventDataStoreAdvancedFieldSelectorArgs:
    def __init__(__self__, *,
                 field: pulumi.Input[builtins.str],
                 ends_with: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 equals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 not_ends_with: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 not_starts_with: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 starts_with: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        A single selector statement in an advanced event selector.
        :param pulumi.Input[builtins.str] field: A field in an event record on which to filter events to be logged. Supported fields include readOnly, eventCategory, eventSource (for management events), eventName, resources.type, and resources.ARN.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ends_with: An operator that includes events that match the last few characters of the event record field specified as the value of Field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] equals: An operator that includes events that match the exact value of the event record field specified as the value of Field. This is the only valid operator that you can use with the readOnly, eventCategory, and resources.type fields.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_ends_with: An operator that excludes events that match the last few characters of the event record field specified as the value of Field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_equals: An operator that excludes events that match the exact value of the event record field specified as the value of Field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_starts_with: An operator that excludes events that match the first few characters of the event record field specified as the value of Field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] starts_with: An operator that includes events that match the first few characters of the event record field specified as the value of Field.
        """
    ...
    def ends_with(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An operator that includes events that match the last few characters of the event record field specified as the value of Field.
        """
    ...
    @ends_with.setter
    def ends_with(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def not_ends_with(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An operator that excludes events that match the last few characters of the event record field specified as the value of Field.
        """
    ...
    def not_ends_with(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def not_starts_with(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An operator that excludes events that match the first few characters of the event record field specified as the value of Field.
        """
    ...
    def not_starts_with(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "not_starts_with", value)

    @property
    @pulumi.getter(name="startsWith")
    def starts_with(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An operator that includes events that match the first few characters of the event record field specified as the value of Field.
        """
...
if not MYPY:
    class EventDataStoreInsightSelectorArgsDict(TypedDict):
        ...
        """
        insight_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EventDataStoreInsightSelectorArgs:
    def __init__(__self__, *,
                 insight_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        A string that contains Insights types that are logged on an event data store.
        :param pulumi.Input[builtins.str] insight_type: The type of Insights to log on an event data store.
        """
    ...
    def insight_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of Insights to log on an event data store.
        """
    ...
    @insight_type.setter
    def insight_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TrailDataResourceArgs:
    def __init__(__self__, *,
        ...
        """
        CloudTrail supports data event logging for Amazon S3 objects and AWS Lambda functions. You can specify up to 250 resources for an individual event selector, but the total number of data resources cannot exceed 250 across all event selectors in a trail. This limit does not apply if you configure resource logging for all data events.
        :param pulumi.Input[builtins.str] type: The resource type in which you want to log data events. You can specify AWS::S3::Object or AWS::Lambda::Function resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: An array of Amazon Resource Name (ARN) strings or partial ARN strings for the specified objects.
        """
        pulumi.set(__self__, "type", type)
...
class TrailEventSelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TrailDataResourceArgs']]] data_resources: CloudTrail supports data event logging for Amazon S3 objects in standard S3 buckets, AWS Lambda functions, and Amazon DynamoDB tables with basic event selectors. You can specify up to 250 resources for an individual event selector, but the total number of data resources cannot exceed 250 across all event selectors in a trail. This limit does not apply if you configure resource logging for all data events.
               ...
               > To log data events for all other resource types including objects stored in [directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-overview.html) , you must use [AdvancedEventSelectors](https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_AdvancedEventSelector.html) . You must also use `AdvancedEventSelectors` if you want to filter on the `eventName` field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_management_event_sources: An optional list of service event sources from which you do not want management events to be logged on your trail. In this release, the list can be empty (disables the filter), or it can filter out AWS Key Management Service events by containing "kms.amazonaws.com". By default, ExcludeManagementEventSources is empty, and AWS KMS events are included in events that are logged to your trail.
        :param pulumi.Input[builtins.bool] include_management_events: Specify if you want your event selector to include management events for your trail.
...
class TrailInsightSelectorArgs:
    def __init__(__self__, *,
        ...
        """
        A string that contains insight types that are logged on a trail.
        :param pulumi.Input[builtins.str] insight_type: The type of insight to log on a trail.
        """
        if insight_type is not None:
            pulumi.set(__self__, "insight_type", insight_type)
