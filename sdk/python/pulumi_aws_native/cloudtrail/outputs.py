...
class ChannelDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The resource that receives events arriving from a channel.
        :param builtins.str location: The ARN of a resource that receives events from a channel.
...
class DashboardRefreshSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_of_day: Optional[builtins.str] = None):
        """
        Configures the automatic refresh schedule for the dashboard. Includes the frequency unit (DAYS or HOURS) and value, as well as the status (ENABLED or DISABLED) of the refresh schedule.
        ...
        :param builtins.str time_of_day: StartTime of the automatic schedule refresh.
        """
    ...
    def time_of_day(self) -> Optional[builtins.str]:
        """
...
class DashboardRefreshScheduleFrequencyProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int value: The frequency value.
        """
...
class DashboardWidget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query_parameters: Optional[Sequence[builtins.str]] = None,
                 view_properties: Optional[Mapping[str, builtins.str]] = None):
        """
        The dashboard widget
        :param builtins.str query_statement: The SQL query statement on one or more event data stores.
        :param Sequence[builtins.str] query_parameters: The placeholder keys in the QueryStatement. For example: $StartTime$, $EndTime$, $Period$.
        :param Mapping[str, builtins.str] view_properties: The view properties of the widget.
        """
    ...
    def query_parameters(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def view_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class EventDataStoreAdvancedEventSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: An optional, descriptive name for an advanced event selector, such as "Log data events for only two S3 buckets".
        """
...
class EventDataStoreAdvancedFieldSelector(dict):
    ...
    def __init__(__self__, *,
                 field: builtins.str,
                 ends_with: Optional[Sequence[builtins.str]] = None,
                 equals: Optional[Sequence[builtins.str]] = None,
                 not_ends_with: Optional[Sequence[builtins.str]] = None,
                 not_equals: Optional[Sequence[builtins.str]] = None,
                 not_starts_with: Optional[Sequence[builtins.str]] = None,
                 starts_with: Optional[Sequence[builtins.str]] = None):
        """
        A single selector statement in an advanced event selector.
        :param builtins.str field: A field in an event record on which to filter events to be logged. Supported fields include readOnly, eventCategory, eventSource (for management events), eventName, resources.type, and resources.ARN.
        :param Sequence[builtins.str] ends_with: An operator that includes events that match the last few characters of the event record field specified as the value of Field.
        :param Sequence[builtins.str] equals: An operator that includes events that match the exact value of the event record field specified as the value of Field. This is the only valid operator that you can use with the readOnly, eventCategory, and resources.type fields.
        :param Sequence[builtins.str] not_ends_with: An operator that excludes events that match the last few characters of the event record field specified as the value of Field.
        :param Sequence[builtins.str] not_equals: An operator that excludes events that match the exact value of the event record field specified as the value of Field.
        :param Sequence[builtins.str] not_starts_with: An operator that excludes events that match the first few characters of the event record field specified as the value of Field.
        :param Sequence[builtins.str] starts_with: An operator that includes events that match the first few characters of the event record field specified as the value of Field.
        """
    ...
    def ends_with(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def equals(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_ends_with(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_equals(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_starts_with(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def starts_with(self) -> Optional[Sequence[builtins.str]]:
        """
...
class EventDataStoreInsightSelector(dict):
    ...
    def __init__(__self__, *,
                 insight_type: Optional[builtins.str] = None):
        """
        A string that contains Insights types that are logged on an event data store.
        :param builtins.str insight_type: The type of Insights to log on an event data store.
        """
    ...
    def insight_type(self) -> Optional[builtins.str]:
        """
...
class TrailDataResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CloudTrail supports data event logging for Amazon S3 objects and AWS Lambda functions. You can specify up to 250 resources for an individual event selector, but the total number of data resources cannot exceed 250 across all event selectors in a trail. This limit does not apply if you configure resource logging for all data events.
        :param builtins.str type: The resource type in which you want to log data events. You can specify AWS::S3::Object or AWS::Lambda::Function resources.
        :param Sequence[builtins.str] values: An array of Amazon Resource Name (ARN) strings or partial ARN strings for the specified objects.
        """
        pulumi.set(__self__, "type", type)
...
class TrailEventSelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclude_management_event_sources: Optional[Sequence[builtins.str]] = None,
                 include_management_events: Optional[builtins.bool] = None,
        ...
        :param Sequence[builtins.str] exclude_management_event_sources: An optional list of service event sources from which you do not want management events to be logged on your trail. In this release, the list can be empty (disables the filter), or it can filter out AWS Key Management Service events by containing "kms.amazonaws.com". By default, ExcludeManagementEventSources is empty, and AWS KMS events are included in events that are logged to your trail.
        :param builtins.bool include_management_events: Specify if you want your event selector to include management events for your trail.
    ...
    def exclude_management_event_sources(self) -> Optional[Sequence[builtins.str]]:
        """
        An optional list of service event sources from which you do not want management events to be logged on your trail. In this release, the list can be empty (disables the filter), or it can filter out AWS Key Management Service events by containing "kms.amazonaws.com". By default, ExcludeManagementEventSources is empty, and AWS KMS events are included in events that are logged to your trail.
        """
    ...
    def include_management_events(self) -> Optional[builtins.bool]:
        """
...
class TrailInsightSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A string that contains insight types that are logged on a trail.
        :param builtins.str insight_type: The type of insight to log on a trail.
        """
        if insight_type is not None:
            pulumi.set(__self__, "insight_type", insight_type)
