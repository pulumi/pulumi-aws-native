...
class Channel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 destinations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ChannelDestinationArgs', 'ChannelDestinationArgsDict', 'outputs.ChannelDestination']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 source: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ChannelDestinationArgs', 'ChannelDestinationArgsDict', 'outputs.ChannelDestination']]]] destinations: One or more resources to which events arriving through a channel are logged and stored.
        :param pulumi.Input[_builtins.str] name: The name of the channel.
        :param pulumi.Input[_builtins.str] source: The ARN of an on-premises storage solution or application, or a partner event source.
