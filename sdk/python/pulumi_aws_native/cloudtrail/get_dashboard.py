...
class GetDashboardResult:
    ...
    def termination_protection_enabled(self) -> Optional[_builtins.bool]:
        """
...
def get_dashboard(dashboard_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dashboard_arn: The ARN of the dashboard.
    """
    __args__ = dict()
...
def get_dashboard_output(dashboard_arn: Optional[pulumi.Input[_builtins.str]] = None,
