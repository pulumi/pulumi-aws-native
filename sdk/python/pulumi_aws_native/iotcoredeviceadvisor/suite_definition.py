...
class SuiteDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SuiteDefinitionConfigurationPropertiesArgs'] suite_definition_configuration: The configuration of the Suite Definition. Listed below are the required elements of the `SuiteDefinitionConfiguration` .
