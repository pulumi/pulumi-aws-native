...
class GetSuiteDefinitionResult:
    ...
    def suite_definition_arn(self) -> Optional[builtins.str]:
        """
    ...
    def suite_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def suite_definition_version(self) -> Optional[builtins.str]:
        """
...
def get_suite_definition(suite_definition_id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSuiteDefinitionResult:
    """
    An example resource schema demonstrating some basic constructs and validation rules.


    :param builtins.str suite_definition_id: The unique identifier for the suite definition.
    """
    __args__ = dict()
...
def get_suite_definition_output(suite_definition_id: Optional[pulumi.Input[builtins.str]] = None,
