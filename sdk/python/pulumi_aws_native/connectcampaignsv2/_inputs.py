...
if not MYPY:
    class CampaignAnswerMachineDetectionConfigArgsDict(TypedDict):
        ...
        """
        enable_answer_machine_detection: pulumi.Input[builtins.bool]
        """
        Flag to decided whether outbound calls should have answering machine detection enabled or not
        """
        await_answer_machine_prompt: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CampaignAnswerMachineDetectionConfigArgs:
    def __init__(__self__, *,
                 enable_answer_machine_detection: pulumi.Input[builtins.bool],
                 await_answer_machine_prompt: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The configuration used for answering machine detection during outbound calls
        :param pulumi.Input[builtins.bool] enable_answer_machine_detection: Flag to decided whether outbound calls should have answering machine detection enabled or not
        :param pulumi.Input[builtins.bool] await_answer_machine_prompt: Enables detection of prompts (e.g., beep after after a voicemail greeting)
        """
    ...
    def enable_answer_machine_detection(self) -> pulumi.Input[builtins.bool]:
        """
        Flag to decided whether outbound calls should have answering machine detection enabled or not
        """
    ...
    def enable_answer_machine_detection(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "enable_answer_machine_detection", value)

    @property
    @pulumi.getter(name="awaitAnswerMachinePrompt")
    def await_answer_machine_prompt(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables detection of prompts (e.g., beep after after a voicemail greeting)
        """
    ...
    def await_answer_machine_prompt(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CampaignCommunicationLimitArgsDict(TypedDict):
        ...
        max_count_per_recipient: pulumi.Input[builtins.int]
...
class CampaignCommunicationLimitArgs:
    ...
    def max_count_per_recipient(self) -> pulumi.Input[builtins.int]:
        return pulumi.get(self, "max_count_per_recipient")

    @max_count_per_recipient.setter
    def max_count_per_recipient(self, value: pulumi.Input[builtins.int]):
...
class CampaignEmailChannelSubtypeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] capacity: The allocation of email capacity between multiple running outbound campaigns.
        """
...
if not MYPY:
    class CampaignEmailOutboundConfigArgsDict(TypedDict):
        ...
        """
        connect_source_email_address: pulumi.Input[builtins.str]
        """
        The Amazon Connect source email address.
        """
        wisdom_template_arn: pulumi.Input[builtins.str]
        """
        The Amazon Resource Name (ARN) of the Amazon Q in Connect template.
        """
        source_email_address_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignEmailOutboundConfigArgs:
    def __init__(__self__, *,
                 connect_source_email_address: pulumi.Input[builtins.str],
                 wisdom_template_arn: pulumi.Input[builtins.str],
                 source_email_address_display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Default SMS outbound config
        :param pulumi.Input[builtins.str] connect_source_email_address: The Amazon Connect source email address.
        :param pulumi.Input[builtins.str] wisdom_template_arn: The Amazon Resource Name (ARN) of the Amazon Q in Connect template.
        :param pulumi.Input[builtins.str] source_email_address_display_name: The display name for the Amazon Connect source email address.
        """
    ...
    def connect_source_email_address(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Connect source email address.
        """
    ...
    def connect_source_email_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "connect_source_email_address", value)

    @property
    @pulumi.getter(name="wisdomTemplateArn")
    def wisdom_template_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the Amazon Q in Connect template.
        """
    ...
    def wisdom_template_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "wisdom_template_arn", value)

    @property
    @pulumi.getter(name="sourceEmailAddressDisplayName")
    def source_email_address_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The display name for the Amazon Connect source email address.
        """
    ...
    def source_email_address_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CampaignEventTriggerArgsDict(TypedDict):
        ...
        """
        customer_profiles_domain_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignEventTriggerArgs:
    def __init__(__self__, *,
                 customer_profiles_domain_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The event trigger of the campaign
        :param pulumi.Input[builtins.str] customer_profiles_domain_arn: The Amazon Resource Name (ARN) of the Customer Profiles domain.
        """
    ...
    def customer_profiles_domain_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Customer Profiles domain.
        """
    ...
    def customer_profiles_domain_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CampaignLocalTimeZoneConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Local time zone config
        :param pulumi.Input[builtins.str] default_time_zone: The timezone to use for all recipients.
...
if not MYPY:
    class CampaignPredictiveConfigArgsDict(TypedDict):
        ...
        Predictive config
        """
        bandwidth_allocation: pulumi.Input[builtins.float]
        """
...
class CampaignPredictiveConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Predictive config
        :param pulumi.Input[builtins.float] bandwidth_allocation: Bandwidth allocation for the predictive outbound mode.
        """
        pulumi.set(__self__, "bandwidth_allocation", bandwidth_allocation)

    @property
    @pulumi.getter(name="bandwidthAllocation")
    def bandwidth_allocation(self) -> pulumi.Input[builtins.float]:
        """
        Bandwidth allocation for the predictive outbound mode.
        """
    ...
    def bandwidth_allocation(self, value: pulumi.Input[builtins.float]):
...
class CampaignProgressiveConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Progressive config
        :param pulumi.Input[builtins.float] bandwidth_allocation: Bandwidth allocation for the progressive outbound mode.
        """
        pulumi.set(__self__, "bandwidth_allocation", bandwidth_allocation)
...
class CampaignRestrictedPeriodArgs:
    def __init__(__self__, *,
        ...
        """
        Restricted period
        :param pulumi.Input[builtins.str] name: The name of a restricted period
        """
...
if not MYPY:
    class CampaignScheduleArgsDict(TypedDict):
        ...
        """
        refresh_frequency: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignScheduleArgs:
    def __init__(__self__, *,
                 end_time: pulumi.Input[builtins.str],
                 start_time: pulumi.Input[builtins.str],
                 refresh_frequency: Optional[pulumi.Input[builtins.str]] = None):
        """
        Campaign schedule
        :param pulumi.Input[builtins.str] end_time: The end time of the schedule in UTC.
        :param pulumi.Input[builtins.str] start_time: The start time of the schedule in UTC.
        :param pulumi.Input[builtins.str] refresh_frequency: The refresh frequency of the campaign.
        """
    ...
    def refresh_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The refresh frequency of the campaign.
        """
    ...
    def refresh_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CampaignSmsChannelSubtypeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] capacity: The allocation of SMS capacity between multiple running outbound campaigns.
        """
        pulumi.set(__self__, "default_outbound_config", default_outbound_config)
        pulumi.set(__self__, "outbound_mode", outbound_mode)
        if capacity is not None:
...
if not MYPY:
    class CampaignSmsOutboundConfigArgsDict(TypedDict):
        ...
        Default SMS outbound config
        """
        connect_source_phone_number_arn: pulumi.Input[builtins.str]
        """
...
class CampaignSmsOutboundConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Default SMS outbound config
        :param pulumi.Input[builtins.str] connect_source_phone_number_arn: The Amazon Resource Name (ARN) of the Amazon Connect source SMS phone number.
        :param pulumi.Input[builtins.str] wisdom_template_arn: The Amazon Resource Name (ARN) of the Amazon Q in Connect template.
        """
    ...
    def connect_source_phone_number_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the Amazon Connect source SMS phone number.
        """
    ...
    def connect_source_phone_number_arn(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CampaignSourceArgsDict(TypedDict):
        ...
        """
        customer_profiles_segment_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignSourceArgs:
    def __init__(__self__, *,
                 customer_profiles_segment_arn: Optional[pulumi.Input[builtins.str]] = None,
                 event_trigger: Optional[pulumi.Input['CampaignEventTriggerArgs']] = None):
        """
        The possible source of the campaign
        :param pulumi.Input[builtins.str] customer_profiles_segment_arn: The Amazon Resource Name (ARN) of the Customer Profiles segment.
    ...
    def customer_profiles_segment_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Customer Profiles segment.
        """
    ...
    def customer_profiles_segment_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CampaignTelephonyChannelSubtypeConfigArgsDict(TypedDict):
        ...
        """
        connect_queue_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignTelephonyChannelSubtypeConfigArgs:
    def __init__(__self__, *,
                 ...
                 capacity: Optional[pulumi.Input[builtins.float]] = None,
                 connect_queue_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Telephony Channel Subtype config
        ...
        :param pulumi.Input[builtins.float] capacity: The allocation of telephony capacity between multiple running outbound campaigns.
        :param pulumi.Input[builtins.str] connect_queue_id: The identifier of the Amazon Connect queue associated with telephony outbound requests of an outbound campaign.
        """
        pulumi.set(__self__, "default_outbound_config", default_outbound_config)
        pulumi.set(__self__, "outbound_mode", outbound_mode)
        if capacity is not None:
    ...
    def connect_queue_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the Amazon Connect queue associated with telephony outbound requests of an outbound campaign.
        """
    ...
    def connect_queue_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CampaignTelephonyOutboundConfigArgsDict(TypedDict):
        ...
        """
        connect_contact_flow_id: pulumi.Input[builtins.str]
        """
        ...
        """
        connect_source_phone_number: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CampaignTelephonyOutboundConfigArgs:
    def __init__(__self__, *,
                 ...
                 connect_source_phone_number: Optional[pulumi.Input[builtins.str]] = None):
        """
        Default Telephone Outbound config
        :param pulumi.Input[builtins.str] connect_contact_flow_id: The identifier of the published Amazon Connect contact flow.
        ...
        :param pulumi.Input[builtins.str] connect_source_phone_number: The Amazon Connect source phone number.
        """
    ...
    def connect_contact_flow_id(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the published Amazon Connect contact flow.
        """
    ...
    def connect_contact_flow_id(self, value: pulumi.Input[builtins.str]):
    ...
    def connect_source_phone_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Connect source phone number.
        """
    ...
    def connect_source_phone_number(self, value: Optional[pulumi.Input[builtins.str]]):
