...
class GetAccountAliasResult:
    ...
    def account_alias(self) -> Optional[builtins.str]:
        """
    ...
    def account_alias_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_account_alias(account_alias_resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_alias_resource_id: Unique identifier representing an alias tied to an account
    """
    __args__ = dict()
...
def get_account_alias_output(account_alias_resource_id: Optional[pulumi.Input[builtins.str]] = None,
