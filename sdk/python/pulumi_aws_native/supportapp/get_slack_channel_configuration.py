...
class GetSlackChannelConfigurationResult:
    ...
    def channel_role_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def notify_on_add_correspondence_to_case(self) -> Optional[_builtins.bool]:
        """
    ...
    def notify_on_create_or_reopen_case(self) -> Optional[_builtins.bool]:
        """
    ...
    def notify_on_resolve_case(self) -> Optional[_builtins.bool]:
        """
...
def get_slack_channel_configuration(channel_id: Optional[_builtins.str] = None,
