...
class SlackChannelConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 channel_role_arn: pulumi.Input[builtins.str],
                 ...
                 notify_on_add_correspondence_to_case: Optional[pulumi.Input[builtins.bool]] = None,
                 notify_on_create_or_reopen_case: Optional[pulumi.Input[builtins.bool]] = None,
                 notify_on_resolve_case: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SlackChannelConfiguration resource.
        :param pulumi.Input[builtins.str] channel_id: The channel ID in Slack, which identifies a channel within a workspace.
        :param pulumi.Input[builtins.str] channel_role_arn: The Amazon Resource Name (ARN) of an IAM role that grants the AWS Support App access to perform operations for AWS services.
        ...
        :param pulumi.Input[builtins.str] team_id: The team ID in Slack, which uniquely identifies a workspace.
        :param pulumi.Input[builtins.str] channel_name: The channel name in Slack.
        :param pulumi.Input[builtins.bool] notify_on_add_correspondence_to_case: Whether to notify when a correspondence is added to a case.
        :param pulumi.Input[builtins.bool] notify_on_create_or_reopen_case: Whether to notify when a case is created or reopened.
        :param pulumi.Input[builtins.bool] notify_on_resolve_case: Whether to notify when a case is resolved.
        """
    ...
    def channel_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def channel_role_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def notify_on_add_correspondence_to_case(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_on_add_correspondence_to_case(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_on_add_correspondence_to_case", value)

    @property
    @pulumi.getter(name="notifyOnCreateOrReopenCase")
    def notify_on_create_or_reopen_case(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_on_create_or_reopen_case(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_on_create_or_reopen_case", value)

    @property
    @pulumi.getter(name="notifyOnResolveCase")
    def notify_on_resolve_case(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_on_resolve_case(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SlackChannelConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 channel_name: Optional[pulumi.Input[builtins.str]] = None,
                 channel_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 notify_on_add_correspondence_to_case: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["channelId", "teamId"])
    ...
    @property
    @pulumi.getter(name="channelRoleArn")
    def channel_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) of an IAM role that grants the AWS Support App access to perform operations for AWS services.
        """
        return pulumi.get(self, "channel_role_arn")
    ...
    @property
    @pulumi.getter(name="notifyOnAddCorrespondenceToCase")
    def notify_on_add_correspondence_to_case(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to notify when a correspondence is added to a case.
        """
        return pulumi.get(self, "notify_on_add_correspondence_to_case")
    ...
    @property
    @pulumi.getter(name="notifyOnCreateOrReopenCase")
    def notify_on_create_or_reopen_case(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to notify when a case is created or reopened.
        """
        return pulumi.get(self, "notify_on_create_or_reopen_case")
    ...
    @property
    @pulumi.getter(name="notifyOnResolveCase")
    def notify_on_resolve_case(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to notify when a case is resolved.
        """
        return pulumi.get(self, "notify_on_resolve_case")
