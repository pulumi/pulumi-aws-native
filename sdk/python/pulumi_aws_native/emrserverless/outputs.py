...
class ApplicationAutoStartConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for Auto Start of Application
        :param builtins.bool enabled: If set to true, the Application will automatically start. Defaults to true.
        """
...
class ApplicationAutoStopConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for Auto Stop of Application
        :param builtins.bool enabled: If set to true, the Application will automatically stop after being idle. Defaults to true.
        :param builtins.int idle_timeout_minutes: The amount of time [in minutes] to wait before auto stopping the Application when idle. Defaults to 15 minutes.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ApplicationCloudWatchLoggingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None,
                 encryption_key_arn: Optional[builtins.str] = None,
                 log_group_name: Optional[builtins.str] = None,
                 log_stream_name_prefix: Optional[builtins.str] = None,
                 log_type_map: Optional[Sequence['outputs.ApplicationLogTypeMapKeyValuePair']] = None):
        """
        :param builtins.bool enabled: If set to false, CloudWatch logging will be turned off. Defaults to false.
        :param builtins.str encryption_key_arn: KMS key ARN to encrypt the logs stored in given CloudWatch log-group.
        :param builtins.str log_group_name: Log-group name to produce log-streams on CloudWatch. If undefined, logs will be produced in a default log-group /aws/emr-serverless
        :param builtins.str log_stream_name_prefix: Log-stream name prefix by which log-stream names will start in the CloudWatch Log-group.
    ...
    def log_stream_name_prefix(self) -> Optional[builtins.str]:
        """
...
class ApplicationConfigurationObject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration for a JobRun.
        :param builtins.str classification: String with a maximum length of 1024.
        """
...
class ApplicationImageConfigurationInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The image configuration.
        :param builtins.str image_uri: The URI of an image in the Amazon ECR registry. This field is required when you create a new application. If you leave this field blank in an update, Amazon EMR will remove the image configuration.
        """
...
class ApplicationInitialCapacityConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int worker_count: Initial count of workers to be initialized when an Application is started. This count will be continued to be maintained until the Application is stopped
        """
...
class ApplicationInitialCapacityConfigKeyValuePair(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Worker type for an analytics framework.
        """
...
class ApplicationInteractiveConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool studio_enabled: Enabled you to connect an Application to Amazon EMR Studio to run interactive workloads in a notebook
        """
...
class ApplicationManagedPersistenceMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encryption_key_arn: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: If set to false, managed logging will be turned off. Defaults to true.
        :param builtins.str encryption_key_arn: KMS key ARN to encrypt the logs stored in managed persistence
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if encryption_key_arn is not None:
...
class ApplicationMaximumAllowedResources(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cpu: Per worker CPU resource. vCPU is the only supported unit and specifying vCPU is optional.
        :param builtins.str memory: Per worker memory resource. GB is the only supported unit and specifying GB is optional.
        :param builtins.str disk: Per worker Disk resource. GB is the only supported unit and specifying GB is optional
        """
...
class ApplicationNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: The ID of the security groups in the VPC to which you want to connect your job or application.
        :param Sequence[builtins.str] subnet_ids: The ID of the subnets in the VPC to which you want to connect your job or application.
        """
...
class ApplicationPrometheusMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
                 remote_write_url: Optional[builtins.str] = None):
        """
        :param builtins.str remote_write_url: The remote write URL in the Amazon Managed Service for Prometheus workspace to send metrics to.
        """
    ...
    def remote_write_url(self) -> Optional[builtins.str]:
        """
...
class ApplicationS3MonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encryption_key_arn: KMS key ARN to encrypt the logs stored in given s3
        """
        if encryption_key_arn is not None:
            pulumi.set(__self__, "encryption_key_arn", encryption_key_arn)
...
class ApplicationSchedulerConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 queue_timeout_minutes: Optional[builtins.int] = None):
        """
        The scheduler configuration for batch and streaming jobs running on this application. Supported with release labels emr-7.0.0 and above.
        :param builtins.int max_concurrent_runs: The maximum concurrent job runs on this application. If scheduler configuration is enabled on your application, the default value is 15. The valid range is 1 to 1000.
        :param builtins.int queue_timeout_minutes: The maximum duration in minutes for the job in QUEUED state. If scheduler configuration is enabled on your application, the default value is 360 minutes (6 hours). The valid range is from 15 to 720.
        """
    ...
    def queue_timeout_minutes(self) -> Optional[builtins.int]:
        """
...
class ApplicationWorkerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str memory: Per worker memory resource. GB is the only supported unit and specifying GB is optional.
        :param builtins.str disk: Per worker Disk resource. GB is the only supported unit and specifying GB is optional
        :param builtins.str disk_type: Per worker DiskType resource. Shuffle optimized and Standard are only supported types and specifying diskType is optional
        """
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "memory", memory)
        if disk is not None:
