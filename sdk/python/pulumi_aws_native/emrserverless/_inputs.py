...
class ApplicationAutoStartConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for Auto Start of Application
        :param pulumi.Input[builtins.bool] enabled: If set to true, the Application will automatically start. Defaults to true.
        """
...
class ApplicationAutoStopConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for Auto Stop of Application
        :param pulumi.Input[builtins.bool] enabled: If set to true, the Application will automatically stop after being idle. Defaults to true.
        :param pulumi.Input[builtins.int] idle_timeout_minutes: The amount of time [in minutes] to wait before auto stopping the Application when idle. Defaults to 15 minutes.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class ApplicationCloudWatchLoggingConfigurationArgsDict(TypedDict):
        ...
        """
        encryption_key_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        log_stream_name_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationCloudWatchLoggingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 log_stream_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 log_type_map: Optional[pulumi.Input[Sequence[pulumi.Input['ApplicationLogTypeMapKeyValuePairArgs']]]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: If set to false, CloudWatch logging will be turned off. Defaults to false.
        :param pulumi.Input[builtins.str] encryption_key_arn: KMS key ARN to encrypt the logs stored in given CloudWatch log-group.
        :param pulumi.Input[builtins.str] log_group_name: Log-group name to produce log-streams on CloudWatch. If undefined, logs will be produced in a default log-group /aws/emr-serverless
        :param pulumi.Input[builtins.str] log_stream_name_prefix: Log-stream name prefix by which log-stream names will start in the CloudWatch Log-group.
    ...
    def log_stream_name_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log-stream name prefix by which log-stream names will start in the CloudWatch Log-group.
        """
    ...
    def log_stream_name_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ApplicationConfigurationObjectArgsDict(TypedDict):
        ...
        """
        classification: pulumi.Input[builtins.str]
        """
...
class ApplicationConfigurationObjectArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for a JobRun.
        :param pulumi.Input[builtins.str] classification: String with a maximum length of 1024.
        """
    ...
    @property
    @pulumi.getter
    def classification(self) -> pulumi.Input[builtins.str]:
        """
        String with a maximum length of 1024.
        """
    ...
    def classification(self, value: pulumi.Input[builtins.str]):
...
class ApplicationImageConfigurationInputArgs:
    def __init__(__self__, *,
        ...
        """
        The image configuration.
        :param pulumi.Input[builtins.str] image_uri: The URI of an image in the Amazon ECR registry. This field is required when you create a new application. If you leave this field blank in an update, Amazon EMR will remove the image configuration.
        """
...
class ApplicationInitialCapacityConfigKeyValuePairArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Worker type for an analytics framework.
        """
...
class ApplicationInitialCapacityConfigArgs:
    def __init__(__self__, *,
                 ...
                 worker_count: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] worker_count: Initial count of workers to be initialized when an Application is started. This count will be continued to be maintained until the Application is stopped
        """
...
class ApplicationInteractiveConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] studio_enabled: Enabled you to connect an Application to Amazon EMR Studio to run interactive workloads in a notebook
        """
...
if not MYPY:
    class ApplicationLogTypeMapKeyValuePairArgsDict(TypedDict):
        key: pulumi.Input[builtins.str]
        value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
elif False:
...
class ApplicationLogTypeMapKeyValuePairArgs:
    ...
    @property
    @pulumi.getter
    def value(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "value")

    @value.setter
    def value(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "value", value)
...
class ApplicationManagedPersistenceMonitoringConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 encryption_key_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: If set to false, managed logging will be turned off. Defaults to true.
        :param pulumi.Input[builtins.str] encryption_key_arn: KMS key ARN to encrypt the logs stored in managed persistence
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if encryption_key_arn is not None:
...
class ApplicationMaximumAllowedResourcesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cpu: Per worker CPU resource. vCPU is the only supported unit and specifying vCPU is optional.
        :param pulumi.Input[builtins.str] memory: Per worker memory resource. GB is the only supported unit and specifying GB is optional.
        :param pulumi.Input[builtins.str] disk: Per worker Disk resource. GB is the only supported unit and specifying GB is optional
        """
...
class ApplicationNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The ID of the security groups in the VPC to which you want to connect your job or application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The ID of the subnets in the VPC to which you want to connect your job or application.
        """
...
if not MYPY:
    class ApplicationPrometheusMonitoringConfigurationArgsDict(TypedDict):
        remote_write_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationPrometheusMonitoringConfigurationArgs:
    def __init__(__self__, *,
                 remote_write_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] remote_write_url: The remote write URL in the Amazon Managed Service for Prometheus workspace to send metrics to.
        """
    ...
    def remote_write_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The remote write URL in the Amazon Managed Service for Prometheus workspace to send metrics to.
        """
    ...
    def remote_write_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationS3MonitoringConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] encryption_key_arn: KMS key ARN to encrypt the logs stored in given s3
        """
        if encryption_key_arn is not None:
            pulumi.set(__self__, "encryption_key_arn", encryption_key_arn)
...
if not MYPY:
    class ApplicationSchedulerConfigurationArgsDict(TypedDict):
        ...
        """
        max_concurrent_runs: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        queue_timeout_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ApplicationSchedulerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 queue_timeout_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        The scheduler configuration for batch and streaming jobs running on this application. Supported with release labels emr-7.0.0 and above.
        :param pulumi.Input[builtins.int] max_concurrent_runs: The maximum concurrent job runs on this application. If scheduler configuration is enabled on your application, the default value is 15. The valid range is 1 to 1000.
        :param pulumi.Input[builtins.int] queue_timeout_minutes: The maximum duration in minutes for the job in QUEUED state. If scheduler configuration is enabled on your application, the default value is 360 minutes (6 hours). The valid range is from 15 to 720.
        """
    ...
    def queue_timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum duration in minutes for the job in QUEUED state. If scheduler configuration is enabled on your application, the default value is 360 minutes (6 hours). The valid range is from 15 to 720.
        """
    ...
    def queue_timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ApplicationWorkerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] memory: Per worker memory resource. GB is the only supported unit and specifying GB is optional.
        :param pulumi.Input[builtins.str] disk: Per worker Disk resource. GB is the only supported unit and specifying GB is optional
        :param pulumi.Input[builtins.str] disk_type: Per worker DiskType resource. Shuffle optimized and Standard are only supported types and specifying diskType is optional
        """
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "memory", memory)
        if disk is not None:
