...
class PermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_type: The resource type this permission can be used with.
...
class Permission(pulumi.CustomResource):
    ...
    def is_resource_type_default(self) -> pulumi.Output[builtins.bool]:
        """
