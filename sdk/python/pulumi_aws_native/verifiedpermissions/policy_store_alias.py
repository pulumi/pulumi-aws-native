...
__all__ = ['PolicyStoreAliasArgs', 'PolicyStoreAlias']
...
@pulumi.type_token("aws-native:verifiedpermissions:PolicyStoreAlias")
class PolicyStoreAlias(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PolicyStoreAliasArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicyStoreAliasArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicyStoreAliasArgs.__new__(PolicyStoreAliasArgs)
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["aliasName", "policyStoreId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(PolicyStoreAlias, __self__).__init__(
            'aws-native:verifiedpermissions:PolicyStoreAlias',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PolicyStoreAlias':
        """
        ...
        return PolicyStoreAlias(resource_name, opts=opts, __props__=__props__)
