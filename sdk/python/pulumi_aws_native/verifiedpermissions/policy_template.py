...
class PolicyTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_store_id: The unique identifier of the policy store that contains the template.
        :param pulumi.Input[builtins.str] statement: Specifies the content that you want to use for the new policy template, written in the Cedar policy language.
        :param pulumi.Input[builtins.str] description: The description to attach to the new or updated policy template.
        """
...
class PolicyTemplate(pulumi.CustomResource):
    ...
    pulumi_type = "aws-native:verifiedpermissions:PolicyTemplate"
