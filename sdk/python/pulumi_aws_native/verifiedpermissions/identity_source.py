...
class IdentitySourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_store_id: Specifies the ID of the policy store in which you want to store this identity source. Only policies and requests made using this policy store can reference identities from the identity provider configured in the new identity source.
...
@pulumi.type_token("aws-native:verifiedpermissions:IdentitySource")
class IdentitySource(pulumi.CustomResource):
    ...
    def identity_source_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="principalEntityType")
    def principal_entity_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the namespace and data type of the principals generated for identities authenticated by the new identity source.
        """
        return pulumi.get(self, "principal_entity_type")
