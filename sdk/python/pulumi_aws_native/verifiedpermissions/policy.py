...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_store_id: Specifies the `PolicyStoreId` of the policy store you want to store the policy in.
        """
...
class Policy(pulumi.CustomResource):
    ...
    pulumi_type = "aws-native:verifiedpermissions:Policy"
