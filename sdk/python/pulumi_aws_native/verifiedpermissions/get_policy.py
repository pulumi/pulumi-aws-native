...
def get_policy(policy_id: Optional[builtins.str] = None,
               policy_store_id: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPolicyResult:
    """
    Definition of AWS::VerifiedPermissions::Policy Resource Type


    :param builtins.str policy_id: The unique ID of the new or updated policy.
    :param builtins.str policy_store_id: Specifies the `PolicyStoreId` of the policy store you want to store the policy in.
    """
    __args__ = dict()
...
def get_policy_output(policy_id: Optional[pulumi.Input[builtins.str]] = None,
