...
class IdentitySourceCognitoUserPoolConfigurationArgsDict(TypedDict):
    ...
    group_configuration: NotRequired[pulumi.Input[Optional['IdentitySourceCognitoGroupConfigurationArgs']]]
...
class IdentitySourceOpenIdConnectConfigurationArgsDict(TypedDict):
    ...
    group_configuration: NotRequired[pulumi.Input[Optional['IdentitySourceOpenIdConnectGroupConfigurationArgs']]]
...
class PolicyTemplateLinkedPolicyDefinitionArgsDict(TypedDict):
    ...
    principal: NotRequired[pulumi.Input[Optional['PolicyEntityIdentifierArgs']]]
    resource: NotRequired[pulumi.Input[Optional['PolicyEntityIdentifierArgs']]]
