...
class GetIdentitySourceResult:
    ...
    def identity_source_id(self) -> Optional[builtins.str]:
        """
    ...
    def principal_entity_type(self) -> Optional[builtins.str]:
        """
...
def get_identity_source(identity_source_id: Optional[builtins.str] = None,
    ...
    :param builtins.str identity_source_id: The unique ID of the new or updated identity store.
    :param builtins.str policy_store_id: Specifies the ID of the policy store in which you want to store this identity source. Only policies and requests made using this policy store can reference identities from the identity provider configured in the new identity source.
    """
    __args__ = dict()
...
def get_identity_source_output(identity_source_id: Optional[pulumi.Input[builtins.str]] = None,
