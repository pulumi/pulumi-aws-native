...
class GetAnomalyDetectorResult:
    ...
    def anomaly_detector_description(self) -> Optional[builtins.str]:
        """
...
def get_anomaly_detector(arn: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnomalyDetectorResult:
    """
    An Amazon Lookout for Metrics Detector


    :param builtins.str arn: The Amazon Resource Name (ARN) of the detector. For example, `arn:aws:lookoutmetrics:us-east-2:123456789012:AnomalyDetector:my-detector`
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_anomaly_detector_output(arn: Optional[pulumi.Input[builtins.str]] = None,
