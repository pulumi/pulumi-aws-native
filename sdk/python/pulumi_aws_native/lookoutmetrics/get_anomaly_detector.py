...
class GetAnomalyDetectorResult:
    ...
    def anomaly_detector_description(self) -> Optional[_builtins.str]:
        """
...
def get_anomaly_detector(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The Amazon Resource Name (ARN) of the detector. For example, `arn:aws:lookoutmetrics:us-east-2:123456789012:AnomalyDetector:my-detector`
    """
    __args__ = dict()
    __args__['arn'] = arn
