...
class AlertArgs:
    def __init__(__self__, *,
                 ...
                 alert_sensitivity_threshold: pulumi.Input[_builtins.int],
                 anomaly_detector_arn: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.int] alert_sensitivity_threshold: A number between 0 and 100 (inclusive) that tunes the sensitivity of the alert.
        :param pulumi.Input[_builtins.str] anomaly_detector_arn: The Amazon resource name (ARN) of the Anomaly Detector to alert.
        :param pulumi.Input[_builtins.str] alert_description: A description for the alert.
        :param pulumi.Input[_builtins.str] alert_name: The name of the alert. If not provided, a name is generated automatically.
        """
    ...
    def alert_sensitivity_threshold(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def alert_sensitivity_threshold(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "alert_sensitivity_threshold", value)

    @_builtins.property
    @pulumi.getter(name="anomalyDetectorArn")
    def anomaly_detector_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def anomaly_detector_arn(self, value: pulumi.Input[_builtins.str]):
...
class Alert(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 alert_description: Optional[pulumi.Input[_builtins.str]] = None,
                 alert_name: Optional[pulumi.Input[_builtins.str]] = None,
                 alert_sensitivity_threshold: Optional[pulumi.Input[_builtins.int]] = None,
                 anomaly_detector_arn: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="alertName")
    def alert_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the alert. If not provided, a name is generated automatically.
        """
        return pulumi.get(self, "alert_name")
    ...
    @_builtins.property
    @pulumi.getter(name="alertSensitivityThreshold")
    def alert_sensitivity_threshold(self) -> pulumi.Output[_builtins.int]:
        """
        A number between 0 and 100 (inclusive) that tunes the sensitivity of the alert.
        """
        return pulumi.get(self, "alert_sensitivity_threshold")
