...
class AlertArgs:
    def __init__(__self__, *,
                 ...
                 alert_sensitivity_threshold: pulumi.Input[builtins.int],
                 anomaly_detector_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] alert_sensitivity_threshold: A number between 0 and 100 (inclusive) that tunes the sensitivity of the alert.
        :param pulumi.Input[builtins.str] anomaly_detector_arn: The Amazon resource name (ARN) of the Anomaly Detector to alert.
        :param pulumi.Input[builtins.str] alert_description: A description for the alert.
        :param pulumi.Input[builtins.str] alert_name: The name of the alert. If not provided, a name is generated automatically.
        """
    ...
    def alert_sensitivity_threshold(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def alert_sensitivity_threshold(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "alert_sensitivity_threshold", value)

    @property
    @pulumi.getter(name="anomalyDetectorArn")
    def anomaly_detector_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def anomaly_detector_arn(self, value: pulumi.Input[builtins.str]):
...
class Alert(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 alert_description: Optional[pulumi.Input[builtins.str]] = None,
                 alert_name: Optional[pulumi.Input[builtins.str]] = None,
                 alert_sensitivity_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 anomaly_detector_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="alertSensitivityThreshold")
    def alert_sensitivity_threshold(self) -> pulumi.Output[builtins.int]:
        """
        A number between 0 and 100 (inclusive) that tunes the sensitivity of the alert.
        """
        return pulumi.get(self, "alert_sensitivity_threshold")
