...
class AlertLambdaConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for a Lambda alert action.
        :param builtins.str lambda_arn: ARN of a Lambda to send alert notifications to.
        :param builtins.str role_arn: ARN of an IAM role that LookoutMetrics should assume to access the Lambda function.
        """
...
class AlertSnsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for an SNS alert action.
        :param builtins.str role_arn: ARN of an IAM role that LookoutMetrics should assume to access the SNS topic.
        :param builtins.str sns_topic_arn: ARN of an SNS topic to send alert notifications to.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class AnomalyDetectorAppFlowConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: An IAM role that gives Amazon Lookout for Metrics permission to access the flow.
        """
...
class AnomalyDetectorCloudwatchConfig(dict):
    ...
    def __init__(__self__, *,
                 role_arn: builtins.str):
        """
        :param builtins.str role_arn: An IAM role that gives Amazon Lookout for Metrics permission to access data in Amazon CloudWatch.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class AnomalyDetectorCsvFormatDescriptor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 header_list: Optional[Sequence[builtins.str]] = None,
                 quote_symbol: Optional[builtins.str] = None):
        """
        :param builtins.str charset: The character set in which the source CSV file is written.
        :param builtins.bool contains_header: Whether or not the source CSV file contains a header.
        :param builtins.str delimiter: The character used to delimit the source CSV file.
        :param 'AnomalyDetectorCsvFormatDescriptorFileCompression' file_compression: The level of compression of the source CSV file.
        :param Sequence[builtins.str] header_list: A list of the source CSV file's headers, if any.
        :param builtins.str quote_symbol: The character used as a quote character.
        """
    ...
    def header_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AnomalyDetectorJsonFormatDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str charset: The character set in which the source JSON file is written.
...
class AnomalyDetectorMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str namespace: The namespace for the metric.
        """
...
class AnomalyDetectorMetricSet(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dimension_list: Optional[Sequence[builtins.str]] = None,
                 metric_set_description: Optional[builtins.str] = None,
        ...
        :param builtins.str metric_set_name: The name of the MetricSet.
        :param 'AnomalyDetectorMetricSource' metric_source: Contains information about how the source data should be interpreted.
        :param Sequence[builtins.str] dimension_list: Dimensions for this MetricSet.
        :param builtins.str metric_set_description: A description for the MetricSet.
        :param 'AnomalyDetectorMetricSetMetricSetFrequency' metric_set_frequency: A frequency period to aggregate the data
        :param builtins.int offset: Offset, in seconds, between the frequency interval and the time at which the metrics are available.
        ...
        :param builtins.str timezone: The time zone in which your source data was recorded.
        """
    ...
    def dimension_list(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def metric_set_description(self) -> Optional[builtins.str]:
        """
...
class AnomalyDetectorRdsSourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_host: The host name of the database.
        :param builtins.str database_name: The name of the RDS database.
        :param builtins.int database_port: The port number where the database can be accessed.
        :param builtins.str db_instance_identifier: A string identifying the database instance.
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the role.
        :param builtins.str secret_manager_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager role.
        :param builtins.str table_name: The name of the table in the database.
...
class AnomalyDetectorRedshiftSourceConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vpc_configuration: 'outputs.AnomalyDetectorVpcConfiguration'):
        """
        :param builtins.str cluster_identifier: A string identifying the Redshift cluster.
        :param builtins.str database_host: The name of the database host.
        :param builtins.str database_name: The Redshift database name.
        :param builtins.int database_port: The port number where the database can be accessed.
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the role providing access to the database.
        :param builtins.str secret_manager_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager role.
        :param builtins.str table_name: The table name of the Redshift database.
...
class AnomalyDetectorS3SourceConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_arn: builtins.str,
                 historical_data_path_list: Optional[Sequence[builtins.str]] = None,
                 templated_path_list: Optional[Sequence[builtins.str]] = None):
        """
        :param 'AnomalyDetectorFileFormatDescriptor' file_format_descriptor: Contains information about a source file's formatting.
        :param builtins.str role_arn: The ARN of an IAM role that has read and write access permissions to the source S3 bucket.
        :param Sequence[builtins.str] historical_data_path_list: A list of paths to the historical data files.
        :param Sequence[builtins.str] templated_path_list: A list of templated paths to the source files.
        """
    ...
    def historical_data_path_list(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def templated_path_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AnomalyDetectorTimestampColumn(dict):
    ...
    def __init__(__self__, *,
                 column_format: Optional[builtins.str] = None,
                 column_name: Optional[builtins.str] = None):
        """
        :param builtins.str column_format: A timestamp format for the timestamps in the dataset
        :param builtins.str column_name: The name of the timestamp column.
        """
    ...
    def column_format(self) -> Optional[builtins.str]:
        """
...
class AnomalyDetectorVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
                 security_group_id_list: Sequence[builtins.str],
                 subnet_id_list: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] security_group_id_list: An array of strings containing the list of security groups.
        :param Sequence[builtins.str] subnet_id_list: An array of strings containing the Amazon VPC subnet IDs (e.g., `subnet-0bb1c79de3EXAMPLE` .
        """
    ...
    def security_group_id_list(self) -> Sequence[builtins.str]:
        """
    ...
    def subnet_id_list(self) -> Sequence[builtins.str]:
        """
