...
class AlertLambdaConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for a Lambda alert action.
        :param _builtins.str lambda_arn: ARN of a Lambda to send alert notifications to.
        :param _builtins.str role_arn: ARN of an IAM role that LookoutMetrics should assume to access the Lambda function.
        """
...
class AlertSnsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration options for an SNS alert action.
        :param _builtins.str role_arn: ARN of an IAM role that LookoutMetrics should assume to access the SNS topic.
        :param _builtins.str sns_topic_arn: ARN of an SNS topic to send alert notifications to.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class AnomalyDetectorAppFlowConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str role_arn: An IAM role that gives Amazon Lookout for Metrics permission to access the flow.
        """
...
class AnomalyDetectorCloudwatchConfig(dict):
    ...
    def __init__(__self__, *,
                 role_arn: _builtins.str):
        """
        :param _builtins.str role_arn: An IAM role that gives Amazon Lookout for Metrics permission to access data in Amazon CloudWatch.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class AnomalyDetectorCsvFormatDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str charset: The character set in which the source CSV file is written.
        :param _builtins.bool contains_header: Whether or not the source CSV file contains a header.
        :param _builtins.str delimiter: The character used to delimit the source CSV file.
        :param 'AnomalyDetectorCsvFormatDescriptorFileCompression' file_compression: The level of compression of the source CSV file.
        :param Sequence[_builtins.str] header_list: A list of the source CSV file's headers, if any.
        :param _builtins.str quote_symbol: The character used as a quote character.
        """
...
class AnomalyDetectorJsonFormatDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str charset: The character set in which the source JSON file is written.
...
class AnomalyDetectorMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str namespace: The namespace for the metric.
        """
...
class AnomalyDetectorMetricSet(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_set_name: _builtins.str,
                 metric_source: 'outputs.AnomalyDetectorMetricSource',
                 dimension_list: Optional[Sequence[_builtins.str]] = None,
                 metric_set_description: Optional[_builtins.str] = None,
        ...
        :param _builtins.str metric_set_name: The name of the MetricSet.
        :param 'AnomalyDetectorMetricSource' metric_source: Contains information about how the source data should be interpreted.
        :param Sequence[_builtins.str] dimension_list: Dimensions for this MetricSet.
        :param _builtins.str metric_set_description: A description for the MetricSet.
        :param 'AnomalyDetectorMetricSetMetricSetFrequency' metric_set_frequency: A frequency period to aggregate the data
        :param _builtins.int offset: Offset, in seconds, between the frequency interval and the time at which the metrics are available.
        ...
        :param _builtins.str timezone: The time zone in which your source data was recorded.
        """
    ...
    def metric_set_name(self) -> _builtins.str:
        """
    ...
    def dimension_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def metric_set_description(self) -> Optional[_builtins.str]:
        """
...
class AnomalyDetectorRdsSourceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str database_host: The host name of the database.
        :param _builtins.str database_name: The name of the RDS database.
        :param _builtins.int database_port: The port number where the database can be accessed.
        :param _builtins.str db_instance_identifier: A string identifying the database instance.
        :param _builtins.str role_arn: The Amazon Resource Name (ARN) of the role.
        :param _builtins.str secret_manager_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager role.
...
class AnomalyDetectorRedshiftSourceConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vpc_configuration: 'outputs.AnomalyDetectorVpcConfiguration'):
        """
        :param _builtins.str cluster_identifier: A string identifying the Redshift cluster.
        :param _builtins.str database_host: The name of the database host.
        :param _builtins.str database_name: The Redshift database name.
        :param _builtins.int database_port: The port number where the database can be accessed.
        :param _builtins.str role_arn: The Amazon Resource Name (ARN) of the role providing access to the database.
        :param _builtins.str secret_manager_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager role.
        :param _builtins.str table_name: The table name of the Redshift database.
...
class AnomalyDetectorS3SourceConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_arn: _builtins.str,
                 historical_data_path_list: Optional[Sequence[_builtins.str]] = None,
                 templated_path_list: Optional[Sequence[_builtins.str]] = None):
        """
        :param 'AnomalyDetectorFileFormatDescriptor' file_format_descriptor: Contains information about a source file's formatting.
        :param _builtins.str role_arn: The ARN of an IAM role that has read and write access permissions to the source S3 bucket.
        :param Sequence[_builtins.str] historical_data_path_list: A list of paths to the historical data files.
        :param Sequence[_builtins.str] templated_path_list: A list of templated paths to the source files.
        """
    ...
    def historical_data_path_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def templated_path_list(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class AnomalyDetectorTimestampColumn(dict):
    ...
    def __init__(__self__, *,
                 column_format: Optional[_builtins.str] = None,
                 column_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str column_format: A timestamp format for the timestamps in the dataset
        :param _builtins.str column_name: The name of the timestamp column.
        """
    ...
    def column_format(self) -> Optional[_builtins.str]:
        """
...
class AnomalyDetectorVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
                 security_group_id_list: Sequence[_builtins.str],
                 subnet_id_list: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] security_group_id_list: An array of strings containing the list of security groups.
        :param Sequence[_builtins.str] subnet_id_list: An array of strings containing the Amazon VPC subnet IDs (e.g., `subnet-0bb1c79de3EXAMPLE` .
        """
    ...
    def security_group_id_list(self) -> Sequence[_builtins.str]:
        """
    ...
    def subnet_id_list(self) -> Sequence[_builtins.str]:
        """
