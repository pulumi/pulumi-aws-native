...
class IntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_arn: The ARN of the Redshift data warehouse to use as the target for replication.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] additional_encryption_context: An optional set of non-secret key–value pairs that contains additional contextual information about the data. For more information, see [Encryption context](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context) in the *Key Management Service Developer Guide*.
                You can only include this parameter if you specify the ``KMSKeyId`` parameter.
        :param pulumi.Input[_builtins.str] data_filter: Data filters for the integration. These filters determine which tables from the source database are sent to the target Amazon Redshift data warehouse.
        :param pulumi.Input[_builtins.str] description: A description of the integration.
        :param pulumi.Input[_builtins.str] integration_name: The name of the integration.
        :param pulumi.Input[_builtins.str] kms_key_id: The AWS Key Management System (AWS KMS) key identifier for the key to use to encrypt the integration. If you don't specify an encryption key, RDS uses a default AWS owned key.
...
@pulumi.type_token("aws-native:rds:Integration")
class Integration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dataFilter")
    def data_filter(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Data filters for the integration. These filters determine which tables from the source database are sent to the target Amazon Redshift data warehouse.
        """
        return pulumi.get(self, "data_filter")
