...
class IntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source_arn: The Amazon Resource Name (ARN) of the database to use as the source for replication.
        :param pulumi.Input[builtins.str] target_arn: The ARN of the Redshift data warehouse to use as the target for replication.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_encryption_context: An optional set of non-secret key–value pairs that contains additional contextual information about the data. For more information, see [Encryption context](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context) in the *Key Management Service Developer Guide*.
                You can only include this parameter if you specify the ``KMSKeyId`` parameter.
        :param pulumi.Input[builtins.str] data_filter: Data filters for the integration. These filters determine which tables from the source database are sent to the target Amazon Redshift data warehouse.
        :param pulumi.Input[builtins.str] description: A description of the integration.
        :param pulumi.Input[builtins.str] integration_name: The name of the integration.
        :param pulumi.Input[builtins.str] kms_key_id: The AWS Key Management System (AWS KMS) key identifier for the key to use to encrypt the integration. If you don't specify an encryption key, RDS uses a default AWS owned key.
...
class Integration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataFilter")
    def data_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Data filters for the integration. These filters determine which tables from the source database are sent to the target Amazon Redshift data warehouse.
        """
        return pulumi.get(self, "data_filter")
    ...
    def integration_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="integrationName")
    def integration_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the integration.
        """
        return pulumi.get(self, "integration_name")
