...
class GetDbProxyTargetGroupResult:
    ...
    def db_cluster_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def db_instance_identifiers(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_db_proxy_target_group(target_group_arn: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbProxyTargetGroupResult:
    """
    Resource schema for AWS::RDS::DBProxyTargetGroup


    :param _builtins.str target_group_arn: The Amazon Resource Name (ARN) representing the target group.
    """
    __args__ = dict()
