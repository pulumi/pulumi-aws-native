...
class GetDBProxyTargetGroupResult:
    def __init__(__self__, connection_pool_configuration_info=None, d_b_cluster_identifiers=None, d_b_instance_identifiers=None, d_b_proxy_name=None, target_group_arn=None):
        ...
        if d_b_proxy_name and not isinstance(d_b_proxy_name, str):
            raise TypeError("Expected argument 'd_b_proxy_name' to be a str")
    ...
    def d_b_proxy_name(self) -> Optional[str]:
        """
...
class AwaitableGetDBProxyTargetGroupResult(GetDBProxyTargetGroupResult):
    ...
    def __await__(self):
        ...
        return GetDBProxyTargetGroupResult(
            ...
            d_b_proxy_name=self.d_b_proxy_name,
            target_group_arn=self.target_group_arn)


def get_db_proxy_target_group(d_b_proxy_name: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDBProxyTargetGroupResult:
    """
    Resource schema for AWS::RDS::DBProxyTargetGroup


    :param str d_b_proxy_name: The identifier for the proxy.
    """
    __args__ = dict()
    ...
    return AwaitableGetDBProxyTargetGroupResult(
        ...
        d_b_proxy_name=__ret__.d_b_proxy_name,
        target_group_arn=__ret__.target_group_arn)


@_utilities.lift_output_func(get_db_proxy_target_group)
def get_db_proxy_target_group_output(d_b_proxy_name: Optional[pulumi.Input[str]] = None,
