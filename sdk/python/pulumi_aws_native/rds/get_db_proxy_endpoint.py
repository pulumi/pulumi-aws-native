...
class GetDbProxyEndpointResult:
    ...
    def db_proxy_endpoint_arn(self) -> Optional[builtins.str]:
        """
...
def get_db_proxy_endpoint(db_proxy_endpoint_name: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbProxyEndpointResult:
    """
    Resource schema for AWS::RDS::DBProxyEndpoint.


    :param builtins.str db_proxy_endpoint_name: The identifier for the DB proxy endpoint. This name must be unique for all DB proxy endpoints owned by your AWS account in the specified AWS Region.
    """
    __args__ = dict()
...
def get_db_proxy_endpoint_output(db_proxy_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
