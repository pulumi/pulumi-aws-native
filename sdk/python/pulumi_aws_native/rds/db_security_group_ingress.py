...
__all__ = ['DBSecurityGroupIngress']
...
class DBSecurityGroupIngress(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DBSecurityGroupIngressPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DBSecurityGroupIngressPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DBSecurityGroupIngressAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DBSecurityGroupIngressProperties']:
        """
