...
class GetDbProxyResult:
    ...
    def db_proxy_arn(self) -> Optional[builtins.str]:
        """
    ...
    def debug_logging(self) -> Optional[builtins.bool]:
        """
    ...
    def idle_client_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def require_tls(self) -> Optional[builtins.bool]:
        """
...
def get_db_proxy(db_proxy_name: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbProxyResult:
    """
    Resource schema for AWS::RDS::DBProxy


    :param builtins.str db_proxy_name: The identifier for the proxy. This name must be unique for all proxies owned by your AWS account in the specified AWS Region.
    """
    __args__ = dict()
...
def get_db_proxy_output(db_proxy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:rds:getDbProxy', __args__, opts=opts, typ=GetDbProxyResult)
    return __ret__.apply(lambda __response__: GetDbProxyResult(
