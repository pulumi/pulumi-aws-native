...
class DbSubnetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] db_subnet_group_name: The name for the DB subnet group. This value is stored as a lowercase string.
                ...
                Example: ``mydbsubnetgroup``
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: The EC2 Subnet IDs for the DB subnet group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Tags to assign to the DB subnet group.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["db_subnet_group_arn"] = None
    ...
    def db_subnet_group_arn(self) -> pulumi.Output[_builtins.str]:
