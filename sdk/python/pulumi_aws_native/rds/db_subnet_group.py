...
class DbSubnetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DbSubnetGroupTagArgs']]] tags: An optional array of key-value pairs to apply to this DB subnet group.
        """
...
class DbSubnetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] db_subnet_group_name: The name for the DB subnet group. This value is stored as a lowercase string.
                ...
                Example: ``mysubnetgroup``
        :param pulumi.Input[Sequence[pulumi.Input[str]]] subnet_ids: The EC2 Subnet IDs for the DB subnet group.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DbSubnetGroupTagArgs']]]] tags: An optional array of key-value pairs to apply to this DB subnet group.
        """
        ...
    @overload
    def __init__(__self__,
