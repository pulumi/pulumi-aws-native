...
class DbSubnetGroupArgs:
    def __init__(__self__, *,
                 db_subnet_group_description: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] db_subnet_group_description: The description for the DB subnet group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The EC2 Subnet IDs for the DB subnet group.
        :param pulumi.Input[builtins.str] db_subnet_group_name: The name for the DB subnet group. This value is stored as a lowercase string.
                Constraints:
    ...
    def db_subnet_group_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_subnet_group_description(self, value: pulumi.Input[builtins.str]):
...
class DbSubnetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 db_subnet_group_description: Optional[pulumi.Input[builtins.str]] = None,
                 db_subnet_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dbSubnetGroupDescription")
    def db_subnet_group_description(self) -> pulumi.Output[builtins.str]:
        """
        The description for the DB subnet group.
        """
        return pulumi.get(self, "db_subnet_group_description")
