...
class DBInstanceArgs:
    def __init__(__self__, *,
                 ...
                 license_model: Optional[pulumi.Input['DBInstanceLicenseModel']] = None,
        ...
        :param pulumi.Input['DBInstanceLicenseModel'] license_model: License model information for this DB instance.
    ...
    def license_model(self) -> Optional[pulumi.Input['DBInstanceLicenseModel']]:
        """
    ...
    def license_model(self, value: Optional[pulumi.Input['DBInstanceLicenseModel']]):
...
class DBInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="licenseModel")
    def license_model(self) -> pulumi.Output[Optional['DBInstanceLicenseModel']]:
        """
        License model information for this DB instance.
        """
        return pulumi.get(self, "license_model")
