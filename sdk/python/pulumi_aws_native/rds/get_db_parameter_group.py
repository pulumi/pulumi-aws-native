...
def get_db_parameter_group(db_parameter_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str db_parameter_group_name: The name of the DB parameter group.
            Constraints:
...
def get_db_parameter_group_output(db_parameter_group_name: Optional[pulumi.Input[builtins.str]] = None,
