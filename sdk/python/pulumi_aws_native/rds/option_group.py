...
class OptionGroupArgs:
    def __init__(__self__, *,
                 ...
                 option_group_description: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] option_group_description: The description of the option group.
        ...
        :param pulumi.Input[builtins.str] option_group_name: The name of the option group to be created.
                Constraints:
    ...
    def option_group_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def option_group_description(self, value: pulumi.Input[builtins.str]):
