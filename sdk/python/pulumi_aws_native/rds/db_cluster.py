...
class DbCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(master_user_secret, DbClusterMasterUserSecretArgs):
            ...
            if not isinstance(read_endpoint, DbClusterReadEndpointArgs):
            ...
            if not isinstance(scaling_configuration, DbClusterScalingConfigurationArgs):
            ...
            if not isinstance(serverless_v2_scaling_configuration, DbClusterServerlessV2ScalingConfigurationArgs):
