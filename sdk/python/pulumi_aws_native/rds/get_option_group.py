...
def get_option_group(option_group_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptionGroupResult:
    """
    The ``AWS::RDS::OptionGroup`` resource creates or updates an option group, to enable and configure features that are specific to a particular DB engine.


    :param builtins.str option_group_name: The name of the option group to be created.
            Constraints:
...
def get_option_group_output(option_group_name: Optional[pulumi.Input[builtins.str]] = None,
