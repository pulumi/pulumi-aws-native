...
if not MYPY:
    class DbInstanceDbInstanceStatusInfoArgsDict(TypedDict):
        ...
        """
        status_type: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class DbInstanceDbInstanceStatusInfoArgs:
    def __init__(__self__, *,
                 ...
                 status_type: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] message: Details of the error if there is an error for the instance. If the instance isn't in an error state, this value is blank.
        :param pulumi.Input[_builtins.bool] normal: Indicates whether the instance is operating normally (TRUE) or is in an error state (FALSE).
        :param pulumi.Input[_builtins.str] status: The status of the DB instance. For a StatusType of read replica, the values can be replicating, replication stop point set, replication stop point reached, error, stopped, or terminated.
        :param pulumi.Input[_builtins.str] status_type: The status type of the DB instance.
        """
    ...
    def status_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The status type of the DB instance.
        """
    ...
    @status_type.setter
    def status_type(self, value: Optional[pulumi.Input[_builtins.str]]):
