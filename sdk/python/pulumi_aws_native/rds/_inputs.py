...
class DbClusterReadEndpointArgs:
    def __init__(__self__, *,
        ...
        The ``ReadEndpoint`` return value specifies the reader endpoint for the DB cluster.
         ...
         If a failover occurs, and the Aurora Replica that you are connected to is promoted to be the primary instance, your connection is dropped. To continue sending your read workload to other Aurora Replicas in the cluster, you can then reconnect to the reader endpoint.
         For more information about Aurora endpoints, see [Amazon Aurora connection management](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Aurora.Overview.Endpoints.html) in the *Amazon Aurora User Guide*.
        :param pulumi.Input[builtins.str] address: The host address of the reader endpoint.
        """
...
if not MYPY:
    class DbInstanceCertificateDetailsArgsDict(TypedDict):
        ...
        """
        ca_identifier: NotRequired[pulumi.Input[builtins.str]]
        """
        The CA identifier of the CA certificate used for the DB instance's server certificate.
        """
        valid_till: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbInstanceCertificateDetailsArgs:
    def __init__(__self__, *,
                 ca_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 valid_till: Optional[pulumi.Input[builtins.str]] = None):
        """
        The details of the DB instance’s server certificate.
         For more information, see [Using SSL/TLS to encrypt a connection to a DB instance](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.html) in the *Amazon RDS User Guide* and [Using SSL/TLS to encrypt a connection to a DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.SSL.html) in the *Amazon Aurora User Guide*.
        :param pulumi.Input[builtins.str] ca_identifier: The CA identifier of the CA certificate used for the DB instance's server certificate.
        :param pulumi.Input[builtins.str] valid_till: The expiration date of the DB instance’s server certificate.
        """
    ...
    def ca_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CA identifier of the CA certificate used for the DB instance's server certificate.
        """
    ...
    def ca_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ca_identifier", value)

    @property
    @pulumi.getter(name="validTill")
    def valid_till(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The expiration date of the DB instance’s server certificate.
        """
    ...
    @valid_till.setter
    def valid_till(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbInstanceEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] port: Specifies the port that the database engine is listening on.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
