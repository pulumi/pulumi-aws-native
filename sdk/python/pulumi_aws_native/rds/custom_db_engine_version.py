...
class CustomDbEngineVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_installation_files_s3_prefix: The Amazon S3 directory that contains the database installation files for your CEV. For example, a valid bucket name is ``123456789012/cev1``. If this setting isn't specified, no prefix is assumed.
        :param pulumi.Input[_builtins.str] description: An optional description of your CEV.
        :param pulumi.Input[_builtins.str] image_id: A value that indicates the ID of the AMI.
        :param pulumi.Input[_builtins.str] kms_key_id: The AWS KMS key identifier for an encrypted CEV. A symmetric encryption KMS key is required for RDS Custom, but optional for Amazon RDS.
...
class CustomDbEngineVersion(pulumi.CustomResource):
    ...
    def db_engine_version_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceCustomDbEngineVersionIdentifier")
    def source_custom_db_engine_version_identifier(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARN of a CEV to use as a source for creating a new CEV. You can specify a different Amazon Machine Imagine (AMI) by using either ``Source`` or ``UseAwsProvidedLatestImage``. You can't specify a different JSON manifest when you specify ``SourceCustomDbEngineVersionIdentifier``.
        """
        return pulumi.get(self, "source_custom_db_engine_version_identifier")
    ...
    @_builtins.property
    @pulumi.getter(name="useAwsProvidedLatestImage")
    def use_aws_provided_latest_image(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to use the latest service-provided Amazon Machine Image (AMI) for the CEV. If you specify ``UseAwsProvidedLatestImage``, you can't also specify ``ImageId``.
        """
        return pulumi.get(self, "use_aws_provided_latest_image")
