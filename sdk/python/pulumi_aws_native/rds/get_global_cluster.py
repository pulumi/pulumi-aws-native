...
def get_global_cluster(global_cluster_identifier: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGlobalClusterResult:
    """
    Resource Type definition for AWS::RDS::GlobalCluster


    :param builtins.str global_cluster_identifier: The cluster identifier of the new global database cluster. This parameter is stored as a lowercase string.
    """
    __args__ = dict()
...
def get_global_cluster_output(global_cluster_identifier: Optional[pulumi.Input[builtins.str]] = None,
