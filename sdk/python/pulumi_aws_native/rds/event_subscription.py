...
class EventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] subscription_name: The name of the subscription.
                Constraints: The name must be less than 255 characters.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: An optional array of key-value pairs to apply to this subscription.
        """
        ...
    @overload
    def __init__(__self__,
