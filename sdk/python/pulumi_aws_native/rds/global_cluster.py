...
class GlobalClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] engine_lifecycle_support: The life cycle type of the global cluster. You can use this setting to enroll your global cluster into Amazon RDS Extended Support.
        :param pulumi.Input[_builtins.str] engine_version: The version number of the database engine to use. If you specify the SourceDBClusterIdentifier property, don't specify this property. The value is inherited from the cluster.
        :param pulumi.Input[_builtins.str] global_cluster_identifier: The cluster identifier of the new global database cluster. This parameter is stored as a lowercase string.
