...
class CapacityReservationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] target_dpus: The number of DPUs to request to be allocated to the reservation.
        ...
        :param pulumi.Input[builtins.str] name: The reservation name.
...
class CapacityReservation(pulumi.CustomResource):
    ...
    def last_successful_allocation_time(self) -> pulumi.Output[builtins.str]:
        """
