...
class GetNamedQueryResult:
    ...
    def named_query_id(self) -> Optional[builtins.str]:
        """
...
def get_named_query(named_query_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNamedQueryResult:
    """
    Resource schema for AWS::Athena::NamedQuery


    :param builtins.str named_query_id: The unique ID of the query.
    """
    __args__ = dict()
...
def get_named_query_output(named_query_id: Optional[pulumi.Input[builtins.str]] = None,
