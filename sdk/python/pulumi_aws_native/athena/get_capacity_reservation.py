...
class GetCapacityReservationResult:
    ...
    def allocated_dpus(self) -> Optional[builtins.int]:
        """
    ...
    def last_successful_allocation_time(self) -> Optional[builtins.str]:
        """
    ...
    def target_dpus(self) -> Optional[builtins.int]:
        """
...
def get_capacity_reservation(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The ARN of the capacity reservation.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_capacity_reservation_output(arn: Optional[pulumi.Input[builtins.str]] = None,
