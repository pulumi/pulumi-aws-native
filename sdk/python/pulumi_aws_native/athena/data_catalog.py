...
class DataCatalogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_type: The type of connection for a FEDERATED data catalog
        :param pulumi.Input[builtins.str] description: A description of the data catalog to be created. 
        :param pulumi.Input[builtins.str] error: Text of the error that occurred during data catalog creation or deletion.
        :param pulumi.Input[builtins.str] name: The name of the data catalog to create. The catalog name must be unique for the AWS account and can use a maximum of 128 alphanumeric, underscore, at sign, or hyphen characters. 
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Specifies the Lambda function or functions to use for creating the data catalog. This is a mapping whose values depend on the catalog type. 
...
class DataCatalog(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def error(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Text of the error that occurred during data catalog creation or deletion.
        """
        return pulumi.get(self, "error")
