...
class PreparedStatementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] work_group: The name of the workgroup to which the prepared statement belongs.
        :param pulumi.Input[builtins.str] description: The description of the prepared statement.
        :param pulumi.Input[builtins.str] statement_name: The name of the prepared statement.
        """
...
class PreparedStatement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="workGroup")
    def work_group(self) -> pulumi.Output[builtins.str]:
        """
        The name of the workgroup to which the prepared statement belongs.
        """
        return pulumi.get(self, "work_group")
