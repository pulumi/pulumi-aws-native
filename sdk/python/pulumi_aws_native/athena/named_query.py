...
class NamedQueryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database: The database to which the query belongs.
        :param pulumi.Input[builtins.str] query_string: The contents of the query with all query statements.
        :param pulumi.Input[builtins.str] description: The query description.
        :param pulumi.Input[builtins.str] name: The query name.
        :param pulumi.Input[builtins.str] work_group: The name of the workgroup that contains the named query.
        """
...
class NamedQuery(pulumi.CustomResource):
    ...
    def named_query_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="workGroup")
    def work_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the workgroup that contains the named query.
        """
        return pulumi.get(self, "work_group")
