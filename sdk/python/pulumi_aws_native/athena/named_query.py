...
class NamedQuery(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NamedQueryPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NamedQueryPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NamedQueryAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NamedQueryProperties']:
        """
