...
def get_work_group(name: Optional[_builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkGroupResult:
    """
    Resource schema for AWS::Athena::WorkGroup


    :param _builtins.str name: The workGroup name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_work_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
