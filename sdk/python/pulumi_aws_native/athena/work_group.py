...
class WorkGroupArgs:
    ...
    def _configure(
        ...
        if recursive_delete_option is not None:
            _setter("recursive_delete_option", recursive_delete_option)
        if state is not None:
            _setter("state", state)
        if tags is not None:
            _setter("tags", tags)
        if work_group_configuration is not None:
            _setter("work_group_configuration", work_group_configuration)
        if work_group_configuration_updates is not None:
            _setter("work_group_configuration_updates", work_group_configuration_updates)
...
class WorkGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(work_group_configuration, WorkGroupConfigurationArgs):
            ...
            if not isinstance(work_group_configuration_updates, WorkGroupConfigurationUpdatesArgs):
