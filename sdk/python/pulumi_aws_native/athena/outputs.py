...
class WorkGroupConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enforce_work_group_configuration: Optional[builtins.bool] = None,
                 ...
                 publish_cloud_watch_metrics_enabled: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str additional_configuration: Specifies a user defined JSON string that is passed to the session engine.
        :param builtins.int bytes_scanned_cutoff_per_query: The upper limit (cutoff) for the amount of bytes a single query in a workgroup is allowed to scan. No default is defined.
        ...
        :param builtins.bool enforce_work_group_configuration: If set to "true", the settings for the workgroup override client-side settings. If set to "false", client-side settings are used. For more information, see [Override client-side settings](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html) .
        :param 'WorkGroupEngineVersion' engine_version: The engine version that all queries running on the workgroup use.
        :param builtins.str execution_role: Role used to access user resources in an Athena for Apache Spark session. This property applies only to Spark-enabled workgroups in Athena.
        ...
        :param builtins.bool publish_cloud_watch_metrics_enabled: Indicates that the Amazon CloudWatch metrics are enabled for the workgroup.
    ...
    def enforce_work_group_configuration(self) -> Optional[builtins.bool]:
        """
    ...
    def publish_cloud_watch_metrics_enabled(self) -> Optional[builtins.bool]:
        """
...
class WorkGroupConfigurationUpdates(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_query_results_configuration: Optional['outputs.WorkGroupManagedQueryResultsConfiguration'] = None,
                 publish_cloud_watch_metrics_enabled: Optional[builtins.bool] = None,
                 remove_bytes_scanned_cutoff_per_query: Optional[builtins.bool] = None,
                 remove_customer_content_encryption_configuration: Optional[builtins.bool] = None,
                 requester_pays_enabled: Optional[builtins.bool] = None,
    ...
    def remove_bytes_scanned_cutoff_per_query(self) -> Optional[builtins.bool]:
    ...
    def remove_customer_content_encryption_configuration(self) -> Optional[builtins.bool]:
...
class WorkGroupCustomerContentEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Indicates the KMS key for encrypting notebook content.
        :param builtins.str kms_key: The customer managed KMS key that is used to encrypt the user's data stores in Athena.
        """
...
class WorkGroupEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key: For `SSE_KMS` and `CSE_KMS` , this is the KMS key ARN or ID.
        """
...
class WorkGroupEngineVersion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Athena engine version for running queries.
        :param builtins.str effective_engine_version: Read only. The engine version on which the query runs. If the user requests a valid engine version other than Auto, the effective engine version is the same as the engine version that the user requested. If the user requests Auto, the effective engine version is chosen by Athena. When a request to update the engine version is made by a `CreateWorkGroup` or `UpdateWorkGroup` operation, the `EffectiveEngineVersion` field is ignored.
        :param builtins.str selected_engine_version: The engine version requested by the user. Possible values are determined by the output of `ListEngineVersions` , including AUTO. The default is AUTO.
        """
...
class WorkGroupResultConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str expected_bucket_owner: The account ID that you expect to be the owner of the Amazon S3 bucket specified by `ResultConfiguration:OutputLocation` . If set, Athena uses the value for `ExpectedBucketOwner` when it makes Amazon S3 calls to your specified output location. If the `ExpectedBucketOwner` account ID does not match the actual owner of the Amazon S3 bucket, the call fails with a permissions error.
...
class WorkGroupResultConfigurationUpdates(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expected_bucket_owner: Optional[builtins.str] = None,
                 output_location: Optional[builtins.str] = None,
                 remove_acl_configuration: Optional[builtins.bool] = None,
                 remove_encryption_configuration: Optional[builtins.bool] = None,
                 remove_expected_bucket_owner: Optional[builtins.bool] = None,
                 remove_output_location: Optional[builtins.bool] = None):
        """
        The result configuration information about the queries in this workgroup that will be updated. Includes the updated results location and an updated option for encrypting query results. 
    ...
    def remove_acl_configuration(self) -> Optional[builtins.bool]:
        """
        If set to `true` , indicates that the previously-specified ACL configuration for queries in this workgroup should be ignored and set to null. If set to `false` or not set, and a value is present in the `AclConfiguration` of `ResultConfigurationUpdates` , the `AclConfiguration` in the workgroup's `ResultConfiguration` is updated with the new value. For more information, see [Workgroup Settings Override Client-Side Settings](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html) .
        """
    ...
    def remove_encryption_configuration(self) -> Optional[builtins.bool]:
        """
    ...
    def remove_expected_bucket_owner(self) -> Optional[builtins.bool]:
        """
    ...
    def remove_output_location(self) -> Optional[builtins.bool]:
        """
