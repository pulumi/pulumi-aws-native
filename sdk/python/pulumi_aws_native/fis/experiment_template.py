...
class ExperimentTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(actions, ExperimentTemplateActionMapArgs):
                actions = actions or {}
                def _setter(key, value):
                    actions[key] = value
            ...
            if not isinstance(log_configuration, ExperimentTemplateLogConfigurationArgs):
            ...
            if not isinstance(targets, ExperimentTemplateTargetMapArgs):
                targets = targets or {}
                def _setter(key, value):
                    targets[key] = value
