...
class ExperimentTemplateAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_after: Optional[Sequence[builtins.str]] = None,
                 targets: Optional[Mapping[str, builtins.str]] = None):
        """
        Specifies an action for the experiment template.
        :param builtins.str action_id: The ID of the action.
        :param builtins.str description: A description for the action.
        :param Mapping[str, builtins.str] parameters: The parameters for the action, if applicable.
        :param Sequence[builtins.str] start_after: The name of the action that must be completed before the current action starts.
        :param Mapping[str, builtins.str] targets: One or more targets for the action.
        """
    ...
    def start_after(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ExperimentTemplateCloudWatchDashboard(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dashboard_identifier: The Amazon Resource Name (ARN) of the CloudWatch dashboard to include in the experiment report.
        """
...
class ExperimentTemplateExperimentReportConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str post_experiment_duration: The duration after the experiment end time for the data sources to include in the report.
        :param builtins.str pre_experiment_duration: The duration before the experiment start time for the data sources to include in the report.
        """
...
class ExperimentTemplateLogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int log_schema_version: The schema version.
...
class ExperimentTemplateTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str selection_mode: Scopes the identified resources to a specific count or percentage.
        ...
        :param Mapping[str, builtins.str] parameters: The parameters for the resource type.
        :param Sequence[builtins.str] resource_arns: The Amazon Resource Names (ARNs) of the targets.
        :param Mapping[str, builtins.str] resource_tags: The tags for the target resources.
        """
