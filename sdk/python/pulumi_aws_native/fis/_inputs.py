...
if not MYPY:
    class ExperimentTemplateActionArgsDict(TypedDict):
        ...
        """
        start_after: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The name of the action that must be completed before the current action starts.
        """
        targets: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ExperimentTemplateActionArgs:
    def __init__(__self__, *,
                 ...
                 start_after: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 targets: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Specifies an action for the experiment template.
        :param pulumi.Input[builtins.str] action_id: The ID of the action.
        :param pulumi.Input[builtins.str] description: A description for the action.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: The parameters for the action, if applicable.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] start_after: The name of the action that must be completed before the current action starts.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] targets: One or more targets for the action.
        """
    ...
    def start_after(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The name of the action that must be completed before the current action starts.
        """
    ...
    @start_after.setter
    def start_after(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "start_after", value)

    @property
    @pulumi.getter
    def targets(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        One or more targets for the action.
        """
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "targets", value)


if not MYPY:
    class ExperimentTemplateCloudWatchDashboardArgsDict(TypedDict):
        dashboard_identifier: pulumi.Input[builtins.str]
        """
...
class ExperimentTemplateCloudWatchDashboardArgs:
    def __init__(__self__, *,
                 dashboard_identifier: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] dashboard_identifier: The Amazon Resource Name (ARN) of the CloudWatch dashboard to include in the experiment report.
        """
        pulumi.set(__self__, "dashboard_identifier", dashboard_identifier)

    @property
    @pulumi.getter(name="dashboardIdentifier")
    def dashboard_identifier(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the CloudWatch dashboard to include in the experiment report.
        """
    ...
    def dashboard_identifier(self, value: pulumi.Input[builtins.str]):
...
class ExperimentTemplateExperimentReportConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] post_experiment_duration: The duration after the experiment end time for the data sources to include in the report.
        :param pulumi.Input[builtins.str] pre_experiment_duration: The duration before the experiment start time for the data sources to include in the report.
        """
...
class ExperimentTemplateLogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] log_schema_version: The schema version.
...
class ExperimentTemplateTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] selection_mode: Scopes the identified resources to a specific count or percentage.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: The parameters for the resource type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_arns: The Amazon Resource Names (ARNs) of the targets.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_tags: The tags for the target resources.
        """
