...
class ExperimentTemplateExperimentReportConfigurationDataSourcesPropertiesArgsDict(TypedDict):
    ...
    """
    cloud_watch_dashboards: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ExperimentTemplateCloudWatchDashboardArgs']]]]]
...
class ExperimentTemplateExperimentReportConfigurationArgsDict(TypedDict):
    ...
    The output destinations of the experiment report.
    """
    data_sources: NotRequired[pulumi.Input[Optional['ExperimentTemplateExperimentReportConfigurationDataSourcesPropertiesArgs']]]
    """
    The data sources for the experiment report.
    """
...
class ExperimentTemplateLogConfigurationArgsDict(TypedDict):
    ...
    The schema version.
    """
    cloud_watch_logs_configuration: NotRequired[pulumi.Input[Optional['ExperimentTemplateLogConfigurationCloudWatchLogsConfigurationPropertiesArgs']]]
    """
    The configuration for experiment logging to CloudWatch Logs .
    """
    s3_configuration: NotRequired[pulumi.Input[Optional['ExperimentTemplateLogConfigurationS3ConfigurationPropertiesArgs']]]
    """
    The configuration for experiment logging to Amazon S3 .
    """
