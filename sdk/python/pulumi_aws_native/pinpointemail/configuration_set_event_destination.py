...
warnings.warn("""ConfigurationSetEventDestination is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class ConfigurationSetEventDestination(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 event_destination_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationSetEventDestination is deprecated: ConfigurationSetEventDestination is not yet supported by AWS Native Cloud Control, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["configuration_set_name", "event_destination_name"])
