...
class SchemaMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] schema_name: The name of the SchemaMapping
        :param pulumi.Input[builtins.str] description: The description of the SchemaMapping
...
class SchemaMapping(pulumi.CustomResource):
    ...
    def has_workflows(self) -> pulumi.Output[builtins.bool]:
