...
class GetPolicyStatementResult:
    ...
    @_builtins.property
    @pulumi.getter
    def action(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def principal(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_policy_statement(arn: Optional[_builtins.str] = None,
