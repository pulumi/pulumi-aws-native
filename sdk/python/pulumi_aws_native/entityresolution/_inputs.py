...
if not MYPY:
    class IdMappingWorkflowInputSourceArgsDict(TypedDict):
        input_source_arn: pulumi.Input[builtins.str]
        """
...
class IdMappingWorkflowInputSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] input_source_arn: An Glue table ARN for the input source table, MatchingWorkflow arn or IdNamespace ARN
        :param pulumi.Input[builtins.str] schema_arn: The ARN (Amazon Resource Name) that AWS Entity Resolution generated for the `SchemaMapping` .
    ...
    def input_source_arn(self) -> pulumi.Input[builtins.str]:
        """
        An Glue table ARN for the input source table, MatchingWorkflow arn or IdNamespace ARN
        """
    ...
    def input_source_arn(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IdMappingWorkflowIntermediateSourceConfigurationArgsDict(TypedDict):
        intermediate_s3_path: pulumi.Input[builtins.str]
        """
...
class IdMappingWorkflowIntermediateSourceConfigurationArgs:
    def __init__(__self__, *,
                 intermediate_s3_path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] intermediate_s3_path: The s3 path that would be used to stage the intermediate data being generated during workflow execution.
        """
        pulumi.set(__self__, "intermediate_s3_path", intermediate_s3_path)

    @property
    @pulumi.getter(name="intermediateS3Path")
    def intermediate_s3_path(self) -> pulumi.Input[builtins.str]:
        """
        The s3 path that would be used to stage the intermediate data being generated during workflow execution.
        """
    ...
    def intermediate_s3_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "intermediate_s3_path", value)


if not MYPY:
    class IdMappingWorkflowOutputSourceArgsDict(TypedDict):
        output_s3_path: pulumi.Input[builtins.str]
        """
        The S3 path to which Entity Resolution will write the output table
        """
        kms_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IdMappingWorkflowOutputSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] output_s3_path: The S3 path to which Entity Resolution will write the output table
        :param pulumi.Input[builtins.str] kms_arn: Customer AWS KMS ARN for encryption at rest. If not provided, system will use an AWS Entity Resolution managed KMS key.
        """
    ...
    def output_s3_path(self) -> pulumi.Input[builtins.str]:
        """
        The S3 path to which Entity Resolution will write the output table
        """
    ...
    def output_s3_path(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IdMappingWorkflowProviderPropertiesArgsDict(TypedDict):
        provider_service_arn: pulumi.Input[builtins.str]
        """
        ...
        """
        provider_configuration: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class IdMappingWorkflowProviderPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 provider_configuration: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] provider_service_arn: Arn of the Provider Service being used.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] provider_configuration: Additional Provider configuration that would be required for the provider service. The Configuration must be in JSON string format
        """
    ...
    def provider_service_arn(self) -> pulumi.Input[builtins.str]:
        """
        Arn of the Provider Service being used.
        """
    ...
    def provider_service_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def provider_configuration(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Additional Provider configuration that would be required for the provider service. The Configuration must be in JSON string format
        """
    ...
    def provider_configuration(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "provider_configuration", value)


if not MYPY:
    class IdMappingWorkflowRuleArgsDict(TypedDict):
        matching_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class IdMappingWorkflowRuleArgs:
    def __init__(__self__, *,
                 ...
                 rule_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matching_keys: A list of `MatchingKeys` . The `MatchingKeys` must have been defined in the `SchemaMapping` . Two records are considered to match according to this rule if all of the `MatchingKeys` match.
        :param pulumi.Input[builtins.str] rule_name: A name for the matching rule.
        """
    ...
    def matching_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of `MatchingKeys` . The `MatchingKeys` must have been defined in the `SchemaMapping` . Two records are considered to match according to this rule if all of the `MatchingKeys` match.
        """
    ...
    def matching_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class IdNamespaceInputSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] input_source_arn: An AWS Glue table Amazon Resource Name (ARN) or a matching workflow ARN for the input source table.
...
class IdNamespaceNamespaceProviderPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 provider_configuration: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] provider_service_arn: The Amazon Resource Name (ARN) of the provider service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] provider_configuration: Additional Provider configuration that would be required for the provider service. The Configuration must be in JSON string format.
        """
        pulumi.set(__self__, "provider_service_arn", provider_service_arn)
        if provider_configuration is not None:
...
if not MYPY:
    class MatchingWorkflowInputSourceArgsDict(TypedDict):
        ...
        """
        schema_arn: pulumi.Input[builtins.str]
        """
        The name of the schema.
        """
        apply_normalization: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class MatchingWorkflowInputSourceArgs:
    def __init__(__self__, *,
                 input_source_arn: pulumi.Input[builtins.str],
                 schema_arn: pulumi.Input[builtins.str],
                 apply_normalization: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] input_source_arn: An Glue table ARN for the input source table
        :param pulumi.Input[builtins.str] schema_arn: The name of the schema.
        :param pulumi.Input[builtins.bool] apply_normalization: Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
        """
        pulumi.set(__self__, "input_source_arn", input_source_arn)
        pulumi.set(__self__, "schema_arn", schema_arn)
    ...
    @property
    @pulumi.getter(name="schemaArn")
    def schema_arn(self) -> pulumi.Input[builtins.str]:
        """
        The name of the schema.
        """
        return pulumi.get(self, "schema_arn")
    ...
    @schema_arn.setter
    def schema_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "schema_arn", value)

    @property
    @pulumi.getter(name="applyNormalization")
    def apply_normalization(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
        """
    ...
    def apply_normalization(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class MatchingWorkflowOutputAttributeArgsDict(TypedDict):
        ...
        """
        hashed: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class MatchingWorkflowOutputAttributeArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 hashed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] name: A name of a column to be written to the output. This must be an `InputField` name in the schema mapping.
        :param pulumi.Input[builtins.bool] hashed: Enables the ability to hash the column values in the output.
        """
    ...
    @property
    @pulumi.getter
    def hashed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables the ability to hash the column values in the output.
        """
    ...
    @hashed.setter
    def hashed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MatchingWorkflowOutputSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] output_s3_path: The S3 path to which Entity Resolution will write the output table
        :param pulumi.Input[builtins.bool] apply_normalization: Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
        :param pulumi.Input[builtins.str] kms_arn: Customer KMS ARN for encryption at rest. If not provided, system will use an AWS Entity Resolution managed KMS key.
        """
...
if not MYPY:
    class SchemaMappingSchemaInputAttributeArgsDict(TypedDict):
        ...
        hashed: NotRequired[pulumi.Input[builtins.bool]]
        match_key: NotRequired[pulumi.Input[builtins.str]]
...
class SchemaMappingSchemaInputAttributeArgs:
    def __init__(__self__, *,
                 ...
                 hashed: Optional[pulumi.Input[builtins.bool]] = None,
                 match_key: Optional[pulumi.Input[builtins.str]] = None,
                 sub_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] sub_type: The subtype of the Attribute. Would be required only when type is PROVIDER_ID
        """
    ...
    def match_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "match_key")

    @match_key.setter
    def match_key(self, value: Optional[pulumi.Input[builtins.str]]):
