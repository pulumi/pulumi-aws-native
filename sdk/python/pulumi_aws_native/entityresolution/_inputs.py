...
class IdMappingWorkflowIdMappingRuleBasedPropertiesArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IdMappingWorkflowRuleArgs']]]]]
    """
...
class IdMappingWorkflowIdMappingTechniquesArgsDict(TypedDict):
    ...
    provider_properties: NotRequired[pulumi.Input[Optional['IdMappingWorkflowProviderPropertiesArgs']]]
    """
    An object which defines any additional configurations required by the provider service.
    """
    rule_based_properties: NotRequired[pulumi.Input[Optional['IdMappingWorkflowIdMappingRuleBasedPropertiesArgs']]]
    """
...
class IdMappingWorkflowProviderPropertiesArgsDict(TypedDict):
    ...
    """
    intermediate_source_configuration: NotRequired[pulumi.Input[Optional['IdMappingWorkflowIntermediateSourceConfigurationArgs']]]
    """
...
class IdNamespaceIdMappingWorkflowPropertiesArgsDict(TypedDict):
    ...
    The type of ID mapping.
    """
    provider_properties: NotRequired[pulumi.Input[Optional['IdNamespaceNamespaceProviderPropertiesArgs']]]
    """
    An object which defines any additional configurations required by the provider service.
    """
    rule_based_properties: NotRequired[pulumi.Input[Optional['IdNamespaceNamespaceRuleBasedPropertiesArgs']]]
    """
    An object which defines any additional configurations required by rule-based matching.
    """
...
class IdNamespaceNamespaceRuleBasedPropertiesArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IdNamespaceRuleArgs']]]]]
    """
...
class MatchingWorkflowOutputSourceArgsDict(TypedDict):
    ...
    Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
    """
    customer_profiles_integration_config: NotRequired[pulumi.Input[Optional['MatchingWorkflowCustomerProfilesIntegrationConfigArgs']]]
    kms_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MatchingWorkflowProviderPropertiesArgsDict(TypedDict):
    ...
    Arn of the Provider service being used.
    """
    intermediate_source_configuration: NotRequired[pulumi.Input[Optional['MatchingWorkflowIntermediateSourceConfigurationArgs']]]
    """
    The Amazon S3 location that temporarily stores your data while it processes. Your information won't be saved permanently.
    """
    provider_configuration: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
...
class MatchingWorkflowResolutionTechniquesArgsDict(TypedDict):
    provider_properties: NotRequired[pulumi.Input[Optional['MatchingWorkflowProviderPropertiesArgs']]]
    """
    ...
    """
    rule_based_properties: NotRequired[pulumi.Input[Optional['MatchingWorkflowRuleBasedPropertiesArgs']]]
    """
    An object which defines the list of matching rules to run and has a field `rules` , which is a list of rule objects.
    """
    rule_condition_properties: NotRequired[pulumi.Input[Optional['MatchingWorkflowRuleConditionPropertiesArgs']]]
    """
