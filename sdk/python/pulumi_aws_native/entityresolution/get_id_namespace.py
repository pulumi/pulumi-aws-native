...
class GetIdNamespaceResult:
    ...
    def id_namespace_arn(self) -> Optional[builtins.str]:
        """
...
def get_id_namespace(id_namespace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str id_namespace_name: The name of the ID namespace.
    """
    __args__ = dict()
...
def get_id_namespace_output(id_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
