...
class IdNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id_namespace_name: The name of the ID namespace.
        ...
        :param pulumi.Input[_builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role. AWS Entity Resolution assumes this role to access the resources defined in this `IdNamespace` on your behalf as part of the workflow run.
...
class IdNamespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 id_mapping_workflow_properties: pulumi.Input[Optional[Sequence[pulumi.Input[Union['IdNamespaceIdMappingWorkflowPropertiesArgs', 'IdNamespaceIdMappingWorkflowPropertiesArgsDict', 'outputs.IdNamespaceIdMappingWorkflowProperties']]]]] = None,
                 id_namespace_name: pulumi.Input[Optional[_builtins.str]] = None,
                 input_source_config: pulumi.Input[Optional[Sequence[pulumi.Input[Union['IdNamespaceInputSourceArgs', 'IdNamespaceInputSourceArgsDict', 'outputs.IdNamespaceInputSource']]]]] = None,
                 role_arn: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: The description of the ID namespace.
        :param pulumi.Input[Sequence[pulumi.Input[Union['IdNamespaceIdMappingWorkflowPropertiesArgs', 'IdNamespaceIdMappingWorkflowPropertiesArgsDict', 'outputs.IdNamespaceIdMappingWorkflowProperties']]]] id_mapping_workflow_properties: Determines the properties of `IdMappingWorflow` where this `IdNamespace` can be used as a `Source` or a `Target` .
        :param pulumi.Input[_builtins.str] id_namespace_name: The name of the ID namespace.
        :param pulumi.Input[Sequence[pulumi.Input[Union['IdNamespaceInputSourceArgs', 'IdNamespaceInputSourceArgsDict', 'outputs.IdNamespaceInputSource']]]] input_source_config: A list of `InputSource` objects, which have the fields `InputSourceARN` and `SchemaName` .
        :param pulumi.Input[_builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role. AWS Entity Resolution assumes this role to access the resources defined in this `IdNamespace` on your behalf as part of the workflow run.
    ...
    def id_namespace_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="idNamespaceName")
    def id_namespace_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the ID namespace.
        """
        return pulumi.get(self, "id_namespace_name")
