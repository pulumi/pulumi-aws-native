...
class GetSchemaMappingResult:
    ...
    def has_workflows(self) -> Optional[_builtins.bool]:
...
def get_schema_mapping(schema_name: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaMappingResult:
    """
    SchemaMapping defined in AWS Entity Resolution service


    :param _builtins.str schema_name: The name of the SchemaMapping
    """
    __args__ = dict()
