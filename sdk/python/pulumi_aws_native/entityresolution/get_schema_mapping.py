...
class GetSchemaMappingResult:
    ...
    def has_workflows(self) -> Optional[builtins.bool]:
...
def get_schema_mapping(schema_name: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchemaMappingResult:
    """
    SchemaMapping defined in AWS Entity Resolution service


    :param builtins.str schema_name: The name of the SchemaMapping
    """
    __args__ = dict()
...
def get_schema_mapping_output(schema_name: Optional[pulumi.Input[builtins.str]] = None,
