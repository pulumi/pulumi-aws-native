...
def get_id_mapping_workflow(workflow_name: Optional[builtins.str] = None,
    ...
    :param builtins.str workflow_name: The name of the IdMappingWorkflow
    """
    __args__ = dict()
...
def get_id_mapping_workflow_output(workflow_name: Optional[pulumi.Input[builtins.str]] = None,
