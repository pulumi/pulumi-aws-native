...
class IdMappingWorkflowIdMappingTechniques(dict):
    ...
    def __init__(__self__, *,
                 ...
                 normalization_version: Optional[builtins.str] = None,
    ...
    def normalization_version(self) -> Optional[builtins.str]:
...
class IdMappingWorkflowInputSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str input_source_arn: An Glue table ARN for the input source table, MatchingWorkflow arn or IdNamespace ARN
        :param builtins.str schema_arn: The ARN (Amazon Resource Name) that AWS Entity Resolution generated for the `SchemaMapping` .
...
class IdMappingWorkflowIntermediateSourceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str intermediate_s3_path: The s3 path that would be used to stage the intermediate data being generated during workflow execution.
        """
...
class IdMappingWorkflowOutputSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_arn: Optional[builtins.str] = None):
        """
        :param builtins.str output_s3_path: The S3 path to which Entity Resolution will write the output table
        :param builtins.str kms_arn: Customer AWS KMS ARN for encryption at rest. If not provided, system will use an AWS Entity Resolution managed KMS key.
        """
    ...
    def kms_arn(self) -> Optional[builtins.str]:
        """
...
class IdMappingWorkflowProviderProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provider_configuration: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str provider_service_arn: Arn of the Provider Service being used.
        ...
        :param Mapping[str, builtins.str] provider_configuration: Additional Provider configuration that would be required for the provider service. The Configuration must be in JSON string format
        """
    ...
    def provider_configuration(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class IdMappingWorkflowRule(dict):
    ...
    def __init__(__self__, *,
                 matching_keys: Sequence[builtins.str],
                 rule_name: builtins.str):
        """
        :param Sequence[builtins.str] matching_keys: A list of `MatchingKeys` . The `MatchingKeys` must have been defined in the `SchemaMapping` . Two records are considered to match according to this rule if all of the `MatchingKeys` match.
    ...
    def matching_keys(self) -> Sequence[builtins.str]:
        """
...
class IdNamespaceInputSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str input_source_arn: An AWS Glue table Amazon Resource Name (ARN) or a matching workflow ARN for the input source table.
...
class IdNamespaceNamespaceProviderProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provider_configuration: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str provider_service_arn: The Amazon Resource Name (ARN) of the provider service.
        :param Mapping[str, builtins.str] provider_configuration: Additional Provider configuration that would be required for the provider service. The Configuration must be in JSON string format.
        """
        pulumi.set(__self__, "provider_service_arn", provider_service_arn)
        if provider_configuration is not None:
...
class MatchingWorkflowInputSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 apply_normalization: Optional[builtins.bool] = None):
        """
        :param builtins.str input_source_arn: An Glue table ARN for the input source table
        :param builtins.str schema_arn: The name of the schema.
        :param builtins.bool apply_normalization: Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
        """
        pulumi.set(__self__, "input_source_arn", input_source_arn)
        pulumi.set(__self__, "schema_arn", schema_arn)
    ...
    def apply_normalization(self) -> Optional[builtins.bool]:
        """
...
class MatchingWorkflowOutputAttribute(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 hashed: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A name of a column to be written to the output. This must be an `InputField` name in the schema mapping.
        :param builtins.bool hashed: Enables the ability to hash the column values in the output.
        """
    ...
    @property
    @pulumi.getter
    def hashed(self) -> Optional[builtins.bool]:
        """
...
class MatchingWorkflowOutputSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str output_s3_path: The S3 path to which Entity Resolution will write the output table
        :param builtins.bool apply_normalization: Normalizes the attributes defined in the schema in the input data. For example, if an attribute has an `AttributeType` of `PHONE_NUMBER` , and the data in the input table is in a format of 1234567890, AWS Entity Resolution will normalize this field in the output to (123)-456-7890.
        :param builtins.str kms_arn: Customer KMS ARN for encryption at rest. If not provided, system will use an AWS Entity Resolution managed KMS key.
        """
...
class SchemaMappingSchemaInputAttribute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hashed: Optional[builtins.bool] = None,
                 match_key: Optional[builtins.str] = None,
                 sub_type: Optional[builtins.str] = None):
        """
        :param builtins.str sub_type: The subtype of the Attribute. Would be required only when type is PROVIDER_ID
        """
    ...
    def match_key(self) -> Optional[builtins.str]:
