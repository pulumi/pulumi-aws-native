...
class PolicyStatementArgs:
    def __init__(__self__, *,
                 ...
                 action: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the resource that will be accessed by the principal.
        :param pulumi.Input[builtins.str] statement_id: A statement identifier that differentiates the statement from others in the same policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] action: The action that the principal can use on the resource.
               
               For example, `entityresolution:GetIdMappingJob` , `entityresolution:GetMatchingJob` .
        :param pulumi.Input[builtins.str] condition: A set of condition keys that you can use in key policies.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] principal: The AWS service or AWS account that can access the resource defined as ARN.
        """
    ...
    @property
    @pulumi.getter
    def action(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PolicyStatement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def action(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The action that the principal can use on the resource.
