...
class PolicyStatementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] condition: A set of condition keys that you can use in key policies.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] principal: The AWS service or AWS account that can access the resource defined as ARN.
        """
...
class PolicyStatement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def action(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The action that the principal can use on the resource.
