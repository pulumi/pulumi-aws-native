...
class IdMappingWorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['IdMappingWorkflowIdMappingTechniquesArgs'] id_mapping_techniques: An object which defines the ID mapping techniques and provider configurations.
        :param pulumi.Input[Sequence[pulumi.Input['IdMappingWorkflowInputSourceArgs']]] input_source_config: An object containing `InputSourceARN` , `SchemaName` , and `Type` .
...
class IdMappingWorkflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] description: The description of the IdMappingWorkflow
        :param pulumi.Input[pulumi.InputType['IdMappingWorkflowIdMappingTechniquesArgs']] id_mapping_techniques: An object which defines the ID mapping techniques and provider configurations.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IdMappingWorkflowInputSourceArgs']]]] input_source_config: An object containing `InputSourceARN` , `SchemaName` , and `Type` .
