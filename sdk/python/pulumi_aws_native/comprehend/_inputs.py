...
class DocumentClassifierInputDataConfigArgsDict(TypedDict):
    augmented_manifests: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DocumentClassifierAugmentedManifestsListItemArgsDict']]]]]
    """
    ...
    """
    document_reader_config: NotRequired[pulumi.Input[Optional['DocumentClassifierDocumentReaderConfigArgsDict']]]
    ...
    """
    documents: NotRequired[pulumi.Input[Optional['DocumentClassifierDocumentsArgsDict']]]
    """
...
class DocumentClassifierInputDataConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label_delimiter: Indicates the delimiter used to separate each label for training a multi-label classifier. The default delimiter between labels is a pipe (|). You can use a different character as a delimiter (if it's an allowed character) by specifying it under Delimiter for labels. If the training documents use a delimiter other than the default or the delimiter you specify, the labels on that line will be combined to make a single unique label, such as LABELLABELLABEL.
        :param pulumi.Input[_builtins.str] s3_uri: The Amazon S3 URI for the input data. The S3 bucket must be in the same Region as the API endpoint that you are calling. The URI can point to a single input file or it can provide the prefix for a collection of input files.
               
               For example, if you use the URI `S3://bucketName/prefix` , if the prefix is a single file, Amazon Comprehend uses that file as input. If more than one file begins with the prefix, Amazon Comprehend uses all of them as input.
               
               This parameter is required if you set `DataFormat` to `COMPREHEND_CSV` .
        :param pulumi.Input[_builtins.str] test_s3_uri: This specifies the Amazon S3 location that contains the test annotations for the document classifier. The URI must be in the same AWS Region as the API endpoint that you are calling.
        """
...
class DocumentClassifierOutputDataConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt the output results from an analysis job. The KmsKeyId can be one of the following formats:
               ...
               - KMS Key Alias: `"alias/ExampleAlias"`
               - ARN of a KMS Key Alias: `"arn:aws:kms:us-west-2:111122223333:alias/ExampleAlias"`
        :param pulumi.Input[_builtins.str] s3_uri: When you use the `OutputDataConfig` object while creating a custom classifier, you specify the Amazon S3 location where you want to write the confusion matrix and other output files. The URI must be in the same Region as the API endpoint that you are calling. The location is used as the prefix for the actual location of this output file.
...
class DocumentClassifierVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnets: The ID for each subnet being used in your private VPC. This subnet is a subset of the a range of IPv4 addresses used by the VPC and is specific to a given availability zone in the VPC’s Region. This ID number is preceded by "subnet-", for instance: "subnet-04ccf456919e69055". For more information, see [VPCs and Subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html) .
        """
...
class FlywheelDataSecurityConfigArgsDict(TypedDict):
    ...
    """
    vpc_config: NotRequired[pulumi.Input[Optional['FlywheelVpcConfigArgsDict']]]
    """
...
class FlywheelDataSecurityConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] model_kms_key_id: ID for the AWS  key that Amazon Comprehend uses to encrypt trained custom models. The ModelKmsKeyId can be either of the following formats:
               ...
               - KMS Key ID: `"1234abcd-12ab-34cd-56ef-1234567890ab"`
               - Amazon Resource Name (ARN) of a KMS Key: `"arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"`
        :param pulumi.Input[_builtins.str] volume_kms_key_id: ID for the AWS  key that Amazon Comprehend uses to encrypt the volume.
...
class FlywheelEntityRecognitionConfigArgsDict(TypedDict):
    entity_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FlywheelEntityTypesListItemArgsDict']]]]]
    """
...
class FlywheelEntityTypesListItemArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] type: An entity type within a labeled training dataset that Amazon Comprehend uses to train a custom entity recognizer.
...
class FlywheelTaskConfigArgsDict(TypedDict):
    ...
    """
    document_classification_config: NotRequired[pulumi.Input[Optional['FlywheelDocumentClassificationConfigArgsDict']]]
    """
    Configuration required for a document classification model.
    """
    entity_recognition_config: NotRequired[pulumi.Input[Optional['FlywheelEntityRecognitionConfigArgsDict']]]
    """
