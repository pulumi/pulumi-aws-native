...
warnings.warn("""Flywheel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class Flywheel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 task_config: Optional[pulumi.Input[pulumi.InputType['FlywheelTaskConfigArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Flywheel is deprecated: Flywheel is not yet supported by AWS Native, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
