...
class DocumentClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(input_data_config, DocumentClassifierInputDataConfigArgs):
            ...
            if not isinstance(output_data_config, DocumentClassifierOutputDataConfigArgs):
            ...
            if not isinstance(vpc_config, DocumentClassifierVpcConfigArgs):
