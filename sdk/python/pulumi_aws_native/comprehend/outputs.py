...
class DocumentClassifierAugmentedManifestsListItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] attribute_names: The JSON attribute that contains the annotations for your training documents. The number of attribute names that you specify depends on whether your augmented manifest file is the output of a single labeling job or a chained labeling job.
...
class DocumentClassifierDocuments(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str s3_uri: The S3 URI location of the training documents specified in the S3Uri CSV file.
        :param _builtins.str test_s3_uri: The S3 URI location of the test documents included in the TestS3Uri CSV file. This field is not required if you do not specify a test CSV file.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
...
class DocumentClassifierInputDataConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str label_delimiter: Indicates the delimiter used to separate each label for training a multi-label classifier. The default delimiter between labels is a pipe (|). You can use a different character as a delimiter (if it's an allowed character) by specifying it under Delimiter for labels. If the training documents use a delimiter other than the default or the delimiter you specify, the labels on that line will be combined to make a single unique label, such as LABELLABELLABEL.
        :param _builtins.str s3_uri: The Amazon S3 URI for the input data. The S3 bucket must be in the same Region as the API endpoint that you are calling. The URI can point to a single input file or it can provide the prefix for a collection of input files.
               
               For example, if you use the URI `S3://bucketName/prefix` , if the prefix is a single file, Amazon Comprehend uses that file as input. If more than one file begins with the prefix, Amazon Comprehend uses all of them as input.
               
               This parameter is required if you set `DataFormat` to `COMPREHEND_CSV` .
        :param _builtins.str test_s3_uri: This specifies the Amazon S3 location that contains the test annotations for the document classifier. The URI must be in the same AWS Region as the API endpoint that you are calling.
        """
...
class DocumentClassifierOutputDataConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str kms_key_id: ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt the output results from an analysis job. The KmsKeyId can be one of the following formats:
               
               - KMS Key ID: `"1234abcd-12ab-34cd-56ef-1234567890ab"`
               - Amazon Resource Name (ARN) of a KMS Key: `"arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"`
               - KMS Key Alias: `"alias/ExampleAlias"`
               - ARN of a KMS Key Alias: `"arn:aws:kms:us-west-2:111122223333:alias/ExampleAlias"`
        :param _builtins.str s3_uri: When you use the `OutputDataConfig` object while creating a custom classifier, you specify the Amazon S3 location where you want to write the confusion matrix and other output files. The URI must be in the same Region as the API endpoint that you are calling. The location is used as the prefix for the actual location of this output file.
...
class FlywheelDataSecurityConfig(dict):
    ...
    def __init__(__self__, *,
                 data_lake_kms_key_id: Optional[_builtins.str] = None,
                 model_kms_key_id: Optional[_builtins.str] = None,
...
class FlywheelDocumentClassificationConfig(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] labels: One or more labels to associate with the custom classifier.
        """
...
class FlywheelEntityTypesListItem(dict):
    def __init__(__self__, *,
                 type: _builtins.str):
        """
        :param _builtins.str type: An entity type within a labeled training dataset that Amazon Comprehend uses to train a custom entity recognizer.
