...
class GetDocumentClassifierResult:
    ...
    def model_policy(self) -> Optional[_builtins.str]:
        """
...
def get_document_classifier(arn: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDocumentClassifierResult:
    """
    Document Classifier enables training document classifier models.


    :param _builtins.str arn: The Amazon Resource Name (ARN) of the document classifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
