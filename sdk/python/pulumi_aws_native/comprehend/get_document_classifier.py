...
class GetDocumentClassifierResult:
    ...
    def model_policy(self) -> Optional[builtins.str]:
        """
...
def get_document_classifier(arn: Optional[builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDocumentClassifierResult:
    """
    Document Classifier enables training document classifier models.


    :param builtins.str arn: The Amazon Resource Name (ARN) of the document classifier.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_document_classifier_output(arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDocumentClassifierResult(
        ...
        model_policy=pulumi.get(__response__, 'model_policy'),
