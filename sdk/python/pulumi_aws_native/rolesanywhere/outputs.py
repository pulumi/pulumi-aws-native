...
class ProfileMappingRule(dict):
    def __init__(__self__, *,
                 specifier: _builtins.str):
        """
        :param _builtins.str specifier: Specifier within a certificate field, such as CN, OU, or UID from the Subject field.
        """
        pulumi.set(__self__, "specifier", specifier)

    @_builtins.property
    @pulumi.getter
    def specifier(self) -> _builtins.str:
        """
...
class TrustAnchorSource(dict):
    ...
    def __init__(__self__, *,
                 source_data: Union['outputs.TrustAnchorSourceData0Properties', 'outputs.TrustAnchorSourceData1Properties'],
    ...
    def source_data(self) -> Union['outputs.TrustAnchorSourceData0Properties', 'outputs.TrustAnchorSourceData1Properties']:
        """
