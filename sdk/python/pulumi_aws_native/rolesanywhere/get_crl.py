...
class GetCrlResult:
    ...
    def crl_data(self) -> Optional[_builtins.str]:
        """
    ...
    def crl_id(self) -> Optional[_builtins.str]:
        """
    ...
    def trust_anchor_arn(self) -> Optional[_builtins.str]:
        """
...
def get_crl(crl_id: Optional[_builtins.str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCrlResult:
    """
    Definition of AWS::RolesAnywhere::CRL Resource Type


    :param _builtins.str crl_id: The unique primary identifier of the Crl
    """
    __args__ = dict()
