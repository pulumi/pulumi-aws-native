...
class GetTrustAnchorResult:
    ...
    def trust_anchor_id(self) -> Optional[_builtins.str]:
        """
...
def get_trust_anchor(trust_anchor_id: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrustAnchorResult:
    """
    Definition of AWS::RolesAnywhere::TrustAnchor Resource Type.


    :param _builtins.str trust_anchor_id: The unique identifier of the trust anchor.
    """
    __args__ = dict()
