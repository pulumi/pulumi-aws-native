...
class GetTrustAnchorResult:
    ...
    def trust_anchor_arn(self) -> Optional[builtins.str]:
        """
    ...
    def trust_anchor_id(self) -> Optional[builtins.str]:
        """
...
def get_trust_anchor(trust_anchor_id: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrustAnchorResult:
    """
    Definition of AWS::RolesAnywhere::TrustAnchor Resource Type.


    :param builtins.str trust_anchor_id: The unique identifier of the trust anchor.
    """
    __args__ = dict()
...
def get_trust_anchor_output(trust_anchor_id: Optional[pulumi.Input[builtins.str]] = None,
