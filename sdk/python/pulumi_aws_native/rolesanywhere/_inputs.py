...
if not MYPY:
    class ProfileMappingRuleArgsDict(TypedDict):
        specifier: pulumi.Input[builtins.str]
        """
...
class ProfileMappingRuleArgs:
    def __init__(__self__, *,
                 specifier: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] specifier: Specifier within a certificate field, such as CN, OU, or UID from the Subject field.
        """
        pulumi.set(__self__, "specifier", specifier)

    @property
    @pulumi.getter
    def specifier(self) -> pulumi.Input[builtins.str]:
        """
        Specifier within a certificate field, such as CN, OU, or UID from the Subject field.
        """
    ...
    @specifier.setter
    def specifier(self, value: pulumi.Input[builtins.str]):
...
class TrustAnchorNotificationSettingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the notification setting is enabled.
        ...
        :param pulumi.Input['TrustAnchorNotificationChannel'] channel: The specified channel of notification. IAM Roles Anywhere uses CloudWatch metrics, EventBridge, and AWS Health Dashboard to notify for an event.
               ...
               > In the absence of a specific channel, IAM Roles Anywhere applies this setting to 'ALL' channels.
        :param pulumi.Input[builtins.float] threshold: The number of days before a notification event. This value is required for a notification setting that is enabled.
        """
...
if not MYPY:
    class TrustAnchorSourceData0PropertiesArgsDict(TypedDict):
        x509_certificate_data: pulumi.Input[builtins.str]
elif False:
...
class TrustAnchorSourceData1PropertiesArgs:
    ...
    def acm_pca_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "acm_pca_arn")

    @acm_pca_arn.setter
    def acm_pca_arn(self, value: pulumi.Input[builtins.str]):
