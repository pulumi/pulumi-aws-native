...
def get_findings_filter(id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFindingsFilterResult:
    """
    Macie FindingsFilter resource schema.


    :param builtins.str id: Findings filter ID.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_findings_filter_output(id: Optional[pulumi.Input[builtins.str]] = None,
