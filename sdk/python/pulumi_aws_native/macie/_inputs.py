...
class FindingsFilterCriterionAdditionalPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] eq: The value for the specified property matches (equals) the specified value. If you specify multiple values, Amazon Macie uses OR logic to join the values.
        :param pulumi.Input[builtins.int] gt: The value for the specified property is greater than the specified value.
        :param pulumi.Input[builtins.int] gte: The value for the specified property is greater than or equal to the specified value.
        :param pulumi.Input[builtins.int] lt: The value for the specified property is less than the specified value.
        :param pulumi.Input[builtins.int] lte: The value for the specified property is less than or equal to the specified value.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] neq: The value for the specified property doesn't match (doesn't equal) the specified value. If you specify multiple values, Amazon Macie uses OR logic to join the values.
        """
        if eq is not None:
