...
class CustomDataIdentifierArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] regex: Regular expression for custom data identifier.
        :param pulumi.Input[builtins.str] description: Description of custom data identifier.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignore_words: Words to be ignored.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] keywords: Keywords to be matched against.
        :param pulumi.Input[builtins.int] maximum_match_distance: Maximum match distance.
        :param pulumi.Input[builtins.str] name: Name of custom data identifier.
...
class CustomDataIdentifier(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="maximumMatchDistance")
    def maximum_match_distance(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum match distance.
        """
        return pulumi.get(self, "maximum_match_distance")
