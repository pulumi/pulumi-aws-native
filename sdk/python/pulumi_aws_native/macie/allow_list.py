...
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: pulumi.Input[Optional[Union['AllowListCriteriaArgs', 'AllowListCriteriaArgsDict', 'outputs.AllowListCriteria']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['AllowListCriteriaArgs', 'AllowListCriteriaArgsDict', 'outputs.AllowListCriteria']] criteria: AllowList criteria.
        :param pulumi.Input[_builtins.str] description: Description of AllowList.
        :param pulumi.Input[_builtins.str] name: Name of AllowList.
