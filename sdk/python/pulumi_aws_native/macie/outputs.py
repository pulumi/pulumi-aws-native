...
class FindingsFilterCriterionAdditionalProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] eq: The value for the specified property matches (equals) the specified value. If you specify multiple values, Amazon Macie uses OR logic to join the values.
        :param builtins.int gt: The value for the specified property is greater than the specified value.
        :param builtins.int gte: The value for the specified property is greater than or equal to the specified value.
        :param builtins.int lt: The value for the specified property is less than the specified value.
        :param builtins.int lte: The value for the specified property is less than or equal to the specified value.
        :param Sequence[builtins.str] neq: The value for the specified property doesn't match (doesn't equal) the specified value. If you specify multiple values, Amazon Macie uses OR logic to join the values.
        """
        if eq is not None:
