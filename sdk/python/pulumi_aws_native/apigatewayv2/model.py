...
class ModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type for the model, for example, "application/json".
        :param pulumi.Input[builtins.str] description: The description of the model.
        :param pulumi.Input[builtins.str] name: The name of the model.
        """
