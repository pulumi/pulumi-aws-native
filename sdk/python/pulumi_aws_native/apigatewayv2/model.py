...
class ModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_type: The content-type for the model, for example, "application/json".
        :param pulumi.Input[_builtins.str] description: The description of the model.
        :param pulumi.Input[_builtins.str] name: The name of the model.
        """
...
@pulumi.type_token("aws-native:apigatewayv2:Model")
