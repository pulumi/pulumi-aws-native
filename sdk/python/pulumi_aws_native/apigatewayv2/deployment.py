...
class DeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description for the deployment resource.
        :param pulumi.Input[builtins.str] stage_name: The name of an existing stage to associate with the deployment.
        """
