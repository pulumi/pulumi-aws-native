...
class IntegrationResponseParameterMapArgsDict(TypedDict):
    ...
    """
    response_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IntegrationResponseParameterArgs']]]]]
...
class RoutingRuleConditionArgsDict(TypedDict):
    match_base_paths: NotRequired[pulumi.Input[Optional['RoutingRuleMatchBasePathsArgs']]]
    """
    The base path to be matched.
    """
    match_headers: NotRequired[pulumi.Input[Optional['RoutingRuleMatchHeadersArgs']]]
    """
