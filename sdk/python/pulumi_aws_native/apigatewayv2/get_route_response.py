...
class GetRouteResponseResult:
    ...
    def route_response_id(self) -> Optional[builtins.str]:
        """
    ...
    def route_response_key(self) -> Optional[builtins.str]:
        """
...
def get_route_response(api_id: Optional[builtins.str] = None,
                       route_id: Optional[builtins.str] = None,
                       route_response_id: Optional[builtins.str] = None,
    ...
    :param builtins.str route_response_id: The route response ID.
    """
    __args__ = dict()
...
def get_route_response_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
                              route_id: Optional[pulumi.Input[builtins.str]] = None,
                              route_response_id: Optional[pulumi.Input[builtins.str]] = None,
