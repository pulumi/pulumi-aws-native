...
class RouteResponse(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RouteResponsePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RouteResponsePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RouteResponseAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RouteResponseProperties']:
        """
