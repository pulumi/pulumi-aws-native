...
def get_domain_name(domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_name: The custom domain name for your API in Amazon API Gateway. Uppercase letters and the underscore (``_``) character are not supported.
    """
    __args__ = dict()
