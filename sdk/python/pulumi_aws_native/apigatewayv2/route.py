...
class RouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] route_key: The route key for the route. For HTTP APIs, the route key can be either ``$default``, or a combination of an HTTP method and resource path, for example, ``GET /pets``.
        :param pulumi.Input[builtins.bool] api_key_required: Specifies whether an API key is required for the route. Supported only for WebSocket APIs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorization_scopes: The authorization scopes supported by this route.
        :param pulumi.Input[builtins.str] authorization_type: The authorization type for the route. For WebSocket APIs, valid values are ``NONE`` for open access, ``AWS_IAM`` for using AWS IAM permissions, and ``CUSTOM`` for using a Lambda authorizer. For HTTP APIs, valid values are ``NONE`` for open access, ``JWT`` for using JSON Web Tokens, ``AWS_IAM`` for using AWS IAM permissions, and ``CUSTOM`` for using a Lambda authorizer.
        :param pulumi.Input[builtins.str] authorizer_id: The identifier of the ``Authorizer`` resource to be associated with this route. The authorizer identifier is generated by API Gateway when you created the authorizer.
        :param pulumi.Input[builtins.str] model_selection_expression: The model selection expression for the route. Supported only for WebSocket APIs.
        :param pulumi.Input[builtins.str] operation_name: The operation name for the route.
        ...
        :param pulumi.Input[builtins.str] route_response_selection_expression: The route response selection expression for the route. Supported only for WebSocket APIs.
        :param pulumi.Input[builtins.str] target: The target for the route.
        """
