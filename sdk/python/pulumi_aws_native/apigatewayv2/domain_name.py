...
warnings.warn("""DomainName is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""", DeprecationWarning)
...
class DomainName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""DomainName is deprecated: DomainName is not yet supported by AWS Cloud Control API, so its creation will currently fail. Please use the classic AWS provider, if possible.""")
        if opts is None:
