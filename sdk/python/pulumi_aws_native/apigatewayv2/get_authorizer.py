...
class GetAuthorizerResult:
    ...
    def authorizer_credentials_arn(self) -> Optional[builtins.str]:
        """
    ...
    def authorizer_payload_format_version(self) -> Optional[builtins.str]:
        """
    ...
    def enable_simple_responses(self) -> Optional[builtins.bool]:
        """
