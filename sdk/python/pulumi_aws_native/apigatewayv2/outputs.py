...
class StageAccessLogSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str destination_arn: The ARN of the CloudWatch Logs log group to receive access logs. This parameter is required to enable access logging.
        :param _builtins.str format: A single line format of the access logs of data, as specified by selected $context variables. The format must include at least $context.requestId. This parameter is required to enable access logging.
        """
...
class StageRouteSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool data_trace_enabled: Specifies whether ( `true` ) or not ( `false` ) data trace logging is enabled for this route. This property affects the log entries pushed to Amazon CloudWatch Logs. Supported only for WebSocket APIs.
        :param _builtins.bool detailed_metrics_enabled: Specifies whether detailed metrics are enabled.
        :param _builtins.str logging_level: Specifies the logging level for this route: `INFO` , `ERROR` , or `OFF` . This property affects the log entries pushed to Amazon CloudWatch Logs. Supported only for WebSocket APIs.
