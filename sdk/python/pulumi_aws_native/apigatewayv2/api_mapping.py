...
class ApiMapping(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ApiMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApiMappingPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ApiMappingAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ApiMappingProperties']:
        """
