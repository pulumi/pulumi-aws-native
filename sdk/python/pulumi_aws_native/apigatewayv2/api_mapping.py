...
class ApiMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The identifier of the API.
        :param pulumi.Input[builtins.str] domain_name: The domain name.
        :param pulumi.Input[builtins.str] stage: The API stage.
        :param pulumi.Input[builtins.str] api_mapping_key: The API mapping key.
        """
...
class ApiMapping(pulumi.CustomResource):
    ...
    def api_mapping_id(self) -> pulumi.Output[builtins.str]:
        """
