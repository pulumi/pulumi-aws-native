...
class VpcLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of subnet IDs to include in the VPC link.
        :param pulumi.Input[builtins.str] name: The name of the VPC link.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security group IDs for the VPC link.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The collection of tags. Each tag element is associated with a given resource.
        """
