...
class CellArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cell_name: The name of the cell to create.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cells: A list of cell Amazon Resource Names (ARNs) contained within this cell, for use in nested cells. For example, Availability Zones within specific Regions.
...
@pulumi.type_token("aws-native:route53recoveryreadiness:Cell")
class Cell(pulumi.CustomResource):
    ...
    def cell_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="cellName")
    def cell_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the cell to create.
        """
        return pulumi.get(self, "cell_name")
