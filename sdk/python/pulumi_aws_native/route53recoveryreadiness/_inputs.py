...
class ResourceSetDnsTargetResourceArgsDict(TypedDict):
    ...
    """
    target_resource: NotRequired[pulumi.Input[Optional['ResourceSetTargetResourceArgs']]]
    """
...
class ResourceSetResourceArgsDict(TypedDict):
    ...
    """
    dns_target_resource: NotRequired[pulumi.Input[Optional['ResourceSetDnsTargetResourceArgs']]]
    """
...
class ResourceSetTargetResourceArgsDict(TypedDict):
    ...
    The target resource that the Route 53 record points to.
    """
    nlb_resource: NotRequired[pulumi.Input[Optional['ResourceSetNlbResourceArgs']]]
    """
    The Network Load Balancer resource that a DNS target resource points to.
    """
    r53_resource: NotRequired[pulumi.Input[Optional['ResourceSetR53ResourceRecordArgs']]]
    """
    The Route 53 resource that a DNS target resource record points to.
    """
