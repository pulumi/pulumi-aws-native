...
class ResourceSetDnsTargetResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str record_type: The type of DNS record of the target resource.
...
class ResourceSetResource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_arn: The Amazon Resource Name (ARN) of the AWS resource.
        """
