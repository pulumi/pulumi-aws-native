...
class ResourceSetArgs:
    def __init__(__self__, *,
                 resource_set_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] resource_set_type: The resource type of the resources in the resource set. Enter one of the following values for resource type: 
        ...
        :param pulumi.Input[builtins.str] resource_set_name: The name of the resource set to create.
        :param pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]] tags: A tag to associate with the parameters for a resource set.
        """
    ...
    def resource_set_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_set_type(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws-native:route53recoveryreadiness:ResourceSet")
class ResourceSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_set_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: A tag to associate with the parameters for a resource set.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def resource_set_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="resourceSetName")
    def resource_set_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource set to create.
        """
        return pulumi.get(self, "resource_set_name")
    ...
    @property
    @pulumi.getter(name="resourceSetType")
    def resource_set_type(self) -> pulumi.Output[builtins.str]:
        """
        The resource type of the resources in the resource set. Enter one of the following values for resource type: 
