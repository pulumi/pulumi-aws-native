...
class GetRecoveryGroupResult:
    ...
    @_builtins.property
    @pulumi.getter
    def cells(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def recovery_group_arn(self) -> Optional[_builtins.str]:
        """
...
def get_recovery_group(recovery_group_name: Optional[_builtins.str] = None,
