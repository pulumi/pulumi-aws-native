...
class GetRecoveryGroupResult:
    ...
    def recovery_group_arn(self) -> Optional[builtins.str]:
        """
...
def get_recovery_group(recovery_group_name: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRecoveryGroupResult:
    """
    AWS Route53 Recovery Readiness Recovery Group Schema and API specifications.


    :param builtins.str recovery_group_name: The name of the recovery group to create.
    """
    __args__ = dict()
...
def get_recovery_group_output(recovery_group_name: Optional[pulumi.Input[builtins.str]] = None,
