...
class RecoveryGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cells: A list of the cell Amazon Resource Names (ARNs) in the recovery group.
        :param pulumi.Input[builtins.str] recovery_group_name: The name of the recovery group to create.
...
@pulumi.type_token("aws-native:route53recoveryreadiness:RecoveryGroup")
class RecoveryGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["recoveryGroupName"])
    ...
    def recovery_group_arn(self) -> pulumi.Output[builtins.str]:
        """
        A collection of tags associated with a resource.
        """
    ...
    @property
    @pulumi.getter(name="recoveryGroupName")
    def recovery_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the recovery group to create.
        """
        return pulumi.get(self, "recovery_group_name")
