...
class GetReadinessCheckResult:
    ...
    def readiness_check_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def resource_set_name(self) -> Optional[_builtins.str]:
        """
...
def get_readiness_check(readiness_check_name: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReadinessCheckResult:
    """
    Aws Route53 Recovery Readiness Check Schema and API specification.


    :param _builtins.str readiness_check_name: Name of the ReadinessCheck to create.
    """
    __args__ = dict()
