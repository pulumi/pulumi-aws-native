...
class GetResourceSetResult:
    ...
    def resource_set_arn(self) -> Optional[builtins.str]:
        """
...
def get_resource_set(resource_set_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceSetResult:
    """
    Schema for the AWS Route53 Recovery Readiness ResourceSet Resource and API.


    :param builtins.str resource_set_name: The name of the resource set to create.
    """
    __args__ = dict()
...
def get_resource_set_output(resource_set_name: Optional[pulumi.Input[builtins.str]] = None,
