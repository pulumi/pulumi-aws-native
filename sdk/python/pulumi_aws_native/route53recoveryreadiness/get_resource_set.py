...
class GetResourceSetResult:
    ...
    def resource_set_arn(self) -> Optional[_builtins.str]:
        """
...
def get_resource_set(resource_set_name: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceSetResult:
    """
    Schema for the AWS Route53 Recovery Readiness ResourceSet Resource and API.


    :param _builtins.str resource_set_name: The name of the resource set to create.
    """
    __args__ = dict()
