...
class ReadinessCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] readiness_check_name: Name of the ReadinessCheck to create.
        :param pulumi.Input[builtins.str] resource_set_name: The name of the resource set to check.
...
@pulumi.type_token("aws-native:route53recoveryreadiness:ReadinessCheck")
class ReadinessCheck(pulumi.CustomResource):
    ...
    def readiness_check_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="readinessCheckName")
    def readiness_check_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the ReadinessCheck to create.
        """
        return pulumi.get(self, "readiness_check_name")
