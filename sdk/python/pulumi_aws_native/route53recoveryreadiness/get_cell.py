...
class GetCellResult:
    ...
    def cell_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def parent_readiness_scopes(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_cell(cell_name: Optional[_builtins.str] = None,
