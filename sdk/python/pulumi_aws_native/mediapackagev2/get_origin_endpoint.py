...
class GetOriginEndpointResult:
    ...
    def dash_manifest_urls(self) -> Optional[Sequence[builtins.str]]:
    ...
    def hls_manifest_urls(self) -> Optional[Sequence[builtins.str]]:
    ...
    def low_latency_hls_manifest_urls(self) -> Optional[Sequence[builtins.str]]:
    ...
    def startover_window_seconds(self) -> Optional[builtins.int]:
        """
...
def get_origin_endpoint(arn: Optional[builtins.str] = None,
...
def get_origin_endpoint_output(arn: Optional[pulumi.Input[builtins.str]] = None,
