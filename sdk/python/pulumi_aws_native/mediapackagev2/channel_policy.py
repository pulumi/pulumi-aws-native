...
class ChannelPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] channel_group_name: The name of the channel group associated with the channel policy.
        :param pulumi.Input[builtins.str] channel_name: The name of the channel associated with the channel policy.
