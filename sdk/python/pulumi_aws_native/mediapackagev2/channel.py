...
class ChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] channel_group_name: The name of the channel group associated with the channel configuration.
        :param pulumi.Input[builtins.str] channel_name: The name of the channel.
        :param pulumi.Input[builtins.str] description: <p>Enter any descriptive text that helps you to identify the channel.</p>
