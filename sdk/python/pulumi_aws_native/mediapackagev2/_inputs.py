...
class OriginEndpointDashManifestConfigurationArgsDict(TypedDict):
    ...
    """
    audio_timeline_pattern: NotRequired[pulumi.Input[Optional['OriginEndpointDashAudioTimelinePattern']]]
    availability_start_time_configuration: NotRequired[pulumi.Input[Optional['OriginEndpointDashAvailabilityStartTimeConfigurationPropertiesArgsDict']]]
    ...
    """
    uri_path_type: NotRequired[pulumi.Input[Optional['OriginEndpointUriPathType']]]
...
class OriginEndpointDashManifestConfigurationArgs:
    def __init__(__self__, *,
                 manifest_name: pulumi.Input[_builtins.str],
                 audio_timeline_pattern: pulumi.Input[Optional['OriginEndpointDashAudioTimelinePattern']] = None,
                 availability_start_time_configuration: pulumi.Input[Optional['OriginEndpointDashAvailabilityStartTimeConfigurationPropertiesArgs']] = None,
                 ...
                 uri_path_type: pulumi.Input[Optional['OriginEndpointUriPathType']] = None,
    ...
    def audio_timeline_pattern(self) -> pulumi.Input[Optional['OriginEndpointDashAudioTimelinePattern']]:
        return pulumi.get(self, "audio_timeline_pattern")

    @audio_timeline_pattern.setter
    def audio_timeline_pattern(self, value: pulumi.Input[Optional['OriginEndpointDashAudioTimelinePattern']]):
        pulumi.set(self, "audio_timeline_pattern", value)

    @_builtins.property
    @pulumi.getter(name="availabilityStartTimeConfiguration")
    def availability_start_time_configuration(self) -> pulumi.Input[Optional['OriginEndpointDashAvailabilityStartTimeConfigurationPropertiesArgs']]:
        return pulumi.get(self, "availability_start_time_configuration")

    @availability_start_time_configuration.setter
    def availability_start_time_configuration(self, value: pulumi.Input[Optional['OriginEndpointDashAvailabilityStartTimeConfigurationPropertiesArgs']]):
    ...
    def uri_path_type(self) -> pulumi.Input[Optional['OriginEndpointUriPathType']]:
        return pulumi.get(self, "uri_path_type")

    @uri_path_type.setter
    def uri_path_type(self, value: pulumi.Input[Optional['OriginEndpointUriPathType']]):
...
class OriginEndpointScteArgsDict(TypedDict):
    ...
    """
    custom_ad_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['OriginEndpointCustomAdType']]]]]
    """
...
class OriginEndpointScteArgs:
    def __init__(__self__, *,
                 custom_ad_types: pulumi.Input[Optional[Sequence[pulumi.Input['OriginEndpointCustomAdType']]]] = None,
    ...
    def custom_ad_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OriginEndpointCustomAdType']]]]:
        """
        <p>A list of additional non-Ad SCTE-35 event types to treat as advertisements. When configured, events matching these types produce ad markers (such as <code>SCTE35-OUT</code> and <code>SCTE35-IN</code> in HLS DATERANGE tags) in manifests.</p> <p>Valid values: <code>PROGRAM</code> | <code>CHAPTER</code> | <code>UNSCHEDULED_EVENT</code> | <code>ALTERNATE_CONTENT_OPPORTUNITY</code> | <code>NETWORK</code> </p> <p>If you don't specify any values, the default is empty (only default ad types are used).</p>
        """
    ...
    def custom_ad_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OriginEndpointCustomAdType']]]]):
...
class OriginEndpointScteDashArgsDict(TypedDict):
    ...
    """
    scte_in_manifests: NotRequired[pulumi.Input[Optional['OriginEndpointScteInManifests']]]

@pulumi.input_type
class OriginEndpointScteDashArgs:
    def __init__(__self__, *,
                 ad_marker_dash: pulumi.Input[Optional['OriginEndpointAdMarkerDash']] = None,
                 scte_in_manifests: pulumi.Input[Optional['OriginEndpointScteInManifests']] = None):
        """
        <p>The SCTE configuration.</p>
    ...
    def scte_in_manifests(self) -> pulumi.Input[Optional['OriginEndpointScteInManifests']]:
        return pulumi.get(self, "scte_in_manifests")

    @scte_in_manifests.setter
    def scte_in_manifests(self, value: pulumi.Input[Optional['OriginEndpointScteInManifests']]):
