...
class GetChannelGroupResult:
    ...
    def egress_domain(self) -> Optional[builtins.str]:
        """
...
def get_channel_group(arn: Optional[builtins.str] = None,
...
def get_channel_group_output(arn: Optional[pulumi.Input[builtins.str]] = None,
