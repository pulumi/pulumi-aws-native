...
class ChannelGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] channel_group_name: The name of the channel group.
        :param pulumi.Input[builtins.str] description: <p>Enter any descriptive text that helps you to identify the channel group.</p>
    ...
    def channel_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def channel_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
