...
if not MYPY:
    class ScheduleCapacityProviderStrategyItemArgsDict(TypedDict):
        ...
        """
        base: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ScheduleCapacityProviderStrategyItemArgs:
    def __init__(__self__, *,
                 capacity_provider: pulumi.Input[builtins.str],
                 base: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.float] base: The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. If no value is specified, the default value of 0 is used.
        :param pulumi.Input[builtins.float] weight: The weight value designates the relative percentage of the total number of tasks launched that should use the specified capacity provider. The weight value is taken into consideration after the base value, if defined, is satisfied.
        """
    ...
    @property
    @pulumi.getter
    def base(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. If no value is specified, the default value of 0 is used.
        """
    ...
    @base.setter
    def base(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class ScheduleEcsParametersArgsDict(TypedDict):
        ...
        """
        tags: NotRequired[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]
        """
        The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define. To learn more, see RunTask in the Amazon ECS API Reference.
        """
        task_count: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ScheduleEcsParametersArgs:
    def __init__(__self__, *,
                 ...
                 task_count: Optional[pulumi.Input[builtins.float]] = None):
        """
        The custom parameters to be used when the target is an Amazon ECS task.
        ...
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task. For more information, see Tagging Your Amazon ECS Resources in the Amazon Elastic Container Service Developer Guide.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]] tags: The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define. To learn more, see RunTask in the Amazon ECS API Reference.
        :param pulumi.Input[builtins.float] task_count: The number of tasks to create based on TaskDefinition. The default is 1.
        """
    ...
    def task_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The number of tasks to create based on TaskDefinition. The default is 1.
        """
    ...
    @task_count.setter
    def task_count(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ScheduleEventBridgeParametersArgs:
    def __init__(__self__, *,
        ...
        """
        EventBridge PutEvent predefined target type.
        :param pulumi.Input[builtins.str] detail_type: Free-form string, with a maximum of 128 characters, used to decide what fields to expect in the event detail.
...
if not MYPY:
    class ScheduleFlexibleTimeWindowArgsDict(TypedDict):
        ...
        *Allowed Values* : `"OFF"` | `"FLEXIBLE"`
        """
        maximum_window_in_minutes: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ScheduleFlexibleTimeWindowArgs:
    def __init__(__self__, *,
                 mode: pulumi.Input['ScheduleFlexibleTimeWindowMode'],
                 maximum_window_in_minutes: Optional[pulumi.Input[builtins.float]] = None):
        """
        Flexible time window allows configuration of a window within which a schedule can be invoked
        :param pulumi.Input['ScheduleFlexibleTimeWindowMode'] mode: Determines whether the schedule is invoked within a flexible time window. You must use quotation marks when you specify this value in your JSON or YAML template.
               ...
               *Allowed Values* : `"OFF"` | `"FLEXIBLE"`
        :param pulumi.Input[builtins.float] maximum_window_in_minutes: The maximum time window during which a schedule can be invoked.
        """
    ...
    def maximum_window_in_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum time window during which a schedule can be invoked.
        """
    ...
    def maximum_window_in_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ScheduleKinesisParametersArgs:
    def __init__(__self__, *,
        ...
        """
        The custom parameter you can use to control the shard to which EventBridge Scheduler sends the event.
        :param pulumi.Input[builtins.str] partition_key: The custom parameter used as the Kinesis partition key. For more information, see Amazon Kinesis Streams Key Concepts in the Amazon Kinesis Streams Developer Guide.
        """
...
class SchedulePlacementConstraintArgs:
    def __init__(__self__, *,
        ...
        """
        An object representing a constraint on task placement.
        :param pulumi.Input[builtins.str] expression: A cluster query language expression to apply to the constraint. You cannot specify an expression if the constraint type is distinctInstance. To learn more, see Cluster Query Language in the Amazon Elastic Container Service Developer Guide.
...
if not MYPY:
    class ScheduleRetryPolicyArgsDict(TypedDict):
        ...
        """
        maximum_event_age_in_seconds: NotRequired[pulumi.Input[builtins.float]]
        """
        The maximum amount of time, in seconds, to continue to make retry attempts.
        """
        maximum_retry_attempts: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ScheduleRetryPolicyArgs:
    def __init__(__self__, *,
                 maximum_event_age_in_seconds: Optional[pulumi.Input[builtins.float]] = None,
                 maximum_retry_attempts: Optional[pulumi.Input[builtins.float]] = None):
        """
        A RetryPolicy object that includes information about the retry policy settings.
        :param pulumi.Input[builtins.float] maximum_event_age_in_seconds: The maximum amount of time, in seconds, to continue to make retry attempts.
        :param pulumi.Input[builtins.float] maximum_retry_attempts: The maximum number of retry attempts to make before the request fails. Retry attempts with exponential backoff continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is reached.
        """
    ...
    def maximum_event_age_in_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum amount of time, in seconds, to continue to make retry attempts.
        """
    ...
    def maximum_event_age_in_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "maximum_event_age_in_seconds", value)

    @property
    @pulumi.getter(name="maximumRetryAttempts")
    def maximum_retry_attempts(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum number of retry attempts to make before the request fails. Retry attempts with exponential backoff continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is reached.
        """
    ...
    def maximum_retry_attempts(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ScheduleSageMakerPipelineParameterArgs:
    def __init__(__self__, *,
        ...
        """
        Name/Value pair of a parameter to start execution of a SageMaker Model Building Pipeline.
        :param pulumi.Input[builtins.str] name: Name of parameter to start execution of a SageMaker Model Building Pipeline.
        :param pulumi.Input[builtins.str] value: Value of parameter to start execution of a SageMaker Model Building Pipeline.
        """
...
class ScheduleTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to be used for this target when the schedule is triggered.
        ...
        :param pulumi.Input[builtins.str] input: The text, or well-formed JSON, passed to the target. If you are configuring a templated Lambda, AWS Step Functions, or Amazon EventBridge target, the input must be a well-formed JSON. For all other target types, a JSON is not required. If you do not specify anything for this field, EventBridge Scheduler delivers a default notification to the target.
