...
class ScheduleEcsParameters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional[Sequence[Mapping[str, _builtins.str]]] = None,
        ...
        :param Sequence[Mapping[str, _builtins.str]] tags: The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define. To learn more, see RunTask in the Amazon ECS API Reference.
        :param _builtins.float task_count: The number of tasks to create based on TaskDefinition. The default is 1.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> Optional[Sequence[Mapping[str, _builtins.str]]]:
        """
    ...
    def task_count(self) -> Optional[_builtins.float]:
        """
...
class ScheduleFlexibleTimeWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float maximum_window_in_minutes: The maximum time window during which a schedule can be invoked.
        """
    ...
    def maximum_window_in_minutes(self) -> Optional[_builtins.float]:
        """
...
class ScheduleRetryPolicy(dict):
    ...
    def __init__(__self__, *,
                 maximum_event_age_in_seconds: Optional[_builtins.float] = None,
    ...
    def maximum_event_age_in_seconds(self) -> Optional[_builtins.float]:
        """
    ...
    def maximum_retry_attempts(self) -> Optional[_builtins.float]:
        """
