...
class ScheduleCapacityProviderStrategyItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 base: Optional[builtins.float] = None,
                 weight: Optional[builtins.float] = None):
        """
        The details of a capacity provider strategy.
        :param builtins.str capacity_provider: The short name of the capacity provider.
        :param builtins.float base: The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. If no value is specified, the default value of 0 is used.
        :param builtins.float weight: The weight value designates the relative percentage of the total number of tasks launched that should use the specified capacity provider. The weight value is taken into consideration after the base value, if defined, is satisfied.
        """
    ...
    @property
    @pulumi.getter
    def base(self) -> Optional[builtins.float]:
        """
...
class ScheduleEcsParameters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional[Sequence[Mapping[str, builtins.str]]] = None,
                 task_count: Optional[builtins.float] = None):
        """
        The custom parameters to be used when the target is an Amazon ECS task.
        ...
        :param builtins.bool enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task. For more information, see Tagging Your Amazon ECS Resources in the Amazon Elastic Container Service Developer Guide.
        ...
        :param Sequence[Mapping[str, builtins.str]] tags: The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define. To learn more, see RunTask in the Amazon ECS API Reference.
        :param builtins.float task_count: The number of tasks to create based on TaskDefinition. The default is 1.
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence[Mapping[str, builtins.str]]]:
        """
    ...
    def task_count(self) -> Optional[builtins.float]:
        """
...
class ScheduleEventBridgeParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        EventBridge PutEvent predefined target type.
        :param builtins.str detail_type: Free-form string, with a maximum of 128 characters, used to decide what fields to expect in the event detail.
...
class ScheduleFlexibleTimeWindow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maximum_window_in_minutes: Optional[builtins.float] = None):
        """
        Flexible time window allows configuration of a window within which a schedule can be invoked
        ...
        :param builtins.float maximum_window_in_minutes: The maximum time window during which a schedule can be invoked.
        """
    ...
    def maximum_window_in_minutes(self) -> Optional[builtins.float]:
        """
...
class ScheduleKinesisParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The custom parameter you can use to control the shard to which EventBridge Scheduler sends the event.
        :param builtins.str partition_key: The custom parameter used as the Kinesis partition key. For more information, see Amazon Kinesis Streams Key Concepts in the Amazon Kinesis Streams Developer Guide.
        """
...
class SchedulePlacementConstraint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An object representing a constraint on task placement.
        :param builtins.str expression: A cluster query language expression to apply to the constraint. You cannot specify an expression if the constraint type is distinctInstance. To learn more, see Cluster Query Language in the Amazon Elastic Container Service Developer Guide.
...
class ScheduleRetryPolicy(dict):
    ...
    def __init__(__self__, *,
                 maximum_event_age_in_seconds: Optional[builtins.float] = None,
                 maximum_retry_attempts: Optional[builtins.float] = None):
        """
        A RetryPolicy object that includes information about the retry policy settings.
        :param builtins.float maximum_event_age_in_seconds: The maximum amount of time, in seconds, to continue to make retry attempts.
        :param builtins.float maximum_retry_attempts: The maximum number of retry attempts to make before the request fails. Retry attempts with exponential backoff continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is reached.
        """
    ...
    def maximum_event_age_in_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def maximum_retry_attempts(self) -> Optional[builtins.float]:
        """
...
class ScheduleSageMakerPipelineParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Name/Value pair of a parameter to start execution of a SageMaker Model Building Pipeline.
        :param builtins.str name: Name of parameter to start execution of a SageMaker Model Building Pipeline.
        :param builtins.str value: Value of parameter to start execution of a SageMaker Model Building Pipeline.
        """
...
class ScheduleTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the IAM role to be used for this target when the schedule is triggered.
