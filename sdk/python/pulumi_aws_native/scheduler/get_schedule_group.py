...
class GetScheduleGroupResult:
    ...
    def last_modification_date(self) -> Optional[builtins.str]:
        """
...
def get_schedule_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the schedule group.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_schedule_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws-native:scheduler:getScheduleGroup', __args__, opts=opts, typ=GetScheduleGroupResult)
    return __ret__.apply(lambda __response__: GetScheduleGroupResult(
