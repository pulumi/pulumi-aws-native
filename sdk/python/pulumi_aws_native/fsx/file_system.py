...
class FileSystem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(lustre_configuration, FileSystemLustreConfigurationArgs):
            ...
            if not isinstance(ontap_configuration, FileSystemOntapConfigurationArgs):
            ...
            if not isinstance(open_zfs_configuration, FileSystemOpenZfsConfigurationArgs):
            ...
            if not isinstance(windows_configuration, FileSystemWindowsConfigurationArgs):
