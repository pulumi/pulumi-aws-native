...
def get_model(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A name for the model. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the model name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
...
def get_model_output(name: Optional[pulumi.Input[builtins.str]] = None,
