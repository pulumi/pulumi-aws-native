...
def get_client_certificate(client_certificate_id: Optional[builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClientCertificateResult:
    """
    The ``AWS::ApiGateway::ClientCertificate`` resource creates a client certificate that API Gateway uses to configure client-side SSL authentication for sending requests to the integration endpoint.


    :param builtins.str client_certificate_id: The ID for the client certificate. For example: `abc123` .
    """
    __args__ = dict()
...
def get_client_certificate_output(client_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
