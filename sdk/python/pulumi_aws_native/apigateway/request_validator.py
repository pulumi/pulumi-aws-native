...
class RequestValidatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] validate_request_parameters: A Boolean flag to indicate whether to validate request parameters ( `true` ) or not ( `false` ).
        """
...
class RequestValidator(pulumi.CustomResource):
    ...
    def request_validator_id(self) -> pulumi.Output[_builtins.str]:
        """
