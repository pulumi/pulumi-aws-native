...
class RequestValidatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of this RequestValidator
        :param pulumi.Input[builtins.bool] validate_request_body: A Boolean flag to indicate whether to validate a request body according to the configured Model schema.
        :param pulumi.Input[builtins.bool] validate_request_parameters: A Boolean flag to indicate whether to validate request parameters ( `true` ) or not ( `false` ).
        """
...
@pulumi.type_token("aws-native:apigateway:RequestValidator")
class RequestValidator(pulumi.CustomResource):
    ...
    def request_validator_id(self) -> pulumi.Output[builtins.str]:
        """
