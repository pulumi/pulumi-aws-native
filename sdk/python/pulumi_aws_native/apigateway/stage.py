...
class StageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cache_cluster_size: The stage's cache capacity in GB. For more information about choosing a cache size, see [Enabling API caching to enhance responsiveness](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html) .
        :param pulumi.Input['StageCanarySettingArgs'] canary_setting: Settings for the canary deployment in this stage.
        :param pulumi.Input[builtins.str] client_certificate_id: The identifier of a client certificate for an API stage.
        :param pulumi.Input[builtins.str] deployment_id: The identifier of the Deployment that the stage points to.
        :param pulumi.Input[builtins.str] description: The stage's description.
        :param pulumi.Input[builtins.str] documentation_version: The version of the associated API documentation.
        ...
        :param pulumi.Input[builtins.str] stage_name: The name of the stage is the first path segment in the Uniform Resource Identifier (URI) of a call to API Gateway. Stage names can only contain alphanumeric characters, hyphens, and underscores. Maximum length is 128 characters.
        ...
        :param pulumi.Input[builtins.bool] tracing_enabled: Specifies whether active tracing with X-ray is enabled for the Stage.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: A map (string-to-string map) that defines the stage variables, where the variable name is the key and the variable value is the value. Variable names are limited to alphanumeric characters. Values must match the following regular expression: ``[A-Za-z0-9-._~:/?#&=,]+``.
        """
...
class Stage(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="tracingEnabled")
    def tracing_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether active tracing with X-ray is enabled for the Stage.
        """
        return pulumi.get(self, "tracing_enabled")
