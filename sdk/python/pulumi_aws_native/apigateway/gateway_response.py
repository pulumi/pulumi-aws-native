...
class GatewayResponseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] response_templates: Response templates of the GatewayResponse as a string-to-string map of key-value pairs.
        :param pulumi.Input[_builtins.str] status_code: The HTTP status code for this GatewayResponse.
        """
