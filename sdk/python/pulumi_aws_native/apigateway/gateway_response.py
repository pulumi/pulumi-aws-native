...
class GatewayResponseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] response_type: The response type of the associated GatewayResponse.
        :param pulumi.Input[builtins.str] rest_api_id: The string identifier of the associated RestApi.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] response_parameters: Response parameters (paths, query strings and headers) of the GatewayResponse as a string-to-string map of key-value pairs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] response_templates: Response templates of the GatewayResponse as a string-to-string map of key-value pairs.
        :param pulumi.Input[builtins.str] status_code: The HTTP status code for this GatewayResponse.
        """
