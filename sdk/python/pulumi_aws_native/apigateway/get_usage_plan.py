...
def get_usage_plan(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID for the usage plan. For example: `abc123` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_usage_plan_output(id: Optional[pulumi.Input[_builtins.str]] = None,
