...
class GetUsagePlanResult:
    ...
    def usage_plan_name(self) -> Optional[builtins.str]:
        """
...
def get_usage_plan(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID for the usage plan. For example: `abc123` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_usage_plan_output(id: Optional[pulumi.Input[builtins.str]] = None,
