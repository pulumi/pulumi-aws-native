...
class DeploymentTagArgs:
    def __init__(__self__, *,
        ...
        An array of key-value pairs to apply to this resource.
         For more information, see [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html).
        :param pulumi.Input[builtins.str] key: A string you can use to assign a value. The combination of tag keys and values can help you organize and categorize your resources.
        :param pulumi.Input[builtins.str] value: The value for the specified tag key.
        """
...
class MethodIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] timeout_in_millis: Custom timeout between 50 and 29,000 milliseconds. The default value is 29,000 milliseconds or 29 seconds. You can increase the default value to longer than 29 seconds for Regional or private APIs only.
