...
class MethodArgs:
    def __init__(__self__, *,
                 ...
                 request_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.bool, builtins.str]]]]] = None,
                 request_validator_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Method resource.
        :param pulumi.Input[builtins.str] http_method: The method's HTTP verb.
        :param pulumi.Input[builtins.str] resource_id: The Resource identifier for the MethodResponse resource.
        :param pulumi.Input[builtins.str] rest_api_id: The string identifier of the associated RestApi.
        :param pulumi.Input[builtins.bool] api_key_required: A boolean flag specifying whether a valid ApiKey is required to invoke this method.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorization_scopes: A list of authorization scopes configured on the method. The scopes are used with a `COGNITO_USER_POOLS` authorizer to authorize the method invocation. The authorization works by matching the method scopes against the scopes parsed from the access token in the incoming request. The method invocation is authorized if any method scopes matches a claimed scope in the access token. Otherwise, the invocation is not authorized. When the method scope is configured, the client must provide an access token instead of an identity token for authorization purposes.
        :param pulumi.Input[builtins.str] authorization_type: The method's authorization type. This parameter is required. For valid values, see [Method](https://docs.aws.amazon.com/apigateway/latest/api/API_Method.html) in the *API Gateway API Reference*.
                 If you specify the ``AuthorizerId`` property, specify ``CUSTOM`` or ``COGNITO_USER_POOLS`` for this property.
        :param pulumi.Input[builtins.str] authorizer_id: The identifier of an authorizer to use on this method. The method's authorization type must be `CUSTOM` or `COGNITO_USER_POOLS` .
        ...
        :param pulumi.Input[builtins.str] operation_name: A human-friendly operation identifier for the method. For example, you can assign the `operationName` of `ListPets` for the `GET /pets` method in the `PetStore` example.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] request_models: A key-value map specifying data schemas, represented by Model resources, (as the mapped value) of the request payloads of given content types (as the mapping key).
        :param pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.bool, builtins.str]]]] request_parameters: A key-value map defining required or optional method request parameters that can be accepted by API Gateway. A key is a method request parameter name matching the pattern of `method.request.{location}.{name}` , where `location` is `querystring` , `path` , or `header` and `name` is a valid and unique parameter name. The value associated with the key is a Boolean flag indicating whether the parameter is required ( `true` ) or optional ( `false` ). The method request parameter names defined here are available in Integration to be mapped to integration request parameters or templates.
        :param pulumi.Input[builtins.str] request_validator_id: The identifier of a RequestValidator for request validation.
        """
    ...
    def request_parameters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.bool, builtins.str]]]]]:
        """
    ...
    def request_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[builtins.bool, builtins.str]]]]]):
