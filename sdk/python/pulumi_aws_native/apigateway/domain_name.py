...
class DomainNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_arn: The reference to an AWS -managed certificate that will be used by edge-optimized endpoint or private endpoint for this domain name. Certificate Manager is the only supported source.
        :param pulumi.Input[builtins.str] domain_name: The custom domain name as an API host name, for example, `my-api.example.com` .
        ...
        :param pulumi.Input[builtins.str] regional_certificate_arn: The reference to an AWS -managed certificate that will be used for validating the regional domain name. Certificate Manager is the only supported source.
...
class DomainName(pulumi.CustomResource):
    ...
    def distribution_domain_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def distribution_hosted_zone_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="ownershipVerificationCertificateArn")
    def ownership_verification_certificate_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the public certificate issued by ACM to validate ownership of your custom domain. Only required when configuring mutual TLS and using an ACM imported or private CA certificate ARN as the RegionalCertificateArn.
        """
        return pulumi.get(self, "ownership_verification_certificate_arn")
    ...
    def regional_hosted_zone_id(self) -> pulumi.Output[builtins.str]:
        """
