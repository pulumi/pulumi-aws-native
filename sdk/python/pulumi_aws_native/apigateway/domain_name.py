...
class DomainNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_arn: The reference to an AWS -managed certificate that will be used by edge-optimized endpoint or private endpoint for this domain name. AWS Certificate Manager is the only supported source.
