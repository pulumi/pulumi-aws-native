...
class DeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description for the Deployment resource to create.
        ...
        :param pulumi.Input[builtins.str] stage_name: The name of the Stage resource for the Deployment resource to create.
        """
