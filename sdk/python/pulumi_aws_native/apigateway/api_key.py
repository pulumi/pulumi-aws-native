...
class ApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] generate_distinct_id: Specifies whether ( `true` ) or not ( `false` ) the key identifier is distinct from the created API key value. This parameter is deprecated and should not be used.
        :param pulumi.Input[_builtins.str] name: A name for the API key. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the API key name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
        ...
        :param pulumi.Input[_builtins.str] value: Specifies a value of the API key.
        """
...
@pulumi.type_token("aws-native:apigateway:ApiKey")
class ApiKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 generate_distinct_id: pulumi.Input[Optional[_builtins.bool]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 stage_keys: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ApiKeyStageKeyArgs', 'ApiKeyStageKeyArgsDict', 'outputs.ApiKeyStageKey']]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: A name for the API key. If you don't specify a name, CFN generates a unique physical ID and uses that ID for the API key name. For more information, see [Name Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html).
                 If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiKeyStageKeyArgs', 'ApiKeyStageKeyArgsDict', 'outputs.ApiKeyStageKey']]]] stage_keys: DEPRECATED FOR USAGE PLANS - Specifies stages associated with the API key.
    ...
    @_builtins.property
    @pulumi.getter(name="generateDistinctId")
    def generate_distinct_id(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether ( `true` ) or not ( `false` ) the key identifier is distinct from the created API key value. This parameter is deprecated and should not be used.
        """
        return pulumi.get(self, "generate_distinct_id")
