...
def get_documentation_version(documentation_version: Optional[builtins.str] = None,
    ...
    :param builtins.str documentation_version: The version identifier of the to-be-updated documentation version.
...
def get_documentation_version_output(documentation_version: Optional[pulumi.Input[builtins.str]] = None,
