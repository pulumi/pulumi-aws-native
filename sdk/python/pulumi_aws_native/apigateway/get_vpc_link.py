...
class GetVpcLinkResult:
    ...
    def vpc_link_id(self) -> Optional[builtins.str]:
        """
...
def get_vpc_link(vpc_link_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vpc_link_id: The ID for the VPC link. For example: `abc123` .
    """
    __args__ = dict()
...
def get_vpc_link_output(vpc_link_id: Optional[pulumi.Input[builtins.str]] = None,
