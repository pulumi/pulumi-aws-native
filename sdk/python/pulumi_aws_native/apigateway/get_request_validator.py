...
class GetRequestValidatorResult:
    ...
    def validate_request_body(self) -> Optional[_builtins.bool]:
        """
    ...
    def validate_request_parameters(self) -> Optional[_builtins.bool]:
        """
...
def get_request_validator(request_validator_id: Optional[_builtins.str] = None,
