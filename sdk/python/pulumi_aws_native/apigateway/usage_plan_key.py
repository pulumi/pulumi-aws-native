...
class UsagePlanKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The Id of the UsagePlanKey resource.
        :param pulumi.Input['UsagePlanKeyKeyType'] key_type: The type of a UsagePlanKey resource for a plan customer.
        :param pulumi.Input[builtins.str] usage_plan_id: The Id of the UsagePlan resource representing the usage plan containing the UsagePlanKey resource representing a plan customer.
        """
...
@pulumi.type_token("aws-native:apigateway:UsagePlanKey")
