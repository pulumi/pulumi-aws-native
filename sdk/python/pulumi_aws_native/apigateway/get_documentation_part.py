...
class GetDocumentationPartResult:
    ...
    def documentation_part_id(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[builtins.str]:
        """
...
def get_documentation_part(documentation_part_id: Optional[builtins.str] = None,
    ...
    :param builtins.str documentation_part_id: The ID for the documentation part.
...
def get_documentation_part_output(documentation_part_id: Optional[pulumi.Input[builtins.str]] = None,
