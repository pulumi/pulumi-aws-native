...
class GetAuthorizerResult:
    ...
    def authorizer_credentials(self) -> Optional[builtins.str]:
        """
    ...
    def identity_source(self) -> Optional[builtins.str]:
        """
    ...
    def provider_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_authorizer(authorizer_id: Optional[builtins.str] = None,
    ...
    :param builtins.str authorizer_id: The ID for the authorizer. For example: `abc123` .
