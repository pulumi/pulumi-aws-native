...
class GetDomainNameAccessAssociationResult:
    ...
    def domain_name_access_association_arn(self) -> Optional[_builtins.str]:
        """
...
def get_domain_name_access_association(domain_name_access_association_arn: Optional[_builtins.str] = None,
