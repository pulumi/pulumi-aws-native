...
class GetDomainNameAccessAssociationResult:
    ...
    def domain_name_access_association_arn(self) -> Optional[builtins.str]:
        """
...
def get_domain_name_access_association(domain_name_access_association_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_name_access_association_arn: The amazon resource name (ARN) of the domain name access association resource.
    """
    __args__ = dict()
...
def get_domain_name_access_association_output(domain_name_access_association_arn: Optional[pulumi.Input[builtins.str]] = None,
