...
class ApiKeyStageKey(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str stage_name: The stage name associated with the stage key.
        """
...
class DeploymentCanarySetting(dict):
    ...
    def __init__(__self__, *,
        ...
        The ``CanarySetting`` property type specifies settings for the canary deployment in this stage.
         ``CanarySetting`` is a property of the [StageDescription](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-deployment-stagedescription.html) property type.
        :param builtins.float percent_traffic: The percent (0-100) of traffic diverted to a canary deployment.
        :param Mapping[str, builtins.str] stage_variable_overrides: Stage variables overridden for a canary release deployment, including new stage variables introduced in the canary. These stage variables are represented as a string-to-string map between stage variable names and their values.
        :param builtins.bool use_stage_cache: A Boolean flag to indicate whether the canary deployment uses the stage cache or not.
        """
...
class DeploymentCanarySettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The ``DeploymentCanarySettings`` property type specifies settings for the canary deployment.
        :param builtins.float percent_traffic: The percentage (0.0-100.0) of traffic routed to the canary deployment.
        :param Mapping[str, builtins.str] stage_variable_overrides: A stage variable overrides used for the canary release deployment. They can override existing stage variables or add new stage variables for the canary release deployment. These stage variables are represented as a string-to-string map between stage variable names and their values.
        :param builtins.bool use_stage_cache: A Boolean flag to indicate whether the canary release deployment uses the stage cache or not.
        """
        if percent_traffic is not None:
            pulumi.set(__self__, "percent_traffic", percent_traffic)
        if stage_variable_overrides is not None:
...
class DeploymentMethodSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        The ``MethodSetting`` property type configures settings for all methods in a stage.
         The ``MethodSettings`` property of the [Amazon API Gateway Deployment StageDescription](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigateway-deployment-stagedescription.html) property type contains a list of ``MethodSetting`` property types.
        :param builtins.bool cache_data_encrypted: Specifies whether the cached responses are encrypted.
        :param builtins.int cache_ttl_in_seconds: Specifies the time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response will be cached.
        :param builtins.bool caching_enabled: Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached.
        :param builtins.bool data_trace_enabled: Specifies whether data trace logging is enabled for this method, which affects the log entries pushed to Amazon CloudWatch Logs. This can be useful to troubleshoot APIs, but can result in logging sensitive data. We recommend that you don't enable this option for production APIs.
        :param builtins.str http_method: The HTTP method.
        :param builtins.str logging_level: Specifies the logging level for this method, which affects the log entries pushed to Amazon CloudWatch Logs. Valid values are `OFF` , `ERROR` , and `INFO` . Choose `ERROR` to write only error-level entries to CloudWatch Logs, or choose `INFO` to include all `ERROR` events as well as extra informational events.
        :param builtins.bool metrics_enabled: Specifies whether Amazon CloudWatch metrics are enabled for this method.
        :param builtins.str resource_path: The resource path for this method. Forward slashes (``/``) are encoded as ``~1`` and the initial slash must include a forward slash. For example, the path value ``/resource/subresource`` must be encoded as ``/~1resource~1subresource``. To specify the root path, use only a slash (``/``).
        :param builtins.int throttling_burst_limit: Specifies the throttling burst limit.
        :param builtins.float throttling_rate_limit: Specifies the throttling rate limit.
        """
...
class DeploymentStageDescription(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_cluster_enabled: Optional[builtins.bool] = None,
                 cache_cluster_size: Optional[builtins.str] = None,
                 cache_data_encrypted: Optional[builtins.bool] = None,
                 cache_ttl_in_seconds: Optional[builtins.int] = None,
                 caching_enabled: Optional[builtins.bool] = None,
                 ...
                 documentation_version: Optional[builtins.str] = None,
                 logging_level: Optional[builtins.str] = None,
                 ...
                 throttling_burst_limit: Optional[builtins.int] = None,
                 throttling_rate_limit: Optional[builtins.float] = None,
                 tracing_enabled: Optional[builtins.bool] = None,
        ...
        :param builtins.bool cache_cluster_enabled: Specifies whether a cache cluster is enabled for the stage. To activate a method-level cache, set `CachingEnabled` to `true` for a method.
        :param builtins.str cache_cluster_size: The size of the stage's cache cluster. For more information, see [cacheClusterSize](https://docs.aws.amazon.com/apigateway/latest/api/API_CreateStage.html#apigw-CreateStage-request-cacheClusterSize) in the *API Gateway API Reference*.
        :param builtins.bool cache_data_encrypted: Indicates whether the cached responses are encrypted.
        :param builtins.int cache_ttl_in_seconds: The time-to-live (TTL) period, in seconds, that specifies how long API Gateway caches responses.
        :param builtins.bool caching_enabled: Indicates whether responses are cached and returned for requests. You must enable a cache cluster on the stage to cache responses. For more information, see [Enable API Gateway Caching in a Stage to Enhance API Performance](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html) in the *API Gateway Developer Guide*.
        :param 'DeploymentCanarySetting' canary_setting: Specifies settings for the canary deployment in this stage.
        :param builtins.str client_certificate_id: The identifier of the client certificate that API Gateway uses to call your integration endpoints in the stage.
        :param builtins.bool data_trace_enabled: Indicates whether data trace logging is enabled for methods in the stage. API Gateway pushes these logs to Amazon CloudWatch Logs.
        :param builtins.str description: A description of the purpose of the stage.
        :param builtins.str documentation_version: The version identifier of the API documentation snapshot.
        :param builtins.str logging_level: The logging level for this method. For valid values, see the ``loggingLevel`` property of the [MethodSetting](https://docs.aws.amazon.com/apigateway/latest/api/API_MethodSetting.html) resource in the *Amazon API Gateway API Reference*.
        :param Sequence['DeploymentMethodSetting'] method_settings: Configures settings for all of the stage's methods.
        :param builtins.bool metrics_enabled: Indicates whether Amazon CloudWatch metrics are enabled for methods in the stage.
        :param Sequence['DeploymentTag'] tags: An array of arbitrary tags (key-value pairs) to associate with the stage.
        :param builtins.int throttling_burst_limit: The target request burst rate limit. This allows more requests through for a period of time than the target rate limit. For more information, see [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html) in the *API Gateway Developer Guide*.
        :param builtins.float throttling_rate_limit: The target request steady-state rate limit. For more information, see [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html) in the *API Gateway Developer Guide*.
        :param builtins.bool tracing_enabled: Specifies whether active tracing with X-ray is enabled for this stage.
        ...
        :param Mapping[str, builtins.str] variables: A map that defines the stage variables. Variable names must consist of alphanumeric characters, and the values must match the following regular expression: ``[A-Za-z0-9-._~:/?#&=,]+``.
        """
    ...
    def cache_cluster_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def cache_cluster_size(self) -> Optional[builtins.str]:
        """
    ...
    def documentation_version(self) -> Optional[builtins.str]:
        """
    ...
    def tracing_enabled(self) -> Optional[builtins.bool]:
        """
...
class DocumentationPartLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str status_code: The HTTP status code of a response. It is a valid field for the API entity types of `RESPONSE` , `RESPONSE_HEADER` , and `RESPONSE_BODY` . The default value is `*` for any status code. When an applicable child entity inherits the content of an entity of the same type with more general specifications of the other `location` attributes, the child entity's `statusCode` attribute must match that of the parent entity exactly.
...
class MethodIntegration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_key_parameters: Optional[Sequence[builtins.str]] = None,
                 cache_namespace: Optional[builtins.str] = None,
                 ...
                 integration_http_method: Optional[builtins.str] = None,
        ...
        :param Sequence[builtins.str] cache_key_parameters: A list of request parameters whose values API Gateway caches. To be valid values for `cacheKeyParameters` , these parameters must also be specified for Method `requestParameters` .
        :param builtins.str cache_namespace: Specifies a group of related cached parameters. By default, API Gateway uses the resource ID as the `cacheNamespace` . You can specify the same `cacheNamespace` across resources to return the same cached data for requests to different resources.
        :param builtins.str connection_id: The ID of the VpcLink used for the integration when `connectionType=VPC_LINK` and undefined, otherwise.
        ...
        :param builtins.str credentials: Specifies the credentials required for the integration, if any. For AWS integrations, three options are available. To specify an IAM Role for API Gateway to assume, use the role's Amazon Resource Name (ARN). To require that the caller's identity be passed through from the request, specify the string `arn:aws:iam::\\*:user/\\*` . To use resource-based permissions on supported AWS services, specify null.
        :param builtins.str integration_http_method: Specifies the integration's HTTP method type. For the Type property, if you specify `MOCK` , this property is optional. For Lambda integrations, you must set the integration method to `POST` . For all other types, you must specify this property.
        ...
        :param Mapping[str, builtins.str] request_parameters: A key-value map specifying request parameters that are passed from the method request to the back end. The key is an integration request parameter name and the associated value is a method request parameter value or static value that must be enclosed within single quotes and pre-encoded as required by the back end. The method request parameter value must match the pattern of `method.request.{location}.{name}` , where `location` is `querystring` , `path` , or `header` and `name` must be a valid and unique method request parameter name.
        :param Mapping[str, builtins.str] request_templates: Represents a map of Velocity templates that are applied on the request payload based on the value of the Content-Type header sent by the client. The content type value is the key in this map, and the template (as a String) is the value.
        :param builtins.int timeout_in_millis: Custom timeout between 50 and 29,000 milliseconds. The default value is 29,000 milliseconds or 29 seconds. You can increase the default value to longer than 29 seconds for Regional or private APIs only.
        :param builtins.str uri: Specifies Uniform Resource Identifier (URI) of the integration endpoint.
    ...
    def cache_key_parameters(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def cache_namespace(self) -> Optional[builtins.str]:
        """
    ...
    def integration_http_method(self) -> Optional[builtins.str]:
        """
    ...
    def request_parameters(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def request_templates(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def timeout_in_millis(self) -> Optional[builtins.int]:
        """
...
class MethodIntegrationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 response_parameters: Optional[Mapping[str, builtins.str]] = None,
                 response_templates: Optional[Mapping[str, builtins.str]] = None,
                 selection_pattern: Optional[builtins.str] = None):
        """
        ``IntegrationResponse`` is a property of the [Amazon API Gateway Method Integration](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apitgateway-method-integration.html) property type that specifies the response that API Gateway sends after a method's backend finishes processing a request.
        :param builtins.str status_code: Specifies the status code that is used to map the integration response to an existing MethodResponse.
        ...
        :param Mapping[str, builtins.str] response_parameters: A key-value map specifying response parameters that are passed to the method response from the back end. The key is a method response header parameter name and the mapped value is an integration response header value, a static value enclosed within a pair of single quotes, or a JSON expression from the integration response body. The mapping key must match the pattern of `method.response.header.{name}` , where `name` is a valid and unique header name. The mapped non-static value must match the pattern of `integration.response.header.{name}` or `integration.response.body.{JSON-expression}` , where `name` is a valid and unique response header name and `JSON-expression` is a valid JSON expression without the `$` prefix.
        :param Mapping[str, builtins.str] response_templates: Specifies the templates used to transform the integration response body. Response templates are represented as a key/value map, with a content-type as the key and a template as the value.
        :param builtins.str selection_pattern: Specifies the regular expression (regex) pattern used to choose an integration response based on the response from the back end. For example, if the success response returns nothing and the error response returns some string, you could use the `.+` regex to match error response. However, make sure that the error response does not contain any newline ( `\\n` ) character in such cases. If the back end is an AWS Lambda function, the AWS Lambda function error header is matched. For all other HTTP and AWS back ends, the HTTP status code is matched.
        """
        pulumi.set(__self__, "status_code", status_code)
        if content_handling is not None:
            pulumi.set(__self__, "content_handling", content_handling)
    ...
    def response_parameters(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def response_templates(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def selection_pattern(self) -> Optional[builtins.str]:
        """
...
class MethodResponse(dict):
    ...
    def __init__(__self__, *,
                 status_code: builtins.str,
                 response_models: Optional[Mapping[str, builtins.str]] = None,
                 response_parameters: Optional[Mapping[str, Any]] = None):
        """
        :param builtins.str status_code: The method response's status code.
        :param Mapping[str, builtins.str] response_models: Specifies the Model resources used for the response's content-type. Response models are represented as a key/value map, with a content-type as the key and a Model name as the value.
    ...
    def response_models(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class RestApiEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] types: A list of endpoint types of an API (RestApi) or its custom domain name (DomainName). For an edge-optimized API and its custom domain name, the endpoint type is `"EDGE"` . For a regional API and its custom domain name, the endpoint type is `REGIONAL` . For a private API, the endpoint type is `PRIVATE` .
        :param Sequence[builtins.str] vpc_endpoint_ids: A list of VpcEndpointIds of an API (RestApi) against which to create Route53 ALIASes. It is only supported for `PRIVATE` endpoint type.
        """
        if ip_address_type is not None:
            pulumi.set(__self__, "ip_address_type", ip_address_type)
        if types is not None:
...
class RestApiS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str version: For versioning-enabled buckets, a specific version of the OpenAPI file.
        """
...
class StageCanarySetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_stage_cache: Optional[builtins.bool] = None):
        """
        :param builtins.str deployment_id: The ID of the canary deployment.
        :param builtins.float percent_traffic: The percent (0-100) of traffic diverted to a canary deployment.
        :param Mapping[str, builtins.str] stage_variable_overrides: Stage variables overridden for a canary release deployment, including new stage variables introduced in the canary. These stage variables are represented as a string-to-string map between stage variable names and their values.
        :param builtins.bool use_stage_cache: A Boolean flag to indicate whether the canary deployment uses the stage cache or not.
        """
...
class StageMethodSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool caching_enabled: Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached.
        :param builtins.bool data_trace_enabled: Specifies whether data trace logging is enabled for this method, which affects the log entries pushed to Amazon CloudWatch Logs. This can be useful to troubleshoot APIs, but can result in logging sensitive data. We recommend that you don't enable this option for production APIs.
        :param builtins.str http_method: The HTTP method. To apply settings to multiple resources and methods, specify an asterisk (``*``) for the ``HttpMethod`` and ``/*`` for the ``ResourcePath``. This parameter is required when you specify a ``MethodSetting``.
        :param builtins.str logging_level: Specifies the logging level for this method, which affects the log entries pushed to Amazon CloudWatch Logs. Valid values are `OFF` , `ERROR` , and `INFO` . Choose `ERROR` to write only error-level entries to CloudWatch Logs, or choose `INFO` to include all `ERROR` events as well as extra informational events.
        :param builtins.bool metrics_enabled: Specifies whether Amazon CloudWatch metrics are enabled for this method.
        :param builtins.str resource_path: The resource path for this method. Forward slashes (``/``) are encoded as ``~1`` and the initial slash must include a forward slash. For example, the path value ``/resource/subresource`` must be encoded as ``/~1resource~1subresource``. To specify the root path, use only a slash (``/``). To apply settings to multiple resources and methods, specify an asterisk (``*``) for the ``HttpMethod`` and ``/*`` for the ``ResourcePath``. This parameter is required when you specify a ``MethodSetting``.
        :param builtins.int throttling_burst_limit: Specifies the throttling burst limit.
        :param builtins.float throttling_rate_limit: Specifies the throttling rate limit.
        """
        if cache_data_encrypted is not None:
...
class UsagePlanApiStage(dict):
    ...
    def __init__(__self__, *,
                 api_id: Optional[builtins.str] = None,
...
class UsagePlanQuotaSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        ``QuotaSettings`` is a property of the [AWS::ApiGateway::UsagePlan](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-usageplan.html) resource that specifies a target for the maximum number of requests users can make to your REST APIs.
         In some cases clients can exceed the targets that you set. Don’t rely on usage plans to control costs. Consider using [](https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html) to monitor costs and [](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html) to manage API requests.
        :param builtins.int limit: The target maximum number of requests that can be made in a given time period.
        :param builtins.int offset: The number of requests subtracted from the given limit in the initial time period.
        :param builtins.str period: The time period in which the limit applies. Valid values are "DAY", "WEEK" or "MONTH".
        """
