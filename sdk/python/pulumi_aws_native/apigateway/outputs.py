...
class ApiKeyStageKey(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str stage_name: The stage name associated with the stage key.
        """
...
class DeploymentAccessLogSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str destination_arn: The Amazon Resource Name (ARN) of the CloudWatch Logs log group or Kinesis Data Firehose delivery stream to receive access logs. If you specify a Kinesis Data Firehose delivery stream, the stream name must begin with `amazon-apigateway-` .
...
class DeploymentCanarySetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float percent_traffic: The percent (0-100) of traffic diverted to a canary deployment.
        ...
        :param _builtins.bool use_stage_cache: A Boolean flag to indicate whether the canary deployment uses the stage cache or not.
        """
...
class DeploymentCanarySettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float percent_traffic: The percentage (0.0-100.0) of traffic routed to the canary deployment.
        :param Mapping[str, _builtins.str] stage_variable_overrides: A stage variable overrides used for the canary release deployment. They can override existing stage variables or add new stage variables for the canary release deployment. These stage variables are represented as a string-to-string map between stage variable names and their values.
        :param _builtins.bool use_stage_cache: A Boolean flag to indicate whether the canary release deployment uses the stage cache or not.
        """
        if percent_traffic is not None:
            pulumi.set(__self__, "percent_traffic", percent_traffic)
        if stage_variable_overrides is not None:
...
class DeploymentMethodSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool data_trace_enabled: Specifies whether data trace logging is enabled for this method, which affects the log entries pushed to Amazon CloudWatch Logs. This can be useful to troubleshoot APIs, but can result in logging sensitive data. We recommend that you don't enable this option for production APIs.
        :param _builtins.str http_method: The HTTP method.
        :param _builtins.str logging_level: Specifies the logging level for this method, which affects the log entries pushed to Amazon CloudWatch Logs. Valid values are `OFF` , `ERROR` , and `INFO` . Choose `ERROR` to write only error-level entries to CloudWatch Logs, or choose `INFO` to include all `ERROR` events as well as extra informational events.
        :param _builtins.bool metrics_enabled: Specifies whether Amazon CloudWatch metrics are enabled for this method.
        :param _builtins.str resource_path: The resource path for this method. Forward slashes (``/``) are encoded as ``~1`` and the initial slash must include a forward slash. For example, the path value ``/resource/subresource`` must be encoded as ``/~1resource~1subresource``. To specify the root path, use only a slash (``/``).
...
class DeploymentStageDescription(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_cluster_enabled: Optional[_builtins.bool] = None,
                 cache_cluster_size: Optional[_builtins.str] = None,
                 cache_data_encrypted: Optional[_builtins.bool] = None,
                 cache_ttl_in_seconds: Optional[_builtins.int] = None,
                 caching_enabled: Optional[_builtins.bool] = None,
                 ...
                 documentation_version: Optional[_builtins.str] = None,
                 logging_level: Optional[_builtins.str] = None,
                 ...
                 throttling_burst_limit: Optional[_builtins.int] = None,
                 throttling_rate_limit: Optional[_builtins.float] = None,
                 tracing_enabled: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool cache_cluster_enabled: Specifies whether a cache cluster is enabled for the stage. To activate a method-level cache, set `CachingEnabled` to `true` for a method.
        :param _builtins.str cache_cluster_size: The size of the stage's cache cluster. For more information, see [cacheClusterSize](https://docs.aws.amazon.com/apigateway/latest/api/API_CreateStage.html#apigw-CreateStage-request-cacheClusterSize) in the *API Gateway API Reference*.
        :param _builtins.bool cache_data_encrypted: Indicates whether the cached responses are encrypted.
        :param _builtins.int cache_ttl_in_seconds: The time-to-live (TTL) period, in seconds, that specifies how long API Gateway caches responses.
        :param _builtins.bool caching_enabled: Indicates whether responses are cached and returned for requests. You must enable a cache cluster on the stage to cache responses. For more information, see [Enable API Gateway Caching in a Stage to Enhance API Performance](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html) in the *API Gateway Developer Guide*.
        :param 'DeploymentCanarySetting' canary_setting: Specifies settings for the canary deployment in this stage.
        :param _builtins.str client_certificate_id: The identifier of the client certificate that API Gateway uses to call your integration endpoints in the stage.
        :param _builtins.bool data_trace_enabled: Indicates whether data trace logging is enabled for methods in the stage. API Gateway pushes these logs to Amazon CloudWatch Logs.
        :param _builtins.str description: A description of the purpose of the stage.
        :param _builtins.str documentation_version: The version identifier of the API documentation snapshot.
        :param _builtins.str logging_level: The logging level for this method. For valid values, see the ``loggingLevel`` property of the [MethodSetting](https://docs.aws.amazon.com/apigateway/latest/api/API_MethodSetting.html) resource in the *Amazon API Gateway API Reference*.
        :param Sequence['DeploymentMethodSetting'] method_settings: Configures settings for all of the stage's methods.
        :param _builtins.bool metrics_enabled: Indicates whether Amazon CloudWatch metrics are enabled for methods in the stage.
        :param Sequence['DeploymentTag'] tags: An array of arbitrary tags (key-value pairs) to associate with the stage.
        :param _builtins.int throttling_burst_limit: The target request burst rate limit. This allows more requests through for a period of time than the target rate limit. For more information, see [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html) in the *API Gateway Developer Guide*.
        :param _builtins.float throttling_rate_limit: The target request steady-state rate limit. For more information, see [Manage API Request Throttling](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html) in the *API Gateway Developer Guide*.
        :param _builtins.bool tracing_enabled: Specifies whether active tracing with X-ray is enabled for this stage.
        ...
        :param Mapping[str, _builtins.str] variables: A map that defines the stage variables. Variable names must consist of alphanumeric characters, and the values must match the following regular expression: ``[A-Za-z0-9-._~:/?#&=,]+``.
        """
    ...
    def cache_cluster_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def cache_cluster_size(self) -> Optional[_builtins.str]:
        """
    ...
    def documentation_version(self) -> Optional[_builtins.str]:
        """
    ...
    def tracing_enabled(self) -> Optional[_builtins.bool]:
        """
...
class DocumentationPartLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str method: The HTTP verb of a method. It is a valid field for the API entity types of `METHOD` , `PATH_PARAMETER` , `QUERY_PARAMETER` , `REQUEST_HEADER` , `REQUEST_BODY` , `RESPONSE` , `RESPONSE_HEADER` , and `RESPONSE_BODY` . The default value is `*` for any method. When an applicable child entity inherits the content of an entity of the same type with more general specifications of the other `location` attributes, the child entity's `method` attribute must match that of the parent entity exactly.
        :param _builtins.str name: The name of the targeted API entity. It is a valid and required field for the API entity types of `AUTHORIZER` , `MODEL` , `PATH_PARAMETER` , `QUERY_PARAMETER` , `REQUEST_HEADER` , `REQUEST_BODY` and `RESPONSE_HEADER` . It is an invalid field for any other entity type.
        :param _builtins.str path: The URL path of the target. It is a valid field for the API entity types of `RESOURCE` , `METHOD` , `PATH_PARAMETER` , `QUERY_PARAMETER` , `REQUEST_HEADER` , `REQUEST_BODY` , `RESPONSE` , `RESPONSE_HEADER` , and `RESPONSE_BODY` . The default value is `/` for the root resource. When an applicable child entity inherits the content of another entity of the same type with more general specifications of the other `location` attributes, the child entity's `path` attribute must match that of the parent entity as a prefix.
        :param _builtins.str status_code: The HTTP status code of a response. It is a valid field for the API entity types of `RESPONSE` , `RESPONSE_HEADER` , and `RESPONSE_BODY` . The default value is `*` for any status code. When an applicable child entity inherits the content of an entity of the same type with more general specifications of the other `location` attributes, the child entity's `statusCode` attribute must match that of the parent entity exactly.
...
class DomainNameEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str ip_address_type: The IP address types that can invoke this DomainName. Use `ipv4` to allow only IPv4 addresses to invoke this DomainName, or use `dualstack` to allow both IPv4 and IPv6 addresses to invoke this DomainName. For the `PRIVATE` endpoint type, only `dualstack` is supported.
...
class MethodIntegration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_key_parameters: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] cache_key_parameters: A list of request parameters whose values API Gateway caches. To be valid values for `cacheKeyParameters` , these parameters must also be specified for Method `requestParameters` .
        :param _builtins.str cache_namespace: Specifies a group of related cached parameters. By default, API Gateway uses the resource ID as the `cacheNamespace` . You can specify the same `cacheNamespace` across resources to return the same cached data for requests to different resources.
        :param _builtins.str connection_id: The ID of the VpcLink used for the integration when `connectionType=VPC_LINK` and undefined, otherwise.
    ...
    def cache_key_parameters(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def integration_http_method(self) -> Optional[_builtins.str]:
        """
    ...
    def request_parameters(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def request_templates(self) -> Optional[Mapping[str, _builtins.str]]:
        """
...
class MethodIntegrationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 response_parameters: Optional[Mapping[str, _builtins.str]] = None,
                 response_templates: Optional[Mapping[str, _builtins.str]] = None,
                 selection_pattern: Optional[_builtins.str] = None):
        """
        ``IntegrationResponse`` is a property of the [Amazon API Gateway Method Integration](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apitgateway-method-integration.html) property type that specifies the response that API Gateway sends after a method's backend finishes processing a request.

        :param _builtins.str status_code: Specifies the status code that is used to map the integration response to an existing MethodResponse.
        ...
        :param Mapping[str, _builtins.str] response_parameters: A key-value map specifying response parameters that are passed to the method response from the back end. The key is a method response header parameter name and the mapped value is an integration response header value, a static value enclosed within a pair of single quotes, or a JSON expression from the integration response body. The mapping key must match the pattern of `method.response.header.{name}` , where `name` is a valid and unique header name. The mapped non-static value must match the pattern of `integration.response.header.{name}` or `integration.response.body.{JSON-expression}` , where `name` is a valid and unique response header name and `JSON-expression` is a valid JSON expression without the `$` prefix.
        :param Mapping[str, _builtins.str] response_templates: Specifies the templates used to transform the integration response body. Response templates are represented as a key/value map, with a content-type as the key and a template as the value.
        :param _builtins.str selection_pattern: Specifies the regular expression (regex) pattern used to choose an integration response based on the response from the back end. For example, if the success response returns nothing and the error response returns some string, you could use the `.+` regex to match error response. However, make sure that the error response does not contain any newline ( `\\n` ) character in such cases. If the back end is an AWS Lambda function, the AWS Lambda function error header is matched. For all other HTTP and AWS back ends, the HTTP status code is matched.
        """
        pulumi.set(__self__, "status_code", status_code)
        if content_handling is not None:
            pulumi.set(__self__, "content_handling", content_handling)
    ...
    def response_parameters(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def response_templates(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def selection_pattern(self) -> Optional[_builtins.str]:
        """
...
class MethodResponse(dict):
    ...
    def __init__(__self__, *,
                 status_code: _builtins.str,
                 response_models: Optional[Mapping[str, _builtins.str]] = None,
                 response_parameters: Optional[Mapping[str, Union[_builtins.bool, _builtins.str]]] = None):
        """
        :param _builtins.str status_code: The method response's status code.
        :param Mapping[str, _builtins.str] response_models: Specifies the Model resources used for the response's content-type. Response models are represented as a key/value map, with a content-type as the key and a Model name as the value.
        :param Mapping[str, Union[_builtins.bool, _builtins.str]] response_parameters: A key-value map specifying required or optional response parameters that API Gateway can send back to the caller. A key defines a method response header and the value specifies whether the associated method response header is required or not. The expression of the key must match the pattern `method.response.header.{name}` , where `name` is a valid and unique header name. API Gateway passes certain integration response data to the method response headers specified here according to the mapping you prescribe in the API's IntegrationResponse. The integration response data that can be mapped include an integration response header expressed in `integration.response.header.{name}` , a static value enclosed within a pair of single quotes (e.g., `'application/json'` ), or a JSON expression from the back-end response payload in the form of `integration.response.body.{JSON-expression}` , where `JSON-expression` is a valid JSON expression without the `$` prefix.)
        """
        pulumi.set(__self__, "status_code", status_code)
    ...
    def response_models(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="responseParameters")
    def response_parameters(self) -> Optional[Mapping[str, Union[_builtins.bool, _builtins.str]]]:
        """
...
class RestApiEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str ip_address_type: The IP address types that can invoke an API (RestApi). Use `ipv4` to allow only IPv4 addresses to invoke an API, or use `dualstack` to allow both IPv4 and IPv6 addresses to invoke an API. For the `PRIVATE` endpoint type, only `dualstack` is supported.
        :param Sequence[_builtins.str] types: A list of endpoint types of an API (RestApi) or its custom domain name (DomainName). For an edge-optimized API and its custom domain name, the endpoint type is `"EDGE"` . For a regional API and its custom domain name, the endpoint type is `REGIONAL` . For a private API, the endpoint type is `PRIVATE` .
...
class RestApiS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: For versioning-enabled buckets, a specific version of the OpenAPI file.
        """
...
class StageMethodSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool caching_enabled: Specifies whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached.
        :param _builtins.bool data_trace_enabled: Specifies whether data trace logging is enabled for this method, which affects the log entries pushed to Amazon CloudWatch Logs. This can be useful to troubleshoot APIs, but can result in logging sensitive data. We recommend that you don't enable this option for production APIs.
        :param _builtins.str http_method: The HTTP method. To apply settings to multiple resources and methods, specify an asterisk (``*``) for the ``HttpMethod`` and ``/*`` for the ``ResourcePath``. This parameter is required when you specify a ``MethodSetting``.
        :param _builtins.str logging_level: Specifies the logging level for this method, which affects the log entries pushed to Amazon CloudWatch Logs. Valid values are `OFF` , `ERROR` , and `INFO` . Choose `ERROR` to write only error-level entries to CloudWatch Logs, or choose `INFO` to include all `ERROR` events as well as extra informational events.
        :param _builtins.bool metrics_enabled: Specifies whether Amazon CloudWatch metrics are enabled for this method.
        :param _builtins.str resource_path: The resource path for this method. Forward slashes (``/``) are encoded as ``~1`` and the initial slash must include a forward slash. For example, the path value ``/resource/subresource`` must be encoded as ``/~1resource~1subresource``. To specify the root path, use only a slash (``/``). To apply settings to multiple resources and methods, specify an asterisk (``*``) for the ``HttpMethod`` and ``/*`` for the ``ResourcePath``. This parameter is required when you specify a ``MethodSetting``.
        :param _builtins.int throttling_burst_limit: Specifies the throttling burst limit.
        :param _builtins.float throttling_rate_limit: Specifies the throttling rate limit.
        """
        if cache_data_encrypted is not None:
...
class UsagePlanQuotaSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int limit: The target maximum number of requests that can be made in a given time period.
        :param _builtins.int offset: The number of requests subtracted from the given limit in the initial time period.
        :param _builtins.str period: The time period in which the limit applies. Valid values are "DAY", "WEEK" or "MONTH".
        """
