...
class ResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] parent_id: The parent resource's identifier.
        :param pulumi.Input[_builtins.str] path_part: The last path segment for this resource.
