...
def get_usage_plan_key(id: Optional[builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUsagePlanKeyResult:
    """
    The ``AWS::ApiGateway::UsagePlanKey`` resource associates an API key with a usage plan. This association determines which users the usage plan is applied to.


    :param builtins.str id: The ID for the usage plan key. For example: `abc123` .
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_usage_plan_key_output(id: Optional[pulumi.Input[builtins.str]] = None,
