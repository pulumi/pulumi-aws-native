...
class VpcLink(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VpcLinkPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VpcLinkPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VpcLinkAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VpcLinkProperties']:
        """
