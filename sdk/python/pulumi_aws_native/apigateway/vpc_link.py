...
class VpcLinkArgs:
    def __init__(__self__, *,
                 target_arns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None):
        """
        The set of arguments for constructing a VpcLink resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_arns: The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner.
        :param pulumi.Input[builtins.str] description: The description of the VPC link.
        :param pulumi.Input[builtins.str] name: The name used to label and identify the VPC link.
    ...
    def target_arns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @target_arns.setter
    def target_arns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class VpcLink(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="targetArns")
    def target_arns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The ARN of the network load balancer of the VPC targeted by the VPC link. The network load balancer must be owned by the same AWS account of the API owner.
        """
        return pulumi.get(self, "target_arns")
