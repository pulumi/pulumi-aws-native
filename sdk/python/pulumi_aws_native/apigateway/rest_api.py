...
class RestApi(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RestApiPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RestApiPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RestApiAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RestApiProperties']:
        """
