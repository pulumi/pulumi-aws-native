...
class RestApiArgs:
    def __init__(__self__, *,
                 ...
                 body_s3_location: pulumi.Input[Optional['RestApiS3LocationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the RestApi. A name is required if the REST API is not based on an OpenAPI specification.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: Custom header parameters as part of the request. For example, to exclude DocumentationParts from an imported API, set `ignore=documentation` as a `parameters` value, as in the AWS CLI command of `aws apigateway import-rest-api --parameters ignore=documentation --body 'file:///path/to/imported-api-body.json'` .
    ...
    def api_key_source_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def api_key_source_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def body_s3_location(self) -> pulumi.Input[Optional['RestApiS3LocationArgs']]:
        """
    ...
    def body_s3_location(self, value: pulumi.Input[Optional['RestApiS3LocationArgs']]):
    ...
    def minimum_compression_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def minimum_compression_size(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class RestApi(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="apiKeySourceType")
    def api_key_source_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The source of the API key for metering requests according to a usage plan. Valid values are: `HEADER` to read the API key from the `X-API-Key` header of a request. `AUTHORIZER` to read the API key from the `UsageIdentifierKey` from a custom authorizer.
        """
        return pulumi.get(self, "api_key_source_type")
    ...
    @_builtins.property
    @pulumi.getter(name="binaryMediaTypes")
    def binary_media_types(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The list of binary media types supported by the RestApi. By default, the RestApi supports only UTF-8-encoded text payloads.
        """
        return pulumi.get(self, "binary_media_types")
    ...
    @_builtins.property
    @pulumi.getter(name="cloneFrom")
    def clone_from(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the RestApi that you want to clone from.
        """
        return pulumi.get(self, "clone_from")
    ...
    @_builtins.property
    @pulumi.getter(name="minimumCompressionSize")
    def minimum_compression_size(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        A nullable integer that is used to enable compression (with non-negative between 0 and 10485760 (10M) bytes, inclusive) or disable compression (with a null value) on an API. When compression is enabled, compression or decompression is not applied on the payload if the payload size is smaller than this value. Setting it to zero allows compression for any payload size.
        """
        return pulumi.get(self, "minimum_compression_size")
