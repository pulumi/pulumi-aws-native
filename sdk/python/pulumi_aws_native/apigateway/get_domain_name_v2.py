...
class GetDomainNameV2Result:
    ...
    def domain_name_id(self) -> Optional[_builtins.str]:
        """
        The domain name ID.
        """
...
def get_domain_name_v2(domain_name_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_name_arn: The amazon resource name (ARN) of the domain name resource.
    """
    __args__ = dict()
