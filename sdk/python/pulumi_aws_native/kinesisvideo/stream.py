...
class StreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] data_retention_in_hours: The number of hours till which Kinesis Video will retain the data in the stream
        :param pulumi.Input[builtins.str] device_name: The name of the device that is writing to the stream.
        :param pulumi.Input[builtins.str] kms_key_id: AWS KMS key ID that Kinesis Video Streams uses to encrypt stream data.
        :param pulumi.Input[builtins.str] media_type: The media type of the stream. Consumers of the stream can use this information when processing the stream.
        :param pulumi.Input[builtins.str] name: The name of the Kinesis Video stream.
...
@pulumi.type_token("aws-native:kinesisvideo:Stream")
