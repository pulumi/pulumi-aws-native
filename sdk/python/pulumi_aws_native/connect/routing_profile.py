...
class RoutingProfileArgs:
    def __init__(__self__, *,
                 default_outbound_queue_arn: pulumi.Input[_builtins.str],
    ...
    def default_outbound_queue_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def default_outbound_queue_arn(self, value: pulumi.Input[_builtins.str]):
...
class RoutingProfile(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="defaultOutboundQueueArn")
    def default_outbound_queue_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The identifier of the default outbound queue for this routing profile.
        """
        return pulumi.get(self, "default_outbound_queue_arn")
