...
class RoutingProfileArgs:
    def __init__(__self__, *,
                 default_outbound_queue_arn: pulumi.Input[builtins.str],
    ...
    def default_outbound_queue_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_outbound_queue_arn(self, value: pulumi.Input[builtins.str]):
...
class RoutingProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultOutboundQueueArn")
    def default_outbound_queue_arn(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the default outbound queue for this routing profile.
        """
        return pulumi.get(self, "default_outbound_queue_arn")
    ...
    def routing_profile_arn(self) -> pulumi.Output[builtins.str]:
        """
