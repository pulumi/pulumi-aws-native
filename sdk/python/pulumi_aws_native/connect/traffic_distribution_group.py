...
class TrafficDistributionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_arn: The identifier of the Amazon Connect instance that has been replicated.
        :param pulumi.Input[builtins.str] description: A description for the traffic distribution group.
        :param pulumi.Input[builtins.str] name: The name for the traffic distribution group.
...
class TrafficDistributionGroup(pulumi.CustomResource):
    ...
    def traffic_distribution_group_arn(self) -> pulumi.Output[builtins.str]:
        """
