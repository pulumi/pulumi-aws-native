...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] directory_id: Existing directoryId user wants to map to the new Connect instance.
        :param pulumi.Input[builtins.str] instance_alias: Alias of the new directory created as part of new instance creation.
