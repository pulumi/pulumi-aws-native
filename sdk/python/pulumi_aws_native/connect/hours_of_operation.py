...
class HoursOfOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_zone: The time zone of the hours of operation.
        :param pulumi.Input[builtins.str] description: The description of the hours of operation.
        ...
        :param pulumi.Input[builtins.str] name: The name of the hours of operation.
