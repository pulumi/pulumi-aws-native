...
class QuickConnectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the quick connect.
        :param pulumi.Input[builtins.str] name: The name of the quick connect.
...
class QuickConnect(pulumi.CustomResource):
    ...
    def quick_connect_arn(self) -> pulumi.Output[builtins.str]:
        """
