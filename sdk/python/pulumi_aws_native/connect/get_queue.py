...
class GetQueueResult:
    ...
    def hours_of_operation_arn(self) -> Optional[builtins.str]:
        """
    ...
    def max_contacts(self) -> Optional[builtins.int]:
        """
    ...
    def quick_connect_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_queue(queue_arn: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQueueResult:
    """
    Resource Type definition for AWS::Connect::Queue


    :param builtins.str queue_arn: The Amazon Resource Name (ARN) for the queue.
    """
    __args__ = dict()
...
def get_queue_output(queue_arn: Optional[pulumi.Input[builtins.str]] = None,
