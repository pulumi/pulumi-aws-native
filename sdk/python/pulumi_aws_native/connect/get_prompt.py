...
class GetPromptResult:
    ...
    def prompt_arn(self) -> Optional[builtins.str]:
        """
...
def get_prompt(prompt_arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPromptResult:
    """
    Resource Type definition for AWS::Connect::Prompt


    :param builtins.str prompt_arn: The Amazon Resource Name (ARN) for the prompt.
    """
    __args__ = dict()
...
def get_prompt_output(prompt_arn: Optional[pulumi.Input[builtins.str]] = None,
