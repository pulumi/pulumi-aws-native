...
class TaskTemplateArgs:
    def __init__(__self__, *,
                 ...
                 contact_flow_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 self_assign_contact_flow_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_arn: The identifier (arn) of the instance.
        :param pulumi.Input[builtins.str] client_token: A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
        :param pulumi.Input['ConstraintsPropertiesArgs'] constraints: The constraints for the task template
        :param pulumi.Input[builtins.str] contact_flow_arn: The identifier of the contact flow.
        ...
        :param pulumi.Input[builtins.str] description: The description of the task template.
        :param pulumi.Input[Sequence[pulumi.Input['TaskTemplateFieldArgs']]] fields: The list of task template's fields
        :param pulumi.Input[builtins.str] name: The name of the task template.
        :param pulumi.Input[builtins.str] self_assign_contact_flow_arn: The identifier of the contact flow.
    ...
    def contact_flow_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def contact_flow_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def self_assign_contact_flow_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the contact flow.
        """
    ...
    def self_assign_contact_flow_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TaskTemplate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contactFlowArn")
    def contact_flow_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier of the contact flow.
        """
        return pulumi.get(self, "contact_flow_arn")
    ...
    @property
    @pulumi.getter(name="selfAssignContactFlowArn")
    def self_assign_contact_flow_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier of the contact flow.
        """
        return pulumi.get(self, "self_assign_contact_flow_arn")
