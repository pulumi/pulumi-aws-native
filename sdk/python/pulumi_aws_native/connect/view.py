...
class ViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] actions: The actions of the view in an array.
        ...
        :param pulumi.Input[builtins.str] description: The description of the view.
...
@pulumi.type_token("aws-native:connect:View")
class View(pulumi.CustomResource):
    ...
    def view_content_sha256(self) -> pulumi.Output[builtins.str]:
        """
