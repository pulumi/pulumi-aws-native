...
class GetContactFlowModuleResult:
    ...
    def contact_flow_module_arn(self) -> Optional[builtins.str]:
        """
...
def get_contact_flow_module(contact_flow_module_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str contact_flow_module_arn: The identifier of the contact flow module (ARN).
    """
    __args__ = dict()
...
def get_contact_flow_module_output(contact_flow_module_arn: Optional[pulumi.Input[builtins.str]] = None,
