...
class ContactFlowModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: The content of the contact flow module in JSON format.
        :param pulumi.Input[builtins.str] instance_arn: The identifier of the Amazon Connect instance (ARN).
        :param pulumi.Input[builtins.str] description: The description of the contact flow module.
        :param pulumi.Input[builtins.str] name: The name of the contact flow module.
        :param pulumi.Input[builtins.str] state: The state of the contact flow module.
...
class ContactFlowModule(pulumi.CustomResource):
    ...
    def contact_flow_module_arn(self) -> pulumi.Output[builtins.str]:
        """
