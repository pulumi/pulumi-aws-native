...
class ContactFlowModuleArgs:
    def __init__(__self__, *,
                 ...
                 external_invocation_configuration: pulumi.Input[Optional['ExternalInvocationConfigurationPropertiesArgs']] = None,
    ...
    def external_invocation_configuration(self) -> pulumi.Input[Optional['ExternalInvocationConfigurationPropertiesArgs']]:
        """
    ...
    def external_invocation_configuration(self, value: pulumi.Input[Optional['ExternalInvocationConfigurationPropertiesArgs']]):
...
@pulumi.type_token("aws-native:connect:ContactFlowModule")
class ContactFlowModule(pulumi.CustomResource):
    ...
    def contact_flow_module_arn(self) -> pulumi.Output[_builtins.str]:
        """
