...
if not MYPY:
    class EvaluationFormNumericQuestionOptionArgsDict(TypedDict):
        ...
        """
        max_value: pulumi.Input[builtins.int]
        """
        The maximum answer value of the range option.
        """
        min_value: pulumi.Input[builtins.int]
        """
        The minimum answer value of the range option.
        """
        automatic_fail: NotRequired[pulumi.Input[builtins.bool]]
        """
        The flag to mark the option as automatic fail. If an automatic fail answer is provided, the overall evaluation gets a score of 0.
        """
        score: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EvaluationFormNumericQuestionOptionArgs:
    def __init__(__self__, *,
                 max_value: pulumi.Input[builtins.int],
                 min_value: pulumi.Input[builtins.int],
                 automatic_fail: Optional[pulumi.Input[builtins.bool]] = None,
                 score: Optional[pulumi.Input[builtins.int]] = None):
        """
        Information about the option range used for scoring in numeric questions.
        :param pulumi.Input[builtins.int] max_value: The maximum answer value of the range option.
        :param pulumi.Input[builtins.int] min_value: The minimum answer value of the range option.
        :param pulumi.Input[builtins.bool] automatic_fail: The flag to mark the option as automatic fail. If an automatic fail answer is provided, the overall evaluation gets a score of 0.
        :param pulumi.Input[builtins.int] score: The score assigned to answer values within the range option.
                *Minimum*: 0
                *Maximum*: 10
        """
    ...
    def max_value(self) -> pulumi.Input[builtins.int]:
        """
        The maximum answer value of the range option.
        """
    ...
    @max_value.setter
    def max_value(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_value", value)

    @property
    @pulumi.getter(name="minValue")
    def min_value(self) -> pulumi.Input[builtins.int]:
        """
        The minimum answer value of the range option.
        """
    ...
    @min_value.setter
    def min_value(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "min_value", value)

    @property
    @pulumi.getter(name="automaticFail")
    def automatic_fail(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The flag to mark the option as automatic fail. If an automatic fail answer is provided, the overall evaluation gets a score of 0.
        """
    ...
    def automatic_fail(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "automatic_fail", value)

    @property
    @pulumi.getter
    def score(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The score assigned to answer values within the range option.
         *Minimum*: 0
         *Maximum*: 10
    ...
    @score.setter
    def score(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EvaluationFormNumericQuestionPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Information about properties for a numeric question in an evaluation form.
        :param pulumi.Input[builtins.int] max_value: The maximum answer value.
        :param pulumi.Input[builtins.int] min_value: The minimum answer value.
...
if not MYPY:
    class EvaluationFormQuestionArgsDict(TypedDict):
        ...
        """
        not_applicable_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EvaluationFormQuestionArgs:
    def __init__(__self__, *,
                 ...
                 not_applicable_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input['EvaluationFormQuestionQuestionType'] question_type: The type of the question.
                *Allowed values*: ``NUMERIC`` | ``SINGLESELECT`` | ``TEXT``
        :param pulumi.Input[builtins.str] ref_id: The identifier of the question. An identifier must be unique within the evaluation form.
                *Length Constraints*: Minimum length of 1. Maximum length of 40.
        :param pulumi.Input[builtins.str] title: The title of the question.
                *Length Constraints*: Minimum length of 1. Maximum length of 350.
        :param pulumi.Input[builtins.str] instructions: The instructions of the section.
                *Length Constraints*: Minimum length of 0. Maximum length of 1024.
        :param pulumi.Input[builtins.bool] not_applicable_enabled: The flag to enable not applicable answers to the question.
        ...
        :param pulumi.Input[builtins.float] weight: The scoring weight of the section.
                *Minimum*: 0
                *Maximum*: 100
        """
    ...
    def not_applicable_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The flag to enable not applicable answers to the question.
        """
    ...
    def not_applicable_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EvaluationFormSectionArgs:
    def __init__(__self__, *,
        ...
        """
        Information about a section from an evaluation form. A section can contain sections and/or questions. Evaluation forms can only contain sections and subsections (two level nesting).
        :param pulumi.Input[builtins.str] ref_id: The identifier of the section. An identifier must be unique within the evaluation form.
                *Length Constraints*: Minimum length of 1. Maximum length of 40.
        :param pulumi.Input[builtins.str] title: The title of the section.
                *Length Constraints*: Minimum length of 1. Maximum length of 128.
        :param pulumi.Input[builtins.str] instructions: The instructions of the section.
...
if not MYPY:
    class EvaluationFormSingleSelectQuestionAutomationArgsDict(TypedDict):
         ...
         *Maximum*: 20
        """
        default_option_ref_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EvaluationFormSingleSelectQuestionAutomationArgs:
    def __init__(__self__, *,
                 ...
                 default_option_ref_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Information about the automation configuration in single select questions. Automation options are evaluated in order, and the first matched option is applied. If no automation option matches, and there is a default option, then the default option is applied.
        :param pulumi.Input[Sequence[pulumi.Input['EvaluationFormSingleSelectQuestionAutomationOptionArgs']]] options: The automation options of the single select question.
                *Minimum*: 1
                *Maximum*: 20
        :param pulumi.Input[builtins.str] default_option_ref_id: The identifier of the default answer option, when none of the automation options match the criteria.
                *Length Constraints*: Minimum length of 1. Maximum length of 40.
        """
        pulumi.set(__self__, "options", options)
    ...
    def default_option_ref_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the default answer option, when none of the automation options match the criteria.
         *Length Constraints*: Minimum length of 1. Maximum length of 40.
        """
    ...
    def default_option_ref_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EvaluationFormSingleSelectQuestionOptionArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the automation configuration in single select questions.
        :param pulumi.Input[builtins.str] ref_id: The identifier of the answer option. An identifier must be unique within the question.
                *Length Constraints*: Minimum length of 1. Maximum length of 40.
        :param pulumi.Input[builtins.str] text: The title of the answer option.
                *Length Constraints*: Minimum length of 1. Maximum length of 128.
        :param pulumi.Input[builtins.bool] automatic_fail: The flag to mark the option as automatic fail. If an automatic fail answer is provided, the overall evaluation gets a score of 0.
        :param pulumi.Input[builtins.int] score: The score assigned to the answer option.
                *Minimum*: 0
                *Maximum*: 10
        """
        pulumi.set(__self__, "ref_id", ref_id)
...
if not MYPY:
    class EvaluationFormSingleSelectQuestionRuleCategoryAutomationArgsDict(TypedDict):
         ...
         *Maximum*: 50
        """
        option_ref_id: pulumi.Input[builtins.str]
        """
        The identifier of the answer option. An identifier must be unique within the question.
         *Length Constraints*: Minimum length of 1. Maximum length of 40.
        """
...
class EvaluationFormSingleSelectQuestionRuleCategoryAutomationArgs:
    def __init__(__self__, *,
        ...
        Information about the automation option based on a rule category for a single select question.
         *Length Constraints*: Minimum length of 1. Maximum length of 50.
        :param pulumi.Input[builtins.str] category: The category name, as defined in Rules.
                *Minimum*: 1
                *Maximum*: 50
        :param pulumi.Input['EvaluationFormSingleSelectQuestionRuleCategoryAutomationCondition'] condition: The condition to apply for the automation option. If the condition is PRESENT, then the option is applied when the contact data includes the category. Similarly, if the condition is NOT_PRESENT, then the option is applied when the contact data does not include the category.
                *Allowed values*: ``PRESENT`` | ``NOT_PRESENT``
                *Maximum*: 50
        :param pulumi.Input[builtins.str] option_ref_id: The identifier of the answer option. An identifier must be unique within the question.
                *Length Constraints*: Minimum length of 1. Maximum length of 40.
        """
    ...
    def option_ref_id(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the answer option. An identifier must be unique within the question.
         *Length Constraints*: Minimum length of 1. Maximum length of 40.
        """
    ...
    def option_ref_id(self, value: pulumi.Input[builtins.str]):
...
class HoursOfOperationOverrideTimeSliceArgs:
    def __init__(__self__, *,
        ...
        """
        The start time or end time for an an hours of operation override.
        :param pulumi.Input[builtins.int] hours: The hours.
        :param pulumi.Input[builtins.int] minutes: The minutes.
        """
...
if not MYPY:
    class HoursOfOperationOverrideArgsDict(TypedDict):
        ...
        """
        effective_from: pulumi.Input[builtins.str]
        """
        ...
        hours_of_operation_override_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The identifier for the hours of operation override.
        """
        override_description: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class HoursOfOperationOverrideArgs:
    def __init__(__self__, *,
                 ...
                 override_name: pulumi.Input[builtins.str],
                 hours_of_operation_override_id: Optional[pulumi.Input[builtins.str]] = None,
                 override_description: Optional[pulumi.Input[builtins.str]] = None):
        """
        Overrides attached to the hours of operation.
    ...
    def effective_from(self) -> pulumi.Input[builtins.str]:
        """
        The date from which the hours of operation override would be effective.
        """
    ...
    def effective_from(self, value: pulumi.Input[builtins.str]):
    ...
    def effective_till(self, value: pulumi.Input[builtins.str]):
    ...
    def override_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "override_name")

    @override_name.setter
    def override_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "override_name", value)

    @property
    @pulumi.getter(name="hoursOfOperationOverrideId")
    def hours_of_operation_override_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier for the hours of operation override.
        """
    ...
    def hours_of_operation_override_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hours_of_operation_override_id", value)

    @property
    @pulumi.getter(name="overrideDescription")
    def override_description(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "override_description")

    @override_description.setter
    def override_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceAttributesArgsDict(TypedDict):
        inbound_calls: pulumi.Input[builtins.bool]
        outbound_calls: pulumi.Input[builtins.bool]
        auto_resolve_best_voices: NotRequired[pulumi.Input[builtins.bool]]
...
class InstanceAttributesArgs:
    def __init__(__self__, *,
                 inbound_calls: pulumi.Input[builtins.bool],
                 outbound_calls: pulumi.Input[builtins.bool],
                 auto_resolve_best_voices: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def inbound_calls(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "inbound_calls")

    @inbound_calls.setter
    def inbound_calls(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "inbound_calls", value)

    @property
    @pulumi.getter(name="outboundCalls")
    def outbound_calls(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "outbound_calls")

    @outbound_calls.setter
    def outbound_calls(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "outbound_calls", value)

    @property
    @pulumi.getter(name="autoResolveBestVoices")
    def auto_resolve_best_voices(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_resolve_best_voices")

    @auto_resolve_best_voices.setter
    def auto_resolve_best_voices(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_resolve_best_voices", value)

    @property
    @pulumi.getter(name="contactLens")
    def contact_lens(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "contact_lens")

    @contact_lens.setter
    def contact_lens(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "contact_lens", value)

    @property
    @pulumi.getter(name="contactflowLogs")
    def contactflow_logs(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "contactflow_logs")

    @contactflow_logs.setter
    def contactflow_logs(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "contactflow_logs", value)

    @property
    @pulumi.getter(name="earlyMedia")
    def early_media(self) -> Optional[pulumi.Input[builtins.bool]]:
    ...
    def use_custom_tts_voices(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "use_custom_tts_voices")

    @use_custom_tts_voices.setter
    def use_custom_tts_voices(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class InstanceStorageConfigEncryptionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The full ARN of the encryption key.
...
if not MYPY:
    class InstanceStorageConfigKinesisFirehoseConfigArgsDict(TypedDict):
        firehose_arn: pulumi.Input[builtins.str]
        """
...
class InstanceStorageConfigKinesisFirehoseConfigArgs:
    def __init__(__self__, *,
                 firehose_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] firehose_arn: The Amazon Resource Name (ARN) of the delivery stream.
        """
        pulumi.set(__self__, "firehose_arn", firehose_arn)

    @property
    @pulumi.getter(name="firehoseArn")
    def firehose_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the delivery stream.
        """
    ...
    @firehose_arn.setter
    def firehose_arn(self, value: pulumi.Input[builtins.str]):
...
class InstanceStorageConfigKinesisStreamConfigArgs:
    def __init__(__self__, *,
                 stream_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] stream_arn: The Amazon Resource Name (ARN) of the data stream.
        """
...
if not MYPY:
    class InstanceStorageConfigKinesisVideoStreamConfigArgsDict(TypedDict):
        ...
        """
        retention_period_hours: pulumi.Input[builtins.float]
        """
...
class InstanceStorageConfigKinesisVideoStreamConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] prefix: The prefix of the video stream.
        :param pulumi.Input[builtins.float] retention_period_hours: The number of hours data is retained in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream.
    ...
    def retention_period_hours(self) -> pulumi.Input[builtins.float]:
        """
        The number of hours data is retained in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream.
    ...
    def retention_period_hours(self, value: pulumi.Input[builtins.float]):
...
class InstanceStorageConfigS3ConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: The S3 bucket name.
        :param pulumi.Input[builtins.str] bucket_prefix: The S3 bucket prefix.
...
if not MYPY:
    class QueueOutboundCallerConfigArgsDict(TypedDict):
        ...
        """
        outbound_caller_id_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The caller ID name.
        """
        outbound_caller_id_number_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        outbound_flow_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class QueueOutboundCallerConfigArgs:
    def __init__(__self__, *,
                 outbound_caller_id_name: Optional[pulumi.Input[builtins.str]] = None,
                 outbound_caller_id_number_arn: Optional[pulumi.Input[builtins.str]] = None,
                 outbound_flow_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The outbound caller ID name, number, and outbound whisper flow.
        :param pulumi.Input[builtins.str] outbound_caller_id_name: The caller ID name.
        :param pulumi.Input[builtins.str] outbound_caller_id_number_arn: The Amazon Resource Name (ARN) of the outbound caller ID number.
               
               > Only use the phone number ARN format that doesn't contain `instance` in the path, for example, `arn:aws:connect:us-east-1:1234567890:phone-number/uuid` . This is the same ARN format that is returned when you create a phone number using CloudFormation , or when you call the [ListPhoneNumbersV2](https://docs.aws.amazon.com/connect/latest/APIReference/API_ListPhoneNumbersV2.html) API.
        :param pulumi.Input[builtins.str] outbound_flow_arn: The Amazon Resource Name (ARN) of the outbound flow.
        """
    ...
    def outbound_caller_id_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The caller ID name.
        """
    ...
    def outbound_caller_id_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "outbound_caller_id_name", value)

    @property
    @pulumi.getter(name="outboundCallerIdNumberArn")
    def outbound_caller_id_number_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the outbound caller ID number.
    ...
    def outbound_caller_id_number_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "outbound_caller_id_number_arn", value)

    @property
    @pulumi.getter(name="outboundFlowArn")
    def outbound_flow_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the outbound flow.
        """
    ...
    def outbound_flow_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class QueueOutboundEmailConfigArgsDict(TypedDict):
        ...
        """
        outbound_email_address_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class QueueOutboundEmailConfigArgs:
    def __init__(__self__, *,
                 outbound_email_address_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The outbound email address ID.
        :param pulumi.Input[builtins.str] outbound_email_address_id: The identifier of the email address.
        """
    ...
    def outbound_email_address_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the email address.
        """
    ...
    def outbound_email_address_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class QuickConnectPhoneNumberQuickConnectConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The phone configuration. This is required only if QuickConnectType is PHONE_NUMBER.
        :param pulumi.Input[builtins.str] phone_number: The phone number in E.164 format.
        """
...
if not MYPY:
    class QuickConnectQueueQuickConnectConfigArgsDict(TypedDict):
        ...
        The queue configuration. This is required only if QuickConnectType is QUEUE.
        """
        contact_flow_arn: pulumi.Input[builtins.str]
        """
...
class QuickConnectQueueQuickConnectConfigArgs:
    def __init__(__self__, *,
        ...
        """
        The queue configuration. This is required only if QuickConnectType is QUEUE.
        :param pulumi.Input[builtins.str] contact_flow_arn: The Amazon Resource Name (ARN) of the flow.
        :param pulumi.Input[builtins.str] queue_arn: The Amazon Resource Name (ARN) of the queue.
        """
    ...
    def contact_flow_arn(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the flow.
        """
    ...
    def contact_flow_arn(self, value: pulumi.Input[builtins.str]):
...
class QuickConnectUserQuickConnectConfigArgs:
    def __init__(__self__, *,
        ...
        The user configuration. This is required only if QuickConnectType is USER.
        :param pulumi.Input[builtins.str] contact_flow_arn: The Amazon Resource Name (ARN) of the flow.
        :param pulumi.Input[builtins.str] user_arn: The Amazon Resource Name (ARN) of the user.
        """
        pulumi.set(__self__, "contact_flow_arn", contact_flow_arn)
...
class RoutingProfileMediaConcurrencyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] concurrency: The number of contacts an agent can have on a channel simultaneously.
...
class RoutingProfileQueueConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Contains information about the queue and channel for which priority and delay can be set.
        :param pulumi.Input[builtins.int] delay: The delay, in seconds, a contact should be in the queue before they are routed to an available agent. For more information, see [Queues: priority and delay](https://docs.aws.amazon.com/connect/latest/adminguide/concepts-routing-profiles-priority.html) in the *Amazon Connect Administrator Guide* .
        :param pulumi.Input[builtins.int] priority: The order in which contacts are to be handled for the queue. For more information, see [Queues: priority and delay](https://docs.aws.amazon.com/connect/latest/adminguide/concepts-routing-profiles-priority.html) .
        :param pulumi.Input['RoutingProfileQueueReferenceArgs'] queue_reference: Contains information about a queue resource.
        """
...
if not MYPY:
    class RuleNotificationRecipientTypeArgsDict(TypedDict):
        ...
        """
        user_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The Amazon Resource Name (ARN) of the user account.
        """
        user_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class RuleNotificationRecipientTypeArgs:
    def __init__(__self__, *,
                 user_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The type of notification recipient.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_arns: The Amazon Resource Name (ARN) of the user account.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_tags: The tags used to organize, track, or control access for this resource. For example, { "tags": {"key1":"value1", "key2":"value2"} }. CON users with the specified tags will be notified.
        """
    ...
    def user_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The Amazon Resource Name (ARN) of the user account.
        """
    ...
    @user_arns.setter
    def user_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_arns", value)

    @property
    @pulumi.getter(name="userTags")
    def user_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The tags used to organize, track, or control access for this resource. For example, { "tags": {"key1":"value1", "key2":"value2"} }. CON users with the specified tags will be notified.
        """
    ...
    @user_tags.setter
    def user_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RuleSubmitAutoEvaluationActionArgsDict(TypedDict):
        evaluation_form_arn: pulumi.Input[builtins.str]
elif False:
...
class RuleSubmitAutoEvaluationActionArgs:
    ...
    def evaluation_form_arn(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "evaluation_form_arn")

    @evaluation_form_arn.setter
    def evaluation_form_arn(self, value: pulumi.Input[builtins.str]):
...
class RuleTaskActionArgs:
    def __init__(__self__, *,
        ...
        Information about the task action. This field is required if ``TriggerEventSource`` is one of the following values: ``OnZendeskTicketCreate`` | ``OnZendeskTicketStatusUpdate`` | ``OnSalesforceCaseCreate``
        :param pulumi.Input[builtins.str] contact_flow_arn: The Amazon Resource Name (ARN) of the flow.
        :param pulumi.Input[builtins.str] name: The name. Supports variable injection. For more information, see [JSONPath reference](https://docs.aws.amazon.com/connect/latest/adminguide/contact-lens-variable-injection.html) in the *Administrators Guide*.
        :param pulumi.Input[builtins.str] description: The description. Supports variable injection. For more information, see [JSONPath reference](https://docs.aws.amazon.com/connect/latest/adminguide/contact-lens-variable-injection.html) in the *Administrators Guide*.
...
if not MYPY:
    class RuleTriggerEventSourceArgsDict(TypedDict):
        ...
        The name of the event source.
        """
        integration_association_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuleTriggerEventSourceArgs:
    def __init__(__self__, *,
                 event_source_name: pulumi.Input['RuleTriggerEventSourceEventSourceName'],
                 integration_association_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The name of the event source.
        :param pulumi.Input['RuleTriggerEventSourceEventSourceName'] event_source_name: The name of the event source.
        :param pulumi.Input[builtins.str] integration_association_arn: The Amazon Resource Name (ARN) of the integration association. ``IntegrationAssociationArn`` is required if ``TriggerEventSource`` is one of the following values: ``OnZendeskTicketCreate`` | ``OnZendeskTicketStatusUpdate`` | ``OnSalesforceCaseCreate``
        """
    ...
    def integration_association_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the integration association. ``IntegrationAssociationArn`` is required if ``TriggerEventSource`` is one of the following values: ``OnZendeskTicketCreate`` | ``OnZendeskTicketStatusUpdate`` | ``OnSalesforceCaseCreate``
        """
    ...
    def integration_association_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SecurityProfileApplicationArgsDict(TypedDict):
        ...
        """
        application_permissions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class SecurityProfileApplicationArgs:
    def __init__(__self__, *,
        ...
        """
        A third-party application's metadata.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_permissions: The permissions that the agent is granted on the application
        :param pulumi.Input[builtins.str] namespace: Namespace of the application that you want to give access to.
        """
    ...
    def application_permissions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The permissions that the agent is granted on the application
        """
    ...
    def application_permissions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class TaskTemplateFieldIdentifierArgs:
    def __init__(__self__, *,
        ...
        """
        the identifier (name) for the task template field
        :param pulumi.Input[builtins.str] name: The name of the task template field
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class TaskTemplateFieldArgsDict(TypedDict):
        ...
        """
        single_select_options: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class TaskTemplateFieldArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input['TaskTemplateFieldType'],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 single_select_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        A task template field object.
        ...
        :param pulumi.Input[builtins.str] description: The description of the task template's field
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] single_select_options: list of field options to be used with single select
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
        if description is not None:
    ...
    def single_select_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        list of field options to be used with single select
        """
    ...
    def single_select_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class UserHierarchyStructureLevelFiveArgsDict(TypedDict):
        ...
        """
        hierarchy_level_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The Amazon Resource Name (ARN) of the hierarchy level.
        """
        hierarchy_level_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserHierarchyStructureLevelFiveArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 hierarchy_level_arn: Optional[pulumi.Input[builtins.str]] = None,
                 hierarchy_level_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Information about level five.
        :param pulumi.Input[builtins.str] name: The name of the hierarchy level.
        :param pulumi.Input[builtins.str] hierarchy_level_arn: The Amazon Resource Name (ARN) of the hierarchy level.
        :param pulumi.Input[builtins.str] hierarchy_level_id: The identifier of the hierarchy level.
        """
        pulumi.set(__self__, "name", name)
    ...
    def hierarchy_level_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the hierarchy level.
        """
    ...
    def hierarchy_level_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hierarchy_level_arn", value)

    @property
    @pulumi.getter(name="hierarchyLevelId")
    def hierarchy_level_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the hierarchy level.
        """
    ...
    def hierarchy_level_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class UserIdentityInfoArgsDict(TypedDict):
        ...
        """
        mobile: NotRequired[pulumi.Input[builtins.str]]
        """
        The user's mobile number.
        """
        secondary_email: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserIdentityInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Contains information about the identity of a user.
        :param pulumi.Input[builtins.str] email: The email address. If you are using SAML for identity management and include this parameter, an error is returned.
        :param pulumi.Input[builtins.str] first_name: The first name. This is required if you are using Amazon Connect or SAML for identity management. Inputs must be in Unicode Normalization Form C (NFC). Text containing characters in a non-NFC form (for example, decomposed characters or combining marks) are not accepted.
        :param pulumi.Input[builtins.str] last_name: The last name. This is required if you are using Amazon Connect or SAML for identity management. Inputs must be in Unicode Normalization Form C (NFC). Text containing characters in a non-NFC form (for example, decomposed characters or combining marks) are not accepted.
        :param pulumi.Input[builtins.str] mobile: The user's mobile number.
        :param pulumi.Input[builtins.str] secondary_email: The user's secondary email address. If you provide a secondary email, the user receives email notifications -- other than password reset notifications -- to this email address instead of to their primary email address.
...
if not MYPY:
    class UserPhoneConfigArgsDict(TypedDict):
        ...
        The phone type.
        """
        after_contact_work_time_limit: NotRequired[pulumi.Input[builtins.int]]
        """
        The After Call Work (ACW) timeout setting, in seconds. This parameter has a minimum value of 0 and a maximum value of 2,000,000 seconds (24 days). Enter 0 if you don't want to allocate a specific amount of ACW time. It essentially means an indefinite amount of time. When the conversation ends, ACW starts; the agent must choose Close contact to end ACW.

        > When returned by a `SearchUsers` call, `AfterContactWorkTimeLimit` is returned in milliseconds.
        """
        auto_accept: NotRequired[pulumi.Input[builtins.bool]]
        """
        The Auto accept setting.
        """
        desk_phone_number: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UserPhoneConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] after_contact_work_time_limit: The After Call Work (ACW) timeout setting, in seconds. This parameter has a minimum value of 0 and a maximum value of 2,000,000 seconds (24 days). Enter 0 if you don't want to allocate a specific amount of ACW time. It essentially means an indefinite amount of time. When the conversation ends, ACW starts; the agent must choose Close contact to end ACW.
               
               > When returned by a `SearchUsers` call, `AfterContactWorkTimeLimit` is returned in milliseconds.
        :param pulumi.Input[builtins.bool] auto_accept: The Auto accept setting.
        :param pulumi.Input[builtins.str] desk_phone_number: The phone number for the user's desk phone.
        :param pulumi.Input[builtins.bool] persistent_connection: The persistent connection setting for the user.
        """
    ...
    def after_contact_work_time_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The After Call Work (ACW) timeout setting, in seconds. This parameter has a minimum value of 0 and a maximum value of 2,000,000 seconds (24 days). Enter 0 if you don't want to allocate a specific amount of ACW time. It essentially means an indefinite amount of time. When the conversation ends, ACW starts; the agent must choose Close contact to end ACW.
    ...
    def after_contact_work_time_limit(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def desk_phone_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The phone number for the user's desk phone.
        """
...
if not MYPY:
    class UserProficiencyArgsDict(TypedDict):
        ...
        """
        level: pulumi.Input[builtins.float]
        """
...
class UserProficiencyArgs:
    def __init__(__self__, *,
        ...
        """
        Proficiency of a user.
        :param pulumi.Input[builtins.str] attribute_name: The name of user’s proficiency. You must use a predefined attribute name that is present in the Amazon Connect instance.
        :param pulumi.Input[builtins.str] attribute_value: The value of user’s proficiency. You must use a predefined attribute value that is present in the Amazon Connect instance.
        :param pulumi.Input[builtins.float] level: The level of the proficiency. The valid values are 1, 2, 3, 4 and 5.
        """
    ...
    @property
    @pulumi.getter
    def level(self) -> pulumi.Input[builtins.float]:
        """
        The level of the proficiency. The valid values are 1, 2, 3, 4 and 5.
        """
    ...
    @level.setter
    def level(self, value: pulumi.Input[builtins.float]):
...
if not MYPY:
    class ValuesPropertiesArgsDict(TypedDict):
        ...
        """
        string_list: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ValuesPropertiesArgs:
    def __init__(__self__, *,
                 string_list: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The values of a predefined attribute.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] string_list: Predefined attribute values of type string list.
        """
    ...
    def string_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Predefined attribute values of type string list.
        """
    ...
    @string_list.setter
    def string_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
