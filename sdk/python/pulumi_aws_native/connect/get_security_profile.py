...
class GetSecurityProfileResult:
    def __init__(__self__, allowed_access_control_hierarchy_group_id=None, allowed_access_control_tags=None, description=None, hierarchy_restricted_resources=None, last_modified_region=None, last_modified_time=None, permissions=None, security_profile_arn=None, tag_restricted_resources=None, tags=None):
