...
class GetSecurityProfileResult:
    ...
    def allowed_access_control_hierarchy_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def hierarchy_restricted_resources(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tag_restricted_resources(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_security_profile(security_profile_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str security_profile_arn: The Amazon Resource Name (ARN) for the security profile.
    """
    __args__ = dict()
...
def get_security_profile_output(security_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
