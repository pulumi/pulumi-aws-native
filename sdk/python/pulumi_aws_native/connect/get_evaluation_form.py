...
class GetEvaluationFormResult:
    ...
    def evaluation_form_arn(self) -> Optional[builtins.str]:
        """
...
def get_evaluation_form(evaluation_form_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str evaluation_form_arn: The Amazon Resource Name (ARN) of the evaluation form.
    """
    __args__ = dict()
...
def get_evaluation_form_output(evaluation_form_arn: Optional[pulumi.Input[builtins.str]] = None,
