...
class GetTaskTemplateResult:
    ...
    def self_assign_contact_flow_arn(self) -> Optional[_builtins.str]:
        """
        The identifier of the contact flow.
        """
...
def get_task_template(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The identifier (arn) of the task template.
    """
    __args__ = dict()
    __args__['arn'] = arn
