...
class GetTaskTemplateResult:
    ...
    def contact_flow_arn(self) -> Optional[builtins.str]:
        """
    ...
    def self_assign_contact_flow_arn(self) -> Optional[builtins.str]:
        """
        The identifier of the contact flow.
        """
...
def get_task_template(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The identifier (arn) of the task template.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_task_template_output(arn: Optional[pulumi.Input[builtins.str]] = None,
