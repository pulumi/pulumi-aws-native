...
class PromptArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the prompt.
        :param pulumi.Input[builtins.str] name: The name of the prompt.
        :param pulumi.Input[builtins.str] s3_uri: S3 URI of the customer's audio file for creating prompts resource..
...
class Prompt(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="s3Uri")
    def s3_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        S3 URI of the customer's audio file for creating prompts resource..
        """
        return pulumi.get(self, "s3_uri")
