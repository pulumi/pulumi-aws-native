...
class GetViewVersionResult:
    ...
    def view_version_arn(self) -> Optional[_builtins.str]:
        """
...
def get_view_version(view_version_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str view_version_arn: The Amazon Resource Name (ARN) of the created view version.
    """
    __args__ = dict()
