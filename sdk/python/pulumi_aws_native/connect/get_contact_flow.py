...
class GetContactFlowResult:
    ...
    def contact_flow_arn(self) -> Optional[_builtins.str]:
        """
...
def get_contact_flow(contact_flow_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str contact_flow_arn: The identifier of the contact flow (ARN).
    """
    __args__ = dict()
