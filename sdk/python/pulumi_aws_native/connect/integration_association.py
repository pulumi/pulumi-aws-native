...
class IntegrationAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: The Amazon Resource Name (ARN) of the instance.
               ...
               *Maximum* : `100`
        :param pulumi.Input[_builtins.str] integration_arn: ARN of the integration being associated with the instance.
...
class IntegrationAssociation(pulumi.CustomResource):
    ...
    def integration_association_id(self) -> pulumi.Output[_builtins.str]:
        """
