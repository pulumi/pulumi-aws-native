...
class GetViewResult:
    ...
    def view_content_sha256(self) -> Optional[builtins.str]:
        """
...
def get_view(view_arn: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetViewResult:
    """
    Resource Type definition for AWS::Connect::View


    :param builtins.str view_arn: The Amazon Resource Name (ARN) of the view.
    """
    __args__ = dict()
...
def get_view_output(view_arn: Optional[pulumi.Input[builtins.str]] = None,
