...
class ContactFlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: The content of the contact flow in JSON format.
        :param pulumi.Input[builtins.str] instance_arn: The identifier of the Amazon Connect instance (ARN).
        :param pulumi.Input['ContactFlowType'] type: The type of the contact flow.
        :param pulumi.Input[builtins.str] description: The description of the contact flow.
        :param pulumi.Input[builtins.str] name: The name of the contact flow.
...
@pulumi.type_token("aws-native:connect:ContactFlow")
class ContactFlow(pulumi.CustomResource):
    ...
    def contact_flow_arn(self) -> pulumi.Output[builtins.str]:
        """
