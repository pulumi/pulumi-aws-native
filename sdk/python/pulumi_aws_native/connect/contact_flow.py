...
class ContactFlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The description of the contact flow.
    ...
    @_builtins.property
    @pulumi.getter
    def state(self) -> pulumi.Input[Optional['ContactFlowState']]:
        """
    ...
    @state.setter
    def state(self, value: pulumi.Input[Optional['ContactFlowState']]):
...
class ContactFlow(pulumi.CustomResource):
    ...
    def contact_flow_arn(self) -> pulumi.Output[_builtins.str]:
        """
