...
class GetQuickConnectResult:
    ...
    def quick_connect_arn(self) -> Optional[builtins.str]:
        """
...
def get_quick_connect(quick_connect_arn: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQuickConnectResult:
    """
    Resource Type definition for AWS::Connect::QuickConnect


    :param builtins.str quick_connect_arn: The Amazon Resource Name (ARN) for the quick connect.
    """
    __args__ = dict()
...
def get_quick_connect_output(quick_connect_arn: Optional[pulumi.Input[builtins.str]] = None,
