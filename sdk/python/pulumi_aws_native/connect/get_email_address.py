...
class GetEmailAddressResult:
    ...
    def email_address_arn(self) -> Optional[_builtins.str]:
        """
...
def get_email_address(email_address_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str email_address_arn: The identifier of the email address.
    """
    __args__ = dict()
