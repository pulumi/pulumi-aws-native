...
class UserHierarchyGroupArgs:
    def __init__(__self__, *,
                 ...
                 parent_group_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The name of the user hierarchy group.
        :param pulumi.Input[builtins.str] parent_group_arn: The Amazon Resource Name (ARN) for the parent user hierarchy group.
    ...
    def parent_group_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_group_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserHierarchyGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="parentGroupArn")
    def parent_group_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) for the parent user hierarchy group.
        """
        return pulumi.get(self, "parent_group_arn")
    ...
    def user_hierarchy_group_arn(self) -> pulumi.Output[builtins.str]:
        """
