...
class ApprovedOriginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The Amazon Resource Name (ARN) of the instance.
               
               *Minimum* : `1`
               
               *Maximum* : `100`
        :param pulumi.Input[builtins.str] origin: Domain name to be added to the allow-list of the instance.
...
class ApprovedOrigin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["instanceId", "origin"])
