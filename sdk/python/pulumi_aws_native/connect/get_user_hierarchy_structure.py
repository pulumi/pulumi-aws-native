...
class GetUserHierarchyStructureResult:
    ...
    def user_hierarchy_structure_arn(self) -> Optional[builtins.str]:
        """
...
def get_user_hierarchy_structure(user_hierarchy_structure_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str user_hierarchy_structure_arn: The identifier of the User Hierarchy Structure.
    """
    __args__ = dict()
...
def get_user_hierarchy_structure_output(user_hierarchy_structure_arn: Optional[pulumi.Input[builtins.str]] = None,
