...
class GetPhoneNumberResult:
    ...
    def phone_number_arn(self) -> Optional[builtins.str]:
        """
...
def get_phone_number(phone_number_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str phone_number_arn: The phone number ARN
    """
    __args__ = dict()
...
def get_phone_number_output(phone_number_arn: Optional[pulumi.Input[builtins.str]] = None,
