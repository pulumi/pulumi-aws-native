...
class GetTrafficDistributionGroupResult:
    ...
    def traffic_distribution_group_arn(self) -> Optional[_builtins.str]:
        """
...
def get_traffic_distribution_group(traffic_distribution_group_arn: Optional[_builtins.str] = None,
