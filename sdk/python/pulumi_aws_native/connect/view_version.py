...
class ViewVersionArgs:
    def __init__(__self__, *,
                 ...
                 view_content_sha256: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ViewVersion resource.
        :param pulumi.Input[builtins.str] view_arn: The Amazon Resource Name (ARN) of the view for which a version is being created.
        :param pulumi.Input[builtins.str] version_description: The description for the view version.
        :param pulumi.Input[builtins.str] view_content_sha256: The view content hash to be checked.
        """
    ...
    def view_content_sha256(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def view_content_sha256(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ViewVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="viewContentSha256")
    def view_content_sha256(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The view content hash to be checked.
        """
        return pulumi.get(self, "view_content_sha256")
    ...
    def view_version_arn(self) -> pulumi.Output[builtins.str]:
        """
