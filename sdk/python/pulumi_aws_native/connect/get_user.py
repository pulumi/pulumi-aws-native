...
class GetUserResult:
    ...
    def directory_user_id(self) -> Optional[builtins.str]:
        """
    ...
    def hierarchy_group_arn(self) -> Optional[builtins.str]:
        """
    ...
    def routing_profile_arn(self) -> Optional[builtins.str]:
        """
    ...
    def security_profile_arns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def user_arn(self) -> Optional[builtins.str]:
        """
...
def get_user(user_arn: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUserResult:
    """
    Resource Type definition for AWS::Connect::User


    :param builtins.str user_arn: The Amazon Resource Name (ARN) for the user.
    """
    __args__ = dict()
...
def get_user_output(user_arn: Optional[pulumi.Input[builtins.str]] = None,
