...
def get_instance(arn: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstanceResult:
    """
    Resource Type definition for AWS::Connect::Instance


    :param builtins.str arn: An instanceArn is automatically generated on creation based on instanceId.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_instance_output(arn: Optional[pulumi.Input[builtins.str]] = None,
