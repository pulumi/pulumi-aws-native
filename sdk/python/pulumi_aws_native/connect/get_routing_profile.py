...
class GetRoutingProfileResult:
    ...
    def default_outbound_queue_arn(self) -> Optional[builtins.str]:
        """
...
def get_routing_profile(routing_profile_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str routing_profile_arn: The Amazon Resource Name (ARN) of the routing profile.
    """
    __args__ = dict()
...
def get_routing_profile_output(routing_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
