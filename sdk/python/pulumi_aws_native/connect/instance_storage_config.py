...
class InstanceStorageConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(kinesis_firehose_config, InstanceStorageConfigKinesisFirehoseConfigArgs):
            ...
            if not isinstance(kinesis_stream_config, InstanceStorageConfigKinesisStreamConfigArgs):
            ...
            if not isinstance(kinesis_video_stream_config, InstanceStorageConfigKinesisVideoStreamConfigArgs):
            ...
            if not isinstance(s3_config, InstanceStorageConfigS3ConfigArgs):
