...
class ContactFlowVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] contact_flow_id: The ARN of the contact flow this version is tied to.
...
class ContactFlowVersion(pulumi.CustomResource):
    ...
    def contact_flow_version_arn(self) -> pulumi.Output[str]:
        """
    ...
    def flow_content_sha256(self) -> pulumi.Output[str]:
        """
