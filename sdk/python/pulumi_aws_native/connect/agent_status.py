...
class AgentStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] display_order: The display order of the status.
...
class AgentStatus(pulumi.CustomResource):
    ...
    def agent_status_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="displayOrder")
    def display_order(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The display order of the status.
        """
        return pulumi.get(self, "display_order")
    ...
    @_builtins.property
    @pulumi.getter(name="resetOrderNumber")
    def reset_order_number(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        A number indicating the reset order of the agent status.
        """
        return pulumi.get(self, "reset_order_number")
