...
class AgentStatusArgs:
    def __init__(__self__, *,
                 ...
                 display_order: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 reset_order_number: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the status.
        :param pulumi.Input[builtins.int] display_order: The display order of the status.
        :param pulumi.Input[builtins.str] name: The name of the status.
        :param pulumi.Input[builtins.bool] reset_order_number: A number indicating the reset order of the agent status.
    ...
    def display_order(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def display_order(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def reset_order_number(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_order_number(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("aws-native:connect:AgentStatus")
class AgentStatus(pulumi.CustomResource):
    ...
    def agent_status_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="displayOrder")
    def display_order(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The display order of the status.
        """
        return pulumi.get(self, "display_order")
    ...
    @property
    @pulumi.getter(name="resetOrderNumber")
    def reset_order_number(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A number indicating the reset order of the agent status.
        """
        return pulumi.get(self, "reset_order_number")
