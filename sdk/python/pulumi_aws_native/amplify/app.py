...
class AppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_token: The personal access token for a GitHub repository for an Amplify app. The personal access token is used to authorize access to a GitHub repository using the Amplify GitHub App. The token is not stored.
        ...
        :param pulumi.Input[builtins.str] build_spec: The build specification (build spec) for an Amplify app.
        ...
        :param pulumi.Input[builtins.str] description: The description of the Amplify app.
        :param pulumi.Input[builtins.bool] enable_branch_auto_deletion: Automatically disconnect a branch in Amplify Hosting when you delete a branch from your Git repository.
        ...
        :param pulumi.Input[builtins.str] repository: The Git repository for the Amplify app.
    ...
    def iam_service_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def iam_service_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class App(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="buildSpec")
    def build_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The build specification (build spec) for an Amplify app.
        """
        return pulumi.get(self, "build_spec")
    ...
    @property
    @pulumi.getter(name="customHeaders")
    def custom_headers(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The custom HTTP headers for an Amplify app.
        """
        return pulumi.get(self, "custom_headers")
    ...
    @property
    @pulumi.getter(name="iamServiceRole")
    def iam_service_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS Identity and Access Management ( IAM ) service role for the Amazon Resource Name (ARN) of the Amplify app.
        """
        return pulumi.get(self, "iam_service_role")
