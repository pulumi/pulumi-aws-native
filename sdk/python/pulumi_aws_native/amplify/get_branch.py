...
class GetBranchResult:
    ...
    def enable_skew_protection(self) -> Optional[builtins.bool]:
        """
...
def get_branch(arn: Optional[builtins.str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBranchResult:
    """
    The AWS::Amplify::Branch resource creates a new branch within an app.


    :param builtins.str arn: ARN for a branch, part of an Amplify App.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_branch_output(arn: Optional[pulumi.Input[builtins.str]] = None,
