...
class BranchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] branch_name: The name for the branch.
        :param pulumi.Input[builtins.str] build_spec: The build specification (build spec) for the branch.
        :param pulumi.Input[builtins.str] compute_role_arn: The Amazon Resource Name (ARN) of the IAM role to assign to a branch of an SSR app. The SSR Compute role allows the Amplify Hosting compute service to securely access specific AWS resources based on the role's permissions. For more information about the SSR Compute role, see [Adding an SSR Compute role](https://docs.aws.amazon.com/amplify/latest/userguide/amplify-SSR-compute-role.html) in the *Amplify User Guide* .
        :param pulumi.Input[builtins.str] description: The description for the branch that is part of an Amplify app.
