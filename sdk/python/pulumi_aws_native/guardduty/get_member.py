...
def get_member(detector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detector_id: The ID of the detector associated with the GuardDuty service to add the member to.
    :param builtins.str member_id: The AWS account ID of the account to designate as a member.
    """
    __args__ = dict()
...
def get_member_output(detector_id: Optional[pulumi.Input[builtins.str]] = None,
