...
class DetectorCfnFeatureAdditionalConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the additional configuration.
        :param builtins.str status: Status of the additional configuration.
        """
        if name is not None:
...
class DetectorCfnFeatureConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the feature. For a list of allowed values, see [DetectorFeatureConfiguration](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_DetectorFeatureConfiguration.html#guardduty-Type-DetectorFeatureConfiguration-name) in the *GuardDuty API Reference* .
...
class DetectorCfnKubernetesAuditLogsConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable: Describes whether Kubernetes audit logs are enabled as a data source for the detector.
        """
...
class DetectorCfnScanEc2InstanceWithFindingsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ebs_volumes: Optional[builtins.bool] = None):
        """
        :param builtins.bool ebs_volumes: Describes the configuration for scanning EBS volumes as data source.
        """
    ...
    def ebs_volumes(self) -> Optional[builtins.bool]:
        """
...
class DetectorCfns3LogsConfiguration(dict):
    def __init__(__self__, *,
                 enable: builtins.bool):
        """
        :param builtins.bool enable: The status of S3 data event logs as a data source.
        """
        pulumi.set(__self__, "enable", enable)
...
class FilterCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 greater_than: Optional[builtins.int] = None,
                 greater_than_or_equal: Optional[builtins.int] = None,
                 gt: Optional[builtins.int] = None,
                 gte: Optional[builtins.int] = None,
                 less_than: Optional[builtins.int] = None,
                 less_than_or_equal: Optional[builtins.int] = None,
                 lt: Optional[builtins.int] = None,
                 lte: Optional[builtins.int] = None,
    ...
    def greater_than(self) -> Optional[builtins.int]:
        return pulumi.get(self, "greater_than")

    @property
    @pulumi.getter(name="greaterThanOrEqual")
    def greater_than_or_equal(self) -> Optional[builtins.int]:
        return pulumi.get(self, "greater_than_or_equal")

    @property
    @pulumi.getter
    def gt(self) -> Optional[builtins.int]:
        return pulumi.get(self, "gt")

    @property
    @pulumi.getter
    def gte(self) -> Optional[builtins.int]:
        return pulumi.get(self, "gte")

    @property
    @pulumi.getter(name="lessThan")
    def less_than(self) -> Optional[builtins.int]:
        return pulumi.get(self, "less_than")

    @property
    @pulumi.getter(name="lessThanOrEqual")
    def less_than_or_equal(self) -> Optional[builtins.int]:
        return pulumi.get(self, "less_than_or_equal")

    @property
    @pulumi.getter
    def lt(self) -> Optional[builtins.int]:
        return pulumi.get(self, "lt")

    @property
    @pulumi.getter
    def lte(self) -> Optional[builtins.int]:
...
class MalwareProtectionPlanCfnProtectedResourceS3BucketProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 object_prefixes: Optional[Sequence[builtins.str]] = None):
        """
        Information about the protected S3 bucket resource.
        :param builtins.str bucket_name: Name of the S3 bucket.
        :param Sequence[builtins.str] object_prefixes: Information about the specified object prefixes. The S3 object will be scanned only if it belongs to any of the specified object prefixes.
        """
    ...
    def object_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MalwareProtectionPlanCfnStatusReasons(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str code: The status code of the Malware Protection plan.
        :param builtins.str message: Issue message that specifies the reason.
        """
        if code is not None:
...
class MalwareProtectionPlanCfnTagging(dict):
    def __init__(__self__, *,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str status: Indicates whether or not you chose GuardDuty to add a predefined tag to the scanned S3 object.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class PublishingDestinationCfnDestinationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str destination_arn: The ARN of the resource to publish to.
        :param builtins.str kms_key_arn: The ARN of the KMS key to use for encryption.
        """
