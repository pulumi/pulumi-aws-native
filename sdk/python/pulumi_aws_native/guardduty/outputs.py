...
class DetectorCfnFeatureAdditionalConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Name of the additional configuration.
        :param _builtins.str status: Status of the additional configuration.
        """
        if name is not None:
...
class DetectorCfnFeatureConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Name of the feature. For a list of allowed values, see [DetectorFeatureConfiguration](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_DetectorFeatureConfiguration.html#guardduty-Type-DetectorFeatureConfiguration-name) in the *GuardDuty API Reference* .
...
class DetectorCfnKubernetesAuditLogsConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enable: Describes whether Kubernetes audit logs are enabled as a data source for the detector.
        """
...
class DetectorCfnScanEc2InstanceWithFindingsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool ebs_volumes: Describes the configuration for scanning EBS volumes as data source.
        """
    ...
    def ebs_volumes(self) -> Optional[_builtins.bool]:
        """
...
class DetectorCfns3LogsConfiguration(dict):
    def __init__(__self__, *,
                 enable: _builtins.bool):
        """
        :param _builtins.bool enable: The status of S3 data event logs as a data source.
        """
        pulumi.set(__self__, "enable", enable)
...
class FilterCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 greater_than_or_equal: Optional[_builtins.int] = None,
    ...
    def greater_than_or_equal(self) -> Optional[_builtins.int]:
    ...
    def less_than_or_equal(self) -> Optional[_builtins.int]:
...
class MalwareProtectionPlanCfnStatusReasons(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str code: The status code of the Malware Protection plan.
        :param _builtins.str message: Issue message that specifies the reason.
        """
        if code is not None:
...
class MalwareProtectionPlanCfnTagging(dict):
    def __init__(__self__, *,
                 status: Optional[_builtins.str] = None):
        """
        :param _builtins.str status: Indicates whether or not you chose GuardDuty to add a predefined tag to the scanned S3 object.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class PublishingDestinationCfnDestinationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str destination_arn: The ARN of the resource to publish to.
        :param _builtins.str kms_key_arn: The ARN of the KMS key to use for encryption.
        """
