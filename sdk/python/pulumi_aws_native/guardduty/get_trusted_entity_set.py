...
def get_trusted_entity_set(detector_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str detector_id: The unique regional detector ID of the GuardDuty account for which you want to create a trusted entity set.
