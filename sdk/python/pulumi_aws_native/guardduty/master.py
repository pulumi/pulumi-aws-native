...
class MasterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] detector_id: Unique ID of the detector of the GuardDuty member account.
        :param pulumi.Input[builtins.str] master_id: ID of the account used as the master account.
        :param pulumi.Input[builtins.str] invitation_id: Value used to validate the master account to the member account.
        """
...
class Master(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["detectorId", "invitationId", "masterId"])
