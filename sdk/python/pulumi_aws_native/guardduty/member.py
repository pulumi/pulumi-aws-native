...
class MemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] member_id: The AWS account ID of the account to designate as a member.
        :param pulumi.Input[_builtins.str] message: The invitation message that you want to send to the accounts that you're inviting to GuardDuty as members.
        :param pulumi.Input[_builtins.str] status: You can use the `Status` property to update the status of the relationship between the member account and its administrator account. Valid values are `Created` and `Invited` when using an `AWS::GuardDuty::Member` resource. If the value for this property is not provided or set to `Created` , a member account is created but not invited. If the value of this property is set to `Invited` , a member account is created and invited.
        """
