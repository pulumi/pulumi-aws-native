...
def get_threat_entity_set(detector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detector_id: The unique regional detector ID of the GuardDuty account for which you want to create a threat entity set.
           
           To find the `detectorId` in the current Region, see the Settings page in the GuardDuty console, or run the [ListDetectors](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_ListDetectors.html) API.
    :param builtins.str id: Returns the unique ID associated with the newly created threat entity set.
    """
    __args__ = dict()
...
def get_threat_entity_set_output(detector_id: Optional[pulumi.Input[builtins.str]] = None,
