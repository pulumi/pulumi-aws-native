...
class GetDetectorResult:
    ...
    def finding_publishing_frequency(self) -> Optional[builtins.str]:
        """
...
def get_detector(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique ID of the detector.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_detector_output(id: Optional[pulumi.Input[builtins.str]] = None,
