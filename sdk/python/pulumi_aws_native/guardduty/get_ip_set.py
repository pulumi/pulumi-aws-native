...
def get_ip_set(detector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detector_id: The unique ID of the detector of the GuardDuty account for which you want to create an IPSet.
...
def get_ip_set_output(detector_id: Optional[pulumi.Input[builtins.str]] = None,
