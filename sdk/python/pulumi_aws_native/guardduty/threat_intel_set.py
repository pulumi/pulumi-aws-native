...
class ThreatIntelSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] format: The format of the file that contains the ThreatIntelSet.
        :param pulumi.Input[_builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[_builtins.bool] activate: A Boolean value that indicates whether GuardDuty is to start using the uploaded ThreatIntelSet.
        :param pulumi.Input[_builtins.str] detector_id: The unique ID of the detector of the GuardDuty account for which you want to create a `ThreatIntelSet` .
        ...
        :param pulumi.Input[_builtins.str] name: A user-friendly ThreatIntelSet name displayed in all findings that are generated by activity that involves IP addresses included in this ThreatIntelSet.
...
class ThreatIntelSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[_builtins.str] name: A user-friendly ThreatIntelSet name displayed in all findings that are generated by activity that involves IP addresses included in this ThreatIntelSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict']]]] tags: The tags to be added to a new threat list resource. Each tag consists of a key and an optional value, both of which you define.
