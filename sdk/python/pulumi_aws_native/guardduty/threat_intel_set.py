...
class ThreatIntelSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] format: The format of the file that contains the ThreatIntelSet.
        :param pulumi.Input[builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[builtins.bool] activate: A Boolean value that indicates whether GuardDuty is to start using the uploaded ThreatIntelSet.
        :param pulumi.Input[builtins.str] detector_id: The unique ID of the detector of the GuardDuty account for which you want to create a `ThreatIntelSet` .
               
               To find the `detectorId` in the current Region, see the
               Settings page in the GuardDuty console, or run the [ListDetectors](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_ListDetectors.html) API.
        :param pulumi.Input[builtins.str] expected_bucket_owner: Contains information on the owner of the bucket.
        :param pulumi.Input[builtins.str] name: A user-friendly ThreatIntelSet name displayed in all findings that are generated by activity that involves IP addresses included in this ThreatIntelSet.
