...
class ThreatIntelSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The user-friendly name to identify the ThreatIntelSet.
...
class ThreatIntelSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] name: The user-friendly name to identify the ThreatIntelSet.
               ...
               The name of your list must be unique within an AWS account and Region. Valid characters are alphanumeric, whitespace, dash (-), and underscores (_).
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: The tags to be added to a new threat entity set resource. Each tag consists of a key and an optional value, both of which you define.
