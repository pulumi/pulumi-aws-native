...
class ThreatIntelSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ThreatIntelSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ThreatIntelSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ThreatIntelSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ThreatIntelSetProperties']:
        """
