...
class ThreatIntelSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] format: The format of the file that contains the `ThreatIntelSet` . For information about supported formats, see [List formats](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_upload-lists.html#prepare_list) in the *Amazon GuardDuty User Guide* .
        :param pulumi.Input[builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[builtins.bool] activate: A boolean value that determines if GuardDuty can start using this list for custom threat detection. For GuardDuty to be able to generate findings based on an activity associated with these entries, this list must be active.
        ...
        :param pulumi.Input[builtins.str] name: The user-friendly name to identify the ThreatIntelSet.
