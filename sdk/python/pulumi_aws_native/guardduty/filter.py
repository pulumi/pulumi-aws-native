...
class FilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] detector_id: The detector ID associated with the GuardDuty account for which you want to create a filter.
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action that is to be applied to the findings that match the filter.
        :param pulumi.Input[builtins.str] description: The description of the filter. Valid characters include alphanumeric characters, and special characters such as hyphen, period, colon, underscore, parentheses ( `{ }` , `[ ]` , and `( )` ), forward slash, horizontal tab, vertical tab, newline, form feed, return, and whitespace.
        :param pulumi.Input[builtins.str] name: The name of the filter. Valid characters include period (.), underscore (_), dash (-), and alphanumeric characters. A whitespace is considered to be an invalid character.
        :param pulumi.Input[builtins.int] rank: Specifies the position of the filter in the list of current filters. Also specifies the order in which this filter is applied to the findings. The minimum value for this property is 1 and the maximum is 100.
...
class Filter(pulumi.CustomResource):
    ...
    pulumi_type = "aws-native:guardduty:Filter"
