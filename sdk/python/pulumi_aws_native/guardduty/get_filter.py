...
def get_filter(detector_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the filter. Valid characters include period (.), underscore (_), dash (-), and alphanumeric characters. A whitespace is considered to be an invalid character.
    """
    __args__ = dict()
