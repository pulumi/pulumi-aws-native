...
def get_filter(detector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detector_id: The detector ID associated with the GuardDuty account for which you want to create a filter.
           
           To find the `detectorId` in the current Region, see the
           Settings page in the GuardDuty console, or run the [ListDetectors](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_ListDetectors.html) API.
    :param builtins.str name: The name of the filter. Valid characters include period (.), underscore (_), dash (-), and alphanumeric characters. A whitespace is considered to be an invalid character.
    """
    __args__ = dict()
...
def get_filter_output(detector_id: Optional[pulumi.Input[builtins.str]] = None,
