...
class ThreatEntitySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] format: The format of the file that contains the threat entity set. For information about supported formats, see [List formats](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_upload-lists.html#prepare_list) in the *Amazon GuardDuty User Guide* .
        :param pulumi.Input[builtins.str] location: The URI of the file that contains the threat entity set.
        :param pulumi.Input[builtins.bool] activate: A boolean value that determines if GuardDuty can start using this list for custom threat detection. For GuardDuty to consider the entries in this list and generate findings based on associated activity, this list must be active.
        :param pulumi.Input[builtins.str] detector_id: The unique regional detector ID of the GuardDuty account for which you want to create a threat entity set.
        ...
        :param pulumi.Input[builtins.str] name: The user-friendly name to identify the threat entity set. Valid characters are alphanumeric, whitespace, dash (-), and underscores (_).
