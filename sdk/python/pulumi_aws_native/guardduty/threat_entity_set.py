...
__all__ = ['ThreatEntitySetArgs', 'ThreatEntitySet']

@pulumi.input_type
class ThreatEntitySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] format: The format of the file that contains the threat entity set. For information about supported formats, see [List formats](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_upload-lists.html#prepare_list) in the *Amazon GuardDuty User Guide* .
        :param pulumi.Input[_builtins.str] location: The URI of the file that contains the threat entity set.
        :param pulumi.Input[_builtins.bool] activate: A boolean value that determines if GuardDuty can start using this list for custom threat detection. For GuardDuty to consider the entries in this list and generate findings based on associated activity, this list must be active.
        :param pulumi.Input[_builtins.str] detector_id: The unique regional detector ID of the GuardDuty account for which you want to create a threat entity set.
        ...
        :param pulumi.Input[_builtins.str] name: The user-friendly name to identify the threat entity set. Valid characters are alphanumeric, whitespace, dash (-), and underscores (_).
...
@pulumi.type_token("aws-native:guardduty:ThreatEntitySet")
class ThreatEntitySet(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ThreatEntitySetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ThreatEntitySetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ThreatEntitySetArgs.__new__(ThreatEntitySetArgs)
        ...
        super(ThreatEntitySet, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ThreatEntitySet':
        """
        ...
        __props__.__dict__["updated_at"] = None
        return ThreatEntitySet(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['ThreatEntitySetStatus']:
        """
