...
class IpSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] format: The format of the file that contains the IPSet.
        :param pulumi.Input[_builtins.str] location: The URI of the file that contains the IPSet.
        :param pulumi.Input[_builtins.bool] activate: Indicates whether or not GuardDuty uses the `IPSet` .
