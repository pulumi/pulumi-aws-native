...
class IpSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] format: The format of the file that contains the IPSet. For information about supported formats, see [List formats](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_upload-lists.html#prepare_list) in the *Amazon GuardDuty User Guide* .
        ...
        :param pulumi.Input[_builtins.str] detector_id: The unique ID of the detector of the GuardDuty account for which you want to create an IPSet.
        ...
        :param pulumi.Input[_builtins.str] name: The user-friendly name to identify the IPSet.
...
@pulumi.type_token("aws-native:guardduty:IpSet")
