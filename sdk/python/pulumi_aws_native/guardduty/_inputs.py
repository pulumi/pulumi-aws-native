...
class DetectorCfnDataSourceConfigurationsArgsDict(TypedDict):
    kubernetes: NotRequired[pulumi.Input[Optional['DetectorCfnKubernetesConfigurationArgs']]]
    """
    Describes which Kubernetes data sources are enabled for a detector.
    """
    malware_protection: NotRequired[pulumi.Input[Optional['DetectorCfnMalwareProtectionConfigurationArgs']]]
    """
    Describes whether Malware Protection will be enabled as a data source.
    """
    s3_logs: NotRequired[pulumi.Input[Optional['DetectorCfns3LogsConfigurationArgs']]]
    """
...
class DetectorCfnFeatureConfigurationArgsDict(TypedDict):
    ...
    """
    additional_configuration: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DetectorCfnFeatureAdditionalConfigurationArgs']]]]]
    """
...
class DetectorCfnMalwareProtectionConfigurationArgsDict(TypedDict):
    scan_ec2_instance_with_findings: NotRequired[pulumi.Input[Optional['DetectorCfnScanEc2InstanceWithFindingsConfigurationArgs']]]
    """
...
class FilterFindingCriteriaArgsDict(TypedDict):
    criterion: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['FilterConditionArgs']]]]]
    """
...
class MalwareProtectionPlanCfnActionsArgsDict(TypedDict):
    tagging: NotRequired[pulumi.Input[Optional['MalwareProtectionPlanCfnTaggingArgs']]]
    """
