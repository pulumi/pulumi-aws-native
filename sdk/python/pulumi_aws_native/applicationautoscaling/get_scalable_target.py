...
def get_scalable_target(resource_id: Optional[_builtins.str] = None,
                        scalable_dimension: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scalable_dimension: The scalable dimension associated with the scalable target. This string consists of the service namespace, resource type, and scaling property.
    ...
    :param _builtins.str service_namespace: The namespace of the AWS service that provides the resource, or a ``custom-resource``.
    """
    __args__ = dict()
