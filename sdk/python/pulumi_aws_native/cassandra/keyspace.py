...
class KeyspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] client_side_timestamps_enabled: Indicates whether client-side timestamps are enabled (true) or disabled (false) for all tables in the keyspace. To add a Region to a single-Region keyspace with at least one table, the value must be set to true. After you enabled client-side timestamps for a table, you can’t disable it again.
        :param pulumi.Input[builtins.str] keyspace_name: Name for Cassandra keyspace
    ...
    def client_side_timestamps_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def client_side_timestamps_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Keyspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="clientSideTimestampsEnabled")
    def client_side_timestamps_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether client-side timestamps are enabled (true) or disabled (false) for all tables in the keyspace. To add a Region to a single-Region keyspace with at least one table, the value must be set to true. After you enabled client-side timestamps for a table, you can’t disable it again.
        """
        return pulumi.get(self, "client_side_timestamps_enabled")
    ...
    @property
    @pulumi.getter(name="keyspaceName")
    def keyspace_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name for Cassandra keyspace
        """
        return pulumi.get(self, "keyspace_name")
