...
if not MYPY:
    class TableAutoScalingSettingArgsDict(TypedDict):
        ...
        """
        auto_scaling_disabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        This optional parameter enables auto scaling for the table if set to `false` .
        """
        maximum_units: NotRequired[pulumi.Input[builtins.int]]
        """
        Manage costs by specifying the maximum amount of throughput to provision. The value must be between 1 and the max throughput per second quota for your account (40,000 by default).
        """
        minimum_units: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TableAutoScalingSettingArgs:
    def __init__(__self__, *,
                 auto_scaling_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 maximum_units: Optional[pulumi.Input[builtins.int]] = None,
                 minimum_units: Optional[pulumi.Input[builtins.int]] = None,
                 scaling_policy: Optional[pulumi.Input['TableScalingPolicyArgs']] = None):
        """
        Represents configuration for auto scaling.
        :param pulumi.Input[builtins.bool] auto_scaling_disabled: This optional parameter enables auto scaling for the table if set to `false` .
        :param pulumi.Input[builtins.int] maximum_units: Manage costs by specifying the maximum amount of throughput to provision. The value must be between 1 and the max throughput per second quota for your account (40,000 by default).
        :param pulumi.Input[builtins.int] minimum_units: The minimum level of throughput the table should always be ready to support. The value must be between 1 and the max throughput per second quota for your account (40,000 by default).
    ...
    def auto_scaling_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This optional parameter enables auto scaling for the table if set to `false` .
        """
    ...
    def auto_scaling_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_scaling_disabled", value)

    @property
    @pulumi.getter(name="maximumUnits")
    def maximum_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Manage costs by specifying the maximum amount of throughput to provision. The value must be between 1 and the max throughput per second quota for your account (40,000 by default).
        """
    ...
    def maximum_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_units", value)

    @property
    @pulumi.getter(name="minimumUnits")
    def minimum_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum level of throughput the table should always be ready to support. The value must be between 1 and the max throughput per second quota for your account (40,000 by default).
        """
    ...
    def minimum_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class TableColumnArgs:
    def __init__(__self__, *,
                 ...
                 column_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] column_name: The name of the column. For more information, see [Identifiers](https://docs.aws.amazon.com/keyspaces/latest/devguide/cql.elements.html#cql.elements.identifier) in the *Amazon Keyspaces Developer Guide* .
        :param pulumi.Input[builtins.str] column_type: The data type of the column. For more information, see [Data types](https://docs.aws.amazon.com/keyspaces/latest/devguide/cql.elements.html#cql.data-types) in the *Amazon Keyspaces Developer Guide* .
        """
...
class TableEncryptionSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableEncryptionType'] encryption_type: The encryption at rest options for the table.
               ...
               Valid values: `CUSTOMER_MANAGED_KMS_KEY` | `AWS_OWNED_KMS_KEY` .
        :param pulumi.Input[builtins.str] kms_key_identifier: Requires a `kms_key_identifier` in the format of a key ARN.
        """
...
class TableProvisionedThroughputArgs:
    def __init__(__self__, *,
        ...
        """
        Throughput for the specified table, which consists of values for ReadCapacityUnits and WriteCapacityUnits
        :param pulumi.Input[builtins.int] read_capacity_units: The amount of read capacity that's provisioned for the table. For more information, see [Read/write capacity mode](https://docs.aws.amazon.com/keyspaces/latest/devguide/ReadWriteCapacityMode.html) in the *Amazon Keyspaces Developer Guide* .
        :param pulumi.Input[builtins.int] write_capacity_units: The amount of write capacity that's provisioned for the table. For more information, see [Read/write capacity mode](https://docs.aws.amazon.com/keyspaces/latest/devguide/ReadWriteCapacityMode.html) in the *Amazon Keyspaces Developer Guide* .
        """
...
class TableReplicaSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        Represents replica specifications.
        :param pulumi.Input[builtins.str] region: The AWS Region.
        ...
        :param pulumi.Input[builtins.int] read_capacity_units: The provisioned read capacity units for the multi-Region table in the specified AWS Region.
        """
...
if not MYPY:
    class TableTargetTrackingScalingPolicyConfigurationArgsDict(TypedDict):
        ...
        """
        target_value: pulumi.Input[builtins.int]
        """
...
class TableTargetTrackingScalingPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Represents configuration for target tracking scaling policy.
        :param pulumi.Input[builtins.int] target_value: Specifies the target value for the target tracking auto scaling policy.
               
               Amazon Keyspaces auto scaling scales up capacity automatically when traffic exceeds this target utilization rate, and then back down when it falls below the target. This ensures that the ratio of consumed capacity to provisioned capacity stays at or near this value. You define `targetValue` as a percentage. An `integer` between 20 and 90.
        :param pulumi.Input[builtins.bool] disable_scale_in: Specifies if `scale-in` is enabled.
               
               When auto scaling automatically decreases capacity for a table, the table *scales in* . When scaling policies are set, they can't scale in the table lower than its minimum capacity.
        :param pulumi.Input[builtins.int] scale_in_cooldown: Specifies a `scale-in` cool down period.
               
               A cooldown period in seconds between scaling activities that lets the table stabilize before another scaling activity starts.
        :param pulumi.Input[builtins.int] scale_out_cooldown: Specifies a scale out cool down period.
    ...
    def target_value(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the target value for the target tracking auto scaling policy.
    ...
    @target_value.setter
    def target_value(self, value: pulumi.Input[builtins.int]):
...
class TypeFieldArgs:
    def __init__(__self__, *,
                 ...
                 field_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] field_name: The name of the field.
        :param pulumi.Input[builtins.str] field_type: The data type of the field. This can be any Cassandra data type or another user-defined type.
        """
