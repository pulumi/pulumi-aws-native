...
class KeyspaceReplicationSpecificationArgsDict(TypedDict):
    region_list: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['KeyspaceRegionListItem']]]]]
    """
...
class KeyspaceReplicationSpecificationArgs:
    def __init__(__self__, *,
                 region_list: pulumi.Input[Optional[Sequence[pulumi.Input['KeyspaceRegionListItem']]]] = None,
    ...
    def region_list(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['KeyspaceRegionListItem']]]]:
        """
        Specifies the AWS Regions that the keyspace is replicated in. You must specify at least two Regions, including the Region that the keyspace is being created in.
    ...
    @region_list.setter
    def region_list(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['KeyspaceRegionListItem']]]]):
...
class TableAutoScalingSettingArgsDict(TypedDict):
    ...
    """
    scaling_policy: NotRequired[pulumi.Input[Optional['TableScalingPolicyArgs']]]
    """
...
class TableAutoScalingSpecificationArgsDict(TypedDict):
    ...
    """
    read_capacity_auto_scaling: NotRequired[pulumi.Input[Optional['TableAutoScalingSettingArgs']]]
    """
    The auto scaling settings for the table's read capacity.
    """
    write_capacity_auto_scaling: NotRequired[pulumi.Input[Optional['TableAutoScalingSettingArgs']]]
    """
...
class TableCdcSpecificationArgsDict(TypedDict):
    ...
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TableTagArgs']]]]]
    """
...
class TableColumnArgs:
    def __init__(__self__, *,
                 ...
                 column_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] column_name: The name of the column. For more information, see [Identifiers](https://docs.aws.amazon.com/keyspaces/latest/devguide/cql.elements.html#cql.elements.identifier) in the *Amazon Keyspaces Developer Guide* .
        :param pulumi.Input[_builtins.str] column_type: The data type of the column. For more information, see [Data types](https://docs.aws.amazon.com/keyspaces/latest/devguide/cql.elements.html#cql.data-types) in the *Amazon Keyspaces Developer Guide* .
        """
...
class TableEncryptionSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableEncryptionType'] encryption_type: The encryption at rest options for the table.
               ...
               Valid values: `CUSTOMER_MANAGED_KMS_KEY` | `AWS_OWNED_KMS_KEY` .
        :param pulumi.Input[_builtins.str] kms_key_identifier: Requires a `kms_key_identifier` in the format of a key ARN.
        """
...
class TableScalingPolicyArgsDict(TypedDict):
    ...
    """
    target_tracking_scaling_policy_configuration: NotRequired[pulumi.Input[Optional['TableTargetTrackingScalingPolicyConfigurationArgs']]]
    """
...
class TableTargetTrackingScalingPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] target_value: Specifies the target value for the target tracking auto scaling policy.
               ...
               Amazon Keyspaces auto scaling scales up capacity automatically when traffic exceeds this target utilization rate, and then back down when it falls below the target. This ensures that the ratio of consumed capacity to provisioned capacity stays at or near this value. You define `targetValue` as a percentage. An `integer` between 20 and 90.
        :param pulumi.Input[_builtins.bool] disable_scale_in: Specifies if `scale-in` is enabled.
               
               When auto scaling automatically decreases capacity for a table, the table *scales in* . When scaling policies are set, they can't scale in the table lower than its minimum capacity.
        :param pulumi.Input[_builtins.int] scale_in_cooldown: Specifies a `scale-in` cool down period.
               
               A cooldown period in seconds between scaling activities that lets the table stabilize before another scaling activity starts.
        :param pulumi.Input[_builtins.int] scale_out_cooldown: Specifies a scale out cool down period.
    ...
    def target_value(self) -> pulumi.Input[_builtins.int]:
        """
        Specifies the target value for the target tracking auto scaling policy.
    ...
    @target_value.setter
    def target_value(self, value: pulumi.Input[_builtins.int]):
...
class TypeFieldArgs:
    def __init__(__self__, *,
                 ...
                 field_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] field_name: The name of the field.
        :param pulumi.Input[_builtins.str] field_type: The data type of the field. This can be any Cassandra data type or another user-defined type.
        """
