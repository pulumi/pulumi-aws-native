...
class TableAutoScalingSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableAutoScalingSettingArgs'] read_capacity_auto_scaling: The optional auto scaling settings for a table with provisioned throughput capacity.
        ...
        :param pulumi.Input['TableAutoScalingSettingArgs'] write_capacity_auto_scaling: The optional auto scaling settings for a table with provisioned throughput capacity.
...
class TableBillingModeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableProvisionedThroughputArgs'] provisioned_throughput: The provisioned throughput for the table, which consists of `ReadCapacityUnits` and `WriteCapacityUnits` .
        """
...
class TableClusteringKeyColumnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input['TableColumnArgs'] column: The name and data type of an individual column in a table. In addition to the data type, you can also use the following two keywords:
