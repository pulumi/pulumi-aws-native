...
class HostVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] security_group_ids: The ID of the security group or security groups associated with the Amazon VPC.
        :param Sequence[_builtins.str] subnet_ids: The ID of the subnet or subnets associated with the Amazon VPC.
