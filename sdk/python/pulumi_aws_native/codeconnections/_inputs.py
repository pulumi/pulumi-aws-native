...
class HostVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: The ID of the security group or security groups associated with the Amazon VPC.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: The ID of the subnet or subnets associated with the Amazon VPC.
