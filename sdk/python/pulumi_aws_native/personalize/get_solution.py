...
class GetSolutionResult:
    ...
    def solution_arn(self) -> Optional[builtins.str]:
        """
...
def get_solution(solution_arn: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSolutionResult:
    """
    Resource schema for AWS::Personalize::Solution.


    :param builtins.str solution_arn: The Amazon Resource Name (ARN) of the solution.
    """
    __args__ = dict()
...
def get_solution_output(solution_arn: Optional[pulumi.Input[builtins.str]] = None,
