...
class GetSolutionResult:
    ...
    def solution_arn(self) -> Optional[_builtins.str]:
        """
...
def get_solution(solution_arn: Optional[_builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSolutionResult:
    """
    Resource schema for AWS::Personalize::Solution.


    :param _builtins.str solution_arn: The Amazon Resource Name (ARN) of the solution.
    """
    __args__ = dict()
...
def get_solution_output(solution_arn: Optional[pulumi.Input[_builtins.str]] = None,
