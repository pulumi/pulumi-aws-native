...
class DatasetImportJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dataset_arn: Optional[builtins.str] = None,
                 dataset_import_job_arn: Optional[builtins.str] = None,
        ...
        :param builtins.str dataset_arn: The ARN of the dataset that receives the imported data
        :param builtins.str dataset_import_job_arn: The ARN of the dataset import job
        :param builtins.str job_name: The name for the dataset import job.
        :param builtins.str role_arn: The ARN of the IAM role that has permissions to read from the Amazon S3 data source.
        """
    ...
    def dataset_import_job_arn(self) -> Optional[builtins.str]:
        """
...
class DatasetImportJobDataSourceProperties(dict):
    ...
    def __init__(__self__, *,
                 data_location: Optional[builtins.str] = None):
        """
        The Amazon S3 bucket that contains the training data to import.
        :param builtins.str data_location: The path to the Amazon S3 bucket where the data that you want to upload to your dataset is stored.
        """
    ...
    def data_location(self) -> Optional[builtins.str]:
        """
...
class SolutionCategoricalHyperParameterRange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides the name and values of a Categorical hyperparameter.
        :param builtins.str name: The name of the hyperparameter.
        :param Sequence[builtins.str] values: A list of the categories for the hyperparameter.
        """
        if name is not None:
...
class SolutionConfig(dict):
    ...
    def __init__(__self__, *,
                 algorithm_hyper_parameters: Optional[Mapping[str, builtins.str]] = None,
                 auto_ml_config: Optional['outputs.SolutionConfigAutoMlConfigProperties'] = None,
                 event_value_threshold: Optional[builtins.str] = None,
                 feature_transformation_parameters: Optional[Mapping[str, builtins.str]] = None,
                 hpo_config: Optional['outputs.SolutionConfigHpoConfigProperties'] = None):
        """
        The configuration to use with the solution. When performAutoML is set to true, Amazon Personalize only evaluates the autoMLConfig section of the solution configuration.
        :param Mapping[str, builtins.str] algorithm_hyper_parameters: Lists the hyperparameter names and ranges.
        ...
        :param builtins.str event_value_threshold: Only events with a value greater than or equal to this threshold are used for training a model.
        :param Mapping[str, builtins.str] feature_transformation_parameters: Lists the feature transformation parameters.
    ...
    def algorithm_hyper_parameters(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def event_value_threshold(self) -> Optional[builtins.str]:
        """
    ...
    def feature_transformation_parameters(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class SolutionConfigAutoMlConfigProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 recipe_list: Optional[Sequence[builtins.str]] = None):
        """
        The AutoMLConfig object containing a list of recipes to search when AutoML is performed.
        :param builtins.str metric_name: The metric to optimize.
        :param Sequence[builtins.str] recipe_list: The list of candidate recipes.
        """
    ...
    def recipe_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SolutionConfigHpoConfigPropertiesHpoObjectiveProperties(dict):
    ...
    def __init__(__self__, *,
                 metric_name: Optional[builtins.str] = None,
                 metric_regex: Optional[builtins.str] = None,
        ...
        :param builtins.str metric_regex: A regular expression for finding the metric in the training job logs.
    ...
    def metric_regex(self) -> Optional[builtins.str]:
        """
...
class SolutionConfigHpoConfigPropertiesHpoResourceConfigProperties(dict):
    ...
    def __init__(__self__, *,
                 max_number_of_training_jobs: Optional[builtins.str] = None,
                 max_parallel_training_jobs: Optional[builtins.str] = None):
        """
        Describes the resource configuration for hyperparameter optimization (HPO).
        :param builtins.str max_number_of_training_jobs: The maximum number of training jobs when you create a solution version. The maximum value for maxNumberOfTrainingJobs is 40.
        :param builtins.str max_parallel_training_jobs: The maximum number of parallel training jobs when you create a solution version. The maximum value for maxParallelTrainingJobs is 10.
        """
    ...
    def max_number_of_training_jobs(self) -> Optional[builtins.str]:
        """
    ...
    def max_parallel_training_jobs(self) -> Optional[builtins.str]:
        """
...
class SolutionContinuousHyperParameterRange(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides the name and range of a continuous hyperparameter.
        :param builtins.float max_value: The maximum allowable value for the hyperparameter.
        :param builtins.float min_value: The minimum allowable value for the hyperparameter.
        :param builtins.str name: The name of the hyperparameter.
        """
...
class SolutionIntegerHyperParameterRange(dict):
    ...
    def __init__(__self__, *,
                 max_value: Optional[builtins.int] = None,
                 min_value: Optional[builtins.int] = None,
                 name: Optional[builtins.str] = None):
        """
        Provides the name and range of an integer-valued hyperparameter.
        :param builtins.int max_value: The maximum allowable value for the hyperparameter.
        :param builtins.int min_value: The minimum allowable value for the hyperparameter.
        :param builtins.str name: The name of the hyperparameter.
        """
        if max_value is not None:
            pulumi.set(__self__, "max_value", max_value)
    ...
    @property
    @pulumi.getter(name="maxValue")
    def max_value(self) -> Optional[builtins.int]:
        """
        The maximum allowable value for the hyperparameter.
        """
        return pulumi.get(self, "max_value")
    ...
    @property
    @pulumi.getter(name="minValue")
    def min_value(self) -> Optional[builtins.int]:
        """
        The minimum allowable value for the hyperparameter.
        """
        return pulumi.get(self, "min_value")
