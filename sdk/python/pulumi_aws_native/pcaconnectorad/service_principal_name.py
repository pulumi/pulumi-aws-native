...
class ServicePrincipalNameArgs:
    def __init__(__self__, *,
                 ...
                 directory_registration_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ServicePrincipalName resource.
        :param pulumi.Input[builtins.str] connector_arn: The Amazon Resource Name (ARN) that was returned when you called [CreateConnector.html](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateConnector.html) .
        :param pulumi.Input[builtins.str] directory_registration_arn: The Amazon Resource Name (ARN) that was returned when you called [CreateDirectoryRegistration](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html) .
        """
    ...
    def connector_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connector_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connector_arn", value)

    @property
    @pulumi.getter(name="directoryRegistrationArn")
    def directory_registration_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def directory_registration_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServicePrincipalName(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectorArn")
    def connector_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) that was returned when you called [CreateConnector.html](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateConnector.html) .
        """
        return pulumi.get(self, "connector_arn")
    ...
    @property
    @pulumi.getter(name="directoryRegistrationArn")
    def directory_registration_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) that was returned when you called [CreateDirectoryRegistration](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html) .
        """
        return pulumi.get(self, "directory_registration_arn")
