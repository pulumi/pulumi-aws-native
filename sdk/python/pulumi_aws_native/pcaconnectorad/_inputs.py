...
class TemplateApplicationPolicy1PropertiesArgs:
    ...
    def policy_object_identifier(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "policy_object_identifier")

    @policy_object_identifier.setter
    def policy_object_identifier(self, value: pulumi.Input[_builtins.str]):
...
class TemplateExtensionsV2ArgsDict(TypedDict):
    ...
    application_policies: NotRequired[pulumi.Input[Optional['TemplateApplicationPoliciesArgs']]]
...
class TemplatePrivateKeyAttributesV2Args:
    ...
    def minimal_key_length(self) -> pulumi.Input[_builtins.float]:
        return pulumi.get(self, "minimal_key_length")

    @minimal_key_length.setter
    def minimal_key_length(self, value: pulumi.Input[_builtins.float]):
...
class TemplatePrivateKeyAttributesV4ArgsDict(TypedDict):
    ...
    crypto_providers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    key_usage_property: NotRequired[pulumi.Input[Optional[Union['TemplateKeyUsageProperty0PropertiesArgs', 'TemplateKeyUsageProperty1PropertiesArgs']]]]
