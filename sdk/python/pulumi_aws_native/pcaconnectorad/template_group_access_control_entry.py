...
class TemplateGroupAccessControlEntryArgs:
    def __init__(__self__, *,
                 ...
                 group_display_name: pulumi.Input[builtins.str],
                 group_security_identifier: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] group_display_name: Name of the Active Directory group. This name does not need to match the group name in Active Directory.
        :param pulumi.Input[builtins.str] group_security_identifier: Security identifier (SID) of the group object from Active Directory. The SID starts with "S-".
        :param pulumi.Input[builtins.str] template_arn: The Amazon Resource Name (ARN) that was returned when you called [CreateTemplate](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateTemplate.html) .
        """
    ...
    def group_display_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_display_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "group_display_name", value)

    @property
    @pulumi.getter(name="groupSecurityIdentifier")
    def group_security_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_security_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TemplateGroupAccessControlEntry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 group_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 group_security_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 template_arn: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="groupDisplayName")
    def group_display_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Active Directory group. This name does not need to match the group name in Active Directory.
        """
        return pulumi.get(self, "group_display_name")
    ...
    @property
    @pulumi.getter(name="groupSecurityIdentifier")
    def group_security_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Security identifier (SID) of the group object from Active Directory. The SID starts with "S-".
        """
        return pulumi.get(self, "group_security_identifier")
