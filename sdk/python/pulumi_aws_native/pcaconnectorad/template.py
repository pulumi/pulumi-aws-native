...
class TemplateArgs:
    def __init__(__self__, *,
                 ...
                 reenroll_all_certificate_holders: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Template resource.
        :param pulumi.Input[builtins.str] connector_arn: The Amazon Resource Name (ARN) that was returned when you called [CreateConnector](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateConnector.html) .
        ...
        :param pulumi.Input[builtins.str] name: Name of the templates. Template names must be unique.
        :param pulumi.Input[builtins.bool] reenroll_all_certificate_holders: This setting allows the major version of a template to be increased automatically. All members of Active Directory groups that are allowed to enroll with a template will receive a new certificate issued using that template.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Metadata assigned to a template consisting of a key-value pair.
        """
    ...
    def reenroll_all_certificate_holders(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reenroll_all_certificate_holders(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Template(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="reenrollAllCertificateHolders")
    def reenroll_all_certificate_holders(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This setting allows the major version of a template to be increased automatically. All members of Active Directory groups that are allowed to enroll with a template will receive a new certificate issued using that template.
        """
        return pulumi.get(self, "reenroll_all_certificate_holders")
