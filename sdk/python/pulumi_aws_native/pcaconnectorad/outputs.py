...
class ConnectorVpcInformation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: The security groups used with the connector. You can use a maximum of 4 security groups with a connector.
...
class TemplateEnrollmentFlagsV2(dict):
    ...
    def __init__(__self__, *,
                 enable_key_reuse_on_nt_token_keyset_storage_full: Optional[builtins.bool] = None,
                 include_symmetric_algorithms: Optional[builtins.bool] = None,
                 no_security_extension: Optional[builtins.bool] = None,
                 remove_invalid_certificate_from_personal_store: Optional[builtins.bool] = None,
                 user_interaction_required: Optional[builtins.bool] = None):
...
class TemplateGeneralFlagsV2(dict):
    ...
    def __init__(__self__, *,
                 auto_enrollment: Optional[builtins.bool] = None,
                 machine_type: Optional[builtins.bool] = None):
    ...
    def auto_enrollment(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "auto_enrollment")

    @property
    @pulumi.getter(name="machineType")
    def machine_type(self) -> Optional[builtins.bool]:
...
class TemplatePrivateKeyAttributesV2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 minimal_key_length: builtins.float,
                 crypto_providers: Optional[Sequence[builtins.str]] = None):
    ...
    def minimal_key_length(self) -> builtins.float:
        return pulumi.get(self, "minimal_key_length")

    @property
    @pulumi.getter(name="cryptoProviders")
    def crypto_providers(self) -> Optional[Sequence[builtins.str]]:
...
class TemplatePrivateKeyFlagsV2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exportable_key: Optional[builtins.bool] = None,
                 strong_key_protection_required: Optional[builtins.bool] = None):
    ...
    def exportable_key(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "exportable_key")

    @property
    @pulumi.getter(name="strongKeyProtectionRequired")
    def strong_key_protection_required(self) -> Optional[builtins.bool]:
...
class TemplatePrivateKeyFlagsV3(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exportable_key: Optional[builtins.bool] = None,
                 require_alternate_signature_algorithm: Optional[builtins.bool] = None,
                 strong_key_protection_required: Optional[builtins.bool] = None):
        pulumi.set(__self__, "client_version", client_version)
        if exportable_key is not None:
            pulumi.set(__self__, "exportable_key", exportable_key)
    ...
    def require_alternate_signature_algorithm(self) -> Optional[builtins.bool]:
...
class TemplatePrivateKeyFlagsV4(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exportable_key: Optional[builtins.bool] = None,
                 require_alternate_signature_algorithm: Optional[builtins.bool] = None,
                 require_same_key_renewal: Optional[builtins.bool] = None,
                 strong_key_protection_required: Optional[builtins.bool] = None,
                 use_legacy_provider: Optional[builtins.bool] = None):
        pulumi.set(__self__, "client_version", client_version)
        if exportable_key is not None:
            pulumi.set(__self__, "exportable_key", exportable_key)
        if require_alternate_signature_algorithm is not None:
    ...
    def require_same_key_renewal(self) -> Optional[builtins.bool]:
    ...
    def use_legacy_provider(self) -> Optional[builtins.bool]:
...
class TemplateSubjectNameFlagsV2(dict):
    ...
    def __init__(__self__, *,
                 require_common_name: Optional[builtins.bool] = None,
                 require_directory_path: Optional[builtins.bool] = None,
                 require_dns_as_cn: Optional[builtins.bool] = None,
                 require_email: Optional[builtins.bool] = None,
                 san_require_directory_guid: Optional[builtins.bool] = None,
                 san_require_dns: Optional[builtins.bool] = None,
                 san_require_domain_dns: Optional[builtins.bool] = None,
                 san_require_email: Optional[builtins.bool] = None,
                 san_require_spn: Optional[builtins.bool] = None,
                 san_require_upn: Optional[builtins.bool] = None):
...
class TemplateV2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 superseded_templates: Optional[Sequence[builtins.str]] = None):
    ...
    def superseded_templates(self) -> Optional[Sequence[builtins.str]]:
