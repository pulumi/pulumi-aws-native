...
class AuthorizerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] signing_disabled: Specifies whether AWS IoT validates the token signature in an authorization request.
        ...
        :param pulumi.Input[_builtins.str] token_key_name: The key used to extract the token from the HTTP headers.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] token_signing_public_keys: The public keys used to validate the token signature returned by your custom authentication service.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Input[Optional['AuthorizerStatus']]:
        """
    ...
    @status.setter
    def status(self, value: pulumi.Input[Optional['AuthorizerStatus']]):
...
class Authorizer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authorizerName")
    def authorizer_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The authorizer name.
        """
        return pulumi.get(self, "authorizer_name")
