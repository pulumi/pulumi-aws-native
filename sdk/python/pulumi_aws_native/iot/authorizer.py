...
class AuthorizerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authorizer_function_arn: The authorizer's Lambda function ARN.
        :param pulumi.Input[builtins.str] authorizer_name: The authorizer name.
        :param pulumi.Input[builtins.bool] enable_caching_for_http: When `true` , the result from the authorizer's Lambda function is cached for clients that use persistent HTTP connections. The results are cached for the time specified by the Lambda function in `refreshAfterInSeconds` . This value doesn't affect authorization of clients that use MQTT connections.
        :param pulumi.Input[builtins.bool] signing_disabled: Specifies whether AWS IoT validates the token signature in an authorization request.
        ...
        :param pulumi.Input[builtins.str] token_key_name: The key used to extract the token from the HTTP headers.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] token_signing_public_keys: The public keys used to validate the token signature returned by your custom authentication service.
        """
...
class Authorizer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authorizerName")
    def authorizer_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The authorizer name.
        """
        return pulumi.get(self, "authorizer_name")
