...
class GetCustomMetricResult:
    ...
    def metric_arn(self) -> Optional[builtins.str]:
        """
...
def get_custom_metric(metric_name: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCustomMetricResult:
    """
    A custom metric published by your devices to Device Defender.


    :param builtins.str metric_name: The name of the custom metric. This will be used in the metric report submitted from the device/thing. Shouldn't begin with aws: . Cannot be updated once defined.
    """
    __args__ = dict()
...
def get_custom_metric_output(metric_name: Optional[pulumi.Input[builtins.str]] = None,
