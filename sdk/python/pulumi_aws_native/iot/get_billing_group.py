...
def get_billing_group(billing_group_name: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBillingGroupResult:
    """
    Resource Type definition for AWS::IoT::BillingGroup


    :param builtins.str billing_group_name: The name of the billing group.
    """
    __args__ = dict()
...
def get_billing_group_output(billing_group_name: Optional[pulumi.Input[builtins.str]] = None,
