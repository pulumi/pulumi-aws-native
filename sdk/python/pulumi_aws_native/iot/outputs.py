...
__all__ = [
    ...
    'TopicRuleRepublishActionHeadersProperties',
    'TopicRuleS3Action',
...
class TopicRuleRepublishAction(dict):
    ...
    def __init__(__self__, *,
                 role_arn: str,
                 topic: str,
                 headers: Optional['outputs.TopicRuleRepublishActionHeadersProperties'] = None,
    ...
    @property
    @pulumi.getter
    def headers(self) -> Optional['outputs.TopicRuleRepublishActionHeadersProperties']:
        return pulumi.get(self, "headers")
...
@pulumi.output_type
class TopicRuleRepublishActionHeadersProperties(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "contentType":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TopicRuleRepublishActionHeadersProperties. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TopicRuleRepublishActionHeadersProperties.__key_warning(key)
        return super().__getitem__(key)
