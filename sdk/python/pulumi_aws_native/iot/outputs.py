...
class AccountAuditConfigurationAuditCheckConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration for a specific audit check.
        :param builtins.bool enabled: True if the check is enabled.
        """
...
class AccountAuditConfigurationAuditNotificationTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_arn: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: True if notifications to the target are enabled.
        :param builtins.str role_arn: The ARN of the role that grants permission to send notifications to the target.
        :param builtins.str target_arn: The ARN of the target (SNS topic) to which audit notifications are sent.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class AccountAuditConfigurationCertAgeCheckCustomConfiguration(dict):
    ...
    def __init__(__self__, *,
                 cert_age_threshold_in_days: Optional[builtins.str] = None):
        """
        A structure containing the configName and corresponding configValue for configuring audit checks.
        :param builtins.str cert_age_threshold_in_days: The number of days that defines when a device certificate is considered to have aged. The check will report a finding if a certificate has been active for a number of days greater than or equal to this threshold value.
        """
    ...
    def cert_age_threshold_in_days(self) -> Optional[builtins.str]:
        """
...
class AccountAuditConfigurationCertExpirationCheckCustomConfiguration(dict):
    ...
    def __init__(__self__, *,
                 cert_expiration_threshold_in_days: Optional[builtins.str] = None):
        """
        A structure containing the configName and corresponding configValue for configuring audit checks.
        :param builtins.str cert_expiration_threshold_in_days: The number of days before expiration that defines when a device certificate is considered to be approaching expiration. The check will report a finding if a certificate will expire within this number of days.
        """
    ...
    def cert_expiration_threshold_in_days(self) -> Optional[builtins.str]:
        """
...
class BillingGroupPropertiesProperties(dict):
    ...
    def __init__(__self__, *,
                 billing_group_description: Optional[builtins.str] = None):
        """
        The properties of the billing group.
        :param builtins.str billing_group_description: The description of the billing group.
        """
    ...
    def billing_group_description(self) -> Optional[builtins.str]:
        """
...
class CaCertificateRegistrationConfig(dict):
    ...
    def __init__(__self__, *,
                 role_arn: Optional[builtins.str] = None,
                 template_body: Optional[builtins.str] = None,
                 template_name: Optional[builtins.str] = None):
        """
        :param builtins.str role_arn: The ARN of the role.
        :param builtins.str template_body: The template body.
        :param builtins.str template_name: The name of the provisioning template.
        """
        if role_arn is not None:
            pulumi.set(__self__, "role_arn", role_arn)
...
class CommandParameterValue(dict):
    def __init__(__self__, *,
                 ...
                 bin: Optional[builtins.str] = None,
                 d: Optional[builtins.float] = None,
                 i: Optional[builtins.int] = None,
                 l: Optional[builtins.str] = None,
                 s: Optional[builtins.str] = None,
                 ul: Optional[builtins.str] = None):
        if b is not None:
    ...
    @property
    @pulumi.getter
    def bin(self) -> Optional[builtins.str]:
        return pulumi.get(self, "bin")

    @property
    @pulumi.getter
    def d(self) -> Optional[builtins.float]:
        return pulumi.get(self, "d")

    @property
    @pulumi.getter
    def i(self) -> Optional[builtins.int]:
        return pulumi.get(self, "i")

    @property
    @pulumi.getter
    def l(self) -> Optional[builtins.str]:
        return pulumi.get(self, "l")

    @property
    @pulumi.getter
    def s(self) -> Optional[builtins.str]:
        return pulumi.get(self, "s")

    @property
    @pulumi.getter
    def ul(self) -> Optional[builtins.str]:
...
class DomainConfigurationAuthorizerConfig(dict):
    ...
    def __init__(__self__, *,
                 allow_authorizer_override: Optional[builtins.bool] = None,
                 default_authorizer_name: Optional[builtins.str] = None):
        """
        :param builtins.bool allow_authorizer_override: A Boolean that specifies whether the domain configuration's authorization service can be overridden.
        :param builtins.str default_authorizer_name: The name of the authorization service for a domain configuration.
        """
    ...
    def allow_authorizer_override(self) -> Optional[builtins.bool]:
        """
    ...
    def default_authorizer_name(self) -> Optional[builtins.str]:
        """
...
class DomainConfigurationClientCertificateConfig(dict):
    ...
    def __init__(__self__, *,
                 client_certificate_callback_arn: Optional[builtins.str] = None):
        """
        :param builtins.str client_certificate_callback_arn: The ARN of the Lambda function that IoT invokes after mutual TLS authentication during the connection.
        """
    ...
    def client_certificate_callback_arn(self) -> Optional[builtins.str]:
        """
...
class DomainConfigurationServerCertificateConfig(dict):
    ...
    def __init__(__self__, *,
                 enable_ocsp_check: Optional[builtins.bool] = None,
                 ocsp_authorized_responder_arn: Optional[builtins.str] = None,
                 ocsp_lambda_arn: Optional[builtins.str] = None):
        """
        :param builtins.bool enable_ocsp_check: A Boolean value that indicates whether Online Certificate Status Protocol (OCSP) server certificate check is enabled or not. For more information, see [Configurable endpoints](https://docs.aws.amazon.com//iot/latest/developerguide/iot-custom-endpoints-configurable.html) from the AWS IoT Core Developer Guide.
        :param builtins.str ocsp_authorized_responder_arn: The Amazon Resource Name (ARN) for an X.509 certificate stored in ACM. If provided, AWS IoT Core will use this certificate to validate the signature of the received OCSP response. The OCSP responder must sign responses using either this authorized responder certificate or the issuing certificate, depending on whether the ARN is provided or not. The certificate must be in the same account and region as the domain configuration.
        :param builtins.str ocsp_lambda_arn: The Amazon Resource Name (ARN) for a Lambda function that acts as a Request for Comments (RFC) 6960-compliant Online Certificate Status Protocol (OCSP) responder, supporting basic OCSP responses. The Lambda function accepts a base64-encoding of the OCSP request in the Distinguished Encoding Rules (DER) format. The Lambda function's response is also a base64-encoded OCSP response in the DER format. The response size must not exceed 4 kilobytes (KiB). The Lambda function must be in the same account and region as the domain configuration.
        """
    ...
    def enable_ocsp_check(self) -> Optional[builtins.bool]:
        """
    ...
    def ocsp_authorized_responder_arn(self) -> Optional[builtins.str]:
        """
    ...
    def ocsp_lambda_arn(self) -> Optional[builtins.str]:
        """
...
class DomainConfigurationServerCertificateSummary(dict):
    ...
    def __init__(__self__, *,
                 server_certificate_arn: Optional[builtins.str] = None,
                 server_certificate_status: Optional['DomainConfigurationServerCertificateSummaryServerCertificateStatus'] = None,
                 server_certificate_status_detail: Optional[builtins.str] = None):
        """
        :param builtins.str server_certificate_arn: The ARN of the server certificate.
        ...
        :param builtins.str server_certificate_status_detail: Details that explain the status of the server certificate.
        """
    ...
    def server_certificate_arn(self) -> Optional[builtins.str]:
        """
    ...
    def server_certificate_status_detail(self) -> Optional[builtins.str]:
        """
...
class DomainConfigurationTlsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str security_policy: The security policy for a domain configuration. For more information, see [Security policies](https://docs.aws.amazon.com/iot/latest/developerguide/transport-security.html#tls-policy-table) in the *AWS IoT Core developer guide* .
        """
...
class FleetMetricAggregationType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Aggregation types supported by Fleet Indexing
        :param builtins.str name: Fleet Indexing aggregation type names such as Statistics, Percentiles and Cardinality
        :param Sequence[builtins.str] values: Fleet Indexing aggregation type values
        """
        pulumi.set(__self__, "name", name)
...
class JobExecutionsRolloutConfigProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int maximum_per_minute: The maximum number of things that will be notified of a pending job, per minute. This parameter allows you to create a staged rollout.
        """
...
class JobTemplateAbortCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int min_number_of_executed_things: The minimum number of things which must receive job execution notifications before the job can be aborted.
        :param builtins.float threshold_percentage: The minimum percentage of job execution failures that must occur to initiate the job abort.
        """
...
class JobTemplateExponentialRolloutRate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Allows you to create an exponential rate of rollout for a job.
        :param builtins.int base_rate_per_minute: The minimum number of things that will be notified of a pending job, per minute at the start of job rollout. This parameter allows you to define the initial rate of rollout.
        :param builtins.float increment_factor: The exponential factor to increase the rate of rollout for a job.
...
class JobTemplateMaintenanceWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a start time and duration for a scheduled Job.
        :param builtins.int duration_in_minutes: Displays the duration of the next maintenance window.
        :param builtins.str start_time: Displays the start time of the next maintenance window.
        """
...
class JobTemplateRateIncreaseCriteria(dict):
    ...
    def __init__(__self__, *,
                 number_of_notified_things: Optional[builtins.int] = None,
                 number_of_succeeded_things: Optional[builtins.int] = None):
        """
        :param builtins.int number_of_notified_things: The threshold for number of notified things that will initiate the increase in rate of rollout.
        :param builtins.int number_of_succeeded_things: The threshold for number of succeeded things that will initiate the increase in rate of rollout.
        """
    ...
    def number_of_notified_things(self) -> Optional[builtins.int]:
        """
    ...
    def number_of_succeeded_things(self) -> Optional[builtins.int]:
        """
...
class JobTemplateRetryCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number_of_retries: Optional[builtins.int] = None):
        """
        Specifies how many times a failure type should be retried.
        :param 'JobTemplateJobRetryFailureType' failure_type: The type of job execution failures that can initiate a job retry.
        :param builtins.int number_of_retries: The number of retries allowed for a failure type for the job.
        """
    ...
    def number_of_retries(self) -> Optional[builtins.int]:
        """
...
class MetricsExportConfigProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A structure containing the mqtt topic for metrics export.
        :param builtins.str mqtt_topic: The topic for metrics export.
        :param builtins.str role_arn: The ARN of the role that grants permission to publish to mqtt topic.
        """
...
class MitigationActionAddThingsToThingGroupParams(dict):
    ...
    def __init__(__self__, *,
                 thing_group_names: Sequence[builtins.str],
                 override_dynamic_groups: Optional[builtins.bool] = None):
        """
        Parameters to define a mitigation action that moves devices associated with a certificate to one or more specified thing groups, typically for quarantine.
        :param Sequence[builtins.str] thing_group_names: The list of groups to which you want to add the things that triggered the mitigation action.
        :param builtins.bool override_dynamic_groups: Specifies if this mitigation action can move the things that triggered the mitigation action out of one or more dynamic thing groups.
        """
    ...
    def thing_group_names(self) -> Sequence[builtins.str]:
        """
    ...
    def override_dynamic_groups(self) -> Optional[builtins.bool]:
        """
...
class MitigationActionEnableIoTLoggingParams(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn_for_logging:  The ARN of the IAM role used for logging.
        """
...
class MitigationActionPublishFindingToSnsParams(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameters, to define a mitigation action that publishes findings to Amazon SNS. You can implement your own custom actions in response to the Amazon SNS messages.
        :param builtins.str topic_arn: The ARN of the topic to which you want to publish the findings.
        """
...
class PresignedUrlConfigProperties(dict):
    ...
    def __init__(__self__, *,
                 role_arn: builtins.str,
                 expires_in_sec: Optional[builtins.int] = None):
        """
        Configuration for pre-signed S3 URLs.
        :param builtins.str role_arn: The ARN of an IAM role that grants grants permission to download files from the S3 bucket where the job data/updates are stored. The role must also grant permission for IoT to download the files.
        ...
        :param builtins.int expires_in_sec: How long (in seconds) pre-signed URLs are valid. Valid values are 60 - 3600, the default value is 3600 seconds. Pre-signed URLs are generated when Jobs receives an MQTT request for the job document.
        """
        pulumi.set(__self__, "role_arn", role_arn)
    ...
    def expires_in_sec(self) -> Optional[builtins.int]:
        """
...
class ProvisioningTemplateProvisioningHook(dict):
    ...
    def __init__(__self__, *,
                 payload_version: Optional[builtins.str] = None,
                 target_arn: Optional[builtins.str] = None):
        """
        :param builtins.str payload_version: The payload that was sent to the target function. The valid payload is `"2020-04-01"` .
        :param builtins.str target_arn: The ARN of the target function.
        """
    ...
    def payload_version(self) -> Optional[builtins.str]:
        """
...
class SecurityProfileAlertTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A structure containing the alert target ARN and the role ARN.
        :param builtins.str alert_target_arn: The ARN of the notification target to which alerts are sent.
        :param builtins.str role_arn: The ARN of the role that grants permission to send alerts to the notification target.
        """
...
class SecurityProfileBehavior(dict):
    ...
    def __init__(__self__, *,
                 ...
                 export_metric: Optional[builtins.bool] = None,
                 metric: Optional[builtins.str] = None,
                 metric_dimension: Optional['outputs.SecurityProfileMetricDimension'] = None,
                 suppress_alerts: Optional[builtins.bool] = None):
        """
        A security profile behavior.
        :param builtins.str name: The name for the behavior.
        ...
        :param builtins.bool export_metric: Value indicates exporting metrics related to the behavior when it is true.
        :param builtins.str metric: What is measured by the behavior.
        :param 'SecurityProfileMetricDimension' metric_dimension: The dimension of the metric.
        :param builtins.bool suppress_alerts: Manage Detect alarm SNS notifications by setting behavior notification to on or suppressed. Detect will continue to performing device behavior evaluations. However, suppressed alarms wouldn't be forwarded for SNS notification.
        """
        pulumi.set(__self__, "name", name)
    ...
    def export_metric(self) -> Optional[builtins.bool]:
        """
    ...
    def suppress_alerts(self) -> Optional[builtins.bool]:
        """
...
class SecurityProfileBehaviorCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 consecutive_datapoints_to_alarm: Optional[builtins.int] = None,
                 consecutive_datapoints_to_clear: Optional[builtins.int] = None,
        ...
        :param builtins.int consecutive_datapoints_to_alarm: If a device is in violation of the behavior for the specified number of consecutive datapoints, an alarm occurs. If not specified, the default is 1.
        :param builtins.int consecutive_datapoints_to_clear: If an alarm has occurred and the offending device is no longer in violation of the behavior for the specified number of consecutive datapoints, the alarm is cleared. If not specified, the default is 1.
        :param builtins.int duration_seconds: Use this to specify the time duration over which the behavior is evaluated.
    ...
    def consecutive_datapoints_to_alarm(self) -> Optional[builtins.int]:
        """
    ...
    def consecutive_datapoints_to_clear(self) -> Optional[builtins.int]:
        """
...
class SecurityProfileMetricDimension(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The dimension of a metric.
        :param builtins.str dimension_name: A unique identifier for the dimension.
...
class SecurityProfileMetricToRetain(dict):
    ...
    def __init__(__self__, *,
        ...
        The metric you want to retain. Dimensions are optional.
        :param builtins.str metric: What is measured by the behavior.
        :param builtins.bool export_metric: The value indicates exporting metrics related to the `MetricToRetain` when it's true.
        :param 'SecurityProfileMetricDimension' metric_dimension: The dimension of the metric.
        """
        pulumi.set(__self__, "metric", metric)
        if export_metric is not None:
...
class SecurityProfileMetricValue(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number: Optional[builtins.float] = None,
                 numbers: Optional[Sequence[builtins.float]] = None,
                 ports: Optional[Sequence[builtins.int]] = None,
                 strings: Optional[Sequence[builtins.str]] = None):
        """
        The value to be compared with the metric.
        :param Sequence[builtins.str] cidrs: If the ComparisonOperator calls for a set of CIDRs, use this to specify that set to be compared with the metric.
        :param builtins.str count: If the ComparisonOperator calls for a numeric value, use this to specify that (integer) numeric value to be compared with the metric.
        :param builtins.float number: The numeral value of a metric.
        :param Sequence[builtins.float] numbers: The numeral values of a metric.
        :param Sequence[builtins.int] ports: If the ComparisonOperator calls for a set of ports, use this to specify that set to be compared with the metric.
        :param Sequence[builtins.str] strings: The string values of a metric.
        """
    ...
    @property
    @pulumi.getter
    def number(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def numbers(self) -> Optional[Sequence[builtins.float]]:
        """
...
class SoftwarePackageVersionS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Amazon S3 location
        :param builtins.str bucket: The S3 bucket
        :param builtins.str key: The S3 key
        :param builtins.str version: The S3 version
        """
...
class ThingAttributePayload(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] attributes: A JSON string containing up to three key-value pair in JSON format. For example:
...
class ThingGroupPropertiesProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 thing_group_description: Optional[builtins.str] = None):
        """
        Thing group properties.
        :param 'ThingGroupAttributePayload' attribute_payload: The thing group attributes in JSON format.
        :param builtins.str thing_group_description: The thing group description.
        """
    ...
    def thing_group_description(self) -> Optional[builtins.str]:
        """
...
class ThingTypePropagatingAttribute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 thing_attribute: Optional[builtins.str] = None):
        """
        :param builtins.str user_property_key: The key of the MQTT 5 user property, which is a key-value pair.
        ...
        :param builtins.str thing_attribute: The thing attribute that is propagating for MQTT 5 message enrichment.
        """
    ...
    def thing_attribute(self) -> Optional[builtins.str]:
        """
...
class ThingTypePropertiesProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 searchable_attributes: Optional[Sequence[builtins.str]] = None,
                 thing_type_description: Optional[builtins.str] = None):
        """
        The thing type properties for the thing type to create. It contains information about the new thing type including a description, a list of searchable thing attribute names, and a list of propagating attributes. After a thing type is created, you can only update `Mqtt5Configuration` .
        ...
        :param Sequence[builtins.str] searchable_attributes: A list of searchable thing attribute names.
        :param builtins.str thing_type_description: The description of the thing type.
        """
    ...
    def searchable_attributes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def thing_type_description(self) -> Optional[builtins.str]:
        """
...
class TimeoutConfigProperties(dict):
    ...
    def __init__(__self__, *,
                 in_progress_timeout_in_minutes: builtins.int):
        """
        Specifies the amount of time each device has to finish its execution of the job.
        :param builtins.int in_progress_timeout_in_minutes: Specifies the amount of time, in minutes, this device has to finish execution of this job. The timeout interval can be anywhere between 1 minute and 7 days (1 to 10080 minutes). The in progress timer can't be updated and will apply to all job executions for the job. Whenever a job execution remains in the IN_PROGRESS status for longer than this interval, the job execution will fail and switch to the terminal `TIMED_OUT` status.
        """
    ...
    def in_progress_timeout_in_minutes(self) -> builtins.int:
        """
...
class TopicRuleAssetPropertyTimestamp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str time_in_seconds: A string that contains the time in seconds since epoch. Accepts substitution templates.
        :param builtins.str offset_in_nanos: Optional. A string that contains the nanosecond time offset. Accepts substitution templates.
        """
...
class TopicRuleAssetPropertyValue(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str quality: Optional. A string that describes the quality of the value. Accepts substitution templates. Must be `GOOD` , `BAD` , or `UNCERTAIN` .
        """
...
class TopicRuleAssetPropertyVariant(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str boolean_value: Optional. A string that contains the boolean value ( `true` or `false` ) of the value entry. Accepts substitution templates.
        :param builtins.str double_value: Optional. A string that contains the double value of the value entry. Accepts substitution templates.
        :param builtins.str integer_value: Optional. A string that contains the integer value of the value entry. Accepts substitution templates.
        :param builtins.str string_value: Optional. The string value of the value entry. Accepts substitution templates.
        """
...
class TopicRuleCloudwatchAlarmAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str alarm_name: The CloudWatch alarm name.
        :param builtins.str role_arn: The IAM role that allows access to the CloudWatch alarm.
        :param builtins.str state_reason: The reason for the alarm change.
        :param builtins.str state_value: The value of the alarm state. Acceptable values are: OK, ALARM, INSUFFICIENT_DATA.
        """
...
class TopicRuleCloudwatchLogsAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_arn: builtins.str,
                 batch_mode: Optional[builtins.bool] = None):
        """
        :param builtins.str log_group_name: The CloudWatch log name.
        :param builtins.str role_arn: The IAM role that allows access to the CloudWatch log.
        :param builtins.bool batch_mode: Indicates whether batches of log records will be extracted and uploaded into CloudWatch.
        """
    ...
    def batch_mode(self) -> Optional[builtins.bool]:
        """
...
class TopicRuleCloudwatchMetricAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_arn: builtins.str,
                 metric_timestamp: Optional[builtins.str] = None):
        """
        :param builtins.str metric_name: The CloudWatch metric name.
        :param builtins.str metric_namespace: The CloudWatch metric namespace name.
        :param builtins.str metric_unit: The [metric unit](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/cloudwatch_concepts.html#Unit) supported by CloudWatch.
        :param builtins.str metric_value: The CloudWatch metric value.
        :param builtins.str role_arn: The IAM role that allows access to the CloudWatch metric.
        :param builtins.str metric_timestamp: An optional [Unix timestamp](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/cloudwatch_concepts.html#about_timestamp) .
        """
    ...
    def metric_timestamp(self) -> Optional[builtins.str]:
        """
...
class TopicRuleDestinationHttpUrlDestinationSummary(dict):
    ...
    def __init__(__self__, *,
                 confirmation_url: Optional[builtins.str] = None):
        """
        :param builtins.str confirmation_url: The URL used to confirm the HTTP topic rule destination URL.
        """
    ...
    def confirmation_url(self) -> Optional[builtins.str]:
        """
...
class TopicRuleDestinationVpcDestinationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of a role that has permission to create and attach to elastic network interfaces (ENIs).
        :param Sequence[builtins.str] security_groups: The security groups of the VPC destination.
        :param Sequence[builtins.str] subnet_ids: The subnet IDs of the VPC destination.
...
class TopicRuleDynamoDBv2Action(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The ARN of the IAM role that grants access to the DynamoDB table.
        """
...
class TopicRuleDynamoDbAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str hash_key_field: The hash key name.
        :param builtins.str hash_key_value: The hash key value.
        :param builtins.str role_arn: The ARN of the IAM role that grants access to the DynamoDB table.
        :param builtins.str table_name: The name of the DynamoDB table.
        :param builtins.str hash_key_type: The hash key type. Valid values are "STRING" or "NUMBER"
        :param builtins.str payload_field: The action payload. This name can be customized.
        :param builtins.str range_key_field: The range key name.
        :param builtins.str range_key_type: The range key type. Valid values are "STRING" or "NUMBER"
        :param builtins.str range_key_value: The range key value.
        """
...
class TopicRuleElasticsearchAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str endpoint: The endpoint of your OpenSearch domain.
        :param builtins.str id: The unique identifier for the document you are storing.
        :param builtins.str index: The index where you want to store your data.
        :param builtins.str role_arn: The IAM role ARN that has access to OpenSearch.
        :param builtins.str type: The type of document you are storing.
        """
...
class TopicRuleFirehoseAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str delivery_stream_name: The delivery stream name.
        :param builtins.str role_arn: The IAM role that grants access to the Amazon Kinesis Firehose stream.
        :param builtins.bool batch_mode: Whether to deliver the Kinesis Data Firehose stream as a batch by using [`PutRecordBatch`](https://docs.aws.amazon.com/firehose/latest/APIReference/API_PutRecordBatch.html) . The default value is `false` .
        ...
        :param builtins.str separator: A character separator that will be used to separate records written to the Firehose stream. Valid values are: '\\n' (newline), '\\t' (tab), '\\r\\n' (Windows newline), ',' (comma).
        """
...
class TopicRuleHttpAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: The endpoint URL. If substitution templates are used in the URL, you must also specify a `confirmationUrl` . If this is a new destination, a new `TopicRuleDestination` is created if possible.
        :param 'TopicRuleHttpAuthorization' auth: The authentication method to use when sending data to an HTTPS endpoint.
        :param builtins.str confirmation_url: The URL to which AWS IoT sends a confirmation message. The value of the confirmation URL must be a prefix of the endpoint URL. If you do not specify a confirmation URL AWS IoT uses the endpoint URL as the confirmation URL. If you use substitution templates in the confirmationUrl, you must create and enable topic rule destinations that match each possible value of the substitution template before traffic is allowed to your endpoint URL.
...
class TopicRuleHttpActionHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The HTTP header key.
        :param builtins.str value: The HTTP header value. Substitution templates are supported.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class TopicRuleIotAnalyticsAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 batch_mode: Optional[builtins.bool] = None):
        """
        :param builtins.str channel_name: The name of the IoT Analytics channel to which message data will be sent.
        :param builtins.str role_arn: The ARN of the role which has a policy that grants IoT Analytics permission to send message data via IoT Analytics (iotanalytics:BatchPutMessage).
        :param builtins.bool batch_mode: Whether to process the action as a batch. The default value is `false` .
...
class TopicRuleIotEventsAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str input_name: The name of the AWS IoT Events input.
        :param builtins.str role_arn: The ARN of the role that grants AWS IoT permission to send an input to an AWS IoT Events detector. ("Action":"iotevents:BatchPutMessage").
        :param builtins.bool batch_mode: Whether to process the event actions as a batch. The default value is `false` .
        ...
        :param builtins.str message_id: The ID of the message. The default `messageId` is a new UUID value.
...
class TopicRuleIotSiteWiseAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The ARN of the role that grants AWS IoT permission to send an asset property value to AWS IoT SiteWise. ( `"Action": "iotsitewise:BatchPutAssetPropertyValue"` ). The trust policy can restrict access to specific asset hierarchy paths.
        """
...
class TopicRuleKafkaAction(dict):
    ...
    def __init__(__self__, *,
                 client_properties: Mapping[str, builtins.str],
        ...
        """
        :param Mapping[str, builtins.str] client_properties: Properties of the Apache Kafka producer client.
        :param builtins.str destination_arn: The ARN of Kafka action's VPC `TopicRuleDestination` .
        :param builtins.str topic: The Kafka topic for messages to be sent to the Kafka broker.
        :param Sequence['TopicRuleKafkaActionHeader'] headers: The list of Kafka headers that you specify.
        :param builtins.str key: The Kafka message key.
        :param builtins.str partition: The Kafka message partition.
        """
    ...
    def client_properties(self) -> Mapping[str, builtins.str]:
        """
...
class TopicRuleKafkaActionHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the Kafka header.
        :param builtins.str value: The value of the Kafka header.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class TopicRuleKinesisAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the IAM role that grants access to the Amazon Kinesis stream.
        :param builtins.str stream_name: The name of the Amazon Kinesis stream.
        :param builtins.str partition_key: The partition key.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class TopicRuleLambdaAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str function_arn: The ARN of the Lambda function.
        """
...
class TopicRuleLocationAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str device_id: The unique ID of the device providing the location data.
        :param builtins.str latitude: A string that evaluates to a double value that represents the latitude of the device's location.
        :param builtins.str longitude: A string that evaluates to a double value that represents the longitude of the device's location.
        :param builtins.str role_arn: The IAM role that grants permission to write to the Amazon Location resource.
        :param builtins.str tracker_name: The name of the tracker resource in Amazon Location in which the location is updated.
...
class TopicRuleOpenSearchAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str endpoint: The endpoint of your OpenSearch domain.
        :param builtins.str id: The unique identifier for the document you are storing.
        :param builtins.str index: The OpenSearch index where you want to store your data.
        :param builtins.str role_arn: The IAM role ARN that has access to OpenSearch.
        :param builtins.str type: The type of document you are storing.
        """
        pulumi.set(__self__, "endpoint", endpoint)
...
class TopicRulePayload(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sql: builtins.str,
                 aws_iot_sql_version: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 error_action: Optional['outputs.TopicRuleAction'] = None,
                 rule_disabled: Optional[builtins.bool] = None):
        """
        :param Sequence['TopicRuleAction'] actions: The actions associated with the rule.
        :param builtins.str sql: The SQL statement used to query the topic. For more information, see [AWS IoT SQL Reference](https://docs.aws.amazon.com/iot/latest/developerguide/iot-sql-reference.html) in the *AWS IoT Developer Guide* .
        :param builtins.str aws_iot_sql_version: The version of the SQL rules engine to use when evaluating the rule.
        ...
        :param builtins.bool rule_disabled: Specifies whether the rule is disabled.
        """
    ...
    def aws_iot_sql_version(self) -> Optional[builtins.str]:
        """
    ...
    def rule_disabled(self) -> Optional[builtins.bool]:
        """
...
class TopicRulePutAssetPropertyValueEntry(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str asset_id: The ID of the AWS IoT SiteWise asset. You must specify either a `propertyAlias` or both an `aliasId` and a `propertyId` . Accepts substitution templates.
        :param builtins.str entry_id: Optional. A unique identifier for this entry that you can define to better track which message caused an error in case of failure. Accepts substitution templates. Defaults to a new UUID.
        :param builtins.str property_alias: The name of the property alias associated with your asset property. You must specify either a `propertyAlias` or both an `aliasId` and a `propertyId` . Accepts substitution templates.
        :param builtins.str property_id: The ID of the asset's property. You must specify either a `propertyAlias` or both an `aliasId` and a `propertyId` . Accepts substitution templates.
        """
...
class TopicRulePutItemInput(dict):
    ...
    def __init__(__self__, *,
                 table_name: builtins.str):
        """
        :param builtins.str table_name: The table where the message data will be written.
        """
        pulumi.set(__self__, "table_name", table_name)
...
class TopicRuleRepublishAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.str topic: The name of the MQTT topic.
        ...
        :param builtins.int qos: The Quality of Service (QoS) level to use when republishing messages. The default value is 0.
        """
        pulumi.set(__self__, "role_arn", role_arn)
        pulumi.set(__self__, "topic", topic)
        if headers is not None:
...
class TopicRuleRepublishActionHeaders(dict):
    ...
    def __init__(__self__, *,
                 content_type: Optional[builtins.str] = None,
                 correlation_data: Optional[builtins.str] = None,
                 message_expiry: Optional[builtins.str] = None,
                 payload_format_indicator: Optional[builtins.str] = None,
                 response_topic: Optional[builtins.str] = None,
                 user_properties: Optional[Sequence['outputs.TopicRuleUserProperty']] = None):
        """
        :param builtins.str content_type: A UTF-8 encoded string that describes the content of the publishing message.
        ...
        :param builtins.str correlation_data: The base64-encoded binary data used by the sender of the request message to identify which request the response message is for.
        ...
        :param builtins.str message_expiry: A user-defined integer value that represents the message expiry interval at the broker. If the messages haven't been sent to the subscribers within that interval, the message expires and is removed. The value of `messageExpiry` represents the number of seconds before it expires. For more information about the limits of `messageExpiry` , see [Message broker and protocol limits and quotas](https://docs.aws.amazon.com//general/latest/gr/iot-core.html#limits_iot) in the IoT Core Reference Guide.
               
               Supports [substitution templates](https://docs.aws.amazon.com//iot/latest/developerguide/iot-substitution-templates.html) .
        :param builtins.str payload_format_indicator: An `Enum` string value that indicates whether the payload is formatted as UTF-8.
               ...
               Supports [substitution templates](https://docs.aws.amazon.com//iot/latest/developerguide/iot-substitution-templates.html) .
        :param builtins.str response_topic: A UTF-8 encoded string that's used as the topic name for a response message. The response topic is used to describe the topic to which the receiver should publish as part of the request-response flow. The topic must not contain wildcard characters.
    ...
    def correlation_data(self) -> Optional[builtins.str]:
        """
    ...
    def message_expiry(self) -> Optional[builtins.str]:
        """
    ...
    def payload_format_indicator(self) -> Optional[builtins.str]:
        """
    ...
    def response_topic(self) -> Optional[builtins.str]:
        """
...
class TopicRuleS3Action(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The Amazon S3 bucket.
        :param builtins.str key: The object key. For more information, see [Actions, resources, and condition keys for Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/dev/list_amazons3.html) .
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
...
class TopicRuleSigV4Authorization(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the signing role.
        :param builtins.str service_name: The service name to use while signing with Sig V4.
        :param builtins.str signing_region: The signing region.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class TopicRuleSnsAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.str target_arn: The ARN of the SNS topic.
        :param builtins.str message_format: (Optional) The message format of the message to publish. Accepted values are "JSON" and "RAW". The default value of the attribute is "RAW". SNS uses this setting to determine if the payload should be parsed and relevant platform-specific bits of the payload should be extracted. For more information, see [Amazon SNS Message and JSON Formats](https://docs.aws.amazon.com/sns/latest/dg/json-formats.html) in the *Amazon Simple Notification Service Developer Guide* .
        """
        pulumi.set(__self__, "role_arn", role_arn)
        pulumi.set(__self__, "target_arn", target_arn)
...
class TopicRuleSqsAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str queue_url: The URL of the Amazon SQS queue.
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.bool use_base64: Specifies whether to use Base64 encoding.
        """
...
class TopicRuleStepFunctionsAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 execution_name_prefix: Optional[builtins.str] = None):
        """
        :param builtins.str role_arn: The ARN of the role that grants IoT permission to start execution of a state machine ("Action":"states:StartExecution").
        :param builtins.str state_machine_name: The name of the Step Functions state machine whose execution will be started.
        :param builtins.str execution_name_prefix: (Optional) A name will be given to the state machine execution consisting of this prefix followed by a UUID. Step Functions automatically creates a unique name for each state machine execution if one is not provided.
        """
        pulumi.set(__self__, "role_arn", role_arn)
    ...
    def execution_name_prefix(self) -> Optional[builtins.str]:
        """
...
class TopicRuleTimestamp(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: An expression that returns a long epoch time value.
        :param builtins.str unit: The precision of the timestamp value that results from the expression described in `value` .
        """
        pulumi.set(__self__, "value", value)
        if unit is not None:
...
class TopicRuleTimestreamAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_name: The name of an Amazon Timestream database that has the table to write records into.
        ...
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the role that grants AWS IoT permission to write to the Timestream database table.
        :param builtins.str table_name: The table where the message data will be written.
