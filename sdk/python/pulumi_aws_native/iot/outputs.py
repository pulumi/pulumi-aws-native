...
@pulumi.output_type
class RegistrationConfigProperties(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "roleArn":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RegistrationConfigProperties. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RegistrationConfigProperties.__key_warning(key)
        return super().__getitem__(key)
