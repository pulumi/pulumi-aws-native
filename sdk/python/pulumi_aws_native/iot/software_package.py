...
class SoftwarePackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A summary of the package being created. This can be used to outline the package's contents or purpose.
        :param pulumi.Input[builtins.str] package_name: The name of the new software package.
