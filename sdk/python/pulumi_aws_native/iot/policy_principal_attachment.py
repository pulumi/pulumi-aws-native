...
__all__ = ['PolicyPrincipalAttachment']
...
class PolicyPrincipalAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PolicyPrincipalAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PolicyPrincipalAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PolicyPrincipalAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PolicyPrincipalAttachmentProperties']:
        """
