...
class GetSoftwarePackageVersionResult:
    ...
    def error_reason(self) -> Optional[builtins.str]:
        """
    ...
    def package_version_arn(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def recipe(self) -> Optional[builtins.str]:
        """
...
def get_software_package_version(package_name: Optional[builtins.str] = None,
    ...
    :param builtins.str package_name: The name of the associated software package.
    :param builtins.str version_name: The name of the new package version.
    """
    __args__ = dict()
...
def get_software_package_version_output(package_name: Optional[pulumi.Input[builtins.str]] = None,
