...
class ThingPrincipalAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ThingPrincipalAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ThingPrincipalAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ThingPrincipalAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ThingPrincipalAttachmentProperties']:
        """
