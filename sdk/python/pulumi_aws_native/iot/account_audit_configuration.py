...
class AccountAuditConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: Your 12-digit account ID (used as the primary identifier for the CloudFormation resource).
        ...
        :param pulumi.Input[builtins.str] role_arn: The ARN of the role that grants permission to AWS IoT to access information about your devices, policies, certificates and other items as required when performing an audit.
