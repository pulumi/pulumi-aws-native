...
class AccountAuditConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(audit_check_configurations, AccountAuditConfigurationAuditCheckConfigurationsArgs):
            ...
            if not isinstance(audit_notification_target_configurations, AccountAuditConfigurationAuditNotificationTargetConfigurationsArgs):
