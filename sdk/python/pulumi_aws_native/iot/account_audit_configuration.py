...
class AccountAuditConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_arn: The ARN of the role that grants permission to AWS IoT to access information about your devices, policies, certificates and other items as required when performing an audit.
...
class AccountAuditConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 audit_check_configurations: pulumi.Input[Optional[Union['AccountAuditConfigurationAuditCheckConfigurationsArgs', 'AccountAuditConfigurationAuditCheckConfigurationsArgsDict', 'outputs.AccountAuditConfigurationAuditCheckConfigurations']]] = None,
                 audit_notification_target_configurations: pulumi.Input[Optional[Union['AccountAuditConfigurationAuditNotificationTargetConfigurationsArgs', 'AccountAuditConfigurationAuditNotificationTargetConfigurationsArgsDict', 'outputs.AccountAuditConfigurationAuditNotificationTargetConfigurations']]] = None,
        ...
        :param pulumi.Input[_builtins.str] account_id: Your 12-digit account ID (used as the primary identifier for the CloudFormation resource).
        :param pulumi.Input[Union['AccountAuditConfigurationAuditCheckConfigurationsArgs', 'AccountAuditConfigurationAuditCheckConfigurationsArgsDict', 'outputs.AccountAuditConfigurationAuditCheckConfigurations']] audit_check_configurations: Specifies which audit checks are enabled and disabled for this account.
