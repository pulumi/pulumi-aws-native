...
def get_resource_specific_logging(target_id: Optional[builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourceSpecificLoggingResult:
    """
    Resource-specific logging allows you to specify a logging level for a specific thing group.


    :param builtins.str target_id: Unique Id for a Target (TargetType:TargetName), this will be internally built to serve as primary identifier for a log target.
    """
    __args__ = dict()
...
def get_resource_specific_logging_output(target_id: Optional[pulumi.Input[builtins.str]] = None,
