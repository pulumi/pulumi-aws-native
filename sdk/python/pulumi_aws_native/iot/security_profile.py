...
class SecurityProfileArgs:
    def __init__(__self__, *,
                 additional_metrics_to_retain_v2: pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileMetricToRetainArgs']]]] = None,
                 alert_targets: pulumi.Input[Optional[Mapping[str, pulumi.Input['SecurityProfileAlertTargetArgs']]]] = None,
                 behaviors: pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileBehaviorArgs']]]] = None,
                 metrics_export_config: pulumi.Input[Optional['MetricsExportConfigPropertiesArgs']] = None,
                 security_profile_description: pulumi.Input[Optional[_builtins.str]] = None,
                 security_profile_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['_root_inputs.TagArgs']]]] = None,
                 target_arns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] security_profile_description: A description of the security profile.
        :param pulumi.Input[_builtins.str] security_profile_name: A unique identifier for the security profile.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_arns: A set of target ARNs that the security profile is attached to.
        """
    ...
    def additional_metrics_to_retain_v2(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileMetricToRetainArgs']]]]:
        """
    ...
    def additional_metrics_to_retain_v2(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileMetricToRetainArgs']]]]):
        pulumi.set(self, "additional_metrics_to_retain_v2", value)

    @_builtins.property
    @pulumi.getter(name="alertTargets")
    def alert_targets(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input['SecurityProfileAlertTargetArgs']]]]:
        """
    ...
    def alert_targets(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input['SecurityProfileAlertTargetArgs']]]]):
        pulumi.set(self, "alert_targets", value)

    @_builtins.property
    @pulumi.getter
    def behaviors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileBehaviorArgs']]]]:
        """
    ...
    @behaviors.setter
    def behaviors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SecurityProfileBehaviorArgs']]]]):
        pulumi.set(self, "behaviors", value)

    @_builtins.property
    @pulumi.getter(name="metricsExportConfig")
    def metrics_export_config(self) -> pulumi.Input[Optional['MetricsExportConfigPropertiesArgs']]:
        """
    ...
    def metrics_export_config(self, value: pulumi.Input[Optional['MetricsExportConfigPropertiesArgs']]):
        pulumi.set(self, "metrics_export_config", value)

    @_builtins.property
    @pulumi.getter(name="securityProfileDescription")
    def security_profile_description(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def security_profile_description(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def target_arns(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @target_arns.setter
    def target_arns(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class SecurityProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 additional_metrics_to_retain_v2: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SecurityProfileMetricToRetainArgs', 'SecurityProfileMetricToRetainArgsDict', 'outputs.SecurityProfileMetricToRetain']]]]] = None,
                 alert_targets: pulumi.Input[Optional[Mapping[str, pulumi.Input[Union['SecurityProfileAlertTargetArgs', 'SecurityProfileAlertTargetArgsDict', 'outputs.SecurityProfileAlertTarget']]]]] = None,
                 behaviors: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SecurityProfileBehaviorArgs', 'SecurityProfileBehaviorArgsDict', 'outputs.SecurityProfileBehavior']]]]] = None,
                 metrics_export_config: pulumi.Input[Optional[Union['MetricsExportConfigPropertiesArgs', 'MetricsExportConfigPropertiesArgsDict', 'outputs.MetricsExportConfigProperties']]] = None,
                 security_profile_description: pulumi.Input[Optional[_builtins.str]] = None,
                 security_profile_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['SecurityProfileMetricToRetainArgs', 'SecurityProfileMetricToRetainArgsDict', 'outputs.SecurityProfileMetricToRetain']]]] additional_metrics_to_retain_v2: A list of metrics whose data is retained (stored). By default, data is retained for any metric used in the profile's behaviors, but it is also retained for any metric specified here.
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['SecurityProfileAlertTargetArgs', 'SecurityProfileAlertTargetArgsDict', 'outputs.SecurityProfileAlertTarget']]]] alert_targets: Specifies the destinations to which alerts are sent.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SecurityProfileBehaviorArgs', 'SecurityProfileBehaviorArgsDict', 'outputs.SecurityProfileBehavior']]]] behaviors: Specifies the behaviors that, when violated by a device (thing), cause an alert.
        :param pulumi.Input[Union['MetricsExportConfigPropertiesArgs', 'MetricsExportConfigPropertiesArgsDict', 'outputs.MetricsExportConfigProperties']] metrics_export_config: A structure containing the mqtt topic for metrics export.
        :param pulumi.Input[_builtins.str] security_profile_description: A description of the security profile.
        :param pulumi.Input[_builtins.str] security_profile_name: A unique identifier for the security profile.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: Metadata that can be used to manage the security profile.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_arns: A set of target ARNs that the security profile is attached to.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["securityProfileName"])
    ...
    @_builtins.property
    @pulumi.getter(name="securityProfileDescription")
    def security_profile_description(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A description of the security profile.
        """
        return pulumi.get(self, "security_profile_description")
    ...
    @_builtins.property
    @pulumi.getter(name="securityProfileName")
    def security_profile_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A unique identifier for the security profile.
        """
        return pulumi.get(self, "security_profile_name")
    ...
    @_builtins.property
    @pulumi.getter(name="targetArns")
    def target_arns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A set of target ARNs that the security profile is attached to.
        """
        return pulumi.get(self, "target_arns")
