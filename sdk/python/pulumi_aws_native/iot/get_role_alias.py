...
class GetRoleAliasResult:
    ...
    def credential_duration_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def role_alias_arn(self) -> Optional[_builtins.str]:
        """
        The role alias ARN.
        """
...
def get_role_alias(role_alias: Optional[_builtins.str] = None,
