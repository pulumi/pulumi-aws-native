...
class GetRoleAliasResult:
    ...
    def credential_duration_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def role_alias_arn(self) -> Optional[builtins.str]:
        """
        The role alias ARN.
        """
...
def get_role_alias(role_alias: Optional[builtins.str] = None,
    ...
    :param builtins.str role_alias: The role alias.
    """
    __args__ = dict()
...
def get_role_alias_output(role_alias: Optional[pulumi.Input[builtins.str]] = None,
