...
class SoftwarePackageVersion(pulumi.CustomResource):
    ...
    def error_reason(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def package_version_arn(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def recipe(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The inline json job document associated with a software package version
        """
        return pulumi.get(self, "recipe")
