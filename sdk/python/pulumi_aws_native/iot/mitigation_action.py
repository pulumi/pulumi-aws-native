...
class MitigationActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The IAM role ARN used to apply this mitigation action.
        :param pulumi.Input[builtins.str] action_name: A unique identifier for the mitigation action.
...
class MitigationAction(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="actionName")
    def action_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A unique identifier for the mitigation action.
        """
        return pulumi.get(self, "action_name")
    ...
    def mitigation_action_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def mitigation_action_id(self) -> pulumi.Output[builtins.str]:
        """
