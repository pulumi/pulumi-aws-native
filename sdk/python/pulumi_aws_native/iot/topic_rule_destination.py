...
class TopicRuleDestination(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(http_url_properties, TopicRuleDestinationHttpUrlDestinationSummaryArgs):
            ...
            if not isinstance(vpc_properties, TopicRuleDestinationVpcDestinationPropertiesArgs):
