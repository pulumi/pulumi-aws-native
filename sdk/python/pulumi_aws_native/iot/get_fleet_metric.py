...
class GetFleetMetricResult:
    ...
    def aggregation_field(self) -> Optional[builtins.str]:
        """
    ...
    def query_version(self) -> Optional[builtins.str]:
        """
...
def get_fleet_metric(metric_name: Optional[builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFleetMetricResult:
    """
    An aggregated metric of certain devices in your fleet


    :param builtins.str metric_name: The name of the fleet metric
    """
    __args__ = dict()
...
def get_fleet_metric_output(metric_name: Optional[pulumi.Input[builtins.str]] = None,
