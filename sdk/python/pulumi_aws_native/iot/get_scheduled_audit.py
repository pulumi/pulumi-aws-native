...
class GetScheduledAuditResult:
    ...
    def scheduled_audit_arn(self) -> Optional[builtins.str]:
        """
    ...
    def target_check_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_scheduled_audit(scheduled_audit_name: Optional[builtins.str] = None,
    ...
    :param builtins.str scheduled_audit_name: The name you want to give to the scheduled audit.
    """
    __args__ = dict()
...
def get_scheduled_audit_output(scheduled_audit_name: Optional[pulumi.Input[builtins.str]] = None,
