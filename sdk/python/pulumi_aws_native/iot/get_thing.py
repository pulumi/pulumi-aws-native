...
def get_thing(thing_name: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetThingResult:
    """
    Resource Type definition for AWS::IoT::Thing


    :param builtins.str thing_name: The name of the thing to update.
...
def get_thing_output(thing_name: Optional[pulumi.Input[builtins.str]] = None,
