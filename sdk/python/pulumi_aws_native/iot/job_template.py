...
class JobTemplateArgs:
    def __init__(__self__, *,
                 ...
                 destination_package_versions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 document: Optional[pulumi.Input[builtins.str]] = None,
                 document_source: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: A description of the Job Template.
        :param pulumi.Input[builtins.str] job_template_id: A unique identifier for the job template. We recommend using a UUID. Alpha-numeric characters, "-", and "_" are valid for use here.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_package_versions: The package version Amazon Resource Names (ARNs) that are installed on the device’s reserved named shadow ( `$package` ) when the job successfully completes.
               
               *Note:* Up to 25 package version ARNS are allowed.
        :param pulumi.Input[builtins.str] document: The job document. Required if you don't specify a value for documentSource.
        :param pulumi.Input[builtins.str] document_source: An S3 link to the job document to use in the template. Required if you don't specify a value for document.
        :param pulumi.Input[builtins.str] job_arn: Optional for copying a JobTemplate from a pre-existing Job configuration.
    ...
    def destination_package_versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def destination_package_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def document_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def document_source(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JobTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['AbortConfigPropertiesArgs', 'AbortConfigPropertiesArgsDict']] abort_config: The criteria that determine when and how a job abort takes place.
        :param pulumi.Input[builtins.str] description: A description of the Job Template.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_package_versions: The package version Amazon Resource Names (ARNs) that are installed on the device’s reserved named shadow ( `$package` ) when the job successfully completes.
        ...
        :param pulumi.Input[builtins.str] document_source: An S3 link to the job document to use in the template. Required if you don't specify a value for document.
        :param pulumi.Input[builtins.str] job_arn: Optional for copying a JobTemplate from a pre-existing Job configuration.
        :param pulumi.Input[Union['JobExecutionsRetryConfigPropertiesArgs', 'JobExecutionsRetryConfigPropertiesArgsDict']] job_executions_retry_config: Allows you to create the criteria to retry a job.
        :param pulumi.Input[Union['JobExecutionsRolloutConfigPropertiesArgs', 'JobExecutionsRolloutConfigPropertiesArgsDict']] job_executions_rollout_config: Allows you to create a staged rollout of a job.
        :param pulumi.Input[builtins.str] job_template_id: A unique identifier for the job template. We recommend using a UUID. Alpha-numeric characters, "-", and "_" are valid for use here.
        :param pulumi.Input[Sequence[pulumi.Input[Union['JobTemplateMaintenanceWindowArgs', 'JobTemplateMaintenanceWindowArgsDict']]]] maintenance_windows: An optional configuration within the SchedulingConfig to setup a recurring maintenance window with a predetermined start time and duration for the rollout of a job document to all devices in a target group for a job.
        :param pulumi.Input[Union['PresignedUrlConfigPropertiesArgs', 'PresignedUrlConfigPropertiesArgsDict']] presigned_url_config: Configuration for pre-signed S3 URLs.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.CreateOnlyTagArgs', '_root_inputs.CreateOnlyTagArgsDict']]]] tags: Metadata that can be used to manage the JobTemplate.
        :param pulumi.Input[Union['TimeoutConfigPropertiesArgs', 'TimeoutConfigPropertiesArgsDict']] timeout_config: Specifies the amount of time each device has to finish its execution of the job.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="destinationPackageVersions")
    def destination_package_versions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The package version Amazon Resource Names (ARNs) that are installed on the device’s reserved named shadow ( `$package` ) when the job successfully completes.
    ...
    @property
    @pulumi.getter
    def document(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The job document. Required if you don't specify a value for documentSource.
        """
        return pulumi.get(self, "document")
    ...
    @property
    @pulumi.getter(name="documentSource")
    def document_source(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An S3 link to the job document to use in the template. Required if you don't specify a value for document.
        """
        return pulumi.get(self, "document_source")
    ...
    @property
    @pulumi.getter(name="jobArn")
    def job_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional for copying a JobTemplate from a pre-existing Job configuration.
        """
        return pulumi.get(self, "job_arn")
