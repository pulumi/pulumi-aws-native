...
class JobTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(abort_config, AbortConfigPropertiesArgs):
            ...
            if not isinstance(job_executions_retry_config, JobExecutionsRetryConfigPropertiesArgs):
            ...
            if not isinstance(job_executions_rollout_config, JobExecutionsRolloutConfigPropertiesArgs):
            ...
            if not isinstance(presigned_url_config, PresignedUrlConfigPropertiesArgs):
            ...
            if not isinstance(timeout_config, TimeoutConfigPropertiesArgs):
