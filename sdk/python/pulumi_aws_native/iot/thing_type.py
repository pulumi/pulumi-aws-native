...
class ThingTypeArgs:
    def __init__(__self__, *,
                 deprecate_thing_type: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] deprecate_thing_type: Deprecates a thing type. You can not associate new things with deprecated thing type.
        ...
        :param pulumi.Input[builtins.str] thing_type_name: The name of the thing type.
    ...
    def deprecate_thing_type(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def deprecate_thing_type(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def thing_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ThingType(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deprecateThingType")
    def deprecate_thing_type(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Deprecates a thing type. You can not associate new things with deprecated thing type.
    ...
    @property
    @pulumi.getter(name="thingTypeName")
    def thing_type_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the thing type.
        """
        return pulumi.get(self, "thing_type_name")
