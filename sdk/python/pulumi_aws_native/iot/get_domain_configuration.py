...
def get_domain_configuration(domain_configuration_name: Optional[builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainConfigurationResult:
    """
    Create and manage a Domain Configuration


    :param builtins.str domain_configuration_name: The name of the domain configuration. This value must be unique to a region.
    """
    __args__ = dict()
...
def get_domain_configuration_output(domain_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
