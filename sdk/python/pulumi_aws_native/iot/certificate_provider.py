...
class CertificateProviderArgs:
    def __init__(__self__, *,
                 ...
                 certificate_provider_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] lambda_function_arn: The ARN of the Lambda function.
        :param pulumi.Input[builtins.str] certificate_provider_name: The name of the certificate provider.
    ...
    def certificate_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def certificate_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateProvider(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="certificateProviderName")
    def certificate_provider_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the certificate provider.
        """
        return pulumi.get(self, "certificate_provider_name")
    ...
    @property
    @pulumi.getter(name="lambdaFunctionArn")
    def lambda_function_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the Lambda function.
        """
        return pulumi.get(self, "lambda_function_arn")
