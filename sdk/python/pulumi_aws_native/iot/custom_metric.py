...
class CustomMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Field represents a friendly name in the console for the custom metric; it doesn't have to be unique. Don't use this name as the metric identifier in the device metric report. Can be updated once defined.
        :param pulumi.Input[builtins.str] metric_name: The name of the custom metric. This will be used in the metric report submitted from the device/thing. Shouldn't begin with aws: . Cannot be updated once defined.
...
class CustomMetric(pulumi.CustomResource):
    ...
    def metric_arn(self) -> pulumi.Output[builtins.str]:
        """
