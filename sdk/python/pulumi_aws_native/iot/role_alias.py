...
class RoleAlias(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="credentialDurationSeconds")
    def credential_duration_seconds(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of seconds for which the credential is valid.
        """
        return pulumi.get(self, "credential_duration_seconds")
    ...
    @_builtins.property
    @pulumi.getter(name="roleAlias")
    def role_alias(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The role alias.
        """
        return pulumi.get(self, "role_alias")
    ...
    def role_alias_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The role alias ARN.
        """
