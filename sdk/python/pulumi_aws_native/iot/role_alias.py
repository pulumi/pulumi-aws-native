...
class RoleAliasArgs:
    def __init__(__self__, *,
                 ...
                 credential_duration_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 role_alias: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] credential_duration_seconds: The number of seconds for which the credential is valid.
        :param pulumi.Input[builtins.str] role_alias: The role alias.
    ...
    def credential_duration_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def credential_duration_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "credential_duration_seconds", value)

    @property
    @pulumi.getter(name="roleAlias")
    def role_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role alias.
        """
    ...
    @role_alias.setter
    def role_alias(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RoleAlias(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="credentialDurationSeconds")
    def credential_duration_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of seconds for which the credential is valid.
        """
        return pulumi.get(self, "credential_duration_seconds")
    ...
    @property
    @pulumi.getter(name="roleAlias")
    def role_alias(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The role alias.
        """
        return pulumi.get(self, "role_alias")
    ...
    def role_alias_arn(self) -> pulumi.Output[builtins.str]:
        """
        The role alias ARN.
        """
