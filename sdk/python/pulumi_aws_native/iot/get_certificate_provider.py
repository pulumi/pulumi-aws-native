...
def get_certificate_provider(certificate_provider_name: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_provider_name: The name of the certificate provider.
    """
    __args__ = dict()
...
def get_certificate_provider_output(certificate_provider_name: Optional[pulumi.Input[builtins.str]] = None,
