...
class GetAuthorizerResult:
    ...
    def authorizer_function_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def enable_caching_for_http(self) -> Optional[_builtins.bool]:
        """
    ...
    def token_key_name(self) -> Optional[_builtins.str]:
        """
    ...
    def token_signing_public_keys(self) -> Optional[Mapping[str, _builtins.str]]:
        """
...
def get_authorizer(authorizer_name: Optional[_builtins.str] = None,
