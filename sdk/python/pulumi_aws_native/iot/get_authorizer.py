...
class GetAuthorizerResult:
    ...
    def authorizer_function_arn(self) -> Optional[builtins.str]:
        """
    ...
    def enable_caching_for_http(self) -> Optional[builtins.bool]:
        """
    ...
    def token_key_name(self) -> Optional[builtins.str]:
        """
    ...
    def token_signing_public_keys(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_authorizer(authorizer_name: Optional[builtins.str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthorizerResult:
    """
    Creates an authorizer.


    :param builtins.str authorizer_name: The authorizer name.
    """
    __args__ = dict()
...
def get_authorizer_output(authorizer_name: Optional[pulumi.Input[builtins.str]] = None,
