...
class GetProvisioningTemplateResult:
    ...
    def template_arn(self) -> Optional[builtins.str]:
        """
    ...
    def template_body(self) -> Optional[builtins.str]:
        """
...
def get_provisioning_template(template_name: Optional[builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProvisioningTemplateResult:
    """
    Creates a fleet provisioning template.


    :param builtins.str template_name: The name of the fleet provisioning template.
    """
    __args__ = dict()
...
def get_provisioning_template_output(template_name: Optional[pulumi.Input[builtins.str]] = None,
