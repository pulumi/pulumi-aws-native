...
class GetDimensionResult:
    ...
    def string_values(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_dimension(name: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDimensionResult:
    """
    A dimension can be used to limit the scope of a metric used in a security profile for AWS IoT Device Defender.


    :param builtins.str name: A unique identifier for the dimension.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_dimension_output(name: Optional[pulumi.Input[builtins.str]] = None,
