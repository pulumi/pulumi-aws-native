...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate_pem: The certificate data in PEM format. Requires SNI_ONLY for the certificate mode or the accompanying CACertificatePem for registration.
        :param pulumi.Input[_builtins.str] certificate_signing_request: The certificate signing request (CSR).
        """
...
@pulumi.type_token("aws-native:iot:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="caCertificatePem")
    def ca_certificate_pem(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The CA certificate used to sign the device certificate being registered, not available when CertificateMode is SNI_ONLY.
        """
        return pulumi.get(self, "ca_certificate_pem")
    ...
    @_builtins.property
    @pulumi.getter(name="certificateSigningRequest")
    def certificate_signing_request(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The certificate signing request (CSR).
        """
        return pulumi.get(self, "certificate_signing_request")
