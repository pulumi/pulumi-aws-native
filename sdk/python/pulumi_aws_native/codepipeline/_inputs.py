...
class CustomActionTypeArtifactDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        Returns information about the details of an artifact.
        :param pulumi.Input[builtins.int] maximum_count: The maximum number of artifacts allowed for the action type.
        :param pulumi.Input[builtins.int] minimum_count: The minimum number of artifacts allowed for the action type.
        """
...
class CustomActionTypeConfigurationPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] secret: Whether the configuration property is secret. Secrets are hidden from all calls except for GetJobDetails, GetThirdPartyJobDetails, PollForJobs, and PollForThirdPartyJobs.
        :param pulumi.Input[builtins.str] description: The description of the action configuration property that is displayed to users. 
        :param pulumi.Input[builtins.bool] queryable: Indicates that the property is used with PollForJobs. When creating a custom action, an action can have up to one queryable property. If it has one, that property must be both required and not secret.If you create a pipeline with a custom action type, and that custom action contains a queryable property, the value for that configuration property is subject to other restrictions. The value must be less than or equal to twenty (20) characters. The value can contain only alphanumeric characters, underscores, and hyphens. 
        :param pulumi.Input[builtins.str] type: The type of the configuration property.
        """
...
class CustomActionTypeSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        Settings is a property of the AWS::CodePipeline::CustomActionType resource that provides URLs that users can access to view information about the CodePipeline custom action. 
        :param pulumi.Input[builtins.str] entity_url_template: The URL returned to the AWS CodePipeline console that provides a deep link to the resources of the external system, such as the configuration page for an AWS CodeDeploy deployment group. This link is provided as part of the action display in the pipeline. 
        :param pulumi.Input[builtins.str] execution_url_template: The URL returned to the AWS CodePipeline console that contains a link to the top-level landing page for the external system, such as the console page for AWS CodeDeploy. This link is shown on the pipeline view page in the AWS CodePipeline console and provides a link to the execution entity of the external action. 
...
class PipelineActionDeclarationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PipelineInputArtifactArgs']]] input_artifacts: The name or ID of the artifact consumed by the action, such as a test or build artifact. While the field is not a required parameter, most actions have an action configuration that requires a specified quantity of input artifacts. To refer to the action configuration specification by action provider, see the [Action structure reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html) in the *AWS CodePipeline User Guide* .
               ...
               > For a CodeBuild action with multiple input artifacts, one of your input sources must be designated the PrimarySource. For more information, see the [CodeBuild action reference page](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference-CodeBuild.html) in the *AWS CodePipeline User Guide* .
        :param pulumi.Input[builtins.str] namespace: The variable namespace associated with the action. All variables produced as output by this action fall under this namespace.
        :param pulumi.Input[Sequence[pulumi.Input['PipelineOutputArtifactArgs']]] output_artifacts: The name or ID of the result of the action declaration, such as a test or build artifact. While the field is not a required parameter, most actions have an action configuration that requires a specified quantity of output artifacts. To refer to the action configuration specification by action provider, see the [Action structure reference](https://docs.aws.amazon.com/codepipeline/latest/userguide/action-reference.html) in the *AWS CodePipeline User Guide* .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] output_variables: The list of variables that are to be exported from the compute action.
        :param pulumi.Input[builtins.str] region: The action declaration's AWS Region, such as us-east-1.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM service role that performs the declared action. This is assumed through the roleArn for the pipeline.
        :param pulumi.Input[builtins.int] run_order: The order in which actions are run.
        :param pulumi.Input[builtins.int] timeout_in_minutes: A timeout duration in minutes that can be applied against the ActionType’s default timeout value specified in Quotas for AWS CodePipeline. This attribute is available only to the manual approval ActionType.
        """
...
class PipelineActionTypeIdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] owner: The creator of the action being called. There are three valid values for the Owner field in the action category section within your pipeline structure: AWS, ThirdParty, and Custom.
        :param pulumi.Input[builtins.str] provider: The provider of the service being called by the action. Valid providers are determined by the action category. For example, an action in the Deploy category type might have a provider of CodeDeploy, which would be specified as CodeDeploy.
        :param pulumi.Input[builtins.str] version: A string that describes the action version.
        """
...
class PipelineArtifactStoreArgs:
    def __init__(__self__, *,
        ...
        """
        The S3 bucket where artifacts for the pipeline are stored.
        :param pulumi.Input[builtins.str] location: The S3 bucket used for storing the artifacts for a pipeline. You can specify the name of an S3 bucket but not a folder in the bucket. A folder to contain the pipeline artifacts is created for you based on the name of the pipeline. You can use any S3 bucket in the same AWS Region as the pipeline to store your pipeline artifacts.
...
class PipelineBlockerDeclarationArgs:
    def __init__(__self__, *,
        ...
        """
        Reserved for future use.
        :param pulumi.Input[builtins.str] name: Reserved for future use.
...
class PipelineConditionArgs:
    def __init__(__self__, *,
        ...
        """
        Represents information about condition.
        :param pulumi.Input[builtins.str] result: The specified result for when the failure conditions are met, such as rolling back the stage
...
class PipelineEncryptionKeyArgs:
    def __init__(__self__, *,
        ...
        """
        Represents information about the key used to encrypt data in the artifact store, such as an AWS Key Management Service (AWS KMS) key
        :param pulumi.Input[builtins.str] id: The ID used to identify the key. For an AWS KMS key, you can use the key ID, the key ARN, or the alias ARN.
        :param pulumi.Input[builtins.str] type: The type of encryption key, such as an AWS KMS key. When creating or updating a pipeline, the value must be set to 'KMS'.
        """
...
class PipelineGitBranchFilterCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        The Git repository branches specified as filter criteria to start the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: The list of patterns of Git branches that, when a commit is pushed, are to be excluded from starting the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: The list of patterns of Git branches that, when a commit is pushed, are to be included as criteria that starts the pipeline.
        """
...
class PipelineGitFilePathFilterCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        The Git repository file paths specified as filter criteria to start the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: The list of patterns of Git repository file paths that, when a commit is pushed, are to be excluded from starting the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: The list of patterns of Git repository file paths that, when a commit is pushed, are to be included as criteria that starts the pipeline.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if includes is not None:
...
class PipelineGitPullRequestFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The field that specifies which pull request events to filter on (opened, updated, closed) for the trigger configuration.
...
class PipelineGitTagFilterCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        The Git tags specified as filter criteria for whether a Git tag repository event will start the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: The list of patterns of Git tags that, when pushed, are to be excluded from starting the pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: The list of patterns of Git tags that, when pushed, are to be included as criteria that starts the pipeline.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if includes is not None:
...
class PipelineInputArtifactArgs:
    def __init__(__self__, *,
        ...
        """
        Represents information about an artifact to be worked on, such as a test or build artifact.
        :param pulumi.Input[builtins.str] name: The name of the artifact to be worked on (for example, "My App").
        """
        pulumi.set(__self__, "name", name)
...
class PipelineOutputArtifactArgs:
    def __init__(__self__, *,
        ...
        """
        Represents information about the output of an action.
        :param pulumi.Input[builtins.str] name: The name of the output of an artifact, such as "My App".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] files: The files that you want to associate with the output artifact that will be exported from the compute action.
        """
        pulumi.set(__self__, "name", name)
...
class PipelineRuleDeclarationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The rule declaration's name.
        :param pulumi.Input[builtins.str] region: The rule declaration's AWS Region, such as us-east-1.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the IAM service role that performs the declared rule. This is assumed through the roleArn for the pipeline.
...
class PipelineRuleTypeIdArgs:
    def __init__(__self__, *,
        ...
        """
        Represents information about a rule type.
        :param pulumi.Input[builtins.str] category: A category for the provider type for the rule.
        :param pulumi.Input[builtins.str] owner: The creator of the rule being called. Only AWS is supported.
        :param pulumi.Input[builtins.str] provider: The provider of the service being called by the rule.
...
class PipelineStageTransitionArgs:
    def __init__(__self__, *,
        ...
        """
        The name of the pipeline in which you want to disable the flow of artifacts from one stage to another.
        :param pulumi.Input[builtins.str] reason: The reason given to the user that a stage is disabled, such as waiting for manual approval or manual tests. This message is displayed in the pipeline console UI.
        :param pulumi.Input[builtins.str] stage_name: The name of the stage where you want to disable the inbound or outbound transition of artifacts.
        """
...
class PipelineVariableDeclarationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_value: The value of a pipeline-level variable.
        :param pulumi.Input[builtins.str] description: The description of a pipeline-level variable. It's used to add additional context about the variable, and not being used at time when pipeline executes.
        """
        pulumi.set(__self__, "name", name)
