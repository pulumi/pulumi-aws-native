...
class PipelineArgs:
    def __init__(__self__, *,
                 ...
                 restart_execution_on_update: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) for CodePipeline to use to either perform actions with no actionRoleArn, or to use to assume roles for actions with an actionRoleArn
        ...
        :param pulumi.Input[builtins.bool] restart_execution_on_update: Indicates whether to rerun the CodePipeline pipeline after you update it.
    ...
    def restart_execution_on_update(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def restart_execution_on_update(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Pipeline(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="restartExecutionOnUpdate")
    def restart_execution_on_update(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to rerun the CodePipeline pipeline after you update it.
        """
        return pulumi.get(self, "restart_execution_on_update")
