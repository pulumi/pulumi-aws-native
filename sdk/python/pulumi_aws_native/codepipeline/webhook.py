...
class WebhookArgs:
    def __init__(__self__, *,
                 ...
                 register_with_third_party: Optional[pulumi.Input[builtins.bool]] = None,
                 target_pipeline_version: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] target_action: The name of the action in a pipeline you want to connect to the webhook.
        :param pulumi.Input[builtins.str] target_pipeline: The name of the pipeline you want to connect to the webhook.
        :param pulumi.Input[builtins.str] name: The name of the webhook
        :param pulumi.Input[builtins.bool] register_with_third_party: Configures a connection between the webhook that was created and the external tool with events to be detected.
        :param pulumi.Input[builtins.int] target_pipeline_version: The version number of the pipeline to be connected to the trigger request.
        """
    ...
    def register_with_third_party(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def register_with_third_party(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "register_with_third_party", value)

    @property
    @pulumi.getter(name="targetPipelineVersion")
    def target_pipeline_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_pipeline_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Webhook(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="registerWithThirdParty")
    def register_with_third_party(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Configures a connection between the webhook that was created and the external tool with events to be detected.
        """
        return pulumi.get(self, "register_with_third_party")
    ...
    @property
    @pulumi.getter(name="targetPipelineVersion")
    def target_pipeline_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The version number of the pipeline to be connected to the trigger request.
        """
        return pulumi.get(self, "target_pipeline_version")
