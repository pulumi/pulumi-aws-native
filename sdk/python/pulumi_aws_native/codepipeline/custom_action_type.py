...
class CustomActionType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(input_artifact_details, CustomActionTypeArtifactDetailsArgs):
            ...
            if not isinstance(output_artifact_details, CustomActionTypeArtifactDetailsArgs):
            ...
            if not isinstance(settings, CustomActionTypeSettingsArgs):
