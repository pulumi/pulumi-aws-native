...
class CustomActionTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: The category of the custom action, such as a build action or a test action.
        ...
        :param pulumi.Input[builtins.str] provider: The provider of the service used in the custom action, such as AWS CodeDeploy.
        :param pulumi.Input[builtins.str] version: The version identifier of the custom action.
