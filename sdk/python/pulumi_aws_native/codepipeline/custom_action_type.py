...
class CustomActionType(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CustomActionTypePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CustomActionTypePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CustomActionTypeAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CustomActionTypeProperties']:
        """
