...
class PipelineActionDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str namespace: The variable namespace associated with the action. All variables produced as output by this action fall under this namespace.
        ...
        :param Sequence[_builtins.str] output_variables: The list of variables that are to be exported from the compute action.
        :param _builtins.str region: The action declaration's AWS Region, such as us-east-1.
        :param _builtins.str role_arn: The ARN of the IAM service role that performs the declared action. This is assumed through the roleArn for the pipeline.
        :param _builtins.int run_order: The order in which actions are run.
        :param _builtins.int timeout_in_minutes: A timeout duration in minutes that can be applied against the ActionType’s default timeout value specified in Quotas for AWS CodePipeline. This attribute is available only to the manual approval ActionType.
        """
...
class PipelineActionTypeId(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: A string that describes the action version.
        """
...
class PipelineRuleDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The rule declaration's name.
        :param _builtins.str region: The rule declaration's AWS Region, such as us-east-1.
        :param _builtins.str role_arn: The ARN of the IAM service role that performs the declared rule. This is assumed through the roleArn for the pipeline.
...
class WebhookFilterRule(dict):
    ...
    def match_equals(self) -> Optional[_builtins.str]:
        """
