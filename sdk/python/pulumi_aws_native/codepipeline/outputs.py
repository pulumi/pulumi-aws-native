...
class CustomActionTypeArtifactDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Returns information about the details of an artifact.
        :param builtins.int maximum_count: The maximum number of artifacts allowed for the action type.
        :param builtins.int minimum_count: The minimum number of artifacts allowed for the action type.
        """
...
class CustomActionTypeConfigurationProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool secret: Whether the configuration property is secret. Secrets are hidden from all calls except for GetJobDetails, GetThirdPartyJobDetails, PollForJobs, and PollForThirdPartyJobs.
        :param builtins.str description: The description of the action configuration property that is displayed to users. 
        :param builtins.bool queryable: Indicates that the property is used with PollForJobs. When creating a custom action, an action can have up to one queryable property. If it has one, that property must be both required and not secret.If you create a pipeline with a custom action type, and that custom action contains a queryable property, the value for that configuration property is subject to other restrictions. The value must be less than or equal to twenty (20) characters. The value can contain only alphanumeric characters, underscores, and hyphens. 
        :param builtins.str type: The type of the configuration property.
        """
...
class CustomActionTypeSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings is a property of the AWS::CodePipeline::CustomActionType resource that provides URLs that users can access to view information about the CodePipeline custom action. 
        :param builtins.str entity_url_template: The URL returned to the AWS CodePipeline console that provides a deep link to the resources of the external system, such as the configuration page for an AWS CodeDeploy deployment group. This link is provided as part of the action display in the pipeline. 
        :param builtins.str execution_url_template: The URL returned to the AWS CodePipeline console that contains a link to the top-level landing page for the external system, such as the console page for AWS CodeDeploy. This link is shown on the pipeline view page in the AWS CodePipeline console and provides a link to the execution entity of the external action. 
...
class PipelineActionDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str namespace: The variable namespace associated with the action. All variables produced as output by this action fall under this namespace.
        ...
        :param Sequence[builtins.str] output_variables: The list of variables that are to be exported from the compute action.
        :param builtins.str region: The action declaration's AWS Region, such as us-east-1.
        :param builtins.str role_arn: The ARN of the IAM service role that performs the declared action. This is assumed through the roleArn for the pipeline.
        :param builtins.int run_order: The order in which actions are run.
        :param builtins.int timeout_in_minutes: A timeout duration in minutes that can be applied against the ActionType’s default timeout value specified in Quotas for AWS CodePipeline. This attribute is available only to the manual approval ActionType.
        """
...
class PipelineActionTypeId(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str owner: The creator of the action being called. There are three valid values for the Owner field in the action category section within your pipeline structure: AWS, ThirdParty, and Custom.
        :param builtins.str provider: The provider of the service being called by the action. Valid providers are determined by the action category. For example, an action in the Deploy category type might have a provider of CodeDeploy, which would be specified as CodeDeploy.
        :param builtins.str version: A string that describes the action version.
        """
...
class PipelineArtifactStore(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The S3 bucket where artifacts for the pipeline are stored.
        :param builtins.str location: The S3 bucket used for storing the artifacts for a pipeline. You can specify the name of an S3 bucket but not a folder in the bucket. A folder to contain the pipeline artifacts is created for you based on the name of the pipeline. You can use any S3 bucket in the same AWS Region as the pipeline to store your pipeline artifacts.
...
class PipelineBlockerDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reserved for future use.
        :param builtins.str name: Reserved for future use.
...
class PipelineCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents information about condition.
        :param builtins.str result: The specified result for when the failure conditions are met, such as rolling back the stage
...
class PipelineEncryptionKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents information about the key used to encrypt data in the artifact store, such as an AWS Key Management Service (AWS KMS) key
        :param builtins.str id: The ID used to identify the key. For an AWS KMS key, you can use the key ID, the key ARN, or the alias ARN.
        :param builtins.str type: The type of encryption key, such as an AWS KMS key. When creating or updating a pipeline, the value must be set to 'KMS'.
        """
...
class PipelineGitBranchFilterCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Git repository branches specified as filter criteria to start the pipeline.
        :param Sequence[builtins.str] excludes: The list of patterns of Git branches that, when a commit is pushed, are to be excluded from starting the pipeline.
        :param Sequence[builtins.str] includes: The list of patterns of Git branches that, when a commit is pushed, are to be included as criteria that starts the pipeline.
        """
...
class PipelineGitFilePathFilterCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Git repository file paths specified as filter criteria to start the pipeline.
        :param Sequence[builtins.str] excludes: The list of patterns of Git repository file paths that, when a commit is pushed, are to be excluded from starting the pipeline.
        :param Sequence[builtins.str] includes: The list of patterns of Git repository file paths that, when a commit is pushed, are to be included as criteria that starts the pipeline.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if includes is not None:
...
class PipelineGitPullRequestFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] events: The field that specifies which pull request events to filter on (opened, updated, closed) for the trigger configuration.
...
class PipelineGitTagFilterCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Git tags specified as filter criteria for whether a Git tag repository event will start the pipeline.
        :param Sequence[builtins.str] excludes: The list of patterns of Git tags that, when pushed, are to be excluded from starting the pipeline.
        :param Sequence[builtins.str] includes: The list of patterns of Git tags that, when pushed, are to be included as criteria that starts the pipeline.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if includes is not None:
...
class PipelineInputArtifact(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents information about an artifact to be worked on, such as a test or build artifact.
        :param builtins.str name: The name of the artifact to be worked on (for example, "My App").
        """
        pulumi.set(__self__, "name", name)
...
class PipelineOutputArtifact(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents information about the output of an action.
        :param builtins.str name: The name of the output of an artifact, such as "My App".
        :param Sequence[builtins.str] files: The files that you want to associate with the output artifact that will be exported from the compute action.
        """
        pulumi.set(__self__, "name", name)
...
class PipelineRuleDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The rule declaration's name.
        :param builtins.str region: The rule declaration's AWS Region, such as us-east-1.
        :param builtins.str role_arn: The ARN of the IAM service role that performs the declared rule. This is assumed through the roleArn for the pipeline.
...
class PipelineRuleTypeId(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents information about a rule type.
        :param builtins.str category: A category for the provider type for the rule.
        :param builtins.str owner: The creator of the rule being called. Only AWS is supported.
        :param builtins.str provider: The provider of the service being called by the rule.
...
class PipelineStageTransition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The name of the pipeline in which you want to disable the flow of artifacts from one stage to another.
        :param builtins.str reason: The reason given to the user that a stage is disabled, such as waiting for manual approval or manual tests. This message is displayed in the pipeline console UI.
        :param builtins.str stage_name: The name of the stage where you want to disable the inbound or outbound transition of artifacts.
        """
...
class PipelineVariableDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str default_value: The value of a pipeline-level variable.
        :param builtins.str description: The description of a pipeline-level variable. It's used to add additional context about the variable, and not being used at time when pipeline executes.
        """
        pulumi.set(__self__, "name", name)
