...
class GetAliasResult:
    ...
    def target_key_id(self) -> Optional[builtins.str]:
        """
...
def get_alias(alias_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alias_name: Specifies the alias name. This value must begin with ``alias/`` followed by a name, such as ``alias/ExampleAlias``. 
