...
def get_replica_key(key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str key_id: The key ID of the replica key, such as `mrk-1234abcd12ab34cd56ef1234567890ab` .
...
def get_replica_key_output(key_id: Optional[pulumi.Input[builtins.str]] = None,
