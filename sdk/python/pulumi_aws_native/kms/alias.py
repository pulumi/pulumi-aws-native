...
class AliasArgs:
    def __init__(__self__, *,
                 target_key_id: pulumi.Input[builtins.str],
                 alias_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Alias resource.
        :param pulumi.Input[builtins.str] target_key_id: Associates the alias with the specified [](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk). The KMS key must be in the same AWS-account and Region.
    ...
    def target_key_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_key_id(self, value: pulumi.Input[builtins.str]):
...
class Alias(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 alias_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="targetKeyId")
    def target_key_id(self) -> pulumi.Output[builtins.str]:
        """
        Associates the alias with the specified [](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk). The KMS key must be in the same AWS-account and Region.
         A valid key ID is required. If you supply a null or empty string value, this operation returns an error.
         For help finding the key ID and ARN, see [Finding the key ID and ARN](https://docs.aws.amazon.com/kms/latest/developerguide/viewing-keys.html#find-cmk-id-arn) in the *Developer Guide*.
