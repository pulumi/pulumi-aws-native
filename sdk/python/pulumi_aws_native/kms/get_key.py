...
class GetKeyResult:
    ...
    def enable_key_rotation(self) -> Optional[_builtins.bool]:
        """
    ...
    def multi_region(self) -> Optional[_builtins.bool]:
        """
...
def get_key(key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key_id: The key ID of the KMS key, such as `1234abcd-12ab-34cd-56ef-1234567890ab` .
