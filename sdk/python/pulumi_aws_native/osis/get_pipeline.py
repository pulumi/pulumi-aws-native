...
class GetPipelineResult:
    ...
    def pipeline_arn(self) -> Optional[builtins.str]:
        """
    ...
    def pipeline_configuration_body(self) -> Optional[builtins.str]:
        """
...
def get_pipeline(pipeline_arn: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPipelineResult:
    """
    An OpenSearch Ingestion Service Data Prepper pipeline running Data Prepper.


    :param builtins.str pipeline_arn: The Amazon Resource Name (ARN) of the pipeline.
    """
    __args__ = dict()
...
def get_pipeline_output(pipeline_arn: Optional[pulumi.Input[builtins.str]] = None,
