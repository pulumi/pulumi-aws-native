...
class PipelineEncryptionAtRestOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Key-value pairs to configure encryption at rest.
        :param builtins.str kms_key_arn: The KMS key to use for encrypting data. By default an AWS owned key is used
        """
...
class PipelineVpcEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str vpc_id: The ID for your VPC. AWS Privatelink generates this value when you create a VPC.
...
class PipelineVpcOptionsVpcAttachmentOptionsProperties(dict):
    ...
    def __init__(__self__, *,
                 attach_to_vpc: builtins.bool,
                 cidr_block: builtins.str):
        """
        Options for attaching a VPC to the pipeline.
        :param builtins.bool attach_to_vpc: Whether the pipeline should be attached to the provided VPC
        :param builtins.str cidr_block: The CIDR block to be reserved for OpenSearch Ingestion to create elastic network interfaces (ENIs).
        """
    ...
    def attach_to_vpc(self) -> builtins.bool:
        """
