...
class AssessmentTemplateArgs:
    def __init__(__self__, *,
                 assessment_target_arn: pulumi.Input[builtins.str],
                 duration_in_seconds: pulumi.Input[builtins.int],
                 rules_package_arns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 assessment_template_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] assessment_target_arn: The ARN of the assessment target to be included in the assessment template.
        :param pulumi.Input[builtins.int] duration_in_seconds: The duration of the assessment run in seconds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rules_package_arns: The ARNs of the rules packages that you want to use in the assessment template.
        :param pulumi.Input[builtins.str] assessment_template_name: The user-defined name that identifies the assessment template that you want to create. You can create several assessment templates for the same assessment target. The names of the assessment templates that correspond to a particular assessment target must be unique.
    ...
    def assessment_target_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assessment_target_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def assessment_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assessment_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AssessmentTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assessment_target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 assessment_template_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="assessmentTargetArn")
    def assessment_target_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the assessment target to be included in the assessment template.
        """
        return pulumi.get(self, "assessment_target_arn")
    ...
    @property
    @pulumi.getter(name="assessmentTemplateName")
    def assessment_template_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user-defined name that identifies the assessment template that you want to create. You can create several assessment templates for the same assessment target. The names of the assessment templates that correspond to a particular assessment target must be unique.
        """
        return pulumi.get(self, "assessment_template_name")
