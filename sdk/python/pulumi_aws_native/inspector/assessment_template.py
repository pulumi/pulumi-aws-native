...
class AssessmentTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AssessmentTemplateTagArgs']]] user_attributes_for_findings: A key and value pair. This data type is used as a request parameter in the `SetTagsForResource` action and a response element in the `ListTagsForResource` action.
        """
...
class AssessmentTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[int] duration_in_seconds: The duration of the assessment run in seconds.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] rules_package_arns: The ARNs of the rules packages that you want to use in the assessment template.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AssessmentTemplateTagArgs']]]] user_attributes_for_findings: A key and value pair. This data type is used as a request parameter in the `SetTagsForResource` action and a response element in the `ListTagsForResource` action.
        """
        ...
    @overload
    def __init__(__self__,
