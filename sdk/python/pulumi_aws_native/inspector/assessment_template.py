...
class AssessmentTemplateArgs:
    def __init__(__self__, *,
                 assessment_target_arn: pulumi.Input[_builtins.str],
                 duration_in_seconds: pulumi.Input[_builtins.int],
                 rules_package_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 assessment_template_name: pulumi.Input[Optional[_builtins.str]] = None,
                 user_attributes_for_findings: pulumi.Input[Optional[Sequence[pulumi.Input['AssessmentTemplateTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] assessment_template_name: The user-defined name that identifies the assessment template that you want to create. You can create several assessment templates for the same assessment target. The names of the assessment templates that correspond to a particular assessment target must be unique.
    ...
    def assessment_target_arn(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def assessment_target_arn(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "assessment_target_arn", value)

    @_builtins.property
    @pulumi.getter(name="durationInSeconds")
    def duration_in_seconds(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def duration_in_seconds(self, value: pulumi.Input[_builtins.int]):
    ...
    def assessment_template_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def assessment_template_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "assessment_template_name", value)

    @_builtins.property
    @pulumi.getter(name="userAttributesForFindings")
    def user_attributes_for_findings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AssessmentTemplateTagArgs']]]]:
        """
    ...
    def user_attributes_for_findings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AssessmentTemplateTagArgs']]]]):
...
class AssessmentTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assessment_target_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 assessment_template_name: pulumi.Input[Optional[_builtins.str]] = None,
                 duration_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 rules_package_arns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 user_attributes_for_findings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AssessmentTemplateTagArgs', 'AssessmentTemplateTagArgsDict', 'outputs.AssessmentTemplateTag']]]]] = None,
                 __props__=None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="assessmentTargetArn")
    def assessment_target_arn(self) -> pulumi.Output[_builtins.str]:
        """
        The ARN of the assessment target to be included in the assessment template.
        """
        return pulumi.get(self, "assessment_target_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="assessmentTemplateName")
    def assessment_template_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The user-defined name that identifies the assessment template that you want to create. You can create several assessment templates for the same assessment target. The names of the assessment templates that correspond to a particular assessment target must be unique.
        """
        return pulumi.get(self, "assessment_template_name")
    ...
    @_builtins.property
    @pulumi.getter(name="durationInSeconds")
    def duration_in_seconds(self) -> pulumi.Output[_builtins.int]:
        """
        The duration of the assessment run in seconds.
        """
        return pulumi.get(self, "duration_in_seconds")
