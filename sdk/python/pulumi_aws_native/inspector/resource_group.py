...
class ResourceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource_group_tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourceGroupTagArgs', 'ResourceGroupTagArgsDict', 'outputs.ResourceGroupTag']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResourceGroupTagArgs', 'ResourceGroupTagArgsDict', 'outputs.ResourceGroupTag']]]] resource_group_tags: The tags (key and value pairs) that will be associated with the resource group.
