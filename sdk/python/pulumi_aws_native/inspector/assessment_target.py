...
class AssessmentTargetArgs:
    def __init__(__self__, *,
                 assessment_target_name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AssessmentTarget resource.
        :param pulumi.Input[builtins.str] assessment_target_name: The name of the Amazon Inspector assessment target. The name must be unique within the AWS account .
        :param pulumi.Input[builtins.str] resource_group_arn: The ARN that specifies the resource group that is used to create the assessment target. If `resourceGroupArn` is not specified, all EC2 instances in the current AWS account and Region are included in the assessment target.
        """
    ...
    def assessment_target_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assessment_target_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assessment_target_name", value)

    @property
    @pulumi.getter(name="resourceGroupArn")
    def resource_group_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_group_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AssessmentTarget(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assessmentTargetName")
    def assessment_target_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Amazon Inspector assessment target. The name must be unique within the AWS account .
        """
        return pulumi.get(self, "assessment_target_name")
    ...
    @property
    @pulumi.getter(name="resourceGroupArn")
    def resource_group_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN that specifies the resource group that is used to create the assessment target. If `resourceGroupArn` is not specified, all EC2 instances in the current AWS account and Region are included in the assessment target.
        """
        return pulumi.get(self, "resource_group_arn")
