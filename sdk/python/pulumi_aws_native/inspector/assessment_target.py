...
class AssessmentTarget(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AssessmentTargetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AssessmentTargetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AssessmentTargetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AssessmentTargetProperties']:
        """
