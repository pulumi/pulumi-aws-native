...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "aws-native:Inspector:AssessmentTarget":
                return AssessmentTarget(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:Inspector:AssessmentTemplate":
                return AssessmentTemplate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "aws-native:Inspector:ResourceGroup":
    ...
    pulumi.runtime.register_resource_module("aws-native", "Inspector", _module_instance)
