...
def get_resource_group(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: The Amazon Resource Name (ARN) that specifies the resource group that is created.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_resource_group_output(arn: Optional[pulumi.Input[builtins.str]] = None,
