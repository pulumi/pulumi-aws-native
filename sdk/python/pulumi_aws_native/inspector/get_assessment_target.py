...
class GetAssessmentTargetResult:
    ...
    def resource_group_arn(self) -> Optional[_builtins.str]:
        """
...
def get_assessment_target(arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arn: The Amazon Resource Name (ARN) that specifies the assessment target that is created.
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_assessment_target_output(arn: Optional[pulumi.Input[_builtins.str]] = None,
