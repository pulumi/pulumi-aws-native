...
class GetAccessGrantsLocationResult:
    ...
    def access_grants_location_arn(self) -> Optional[_builtins.str]:
        """
    ...
    def location_scope(self) -> Optional[_builtins.str]:
        """
...
def get_access_grants_location(access_grants_location_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str access_grants_location_id: The unique identifier for the specified Access Grants location.
    """
    __args__ = dict()
