...
def get_multi_region_access_point(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name you want to assign to this Multi Region Access Point.
    """
    __args__ = dict()
    __args__['name'] = name
