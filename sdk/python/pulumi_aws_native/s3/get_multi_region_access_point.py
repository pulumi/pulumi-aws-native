...
def get_multi_region_access_point(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name you want to assign to this Multi Region Access Point.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_multi_region_access_point_output(name: Optional[pulumi.Input[builtins.str]] = None,
