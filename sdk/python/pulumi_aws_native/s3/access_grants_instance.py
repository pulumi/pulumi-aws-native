...
class AccessGrantsInstanceArgs:
    def __init__(__self__, *,
                 identity_center_arn: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['_root_inputs.CreateOnlyTagArgs']]]] = None):
        """
        The set of arguments for constructing a AccessGrantsInstance resource.
        :param pulumi.Input[builtins.str] identity_center_arn: The Amazon Resource Name (ARN) of the specified AWS Identity Center.
    ...
    def identity_center_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_center_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws-native:s3:AccessGrantsInstance")
class AccessGrantsInstance(pulumi.CustomResource):
    ...
    def access_grants_instance_arn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def access_grants_instance_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="identityCenterArn")
    def identity_center_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the specified AWS Identity Center.
        """
        return pulumi.get(self, "identity_center_arn")
