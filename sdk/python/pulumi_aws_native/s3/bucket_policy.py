...
class BucketPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BucketPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['BucketPolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.BucketPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BucketPolicyProperties']:
        """
