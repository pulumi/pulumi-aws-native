...
class GetAccessGrantResult:
    ...
    def access_grant_arn(self) -> Optional[builtins.str]:
        """
    ...
    def access_grant_id(self) -> Optional[builtins.str]:
        """
    ...
    def grant_scope(self) -> Optional[builtins.str]:
        """
...
def get_access_grant(access_grant_id: Optional[builtins.str] = None,
    ...
    :param builtins.str access_grant_id: The ID assigned to this access grant.
    """
    __args__ = dict()
...
def get_access_grant_output(access_grant_id: Optional[pulumi.Input[builtins.str]] = None,
