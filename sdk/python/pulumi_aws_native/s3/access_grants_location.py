...
class AccessGrantsLocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] iam_role_arn: The Amazon Resource Name (ARN) of the access grant location's associated IAM role.
        :param pulumi.Input[builtins.str] location_scope: Descriptor for where the location actually points
...
class AccessGrantsLocation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="locationScope")
    def location_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Descriptor for where the location actually points
        """
        return pulumi.get(self, "location_scope")
