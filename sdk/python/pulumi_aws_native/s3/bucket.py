...
class Bucket(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 abac_status: pulumi.Input[Optional['BucketAbacStatus']] = None,
                 accelerate_configuration: pulumi.Input[Optional[Union['BucketAccelerateConfigurationArgs', 'BucketAccelerateConfigurationArgsDict', 'outputs.BucketAccelerateConfiguration']]] = None,
                 access_control: pulumi.Input[Optional['BucketAccessControl']] = None,
                 analytics_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketAnalyticsConfigurationArgs', 'BucketAnalyticsConfigurationArgsDict', 'outputs.BucketAnalyticsConfiguration']]]]] = None,
                 bucket_encryption: pulumi.Input[Optional[Union['BucketEncryptionArgs', 'BucketEncryptionArgsDict', 'outputs.BucketEncryption']]] = None,
                 bucket_name: pulumi.Input[Optional[_builtins.str]] = None,
                 bucket_name_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 bucket_namespace: pulumi.Input[Optional['BucketNamespace']] = None,
                 cors_configuration: pulumi.Input[Optional[Union['BucketCorsConfigurationArgs', 'BucketCorsConfigurationArgsDict', 'outputs.BucketCorsConfiguration']]] = None,
                 intelligent_tiering_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketIntelligentTieringConfigurationArgs', 'BucketIntelligentTieringConfigurationArgsDict', 'outputs.BucketIntelligentTieringConfiguration']]]]] = None,
                 inventory_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketInventoryConfigurationArgs', 'BucketInventoryConfigurationArgsDict', 'outputs.BucketInventoryConfiguration']]]]] = None,
                 ...
                 logging_configuration: pulumi.Input[Optional[Union['BucketLoggingConfigurationArgs', 'BucketLoggingConfigurationArgsDict', 'outputs.BucketLoggingConfiguration']]] = None,
                 metadata_configuration: pulumi.Input[Optional[Union['BucketMetadataConfigurationArgs', 'BucketMetadataConfigurationArgsDict', 'outputs.BucketMetadataConfiguration']]] = None,
                 metadata_table_configuration: pulumi.Input[Optional[Union['BucketMetadataTableConfigurationArgs', 'BucketMetadataTableConfigurationArgsDict', 'outputs.BucketMetadataTableConfiguration']]] = None,
                 metrics_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketMetricsConfigurationArgs', 'BucketMetricsConfigurationArgsDict', 'outputs.BucketMetricsConfiguration']]]]] = None,
                 notification_configuration: pulumi.Input[Optional[Union['BucketNotificationConfigurationArgs', 'BucketNotificationConfigurationArgsDict', 'outputs.BucketNotificationConfiguration']]] = None,
                 object_lock_configuration: pulumi.Input[Optional[Union['BucketObjectLockConfigurationArgs', 'BucketObjectLockConfigurationArgsDict', 'outputs.BucketObjectLockConfiguration']]] = None,
                 object_lock_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ownership_controls: pulumi.Input[Optional[Union['BucketOwnershipControlsArgs', 'BucketOwnershipControlsArgsDict', 'outputs.BucketOwnershipControls']]] = None,
                 public_access_block_configuration: pulumi.Input[Optional[Union['BucketPublicAccessBlockConfigurationArgs', 'BucketPublicAccessBlockConfigurationArgsDict', 'outputs.BucketPublicAccessBlockConfiguration']]] = None,
                 replication_configuration: pulumi.Input[Optional[Union['BucketReplicationConfigurationArgs', 'BucketReplicationConfigurationArgsDict', 'outputs.BucketReplicationConfiguration']]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]]] = None,
                 versioning_configuration: pulumi.Input[Optional[Union['BucketVersioningConfigurationArgs', 'BucketVersioningConfigurationArgsDict', 'outputs.BucketVersioningConfiguration']]] = None,
                 website_configuration: pulumi.Input[Optional[Union['BucketWebsiteConfigurationArgs', 'BucketWebsiteConfigurationArgsDict', 'outputs.BucketWebsiteConfiguration']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input['BucketAbacStatus'] abac_status: The ABAC status of the general purpose bucket. When ABAC is enabled for the general purpose bucket, you can use tags to manage access to the general purpose buckets as well as for cost tracking purposes. When ABAC is disabled for the general purpose buckets, you can only use tags for cost tracking purposes. For more information, see [Using tags with S3 general purpose buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/buckets-tagging.html).
        :param pulumi.Input[Union['BucketAccelerateConfigurationArgs', 'BucketAccelerateConfigurationArgsDict', 'outputs.BucketAccelerateConfiguration']] accelerate_configuration: Configures the transfer acceleration state for an Amazon S3 bucket. For more information, see [Amazon S3 Transfer Acceleration](https://docs.aws.amazon.com/AmazonS3/latest/dev/transfer-acceleration.html) in the *Amazon S3 User Guide*.
        :param pulumi.Input['BucketAccessControl'] access_control: This is a legacy property, and it is not recommended for most use cases. A majority of modern use cases in Amazon S3 no longer require the use of ACLs, and we recommend that you keep ACLs disabled. For more information, see [Controlling object ownership](https://docs.aws.amazon.com//AmazonS3/latest/userguide/about-object-ownership.html) in the *Amazon S3 User Guide*.
                 A canned access control list (ACL) that grants predefined permissions to the bucket. For more information about canned ACLs, see [Canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl) in the *Amazon S3 User Guide*.
                 S3 buckets are created with ACLs disabled by default. Therefore, unless you explicitly set the [AWS::S3::OwnershipControls](https://docs.aws.amazon.com//AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket-ownershipcontrols.html) property to enable ACLs, your resource will fail to deploy with any value other than Private. Use cases requiring ACLs are uncommon.
                 The majority of access control configurations can be successfully and more easily achieved with bucket policies. For more information, see [AWS::S3::BucketPolicy](https://docs.aws.amazon.com//AWSCloudFormation/latest/UserGuide/aws-properties-s3-policy.html). For examples of common policy configurations, including S3 Server Access Logs buckets and more, see [Bucket policy examples](https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-bucket-policies.html) in the *Amazon S3 User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketAnalyticsConfigurationArgs', 'BucketAnalyticsConfigurationArgsDict', 'outputs.BucketAnalyticsConfiguration']]]] analytics_configurations: Specifies the configuration and any analyses for the analytics filter of an Amazon S3 bucket.
        :param pulumi.Input[Union['BucketEncryptionArgs', 'BucketEncryptionArgsDict', 'outputs.BucketEncryption']] bucket_encryption: Specifies default encryption for a bucket using server-side encryption with Amazon S3-managed keys (SSE-S3), AWS KMS-managed keys (SSE-KMS), or dual-layer server-side encryption with KMS-managed keys (DSSE-KMS). For information about the Amazon S3 default encryption feature, see [Amazon S3 Default Encryption for S3 Buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html) in the *Amazon S3 User Guide*.
        :param pulumi.Input[_builtins.str] bucket_name: A name for the bucket. If you don't specify a name, AWS CloudFormation generates a unique ID and uses that ID for the bucket name. The bucket name must contain only lowercase letters, numbers, periods (.), and dashes (-) and must follow [Amazon S3 bucket restrictions and limitations](https://docs.aws.amazon.com/AmazonS3/latest/dev/BucketRestrictions.html). For more information, see [Rules for naming Amazon S3 buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html) in the *Amazon S3 User Guide*.
                 If you specify a name, you can't perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you need to replace the resource, specify a new name.
        :param pulumi.Input[Union['BucketCorsConfigurationArgs', 'BucketCorsConfigurationArgsDict', 'outputs.BucketCorsConfiguration']] cors_configuration: Describes the cross-origin access configuration for objects in an Amazon S3 bucket. For more information, see [Enabling Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html) in the *Amazon S3 User Guide*.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketIntelligentTieringConfigurationArgs', 'BucketIntelligentTieringConfigurationArgsDict', 'outputs.BucketIntelligentTieringConfiguration']]]] intelligent_tiering_configurations: Defines how Amazon S3 handles Intelligent-Tiering storage.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketInventoryConfigurationArgs', 'BucketInventoryConfigurationArgsDict', 'outputs.BucketInventoryConfiguration']]]] inventory_configurations: Specifies the S3 Inventory configuration for an Amazon S3 bucket. For more information, see [GET Bucket inventory](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketGETInventoryConfig.html) in the *Amazon S3 API Reference*.
        :param pulumi.Input[Union['BucketLifecycleConfigurationArgs', 'BucketLifecycleConfigurationArgsDict', 'outputs.BucketLifecycleConfiguration']] lifecycle_configuration: Specifies the lifecycle configuration for objects in an Amazon S3 bucket. For more information, see [Object Lifecycle Management](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html) in the *Amazon S3 User Guide*.
        :param pulumi.Input[Union['BucketLoggingConfigurationArgs', 'BucketLoggingConfigurationArgsDict', 'outputs.BucketLoggingConfiguration']] logging_configuration: Settings that define where logs are stored.
        :param pulumi.Input[Union['BucketMetadataConfigurationArgs', 'BucketMetadataConfigurationArgsDict', 'outputs.BucketMetadataConfiguration']] metadata_configuration: The S3 Metadata configuration for a general purpose bucket.
        :param pulumi.Input[Union['BucketMetadataTableConfigurationArgs', 'BucketMetadataTableConfigurationArgsDict', 'outputs.BucketMetadataTableConfiguration']] metadata_table_configuration: The metadata table configuration of an S3 general purpose bucket.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketMetricsConfigurationArgs', 'BucketMetricsConfigurationArgsDict', 'outputs.BucketMetricsConfiguration']]]] metrics_configurations: Specifies a metrics configuration for the CloudWatch request metrics (specified by the metrics configuration ID) from an Amazon S3 bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. For more information, see [PutBucketMetricsConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTMetricConfiguration.html).
        :param pulumi.Input[Union['BucketNotificationConfigurationArgs', 'BucketNotificationConfigurationArgsDict', 'outputs.BucketNotificationConfiguration']] notification_configuration: Configuration that defines how Amazon S3 handles bucket notifications.
        :param pulumi.Input[Union['BucketObjectLockConfigurationArgs', 'BucketObjectLockConfigurationArgsDict', 'outputs.BucketObjectLockConfiguration']] object_lock_configuration: This operation is not supported for directory buckets.
                 Places an Object Lock configuration on the specified bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html).
                  +  The ``DefaultRetention`` settings require both a mode and a period.
                 +  The ``DefaultRetention`` period can be either ``Days`` or ``Years`` but you must select one. You cannot specify ``Days`` and ``Years`` at the same time.
                 +  You can enable Object Lock for new or existing buckets. For more information, see [Configuring Object Lock](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock-configure.html).
                  ...
                  You must URL encode any signed header values that contain spaces. For example, if your header value is ``my file.txt``, containing two spaces after ``my``, you must URL encode this value to ``my%20%20file.txt``.
        :param pulumi.Input[_builtins.bool] object_lock_enabled: Indicates whether this bucket has an Object Lock configuration enabled. Enable ``ObjectLockEnabled`` when you apply ``ObjectLockConfiguration`` to a bucket.
        :param pulumi.Input[Union['BucketOwnershipControlsArgs', 'BucketOwnershipControlsArgsDict', 'outputs.BucketOwnershipControls']] ownership_controls: Configuration that defines how Amazon S3 handles Object Ownership rules.
        :param pulumi.Input[Union['BucketPublicAccessBlockConfigurationArgs', 'BucketPublicAccessBlockConfigurationArgsDict', 'outputs.BucketPublicAccessBlockConfiguration']] public_access_block_configuration: Configuration that defines how Amazon S3 handles public access.
        :param pulumi.Input[Union['BucketReplicationConfigurationArgs', 'BucketReplicationConfigurationArgsDict', 'outputs.BucketReplicationConfiguration']] replication_configuration: Configuration for replicating objects in an S3 bucket. To enable replication, you must also enable versioning by using the ``VersioningConfiguration`` property.
                Amazon S3 can store replicated objects in a single destination bucket or multiple destination buckets. The destination bucket or buckets must already exist.
        :param pulumi.Input[Sequence[pulumi.Input[Union['_root_inputs.TagArgs', '_root_inputs.TagArgsDict', '_root_outputs.Tag']]]] tags: An arbitrary set of tags (key-value pairs) for this S3 bucket.
        :param pulumi.Input[Union['BucketVersioningConfigurationArgs', 'BucketVersioningConfigurationArgsDict', 'outputs.BucketVersioningConfiguration']] versioning_configuration: Enables multiple versions of all objects in this bucket. You might enable versioning to prevent objects from being deleted or overwritten by mistake or to archive objects so that you can retrieve previous versions of them.
                 When you enable versioning on a bucket for the first time, it might take a short amount of time for the change to be fully propagated. We recommend that you wait for 15 minutes after enabling versioning before issuing write operations (``PUT`` or ``DELETE``) on objects in the bucket.
        :param pulumi.Input[Union['BucketWebsiteConfigurationArgs', 'BucketWebsiteConfigurationArgsDict', 'outputs.BucketWebsiteConfiguration']] website_configuration: Information used to configure the bucket as a static website. For more information, see [Hosting Websites on Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteHosting.html).
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def dual_stack_domain_name(self) -> pulumi.Output[_builtins.str]:
        """
