...
class BucketAnalyticsConfigurationArgsDict(TypedDict):
    ...
    """
    tag_filters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketTagFilterArgs']]]]]
    """
...
class BucketInventoryTableConfigurationArgsDict(TypedDict):
    ...
    """
    encryption_configuration: NotRequired[pulumi.Input[Optional['BucketMetadataTableEncryptionConfigurationArgs']]]
    """
...
class BucketLambdaConfigurationArgsDict(TypedDict):
    ...
    """
    filter: NotRequired[pulumi.Input[Optional['BucketNotificationFilterArgs']]]
    """
...
class BucketLoggingConfigurationArgsDict(TypedDict):
    ...
    """
    target_object_key_format: NotRequired[pulumi.Input[Optional['BucketTargetObjectKeyFormatArgs']]]
    """
...
class BucketMetadataConfigurationArgsDict(TypedDict):
    ...
    """
    destination: NotRequired[pulumi.Input[Optional['BucketMetadataDestinationArgs']]]
    """
    The destination information for the S3 Metadata configuration.
    """
    inventory_table_configuration: NotRequired[pulumi.Input[Optional['BucketInventoryTableConfigurationArgs']]]
    """
...
class BucketMetricsArgsDict(TypedDict):
    ...
    """
    event_threshold: NotRequired[pulumi.Input[Optional['BucketReplicationTimeValueArgs']]]
    """
...
class BucketNotificationConfigurationArgsDict(TypedDict):
    ...
    """
    event_bridge_configuration: NotRequired[pulumi.Input[Optional['BucketEventBridgeConfigurationArgs']]]
    """
    Enables delivery of events to Amazon EventBridge.
    """
    lambda_configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketLambdaConfigurationArgs']]]]]
    """
    Describes the LAMlong functions to invoke and the events for which to invoke them.
    """
    queue_configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketQueueConfigurationArgs']]]]]
    """
    The Amazon Simple Queue Service queues to publish messages to and the events for which to publish messages.
    """
    topic_configurations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketTopicConfigurationArgs']]]]]
    """
...
class BucketObjectLockConfigurationArgsDict(TypedDict):
    ...
    """
    rule: NotRequired[pulumi.Input[Optional['BucketObjectLockRuleArgs']]]
    """
...
class BucketObjectLockRuleArgsDict(TypedDict):
    ...
    """
    default_retention: NotRequired[pulumi.Input[Optional['BucketDefaultRetentionArgs']]]
    """
...
class BucketReplicationDestinationArgsDict(TypedDict):
    ...
    """
    access_control_translation: NotRequired[pulumi.Input[Optional['BucketAccessControlTranslationArgs']]]
    """
    Specify this only in a cross-account scenario (where source and destination bucket owners are not the same), and you want to change replica ownership to the AWS-account that owns the destination bucket. If this is not specified in the replication configuration, the replicas are owned by same AWS-account that owns the source object.
    """
    ...
    """
    encryption_configuration: NotRequired[pulumi.Input[Optional['BucketEncryptionConfigurationArgs']]]
    """
    Specifies encryption-related information.
    """
    metrics: NotRequired[pulumi.Input[Optional['BucketMetricsArgs']]]
    """
    A container specifying replication metrics-related settings enabling replication metrics and events.
    """
    replication_time: NotRequired[pulumi.Input[Optional['BucketReplicationTimeArgs']]]
    """
...
class BucketReplicationRuleFilterArgsDict(TypedDict):
    ...
    """
    and_: NotRequired[pulumi.Input[Optional['BucketReplicationRuleAndOperatorArgs']]]
    """
    ...
    An object key name prefix that identifies the subset of objects to which the rule applies.
      Replacement must be made for object keys containing special characters (such as carriage returns) when using XML requests. For more information, see [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints).
    """
    tag_filter: NotRequired[pulumi.Input[Optional['BucketTagFilterArgs']]]
    """
...
class BucketReplicationRuleArgsDict(TypedDict):
    ...
    """
    delete_marker_replication: NotRequired[pulumi.Input[Optional['BucketDeleteMarkerReplicationArgs']]]
    """
    Specifies whether Amazon S3 replicates delete markers. If you specify a ``Filter`` in your replication configuration, you must also include a ``DeleteMarkerReplication`` element. If your ``Filter`` includes a ``Tag`` element, the ``DeleteMarkerReplication````Status`` must be set to Disabled, because Amazon S3 does not support replicating delete markers for tag-based rules. For an example configuration, see [Basic Rule Configuration](https://docs.aws.amazon.com/AmazonS3/latest/dev/replication-add-config.html#replication-config-min-rule-config). 
     For more information about delete marker replication, see [Basic Rule Configuration](https://docs.aws.amazon.com/AmazonS3/latest/dev/delete-marker-replication.html). 
      If you are using an earlier version of the replication configuration, Amazon S3 handles replication of delete markers differently. For more information, see [Backward Compatibility](https://docs.aws.amazon.com/AmazonS3/latest/dev/replication-add-config.html#replication-backward-compat-considerations).
    """
    filter: NotRequired[pulumi.Input[Optional['BucketReplicationRuleFilterArgs']]]
    """
    ...
    """
    source_selection_criteria: NotRequired[pulumi.Input[Optional['BucketSourceSelectionCriteriaArgs']]]
    """
...
class BucketRoutingRuleArgsDict(TypedDict):
    ...
    """
    routing_rule_condition: NotRequired[pulumi.Input[Optional['BucketRoutingRuleConditionArgs']]]
    """
    A container for describing a condition that must be met for the specified redirect to apply. For example, 1. If request is for pages in the ``/docs`` folder, redirect to the ``/documents`` folder. 2. If request results in HTTP error 4xx, redirect request to another host where you might process the error.
    """
...
class BucketRuleArgsDict(TypedDict):
    ...
    """
    noncurrent_version_expiration: NotRequired[pulumi.Input[Optional['BucketNoncurrentVersionExpirationArgs']]]
    """
    Specifies when noncurrent object versions expire. Upon expiration, S3 permanently deletes the noncurrent object versions. You set this lifecycle configuration action on a bucket that has versioning enabled (or suspended) to request that S3 delete noncurrent object versions at a specific period in the object's lifetime.
    """
    ...
    """
    noncurrent_version_transition: NotRequired[pulumi.Input[Optional['BucketNoncurrentVersionTransitionArgs']]]
    """
    (Deprecated.) For buckets with versioning enabled (or suspended), specifies when non-current objects transition to a specified storage class. If you specify a transition and expiration time, the expiration time must be later than the transition time. If you specify this property, don't specify the ``NoncurrentVersionTransitions`` property.
    """
    noncurrent_version_transitions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketNoncurrentVersionTransitionArgs']]]]]
    """
    ...
    """
    transition: NotRequired[pulumi.Input[Optional['BucketTransitionArgs']]]
    """
    (Deprecated.) Specifies when an object transitions to a specified storage class. If you specify an expiration and transition time, you must use the same time unit for both properties (either in days or by date). The expiration time must also be later than the transition time. If you specify this property, don't specify the ``Transitions`` property.
    """
    transitions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketTransitionArgs']]]]]
    """
...
class BucketServerSideEncryptionRuleArgsDict(TypedDict):
    ...
    Specifies the default server-side encryption configuration.
      ...
      +  *Directory buckets* - When you specify an [customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk) for encryption in your directory bucket, only use the key ID or key ARN. The key alias format of the KMS key isn't supported.
    """
    blocked_encryption_types: NotRequired[pulumi.Input[Optional['BucketBlockedEncryptionTypesArgs']]]
    """
    A bucket-level setting for Amazon S3 general purpose buckets used to prevent the upload of new objects encrypted with the specified server-side encryption type. For example, blocking an encryption type will block ``PutObject``, ``CopyObject``, ``PostObject``, multipart upload, and replication requests to the bucket for objects with the specified encryption type. However, you can continue to read and list any pre-existing objects already encrypted with the specified encryption type. For more information, see [Blocking or unblocking SSE-C for a general purpose bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/blocking-unblocking-s3-c-encryption-gpb.html).
      Currently, this parameter only supports blocking or unblocking server-side encryption with customer-provided keys (SSE-C). For more information about SSE-C, see [Using server-side encryption with customer-provided keys (SSE-C)](https://docs.aws.amazon.com/AmazonS3/latest/userguide/ServerSideEncryptionCustomerKeys.html).
    """
    ...
    """
    server_side_encryption_by_default: NotRequired[pulumi.Input[Optional['BucketServerSideEncryptionByDefaultArgs']]]
    """
...
class BucketSourceSelectionCriteriaArgsDict(TypedDict):
    ...
    A container that describes additional filters for identifying the source objects that you want to replicate. You can choose to enable or disable the replication of these objects.
    """
    replica_modifications: NotRequired[pulumi.Input[Optional['BucketReplicaModificationsArgs']]]
    """
    A filter that you can specify for selection for modifications on replicas.
    """
    sse_kms_encrypted_objects: NotRequired[pulumi.Input[Optional['BucketSseKmsEncryptedObjectsArgs']]]
    """
...
class BucketStorageClassAnalysisArgsDict(TypedDict):
    ...
    """
    data_export: NotRequired[pulumi.Input[Optional['BucketDataExportArgs']]]
    """
    Specifies how data related to the storage class analysis for an Amazon S3 bucket should be exported.
    """
...
class BucketWebsiteConfigurationArgsDict(TypedDict):
    ...
    """
    redirect_all_requests_to: NotRequired[pulumi.Input[Optional['BucketRedirectAllRequestsToArgs']]]
    """
    The redirect behavior for every request to this bucket's website endpoint.
      If you specify this property, you can't specify any other property.
    """
    routing_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BucketRoutingRuleArgs']]]]]
    """
...
class StorageLensAccountLevelArgsDict(TypedDict):
    ...
    """
    activity_metrics: NotRequired[pulumi.Input[Optional['StorageLensActivityMetricsArgs']]]
    """
    This property contains the details of account-level activity metrics for S3 Storage Lens.
    """
    advanced_cost_optimization_metrics: NotRequired[pulumi.Input[Optional['StorageLensAdvancedCostOptimizationMetricsArgs']]]
    """
    This property contains the details of account-level advanced cost optimization metrics for S3 Storage Lens.
    """
    advanced_data_protection_metrics: NotRequired[pulumi.Input[Optional['StorageLensAdvancedDataProtectionMetricsArgs']]]
    """
    This property contains the details of account-level advanced data protection metrics for S3 Storage Lens.
    """
    advanced_performance_metrics: NotRequired[pulumi.Input[Optional['StorageLensAdvancedPerformanceMetricsArgs']]]
    """
    This property contains the account-level details for S3 Storage Lens advanced performance metrics.
    """
    detailed_status_codes_metrics: NotRequired[pulumi.Input[Optional['StorageLensDetailedStatusCodesMetricsArgs']]]
    """
    This property contains the details of account-level detailed status code metrics for S3 Storage Lens.
    """
    storage_lens_group_level: NotRequired[pulumi.Input[Optional['StorageLensGroupLevelArgs']]]
    """
...
class StorageLensBucketLevelArgsDict(TypedDict):
    ...
    """
    prefix_level: NotRequired[pulumi.Input[Optional['StorageLensPrefixLevelArgs']]]
    """
...
class StorageLensConfigurationArgsDict(TypedDict):
    ...
    """
    aws_org: NotRequired[pulumi.Input[Optional['StorageLensAwsOrgArgs']]]
    """
    This property contains the details of the AWS Organization for the S3 Storage Lens configuration.
    """
    data_export: NotRequired[pulumi.Input[Optional['StorageLensDataExportArgs']]]
    """
    This property contains the details of this S3 Storage Lens configuration's metrics export.
    """
    exclude: NotRequired[pulumi.Input[Optional['StorageLensBucketsAndRegionsArgs']]]
    """
    This property contains the details of the bucket and or Regions excluded for Amazon S3 Storage Lens configuration.
    """
    expanded_prefixes_data_export: NotRequired[pulumi.Input[Optional['StorageLensExpandedPrefixesDataExportArgs']]]
    """
    This property configures your S3 Storage Lens expanded prefixes metrics report.
    """
    include: NotRequired[pulumi.Input[Optional['StorageLensBucketsAndRegionsArgs']]]
    """
...
class StorageLensDataExportArgsDict(TypedDict):
    ...
    """
    cloud_watch_metrics: NotRequired[pulumi.Input[Optional['StorageLensCloudWatchMetricsArgs']]]
    """
    This property enables the Amazon CloudWatch publishing option for S3 Storage Lens metrics.
    """
    s3_bucket_destination: NotRequired[pulumi.Input[Optional['StorageLensS3BucketDestinationArgs']]]
    """
    This property contains the details of the bucket where the S3 Storage Lens metrics export will be placed.
    """
    storage_lens_table_destination: NotRequired[pulumi.Input[Optional['StorageLensTableDestinationArgs']]]
    """
...
class StorageLensGroupAndArgsDict(TypedDict):
    ...
    """
    match_any_tag: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StorageLensGroupTagArgs']]]]]
    """
    ...
    """
    match_object_age: NotRequired[pulumi.Input[Optional['StorageLensGroupMatchObjectAgeArgs']]]
    """
    ...
    """
    match_object_size: NotRequired[pulumi.Input[Optional['StorageLensGroupMatchObjectSizeArgs']]]
    """
...
class StorageLensGroupFilterArgsDict(TypedDict):
    ...
    """
    and_: NotRequired[pulumi.Input[Optional['StorageLensGroupAndArgs']]]
    """
    ...
    This property contains `BytesGreaterThan` and `BytesLessThan` to define the object size range (minimum and maximum number of Bytes).
    """
    or_: NotRequired[pulumi.Input[Optional['StorageLensGroupOrArgs']]]
    """
...
class StorageLensGroupLevelArgsDict(TypedDict):
    ...
    """
    storage_lens_group_selection_criteria: NotRequired[pulumi.Input[Optional['StorageLensGroupSelectionCriteriaArgs']]]
    """
...
class StorageLensPrefixLevelStorageMetricsArgsDict(TypedDict):
    ...
    """
    selection_criteria: NotRequired[pulumi.Input[Optional['StorageLensSelectionCriteriaArgs']]]
    """
...
class StorageLensS3BucketDestinationArgsDict(TypedDict):
    ...
    """
    encryption: NotRequired[pulumi.Input[Optional['StorageLensEncryptionArgs']]]
    """
