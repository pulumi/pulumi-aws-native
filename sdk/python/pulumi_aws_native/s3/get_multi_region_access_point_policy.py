...
def get_multi_region_access_point_policy(mrap_name: Optional[builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMultiRegionAccessPointPolicyResult:
    """
    The policy to be attached to a Multi Region Access Point


    :param builtins.str mrap_name: The name of the Multi Region Access Point to apply policy
    """
    __args__ = dict()
...
def get_multi_region_access_point_policy_output(mrap_name: Optional[pulumi.Input[builtins.str]] = None,
