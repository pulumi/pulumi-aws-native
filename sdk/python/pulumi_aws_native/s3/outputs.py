...
class AccessGrantGrantee(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str grantee_identifier: The unique identifier of the Grantee
...
class AccessGrantsLocationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 s3_sub_prefix: builtins.str):
        """
        :param builtins.str s3_sub_prefix: The S3 sub prefix of a registered location in your S3 Access Grants instance
        """
...
class BucketAbortIncompleteMultipartUpload(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. For more information, see [Stopping Incomplete Multipart Uploads Using a Bucket Lifecycle Policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config) in the *Amazon S3 User Guide*.
        :param builtins.int days_after_initiation: Specifies the number of days after which Amazon S3 stops an incomplete multipart upload.
        """
...
class BucketAccessControlTranslation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specify this only in a cross-account scenario (where source and destination bucket owners are not the same), and you want to change replica ownership to the AWS-account that owns the destination bucket. If this is not specified in the replication configuration, the replicas are owned by same AWS-account that owns the source object.
        :param builtins.str owner: Specifies the replica ownership. For default and valid values, see [PUT bucket replication](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html) in the *Amazon S3 API Reference*.
        """
...
class BucketAnalyticsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the configuration and any analyses for the analytics filter of an Amazon S3 bucket.
        :param builtins.str id: The ID that identifies the analytics configuration.
        ...
        :param builtins.str prefix: The prefix that an object must have to be included in the analytics results.
...
class BucketCorsRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] allowed_headers: Headers that are specified in the ``Access-Control-Request-Headers`` header. These headers are allowed in a preflight OPTIONS request. In response to any preflight OPTIONS request, Amazon S3 returns any requested headers that are allowed.
        :param Sequence[builtins.str] exposed_headers: One or more headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript ``XMLHttpRequest`` object).
        :param builtins.str id: A unique identifier for this rule. The value must be no more than 255 characters.
        :param builtins.int max_age: The time in seconds that your browser is to cache the preflight response for the specified resource.
        """
...
class BucketDataExport(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str output_schema_version: The version of the output schema to use when exporting data. Must be ``V_1``.
        """
...
class BucketDefaultRetention(dict):
    ...
    def __init__(__self__, *,
        ...
        The container element for optionally specifying the default Object Lock retention settings for new objects placed in the specified bucket.
           +  The ``DefaultRetention`` settings require both a mode and a period.
          +  The ``DefaultRetention`` period can be either ``Days`` or ``Years`` but you must select one. You cannot specify ``Days`` and ``Years`` at the same time.
        :param builtins.int days: The number of days that you want to specify for the default retention period. If Object Lock is turned on, you must specify ``Mode`` and specify either ``Days`` or ``Years``.
        ...
        :param builtins.int years: The number of years that you want to specify for the default retention period. If Object Lock is turned on, you must specify ``Mode`` and specify either ``Days`` or ``Years``.
        """
        if days is not None:
...
class BucketDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies information about where to publish analysis or configuration results for an Amazon S3 bucket.
        :param builtins.str bucket_arn: The Amazon Resource Name (ARN) of the bucket to which data is exported.
        :param 'BucketDestinationFormat' format: Specifies the file format used when exporting data to Amazon S3.
                *Allowed values*: ``CSV`` | ``ORC`` | ``Parquet``
        :param builtins.str bucket_account_id: The account ID that owns the destination S3 bucket. If no account ID is provided, the owner is not validated before exporting data.
                  Although this value is optional, we strongly recommend that you set it to help prevent problems if the destination bucket ownership changes.
        :param builtins.str prefix: The prefix to use when exporting data. The prefix is prepended to all results.
        """
...
class BucketEventBridgeConfiguration(dict):
    ...
    def __init__(__self__, *,
                 event_bridge_enabled: builtins.bool):
        """
        Amazon S3 can send events to Amazon EventBridge whenever certain events happen in your bucket, see [Using EventBridge](https://docs.aws.amazon.com/AmazonS3/latest/userguide/EventBridge.html) in the *Amazon S3 User Guide*.
         Unlike other destinations, delivery of events to EventBridge can be either enabled or disabled for a bucket. If enabled, all events will be sent to EventBridge and you can use EventBridge rules to route events to additional targets. For more information, see [What Is Amazon EventBridge](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-what-is.html) in the *Amazon EventBridge User Guide*
        :param builtins.bool event_bridge_enabled: Enables delivery of events to Amazon EventBridge.
        """
        pulumi.set(__self__, "event_bridge_enabled", event_bridge_enabled)

    @property
    @pulumi.getter(name="eventBridgeEnabled")
    def event_bridge_enabled(self) -> builtins.bool:
        """
...
class BucketFilterRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the Amazon S3 object key name to filter on. An object key name is the name assigned to an object in your Amazon S3 bucket. You specify whether to filter on the suffix or prefix of the object key name. A prefix is a specific string of characters at the beginning of an object key name, which you can use to organize objects. For example, you can start the key names of related objects with a prefix, such as ``2023-`` or ``engineering/``. Then, you can use ``FilterRule`` to find objects in a bucket with key names that have the same prefix. A suffix is similar to a prefix, but it is at the end of the object key name instead of at the beginning.
        :param builtins.str name: The object key name prefix or suffix identifying one or more objects to which the filtering rule applies. The maximum length is 1,024 characters. Overlapping prefixes and suffixes are not supported. For more information, see [Configuring Event Notifications](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html) in the *Amazon S3 User Guide*.
        :param builtins.str value: The value that the filter searches for in object key names.
        """
...
class BucketIntelligentTieringConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the S3 Intelligent-Tiering configuration for an Amazon S3 bucket.
         For information about the S3 Intelligent-Tiering storage class, see [Storage class for automatically optimizing frequently and infrequently accessed objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-class-intro.html#sc-dynamic-data-access).
        :param builtins.str id: The ID used to identify the S3 Intelligent-Tiering configuration.
        ...
        :param builtins.str prefix: An object key name prefix that identifies the subset of objects to which the rule applies.
...
class BucketInventoryConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enabled: Specifies whether the inventory is enabled or disabled. If set to ``True``, an inventory list is generated. If set to ``False``, no inventory list is generated.
        :param builtins.str id: The ID used to identify the inventory configuration.
        ...
        :param builtins.str prefix: Specifies the inventory filter prefix.
        """
        pulumi.set(__self__, "destination", destination)
...
class BucketInventoryTableConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str table_arn: The Amazon Resource Name (ARN) for the inventory table.
...
class BucketJournalTableConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str table_arn: The Amazon Resource Name (ARN) for the journal table.
...
class BucketLambdaConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the LAMlong functions to invoke and the events for which to invoke them.
        :param builtins.str event: The Amazon S3 bucket event for which to invoke the LAMlong function. For more information, see [Supported Event Types](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html) in the *Amazon S3 User Guide*.
        :param builtins.str function: The Amazon Resource Name (ARN) of the LAMlong function that Amazon S3 invokes when the specified event type occurs.
...
class BucketLoggingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 destination_bucket_name: Optional[builtins.str] = None,
                 log_file_prefix: Optional[builtins.str] = None,
                 target_object_key_format: Optional['outputs.BucketTargetObjectKeyFormat'] = None):
        """
        Describes where logs are stored and the prefix that Amazon S3 assigns to all log object keys for a bucket. For examples and more information, see [PUT Bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html) in the *Amazon S3 API Reference*.
          To successfully complete the ``AWS::S3::Bucket LoggingConfiguration`` request, you must have ``s3:PutObject`` and ``s3:PutObjectAcl`` in your IAM permissions.
        :param builtins.str destination_bucket_name: The name of the bucket where Amazon S3 should store server access log files. You can store log files in any bucket that you own. By default, logs are stored in the bucket where the ``LoggingConfiguration`` property is defined.
        :param builtins.str log_file_prefix: A prefix for all log object keys. If you store log files from multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish which log files came from which bucket.
    ...
    def destination_bucket_name(self) -> Optional[builtins.str]:
        """
    ...
    def log_file_prefix(self) -> Optional[builtins.str]:
        """
...
class BucketMetadataDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str table_bucket_arn: The Amazon Resource Name (ARN) of the table bucket where the metadata configuration is stored.
        :param builtins.str table_namespace: The namespace in the table bucket where the metadata tables for a metadata configuration are stored.
        """
...
class BucketMetadataTableEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_arn: If server-side encryption with KMSlong (KMS) keys (SSE-KMS) is specified, you must also specify the KMS key Amazon Resource Name (ARN). You must specify a customer-managed KMS key that's located in the same Region as the general purpose bucket that corresponds to the metadata table configuration.
        """
...
class BucketMetricsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies a metrics configuration for the CloudWatch request metrics (specified by the metrics configuration ID) from an Amazon S3 bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. For examples, see [AWS::S3::Bucket](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket.html#aws-properties-s3-bucket--examples). For more information, see [PUT Bucket metrics](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTMetricConfiguration.html) in the *Amazon S3 API Reference*.
        :param builtins.str id: The ID used to identify the metrics configuration. This can be any value you choose that helps you identify your metrics configuration.
        :param builtins.str access_point_arn: The access point that was used while performing operations on the object. The metrics configuration only includes objects that meet the filter's criteria.
        :param builtins.str prefix: The prefix that an object must have to be included in the metrics results.
...
class BucketNoncurrentVersionTransition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int transition_in_days: Specifies the number of days an object is noncurrent before Amazon S3 can perform the associated action. For information about the noncurrent days calculations, see [How Amazon S3 Calculates How Long an Object Has Been Noncurrent](https://docs.aws.amazon.com/AmazonS3/latest/dev/intro-lifecycle-rules.html#non-current-days-calculations) in the *Amazon S3 User Guide*.
        :param builtins.int newer_noncurrent_versions: Specifies how many noncurrent versions S3 will retain. If there are this many more recent noncurrent versions, S3 will take the associated action. For more information about noncurrent versions, see [Lifecycle configuration elements](https://docs.aws.amazon.com/AmazonS3/latest/userguide/intro-lifecycle-rules.html) in the *Amazon S3 User Guide*.
        """
    ...
    def transition_in_days(self) -> builtins.int:
        """
        Specifies the number of days an object is noncurrent before Amazon S3 can perform the associated action. For information about the noncurrent days calculations, see [How Amazon S3 Calculates How Long an Object Has Been Noncurrent](https://docs.aws.amazon.com/AmazonS3/latest/dev/intro-lifecycle-rules.html#non-current-days-calculations) in the *Amazon S3 User Guide*.
        """
...
class BucketObjectLockConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Places an Object Lock configuration on the specified bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html).
        :param builtins.str object_lock_enabled: Indicates whether this bucket has an Object Lock configuration enabled. Enable ``ObjectLockEnabled`` when you apply ``ObjectLockConfiguration`` to a bucket.
...
class BucketPublicAccessBlockConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The PublicAccessBlock configuration that you want to apply to this Amazon S3 bucket. You can enable the configuration options in any combination. For more information about when Amazon S3 considers a bucket or object public, see [The Meaning of "Public"](https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status) in the *Amazon S3 User Guide*.
        :param builtins.bool block_public_acls: Specifies whether Amazon S3 should block public access control lists (ACLs) for this bucket and objects in this bucket. Setting this element to ``TRUE`` causes the following behavior:
                 +  PUT Bucket ACL and PUT Object ACL calls fail if the specified ACL is public.
                 +  PUT Object calls fail if the request includes a public ACL.
                 +  PUT Bucket calls fail if the request includes a public ACL.
                 
                Enabling this setting doesn't affect existing policies or ACLs.
        :param builtins.bool block_public_policy: Specifies whether Amazon S3 should block public bucket policies for this bucket. Setting this element to ``TRUE`` causes Amazon S3 to reject calls to PUT Bucket policy if the specified bucket policy allows public access. 
                Enabling this setting doesn't affect existing bucket policies.
        :param builtins.bool ignore_public_acls: Specifies whether Amazon S3 should ignore public ACLs for this bucket and objects in this bucket. Setting this element to ``TRUE`` causes Amazon S3 to ignore all public ACLs on this bucket and objects in this bucket.
                Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set.
        :param builtins.bool restrict_public_buckets: Specifies whether Amazon S3 should restrict public bucket policies for this bucket. Setting this element to ``TRUE`` restricts access to this bucket to only AWS-service principals and authorized users within this account if the bucket has a public policy.
                Enabling this setting doesn't affect previously stored bucket policies, except that public and cross-account access within any public bucket policy, including non-public delegation to specific accounts, is blocked.
        """
        if block_public_acls is not None:
            pulumi.set(__self__, "block_public_acls", block_public_acls)
...
class BucketQueueConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the configuration for publishing messages to an Amazon Simple Queue Service (Amazon SQS) queue when Amazon S3 detects specified events.
        :param builtins.str event: The Amazon S3 bucket event about which you want to publish messages to Amazon SQS. For more information, see [Supported Event Types](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html) in the *Amazon S3 User Guide*.
        :param builtins.str queue: The Amazon Resource Name (ARN) of the Amazon SQS queue to which Amazon S3 publishes a message when it detects events of the specified type. FIFO queues are not allowed when enabling an SQS queue as the event notification destination.
...
class BucketRecordExpiration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int days: If you enable journal table record expiration, you can set the number of days to retain your journal table records. Journal table records must be retained for a minimum of 7 days. To set this value, specify any whole number from ``7`` to ``2147483647``. For example, to retain your journal table records for one year, set this value to ``365``.
        """
...
class BucketRedirectRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies how requests are redirected. In the event of an error, you can specify a different error code to return.
        :param builtins.str host_name: The host name to use in the redirect request.
        :param builtins.str http_redirect_code: The HTTP redirect code to use on the response. Not required if one of the siblings is present.
        ...
        :param builtins.str replace_key_prefix_with: The object key prefix to use in the redirect request. For example, to redirect requests for all pages with prefix ``docs/`` (objects in the ``docs/`` folder) to ``documents/``, you can set a condition block with ``KeyPrefixEquals`` set to ``docs/`` and in the Redirect set ``ReplaceKeyPrefixWith`` to ``/documents``. Not required if one of the siblings is present. Can be present only if ``ReplaceKeyWith`` is not provided.
                 Replacement must be made for object keys containing special characters (such as carriage returns) when using XML requests. For more information, see [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints).
        :param builtins.str replace_key_with: The specific object key to use in the redirect request. For example, redirect request to ``error.html``. Not required if one of the siblings is present. Can be present only if ``ReplaceKeyPrefixWith`` is not provided.
                 Replacement must be made for object keys containing special characters (such as carriage returns) when using XML requests. For more information, see [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints).
        """
...
class BucketReplicationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A container for replication rules. You can add up to 1,000 rules. The maximum size of a replication configuration is 2 MB. The latest version of the replication configuration XML is V2. For more information about XML V2 replication configurations, see [Replication configuration](https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-add-config.html) in the *Amazon S3 User Guide*.
        :param builtins.str role: The Amazon Resource Name (ARN) of the IAMlong (IAM) role that Amazon S3 assumes when replicating objects. For more information, see [How to Set Up Replication](https://docs.aws.amazon.com/AmazonS3/latest/dev/replication-how-setup.html) in the *Amazon S3 User Guide*.
...
class BucketReplicationDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A container for information about the replication destination and its configurations including enabling the S3 Replication Time Control (S3 RTC).
        :param builtins.str bucket: The Amazon Resource Name (ARN) of the bucket where you want Amazon S3 to store the results.
...
class BucketReplicationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: A unique identifier for the rule. The maximum value is 255 characters. If you don't specify a value, AWS CloudFormation generates a random ID. When using a V2 replication configuration this property is capitalized as "ID".
        :param builtins.str prefix: An object key name prefix that identifies the object or objects to which the rule applies. The maximum prefix length is 1,024 characters. To include all objects in a bucket, specify an empty string. To filter using a V1 replication configuration, add the ``Prefix`` directly as a child element of the ``Rule`` element.
                 Replacement must be made for object keys containing special characters (such as carriage returns) when using XML requests. For more information, see [XML related object key constraints](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html#object-key-xml-related-constraints).
        :param builtins.int priority: The priority indicates which rule has precedence whenever two or more replication rules conflict. Amazon S3 will attempt to replicate objects according to all replication rules. However, if there are two or more rules with the same destination bucket, then objects will be replicated according to the rule with the highest priority. The higher the number, the higher the priority. 
...
class BucketReplicationTimeValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A container specifying the time value for S3 Replication Time Control (S3 RTC) and replication metrics ``EventThreshold``.
        :param builtins.int minutes: Contains an integer specifying time in minutes. 
                 Valid value: 15
        """
...
class BucketRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 noncurrent_version_expiration_in_days: Optional[builtins.int] = None,
        ...
        :param builtins.bool expired_object_delete_marker: Indicates whether Amazon S3 will remove a delete marker without any noncurrent versions. If set to true, the delete marker will be removed if there are no noncurrent versions. This cannot be specified with ``ExpirationInDays``, ``ExpirationDate``, or ``TagFilters``.
    ...
    def noncurrent_version_expiration_in_days(self) -> Optional[builtins.int]:
        """
        (Deprecated.) For buckets with versioning enabled (or suspended), specifies the time, in days, between when a new version of the object is uploaded to the bucket and when old versions of the object expire. When object versions expire, Amazon S3 permanently deletes them. If you specify a transition and expiration time, the expiration time must be later than the transition time.
        """
...
class BucketS3TablesDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The destination information for a V1 S3 Metadata configuration. The destination table bucket must be in the same Region and AWS-account as the general purpose bucket. The specified metadata table name must be unique within the ``aws_s3_metadata`` namespace in the destination table bucket.
        :param builtins.str table_bucket_arn: The Amazon Resource Name (ARN) for the table bucket that's specified as the destination in the metadata table configuration. The destination table bucket must be in the same Region and AWS-account as the general purpose bucket.
        :param builtins.str table_name: The name for the metadata table in your metadata table configuration. The specified metadata table name must be unique within the ``aws_s3_metadata`` namespace in the destination table bucket.
        :param builtins.str table_arn: The Amazon Resource Name (ARN) for the metadata table in the metadata table configuration. The specified metadata table name must be unique within the ``aws_s3_metadata`` namespace in the destination table bucket.
        :param builtins.str table_namespace: The table bucket namespace for the metadata table in your metadata table configuration. This value is always ``aws_s3_metadata``.
        """
        pulumi.set(__self__, "table_bucket_arn", table_bucket_arn)
        pulumi.set(__self__, "table_name", table_name)
        if table_arn is not None:
...
class BucketServerSideEncryptionByDefault(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_master_key_id: AWS Key Management Service (KMS) customer managed key ID to use for the default encryption. 
...
class BucketTiering(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int days: The number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier. The minimum number of days specified for Archive Access tier must be at least 90 days and Deep Archive Access tier must be at least 180 days. The maximum can be up to 2 years (730 days).
        """
...
class BucketTopicConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A container for specifying the configuration for publication of messages to an Amazon Simple Notification Service (Amazon SNS) topic when Amazon S3 detects specified events.
        :param builtins.str event: The Amazon S3 bucket event about which to send notifications. For more information, see [Supported Event Types](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html) in the *Amazon S3 User Guide*.
        :param builtins.str topic: The Amazon Resource Name (ARN) of the Amazon SNS topic to which Amazon S3 publishes a message when it detects events of the specified type.
...
class BucketTransition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transition_date: Optional[builtins.str] = None,
                 transition_in_days: Optional[builtins.int] = None):
        """
        Specifies when an object transitions to a specified storage class. For more information about Amazon S3 lifecycle configuration rules, see [Transitioning Objects Using Amazon S3 Lifecycle](https://docs.aws.amazon.com/AmazonS3/latest/dev/lifecycle-transition-general-considerations.html) in the *Amazon S3 User Guide*.
        :param 'BucketTransitionStorageClass' storage_class: The storage class to which you want the object to transition.
        :param builtins.str transition_date: Indicates when objects are transitioned to the specified storage class. The date value must be in ISO 8601 format. The time is always midnight UTC.
        :param builtins.int transition_in_days: Indicates the number of days after creation when objects are transitioned to the specified storage class. If the specified storage class is ``INTELLIGENT_TIERING``, ``GLACIER_IR``, ``GLACIER``, or ``DEEP_ARCHIVE``, valid values are ``0`` or positive integers. If the specified storage class is ``STANDARD_IA`` or ``ONEZONE_IA``, valid values are positive integers greater than ``30``. Be aware that some storage classes have a minimum storage duration and that you're charged for transitioning objects before their minimum storage duration. For more information, see [Constraints and considerations for transitions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-transition-general-considerations.html#lifecycle-configuration-constraints) in the *Amazon S3 User Guide*.
        """
        pulumi.set(__self__, "storage_class", storage_class)
    ...
    def transition_date(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="transitionInDays")
    def transition_in_days(self) -> Optional[builtins.int]:
        """
...
class BucketWebsiteConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies website configuration parameters for an Amazon S3 bucket.
        :param builtins.str error_document: The name of the error document for the website.
        :param builtins.str index_document: The name of the index document for the website.
...
class MultiRegionAccessPointRegion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bucket_account_id: Optional[builtins.str] = None):
        """
        :param builtins.str bucket: The name of the associated bucket for the Region.
        :param builtins.str bucket_account_id: The AWS account ID that owns the Amazon S3 bucket that's associated with this Multi-Region Access Point.
        """
        pulumi.set(__self__, "bucket", bucket)
        if bucket_account_id is not None:
            pulumi.set(__self__, "bucket_account_id", bucket_account_id)
...
class StorageLensActivityMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Enables activity metrics.
        :param builtins.bool is_enabled: Specifies whether activity metrics are enabled or disabled.
        """
...
class StorageLensAdvancedCostOptimizationMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Enables advanced cost optimization metrics.
        :param builtins.bool is_enabled: Specifies whether advanced cost optimization metrics are enabled or disabled.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class StorageLensAdvancedDataProtectionMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Enables advanced data protection metrics.
        :param builtins.bool is_enabled: Specifies whether advanced data protection metrics are enabled or disabled.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class StorageLensAwsOrg(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The AWS Organizations ARN to use in the Amazon S3 Storage Lens configuration.
        :param builtins.str arn: This resource contains the ARN of the AWS Organization.
        """
...
class StorageLensBucketsAndRegions(dict):
    ...
    """
    def __init__(__self__, *,
                 buckets: Optional[Sequence[builtins.str]] = None,
                 regions: Optional[Sequence[builtins.str]] = None):
        """
        S3 buckets and Regions to include/exclude in the Amazon S3 Storage Lens configuration.
        :param Sequence[builtins.str] buckets: This property contains the details of the buckets for the Amazon S3 Storage Lens configuration. This should be the bucket Amazon Resource Name(ARN). For valid values, see [Buckets ARN format here](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_Include.html#API_control_Include_Contents) in the *Amazon S3 API Reference* .
        :param Sequence[builtins.str] regions: This property contains the details of the Regions for the S3 Storage Lens configuration.
        """
    ...
    @property
    @pulumi.getter
    def buckets(self) -> Optional[Sequence[builtins.str]]:
        """
...
class StorageLensCloudWatchMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CloudWatch metrics settings for the Amazon S3 Storage Lens metrics export.
        :param builtins.bool is_enabled: Specifies whether CloudWatch metrics are enabled or disabled.
        """
        pulumi.set(__self__, "is_enabled", is_enabled)
...
class StorageLensConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_lens_arn: Optional[builtins.str] = None):
        """
        Specifies the details of Amazon S3 Storage Lens configuration.
        ...
        :param builtins.str id: This property contains the details of the ID of the S3 Storage Lens configuration.
        :param builtins.bool is_enabled: Specifies whether the Amazon S3 Storage Lens configuration is enabled or disabled.
        ...
        :param builtins.str storage_lens_arn: The ARN for the Amazon S3 Storage Lens configuration.
        """
    ...
    def storage_lens_arn(self) -> Optional[builtins.str]:
        """
...
class StorageLensDetailedStatusCodesMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Enables detailed status codes metrics.
        :param builtins.bool is_enabled: Specifies whether detailed status codes metrics are enabled or disabled.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class StorageLensGroupAnd(dict):
    ...
    def __init__(__self__, *,
                 match_any_prefix: Optional[Sequence[builtins.str]] = None,
                 match_any_suffix: Optional[Sequence[builtins.str]] = None,
        ...
        """
        The Storage Lens group will include objects that match all of the specified filter values.
        :param Sequence[builtins.str] match_any_prefix: This property contains a list of prefixes. At least one prefix must be specified. Up to 10 prefixes are allowed.
        :param Sequence[builtins.str] match_any_suffix: This property contains a list of suffixes. At least one suffix must be specified. Up to 10 suffixes are allowed.
    ...
    def match_any_prefix(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def match_any_suffix(self) -> Optional[Sequence[builtins.str]]:
        """
...
class StorageLensGroupMatchObjectAge(dict):
    ...
    def __init__(__self__, *,
                 days_greater_than: Optional[builtins.int] = None,
                 days_less_than: Optional[builtins.int] = None):
        """
        Filter to match all of the specified values for the minimum and maximum object age.
        :param builtins.int days_greater_than: Minimum object age to which the rule applies.
        :param builtins.int days_less_than: Maximum object age to which the rule applies.
        """
    ...
    def days_greater_than(self) -> Optional[builtins.int]:
        """
    ...
    def days_less_than(self) -> Optional[builtins.int]:
        """
...
class StorageLensGroupMatchObjectSize(dict):
    ...
    def __init__(__self__, *,
                 bytes_greater_than: Optional[builtins.int] = None,
                 bytes_less_than: Optional[builtins.int] = None):
        """
        Filter to match all of the specified values for the minimum and maximum object size.
        :param builtins.int bytes_greater_than: Minimum object size to which the rule applies.
        :param builtins.int bytes_less_than: Maximum object size to which the rule applies.
        """
    ...
    def bytes_greater_than(self) -> Optional[builtins.int]:
        """
    ...
    def bytes_less_than(self) -> Optional[builtins.int]:
        """
...
class StorageLensGroupOr(dict):
    ...
    def __init__(__self__, *,
        ...
        The Storage Lens group will include objects that match any of the specified filter values.
        :param Sequence[builtins.str] match_any_prefix: This property contains a list of prefixes. At least one prefix must be specified. Up to 10 prefixes are allowed.
        :param Sequence[builtins.str] match_any_suffix: This property contains the list of suffixes. At least one suffix must be specified. Up to 10 suffixes are allowed.
        :param Sequence['StorageLensGroupTag'] match_any_tag: This property contains the list of S3 object tags. At least one object tag must be specified. Up to 10 object tags are allowed.
...
class StorageLensGroupSelectionCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Selection criteria for Storage Lens Group level metrics
        :param Sequence[builtins.str] exclude: This property indicates which Storage Lens group ARNs to exclude from the Storage Lens group aggregation.
        :param Sequence[builtins.str] include: This property indicates which Storage Lens group ARNs to include in the Storage Lens group aggregation.
        """
        if exclude is not None:
            pulumi.set(__self__, "exclude", exclude)
        if include is not None:
...
class StorageLensPrefixLevelStorageMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_enabled: Specifies whether prefix-level storage metrics are enabled or disabled.
...
class StorageLensS3BucketDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        S3 bucket destination settings for the Amazon S3 Storage Lens metrics export.
        :param builtins.str account_id: The AWS account ID that owns the destination S3 bucket.
        :param builtins.str arn: The ARN of the bucket to which Amazon S3 Storage Lens exports will be placed.
        ...
        :param builtins.str prefix: The prefix to use for Amazon S3 Storage Lens export.
        """
...
class StorageLensSelectionCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_depth: Optional[builtins.int] = None,
                 min_storage_bytes_percentage: Optional[builtins.float] = None):
        """
        Selection criteria for prefix-level metrics.
        :param builtins.str delimiter: Delimiter to divide S3 key into hierarchy of prefixes.
        :param builtins.int max_depth: Max depth of prefixes of S3 key that Amazon S3 Storage Lens will analyze.
        :param builtins.float min_storage_bytes_percentage: The minimum storage bytes threshold for the prefixes to be included in the analysis.
        """
    ...
    def max_depth(self) -> Optional[builtins.int]:
        """
    ...
    def min_storage_bytes_percentage(self) -> Optional[builtins.float]:
        """
