...
class GetAccessGrantsInstanceResult:
    ...
    def access_grants_instance_arn(self) -> Optional[builtins.str]:
        """
    ...
    def access_grants_instance_id(self) -> Optional[builtins.str]:
        """
    ...
    def identity_center_arn(self) -> Optional[builtins.str]:
        """
...
def get_access_grants_instance(access_grants_instance_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str access_grants_instance_arn: The Amazon Resource Name (ARN) of the specified Access Grants instance.
    """
    __args__ = dict()
...
def get_access_grants_instance_output(access_grants_instance_arn: Optional[pulumi.Input[builtins.str]] = None,
