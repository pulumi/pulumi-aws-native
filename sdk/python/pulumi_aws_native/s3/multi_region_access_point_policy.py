...
class MultiRegionAccessPointPolicyArgs:
    def __init__(__self__, *,
                 mrap_name: pulumi.Input[_builtins.str],
                 policy: Any):
        """
    ...
    def mrap_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @mrap_name.setter
    def mrap_name(self, value: pulumi.Input[_builtins.str]):
...
class MultiRegionAccessPointPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="mrapName")
    def mrap_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Multi Region Access Point to apply policy
        """
        return pulumi.get(self, "mrap_name")
