...
class GetStorageLensGroupResult:
    ...
    def storage_lens_group_arn(self) -> Optional[builtins.str]:
        """
...
def get_storage_lens_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: This property contains the Storage Lens group name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_storage_lens_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
