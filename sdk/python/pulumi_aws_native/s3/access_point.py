...
class AccessPoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(public_access_block_configuration, AccessPointPublicAccessBlockConfigurationArgs):
            ...
            if not isinstance(vpc_configuration, AccessPointVpcConfigurationArgs):
