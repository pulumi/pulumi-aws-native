...
class SinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the ObservabilityAccessManager Sink.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags to apply to the sink
        """
        if name is not None:
