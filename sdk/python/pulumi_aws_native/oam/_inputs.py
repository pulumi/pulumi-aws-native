...
class LinkFilterArgs:
    def __init__(__self__, *,
                 filter: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] filter: When used in `MetricConfiguration` this field specifies which metric namespaces are to be shared with the monitoring account
