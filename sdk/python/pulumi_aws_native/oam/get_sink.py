...
def get_sink(arn: Optional[builtins.str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSinkResult:
    """
    Resource Type definition for AWS::Oam::Sink


    :param builtins.str arn: The Amazon resource name (ARN) of the ObservabilityAccessManager Sink
    """
    __args__ = dict()
    __args__['arn'] = arn
...
def get_sink_output(arn: Optional[pulumi.Input[builtins.str]] = None,
