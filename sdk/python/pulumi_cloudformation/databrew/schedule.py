...
class Schedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['SchedulePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Schedule, __self__).__init__(
            'cloudformation:DataBrew:Schedule',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ScheduleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ScheduleProperties']:
        """
