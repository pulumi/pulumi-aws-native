...
class Recipe(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RecipePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RecipePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Recipe, __self__).__init__(
            'cloudformation:DataBrew:Recipe',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RecipeAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RecipeProperties']:
        """
