...
class GatewayRoute(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GatewayRoutePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GatewayRoutePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(GatewayRoute, __self__).__init__(
            'cloudformation:AppMesh:GatewayRoute',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GatewayRouteAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GatewayRouteProperties']:
        """
