...
class VirtualGateway(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VirtualGatewayPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VirtualGatewayPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(VirtualGateway, __self__).__init__(
            'cloudformation:AppMesh:VirtualGateway',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VirtualGatewayAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VirtualGatewayProperties']:
        """
