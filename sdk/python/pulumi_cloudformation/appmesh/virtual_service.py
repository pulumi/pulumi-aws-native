...
class VirtualService(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VirtualServicePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VirtualServicePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VirtualServiceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VirtualServiceProperties']:
        """
