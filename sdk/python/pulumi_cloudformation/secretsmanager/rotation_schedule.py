...
class RotationSchedule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RotationSchedulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RotationSchedulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RotationScheduleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RotationScheduleProperties']:
        """
