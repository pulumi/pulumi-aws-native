...
__all__ = ['SecretTargetAttachment']
...
class SecretTargetAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SecretTargetAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SecretTargetAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SecretTargetAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SecretTargetAttachmentProperties']:
        """
