...
class CustomResource(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CustomResourcePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CustomResourcePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(CustomResource, __self__).__init__(
            'cloudformation:CloudFormation:CustomResource',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CustomResourceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CustomResourceProperties']:
        """
