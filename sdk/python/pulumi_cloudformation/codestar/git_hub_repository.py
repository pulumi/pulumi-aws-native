...
class GitHubRepository(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GitHubRepositoryPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GitHubRepositoryPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GitHubRepositoryAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GitHubRepositoryProperties']:
        """
