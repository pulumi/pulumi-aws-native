...
class DistributionConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DistributionConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DistributionConfigurationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DistributionConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DistributionConfigurationProperties']:
        """
