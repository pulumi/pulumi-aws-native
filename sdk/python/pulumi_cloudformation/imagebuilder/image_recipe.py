...
class ImageRecipe(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ImageRecipePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ImageRecipePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ImageRecipeAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ImageRecipeProperties']:
        """
