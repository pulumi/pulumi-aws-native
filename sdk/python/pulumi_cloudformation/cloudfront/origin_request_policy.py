...
class OriginRequestPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['OriginRequestPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['OriginRequestPolicyPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(OriginRequestPolicy, __self__).__init__(
            'cloudformation:CloudFront:OriginRequestPolicy',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.OriginRequestPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.OriginRequestPolicyProperties']:
        """
