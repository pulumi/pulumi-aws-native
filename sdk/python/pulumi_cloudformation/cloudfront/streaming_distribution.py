...
class StreamingDistribution(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StreamingDistributionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StreamingDistributionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StreamingDistributionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StreamingDistributionProperties']:
        """
