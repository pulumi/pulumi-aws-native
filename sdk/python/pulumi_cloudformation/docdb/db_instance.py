...
class DBInstance(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DBInstancePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DBInstancePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DBInstanceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DBInstanceProperties']:
        """
