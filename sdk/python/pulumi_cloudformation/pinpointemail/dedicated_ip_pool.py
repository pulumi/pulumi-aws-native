...
class DedicatedIpPool(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DedicatedIpPoolPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DedicatedIpPoolPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DedicatedIpPoolAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DedicatedIpPoolProperties']:
        """
