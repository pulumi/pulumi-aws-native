...
__all__ = ['ConfigurationSetEventDestination']
...
class ConfigurationSetEventDestination(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigurationSetEventDestinationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationSetEventDestinationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigurationSetEventDestinationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigurationSetEventDestinationProperties']:
        """
