...
class SourceCredential(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SourceCredentialPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SourceCredentialPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SourceCredentialAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SourceCredentialProperties']:
        """
