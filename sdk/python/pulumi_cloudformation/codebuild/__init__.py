...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "cloudformation:CodeBuild:Project":
                return Project(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:CodeBuild:ReportGroup":
                return ReportGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:CodeBuild:SourceCredential":
    ...
    pulumi.runtime.register_resource_module("cloudformation", "CodeBuild", _module_instance)
