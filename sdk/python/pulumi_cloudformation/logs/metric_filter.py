...
class MetricFilter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MetricFilterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MetricFilterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MetricFilterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MetricFilterProperties']:
        """
