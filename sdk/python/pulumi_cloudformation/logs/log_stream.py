...
class LogStream(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LogStreamPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LogStreamPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LogStreamAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LogStreamProperties']:
        """
