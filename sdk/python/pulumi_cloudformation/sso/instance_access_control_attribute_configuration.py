...
class InstanceAccessControlAttributeConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InstanceAccessControlAttributeConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InstanceAccessControlAttributeConfigurationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(InstanceAccessControlAttributeConfiguration, __self__).__init__(
            'cloudformation:SSO:InstanceAccessControlAttributeConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InstanceAccessControlAttributeConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InstanceAccessControlAttributeConfigurationProperties']:
        """
