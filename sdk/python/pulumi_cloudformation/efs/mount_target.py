...
class MountTarget(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MountTargetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MountTargetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MountTargetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MountTargetProperties']:
        """
