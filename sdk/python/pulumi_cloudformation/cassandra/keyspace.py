...
class Keyspace(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['KeyspacePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['KeyspacePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Keyspace, __self__).__init__(
            'cloudformation:Cassandra:Keyspace',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.KeyspaceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.KeyspaceProperties']:
        """
