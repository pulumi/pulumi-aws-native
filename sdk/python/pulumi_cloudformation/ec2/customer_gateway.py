...
class CustomerGateway(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CustomerGatewayPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CustomerGatewayPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CustomerGatewayAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CustomerGatewayProperties']:
        """
