...
class TrafficMirrorTarget(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TrafficMirrorTargetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TrafficMirrorTargetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TrafficMirrorTargetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TrafficMirrorTargetProperties']:
        """
