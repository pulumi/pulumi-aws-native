...
__all__ = ['VPCEndpointServicePermissions']
...
class VPCEndpointServicePermissions(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPCEndpointServicePermissionsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPCEndpointServicePermissionsPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPCEndpointServicePermissionsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPCEndpointServicePermissionsProperties']:
        """
