...
class CapacityReservation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CapacityReservationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CapacityReservationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CapacityReservationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CapacityReservationProperties']:
        """
