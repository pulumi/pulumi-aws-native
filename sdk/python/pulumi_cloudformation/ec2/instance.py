...
class Instance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['InstancePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InstanceProperties']:
        """
