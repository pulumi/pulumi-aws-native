...
class NetworkInterfaceAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NetworkInterfaceAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NetworkInterfaceAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NetworkInterfaceAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NetworkInterfaceAttachmentProperties']:
        """
