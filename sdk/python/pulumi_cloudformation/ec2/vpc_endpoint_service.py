...
class VPCEndpointService(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPCEndpointServicePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPCEndpointServicePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPCEndpointServiceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPCEndpointServiceProperties']:
        """
