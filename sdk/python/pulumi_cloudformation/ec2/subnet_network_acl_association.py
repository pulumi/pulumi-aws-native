...
__all__ = ['SubnetNetworkAclAssociation']
...
class SubnetNetworkAclAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SubnetNetworkAclAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SubnetNetworkAclAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SubnetNetworkAclAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SubnetNetworkAclAssociationProperties']:
        """
