...
class SecurityGroupEgress(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SecurityGroupEgressPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SecurityGroupEgressPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SecurityGroupEgressAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SecurityGroupEgressProperties']:
        """
