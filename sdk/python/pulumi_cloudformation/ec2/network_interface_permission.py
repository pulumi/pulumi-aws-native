...
__all__ = ['NetworkInterfacePermission']
...
class NetworkInterfacePermission(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NetworkInterfacePermissionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NetworkInterfacePermissionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NetworkInterfacePermissionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NetworkInterfacePermissionProperties']:
        """
