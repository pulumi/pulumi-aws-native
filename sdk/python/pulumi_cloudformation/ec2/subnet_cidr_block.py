...
class SubnetCidrBlock(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SubnetCidrBlockPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SubnetCidrBlockPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SubnetCidrBlockAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SubnetCidrBlockProperties']:
        """
