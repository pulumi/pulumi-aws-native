...
class TrafficMirrorFilter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TrafficMirrorFilterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TrafficMirrorFilterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TrafficMirrorFilterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TrafficMirrorFilterProperties']:
        """
