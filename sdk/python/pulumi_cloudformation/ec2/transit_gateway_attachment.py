...
__all__ = ['TransitGatewayAttachment']
...
class TransitGatewayAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TransitGatewayAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TransitGatewayAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TransitGatewayAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TransitGatewayAttachmentProperties']:
        """
