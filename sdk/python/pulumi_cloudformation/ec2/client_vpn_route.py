...
class ClientVpnRoute(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClientVpnRoutePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClientVpnRoutePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClientVpnRouteAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClientVpnRouteProperties']:
        """
