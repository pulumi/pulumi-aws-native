...
class RouteTable(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RouteTablePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RouteTablePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RouteTableAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RouteTableProperties']:
        """
