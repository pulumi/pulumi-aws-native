...
class VPCPeeringConnection(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPCPeeringConnectionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPCPeeringConnectionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPCPeeringConnectionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPCPeeringConnectionProperties']:
        """
