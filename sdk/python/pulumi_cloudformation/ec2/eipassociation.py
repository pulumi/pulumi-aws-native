...
class EIPAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EIPAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EIPAssociationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(EIPAssociation, __self__).__init__(
            'cloudformation:EC2:EIPAssociation',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EIPAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EIPAssociationProperties']:
        """
