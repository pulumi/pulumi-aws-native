...
class TrafficMirrorSession(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TrafficMirrorSessionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TrafficMirrorSessionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TrafficMirrorSessionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TrafficMirrorSessionProperties']:
        """
