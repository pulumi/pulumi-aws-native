...
class SubnetRouteTableAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SubnetRouteTableAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SubnetRouteTableAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SubnetRouteTableAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SubnetRouteTableAssociationProperties']:
        """
