...
class InternetGateway(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InternetGatewayPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InternetGatewayPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(InternetGateway, __self__).__init__(
            'cloudformation:EC2:InternetGateway',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InternetGatewayAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InternetGatewayProperties']:
        """
