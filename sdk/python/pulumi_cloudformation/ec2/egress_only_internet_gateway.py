...
class EgressOnlyInternetGateway(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EgressOnlyInternetGatewayPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EgressOnlyInternetGatewayPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(EgressOnlyInternetGateway, __self__).__init__(
            'cloudformation:EC2:EgressOnlyInternetGateway',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EgressOnlyInternetGatewayAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EgressOnlyInternetGatewayProperties']:
        """
