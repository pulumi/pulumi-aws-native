...
class VPNConnection(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPNConnectionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPNConnectionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPNConnectionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPNConnectionProperties']:
        """
