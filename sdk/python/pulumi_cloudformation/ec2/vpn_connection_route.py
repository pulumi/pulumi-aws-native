...
class VPNConnectionRoute(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['VPNConnectionRoutePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VPNConnectionRoutePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.VPNConnectionRouteAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VPNConnectionRouteProperties']:
        """
