...
class Workflow(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['WorkflowPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WorkflowPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.WorkflowAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WorkflowProperties']:
        """
