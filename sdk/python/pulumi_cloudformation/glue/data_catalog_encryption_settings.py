...
class DataCatalogEncryptionSettings(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DataCatalogEncryptionSettingsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DataCatalogEncryptionSettingsPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DataCatalogEncryptionSettingsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DataCatalogEncryptionSettingsProperties']:
        """
