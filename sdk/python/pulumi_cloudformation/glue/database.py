...
class Database(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DatabasePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DatabasePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DatabaseAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DatabaseProperties']:
        """
