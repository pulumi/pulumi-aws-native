...
class MLTransform(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MLTransformPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MLTransformPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MLTransformAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MLTransformProperties']:
        """
