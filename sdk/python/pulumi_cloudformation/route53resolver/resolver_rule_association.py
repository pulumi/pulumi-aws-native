...
class ResolverRuleAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResolverRuleAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResolverRuleAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResolverRuleAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResolverRuleAssociationProperties']:
        """
