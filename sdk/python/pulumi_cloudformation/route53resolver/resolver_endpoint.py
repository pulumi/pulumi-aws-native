...
class ResolverEndpoint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResolverEndpointPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResolverEndpointPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResolverEndpointAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResolverEndpointProperties']:
        """
