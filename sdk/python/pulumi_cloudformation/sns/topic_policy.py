...
class TopicPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TopicPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TopicPolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TopicPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TopicPolicyProperties']:
        """
