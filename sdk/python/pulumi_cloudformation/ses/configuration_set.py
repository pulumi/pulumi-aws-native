...
class ConfigurationSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigurationSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationSetPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(ConfigurationSet, __self__).__init__(
            'cloudformation:SES:ConfigurationSet',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigurationSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigurationSetProperties']:
        """
