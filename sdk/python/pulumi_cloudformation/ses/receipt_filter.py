...
class ReceiptFilter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ReceiptFilterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ReceiptFilterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ReceiptFilterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ReceiptFilterProperties']:
        """
