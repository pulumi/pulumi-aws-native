...
class PortfolioShare(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PortfolioSharePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PortfolioSharePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PortfolioShareAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PortfolioShareProperties']:
        """
