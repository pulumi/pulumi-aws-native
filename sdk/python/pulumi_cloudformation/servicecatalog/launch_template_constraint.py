...
__all__ = ['LaunchTemplateConstraint']
...
class LaunchTemplateConstraint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LaunchTemplateConstraintPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LaunchTemplateConstraintPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LaunchTemplateConstraintAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LaunchTemplateConstraintProperties']:
        """
