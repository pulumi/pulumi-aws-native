...
class TagOptionAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TagOptionAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TagOptionAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TagOptionAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TagOptionAssociationProperties']:
        """
