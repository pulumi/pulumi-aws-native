...
__all__ = ['PortfolioPrincipalAssociation']
...
class PortfolioPrincipalAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PortfolioPrincipalAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PortfolioPrincipalAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PortfolioPrincipalAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PortfolioPrincipalAssociationProperties']:
        """
