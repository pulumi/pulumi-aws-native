...
class LaunchRoleConstraint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LaunchRoleConstraintPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LaunchRoleConstraintPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LaunchRoleConstraintAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LaunchRoleConstraintProperties']:
        """
