...
__all__ = ['LaunchNotificationConstraint']
...
class LaunchNotificationConstraint(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LaunchNotificationConstraintPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LaunchNotificationConstraintPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LaunchNotificationConstraintAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LaunchNotificationConstraintProperties']:
        """
