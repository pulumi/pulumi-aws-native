...
__all__ = ['AcceptedPortfolioShare']
...
class AcceptedPortfolioShare(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AcceptedPortfolioSharePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AcceptedPortfolioSharePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AcceptedPortfolioShareAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AcceptedPortfolioShareProperties']:
        """
