...
__all__ = ['PortfolioProductAssociation']
...
class PortfolioProductAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PortfolioProductAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PortfolioProductAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PortfolioProductAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PortfolioProductAssociationProperties']:
        """
