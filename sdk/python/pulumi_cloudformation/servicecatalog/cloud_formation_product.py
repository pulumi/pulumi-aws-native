...
class CloudFormationProduct(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CloudFormationProductPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CloudFormationProductPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CloudFormationProductAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CloudFormationProductProperties']:
        """
