...
class SqlInjectionMatchSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SqlInjectionMatchSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SqlInjectionMatchSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SqlInjectionMatchSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SqlInjectionMatchSetProperties']:
        """
