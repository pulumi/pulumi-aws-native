...
class GeoMatchSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GeoMatchSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GeoMatchSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GeoMatchSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GeoMatchSetProperties']:
        """
