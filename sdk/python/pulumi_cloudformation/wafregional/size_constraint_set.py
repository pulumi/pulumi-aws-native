...
class SizeConstraintSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SizeConstraintSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SizeConstraintSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SizeConstraintSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SizeConstraintSetProperties']:
        """
