...
class XssMatchSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['XssMatchSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['XssMatchSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.XssMatchSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.XssMatchSetProperties']:
        """
