...
class RateBasedRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RateBasedRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RateBasedRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RateBasedRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RateBasedRuleProperties']:
        """
