...
class FlowTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['FlowTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FlowTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.FlowTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FlowTemplateProperties']:
        """
