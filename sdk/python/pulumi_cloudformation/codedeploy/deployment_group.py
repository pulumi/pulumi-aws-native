...
class DeploymentGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeploymentGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeploymentGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeploymentGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeploymentGroupProperties']:
        """
