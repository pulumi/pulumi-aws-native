...
class ConfigurationTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigurationTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigurationTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigurationTemplateProperties']:
        """
