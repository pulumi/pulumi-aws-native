...
class MicrosoftAD(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MicrosoftADPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MicrosoftADPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MicrosoftADAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MicrosoftADProperties']:
        """
