...
__all__ = ['OrganizationConfigRule']
...
class OrganizationConfigRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['OrganizationConfigRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['OrganizationConfigRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.OrganizationConfigRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.OrganizationConfigRuleProperties']:
        """
