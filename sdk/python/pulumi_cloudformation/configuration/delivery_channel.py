...
class DeliveryChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeliveryChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeliveryChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeliveryChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeliveryChannelProperties']:
        """
