...
class ConformancePack(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConformancePackPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConformancePackPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConformancePackAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConformancePackProperties']:
        """
