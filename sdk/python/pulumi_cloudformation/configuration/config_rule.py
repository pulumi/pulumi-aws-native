...
class ConfigRule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigRulePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigRulePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigRuleAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigRuleProperties']:
        """
