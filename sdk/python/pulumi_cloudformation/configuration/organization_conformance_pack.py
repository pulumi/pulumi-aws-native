...
class OrganizationConformancePack(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['OrganizationConformancePackPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['OrganizationConformancePackPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.OrganizationConformancePackAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.OrganizationConformancePackProperties']:
        """
