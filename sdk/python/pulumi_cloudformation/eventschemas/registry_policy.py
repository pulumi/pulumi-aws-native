...
class RegistryPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RegistryPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RegistryPolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RegistryPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RegistryPolicyProperties']:
        """
