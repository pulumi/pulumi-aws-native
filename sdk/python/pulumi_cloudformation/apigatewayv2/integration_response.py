...
class IntegrationResponse(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['IntegrationResponsePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['IntegrationResponsePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.IntegrationResponseAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.IntegrationResponseProperties']:
        """
