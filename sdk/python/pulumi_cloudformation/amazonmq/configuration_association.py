...
__all__ = ['ConfigurationAssociation']
...
class ConfigurationAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ConfigurationAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConfigurationAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ConfigurationAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ConfigurationAssociationProperties']:
        """
