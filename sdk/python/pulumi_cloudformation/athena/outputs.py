...
@pulumi.output_type
class DataCatalogAttributes(dict):
...
@pulumi.output_type
class DataCatalogProperties(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional['outputs.DataCatalogTags'] = None):
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html
        :param str name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html#cfn-athena-datacatalog-name
        :param str type: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html#cfn-athena-datacatalog-type
        :param str description: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html#cfn-athena-datacatalog-description
        :param Mapping[str, str] parameters: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html#cfn-athena-datacatalog-parameters
        :param 'DataCatalogTagsArgs' tags: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-datacatalog.html#cfn-athena-datacatalog-tags
        """
    ...
    def tags(self) -> Optional['outputs.DataCatalogTags']:
        """
...
@pulumi.output_type
class NamedQueryAttributes(dict):
    def __init__(__self__, *,
                 named_query_id: str):
...
@pulumi.output_type
class NamedQueryProperties(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html
        :param str database: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html#cfn-athena-namedquery-database
        :param str query_string: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html#cfn-athena-namedquery-querystring
        :param str description: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html#cfn-athena-namedquery-description
        :param str name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html#cfn-athena-namedquery-name
        :param str work_group: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-namedquery.html#cfn-athena-namedquery-workgroup
        """
...
@pulumi.output_type
class WorkGroupAttributes(dict):
    def __init__(__self__, *,
                 creation_time: str):
...
@pulumi.output_type
class WorkGroupProperties(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional['outputs.WorkGroupTags'] = None,
                 work_group_configuration: Optional['outputs.WorkGroupWorkGroupConfiguration'] = None,
                 work_group_configuration_updates: Optional['outputs.WorkGroupWorkGroupConfigurationUpdates'] = None):
        """
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html
        :param str name: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-name
        :param str description: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-description
        :param bool recursive_delete_option: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-recursivedeleteoption
        :param str state: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-state
        :param 'WorkGroupTagsArgs' tags: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-tags
        :param 'WorkGroupWorkGroupConfigurationArgs' work_group_configuration: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-workgroupconfiguration
        :param 'WorkGroupWorkGroupConfigurationUpdatesArgs' work_group_configuration_updates: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-workgroupconfigurationupdates
        """
        pulumi.set(__self__, "name", name)
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="Tags")
    def tags(self) -> Optional['outputs.WorkGroupTags']:
        """
    ...
    def work_group_configuration(self) -> Optional['outputs.WorkGroupWorkGroupConfiguration']:
        """
    ...
    def work_group_configuration_updates(self) -> Optional['outputs.WorkGroupWorkGroupConfigurationUpdates']:
        """
