...
class UserProfile(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserProfilePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserProfilePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserProfileAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserProfileProperties']:
        """
