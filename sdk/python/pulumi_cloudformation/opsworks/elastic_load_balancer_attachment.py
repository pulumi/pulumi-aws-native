...
__all__ = ['ElasticLoadBalancerAttachment']
...
class ElasticLoadBalancerAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ElasticLoadBalancerAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ElasticLoadBalancerAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ElasticLoadBalancerAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ElasticLoadBalancerAttachmentProperties']:
        """
