...
class MaintenanceWindowTarget(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MaintenanceWindowTargetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MaintenanceWindowTargetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MaintenanceWindowTargetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MaintenanceWindowTargetProperties']:
        """
