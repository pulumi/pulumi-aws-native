...
class MaintenanceWindowTask(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MaintenanceWindowTaskPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MaintenanceWindowTaskPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MaintenanceWindowTaskAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MaintenanceWindowTaskProperties']:
        """
