...
class PatchBaseline(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PatchBaselinePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PatchBaselinePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PatchBaselineAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PatchBaselineProperties']:
        """
