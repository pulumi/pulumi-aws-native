...
class CoreDefinitionVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CoreDefinitionVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CoreDefinitionVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CoreDefinitionVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CoreDefinitionVersionProperties']:
        """
