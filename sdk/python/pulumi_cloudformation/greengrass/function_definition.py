...
class FunctionDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['FunctionDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FunctionDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FunctionDefinition':
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.FunctionDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FunctionDefinitionProperties']:
        """
