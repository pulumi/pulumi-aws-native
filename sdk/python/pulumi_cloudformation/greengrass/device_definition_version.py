...
__all__ = ['DeviceDefinitionVersion']
...
class DeviceDefinitionVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeviceDefinitionVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeviceDefinitionVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeviceDefinitionVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeviceDefinitionVersionProperties']:
        """
