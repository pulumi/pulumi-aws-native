...
__all__ = ['SubscriptionDefinitionVersion']
...
class SubscriptionDefinitionVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SubscriptionDefinitionVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SubscriptionDefinitionVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SubscriptionDefinitionVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SubscriptionDefinitionVersionProperties']:
        """
