...
class CoreDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CoreDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CoreDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CoreDefinition':
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CoreDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CoreDefinitionProperties']:
        """
