...
__all__ = ['LoggerDefinitionVersion']
...
class LoggerDefinitionVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LoggerDefinitionVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LoggerDefinitionVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LoggerDefinitionVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LoggerDefinitionVersionProperties']:
        """
