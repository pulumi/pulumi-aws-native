...
class ResourceDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ResourceDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ResourceDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ResourceDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ResourceDefinitionProperties']:
        """
