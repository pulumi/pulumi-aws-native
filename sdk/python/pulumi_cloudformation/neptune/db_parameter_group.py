...
class DBParameterGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DBParameterGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DBParameterGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DBParameterGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DBParameterGroupProperties']:
        """
