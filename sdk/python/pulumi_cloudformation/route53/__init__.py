...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "cloudformation:Route53:HealthCheck":
                return HealthCheck(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:Route53:HostedZone":
                return HostedZone(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:Route53:RecordSet":
                return RecordSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:Route53:RecordSetGroup":
    ...
    pulumi.runtime.register_resource_module("cloudformation", "Route53", _module_instance)
