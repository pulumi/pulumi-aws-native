...
class HostedZone(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['HostedZonePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['HostedZonePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.HostedZoneAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.HostedZoneProperties']:
        """
