...
class RecordSetGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RecordSetGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RecordSetGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RecordSetGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RecordSetGroupProperties']:
        """
