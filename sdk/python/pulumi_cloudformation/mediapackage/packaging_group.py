...
class PackagingGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PackagingGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PackagingGroupPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(PackagingGroup, __self__).__init__(
            'cloudformation:MediaPackage:PackagingGroup',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PackagingGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PackagingGroupProperties']:
        """
