...
class PackagingConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PackagingConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PackagingConfigurationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(PackagingConfiguration, __self__).__init__(
            'cloudformation:MediaPackage:PackagingConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PackagingConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PackagingConfigurationProperties']:
        """
