...
class GraphQLSchema(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GraphQLSchemaPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GraphQLSchemaPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GraphQLSchemaAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GraphQLSchemaProperties']:
        """
