...
class FunctionConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['FunctionConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FunctionConfigurationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.FunctionConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FunctionConfigurationProperties']:
        """
