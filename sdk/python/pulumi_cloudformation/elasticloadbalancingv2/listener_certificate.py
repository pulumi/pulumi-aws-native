...
class ListenerCertificate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ListenerCertificatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ListenerCertificatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ListenerCertificateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ListenerCertificateProperties']:
        """
