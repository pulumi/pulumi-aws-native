...
class Webhook(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['WebhookPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WebhookPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.WebhookAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WebhookProperties']:
        """
