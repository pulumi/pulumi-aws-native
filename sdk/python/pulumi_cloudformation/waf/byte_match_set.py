...
class ByteMatchSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ByteMatchSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ByteMatchSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ByteMatchSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ByteMatchSetProperties']:
        """
