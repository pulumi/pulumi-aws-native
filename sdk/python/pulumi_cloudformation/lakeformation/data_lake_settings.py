...
class DataLakeSettings(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DataLakeSettingsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DataLakeSettingsPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(DataLakeSettings, __self__).__init__(
            'cloudformation:LakeFormation:DataLakeSettings',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DataLakeSettingsAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DataLakeSettingsProperties']:
        """
