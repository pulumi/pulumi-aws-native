...
class LaunchConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LaunchConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LaunchConfigurationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LaunchConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LaunchConfigurationProperties']:
        """
