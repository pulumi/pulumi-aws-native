...
class LifecycleHook(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LifecycleHookPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LifecycleHookPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LifecycleHookAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LifecycleHookProperties']:
        """
