...
class Repository(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RepositoryPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RepositoryPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RepositoryAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RepositoryProperties']:
        """
