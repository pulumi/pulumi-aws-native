...
class Assessment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['AssessmentPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Assessment, __self__).__init__(
            'cloudformation:AuditManager:Assessment',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AssessmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AssessmentProperties']:
        """
