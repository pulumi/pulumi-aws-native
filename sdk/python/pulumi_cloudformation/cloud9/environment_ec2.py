...
class EnvironmentEC2(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EnvironmentEC2PropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EnvironmentEC2PropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EnvironmentEC2Attributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EnvironmentEC2Properties']:
        """
