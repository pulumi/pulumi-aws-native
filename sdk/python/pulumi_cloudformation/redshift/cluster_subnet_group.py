...
class ClusterSubnetGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClusterSubnetGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterSubnetGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClusterSubnetGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClusterSubnetGroupProperties']:
        """
