...
class ClusterSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClusterSecurityGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterSecurityGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterSecurityGroup':
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClusterSecurityGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClusterSecurityGroupProperties']:
        """
