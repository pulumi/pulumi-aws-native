...
class ClusterParameterGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClusterParameterGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterParameterGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClusterParameterGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClusterParameterGroupProperties']:
        """
