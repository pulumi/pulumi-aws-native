...
__all__ = ['ClusterSecurityGroupIngress']
...
class ClusterSecurityGroupIngress(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClusterSecurityGroupIngressPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClusterSecurityGroupIngressPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClusterSecurityGroupIngressAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClusterSecurityGroupIngressProperties']:
        """
