...
class Preset(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PresetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PresetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Preset':
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PresetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PresetProperties']:
        """
