...
class FindingsFilter(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['FindingsFilterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FindingsFilterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.FindingsFilterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FindingsFilterProperties']:
        """
