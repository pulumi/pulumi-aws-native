...
class WebACLAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['WebACLAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WebACLAssociationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(WebACLAssociation, __self__).__init__(
            'cloudformation:WAFv2:WebACLAssociation',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.WebACLAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WebACLAssociationProperties']:
        """
