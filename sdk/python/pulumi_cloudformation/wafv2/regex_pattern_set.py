...
class RegexPatternSet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RegexPatternSetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RegexPatternSetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RegexPatternSetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RegexPatternSetProperties']:
        """
