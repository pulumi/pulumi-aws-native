...
class CodeSigningConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CodeSigningConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CodeSigningConfigPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(CodeSigningConfig, __self__).__init__(
            'cloudformation:Lambda:CodeSigningConfig',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CodeSigningConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CodeSigningConfigProperties']:
        """
