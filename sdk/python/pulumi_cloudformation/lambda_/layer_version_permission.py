...
__all__ = ['LayerVersionPermission']
...
class LayerVersionPermission(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['LayerVersionPermissionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LayerVersionPermissionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.LayerVersionPermissionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LayerVersionPermissionProperties']:
        """
