...
class EventInvokeConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EventInvokeConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EventInvokeConfigPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EventInvokeConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EventInvokeConfigProperties']:
        """
