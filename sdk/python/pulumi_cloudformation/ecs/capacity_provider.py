...
class CapacityProvider(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CapacityProviderPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CapacityProviderPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CapacityProviderAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CapacityProviderProperties']:
        """
