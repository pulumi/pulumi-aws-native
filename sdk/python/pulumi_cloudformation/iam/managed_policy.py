...
class ManagedPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ManagedPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ManagedPolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ManagedPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ManagedPolicyProperties']:
        """
