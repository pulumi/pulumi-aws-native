...
class AccessKey(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AccessKeyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AccessKeyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AccessKeyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AccessKeyProperties']:
        """
