...
class InstanceProfile(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InstanceProfilePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InstanceProfilePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InstanceProfileAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InstanceProfileProperties']:
        """
