...
class TopicRuleDestination(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TopicRuleDestinationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TopicRuleDestinationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(TopicRuleDestination, __self__).__init__(
            'cloudformation:IoT:TopicRuleDestination',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TopicRuleDestinationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TopicRuleDestinationProperties']:
        """
