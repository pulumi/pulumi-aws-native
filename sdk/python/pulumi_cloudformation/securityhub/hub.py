...
class Hub(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['HubPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['HubPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Hub, __self__).__init__(
            'cloudformation:SecurityHub:Hub',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.HubAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.HubProperties']:
        """
