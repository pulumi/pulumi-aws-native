...
class QueuePolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['QueuePolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['QueuePolicyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.QueuePolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.QueuePolicyProperties']:
        """
