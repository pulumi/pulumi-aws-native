...
class AssessmentTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AssessmentTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AssessmentTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AssessmentTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AssessmentTemplateProperties']:
        """
