...
class RepositoryAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RepositoryAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RepositoryAssociationPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(RepositoryAssociation, __self__).__init__(
            'cloudformation:CodeGuruReviewer:RepositoryAssociation',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RepositoryAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RepositoryAssociationProperties']:
        """
