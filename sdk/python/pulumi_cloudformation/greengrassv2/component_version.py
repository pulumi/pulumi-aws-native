...
class ComponentVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ComponentVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ComponentVersionPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(ComponentVersion, __self__).__init__(
            'cloudformation:GreengrassV2:ComponentVersion',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ComponentVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ComponentVersionProperties']:
        """
