...
class GameSessionQueue(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GameSessionQueuePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GameSessionQueuePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GameSessionQueueAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GameSessionQueueProperties']:
        """
