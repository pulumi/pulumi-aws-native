...
__all__ = ['MatchmakingConfiguration']
...
class MatchmakingConfiguration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MatchmakingConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MatchmakingConfigurationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MatchmakingConfigurationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MatchmakingConfigurationProperties']:
        """
