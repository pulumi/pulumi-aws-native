...
class GlobalNetwork(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GlobalNetworkPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GlobalNetworkPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GlobalNetworkAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GlobalNetworkProperties']:
        """
