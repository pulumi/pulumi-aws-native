...
class TransitGatewayRegistration(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['TransitGatewayRegistrationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['TransitGatewayRegistrationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.TransitGatewayRegistrationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.TransitGatewayRegistrationProperties']:
        """
