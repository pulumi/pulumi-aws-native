...
class Graph(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GraphPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GraphPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(Graph, __self__).__init__(
            'cloudformation:Detective:Graph',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GraphAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GraphProperties']:
        """
