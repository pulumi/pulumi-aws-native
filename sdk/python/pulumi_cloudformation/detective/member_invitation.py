...
class MemberInvitation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['MemberInvitationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['MemberInvitationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.MemberInvitationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MemberInvitationProperties']:
        """
