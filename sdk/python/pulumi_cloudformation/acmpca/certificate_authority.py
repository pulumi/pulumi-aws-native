...
class CertificateAuthority(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CertificateAuthorityPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CertificateAuthorityPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CertificateAuthorityAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CertificateAuthorityProperties']:
        """
