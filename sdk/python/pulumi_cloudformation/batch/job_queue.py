...
class JobQueue(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['JobQueuePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['JobQueuePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.JobQueueAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.JobQueueProperties']:
        """
