...
class JobDefinition(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['JobDefinitionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.JobDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.JobDefinitionProperties']:
        """
