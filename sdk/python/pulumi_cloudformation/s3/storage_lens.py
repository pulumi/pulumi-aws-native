...
class StorageLens(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StorageLensPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StorageLensPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StorageLensAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StorageLensProperties']:
        """
