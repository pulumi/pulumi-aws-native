...
class ScalableTarget(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ScalableTargetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ScalableTargetPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ScalableTargetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ScalableTargetProperties']:
        """
