...
class StreamKey(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StreamKeyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StreamKeyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StreamKeyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StreamKeyProperties']:
        """
