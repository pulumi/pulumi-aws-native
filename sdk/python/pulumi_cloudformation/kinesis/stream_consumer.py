...
class StreamConsumer(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StreamConsumerPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StreamConsumerPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StreamConsumerAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StreamConsumerProperties']:
        """
