...
__all__ = ['NotebookInstanceLifecycleConfig']
...
class NotebookInstanceLifecycleConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NotebookInstanceLifecycleConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['NotebookInstanceLifecycleConfigPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NotebookInstanceLifecycleConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NotebookInstanceLifecycleConfigProperties']:
        """
