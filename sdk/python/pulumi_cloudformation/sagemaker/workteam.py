...
class Workteam(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['WorkteamPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['WorkteamPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.WorkteamAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WorkteamProperties']:
        """
