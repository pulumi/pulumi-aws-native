...
class ModelPackageGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ModelPackageGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ModelPackageGroupPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(ModelPackageGroup, __self__).__init__(
            'cloudformation:SageMaker:ModelPackageGroup',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ModelPackageGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ModelPackageGroupProperties']:
        """
