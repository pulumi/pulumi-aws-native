...
class ModelExplainabilityJobDefinition(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ModelExplainabilityJobDefinitionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ModelExplainabilityJobDefinitionPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(ModelExplainabilityJobDefinition, __self__).__init__(
            'cloudformation:SageMaker:ModelExplainabilityJobDefinition',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ModelExplainabilityJobDefinitionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ModelExplainabilityJobDefinitionProperties']:
        """
