...
class CodeRepository(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CodeRepositoryPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CodeRepositoryPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CodeRepositoryAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CodeRepositoryProperties']:
        """
