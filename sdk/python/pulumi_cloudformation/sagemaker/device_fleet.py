...
class DeviceFleet(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeviceFleetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeviceFleetPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(DeviceFleet, __self__).__init__(
            'cloudformation:SageMaker:DeviceFleet',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeviceFleetAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeviceFleetProperties']:
        """
