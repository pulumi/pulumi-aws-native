...
__all__ = ['RobotApplicationVersion']
...
class RobotApplicationVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RobotApplicationVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RobotApplicationVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RobotApplicationVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RobotApplicationVersionProperties']:
        """
