...
class SimulationApplication(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SimulationApplicationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SimulationApplicationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SimulationApplicationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SimulationApplicationProperties']:
        """
