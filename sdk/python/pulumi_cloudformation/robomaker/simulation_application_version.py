...
__all__ = ['SimulationApplicationVersion']
...
class SimulationApplicationVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SimulationApplicationVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SimulationApplicationVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SimulationApplicationVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SimulationApplicationVersionProperties']:
        """
