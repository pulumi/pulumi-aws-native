...
class Alarm(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AlarmPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AlarmPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AlarmAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AlarmProperties']:
        """
