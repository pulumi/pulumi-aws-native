...
class AnomalyDetector(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['AnomalyDetectorPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AnomalyDetectorPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.AnomalyDetectorAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AnomalyDetectorProperties']:
        """
