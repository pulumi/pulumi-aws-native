...
class FirewallPolicy(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['FirewallPolicyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['FirewallPolicyPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(FirewallPolicy, __self__).__init__(
            'cloudformation:NetworkFirewall:FirewallPolicy',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.FirewallPolicyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FirewallPolicyProperties']:
        """
