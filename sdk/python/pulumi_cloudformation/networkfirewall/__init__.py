...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "cloudformation:NetworkFirewall:Firewall":
                return Firewall(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:NetworkFirewall:FirewallPolicy":
                return FirewallPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:NetworkFirewall:LoggingConfiguration":
                return LoggingConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "cloudformation:NetworkFirewall:RuleGroup":
    ...
    pulumi.runtime.register_resource_module("cloudformation", "NetworkFirewall", _module_instance)
