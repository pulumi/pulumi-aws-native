...
class StackFleetAssociation(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['StackFleetAssociationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['StackFleetAssociationPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.StackFleetAssociationAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StackFleetAssociationProperties']:
        """
