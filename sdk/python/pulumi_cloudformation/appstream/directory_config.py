...
class DirectoryConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DirectoryConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DirectoryConfigPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DirectoryConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DirectoryConfigProperties']:
        """
