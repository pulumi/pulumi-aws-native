...
class ImageBuilder(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ImageBuilderPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ImageBuilderPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ImageBuilderAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ImageBuilderProperties']:
        """
