...
class DBSecurityGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DBSecurityGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DBSecurityGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DBSecurityGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DBSecurityGroupProperties']:
        """
