...
class DBSubnetGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DBSubnetGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DBSubnetGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DBSubnetGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DBSubnetGroupProperties']:
        """
