...
class GlobalCluster(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GlobalClusterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GlobalClusterPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(GlobalCluster, __self__).__init__(
            'cloudformation:RDS:GlobalCluster',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GlobalClusterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GlobalClusterProperties']:
        """
