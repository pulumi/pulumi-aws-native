...
class EventSubscription(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EventSubscriptionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EventSubscriptionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EventSubscriptionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EventSubscriptionProperties']:
        """
