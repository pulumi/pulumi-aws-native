...
class ReplicationTask(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ReplicationTaskPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ReplicationTaskPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ReplicationTaskAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ReplicationTaskProperties']:
        """
