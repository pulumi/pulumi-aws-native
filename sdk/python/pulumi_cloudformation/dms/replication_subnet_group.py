...
class ReplicationSubnetGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ReplicationSubnetGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ReplicationSubnetGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ReplicationSubnetGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ReplicationSubnetGroupProperties']:
        """
