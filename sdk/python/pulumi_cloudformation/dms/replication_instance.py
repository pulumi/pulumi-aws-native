...
class ReplicationInstance(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ReplicationInstancePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ReplicationInstancePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ReplicationInstanceAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ReplicationInstanceProperties']:
        """
