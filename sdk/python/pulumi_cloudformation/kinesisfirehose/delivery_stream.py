...
class DeliveryStream(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeliveryStreamPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DeliveryStreamPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DeliveryStreamAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeliveryStreamProperties']:
        """
