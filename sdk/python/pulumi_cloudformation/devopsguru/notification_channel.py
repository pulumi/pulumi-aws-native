...
class NotificationChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['NotificationChannelPropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(NotificationChannel, __self__).__init__(
            'cloudformation:DevOpsGuru:NotificationChannel',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.NotificationChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.NotificationChannelProperties']:
        """
