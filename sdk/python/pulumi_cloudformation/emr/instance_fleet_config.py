...
class InstanceFleetConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InstanceFleetConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InstanceFleetConfigPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InstanceFleetConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InstanceFleetConfigProperties']:
        """
