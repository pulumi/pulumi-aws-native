...
class InstanceGroupConfig(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['InstanceGroupConfigPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InstanceGroupConfigPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.InstanceGroupConfigAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.InstanceGroupConfigProperties']:
        """
