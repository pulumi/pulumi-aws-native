...
class SigningProfile(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SigningProfilePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SigningProfilePropertiesArgs']] properties: The input properties associated with the resource
        ...
        super(SigningProfile, __self__).__init__(
            'cloudformation:Signer:SigningProfile',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SigningProfileAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SigningProfileProperties']:
        """
