...
class UserPoolDomain(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolDomainPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolDomainPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolDomainAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolDomainProperties']:
        """
