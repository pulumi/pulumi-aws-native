...
class IdentityPoolRoleAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['IdentityPoolRoleAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['IdentityPoolRoleAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.IdentityPoolRoleAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.IdentityPoolRoleAttachmentProperties']:
        """
