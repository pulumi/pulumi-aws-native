...
__all__ = ['UserPoolRiskConfigurationAttachment']
...
class UserPoolRiskConfigurationAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolRiskConfigurationAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolRiskConfigurationAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolRiskConfigurationAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolRiskConfigurationAttachmentProperties']:
        """
