...
__all__ = ['UserPoolUICustomizationAttachment']
...
class UserPoolUICustomizationAttachment(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolUICustomizationAttachmentPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolUICustomizationAttachmentPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolUICustomizationAttachmentAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolUICustomizationAttachmentProperties']:
        """
