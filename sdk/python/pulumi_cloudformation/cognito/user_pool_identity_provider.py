...
__all__ = ['UserPoolIdentityProvider']
...
class UserPoolIdentityProvider(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolIdentityProviderPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolIdentityProviderPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolIdentityProviderAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolIdentityProviderProperties']:
        """
