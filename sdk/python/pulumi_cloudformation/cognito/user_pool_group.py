...
class UserPoolGroup(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UserPoolGroupPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UserPoolGroupPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UserPoolGroupAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UserPoolGroupProperties']:
        """
