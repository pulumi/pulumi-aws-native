...
class BasePathMapping(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BasePathMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['BasePathMappingPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.BasePathMappingAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BasePathMappingProperties']:
        """
