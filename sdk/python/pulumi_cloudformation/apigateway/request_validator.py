...
class RequestValidator(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RequestValidatorPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['RequestValidatorPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.RequestValidatorAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.RequestValidatorProperties']:
        """
