...
class DocumentationVersion(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DocumentationVersionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DocumentationVersionPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DocumentationVersionAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DocumentationVersionProperties']:
        """
