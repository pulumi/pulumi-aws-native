...
class UsagePlanKey(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UsagePlanKeyPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UsagePlanKeyPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UsagePlanKeyAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UsagePlanKeyProperties']:
        """
