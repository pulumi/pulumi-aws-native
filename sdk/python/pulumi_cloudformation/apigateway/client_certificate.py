...
class ClientCertificate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ClientCertificatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ClientCertificatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.ClientCertificateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ClientCertificateProperties']:
        """
