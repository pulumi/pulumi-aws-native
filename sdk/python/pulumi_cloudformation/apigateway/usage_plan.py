...
class UsagePlan(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['UsagePlanPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['UsagePlanPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.UsagePlanAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.UsagePlanProperties']:
        """
