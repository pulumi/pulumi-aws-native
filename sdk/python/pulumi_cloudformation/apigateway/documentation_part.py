...
class DocumentationPart(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DocumentationPartPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DocumentationPartPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.DocumentationPartAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DocumentationPartProperties']:
        """
