...
class GatewayResponse(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['GatewayResponsePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GatewayResponsePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.GatewayResponseAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GatewayResponseProperties']:
        """
