...
class SmsTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SmsTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SmsTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SmsTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SmsTemplateProperties']:
        """
