...
class APNSVoipChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['APNSVoipChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['APNSVoipChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.APNSVoipChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.APNSVoipChannelProperties']:
        """
