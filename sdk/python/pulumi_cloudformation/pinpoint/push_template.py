...
class PushTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PushTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['PushTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.PushTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PushTemplateProperties']:
        """
