...
class APNSVoipSandboxChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['APNSVoipSandboxChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['APNSVoipSandboxChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.APNSVoipSandboxChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.APNSVoipSandboxChannelProperties']:
        """
