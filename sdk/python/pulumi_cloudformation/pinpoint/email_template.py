...
class EmailTemplate(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['EmailTemplatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['EmailTemplatePropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.EmailTemplateAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EmailTemplateProperties']:
        """
