...
class APNSSandboxChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['APNSSandboxChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['APNSSandboxChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.APNSSandboxChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.APNSSandboxChannelProperties']:
        """
