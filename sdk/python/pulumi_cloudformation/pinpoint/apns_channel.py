...
class APNSChannel(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['APNSChannelPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['APNSChannelPropertiesArgs']] properties: The input properties associated with the resource
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'APNSChannel':
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.APNSChannelAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.APNSChannelProperties']:
        """
