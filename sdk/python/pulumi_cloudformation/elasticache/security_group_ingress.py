...
class SecurityGroupIngress(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SecurityGroupIngressPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['SecurityGroupIngressPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.SecurityGroupIngressAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SecurityGroupIngressProperties']:
        """
