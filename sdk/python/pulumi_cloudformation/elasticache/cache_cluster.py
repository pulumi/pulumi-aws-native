...
class CacheCluster(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['CacheClusterPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CacheClusterPropertiesArgs']] properties: The input properties associated with the resource
    ...
    @property
    @pulumi.getter
    def attributes(self) -> pulumi.Output['outputs.CacheClusterAttributes']:
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CacheClusterProperties']:
        """
